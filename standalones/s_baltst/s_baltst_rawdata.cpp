...
bsl::ostream& RawData::print(bsl::ostream& stream,
                             int           level,
                             int           spacesPerLevel) const
{
    ...
    printer.start();
    {
        ...
        bdlb::Print::singleLineHexDump(
            stream, this->charvec().begin(), this->charvec().end());
        stream << " ]" << (multilineFlag ? "\n" : "");
    }
