// s_baltst_sqrt.h              *DO NOT EDIT*              @generated -*-C++-*-
#ifndef INCLUDED_S_BALTST_SQRT
#define INCLUDED_S_BALTST_SQRT

#include <bsls_ident.h>
BSLS_IDENT_RCSID(s_baltst_sqrt_h, "$Id$ $CSID$")
...
BDLAT_DECL_SEQUENCE_WITH_BITWISEMOVEABLE_TRAITS(s_baltst::Sqrt)
template <>
struct bdlat_UsesDefaultValueFlag<s_baltst::Sqrt> : bsl::true_type {};
...
// MANIPULATORS
template <typename t_MANIPULATOR>
int Sqrt::manipulateAttributes(t_MANIPULATOR& manipulator)
{
    int ret;
...
template <typename t_MANIPULATOR>
int Sqrt::manipulateAttribute(t_MANIPULATOR& manipulator, int id)
{
    enum { NOT_FOUND = -1 };
...
// ACCESSORS
template <typename t_ACCESSOR>
int Sqrt::accessAttributes(t_ACCESSOR& accessor) const
{
    int ret;
...
template <typename t_ACCESSOR>
int Sqrt::accessAttribute(t_ACCESSOR& accessor, int id) const
{
    enum { NOT_FOUND = -1 };
