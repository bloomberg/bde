...
template <>
struct bdlat_UsesDefaultValueFlag<s_baltst::BigRecord> : bsl::true_type {};
...
// MANIPULATORS
template <typename t_MANIPULATOR>
int BigRecord::manipulateAttributes(t_MANIPULATOR& manipulator)
{
    int ret;
...
template <typename t_MANIPULATOR>
int BigRecord::manipulateAttribute(t_MANIPULATOR& manipulator, int id)
{
    enum { NOT_FOUND = -1 };
...
// ACCESSORS
template <typename t_ACCESSOR>
int BigRecord::accessAttributes(t_ACCESSOR& accessor) const
{
    int ret;
...
template <typename t_ACCESSOR>
int BigRecord::accessAttribute(t_ACCESSOR& accessor, int id) const
{
    enum { NOT_FOUND = -1 };
