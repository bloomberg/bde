...
template <class MANIPULATOR>
int MySequenceWithNillables::manipulateAttribute(MANIPULATOR& manipulator, int id)
{
    enum { NOT_FOUND = -1 };
...
bool s_baltst::operator==(
        const s_baltst::MySequenceWithNillables& lhs,
        const s_baltst::MySequenceWithNillables& rhs)
{
