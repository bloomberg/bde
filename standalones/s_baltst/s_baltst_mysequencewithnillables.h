// s_baltst_mysequencewithnillables.h    *DO NOT EDIT*     @generated -*-C++-*-
#ifndef INCLUDED_S_BALTST_MYSEQUENCEWITHNILLABLES
#define INCLUDED_S_BALTST_MYSEQUENCEWITHNILLABLES

#include <bsls_ident.h>
BSLS_IDENT_RCSID(s_baltst_mysequencewithnillables_h, "$Id$ $CSID$")
...
namespace s_baltst { class MySequenceWithNillables; }
namespace s_baltst {
...
class MySequenceWithNillables {
 ...
 && defined(BSLS_COMPILERFEATURES_SUPPORT_NOEXCEPT)
    ...
    /// state.
    MySequenceWithNillables(MySequenceWithNillables&& original) noexcept;
    ...
    /// allocator is used.
    MySequenceWithNillables(MySequenceWithNillables&& original,
 ...
 && defined(BSLS_COMPILERFEATURES_SUPPORT_NOEXCEPT)
    ...
    friend bool operator==(const MySequenceWithNillables& lhs,
...
BDLAT_DECL_SEQUENCE_WITH_ALLOCATOR_BITWISEMOVEABLE_TRAITS(s_baltst::MySequenceWithNillables)
template <>
struct bdlat_UsesDefaultValueFlag<s_baltst::MySequenceWithNillables> : bsl::true_type {};
...
// MANIPULATORS
template <typename t_MANIPULATOR>
int MySequenceWithNillables::manipulateAttributes(t_MANIPULATOR& manipulator)
{
    int ret;
...
template <typename t_MANIPULATOR>
int MySequenceWithNillables::manipulateAttribute(t_MANIPULATOR& manipulator, int id)
{
    enum { NOT_FOUND = -1 };
...
inline
bdlb::NullableValue<s_baltst::MySequence>& MySequenceWithNillables::attribute3()
{
    return d_attribute3;
}
...
// ACCESSORS
template <typename t_ACCESSOR>
int MySequenceWithNillables::accessAttributes(t_ACCESSOR& accessor) const
{
    int ret;
...
template <typename t_ACCESSOR>
int MySequenceWithNillables::accessAttribute(t_ACCESSOR& accessor, int id) const
{
    enum { NOT_FOUND = -1 };
...
inline
const bdlb::NullableValue<bsl::string>& MySequenceWithNillables::attribute2() const
{
    return d_attribute2;
}

inline
const bdlb::NullableValue<s_baltst::MySequence>& MySequenceWithNillables::attribute3() const
{
    return d_attribute3;
}
