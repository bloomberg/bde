...
class MySequenceWithArray {
 ...
 && defined(BSLS_COMPILERFEATURES_SUPPORT_NOEXCEPT)
    ...
    friend bool operator==(const MySequenceWithArray& lhs,
...
template <>
struct bdlat_UsesDefaultValueFlag<s_baltst::MySequenceWithArray> : bsl::true_type {};
...
// MANIPULATORS
template <typename t_MANIPULATOR>
int MySequenceWithArray::manipulateAttributes(t_MANIPULATOR& manipulator)
{
    int ret;
...
template <typename t_MANIPULATOR>
int MySequenceWithArray::manipulateAttribute(t_MANIPULATOR& manipulator, int id)
{
    enum { NOT_FOUND = -1 };
...
// ACCESSORS
template <typename t_ACCESSOR>
int MySequenceWithArray::accessAttributes(t_ACCESSOR& accessor) const
{
    int ret;
...
template <typename t_ACCESSOR>
int MySequenceWithArray::accessAttribute(t_ACCESSOR& accessor, int id) const
{
    enum { NOT_FOUND = -1 };
