// s_baltst_mysequencewithnullable.cpp    *DO NOT EDIT*    @generated -*-C++-*-

#include <bsls_ident.h>
BSLS_IDENT_RCSID(s_baltst_mysequencewithnullable_cpp, "$Id$ $CSID$")
...
MySequenceWithNullable::MySequenceWithNullable(MySequenceWithNullable&& original) noexcept
: d_attribute2(bsl::move(original.d_attribute2))
, d_attribute1(bsl::move(original.d_attribute1))
{
}

MySequenceWithNullable::MySequenceWithNullable(MySequenceWithNullable&& original,
                                               bslma::Allocator *basicAllocator)
...
bsl::ostream& MySequenceWithNullable::print(bsl::ostream& stream,
                                            int           level,
