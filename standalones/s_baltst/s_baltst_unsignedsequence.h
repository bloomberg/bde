...
class UnsignedSequence {
  ...
  public:
    ...
    friend bool operator==(const UnsignedSequence& lhs,
...
template <>
struct bdlat_UsesDefaultValueFlag<s_baltst::UnsignedSequence> : bsl::true_type {};
...
// MANIPULATORS
template <typename t_MANIPULATOR>
int UnsignedSequence::manipulateAttributes(t_MANIPULATOR& manipulator)
{
    int ret;
...
template <typename t_MANIPULATOR>
int UnsignedSequence::manipulateAttribute(t_MANIPULATOR& manipulator, int id)
{
    enum { NOT_FOUND = -1 };
...
// ACCESSORS
template <typename t_ACCESSOR>
int UnsignedSequence::accessAttributes(t_ACCESSOR& accessor) const
{
    int ret;
...
template <typename t_ACCESSOR>
int UnsignedSequence::accessAttribute(t_ACCESSOR& accessor, int id) const
{
    enum { NOT_FOUND = -1 };
