// s_baltst_mysimpleintcontent.h       *DO NOT EDIT*       @generated -*-C++-*-
#ifndef INCLUDED_S_BALTST_MYSIMPLEINTCONTENT
#define INCLUDED_S_BALTST_MYSIMPLEINTCONTENT

#include <bsls_ident.h>
BSLS_IDENT_RCSID(s_baltst_mysimpleintcontent_h, "$Id$ $CSID$")
...
namespace s_baltst { class MySimpleIntContent; }
namespace s_baltst {
...
class MySimpleIntContent {
 ...
 && defined(BSLS_COMPILERFEATURES_SUPPORT_NOEXCEPT)
    ...
    MySimpleIntContent(MySimpleIntContent&& original) noexcept;
    ...
    /// used.
    MySimpleIntContent(MySimpleIntContent&& original,
 ...
 && defined(BSLS_COMPILERFEATURES_SUPPORT_NOEXCEPT)
    ...
    /// Return the value of the "TheContent" attribute of this object.
    int theContent() const;
    ...
    friend bool operator==(const MySimpleIntContent& lhs,
...
BDLAT_DECL_SEQUENCE_WITH_ALLOCATOR_BITWISEMOVEABLE_TRAITS(s_baltst::MySimpleIntContent)
template <>
struct bdlat_UsesDefaultValueFlag<s_baltst::MySimpleIntContent> : bsl::true_type {};
...
// MANIPULATORS
template <typename t_MANIPULATOR>
int MySimpleIntContent::manipulateAttributes(t_MANIPULATOR& manipulator)
{
    int ret;
...
template <typename t_MANIPULATOR>
int MySimpleIntContent::manipulateAttribute(t_MANIPULATOR& manipulator, int id)
{
    enum { NOT_FOUND = -1 };
...
// ACCESSORS
template <typename t_ACCESSOR>
int MySimpleIntContent::accessAttributes(t_ACCESSOR& accessor) const
{
    int ret;
...
template <typename t_ACCESSOR>
int MySimpleIntContent::accessAttribute(t_ACCESSOR& accessor, int id) const
{
    enum { NOT_FOUND = -1 };
...
inline
int MySimpleIntContent::theContent() const
{
    return d_theContent;
}
