...
class MySimpleContent {
 ...
 && defined(BSLS_COMPILERFEATURES_SUPPORT_NOEXCEPT)
    ...
    friend bool operator==(const MySimpleContent& lhs,
...
template <>
struct bdlat_UsesDefaultValueFlag<s_baltst::MySimpleContent> : bsl::true_type {};
...
// MANIPULATORS
template <typename t_MANIPULATOR>
int MySimpleContent::manipulateAttributes(t_MANIPULATOR& manipulator)
{
    int ret;
...
template <typename t_MANIPULATOR>
int MySimpleContent::manipulateAttribute(t_MANIPULATOR& manipulator, int id)
{
    enum { NOT_FOUND = -1 };
...
// ACCESSORS
template <typename t_ACCESSOR>
int MySimpleContent::accessAttributes(t_ACCESSOR& accessor) const
{
    int ret;
...
template <typename t_ACCESSOR>
int MySimpleContent::accessAttribute(t_ACCESSOR& accessor, int id) const
{
    enum { NOT_FOUND = -1 };
