...
class RawDataUnformatted {
 ...
 && defined(BSLS_COMPILERFEATURES_SUPPORT_NOEXCEPT)
    ...
    friend bool operator==(const RawDataUnformatted& lhs,
...
template <>
struct bdlat_UsesDefaultValueFlag<s_baltst::RawDataUnformatted> : bsl::true_type {};
...
// MANIPULATORS
template <typename t_MANIPULATOR>
int RawDataUnformatted::manipulateAttributes(t_MANIPULATOR& manipulator)
{
    int ret;
...
template <typename t_MANIPULATOR>
int RawDataUnformatted::manipulateAttribute(t_MANIPULATOR& manipulator, int id)
{
    enum { NOT_FOUND = -1 };
...
// ACCESSORS
template <typename t_ACCESSOR>
int RawDataUnformatted::accessAttributes(t_ACCESSOR& accessor) const
{
    int ret;
...
template <typename t_ACCESSOR>
int RawDataUnformatted::accessAttribute(t_ACCESSOR& accessor, int id) const
{
    enum { NOT_FOUND = -1 };
