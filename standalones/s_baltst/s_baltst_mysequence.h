// s_baltst_mysequence.h           *DO NOT EDIT*           @generated -*-C++-*-
#ifndef INCLUDED_S_BALTST_MYSEQUENCE
#define INCLUDED_S_BALTST_MYSEQUENCE

#include <bsls_ident.h>
BSLS_IDENT_RCSID(s_baltst_mysequence_h, "$Id$ $CSID$")
...
class MySequence {
 ...
 && defined(BSLS_COMPILERFEATURES_SUPPORT_NOEXCEPT)
    ...
    MySequence(MySequence&& original) noexcept;
    ...
    /// `basicAllocator` is 0, the currently installed default allocator is
    /// used.
    MySequence(MySequence&& original,
...
BDLAT_DECL_SEQUENCE_WITH_ALLOCATOR_BITWISEMOVEABLE_TRAITS(s_baltst::MySequence)
template <>
struct bdlat_UsesDefaultValueFlag<s_baltst::MySequence> : bsl::true_type {};
...
// MANIPULATORS
template <typename t_MANIPULATOR>
int MySequence::manipulateAttributes(t_MANIPULATOR& manipulator)
{
    int ret;
...
template <typename t_MANIPULATOR>
int MySequence::manipulateAttribute(t_MANIPULATOR& manipulator, int id)
{
    enum { NOT_FOUND = -1 };
...
// ACCESSORS
template <typename t_ACCESSOR>
int MySequence::accessAttributes(t_ACCESSOR& accessor) const
{
    int ret;
...
template <typename t_ACCESSOR>
int MySequence::accessAttribute(t_ACCESSOR& accessor, int id) const
{
    enum { NOT_FOUND = -1 };
