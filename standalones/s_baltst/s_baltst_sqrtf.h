...
class SqrtF {
  ...
  public:
    ...
    friend bool operator==(const SqrtF& lhs, const SqrtF& rhs)
    {
    ...
    friend bsl::ostream& operator<<(bsl::ostream& stream, const SqrtF& rhs)
    {
...
template <>
struct bdlat_UsesDefaultValueFlag<s_baltst::SqrtF> : bsl::true_type {};
...
// MANIPULATORS
template <typename t_MANIPULATOR>
int SqrtF::manipulateAttributes(t_MANIPULATOR& manipulator)
{
    int ret;
...
template <typename t_MANIPULATOR>
int SqrtF::manipulateAttribute(t_MANIPULATOR& manipulator, int id)
{
    enum { NOT_FOUND = -1 };
...
// ACCESSORS
template <typename t_ACCESSOR>
int SqrtF::accessAttributes(t_ACCESSOR& accessor) const
{
    int ret;
...
template <typename t_ACCESSOR>
int SqrtF::accessAttribute(t_ACCESSOR& accessor, int id) const
{
    enum { NOT_FOUND = -1 };
