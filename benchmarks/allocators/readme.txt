...
They depend on a patched BDE library built with waf and specific
...
Other targets of interest:
  bde run-growth run-locality run-zation run-tention
...
Q3: Why does this depend on recent clang++ and libc++?
