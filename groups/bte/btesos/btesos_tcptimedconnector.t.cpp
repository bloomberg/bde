// btesos_tcptimedconnector.t.cpp      -*-C++-*-
...
typedef btesos_TcpTimedConnector Obj;
...
static int testExecutionHelper(btesos_TcpTimedConnector   *connector,
                               int                        *status,
...
static
int processTest(btesos_TcpTimedConnector                      *connector,
    ...
    switch (test) { case 0:
      case 24: {
                                  ...
                                  << "=============" << endl;
        {
            ...
            btesos_TcpTimedConnector connector(&factory);
...
// TBD FIX ME
          ...
          //
          // Plan:
          //   After a 'btesos_TcpTimedConnector' object 'connector' is
...

          {
              ...
              bdet_TimeInterval timeout(2, 1000), time(120, 0);
...
// ===============>
      ...
      case 2: {
          ...
          //   can create different 'btesos_TcpTimedConnector' objects
          //   successfully, based on different parameters; (2) if can
          //   destructor any 'btesos_TcpTimedConnector' object successfully.
          // Plan:
          //   Build a set of data 'VALUES' to construct different
          //   'btesos_TcpTimedConnector' objects.  With each objects,
          //   establish a specified number of channels, verify the result
          //   from each channel operation.
          // Testing:
          //   virtual btesos_TcpTimedConnector();
          //   virtual btesos_TcpTimedConnector(..., int initialCapacity, ...);
          //   virtual ~btesos_TcpTimedConnector();
          // ----------------------------------------------------------------
          if (verbose) {
