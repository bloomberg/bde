// btesos_tcpchannel.h             -*-C++-*-
#ifndef INCLUDED_BTESOS_TCPCHANNEL
#define INCLUDED_BTESOS_TCPCHANNEL
...
//
//@SEE_ALSO: btesos_tcpacceptor       btesos_tcpconnector
//@SEE_ALSO: btesos_tcptimedchannel   btesos_tcpcbchannel
//@SEE_ALSO: bteso_socketoptutil
//
//@DESCRIPTION: This component provides concrete implementation of the blocking
// communication channel ('btesc_channel') over TCP/IPv4 sockets.  Both
...
class btesos_TcpChannel : public btesc_Channel {
    // This class implements 'btesc_Channel' protocol over TCP/IP sockets.  It
  ...
  private:  // not implemented
    ...
    btesos_TcpChannel& operator=(const btesos_TcpChannel&);
  ...
  public:
    ...
    int read(int  *augStatus, char *buffer, int numBytes, int flags = 0);
        ...
        // 'btesc_Channel::ASYNC_INTERRUPT', "asynchronous events" are
    ...
    int readRaw(int  *augStatus,
        ...
        // 'flags' incorporates 'btesc_Channel::ASYNC_INTERRUPT', "asynchronous
     ...
     int readvRaw(int              *augStatus,
        ...
        // incorporates 'btesc_Channel::ASYNC_INTERRUPT', "asynchronous events"
...
inline
void btesos_TcpChannel::invalidate()
{
    d_isInvalidFlag = 1;
}

inline
bteso_StreamSocket<bteso_IPv4Address> *btesos_TcpChannel::socket() const
{
    return d_socket_p;
}

inline
int btesos_TcpChannel::isInvalid() const
{
