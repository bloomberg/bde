// btesos_tcptimedcbacceptor.h   -*-C++-*-
#ifndef INCLUDED_BTESOS_TCPTIMEDCBACCEPTOR
#define INCLUDED_BTESOS_TCPTIMEDCBACCEPTOR
...
//
//@CLASSES:
//  btesos_TcpTimedCbAcceptor: non-blocking timed channel allocator
//
//@SEE_ALSO: btesos_tcptimedcbchannel bteso_tcptimereventmanager
//           btesos_tcptimedcbconnector btesos_tcpcbchannel
...
//      d_allocateFunctor = bdef_BindUtil::bind(&allocateCb, this);
//  }
//
//  my_EchoServer::~my_EchoServer() {
//  }
...
class btesos_TcpTimedCbAcceptor_Reg; // component-local class declaration

                        // ===============================
                        // class btesos_TcpTimedCbAcceptor
                        // ===============================

class btesos_TcpTimedCbAcceptor : public btesc_TimedCbChannelAllocator {
  ...
  private:
    // Not implemented.
    btesos_TcpTimedCbAcceptor(const btesos_TcpTimedCbAcceptor&);
    btesos_TcpTimedCbAcceptor& operator=(const btesos_TcpTimedCbAcceptor&);
