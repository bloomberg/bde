// btesos_tcptimedacceptor.t.cpp      -*-C++-*-
...
//-----------------------------------------------------------------------------
// [ 2] virtual btesos_TcpTimedAcceptor()
// [ 2] virtual btesos_TcpTimedAcceptor(..., int initialCapacity, ...)
// [ 2] virtual ~btesos_TcpTimedAcceptor()
// [ 4] btesc_Channel *allocate()
// [ 5] btesc_Channel *allocateTimed()
// [ 6] btesc_Channel *timedAllocate()
// [ 7] btesc_Channel *timedAllocateTimed()
// [ 8] int open();
...
typedef btesos_TcpTimedAcceptor Obj;
...
static int testExecutionHelper(btesos_TcpTimedAcceptor     *acceptor,
                               int                         *status,
...
static
int processTest(btesos_TcpTimedAcceptor          *acceptor,
    ...
    switch (test) { case 0:
      case 24: {
                                  ...
                                  << "=============" << endl;
        {
            ...
            bdet_TimeInterval acceptTimeout(120, 0);
            btesos_TcpTimedAcceptor acceptor(&factory); // default allocator.
...
// ===================>
      ...
      case 7: {
          ...
          //
          // Plan:
          //   After a 'btesos_TcpTimedAcceptor' object 'acceptor' is
...

          {
              ...
              bdet_TimeInterval timeout(0, 5), time(5, 0);
...
// ===================>
                      ...
                      int ret = bcemt_ThreadUtil::create(&threadHandle,
                                                         ...
                                                         server);
                      ASSERT(0 == ret);
                      bdet_TimeInterval time = *DATA.d_timeout +
...
// ===============>
      ...
      case 2: {
          ...
          //   can create different 'btesos_TcpTimedAcceptor' objects
          //   successfully, based on different parameters; (2) if can
          //   destructor any 'btesos_TcpTimedAcceptor' object successfully.
          // Plan:
          //   Build a set of data 'VALUES' to construct different
          //   'btesos_TcpTimedAcceptor' objects.  With each objects,
          //   establish a specified number of channels, verify the result
          //   from each channel operation.
          // Testing:
          //   virtual btesos_TcpTimedAcceptor();
          //   virtual btesos_TcpTimedAcceptor(..., int initialCapacity, ...);
          //   virtual ~btesos_TcpTimedAcceptor();
          // ----------------------------------------------------------------
          if (verbose) {
