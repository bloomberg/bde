// btesos_tcpconnector.h   -*-C++-*-
#ifndef INCLUDED_BTESOS_TCPCONNECTOR
#define INCLUDED_BTESOS_TCPCONNECTOR
...
//
//@CLASSES:
//  btesos_TcpConnector: blocking 'btesc'-style channel allocator.
//
//@SEE_ALSO: btesos_tcpacceptor btesos_tcptimedchannel
//
...
// client.  (See 'btesos_tcpacceptor' for an echo server.)  An echo server
...
// MANIPULATORS
inline
void btesos_TcpConnector::setPeer(const bteso_IPv4Address& endpoint)
{
    d_peerAddress = endpoint;
}

inline
void btesos_TcpConnector::invalidate()
{
    d_isInvalidFlag = 1;
}
...
// ACCESSORS
inline
const bteso_IPv4Address& btesos_TcpConnector::peer() const
{
...
inline
int btesos_TcpConnector::isInvalid() const
{
