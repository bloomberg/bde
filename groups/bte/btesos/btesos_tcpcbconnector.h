// btesos_tcpcbconnector.h   -*-C++-*-
#ifndef INCLUDED_BTESOS_TCPCBCONNECTOR
#define INCLUDED_BTESOS_TCPCBCONNECTOR
...
//
//@CLASSES:
//  btesos_TcpTimedCbConnector: non-blocking channel allocator
//
//@SEE_ALSO: btesos_tcptimedcbchannel bteso_tcptimereventmanager
//           btesos_tcpcbacceptor btesos_tcpcbchannel
...
//      }
//
//      callback = bdef_BindUtil::bind(&my_DataStream::allocateCb,
//                                     this,
//                                     _1, _2,
//                                     &d_dataChannel);
//
...
class btesos_TcpCbConnector_Reg; // component-local class declaration

                       // ===========================
                       // class btesos_TcpCbConnector
                       // ===========================

class btesos_TcpCbConnector : public btesc_CbChannelAllocator {
  ...
  private:
    btesos_TcpCbConnector(const btesos_TcpCbConnector&); // not impl.
    btesos_TcpCbConnector&
        operator=(const btesos_TcpCbConnector&);              // not impl.
