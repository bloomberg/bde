// btemt_querydispatcherconfiguration.cpp  -*-C++-*-
#include <btemt_querydispatcherconfiguration.h>

#include <bdes_ident.h>
BDES_IDENT_RCSID(btemt_querydispatcherconfiguration_cpp,"$Id$ $CSID$")
...
int btemt_QueryDispatcherConfiguration::maxSupportedBdexVersion() {
    return 1;
}

int btemt_QueryDispatcherConfiguration::maxSupportedVersion() {
