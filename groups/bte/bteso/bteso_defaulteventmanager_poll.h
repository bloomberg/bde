...
//
//@CLASSES:
//  bteso_DefaultEventManager<bteso_Platform::POLL>: 'poll'-based multiplexer
//
...
// that uses the 'poll' system call to monitor for socket events and adheres to
...
// 'bteso_DefaultEventManager<bteso_Platform::POLL>' object; also create a
...
class bteso_TimeMetrics;
            ...
            // =====================================================
            // class bteso_DefaultEventManager<bteso_Platform::POLL>
            // =====================================================
template<>
class bteso_DefaultEventManager<bteso_Platform::POLL>
...
// ACCESSORS
inline
bool bteso_DefaultEventManager<bteso_Platform::POLL>::
