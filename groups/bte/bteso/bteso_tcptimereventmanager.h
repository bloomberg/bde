// bteso_tcptimereventmanager.h -*-C++-*-
#ifndef INCLUDED_BTESO_TCPTIMEREVENTMANAGER
#define INCLUDED_BTESO_TCPTIMEREVENTMANAGER
...
//
//@CLASSES:
//  bteso_TcpTimerEventManager: socket-event and timer multiplexer
//
//@SEE_ALSO: bteso_eventmanager, bteso_sockethandle,
...
// 'bteso_timereventmanager' protocol for socket handles.  An interested party
...
//      // the user's command.
//
//      bteso_SocketHandle::Handle  d_client;   // socket handle for "control
//                                              // data"
...
//              bdef_MemFnUtil::memFn(&my_CommandMediator::readCb, this),
//              basicAllocator);
...
class bteso_TcpTimerEventManager : public bteso_TimerEventManager
{
  ...
  private:
    bteso_TcpTimerEventManager(const bteso_TcpTimerEventManager&);
    bteso_TcpTimerEventManager& operator=(const bteso_TcpTimerEventManager&);
  ...
  public:
    ...
    const bteso_EventManager *socketEventManager() const;
