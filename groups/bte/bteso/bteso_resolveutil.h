// bteso_resolveutil.h         -*-C++-*-
#ifndef INCLUDED_BTESO_RESOLVEUTIL
#define INCLUDED_BTESO_RESOLVEUTIL
...
//
//@CLASSES:
//  bteso_ResolveUtil: namespace for platform-independent resolution utilities
//
...
// port number from a name.  First we create two 'bteso_IPv4Address' objects to
// store the return value for host 'n100', 'ibm1' respectively, and verify the
// return addresses:
//..
...
//      retCode = bteso_ResolveUtil::getAddress(&result2, hostname2,
//                                                        &errorCode);
//      assert(0 == retCode);
//      assert(0 == errorCode);
...
//..
//      bsl::vector<bteso_IPv4Address> addr_array;
//      bteso_IPv4Address result3;
//
//      const char *hostname3 = "n024";
//      retCode = bteso_ResolveUtil::getAddresses(&addr_array,
//                                                hostname3,
//                                                &errorCode);
//      assert(0 == retCode);
//      assert(0 == errorCode);
...
struct bteso_ResolveUtil {
  ...
  public:
    ...
    // CLASS METHODS
    static int getAddress       (bteso_IPv4Address *result,
                                 const char        *hostName,
                                 int               *errorCode = 0);
    static int getAddressDefault(bteso_IPv4Address *result,
                                 const char        *hostName,
                                 int               *errorCode = 0);
    ...
    static int getAddresses(bsl::vector<bteso_IPv4Address> *result,
                            const char                     *hostName,
                            int                            *errorCode = 0);
    ...
    static int getServicePort(bteso_IPv4Address *result,
