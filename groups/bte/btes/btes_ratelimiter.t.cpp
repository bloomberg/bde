...
//..
      ...
      case 12: {
        ...
        for(int ti=0; ti<NUM_DATA; ti++) {
            ...
            btes_LeakyBucket peakLb(P_RATE,
                                    btes_LeakyBucket::calculateCapacity(P_RATE,
                                                                        P_WND),
                                    Ti(0));

            btes_LeakyBucket sustLb(S_RATE,
                                    btes_LeakyBucket::calculateCapacity(S_RATE,
                                                                        S_WND),
                                    Ti(0));
     ...
     //  ---- ----- -----  ------   -------  ---------- -----  ------  --------
      ...
      case 7: {
        ...
        //
        // Testing:
        //   bdet_TimeInterval wouldExceedBandwidth(currentTime);
        //   bdet_TimeInterval calculateTimeToSubmit(currentTime);
        // --------------------------------------------------------------------
 ...
 // ---- ------- ------- ------ -------- -------- ------ ----- -------- -------
    ...
    {L_,   100,   Ti(10), 1000, Ti(0.5),  Ti(0),   10,   100,  Ti(   1), false}
      ...
      case 4: {
        ...
        //:    the pair of 'btes_LeakyBucket' objects.
        //:
 ...
 //  ---- ------- ------- ------- --------- -------- -------- ------ --------
     ...
     {L_,   100,   Ti(10),  1000,  Ti(0.1),   Ti(0),   10,     100,  Ti(0.01)}
        ...
        for (int ti = 0; ti < NUM_DATA; ++ti) {
            ...
            const Uint64 S_CAP = btes_LeakyBucket::calculateCapacity(S_RATE,
                                                                     S_WND);

            const Uint64 P_CAP = btes_LeakyBucket::calculateCapacity(P_RATE,
                                                                     P_WND);
