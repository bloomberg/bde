...
class mock_LB {
    // This mechanism mocks basic functionality of 'btes_LeakyBucket' and is
...
//..
      ...
      case 18: {
        ...
        //
        // Testing:
        //   static bdet_TimeInterval calculateTimeWindow(capacity, drainRate);
        // --------------------------------------------------------------------
...
//  ---- ---- ----  ----- ---- -------   ------   -----------   ----- ---------
  ...
  { L_, 1000,  500, 1000, 500, Ti(  0),  Ti(0.5),  Ti(   0.501), 500, Ti(0.5)}
      ...
      case 12: {
        ...
        //
        // Testing:
        //   void btes_LeakyBucket::getStatistics(smtUnits, unusedUnits) const;
        // --------------------------------------------------------------------
...
// ---- ----- ----- ------ ---- -------  ------ --------  ------- ----- -------
   ...
   for (int ti = 0; ti < NUM_DATA; ++ti) {
      ...
      case 4: {
        ...
        //
        // Testing:
        //   btes_LeakyBucket(drainRate, window, currentTime);
        //---------------------------------------------------------------------
