...
#define INCLUDED_BTESC_CBCHANNEL
...
//
//@CLASSES:
// btesc_CbChannel: non-blocking stream-based channel protocol
//
//@SEE_ALSO: btesc_timedcbchannel, btesc_channel, btemc_cbchannel
//
...
///Protocol Hierarchy
///------------------
// 'btesc_CbChannel' forms the base of an interface hierarchy; other interfaces
...
//     }
//
//     void myWritevAndPrintStatusWhenAvailable(btesc_CbChannel *channel)
...
//
//         // Create a functor.
//         btesc_CbChannel::WriteCallback functor(
//          bdef_BindUtil::bind(&myPrintWriteStatus, _1, _2, TOTAL_NUM_BYTES));
//
...
// available to read and write data from and to a 'btesc_CbChannel'; note that,
...
//
//          // Create a functor.
//          btesc_CbChannel::BufferedReadCallback functor(&myPrintTick);
...
//  }
//
//  void myPrintTickWhenAvailable(btesc_CbChannel *channel)
...
class btesc_CbChannel {
  ...
  private:
    btesc_CbChannel& operator=(const btesc_CbChannel&); // not impl.
