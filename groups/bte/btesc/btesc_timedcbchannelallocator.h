// btesc_timedcbchannelallocator.h       -*-C++-*-
#ifndef INCLUDED_BTESC_TIMEDCBCHANNELALLOCATOR
#define INCLUDED_BTESC_TIMEDCBCHANNELALLOCATOR
...
//
//@CLASSES:
// btesc_TimedCbChannelAllocator: non-blocking channel allocator with timeout
//
//@SEE_ALSO: btesc_timedchannelallocator btemc_timedcbchannelallocator
//
...
// 'btesc_TimedCbChannelAllocator' protocol is as follows:
//..
//                  ,-----------------------------.
...
// illustrate the use of the 'btesc_TimedChannelAllocator' and does not
...
// server using just the 'btesc_TimedCbChannelAllocator' and
// 'btesc_TimedCbChannel' protocols.  In this implementation the "allocate"
...
//                  bdef_BindUtil::bind(&my_TickReporter::readCb,
//                                      this,
//                                      _1, _2, _3,
//                                      clientChannel));
//
...
//                      bdef_BindUtil::bind(&my_TickReporter::timeCb,
//                                          this,
//                                          0,
//                                          &curNumTicks,
//                                          now));
...
//      d_allocFunctor = bdef_BindUtil::bind(&my_TickReporter::acceptCb,
//                                           this,
//                                           timeout));
//
...
//                      bdef_BindUtil::bind(&my_TickerplantSimulator::writeCb,
//                                          this,
//                                          _1, _2,
//                                          serverChannel,
//                                          msgSize,
...
//          if (1 == curNumTicks) {
//              bdef_Function<void (*)()> timerFunctor(
//                      bdef_BindUtil::bind(&my_TickerplantSimulator::timeCb,
//                                          this,
//                                          0,
//                                          &curNumTicks,
//                                          maxTicks,
...
//      assert(0 < inputSize);
//
//      d_allocateFunctor = bdef_BindUtil::bind(
...
class btesc_TimedCbChannelAllocator
// : public btesc_CbChannelAllocator                // TBD: later
{
  ...
  private:
    btesc_TimedCbChannelAllocator&
        operator=(const btesc_TimedCbChannelAllocator&); // not implemented
  ...
  public:
    ...
    // CREATORS
    virtual ~btesc_TimedCbChannelAllocator();
