...
//..
      ...
      case 1: {
        ...
        //
        // Concerns:
        //   That BOS_VERSION corresponds to the three components,
        //   BOS_VERSION_MAJOR, BOS_VERSION_MINOR, and BOS_VERSION_PATCH.
        //
        // Plan:
        //   Decompose BOS_VERSION into its three components and verify
        ...
        int major = (BOS_VERSION / 10000) % 100;
        int minor = (BOS_VERSION / 100) % 100;
        int patch = BOS_VERSION % 100;

        (void)patch;

        ASSERT(BOS_VERSION_MAJOR == major);
        ASSERT(BOS_VERSION_MINOR == minor);
