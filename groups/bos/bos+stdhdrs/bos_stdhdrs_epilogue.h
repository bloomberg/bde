// bos_stdhdrs_epilogue.h                                             -*-C++-*-

//@PURPOSE: Provide final declarations for each C++ standard header file.
//
//@SEE_ALSO: bos_stdhdrs_prologue, bos_stdhdrs_epilogue_recursive
//
...
// types.  The inclusion of this file at the end of a 'bos+stdhdrs' header must
// be paired with the inclusion of 'bos_stdhdrs_prologue.h' at the start of the
// same header.
//
...
// header.  'bos_stdhdrs_epilogue_recursive.h' is the implementation of the
...
#define USE_BOS_STDHDRS_EPILOGUE_RECURSIVE
#include <bos_stdhdrs_epilogue_recursive.h>
#undef USE_BOS_STDHDRS_EPILOGUE_RECURSIVE
...
# define std bsl
# define BOS_STDHDRS_DEFINED_STD_MACRO
#endif

#undef BOS_STDHDRS_PROLOGUE_IN_EFFECT
#undef BOS_STDHDRS_RUN_EPILOGUE
