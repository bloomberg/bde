...
/*
// Note that 'wchar.h' is meant for multiple inclusion on Linux, so only the
...
#   define BOS_STDHDRS_EPILOGUE_RUN_BY_c_wchar
#   endif
#   include <bos_stdhdrs_incpaths.h>
...
#   ifdef BOS_STDHDRS_EPILOGUE_RUN_BY_c_wchar
#   undef BOS_STDHDRS_EPILOGUE_RUN_BY_c_wchar
