...
// header must be paired with the inclusion of 'bos_stdhdrs_epilogue.h' at the
// end of the same header.  See 'bos+stdhdrs.txt' for an overview of the
...
#ifdef BOS_STDHDRS_PROLOGUE_IN_EFFECT
# error "Prologue was included while still in effect"
#endif

#define BOS_STDHDRS_PROLOGUE_IN_EFFECT

#ifdef BOS_STDHDRS_DEFINED_STD_MACRO
# undef std
# undef BOS_STDHDRS_DEFINED_STD_MACRO
#elif defined(std)
# error "A macro for 'std' should not be '#define'd outside of 'bos+stdhdrs'."
#endif

// The rest of this file is intended to be included only once and is thus
// protected by include guards.
#ifndef INCLUDED_BOS_STDHDRS_PROLOGUE
#define INCLUDED_BOS_STDHDRS_PROLOGUE
...
namespace bsl {
    ...
    // Other 'std' symbols are imported by files in the 'bos+bslhdrs' package.
...
#endif // INCLUDED_BOS_STDHDRS_PROLOGUE
