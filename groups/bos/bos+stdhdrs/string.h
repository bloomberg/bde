...
/*
// Note that 'string.h' might be meant for multiple inclusion on some
...
#   define BOS_STDHDRS_EPILOGUE_RUN_BY_c_string
#   endif
#   include <bos_stdhdrs_incpaths.h>
...
#   ifdef BOS_STDHDRS_EPILOGUE_RUN_BY_c_string
#   undef BOS_STDHDRS_EPILOGUE_RUN_BY_c_string
