/* setjmp.h                                                          -*-C-*- */
#ifndef INCLUDED_NATIVE_C_SETJMP
#define INCLUDED_NATIVE_C_SETJMP
...
#   define BOS_STDHDRS_EPILOGUE_RUN_BY_c_setjmp
#   endif
#   include <bos_stdhdrs_incpaths.h>
...
#   ifdef BOS_STDHDRS_EPILOGUE_RUN_BY_c_setjmp
#   undef BOS_STDHDRS_EPILOGUE_RUN_BY_c_setjmp
