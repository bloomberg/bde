/* bos_stdhdrs_incpaths.h                                            -*-C-*- */
#ifndef INCLUDED_BOS_STDHDRS_INCPATHS
#define INCLUDED_BOS_STDHDRS_INCPATHS
...
// components in the bos package group.  The stability of this interface is not
// guaranteed.
//
...
// 'bos+stdhdrs' package.  The actual paths are hard coded to be platform
// specific.
//
...
///Usage
///-----
// The 'bos+stdhdrs' package provides low-level system facilities, including a
...
// the 'bos+stdhdrs' package.  Sometimes, however, it is necessary to force
...
// Note that 'bosscm_version.h' is not included here because it pulls in c++
...
#endif // ! defined(INCLUDED_BOS_STDHDRS_INCPATHS)
