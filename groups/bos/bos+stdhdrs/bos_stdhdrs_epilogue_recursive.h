// bos_stdhdrs_epilogue_recursive.h                                   -*-C++-*-

//@PURPOSE: Provide corresponding bslstl definitions for C++ standard headers.
//
//@SEE_ALSO: bos_stdhdrs_epilogue, bos+stdhdrs.txt
//
//@DESCRIPTION: This header is the recursive part of the implementation of
// 'bos_stdhdrs_epilogue.h'.  Its purpose is to include appropriate 'bslstp'
...
// 'INCLUDE_BOS_STDHDRS_EPILOGUE_RECURSIVE' which indicates that this recursive
...
// processed, 'INCLUDE_BOS_STDHDRS_EPILOGUE_RECURSIVE' will not be defined,
...
// Prevent accidental inclusion from anywhere but 'bos_stdhdrs_epilogue.h'.
#if !defined(USE_BOS_STDHDRS_EPILOGUE_RECURSIVE)
#error "this header can only be included from bos_stdhdrs_epilogue.h"
#endif

// 'INCLUDE_BOS_STDHDRS_EPILOGUE_RECURSIVE' controls the recursive inclusion,
// so it should not be leaked outside of this header.  Doing so may cause an
// infinite recursive inclusion.
#if defined(INCLUDE_BOS_STDHDRS_EPILOGUE_RECURSIVE)
...
// Now include those 'bslstl' components corresponding to the 'bos+stdhdrs'
...
#if defined(INCLUDE_BOS_STDHDRS_EPILOGUE_RECURSIVE)
# undef INCLUDE_BOS_STDHDRS_EPILOGUE_RECURSIVE
# include <bos_stdhdrs_epilogue_recursive.h>
#endif
