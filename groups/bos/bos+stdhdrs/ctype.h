...
/*
// Note that 'ctype.h' might be meant for multiple inclusion on some platforms,
// so only the ident is protected by the include guard.
*/
...
#   else
#     include BSL_NATIVE_OS_RTL_HEADER(ctype.h)
#   endif
...
#   define BOS_STDHDRS_EPILOGUE_RUN_BY_c_ctype
#   endif
#   include <bos_stdhdrs_incpaths.h>
...
#   ifdef BOS_STDHDRS_EPILOGUE_RUN_BY_c_ctype
#   undef BOS_STDHDRS_EPILOGUE_RUN_BY_c_ctype
