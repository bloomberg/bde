...
#   else
#     include BSL_NATIVE_C_LIB_HEADER(sys/time.h)
#   endif
...
#   define BOS_STDHDRS_EPILOGUE_RUN_BY_c_sys_time
#   endif
...
#   ifdef BOS_STDHDRS_EPILOGUE_RUN_BY_c_sys_time
#   undef BOS_STDHDRS_EPILOGUE_RUN_BY_c_sys_time
