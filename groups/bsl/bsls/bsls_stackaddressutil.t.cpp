    ...
    switch (mode) {
      case e_CAPTURE_ADDRESSES: {
        ...
        if (0 == idMod) {
            ...
            //  - (possibly) an ignored frame
            //  - `&topOfTheStack` + off
            //  - `&recurseABunchOfTimes` + off of call to `topOfTheStack`
            //  - many identical instances of `&recurseABunchOfTimes` recurse
            //  - `loopForEightSeconds` + off
