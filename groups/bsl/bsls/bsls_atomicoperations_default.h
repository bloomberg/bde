...
//
//@CLASSES:
//  bsls_AtomicOperations_DefaultInt: defaults for atomic operations on int
//  bsls_AtomicOperations_DefaultInt64: defaults for Int64
//  bsls_AtomicOperations_DefaultPointer32: defaults for 32-bit pointer
//  bsls_AtomicOperations_DefaultPointer64: defaults for 64-bit pointer
//  bsls_AtomicOperations_Default32: all atomics for a generic 32-bit platform
//  bsls_AtomicOperations_Default64: all atomics for a generic 64-bit platform
//
...
// classes:
//: o bsls_AtomicOperations_DefaultInt - provides atomic operations for int
//: o bsls_AtomicOperations_DefaultInt64 - for Int64
//: o bsls_AtomicOperations_DefaultPointer32 - for 32-bit pointer
//: o bsls_AtomicOperations_DefaultPointer64 - for 64-bit pointer
//
...
//
//: o bsls_AtomicOperations_Default32 - a set of atomic operations for a
//:   generic 32-bit platform
//:
//: o bsls_AtomicOperations_Default64 - a set of atomic operations for a
//:   generic 64-bit platform
//
// This is how the generic platform base classes are composed:
//: o bsls_AtomicOperations_Default32 : public bsls_AtomicOperations_DefaultInt
//:                                   , bsls_AtomicOperations_DefaultInt64
//:                                   , bsls_AtomicOperations_DefaultPointer32
//: o bsls_AtomicOperations_Default64 : public bsls_AtomicOperations_DefaultInt
//:                                   , bsls_AtomicOperations_DefaultInt64
//:                                   , bsls_AtomicOperations_DefaultPointer64
//
// A typical derived class implementing platform-specific atomic operations
// needs to derive from either 'bsls_AtomicOperations_Default32' (if the
// platform is 32-bit) or 'bsls_AtomicOperations_Default64' (if the platform is
// 64-bit).
//
// For example, let's take the X86_64 platform with GCC compiler.  The derived
// class for this platform, 'bsls_AtomicOperations_X64_ALL_GCC', inherits from
// 'bsls_AtomicOperations_Default64' and implements all platform-specific
// atomic operations:
//..
//  struct bsls_AtomicOperations_X64_ALL_GCC
//      : bsls_AtomicOperations_Default64<bsls_AtomicOperations_X64_ALL_GCC>
//  {
//      typedef bsls_Atomic_TypeTraits<bsls_AtomicOperations_X64_ALL_GCC>
//          Types;   // for explanation of atomic type traits see below
//
...
// base class.  For example, 'bsls_AtomicOperations_X64_ALL_GCC' can provide a
// better implementation for 'getIntAcquire' than the one provided by the
// 'bsls_AtomicOperations_DefaultInt' base class.  So
// 'bsls_AtomicOperations_X64_ALL_GCC' implements its own 'getIntAcquire' with
...
// atomic operations (the bsls_AtomicOperations_ prefix is omitted for
// brevity):
//..
...
// platform defined by the 'bsls_AtomicOperations_X64_ALL_GCC' class might look
// like:
//..
//  template <>
...
namespace BloombergLP {
                   ...
                   // =======================================
                   // struct bsls_AtomicOperations_DefaultInt
                   // =======================================
    ...
    // 32-bit integer type.
{
  ...
  public:
    // CLASS METHODS
    static void initInt(typename Types::Int *atomicInt, int initialValue = 0);

    static int getIntRelaxed(typename Types::Int const *atomicInt);

    static int getIntAcquire(typename Types::Int const *atomicInt);

    static void setIntRelaxed(typename Types::Int *atomicInt, int value);
    ...
    static void addInt(typename Types::Int *atomicInt, int value);

    static void addIntRelaxed(typename Types::Int *atomicInt, int value);

    static void addIntAcqRel(typename Types::Int *atomicInt, int value);

    static int incrementIntNv(typename Types::Int *atomicInt);

    static int incrementIntNvAcqRel(typename Types::Int *atomicInt);

    static void incrementInt(typename Types::Int *atomicInt);

    static void incrementIntAcqRel(typename Types::Int *atomicInt);

    static int decrementIntNv(typename Types::Int *atomicInt);

    static int decrementIntNvAcqRel(typename Types::Int *atomicInt);

    static void decrementInt(typename Types::Int *atomicInt);

    static void decrementIntAcqRel(typename Types::Int *atomicInt);
};

                  // =========================================
                  // struct bsls_AtomicOperations_DefaultInt64
                  // =========================================
    ...
    // 64-bit integer type.
{
  ...
  private:
    ...
    // NOT IMPLEMENTED
    static bsls_Types::Int64 getInt64(typename Types::Int64 const *atomicInt);

    static void setInt64(typename Types::Int64 *atomicInt,
                         bsls_Types::Int64      value);

    static bsls_Types::Int64 swapInt64(typename Types::Int64 *atomicInt,
                                       bsls_Types::Int64      swapValue);

    static bsls_Types::Int64 testAndSwapInt64(
                                      typename Types::Int64 *atomicInt,
                                      bsls_Types::Int64      compareValue,
                                      bsls_Types::Int64      swapValue);

    static bsls_Types::Int64 addInt64Nv(typename Types::Int64 *atomicInt,
                                        bsls_Types::Int64      value);

  public:
    // CLASS METHODS
    static void initInt64(typename Types::Int64  *atomicInt,
                          bsls_Types::Int64       initialValue = 0);

    static bsls_Types::Int64 getInt64Relaxed(
                                       typename Types::Int64 const *atomicInt);

    static bsls_Types::Int64 getInt64Acquire(
                                       typename Types::Int64 const *atomicInt);

    static void setInt64Relaxed(typename Types::Int64 *atomicInt,
                                bsls_Types::Int64      value);

    static void setInt64Release(typename Types::Int64 *atomicInt,
                                bsls_Types::Int64      value);

    static bsls_Types::Int64 swapInt64AcqRel(typename Types::Int64 *atomicInt,
                                             bsls_Types::Int64      swapValue);
    ...
    static void addInt64(typename Types::Int64 *atomicInt,
                         bsls_Types::Int64      value);

    static void addInt64Relaxed(typename Types::Int64 *atomicInt,
                                bsls_Types::Int64      value);

    static void addInt64AcqRel(typename Types::Int64 *atomicInt,
                               bsls_Types::Int64      value);

    static void incrementInt64(typename Types::Int64 *atomicInt);

    static void incrementInt64AcqRel(typename Types::Int64 *atomicInt);
    ...
    static void decrementInt64(typename Types::Int64 *atomicInt);

    static void decrementInt64AcqRel(typename Types::Int64 *atomicInt);
    ...
    static bsls_Types::Int64 decrementInt64NvAcqRel(
                ...
                // =============================================
                // struct bsls_AtomicOperations_DefaultPointer32
                // =============================================
...
struct bsls_AtomicOperations_DefaultPointer32
    ...
    // operations together form a full set of atomic operations for the pointer
    // type.
    //
    // Note that 'bsls_AtomicOperations_DefaultPointer32' is implemented in
    ...
    //  static void setIntRelease(typename Types::Int *atomicInt, int value);
    //  static int swapInt(typename Types::Int *atomicInt, int swapValue);
    //  static int swapIntAcqRel(typename Types::Int *atomicInt,
    //                           int                  swapValue);
    //  static int testAndSwapInt(typename Types::Int *atomicInt,
    //                            int                  compareValue,
    //                            int                  swapValue);
    ...
    //..
{
    ...
    // CLASS METHODS
    static void initPointer(typename Types::Pointer *atomicPtr,
                            const void              *initialValue = 0);

    static const void *getPtr(typename Types::Pointer const *atomicPtr);

    static const void *getPtrRelaxed(typename Types::Pointer const *atomicPtr);

    static const void *getPtrAcquire(typename Types::Pointer const *atomicPtr);

    static void setPtr(typename Types::Pointer *atomicPtr,
                       const void              *value);

    static void setPtrRelaxed(typename Types::Pointer *atomicPtr,
                              const void              *value);

    static void setPtrRelease(typename Types::Pointer *atomicPtr,
                              const void              *value);

    static void *swapPtr(typename Types::Pointer *atomicPtr,
                         const void              *swapValue);

    static void *swapPtrAcqRel(typename Types::Pointer *atomicPtr,
                               const void              *swapValue);

    static void *testAndSwapPtr(typename Types::Pointer   *atomicPtr,
                                const void                *compareValue,
                                const void                *swapValue);

    static void *testAndSwapPtrAcqRel(typename Types::Pointer *atomicPtr,
                                      const void              *compareValue,
                                      const void              *swapValue);
};

                // =============================================
                // struct bsls_AtomicOperations_DefaultPointer64
                // =============================================
...
struct bsls_AtomicOperations_DefaultPointer64
    ...
    //  static bsls_Types::Int64 swapInt64(typename Types::Int64 *atomicInt,
    //                                     bsls_Types::Int64      swapValue);
    //  static bsls_Types::Int64 swapInt64AcqRel(
    //                                    typename Types::Int64 *atomicInt,
    //                                    bsls_Types::Int64      swapValue);
    //  static bsls_Types::Int64 testAndSwapInt64(
    //                                    typename Types::Int64 *atomicInt,
    ...
    //..
{
    ...
    static void *testAndSwapPtrAcqRel(typename Types::Pointer *atomicPtr,
                   ...
                   // ======================================
                   // struct bsls_AtomicOperations_Default32
                   // ======================================
    ...
    // type for a generic 32-bit platform.
{
                   ...
                   // ======================================
                   // struct bsls_AtomicOperations_Default64
                   // ======================================
...
template <typename IMP>
inline
void bsls_AtomicOperations_DefaultInt<IMP>::
    initInt(typename Types::Int *atomicInt, int initialValue)
{
...
template <typename IMP>
inline
int bsls_AtomicOperations_DefaultInt<IMP>::
    getIntRelaxed(typename Types::Int const *atomicInt)
{
...
inline
void bsls_AtomicOperations_DefaultInt<IMP>::
    setIntRelaxed(typename Types::Int *atomicInt, int value)
{
...
inline
void bsls_AtomicOperations_DefaultInt<IMP>::
    addInt(typename Types::Int *atomicInt, int value)
{
...
inline
void bsls_AtomicOperations_DefaultInt<IMP>::
    addIntRelaxed(typename Types::Int *atomicInt, int value)
{
...
inline
void bsls_AtomicOperations_DefaultInt<IMP>::
    addIntAcqRel(typename Types::Int *atomicInt, int value)
{
...
inline
int bsls_AtomicOperations_DefaultInt<IMP>::
    incrementIntNv(typename Types::Int *atomicInt)
{
...
inline
int bsls_AtomicOperations_DefaultInt<IMP>::
    incrementIntNvAcqRel(typename Types::Int *atomicInt)
{
...
inline
void bsls_AtomicOperations_DefaultInt<IMP>::
    incrementInt(typename Types::Int *atomicInt)
{
...
inline
void bsls_AtomicOperations_DefaultInt<IMP>::
    incrementIntAcqRel(typename Types::Int *atomicInt)
{
...
inline
int bsls_AtomicOperations_DefaultInt<IMP>::
    decrementIntNv(typename Types::Int *atomicInt)
{
    return IMP::addIntNv(atomicInt, -1);
}
...
inline
int bsls_AtomicOperations_DefaultInt<IMP>::
    decrementIntNvAcqRel(typename Types::Int *atomicInt)
{
    return IMP::addIntNvAcqRel(atomicInt, -1);
}
...
inline
void bsls_AtomicOperations_DefaultInt<IMP>::
    decrementInt(typename Types::Int *atomicInt)
{
    IMP::addInt(atomicInt, -1);
}
...
inline
void bsls_AtomicOperations_DefaultInt<IMP>::
    decrementIntAcqRel(typename Types::Int *atomicInt)
{
    IMP::addIntAcqRel(atomicInt, -1);
}
...
template <typename IMP>
inline
void bsls_AtomicOperations_DefaultInt64<IMP>::
    initInt64(typename Types::Int64  *atomicInt,
...
template <typename IMP>
inline
bsls_Types::Int64 bsls_AtomicOperations_DefaultInt64<IMP>::
    getInt64Relaxed(typename Types::Int64 const *atomicInt)
{
    return atomicInt->d_value;
}
...
inline
bsls_Types::Int64 bsls_AtomicOperations_DefaultInt64<IMP>::
                        getInt64Acquire(typename Types::Int64 const *atomicInt)
{
...
inline
void bsls_AtomicOperations_DefaultInt64<IMP>::
    setInt64Relaxed(typename Types::Int64 *atomicInt,
                    bsls_Types::Int64      value)
{
    atomicInt->d_value = value;
}
...
inline
void bsls_AtomicOperations_DefaultInt64<IMP>::
    setInt64Release(typename Types::Int64 *atomicInt,
                    bsls_Types::Int64      value)
{
...
inline
bsls_Types::Int64 bsls_AtomicOperations_DefaultInt64<IMP>::
    swapInt64AcqRel(typename Types::Int64 *atomicInt,
                    bsls_Types::Int64      swapValue)
{
...
inline
bsls_Types::Int64 bsls_AtomicOperations_DefaultInt64<IMP>::
    testAndSwapInt64AcqRel(typename Types::Int64 *atomicInt,
                           bsls_Types::Int64      compareValue,
                           bsls_Types::Int64      swapValue)
{
...
inline
bsls_Types::Int64 bsls_AtomicOperations_DefaultInt64<IMP>::
    addInt64NvRelaxed(typename Types::Int64 *atomicInt,
                      bsls_Types::Int64      value)
{
...
inline
bsls_Types::Int64 bsls_AtomicOperations_DefaultInt64<IMP>::
    addInt64NvAcqRel(typename Types::Int64 *atomicInt,
                     bsls_Types::Int64      value)
{
...
inline
void bsls_AtomicOperations_DefaultInt64<IMP>::
    addInt64(typename Types::Int64 *atomicInt,
             bsls_Types::Int64      value)
{
...
inline
void bsls_AtomicOperations_DefaultInt64<IMP>::
    addInt64Relaxed(typename Types::Int64 *atomicInt,
                    bsls_Types::Int64      value)
{
...
inline
void bsls_AtomicOperations_DefaultInt64<IMP>::
    addInt64AcqRel(typename Types::Int64 *atomicInt,
                   bsls_Types::Int64      value)
{
...
inline
void bsls_AtomicOperations_DefaultInt64<IMP>::
    incrementInt64(typename Types::Int64 *atomicInt)
{
...
inline
void bsls_AtomicOperations_DefaultInt64<IMP>::
    incrementInt64AcqRel(typename Types::Int64 *atomicInt)
{
...
inline
bsls_Types::Int64 bsls_AtomicOperations_DefaultInt64<IMP>::
    incrementInt64Nv(typename Types::Int64 *atomicInt)
{
...
inline
bsls_Types::Int64 bsls_AtomicOperations_DefaultInt64<IMP>::
    incrementInt64NvAcqRel(typename Types::Int64 *atomicInt)
{
...
inline
void bsls_AtomicOperations_DefaultInt64<IMP>::
    decrementInt64(typename Types::Int64 *atomicInt)
{
    IMP::addInt64(atomicInt, -1);
}
...
inline
void bsls_AtomicOperations_DefaultInt64<IMP>::
    decrementInt64AcqRel(typename Types::Int64 *atomicInt)
{
    IMP::addInt64AcqRel(atomicInt, -1);
}
...
inline
bsls_Types::Int64 bsls_AtomicOperations_DefaultInt64<IMP>::
    decrementInt64Nv(typename Types::Int64 *atomicInt)
{
    return IMP::addInt64Nv(atomicInt, -1);
}
...
inline
bsls_Types::Int64 bsls_AtomicOperations_DefaultInt64<IMP>::
    decrementInt64NvAcqRel(typename Types::Int64 *atomicInt)
{
    return IMP::addInt64NvAcqRel(atomicInt, -1);
}
...
template <typename IMP>
inline
void bsls_AtomicOperations_DefaultPointer32<IMP>::
    initPointer(typename Types::Pointer *atomicPtr,
...
template <typename IMP>
inline
const void *bsls_AtomicOperations_DefaultPointer32<IMP>::
    getPtr(typename Types::Pointer const *atomicPtr)
{
    return reinterpret_cast<const void *>(
             IMP::getInt(
                reinterpret_cast<typename Types::Int const *>(
                    atomicPtr)));
}
...
inline
const void *bsls_AtomicOperations_DefaultPointer32<IMP>::
    getPtrRelaxed(typename Types::Pointer const *atomicPtr)
{
    return reinterpret_cast<const void *>(
             IMP::getIntRelaxed(
                reinterpret_cast<typename Types::Int const *>(
...
inline
const void *bsls_AtomicOperations_DefaultPointer32<IMP>::
    getPtrAcquire(typename Types::Pointer const *atomicPtr)
{
    return reinterpret_cast<const void *>(
             IMP::getIntAcquire(
                reinterpret_cast<typename Types::Int const *>(
...
inline
void bsls_AtomicOperations_DefaultPointer32<IMP>::
    setPtr(typename Types::Pointer *atomicPtr,
           const void              *value)
{
    IMP::setInt(
        reinterpret_cast<typename Types::Int *>(atomicPtr),
...
inline
void bsls_AtomicOperations_DefaultPointer32<IMP>::
    setPtrRelaxed(typename Types::Pointer *atomicPtr,
                  const void              *value)
{
    IMP::setIntRelaxed(
        reinterpret_cast<typename Types::Int *>(atomicPtr),
...
inline
void bsls_AtomicOperations_DefaultPointer32<IMP>::
    setPtrRelease(typename Types::Pointer *atomicPtr,
                  const void              *value)
{
    IMP::setIntRelease(
        reinterpret_cast<typename Types::Int *>(atomicPtr),
...
inline
void *bsls_AtomicOperations_DefaultPointer32<IMP>::
    swapPtr(typename Types::Pointer *atomicPtr,
            const void              *swapValue)
{
...
inline
void *bsls_AtomicOperations_DefaultPointer32<IMP>::
    swapPtrAcqRel(typename Types::Pointer *atomicPtr,
                  const void              *swapValue)
{
    return reinterpret_cast<void *>(
            IMP::swapIntAcqRel(
...
inline
void *bsls_AtomicOperations_DefaultPointer32<IMP>::
    testAndSwapPtr(typename Types::Pointer   *atomicPtr,
                   const void                *compareValue,
                   const void                *swapValue)
{
    return reinterpret_cast<void *>(
...
inline
void *bsls_AtomicOperations_DefaultPointer32<IMP>::
    testAndSwapPtrAcqRel(typename Types::Pointer *atomicPtr,
                         const void              *compareValue,
                         const void              *swapValue)
{
    return reinterpret_cast<void *>(
...
template <typename IMP>
inline
void bsls_AtomicOperations_DefaultPointer64<IMP>::
    initPointer(typename Types::Pointer *atomicPtr,
                const void              *initialValue)
{
    atomicPtr->d_value = initialValue;
...
template <typename IMP>
inline
const void *bsls_AtomicOperations_DefaultPointer64<IMP>::
    getPtr(typename Types::Pointer const *atomicPtr)
{
    return reinterpret_cast<const void *>(
             IMP::getInt64(
                reinterpret_cast<typename Types::Int64 const *>(
                    atomicPtr)));
}
...
{
    IMP::setInt64(
        reinterpret_cast<typename Types::Int64 *>(atomicPtr),
        reinterpret_cast<bsls_Types::Int64>(value));
}
            ...
            const void              *swapValue)
{
    return reinterpret_cast<void *>(
            IMP::swapInt64(
                reinterpret_cast<typename Types::Int64 *>(atomicPtr),
                reinterpret_cast<bsls_Types::Int64>(swapValue)));
}
                   ...
                   const void                *swapValue)
{
    return reinterpret_cast<void *>(
            IMP::testAndSwapInt64(
                reinterpret_cast<typename Types::Int64 *>(atomicPtr),
                reinterpret_cast<bsls_Types::Int64>(compareValue),
                reinterpret_cast<bsls_Types::Int64>(swapValue)));
}
