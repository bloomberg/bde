...
// ----------------------------------
//
// The following python script is used to generate the data in Section 2 of the DATA array 
//..
//  #!/usr/bin/env python
//
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 11: {
        ...
        struct TimerTestData {
			...
			,{ L_, 9223372036854775806, 6012954213, 4294967295, 2147483647099999999 }
			,{ L_, 9223372036854775807, 6012954213, 4294967295, 2147483647099999999 }
			...
			,{ L_, 9223372036854775806, 4189542000, 2992530000, 3082131852534555645 }
			,{ L_, 9223372036854775807, 4189542000, 2992530000, 3082131852534555645 }
			...
			,{ L_, 132345307563141280, 20088469, 14348907, 9223372034054775809 }
			,{ L_, 132345307563141281, 20088469, 14348907, 9223372034054775879 }
			...
			,{ L_, 132345316786513315, 20088471, 14348908, 9223372034054775736 }
			,{ L_, 132345316786513316, 20088471, 14348908, 9223372034054775805 }
			...
			,{ L_, 132345298339769244, 20088468, 14348906, 9223372034054775743 }
			,{ L_, 132345298339769245, 20088468, 14348906, 9223372034054775813 }
			...
			,{ L_, 397035922689423841, 60265409, 43046721, 9223372034054775786 }
			,{ L_, 397035922689423842, 60265409, 43046721, 9223372034054775809 }
			...
			,{ L_, 397035931912795877, 60265410, 43046722, 9223372034054775808 }
			,{ L_, 397035931912795878, 60265410, 43046722, 9223372034054775831 }
			...
			,{ L_, 397035913466051805, 60265408, 43046720, 9223372034054775764 }
			,{ L_, 397035913466051806, 60265408, 43046720, 9223372034054775787 }
			...
			,{ L_, 1191107768068271526, 180796228, 129140163, 9223372034054775802 }
			,{ L_, 1191107768068271527, 180796228, 129140163, 9223372034054775809 }
			...
			,{ L_, 1191107777291643561, 180796229, 129140164, 9223372034054775801 }
			,{ L_, 1191107777291643562, 180796229, 129140164, 9223372034054775809 }
			...
			,{ L_, 1191107758844899491, 180796226, 129140162, 9223372034054775810 }
			,{ L_, 1191107758844899492, 180796226, 129140162, 9223372034054775817 }
			...
			,{ L_, 3573323304204814580, 542388684, 387420489, 9223372034054775807 }
			,{ L_, 3573323304204814581, 542388684, 387420489, 9223372034054775809 }
			...
			,{ L_, 3573323313428186614, 542388686, 387420490, 9223372034054775801 }
			,{ L_, 3573323313428186615, 542388686, 387420490, 9223372034054775804 }
			...
			,{ L_, 3573323294981442544, 542388683, 387420488, 9223372034054775804 }
			,{ L_, 3573323294981442545, 542388683, 387420488, 9223372034054775807 }
			...
			,{ L_, 9223372036854775806, 1627166053, 1162261467, 7935711797307317728 }
			,{ L_, 9223372036854775807, 1627166053, 1162261467, 7935711797307317729 }
			...
			,{ L_, 9223372036854775806, 1627166055, 1162261468, 7935711790479497984 }
			,{ L_, 9223372036854775807, 1627166055, 1162261468, 7935711790479497985 }
			...
			,{ L_, 9223372036854775806, 1627166052, 1162261466, 7935711804135137483 }
			,{ L_, 9223372036854775807, 1627166052, 1162261466, 7935711804135137484 }
			// Frequency: 3486784401, Initial Time: 4881498161
			,{ L_, 9223372036854775806, 4881498161, 3486784401, 2645237264835772576 }
			,{ L_, 9223372036854775807, 4881498161, 3486784401, 2645237264835772576 }
			// Frequency: 3486784402, Initial Time: 4881498162
			,{ L_, 9223372036854775806, 4881498162, 3486784402, 2645237264077125937 }
			,{ L_, 9223372036854775807, 4881498162, 3486784402, 2645237264077125937 }
			// Frequency: 3486784400, Initial Time: 4881498160
			,{ L_, 9223372036854775806, 4881498160, 3486784400, 2645237265594419215 }
			,{ L_, 9223372036854775807, 4881498160, 3486784400, 2645237265594419215 }
...

        {
            ...
            for (int si = 0; si < NUM_DATA; ++si) {
				...
				if (veryVerbose) {
					T_(); P_(LINE); P_(INPUT); P_(INITIAL_TIME); P_(FREQUENCY); P(OUTPUT)
				}
...

        {
            ...
            for (int exponent = 0; exponent < 60; ++exponent) {
				...
				if (veryVerbose) {
					T_(); P_(exponent); P_(startTime.d_opaque); P(endTime.d_opaque);
				}
...

        {
			...
			for (int bits = 0; bits < 64 && (bits == 0 || (bsls::Types::Int64) getBitMask(bits - 1) < testPeriod); ++bits) {
				...
				for (int iterations = 0; iterations < NUM_TESTS && iterations < 1 << bits; ++iterations) {
