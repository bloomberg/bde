...
//
// CLASS METHODS
// [ 1] const char *toAscii(LogSeverity::Enum val);
// ----------------------------------------------------------------------------
// [ 2] USAGE EXAMPLE
// ----------------------------------------------------------------------------
...
typedef bsls::LogSeverity::Enum Enum;
typedef bsls::LogSeverity       Obj;
...
//..
      ...
      case 1: {
        ...
        // Testing:
        //   enum Enum { ... };
        //   const char *toAscii(LogSeverity::Enum val);
        // -------------------------------------------------------------------
        ...
        static const struct {
            ...
            // ----    -----------------------      -----------------
            {  L_,     Obj::e_FATAL,                "FATAL"           },
            {  L_,     Obj::e_ERROR,                "ERROR"           },
            {  L_,     Obj::e_WARN,                 "WARN"            },
            {  L_,     Obj::e_INFO,                 "INFO"            },
