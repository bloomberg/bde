...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:
      ...
      case 2: {
        // --------------------------------------------------------------------
        // TESTING bsls_UnspecifiedBool<TYPE>::BoolType
        //:    1 Initialization
        ...
        //:   the literal '0' should produce the value 'false' when converted
        //:   to a boolean value.
        //:
        ...
        //:   in each context where the language supports an implicit
        //:   conversion to a boolean type.  (C1)
        //:
