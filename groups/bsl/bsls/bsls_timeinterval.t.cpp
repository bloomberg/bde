...
#define NL "\n"
        ...
        { L_,  0,  0,      0,      0,  "(0s, 0ns)"              NL },
        { L_,  0,  1,      0,      0,  "(0s, 0ns)"              NL },
        { L_,  0, -1,      0,      0,  "(0s, 0ns)"                 },
        { L_,  0,  4,      0,      0,  "(0s, 0ns)"              NL },
        ...
        //LINE L SPL       S       Ns   EXP
        //---- - ---       -       --   ---
        { L_,  3,  0,      0,      0,  "(0s, 0ns)"              NL },
        { L_,  3,  2,      0,      0,  "      (0s, 0ns)"        NL },
        { L_,  3, -2,      0,      0,  "      (0s, 0ns)"           },
        { L_,  3,  4,      0,      0,  "            (0s, 0ns)"  NL },
        { L_, -3,  0,      0,      0,  "(0s, 0ns)"              NL },
        { L_, -3,  2,      0,      0,  "(0s, 0ns)"              NL },
        { L_, -3, -2,      0,      0,  "(0s, 0ns)"                 },
        { L_, -3,  4,      0,      0,  "(0s, 0ns)"              NL },
        ...
        //LINE L SPL       S       Ns   EXP
        //---- - ---       -       --   ---
        { L_,  2,  3,   -123,  -5000,  "      (-123s, -5000ns)" NL },
        ...
        //---- - ---       -       --   ---
        { L_,  0,  4,      0,      0,  "(0s, 0ns)"              NL },
        { L_,  0,  4,   -123,  -5000,  "(-123s, -5000ns)"       NL },
...
#undef NL
        ...
        if (verbose) printf("\nTesting 'operator<<' (ostream).\n");
        {
            static const struct {
                ...
                { L_,             0,        100, "(0s, 100ns)"                  },
                { L_,             0,       -100, "(0s, -100ns)"                 },
                { L_,          -123,      -5000, "(-123s, -5000ns)"             },
                { L_,  3000000000LL,  999999999, "(3000000000s, 999999999ns)"   },
                { L_, -3000000000LL, -999999999, "(-3000000000s, -999999999ns)" }
            };
