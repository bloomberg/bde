// bsls_bsllockimpl_pthread.t.cpp                                     -*-C++-*-
...
// 'bsls::BslLockImpl_pthread', are 'lock' and 'unlock'.
//
...
// order.
// ----------------------------------------------------------------------------
// [ 1] BslLockImpl_pthread::BslLockImpl_pthread();
// [ 1] BslLockImpl_pthread::~BslLockImpl_pthread();
// [ 1] void BslLockImpl_pthread::lock();
// [ 1] void BslLockImpl_pthread::unlock();
// ----------------------------------------------------------------------------
// [ 2] USAGE EXAMPLE
...
typedef bsls::BslLockImpl_pthread      Obj;
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 1: {
        // --------------------------------------------------------------------
        // BASIC TEST
        //   Ensure that 'BslLockImpl_pthread' works as expected.
        //
        // Concerns:
