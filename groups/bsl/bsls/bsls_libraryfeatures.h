...
// we include standard headers, our "intercept" headers (see 'bsl+stdhdrs'
// package) will ensure the proper inclusion.
...
#elif defined(__SGI_STL) || defined(_STLPORT_VERSION)
