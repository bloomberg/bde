...
#define BSLS_LIBRARYFEATURES_HAS_CPP98_AUTO_PTR
    ...
    // #define BSLS_LIBRARYFEATURES_HAS_CPP17_PRECISE_BITWIDTH_ATOMICS
        ...
        // First check for Apple Clang with it distinct version numbering:
...
//          #define BSLS_LIBRARYFEATURES_HAS_CPP17_PRECISE_BITWIDTH_ATOMICS
        #else
             // Otherwise, modern Clang compilers have broad C++11 support.
             // These macros are experimentally determined to be appropriate
             // after testing with the 3.9.1 compiler; there has been no effort
             // to establish when the different library features become
             // available through erlier versions libc++.
             #define BSLS_LIBRARYFEATURES_HAS_C99_LIBRARY
             #define BSLS_LIBRARYFEATURES_HAS_CPP11_BASELINE_LIBRARY
             #define BSLS_LIBRARYFEATURES_HAS_CPP11_EXCEPTION_HANDLING
             #define BSLS_LIBRARYFEATURES_HAS_CPP11_GARBAGE_COLLECTION_API
