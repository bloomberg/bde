// bslmf_invokeresult_cpp03.t.cpp                                     -*-C++-*-
...
// original.
//
// Generated on Thu Apr 15 17:44:14 2021
// Command line: sim_cpp11_features.pl bslmf_invokeresult.t.cpp
...
#if defined(BSLS_PLATFORM_CMP_GNU) && BSLS_PLATFORM_CMP_VERSION < 90000
...
template <class TP>
struct IsReferenceWrapper<bsl::reference_wrapper<TP> > : bsl::true_type {
};
...
#endif // !BSLMF_INVOKERESULT_ABRIDGED_TEST
    }
};
...
#ifdef GCC_PRE_CWG616_RESOLUTION_SEMANTICS
        typedef typename
            bsl::conditional<
...
///Implementation Note
///-------------------
// Traditional BDE-style test drivers place each test case as a literal 'case'
// inside of a 'switch' block-statement in 'main', which "switches" on the
// number of the test case.  Unfortunately, when these 'switch'
// block-statements get very large, some compilers have a hard time compiling
// the code, and can run out of resources.  So, this test driver departs from
// the BDE tradition, and implements each test case as a separate free
// function, because some compilers have had a hard time compiling this test
// driver in the past.  Notably, the IBM XL C++ compiler, with its default
// resource limits, often ran out of memory compiling this test driver prior to
// factoring out the test cases into free functions.

void testCase8(BSLA_MAYBE_UNUSED int  test,
...
void testCase7(BSLA_MAYBE_UNUSED int  test,
               BSLA_MAYBE_UNUSED bool verbose,
               BSLA_MAYBE_UNUSED bool veryVerbose,
               BSLA_MAYBE_UNUSED bool veryVeryVerbose,
               BSLA_MAYBE_UNUSED bool veryVeryVeryVerbose)
{
        ...
        typedef bsl::reference_wrapper<MyClass>                wM;
        typedef bsl::reference_wrapper<const MyClass>          wcM;
        typedef bsl::reference_wrapper<volatile MyClass>       wvM;
        typedef bsl::reference_wrapper<const volatile MyClass> wcvM;
...
void testCase6(BSLA_MAYBE_UNUSED int  test,
               BSLA_MAYBE_UNUSED bool verbose,
               BSLA_MAYBE_UNUSED bool veryVerbose,
               BSLA_MAYBE_UNUSED bool veryVeryVerbose,
               BSLA_MAYBE_UNUSED bool veryVeryVeryVerbose)
...
void testCase5(BSLA_MAYBE_UNUSED int  test,
               BSLA_MAYBE_UNUSED bool verbose,
               BSLA_MAYBE_UNUSED bool veryVerbose,
               BSLA_MAYBE_UNUSED bool veryVeryVerbose,
               BSLA_MAYBE_UNUSED bool veryVeryVeryVerbose)
...
void testCase4(BSLA_MAYBE_UNUSED int  test,
               BSLA_MAYBE_UNUSED bool verbose,
               BSLA_MAYBE_UNUSED bool veryVerbose,
               BSLA_MAYBE_UNUSED bool veryVeryVerbose,
               BSLA_MAYBE_UNUSED bool veryVeryVeryVerbose)
{
       ...
       applyPtrAndRef<PtrToMemObjTest<const SmartPtr<VMc>&, VMc&>, CVenum>(L_);
#if !BSLMF_INVOKERESULT_ABRIDGED_TEST
       ...
       applyPtrAndRef<PtrToMemObjTest<const MovePtr<VMc>&, VMc&&>, CVenum>(L_);
...
void testCase3(BSLA_MAYBE_UNUSED int  test,
               BSLA_MAYBE_UNUSED bool verbose,
               BSLA_MAYBE_UNUSED bool veryVerbose,
               BSLA_MAYBE_UNUSED bool veryVeryVerbose,
               BSLA_MAYBE_UNUSED bool veryVeryVeryVerbose)
...
void testCase2(BSLA_MAYBE_UNUSED int  test,
               BSLA_MAYBE_UNUSED bool verbose,
               BSLA_MAYBE_UNUSED bool veryVerbose,
               BSLA_MAYBE_UNUSED bool veryVeryVerbose,
               BSLA_MAYBE_UNUSED bool veryVeryVeryVerbose)
...
void testCase1(BSLA_MAYBE_UNUSED int  test,
               BSLA_MAYBE_UNUSED bool verbose,
               BSLA_MAYBE_UNUSED bool veryVerbose,
               BSLA_MAYBE_UNUSED bool veryVeryVerbose,
               BSLA_MAYBE_UNUSED bool veryVeryVeryVerbose)
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 7: {
        ...
        //
        // Concerns:
        //: o In C++11, 'bsl::invoke_result<F, ARGS...>' has a nested typedef
        ...
        //
        // Plan:
        //: o For a large array of various 'const'-, 'volatile'-, and/or
