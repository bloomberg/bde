...
// [ 1] bsl::is_member_object_pointer_v
//
// ----------------------------------------------------------------------------
// [ 2] USAGE EXAMPLE
...
//..
      ...
      case 1: {
        ...
        // C-1, 3
        TEST_OBJECT(bsl::is_member_object_pointer, bool);
        TEST_OBJECT(bsl::is_member_object_pointer, int);
        TEST_OBJECT(bsl::is_member_object_pointer, long double);

#if defined(BSLS_NULLPTR_USING_NATIVE_NULLPTR_T)
        TEST_OBJECT(bsl::is_member_object_pointer, bsl::nullptr_t);
#else
        ...
        TYPE_ASSERT(bsl::is_member_object_pointer, volatile void, false);
        TYPE_ASSERT(bsl::is_member_object_pointer, const volatile void, false);
        TEST_OBJECT(bsl::is_member_object_pointer, void *);

        // C-2, 3
        TEST_OBJECT(bsl::is_member_object_pointer, EnumTestType);
        TEST_OBJECT(bsl::is_member_object_pointer, EnumClassTestType);
        TEST_OBJECT(bsl::is_member_object_pointer, StructTestType);
        TEST_OBJECT(bsl::is_member_object_pointer, UnionTestType);
        TEST_OBJECT(bsl::is_member_object_pointer, Incomplete);
        TEST_OBJECT(bsl::is_member_object_pointer, BaseClassTestType);
        TEST_OBJECT(bsl::is_member_object_pointer, DerivedClassTestType);


        // C-4
        TEST_ARRAY(bsl::is_member_object_pointer, int);
        TEST_ARRAY(bsl::is_member_object_pointer, void *);
        TEST_ARRAY(bsl::is_member_object_pointer, EnumTestType);
        TEST_ARRAY(bsl::is_member_object_pointer, UnionTestType);
        TEST_ARRAY(bsl::is_member_object_pointer, StructTestType);
        TEST_ARRAY(bsl::is_member_object_pointer, Incomplete *);
        ...
        TEST_FUNCTION(bsl::is_member_object_pointer, int  (int)      );
        TEST_FUNCTION(bsl::is_member_object_pointer, void (void)     );
        TEST_FUNCTION(bsl::is_member_object_pointer, int  (void)     );
        TEST_FUNCTION(bsl::is_member_object_pointer, void (int)      );
        TEST_FUNCTION(bsl::is_member_object_pointer, MemFnType (int) );
        ...
        TEST_FUNCTION(bsl::is_member_object_pointer, int (INT_13)    );
        TEST_FUNCTION(bsl::is_member_object_pointer, int (INT_14)    );
        TEST_FUNCTION(bsl::is_member_object_pointer, int (INT_15)    );
        TEST_FUNCTION(bsl::is_member_object_pointer, int (INT_16)    );
        ...
        TEST_FUNCTION(bsl::is_member_object_pointer, int  (...)      );
        TEST_FUNCTION(bsl::is_member_object_pointer, void (...)      );
        TEST_FUNCTION(bsl::is_member_object_pointer, int  (int...)   );
        TEST_FUNCTION(bsl::is_member_object_pointer, void (int...)   );
        ...
        // C-6
        TEST_MEMPTR(bsl::is_member_object_pointer, int);
        TEST_MEMPTR(bsl::is_member_object_pointer, void *);
        TEST_MEMPTR(bsl::is_member_object_pointer, int (*)());

        TEST_MEMPTR(bsl::is_member_object_pointer, EnumTestType);
        TEST_MEMPTR(bsl::is_member_object_pointer, EnumClassTestType);
        TEST_MEMPTR(bsl::is_member_object_pointer, StructTestType);
        TEST_MEMPTR(bsl::is_member_object_pointer, UnionTestType);
        TEST_MEMPTR(bsl::is_member_object_pointer, Incomplete);
        TEST_MEMPTR(bsl::is_member_object_pointer, BaseClassTestType);
        TEST_MEMPTR(bsl::is_member_object_pointer, DerivedClassTestType);

        // C-7
        typedef Incomplete X;  // Smaller name to fit tests onto a single line.

        TEST_MEMPTR(bsl::is_member_object_pointer, int X::*);
        TEST_MEMPTR(bsl::is_member_object_pointer, int (X::*)());
        TEST_MEMPTR(bsl::is_member_object_pointer, int (X::*)(...));
        TEST_MEMPTR(bsl::is_member_object_pointer, int (X::*)(INT_21...));
        TEST_MEMPTR(bsl::is_member_object_pointer, int (X::*)() volatile);
#if defined(BSLS_COMPILERFEATURES_SUPPORT_REF_QUALIFIERS)
        TEST_MEMPTR(bsl::is_member_object_pointer, int (X::*)() &&);
# if defined(BSLS_COMPILERFEATURES_SUPPORT_NOEXCEPT_TYPES)
        TEST_MEMPTR(bsl::is_member_object_pointer, int (X::*)() & noexcept);
# endif
#endif

#if defined(BSLMF_ISMEMBEROBJECTPOINTER_SHOW_FAIL_FOR_DIAGNOSTICS)
        // Test diagnostics for readability with an interesting failure
        TEST_MEMPTR(bsl::is_member_object_pointer, int (int)             );
# if defined(BSLS_COMPILERFEATURES_SUPPORT_NOEXCEPT_TYPES)
        TEST_MEMPTR(bsl::is_member_object_pointer, int (int) && noexcept );
# endif
#endif
        ...
        TEST_MEMFUN(bsl::is_member_object_pointer, void (X::*)(void)     );
        TEST_MEMFUN(bsl::is_member_object_pointer, int  (X::*)(void)     );
        ...
        TEST_MEMFUN(bsl::is_member_object_pointer, int (X::*)(INT_13)    );
        TEST_MEMFUN(bsl::is_member_object_pointer, int (X::*)(INT_14)    );
        TEST_MEMFUN(bsl::is_member_object_pointer, int (X::*)(INT_15)    );
        TEST_MEMFUN(bsl::is_member_object_pointer, int (X::*)(INT_16)    );
