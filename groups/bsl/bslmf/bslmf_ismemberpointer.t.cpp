...
# define MSVC_TEST_MEMFUN(META_FUNC, RET, CLASS, ARGS)                 \
    ...
    MSVC_TEST_MEMFUN_REF(META_FUNC, RET, CLASS, ARGS, const volatile)
        ...
        // int (X::*)(...)
        MSVC_TEST_MEMFUN(bsl::is_member_pointer, int,  X, (...)      );

        // void (X::*)(...)
        MSVC_TEST_MEMFUN(bsl::is_member_pointer, void, X, (...)      );

        // int (X::*)(int...)
        MSVC_TEST_MEMFUN(bsl::is_member_pointer, int,  X, (int...)   );

        // void (X::*)(int...)
        MSVC_TEST_MEMFUN(bsl::is_member_pointer, void, X, (int...)   );

        // int (X::*)(INT_09...)
        MSVC_TEST_MEMFUN(bsl::is_member_pointer, int, X, (INT_09...) );
#if !DO_FEWER_TESTS
        MSVC_TEST_MEMFUN(bsl::is_member_pointer, int, X, (INT_10...) );
        MSVC_TEST_MEMFUN(bsl::is_member_pointer, int, X, (INT_11...) );
        MSVC_TEST_MEMFUN(bsl::is_member_pointer, int, X, (INT_12...) );
        MSVC_TEST_MEMFUN(bsl::is_member_pointer, int, X, (INT_13...) );
        MSVC_TEST_MEMFUN(bsl::is_member_pointer, int, X, (INT_14...) );
        MSVC_TEST_MEMFUN(bsl::is_member_pointer, int, X, (INT_15...) );
        MSVC_TEST_MEMFUN(bsl::is_member_pointer, int, X, (INT_16...) );
        MSVC_TEST_MEMFUN(bsl::is_member_pointer, int, X, (INT_17...) );
        MSVC_TEST_MEMFUN(bsl::is_member_pointer, int, X, (INT_18...) );
        MSVC_TEST_MEMFUN(bsl::is_member_pointer, int, X, (INT_19...) );
#endif  // not DO_FEWER_TESTS
        MSVC_TEST_MEMFUN(bsl::is_member_pointer, int, X, (INT_20...) );
        MSVC_TEST_MEMFUN(bsl::is_member_pointer, int, X, (INT_21...) );
#endif
      } break;
      default: {
