...
//
//@CLASSES:
//  bslma_DefaultAllocatorGuard: default-allocator scoped guard
//
...
// 'bslma_DefaultAllocatorGuard', that serves as a "scoped guard" to enable the
...
// of a class derived from 'bslma_Allocator'.  The default allocator at the
...
// 'bslma_NewDeleteAllocator::singleton()' will be the default allocator for
// that process (i.e., calls to 'bslma_Default::defaultAllocator()' will return
// the new-delete allocator unless someone has set the default allocator to a
// different allocator intentionally).  Consider for purposes of this
// illustrative example the case where we, as owners of a test driver 'main',
// can count on the 'bslma_NewDeleteAllocator' singleton being the default.
//
...
// in testing real production code, 'bslma_TestAllocator' serves this purpose.)
//..
...
// 'bslma_Allocator' and the 'bslma_Default' mechanism.  First, we confirm that
// the 'bslma_NewDeleteAllocator' singleton is indeed installed.
//..
//    //my_component.t.cpp
//
//    // ...
...
//   {
//       // ...
//       bslma_NewDeleteAllocator *na = &bslma_NewDeleteAllocator::singleton();
...
class bslma_DefaultAllocatorGuard {
    ...
    // NOT IMPLEMENTED
    bslma_DefaultAllocatorGuard(const bslma_DefaultAllocatorGuard&);
    bslma_DefaultAllocatorGuard& operator=(const bslma_DefaultAllocatorGuard&);
