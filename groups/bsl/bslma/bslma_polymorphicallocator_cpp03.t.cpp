// bslma_polymorphicallocator_cpp03.t.cpp                             -*-C++-*-
...
//
// Generated on Wed Oct  5 17:07:07 2022
// Command line: sim_cpp11_features.pl bslma_polymorphicallocator.t.cpp

// Expanded test driver only when compiling bslma_polymorphicallocator.cpp
#ifdef COMPILING_BSLMA_POLYMORPHICALLOCATOR_T_CPP

// No C++03 Expansion

#else // if ! defined(COMPILING_BSLMA_POLYMORPHICALLOCATOR_T_CPP)

// Trivial program when not compiling bslma_polymorphicallocator.t.cpp
int main() {
    return -1;
}

#endif // defined(COMPILING_BSLMA_POLYMORPHICALLOCATOR_T_CPP)
