// bslma_bslallocator_cpp03.t.cpp                                     -*-C++-*-
...
//
// Generated on Thu Aug 10 10:41:14 2023
// Command line: sim_cpp11_features.pl bslma_bslallocator.t.cpp

// Expanded test driver only when compiling bslma_bslallocator.cpp
#ifdef COMPILING_BSLMA_BSLALLOCATOR_T_CPP

// No C++03 Expansion

#else // if ! defined(COMPILING_BSLMA_BSLALLOCATOR_T_CPP)

// Trivial program when not compiling bslma_bslallocator.t.cpp
int main() {
    return -1;
}

#endif // defined(COMPILING_BSLMA_BSLALLOCATOR_T_CPP)
