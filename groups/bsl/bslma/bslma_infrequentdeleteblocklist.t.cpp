...
//                                  Overview
//                                  --------
// The goals of this 'bslma_InfrequentDeleteBlockList' test suite are to verify
...
// deallocated.
//-----------------------------------------------------------------------------
// [1] bslma_InfrequentDeleteBlockList(basicAllocator);
// [2] ~bslma_InfrequentDeleteBlockList();
...
typedef bslma_InfrequentDeleteBlockList Obj;
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:
      ...
      case 3: {
        ...
        bslma_InfrequentDeleteBlockList sa(&ta);
      ...
      case 2: {
        // --------------------------------------------------------------------
        // RELEASE TEST:
        //   Create a 'bslma_InfrequentDeleteBlockList' memory manager
      ...
      case 1: {
        ...
        //
        // Testing:
        //   bslma_InfrequentDeleteBlockList(basicAllocator);
