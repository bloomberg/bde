// bslma_allocatorutil_cpp03.t.cpp                                    -*-C++-*-
...
// Command line: sim_cpp11_features.pl bslma_allocatorutil.t.cpp

// Expanded test driver only when compiling bslma_allocatorutil.cpp
#ifdef COMPILING_BSLMA_ALLOCATORUTIL_T_CPP

// No C++03 Expansion

#else // if ! defined(COMPILING_BSLMA_ALLOCATORUTIL_T_CPP)

// Trivial program when not compiling bslma_allocatorutil.t.cpp
int main() {
    return -1;
}

#endif // defined(COMPILING_BSLMA_ALLOCATORUTIL_T_CPP)
