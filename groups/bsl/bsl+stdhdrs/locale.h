/* locale.h                                                          -*-C-*- */
#ifndef INCLUDED_NATIVE_C_LOCALE
#define INCLUDED_NATIVE_C_LOCALE
...
/*
// Note that 'locale.h' might be meant for multiple inclusion on some
// platforms, so only the ident is protected by the include guard.
*/

#endif  /* INCLUDED_NATIVE_C_LOCALE */
...
# else
#   include BSL_NATIVE_OS_RTL_HEADER(locale.h)
# endif
...
# ifdef BSL_STDHDRS_EPILOGUE_RUN_BY_c_locale
# undef BSL_STDHDRS_EPILOGUE_RUN_BY_c_locale
