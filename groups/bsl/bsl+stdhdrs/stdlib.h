/* stdlib.h                                                          -*-C-*- */
#ifndef INCLUDED_NATIVE_C_STDLIB
#define INCLUDED_NATIVE_C_STDLIB
...
/*
// Note that 'stdlib.h' is meant for multiple inclusion on Linux, so only the
// ident is protected by the include guard.
*/

#endif  /* INCLUDED_NATIVE_C_STDLIB */
