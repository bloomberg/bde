/* signal.h                                                          -*-C-*- */
#ifndef INCLUDED_NATIVE_C_SIGNAL
#define INCLUDED_NATIVE_C_SIGNAL
...
/*
// Note that 'signal.h' is meant for multiple inclusion on Linux, so only the
// ident is protected by the include guard.
*/

#endif  /* INCLUDED_NATIVE_C_SIGNAL */
...
#   ifdef BSL_STDHDRS_EPILOGUE_RUN_BY_c_signal
#   undef BSL_STDHDRS_EPILOGUE_RUN_BY_c_signal
