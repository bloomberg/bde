...
// <limits.SUNWCCh>.  This problem is solved by creating a script
// 'cphdrs.pl' that, given a header file name (provided by bde_build.pl), it
// will copy that file and also its corresponding without the .h and with the
// .SUNWCCh.

// The second problem is that when a header does not have a corresponding .h
// file, such as <algorithm>, there is no way to make bde_build.pl provide this
// name unless we create this dummy header file.
