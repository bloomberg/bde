...
#include <bslstl_optional_cpp03.h>      // Pro-forma #include

// Empty file except when compiling bslstl_optional.cpp
#ifdef COMPILING_BSLSTL_OPTIONAL_CPP
