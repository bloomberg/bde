...
void testCase12b()
{
    ...
    bsl::visitR<void>(Voidfunctor, var);
...
void testCase12a()
{
    ...
    CallablePassByLRef<void> Voidfunctor;
    ASSERT(
          (std::is_same<decltype(bsl::visit(Voidfunctor, var)), void>::value));
...
int main(int argc, char **argv)
{
    ...
    switch (test) { case 0:
      case 16: {
        ...
        bsl::variant<int, char, std::string> v2(bsl::in_place_type_t<char>(),
                                                'c');
