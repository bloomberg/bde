// bslstl_iserrorcodeenum.t.cpp                                       -*-C++-*-
...
// enumeration type as eligible to participate in the '<system_error>'
// facility.
//
// ----------------------------------------------------------------------------
//
...
template struct is_error_code_enum<ErrorValues::Ineligible>;
...
//..
    namespace BSL_IS_ERROR_CODE_ENUM_NAMESPACE {
    template <>
    struct is_error_code_enum<CarError::Enum>
...
//..
      ...
      case 1: {
        ...
        if (veryVerbose) {
            ...
            P(is_error_code_enum<Ineligible>::value)
            P(is_error_code_enum<MarkedIneligible>::value)
        }

        ASSERT(is_error_code_enum<Eligible>::value);
        ASSERT(!is_error_code_enum<Ineligible>::value);
        ASSERT(!is_error_code_enum<MarkedIneligible>::value);
      } break;
      default: {
