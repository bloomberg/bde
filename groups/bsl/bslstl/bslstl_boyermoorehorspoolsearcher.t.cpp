...
#include <bsltf_templatetestfacility.h>  // needed?
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:
      ...
      case 4: {
        ...
        //:   attributes.
        //:
        //: 2 The allocator installed in the copied object depends on the the
        //:
        ...
        Mech mZ(needleFirst, needleLast, hashFunctor, equalFunctor, xsa);
        Mech mX(needleFirst, needleLast, hashFunctor, equalFunctor, xsa);
        ...
        // The copied object state matches 'original' except for allocator.
 ...
 //---------v
        ...
        if (verbose) printf("\n" "Allocator Installation and Accessor" "\n");
        {
            ...
            for (char cfg = 'a'; cfg <= 'c'; ++cfg) {
                ...
                switch (CONFIG) {
                  ...
                  default: {
                    ASSERTV(CONFIG, !"Bad allocsator config.");
                  } break;
                }
      ...
      case 1: {
        ...
        bsl::boyer_moore_horspool_searcher<const int *> myIntSearcher(
                                                                 intNeedle,
                                                                 intNeedle
                                                               + numIntNeedle);
