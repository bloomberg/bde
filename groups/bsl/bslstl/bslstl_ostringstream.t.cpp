...
// [ 6] ostringstream(MovableRef<STRING> s, const A& a = A());
// [ 6] ostringstream(const OTHER_STRING& s, const A& a = A());
// [ 7] ostringstream(const STRING& s, openmode mask, const A& a = A());
// [ 7] ostringstream(MovableRef<STRING> s, openmode mask, const A& a = A());
// [ 7] ostringstream(const OTHER_STRING& s, openmode mask, const A& a = A());
//
// MANIPULATORS
...
void testCase10()
{
    ...
    for (int i = 0; i <= LENGTH_OF_SUFFICIENTLY_LONG_STRING; ++i)
    {
        ...
        const bsls::Types::Int64 DEFAULT_NUM_BYTES_TOTAL = da.numBytesTotal();
...
void testCase6()
{
    ...
    //   ostringstream(MovableRef<STRING> s, const A& a = A());
    //   ostringstream(const OTHER_STRING& s, const A& a = A());
    // ------------------------------------------------------------------------
...
void testCase7()
{
    ...
    //   ostringstream(MovableRef<STRING> s, openmode mask, const A& a = A());
    //   ostringstream(const OTHER_STRING& s, openmode mask, const A& a = A());
    // ------------------------------------------------------------------------
