...
// original.
//
// Generated on Fri Jan 22 17:07:31 2021
// Command line: sim_cpp11_features.pl bslstl_optional.t.cpp

// Expanded test driver only when compiling bslstl_optional.cpp
#ifdef COMPILING_BSLSTL_OPTIONAL_T_CPP

// No C++03 Expansion

#else // if ! defined(COMPILING_BSLSTL_OPTIONAL_T_CPP)

// Trivial program when not compiling bslstl_optional.t.cpp
int main() {
    return -1;
}

#endif // defined(COMPILING_BSLSTL_OPTIONAL_T_CPP)
