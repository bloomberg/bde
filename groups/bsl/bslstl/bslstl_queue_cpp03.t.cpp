...
#ifdef COMPILING_BSLSTL_QUEUE_T_CPP
...
#else // if ! defined(COMPILING_BSLSTL_QUEUE_T_CPP)

// Trivial program when not compiling bslstl_queue.t.cpp
int main() {
    return -1;
}
