...
class map {
  ...
  public:
    ...
    explicit map(const COMPARATOR& comparator = COMPARATOR(),
        ...
        // 'ALLOCATOR' is used.  If the (template parameter) type 'ALLOCATOR'
        // is 'bsl::allocator' (the default), then 'allocator', if supplied,
        // shall be convertible to 'bslma::Allocator *'.  If the (template
        // parameter) type 'ALLOCATOR' is 'bsl::allocator' and 'allocator' is
