...
size_t HashTable_GrowthUtil::nextPrime(size_t n)
{   // An abbreviated list of prime numbers in the domain of 32-bit
    ...
    // messing up the doubling pattern, not critical while only proof-of-concept
    // code.
    ...
    return *std::lower_bound(s_beginPrimes, s_endPrimes, n);
}
