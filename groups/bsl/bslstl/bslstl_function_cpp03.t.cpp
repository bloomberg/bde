...
// original.
//
// Generated on Fri Oct 16 10:41:24 2020
// Command line: sim_cpp11_features.pl bslstl_function.t.cpp

// Expanded test driver only when compiling bslstl_function.cpp
#ifdef COMPILING_BSLSTL_FUNCTION_T_CPP

// No C++03 Expansion

#else // if ! defined(COMPILING_BSLSTL_FUNCTION_T_CPP)

// Trivial program when not compiling bslstl_function.t.cpp
int main() {
    return -1;
}

#endif // defined(COMPILING_BSLSTL_FUNCTION_T_CPP)
