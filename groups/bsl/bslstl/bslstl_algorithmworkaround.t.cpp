...
//                             TEST PLAN
// ----------------------------------------------------------------------------
// The component under test provides work arounds for incorrectly implemented
      ...
      case 2: {
...

        {
            ...
            for (int i = 0; i < NUM_DATA; ++i) {
                ...
                {
                    const int *result = bsl::lower_bound(INPUT, END, VALUE);
                ...
                {
                    const int *result =
                        bsl::lower_bound(INPUT, END, VALUE, std::less<int>());
                ...
                {
                    const int *result = bsl::upper_bound(INPUT, END, VALUE);
                    const int offset = result - INPUT;
                ...
                {
                    const int *result =
                        bsl::upper_bound(INPUT, END, VALUE, std::less<int>());
