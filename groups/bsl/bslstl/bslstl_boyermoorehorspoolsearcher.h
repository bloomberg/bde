...
class boyer_moore_horspool_searcher {
  ...
  public:
    ...
    // ACCESSORS
    template<class RANDOM_ITR_HAYSTACK>
    bsl::pair<RANDOM_ITR_HAYSTACK, RANDOM_ITR_HAYSTACK> operator()(
                                       RANDOM_ITR_HAYSTACK haystackFirst,
                                       RANDOM_ITR_HAYSTACK haystackLast) const;
    ...
    RANDOM_ITR_NEEDLE needleFirst() const;
    ...
    RANDOM_ITR_NEEDLE needleLast() const;
...
template <class RANDOM_ITR_NEEDLE,
          ...
          class EQUAL,
          class ALLOCATOR>
boyer_moore_horspool_searcher<RANDOM_ITR_NEEDLE,
                              HASH,
                              EQUAL,
                              ALLOCATOR>::
boyer_moore_horspool_searcher(RANDOM_ITR_NEEDLE needleFirst,
                              RANDOM_ITR_NEEDLE needleLast,
                              HASH              hash,
                              EQUAL             equal,
                              const ALLOCATOR&  basicAllocator)
...
template <class RANDOM_ITR_NEEDLE,
          ...
          class ALLOCATOR>
template <class RANDOM_ITR_HAYSTACK>
bsl::pair<RANDOM_ITR_HAYSTACK, RANDOM_ITR_HAYSTACK>
boyer_moore_horspool_searcher<RANDOM_ITR_NEEDLE,
                              HASH,
                              EQUAL,
                              ALLOCATOR>::operator()(
...
template <class RANDOM_ITR_NEEDLE,
          ...
          class ALLOCATOR>
inline
RANDOM_ITR_NEEDLE boyer_moore_horspool_searcher<RANDOM_ITR_NEEDLE,
                                                HASH,
                                                EQUAL,
...
template <class RANDOM_ITR_NEEDLE,
          ...
          class ALLOCATOR>
inline
HASH boyer_moore_horspool_searcher<RANDOM_ITR_NEEDLE,
                                   HASH,
                                   EQUAL,
                                   ALLOCATOR>::hash() const
{
...
inline
EQUAL boyer_moore_horspool_searcher<RANDOM_ITR_NEEDLE,
                                    HASH,
                                    EQUAL,
                                    ALLOCATOR>::equal() const
{
...
template <class RANDOM_ITR_NEEDLE,
          ...
          class ALLOCATOR>
inline
ALLOCATOR boyer_moore_horspool_searcher<RANDOM_ITR_NEEDLE,
                                        HASH,
                                        EQUAL,
                                        ALLOCATOR>::allocator() const
{
...
struct UsesBslmaAllocator<
    bsl::boyer_moore_horspool_searcher<RANDOM_ITR_NEEDLE,
                                       HASH,
                                       EQUAL,
                                       ALLOCATOR>
