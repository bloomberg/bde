// bslstl_vector_test2.h                                              -*-C++-*-
#ifndef INCLUDED_BSLSTL_VECTOR_TEST2
#define INCLUDED_BSLSTL_VECTOR_TEST2
...
//
//@DESCRIPTION: This component provides a third translation unit for 'vector'
...
// set of tests (12-23) are in 'bslstl_vector_test1', and the remaining tests
// (24 and higher) are in this subordinate component's test driver.
//
