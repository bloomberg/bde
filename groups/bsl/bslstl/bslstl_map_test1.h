// bslstl_map_test1.h                                                 -*-C++-*-
#ifndef INCLUDED_BSLSTL_MAP_TEST1
#define INCLUDED_BSLSTL_MAP_TEST1
...
//@SEE_ALSO: bslstl_map
//
//@DESCRIPTION: This component provides a second translation unit for 'map'
// test cases to reduce the test-driver's build time.  The usage example test,
// and test cases 1-8 are in the original component test driver.  Test cases
// 9-27 are in this subordinate component's test driver.  Test case 28 is in
// the 'bslstl_map_test2' component's test driver, while the remaining tests
// (29 and higher) are in the 'bslstl_map_test3' component's test driver.
//
