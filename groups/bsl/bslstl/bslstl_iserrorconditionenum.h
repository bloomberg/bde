...
// facility.  It also defines a macro, 'BSL_IS_ERROR_CONDITION_ENUM_NAMESPACE',
// to be used as the namespace in which to write such specializations.
//
...
// 'BSL_IS_ERROR_CONDITION_ENUM_NAMESPACE' is defined to be the standard
// namespace.
//
///Usage
///-----
