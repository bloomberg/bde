// bslalg_bidirectionallistutil.cpp                                   -*-C++-*-
...
void BidirectionalListUtil::spliceListBeforeLink(BidirectionalLink *first,
...
void BidirectionalListUtil::unlink(BidirectionalLink *node)
