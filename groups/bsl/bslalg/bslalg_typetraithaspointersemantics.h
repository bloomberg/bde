...
//
//@CLASSES:
//  bslalg_TypeTraitHasPointerSemantics: has pointer semantics
//
...
// 'bslalg_TypeTraitHasPointerSemantics'.  A type with this trait is said to
...
namespace BloombergLP {
                 ...
                 //===========================================
                 // struct bslalg_TypeTraitHasPointerSemantics
                 //===========================================
...
struct bslalg_TypeTraitHasPointerSemantics {
    ...
    // 'bslma_ManagedPtr'.  This trait is generally used by objects that invoke
    // the wrapped type.
};
