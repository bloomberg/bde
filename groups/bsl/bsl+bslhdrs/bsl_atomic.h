...
namespace bsl {
    ...
    using native_std::atomic_sub;
    using native_std::atomic_sub_explicit;
    using native_std::atomic_and;
    using native_std::atomic_and_explicit;
    using native_std::atomic_or;
    using native_std::atomic_or_explicit;
    using native_std::atomic_xor;
    using native_std::atomic_xor_explicit;
...
#include <bslstl_atomicworkaround.h>
#endif

#ifndef BDE_OMIT_TRANSITIONAL // STP
#ifndef BSL_OVERRIDES_STD
#include <bslstp_exatomic.h>
#endif
