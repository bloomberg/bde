...
//-----------------------------------------------------------------------------
// CREATORS
// [ 2] AllocBitwiseMoveableTestType(bslma::Allocator *bA = 0);
// [ 3] AllocBitwiseMoveableTestType(int data);
// [ 7] AllocBitwiseMoveableTestType(const AllocBitwiseMoveableTestType&);
// [ 2] ~AllocBitwiseMoveableTestType();
//
// MANIPULATORS
// [ 9] AllocBitwiseMoveableTestType& operator=(rhs);
...
typedef bsltf::AllocBitwiseMoveableTestType Obj;
...
//..
      ...
      case 9: {
        ...
        //
        // Testing:
        //   AllocBitwiseMoveableTestType& operator=(rhs);
        // --------------------------------------------------------------------
      ...
      case 7: {
        ...
        //
        // Testing:
        //   AllocBitwiseMoveableTestType(const AllocBitwiseMoveableTestType&);
        // --------------------------------------------------------------------
      ...
      case 3: {
        ...
        //
        // Testing:
        //   AllocBitwiseMoveableTestType(int data);
        // --------------------------------------------------------------------
      ...
      case 2: {
        ...
        //
        // Testing:
        //   AllocBitwiseMoveableTestType(bslma::Allocator *bA = 0);
