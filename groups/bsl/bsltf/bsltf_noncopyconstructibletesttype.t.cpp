...
// [ 3] NonCopyConstructibleTestType(int data);
// [ 7] NonCopyConstructibleTestType(const NonCopyConstructibleTestType&);
// [ 2] ~NonCopyConstructibleTestType();
//
// MANIPULATORS
// [ 9] NonCopyConstructibleTestType& operator=(rhs);
...
typedef bsltf::NonCopyConstructibleTestType Obj;
