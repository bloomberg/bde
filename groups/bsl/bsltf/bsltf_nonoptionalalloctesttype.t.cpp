...
//-----------------------------------------------------------------------------
// CREATORS
// [ 2] NonOptionalAllocTestType(bslma::Allocator *basicAllocator);
// [ 3] NonOptionalAllocTestType(int data, bslma::Allocator *basicAllocator);
// [ 7] NonOptionalAllocTestType(const NonOptionalAllocTestType& original);
// [ 2] ~NonOptionalAllocTestType();
//
// MANIPULATORS
// [ 9] NonOptionalAllocTestType& operator=(const NOATT& rhs);
...
typedef bsltf::NonOptionalAllocTestType Obj;
...
//..
      ...
      case 12: {
        ...
        //   The 'NonOptionalAllocTestType' object is specifically designed to
        //   NOT be bitwise-moveable, so that it can be used to verify code is
                            ...
                            "\n=================================\n");
        {
            ...
            if (verbose) printf("\n");
            {
                ...
                new (arr) Obj(&scratch);
                memmove(static_cast<void *>(arr+1), arr, sizeof(Obj));
      ...
      case 11: {
        // --------------------------------------------------------------------
        // TESTING TYPE TRAITS
        //   Ensure that 'NonOptionalAllocTestType' has the necessary trait
        //   values to guarantee its expected behavior.
        //
        // Concerns:
      ...
      case 9: {
        ...
        //
        // Testing:
        //   NonOptionalAllocTestType& operator=(const NOATT& rhs);
        // --------------------------------------------------------------------
      ...
      case 7: {
        ...
        //
        // Testing:
        //   NonOptionalAllocTestType(const NonOptionalAllocTestType& orig);
        // --------------------------------------------------------------------
      ...
      case 3: {
        ...
        //
        // Testing:
        //   NonOptionalAllocTestType(int data);
        // --------------------------------------------------------------------
      ...
      case 2: {
        ...
        //
        // Testing:
        //   NonOptionalAllocTestType(bslma::Allocator *bA);
