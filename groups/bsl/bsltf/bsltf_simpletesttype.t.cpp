...
// CREATORS
// [ 2] SimpleTestType();
// [ 3] SimpleTestType(int data);
// [ 7] SimpleTestType(const SimpleTestType& original);
// [ 2] ~SimpleTestType();
//
// MANIPULATORS
// [ 9] SimpleTestType& operator=(const SimpleTestType& rhs);
...
//
// FREE OPERATORS
// [ 6] bool operator==(const SimpleTestType& lhs, const SimpleTestType& rhs);
// [ 6] bool operator!=(const SimpleTestType& lhs, const SimpleTestType& rhs);
//-----------------------------------------------------------------------------
// [ 1] BREATHING TEST
// [11] USAGE EXAMPLE
...
typedef bsltf::SimpleTestType Obj;
