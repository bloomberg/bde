// bsltf_nonassignabletesttype.t.cpp                                  -*-C++-*-
...
// attribute class, except it doesn't provide an assignment operator.  The
// Primary Manipulators and Basic Accessors are therefore, respectively, the
// attribute setters and getters, each of which follows our standard
// unconstrained attribute-type naming conventions: 'setAttributeName' and
// 'attributeName'.
//
...
//-----------------------------------------------------------------------------
// CREATORS
// [ 2] NonAssignableTestType();
// [ 3] NonAssignableTestType(int data);
// [ 7] NonAssignableTestType(const NonAssignableTestType& original);
// [ 2] ~NonAssignableTestType();
//
// MANIPULATORS
// [ 9] NonAssignableTestType& operator=(const NonAssignableTestType& rhs);
...
typedef bsltf::NonAssignableTestType Obj;
...
//..
      ...
      case 9: {
        ...
        //
        // Plan:
        //: 1 There is no good way to test the copy-assignment operator's
        //:   access privilege in C++03.  SFINAE doesn't support check for
        //:   private-access.
        //
        // Testing:
      ...
      case 7: {
        ...
        //
        // Testing:
        //   NonAssignableTestType(const NonAssignableTestType& original);
        // --------------------------------------------------------------------
