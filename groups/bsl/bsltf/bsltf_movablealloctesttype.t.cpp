...
// TBD: need to add test cases for move semantics
...
//-----------------------------------------------------------------------------
// CREATORS
// [ 2] MovableAllocTestType(bslma::Allocator *bA = 0);
// [ 3] MovableAllocTestType(int data);
// [ 7] MovableAllocTestType(const MovableAllocTestType& original);
// [ 2] ~MovableAllocTestType();
//
// MANIPULATORS
// [ 9] MovableAllocTestType& operator=(const MovableAllocTestType& rhs);
...
//..
      ...
      case 12: {
        ...
        //   The 'MovableAllocTestType' object is specifically designed to NOT
        //   be bitwise-moveable, so that it can be used to verify code is
      ...
      case 11: {
        // --------------------------------------------------------------------
        // TESTING TYPE TRAITS
        //   Ensure that 'MovableAllocTestType' has the necessary trait values
      ...
      case 2: {
        ...
        //
        // Testing:
        //   MovableAllocTestType(bslma::Allocator *bA = 0);
      ...
      case 1: {
        ...
        }
        {
            ...
            Obj mY(bslmf::MovableRefUtil::move(mX), &oa2); const Obj& Y = mY;
