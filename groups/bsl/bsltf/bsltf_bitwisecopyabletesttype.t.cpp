// bsltf_bitwisecopyabletesttype.t.cpp                                -*-C++-*-
...
//-----------------------------------------------------------------------------
// CREATORS
// [ 2] BitwiseCopyableTestType();
// [ 3] BitwiseCopyableTestType(int data);
// [ 7] BitwiseCopyableTestType(const BitwiseCopyableTestType& original);
// [ 2] ~BitwiseCopyableTestType();
//
// MANIPULATORS
// [ 9] BitwiseCopyableTestType& operator=(const BitwiseCopyableTestType& rhs);
...
typedef bsltf::BitwiseCopyableTestType Obj;
    ...
    // Prints the traits of the parameterized 'TYPE' to the console.
{
    ...
    if (bsl::is_trivially_copyable<TYPE>::value) {
...
//..
      ...
      case 9: {
        ...
        //
        // Testing:
        //  BitwiseCopyableTestType& operator=(const BitwiseCopyableTestType&);
        // -------------------------------------------------------------------
