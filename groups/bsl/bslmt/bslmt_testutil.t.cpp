...
struct Func {
    ...
    // CREATORS
    Func() : d_enablePush(false) {}

    //! Func(const Func& original) == default;

    // MANIPULATORS
    //! Func& operator=(const Func& original) == default;
...
void eliminateLineNumbers()
    ...
    // numbers will be 3 or 4 digit.  We've already tested that the asserts
