// bsltt_integerconstant.h                  -*-C++-*-
#ifndef INCLUDED_BSLTT_INTEGERCONSTANT
#define INCLUDED_BSLTT_INTEGERCONSTANT
...
// bsltt::integer_constant<TYPE,VAL>: An alias for 'bsl::integer_constant'
// bsltt::false_type: An alias for 'bsl::false_type'
// bsltt::true_type: An alias for 'bsl::true_type'
//
//@SEE_ALSO:
//
...
//    
//    template <class T>
//    int doSomethingImp(T *t, bsltt::true_type)
//    {
...
//    
//    template <class T>
//    int doSomethingImp(T *t, bsltt::false_type)
//    {
...
//        // value of 'IsSlow'.
//        return doSomethingImp(t, bsltt::integer_constant<bool, IsSlow>());
//    }
//..
...
//..
//    template <class TYPE> struct IsFloatingPoint    : bsltt::false_type { };
//    template <> struct IsFloatingPoint<float>       : bsltt::true_type { };
//    template <> struct IsFloatingPoint<double>      : bsltt::true_type { };
//    template <> struct IsFloatingPoint<long double> : bsltt::true_type { };
//..
...
namespace bsltt {
    ...
    // Import 'bsl' classes into 'BloombergLP::bsltt'
    using bsl::integer_constant;
    using bsl::true_type;
    using bsl::false_type;

}  // close namespace bsltt
...
#endif // ! defined(INCLUDED_BSLTT_INTEGERCONSTANT)
