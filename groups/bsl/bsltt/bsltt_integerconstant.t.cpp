    ...
    // plan for this test.
{
    ...
    typedef bsltt::integer_constant<TYPE, VAL> Obj;
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 4: {
        ...
        ASSERT((IsSameType<bsltt::false_type,
                           bsltt::integer_constant<bool, false> >::VALUE));
        ASSERT((IsSameType<bsltt::true_type,
                           bsltt::integer_constant<bool, true> >::VALUE));
	...
	//
        ...
        using namespace BloombergLP::bsltt;
