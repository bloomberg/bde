...
//
      ...
      case 1: {
        ...
        // but to keep the table readable we wrap this transformation in short
        // macros.

#define _91C static_cast<char   >(-91)
#define _92C static_cast<char   >(-92)
#define _93C static_cast<char   >(-93)
#define _94C static_cast<char   >(-94)
#define _95C static_cast<char   >(-95)
#define _96C static_cast<char   >(-96)
#define _97C static_cast<char   >(-97)

#define _91W static_cast<wchar_t>(-91)
#define _92W static_cast<wchar_t>(-92)
#define _93W static_cast<wchar_t>(-93)
#define _94W static_cast<wchar_t>(-94)
#define _95W static_cast<wchar_t>(-95)
#define _96W static_cast<wchar_t>(-96)
#define _97W static_cast<wchar_t>(-97)
        ...
        static const struct {
            ...
            { L_,   "{:#04x}",    "0xa5",        _91C  },
            { L_,   "{:#04X}",    "0XA5",        _91C  },
            { L_,   "{:#b}",      "0b10100101",  _91C  },
            { L_,   "{:#05b}",    "0b10100101",  _91C  },
            { L_,   "{:#06b}",    "0b10100101",  _91C  },
            { L_,   "{:#06B}",    "0B10100101",  _91C  },
            { L_,   "{:#d}",      "165",         _91C  },
            { L_,   "{:#o}",      "0245",        _91C  },
            { L_,   "{:b}",       "10100101",    _91C  },
        ...
        static const struct {
            ...
            // negative value
            { L_,   L"{:#05x}",    L"0x0a5",       _91C  },
            { L_,   L"{:#05X}",    L"0X0A5",       _91C  },
            { L_,   L"{:#0x}",     L"0xa5",        _91C  },
            { L_,   L"{:#01x}",    L"0xa5",        _91C  },
            { L_,   L"{:#02x}",    L"0xa5",        _91C  },
            { L_,   L"{:#03x}",    L"0xa5",        _91C  },
            { L_,   L"{:#04x}",    L"0xa5",        _91C  },
            { L_,   L"{:#04X}",    L"0XA5",        _91C  },
            { L_,   L"{:#b}",      L"0b10100101",  _91C  },
            { L_,   L"{:#05b}",    L"0b10100101",  _91C  },
            { L_,   L"{:#06b}",    L"0b10100101",  _91C  },
            { L_,   L"{:#06B}",    L"0B10100101",  _91C  },
            { L_,   L"{:#d}",      L"165",         _91C  },
            { L_,   L"{:#o}",      L"0245",        _91C  },
            { L_,   L"{:b}",       L"10100101",    _91C  },
            { L_,   L"{:B}",       L"10100101",    _91C  },
            { L_,   L"{:d}",       L"165",         _91C  },
            { L_,   L"{:o}",       L"245",         _91C  },
            { L_,   L"{:x}",       L"a5",          _91C  },
        ...
        static const struct {
            ...
            //LINE  FORMAT     EXPECTED                        VALUE
            //----  ---------- -----------------------------   -----
            { L_,   "{:}",     { _91C,    0,   0,    0,   0 }, _91C   },
            { L_,   "{0:}",    { _92C,    0,   0,    0,   0 }, _92C   },
            { L_,   "{:*<4}",  { _93C,  '*', '*',  '*',   0 }, _93C   },
            { L_,   "{:*>4}",  { '*',   '*', '*', _94C,   0 }, _94C   },
            { L_,   "{:*^4}",  { '*',  _95C, '*',  '*',   0 }, _95C   },
            { L_,   "{:c}",    { _96C,    0,   0,    0,   0 }, _96C   },
            { L_,   "{:4c}",   { _97C,  ' ', ' ',  ' ',   0 }, _97C   },
        };
        ...
        static const struct {
            ...
            //LINE  FORMAT      EXPECTED                         VALUE
            //----  ----------- -----------------------------    -----
            { L_,   L"{:}",     { _91W,    0,   0,    0,   0 },  _91W   },
            { L_,   L"{0:}",    { _92W,    0,   0,    0,   0 },  _92W   },
            { L_,   L"{:*<4}",  { _93W,  '*', '*',  '*',   0 },  _93W   },
            { L_,   L"{:*>4}",  { '*',   '*', '*', _94W,   0 },  _94W   },
            { L_,   L"{:*^4}",  { '*',  _95W, '*',  '*',   0 },  _95W   },
            { L_,   L"{:c}",    { _96W,    0,   0,    0,   0 },  _96W   },
            { L_,   L"{:4c}",   { _97W,  ' ', ' ',  ' ',   0 },  _97W   },
        };
        ...
        static const struct {
            ...
            //LINE  FORMAT      EXPECTED                      VALUE
            //----  ----------- --------------------------    -----
            { L_,   L"{:}",     { 165,   0,   0,   0,   0 },  _91C   },
            { L_,   L"{0:}",    { 164,   0,   0,   0,   0 },  _92C   },
            { L_,   L"{:*<4}",  { 163, '*', '*', '*',   0 },  _93C   },
            { L_,   L"{:*>4}",  { '*', '*', '*', 162,   0 },  _94C   },
            { L_,   L"{:*^4}",  { '*', 161, '*', '*',   0 },  _95C   },
            { L_,   L"{:c}",    { 160,   0,   0,   0,   0 },  _96C   },
            { L_,   L"{:4c}",   { 159, ' ', ' ', ' ',   0 },  _97C   },
        };
