...
// ```
      ...
      case 2: {
        ...
        //    that do have a formatter in the standard library like `void *`,
        //    `const void *`, and `std::nullptr_t`.
        //
        // Plan:
        // 1. Verify that `std::formatter` instantiations for `void *`,
        //    `const void *`, and `std::nullptr_t` with `char` and `wchar_t`
...
#ifdef BSLS_LIBRARYFEATURES_HAS_CPP20_FORMAT
        ASSERT((
            !bslmf::IsAccessibleBaseOf<bsl::formatter<void *, char>,
                                       std::formatter<void *, char> >::value));
        ASSERT((!bslmf::IsAccessibleBaseOf<
                bsl::formatter<void *, wchar_t>,
                std::formatter<void *, wchar_t> >::value));

        ASSERT((!bslmf::IsAccessibleBaseOf<
                bsl::formatter<const void *, char>,
                std::formatter<const void *, char> >::value));
        ASSERT((!bslmf::IsAccessibleBaseOf<
                bsl::formatter<const void *, wchar_t>,
                std::formatter<const void *, wchar_t> >::value));

        ASSERT((!bslmf::IsAccessibleBaseOf<
                bsl::formatter<std::nullptr_t, char>,
                std::formatter<std::nullptr_t, char> >::value));
        ASSERT((!bslmf::IsAccessibleBaseOf<
                bsl::formatter<std::nullptr_t, wchar_t>,
                std::formatter<std::nullptr_t, wchar_t> >::value));
#endif  // BSLS_LIBRARYFEATURES_HAS_CPP20_FORMAT
      } break;
      case 1: {
        // --------------------------------------------------------------------
     ...
     defined(BSLS_LIBRARYFEATURES_HAS_CPP26_BASELINE_LIBRARY)
        ...
        static const struct {
            ...
            { L_,   "{:P}",      "0X0",            nullPtr,   oracleRequired },
            { L_,   "{0:P}",     "0X0",            nullPtr,   oracleRequired },
            ...
            { L_,   "{:*>12p}",  "*********0x0",   nullPtr,   true           },
            { L_,   "{:*<12p}",  "0x0*********",   nullPtr,   true           },
            { L_,   "{:*^12P}",  "****0X0*****",   nullPtr,   oracleRequired },
            { L_,   "{:*>12P}",  "*********0X0",   nullPtr,   oracleRequired },
            { L_,   "{:*^12P}",  "****0X0*****",   nullPtr,   oracleRequired },
            ...
            { L_,   "{:P}",      "0X13579BDF",     ptr,       oracleRequired },
            { L_,   "{0:P}",     "0X13579BDF",     ptr,       oracleRequired },
            ...
            { L_,   "{:*>12p}",  "**0x13579bdf",   ptr,       true           },
            { L_,   "{:*^12p}",  "*0x13579bdf*",   ptr,       true           },
            { L_,   "{:*<12P}",  "0X13579BDF**",   ptr,       oracleRequired },
            { L_,   "{:*>12P}",  "**0X13579BDF",   ptr,       oracleRequired },
            { L_,   "{:*^12P}",  "*0X13579BDF*",   ptr,       oracleRequired },
        };
        ...
        static const struct {
            ...
            { L_,   L"{:P}",     L"0X0",           nullPtr,   oracleRequired },
            { L_,   L"{0:P}",    L"0X0",           nullPtr,   oracleRequired },
            ...
            { L_,   L"{:*>12p}", L"*********0x0",  nullPtr,   true           },
            { L_,   L"{:*^12p}", L"****0x0*****",  nullPtr,   true           },
            { L_,   L"{:*<12P}", L"0X0*********",  nullPtr,   oracleRequired },
            { L_,   L"{:*>12P}", L"*********0X0",  nullPtr,   oracleRequired },
            { L_,   L"{:*^12P}", L"****0X0*****",  nullPtr,   oracleRequired },
            ...
            { L_,   L"{:P}",     L"0X13579BDF",    ptr,       oracleRequired },
            { L_,   L"{0:P}",    L"0X13579BDF",    ptr,       oracleRequired },
            ...
            { L_,   L"{:*>12p}", L"**0x13579bdf",  ptr,       true           },
            { L_,   L"{:*^12p}", L"*0x13579bdf*",  ptr,       true           },
            { L_,   L"{:*<12P}", L"0X13579BDF**",  ptr,       oracleRequired },
            { L_,   L"{:*>12P}", L"**0X13579BDF",  ptr,       oracleRequired },
            { L_,   L"{:*^12P}", L"*0X13579BDF*",  ptr,       oracleRequired },
        };
