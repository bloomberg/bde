// bcefi_vfunc6.t.cpp              -*-C++-*-

#include <bcefi_vfunc6.h>
...
// non-'const' member function for every 'bcefi_Vfunc6MN' class.  Also, verify
...
//  'c_O'     for 'const OBJ'
//-----------------------------------------------------------------------------
// 'bcefi_Vfunc6Null' methods:
// [ 6] bcefi_Vfunc6Null<A1u4>(ba *);
// [ 6] void execute<A1-6>(c_A1-6&) const;
// [ 6] ~bcefi_Vfunc6Null<A1-6>();
//-----------------------------------------------------------------------------
// 'bcefi_Vfunc6F6' methods:
// [ 6] bcefi_Vfunc6F6<F, A1-6>(c_F&, ba *);
// [ 6] void execute<F, A1-6>(c_A1-6&) const;
// [ 6] ~bcefi_Vfunc6F6<F, A1-6>();
// ----------------------------------------------------------------------------
// 'bcefi_Vfunc6C6' methods:
// [ 6] bcefi_Vfunc6C6<OBJ, C, A1-6>( OBJ *, c_C&, ba *);
// [ 6] void execute<OBJ, C, A1-6>(c_A1-6&) const;
// [ 6] ~bcefi_Vfunc6C6<OBJ, C, A1-6>();
// ----------------------------------------------------------------------------
// 'bcefi_Vfunc6M6' methods:
// [ 6] bcefi_Vfunc6M6<OBJ, M, A1-6>( OBJ *, c_M&, a *);
// [ 6] void execute<OBJ, M, A1-6>(c_A1-6&) const;
// [ 6] ~bcefi_Vfunc6M6<OBJ, M, A1-6>();
//-----------------------------------------------------------------------------
// 'bcefi_Vfunc6F7' methods:
// [ 7] bcefi_Vfunc6F7<F, A1-6, D1>(c_F&, c_D1&, ba *);
// [ 7] void execute<F, A1-6, D1>(c_A1-6&) const;
// [ 7] ~bcefi_Vfunc6F7<F, A1-6, D1>();
// ----------------------------------------------------------------------------
// 'bcefi_Vfunc6C7' methods:
// [ 7] bcefi_Vfunc6C7<OBJ, C, A1-6, D1>( OBJ *, c_C&, c_D1&, ba *);
// [ 7] void execute<OBJ, C, A1-6, D1>(c_A1-6&) const;
// [ 7] ~bcefi_Vfunc6C7<OBJ, C, A1-6, D1>();
// ----------------------------------------------------------------------------
// 'bcefi_Vfunc6M7' methods:
// [ 7] bcefi_Vfunc6M7<OBJ, M, A1-6, D1>( OBJ *, c_M&, c_D1, ba *);
// [ 7] void execute<OBJ, M, A1-6, D1>(c_A1-6&) const;
// [ 7] ~bcefi_Vfunc6M7<OBJ, M, A1-6, D1>();
//-----------------------------------------------------------------------------
// 'bcefi_Vfunc6F8' methods:
// [ 8] bcefi_Vfunc6F8<F, A1-6, D1-2>(c_F&, c_D1-2&, ba *);
// [ 8] void execute<F, A1-6, D1-2>(c_A1-6&) const;
// [ 8] ~bcefi_Vfunc6F8<F, A1-6, D1-2>();
// ----------------------------------------------------------------------------
// 'bcefi_Vfunc6C8' methods:
// [ 8] bcefi_Vfunc6C8<OBJ, C, A1-6, D1-2>( OBJ *, c_C&, c_D1-2&, ba *);
// [ 8] void execute<OBJ, C, A1-6, D1-2>(c_A1-6&) const;
// [ 8] ~bcefi_Vfunc6C8<OBJ, C, A1-6, D1-2>();
// ----------------------------------------------------------------------------
// 'bcefi_Vfunc6M8' methods:
// [ 8] bcefi_Vfunc6M8<OBJ, M, A1-6, D1-2>( OBJ *, c_M&, c_D1-2, ba *);
// [ 8] void execute<OBJ, M, A1-6, D1-2>(c_A1-6&) const;
// [ 8] ~bcefi_Vfunc6M8<OBJ, M, A1-6, D1-2>();
//-----------------------------------------------------------------------------
// 'bcefi_Vfunc6F9' methods:
// [ 9] bcefi_Vfunc6F9<F, A1-6, D1-3>(c_F&, c_D1-3&, ba *);
// [ 9] void execute<F, A1-6, D1-3>(c_A1-6&) const;
// [ 9] ~bcefi_Vfunc6F9<F, A1-6, D1-3>();
// ----------------------------------------------------------------------------
// 'bcefi_Vfunc6C9' methods:
// [ 9] bcefi_Vfunc6C9<OBJ, C, A1-6, D1-3>( OBJ *, c_C&, c_D1-3&, ba *);
// [ 9] void execute<OBJ, C, A1-6, D1-3>(c_A1-6&) const;
// [ 9] ~bcefi_Vfunc6C9<OBJ, C, A1-6, D1-3>();
// ----------------------------------------------------------------------------
// 'bcefi_Vfunc6M9' methods:
// [ 9] bcefi_Vfunc6M9<OBJ, M, A1-6, D1-3>( OBJ *, c_M&, c_D1-3, ba *);
// [ 9] void execute<OBJ, M, A1-6, D1-3>(c_A1-6&) const;
// [ 9] ~bcefi_Vfunc6M9<OBJ, M, A1-6, D1-3>();
//-----------------------------------------------------------------------------
// [11] USAGE EXAMPLE
...
//       // that 'bcefi_vfunc6X4' classes pass when calling the callback
//       // function.
//       //
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 10: {
        ...
        //   'pragma' in 'bcefi_vfunc6.h' fixes this problem.  This test
...

        {
            ...
            typedef bcefr_Vfunc6<rrr *, rrr *, rrr *, rrr *,
                                 rrr *, rrr *> ObjBase;

            typedef bcefi_Vfunc6F9<CbFuncF9,
                                       rrr *, rrr *, rrr *, rrr *,
                                       rrr *, rrr *, rrr *, rrr *, rrr *> Obj1;

            typedef bcefi_Vfunc6F9<CbFuncF10,
                                       rrr *, rrr *, rrr *, rrr *,
      ...
      case 9: {
        ...
        //       functions by 'bcefi_Vfunc6M9' instances.
        //    5. Destructor of each class under test is properly executed.
        //
        // Plan:
        //   Create objects of every 'bcefi_Vfunc6X9' class.  Initialize
        //   'bcefi_Vfunc6F9' to have 'checkArgumentValues9' as the callback
        //   function.  Initialize 'bcefi_Vfunc6C9' and 'bcefi_Vfunc6M9' to
        //   have 'checkArgumentValues9' method of the 'CbClass' class as the
        //   callback function.  Call the 'execute' method for each
        //   'bcefi_Vfunc6X9' class.  The arguments in this call are
        ...
        //
        //   Create objects of every 'bcefi_Vfunc6X9' class.  Initialize
        //   'bcefi_Vfunc6F9' to have 'checkParameterTypes9' as the callback
        //   function.  Initialize 'bcefi_Vfunc6C9' to have
        //   'checkParameterTypesC9' method of the 'CbClass' class as the
        //   callback function.  Initialize 'bcefi_Vfunc6M9' to have
        //   'checkParameterTypesM9' method of the 'CbClass' class as the
        //   callback function.  The latter will test wether the
        //   'bcefi_Vfunc6M9' can have non-'const' functions as the callback
        //   function.
        //
        //   Having a function of 'checkParameterTypes' family as a callback
        //   function forces 'bcefi_Vfunc6X9' to be templatized so that each
        ...
        // Testing:
        //   'bcefi_Vfunc6F9' methods:
        //   bcefi_Vfunc6F9<F, A1-6, D1-3>(c_F&, c_D1-3&, ba *);
        //   void execute<F, A1-6, D1-3>(c_A1-6&) const;
        //   ~bcefi_Vfunc6F9<F, A1-6, D1-3>();
        // --------------------------------------------------------------------
        //   'bcefi_Vfunc6C9' methods:
        //   bcefi_Vfunc6C9<OBJ, C, A1-6, D1-3>( OBJ *, c_C&, c_D1-3&, ba *);
        //   void execute<OBJ, C, A1-6, D1-3>(c_A1-6&) const;
        //   ~bcefi_Vfunc6C9<OBJ, C, A1-6, D1-3>();
        // --------------------------------------------------------------------
        //   'bcefi_Vfunc6M9' methods:
        //   bcefi_Vfunc6M9<OBJ, M, A1-6, D1-3>( OBJ *, c_M&, c_D1-3, ba *);
        //    void execute<OBJ, M, A1-6, D1-3>(c_A1-6&) const;
        //   ~bcefi_Vfunc6M9<OBJ, M, A1-6, D1-3>();
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting constructors and argument values." << endl;
        {
            ...
            typedef void (CbClass::*CbFuncC9)(int *, int *, int *, int *,
                                              int *, int *, int *, int *,
                                              int *) const;
            typedef bcefr_Vfunc6<int *, int *, int *, int *,
                                 int *, int *> ObjBase;
            ...
            if (verbose) cout << "\t'bcefi_Vfunc6F9' object." << endl;
            {
                typedef bcefi_Vfunc6F9<CbFuncF9,
                                       int *, int *, int *, int *,
            ...
            if (verbose) cout << "\t'bcefi_Vfunc6C9' object." << endl;
            {
                typedef bcefi_Vfunc6C9<CbClass, CbFuncC9, int *, int *,
                                       int *, int *, int *, int *, int *,
                                       int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
            ...
            if (verbose) cout << "\t'bcefi_Vfunc6M9' object." << endl;
            {
                typedef bcefi_Vfunc6M9<CbClass, CbFuncC9,
                                       int *, int *, int *, int *,
                                       int *, int *, int *, int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
            ...
            cout << "\nTesting parameter types and destructors." << endl;
        {
            ...
            typedef void (CbClass::*CbFuncM9)(T1, T2, T3, T4, T5, T6, T7, T8,
                                              T9);
            typedef bcefr_Vfunc6<T1, T2, T3, T4, T5, T6> ObjBase;
            ...
            if (verbose)
                cout << "\tWhen calling 'bcefi_Vfunc6F9' 'execute' method."
                     << endl;
            {
                typedef bcefi_Vfunc6F9<CbFuncF9, T1, T2, T3, T4, T5, T6, T7,
                                       T8, T9> Obj;
                dcEnabled = 0;
            ...
            if (verbose)
                cout << "\tWhen calling 'bcefi_Vfunc6C9' 'execute' method."
                     << endl;
            {
                typedef bcefi_Vfunc6C9<CbClass, CbFuncC9, T1, T2,
            ...
            if (verbose)
                cout << "\tWhen calling 'bcefi_Vfunc6M9' 'execute' method."
                     << endl;
            {
                typedef bcefi_Vfunc6M9<CbClass, CbFuncM9, T1, T2, T3, T4,
                                       T5, T6, T7, T8, T9> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG6;
                numDeallocations = ta.numDeallocation();
      ...
      case 8: {
        ...
        //       those intended as argument types for the function parameters.
        //    4. Non-'const' member functions can be used as callback
        //       functions by 'bcefi_Vfunc6M8' instances.
        //    5. Destructor of each class under test is properly executed.
        //
        // Plan:
        //   Create objects of every 'bcefi_Vfunc6X8' class.  Initialize
        //   'bcefi_Vfunc6F8' to have 'checkArgumentValues8' as the callback
        //   function.  Initialize 'bcefi_Vfunc6C8' and 'bcefi_Vfunc6M8' to
        //   have 'checkArgumentValues8' method of the 'CbClass' class as the
        //   callback function.  Call the 'execute' method for each
        //   'bcefi_Vfunc6X8' class.  The arguments in this call are
        //   initialized with values of 'ARG1', 'ARG2', 'ARG3', 'ARG4',
        ...
        //
        //   Create objects of every 'bcefi_Vfunc6X8' class.  Initialize
        //   'bcefi_Vfunc6F8' to have 'checkParameterTypes8' as the callback
        //   function.  Initialize 'bcefi_Vfunc6C8' to have
        //   'checkParameterTypesC8' method of the 'CbClass' class as the
        //   callback function.  Initialize 'bcefi_Vfunc6M8' to have
        //   'checkParameterTypesM8' method of the 'CbClass' class as the
        //   callback function.  The latter will test wether the
        //   'bcefi_Vfunc6M8' can have non-'const' functions as the callback
        //   function.
        //
        //   Having a function of 'checkParameterTypes' family as a callback
        //   function forces 'bcefi_Vfunc6X8' to be templatized so that each
        //   argument to the callback function will be of unique type.  Hence,
        //   if the types of arguments passed in to the callback function is
        //   incorrect, the compiler will generate an error.
        //
        ...
        // Testing:
        //   'bcefi_Vfunc6F8' methods:
        //   bcefi_Vfunc6F8<F, A1-6, D1-3>(c_F&, c_D1-3&, ba *);
        //   void execute<F, A1-6, D1-3>(c_A1-6&) const;
        //   ~bcefi_Vfunc6F8<F, A1-6, D1-3>();
        // -------------------------------------------------------------------
        //   'bcefi_Vfunc6C8' methods:
        //   bcefi_Vfunc6C8<OBJ, C, A1-6, D1-3>( OBJ *, c_C&, c_D1-3&, ba *);
        //   void execute<OBJ, C, A1-6, D1-3>(c_A1-6&) const;
        //   ~bcefi_Vfunc6C8<OBJ, C, A1-6, D1-3>();
        // --------------------------------------------------------------------
        //   'bcefi_Vfunc6M8' methods:
        //   bcefi_Vfunc6M8<OBJ, M, A1-6, D1-3>( OBJ *, c_M&, c_D1-3, ba *);
        //    void execute<OBJ, M, A1-6, D1-3>(c_A1-6&) const;
        //   ~bcefi_Vfunc6M8<OBJ, M, A1-6, D1-3>();
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting constructors and argument values." << endl;
        {
            ...
            if (verbose) cout << "\t'bcefi_Vfunc6F8' object." << endl;
            {
                typedef bcefi_Vfunc6F8<CbFuncF8,
                                       int *, int *, int *, int *,
                                       int *, int *, int *, int *> Obj;
            ...
            if (verbose) cout << "\t'bcefi_Vfunc6C8' object." << endl;
            {
                typedef bcefi_Vfunc6C8<CbClass, CbFuncC8, int *, int *,
                                       int *, int *, int *, int *,
                                       int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
            ...
            if (verbose) cout << "\t'bcefi_Vfunc6M8' object." << endl;
            {
                typedef bcefi_Vfunc6M8<CbClass, CbFuncC8,
                                       int *, int *, int *, int *,
                                       int *, int *, int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
            ...
            cout << "\nTesting parameter types and destructors." << endl;
        {
            ...
            if (verbose)
                cout << "\tWhen calling 'bcefi_Vfunc6F8' 'execute' method."
                     << endl;
            {
                typedef bcefi_Vfunc6F8<CbFuncF8, T1, T2, T3, T4, T5, T6, T7,
                                       T8> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG6;
                numDeallocations = ta.numDeallocation();
            ...
            if (verbose)
                cout << "\tWhen calling 'bcefi_Vfunc6C8' 'execute' method."
                     << endl;
            {
                typedef bcefi_Vfunc6C8<CbClass, CbFuncC8, T1, T2,
            ...
            if (verbose)
                cout << "\tWhen calling 'bcefi_Vfunc6M8' 'execute' method."
                     << endl;
            {
                typedef bcefi_Vfunc6M8<CbClass, CbFuncM8, T1, T2, T3, T4,
                                       T5, T6, T7, T8> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG6;
                numDeallocations = ta.numDeallocation();
      ...
      case 7: {
        ...
        //       those intended as argument types for the function parameters.
        //    4. Non-'const' member functions can be used as callback
        //       functions by 'bcefi_Vfunc6M7' instances.
        //    5. Destructor of each class under test is properly executed.
        //
        // Plan:
        //   Create objects of every 'bcefi_Vfunc6X7' class.  Initialize
        //   'bcefi_Vfunc6F7' to have 'checkArgumentValues7' as the callback
        //   function.  Initialize 'bcefi_Vfunc6C7' and 'bcefi_Vfunc6M7' to
        //   have 'checkArgumentValues7' method of the 'CbClass' class as the
        //   callback function.  Call the 'execute' method for each
        //   'bcefi_Vfunc6X7' class.  The arguments in this call are
        //   initialized with values of 'ARG1', 'ARG2', 'ARG3', 'ARG4',
        ...
        //
        //   Create objects of every 'bcefi_Vfunc6X7' class.  Initialize
        //   'bcefi_Vfunc6F7' to have 'checkParameterTypes7' as the callback
        //   function.  Initialize 'bcefi_Vfunc6C7' to have
        //   'checkParameterTypesC7' method of the 'CbClass' class as the
        //   callback function.  Initialize 'bcefi_Vfunc6M7' to have
        //   'checkParameterTypesM7' method of the 'CbClass' class as the
        //   callback function.  The latter will test wether the
        //   'bcefi_Vfunc6M7' can have non-'const' functions as the callback
        //   function.
        //
        //   Having a function of 'checkParameterTypes' family as a callback
        //   function forces 'bcefi_Vfunc6X7' to be templatized so that each
        //   argument to the callback function will be of unique type.  Hence,
        //   if the types of arguments passed in to the callback function is
        //   incorrect, the compiler will generate an error.
        //
        ...
        // Testing:
        //   'bcefi_Vfunc6F7' methods:
        //   bcefi_Vfunc6F7<F, A1-6, D1-2>(c_F&, c_D1-2&, ba *);
        //   void execute<F, A1-6, D1-2>(c_A1-6&) const;
        //   ~bcefi_Vfunc6F7<F, A1-6, D1-2>();
        // --------------------------------------------------------------------
        //   'bcefi_Vfunc6C7' methods:
        //   bcefi_Vfunc6C7<OBJ, C, A1-6, D1-2>( OBJ *, c_C&, c_D1-2&, ba *);
        //   void execute<OBJ, C, A1-6, D1-2>(c_A1-6&) const;
        //   ~bcefi_Vfunc6C7<OBJ, C, A1-6, D1-2>();
        // --------------------------------------------------------------------
        //   'bcefi_Vfunc6M7' methods:
        //   bcefi_Vfunc6M7<OBJ, M, A1-6, D1-2>( OBJ *, c_M&, c_D1-2, ba *);
        //   void execute<OBJ, M, A1-6, D1-2>(c_A1-6&) const;
        //   ~bcefi_Vfunc6M7<OBJ, M, A1-6, D1-2>();
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting constructors and argument values." << endl;
        {
            ...
            if (verbose) cout << "\t'bcefi_Vfunc6F7' object." << endl;
            {
                typedef bcefi_Vfunc6F7<CbFuncF7,
                                       int *, int *, int *,
                                       int *, int *, int *, int *> Obj;
            ...
            if (verbose) cout << "\t'bcefi_Vfunc6C7' object." << endl;
            {
                typedef bcefi_Vfunc6C7<CbClass, CbFuncC7, int *,
                                       int *, int *, int *, int *,
                                       int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
            ...
            if (verbose) cout << "\t'bcefi_Vfunc6M7' object." << endl;
            {
                typedef bcefi_Vfunc6M7<CbClass, CbFuncC7,
                                       int *, int *, int *,
                                       int *, int *, int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
            ...
            cout << "\nTesting parameter types and destructors." << endl;
        {
            ...
            if (verbose)
                cout << "\tWhen calling 'bcefi_Vfunc6F7' 'execute' method."
                     << endl;
            {
                typedef bcefi_Vfunc6F7<CbFuncF7, T1, T2, T3, T4, T5, T6,
                                       T7> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG6;
                numDeallocations = ta.numDeallocation();
            ...
            if (verbose)
                cout << "\tWhen calling 'bcefi_Vfunc6C7' 'execute' method."
                     << endl;
            {
                typedef bcefi_Vfunc6C7<CbClass, CbFuncC7, T1, T2,
                                       T3, T4, T5, T6, T7> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG6;
                numDeallocations = ta.numDeallocation();
            ...
            if (verbose)
                cout << "\tWhen calling 'bcefi_Vfunc6M7' 'execute' method."
                     << endl;
            {
                typedef bcefi_Vfunc6M7<CbClass, CbFuncM7, T1, T2, T3, T4,
                                       T5, T6, T7> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG6;
                numDeallocations = ta.numDeallocation();
      ...
      case 6: {
        ...
        //       those intended as argument types for the function parameters.
        //    4. Non-'const' member functions can be used as callback
        //       functions by 'bcefi_Vfunc6M6' instances.
        //    5. Destructor of each class under test is properly executed.
        //
        // Plan:
        //   Create objects of every 'bcefi_Vfunc6X6' class.  Initialize
        //   'bcefi_Vfunc6F6' to have 'checkArgumentValues6' as the callback
        //   function.  Initialize 'bcefi_Vfunc6C6' and 'bcefi_Vfunc6M6' to
        //   have 'checkArgumentValues6' method of the 'CbClass' class as the
        //   callback function.  Call the 'execute' method for each
        //   'bcefi_Vfunc6X6' class.  The arguments in this call are
        //   initialized with values of 'ARG1', 'ARG2', 'ARG3', 'ARG4',
        ...
        //
        //   Create objects of every 'bcefi_Vfunc6X6' class.  Initialize
        //   'bcefi_Vfunc6F6' to have 'checkParameterTypes6' as the callback
        //   function.  Initialize 'bcefi_Vfunc6C6' to have
        //   'checkParameterTypesC6' method of the 'CbClass' class as the
        //   callback function.  Initialize 'bcefi_Vfunc6M6' to have
        //   'checkParameterTypesM6' method of the 'CbClass' class as the
        //   callback function.  The latter will test wether the
        //   'bcefi_Vfunc6M6' can have non-'const' functions as the callback
        //   function.
        //
        //   Having a function of 'checkParameterTypes' family as a callback
        //   function forces 'bcefi_Vfunc6X6' to be templatized so that each
        //   argument to the callback function will be of unique type.  Hence,
        //   if the types of arguments passed in to the callback function is
        //   incorrect, the compiler will generate an error.
        //
        ...
        // Testing:
        //   'bcefi_Vfunc6F6' methods:
        //   bcefi_Vfunc6F6<F, A1-6, D1>(c_F&, c_D1&, ba *);
        //   void execute<F, A1-6, D1>(c_A1-6&) const;
        //   ~bcefi_Vfunc6F6<F, A1-6, D1>();
        // --------------------------------------------------------------------
        //   'bcefi_Vfunc6C6' methods:
        //   bcefi_Vfunc6C6<OBJ, C, A1-6, D1-2>( OBJ *, c_C&, c_D1-2&, ba *);
        //   void execute<OBJ, C, A1-6, D1-2>(c_A1-6&) const;
        //   ~bcefi_Vfunc6C6<OBJ, C, A1-6, D1-2>();
        // --------------------------------------------------------------------
        //   'bcefi_Vfunc6M6' methods:
        //   bcefi_Vfunc6M6<OBJ, M, A1-6, D1-2>( OBJ *, c_M&, c_D1-2, ba *);
        //    void execute<OBJ, M, A1-6, D1-2>(c_A1-6&) const;
        //   ~bcefi_Vfunc6M6<OBJ, M, A1-6, D1-2>();
        // --------------------------------------------------------------------
        //   'bcefi_Vfunc6Null' methods:
        //   bcefi_Vfunc6Null<A1-6>(ba *);
        //   void execute<A1-6>(c_A1-6&) const;
        //   ~bcefi_Vfunc6Null<A1-6>();
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting constructors and argument values." << endl;
        {
            ...
            if (verbose) cout << "\t'bcefi_Vfunc6F6' object." << endl;
            {
                typedef bcefi_Vfunc6F6<CbFuncF6,
                                       int *, int *, int *,
                                       int *, int *, int *> Obj;
            ...
            if (verbose) cout << "\t'bcefi_Vfunc6C6' object." << endl;
            {
                typedef bcefi_Vfunc6C6<CbClass, CbFuncC6, int *,
                                       int *, int *, int *,
                                       int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
            ...
            if (verbose) cout << "\t'bcefi_Vfunc6M6' object." << endl;
            {
                typedef bcefi_Vfunc6M6<CbClass, CbFuncC6,
                                       int *, int *, int *,
                                       int *, int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
            ...
            cout << "\nTesting parameter types and destructors." << endl;
        {
            ...
            if (verbose)
                cout << "\tWhen calling 'bcefi_Vfunc6F6' 'execute' method."
                     << endl;
            {
                typedef bcefi_Vfunc6F6<CbFuncF6, T1, T2, T3, T4, T5, T6> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG6;
                numDeallocations = ta.numDeallocation();
            ...
            if (verbose)
                cout << "\tWhen calling 'bcefi_Vfunc6C6' 'execute' method."
                     << endl;
            {
                typedef bcefi_Vfunc6C6<CbClass, CbFuncC6, T1, T2,
                                       T3, T4, T5, T6> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG6;
                numDeallocations = ta.numDeallocation();
            ...
            if (verbose)
                cout << "\tWhen calling 'bcefi_Vfunc6M6' 'execute' method."
                     << endl;
            {
                typedef bcefi_Vfunc6M6<CbClass, CbFuncM6, T1, T2, T3, T4,
                                       T5, T6> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG6;
                numDeallocations = ta.numDeallocation();
            ...
            if (verbose)
                cout << "\nTesting bcefi_Vfunc6Null object." << endl;
            {
                destructorCheck = DESTRUCTOR_FLAG6;
                numDeallocations = ta.numDeallocation();

                typedef bcefi_Vfunc6Null<T1, T2, T3, T4, T5, T6> Obj;
