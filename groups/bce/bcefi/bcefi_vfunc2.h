...
class bcefi_Vfunc2Null : public bcefr_Vfunc2<A1, A2> {
  ...
  public:
    // CREATORS
    bcefi_Vfunc2Null(bslma::Allocator *basicAllocator);
...
class bcefi_Vfunc2F2 : public bcefr_Vfunc2<A1, A2> {
  ...
  public:
    // CREATORS
    bcefi_Vfunc2F2(F procedure, bslma::Allocator *basicAllocator);
        // Create a representation for a function object (functor) taking two
...
template <class A1, class A2>
inline
bcefi_Vfunc2Null<A1, A2>::bcefi_Vfunc2Null(bslma::Allocator*basicAllocator)
