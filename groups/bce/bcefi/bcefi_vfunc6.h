...
//
//@CLASSES:
// bcefi_Vfunc6Null: a 6-arg void no-op functor
//
// bcefi_Vfunc6F6: a 6-arg void functor created from a 6-arg function
// bcefi_Vfunc6F7: a 6-arg void functor created from a 7-arg function
// bcefi_Vfunc6F8: a 6-arg void functor created from a 8-arg function
// bcefi_Vfunc6F9: a 6-arg void functor created from a 9-arg function
//
// bcefi_Vfunc6C6: a 6-arg void functor created from obj & 6-arg method
// bcefi_Vfunc6C7: a 6-arg void functor created from obj & 7-arg method
// bcefi_Vfunc6C8: a 6-arg void functor created from obj & 8-arg method
// bcefi_Vfunc6C9: a 6-arg void functor created from obj & 9-arg method
//
// bcefi_Vfunc6M6: a 6-arg void functor created from obj ptr & 6-arg method
// bcefi_Vfunc6M7: a 6-arg void functor created from obj ptr & 7-arg method
// bcefi_Vfunc6M8: a 6-arg void functor created from obj ptr & 8-arg method
// bcefi_Vfunc6M9: a 6-arg void functor created from obj ptr & 9-arg method
//
...
// implementation of the base 'bcefr_Vfunc6' representation based on the
...
// then the "null functor" 'bcefi_Vfunc6Null' may be used.
//
///Language-Imposed Details
///------------------------
// For practical reasons, this component must distinguish among four types of
// functors.  The first type is a "null functor" 'bcefi_Vfunc6Null', which
...
// implementations are named 'bcefi_Vfunc6XN' where 'X' is one of 'F', 'C', or
...
//..
// Note that a 'const' member function may be wrapped by a 'bcefi_Vfunc6MN'
// functor, but wrapping a non-'const' method by a 'bcefi_Vfunc6CN' will
// result in compile time error in most compiler implementations.
//
// Note also that, to accommodate the preservation of 'const', the
// 'bcefi_Vfunc6CN' functors hold an object 'Obj', supplied by a 'const'
// 'Obj&' in the constructor, while 'bcefi_Vfunc6MN' functors hold a pointer
...
namespace BloombergLP {
                        ...
                        // ======================
                        // class bcefi_Vfunc6Null
                        // ======================

template <class A1, class A2, class A3, class A4, class A5, class A6>
class bcefi_Vfunc6Null : public bcefr_Vfunc6<A1, A2, A3, A4, A5, A6> {
    ...
    // NOT IMPLEMENTED
    bcefi_Vfunc6Null(const bcefi_Vfunc6Null<A1, A2, A3, A4, A5, A6>&);
    bcefi_Vfunc6Null<A1, A2, A3, A4, A5, A6>& operator=(
                     const bcefi_Vfunc6Null<A1, A2, A3, A4, A5, A6>&);
  ...
  public:
    ...
    bcefi_Vfunc6Null(bslma_Allocator *basicAllocator);
        ...
        // arguments, returning 'void', and performing no operation.
                        ...
                        // ====================
                        // class bcefi_Vfunc6F6
                        // ====================

template <class F, class A1, class A2, class A3, class A4, class A5, class A6>
class bcefi_Vfunc6F6 : public bcefr_Vfunc6<A1, A2, A3, A4, A5, A6> {
    // This class defines the representation for a function object (functor),
    ...
    bcefi_Vfunc6F6<F, A1, A2, A3, A4, A5, A6>& operator=(
                   const bcefi_Vfunc6F6<F, A1, A2, A3, A4, A5, A6>&);
  ...
  public:
    ...
    bcefi_Vfunc6F6(F procedure, bslma_Allocator *basicAllocator);
        ...
        // ignored.
                        ...
                        // ====================
                        // class bcefi_Vfunc6F7
                        // ====================

template <class F, class A1, class A2, class A3, class A4, class A5,
          class A6, class D1>
class bcefi_Vfunc6F7 : public bcefr_Vfunc6<A1, A2, A3, A4, A5, A6> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking six arguments and
    // returning 'void', that holds a pure procedure (i.e., free function,
    ...
    bcefi_Vfunc6F7<F, A1, A2, A3, A4, A5, A6, D1>& operator=(
                   const bcefi_Vfunc6F7<F, A1, A2, A3, A4, A5, A6, D1>&);
  ...
  public:
    ...
    bcefi_Vfunc6F7(F                procedure,
        ...
        // will be ignored.
                        ...
                        // ====================
                        // class bcefi_Vfunc6F8
                        // ====================

template <class F, class A1, class A2,
          class A3, class A4, class A5, class A6, class D1, class D2>
class bcefi_Vfunc6F8 : public bcefr_Vfunc6<A1, A2, A3, A4, A5, A6> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking six arguments and
    // returning 'void', that holds a pure procedure (i.e., free function,
    ...
    bcefi_Vfunc6F8<F, A1, A2, A3, A4, A5, A6, D1, D2>& operator=(
                   const bcefi_Vfunc6F8<F, A1, A2, A3, A4, A5, A6, D1, D2>&);
  ...
  public:
    ...
    bcefi_Vfunc6F8(F                procedure,
        ...
        // returned from 'procedure' will be ignored.
                        ...
                        // ====================
                        // class bcefi_Vfunc6F9
                        // ====================

template <class F, class A1, class A2,
          class A3, class A4, class A5, class A6,
          class D1, class D2, class D3>
class bcefi_Vfunc6F9 : public bcefr_Vfunc6<A1, A2, A3, A4, A5, A6> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking six arguments and
    // returning 'void', that holds a pure procedure (i.e., free function,
    // static member function, or functor) taking three additional trailing
    ...
    // NOT IMPLEMENTED
    bcefi_Vfunc6F9(
                 const bcefi_Vfunc6F9<F, A1, A2, A3, A4, A5, A6, D1, D2, D3>&);
    bcefi_Vfunc6F9<F, A1, A2, A3, A4, A5, A6, D1, D2, D3>& operator=(
                 const bcefi_Vfunc6F9<F, A1, A2, A3, A4, A5, A6, D1, D2, D3>&);
  ...
  public:
    ...
    bcefi_Vfunc6F9(F                procedure,
        ...
        // be ignored.
                        ...
                        // ====================
                        // class bcefi_Vfunc6C6
                        // ====================

template <class OBJ, class C, class A1, class A2,
          class A3, class A4, class A5, class A6>
class bcefi_Vfunc6C6 : public bcefr_Vfunc6<A1, A2, A3, A4, A5, A6> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking six arguments and
    ...
    bcefi_Vfunc6C6<OBJ, C, A1, A2, A3, A4, A5, A6>& operator=(
                   const bcefi_Vfunc6C6<OBJ, C, A1, A2, A3, A4, A5, A6>&);
  ...
  public:
    ...
    bcefi_Vfunc6C6(const OBJ&       object,
        ...
        // Note that any value returned from 'method' will be ignored.
                        ...
                        // ====================
                        // class bcefi_Vfunc6C7
                        // ====================

template <class OBJ, class C, class A1, class A2,
          class A3, class A4, class A5, class A6, class D1>
class bcefi_Vfunc6C7 : public bcefr_Vfunc6<A1, A2, A3, A4, A5, A6> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking six arguments and
    // returning 'void', that holds an object and one of that object's 'const'
    ...
    bcefi_Vfunc6C7<OBJ, C, A1, A2, A3, A4, A5, A6, D1>& operator=(
                   const bcefi_Vfunc6C7<OBJ, C, A1, A2, A3, A4, A5, A6, D1>&);
  ...
  public:
    ...
    bcefi_Vfunc6C7(const OBJ&       object,
        ...
        // memory.  Note that any value returned from 'method' will be ignored.
                        ...
                        // ====================
                        // class bcefi_Vfunc6C8
                        // ====================

template <class OBJ, class C, class A1, class A2,
          class A3, class A4, class A5, class A6,
          class D1, class D2>
class bcefi_Vfunc6C8 : public bcefr_Vfunc6<A1, A2, A3, A4, A5, A6> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking six arguments and
    // returning 'void', that holds an object and one of that object's 'const'
    ...
    // NOT IMPLEMENTED
    bcefi_Vfunc6C8(
                const bcefi_Vfunc6C8<OBJ, C, A1, A2, A3, A4, A5, A6, D1, D2>&);
    bcefi_Vfunc6C8<OBJ, C, A1, A2, A3, A4, A5, A6, D1, D2>& operator=(
                const bcefi_Vfunc6C8<OBJ, C, A1, A2, A3, A4, A5, A6, D1, D2>&);
  ...
  public:
    // CREATORS
    bcefi_Vfunc6C8(const OBJ&       object,
                   C                method,
                   const D1&        embeddedArg1,
                   const D2&        embeddedArg2,
                   bslma_Allocator *basicAllocator);
        ...
        // from 'method' will be ignored.
                        ...
                        // ====================
                        // class bcefi_Vfunc6C9
                        // ====================

template <class OBJ, class C, class A1, class A2,
          class A3, class A4, class A5, class A6,
          class D1, class D2, class D3>
class bcefi_Vfunc6C9 : public bcefr_Vfunc6<A1, A2, A3, A4, A5, A6> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking six arguments and
    // returning 'void', that holds an object and one of that object's 'const'
    // member functions taking three additional trailing arguments, and the
    ...
    // NOT IMPLEMENTED
    bcefi_Vfunc6C9(
            const bcefi_Vfunc6C9<OBJ, C, A1, A2, A3, A4, A5, A6, D1, D2, D3>&);
    bcefi_Vfunc6C9<OBJ, C, A1, A2, A3, A4, A5, A6, D1, D2, D3>& operator=(
            const bcefi_Vfunc6C9<OBJ, C, A1, A2, A3, A4, A5, A6, D1, D2, D3>&);
  ...
  public:
    // CREATORS
    bcefi_Vfunc6C9(const OBJ&       object,
                   C                method,
                   const D1&        embeddedArg1,
                   const D2&        embeddedArg2,
                   const D3&        embeddedArg3,
        ...
        // returned from 'method' will be ignored.
                        ...
                        // ====================
                        // class bcefi_Vfunc6M6
                        // ====================

template <class OBJ, class M, class A1, class A2,
          class A3, class A4, class A5, class A6>
class bcefi_Vfunc6M6 : public bcefr_Vfunc6<A1, A2, A3, A4, A5, A6> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking six arguments and
    ...
    // NOT IMPLEMENTED
    bcefi_Vfunc6M6(const bcefi_Vfunc6M6<OBJ, M, A1, A2, A3, A4, A5, A6>&);
    bcefi_Vfunc6M6<OBJ, M, A1, A2, A3, A4, A5, A6>& operator=(
                   const bcefi_Vfunc6M6<OBJ, M, A1, A2, A3, A4, A5, A6>&);
  ...
  public:
    ...
    bcefi_Vfunc6M6(OBJ             *object,
        ...
        // from 'method' will be ignored.
                        ...
                        // ====================
                        // class bcefi_Vfunc6M7
                        // ====================

template <class OBJ, class M, class A1, class A2,
          class A3, class A4, class A5, class A6, class D1>
class bcefi_Vfunc6M7 : public bcefr_Vfunc6<A1, A2, A3, A4, A5, A6> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking six arguments and
    // returning 'void', that holds the address of an object and one of that
    ...
    bcefi_Vfunc6M7<OBJ, M, A1, A2, A3, A4, A5, A6, D1>& operator=(
                   const bcefi_Vfunc6M7<OBJ, M, A1, A2, A3, A4, A5, A6, D1>&);
  ...
  public:
    ...
    bcefi_Vfunc6M7(OBJ             *object,
        ...
        // returned from 'method' will be ignored.
                        ...
                        // ====================
                        // class bcefi_Vfunc6M8
                        // ====================

template <class OBJ, class M, class A1, class A2,
          class A3, class A4, class A5, class A6,
          class D1, class D2>
class bcefi_Vfunc6M8 : public bcefr_Vfunc6<A1, A2, A3, A4, A5, A6> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking six arguments and
    // returning 'void', that holds the address of an object and one of that
    ...
    // NOT IMPLEMENTED
    bcefi_Vfunc6M8(
                const bcefi_Vfunc6M8<OBJ, M, A1, A2, A3, A4, A5, A6, D1, D2>&);
    bcefi_Vfunc6M8<OBJ, M, A1, A2, A3, A4, A5, A6, D1, D2>& operator=(
                const bcefi_Vfunc6M8<OBJ, M, A1, A2, A3, A4, A5, A6, D1, D2>&);
  ...
  public:
    ...
    bcefi_Vfunc6M8(OBJ             *object,
        ...
        // ignored
                        ...
                        // ====================
                        // class bcefi_Vfunc6M9
                        // ====================

template <class OBJ, class M, class A1, class A2,
          class A3, class A4, class A5, class A6,
          class D1, class D2, class D3>
class bcefi_Vfunc6M9 : public bcefr_Vfunc6<A1, A2, A3, A4, A5, A6> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking six arguments and
    // returning 'void', that holds the address of an object and one of that
    // object's ('const' or non-'const') member functions taking three
    ...
    // NOT IMPLEMENTED
    bcefi_Vfunc6M9(
            const bcefi_Vfunc6M9<OBJ, M, A1, A2, A3, A4, A5, A6, D1, D2, D3>&);
    bcefi_Vfunc6M9<OBJ, M, A1, A2, A3, A4, A5, A6, D1, D2, D3>& operator=(
            const bcefi_Vfunc6M9<OBJ, M, A1, A2, A3, A4, A5, A6, D1, D2, D3>&);
...
template <class A1, class A2, class A3, class A4, class A5, class A6>
inline
void bcefi_Vfunc6Null<A1, A2, A3, A4, A5, A6>::execute(const A1&,
                                                       const A2&,
                                                       const A3&,
                                                       const A4&,
                                                       const A5&,
...
template <class F, class A1, class A2, class A3, class A4, class A5, class A6>
inline
void bcefi_Vfunc6F6<F, A1, A2, A3, A4, A5, A6>::execute(
                                                   const A1& argument1,
                                                   const A2& argument2,
                                                   const A3& argument3,
                                                   const A4& argument4,
...
template <class F, class A1, class A2, class A3, class A4, class A5,
          class A6, class D1>
inline
void bcefi_Vfunc6F7<F, A1, A2, A3, A4, A5, A6, D1>::execute(
                                                   const A1& argument1,
                                                   const A2& argument2,
                                                   const A3& argument3,
                                                   const A4& argument4,
...
template <class F, class A1, class A2,
          class A3, class A4, class A5, class A6, class D1, class D2>
inline
bcefi_Vfunc6F8<F, A1, A2, A3, A4, A5, A6, D1, D2>::bcefi_Vfunc6F8(
                                             F                procedure,
                                             const D1&        embeddedArg1,
                                             const D2&        embeddedArg2,
                                             bslma_Allocator *basicAllocator)
...
template <class F, class A1, class A2,
          class A3, class A4, class A5, class A6, class D1, class D2>
inline
void bcefi_Vfunc6F8<F, A1, A2, A3, A4, A5, A6, D1, D2>::execute(
                                                   const A1& argument1,
                                                   const A2& argument2,
                                                   const A3& argument3,
                                                   const A4& argument4,
...
template <class F, class A1, class A2,
          ...
          class D1, class D2, class D3>
inline
bcefi_Vfunc6F9<F, A1, A2, A3, A4, A5, A6, D1, D2, D3>::bcefi_Vfunc6F9(
                                             F                procedure,
                                             const D1&        embeddedArg1,
                                             const D2&        embeddedArg2,
                                             const D3&        embeddedArg3,
...
template <class F, class A1, class A2, class A3, class A4, class A5, class A6,
          class D1, class D2, class D3>
inline
void bcefi_Vfunc6F9<F, A1, A2, A3, A4, A5, A6, D1, D2, D3>::execute(
                                                   const A1& argument1,
                                                   const A2& argument2,
                                                   const A3& argument3,
                                                   const A4& argument4,
...
template <class OBJ, class C, class A1, class A2,
          class A3, class A4, class A5, class A6>
inline
void bcefi_Vfunc6C6<OBJ, C, A1, A2, A3, A4, A5, A6>::execute(
                                                   const A1& argument1,
                                                   const A2& argument2,
                                                   const A3& argument3,
                                                   const A4& argument4,
...
template <class OBJ, class C, class A1, class A2,
          class A3, class A4, class A5, class A6, class D1>
inline
bcefi_Vfunc6C7<OBJ, C, A1, A2, A3, A4, A5, A6, D1>::bcefi_Vfunc6C7(
                                             const OBJ&       object,
                                             C                method,
                                             const D1&        embeddedArg1,
                                             bslma_Allocator *basicAllocator)
...
template <class OBJ, class C, class A1, class A2,
          class A3, class A4, class A5, class A6, class D1>
inline
void bcefi_Vfunc6C7<OBJ, C, A1, A2, A3, A4, A5, A6, D1>::execute(
                                                   const A1& argument1,
                                                   const A2& argument2,
                                                   const A3& argument3,
                                                   const A4& argument4,
...
template <class OBJ, class C, class A1, class A2,
          ...
          class D1, class D2>
inline
bcefi_Vfunc6C8<OBJ, C, A1, A2, A3, A4, A5, A6, D1, D2>::bcefi_Vfunc6C8(
                                             const OBJ&       object,
                                             C                method,
                                             const D1&        embeddedArg1,
                                             const D2&        embeddedArg2,
...
template <class OBJ, class C, class A1, class A2,
          ...
          class D1, class D2>
inline
void bcefi_Vfunc6C8<OBJ, C, A1, A2, A3, A4, A5, A6, D1, D2>::execute(
                                                   const A1& argument1,
                                                   const A2& argument2,
                                                   const A3& argument3,
                                                   const A4& argument4,
...
inline
bcefi_Vfunc6C9<OBJ, C, A1, A2, A3, A4, A5, A6, D1, D2, D3>::bcefi_Vfunc6C9(
                                             const OBJ&       object,
                                             C                method,
                                             const D1&        embeddedArg1,
                                             const D2&        embeddedArg2,
...
template <class OBJ, class C, class A1, class A2,
          class A3, class A4, class A5, class A6, class D1, class D2, class D3>
inline
void bcefi_Vfunc6C9<OBJ, C, A1, A2, A3, A4, A5, A6, D1, D2, D3>::execute(
                                                   const A1& argument1,
                                                   const A2& argument2,
                                                   const A3& argument3,
                                                   const A4& argument4,
...
template <class OBJ, class M, class A1, class A2,
          class A3, class A4, class A5, class A6>
inline
void bcefi_Vfunc6M6<OBJ, M, A1, A2, A3, A4, A5, A6>::execute(
                                                   const A1& argument1,
                                                   const A2& argument2,
                                                   const A3& argument3,
                                                   const A4& argument4,
...
template <class OBJ, class M, class A1, class A2,
          class A3, class A4, class A5, class A6, class D1>
inline
bcefi_Vfunc6M7<OBJ, M, A1, A2, A3, A4, A5, A6, D1>::bcefi_Vfunc6M7(
                                             OBJ             *object,
                                             M                method,
                                             const D1&        embeddedArg1,
                                             bslma_Allocator *basicAllocator)
...
template <class OBJ, class M, class A1, class A2,
          class A3, class A4, class A5, class A6, class D1>
inline
void bcefi_Vfunc6M7<OBJ, M, A1, A2, A3, A4, A5, A6, D1>::execute(
                                                   const A1& argument1,
                                                   const A2& argument2,
                                                   const A3& argument3,
                                                   const A4& argument4,
...
template <class OBJ, class M, class A1, class A2,
          ...
          class D1, class D2>
inline
bcefi_Vfunc6M8<OBJ, M, A1, A2, A3, A4, A5, A6, D1, D2>::bcefi_Vfunc6M8(
                                             OBJ             *object,
                                             M                method,
                                             const D1&        embeddedArg1,
                                             const D2&        embeddedArg2,
...
template <class OBJ, class M, class A1, class A2,
          ...
          class D1, class D2>
inline
void bcefi_Vfunc6M8<OBJ, M, A1, A2, A3, A4, A5, A6, D1, D2>::execute(
                                                   const A1& argument1,
                                                   const A2& argument2,
                                                   const A3& argument3,
                                                   const A4& argument4,
...
template <class OBJ, class M, class A1, class A2,
          ...
          class D1, class D2, class D3>
inline
bcefi_Vfunc6M9<OBJ, M, A1, A2, A3, A4, A5, A6, D1, D2, D3>::bcefi_Vfunc6M9(
                                             OBJ             *object,
                                             M                method,
                                             const D1&        embeddedArg1,
                                             const D2&        embeddedArg2,
...
template <class OBJ, class M, class A1, class A2,
          ...
          class D1, class D2, class D3>
inline
void bcefi_Vfunc6M9<OBJ, M, A1, A2, A3, A4, A5, A6, D1, D2, D3>::execute(
                                                   const A1& argument1,
                                                   const A2& argument2,
                                                   const A3& argument3,
                                                   const A4& argument4,
