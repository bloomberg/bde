// bcefi_vfunc0.t.cpp              -*-C++-*-

#include <bcefi_vfunc0.h>
...
// non-'const' member function for every 'bcefi_Vfunc0MN' class.  Also, verify
...
//  'c_O'     for 'const OBJ'
//-----------------------------------------------------------------------------
// [ 1] 'bcefi_Vfunc0Null' methods:
// [ 1] bcefi_Vfunc0Null(ba *);
// [ 1] void execute() const;
// [ 1] ~bcefi_Vfunc0Null();
// ----------------------------------------------------------------------------
// 'bcefi_Vfunc0F1' methods:
// [ 1] bcefi_Vfunc0F1<F>(c_F&, ba *);
// [ 1] void execute<F>() const;
// [ 1] ~bcefi_Vfunc0F1<F>();
// ----------------------------------------------------------------------------
// 'bcefi_Vfunc0C1' methods:
// [ 1] bcefi_Vfunc0C1<OBJ, C>( OBJ *, c_C&, ba *);
// [ 1] void execute<OBJ, C>() const;
// [ 1] ~bcefi_Vfunc0C1<OBJ, C>();
// ----------------------------------------------------------------------------
// 'bcefi_Vfunc0M1' methods:
// [ 1] bcefi_Vfunc0M1<OBJ, M>( OBJ *, c_M&, ba *);
// [ 1] void execute<OBJ, M>() const;
// [ 1] ~bcefi_Vfunc0M1<OBJ, M>();
// ----------------------------------------------------------------------------
// 'bcefi_Vfunc0F2' methods:
// [ 2] bcefi_Vfunc0F2<F, D1>(c_F&, c_D1&, ba *);
// [ 2] void execute<F, D1>() const;
// [ 2] ~bcefi_Vfunc0F2<F, D1>();
// ----------------------------------------------------------------------------
// 'bcefi_Vfunc0C2' methods:
// [ 2] bcefi_Vfunc0C2<OBJ, C, D1>( OBJ *, c_C&, c_D1&, ba *);
// [ 2] void execute<OBJ, C, D1>() const;
// [ 2] ~bcefi_Vfunc0C2<OBJ, C, D1>();
// ----------------------------------------------------------------------------
// 'bcefi_Vfunc0M2' methods:
// [ 2] bcefi_Vfunc0M2<OBJ, M, D1>( OBJ *, c_M&, c_D1&, ba *);
// [ 2] void execute<OBJ, M, D1>() const;
// [ 2] ~bcefi_Vfunc0M2<OBJ, M, D1>();
//-----------------------------------------------------------------------------
// 'bcefi_Vfunc0F3' methods:
// [ 3] bcefi_Vfunc0F3<F, D1-2>(c_F&, c_D1-2&, ba *);
// [ 3] void execute<F, D1-2>() const;
// [ 3] ~bcefi_Vfunc0F3<F, D1-2>();
// ----------------------------------------------------------------------------
// 'bcefi_Vfunc0C3' methods:
// [ 3] bcefi_Vfunc0C3<OBJ, C, D1-2>( OBJ *, c_C&, c_D1-2&, ba *);
// [ 3] void execute<OBJ, C, D1-2>() const;
// [ 3] ~bcefi_Vfunc0C3<OBJ, C, D1-2>();
// ----------------------------------------------------------------------------
// 'bcefi_Vfunc0M3' methods:
// [ 3] bcefi_Vfunc0M3<OBJ, M, D1-2>( OBJ *, c_M&, c_D1-2, ba *);
// [ 3] void execute<OBJ, M, D1-2>() const;
// [ 3] ~bcefi_Vfunc0M3<OBJ, M, D1-2>();
//-----------------------------------------------------------------------------
// 'bcefi_Vfunc0F4' methods:
// [ 4] bcefi_Vfunc0F4<F, D1-3>(c_F&, c_D1-3&, ba *);
// [ 4] void execute<F, D1-3>() const;
// [ 4] ~bcefi_Vfunc0F4<F, D1-3>();
// ----------------------------------------------------------------------------
// 'bcefi_Vfunc0C4' methods:
// [ 4] bcefi_Vfunc0C4<OBJ, C, D1-3>( OBJ *, c_C&, c_D1-3&, ba *);
// [ 4] void execute<OBJ, C, D1-3>() const;
// [ 4] ~bcefi_Vfunc0C4<OBJ, C, D1-3>();
// ----------------------------------------------------------------------------
// 'bcefi_Vfunc0M4' methods:
// [ 4] bcefi_Vfunc0M4<OBJ, M, D1-3>( OBJ *, c_M&, c_D1-3, ba *);
// [ 4] void execute<OBJ, M, D1-3>() const;
// [ 4] ~bcefi_Vfunc0M4<OBJ, M, D1-3>();
//-----------------------------------------------------------------------------
// 'bcefi_Vfunc0F5' methods:
// [ 5] bcefi_Vfunc0F5<F, D1-4>(c_F&, c_D1-4&, ba *);
// [ 5] void execute<F, D1-4>() const;
// [ 5] ~bcefi_Vfunc0F5<F, D1-4>();
// ----------------------------------------------------------------------------
// 'bcefi_Vfunc0C5' methods:
// [ 5] bcefi_Vfunc0C5<OBJ, C, D1-4>( OBJ *, c_C&, c_D1-4&, ba *);
// [ 5] void execute<OBJ, C, D1-4>() const;
// [ 5] ~bcefi_Vfunc0C5<OBJ, C, D1-4>();
// ----------------------------------------------------------------------------
// 'bcefi_Vfunc0M5' methods:
// [ 5] bcefi_Vfunc0M5<OBJ, M, D1-4>( OBJ *, c_M&, c_D1-4, ba *);
// [ 5] void execute<OBJ, M, D1-4>() const;
// [ 5] ~bcefi_Vfunc0M5<OBJ, M, D1-4>();
//-----------------------------------------------------------------------------
// 'bcefi_Vfunc0F6' methods:
// [ 6] bcefi_Vfunc0F6<F, D1-5>(c_F&, c_D1-5&, ba *);
// [ 6] void execute<F, D1-5>() const;
// [ 6] ~bcefi_Vfunc0F6<F, D1-5>();
// ----------------------------------------------------------------------------
// 'bcefi_Vfunc0C6' methods:
// [ 6] bcefi_Vfunc0C6<OBJ, C, D1-5>( OBJ *, c_C&, c_D1-5&, ba *);
// [ 6] void execute<OBJ, C, D1-5>() const;
// [ 6] ~bcefi_Vfunc0C6<OBJ, C, D1-5>();
// ----------------------------------------------------------------------------
// 'bcefi_Vfunc0M6' methods:
// [ 6] bcefi_Vfunc0M6<OBJ, M, D1-5>( OBJ *, c_M&, c_D1-5, ba *);
// [ 6] void execute<OBJ, M, D1-5>() const;
// [ 6] ~bcefi_Vfunc0M6<OBJ, M, D1-5>();
//-----------------------------------------------------------------------------
// 'bcefi_Vfunc0F7' methods:
// [ 7] bcefi_Vfunc0F7<F, D1-6>(c_F&, c_D1-6&, ba *);
// [ 7] void execute<F, D1-6>() const;
// [ 7] ~bcefi_Vfunc0F7<F, D1-6>();
// ----------------------------------------------------------------------------
// 'bcefi_Vfunc0C7' methods:
// [ 7] bcefi_Vfunc0C7<OBJ, C, D1-6>( OBJ *, c_C&, c_D1-6&, ba *);
// [ 7] void execute<OBJ, C, D1-6>() const;
// [ 7] ~bcefi_Vfunc0C7<OBJ, C, D1-6>();
// ----------------------------------------------------------------------------
// 'bcefi_Vfunc0M7' methods:
// [ 7] bcefi_Vfunc0M7<OBJ, M, D1-6>( OBJ *, c_M&, c_D1-6, ba *);
// [ 7] void execute<OBJ, M, D1-6>() const;
// [ 7] ~bcefi_Vfunc0M7<OBJ, M, D1-6>();
//-----------------------------------------------------------------------------
// 'bcefi_Vfunc0F8' methods:
// [ 8] bcefi_Vfunc0F8<F, D1-7>(c_F&, c_D1-7&, ba *);
// [ 8] void execute<F, D1-7>() const;
// [ 8] ~bcefi_Vfunc0F8<F, D1-7>();
// ----------------------------------------------------------------------------
// 'bcefi_Vfunc0C8' methods:
// [ 8] bcefi_Vfunc0C8<OBJ, C, D1-7>( OBJ *, c_C&, c_D1-7&, ba *);
// [ 8] void execute<OBJ, C, D1-7>() const;
// [ 8] ~bcefi_Vfunc0C8<OBJ, C, D1-7>();
// ----------------------------------------------------------------------------
// 'bcefi_Vfunc0M8' methods:
// [ 8] bcefi_Vfunc0M8<OBJ, M, D1-7>( OBJ *, c_M&, c_D1-7, ba *);
// [ 8] void execute<OBJ, M, D1-7>() const;
// [ 8] ~bcefi_Vfunc0M8<OBJ, M, D1-7>();
//-----------------------------------------------------------------------------
// 'bcefi_Vfunc0F9' methods:
// [ 9] bcefi_Vfunc0F9<F, D1-8>(c_F&, c_D1-8&, ba *);
// [ 9] void execute<F, D1-8>() const;
// [ 9] ~bcefi_Vfunc0F9<F, D1-8>();
// ----------------------------------------------------------------------------
// 'bcefi_Vfunc0C9' methods:
// [ 9] bcefi_Vfunc0C9<OBJ, C, D1-8>( OBJ *, c_C&, c_D1-8&, ba *);
// [ 9] void execute<OBJ, C, D1-8>() const;
// [ 9] ~bcefi_Vfunc0C9<OBJ, C, D1-8>();
// ----------------------------------------------------------------------------
// 'bcefi_Vfunc0M9' methods:
// [ 9] bcefi_Vfunc0M9<OBJ, M, D1-8>( OBJ *, c_M&, c_D1-8, ba *);
// [ 9] void execute<OBJ, M, D1-8>() const;
// [ 9] ~bcefi_Vfunc0M9<OBJ, M, D1-8>();
//-----------------------------------------------------------------------------
// [11] USAGE EXAMPLE
...
//       // that 'bcefi_vfunc0X4' classes pass when calling the callback
//       // function.
//       //
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      case 11: {
                          ...
                          << "=====================" << endl;
        {
            ...
            typedef bcefi_Vfunc0F4<MyFunctionPtr,
                        int, double, const char *, int> MyFunctorRep;
            bcefr_Vfunc0 *rep = new(ta) MyFunctorRep(
                                               myFunction, 1, 10, "3", 4, &ta);
            rep->execute();
            bcefr_Vfunc0::deleteObject(rep);
        }
      } break;
      case 10: {
        // --------------------------------------------------------------------
        ...
        //   'pragma' in 'bcefi_vfunc0.h' fixes this problem.  This test
...

        {
            ...
            typedef bcefr_Vfunc0 ObjBase;

            typedef bcefi_Vfunc0F9<CbFuncF9,
                                       rrr *, rrr *, rrr *, rrr *,
                                       rrr *, rrr *, rrr *, rrr *, rrr *> Obj1;

            typedef bcefi_Vfunc0F9<CbFuncF10,
                                       rrr *, rrr *, rrr *, rrr *,
      ...
      case 9: {
        ...
        //       functions by 'bcefi_Vfunc0M9' instances.
        //    5. Destructor of each class under test is properly executed.
        //
        // Plan:
        //   Create objects of every 'bcefi_Vfunc0X9' class.  Initialize
        //   'bcefi_Vfunc0F9' to have 'checkArgumentValues9' as the callback
        //   function.  Initialize 'bcefi_Vfunc0C9' and 'bcefi_Vfunc0M9' to
        //   have 'checkArgumentValues9' method of the 'CbClass' class as the
        //   callback function.  Call the 'execute' method for each
        //   'bcefi_Vfunc0X9' class.  The arguments in this call are
        ...
        //
        //   Create objects of every 'bcefi_Vfunc0X9' class.  Initialize
        //   'bcefi_Vfunc0F9' to have 'checkParameterTypes9' as the callback
        //   function.  Initialize 'bcefi_Vfunc0C9' to have
        //   'checkParameterTypesC9' method of the 'CbClass' class as the
        //   callback function.  Initialize 'bcefi_Vfunc0M9' to have
        //   'checkParameterTypesM9' method of the 'CbClass' class as the
        //   callback function.  The latter will test wether the
        //   'bcefi_Vfunc0M9' can have non-'const' functions as the callback
        //   function.
        //
        //   Having a function of 'checkParameterTypes' family as a callback
        //   function forces 'bcefi_Vfunc0X9' to be templatized so that each
        ...
        // Testing:
        //   'bcefi_Vfunc0F9' methods:
        //   bcefi_Vfunc0F9<F, D1-9>(c_F&, c_D1-9&, ba *);
        //   void execute<F, D1-9>() const;
        //   ~bcefi_Vfunc0F9<F, D1-9>();
        // --------------------------------------------------------------------
        //   'bcefi_Vfunc0C9' methods:
        //   bcefi_Vfunc0C9<OBJ, C, D1-9>( OBJ *, c_C&, c_D1-9&, ba *);
        //   void execute<OBJ, C, D1-9>() const;
        //   ~bcefi_Vfunc0C9<OBJ, C, D1-9>();
        // --------------------------------------------------------------------
        //   'bcefi_Vfunc0M9' methods:
        //   bcefi_Vfunc0M9<OBJ, M, D1-9>( OBJ *, c_M&, c_D1-9, ba *);
        //    void execute<OBJ, M, D1-9>() const;
        //   ~bcefi_Vfunc0M9<OBJ, M, D1-9>();
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting constructors and argument values." << endl;
        {
            ...
            if (verbose) cout << "\t'bcefi_Vfunc0F9' object." << endl;
            {
                typedef bcefi_Vfunc0F9<CbFuncF9,
                                       int *, int *, int *, int *,
            ...
            if (verbose) cout << "\t'bcefi_Vfunc0C9' object." << endl;
            {
                typedef bcefi_Vfunc0C9<CbClass, CbFuncC9, int *, int *,
                                       int *, int *, int *, int *, int *,
                                       int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
            ...
            if (verbose) cout << "\t'bcefi_Vfunc0M9' object." << endl;
            {
                typedef bcefi_Vfunc0M9<CbClass, CbFuncC9,
                                       int *, int *, int *, int *,
                                       int *, int *, int *, int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
            ...
            cout << "\nTesting parameter types and destructors." << endl;
        {
            ...
            if (verbose)
                cout << "\tWhen calling 'bcefi_Vfunc0F9' 'execute' method."
                     << endl;
            {
                typedef bcefi_Vfunc0F9<CbFuncF9, T1, T2, T3, T4, T5, T6, T7,
                                       T8, T9> Obj;
                dcEnabled = 0;
                destructorCheck = 0;
            ...
            if (verbose)
                cout << "\tWhen calling 'bcefi_Vfunc0C9' 'execute' method."
                     << endl;
            {
                typedef bcefi_Vfunc0C9<CbClass, CbFuncC9, T1, T2,
            ...
            if (verbose)
                cout << "\tWhen calling 'bcefi_Vfunc0M9' 'execute' method."
                     << endl;
            {
                typedef bcefi_Vfunc0M9<CbClass, CbFuncM9, T1, T2, T3, T4,
                                       T5, T6, T7, T8, T9> Obj;
                dcEnabled = 0;
                destructorCheck = 0;
                numDeallocations = ta.numDeallocation();
      ...
      case 8: {
        ...
        //       those intended as argument types for the function parameters.
        //    4. Non-'const' member functions can be used as callback
        //       functions by 'bcefi_Vfunc0M8' instances.
        //    5. Destructor of each class under test is properly executed.
        //
        // Plan:
        //   Create objects of every 'bcefi_Vfunc0X8' class.  Initialize
        //   'bcefi_Vfunc0F8' to have 'checkArgumentValues8' as the callback
        //   function.  Initialize 'bcefi_Vfunc0C8' and 'bcefi_Vfunc0M8' to
        //   have 'checkArgumentValues8' method of the 'CbClass' class as the
        //   callback function.  Call the 'execute' method for each
        //   'bcefi_Vfunc0X8' class.  The arguments in this call are
        //   initialized with values of 'ARG1', 'ARG2', 'ARG3', 'ARG4',
        ...
        //
        //   Create objects of every 'bcefi_Vfunc0X8' class.  Initialize
        //   'bcefi_Vfunc0F8' to have 'checkParameterTypes8' as the callback
        //   function.  Initialize 'bcefi_Vfunc0C8' to have
        //   'checkParameterTypesC8' method of the 'CbClass' class as the
        //   callback function.  Initialize 'bcefi_Vfunc0M8' to have
        //   'checkParameterTypesM8' method of the 'CbClass' class as the
        //   callback function.  The latter will test wether the
        //   'bcefi_Vfunc0M8' can have non-'const' functions as the callback
        //   function.
        //
        //   Having a function of 'checkParameterTypes' family as a callback
        //   function forces 'bcefi_Vfunc0X8' to be templatized so that each
        //   argument to the callback function will be of unique type.  Hence,
        //   if the types of arguments passed in to the callback function is
        //   incorrect, the compiler will generate an error.
        //
        ...
        // Testing:
        //   'bcefi_Vfunc0F8' methods:
        //   bcefi_Vfunc0F8<F, D1-8>(c_F&, c_D1-8&, ba *);
        //   void execute<F, D1-8>() const;
        //   ~bcefi_Vfunc0F8<F, D1-8>();
        // -------------------------------------------------------------------
        //   'bcefi_Vfunc0C8' methods:
        //   bcefi_Vfunc0C8<OBJ, C, D1-8>( OBJ *, c_C&, c_D1-8&, ba *);
        //   void execute<OBJ, C, D1-8>() const;
        //   ~bcefi_Vfunc0C8<OBJ, C, D1-8>();
        // --------------------------------------------------------------------
        //   'bcefi_Vfunc0M8' methods:
        //   bcefi_Vfunc0M8<OBJ, M, D1-8>( OBJ *, c_M&, c_D1-8, ba *);
        //    void execute<OBJ, M, D1-8>() const;
        //   ~bcefi_Vfunc0M8<OBJ, M, D1-8>();
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting constructors and argument values." << endl;
        {
            ...
            if (verbose) cout << "\t'bcefi_Vfunc0F8' object." << endl;
            {
                typedef bcefi_Vfunc0F8<CbFuncF8,
                                       int *, int *, int *, int *,
                                       int *, int *, int *, int *> Obj;
            ...
            if (verbose) cout << "\t'bcefi_Vfunc0C8' object." << endl;
            {
                typedef bcefi_Vfunc0C8<CbClass, CbFuncC8, int *, int *,
                                       int *, int *, int *, int *,
                                       int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
            ...
            if (verbose) cout << "\t'bcefi_Vfunc0M8' object." << endl;
            {
                typedef bcefi_Vfunc0M8<CbClass, CbFuncC8,
                                       int *, int *, int *, int *,
                                       int *, int *, int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
            ...
            cout << "\nTesting parameter types and destructors." << endl;
        {
            ...
            if (verbose)
                cout << "\tWhen calling 'bcefi_Vfunc0F8' 'execute' method."
                     << endl;
            {
                typedef bcefi_Vfunc0F8<CbFuncF8, T1, T2, T3, T4, T5, T6, T7,
                                       T8> Obj;
                dcEnabled = 0;
                destructorCheck = 0;
                numDeallocations = ta.numDeallocation();
            ...
            if (verbose)
                cout << "\tWhen calling 'bcefi_Vfunc0C8' 'execute' method."
                     << endl;
            {
                typedef bcefi_Vfunc0C8<CbClass, CbFuncC8, T1, T2,
            ...
            if (verbose)
                cout << "\tWhen calling 'bcefi_Vfunc0M8' 'execute' method."
                     << endl;
            {
                typedef bcefi_Vfunc0M8<CbClass, CbFuncM8, T1, T2, T3, T4,
                                       T5, T6, T7, T8> Obj;
                dcEnabled = 0;
                destructorCheck = 0;
                numDeallocations = ta.numDeallocation();
      ...
      case 7: {
        ...
        //       those intended as argument types for the function parameters.
        //    4. Non-'const' member functions can be used as callback
        //       functions by 'bcefi_Vfunc0M7' instances.
        //    5. Destructor of each class under test is properly executed.
        //
        // Plan:
        //   Create objects of every 'bcefi_Vfunc0X7' class.  Initialize
        //   'bcefi_Vfunc0F7' to have 'checkArgumentValues7' as the callback
        //   function.  Initialize 'bcefi_Vfunc0C7' and 'bcefi_Vfunc0M7' to
        //   have 'checkArgumentValues7' method of the 'CbClass' class as the
        //   callback function.  Call the 'execute' method for each
        //   'bcefi_Vfunc0X7' class.  The arguments in this call are
        //   initialized with values of 'ARG1', 'ARG2', 'ARG3', 'ARG4',
        ...
        //
        //   Create objects of every 'bcefi_Vfunc0X7' class.  Initialize
        //   'bcefi_Vfunc0F7' to have 'checkParameterTypes7' as the callback
        //   function.  Initialize 'bcefi_Vfunc0C7' to have
        //   'checkParameterTypesC7' method of the 'CbClass' class as the
        //   callback function.  Initialize 'bcefi_Vfunc0M7' to have
        //   'checkParameterTypesM7' method of the 'CbClass' class as the
        //   callback function.  The latter will test wether the
        //   'bcefi_Vfunc0M7' can have non-'const' functions as the callback
        //   function.
        //
        //   Having a function of 'checkParameterTypes' family as a callback
        //   function forces 'bcefi_Vfunc0X7' to be templatized so that each
        //   argument to the callback function will be of unique type.  Hence,
        //   if the types of arguments passed in to the callback function is
        //   incorrect, the compiler will generate an error.
        //
        ...
        // Testing:
        //   'bcefi_Vfunc0F7' methods:
        //   bcefi_Vfunc0F7<F, D1-7>(c_F&, c_D1-7&, ba *);
        //   void execute<F, D1-7>() const;
        //   ~bcefi_Vfunc0F7<F, D1-7>();
        // --------------------------------------------------------------------
        //   'bcefi_Vfunc0C7' methods:
        //   bcefi_Vfunc0C7<OBJ, C, D1-7>( OBJ *, c_C&, c_D1-7&, ba *);
        //   void execute<OBJ, C, D1-7>() const;
        //   ~bcefi_Vfunc0C7<OBJ, C, D1-7>();
        // --------------------------------------------------------------------
        //   'bcefi_Vfunc0M7' methods:
        //   bcefi_Vfunc0M7<OBJ, M, D1-7>( OBJ *, c_M&, c_D1-7, ba *);
        //   void execute<OBJ, M, D1-7>() const;
        //   ~bcefi_Vfunc0M7<OBJ, M, D1-7>();
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting constructors and argument values." << endl;
        {
            ...
            if (verbose) cout << "\t'bcefi_Vfunc0F7' object." << endl;
            {
                typedef bcefi_Vfunc0F7<CbFuncF7,
                                       int *, int *, int *,
                                       int *, int *, int *, int *> Obj;
            ...
            if (verbose) cout << "\t'bcefi_Vfunc0C7' object." << endl;
            {
                typedef bcefi_Vfunc0C7<CbClass, CbFuncC7, int *,
                                       int *, int *, int *, int *,
                                       int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
            ...
            if (verbose) cout << "\t'bcefi_Vfunc0M7' object." << endl;
            {
                typedef bcefi_Vfunc0M7<CbClass, CbFuncC7,
                                       int *, int *, int *,
                                       int *, int *, int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
            ...
            cout << "\nTesting parameter types and destructors." << endl;
        {
            ...
            if (verbose)
                cout << "\tWhen calling 'bcefi_Vfunc0F7' 'execute' method."
                     << endl;
            {
                typedef bcefi_Vfunc0F7<CbFuncF7, T1, T2, T3, T4, T5, T6,
                                       T7> Obj;
                dcEnabled = 0;
                destructorCheck = 0;
                numDeallocations = ta.numDeallocation();
            ...
            if (verbose)
                cout << "\tWhen calling 'bcefi_Vfunc0C7' 'execute' method."
                     << endl;
            {
                typedef bcefi_Vfunc0C7<CbClass, CbFuncC7, T1, T2,
                                       T3, T4, T5, T6, T7> Obj;
                dcEnabled = 0;
                destructorCheck = 0;
                numDeallocations = ta.numDeallocation();
            ...
            if (verbose)
                cout << "\tWhen calling 'bcefi_Vfunc0M7' 'execute' method."
                     << endl;
            {
                typedef bcefi_Vfunc0M7<CbClass, CbFuncM7, T1, T2, T3, T4,
                                       T5, T6, T7> Obj;
                dcEnabled = 0;
                destructorCheck = 0;
                numDeallocations = ta.numDeallocation();
      ...
      case 6: {
        ...
        //       those intended as argument types for the function parameters.
        //    4. Non-'const' member functions can be used as callback
        //       functions by 'bcefi_Vfunc0M6' instances.
        //    5. Destructor of each class under test is properly executed.
        //
        // Plan:
        //   Create objects of every 'bcefi_Vfunc0X6' class.  Initialize
        //   'bcefi_Vfunc0F6' to have 'checkArgumentValues6' as the callback
        //   function.  Initialize 'bcefi_Vfunc0C6' and 'bcefi_Vfunc0M6' to
        //   have 'checkArgumentValues6' method of the 'CbClass' class as the
        //   callback function.  Call the 'execute' method for each
        //   'bcefi_Vfunc0X6' class.  The arguments in this call are
        //   initialized with values of 'ARG1', 'ARG2', 'ARG3', 'ARG4',
        ...
        //
        //   Create objects of every 'bcefi_Vfunc0X6' class.  Initialize
        //   'bcefi_Vfunc0F6' to have 'checkParameterTypes6' as the callback
        //   function.  Initialize 'bcefi_Vfunc0C6' to have
        //   'checkParameterTypesC6' method of the 'CbClass' class as the
        //   callback function.  Initialize 'bcefi_Vfunc0M6' to have
        //   'checkParameterTypesM6' method of the 'CbClass' class as the
        //   callback function.  The latter will test wether the
        //   'bcefi_Vfunc0M6' can have non-'const' functions as the callback
        //   function.
        //
        //   Having a function of 'checkParameterTypes' family as a callback
        //   function forces 'bcefi_Vfunc0X6' to be templatized so that each
        //   argument to the callback function will be of unique type.  Hence,
        //   if the types of arguments passed in to the callback function is
        //   incorrect, the compiler will generate an error.
        //
        ...
        // Testing:
        //   'bcefi_Vfunc0F6' methods:
        //   bcefi_Vfunc0F6<F, D1-6>(c_F&, c_D1-6&, ba *);
        //   void execute<F, D1-6>() const;
        //   ~bcefi_Vfunc0F6<F, D1-6>();
        // --------------------------------------------------------------------
        //   'bcefi_Vfunc0C6' methods:
        //   bcefi_Vfunc0C6<OBJ, C, D1-6>( OBJ *, c_C&, c_D1-6&, ba *);
        //   void execute<OBJ, C, D1-6>() const;
        //   ~bcefi_Vfunc0C6<OBJ, C, D1-6>();
        // --------------------------------------------------------------------
        //   'bcefi_Vfunc0M6' methods:
        //   bcefi_Vfunc0M6<OBJ, M, D1-6>( OBJ *, c_M&, c_D1-6, ba *);
        //    void execute<OBJ, M, D1-6>() const;
        //   ~bcefi_Vfunc0M6<OBJ, M, D1-6>();
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting constructors and argument values." << endl;
        {
            ...
            if (verbose) cout << "\t'bcefi_Vfunc0F6' object." << endl;
            {
                typedef bcefi_Vfunc0F6<CbFuncF6,
                                       int *, int *, int *,
                                       int *, int *, int *> Obj;
            ...
            if (verbose) cout << "\t'bcefi_Vfunc0C6' object." << endl;
            {
                typedef bcefi_Vfunc0C6<CbClass, CbFuncC6, int *,
                                       int *, int *, int *,
                                       int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
            ...
            if (verbose) cout << "\t'bcefi_Vfunc0M6' object." << endl;
            {
                typedef bcefi_Vfunc0M6<CbClass, CbFuncC6,
                                       int *, int *, int *,
                                       int *, int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
            ...
            cout << "\nTesting parameter types and destructors." << endl;
        {
            ...
            if (verbose)
                cout << "\tWhen calling 'bcefi_Vfunc0F6' 'execute' method."
                     << endl;
            {
                typedef bcefi_Vfunc0F6<CbFuncF6, T1, T2, T3, T4, T5, T6> Obj;
                dcEnabled = 0;
                destructorCheck = 0;
                numDeallocations = ta.numDeallocation();
            ...
            if (verbose)
                cout << "\tWhen calling 'bcefi_Vfunc0C6' 'execute' method."
                     << endl;
            {
                typedef bcefi_Vfunc0C6<CbClass, CbFuncC6, T1, T2,
                                       T3, T4, T5, T6> Obj;
                dcEnabled = 0;
                destructorCheck = 0;
                numDeallocations = ta.numDeallocation();
            ...
            if (verbose)
                cout << "\tWhen calling 'bcefi_Vfunc0M6' 'execute' method."
                     << endl;
            {
                typedef bcefi_Vfunc0M6<CbClass, CbFuncM6, T1, T2, T3, T4,
                                       T5, T6> Obj;
                dcEnabled = 0;
                destructorCheck = 0;
                numDeallocations = ta.numDeallocation();
      ...
      case 5: {
        ...
        //       those intended as argument types for the function parameters.
        //    4. Non-'const' member functions can be used as callback
        //       functions by 'bcefi_Vfunc0M5' instances.
        //    5. Destructor of each class under test is properly executed.
        //
        // Plan:
        //   Create objects of every 'bcefi_Vfunc0X5' class.  Initialize
        //   'bcefi_Vfunc0F5' to have 'checkArgumentValues5' as the callback
        //   function.  Initialize 'bcefi_Vfunc0C5' and 'bcefi_Vfunc0M5' to
        //   have 'checkArgumentValues5' method of the 'CbClass' class as the
        //   callback function.  Call the 'execute' method for each
        //   'bcefi_Vfunc0X5' class.  The arguments in this call are
        ...
        //
        //   Create objects of every 'bcefi_Vfunc0X5' class.  Initialize
        //   'bcefi_Vfunc0F5' to have 'checkParameterTypes5' as the callback
        //   function.  Initialize 'bcefi_Vfunc0C5' to have
        //   'checkParameterTypesC5' method of the 'CbClass' class as the
        //   callback function.  Initialize 'bcefi_Vfunc0M5' to have
        //   'checkParameterTypesM5' method of the 'CbClass' class as the
        //   callback function.  The latter will test wether the
        //   'bcefi_Vfunc0M5' can have non-'const' functions as the callback
        //   function.
        //
        //   Having a function of 'checkParameterTypes' family as a callback
        //   function forces 'bcefi_Vfunc0X5' to be templatized so that each
        //   argument to the callback function will be of unique type.  Hence,
        //   if the types of arguments passed in to the callback function is
        //   incorrect, the compiler will generate an error.
        //
        ...
        // Testing:
        //   'bcefi_Vfunc0F5' methods:
        //   bcefi_Vfunc0F5<F, D1-5>(c_F&, c_D1-5&, ba *);
        //   void execute<F, D1-5>() const;
        //   ~bcefi_Vfunc0F5<F, D1-5>();
        // --------------------------------------------------------------------
        //   'bcefi_Vfunc0C5' methods:
        //   bcefi_Vfunc0C5<OBJ, C, D1-5>( OBJ *, c_C&, c_D1-5&, ba *);
        //   void execute<OBJ, C, D1-5>() const;
        //   ~bcefi_Vfunc0C5<OBJ, C, D1-5>();
        // --------------------------------------------------------------------
        //   'bcefi_Vfunc0M5' methods:
        //   bcefi_Vfunc0M5<OBJ, M, D1-5>( OBJ *, c_M&, c_D1-5, ba *);
        //   void execute<OBJ, M, D1-5>() const;
        //   ~bcefi_Vfunc0M5<OBJ, M, D1-5>();
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting constructors and argument values." << endl;
        {
            ...
            if (verbose) cout << "\t'bcefi_Vfunc0F5' object." << endl;
            {
                typedef bcefi_Vfunc0F5<CbFuncF5, int *, int *,
                                       int *, int *, int *> Obj;
            ...
            if (verbose) cout << "\t'bcefi_Vfunc0C5' object." << endl;
            {
                typedef bcefi_Vfunc0C5<CbClass, CbFuncC5, int *,
                                       int *, int *, int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
                ObjBase *x = new(ta) Obj(cbObject,
            ...
            if (verbose) cout << "\t'bcefi_Vfunc0M5' object." << endl;
            {
                typedef bcefi_Vfunc0M5<CbClass, CbFuncC5,
                                       int *, int *, int *, int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
                ObjBase *x = new(ta) Obj(&cbObject,
            ...
            cout << "\nTesting parameter types and destructors." << endl;
        {
            ...
            if (verbose)
                cout << "\tWhen calling 'bcefi_Vfunc0F5' 'execute' method."
                     << endl;
            {
                typedef bcefi_Vfunc0F5<CbFuncF5, T1, T2, T3, T4, T5> Obj;
                dcEnabled = 0;
                destructorCheck = 0;
                numDeallocations = ta.numDeallocation();
            ...
            if (verbose)
                cout << "\tWhen calling 'bcefi_Vfunc0C5' 'execute' method."
                     << endl;
            {
                typedef bcefi_Vfunc0C5<CbClass, CbFuncC5, T1, T2,
                                       T3, T4, T5> Obj;
                dcEnabled = 0;
                destructorCheck = 0;
                numDeallocations = ta.numDeallocation();
            ...
            if (verbose)
                cout << "\tWhen calling 'bcefi_Vfunc0M5' 'execute' method."
                     << endl;
            {
                typedef bcefi_Vfunc0M5<CbClass, CbFuncM5, T1, T2, T3, T4,
                                       T5> Obj;
                dcEnabled = 0;
                destructorCheck = 0;
                numDeallocations = ta.numDeallocation();
      ...
      case 4: {
        ...
        //       those intended as argument types for the function parameters.
        //    4. Non-'const' member functions can be used as callback
        //       functions by 'bcefi_Vfunc0M4' instances.
        //    5. Destructor of each class under test is properly executed.
        //
        // Plan:
        //   Create objects of every 'bcefi_Vfunc0X4' class.  Initialize
        //   'bcefi_Vfunc0F4' to have 'checkArgumentValues4' as the callback
        //   function.  Initialize 'bcefi_Vfunc0C4' and 'bcefi_Vfunc0M4' to
        //   have 'checkArgumentValues4' method of the 'CbClass' class as the
        //   callback function.  Call the 'execute' method for each
        //   'bcefi_Vfunc0X4' class.  The arguments in this call are
        ...
        //
        //   Create objects of every 'bcefi_Vfunc0X4' class.  Initialize
        //   'bcefi_Vfunc0F4' to have 'checkParameterTypes4' as the callback
        //   function.  Initialize 'bcefi_Vfunc0C4' to have
        //   'checkParameterTypesC4' method of the 'CbClass' class as the
        //   callback function.  Initialize 'bcefi_Vfunc0M4' to have
        //   'checkParameterTypesM4' method of the 'CbClass' class as the
        //   callback function.  The latter will test wether the
        //   'bcefi_Vfunc0M4' can have non-'const' functions as the callback
        //   function.
        //
        //   Having a function of 'checkParameterTypes' family as a callback
        //   function forces 'bcefi_Vfunc0X4' to be templatized so that each
        //   argument to the callback function will be of unique type.  Hence,
        //   if the types of arguments passed in to the callback function is
        //   incorrect, the compiler will generate an error.
        //
        ...
        // Testing:
        //   'bcefi_Vfunc0F4' methods:
        //   bcefi_Vfunc0F4<F, D1-4>(c_F&, c_D1-4&, ba *);
        //   void execute<F, D1-4>() const;
        //   ~bcefi_Vfunc0F4<F, D1-4>();
        //  -------------------------------------------------------------------
        //   'bcefi_Vfunc0C4' methods:
        //   bcefi_Vfunc0C4<OBJ, C, D1-4>( OBJ *, c_C&, c_D1-4&, ba *);
        //   void execute<OBJ, C, D1-4>() const;
        //   ~bcefi_Vfunc0C4<OBJ, C, D1-4>();
        //  -------------------------------------------------------------------
        //   'bcefi_Vfunc0M4' methods:
        //   bcefi_Vfunc0M4<OBJ, M, D1-4>( OBJ *, c_M&, c_D1-4, ba *);
        //   void execute<OBJ, M, D1-4>() const;
        //   ~bcefi_Vfunc0M4<OBJ, M, D1-4>();
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting constructors and argument values." << endl;
        {
            ...
            if (verbose) cout << "\t'bcefi_Vfunc0F4' object." << endl;
            {
                typedef bcefi_Vfunc0F4<CbFuncF4,
                                       int *, int *, int *, int *> Obj;
            ...
            if (verbose) cout << "\t'bcefi_Vfunc0C4' object." << endl;
            {
                typedef bcefi_Vfunc0C4<CbClass, CbFuncC4,
                                       int *, int *, int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
                ObjBase *x = new(ta) Obj(cbObject,
            ...
            if (verbose) cout << "\t'bcefi_Vfunc0M4' object." << endl;
            {
                typedef bcefi_Vfunc0M4<CbClass, CbFuncC4,
                                       int *, int *, int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
                ObjBase *x = new(ta) Obj(&cbObject,
            ...
            cout << "\nTesting parameter types and destructors." << endl;
        {
            ...
            if (verbose)
                cout << "\tWhen calling 'bcefi_Vfunc0F4' 'execute' method."
                     << endl;
            {
                typedef bcefi_Vfunc0F4<CbFuncF4, T1, T2, T3, T4> Obj;
                dcEnabled = 0;
                destructorCheck = 0;
                numDeallocations = ta.numDeallocation();
            ...
            if (verbose)
                cout << "\tWhen calling 'bcefi_Vfunc0C4' 'execute' method."
                     << endl;
            {
                typedef bcefi_Vfunc0C4<CbClass, CbFuncC4, T1, T2,
                                       T3, T4> Obj;
                dcEnabled = 0;
                destructorCheck = 0;
                numDeallocations = ta.numDeallocation();
            ...
            if (verbose)
                cout << "\tWhen calling 'bcefi_Vfunc0M4' 'execute' method."
                     << endl;
            {
                typedef bcefi_Vfunc0M4<CbClass, CbFuncM4, T1, T2, T3, T4> Obj;
                dcEnabled = 0;
                destructorCheck = 0;
                numDeallocations = ta.numDeallocation();
      ...
      case 3: {
        ...
        //       those intended as argument types for the function parameters.
        //    4. Non-'const' member functions can be used as callback
        //       functions by 'bcefi_Vfunc0M3' instances.
        //    5. Destructor of each class under test is properly executed.
        //
        // Plan:
        //   Create objects of every 'bcefi_Vfunc0X3' class.  Initialize
        //   'bcefi_Vfunc0F3' to have 'checkArgumentValues3' as the callback
        //   function.  Initialize 'bcefi_Vfunc0C3' and 'bcefi_Vfunc0M3' to
        //   have 'checkArgumentValues3' method of the 'CbClass' class as the
        //   callback function.  Call the 'execute' method for each
        //   'bcefi_Vfunc0X3' class.  The arguments in this call are
        ...
        //
        //   Create objects of every 'bcefi_Vfunc0X3' class.  Initialize
        //   'bcefi_Vfunc0F3' to have 'checkParameterTypes3' as the callback
        //   function.  Initialize 'bcefi_Vfunc0C3' to have
        //   'checkParameterTypesC3' method of the 'CbClass' class as the
        //   callback function.  Initialize 'bcefi_Vfunc0M3' to have
        //   'checkParameterTypesM3' method of the 'CbClass' class as the
        //   callback function.  The latter will test wether the
        //   'bcefi_Vfunc0M3' can have non-'const' functions as the callback
        //   function.
        //
        //   Having a function of 'checkParameterTypes' family as a callback
        //   function forces 'bcefi_Vfunc0X3' to be templatized so that each
        //   argument to the callback function will be of unique type.  Hence,
        //   if the types of arguments passed in to the callback function is
        //   incorrect, the compiler will generate an error.
        //
        ...
        // Testing:
        //   'bcefi_Vfunc0F3' methods:
        //   bcefi_Vfunc0F3<F, D1-3>(c_F&, c_D1-3&, ba *);
        //   void execute<F, D1-3>() const;
        //   ~bcefi_Vfunc0F3<F, D1-3>();
        // --------------------------------------------------------------------
        //   'bcefi_Vfunc0C3' methods:
        //   bcefi_Vfunc0C3<OBJ, C, D1-3>( OBJ *, c_C&, c_D1-3&, ba *);
        //   void execute<OBJ, C, D1-3>() const;
        //   ~bcefi_Vfunc0C3<OBJ, C, D1-3>();
        // --------------------------------------------------------------------
        //   'bcefi_Vfunc0M3' methods:
        //   bcefi_Vfunc0M3<OBJ, M, D1-3>( OBJ *, c_M&, c_D1-3, ba *);
        //   void execute<OBJ, M, D1-3>() const;
        //   ~bcefi_Vfunc0M3<OBJ, M, D1-3>();
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting constructors and argument values." << endl;
        {
            ...
            if (verbose) cout << "\t'bcefi_Vfunc0F3' object." << endl;
            {
                typedef bcefi_Vfunc0F3<CbFuncF3,
                                       int *, int *, int *> Obj;
            ...
            if (verbose) cout << "\t'bcefi_Vfunc0C3' object." << endl;
            {
                typedef bcefi_Vfunc0C3<CbClass, CbFuncC3,
                                       int *, int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
                ObjBase *x = new(ta) Obj(cbObject,
            ...
            if (verbose) cout << "\t'bcefi_Vfunc0M3' object." << endl;
            {
                typedef bcefi_Vfunc0M3<CbClass, CbFuncC3,
                                       int *, int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
                ObjBase *x = new(ta) Obj(&cbObject,
            ...
            cout << "\nTesting parameter types and destructors." << endl;
        {
            ...
            if (verbose)
                cout << "\tWhen calling 'bcefi_Vfunc0F3' 'execute' method."
                     << endl;
            {
                typedef bcefi_Vfunc0F3<CbFuncF3, T1, T2, T3> Obj;
                dcEnabled = 0;
                destructorCheck = 0;
                numDeallocations = ta.numDeallocation();
            ...
            if (verbose)
                cout << "\tWhen calling 'bcefi_Vfunc0C3' 'execute' method."
                     << endl;
            {
                typedef bcefi_Vfunc0C3<CbClass, CbFuncC3, T1, T2,
                                       T3> Obj;
                dcEnabled = 0;
                destructorCheck = 0;
                numDeallocations = ta.numDeallocation();
            ...
            if (verbose)
                cout << "\tWhen calling 'bcefi_Vfunc0M3' 'execute' method."
                     << endl;
            {
                typedef bcefi_Vfunc0M3<CbClass, CbFuncM3, T1, T2, T3> Obj;
                dcEnabled = 0;
                destructorCheck = 0;
                numDeallocations = ta.numDeallocation();
      ...
      case 2: {
        ...
        //       those intended as argument types for the function parameters.
        //    4. Non-'const' member functions can be used as callback
        //       functions by 'bcefi_Vfunc0M2' instances.
        //    5. Destructor of each class under test is properly executed.
        //
        // Plan:
        //   Create objects of every 'bcefi_Vfunc0X2' class.  Initialize
        //   'bcefi_Vfunc0F2' to have 'checkArgumentValues2' as the callback
        //   function.  Initialize 'bcefi_Vfunc0C2' and 'bcefi_Vfunc0M2' to
        //   have 'checkArgumentValues2' method of the 'CbClass' class as the
        //   callback function.  Call the 'execute' method for each
        //   'bcefi_Vfunc0X2' class.  The arguments in this call are
        ...
        //
        //   Create objects of every 'bcefi_Vfunc0X2' class.  Initialize
        //   'bcefi_Vfunc0F2' to have 'checkParameterTypes2' as the callback
        //   function.  Initialize 'bcefi_Vfunc0C2' to have
        //   'checkParameterTypesC2' method of the 'CbClass' class as the
        //   callback function.  Initialize 'bcefi_Vfunc0M2' to have
        //   'checkParameterTypesM2' method of the 'CbClass' class as the
        //   callback function.  The latter will test wether the
        //   'bcefi_Vfunc0M2' can have non-'const' functions as the callback
        //   function.
        //
        //   Having a function of 'checkParameterTypes' family as a callback
        //   function forces 'bcefi_Vfunc0X2' to be templatized so that each
        //   argument to the callback function will be of unique type.  Hence,
        //   if the types of arguments passed in to the callback function is
        //   incorrect, the compiler will generate an error.
        //
        ...
        // Testing:
        //   'bcefi_Vfunc0F2' methods:
        //   bcefi_Vfunc0F2<F, D1-2>(c_F&, c_D1-2&, ba *);
        //   void execute<F, D1-2>(D1-2&) const;
        //   ~bcefi_Vfunc0F2<F, D1-2>();
        // -------------------------------------------------------------------
        //   'bcefi_Vfunc0C2' methods:
        //   bcefi_Vfunc0C2<OBJ, C, D1-2>( OBJ *, c_C&, c_D1-2&, ba *);
        //   void execute<OBJ, C, D1-2>() const;
        //   ~bcefi_Vfunc0C2<OBJ, C, D1-2>();
        // --------------------------------------------------------------------
        //   'bcefi_Vfunc0M2' methods:
        //   bcefi_Vfunc0M2<OBJ, M, D1-2>( OBJ *, c_M&, c_D1-2&, ba *);
        //   void execute<OBJ, M, D1-2>() const;
        //   ~bcefi_Vfunc0M2<OBJ, M, D1-2>();
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting constructors and argument values." << endl;
        {
            ...
            if (verbose) cout << "\t'bcefi_Vfunc0F2' object." << endl;
            {
                typedef bcefi_Vfunc0F2<CbFuncF2,
                                       int *, int *> Obj;
            ...
            if (verbose) cout << "\t'bcefi_Vfunc0C2' object." << endl;
            {
                typedef bcefi_Vfunc0C2<CbClass, CbFuncC2,
                                       int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
                ObjBase *x = new(ta) Obj(cbObject,
            ...
            if (verbose) cout << "\t'bcefi_Vfunc0M2' object." << endl;
            {
                typedef bcefi_Vfunc0M2<CbClass, CbFuncC2,
                                       int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
                ObjBase *x = new(ta) Obj(&cbObject,
            ...
            cout << "\nTesting parameter types and destructors." << endl;
        {
            ...
            if (verbose)
                cout << "\tWhen calling 'bcefi_Vfunc0F2' 'execute' method."
                     << endl;
            {
                typedef bcefi_Vfunc0F2<CbFuncF2, T1, T2> Obj;
                dcEnabled = 0;
                destructorCheck = 0;
                numDeallocations = ta.numDeallocation();
            ...
            if (verbose)
                cout << "\tWhen calling 'bcefi_Vfunc0C2' 'execute' method."
                     << endl;
            {
                typedef bcefi_Vfunc0C2<CbClass, CbFuncC2, T1, T2> Obj;
                dcEnabled = 0;
                destructorCheck = 0;
                numDeallocations = ta.numDeallocation();
            ...
            if (verbose)
                cout << "\tWhen calling 'bcefi_Vfunc0M2' 'execute' method."
                     << endl;
            {
                typedef bcefi_Vfunc0M2<CbClass, CbFuncM2, T1, T2> Obj;
                dcEnabled = 0;
                destructorCheck = 0;
                numDeallocations = ta.numDeallocation();
      ...
      case 1: {
        ...
        //       those intended as argument types for the function parameters.
        //    4. Non-'const' member functions can be used as callback
        //       functions by 'bcefi_Vfunc0M1' instances.
        //    5. Destructor of each class under test is properly executed.
        //
        // Plan:
        //   Create objects of every 'bcefi_Vfunc0X1' class.  Initialize
        //   'bcefi_Vfunc0F1' to have 'checkArgumentValues1' as the callback
        //   function.  Initialize 'bcefi_Vfunc0C1' and 'bcefi_Vfunc0M1' to
        //   have 'checkArgumentValues1' method of the 'CbClass' class as the
        //   callback function.  Call the 'execute' method for each
        //   'bcefi_Vfunc0X1' class.  The argument in this call is initialized
        ...
        //
        //   Create objects of every 'bcefi_Vfunc0X1' class.  Initialize
        //   'bcefi_Vfunc0F1' to have 'checkParameterTypes1' as the callback
        //   function.  Initialize 'bcefi_Vfunc0C1' to have
        //   'checkParameterTypesC1' method of the 'CbClass' class as the
        //   callback function.  Initialize 'bcefi_Vfunc0M1' to have
        //   'checkParameterTypesM1' method of the 'CbClass' class as the
        //   callback function.  The latter will test wether the
        //   'bcefi_Vfunc0M1' can have non-'const' functions as the callback
        //   function.
        //
        //   Having a function of 'checkParameterTypes' family as a callback
        //   function forces 'bcefi_Vfunc0X1' to be templatized so that the
        //   argument to the callback function will be of unique type.  Hence,
        ...
        //   classes.
        //
        //   For 'bcefi_Vfunc0X0' class pass 'checkVfunc0Execution' function as
        //   a callback.  This function will increment a global counter and by
        //   checking it we will verify that the function was executed.
        //
        // Testing:
        //   'bcefi_Vfunc0F1' methods:
        //   bcefi_Vfunc0F1<F, D1>(c_F&, c_D1&, ba *);
        //   void execute<F, D1>() const;
        //   ~bcefi_Vfunc0F1<F, D1>();
        // -------------------------------------------------------------------
        //   'bcefi_Vfunc0C1' methods:
        //   bcefi_Vfunc0C1<OBJ, C, D1>( OBJ *, c_C&, c_D1&, ba *);
        //   void execute<OBJ, C, D1>() const;
        //   ~bcefi_Vfunc0C1<OBJ, C, D1>();
        // --------------------------------------------------------------------
        //   'bcefi_Vfunc0M1' methods:
        //   bcefi_Vfunc0M1<OBJ, M, D1>( OBJ *, c_M&, c_D1&, ba *);
        //   void execute<OBJ, M, D1>() const;
        //   ~bcefi_Vfunc0M1<OBJ, M, D1>();
        // --------------------------------------------------------------------
        //   'bcefi_Vfunc0Null' methods:
        //   bcefi_Vfunc0Null(ba *);
        //   void execute() const;
        //   ~bcefi_Vfunc0Null();
        // --------------------------------------------------------------------
        //   'bcefi_Vfunc0F0' methods:
        //   bcefi_Vfunc0F0<F>(c_F&, ba *);
        //   void execute<F>() const;
        //   ~bcefi_Vfunc0F0<F>();
        // -------------------------------------------------------------------
        //   'bcefi_Vfunc0C0' methods:
        //   bcefi_Vfunc0C0<OBJ, C>( OBJ *, c_C&, ba *);
        //   void execute<OBJ, C>() const;
        //   ~bcefi_Vfunc0C0<OBJ, C>();
        // --------------------------------------------------------------------
        //   'bcefi_Vfunc0M0' methods:
        //   bcefi_Vfunc0M0<OBJ, M>( OBJ *, c_M&, ba *);
        //   void execute<OBJ, M>() const;
        //   ~bcefi_Vfunc0M0<OBJ, M>();
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting constructors and argument values." << endl;
        {
            ...
            if (verbose) cout << "\t'bcefi_Vfunc0F1' object." << endl;
            {
                typedef bcefi_Vfunc0F1<CbFuncF1, int *> Obj;
            ...
            if (verbose) cout << "\t'bcefi_Vfunc0C1' object." << endl;
            {
                typedef bcefi_Vfunc0C1<CbClass, CbFuncC1, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
                ObjBase *x = new(ta) Obj(cbObject,
            ...
            if (verbose) cout << "\t'bcefi_Vfunc0M1' object." << endl;
            {
                typedef bcefi_Vfunc0M1<CbClass, CbFuncC1, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
                ObjBase *x = new(ta) Obj(&cbObject,
            ...
            cout << "\nTesting parameter types and destructors." << endl;
        {
            ...
            if (verbose)
                cout << "\tWhen calling 'bcefi_Vfunc0F1' 'execute' method."
                     << endl;
            {
                typedef bcefi_Vfunc0F1<CbFuncF1, T1> Obj;
                dcEnabled = 0;
                destructorCheck = 0;
                numDeallocations = ta.numDeallocation();
            ...
            if (verbose)
                cout << "\tWhen calling 'bcefi_Vfunc0C1' 'execute' method."
                     << endl;
            {
                typedef bcefi_Vfunc0C1<CbClass, CbFuncC1, T1> Obj;
                dcEnabled = 0;
                destructorCheck = 0;
                numDeallocations = ta.numDeallocation();
            ...
            if (verbose)
                cout << "\tWhen calling 'bcefi_Vfunc0M1' 'execute' method."
                     << endl;
            {
                typedef bcefi_Vfunc0M1<CbClass, CbFuncM1, T1> Obj;
                dcEnabled = 0;
                destructorCheck = 0;
                numDeallocations = ta.numDeallocation();
            ...
            if (verbose)
                cout << "\nTesting bcefi_Vfunc0Null object." << endl;
            {
                destructorCheck = 0;
                numDeallocations = ta.numDeallocation();

                typedef bcefi_Vfunc0Null Obj;
...

        {
            ...
            int numDeallocations = ta.numDeallocation();

            if (verbose) cout << "\t'bcefi_Vfunc0F0' object." << endl;
            {
                typedef bcefi_Vfunc0F0<CbFuncF0> Obj;
            ...
            if (verbose) cout << "\t'bcefi_Vfunc0C0' object." << endl;
            {
                typedef bcefi_Vfunc0C0<CbClass, CbFuncC0> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
                ObjBase *x = new(ta) Obj(cbObject,
            ...
            if (verbose) cout << "\t'bcefi_Vfunc0M0' object." << endl;
            {
                typedef bcefi_Vfunc0M0<CbClass, CbFuncC0> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
                ObjBase *x = new(ta) Obj(&cbObject,
