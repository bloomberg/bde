...
class bcefi_Vfunc1Null : public bcefr_Vfunc1<A1> {
  ...
  public:
    // CREATORS
    bcefi_Vfunc1Null(bslma::Allocator *basicAllocator);
...
class bcefi_Vfunc1F1 : public bcefr_Vfunc1<A1> {
  ...
  public:
    // CREATORS
    bcefi_Vfunc1F1(F procedure, bslma::Allocator *basicAllocator);
        // Create a representation for a function object (functor) taking one
...
template <class A1>
inline
bcefi_Vfunc1Null<A1>::bcefi_Vfunc1Null(bslma::Allocator*basicAllocator)
