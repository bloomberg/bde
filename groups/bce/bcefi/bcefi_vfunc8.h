...
#define INCLUDED_BCEFI_VFUNC8

//@PURPOSE: Provide concrete representations for 8-arg void function objects.
//
//@CLASSES:
//
// bcefi_Vfunc8Null: a 8-arg void no-op functor
//
// bcefi_Vfunc8F8: a 8-arg void functor created from a 8-arg function
// bcefi_Vfunc8F9: a 8-arg void functor created from a 9-arg function
//
// bcefi_Vfunc8C8: a 8-arg void functor created from obj & 8-arg method
// bcefi_Vfunc8C9: a 8-arg void functor created from obj & 9-arg method
//
// bcefi_Vfunc8M8: a 8-arg void functor created from obj ptr & 8-arg method
// bcefi_Vfunc8M9: a 8-arg void functor created from obj ptr & 9-arg method
//
...
// implementation of the base 'bcefr_Vfunc8' representation based on the
...
// then the "null functor" 'bcefi_Vfunc8Null' may be used.
//
///Language-Imposed Details
///------------------------
// For practical reasons, this component must distinguish among four types of
// functors.  The first type is a "null functor" 'bcefi_Vfunc8Null', which
...
// implementations are named 'bcefi_Vfunc8XN' where 'X' is one of {'F', 'C',
...
//..
// Note that a 'const' member function may be wrapped by a 'bcefi_Vfunc8MN'
// functor, but wrapping a non-'const' method by a 'bcefi_Vfunc8CN' will
// result in compile time error in most compiler implementations.
//
// Note also that, to accommodate the preservation of 'const', the
// 'bcefi_Vfunc8CN' functors hold an object 'Obj', supplied by a 'const'
// 'Obj&' in the constructor, while 'bcefi_Vfunc8MN' functors hold a pointer
...
#ifndef INCLUDED_BCEFR_VFUNC8
#include <bcefr_vfunc8.h>
#endif

namespace BloombergLP {

                        // ======================
                        // class bcefi_Vfunc8Null
                        // ======================

template <class A1, class A2, class A3, class A4, class A5, class A6,
          class A7, class A8>
class bcefi_Vfunc8Null : public bcefr_Vfunc8<A1, A2, A3, A4, A5, A6, A7, A8> {
  ...
  private:
    // not implemented
    bcefi_Vfunc8Null(const bcefi_Vfunc8Null<A1, A2, A3, A4, A5, A6, A7, A8>&);
    bcefi_Vfunc8Null<A1, A2, A3, A4, A5, A6, A7, A8>& operator=(
        const bcefi_Vfunc8Null<A1, A2, A3, A4, A5, A6, A7, A8>&);

  public:
    // CREATORS
    inline bcefi_Vfunc8Null(bdema_Allocator *basicAllocator);
        // Create a representation for a function object (functor) taking eight
        // arguments, returning 'void', and performing no operation.

  private:
    inline ~bcefi_Vfunc8Null();
    ...
    inline void execute(const A1& argument1, const A2& argument2,
        ...
        // 'argument7', and 'argument8'.
                        ...
                        // ====================
                        // class bcefi_Vfunc8F8
                        // ====================

template <class F, class A1, class A2, class A3, class A4, class A5, class A6,
          class A7, class A8>
class bcefi_Vfunc8F8 : public bcefr_Vfunc8<A1, A2, A3, A4, A5, A6, A7, A8> {
    // This class defines the representation for a function object (functor),
  ...
  private:
    // not implemented
    bcefi_Vfunc8F8(const bcefi_Vfunc8F8<F, A1, A2, A3, A4, A5, A6, A7, A8>&);
    bcefi_Vfunc8F8<F, A1, A2, A3, A4, A5, A6, A7, A8>& operator=(
        const bcefi_Vfunc8F8<F, A1, A2, A3, A4, A5, A6, A7, A8>&);

  public:
    // CREATORS
    inline bcefi_Vfunc8F8(F                procedure,
  ...
  private:
    ...
    inline void execute(const A1& argument1, const A2& argument2,
        ...
        // and 'argument8' (and no additional arguments).
                        ...
                        // ====================
                        // class bcefi_Vfunc8F9
                        // ====================

template <class F, class A1, class A2, class A3, class A4, class A5,
          class A6, class A7, class A8, class D1>
class bcefi_Vfunc8F9 : public bcefr_Vfunc8<A1, A2, A3, A4, A5, A6, A7, A8> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking eight arguments and
    // returning 'void', that holds a pure procedure (i.e., free function,
  ...
  private:
    // not implemented
    bcefi_Vfunc8F9(
        const bcefi_Vfunc8F9<F, A1, A2, A3, A4, A5, A6, A7, A8, D1>&);
    bcefi_Vfunc8F9<F, A1, A2, A3, A4, A5, A6, A7, A8, D1>& operator=(
        const bcefi_Vfunc8F9<F, A1, A2, A3, A4, A5, A6, A7, A8, D1>&);
  public:
    // CREATORS
    inline bcefi_Vfunc8F9(F                procedure,
...
class bcefi_Vfunc8C8 : public bcefr_Vfunc8<A1, A2, A3, A4, A5, A6, A7, A8> {
  ...
  private:
    // not implemented
    bcefi_Vfunc8C8(
        const bcefi_Vfunc8C8<OBJ, C, A1, A2, A3, A4, A5, A6, A7, A8>&);
    bcefi_Vfunc8C8<OBJ, C, A1, A2, A3, A4, A5, A6, A7, A8>& operator=(
        const bcefi_Vfunc8C8<OBJ, C, A1, A2, A3, A4, A5, A6, A7, A8>&);
  public:
    // CREATORS
    inline bcefi_Vfunc8C8(const OBJ&       object,
                          C                method,
                          bdema_Allocator *basicAllocator);
        // Create a representation for a function object (functor) taking eight
  ...
  private:
    ...
    inline void execute(const A1& argument1, const A2& argument2,
        ...
        // (and no additional arguments).
                        ...
                        // ====================
                        // class bcefi_Vfunc8C9
                        // ====================

template <class OBJ, class C, class A1, class A2,
          class A3, class A4, class A5, class A6, class A7, class A8, class D1>
class bcefi_Vfunc8C9 : public bcefr_Vfunc8<A1, A2, A3, A4, A5, A6, A7, A8> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking eight arguments and
    // returning 'void', that holds an object and one of that object's 'const'
  ...
  private:
    // not implemented
    bcefi_Vfunc8C9(
        const bcefi_Vfunc8C9<OBJ, C, A1, A2, A3, A4, A5, A6, A7, A8, D1>&);
    bcefi_Vfunc8C9<OBJ, C, A1, A2, A3, A4, A5, A6, A7, A8, D1>& operator=(
        const bcefi_Vfunc8C9<OBJ, C, A1, A2, A3, A4, A5, A6, A7, A8, D1>&);
  public:
    // CREATORS
    inline bcefi_Vfunc8C9(const OBJ&       object,
                          C                method,
                          const D1&        embeddedArg1,
                          bdema_Allocator *basicAllocator);
        // Create a representation for a function object (functor) taking eight
  ...
  private:
    ...
    inline void execute(const A1& argument1, const A2& argument2,
        ...
        // along with the trailing argument value specified at construction.
                        ...
                        // ====================
                        // class bcefi_Vfunc8M8
                        // ====================

template <class OBJ, class M, class A1, class A2,
          class A3, class A4, class A5, class A6, class A7, class A8>
class bcefi_Vfunc8M8 : public bcefr_Vfunc8<A1, A2, A3, A4, A5, A6, A7, A8> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking eight arguments and
  ...
  private:
    // not implemented
    bcefi_Vfunc8M8(
        const bcefi_Vfunc8M8<OBJ, M, A1, A2, A3, A4, A5, A6, A7, A8>&);
    bcefi_Vfunc8M8<OBJ, M, A1, A2, A3, A4, A5, A6, A7, A8>& operator=(
        const bcefi_Vfunc8M8<OBJ, M, A1, A2, A3, A4, A5, A6, A7, A8>&);
  public:
    // CREATORS
    inline bcefi_Vfunc8M8(OBJ             *object,
                          M                method,
                          bdema_Allocator *basicAllocator);
        // Create a representation for a function object (functor) taking eight
  ...
  private:
    ...
    inline void execute(const A1& argument1, const A2& argument2,
        ...
        // (and no additional arguments).
                        ...
                        // ====================
                        // class bcefi_Vfunc8M9
                        // ====================

template <class OBJ, class M, class A1, class A2,
          class A3, class A4, class A5, class A6, class A7, class A8, class D1>
class bcefi_Vfunc8M9 : public bcefr_Vfunc8<A1, A2, A3, A4, A5, A6, A7, A8> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking eight arguments and
    // returning 'void', that holds the address of an object and one of that
  ...
  private:
    // not implemented
    bcefi_Vfunc8M9(
        const bcefi_Vfunc8M9<OBJ, M, A1, A2, A3, A4, A5, A6, A7, A8, D1>&);
    bcefi_Vfunc8M9<OBJ, M, A1, A2, A3, A4, A5, A6, A7, A8, D1>& operator=(
        const bcefi_Vfunc8M9<OBJ, M, A1, A2, A3, A4, A5, A6, A7, A8, D1>&);
  public:
    // CREATORS
    inline bcefi_Vfunc8M9(OBJ             *object,
                          M                method,
                          const D1&        embeddedArg1,
                          bdema_Allocator *basicAllocator);
        // Create a representation for a function object (functor) taking eight
...
inline
bcefi_Vfunc8Null<A1, A2, A3, A4, A5, A6, A7, A8>::bcefi_Vfunc8Null(
                                             bdema_Allocator *basicAllocator)
: bcefr_Vfunc8<A1, A2, A3, A4, A5, A6, A7, A8>(basicAllocator)
{
}

template <class A1, class A2, class A3, class A4,
          class A5, class A6, class A7, class A8>
inline bcefi_Vfunc8Null<A1, A2, A3, A4, A5, A6, A7, A8>::~bcefi_Vfunc8Null()
{
}

template <class A1, class A2, class A3, class A4,
          class A5, class A6, class A7, class A8>
inline void bcefi_Vfunc8Null<A1, A2, A3, A4, A5, A6, A7, A8>::execute(
                                                   const A1& argument1,
                                                   const A2& argument2,
                                                   const A3& argument3,
                                                   const A4& argument4,
...
template <class F, class A1, class A2, class A3, class A4,
          class A5, class A6, class A7, class A8>
inline
bcefi_Vfunc8F8<F, A1, A2, A3, A4, A5, A6, A7, A8>::bcefi_Vfunc8F8(
                                             F                procedure,
                                             bdema_Allocator *basicAllocator)
: bcefr_Vfunc8<A1, A2, A3, A4, A5, A6, A7, A8>(basicAllocator)
, d_f(procedure)
...
template <class F, class A1, class A2, class A3, class A4, class A5, class A6,
          class A7, class A8>
inline bcefi_Vfunc8F8<F, A1, A2, A3, A4, A5, A6, A7, A8>::~bcefi_Vfunc8F8()
{
}

template <class F, class A1, class A2, class A3, class A4, class A5, class A6,
          class A7, class A8>
inline void bcefi_Vfunc8F8<F, A1, A2, A3, A4, A5, A6, A7, A8>::execute(
                                                   const A1& argument1,
                                                   const A2& argument2,
                                                   const A3& argument3,
                                                   const A4& argument4,
...
template <class F, class A1, class A2, class A3, class A4, class A5,
          class A6, class A7, class A8, class D1>
inline bcefi_Vfunc8F9<F, A1, A2, A3, A4, A5, A6, A7, A8, D1>::bcefi_Vfunc8F9(
                                             F                procedure,
                                             const D1&        embeddedArg1,
                                             bdema_Allocator *basicAllocator)
: bcefr_Vfunc8<A1, A2, A3, A4, A5, A6, A7, A8>(basicAllocator)
...
template <class F, class A1, class A2, class A3, class A4, class A5,
          class A6, class A7, class A8, class D1>
inline void bcefi_Vfunc8F9<F, A1, A2, A3, A4, A5, A6, A7, A8, D1>::execute(
                                                   const A1& argument1,
                                                   const A2& argument2,
                                                   const A3& argument3,
                                                   const A4& argument4,
...
template <class OBJ, class C, class A1, class A2,
          class A3, class A4, class A5, class A6, class A7, class A8>
inline bcefi_Vfunc8C8<OBJ, C, A1, A2, A3, A4, A5, A6, A7, A8>::bcefi_Vfunc8C8(
                                             const OBJ&       object,
                                             C                method,
                                             bdema_Allocator *basicAllocator)
: bcefr_Vfunc8<A1, A2, A3, A4, A5, A6, A7, A8>(basicAllocator)
...
template <class OBJ, class C, class A1, class A2,
          class A3, class A4, class A5, class A6, class A7, class A8>
inline
bcefi_Vfunc8C8<OBJ, C, A1, A2, A3, A4, A5, A6, A7, A8>::~bcefi_Vfunc8C8()
{
}
...
template <class OBJ, class C, class A1, class A2,
          class A3, class A4, class A5, class A6, class A7, class A8>
inline void bcefi_Vfunc8C8<OBJ, C, A1, A2, A3, A4, A5, A6, A7, A8>::execute(
                                                   const A1& argument1,
                                                   const A2& argument2,
                                                   const A3& argument3,
                                                   const A4& argument4,
...
template <class OBJ, class C, class A1, class A2,
          class A3, class A4, class A5, class A6, class A7, class A8, class D1>
inline
bcefi_Vfunc8C9<OBJ, C, A1, A2, A3, A4, A5, A6, A7, A8, D1>::bcefi_Vfunc8C9(
                                             const OBJ&       object,
                                             C                method,
                                             const D1&        embeddedArg1,
                                             bdema_Allocator *basicAllocator)
...
template <class OBJ, class C, class A1, class A2,
          class A3, class A4, class A5, class A6, class A7, class A8, class D1>
inline
void bcefi_Vfunc8C9<OBJ, C, A1, A2, A3, A4, A5, A6, A7, A8, D1>::execute(
                                                   const A1& argument1,
                                                   const A2& argument2,
                                                   const A3& argument3,
                                                   const A4& argument4,
...
template <class OBJ, class M, class A1, class A2,
          class A3, class A4, class A5, class A6, class A7, class A8>
inline bcefi_Vfunc8M8<OBJ, M, A1, A2, A3, A4, A5, A6, A7, A8>::bcefi_Vfunc8M8(
                                             OBJ             *object,
                                             M                method,
                                             bdema_Allocator *basicAllocator)
: bcefr_Vfunc8<A1, A2, A3, A4, A5, A6, A7, A8>(basicAllocator)
...
template <class OBJ, class M, class A1, class A2,
          class A3, class A4, class A5, class A6, class A7, class A8>
inline
bcefi_Vfunc8M8<OBJ, M, A1, A2, A3, A4, A5, A6, A7, A8>::~bcefi_Vfunc8M8()
{
}

template <class OBJ, class M, class A1, class A2,
          class A3, class A4, class A5, class A6, class A7, class A8>
inline void bcefi_Vfunc8M8<OBJ, M, A1, A2, A3, A4, A5, A6, A7, A8>::execute(
                                                   const A1& argument1,
                                                   const A2& argument2,
                                                   const A3& argument3,
                                                   const A4& argument4,
...
template <class OBJ, class M, class A1, class A2,
          class A3, class A4, class A5, class A6, class A7, class A8, class D1>
inline
bcefi_Vfunc8M9<OBJ, M, A1, A2, A3, A4, A5, A6, A7, A8, D1>::bcefi_Vfunc8M9(
                                             OBJ             *object,
                                             M                method,
                                             const D1&        embeddedArg1,
                                             bdema_Allocator *basicAllocator)
...
template <class OBJ, class M, class A1, class A2,
          class A3, class A4, class A5, class A6, class A7, class A8, class D1>
inline
void bcefi_Vfunc8M9<OBJ, M, A1, A2, A3, A4, A5, A6, A7, A8, D1>::execute(
                                                   const A1& argument1,
                                                   const A2& argument2,
                                                   const A3& argument3,
                                                   const A4& argument4,
