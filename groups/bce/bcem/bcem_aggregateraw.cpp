...
int bcem_AggregateRaw::descendIntoField(
                        bcem_AggregateError                  *errorDescription,
                        const bcem_AggregateRaw_NameOrIndex&  fieldOrIdx,
                                   ...
                                   int                  numItems) const
{
    ...
    switch (d_dataType) {
      ...
      default: {
        ...
        if (numItems > 0) {
            ArrayInserter inserter(index, numItems,
                                                     d_fieldDef);
