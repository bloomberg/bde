...
// [ 1] const char *toAscii(bcem_ErrorCode::Code val);
//
// FREE OPERATORS
// [ 2] operator<<(ostream& s, bcem_ErrorCode::Code val);
// ----------------------------------------------------------------------------
// [ 5] USAGE EXAMPLE
...
typedef bcem_ErrorCode::Code Enum;
typedef bcem_ErrorCode       Obj;
...
#undef NL
      ...
      case 2: {
        ...
        //
        // Testing:
        //   operator<<(ostream& s, bcem_ErrorCode::Code val);
        // --------------------------------------------------------------------
      ...
      case 1: {
        ...
        // Testing:
        //   enum Enum { ... };
        //   const char *toAscii(bcem_ErrorCode::Enum val);
        // -------------------------------------------------------------------
