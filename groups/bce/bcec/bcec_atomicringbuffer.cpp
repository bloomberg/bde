...
// The inner ring is implemented in the class 'bcec_AtomicRingBuffer'.  Each
// 'bcec_AtomicRingBuffer' object holds a 'bcec_AtomicRinBufferIndexManager'
// that it uses to manage the state of the elements in 'd_elements'.
