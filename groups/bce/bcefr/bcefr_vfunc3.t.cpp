...
//                              Overview
//                              --------
// 'bcefr_Vfunc3' is an abstract class that provides a pure virtual function
...
//
// In order to test 'bcefr_Vfunc3' we have to implement a concrete class
...
//
//-----------------------------------------------------------------------------
// [ 2] bcefr_Vfunc3<A1-3>(bslma_Allocator *ba);
// [ 2] void increment();
// [ 2] int decrement();
// [ 2] void execute(c_A1-3&) const;
// [ 2] ~bcefr_Vfunc3<A1-3>();
// [ 2] static void deleteObject(bcefr_Vfunc3 *object);
//-----------------------------------------------------------------------------
...
class ConcreteDerivedClass : public bcefr_Vfunc3 <A1, A2, A3> {
  public:
    ...
    virtual void execute(const A1& argument1, const A2& argument2,
        ...
        //
        // This function tests that the 'execute' method of 'bcefr_Vfunc3' is
...
template <class A1, class A2, class A3>
class EnvelopeClass {
    // Provide an object that encapsulates a 'bcefr_Vfunc3' object.

    bcefr_Vfunc3<A1, A2, A3> *d_rep_p;  // polymorphic functor representation

  public:
    // CREATORS
    EnvelopeClass(bcefr_Vfunc3<A1, A2, A3> *rep) : d_rep_p(rep)
    ...
    ~EnvelopeClass()
        ...
        // representation using 'deleteObject' method of 'bcefr_Vfunc3' class.
    {
        if (0 == d_rep_p->decrement()) {
            bcefr_Vfunc3<A1, A2, A3>::deleteObject(d_rep_p);
        }
    }
...
typedef bcefr_Vfunc3<int, int, int> Obj;
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
                          ...
                          << "=====================" << endl;
        {
            ...
            Obj *x = new(*myAllocator) DerivedObj(myAllocator);
            {
                ...
                ASSERT(1 == getCount(x));
                {
                    ...
                    ASSERT(2 == getCount(x));
                    env1(5, 7, 5);    ASSERT(2 == executeUsageCounter);
                }
                // The reference counter is 1
                ASSERT(1 == getCount(x));
      ...
      case 2: {
        ...
        //
        // Testing:
        //   bcefr_Vfunc3<A1-3>(bslma_Allocator *ba);
        //   void increment();
        //   int decrement();
        //   void execute(c_A1-3&) const;
        //   static void deleteObject(bcefr_Vfunc3 *object);
        //   ~bcefr_Vfunc3<A1-3>();
        // --------------------------------------------------------------------
