...
//
//@CLASSES:
//   bcefr_Vfunc3: thread-safe reference-counted base class with an allocator
//
...
// class for all internal representations of the 'bcef_Vfunc3' family of
...
// reflect the number of 'bcef_Vfunc3' objects (envelopes) or other partial
...
// information about the details of the 'bcefr_Vfunc3' object memory management
...
// classes derived from 'bcefr_Vfunc3' to declare destructor 'private' and
...
//           // representation using 'deleteObject' method of 'bcefr_Vfunc3'
//           // class.
//       {
...
class bcefr_Vfunc3 {
    ...
    // facilitates the use of 'bcefr_Vfunc3' as a reference-counted letter
    // class in the envelope-letter pattern.  'deleteObject' is used to to
    // destroy and deallocate the concrete objects derived from 'bcefr_Vfunc3',
  ...
  private:
    bcefr_Vfunc3(const bcefr_Vfunc3&);                  // not implemented
    bcefr_Vfunc3& operator=(const bcefr_Vfunc3&);       // not implemented

  protected:
    virtual ~bcefr_Vfunc3();
  ...
  public:
    ...
    // CREATORS
    bcefr_Vfunc3(bslma_Allocator *basicAllocator);
...
// PROTECTED CREATORS
template <class A1, class A2, class A3>
inline bcefr_Vfunc3<A1, A2, A3>::~bcefr_Vfunc3()
{
}

// CLASS METHODS
template <class A1, class A2, class A3>
void bcefr_Vfunc3<A1, A2, A3>::deleteObject(bcefr_Vfunc3 *object)
{
    object->~bcefr_Vfunc3();
...
// CREATORS
template <class A1, class A2, class A3>
inline bcefr_Vfunc3<A1, A2, A3>::bcefr_Vfunc3(bslma_Allocator *basicAllocator)
...
// MANIPULATORS
template <class A1, class A2, class A3>
inline void bcefr_Vfunc3<A1, A2, A3>::increment()
{
    bces_AtomicUtil::incrementInt(&d_count);
}

template <class A1, class A2, class A3>
inline int bcefr_Vfunc3<A1, A2, A3>::decrement()
{
