...
//
//@CLASSES:
//   bcefr_Vfunc0: thread-safe reference-counted base class with an allocator
//
...
// class for all internal representations of the 'bcef_Vfunc0' family of
...
// reflect the number of 'bcef_Vfunc0' objects (envelopes) or other partial
...
// information about the details of the 'bcefr_Vfunc0' object memory management
...
// classes derived from 'bcefr_Vfunc0' to declare destructor 'private' and
...
//..
// Instantiate a 'ConcreteDerivedClass' class derived from 'bcefr_Vfunc0'.
//..
...
//..
//   class EnvelopeClass {
//       // Provide an object that encapsulates a 'bcefr_Vfunc0' object.
//
//       bcefr_Vfunc0 *d_rep_p;
//           // polymorphic functor representation
//
//     public:
//       // CREATORS
//       EnvelopeClass(bcefr_Vfunc0 *rep) : d_rep_p(rep)
...
//           // representation using 'deleteObject' method of 'bcefr_Vfunc0'
//           // class.
//       {
...
class bcefr_Vfunc0 {
    ...
    // facilitates the use of 'bcefr_Vfunc0' as a reference-counted letter
    // class in the envelope-letter pattern.  'deleteObject' is used to to
    // destroy and deallocate the concrete objects derived from 'bcefr_Vfunc0',
  ...
  private:
    ...
    bcefr_Vfunc0& operator=(const bcefr_Vfunc0&);       // not implemented

  protected:
    virtual ~bcefr_Vfunc0();
  ...
  public:
    // CLASS METHODS
    static void deleteObject(bcefr_Vfunc0 *object);
...
// PROTECTED CREATORS
inline bcefr_Vfunc0::~bcefr_Vfunc0()
{
}

// CLASS METHODS
inline void bcefr_Vfunc0::deleteObject(bcefr_Vfunc0 *object)
{
    object->~bcefr_Vfunc0();
...
// MANIPULATORS
inline void bcefr_Vfunc0::increment()
{
    bces_AtomicUtil::incrementInt(&d_count);
}

inline int bcefr_Vfunc0::decrement()
{
