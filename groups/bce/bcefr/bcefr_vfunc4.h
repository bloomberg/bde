...
//
//@CLASSES:
//   bcefr_Vfunc4: thread-safe reference-counted base class with an allocator
//
...
// class for all internal representations of the 'bcef_Vfunc4' family of
...
// reflect the number of 'bcef_Vfunc4' objects (envelopes) or other partial
...
// information about the details of the 'bcefr_Vfunc4' object memory management
...
// classes derived from 'bcefr_Vfunc4' to declare destructor 'private' and
...
//..
// Instantiate a 'ConcreteDerivedClass' class derived from 'bcefr_Vfunc4'.
//..
...
//           // representation using 'deleteObject' method of 'bcefr_Vfunc4'
//           // class.
//       {
...
class bcefr_Vfunc4 {
    ...
    // facilitates the use of 'bcefr_Vfunc4' as a reference-counted letter
    // class in the envelope-letter pattern.  'deleteObject' is used to to
    // destroy and deallocate the concrete objects derived from 'bcefr_Vfunc4',
  ...
  private:
    bcefr_Vfunc4(const bcefr_Vfunc4&);                  // not implemented
    bcefr_Vfunc4& operator=(const bcefr_Vfunc4&);       // not implemented

  protected:
    virtual ~bcefr_Vfunc4();
  ...
  public:
    ...
    // CREATORS
    bcefr_Vfunc4(bslma_Allocator *basicAllocator);
...
// PROTECTED CREATORS
template <class A1, class A2, class A3, class A4>
inline bcefr_Vfunc4<A1, A2, A3, A4>::~bcefr_Vfunc4()
{
}

// CLASS METHODS
template <class A1, class A2, class A3, class A4>
void bcefr_Vfunc4<A1, A2, A3, A4>::deleteObject(bcefr_Vfunc4 *object)
{
    object->~bcefr_Vfunc4();
...
// MANIPULATORS
template <class A1, class A2, class A3, class A4>
inline void bcefr_Vfunc4<A1, A2, A3, A4>::increment()
{
    bces_AtomicUtil::incrementInt(&d_count);
}

template <class A1, class A2, class A3, class A4>
inline int bcefr_Vfunc4<A1, A2, A3, A4>::decrement()
{
