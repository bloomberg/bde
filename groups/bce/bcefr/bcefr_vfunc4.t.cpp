...
//                              Overview
//                              --------
// 'bcefr_Vfunc4' is an abstract class that provides a pure virtual function
...
//
// In order to test 'bcefr_Vfunc4' we have to implement a concrete class
...
//
//-----------------------------------------------------------------------------
// [ 2] bcefr_Vfunc4<A1-4>(bslma_Allocator *ba);
// [ 2] void increment();
// [ 2] int decrement();
// [ 2] void execute(c_A1-4&) const;
// [ 2] ~bcefr_Vfunc4<A1-4>();
// [ 2] static void deleteObject(bcefr_Vfunc4 *object);
//-----------------------------------------------------------------------------
...
class ConcreteDerivedClass : public bcefr_Vfunc4 <A1, A2, A3, A4> {
  public:
    ...
    virtual void execute(const A1& argument1, const A2& argument2,
        ...
        //
        // This function tests that the 'execute' method of 'bcefr_Vfunc4' is
...
template <class A1, class A2, class A3, class A4>
class EnvelopeClass {
    // Provide an object that encapsulates a 'bcefr_Vfunc4' object.

    bcefr_Vfunc4<A1, A2, A3, A4> *d_rep_p;
        // polymorphic functor representation

  public:
    // CREATORS
    EnvelopeClass(bcefr_Vfunc4<A1, A2, A3, A4> *rep) :
        d_rep_p(rep)
    ...
    ~EnvelopeClass()
        ...
        // representation using 'deleteObject' method of 'bcefr_Vfunc4' class.
    {
        if (0 == d_rep_p->decrement()) {
            bcefr_Vfunc4<A1, A2, A3, A4>::deleteObject(
                                                                     d_rep_p);
        }
    }
...
typedef bcefr_Vfunc4<int, int, int, int> Obj;
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 2: {
        ...
        //
        // Testing:
        //   bcefr_Vfunc4<A1-4>(bslma_Allocator *ba);
        //   void increment();
        //   int decrement();
        //   void execute(c_A1-4&) const;
        //   static void deleteObject(bcefr_Vfunc4 *object);
        //   ~bcefr_Vfunc4<A1-4>();
        // --------------------------------------------------------------------
