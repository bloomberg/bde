...
//                              Overview
//                              --------
// 'bcefr_Vfunc2' is an abstract class that provides a pure virtual function
...
//
// This test verifies that member functions modify 'd_count' according to
// their specification and that the static 'deleteObject' method destroys the
...
//
// We can observe the value of 'd_count' only through the return value of
// the 'decrement' method.  We will use a composition of the 'increment' and
...
//
// In order to test 'bcefr_Vfunc2' we have to implement a concrete class
...
// variables to ensure that both 'execute' method and the virtual
...
//
//-----------------------------------------------------------------------------
// [ 2] bcefr_Vfunc2<A1, A2>(bslma_Allocator *ba);
// [ 2] void increment();
// [ 2] int decrement();
// [ 2] void execute(const A1& argument1, const A2& argument2) const;
// [ 2] ~bcefr_Vfunc2<A1, A2>();
// [ 2] static void deleteObject(bcefr_Vfunc2 *object);
//-----------------------------------------------------------------------------
...
class ConcreteDerivedClass : public bcefr_Vfunc2 <A1, A2> {
  public:
    ...
    virtual void execute(const A1& argument1, const A2& argument2) const
        ...
        //
        // This function tests that the 'execute' method of 'bcefr_Vfunc2' is
...
template <class A1, class A2>
class EnvelopeClass {
    // Provide an object that encapsulates a 'bcefr_Vfunc2' object.

    bcefr_Vfunc2<A1, A2> *d_rep_p;  // polymorphic functor representation

  public:
    // CREATORS
    EnvelopeClass(bcefr_Vfunc2<A1, A2> *rep) : d_rep_p(rep)
    ...
    ~EnvelopeClass()
        ...
        // representation using 'deleteObject' method of 'bcefr_Vfunc2' class.
    {
...
typedef bcefr_Vfunc2<int, int> Obj;
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 2: {
        ...
        //        initialize 'd_allocator_p'.  Check the value of
        //        'd_count' using global 'getCount' function.
        ...
        //
        // Testing:
        //   bcefr_Vfunc2<A1, A2>(bslma_Allocator *ba);
        //   void increment();
        //   int decrement();
        //   void execute(const A1& argument1, const A2& argument2) const;
        //   static void deleteObject(bcefr_Vfunc2 *object);
        //   ~bcefr_Vfunc2<A1, A2>();
        // --------------------------------------------------------------------
      ...
      case 1: {
        ...
        //   We need to confirm that the helper returns current count
        //   without chnging it.
        //
        // Plan:
