...
//
//@CLASSES:
//   bcefr_Vfunc2: thread-safe reference-counted base class with an allocator
//
...
// class for all internal representations of the 'bcef_Vfunc2' family of
...
// reflect the number of 'bcef_Vfunc2' objects (envelopes) or other partial
...
// information about the details of the 'bcefr_Vfunc2' object memory management
...
// classes derived from 'bcefr_Vfunc2' to declare destructor 'private' and
...
//   };
//..
// Create an envelope class 'EnvelopeClass' that is using bcefr_Vfunc2<A1, A2>
//..
//   template <class A1, class A2>
//   class EnvelopeClass {
...
//           // representation using 'deleteObject' method of 'bcefr_Vfunc2'
//           // class.
//       {
...
class bcefr_Vfunc2 {
    ...
    // facilitates the use of 'bcefr_Vfunc2' as a reference-counted letter
    // class in the envelope-letter pattern.  'deleteObject' is used to to
    // destroy and deallocate the concrete objects derived from 'bcefr_Vfunc2',
  ...
  private:
    bcefr_Vfunc2(const bcefr_Vfunc2&);                  // not implemented
    bcefr_Vfunc2& operator=(const bcefr_Vfunc2&);       // not implemented

  protected:
    virtual ~bcefr_Vfunc2();
  ...
  public:
    ...
    // CREATORS
    bcefr_Vfunc2(bslma_Allocator *basicAllocator);
...
// PROTECTED CREATORS
template <class A1, class A2>
inline bcefr_Vfunc2<A1, A2>::~bcefr_Vfunc2()
{
}

// CLASS METHODS
template <class A1, class A2>
void bcefr_Vfunc2<A1, A2>::deleteObject(bcefr_Vfunc2 *object)
{
    object->~bcefr_Vfunc2();
...
// CREATORS
template <class A1, class A2>
inline bcefr_Vfunc2<A1, A2>::bcefr_Vfunc2(bslma_Allocator *basicAllocator)
...
// MANIPULATORS
template <class A1, class A2>
inline void bcefr_Vfunc2<A1, A2>::increment()
{
    bces_AtomicUtil::incrementInt(&d_count);
}

template <class A1, class A2>
inline int bcefr_Vfunc2<A1, A2>::decrement()
{
