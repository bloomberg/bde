...
//                              Overview
//                              --------
// 'bcefr_Vfunc1' is an abstract class that provides a pure virtual function
...
//
// In order to test 'bcefr_Vfunc1' we have to implement a concrete class
...
// [ 2] ~bcefr_Vfunc1<A1>();
// [ 2] static void deleteObject(bcefr_Vfunc1 *object);
//-----------------------------------------------------------------------------
...
class ConcreteDerivedClass : public bcefr_Vfunc1 <A1> {
  public:
    ...
    virtual void execute(const A1& argument1) const
        ...
        //
        // This function tests that the 'execute' method of 'bcefr_Vfunc1' is
...
class EnvelopeClass {
  ...
  public:
    ...
    ~EnvelopeClass()
        ...
        // representation using 'deleteObject' method of 'bcefr_Vfunc1' class.
    {
