...
//
//@CLASSES:
//   bcefr_Vfunc5: thread-safe reference-counted base class with an allocator
//
...
// class for all internal representations of the 'bcef_Vfunc5' family of
...
// reflect the number of 'bcef_Vfunc5' objects (envelopes) or other partial
...
// information about the details of the 'bcefr_Vfunc5' object memory management
...
// classes derived from 'bcefr_Vfunc5' to declare destructor 'private' and
...
//..
// Instantiate a 'ConcreteDerivedClass' class derived from 'bcefr_Vfunc5'.
//..
//   template <class A1, class A2, class A3, class A4, class A5>
//   class ConcreteDerivedClass : public bcefr_Vfunc5 <A1, A2, A3, A4, A5>
//   {
//     public:
//       ConcreteDerivedClass(bslma_Allocator *basicAllocator)
//       : bcefr_Vfunc5(basicAllocator) { }
//
...
// bcefr_Vfunc5<A1, A2, A3, A4, A5>
//..
//   template <class A1, class A2, class A3, class A4, class A5>
//   class EnvelopeClass {
//       // Provide an object that encapsulates a 'bcefr_Vfunc5' object.
//
//       bcefr_Vfunc5<A1, A2, A3, A4, A5> *d_rep_p;
//           // polymorphic functor representation
//
//     public:
//       // CREATORS
//       EnvelopeClass(bcefr_Vfunc5<A1, A2, A3, A4, A5> *rep) :
//           d_rep_p(rep)
...
//           // representation using 'deleteObject' method of 'bcefr_Vfunc5'
//           // class.
//       {
...
//   typedef bcefr_Vfunc5<int, int, int, int, int> Obj;
...
//       env1(1, 2, 3, 4, 5);    ASSERT(1 == executeUsageCounter);
//       {
//           EnvelopeClass<int, int, int, int, int> env1(x);
...
class bcefr_Vfunc5 {
    ...
    // facilitates the use of 'bcefr_Vfunc5' as a reference-counted letter
    // class in the envelope-letter pattern.  'deleteObject' is used to to
    // destroy and deallocate the concrete objects derived from 'bcefr_Vfunc5',
  ...
  private:
    bcefr_Vfunc5(const bcefr_Vfunc5&);                  // not implemented
    bcefr_Vfunc5& operator=(const bcefr_Vfunc5&);       // not implemented

  protected:
    virtual ~bcefr_Vfunc5();
  ...
  public:
    // CLASS METHODS
    static void deleteObject(bcefr_Vfunc5 *object);
    ...
    // CREATORS
    bcefr_Vfunc5(bslma_Allocator *basicAllocator);
...
// PROTECTED CREATORS
template <class A1, class A2, class A3, class A4, class A5>
inline bcefr_Vfunc5<A1, A2, A3, A4, A5>::~bcefr_Vfunc5()
{
}

// CLASS METHODS
template <class A1, class A2, class A3, class A4, class A5>
void bcefr_Vfunc5<A1, A2, A3, A4, A5>::deleteObject(bcefr_Vfunc5 *object)
{
    object->~bcefr_Vfunc5();
...
// MANIPULATORS
template <class A1, class A2, class A3, class A4, class A5>
inline void bcefr_Vfunc5<A1, A2, A3, A4, A5>::increment()
{
    bces_AtomicUtil::incrementInt(&d_count);
}

template <class A1, class A2, class A3, class A4, class A5>
inline int bcefr_Vfunc5<A1, A2, A3, A4, A5>::decrement()
{
