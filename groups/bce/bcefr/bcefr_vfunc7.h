...
#define INCLUDED_BCEFR_VFUNC7

//@PURPOSE: Provide a common reference-counted base class representation.
//
//@CLASSES:
//   bcefr_Vfunc7: thread_safe reference-counted base class with an allocator
//
//@AUTHOR: John Lakos (jlakos)
//
//@DESCRIPTION: This component defines the common (partially implemented) base
// class for all internal representations of the 'bcef_Vfunc7' family of
...
// reflect the number of 'bcef_Vfunc7' objects (envelopes) or other partial
...
// information about the details of the 'bcefr_Vfunc7' object memory management
...
// classes derived from 'bcefr_Vfunc7' to declare destructor 'private' and
...
//..
// Instantiate a 'ConcreteDerivedClass' class derived from 'bcefr_Vfunc7'.
//..
//   template <class A1, class A2, class A3, class A4, class A5, class A6,
//             class A7>
//   class ConcreteDerivedClass : public bcefr_Vfunc7 <A1, A2, A3, A4, A5,
//                                                       A6, A7> {
//     public:
//       ConcreteDerivedClass(bdema_Allocator *basicAllocator)
//       : bcefr_Vfunc7(basicAllocator) { }
//
...
// bcefr_Vfunc7<A1, A2, A3, A4, A5, A6, A7>
//..
//   template <class A1, class A2, class A3, class A4, class A5, class A6,
//             class A7>
//   class EnvelopeClass {
...
//           // representation using 'deleteObject' method of 'bcefr_Vfunc7'
//           // class.
//       {
...
//       env1(1, 2, 3, 4, 5, 6, 7);    ASSERT(1 == executeUsageCounter);
//       {
//           EnvelopeClass<int, int, int, int, int, int, int> env1(x);
...
class bcefr_Vfunc7 {
    ...
    // facilitates the use of 'bcefr_Vfunc7' as a reference-counted letter
    // class in the envelope-letter pattern.  'deleteObject' is used to to
    // destroy and deallocate the concrete objects derived from 'bcefr_Vfunc7',
  ...
  private:
    bcefr_Vfunc7(const bcefr_Vfunc7&);                  // not implemented
    bcefr_Vfunc7& operator=(const bcefr_Vfunc7&);       // not implemented

  protected:
    virtual ~bcefr_Vfunc7();
  ...
  public:
    ...
    // CREATORS
    bcefr_Vfunc7(bdema_Allocator *basicAllocator);
...
template <class A1, class A2, class A3, class A4, class A5, class A6,
          class A7>
inline bcefr_Vfunc7<A1, A2, A3, A4, A5, A6, A7>::~bcefr_Vfunc7()
{
}
...
template <class A1, class A2, class A3, class A4, class A5, class A6,
          class A7>
void bcefr_Vfunc7<A1, A2, A3, A4, A5, A6, A7>::deleteObject(
                                                        bcefr_Vfunc7 *object)
{
    object->~bcefr_Vfunc7();
...
template <class A1, class A2, class A3, class A4, class A5, class A6,
          class A7>
inline void bcefr_Vfunc7<A1, A2, A3, A4, A5, A6, A7>::increment()
{
...
template <class A1, class A2, class A3, class A4, class A5, class A6,
          class A7>
inline int bcefr_Vfunc7<A1, A2, A3, A4, A5, A6, A7>::decrement()
{
