...
//                              Overview
//                              --------
// 'bcefr_Vfunc8' is an abstract class that provides a pure virtual function
...
//
// In order to test 'bcefr_Vfunc8' we have to implement a concrete class
...
//
//-----------------------------------------------------------------------------
// [ 2] bcefr_Vfunc8<A1-8>(bdema_Allocator *ba);
// [ 2] void increment();
// [ 2] int decrement();
// [ 2] void execute(c_A1-8&) const;
// [ 2] ~bcefr_Vfunc8<A1-8>();
// [ 2] static void deleteObject(bcefr_Vfunc8 *object);
//-----------------------------------------------------------------------------
...
template <class A1, class A2, class A3, class A4, class A5, class A6,
          class A7, class A8>
class ConcreteDerivedClass : public bcefr_Vfunc8 <A1, A2, A3, A4, A5, A6,
                                                  A7, A8> {
  public:
    ...
    virtual void execute(const A1& argument1, const A2& argument2,
        ...
        //
        // This function tests that the 'execute' method of 'bcefr_Vfunc8' is
...
template <class A1, class A2, class A3, class A4, class A5, class A6,
          class A7, class A8>
class EnvelopeClass {
    // Provide an object that encapsulates a 'bcefr_Vfunc8' object.

    bcefr_Vfunc8<A1, A2, A3, A4, A5, A6, A7, A8> *d_rep_p;
        // polymorphic functor representation

  public:
    // CREATORS
    EnvelopeClass(bcefr_Vfunc8<A1, A2, A3, A4, A5, A6, A7, A8> *rep) :
        d_rep_p(rep)
    ...
    ~EnvelopeClass()
        ...
        // representation using 'deleteObject' method of 'bcefr_Vfunc8' class.
    {
        if (0 == d_rep_p->decrement()) {
            bcefr_Vfunc8<A1, A2, A3, A4, A5, A6, A7, A8>::deleteObject(
                                                                     d_rep_p);
        }
    }
...
typedef bcefr_Vfunc8<int, int, int, int, int, int, int, int> Obj;
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      case 4: {
                          ...
                          << "=====================" << endl;
        {
            ...
            typedef ConcreteDerivedClass<int, int, int, int, int,
                                         int, int, int> DerivedObj;
            typedef bcefr_Vfunc8<int, int, int, int, int,
                                 int, int, int> Obj;
            ...
            Obj *x = new(*myAllocator) DerivedObj(myAllocator);
            {
                ...
                ASSERT(0 == getCount(x));
                EnvelopeClass<int, int, int, int, int,
                              int, int, int> env1(x);
      ...
      case 2: {
        ...
        //
        // Testing:
        //   bcefr_Vfunc8<A1-8>(bdema_Allocator *ba);
        //   void increment();
        //   int decrement();
        //   void execute(c_A1-8&) const;
        //   static void deleteObject(bcefr_Vfunc8 *object);
        //   ~bcefr_Vfunc8<A1-8>();
        // --------------------------------------------------------------------
