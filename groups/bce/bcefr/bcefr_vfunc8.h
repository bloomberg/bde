...
#define INCLUDED_BCEFR_VFUNC8

//@PURPOSE: Provide a common reference-counted base class representation.
//
//@CLASSES:
//   bcefr_Vfunc8: thread-safe reference-counted base class with an allocator
//
//@AUTHOR: John Lakos (jlakos)
//
//@DESCRIPTION: This component defines the common (partially implemented) base
// class for all internal representations of the 'bcef_Vfunc8' family of
...
// reflect the number of 'bcef_Vfunc8' objects (envelopes) or other partial
...
// information about the details of the 'bcefr_Vfunc8' object memory management
...
// classes derived from 'bcefr_Vfunc8' to declare destructor 'private' and
...
//..
// Instantiate a 'ConcreteDerivedClass' class derived from 'bcefr_Vfunc8'.
//..
//   template <class A1, class A2, class A3, class A4, class A5, class A6,
//             class A7, class A8>
//   class ConcreteDerivedClass : public bcefr_Vfunc8 <A1, A2, A3, A4, A5,
//                                                       A6, A7, A8> {
//     public:
//       ConcreteDerivedClass(bdema_Allocator *basicAllocator)
//       : bcefr_Vfunc8(basicAllocator) { }
//
...
// bcefr_Vfunc8<A1, A2, A3, A4, A5, A6, A7, A8>
//..
//   template <class A1, class A2, class A3, class A4, class A5, class A6,
//             class A7, class A8>
//   class EnvelopeClass {
...
//           // representation using 'deleteObject' method of 'bcefr_Vfunc8'
//           // class.
//       {
...
//       env1(1, 2, 3, 4, 5, 6, 7, 8);    ASSERT(1 == executeUsageCounter);
//       {
//           EnvelopeClass<int, int, int, int, int, int, int, int> env1(x);
...
class bcefr_Vfunc8 {
    ...
    // facilitates the use of 'bcefr_Vfunc8' as a reference-counted letter
    // class in the envelope-letter pattern.  'deleteObject' is used to to
    // destroy and deallocate the concrete objects derived from 'bcefr_Vfunc8',
  ...
  private:
    bcefr_Vfunc8(const bcefr_Vfunc8&);                  // not implemented
    bcefr_Vfunc8& operator=(const bcefr_Vfunc8&);       // not implemented

  protected:
    virtual ~bcefr_Vfunc8();
  ...
  public:
    ...
    // CREATORS
    bcefr_Vfunc8(bdema_Allocator *basicAllocator);
...
template <class A1, class A2, class A3, class A4, class A5, class A6,
          class A7, class A8>
inline bcefr_Vfunc8<A1, A2, A3, A4, A5, A6, A7, A8>::~bcefr_Vfunc8()
{
}
...
template <class A1, class A2, class A3, class A4, class A5, class A6,
          class A7, class A8>
void bcefr_Vfunc8<A1, A2, A3, A4, A5, A6, A7, A8>::deleteObject(
                                                        bcefr_Vfunc8 *object)
{
    object->~bcefr_Vfunc8();
...
template <class A1, class A2, class A3, class A4, class A5, class A6,
          class A7, class A8>
inline void bcefr_Vfunc8<A1, A2, A3, A4, A5, A6, A7, A8>::increment()
{
...
template <class A1, class A2, class A3, class A4, class A5, class A6,
          class A7, class A8>
inline int bcefr_Vfunc8<A1, A2, A3, A4, A5, A6, A7, A8>::decrement()
{
