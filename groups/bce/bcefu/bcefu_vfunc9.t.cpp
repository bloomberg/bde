...
//
//-----------------------------------------------------------------------------
// [ 9] makeF(         bcef_Vfunc9<A1-9> *,       F);
// [ 9] makeC(         bcef_Vfunc9<A1-9> *, c_O&, C);
// [ 9] makeM(         bcef_Vfunc9<A1-9> *, OBJ*, M);
// [ 9] makeF(   bA *, bcef_Vfunc9<A1-9> *,       F);
// [ 9] makeC(   bA *, bcef_Vfunc9<A1-9> *, c_O&, C);
// [ 9] makeM(   bA *, bcef_Vfunc9<A1-9> *, OBJ*, M);
// [ 9] makeNull(      bcef_Vfunc9<A1-9> *);
// [ 9] makeNull(bA *, bcef_Vfunc9<A1-9> *);
//-----------------------------------------------------------------------------
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      case 9: {
        ...
        //
        // Plan:
        //   Use each function to initialize a separate 'bcef_Vfunc9' object
        //   with the 'checkArgumentValues' function, which verifies that the
        //   parameters are "wired" correctly.  Use each function to
        //   initialize 'bcef_Vfunc9' object with the 'checkParameterTypes'
        ...
        //
        // Testing:
        //    makeF(         bcef_Vfunc9<A1-9> *,        F);
        //    makeC(         bcef_Vfunc9<A1-9> *, c_O&,  C);
        //    makeM(         bcef_Vfunc9<A1-9> *, OBJ *, M);
        //    makeNull(      bcef_Vfunc9<A1-9> *);
        //    makeF(   bA *, bcef_Vfunc9<A1-9> *,        F);
        //    makeC(   bA *, bcef_Vfunc9<A1-9> *, c_O&,  C);
        //    makeM(   bA *, bcef_Vfunc9<A1-9> *, OBJ *, M);
        //    makeNull(bA *, bcef_Vfunc9<A1-9> *);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bcef_Vfunc9<int *, int *, int *, int *, int *, int *,
                            int *, int *, int *> x1;
                bcefu_Vfunc9::makeF(&x1, checkArgumentValues9);
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            if (verbose) cout << "Testing 'makeF'" << endl;
            {
                bcef_Vfunc9<T1, T2, T3, T4, T5, T6, T7, T8, T9> x1;
                bcefu_Vfunc9::makeF(&x1, checkParameterTypes9);
                x1(a1, a2, a3, a4, a5, a6, a7, a8, a9);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            if (verbose) cout << "Testing 'makeF'" << endl;
            {
                bcef_Vfunc9<int *, int *, int *, int *, int *, int *,
                            int *, int *, int *> x1;
                bcefu_Vfunc9::makeF(&ta, &x1, checkArgumentValues9);
                x1(&a1, &a2, &a3, &a4, &a5, &a6, &a7, &a8, &a9);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            if (verbose) cout << "Testing 'makeC'" << endl;
            {
                bcef_Vfunc9<int *, int *, int *, int *, int *, int *,
                            int *, int *, int *> x1;
                bcefu_Vfunc9::makeC(&ta, &x1, cbObj,
                                    &CbClass::checkArgumentValues9);
                x1(&a1, &a2, &a3, &a4, &a5, &a6, &a7, &a8, &a9);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            if (verbose) cout << "Testing 'makeM'" << endl;
            {
                bcef_Vfunc9<int *, int *, int *, int *, int *, int *,
                            int *, int *, int *> x1;
                bcefu_Vfunc9::makeM(&ta, &x1, &cbObj,
                                    &CbClass::checkArgumentValues9);
                x1(&a1, &a2, &a3, &a4, &a5, &a6, &a7, &a8, &a9);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bcef_Vfunc9<T1, T2, T3, T4, T5, T6, T7, T8, T9> x1;
                bcefu_Vfunc9::makeF(&ta, &x1, checkParameterTypes9);
                x1(a1, a2, a3, a4, a5, a6, a7, a8, a9);
            }
