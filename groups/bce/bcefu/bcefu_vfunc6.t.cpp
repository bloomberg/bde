// bcefu_vfunc6.t.cpp              -*-C++-*-

#include <bcefu_vfunc6.h>
...
//
//-----------------------------------------------------------------------------
// [ 9] makeF(         bcef_Vfunc6<A1-6> *,       F, c_D1-3&);
// [ 9] makeC(         bcef_Vfunc6<A1-6> *, c_O&, C, c_D1-3&);
// [ 9] makeM(         bcef_Vfunc6<A1-6> *, OBJ*, M, c_D1-3&);
// [ 9] makeF(   bA *, bcef_Vfunc6<A1-6> *,       F, c_D1-3&);
// [ 9] makeC(   bA *, bcef_Vfunc6<A1-6> *, c_O&, C, c_D1-3&);
// [ 9] makeM(   bA *, bcef_Vfunc6<A1-6> *, OBJ*, M, c_D1-3&);
// [ 8] makeF(         bcef_Vfunc6<A1-6> *,       F, c_D1-2&);
// [ 8] makeC(         bcef_Vfunc6<A1-6> *, c_O&, C, c_D1-2&);
// [ 8] makeM(         bcef_Vfunc6<A1-6> *, OBJ*, M, c_D1-2&);
// [ 8] makeF(   bA *, bcef_Vfunc6<A1-6> *,       F, c_D1-2&);
// [ 8] makeC(   bA *, bcef_Vfunc6<A1-6> *, c_O&, C, c_D1-2&);
// [ 8] makeM(   bA *, bcef_Vfunc6<A1-6> *, OBJ*, M, c_D1-2&);
// [ 7] makeF(         bcef_Vfunc6<A1-6> *,       F, c_D1&);
// [ 7] makeC(         bcef_Vfunc6<A1-6> *, c_O&, C, c_D1&);
// [ 7] makeM(         bcef_Vfunc6<A1-6> *, OBJ*, M, c_D1&);
// [ 7] makeF(   bA *, bcef_Vfunc6<A1-6> *,       F, c_D1&);
// [ 7] makeC(   bA *, bcef_Vfunc6<A1-6> *, c_O&, C, c_D1&);
// [ 7] makeM(   bA *, bcef_Vfunc6<A1-6> *, OBJ*, M, c_D1&);
// [ 6] makeF(         bcef_Vfunc6<A1-6> *,       F);
// [ 6] makeC(         bcef_Vfunc6<A1-6> *, c_O&, C);
// [ 6] makeM(         bcef_Vfunc6<A1-6> *, OBJ*, M);
// [ 6] makeF(   bA *, bcef_Vfunc6<A1-6> *,       F);
// [ 6] makeC(   bA *, bcef_Vfunc6<A1-6> *, c_O&, C);
// [ 6] makeM(   bA *, bcef_Vfunc6<A1-6> *, OBJ*, M);
// [ 6] makeNull(      bcef_Vfunc6<A1-6> *);
// [ 6] makeNull(bA *, bcef_Vfunc6<A1-6> *);
//-----------------------------------------------------------------------------
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      case 9: {
        ...
        //
        // Plan:
        //   Use each function to initialize a separate 'bcef_Vfunc6' object
        //   with the 'checkArgumentValues' function, which verifies that the
        //   parameters are "wired" correctly.  Use each function to
        //   initialize 'bcef_Vfunc6' object with the 'checkParameterTypes'
        ...
        //
        // Testing:
        //    makeF(      bcef_Vfunc6<A1-6> *,        F, c_D1-3&);
        //    makeC(      bcef_Vfunc6<A1-6> *, c_O&,  C, c_D1-3&);
        //    makeM(      bcef_Vfunc6<A1-6> *, OBJ *, M, c_D1-3&);
        //    makeF(bA *, bcef_Vfunc6<A1-6> *,        F, c_D1-3&);
        //    makeC(bA *, bcef_Vfunc6<A1-6> *, c_O&,  C, c_D1-3&);
        //    makeM(bA *, bcef_Vfunc6<A1-6> *, OBJ *, M, c_D1-3&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bcef_Vfunc6<int *, int *, int *, int *, int *, int *> x1;
                bcefu_Vfunc6::makeF(&x1, checkArgumentValues9,
                                    &a7, &a8, &a9);
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            if (verbose) cout << "Testing 'makeF'" << endl;
            {
                bcef_Vfunc6<T1, T2, T3, T4, T5, T6> x1;
                bcefu_Vfunc6::makeF(&x1, checkParameterTypes9,
                                    a7, a8, a9);
                x1(a1, a2, a3, a4, a5, a6);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bcef_Vfunc6<int *, int *, int *, int *, int *, int *> x1;
                bcefu_Vfunc6::makeF(&ta, &x1, checkArgumentValues9,
                                    &a7, &a8, &a9);
                x1(&a1, &a2, &a3, &a4, &a5, &a6);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            {
                bcef_Vfunc6<int *, int *, int *, int *, int *, int *> x1;
                bcefu_Vfunc6::makeC(&ta, &x1, cbObj,
                                    &CbClass::checkArgumentValues9,
                                    &a7, &a8, &a9);
                x1(&a1, &a2, &a3, &a4, &a5, &a6);
                ASSERT(ARG1_PLUS1 == a1);
            ...
            {
                bcef_Vfunc6<int *, int *, int *, int *, int *, int *> x1;
                bcefu_Vfunc6::makeM(&ta, &x1, &cbObj,
                                    &CbClass::checkArgumentValues9,
                                    &a7, &a8, &a9);
                x1(&a1, &a2, &a3, &a4, &a5, &a6);
                ASSERT(ARG1_PLUS1 == a1);
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bcef_Vfunc6<T1, T2, T3, T4, T5, T6> x1;
                bcefu_Vfunc6::makeF(&ta, &x1, checkParameterTypes9,
                                    a7, a8, a9);
                x1(a1, a2, a3, a4, a5, a6);
            }
      ...
      case 8: {
        ...
        //
        // Testing:
        //    makeF(      bcef_Vfunc6<A1-6> *,        F, c_D1-2&);
        //    makeC(      bcef_Vfunc6<A1-6> *, c_O&,  C, c_D1-2&);
        //    makeM(      bcef_Vfunc6<A1-6> *, OBJ *, M, c_D1-2&);
        //    makeF(bA *, bcef_Vfunc6<A1-6> *,        F, c_D1-2&);
        //    makeC(bA *, bcef_Vfunc6<A1-6> *, c_O&,  C, c_D1-2&);
        //    makeM(bA *, bcef_Vfunc6<A1-6> *, OBJ *, M, c_D1-2&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bcef_Vfunc6<int *, int *, int *, int *, int *, int *> x1;
                bcefu_Vfunc6::makeF(&x1, checkArgumentValues8, &a7, &a8);
                x1(&a1, &a2, &a3, &a4, &a5, &a6);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            }
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bcef_Vfunc6<T1, T2, T3, T4, T5, T6> x1;
                bcefu_Vfunc6::makeF(&x1, checkParameterTypes8, a7, a8);
                x1(a1, a2, a3, a4, a5, a6);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bcef_Vfunc6<int *, int *, int *, int *, int *, int *> x1;
                bcefu_Vfunc6::makeF(&ta, &x1, checkArgumentValues8, &a7, &a8);
                x1(&a1, &a2, &a3, &a4, &a5, &a6);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bcef_Vfunc6<T1, T2, T3, T4, T5, T6> x1;
                bcefu_Vfunc6::makeF(&ta, &x1, checkParameterTypes8, a7, a8);
                x1(a1, a2, a3, a4, a5, a6);
            }
      ...
      case 7: {
        ...
        //
        // Testing:
        //    makeF(      bcef_Vfunc6<A1-6> *,        F, c_D1&);
        //    makeC(      bcef_Vfunc6<A1-6> *, c_O&,  C, c_D1&);
        //    makeM(      bcef_Vfunc6<A1-6> *, OBJ *, M, c_D1&);
        //    makeF(bA *, bcef_Vfunc6<A1-6> *,        F, c_D1&);
        //    makeC(bA *, bcef_Vfunc6<A1-6> *, c_O&,  C, c_D1&);
        //    makeM(bA *, bcef_Vfunc6<A1-6> *, OBJ *, M, c_D1&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bcef_Vfunc6<int *, int *, int *, int *, int *, int *> x1;
                bcefu_Vfunc6::makeF(&x1, checkArgumentValues7, &a7);
                x1(&a1, &a2, &a3, &a4, &a5, &a6);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            }
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bcef_Vfunc6<T1, T2, T3, T4, T5, T6> x1;
                bcefu_Vfunc6::makeF(&x1, checkParameterTypes7, a7);
                x1(a1, a2, a3, a4, a5, a6);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bcef_Vfunc6<int *, int *, int *, int *, int *, int *> x1;
                bcefu_Vfunc6::makeF(&ta, &x1, checkArgumentValues7, &a7);
                x1(&a1, &a2, &a3, &a4, &a5, &a6);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bcef_Vfunc6<T1, T2, T3, T4, T5, T6> x1;
                bcefu_Vfunc6::makeF(&ta, &x1, checkParameterTypes7, a7);
                x1(a1, a2, a3, a4, a5, a6);
            }
      ...
      case 6: {
        ...
        //
        // Testing:
        //    makeF(         bcef_Vfunc6<A1-6> *,        F);
        //    makeC(         bcef_Vfunc6<A1-6> *, c_O&,  C);
        //    makeM(         bcef_Vfunc6<A1-6> *, OBJ *, M);
        //    makeNull(      bcef_Vfunc6<A1-6> *);
        //    makeF(   bA *, bcef_Vfunc6<A1-6> *,        F);
        //    makeC(   bA *, bcef_Vfunc6<A1-6> *, c_O&,  C);
        //    makeM(   bA *, bcef_Vfunc6<A1-6> *, OBJ *, M);
        //    makeNull(bA *, bcef_Vfunc6<A1-6> *);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bcef_Vfunc6<int *, int *, int *, int *, int *, int *> x1;
                bcefu_Vfunc6::makeF(&x1, checkArgumentValues6);
                x1(&a1, &a2, &a3, &a4, &a5, &a6);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            }
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bcef_Vfunc6<T1, T2, T3, T4, T5, T6> x1;
                bcefu_Vfunc6::makeF(&x1, checkParameterTypes6);
                x1(a1, a2, a3, a4, a5, a6);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bcef_Vfunc6<int *, int *, int *, int *, int *, int *> x1;
                bcefu_Vfunc6::makeF(&ta, &x1, checkArgumentValues6);
                x1(&a1, &a2, &a3, &a4, &a5, &a6);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bcef_Vfunc6<T1, T2, T3, T4, T5, T6> x1;
                bcefu_Vfunc6::makeF(&ta, &x1, checkParameterTypes6);
                x1(a1, a2, a3, a4, a5, a6);
            }
