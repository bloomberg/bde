// bcefu_vfunc7.t.cpp              -*-C++-*-

#include "bcefu_vfunc7.h"
...
//
//-----------------------------------------------------------------------------
// [ 9] makeF(         bcef_Vfunc7<A1-7> *,       F, c_D1-2&);
// [ 9] makeC(         bcef_Vfunc7<A1-7> *, c_O&, C, c_D1-2&);
// [ 9] makeM(         bcef_Vfunc7<A1-7> *, OBJ*, M, c_D1-2&);
// [ 9] makeF(   bA *, bcef_Vfunc7<A1-7> *,       F, c_D1-2&);
// [ 9] makeC(   bA *, bcef_Vfunc7<A1-7> *, c_O&, C, c_D1-2&);
// [ 9] makeM(   bA *, bcef_Vfunc7<A1-7> *, OBJ*, M, c_D1-2&);
// [ 8] makeF(         bcef_Vfunc7<A1-7> *,       F, c_D1&);
// [ 8] makeC(         bcef_Vfunc7<A1-7> *, c_O&, C, c_D1&);
// [ 8] makeM(         bcef_Vfunc7<A1-7> *, OBJ*, M, c_D1&);
// [ 8] makeF(   bA *, bcef_Vfunc7<A1-7> *,       F, c_D1&);
// [ 8] makeC(   bA *, bcef_Vfunc7<A1-7> *, c_O&, C, c_D1&);
// [ 8] makeM(   bA *, bcef_Vfunc7<A1-7> *, OBJ*, M, c_D1&);
// [ 7] makeF(         bcef_Vfunc7<A1-7> *,       F);
// [ 7] makeC(         bcef_Vfunc7<A1-7> *, c_O&, C);
// [ 7] makeM(         bcef_Vfunc7<A1-7> *, OBJ*, M);
// [ 7] makeF(   bA *, bcef_Vfunc7<A1-7> *,       F);
// [ 7] makeC(   bA *, bcef_Vfunc7<A1-7> *, c_O&, C);
// [ 7] makeM(   bA *, bcef_Vfunc7<A1-7> *, OBJ*, M);
// [ 7] makeNull(      bcef_Vfunc7<A1-7> *);
// [ 7] makeNull(bA *, bcef_Vfunc7<A1-7> *);
//-----------------------------------------------------------------------------
...
class CbClass {
  public:
    void checkVfunc7ExecutionC() const
    {
        ++a0_global;
    }

    void checkVfunc7ExecutionM() const
    {
        ++a0_global;
    }
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      case 9: {
        ...
        //
        // Plan:
        //   Use each function to initialize a separate 'bcef_Vfunc7' object
        //   with the 'checkArgumentValues' function, which verifies that the
        //   parameters are "wired" correctly.  Use each function to
        //   initialize 'bcef_Vfunc7' object with the 'checkParameterTypes'
        ...
        //
        // Testing:
        //    makeF(      bcef_Vfunc7<A1-7> *,        F, c_D1-2&);
        //    makeC(      bcef_Vfunc7<A1-7> *, c_O&,  C, c_D1-2&);
        //    makeM(      bcef_Vfunc7<A1-7> *, OBJ *, M, c_D1-2&);
        //    makeF(bA *, bcef_Vfunc7<A1-7> *,        F, c_D1-2&);
        //    makeC(bA *, bcef_Vfunc7<A1-7> *, c_O&,  C, c_D1-2&);
        //    makeM(bA *, bcef_Vfunc7<A1-7> *, OBJ *, M, c_D1-2&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bcef_Vfunc7<int *, int *, int *, int *, int *, int *,
                            int *> x1;
                bcefu_Vfunc7::makeF(&x1, checkArgumentValues9, &a8, &a9);
            ...
            if (verbose) cout << "Testing 'makeC'" << endl;
            {
                bcef_Vfunc7<int *, int *, int *, int *, int *, int *,
                            int *> x1;
                bcefu_Vfunc7::makeC(&x1, cbObj,
                                    &CbClass::checkArgumentValues9, &a8, &a9);
                x1(&a1, &a2, &a3, &a4, &a5, &a6, &a7);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            }
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            if (verbose) cout << "Testing 'makeF'" << endl;
            {
                bcef_Vfunc7<T1, T2, T3, T4, T5, T6, T7> x1;
                bcefu_Vfunc7::makeF(&x1, checkParameterTypes9, a8, a9);
                x1(a1, a2, a3, a4, a5, a6, a7);
            }
            ...
            if (verbose) cout << "Testing 'makeC'" << endl;
            {
                ...
                CbClass cbObj;
                bcefu_Vfunc7::makeC(&x1, cbObj,
                                    &CbClass::checkParameterTypesC9, a8, a9);
                x1(a1, a2, a3, a4, a5, a6, a7);
            }
            ...
            if (verbose) cout << "Testing 'makeM'" << endl;
            {
                ...
                CbClass cbObj;
                bcefu_Vfunc7::makeM(&x1, &cbObj,
                                     &CbClass::checkParameterTypesM9, a8, a9);
                x1(a1, a2, a3, a4, a5, a6, a7);
            }
        }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            if (verbose) cout << "Testing 'makeF'" << endl;
            {
                bcef_Vfunc7<int *, int *, int *, int *, int *, int *,
                            int *> x1;
                bcefu_Vfunc7::makeF(&ta, &x1, checkArgumentValues9, &a8, &a9);
                x1(&a1, &a2, &a3, &a4, &a5, &a6, &a7);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            if (verbose) cout << "Testing 'makeC'" << endl;
            {
                bcef_Vfunc7<int *, int *, int *, int *, int *, int *,
                            int *> x1;
                bcefu_Vfunc7::makeC(&ta, &x1, cbObj,
                                    &CbClass::checkArgumentValues9, &a8, &a9);
                x1(&a1, &a2, &a3, &a4, &a5, &a6, &a7);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            if (verbose) cout << "Testing 'makeM'" << endl;
            {
                bcef_Vfunc7<int *, int *, int *, int *, int *, int *,
                            int *> x1;
                bcefu_Vfunc7::makeM(&ta, &x1, &cbObj,
                                    &CbClass::checkArgumentValues9, &a8, &a9);
                x1(&a1, &a2, &a3, &a4, &a5, &a6, &a7);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bcef_Vfunc7<T1, T2, T3, T4, T5, T6, T7> x1;
                bcefu_Vfunc7::makeF(&ta, &x1, checkParameterTypes9, a8, a9);
                x1(a1, a2, a3, a4, a5, a6, a7);
            }
      ...
      case 8: {
        ...
        //
        // Testing:
        //    makeF(      bcef_Vfunc7<A1-7> *,        F, c_D1&);
        //    makeC(      bcef_Vfunc7<A1-7> *, c_O&,  C, c_D1&);
        //    makeM(      bcef_Vfunc7<A1-7> *, OBJ *, M, c_D1&);
        //    makeF(bA *, bcef_Vfunc7<A1-7> *,        F, c_D1&);
        //    makeC(bA *, bcef_Vfunc7<A1-7> *, c_O&,  C, c_D1&);
        //    makeM(bA *, bcef_Vfunc7<A1-7> *, OBJ *, M, c_D1&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            if (verbose) cout << "Testing 'makeF'" << endl;
            {
                bcef_Vfunc7<int *, int *, int *, int *, int *, int *,
                            int *> x1;
                bcefu_Vfunc7::makeF(&x1, checkArgumentValues8, &a8);
                x1(&a1, &a2, &a3, &a4, &a5, &a6, &a7);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            }
            ...
            if (verbose) cout << "Testing 'makeC'" << endl;
            {
                bcef_Vfunc7<int *, int *, int *, int *, int *, int *,
                            int *> x1;
                bcefu_Vfunc7::makeC(&x1, cbObj,
                                    &CbClass::checkArgumentValues8, &a8);
                x1(&a1, &a2, &a3, &a4, &a5, &a6, &a7);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            }
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bcef_Vfunc7<T1, T2, T3, T4, T5, T6, T7> x1;
                bcefu_Vfunc7::makeF(&x1, checkParameterTypes8, a8);
                x1(a1, a2, a3, a4, a5, a6, a7);
            }
            ...
            if (verbose) cout << "Testing 'makeC'" << endl;
            {
                ...
                CbClass cbObj;
                bcefu_Vfunc7::makeC(&x1, cbObj,
                                    &CbClass::checkParameterTypesC8, a8);
                x1(a1, a2, a3, a4, a5, a6, a7);
            }
            ...
            if (verbose) cout << "Testing 'makeM'" << endl;
            {
                ...
                CbClass cbObj;
                bcefu_Vfunc7::makeM(&x1, &cbObj,
                                     &CbClass::checkParameterTypesM8, a8);
                x1(a1, a2, a3, a4, a5, a6, a7);
            }
        }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            if (verbose) cout << "Testing 'makeF'" << endl;
            {
                bcef_Vfunc7<int *, int *, int *, int *, int *, int *,
                            int *> x1;
                bcefu_Vfunc7::makeF(&ta, &x1, checkArgumentValues8, &a8);
                x1(&a1, &a2, &a3, &a4, &a5, &a6, &a7);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bcef_Vfunc7<T1, T2, T3, T4, T5, T6, T7> x1;
                bcefu_Vfunc7::makeF(&ta, &x1, checkParameterTypes8, a8);
                x1(a1, a2, a3, a4, a5, a6, a7);
            }
      ...
      case 7: {
        ...
        //
        // Testing:
        //    makeF(         bcef_Vfunc7<A1-7> *,        F);
        //    makeC(         bcef_Vfunc7<A1-7> *, c_O&,  C);
        //    makeM(         bcef_Vfunc7<A1-7> *, OBJ *, M);
        //    makeNull(      bcef_Vfunc7<A1-7> *);
        //    makeF(   bA *, bcef_Vfunc7<A1-7> *,        F);
        //    makeC(   bA *, bcef_Vfunc7<A1-7> *, c_O&,  C);
        //    makeM(   bA *, bcef_Vfunc7<A1-7> *, OBJ *, M);
        //    makeNull(bA *, bcef_Vfunc7<A1-7> *);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            if (verbose) cout << "Testing 'makeF'" << endl;
            {
                bcef_Vfunc7<int *, int *, int *, int *, int *, int *,
                            int *> x1;
                bcefu_Vfunc7::makeF(&x1, checkArgumentValues7);
                x1(&a1, &a2, &a3, &a4, &a5, &a6, &a7);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            }
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bcef_Vfunc7<T1, T2, T3, T4, T5, T6, T7> x1;
                bcefu_Vfunc7::makeF(&x1, checkParameterTypes7);
                x1(a1, a2, a3, a4, a5, a6, a7);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            if (verbose) cout << "Testing 'makeF'" << endl;
            {
                bcef_Vfunc7<int *, int *, int *, int *, int *, int *,
                            int *> x1;
                bcefu_Vfunc7::makeF(&ta, &x1, checkArgumentValues7);
                x1(&a1, &a2, &a3, &a4, &a5, &a6, &a7);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bcef_Vfunc7<T1, T2, T3, T4, T5, T6, T7> x1;
                bcefu_Vfunc7::makeF(&ta, &x1, checkParameterTypes7);
                x1(a1, a2, a3, a4, a5, a6, a7);
            }
