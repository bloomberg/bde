...
//
//-----------------------------------------------------------------------------
// [ 9] makeF(         bcef_Vfunc2<A1, A2> *,       F, c_D1-7&);
// [ 9] makeC(         bcef_Vfunc2<A1, A2> *, c_O&, C, c_D1-7&);
// [ 9] makeM(         bcef_Vfunc2<A1, A2> *, OBJ*, M, c_D1-7&);
// [ 9] makeF(   bA *, bcef_Vfunc2<A1, A2> *,       F, c_D1-7&);
// [ 9] makeC(   bA *, bcef_Vfunc2<A1, A2> *, c_O&, C, c_D1-7&);
// [ 9] makeM(   bA *, bcef_Vfunc2<A1, A2> *, OBJ*, M, c_D1-7&);
// [ 8] makeF(         bcef_Vfunc2<A1, A2> *,       F, c_D1-6&);
// [ 8] makeC(         bcef_Vfunc2<A1, A2> *, c_O&, C, c_D1-6&);
// [ 8] makeM(         bcef_Vfunc2<A1, A2> *, OBJ*, M, c_D1-6&);
// [ 8] makeF(   bA *, bcef_Vfunc2<A1, A2> *,       F, c_D1-6&);
// [ 8] makeC(   bA *, bcef_Vfunc2<A1, A2> *, c_O&, C, c_D1-6&);
// [ 8] makeM(   bA *, bcef_Vfunc2<A1, A2> *, OBJ*, M, c_D1-6&);
// [ 7] makeF(         bcef_Vfunc2<A1, A2> *,       F, c_D1-5&);
// [ 7] makeC(         bcef_Vfunc2<A1, A2> *, c_O&, C, c_D1-5&);
// [ 7] makeM(         bcef_Vfunc2<A1, A2> *, OBJ*, M, c_D1-5&);
// [ 7] makeF(   bA *, bcef_Vfunc2<A1, A2> *,       F, c_D1-5&);
// [ 7] makeC(   bA *, bcef_Vfunc2<A1, A2> *, c_O&, C, c_D1-5&);
// [ 7] makeM(   bA *, bcef_Vfunc2<A1, A2> *, OBJ*, M, c_D1-5&);
// [ 6] makeF(         bcef_Vfunc2<A1, A2> *,       F, c_D1-4&);
// [ 6] makeC(         bcef_Vfunc2<A1, A2> *, c_O&, C, c_D1-4&);
// [ 6] makeM(         bcef_Vfunc2<A1, A2> *, OBJ*, M, c_D1-4&);
// [ 6] makeF(   bA *, bcef_Vfunc2<A1, A2> *,       F, c_D1-4&);
// [ 6] makeC(   bA *, bcef_Vfunc2<A1, A2> *, c_O&, C, c_D1-4&);
// [ 6] makeM(   bA *, bcef_Vfunc2<A1, A2> *, OBJ*, M, c_D1-4&);
// [ 5] makeF(         bcef_Vfunc2<A1, A2> *,       F, c_D1-3&);
// [ 5] makeC(         bcef_Vfunc2<A1, A2> *, c_O&, C, c_D1-3&);
// [ 5] makeM(         bcef_Vfunc2<A1, A2> *, OBJ*, M, c_D1-3&);
// [ 5] makeF(   bA *, bcef_Vfunc2<A1, A2> *,       F, c_D1-3&);
// [ 5] makeC(   bA *, bcef_Vfunc2<A1, A2> *, c_O&, C, c_D1-3&);
// [ 5] makeM(   bA *, bcef_Vfunc2<A1, A2> *, OBJ*, M, c_D1-3&);
// [ 4] makeF(         bcef_Vfunc2<A1, A2> *,       F, c_D1-2&);
// [ 4] makeC(         bcef_Vfunc2<A1, A2> *, c_O&, C, c_D1-2&);
// [ 4] makeM(         bcef_Vfunc2<A1, A2> *, OBJ*, M, c_D1-2&);
// [ 4] makeF(   bA *, bcef_Vfunc2<A1, A2> *,       F, c_D1-2&);
// [ 4] makeC(   bA *, bcef_Vfunc2<A1, A2> *, c_O&, C, c_D1-2&);
// [ 4] makeM(   bA *, bcef_Vfunc2<A1, A2> *, OBJ*, M, c_D1-2&);
// [ 3] makeF(         bcef_Vfunc2<A1, A2> *,       F, c_D1&);
// [ 3] makeC(         bcef_Vfunc2<A1, A2> *, c_O&, C, c_D1&);
// [ 3] makeM(         bcef_Vfunc2<A1, A2> *, OBJ*, M, c_D1&);
// [ 3] makeF(   bA *, bcef_Vfunc2<A1, A2> *,       F, c_D1&);
// [ 3] makeC(   bA *, bcef_Vfunc2<A1, A2> *, c_O&, C, c_D1&);
// [ 3] makeM(   bA *, bcef_Vfunc2<A1, A2> *, OBJ*, M, c_D1&);
// [ 2] makeF(         bcef_Vfunc2<A1, A2> *,       F);
// [ 2] makeC(         bcef_Vfunc2<A1, A2> *, c_O&, C);
// [ 2] makeM(         bcef_Vfunc2<A1, A2> *, OBJ*, M);
// [ 2] makeF(   bA *, bcef_Vfunc2<A1, A2> *,       F);
// [ 2] makeC(   bA *, bcef_Vfunc2<A1, A2> *, c_O&, C);
// [ 2] makeM(   bA *, bcef_Vfunc2<A1, A2> *, OBJ*, M);
// [ 2] makeNull(      bcef_Vfunc2<A1, A2> *);
// [ 2] makeNull(bA *, bcef_Vfunc2<A1, A2> *);
//-----------------------------------------------------------------------------
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      case 9: {
        ...
        //
        // Plan:
        //   Use each function to initialize a separate 'bcef_Vfunc2' object
        //   with the 'checkArgumentValues' function, which verifies that the
        //   parameters are "wired" correctly.  Use each function to
        //   initialize 'bcef_Vfunc2' object with the 'checkParameterTypes'
        ...
        //
        // Testing:
        //    makeF(      bcef_Vfunc2<A1, A2> *,        F, c_D1-7&);
        //    makeC(      bcef_Vfunc2<A1, A2> *, c_O&,  C, c_D1-7&);
        //    makeM(      bcef_Vfunc2<A1, A2> *, OBJ *, M, c_D1-7&);
        //    makeF(bA *, bcef_Vfunc2<A1, A2> *,        F, c_D1-7&);
        //    makeC(bA *, bcef_Vfunc2<A1, A2> *, c_O&,  C, c_D1-7&);
        //    makeM(bA *, bcef_Vfunc2<A1, A2> *, OBJ *, M, c_D1-7&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bcef_Vfunc2<int *, int *> x1;
                bcefu_Vfunc2::makeF(&x1, checkArgumentValues9, &a3,
                                    &a4, &a5, &a6, &a7, &a8, &a9);
                x1(&a1, &a2);
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            if (verbose) cout << "Testing 'makeF'" << endl;
            {
                bcef_Vfunc2<T1, T2> x1;
                bcefu_Vfunc2::makeF(&x1, checkParameterTypes9, a3,
                                    a4, a5, a6, a7, a8, a9);
                x1(a1, a2);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bcef_Vfunc2<int *, int *> x1;
                bcefu_Vfunc2::makeF(&ta, &x1, checkArgumentValues9,
                                    &a3, &a4, &a5, &a6, &a7, &a8, &a9);
                x1(&a1, &a2);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            {
                bcef_Vfunc2<int *, int *> x1;
                bcefu_Vfunc2::makeC(&ta, &x1, cbObj,
                                    &CbClass::checkArgumentValues9,
                                    &a3, &a4, &a5, &a6, &a7, &a8, &a9);
                x1(&a1, &a2);
                ASSERT(ARG1_PLUS1 == a1);
            ...
            {
                bcef_Vfunc2<int *, int *> x1;
                bcefu_Vfunc2::makeM(&ta, &x1, &cbObj,
                                    &CbClass::checkArgumentValues9,
                                    &a3, &a4, &a5, &a6, &a7, &a8, &a9);
                x1(&a1, &a2);
                ASSERT(ARG1_PLUS1 == a1);
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bcef_Vfunc2<T1, T2> x1;
                bcefu_Vfunc2::makeF(&ta, &x1, checkParameterTypes9, a3,
                                    a4, a5, a6, a7, a8, a9);
                x1(a1, a2);
            }
      ...
      case 8: {
        ...
        //
        // Testing:
        //    makeF(      bcef_Vfunc2<A1, A2> *,        F, c_D1-6&);
        //    makeC(      bcef_Vfunc2<A1, A2> *, c_O&,  C, c_D1-6&);
        //    makeM(      bcef_Vfunc2<A1, A2> *, OBJ *, M, c_D1-6&);
        //    makeF(bA *, bcef_Vfunc2<A1, A2> *,        F, c_D1-6&);
        //    makeC(bA *, bcef_Vfunc2<A1, A2> *, c_O&,  C, c_D1-6&);
        //    makeM(bA *, bcef_Vfunc2<A1, A2> *, OBJ *, M, c_D1-6&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bcef_Vfunc2<int *, int *> x1;
                bcefu_Vfunc2::makeF(&x1, checkArgumentValues8, &a3,
                                    &a4, &a5, &a6, &a7, &a8);
                x1(&a1, &a2);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bcef_Vfunc2<T1, T2> x1;
                bcefu_Vfunc2::makeF(&x1, checkParameterTypes8, a3,
                                    a4, a5, a6, a7, a8);
                x1(a1, a2);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bcef_Vfunc2<int *, int *> x1;
                bcefu_Vfunc2::makeF(&ta, &x1, checkArgumentValues8,
                                    &a3, &a4, &a5, &a6, &a7, &a8);
                x1(&a1, &a2);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bcef_Vfunc2<T1, T2> x1;
                bcefu_Vfunc2::makeF(&ta, &x1, checkParameterTypes8, a3,
                                    a4, a5, a6, a7, a8);
                x1(a1, a2);
            }
      ...
      case 7: {
        ...
        //
        // Testing:
        //    makeF(      bcef_Vfunc2<A1, A2> *,        F, c_D1-5&);
        //    makeC(      bcef_Vfunc2<A1, A2> *, c_O&,  C, c_D1-5&);
        //    makeM(      bcef_Vfunc2<A1, A2> *, OBJ *, M, c_D1-5&);
        //    makeF(bA *, bcef_Vfunc2<A1, A2> *,        F, c_D1-5&);
        //    makeC(bA *, bcef_Vfunc2<A1, A2> *, c_O&,  C, c_D1-5&);
        //    makeM(bA *, bcef_Vfunc2<A1, A2> *, OBJ *, M, c_D1-5&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bcef_Vfunc2<int *, int *> x1;
                bcefu_Vfunc2::makeF(&x1, checkArgumentValues7, &a3,
                                    &a4, &a5, &a6, &a7);
                x1(&a1, &a2);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bcef_Vfunc2<T1, T2> x1;
                bcefu_Vfunc2::makeF(&x1, checkParameterTypes7, a3,
                                    a4, a5, a6, a7);
                x1(a1, a2);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bcef_Vfunc2<int *, int *> x1;
                bcefu_Vfunc2::makeF(&ta, &x1, checkArgumentValues7,
                                    &a3, &a4, &a5, &a6, &a7);
                x1(&a1, &a2);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bcef_Vfunc2<T1, T2> x1;
                bcefu_Vfunc2::makeF(&ta, &x1, checkParameterTypes7, a3,
                                    a4, a5, a6, a7);
                x1(a1, a2);
            }
      ...
      case 6: {
        ...
        //
        // Testing:
        //    makeF(      bcef_Vfunc2<A1, A2> *,        F, c_D1-4&);
        //    makeC(      bcef_Vfunc2<A1, A2> *, c_O&,  C, c_D1-4&);
        //    makeM(      bcef_Vfunc2<A1, A2> *, OBJ *, M, c_D1-4&);
        //    makeF(bA *, bcef_Vfunc2<A1, A2> *,        F, c_D1-4&);
        //    makeC(bA *, bcef_Vfunc2<A1, A2> *, c_O&,  C, c_D1-4&);
        //    makeM(bA *, bcef_Vfunc2<A1, A2> *, OBJ *, M, c_D1-4&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bcef_Vfunc2<int *, int *> x1;
                bcefu_Vfunc2::makeF(&x1, checkArgumentValues6, &a3,
                                    &a4, &a5, &a6);
                x1(&a1, &a2);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bcef_Vfunc2<T1, T2> x1;
                bcefu_Vfunc2::makeF(&x1, checkParameterTypes6, a3,
                                    a4, a5, a6);
                x1(a1, a2);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bcef_Vfunc2<int *, int *> x1;
                bcefu_Vfunc2::makeF(&ta, &x1, checkArgumentValues6,
                                    &a3, &a4, &a5, &a6);
                x1(&a1, &a2);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bcef_Vfunc2<T1, T2> x1;
                bcefu_Vfunc2::makeF(&ta, &x1, checkParameterTypes6, a3,
                                    a4, a5, a6);
                x1(a1, a2);
            }
      ...
      case 5: {
        ...
        //
        // Testing:
        //    makeF(      bcef_Vfunc2<A1, A2> *,        F, c_D1-3&);
        //    makeC(      bcef_Vfunc2<A1, A2> *, c_O&,  C, c_D1-3&);
        //    makeM(      bcef_Vfunc2<A1, A2> *, OBJ *, M, c_D1-3&);
        //    makeF(bA *, bcef_Vfunc2<A1, A2> *,        F, c_D1-3&);
        //    makeC(bA *, bcef_Vfunc2<A1, A2> *, c_O&,  C, c_D1-3&);
        //    makeM(bA *, bcef_Vfunc2<A1, A2> *, OBJ *, M, c_D1-3&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bcef_Vfunc2<int *, int *> x1;
                bcefu_Vfunc2::makeF(&x1, checkArgumentValues5, &a3,
                                    &a4, &a5);
                x1(&a1, &a2);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bcef_Vfunc2<T1, T2> x1;
                bcefu_Vfunc2::makeF(&x1, checkParameterTypes5, a3,
                                    a4, a5);
                x1(a1, a2);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bcef_Vfunc2<int *, int *> x1;
                bcefu_Vfunc2::makeF(&ta, &x1, checkArgumentValues5,
                                    &a3, &a4, &a5);
                x1(&a1, &a2);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bcef_Vfunc2<T1, T2> x1;
                bcefu_Vfunc2::makeF(&ta, &x1, checkParameterTypes5, a3,
                                    a4, a5);
                x1(a1, a2);
            }
      ...
      case 4: {
        ...
        //
        // Testing:
        //    makeF(      bcef_Vfunc2<A1, A2> *,        F, c_D1-2&);
        //    makeC(      bcef_Vfunc2<A1, A2> *, c_O&,  C, c_D1-2&);
        //    makeM(      bcef_Vfunc2<A1, A2> *, OBJ *, M, c_D1-2&);
        //    makeF(bA *, bcef_Vfunc2<A1, A2> *,        F, c_D1-2&);
        //    makeC(bA *, bcef_Vfunc2<A1, A2> *, c_O&,  C, c_D1-2&);
        //    makeM(bA *, bcef_Vfunc2<A1, A2> *, OBJ *, M, c_D1-2&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bcef_Vfunc2<int *, int *> x1;
                bcefu_Vfunc2::makeF(&x1, checkArgumentValues4, &a3,
                                    &a4);
                x1(&a1, &a2);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bcef_Vfunc2<T1, T2> x1;
                bcefu_Vfunc2::makeF(&x1, checkParameterTypes4, a3,
                                    a4);
                x1(a1, a2);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bcef_Vfunc2<int *, int *> x1;
                bcefu_Vfunc2::makeF(&ta, &x1, checkArgumentValues4,
                                    &a3, &a4);
                x1(&a1, &a2);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bcef_Vfunc2<T1, T2> x1;
                bcefu_Vfunc2::makeF(&ta, &x1, checkParameterTypes4, a3,
                                    a4);
                x1(a1, a2);
            }
      ...
      case 3: {
        ...
        //
        // Testing:
        //    makeF(      bcef_Vfunc2<A1, A2> *,        F, c_D1&);
        //    makeC(      bcef_Vfunc2<A1, A2> *, c_O&,  C, c_D1&);
        //    makeM(      bcef_Vfunc2<A1, A2> *, OBJ *, M, c_D1&);
        //    makeF(bA *, bcef_Vfunc2<A1, A2> *,        F, c_D1&);
        //    makeC(bA *, bcef_Vfunc2<A1, A2> *, c_O&,  C, c_D1&);
        //    makeM(bA *, bcef_Vfunc2<A1, A2> *, OBJ *, M, c_D1&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bcef_Vfunc2<int *, int *> x1;
                bcefu_Vfunc2::makeF(&x1, checkArgumentValues3, &a3);
                x1(&a1, &a2);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            }
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bcef_Vfunc2<T1, T2> x1;
                bcefu_Vfunc2::makeF(&x1, checkParameterTypes3, a3);
                x1(a1, a2);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bcef_Vfunc2<int *, int *> x1;
                bcefu_Vfunc2::makeF(&ta, &x1, checkArgumentValues3, &a3);
                x1(&a1, &a2);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bcef_Vfunc2<T1, T2> x1;
                bcefu_Vfunc2::makeF(&ta, &x1, checkParameterTypes3, a3);
                x1(a1, a2);
            }
      ...
      case 2: {
        ...
        //
        // Testing:
        //    makeF(         bcef_Vfunc2<A1, A2> *,        F);
        //    makeC(         bcef_Vfunc2<A1, A2> *, c_O&,  C);
        //    makeM(         bcef_Vfunc2<A1, A2> *, OBJ *, M);
        //    makeNull(      bcef_Vfunc2<A1, A2> *);
        //    makeF(   bA *, bcef_Vfunc2<A1, A2> *,        F);
        //    makeC(   bA *, bcef_Vfunc2<A1, A2> *, c_O&,  C);
        //    makeM(   bA *, bcef_Vfunc2<A1, A2> *, OBJ *, M);
        //    makeNull(bA *, bcef_Vfunc2<A1, A2> *);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bcef_Vfunc2<int *, int *> x1;
                bcefu_Vfunc2::makeF(&x1, checkArgumentValues2);
                x1(&a1, &a2);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            }
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bcef_Vfunc2<T1, T2> x1;
                bcefu_Vfunc2::makeF(&x1, checkParameterTypes2);
                x1(a1, a2);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bcef_Vfunc2<int *, int *> x1;
                bcefu_Vfunc2::makeF(&ta, &x1, checkArgumentValues2);
                x1(&a1, &a2);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bcef_Vfunc2<T1, T2> x1;
                bcefu_Vfunc2::makeF(&ta, &x1, checkParameterTypes2);
                x1(a1, a2);
            }
