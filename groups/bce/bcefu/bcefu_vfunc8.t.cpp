...
//
//-----------------------------------------------------------------------------
// [ 9] makeF(         bcef_Vfunc8<A1-8> *,       F, c_D1&);
// [ 9] makeC(         bcef_Vfunc8<A1-8> *, c_O&, C, c_D1&);
// [ 9] makeM(         bcef_Vfunc8<A1-8> *, OBJ*, M, c_D1&);
// [ 9] makeF(   bA *, bcef_Vfunc8<A1-8> *,       F, c_D1&);
// [ 9] makeC(   bA *, bcef_Vfunc8<A1-8> *, c_O&, C, c_D1&);
// [ 9] makeM(   bA *, bcef_Vfunc8<A1-8> *, OBJ*, M, c_D1&);
// [ 8] makeF(         bcef_Vfunc8<A1-8> *,       F);
// [ 8] makeC(         bcef_Vfunc8<A1-8> *, c_O&, C);
// [ 8] makeM(         bcef_Vfunc8<A1-8> *, OBJ*, M);
// [ 8] makeF(   bA *, bcef_Vfunc8<A1-8> *,       F);
// [ 8] makeC(   bA *, bcef_Vfunc8<A1-8> *, c_O&, C);
// [ 8] makeM(   bA *, bcef_Vfunc8<A1-8> *, OBJ*, M);
// [ 8] makeNull(      bcef_Vfunc8<A1-8> *);
// [ 8] makeNull(bA *, bcef_Vfunc8<A1-8> *);
//-----------------------------------------------------------------------------
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      case 9: {
        ...
        //
        // Plan:
        //   Use each function to initialize a separate 'bcef_Vfunc8' object
        //   with the 'checkArgumentValues' function, which verifies that the
        //   parameters are "wired" correctly.  Use each function to
        //   initialize 'bcef_Vfunc8' object with the 'checkParameterTypes'
        ...
        //
        // Testing:
        //    makeF(      bcef_Vfunc8<A1-8> *,        F, c_D1&);
        //    makeC(      bcef_Vfunc8<A1-8> *, c_O&,  C, c_D1&);
        //    makeM(      bcef_Vfunc8<A1-8> *, OBJ *, M, c_D1&);
        //    makeF(bA *, bcef_Vfunc8<A1-8> *,        F, c_D1&);
        //    makeC(bA *, bcef_Vfunc8<A1-8> *, c_O&,  C, c_D1&);
        //    makeM(bA *, bcef_Vfunc8<A1-8> *, OBJ *, M, c_D1&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bcef_Vfunc8<int *, int *, int *, int *, int *, int *,
                            int *, int *> x1;
                bcefu_Vfunc8::makeF(&x1, checkArgumentValues9, &a9);
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            if (verbose) cout << "Testing 'makeF'" << endl;
            {
                bcef_Vfunc8<T1, T2, T3, T4, T5, T6, T7, T8> x1;
                bcefu_Vfunc8::makeF(&x1, checkParameterTypes9, a9);
                x1(a1, a2, a3, a4, a5, a6, a7, a8);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            if (verbose) cout << "Testing 'makeF'" << endl;
            {
                bcef_Vfunc8<int *, int *, int *, int *, int *, int *,
                            int *, int *> x1;
                bcefu_Vfunc8::makeF(&ta, &x1, checkArgumentValues9, &a9);
                x1(&a1, &a2, &a3, &a4, &a5, &a6, &a7, &a8);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            if (verbose) cout << "Testing 'makeC'" << endl;
            {
                bcef_Vfunc8<int *, int *, int *, int *, int *, int *,
                            int *, int *> x1;
                bcefu_Vfunc8::makeC(&ta, &x1, cbObj,
                                    &CbClass::checkArgumentValues9, &a9);
                x1(&a1, &a2, &a3, &a4, &a5, &a6, &a7, &a8);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            if (verbose) cout << "Testing 'makeM'" << endl;
            {
                bcef_Vfunc8<int *, int *, int *, int *, int *, int *,
                            int *, int *> x1;
                bcefu_Vfunc8::makeM(&ta, &x1, &cbObj,
                                    &CbClass::checkArgumentValues9, &a9);
                x1(&a1, &a2, &a3, &a4, &a5, &a6, &a7, &a8);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bcef_Vfunc8<T1, T2, T3, T4, T5, T6, T7, T8> x1;
                bcefu_Vfunc8::makeF(&ta, &x1, checkParameterTypes9, a9);
                x1(a1, a2, a3, a4, a5, a6, a7, a8);
            }
      ...
      case 8: {
        ...
        //
        // Testing:
        //    makeF(         bcef_Vfunc8<A1-8> *,        F);
        //    makeC(         bcef_Vfunc8<A1-8> *, c_O&,  C);
        //    makeM(         bcef_Vfunc8<A1-8> *, OBJ *, M);
        //    makeNull(      bcef_Vfunc8<A1-8> *);
        //    makeF(   bA *, bcef_Vfunc8<A1-8> *,        F);
        //    makeC(   bA *, bcef_Vfunc8<A1-8> *, c_O&,  C);
        //    makeM(   bA *, bcef_Vfunc8<A1-8> *, OBJ *, M);
        //    makeNull(bA *, bcef_Vfunc8<A1-8> *);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            if (verbose) cout << "Testing 'makeF'" << endl;
            {
                bcef_Vfunc8<int *, int *, int *, int *, int *, int *,
                            int *, int *> x1;
                bcefu_Vfunc8::makeF(&x1, checkArgumentValues8);
                x1(&a1, &a2, &a3, &a4, &a5, &a6, &a7, &a8);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            }
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bcef_Vfunc8<T1, T2, T3, T4, T5, T6, T7, T8> x1;
                bcefu_Vfunc8::makeF(&x1, checkParameterTypes8);
                x1(a1, a2, a3, a4, a5, a6, a7, a8);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            if (verbose) cout << "Testing 'makeF'" << endl;
            {
                bcef_Vfunc8<int *, int *, int *, int *, int *, int *,
                            int *, int *> x1;
                bcefu_Vfunc8::makeF(&ta, &x1, checkArgumentValues8);
                x1(&a1, &a2, &a3, &a4, &a5, &a6, &a7, &a8);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bcef_Vfunc8<T1, T2, T3, T4, T5, T6, T7, T8> x1;
                bcefu_Vfunc8::makeF(&ta, &x1, checkParameterTypes8);
                x1(a1, a2, a3, a4, a5, a6, a7, a8);
            }
