// bcefu_vfunc2.h                  -*-C++-*-
#ifndef INCLUDED_BCEFU_VFUNC2
#define INCLUDED_BCEFU_VFUNC2
...
//..
//   bcefu_Vfunc2::makeF:    Initialize the functor by embedding a function
//                           (or another functor) and any additional trailing
//                           arguments.
//
//   bcefu_Vfunc2::makeC:    Initialize the functor by embedding an object, one
//                           of that object's 'const' methods, and any
//                           additional trailing arguments for that method.
//
//   bcefu_Vfunc2::makeM:    Initialize the functor by embedding THE ADDRESS OF
...
//
//   bcefu_Vfunc2::makeNull: Initialize the functor with an empty function.
//..
...
struct bcefu_Vfunc2 {
    ...
    static void makeNull(bcef_Vfunc2<A1, A2> *handle)
        ...
        // currently installed default allocator is used.
    {
        ...
        *handle = bcef_Vfunc2<A1, A2>(new(*ba) bcefi_Vfunc2Null<A1, A2>(ba));
    }

    template <class A1, class A2>
    static void makeNull(bslma_Allocator *basicAllocator,
                         bcef_Vfunc2<A1, A2> *handle)
        // Initialize the specified two-argument empty functor 'handle'.
        // Optionally specify, as the *first* argument, a 'basicAllocator' used
        // to supply memory.  If 'basicAllocator' is 0 or unspecified, the
        // currently installed default allocator is used.
    ...
    static void makeF(bcef_Vfunc2<A1, A2> *handle, F function)
    ...
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc2<A1, A2>(
                             new(*ba) bcefi_Vfunc2F2<F, A1, A2>(function, ba));
    }
    ...
    static void makeF(bcef_Vfunc2<A1, A2> *handle,
                      F                function,
        ...
        // installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc2<A1, A2>(
          new(*ba) bcefi_Vfunc2F3<F, A1, A2, D1> (function, embeddedArg1, ba));
    }
        ...
        // currently installed default allocator is used.
    {
        ...
        *handle = bcef_Vfunc2<A1, A2>(
            new(*ba) bcefi_Vfunc2F4<F, A1, A2, D1, D2>
        ...
        // currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc2<A1, A2>(
            new(*ba) bcefi_Vfunc2F5<F, A1, A2, D1, D2, D3>
        ...
        // currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc2<A1, A2>(
            new(*ba) bcefi_Vfunc2F6<F, A1, A2, D1, D2, D3, D4>
        ...
        // currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc2<A1, A2>(
            new(*ba) bcefi_Vfunc2F7<F, A1, A2, D1, D2, D3, D4, D5>
                (function, embeddedArg1, embeddedArg2, embeddedArg3,
        ...
        // currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc2<A1, A2>(
            new(*ba) bcefi_Vfunc2F8<F, A1, A2, D1, D2, D3, D4, D5, D6>
                (function, embeddedArg1, embeddedArg2, embeddedArg3,
        ...
        // currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc2<A1, A2>(
            new(*ba) bcefi_Vfunc2F9<F, A1, A2, D1, D2, D3, D4, D5, D6, D7>
                (function, embeddedArg1, embeddedArg2, embeddedArg3,
    ...
    static void makeC(bcef_Vfunc2<A1, A2> *handle, const OBJ& object,
                      C                method)
        // Initialize the specified two-argument functor 'handle' by embedding
        // the specified 'function' (or functor) taking no additional trailing
        // arguments.  Optionally specify, as the *first* argument, a
        ...
        // unspecified, the currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc2<A1, A2>(
            new(*ba) bcefi_Vfunc2C2<OBJ, C, A1, A2>(object, method, ba));
    }
    ...
    static void makeC(bcef_Vfunc2<A1, A2> *handle,
                      const OBJ&       object,
                      C                method,
                      const D1&        embeddedArg1)
        // Initialize the specified two-argument functor 'handle' by embedding
        ...
        // default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc2<A1, A2>(
            new(*ba) bcefi_Vfunc2C3<OBJ, C, A1, A2, D1>(
        ...
        // currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc2<A1, A2>(
            new(*ba) bcefi_Vfunc2C4<OBJ, C, A1, A2, D1, D2>(
        ...
        // currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc2<A1, A2>(
            new(*ba) bcefi_Vfunc2C5<OBJ, C, A1, A2, D1, D2, D3>(
        ...
        // currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc2<A1, A2>(
            new(*ba) bcefi_Vfunc2C6<OBJ, C, A1, A2, D1, D2, D3, D4>(
        ...
        // currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc2<A1, A2>(
            new(*ba) bcefi_Vfunc2C7<OBJ, C, A1, A2, D1, D2, D3, D4, D5>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, ba));
    }
        ...
        // currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc2<A1, A2>(
            new(*ba) bcefi_Vfunc2C8<OBJ, C, A1, A2, D1, D2, D3, D4, D5, D6>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, embeddedArg6, ba));
    }
        ...
        // currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc2<A1, A2>(
           new(*ba) bcefi_Vfunc2C9<OBJ, C, A1, A2, D1, D2, D3, D4, D5, D6, D7>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, embeddedArg6, embeddedArg7,  ba));
    }
    ...
    static void makeM(bcef_Vfunc2<A1, A2> *handle, OBJ *object,
                      M                method)
        // Initialize the specified two-argument functor 'handle' by embedding
        ...
        // unspecified, the currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc2<A1, A2>(
            new(*ba) bcefi_Vfunc2M2<OBJ, M, A1, A2>(object, method, ba));
    }
    ...
    static void makeM(bcef_Vfunc2<A1, A2> *handle,
                      OBJ             *object,
                      M                method,
                      const D1&        embeddedArg1)
        // Initialize the specified two-argument functor 'handle' by embedding
        ...
        // default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc2<A1, A2>(
            new(*ba) bcefi_Vfunc2M3<OBJ, M, A1, A2, D1>(
                object, method, embeddedArg1, ba));
    }
        ...
        // currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc2<A1, A2>(
            new(*ba) bcefi_Vfunc2M4<OBJ, M, A1, A2, D1, D2>(
                object, method, embeddedArg1, embeddedArg2, ba));
    }
...
static void makeM(bcef_Vfunc2<A1, A2> *handle,
        ...
        // currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc2<A1, A2>(
            new(*ba) bcefi_Vfunc2M5<OBJ, M, A1, A2, D1, D2, D3>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3, ba));
    }
        ...
        // currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc2<A1, A2>(
            new(*ba) bcefi_Vfunc2M6<OBJ, M, A1, A2, D1, D2, D3, D4>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, ba));
    }
        ...
        // currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc2<A1, A2>(
            new(*ba) bcefi_Vfunc2M7<OBJ, M, A1, A2, D1, D2, D3, D4, D5>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, ba));
    }
        ...
        // currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc2<A1, A2>(
            new(*ba) bcefi_Vfunc2M8<OBJ, M, A1, A2, D1, D2, D3, D4, D5, D6>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, embeddedArg6, ba));
    }
        ...
        // currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc2<A1, A2>(
           new(*ba) bcefi_Vfunc2M9<OBJ, M, A1, A2, D1, D2, D3, D4, D5, D6, D7>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, embeddedArg6, embeddedArg7, ba));
    }
