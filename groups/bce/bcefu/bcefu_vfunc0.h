// bcefu_vfunc0.h                  -*-C++-*-
#ifndef INCLUDED_BCEFU_VFUNC0
#define INCLUDED_BCEFU_VFUNC0
...
//
//@CLASSES:
//   bcefu_Vfunc0: namespace for factory methods loading 0-arg void functors
//
...
//..
//   bcefu_Vfunc0::makeF:    Initialize the functor by embedding a function
//                           (or another functor) and any additional trailing
//                           arguments.
//
//   bcefu_Vfunc0::makeC:    Initialize the functor by embedding an object, one
//                           of that object's 'const' methods, and any
//                           additional trailing arguments for that method.
//
//   bcefu_Vfunc0::makeM:    Initialize the functor by embedding THE ADDRESS OF
...
//
//   bcefu_Vfunc0::makeNull: Initialize the functor with an empty function.
//..
...
struct bcefu_Vfunc0 {
    ...
    static void makeNull(bcef_Vfunc0 *handle)
        ...
        // currently installed default allocator is used.
    {
        ...
        *handle = bcef_Vfunc0(new(*ba) bcefi_Vfunc0Null(ba));
    }
    ...
    template <class F>
    static void makeF(bcef_Vfunc0 *handle, F function)
        ...
        // unspecified, the currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc0(
                              new(*ba) bcefi_Vfunc0F0<F>(function, ba));
    }
        ...
        // installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc0(
            new(*ba) bcefi_Vfunc0F1<F, D1> (function, embeddedArg1, ba));
    }
        ...
        // currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc0(
            new(*ba) bcefi_Vfunc0F3<F, D1, D2, D3>
        ...
        // currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc0(
            new(*ba) bcefi_Vfunc0F4<F, D1, D2, D3, D4>
        ...
        // currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc0(
            new(*ba) bcefi_Vfunc0F5<F, D1, D2, D3, D4, D5>
                (function, embeddedArg1, embeddedArg2, embeddedArg3,
        ...
        // currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc0(
            new(*ba) bcefi_Vfunc0F6<F, D1, D2, D3, D4, D5, D6>
                (function, embeddedArg1, embeddedArg2, embeddedArg3,
        ...
        // currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc0(
            new(*ba) bcefi_Vfunc0F7<F, D1, D2, D3, D4, D5, D6, D7>
                (function, embeddedArg1, embeddedArg2, embeddedArg3,
        ...
        // currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc0(
            new(*ba) bcefi_Vfunc0F8<F, D1, D2, D3, D4, D5, D6, D7, D8>
                (function, embeddedArg1, embeddedArg2, embeddedArg3,
        ...
        // currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc0(
            new(*ba) bcefi_Vfunc0F9<F, D1, D2, D3, D4, D5, D6, D7, D8, D9>
                (function, embeddedArg1, embeddedArg2, embeddedArg3,
                 embeddedArg4, embeddedArg5, embeddedArg6, embeddedArg7,
    ...
    static void makeC(bcef_Vfunc0 *handle, const OBJ& object,
                      C            method)
        // Initialize the specified zero-argument functor 'handle' by embedding
        // the specified 'function' (or functor) taking no additional trailing
        // arguments.  Optionally specify, as the *first* argument, a
        ...
        // unspecified, the currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc0(
            new(*ba) bcefi_Vfunc0C0<OBJ, C>(object, method, ba));
    }
        ...
        // default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc0(
            new(*ba) bcefi_Vfunc0C1<OBJ, C, D1>(
        ...
        // currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc0(
            new(*ba) bcefi_Vfunc0C2<OBJ, C, D1, D2>(
        ...
        // currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc0(
            new(*ba) bcefi_Vfunc0C3<OBJ, C, D1, D2, D3>(
        ...
        // currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc0(
            new(*ba) bcefi_Vfunc0C4<OBJ, C, D1, D2, D3, D4>(
        ...
        // currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc0(
            new(*ba) bcefi_Vfunc0C5<OBJ, C, D1, D2, D3, D4, D5>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, ba));
    }
        ...
        // currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc0(
            new(*ba) bcefi_Vfunc0C6<OBJ, C, D1, D2, D3, D4, D5, D6>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, embeddedArg6, ba));
    }
        ...
        // currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc0(
            new(*ba) bcefi_Vfunc0C7<OBJ, C, D1, D2, D3, D4, D5, D6, D7>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, embeddedArg6, embeddedArg7,  ba));
    }
        ...
        // currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc0(
            new(*ba) bcefi_Vfunc0C8<OBJ, C, D1, D2, D3, D4, D5, D6, D7, D8>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, embeddedArg6, embeddedArg7,
                embeddedArg8, ba));
    }
        ...
        // currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc0(
           new(*ba) bcefi_Vfunc0C9<OBJ, C, D1, D2, D3, D4, D5, D6, D7, D8, D9>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, embeddedArg6, embeddedArg7,
                embeddedArg8, embeddedArg9, ba));
    }
    ...
    static void makeM(bcef_Vfunc0 *handle, OBJ *object,
                      M            method)
        // Initialize the specified zero-argument functor 'handle' by embedding
        ...
        // unspecified, the currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc0(
            new(*ba) bcefi_Vfunc0M0<OBJ, M>(object, method, ba));
    }
        ...
        // default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc0(
            new(*ba) bcefi_Vfunc0M1<OBJ, M, D1>(
                object, method, embeddedArg1, ba));
    }
        ...
        // currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc0(
            new(*ba) bcefi_Vfunc0M2<OBJ, M, D1, D2>(
                object, method, embeddedArg1, embeddedArg2, ba));
    }
        ...
        // currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc0(
            new(*ba) bcefi_Vfunc0M3<OBJ, M, D1, D2, D3>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3, ba));
    }
        ...
        // currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc0(
            new(*ba) bcefi_Vfunc0M4<OBJ, M, D1, D2, D3, D4>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, ba));
    }
        ...
        // currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc0(
            new(*ba) bcefi_Vfunc0M5<OBJ, M, D1, D2, D3, D4, D5>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, ba));
    }
        ...
        // currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc0(
            new(*ba) bcefi_Vfunc0M6<OBJ, M, D1, D2, D3, D4, D5, D6>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, embeddedArg6, ba));
    }
        ...
        // currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc0(
            new(*ba) bcefi_Vfunc0M7<OBJ, M, D1, D2, D3, D4, D5, D6, D7>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, embeddedArg6, embeddedArg7, ba));
    }
        ...
        // currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc0(
            new(*ba) bcefi_Vfunc0M8<OBJ, M, D1, D2, D3, D4, D5, D6, D7, D8>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, embeddedArg6, embeddedArg7,
                embeddedArg8, ba));
    }
        ...
        // currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bcef_Vfunc0(
           new(*ba) bcefi_Vfunc0M9<OBJ, M, D1, D2, D3, D4, D5, D6, D7, D8, D9>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, embeddedArg6, embeddedArg7,
                embeddedArg8, embeddedArg9, ba));
    }
