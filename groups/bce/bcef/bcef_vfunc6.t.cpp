...
//                              Overview
//                              --------
// The 'bcef_Vfunc6' class holds a pointer to an instance of a 'bcefr_Vfunc6'
// (an abstact class), and manipulates it appropriately.  Our main objective
// is to make sure that the 'bcefr_Vfunc6' object is initialized correctly and
// that its integer data (the reference count) is modified by the methods of
// 'bcef_Vfunc6' as expected.
//
...
//-----------------------------------------------------------------------------
// [ 1] bcef_Vfunc6<A1-6>();
// [ 1] bcef_Vfunc6<A1-6>(bcefr_Vfunc6<A1-6> *);
// [ 1] bcef_Vfunc6<A1-6>(const bcef_Vfunc6<A1-6>&);
// [ 1] ~bcef_Vfunc6<A1-6>();
// [ 2] bcef_Vfunc6<A1-6>& operator=(const bcef_Vfunc6<A1-6>&);
...
class FunctorRep : public bcefr_Vfunc6<A1, A2, A3, A4, A5, A6> {
...
//-----------------------------------------------------------------------------
    ...
    typedef bcefr_Vfunc6<int *, int *, int *, int *, int *, int *> ObjRep;
    typedef bcef_Vfunc6<int *, int *, int *, int *, int *, int *> Obj;
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 2: {
        ...
        //    2. A new object shares a 'bcefr_Vfunc6' object with its "right
        ...
        //   'bcefr_Vfunc6<A1, A2, A3, A4, A5, A6> *' object 'R'.  Call the
        //   constructor to create 'bcef_Vfunc6' objects 'Obj2' and 'Obj3'
        //   using 'R'.
        ...
        //    3c. N/A.
        //
        //   Create the 'bcefr_Vfunc6<A1, A2, A3, A4, A5, A6> *' object.  Call
        //   the constructor to create the 'bcef_Vfunc6' object 'Obj1'.
        ...
        //        to verify that 'Obj1' and 'Obj2' use the same 'bcefr_Vfunc6'
        //        object.
        //    3d. Check the reference counter using the 'getCount' function.
        //        Create another object and check it again.
        //
        //   Create two 'bcefr_Vfunc6<A1, A2, A3, A4, A5, A6> *' objects 'R1'
        //   and 'R2'.  Create two 'bcef_Vfunc6' objects 'Obj1' and 'Obj2'
        ...
        //        to verify that 'Obj2' and 'Obj3' use the same 'bcefr_Vfunc6'
        //        object.
        //    3e. Check the reference counter using the 'getCount' function
        //        before and after the assignment for both 'Obj1' and 'Obj2'
        //        representations.
        //
        //   Create a 'bcefr_Vfunc6<A1, A2, A3, A4, A5, A6> *' object.  Call
        //   the constructor to create a 'bcef_Vfunc6' object 'Obj1'.
        ...
        //
        // Testing:
        //   bcef_Vfunc6<A1-6>& operator=(const bcef_Vfunc6<A1-6>&);
        // --------------------------------------------------------------------
      ...
      case 1: {
        ...
        //    b. constructor taking a pointer to a 'bcefr_Vfunc6' object
        //    c. copy constructor
        //
        ...
        //    6. The 'bcefr_Vfunc6<A1, A2, A3, A4, A5, A6>' object
        ...
        //       'operator const void *() const'.
        //
        //   1b. Create the 'bcefr_Vfunc6<A1, A2, A3, A4, A5, A6> *' object.
        ...
        //       'bcefr_Vfunc6<A1, A2, A3, A4, A5, A6> *' object.  Verify that
        ...
        //       to verify that both 'bcef_Vfunc6' objects use the same
        //       'bcefr_Vfunc6' object.
        ...
        //
        // Testing:
        //   bcef_Vfunc6(const bcef_Vfunc6 &rhs);
        // --------------------------------------------------------------------
                          ...
                          << "==============================" << endl;
        {
            ...
            if (verbose)
                cout << "\nTesting Constructor Taking '*bcefr_Vfunc6'."
                     << endl;
