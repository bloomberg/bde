...
//
//@CLASSES:
//   bcef_Vfunc3: signature-specific function object (functor)
//
...
// construction.
//
// The 'bcef_Vfunc3' functor (envelope) holds a polymorphic, reference-counted,
...
// signature and (2) the supplied user data.  See the 'bcefu_vfunc3' component
// for more information on populating 'bcef_Vfunc3' function objects with
...
class bcef_Vfunc3 {
    ...
    // NOT IMPLEMENTED
    bool operator==(const bcef_Vfunc3&) const;
    bool operator!=(const bcef_Vfunc3&) const;

    template<class B1, class B2, class B3>
    bool operator==(const bcef_Vfunc3<B1, B2, B3>&) const;
    template<class B1, class B2, class B3>
    bool operator!=(const bcef_Vfunc3<B1, B2, B3>&) const;
  ...
  public:
    ...
    bcef_Vfunc3(bcefr_Vfunc3<A1, A2, A3> *representation);
        ...
        // components (see 'bcefu_vfunc3') to create an appropriate
        // representation and load it into an existing functor.

    bcef_Vfunc3(const bcef_Vfunc3<A1, A2, A3>& functionObject);
    ...
    ~bcef_Vfunc3();
        ...
        // the static 'deleteObject' method of 'bcefr_Vfunc3' base class).

    // MANIPULATORS
    bcef_Vfunc3<A1, A2, A3>& operator=(
        const bcef_Vfunc3<A1, A2, A3>& functionObject);
        ...
        // 'deleteObject' method of 'bcefr_Vfunc3' base class.
...
template <class A1, class A2, class A3>
inline bcef_Vfunc3<A1, A2, A3>::bcef_Vfunc3()
: d_rep_p(0)
{
}

template <class A1, class A2, class A3>
inline bcef_Vfunc3<A1, A2, A3>::bcef_Vfunc3(bcefr_Vfunc3<A1, A2, A3> *rep)
: d_rep_p(rep)
{
    if (d_rep_p) {
        d_rep_p->increment();
...
template <class A1, class A2, class A3>
inline bcef_Vfunc3<A1, A2, A3>::bcef_Vfunc3(const bcef_Vfunc3& functor)
...
bcef_Vfunc3<A1, A2, A3>&
bcef_Vfunc3<A1, A2, A3>::operator=(const bcef_Vfunc3<A1, A2, A3>& rhs)
{
...
template <class A1, class A2, class A3>
inline void bcef_Vfunc3<A1, A2, A3>::operator()(const A1& argument1,
                                                const A2& argument2,
                                                const A3& argument3) const
{
...
template <class A1, class A2, class A3>
inline bcef_Vfunc3<A1, A2, A3>::operator const void *() const
{
    return d_rep_p;
}
