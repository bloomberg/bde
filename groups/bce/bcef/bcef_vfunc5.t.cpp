...
//                              Overview
//                              --------
// The 'bcef_Vfunc5' class holds a pointer to an instance of a 'bcefr_Vfunc5'
// (an abstact class), and manipulates it appropriately.  Our main objective
// is to make sure that the 'bcefr_Vfunc5' object is initialized correctly and
// that its integer data (the reference count) is modified by the methods of
// 'bcef_Vfunc5' as expected.
//
...
//-----------------------------------------------------------------------------
// [ 1] bcef_Vfunc5<A1-5>();
// [ 1] bcef_Vfunc5<A1-5>(bcefr_Vfunc5<A1-5> *);
// [ 1] bcef_Vfunc5<A1-5>(const bcef_Vfunc5<A1-5>&);
// [ 1] ~bcef_Vfunc5<A1-5>();
// [ 2] bcef_Vfunc5<A1-5>& operator=(const bcef_Vfunc5<A1-5>&);
// [ 1] void operator()(c_A1-5&) const;
...
class FunctorRep : public bcefr_Vfunc5<A1, A2, A3, A4, A5> {
  ...
  private:
    // not implemented
    FunctorRep(const FunctorRep<F, A1, A2, A3, A4, A5, D1, D2, D3, D4>&);
    FunctorRep<F, A1, A2, A3, A4, A5, D1, D2, D3, D4>&
        operator=(const FunctorRep<F, A1, A2, A3, A4, A5, D1, D2, D3, D4>&);
  private:
    inline ~FunctorRep();
  ...
  public:
    ...
    inline FunctorRep(F                procedure,
        ...
        // four additional trailing arguments, and the corresponding
    ...
    inline void execute(const A1& argument1, const A2& argument2,
        ...
        // function, or functor) with the specified 'argument1-5' along with
...
template <class F, class A1, class A2, class A3, class A4, class A5,
          class D1, class D2, class D3, class D4>
inline FunctorRep<F, A1, A2, A3, A4, A5, D1, D2, D3, D4>::FunctorRep(
                                             F                procedure,
                                             const D1&        embeddedArg1,
                                             const D2&        embeddedArg2,
                                             const D3&        embeddedArg3,
...
template <class F, class A1, class A2, class A3, class A4, class A5,
          class D1, class D2, class D3, class D4>
inline
FunctorRep<F, A1, A2, A3, A4, A5, D1, D2, D3, D4>::~FunctorRep()
{
}

template <class F, class A1, class A2, class A3, class A4, class A5,
          class D1, class D2, class D3, class D4> inline
void FunctorRep<F, A1, A2, A3, A4, A5, D1, D2, D3, D4>::execute(
                                                   const A1& argument1,
                                                   const A2& argument2,
                                                   const A3& argument3,
                                                   const A4& argument4,
...
template <class F, class A1, class A2, class A3, class A4, class A5,
          class D1, class D2, class D3, class D4>
int
FunctorRep<F, A1, A2, A3, A4, A5, D1, D2, D3, D4>::invocationCounter() const
{
...
//-----------------------------------------------------------------------------
    ...
    typedef bcefr_Vfunc5<int *, int *, int *, int *, int *> ObjRep;
    typedef bcef_Vfunc5<int *, int *, int *, int *, int *> Obj;
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 2: {
        ...
        //    2. A new object shares a 'bcefr_Vfunc5' object with its "right
        ...
        //   'bcefr_Vfunc5<A1, A2, A3, A4, A5> *' object 'R'.  Call the
        //   constructor to create 'bcef_Vfunc5' objects 'Obj2' and 'Obj3'
        //   using 'R'.
        ...
        //    3c. N/A.
        //
        //   Create the 'bcefr_Vfunc5<A1, A2, A3, A4, A5> *' object.  Call the
        //   constructor to create the 'bcef_Vfunc5' object 'Obj1'.
        ...
        //        to verify that 'Obj1' and 'Obj2' use the same 'bcefr_Vfunc5'
        //        object.
        //    3d. Check the reference counter using the 'getCount' function.
        //        Create another object and check it again.
        //
        //   Create two 'bcefr_Vfunc5<A1, A2, A3, A4, A5> *' objects 'R1' and
        //   'R2'.  Create two 'bcef_Vfunc5' objects 'Obj1' and 'Obj2' using
        ...
        //        to verify that 'Obj2' and 'Obj3' use the same 'bcefr_Vfunc5'
        //        object.
        //    3e. Check the reference counter using the 'getCount' function
        //        before and after the assignment for both 'Obj1' and 'Obj2'
        //        representations.
        //
        //   Create a 'bcefr_Vfunc5<A1, A2, A3, A4, A5> *' object.  Call the
        //   constructor to create a 'bcef_Vfunc5' object 'Obj1'.
        ...
        //
        // Testing:
        //   bcef_Vfunc5<A1-5>& operator=(const bcef_Vfunc5<A1-5>&);
        // --------------------------------------------------------------------
                 ...
                 << endl;
        {
            ...
            ObjRep *rep1 = new(testAllocator)
                ParmMatchingFunctorImp(checkParameterMatching, &a6,
            ...
            cout << "    Testing assignment to an initialized object." << endl;
        {
            ...
            ObjRep *rep2 = new(testAllocator)
                ParmMatchingFunctorImp(checkParameterMatching, &b6,
      ...
      case 1: {
        ...
        //    b. constructor taking a pointer to a 'bcefr_Vfunc5' object
        //    c. copy constructor
        //
        ...
        //    6. The 'bcefr_Vfunc5<A1, A2, A3, A4, A5>' object
        ...
        //       'operator const void *() const'.
        //
        //   1b. Create the 'bcefr_Vfunc5<A1, A2, A3, A4, A5> *' object.
        ...
        //       'bcefr_Vfunc5<A1, A2, A3, A4, A5> *' object.  Verify that the
        ...
        //       to verify that both 'bcef_Vfunc5' objects use the same
        //       'bcefr_Vfunc5' object.
        ...
        //
        // Testing:
        //   bcef_Vfunc5(const bcef_Vfunc5 &rhs);
        // --------------------------------------------------------------------
                          ...
                          << "==============================" << endl;
        {
            ...
            if (verbose)
                cout << "\nTesting Constructor Taking '*bcefr_Vfunc5'."
                     << endl;
