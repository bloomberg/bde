...
//
//@CLASSES:
//   bcef_Vfunc5: signature-specific function object (functor)
//
...
// construction.
//
// The 'bcef_Vfunc5' functor (envelope) holds a polymorphic, reference-counted,
...
// signature and (2) the supplied user data.  See the 'bcefu_vfunc5' component
// for more information on populating 'bcef_Vfunc5' function objects with
...
class bcef_Vfunc5 {
    ...
    // NOT IMPLEMENTED
    bool operator==(const bcef_Vfunc5&) const;
    bool operator!=(const bcef_Vfunc5&) const;

    template<class B1, class B2, class B3, class B4, class B5>
    bool operator==(const bcef_Vfunc5<B1, B2, B3, B4, B5>&) const;
    template<class B1, class B2, class B3, class B4, class B5>
    bool operator!=(const bcef_Vfunc5<B1, B2, B3, B4, B5>&) const;
  ...
  public:
    ...
    bcef_Vfunc5(bcefr_Vfunc5<A1, A2, A3, A4, A5> *representation);
        ...
        // components (see 'bcefu_vfunc5') to create an appropriate
        // representation and load it into an existing functor.

    bcef_Vfunc5(const bcef_Vfunc5<A1, A2, A3, A4, A5>& functionObject);
    ...
    ~bcef_Vfunc5();
        ...
        // the static 'deleteObject' method of 'bcefr_Vfunc5' base class).

    // MANIPULATORS
    bcef_Vfunc5<A1, A2, A3, A4, A5>& operator=(
        const bcef_Vfunc5<A1, A2, A3, A4, A5>& functionObject);
        ...
        // 'deleteObject' method of 'bcefr_Vfunc5' base class.
...
template <class A1, class A2, class A3, class A4, class A5>
inline bcef_Vfunc5<A1, A2, A3, A4, A5>::bcef_Vfunc5()
: d_rep_p(0)
{
}
...
template <class A1, class A2, class A3, class A4, class A5>
inline
bcef_Vfunc5<A1, A2, A3, A4, A5>::bcef_Vfunc5(
    bcefr_Vfunc5<A1, A2, A3, A4, A5> *rep)
: d_rep_p(rep)
{
    if (d_rep_p) {
        d_rep_p->increment();
...
template <class A1, class A2, class A3, class A4, class A5>
inline bcef_Vfunc5<A1, A2, A3, A4, A5>::bcef_Vfunc5(const bcef_Vfunc5& functor)
...
inline bcef_Vfunc5<A1, A2, A3, A4, A5>::~bcef_Vfunc5()
{
    if (d_rep_p && 0 == d_rep_p->decrement()) {
        bcefr_Vfunc5<A1, A2, A3, A4, A5>::deleteObject(d_rep_p);
    }
}

template <class A1, class A2, class A3, class A4, class A5> inline
bcef_Vfunc5<A1, A2, A3, A4, A5>&
bcef_Vfunc5<A1, A2, A3, A4, A5>::operator=(
    const bcef_Vfunc5<A1, A2, A3, A4, A5>& rhs)
{
...
template <class A1, class A2, class A3, class A4, class A5>
inline void bcef_Vfunc5<A1, A2, A3, A4, A5>::operator()(
                                                const A1& argument1,
                                                const A2& argument2,
                                                const A3& argument3,
                                                const A4& argument4,
...
template <class A1, class A2, class A3, class A4, class A5>
inline bcef_Vfunc5<A1, A2, A3, A4, A5>::operator const void *() const
{
    return d_rep_p;
}
