...
//                              Overview
//                              --------
// The 'bcef_Vfunc4' class holds a pointer to an instance of a 'bcefr_Vfunc4'
// (an abstact class), and manipulates it appropriately.  Our main objective
// is to make sure that the 'bcefr_Vfunc4' object is initialized correctly and
// that its integer data (the reference count) is modified by the methods of
// 'bcef_Vfunc4' as expected.
//
...
//-----------------------------------------------------------------------------
// [ 1] bcef_Vfunc4<A1-4>();
// [ 1] bcef_Vfunc4<A1-4>(bcefr_Vfunc4<A1-4> *);
// [ 1] bcef_Vfunc4<A1-4>(const bcef_Vfunc4<A1-4>&);
// [ 1] ~bcef_Vfunc4<A1-4>();
// [ 2] bcef_Vfunc4<A1-4>& operator=(const bcef_Vfunc4<A1-4>&);
...
class FunctorRep : public bcefr_Vfunc4<A1, A2, A3, A4> {
...
//-----------------------------------------------------------------------------
    ...
    typedef bcefr_Vfunc4<int *, int *, int *, int *> ObjRep;
    typedef bcef_Vfunc4<int *, int *, int *, int *> Obj;
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 2: {
        ...
        //    2. A new object shares a 'bcefr_Vfunc4' object with its "right
        ...
        //   'bcefr_Vfunc4<A1, A2, A3, A4> *' object 'R'.  Call the
        //   constructor to create 'bcef_Vfunc4' objects 'Obj2' and 'Obj3'
        //   using 'R'.
        ...
        //    3c. N/A.
        //
        //   Create the 'bcefr_Vfunc4<A1, A2, A3, A4> *' object.  Call the
        //   constructor to create the 'bcef_Vfunc4' object 'Obj1'.
        ...
        //        to verify that 'Obj1' and 'Obj2' use the same 'bcefr_Vfunc4'
        //        object.
        //    3d. Check the reference counter using the 'getCount' function.
        //        Create another object and check it again.
        //
        //   Create two 'bcefr_Vfunc4<A1, A2, A3, A4> *' objects 'R1' and 'R2'.
        //   Create two 'bcef_Vfunc4' objects 'Obj1' and 'Obj2' using 'R1'
        //   and 'R2', respectively.
        ...
        //        to verify that 'Obj2' and 'Obj3' use the same 'bcefr_Vfunc4'
        //        object.
        //    3e. Check the reference counter using the 'getCount' function
        //        before and after the assignment for both 'Obj1' and 'Obj2'
        //        representations.
        //
        //   Create a 'bcefr_Vfunc4<A1, A2, A3, A4> *' object.  Call the
        //   constructor to create a 'bcef_Vfunc4' object 'Obj1'.
        ...
        //
        // Testing:
        //   bcef_Vfunc4<A1-4>& operator=(const bcef_Vfunc4<A1-4>&);
        // --------------------------------------------------------------------
      ...
      case 1: {
        ...
        //    b. constructor taking a pointer to a 'bcefr_Vfunc4' object
        //    c. copy constructor
        //
        ...
        //    6. The 'bcefr_Vfunc4<A1, A2, A3, A4>' object
        ...
        //       'operator const void *() const'.
        //
        //   1b. Create the 'bcefr_Vfunc4<A1, A2, A3, A4> *' object.  Call the
        ...
        //       'bcefr_Vfunc4<A1, A2, A3, A4> *' object.  Verify that the
        ...
        //       to verify that both 'bcef_Vfunc4' objects use the same
        //       'bcefr_Vfunc4' object.
        ...
        //
        // Testing:
        //   bcef_Vfunc4(const bcef_Vfunc4 &rhs);
        // --------------------------------------------------------------------
                          ...
                          << "==============================" << endl;
        {
            ...
            if (verbose)
                cout << "\nTesting Constructor Taking '*bcefr_Vfunc4'."
                     << endl;
