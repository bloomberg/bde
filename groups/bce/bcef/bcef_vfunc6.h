...
//
//@CLASSES:
//   bcef_Vfunc6: signature-specific function object (functor)
//
...
// construction.
//
// The 'bcef_Vfunc6' functor (envelope) holds a polymorphic, reference-counted,
...
// signature and (2) the supplied user data.  See the 'bcefu_vfunc6' component
// for more information on populating 'bcef_Vfunc6' function objects with
...
class bcef_Vfunc6 {
    ...
    // NOT IMPLEMENTED
    bool operator==(const bcef_Vfunc6&) const;
    bool operator!=(const bcef_Vfunc6&) const;

    template<class B1, class B2, class B3, class B4, class B5, class B6>
    bool operator==(const bcef_Vfunc6<B1, B2, B3, B4, B5, B6>&) const;
    template<class B1, class B2, class B3, class B4, class B5, class B6>
    bool operator!=(const bcef_Vfunc6<B1, B2, B3, B4, B5, B6>&) const;

  public:
    // TRAITS
    BSLALG_DECLARE_NESTED_TRAITS(bcef_Vfunc6,
    ...
    bcef_Vfunc6(bcefr_Vfunc6<A1, A2, A3, A4, A5, A6> *representation);
        ...
        // components (see 'bcefu_vfunc6') to create an appropriate
        // representation and load it into an existing functor.

    bcef_Vfunc6(const bcef_Vfunc6<A1, A2, A3, A4, A5, A6>& functionObject);
    ...
    ~bcef_Vfunc6();
        ...
        // the static 'deleteObject' method of 'bcefr_Vfunc6' base class).

    // MANIPULATORS
    bcef_Vfunc6<A1, A2, A3, A4, A5, A6>& operator=(
        const bcef_Vfunc6<A1, A2, A3, A4, A5, A6>& functionObject);
        ...
        // 'deleteObject' method of 'bcefr_Vfunc6' base class.
...
template <class A1, class A2, class A3, class A4, class A5, class A6>
inline bcef_Vfunc6<A1, A2, A3, A4, A5, A6>::bcef_Vfunc6()
: d_rep_p(0)
{
}
...
template <class A1, class A2, class A3, class A4, class A5, class A6>
inline
bcef_Vfunc6<A1, A2, A3, A4, A5, A6>::bcef_Vfunc6(
    bcefr_Vfunc6<A1, A2, A3, A4, A5, A6> *rep)
: d_rep_p(rep)
{
    if (d_rep_p) {
        d_rep_p->increment();
...
inline bcef_Vfunc6<A1, A2, A3, A4, A5, A6>::~bcef_Vfunc6()
{
    if (d_rep_p && 0 == d_rep_p->decrement()) {
        bcefr_Vfunc6<A1, A2, A3, A4, A5, A6>::deleteObject(d_rep_p);
    }
}

template <class A1, class A2, class A3, class A4, class A5, class A6> inline
bcef_Vfunc6<A1, A2, A3, A4, A5, A6>&
bcef_Vfunc6<A1, A2, A3, A4, A5, A6>::operator=(
    const bcef_Vfunc6<A1, A2, A3, A4, A5, A6>& rhs)
{
...
template <class A1, class A2, class A3, class A4, class A5, class A6>
inline void bcef_Vfunc6<A1, A2, A3, A4, A5, A6>::operator()(
                                                const A1& argument1,
                                                const A2& argument2,
                                                const A3& argument3,
                                                const A4& argument4,
...
template <class A1, class A2, class A3, class A4, class A5, class A6>
inline bcef_Vfunc6<A1, A2, A3, A4, A5, A6>::operator const void *() const
{
    return d_rep_p;
}
