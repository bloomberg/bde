// bcef_vfunc2.h                -*-C++-*-
#ifndef INCLUDED_BCEF_VFUNC2
#define INCLUDED_BCEF_VFUNC2
...
//
//@CLASSES:
//   bcef_Vfunc2: signature-specific function object (functor)
//
...
// construction.
//
// The 'bcef_Vfunc2' functor (envelope) holds a polymorphic, reference-counted,
...
// signature and (2) the supplied user data.  See the 'bcefu_vfunc2' component
// for more information on populating 'bcef_Vfunc2' function objects with
...
class bcef_Vfunc2 {
  ...
  public:
    ...
    bcef_Vfunc2(bcefr_Vfunc2<A1, A2> *representation);
        ...
        // components (see 'bcefu_vfunc2') to create an appropriate
        // representation and load it into an existing functor.

    bcef_Vfunc2(const bcef_Vfunc2<A1, A2>& functionObject);
    ...
    ~bcef_Vfunc2();
        ...
        // the static 'deleteObject' method of 'bcefr_Vfunc2' base class).

    // MANIPULATORS
    bcef_Vfunc2<A1, A2>& operator=(const bcef_Vfunc2<A1, A2>& functionObject);
        ...
        // 'deleteObject' method of 'bcefr_Vfunc2' base class.
...
template <class A1, class A2>
inline bcef_Vfunc2<A1, A2>::bcef_Vfunc2()
: d_rep_p(0)
{
}

template <class A1, class A2>
inline bcef_Vfunc2<A1, A2>::bcef_Vfunc2(bcefr_Vfunc2<A1, A2> *rep)
: d_rep_p(rep)
{
    if (d_rep_p) {
        d_rep_p->increment();
...
template <class A1, class A2>
inline bcef_Vfunc2<A1, A2>::bcef_Vfunc2(const bcef_Vfunc2& functor)
...
inline bcef_Vfunc2<A1, A2>::~bcef_Vfunc2()
{
    if (d_rep_p && 0 == d_rep_p->decrement()) {
        bcefr_Vfunc2<A1, A2>::deleteObject(d_rep_p);
    }
}

template <class A1, class A2> inline
bcef_Vfunc2<A1, A2>&
bcef_Vfunc2<A1, A2>::operator=(const bcef_Vfunc2<A1, A2>& rhs)
{
...
template <class A1, class A2>
inline void bcef_Vfunc2<A1, A2>::operator()(const A1& argument1,
...
template <class A1, class A2>
inline bcef_Vfunc2<A1, A2>::operator const void *() const
{
    return d_rep_p;
}
