...
//                              Overview
//                              --------
// The 'bcef_Vfunc0' class holds a pointer to an instance of a 'bcefr_Vfunc0'
// (an abstact class), and manipulates it appropriately.  Our main objective
// is to make sure that the 'bcefr_Vfunc0' object is initialized correctly and
// that its integer data (the reference count) is modified by the methods of
// 'bcef_Vfunc0' as expected.
//
...
//-----------------------------------------------------------------------------
// [ 1] bcef_Vfunc0();
// [ 1] bcef_Vfunc0(bcefr_Vfunc0 *);
// [ 1] bcef_Vfunc0(const bcef_Vfunc0&);
// [ 1] ~bcef_Vfunc0();
// [ 2] bcef_Vfunc0& operator=(const bcef_Vfunc0&);
...
class FunctorRep : public bcefr_Vfunc0 {
...
//-----------------------------------------------------------------------------
    ...
    typedef bcefr_Vfunc0 ObjRep;
    typedef bcef_Vfunc0 Obj;
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 2: {
        ...
        //    2. A new object shares a 'bcefr_Vfunc0' object with its "right
        ...
        //   'bcefr_Vfunc0 *' object 'R'.  Call the constructor to create
        //   'bcef_Vfunc0' objects 'Obj2' and 'Obj3' using 'R'.
        ...
        //    3c. N/A.
        //
        //   Create the 'bcefr_Vfunc0 *' object.  Call the constructor to
        //   create the 'bcef_Vfunc0' object 'Obj1'.
        ...
        //        to verify that 'Obj1' and 'Obj2' use the same 'bcefr_Vfunc0'
        //        object.
        //    3d. Check the reference counter using the 'getCount' function.
        //        Create another object and check it again.
        //
        //   Create two 'bcefr_Vfunc0 *' objects 'R1' and 'R2'.  Create two
        //   'bcef_Vfunc0' objects 'Obj1' and 'Obj2' using 'R1' and 'R2',
        //   respectively.
        ...
        //        to verify that 'Obj2' and 'Obj3' use the same 'bcefr_Vfunc0'
        //        object.
        //    3e. Check the reference counter using the 'getCount' function
        //        before and after the assignment for both 'Obj1' and 'Obj2'
        //        representations.
        //
        //   Create a 'bcefr_Vfunc0 *' object.  Call the constructor to create
        //   a 'bcef_Vfunc0' object 'Obj1'.
        ...
        //
        // Testing:
        //   bcef_Vfunc0& operator=(const bcef_Vfunc0&);
        // --------------------------------------------------------------------
      ...
      case 1: {
        ...
        //    b. constructor taking a pointer to a 'bcefr_Vfunc0' object
        //    c. copy constructor
        //
        ...
        //    6. The 'bcefr_Vfunc0' object is destroyed when the
        ...
        //       'operator const void *() const'.
        //
        //   1b. Create the 'bcefr_Vfunc0 *' object.  Call the
        ...
        //       'bcefr_Vfunc0 *' object.  Verify that the reference counter
        //       is incremented.
        //
        ...
        //       to verify that both 'bcef_Vfunc0' objects use the same
        //       'bcefr_Vfunc0' object.
        ...
        //
        // Testing:
        //   bcef_Vfunc0(const bcef_Vfunc0 &rhs);
        // --------------------------------------------------------------------
                          ...
                          << "==============================" << endl;
        {
            ...
            if (verbose)
                cout << "\nTesting Constructor Taking '*bcefr_Vfunc0'."
                     << endl;
