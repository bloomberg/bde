...
// jobs.
//
// 'bcep_FixedThreadPool' implements a queuing mechanism that distributes work
...
// 'bcep_FixedThreadPool' will handle the queue management, thread management,
...
///Usage
///-----
// This example demonstrates the use of a 'bcep_FixedThreadPool' to parallelize
...
// to the Unix command 'fgrep'; the use of a 'bcep_FixedThreadPool' allows the
// utility to search multiple files concurrently.
//
// The example program will take as input a string and a list of files to
// search.  The program creates a 'bcep_FixedThreadPool', and then enqueues a
...
inline
int bcep_FixedThreadPool::enqueueJob(bcep_FixedThreadPoolJobFunc  function,
                                     void                        *userData)
{
...
inline
int bcep_FixedThreadPool::tryEnqueueJob(bcep_FixedThreadPoolJobFunc  function,
                                        void                        *userData)
{
