// bces_atomicutilimpl_ia64.t.cpp  -*-C++-*-
...
typedef bces_AtomicUtilImpl<bsls_Platform::CpuIa64> Obj;
...
{
#ifndef BSLS_PLATFORM__CPU_IA64
    ...
    switch (test) { case 0:
      ...
      case 5: {
                          ...
                          << endl;
        {
            ...
            const bsls_PlatformUtil::Int64 EXPTOTAL =
                                      NTHREADS * NITERATIONS * 2 + STARTVALUE;
            Obj::Int64 mInt;
                          ...
                          << endl;
        {
            ...
            const bsls_PlatformUtil::Int64 STARTVALUE =
                               (NTHREADS * NITERATIONS * 2) + EXPTOTAL;
            Obj::Int64 mInt;
      ...
      case 3: {
                          ...
                          << endl;
        {
            ...
            const bsls_PlatformUtil::Int64 EXPTOTAL   =
                      (NTHREADS * NITERATIONS * ADDVAL * 2) + STARTVALUE;
            Obj::Int64 mInt;
