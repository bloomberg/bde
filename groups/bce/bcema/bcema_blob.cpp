...
// Set 'NOT_PARANOID' to 0 for expensive checking beyond what would be expected
// in a safe build.  One of the test cases in the test driver will fail by
// design, to enforce that 'NOT_PARANOID' must be set to 1 when code is checked
// in.
