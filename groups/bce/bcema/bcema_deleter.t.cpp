...
class my_Deleter : public bcema_Deleter<my_Obj> {
...
int main(int argc, char *argv[]) {
    ...
    switch (test) { case 0:
      case 1: {
        ...
        //   'bcema_Deleter' class compiles and links when all virtual
        //   functions are defined.
        //
        // Plan:
        //   Construct an object of a class derived from 'bcema_Deleter'.
        //   Upcast a reference to the object to the base class
        //   'bcema_Deleter'.  Using the base class reference invoke both
        ...
        if (verbose) cout << "\tTesting '~bcema_Deleter'" << endl;
        {
            bcema_Deleter<my_Obj> *mX = new my_Deleter(&destructorFlag);
            delete mX;
