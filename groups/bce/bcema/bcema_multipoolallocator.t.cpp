// bcema_multipoolallocator.t.cpp  -*-C++-*-
...
// 'bcema_MultipoolAllocator' correctly proxies memory requests (except
// deallocation) to its 'bcema_Multipool' member; and 2) 'deallocate' method
...
//-----------------------------------------------------------------------------
// [1] bcema_MultipoolAllocator(numPools, basicAllocator);
// [1] ~bcema_MultipoolAllocator();
// [2] bcema_MultipoolAllocator(numPools);
// [2] bcema_MultipoolAllocator(numPools, Z);
// [3] bcema_MultipoolAllocator(numPools, minSize);
// [3] bcema_MultipoolAllocator(numPools, poolNumObjects);
// [3] bcema_MultipoolAllocator(numPools, minSize, poolNumObjects);
// [3] bcema_MultipoolAllocator(numPools, minSize, Z);
// [3] bcema_MultipoolAllocator(numPools, poolNumObjects, Z);
// [3] bcema_MultipoolAllocator(numPools, minSize, poolNumObjects, Z);
...
//..
//
///Example 2: Performance of a 'bcema_MultipoolAllocator'
/// - - - - - - - - - - - - - - - - - - - - - - - - - - -
// A 'bcema_MultipoolAllocator' can greatly improve efficiency when it is used
...
//                                                               maxChunkSize);
//      {
//          bcema_MultipoolAllocator ma(NUM_POOLS, strategy, maxChunkSize);
...
// using default constructed 'bcema_MultipoolAllocator' parameters, is shown
// below:
//..
//  New Delete Allocator:
//
    ...
    switch (test) { case 0:
      ...
      case 6: {
...

        {
            ...
            bcema_MultipoolAllocator mp(NUM_POOLS);
      ...
      case 5: {
        ...
        for (int j = 0; j < NUM_RES_DATA; ++j) {
            ...
            bcema_Multipool sp(&multiPoolTA);
      ...
      case 1: {
        ...
        //
        // Testing:
        //   bcema_MultipoolAllocator(basicAllocator);
