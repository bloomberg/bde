// baenet_httptransferencoding.h   -*-C++-*-   GENERATED FILE -- DO NOT EDIT
#ifndef INCLUDED_BAENET_HTTPTRANSFERENCODING
#define INCLUDED_BAENET_HTTPTRANSFERENCODING

#ifndef INCLUDED_BDES_IDENT
#include <bdes_ident.h>
#endif
BDES_IDENT_RCSID(baenet_httptransferencoding_h,"$Id$ $CSID$ $CCId$")
...
struct baenet_HttpTransferEncoding {
...
bsl::ostream& operator<<(bsl::ostream&                      stream,
                         baenet_HttpTransferEncoding::Value rhs);
...
BDEAT_DECL_ENUMERATION_TRAITS(baenet_HttpTransferEncoding)
...
// CLASS METHODS
inline
int baenet_HttpTransferEncoding::maxSupportedBdexVersion()
{
    return 1;  // versions start at 1
}

inline
int baenet_HttpTransferEncoding::fromString(Value *result, const bsl::string& string)
{
...
inline
bsl::ostream& baenet_HttpTransferEncoding::print(bsl::ostream&      stream,
                                 baenet_HttpTransferEncoding::Value value)
{
    return stream << toString(value);
}

template <class STREAM>
STREAM& baenet_HttpTransferEncoding::bdexStreamIn(STREAM&             stream,
                                   baenet_HttpTransferEncoding::Value& value,
                                   int                 version)
{
    switch(version) {
...
template <class STREAM>
STREAM& baenet_HttpTransferEncoding::bdexStreamOut(STREAM&              stream,
                                    baenet_HttpTransferEncoding::Value value,
                                    int                version)
{
    switch (version) {
...
bsl::ostream& operator<<(
        ...
        baenet_HttpTransferEncoding::Value rhs)
{
    return baenet_HttpTransferEncoding::print(stream, rhs);
}
