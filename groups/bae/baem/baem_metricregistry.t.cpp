...
// [ 3]  baem_MetricId getId(const bdeut_StringRef& , const bdeut_StringRef& );
// [ 2]  const baem_Category *addCategory(const bdeut_StringRef& category);
// [ 4]  const baem_Category *getCategory(const bdeut_StringRef& category);
// [ 6]  void setCategoryEnabled(const baem_Category* , isEnabled);
// [ 6]  void setAllCategoriesEnabled(bool );
// [10]  void setPreferredPublicationType(const baem_MetricId& ,
//                                        baem_PublicationType::Value );
// [11]  void setFormat(const baem_MetricId& , const baem_MetricFormat& );
// [12]  int createUserDataKey();
// [13]  void setUserData(baem_MetricId, int, const void *);
// [14]  void setUserData(const char *, int, const void *,bool);
// ACCESSORS
// [ 2]  bsl::size_t numMetrics() const;
// [ 2]  bsl::size_t numCategories() const;
// [ 2]  baem_MetricId findId(const bdeut_StringRef& ,
//                           const bdeut_StringRef& ) const;
// [ 2]  const baem_Category *findCategory(const bdeut_StringRef& ) const;
// [ 5]  void getAllCategories(bsl::vector<const baem_Category *> *) const;
...
void ConcurrencyTest::execute()
{
    ...
    for(int i = 0; i < 10; ++i) {
        ...
        stringId(&uniqueString1, "U1", bcemt_ThreadUtil::selfIdAsInt(), i);
        stringId(&uniqueString2, "U2", bcemt_ThreadUtil::selfIdAsInt(), i);
        const char *S1 = uniqueString1.c_str();
        const char *S2 = uniqueString2.c_str();

        bsl::vector<const baem_Category *> startCategories(d_allocator_p);
        ...
        bsl::vector<const baem_Category *> categories(d_allocator_p);
...
// 'registry', and then using this registry to create a 'baem_MetricId' for a
...
//..
// Next we use 'getCategory' to find the address of the 'baem_Category'
...
//..
      ...
      case 14:{
        ...
        //
        // Testing:
        //   int setUserDataKey(baem_MetricId, int, const void *);
        // --------------------------------------------------------------------
...

        {
            ...
            for (int i = 0;  i < NUM_METRICS; ++i) {
                ...
                for (int j = 0; j < NUM_METRICS; ++j) {
                    const void *EXP_VALUE =
                        ...
                        ? VALUE
                        : 0;
                    baem_MetricId id = mX.getId(METRICS[j].d_category,
                                                METRICS[j].d_name);
            ...
            if (veryVerbose) {
                ...
                for (int i = 0; i < NUM_METRICS; ++i) {
                    baem_MetricId id = mX.getId(METRICS[i].d_category,
                                                METRICS[i].d_name);
      ...
      case 13: {
        ...
        for (int i = 0; i < NUM_METRICS; ++i) {
            ...
            for (int j = 0; j < NUM_METRICS; ++j) {
                baem_MetricId testId = mX.getId(METRICS[j].d_category,
                                                METRICS[j].d_name);
      ...
      case 11: {
        ...
        BEGIN_BSLMA_EXCEPTION_TEST {
            ...
            const Format *f1 = id1.description()->format().ptr();
            const Format *f2 = id2.description()->format().ptr();
      ...
      case 10: {
        ...
        //
        // Testing:
        // void setPreferredPublicationType(const baem_MetricId&        ,
        //                                  baem_PublicationType::Value );
        // --------------------------------------------------------------------
    ...
    case 8: {
        ...
        //   'baem_MetricDescription' and 'baem_Category' objects that contain
    ...
    case 6: {
        ...
        //
        // Testing:
        //   void setCategoryEnabled(const baem_Category* , bool );
        ...
        bsl::vector<const baem_Category *> categories(Z);
      ...
      case 5: {
        ...
        //
        // Testing:
        //   void getAllCategories(bsl::vector<const baem_Category *>*) const;
        // --------------------------------------------------------------------
        ...
        const int NUM_CATEGORIES = sizeof CATEGORIES / sizeof *CATEGORIES;
        {
            ...
            bsl::set<const baem_Category *>    categorySet(Z);
            bsl::vector<const baem_Category *> categories(Z);
            ...
            for (int i = 0; i < NUM_CATEGORIES; ++i) {
                ...
                bsl::set<const baem_Category *> tempSet(categories.begin(),
                                                        categories.end());
        ...
        }
        {
            ...
            bsl::vector<const baem_Category *> initialVector(Z);
            initialVector.push_back(0);
            initialVector.push_back((const baem_Category *)1);
            initialVector.push_back((const baem_Category *)2);
            initialVector.push_back((const baem_Category *)3);
            const int INITIAL_SIZE = initialVector.size();

            Obj mX(Z); const Obj& MX = mX;
            {
                bsl::vector<const baem_Category *> categories(initialVector,Z);
            ...
            for (int i = 0; i < NUM_CATEGORIES; ++i) {
                ...
                bsl::vector<const baem_Category *> exp_categories(Z);
      ...
      case 4: {
        ...
        //
        // Testing:
        //   const baem_Category *getCategory(const bdeut_StringRef& );
        // --------------------------------------------------------------------
      ...
      case 3: {
        ...
        //
        // Testing:
        //   baem_MetricId getId(const bdeut_StringRef& ,
      ...
      case 2: {
        ...
        //                       const bdeut_StringRef& );
        //   const baem_Category *addCategory(const bdeut_StringRef& );
        //   bsl::size_t numMetrics() const;
        //   bsl::size_t numCategories() const;
        //   baem_MetricId findId(const bdeut_StringRef& ,
        //                        const bdeut_StringRef& ) const;
        //   const baem_Category *findCategory(const bdeut_StringRef& ) const;
        // --------------------------------------------------------------------
