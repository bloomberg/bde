...
//                                  Overview
//                                  --------
// The 'baem_MetricRecord' is a simple value object holding to
...
// CREATORS
// [ 3]  baem_MetricRecord();
// [ 5]  baem_MetricRecord(const baem_MetricRecord&  original);
// [ 3]  baem_MetricRecord(const baem_MetricId& metric);
// [ 3]  baem_MetricRecord(const baem_MetricId& metric,
//                         int                  count,
//                         double               total,
//                         double               min,
...
//
//  MANIPULATORS
// [ 6]  baem_MetricRecord& operator=(const baem_MetricRecord& rhs);
// [ 2]  baem_MetricId& metric();
// [ 2]  int& count();
// [ 2]  double& total();
// [ 2]  double& max();
// [ 2]  double& min();
...
//
// FREE OPERATORS
// [ 4]  bool operator==(const baem_MetricRecord&,
//                       const baem_MetricRecord&);
// [ 4]  bool operator!=(const baem_MetricRecord&,
//                       const baem_MetricRecord&);
...
// 'loadRequestSizeInformation' method that populates a 'baem_MetricRecord'
...
//..
// Now we create 'baem_MetricRecord' to hold our aggregated metrics values.
// Note that we create 'baem_MetricId' object by hand; however, in practice an
// id should be obtained from a 'baem_MetricRegistry' object (such as the one
// owned by a 'baem_MetricsManager').
//..
...
//..
      ...
      case 7: {
        ...
        //   operator<<(ostream&, const baem_MetricRecord&);
        // --------------------------------------------------------------------
      ...
      case 4: {
        ...
        //
        // Testing:
        //   bool operator==(const baem_MetricRecord&,
        //                   const baem_MetricRecord&);
        //   bool operator!=(const baem_MetricRecord&,
        //                   const baem_MetricRecord&);
        // --------------------------------------------------------------------
      ...
      case 3: {
        ...
        // Testing:
        //   baem_MetricRecord()
        //   baem_MetricRecord(const baem_MetricId& );
        //   baem_MetricRecord(const baem_MetricId&  ,
        //                     int,
        //                     double,
        //                     double,
      ...
      case 1: {
        ...
        ASSERT(0 == mX3.total());
        ASSERT(0 == X3.total());
        ASSERT(baem_MetricRecord::DEFAULT_MIN == mX3.min());
        ASSERT(baem_MetricRecord::DEFAULT_MIN == X3.min());
        ASSERT(baem_MetricRecord::DEFAULT_MAX == mX3.max());
        ASSERT(baem_MetricRecord::DEFAULT_MAX == X3.max());
        ...
        ASSERT(0 == mX4.total());
        ASSERT(0 == X4.total());
        ASSERT(baem_MetricRecord::DEFAULT_MIN == mX4.min());
        ASSERT(baem_MetricRecord::DEFAULT_MIN == X4.min());
        ASSERT(baem_MetricRecord::DEFAULT_MAX == mX4.max());
        ASSERT(baem_MetricRecord::DEFAULT_MAX == X4.max());
