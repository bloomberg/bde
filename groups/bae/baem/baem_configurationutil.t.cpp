// baem_configurationutil.t.cpp  -*-C++-*-
...
//                           baem_MetricsManager      *manager = 0);
// [ 4] static baem_MetricDescription::UserDataKey createUserDataKey(
//                                                      baem_MetricsManager *);
// [ 5] static void setUserData(const char *,
//                              const char *,
//                              baem_MetricDescription::UserDataKey  ,
//                              const void *,
//                              baem_MetricsManager *);
...
typedef baem_ConfigurationUtil              Obj;
typedef baem_MetricFormatSpec               Spec;
typedef baem_MetricsManager                 MMgr;
typedef baem_PublicationType                Type;
typedef baem_MetricRegistry                 Registry;
typedef baem_MetricDescription::UserDataKey Key;
//=============================================================================
//                              USAGE EXAMPLE
//-----------------------------------------------------------------------------
...
// creating a 'baem_DefaultMetricsManagerScopedGuard', which manages the
...
///Usage
///-----
// The following example demonstrates how to use a 'baem_ConfigurationUtil' to
// configure the output for a metric.
//
// We start by initializing a default metrics manager by creating a
// 'baem_DefaultMetricsManagerScopedGuard', which manages the
...
//..
       BAEM_METRICS_UPDATE("myCategory", "avgElapsedTimeMs", .005);
//..
// Finally, we publish the metric.  Note that in practice, clients of
// the 'baem' package can use the 'baem_PublicationScheduler' to schedule the
// periodic publication of metrics:
...
//..
      ...
      case 6: {
                              ...
                              << endl;
        {
            ...
            MMgr& mgr = *baem_DefaultMetricsManager::instance();
      ...
      case 3: {
        ...
        {
            baem_DefaultMetricsManagerScopedGuard guard(Z);
            const MMgr *MGR = baem_DefaultMetricsManager::instance();
            // Initialized BAEM_UNSPECIFIED publication type to SPEC1
