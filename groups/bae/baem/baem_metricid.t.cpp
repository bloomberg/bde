...
//                                 Overview
//                                 --------
// A 'bdema_MetricId' is a simple in-core value semantic class
...
// CREATORS
// [ 2] baem_MetricId();
// [ 3] baem_MetricId(const baem_MetricDescription *);
// [ 5] baem_MetricId(const baem_MetricId&);
// [ 2] ~baem_MetricId();
// MANIPULATORS
// [ 6] baem_MetricId& operator=(const baem_MetricId&);
// [ 2] const baem_MetricDescription *&description();
// ACCESSORS
// [ 2] const baem_MetricDescription * const & description() const;
// [ 2] bool isValid() const;
// [ 7] const baem_Category *category() const;
// [ 7] const char *categoryName() const;
// [ 8] const char *metricName() const;
// [ 9] bsl::ostream& print(bsl::ostream&) const;
// FREE OPERATORS
// [ 4] bool operator==(const baem_MetricId&, const baem_MetricId&);
// [ 4] bool operator!=(const baem_MetricId&, const baem_MetricId&);
// [10] bool operator<(const baem_MetricId&, const baem_MetricId&);
// [ 9] bsl::ostream& operator<<(bsl::ostream&, const baem_MetricId&);
//-----------------------------------------------------------------------------
// [ 1] BREATHING TEST
// [11] USAGE EXAMPLE
//-----------------------------------------------------------------------------
...
//..
// Now we create three 'baem_MetricId' objects.
//..
...
//..
    ...
    ASSERT(metricIdB != differentIdB);   // The 'baem_MetricDescription'
      ...
      case 10: {
        ...
        //
        // Testing:
        // bool operator<(const baem_MetricId&, const baem_MetricId&);
        // --------------------------------------------------------------------
      ...
      case 9: {
        ...
        //
        // Testing:
        //   operator<<(ostream&, const baem_MetricId&);
      ...
      case 7: {
        ...
        //
        // Concerns:
        //   'category()' returns the 'baem_Category' address of the
        //   'baem_MetricDescription' object underlying a 'baem_MetricId', and
      ...
      case 3: {
        ...
        // Testing:
        //   baem_MetricId()
        //   baem_MetricId(const baem_MetricDescription *)
        // --------------------------------------------------------------------
