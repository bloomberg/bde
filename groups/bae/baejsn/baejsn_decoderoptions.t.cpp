// baejsn_decoderoptions.t.cpp                                        -*-C++-*-

#include <bdes_ident.h>
BDES_IDENT_RCSID(baejsn_decoderoptions_t_cpp,"$Id$ $CSID$")
...
// ----------------------------------------------------------------------------
// CREATORS
// [ 2] baejsn_DecoderOptions();
// [ 7] baejsn_DecoderOptions(const baejsn_DecoderOptions& original);
// [ 2] ~baejsn_DecoderOptions();
//
// MANIPULATORS
// [ 9] operator=(const baejsn_DecoderOptions& rhs);
...
//
// FREE OPERATORS
// [ 6] bool operator==(const baejsn_DecoderOptions& lhs, rhs);
// [ 6] bool operator!=(const baejsn_DecoderOptions& lhs, rhs);
// [ 5] operator<<(ostream& s, const baejsn_DecoderOptions& d);
// ----------------------------------------------------------------------------
// [ 1] BREATHING TEST
// [11] USAGE EXAMPLE
...
typedef baejsn_DecoderOptions Obj;
...
//
// First, we default-construct a 'baejsn_DecoderOptions' object:
//..
...
//..
      ...
      case 9: {
        ...
        //
        // Testing:
        //   operator=(const baejsn_DecoderOptions& rhs);
        // --------------------------------------------------------------------
      ...
      case 7: {
        ...
        //
        // Testing:
        //   baejsn_DecoderOptions(const baejsn_DecoderOptions& o);
        // --------------------------------------------------------------------
      ...
      case 6: {
        ...
        //
        // Testing:
        //   bool operator==(const baejsn_DecoderOptions& lhs, rhs);
        //   bool operator!=(const baejsn_DecoderOptions& lhs, rhs);
        // --------------------------------------------------------------------
      ...
      case 5: {
        ...
        //   operator<<(ostream& s, const baejsn_DecoderOptions& d);
        // --------------------------------------------------------------------
