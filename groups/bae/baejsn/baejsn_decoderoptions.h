...
// (value-semantic) attribute class, 'baejsn_DecoderOptions', that is used to
...
class baejsn_DecoderOptions {
  ...
  public:
    ...
    //! baejsn_DecoderOptions(const baejsn_DecoderOptions& original) = default;
        // Create a 'baejsn_DecoderOptions' object having the same value as the
