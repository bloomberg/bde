...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:
    ...
    #if BAE_VERSION > BDE_MAKE_VERSION(1, 2)
      ...
      case 1: {
        ...
        //
        // Concerns:
        //   That BAE_VERSION corresponds to the three components,
        //   BAE_VERSION_MAJOR, BAE_VERSION_MINOR, and BAE_VERSION_PATCH.
        //
        // Plan:
        //   Decompose BAE_VERSION into its three components and verify
        ...
        int major = (BAE_VERSION / 10000) % 100;
        int minor = (BAE_VERSION / 100) % 100;
        int patch = BAE_VERSION % 100;

        ASSERT(BAE_VERSION_MAJOR == major);
        ASSERT(BAE_VERSION_MINOR == minor);
