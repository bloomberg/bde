// baexml_validatingreader.t.cpp                         -*-C++-*-
...
//#include <baexml_util.h>  // for testing
...
typedef baexml_ValidatingReader Obj;
...
// Start of usage example, extract to the 'baexml_ValidatingReader' header
// file.

// Create a class that implements the 'baexml_ValidatingReader' interface.
//..
class TestReader : public baexml_ValidatingReader
{
...
//..
int advancePastWhiteSpace(baexml_ValidatingReader& reader) {
    ...
    do {
        ...
        type  = reader.nodeType();
            ...
            type == baexml_ValidatingReader::BAEXML_NODE_TYPE_WHITESPACE ||
            (type == baexml_ValidatingReader::BAEXML_NODE_TYPE_TEXT &&
             bsl::strlen(value) == bsl::strspn(value, whiteSpace)));

    ASSERT( reader.nodeType() !=
                         baexml_ValidatingReader::BAEXML_NODE_TYPE_WHITESPACE);
...
// to the usage example in the 'baexml_ValidatingReader' header.
...
//..
    ...
    rc = parse(&testReader2, TEST_BAS_XML_STRING, TEST_XSD_STRING);
//..
...
// End of usage example, extract to the 'baexml_ValidatingReader' header file.
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      case 2: {
        ...
        // USAGE EXAMPLE
        //
        // This is a simple implementation of the 'baexml_ValidatingReader'
        // interface.
        //
        // Concerns:
        //   That the usage example compiles and runs correctly.
        //   That a class can be derived from 'baexml_ValidatingReader' and
        ...
        //
        // Testing:
        //   baexml_ValidatingReader();  // Constructor
        //   ~baexml_ValidatingReader(); // Destructor
