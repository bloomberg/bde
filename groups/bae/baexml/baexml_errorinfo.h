// baexml_errorinfo.h                   -*-C++-*-
#ifndef INCLUDED_BAEXML_ERRORINFO
#define INCLUDED_BAEXML_ERRORINFO
...
// 'baexml_ErrorInfo', that contains the following diagnostic information:
//..
...
//..
// Parsing components in the 'baexml' package make use of 'baexml_ErrorInfo'
// as a standard way to report errors and warnings back to the caller.  The
// information contained within a 'baexml_ErrorInfo' object is sufficient to
...
class baexml_ErrorInfo
{
  ...
  public:
    ...
    enum Severity
    {
        ...
        // component that sets the severity of a 'baexml_ErrorInfo' object
...
// MANIPULATORS
inline void
baexml_ErrorInfo::setError(const baexml_ErrorInfo& other)
{
...
// ACCESSORS
inline baexml_ErrorInfo::Severity
baexml_ErrorInfo::severity() const
{
    return d_severity;
}

inline bool
baexml_ErrorInfo::isNoError() const
{
    return d_severity == BAEXML_NO_ERROR;
}

inline bool
baexml_ErrorInfo::isWarning() const
{
    return d_severity == BAEXML_WARNING;
}

inline bool
baexml_ErrorInfo::isError() const
{
    return d_severity == BAEXML_ERROR;
}

inline bool
baexml_ErrorInfo::isFatalError() const
{
    return d_severity == BAEXML_FATAL_ERROR;
}

inline bool
baexml_ErrorInfo::isAnyError() const
{
    return d_severity >= BAEXML_ERROR;
}

inline int
baexml_ErrorInfo::lineNumber() const
{
    return d_lineNumber;
}

inline int
baexml_ErrorInfo::columnNumber() const
{
    return d_columnNumber;
}

inline const bsl::string &
baexml_ErrorInfo::source() const
{
    return d_source;
}

inline const bsl::string &
baexml_ErrorInfo::message() const
{
    return d_message;
}
...
#endif //INCLUDED_BAEXML_ERRORINFO
// ---------------------------------------------------------------------------
// NOTICE:
