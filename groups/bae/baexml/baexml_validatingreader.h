// baexml_validatingreader.h                  -*-C++-*-
#ifndef INCLUDED_BAEXML_VALIDATINGREADER
#define INCLUDED_BAEXML_VALIDATINGREADER
...
//
//@CLASSES:
//  baexml_ValidatingReader: reader protocol for parsing and validating XML
//
//@SEE_ALSO: baexml_reader
//
//@AUTHOR: Pablo Halpern (phalpern)
//
//@DESCRIPTION: This component represents an abstract class
// 'baexml_ValidatingReader' - an XML reader that provides data validation
// against DTD or/and XML Schemas(XSD).  The 'baexml_ValidatingReader' inherits
// from the 'baexml_Reader' interface and therefore fully compliant with
// it.  In addition, 'baexml_ValidatingReader' provides additional methods
...
// 'baexml_ValidatingReader' requires that all schema sources must be
...
// 'baexml_ValidatingReader' interface defines the two level schemas resolution
// process:
//..
...
//    (see 'baexml_Reader::XmlResolverFunctor').
//..
...
///Schema Cache
///------------
// 'baexml_ValidatingReader' provides two abstract methods to maintain the
// schema cache:
//..
...
//..
//  const char TEST_BAS_XML_STRING[] =
//    "<?xml version='1.0' encoding='UTF-8'?>\n"
//    "<directory-entry xmlns:dir='http://bloomberg.com/schemas/directory'\n"
//    "     xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'\n"
//    "     xsi:schemaLocation='http://bloomberg.com/schemas/directory  \n"
...
//..
//int parse(baexml_ValidatingReader *reader,
//          const char              *xmlData,
...
namespace BloombergLP {
                        ...
                        // =============================
                        // class baexml_ValidatingReader
                        // =============================

class baexml_ValidatingReader : public baexml_Reader {
    // TBD Class description

  public:
    // CREATORS
    virtual ~baexml_ValidatingReader();
        // Destroy this object.
    ...
    virtual int addSchema(const char *location, bsl::streambuf *schema) = 0;
        ...
        // schema.  (See 'setResolver' in the 'baexml_Reader' base class.)
