...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 2: {
        // --------------------------------------------------------------------
        // THOROUGH TEST
        //   This will thoroughly test the 'baexml_ListParser' class.
        //
        // Concerns:
        ...
        //   'baexml_ListParser<TYPE>' object and associate it with an
        ...
        for (int i = 0; i < NUM_DATA; ++i) {
            ...
            typedef baexml_ListParser<bsl::vector<int> > Parser;
      ...
      case 1: {
...

        {
            ...
            typedef baexml_ListParser<ArrayType> ListParser;
