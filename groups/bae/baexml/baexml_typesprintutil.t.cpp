...
typedef baexml_TypesPrintUtil Util;
...
#undef ZERO
        ...
        if (verbose) cout << "\nUsing 'bdeut_StringRef'." << endl;
        {
            typedef bdeut_StringRef Type;
      ...
      case 6: {
...

        {
            ...
            if (verbose)
                cout << "\nUsing 'bdeut_StringRef' on valid strings." << endl;
            {
                typedef bdeut_StringRef Type;
...

        {
            ...
            if (verbose)
                cout << "\nUsing 'bdeut_StringRef' on invalid strings."
                     << endl;
            {
                typedef bdeut_StringRef Type;
      ...
      case 3: {
        ...
        if (verbose) cout << "\nUsing 'float'." << endl;
        {
            ...
            for (int i = 0; i < NUM_DATA; ++i) {
                ...
                if (bdes_Float::isNan(INPUT) ||
                    bdes_Float::isInfinite(INPUT)) {
      ...
      case 1: {
        ...
        // --------------------------------------------------------------------
...

          {
              ...
              baexml_TypesPrintUtil::print(ss, TestEnum::VALUE2,
...

          {
              ...
              baexml_TypesPrintUtil::printHex(ss, vec);
