...
const int baexml_DecoderOptions::DEFAULT_INITIALIZER_MAX_DEPTH = 32;

const int baexml_DecoderOptions::DEFAULT_INITIALIZER_FORMATTING_MODE = 0;

const bool baexml_DecoderOptions::DEFAULT_INITIALIZER_SKIP_UNKNOWN_ELEMENTS = true;
