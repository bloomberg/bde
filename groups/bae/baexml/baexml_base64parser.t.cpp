...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 2: {
        // --------------------------------------------------------------------
        // THOROUGH TEST
        //   This will thoroughly test the 'baexml_Base64Parser' class.
        //
        // Concerns:
        ...
        //   in a set of test data, create an 'baexml_Base64Parser<TYPE>'
      ...
      case 1: {
...

        {
            ...
            typedef baexml_Base64Parser<Type> Parser;
