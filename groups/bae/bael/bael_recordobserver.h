// bael_recordobserver.h                 -*-C++-*-
#ifndef INCLUDED_BAEL_RECORDOBSERVER
#define INCLUDED_BAEL_RECORDOBSERVER
...
//
//@CLASSES:
//  bael_RecordObserver: protocol class for receiving and processing log
//                       records
//
//@SEE_ALSO: bael_observer, bael_record, bael_loggermanager
//
...
//..
//     1. Define a concrete class derived from 'bael_RecordObserver'.
...
class bael_Context;
                           ...
                           // =========================
                           // class bael_RecordObserver
                           // =========================

class bael_RecordObserver {
    // This class provides a protocol for asynchronously receiving and 
    // processing log record output.
