...
// takes a literal name and a 'bdeut_variant' value as the primary
...
//-----------------------------------------------------------------------------
// [13] static int hash(const bael_Attribute&, int size);
// [11] bael_Attribute(const char *n, int v, bdema_Alct *ba);
// [11] bael_Attribute(const char *n, Int64 v, bdema_Alct *ba);
// [11] bael_Attribute(const char *n, const char *v, bdema_Alct *ba);
// [ 2] bael_Attribute(const char *n, const VALUE& v, bdema_Alct *ba);
// [ 7] bael_Attribute(const bael_Attribute&, bdema_Alct *ba);
// [ 2] ~bael_Attribute();
// [ 9] bael_Attribute& operator=(const bael_Attribute& rhs);
...
// [ 6] operator==(const bael_Attribute&, const bael_Attribute&);
// [ 6] operator!=(const bael_Attribute&, const bael_Attribute&);
// [ 5] bsl::ostream& operator<<(bsl::ostream&, const bael_Attribute&);
//-----------------------------------------------------------------------------
// [ 1] BREATHING TEST
...
int MyAttribute::hash(const MyAttribute& attribute, int size)
{
    if (attribute.d_hashValue < 0 || attribute.d_hashSize != size) {
        ...
        switch (attribute.d_value.type()) {
          case 0:
            hash += bdeu_HashUtil::hash1(attribute.d_value.int32Value());
            break;
          case 1:
            hash += bdeu_HashUtil::hash1(attribute.d_value.int64Value());
            break;
          case 2:
            hash += bdeu_HashUtil::hash1(attribute.d_value.stringValue());
            break;
        }
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 14: {
...

        {
            ...
            for (int i = 0; i < numTrials; ++i) {
                clock_gettime(CLOCK_HIGHRES, &t1);
                bael_Attribute attribute1("UUID", "12345678910");
                clock_gettime(CLOCK_HIGHRES, &t2);
                totalCreationTime += (t2.tv_sec - t1.tv_sec) * oneBillion
                                    + t2.tv_nsec - t1.tv_nsec;
      ...
      case 13: {
        ...
        //
        // Testing:
        //   static int hash(const bael_Attribute&, int size);
        // --------------------------------------------------------------------
      ...
      case 11: {
        ...
        //
        // Testing:
        //   bael_Attribute(const char *n, int v, bdema_Alct *ba);
        //   bael_Attribute(const char *n, Int64 v, bdema_Alct *ba);
        //   bael_Attribute(const char *n, const char *v, bdema_Alct *ba);
        // --------------------------------------------------------------------
      ...
      case 7: {
        ...
        //
        // Testing:
        //   bael_Attribute(const bael_Attribute&);
        // --------------------------------------------------------------------
        if (verbose) cout << "\nTesting Copy Constructor"
                          << "\n========================" << endl;
      ...
      case 6: {
        ...
        //   Construct a set W of unique bael_Attribute objects using every
        ...
        //   attribute value to create another bael_Attribute object to verify
        //   that is the same as that created directly from the name/value
        //   pair.
        //
        // Testing:
        //   operator==(const bael_Attribute&, const bael_Attribute&);
        //   operator!=(const bael_Attribute&, const bael_Attribute&);
        // --------------------------------------------------------------------
      ...
      case 5: {
        ...
        //
        // Testing:
        //   bsl::ostream& operator<<(bsl::ostream&, const bael_Attribute&);
        // --------------------------------------------------------------------
      ...
      case 4: {
        ...
        // Plan:
        //   Specify a set S of unique names and a set T of unique value.
        //   Construct one bael_Attribute object for every element of the
      ...
      case 2: {
        ...
        //
        // Plan:
        //   Construct bael_Attribute objects with distinct name and value
        ...
        //
        // Testing:
        //   bael_Attribute(const char *n, const VALUE& v, bdema_Alct *ba);
        //   ~bael_Attribute();
        // --------------------------------------------------------------------
