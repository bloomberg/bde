// bael_fixedsizerecordbuffer.t.cpp      -*-C++-*-
...
//                                   Overview
//                                   --------
// Testing 'bael_FixedSizeRecordBuffer' is divided into following parts (apart
...
// [ 3] void popBack();
// [12] void popFront();
// [ 2] int  pushBack(const bcema_SharedPtr<bael_Record>& handle);
// [13] int  pushFront(const bcema_SharedPtr<bael_Record>& handle);
// [ 4] void removeAll();
//
// ACCESSORS
// [ 6] int length() const;
   ...
   // 'numThreads'.  Finally join all the threads.
{
    ...
    for (int i = 0; i < numThreads; ++i) {
        bcemt_ThreadUtil::create(&threads[i], func, (void *)(&handles[i]));
    }
    for (int i = 0; i < numThreads; ++i) {
        bcemt_ThreadUtil::join(threads[i]);
    }
...
bael_Record *buildRecord(bdet_Datetime time,
                         int pid,
                         int tid,
                         const char *file,
                         int line,
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 14: {
        ...
        bael_FixedSizeRecordBuffer rb1(MAX_TOTAL_SIZE, alloc);
      ...
      case 13: {
        ...
        bdetu_Datetime::convertFromTimeT(&now, time(0));
        int pid = 1, tid = 2;
        bael_Record *R1 = buildRecord(now,
                                      pid,
                                      tid,
                                      __FILE__,
                                      __LINE__,
        ...
        bael_Record *R2 = buildRecord(now,
                                      pid,
                                      tid,
                                      __FILE__,
                                      __LINE__,
        ...
        bael_Record *R3 = buildRecord(now,
                                      pid,
                                      tid,
                                      __FILE__,
                                      __LINE__,
        ...
        bael_Record *R4 = buildRecord(now,
                                      pid,
                                      tid,
                                      __FILE__,
                                      __LINE__,
        ...
        bael_Record *R5 = buildRecord(now,
                                      pid,
                                      tid,
                                      __FILE__,
                                      __LINE__,
        ...
        bael_Record *R6 = buildRecord(now,
                                      pid,
                                      tid,
                                      __FILE__,
                                      __LINE__,
      ...
      case 10: {
        ...
        bcemt_ThreadUtil::create(&t1,
                                 beginSequenceEndSequenceThread,
                                 NULL);
        bcemt_ThreadUtil::create(&t2,
                                 pushBackPopRemoveAllThread,
                                 (void *)(&H));

        bcemt_ThreadUtil::join(t1);
        bcemt_ThreadUtil::join(t2);
