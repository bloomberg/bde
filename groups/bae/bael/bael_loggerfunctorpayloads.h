// bael_loggerfunctorpayloads.h              -*-C++-*-
#ifndef INCLUDED_BAEL_LOGGERFUNCTORPAYLOADS
#define INCLUDED_BAEL_LOGGERFUNCTORPAYLOADS
...
//
//@CLASSES
//    bael_LoggerFunctorPayloads: namespace for logger manager functor payloads
//
...
// 'bdef' functors used as callbacks in the 'bael_loggermanager' component.
...
// the four signatures:
//..
//    (bdem_List *, bdem_Schema)
//    (bael_Transmission::Cause)
//    (int *, int *, int *, int *, const char *)
//..
// These signatures match the five 'typedef' definitions used in the
// 'bael_loggermanager' component, as shown below.  Note that
// 'bael_LoggerManager::PublishAllCallback' is just an alias for
// 'bael_Logger::PublishAllCallback', which is itself an alias for a particular
// 'bdef_Function' specialization.
//..
//  bael_Logger Functors
//  --------------------
//  typedef bdef_Function<void (*)(bdem_List *, bdem_Schema)> Populator;
...
//
//  typedef bael_Logger::PublishAllCallback PublishAllCallback;
//      // 'PublishAllCallback' is the type of the functor that is invoked
...
//
// In particular, 'bael_LoggerManager' can accept an argument of type
...
// initialize the logger manager.  For this example, a 'bael_TestObserver'
...
//..
//       bael_LoggerManager::DefaultThresholdsCallback myCallback;
//..
// Next, we populate 'myCallback' with the desired "payload" function,
// 'bael_LoggerFunctorPayloads::loadParentCategoryThresholdValues', and use
...
//..
//       char delimiter = '.';
//       myCallback = bdef_BindUtil::bind(&bael_LoggerFunctorPayloads
...
//..
// Next, we can use the appropriate 'bael_Category' accessor methods to
...
struct bael_LoggerFunctorPayloads {
    ...
    // callback functor within 'bael_loggermanager'.
    ...
    void loadParentCategoryThresholdValues(int                *recordLevel,
        ...
        // unless the 'bael_LoggerManager' singleton has been initialized.
};
