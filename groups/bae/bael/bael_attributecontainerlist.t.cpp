// bael_attributecontainerlist.t.cpp            -*-C++-*-
...
// CREATORS
// [ 3] bael_AttributeContainerListIterator();
// [ 5] bael_AttributeContainerListIterator(
//                                const bael_AttributeContainerListIterator& );
// [ 3] bael_AttributeContainerListIterator(
//                                        bael_AttributeContainerList_Node *);
// MANIPULATORS
// [ 6] bael_AttributeContainerListIterator& operator=(
//                              const bael_AttributeContainerListIterator& );
// [ 3] bael_AttributeContainerListIterator operator++(int);
// [ 7] bael_AttributeContainerListIterator operator++();
// ACCESSORS
// [ 3] const bael_AttributeContainer *const *operator->() const;
// [ 3] const bael_AttributeContainer *operator*() const;
// [ 3] bool valid() const;
// FREE OPERATORS
// [ 4] bool operator==(const bael_AttributeContainerListIterator& ,
//                      const bael_AttributeContainerListIterator& );
// [ 4] bool operator!=(const bael_AttributeContainerListIterator& ,
//                      const bael_AttributeContainerListIterator& );
...
//                                       const bael_AttributeContainerList& );
// [ 8] iterator pushFront(const bael_AttributeContainer *);
...
// [13] bool hasValue(const bael_Attribute& ) const;
// [12] bsl::ostream& print(bsl::ostream& , int, int) const;
// FREE OPERATORS
// [ 9] bool operator==(const bael_AttributeContainerList& ,
//                      const bael_AttributeContainerList& );
// [ 9] bool operator!=(const bael_AttributeContainerList& ,
//                      const bael_AttributeContainerList& );
...
typedef bael_AttributeContainerList         Obj;
typedef bael_AttributeContainerListIterator ObjIter;
...
class TestPrintContainer : public bael_AttributeContainer {
    // An implementation of 'bael_AttributeContainer' intended to test the
    // 'print' method.
  ...
  public:
    ...
    // ACCESSORS
    virtual bool hasValue(const bael_Attribute& value) const {return true;}
        // Return 'true'.
...
//-----------------------------------------------------------------------------
// The 'g' family of functions generate a 'bael_AttributeContainerList' object
...
//..
    ...
    s1.insert(bael_Attribute("Set1", 1));
    s2.insert(bael_Attribute("Set2", 2));
    s3.insert(bael_Attribute("Set3", 3));
//
//..
// We can now create our 'bael_AttributeContainerList' and add the three
...
//..
    ASSERT(exampleList.hasValue(bael_Attribute("Set1", 1)));
    ASSERT(exampleList.hasValue(bael_Attribute("Set2", 2)));
    ASSERT(exampleList.hasValue(bael_Attribute("Set3", 3)));

    ASSERT(!exampleList.hasValue(bael_Attribute("Set1", 2)));
    ASSERT(!exampleList.hasValue(bael_Attribute("Set2", 1)));
    ASSERT(!exampleList.hasValue(bael_Attribute("Set4", 1)));
//..
...
//..
      ...
      case 13: {
        ...
        for (int i = 0; i < NUM_VALUES; ++i) {
            ...
            for (int j = 0; j < 10; ++j) {
                ...
                LOOP2_ASSERT(i, j,
                             hasValue == X.hasValue(bael_Attribute("X", j)));
            }
        }
      } break;
      case 12: {
      ...
      case 11: {
        // --------------------------------------------------------------------
        // TESTING ASSIGNMENT OPERATOR: bael_AttributeContainerList
        //
        // Concerns:
      ...
      case 10: {
        ...
        //
        // Testing:
        //   bael_AttributeContainerList(const bael_AttributeContainerList& );
        // --------------------------------------------------------------------
      ...
      case 9: {
        // --------------------------------------------------------------------
        // TESTING EQUALITY OPERATOR: bael_AttributeContainerList
        //
        // Concerns:
        ...
        //
        // Testing:
        //   bool operator==(const bael_AttributeContainerList&,
        //                   const bael_AttributeContainerList&);
        //   bool operator!=(const bael_AttributeContainerList&,
        //                   const bael_AttributeContainerList&);
        // --------------------------------------------------------------------
        ...
        if (verbose) cout << endl
                          << "TEST EQUALITY: bael_AttributeContainerList\n"
                          << "==========================================\n";
      ...
      case 5: {
        // --------------------------------------------------------------------
        // TESTING COPY CONSTRUCTOR:  bael_AttributeContainerListIterator
        //
        // Concerns:
        //   Any value must be able to be copy constructed without affecting
        //   its argument.
        ...
        //
        // Testing:
        //   bael_AttributeContainerListIterator(const
        //                              bael_AttributeContainerListIterator& );
        // --------------------------------------------------------------------
      ...
      case 4: {
        // --------------------------------------------------------------------
        // TESTING EQUALITY OPERATOR: bael_AttributeContainerListIterator
        //
        // Concerns:
        //   Any subtle variation in value must be detected by the equality
        //   operators.  The test data have variations in each input parameter,
        ...
        //
        // Testing:
        //   bool operator==(const bael_AttributeContainerListIterator&,
        //                   const bael_AttributeContainerListIterator&);
        //   bool operator!=(const bael_AttributeContainerListIterator&,
        //                   const bael_AttributeContainerListIterator&);
        // --------------------------------------------------------------------
      ...
      case 3: {
        ...
        //   const bael_AttributeContainer *const *operator->() const;
        //   bool isValid();
        // --------------------------------------------------------------------
      ...
      case 2: {
        ...
        // --------------------------------------------------------------------
          ...
          bael_AttributeContainer *containers[NUM_VALUES];

          bsl::vector<Obj::iterator> mXIters, mYIters;
          for (int i = 0; i < 10; ++i) {
              // Note that this is an invalid address.
              containers[i] = (bael_AttributeContainer *)(i + 1);
          ...
          a.insert(bael_Attribute("A", 1));
          b.insert(bael_Attribute("A", 2));
          c.insert(bael_Attribute("C", 1));
          ASSERT( a.hasValue(bael_Attribute("A", 1)));
          ASSERT(!a.hasValue(bael_Attribute("A", 2)));
          ASSERT(!a.hasValue(bael_Attribute("C", 1)));
          ASSERT(!b.hasValue(bael_Attribute("A", 1)));
          ASSERT( b.hasValue(bael_Attribute("A", 2)));
          ASSERT(!b.hasValue(bael_Attribute("C", 1)));
          ASSERT(!c.hasValue(bael_Attribute("A", 1)));
          ASSERT(!c.hasValue(bael_Attribute("A", 2)));
          ASSERT( c.hasValue(bael_Attribute("C", 1)));

          ASSERT(!MX.hasValue(bael_Attribute("A", 1)));
          ASSERT(!MX.hasValue(bael_Attribute("A", 2)));
          ASSERT(!MX.hasValue(bael_Attribute("C", 1)));
