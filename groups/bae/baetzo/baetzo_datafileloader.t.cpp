...
//
// MANIPULATORS
// [ 6] int loadTimeZone(baetzo_Zoneinfo *result, const char *timeZoneId);
...
//-----------------------------------------------------------------------------
typedef baetzo_DataFileLoader Obj;
...
int main(int argc, char *argv[])
{
    ...
    if (!bdesu_FileUtil::exists(TEST_DIRECTORY)) {
        ASSERT(0 == bdesu_FileUtil::createDirectories(TEST_DIRECTORY, true));
    }

    if (!bdesu_FileUtil::exists(TEST_GMT_FILE)) {
    ...
    if (bdesu_FileUtil::exists("test/GMT")) {
...
///Usage
///-----
// The following example illustrates how to use a 'baetzo_DataFileLoader' to
...
//..
    ...
    const char *TIME_ZONE_FILE      = "test/Asia/Bangkok";
#endif
    int rc = bdesu_FileUtil::createDirectories(TIME_ZONE_DIRECTORY, true);
    ASSERT(0 == rc);
//..
...
//..
//
///Example 1: Using a 'baetzo_DataFileLoader' to Load a Zoneinfo File
/// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// In this example we demonstrate how to use a 'baetzo_DataFileLoader' to load
// a time zone data file into a 'baetzo_Zoneinfo' object.  First we create
// a 'baetzo_DataFileLoader' object, and configure it with the relative path
...
//..
// Then we create a 'baetzo_Zoneinfo' and load it using 'loader':
//..
...
//..
    if (verbose) {
      ...
      case 6: {
        ...
        //
        // Testing:
        //   int loadTimeZone(baetzo_Zoneinfo *result, const char *timeZoneId);
        // --------------------------------------------------------------------
...
#undef ROOT
      ...
      case 1: {
        ...
        }
        {
            ...
            bsl::string path(Z);
            baetzo_Zoneinfo tz(Z); const baetzo_Zoneinfo& TZ = tz;
