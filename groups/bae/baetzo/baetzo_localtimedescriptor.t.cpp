// baetzo_localtimedescriptor.t.cpp                                   -*-C++-*-
...
//
// CREATORS
// [ 2] baetzo_LocalTimeDescriptor(bslma::Allocator *bA = 0);
...
typedef baetzo_LocalTimeDescriptor Obj;
...
//..
      ...
      case 8: {
        ...
        //   void swap(baetzo_LocalTimeDescriptor& a, b);
        // --------------------------------------------------------------------
      ...
      case 6: {
        ...
        //
        // Testing:
        //   bool operator==(const baetzo_LocalTimeDescriptor& lhs, rhs);
        //   bool operator!=(const baetzo_LocalTimeDescriptor& lhs, rhs);
        // --------------------------------------------------------------------
...
#undef SP
      ...
      case 2: {
        ...
        //
        // Testing:
        //   baetzo_LocalTimeDescriptor(bslma::Allocator *bA = 0);
