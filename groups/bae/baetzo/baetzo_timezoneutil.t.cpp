...
typedef baetzo_TimeZoneUtil        Obj;
...
//                      GLOBAL CONSTANTS
//-----------------------------------------------------------------------------
const Dst::Enum      UNSP = Dst::BAETZO_UNSPECIFIED;
const Dst::Enum      DST  = Dst::BAETZO_DST;
const Dst::Enum      STD  = Dst::BAETZO_STANDARD;
const Validity::Enum UNI  = Validity::BAETZO_VALID_UNIQUE;
const Validity::Enum AMB  = Validity::BAETZO_VALID_AMBIGUOUS;
const Validity::Enum INV  = Validity::BAETZO_INVALID;
...
// 'baet_LocalDatetime' object to hold the result of the conversion operation:
//..
    baet_LocalDatetime newYorkTime;
//..
// Then, we create a 'bdet_Datetime' object holding the UTC time
...
//..
    baet_LocalDatetime romeTime(allocator);
...
// York:
//..
    const bdet_Datetime uniqueTest = romeTime.datetimeTz().localDatetime();
...
//..
      ...
      case 8: {
        ...
        //
        // Concerns:
        //: 1 'BAETZO_UNSUPPORTED_ID' is returned when an invalid identifier is
        //:   supplied.
        //:
        //: 2 Resulting 'baet_LocalDatetime' has the same time zone as the
        //:   supplied 'targetTimeZoneId'.
        //:
        //: 3 'baetzo_TimeZoneUtilImp::convertLocalToLocalTime' is invoked to
        //:   return the correct result.
        //:
        //: 4 'dstPolicy' is default to 'BAETZO_UNSPECIFIED' if not specified.
        //:
        //: 5 QoI: Asserted precondition violations are detected when enabled.
        //
        // Plan:
        //: 1 Test that 'BAETZO_UNSUPPORTED_ID' is returned when given a time
...
{ L_,   NY,   "2010-03-14T02:00:00.000", "2010-03-14T03:00:00.000-04:00" },
      ...
      case 7: {
        ...
        //
        // Concerns:
        //: 1 Resulting 'baet_LocalDatetime' have the same identifier.
        //:
        ...
        //
        // Plan:
        //: 1 Test that the method returns 'BAETZO_UNSUPPORTED_ID' when
        ...
        //
        // Testing:
        //   addInterval(LclDatetm *, const LclDatetm&, const DatetmInterval&);
        // --------------------------------------------------------------------
      ...
      case 6: {
        ...
        //:   supplied.
        //:
        //: 2 'baetzo_TimeZoneUtilImp::convertUtcToLocalTime' is invoked to
        //:   return the correct result.
        //:
        //: 3 Resulting 'baet_LocalDatetime' holds the right string identifier.
        //:
...
// Time zone with multiple sequential STD transitions (Saigon)
 ...
 { L_,  SA, "1912-04-30T17:01:00.000", "1912-05-01T01:01:00.000+08:00" },
      ...
      case 5: {
        ...
        //:   passed in.
        //:
        //: 2 'baetzo_TimeZoneUtilImp::convertLocalToUtc' is invoked return the
        //:   correct result.
        //:
        //: 3 'dstPolicy' is default to 'BAETZO_UNSPECIFIED' if not specified.
        //:
        //: 4 QoI: Asserted precondition violations are detected when enabled.
        //
        // Plan:
      ...
      case 4: {
        ...
        //:   passed in.
        //:
        //: 2 'baetzo_TimeZoneUtilImp::initLocalTime' is invoked return the
        //:   correct result.
        //:
        //: 3 'dstPolicy' is default to 'BAETZO_UNSPECIFIED' if not specified.
        //:
...
{ L_, NY, "2010-03-14T02:00:00",     "2010-03-14T03:00:00-04:00" },
      ...
      case 3: {
        ...
        //:   result.
        //:
        //: 3 'dstPolicy' is default to 'BAETZO_UNSPECIFIED'.
        //:
        //: 4 QoI: Asserted precondition violations are detected when enabled.
        //
        // Plan:
...
{ L_, GMT, "2010-03-14T07:00:00", STD, "0001-01-01T00:00:00",
      ...
      case 2: {
        ...
        //
        // Concerns:
        //: 1 returns 'BAETZO_UNSUPPORTED_ID' if 'timeZoneId' is not
        //:   recognized.
        //:
        //: 2 'baetzo_TimeZoneUtilImp::loadLocalTimePeriodForUtc' is correctly
        ...
        //:   'BAETZO_UNSUPPORTED_ID' when given a time zone identifier that
        //:   does not exist. (C-1)
        //:
        //: 2 Use a table-based approach with widely varying input values and
        //:   verify that the method returns the expected result.  (C-2)
 ...
 { L_,  SA, "1912-04-30T17:01:00.000", "1912-05-01T01:01:00.000+08:00" },
        ...
        }
        {
...

            {
                ...
                bdet_DatetimeTz    resultTz;
                baet_LocalDatetime resultLcl(Z);
                ASSERT(EUID == Obj::initLocalTime(&resultTz,
                                                  inputTime,
                                                  "bogusId",
                                                  UNSP));
 ...
 // NY, Spring transition 2010
  ...
  // GMT
            ...
            for (int i = 0; i < NUM_VALUES; ++i) {
                ...
                bdet_DatetimeTz inputTz;
                bdet_Datetime   start, end;
                ASSERT(0 == bdepu_Iso8601::parse(&inputTz,
                                                 inputStr.c_str(),
                                                 inputStr.size()));
