// baetzo_zoneinfoutil.h                                              -*-C++-*-
#ifndef INCLUDED_BAETZO_ZONEINFOUTIL
#define INCLUDED_BAETZO_ZONEINFOUTIL
...
//@PURPOSE: Provide utility operations on 'baetzo_Zoneinfo' objects.
//
//@CLASSES:
//  baetzo_ZoneinfoUtil: a utility for operations on a 'baetzo_Zoneinfo' object
//
//@SEE_ALSO: baetzo_zoneinfo, baetzo_localtimevalidity
//
//@AUTHOR: Stefano Pacifico (spacifico1)
//
//@DESCRIPTION: This component provides a suite of pure functions that operate
// on objects of type 'baetzo_Zoneinfo'.  A 'baetzo_Zoneinfo' is a value
...
// time zone data (see 'baetzo_zoneinfo' for more information).  The primary
// functions provided by 'baetzo_ZoneinfoUtil' are 'convertUtcToLocalTime'
...
// 'baetzo_Zoneinfo' object; 'loadRelevantTransitions' returns the transition,
// from the supplied 'baetzo_Zoneinfo' object's list of transitions that
...
// time is either invalid or ambiguous (see 'baetzo_localtimevalidity').  Note
...
// 'baetzo_Zoneinfo' object that describes the properties of a client supplied
...
// 'baetzo_Zoneinfo' type itself.  A Zoneinfo meeting these constraints is
// considered *well-formed*, and 'baetzo_ZoneinfoUtil::isWellFormed' will
// return 'true' for such a value.  Specifically, a 'baetzo_Zoneinfo' object
...
// zone.
//
///Prologue: Initializing a 'baetzo_Zoneinfo' object.
///- - - - - - - - - - - - - - - - - - - - - - - - -
...
//  baetzo_ZoneinfoUtil::convertUtcToLocalTime(&localNYTime,
//                                             &iterator,
//                                             utcTime,
//                                             newYork);
//..
...
//..
//  baetzo_Zoneinfo::TransitionConstIterator transitionIter     = iterator;
//  baetzo_Zoneinfo::TransitionConstIterator nextTransitionIter = ++iterator;
//
//  const bdetu_Epoch::TimeT64 utcTimeT =
//                                      bdetu_Epoch::converToTimeT64(utcTime);
...
// local-time descriptor (see 'baetzo_localtimedescriptor') that applies to a
// local time value, represented using a 'bdet_Datetime' object.
//
// We start by defining a 'bdet_Datetime' object for "Jan 1, 2011 12:00" in
// New York:
//..
//  bdet_Datetime nyLocalTime(2011, 1, 1, 12);
//..
...
//  baetzo_Zoneinfo::TransitionConstIterator firstTransition, secondTransition;
//  baetzo_ZoneinfoUtil::loadRelevantTransitions(&firstTransition,
//                                               &secondTransition,
//                                               &validity,
//                                               nyLocalTime,
//                                               newYork);
...
// 'baetzo_LocalTimeValidity::BAETZO_VALID_UNIQUE' and the two returned
...
//..
// Next, we create a second 'bdet_Datetime' object to represent
...
//..
//  bdet_Datetime ambiguousLocalTime(2010, 11, 7, 1, 30);
//..
...
//..
//  assert(baetzo_LocalTimeValidity::BAETZO_VALID_AMBIGUOUS == validity);
//  assert(firstTransition != secondTransition);
//..
...
class bdet_DatetimeTz;
                        ...
                        // =========================
                        // class baetzo_ZoneinfoUtil
                        // =========================

struct baetzo_ZoneinfoUtil {
    ...
    static bool isWellFormed(const baetzo_Zoneinfo& timeZone);
