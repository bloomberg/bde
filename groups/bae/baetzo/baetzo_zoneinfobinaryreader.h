// baetzo_zoneinfobinaryreader.h                                      -*-C++-*-
#ifndef INCLUDED_BAETZO_ZONEINFOBINARYREADER
#define INCLUDED_BAETZO_ZONEINFOBINARYREADER
...
//
//@CLASSES:
//  baetzo_ZoneinfoBinaryReader: utilities for reading Zoneinfo binary data
//
...
// 'baetzo_ZoneinfoBinaryReader', containing utilities to read the binary data
// format of the Zoneinfo database from a 'bsl::istream' and populate a
// 'baetzo_Zoneinfo' object.  The Zoneinfo database (also known as the Olson
...
// 'http://www.twinsun.com/tz/tz-link.htm', including the time zone rules for
// the supported time zones, and source code for the 'zic' compiler (for
// compiling those rules into the binary representation read by utility
...
//:   rule for computing the local time in that time zone changes.
//:
...
//
// The version '2' portion of the binary data is currently ignored by this
// component.
//
...
//
//: o http://www.twinsun.com/tz/tz-link.htm -- Central links for Zoneinfo
...
class baetzo_ZoneinfoBinaryHeader;
                      ...
                      // ==================================
                      // struct baetzo_ZoneinfoBinaryReader
                      // ==================================
...
struct baetzo_ZoneinfoBinaryReader {
  ...
  public:
    ...
    // CLASS METHODS
    static int read(baetzo_Zoneinfo *zoneinfoResult,
                    bsl::istream&    stream);
    static int read(baetzo_Zoneinfo             *zoneinfoResult,
