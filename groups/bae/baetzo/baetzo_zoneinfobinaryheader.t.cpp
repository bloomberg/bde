// baetzo_zoneinfobinaryheader.t.cpp                                  -*-C++-*-
...
//
// CREATORS
// [ 2] baetzo_ZoneinfoBinaryHeader();
// [ 3] baetzo_ZoneinfoBinaryHeader(char, int, int, int, int, int, int);
// [ 2] ~baetzo_ZoneinfoBinaryHeader();
//
// MANIPULATORS
// [ 9] operator=(const baetzo_ZoneinfoBinaryHeader& rhs);
...
//
// [ 8] void swap(baetzo_ZoneinfoBinaryHeader& other);
//
// ACCESSORS
...
//
// FREE OPERATORS
// [ 6] bool operator==(const baetzo_ZoneinfoBinaryHeader& lhs, rhs);
// [ 6] bool operator!=(const baetzo_ZoneinfoBinaryHeader& lhs, rhs);
//
// FREE FUNCTIONS
// [ 5] void swap(baetzo_ZoneinfoBinaryHeader& a, b);
// ----------------------------------------------------------------------------
// [ 1] BREATHING TEST
// [12] USAGE EXAMPLE
...
typedef baetzo_ZoneinfoBinaryHeader Obj;
...
//..
      ...
      case 9: {
        ...
        //
        // Testing:
        //   operator=(const baetzo_ZoneinfoBinaryHeader& rhs);
        // --------------------------------------------------------------------
      ...
      case 8: {
        ...
        //   void swap(baetzo_ZoneinfoBinaryHeader& a, b);
        // --------------------------------------------------------------------
        if (verbose) cout << endl
...
#undef SP
      ...
      case 3: {
        ...
        //
        // Testing:
        //   baetzo_ZoneinfoBinaryHeader(char, int, int, int, int, int, int);
        // --------------------------------------------------------------------
