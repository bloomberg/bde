// baetzo_defaultzoneinfocache.t.cpp                                  -*-C++-*-
...
//                              Overview
//                              --------
// 'baetzo_DefaultZoneinfoCache' is a mechanism that implements the unique,
...
// [ 5] baetzo_ZoneinfoCache *defaultCache(baetzo_ZoneinfoCache *cache);
// [ 2] void loadDefaultZoneinfoDataLocations(bsl::vector<char *> *locations);
// [ 4] baetzo_ZoneinfoCache *setDefaultCache(baetzo_ZoneinfoCache *cache);
//
////---------------------------------------------------------------------------
// [ 1] BREATHING TEST: 'baetzo_DefaultZoneinfoCache'
// [ 6] USAGE EXAMPLE
//-----------------------------------------------------------------------------
//=============================================================================
...
//-----------------------------------------------------------------------------
typedef baetzo_DefaultZoneinfoCache Obj;
typedef baetzo_ZoneinfoCache        Cache;
...
// Zoneinfo cache as an optional argument (e.g., 'baetzo_timezoneutil').  Note
...
// takes an optional 'baetzo_ZoneinfoCache' argument, 'zoneinfoCache', where,
...
//..
// Next, we use 'loader' to initialize a 'baetzo_ZoneinfoCache' object:
//..
        baetzo_ZoneinfoCache  cache(&loader);
//..
// Then, we create a 'baetzo_DefaultZoneinfoCacheScopedGuard' to set the
...
//..
      ...
      case 5: {
        ...
        //:
        //: 5 Return the specified 'baetzo_ZoneinfoCache' address, if
                          ...
                          << endl;
        {
            ...
            const baetzo_ZoneinfoCache *RESULT = Obj::defaultCache(&cache);
                          ...
                          << endl;
        {
            ...
            baetzo_ZoneinfoCache tempCache(&loader);
      ...
      case 4: {
        ...
        //:
        //: 2 Return the previously installed default 'baetzo_ZoneinfoCache'.
        //:
        ...
        //
        // Testing:
        //   setDefaultCache(baetzo_ZoneinfoCache *cache)
        // --------------------------------------------------------------------
        ...
        baetzo_TestLoader loader;
        baetzo_ZoneinfoCache cache(&loader);
        baetzo_ZoneinfoCache cache2(&loader);

        if (verbose) cout << "\nTesting invoking 'setDefaultCache' and GA."
                          << endl;
        {
            const int GA_NUM_BYTES = globalAllocator.numBytesInUse();
            baetzo_ZoneinfoCache *cachePtr = Obj::setDefaultCache(&cache);
        ...
        {
            baetzo_ZoneinfoCache *cachePtr = Obj::setDefaultCache(&cache2);
