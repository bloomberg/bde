...
// [ 1] const char *toAscii(baetzo_ErrorCode::Enum val);
//
// FREE OPERATORS
// [ 2] operator<<(ostream& s, baetzo_ErrorCode::Enum val);
// ----------------------------------------------------------------------------
// [ 5] USAGE EXAMPLE
...
typedef baetzo_ErrorCode::Enum Enum;
typedef baetzo_ErrorCode       Obj;
...
#undef NL
      ...
      case 2: {
        ...
        //
        // Testing:
        //   operator<<(ostream& s, baetzo_ErrorCode::Enum val);
        // --------------------------------------------------------------------
      ...
      case 1: {
        ...
        // Testing:
        //   enum Enum { ... };
        //   const char *toAscii(baetzo_ErrorCode::Enum val);
        // -------------------------------------------------------------------
