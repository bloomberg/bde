...
// [ 1] const char *toAscii(baetzo_DstPolicy::Enum val);
//
// FREE OPERATORS
// [ 2] operator<<(ostream& s, baetzo_DstPolicy::Enum val);
// ----------------------------------------------------------------------------
// [ 5] USAGE EXAMPLE
...
typedef baetzo_DstPolicy::Enum Enum;
typedef baetzo_DstPolicy       Obj;
...
#undef NL
      ...
      case 2: {
        ...
        //
        // Testing:
        //   operator<<(ostream& s, baetzo_DstPolicy::Enum val);
        // --------------------------------------------------------------------
      ...
      case 1: {
        ...
        // Testing:
        //   enum Enum { ... };
        //   const char *toAscii(baetzo_DstPolicy::Enum val);
        // -------------------------------------------------------------------
