...
// ----------------------------------------------------------------------------
// CREATORS
// [ 2] baesu_StackTraceFrame(bslma_Allocator *bA = 0);
// [ 3] baesu_StackTraceFrame(cvp, cSR, int, cSR, siz, cSR, cSR, *bA = 0);
// [ 7] baesu_StackTraceFrame(const baesu_STF& o, *bA = 0);
// [ 2] ~baesu_StackTraceFrame();
//
// MANIPULATORS
// [ 9] operator=(const baesu_StackTraceFrame& rhs);
// [ 2] setAddress(const void *value);
// [ 2] setLibraryFileName(const bdeut_StringRef& value);
// [ 2] setLineNumber(int value);
// [ 2] setMangledSymbolName(const bdeut_StringRef& value);
// [ 2] setOffsetFromSymbol(bsl::size_t value);
// [ 2] setSourceFileName(const bdeut_StringRef& value);
// [ 2] setSymbolName(const bdeut_StringRef& value);
//
// [ 8] void swap(baesu_StackTraceFrame& other);
//
// ACCESSORS
...
//
// FREE OPERATORS
// [ 6] bool operator==(const baesu_StackTraceFrame& lhs, rhs);
// [ 6] bool operator!=(const baesu_StackTraceFrame& lhs, rhs);
// [ 5] operator<<(bsl::ostream& s, const baesu_STF& f);
//
// FREE FUNCTIONS
// [ 8] void swap(baesu_StackTraceFrame& a, b);
// ----------------------------------------------------------------------------
// [ 1] BREATHING TEST
// [12] USAGE EXAMPLE
...
//..
      ...
      case 11: {
        ...
        //:
        //: 2 Create two 'bslma_TestAllocator' objects. Install one as the
        ...
        //:
        //: 3 Create a default 'baesu_StackTraceFrame' object and check that
      ...
      case 9: {
        ...
        //
        // Testing:
        //   operator=(const baesu_StackTraceFrame& rhs);
        // --------------------------------------------------------------------
      ...
      case 8: {
        ...
        //   void swap(baesu_StackTraceFrame& a, b);
        // --------------------------------------------------------------------
      ...
      case 7: {
        ...
        //
        // Testing:
        //   baesu_StackTraceFrame(cvp, cSR, int, cSR, siz, cSR, cSR, *bA = 0);
        // --------------------------------------------------------------------
...
#undef SP
      ...
      case 2: {
        ...
        //
        // Testing:
        //   baesu_StackTraceFrame(bslma_Allocator *bA = 0);
        //   ~baesu_StackTraceFrame();
        //   setAddress(const void *value);
        //   setLibraryFileName(const bdeut_StringRef& value);
        //   setLineNumber(int value);
        //   setMangledSymbolName(const bdeut_StringRef& value);
        //   setOffsetFromSymbol(bsl::size_t value);
        //   setSourceFileName(const bdeut_StringRef& value);
        //   setSymbolName(const bdeut_StringRef& value);
        // --------------------------------------------------------------------
