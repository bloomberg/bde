// baelu_severity.t.cpp         -*-C++-*-

#include <baelu_severity.h>
...
// TEST PLAN
//-----------------------------------------------------------------------------
// This component currently has two procedures: The 'fromAscii' procedure is an
// inverse operation on 'baelu_Severity::toAscii'.  The 'isValidName' procedure
// is a helper to 'fromAscii'.  The test strategy is to first validate that
// 'fromAscii' correctly interprets the small set of C-style strings that
// represent the enumerated values of 'bael_Severity::Level' and then confirm
// that it rejects as invalid strings that are small perturbations from the
// members of the valid set.  Once some confidence in 'fromAscii' is
// established, it is checked for consistency with 'isValidName' and then
// checked for consistency with 'baelu_Severity::toAscii'.
//-----------------------------------------------------------------------------
// [ 3] static int fromAscii(bael_Severity::Level *, const char *); [ 2] static
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 3: {
        // --------------------------------------------------------------------
        // CONSISTENCY
        //    The 'fromAscii' procedure should be a functional
        //    inverse to 'bael_Severity::ToAscii'.
        //
        // Concerns:
        //    - The implementations of 'bael_Severity' and 'baelu_Severity'
        //      may become out-of-synch.  This test is provided to aid
        //      maintenance.
        //
        //  Plan:
        ...
        if (verbose) cout << "CONSISTENCY WITH 'ToAscii'" << endl
            ...
            for (int i = 0; i < NUM_VALUES; ++i) {
                ...
                int  status = Util::fromAscii(&result,
      ...
      case 2: {
        ...
        //   Test that 'isValidName' correctly classifies input strings.
        //
        // Concerns:
        ...
        //     'isValidName'.  Where the return status of 'fromAscii'
        //     is 0 the return value of 'isValidName' should be 'true',
        //     and 'false' otherwise.
        //
        // Testing:
      ...
      case 1: {
        ...
        //
        // Concerns:
        //   - Does 'fromAscii' work correctly for each of the valid inputs?
        ...
        //     input strings.
        //   - Confirm that 'fromAscii' correctly returns invalid status
        //     (non-zero) and leaves unchanged the severity value at
