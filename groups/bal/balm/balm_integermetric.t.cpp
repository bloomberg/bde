...
// primarily provide user-friendly access to a 'balm::IntegerCollector' object.
// The classes and macros supply simplified constructors (that lookup the
// appropriate 'balm::IntegerCollector' instance) and manipulator methods that
// respect whether the category of the collector is enabled.  Most of the
// tests can be performed by creating an "oracle" 'balm::IntegerCollector'
...
//-----------------------------------------------------------------------------
// CLASS METHODS
// [ 9] static balm::IntegerCollector *lookupCollector(const bdlb::StringRef&  ,
//                                             const bdlb::StringRef&  ,
//                                             balm::MetricsManager    *);
// [ 9] static balm::IntegerCollector *lookupCollector(const balm::MetricId&  ,
//                                             balm::MetricsManager  *);
// CREATORS
// [ 2] balm::IntegerMetric(const bdlb::StringRef&  ,
//                  const bdlb::StringRef&  ,
//                  balm::MetricsManager    *);
// [ 2] explicit balm::IntegerMetric(const balm::MetricId&,
//                                  balm::MetricsManager*);
// [ 2] explicit balm::IntegerMetric(balm::IntegerCollector *collector);
// [ 5] balm::IntegerMetric(const balm::IntegerMetric& original);
// [ 2] ~balm::IntegerMetric();
// MANIPULATORS
// [ 6] void increment();
// [ 7] void update(int);
// [ 8] void accumulateCountTotalMinMax(int, int, int, int);
// [ 2] balm::IntegerCollector *collector();
// ACCESSORS
// [ 2] const balm::IntegerCollector *collector() const;
...
typedef balm::IntegerMetric         Obj;
...
// 'balm::DefaultMetricsManager::release()'.
      ...
      case 10: {
        // --------------------------------------------------------------------
        // CONCURRENCY TEST: 'balm::IntegerMetric'
        //
        // Testing:
        //     Thread-safety of 'balm::IntegerMetric' methods.
        //
        // --------------------------------------------------------------------
      ...
      case 4: {
        ...
        //
        // Testing:
        //   bool operator==(const balm::IntegerMetric&,
        //                   const balm::IntegerMetric&);
        //   bool operator!=(const balm::IntegerMetric&,
        //                   const balm::IntegerMetric&);
        // --------------------------------------------------------------------
      ...
      case 3: {
        ...
        //   'true'.  Also verify that a 'balm::IntegerMetric' with a null
      ...
      case 2: {
        ...
        //   subtle differences.
        //
        //   Create a 'balm::IntegerMetric' object for each member of set S
        //   without a metrics manager or default metrics manager and verify
        //   their collector value is 0.
        //
        //   Create a 'balm::IntegerMetric' object for each member of set S and
        ...
        //   'balm::IntegerMetric' object for each member of set S without
        ...
        //
        // Testing:
        //    balm::IntegerMetric(const bdlb::StringRef&  ,
        //                const bdlb::StringRef&  ,
        //                balm::MetricsManager    *);
        //    explicit balm::IntegerMetric(const balm::MetricId&  ,
        //                         balm::MetricsManager  *);
        //    explicit balm::IntegerMetric(balm::IntegerCollector *);
        //    ~balm::IntegerMetric();
        //    balm::IntegerCollector *collector();
        //    const balm::IntegerCollector *collector() const;
