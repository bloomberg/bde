...
//
//@DESCRIPTION:  The 'balber::BerDecoder' class provided in this component
...
// we will verify the contents of 'osb' using the 'balber_berdecoder' component:
//..
...
namespace balber {class BerDecoder_Node;
...
//                                                          // receiving object
    ...
    BerDecoder_Node& operator=(BerDecoder_Node&);
...
class BerDecoder_NodeVisitor {
    ...
    // NOT IMPLEMENTED
    BerDecoder_NodeVisitor(const BerDecoder_NodeVisitor&);
...
BerDecoder::errorSeverity() const
{
    return d_severity;
}
...
// inline
// const char *BerDecoder_Node::typeName() const
// {
//     return d_typeName;
// }
...
// template <typename TYPE>
// inline
// void BerDecoder_Node::setType(const TYPE *variable)
// {
...
template <typename TYPE>
int
BerDecoder_Node::decode(TYPE *variable, bdeat_TypeCategory::Choice)
{
...
template <typename TYPE>
int
BerDecoder_Node::decode(TYPE *variable,
...
template <typename TYPE>
int
BerDecoder_Node::decode(TYPE *variable, bdeat_TypeCategory::Enumeration)
{
    int value = 0;
...
template <typename TYPE>
inline
int BerDecoder_Node::decode(TYPE *variable, bdeat_TypeCategory::Array)
{
...
template <typename TYPE>
inline
int BerDecoder_Node::decode(TYPE *variable,
