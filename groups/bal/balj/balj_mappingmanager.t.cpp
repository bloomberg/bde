...
typedef balj::MappingManager Obj;
...
public:
   ...
   {
      return bdlf::BindUtil::bind(&Case2Thread::run, this);
   }
};
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:
       case 2: {
          ...
          const int PAGESIZE_BYTES = bdlsu::MemoryUtil::pageSize();
