...
class LocalTimeDescriptor {
  ...
  public:
    ...
    explicit LocalTimeDescriptor(const allocator_type& allocator);
        ...
        //  description()        == ""
        //..
        // Optionally specify an 'allocator' used to supply memory (e.g., as
        // the address of a 'bslma::Allocator' object); otherwise, the default
        // allocator is used.
    ...
    LocalTimeDescriptor(int                      utcOffsetInSeconds,
        ...
        // attribute values.  Optionally specify an 'allocator' used to supply
        // memory (e.g., as the address of a 'bslma::Allocator' object);
        // otherwise, the default allocator is used.  The behavior is
        // undefined unless '-86339 <= utcOffsetInSeconds <= 86399'.
    ...
    LocalTimeDescriptor(const LocalTimeDescriptor& original,
        ...
        // used to supply memory (e.g., as the address of a 'bslma::Allocator'
        // object); otherwise, the default allocator is used.
