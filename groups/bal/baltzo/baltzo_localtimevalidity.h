...
// 'baltzo::LocalTimeValidity::Enum', which enumerates the set of validity codes
...
struct LocalTimeValidity {
  ...
  public:
    ...
    static const char *toAscii(LocalTimeValidity::Enum value);
        ...
        //                      LocalTimeValidity::BAETZO_VALID_UNIQUE);
        //..
...
// ============================================================================
                     ...
                     // -------------------------------
                     // struct baltzo::LocalTimeValidity
                     // -------------------------------
