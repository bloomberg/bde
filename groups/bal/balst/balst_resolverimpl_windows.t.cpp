// balst_resolverimpl_windows.t.cpp                                   -*-C++-*-
...
typedef balst::ResolverImpl<balst::ObjectFileFormat::Windows> Obj;
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:
      ...
      case 1: {
        // --------------------------------------------------------------------
        // balst::ResolverImp<Windows> BREATHING TEST
        //
        // Concerns:
        ...
        if (verbose) cout << "balst::ResolverImpl<Windows> breathing test\n"
                             "===========================================\n";
        ...
        for (unsigned int i = 0; i < st.length(); ++i) {
            ...
            switch (i) {
              case 0: {
                sourceName      = "balst_resolverimpl_windows.t.cpp";
              ...
              case 2: {
                sourceName      = "balst_resolverimpl_windows.cpp";
                mangleMatch     = "resolve";
                demangledSymbol = "BloombergLP::balst::ResolverImpl<"
