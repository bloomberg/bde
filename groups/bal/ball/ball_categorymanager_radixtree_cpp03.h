// ball_categorymanager_radixtree_cpp03.h                             -*-C++-*-

// Automatically generated file.  **DO NOT EDIT**

#ifndef INCLUDED_BALL_CATEGORYMANAGER_RADIXTREE_CPP03
#define INCLUDED_BALL_CATEGORYMANAGER_RADIXTREE_CPP03

//@PURPOSE: Provide C++03 implementation for ball_categorymanager_radixtree.h
//
//@CLASSES: See ball_categorymanager_radixtree.h for list of classes
//
//@SEE_ALSO: ball_categorymanager_radixtree
//
...
//
// Generated on Mon Sep 07 16:11:15 2026
// Command line: sim_cpp11_features ball_categorymanager_radixtree.h
...
// Command line: sim_cpp11_features ball_categorymanager_radixtree.h
#ifndef BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT
#define BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT 10
#endif
#ifndef BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_A
#define BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_A BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT
#endif
#if BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_A >= 0
    EmplaceResult emplaceImp(Node                    *node,
                             const bsl::string_view&  remainingKey);
#endif  // BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_A >= 0

#if BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_A >= 1
    template <class Args_01>
    EmplaceResult emplaceImp(Node                    *node,
                             const bsl::string_view&  remainingKey,
                           BSLS_COMPILERFEATURES_FORWARD_REF(Args_01) args_01);
#endif  // BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_A >= 1

#if BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_A >= 2
    template <class Args_01,
              class Args_02>
    EmplaceResult emplaceImp(Node                    *node,
                             const bsl::string_view&  remainingKey,
...
#endif  // BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_A >= 2

#if BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_A >= 3
    template <class Args_01,
              class Args_02,
              class Args_03>
    EmplaceResult emplaceImp(Node                    *node,
...
#endif  // BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_A >= 3

#if BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_A >= 4
    template <class Args_01,
              class Args_02,
              class Args_03,
              class Args_04>
...
#endif  // BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_A >= 4

#if BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_A >= 5
    template <class Args_01,
              class Args_02,
              class Args_03,
              class Args_04,
...
#endif  // BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_A >= 5

#if BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_A >= 6
    template <class Args_01,
              class Args_02,
              class Args_03,
              class Args_04,
...
#endif  // BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_A >= 6

#if BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_A >= 7
    template <class Args_01,
              class Args_02,
              class Args_03,
              class Args_04,
...
#endif  // BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_A >= 7

#if BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_A >= 8
    template <class Args_01,
              class Args_02,
              class Args_03,
              class Args_04,
...
#endif  // BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_A >= 8

#if BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_A >= 9
    template <class Args_01,
              class Args_02,
              class Args_03,
              class Args_04,
...
#endif  // BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_A >= 9

#if BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_A >= 10
    template <class Args_01,
              class Args_02,
              class Args_03,
              class Args_04,
...
#endif  // BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_A >= 10
...
#define BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT 10
#endif
#ifndef BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_B
#define BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_B BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT
#endif
#if BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_B >= 0
    EmplaceResult emplace(const bsl::string_view& key);
#endif  // BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_B >= 0

#if BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_B >= 1
    template <class Args_01>
    EmplaceResult emplace(const bsl::string_view& key,
                          BSLS_COMPILERFEATURES_FORWARD_REF(Args_01) args_01);
#endif  // BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_B >= 1

#if BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_B >= 2
    template <class Args_01,
              class Args_02>
    EmplaceResult emplace(const bsl::string_view& key,
                          BSLS_COMPILERFEATURES_FORWARD_REF(Args_01) args_01,
                          BSLS_COMPILERFEATURES_FORWARD_REF(Args_02) args_02);
#endif  // BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_B >= 2

#if BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_B >= 3
    template <class Args_01,
              class Args_02,
              class Args_03>
    EmplaceResult emplace(const bsl::string_view& key,
                          ...
                          BSLS_COMPILERFEATURES_FORWARD_REF(Args_02) args_02,
                          BSLS_COMPILERFEATURES_FORWARD_REF(Args_03) args_03);
#endif  // BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_B >= 3

#if BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_B >= 4
    template <class Args_01,
              class Args_02,
              class Args_03,
              class Args_04>
    EmplaceResult emplace(const bsl::string_view& key,
                          ...
                          BSLS_COMPILERFEATURES_FORWARD_REF(Args_03) args_03,
                          BSLS_COMPILERFEATURES_FORWARD_REF(Args_04) args_04);
#endif  // BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_B >= 4

#if BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_B >= 5
    template <class Args_01,
              class Args_02,
              class Args_03,
              class Args_04,
    ...
    EmplaceResult emplace(const bsl::string_view& key,
                          ...
                          BSLS_COMPILERFEATURES_FORWARD_REF(Args_04) args_04,
                          BSLS_COMPILERFEATURES_FORWARD_REF(Args_05) args_05);
#endif  // BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_B >= 5

#if BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_B >= 6
    template <class Args_01,
              class Args_02,
              class Args_03,
              class Args_04,
    ...
    EmplaceResult emplace(const bsl::string_view& key,
                          ...
                          BSLS_COMPILERFEATURES_FORWARD_REF(Args_05) args_05,
                          BSLS_COMPILERFEATURES_FORWARD_REF(Args_06) args_06);
#endif  // BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_B >= 6

#if BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_B >= 7
    template <class Args_01,
              class Args_02,
              class Args_03,
              class Args_04,
    ...
    EmplaceResult emplace(const bsl::string_view& key,
                          ...
                          BSLS_COMPILERFEATURES_FORWARD_REF(Args_06) args_06,
                          BSLS_COMPILERFEATURES_FORWARD_REF(Args_07) args_07);
#endif  // BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_B >= 7

#if BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_B >= 8
    template <class Args_01,
              class Args_02,
              class Args_03,
              class Args_04,
    ...
    EmplaceResult emplace(const bsl::string_view& key,
                          ...
                          BSLS_COMPILERFEATURES_FORWARD_REF(Args_07) args_07,
                          BSLS_COMPILERFEATURES_FORWARD_REF(Args_08) args_08);
#endif  // BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_B >= 8

#if BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_B >= 9
    template <class Args_01,
              class Args_02,
              class Args_03,
              class Args_04,
    ...
    EmplaceResult emplace(const bsl::string_view& key,
                          ...
                          BSLS_COMPILERFEATURES_FORWARD_REF(Args_08) args_08,
                          BSLS_COMPILERFEATURES_FORWARD_REF(Args_09) args_09);
#endif  // BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_B >= 9

#if BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_B >= 10
    template <class Args_01,
              class Args_02,
              class Args_03,
              class Args_04,
    ...
    EmplaceResult emplace(const bsl::string_view& key,
                          ...
                          BSLS_COMPILERFEATURES_FORWARD_REF(Args_09) args_09,
                          BSLS_COMPILERFEATURES_FORWARD_REF(Args_10) args_10);
#endif  // BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_B >= 10
...
#define BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT 10
#endif
#ifndef BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_C
#define BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_C BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT
#endif
#if BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_C >= 0
template <class t_VALUE>
                                         ...
                                         const bsl::string_view&  remainingKey)
{
    ...
    if (remainingKey.empty()) {
        if (node->value().has_value()) {
            return EmplaceResult(false, node->value().value());
        }
        node->value().emplace();
        return EmplaceResult(true, node->value().value());
    }
    ...
    if (it == node->children().end()) {
        ...
        iter->second.value().emplace();
        guard.release();
        return EmplaceResult(true, iter->second.value().value());
    }
    ...
    newIter->second.value().emplace();

    it->second = bslmf::MovableRefUtil::move(splitNode);
    return EmplaceResult(true, newIter->second.value().value());
}
#endif  // BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_C >= 0

#if BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_C >= 1
template <class t_VALUE>
template <class Args_01>
typename CategoryManager_RadixTree<t_VALUE>::EmplaceResult
CategoryManager_RadixTree<t_VALUE>::emplaceImp(
                            ...
                            BSLS_COMPILERFEATURES_FORWARD_REF(Args_01) args_01)
{
    ...
    if (remainingKey.empty()) {
        ...
        node->value().emplace(BSLS_COMPILERFEATURES_FORWARD(Args_01, args_01));
        return EmplaceResult(true, node->value().value());
    }
    ...
    if (it == node->children().end()) {
        typename Node::Children::iterator iter =
                       node->children().emplace(firstChar, remainingKey).first;
        ChildNodeGuard guard(node, iter);
        iter->second.value().emplace(BSLS_COMPILERFEATURES_FORWARD(Args_01,
                                     args_01));
        guard.release();
        return EmplaceResult(true, iter->second.value().value());
    }
    ...
    if (commonLen == remainingKey.size()) {
        splitNode.value().emplace(BSLS_COMPILERFEATURES_FORWARD(Args_01,
                                  args_01));
    ...
    const typename Node::Children::iterator newIter =
                      splitNode.children().emplace(newKey[0], newKey).first;
    newIter->second.value().emplace(BSLS_COMPILERFEATURES_FORWARD(Args_01,
                                    args_01));

    it->second = bslmf::MovableRefUtil::move(splitNode);
    return EmplaceResult(true, newIter->second.value().value());
}
#endif  // BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_C >= 1

#if BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_C >= 2
template <class t_VALUE>
template <class Args_01,
          class Args_02>
typename CategoryManager_RadixTree<t_VALUE>::EmplaceResult
...
#endif  // BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_C >= 2

#if BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_C >= 3
template <class t_VALUE>
template <class Args_01,
          class Args_02,
          class Args_03>
...
#endif  // BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_C >= 3

#if BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_C >= 4
template <class t_VALUE>
template <class Args_01,
          class Args_02,
          class Args_03,
...
#endif  // BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_C >= 4

#if BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_C >= 5
template <class t_VALUE>
template <class Args_01,
          class Args_02,
          class Args_03,
...
#endif  // BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_C >= 5

#if BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_C >= 6
template <class t_VALUE>
template <class Args_01,
          class Args_02,
          class Args_03,
...
#endif  // BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_C >= 6

#if BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_C >= 7
template <class t_VALUE>
template <class Args_01,
          class Args_02,
          class Args_03,
...
#endif  // BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_C >= 7

#if BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_C >= 8
template <class t_VALUE>
template <class Args_01,
          class Args_02,
          class Args_03,
...
#endif  // BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_C >= 8

#if BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_C >= 9
template <class t_VALUE>
template <class Args_01,
          class Args_02,
          class Args_03,
...
#endif  // BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_C >= 9

#if BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_C >= 10
template <class t_VALUE>
template <class Args_01,
          class Args_02,
          class Args_03,
...
#endif  // BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_C >= 10
                               ...
                               BSLS_COMPILERFEATURES_FORWARD_REF(Args)... args)
{
    ...
    if (remainingKey.empty()) {
        ...
        node->value().emplace(BSLS_COMPILERFEATURES_FORWARD(Args, args)...);
        return EmplaceResult(true, node->value().value());
    }
    ...
    if (it == node->children().end()) {
        typename Node::Children::iterator iter =
                       node->children().emplace(firstChar, remainingKey).first;
        ChildNodeGuard guard(node, iter);
        iter->second.value().emplace(BSLS_COMPILERFEATURES_FORWARD(Args,
                                     args)...);
        guard.release();
        return EmplaceResult(true, iter->second.value().value());
    }
    ...
    if (commonLen == remainingKey.size()) {
        splitNode.value().emplace(BSLS_COMPILERFEATURES_FORWARD(Args,
                                  args)...);
    ...
    const typename Node::Children::iterator newIter =
                      splitNode.children().emplace(newKey[0], newKey).first;
    newIter->second.value().emplace(BSLS_COMPILERFEATURES_FORWARD(Args,
                                    args)...);
...
#define BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT 10
#endif
#ifndef BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_D
#define BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_D BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT
#endif
#if BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_D >= 0
template <class t_VALUE>
typename CategoryManager_RadixTree<t_VALUE>::EmplaceResult
...
#endif  // BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_D >= 0

#if BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_D >= 1
template <class t_VALUE>
template <class Args_01>
typename CategoryManager_RadixTree<t_VALUE>::EmplaceResult
CategoryManager_RadixTree<t_VALUE>::emplace(const bsl::string_view& key,
...
#endif  // BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_D >= 1

#if BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_D >= 2
template <class t_VALUE>
template <class Args_01,
          class Args_02>
typename CategoryManager_RadixTree<t_VALUE>::EmplaceResult
...
#endif  // BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_D >= 2

#if BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_D >= 3
template <class t_VALUE>
template <class Args_01,
          class Args_02,
          class Args_03>
...
#endif  // BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_D >= 3

#if BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_D >= 4
template <class t_VALUE>
template <class Args_01,
          class Args_02,
          class Args_03,
...
#endif  // BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_D >= 4

#if BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_D >= 5
template <class t_VALUE>
template <class Args_01,
          class Args_02,
          class Args_03,
...
#endif  // BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_D >= 5

#if BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_D >= 6
template <class t_VALUE>
template <class Args_01,
          class Args_02,
          class Args_03,
...
#endif  // BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_D >= 6

#if BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_D >= 7
template <class t_VALUE>
template <class Args_01,
          class Args_02,
          class Args_03,
...
#endif  // BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_D >= 7

#if BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_D >= 8
template <class t_VALUE>
template <class Args_01,
          class Args_02,
          class Args_03,
...
#endif  // BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_D >= 8

#if BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_D >= 9
template <class t_VALUE>
template <class Args_01,
          class Args_02,
          class Args_03,
...
#endif  // BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_D >= 9

#if BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_D >= 10
template <class t_VALUE>
template <class Args_01,
          class Args_02,
          class Args_03,
...
#endif  // BALL_CATEGORYMANAGER_RADIXTREE_VARIADIC_LIMIT_D >= 10
...
#else // if ! defined(DEFINED_BALL_CATEGORYMANAGER_RADIXTREE_H)
# error Not valid except when included from ball_categorymanager_radixtree.h
#endif // ! defined(COMPILING_BALL_CATEGORYMANAGER_RADIXTREE_H)

#endif // ! defined(INCLUDED_BALL_CATEGORYMANAGER_RADIXTREE_CPP03)
