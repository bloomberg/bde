...
struct Administration {
    ...
    static int addCategory(const char *categoryName,
        ...
        // singleton has been initialized and it is not in the process of being
        // shut down.
    ...
    static int setAllThresholdLevels(int recordLevel,
        ...
        // and it is not in the process of being shut down.
    ...
    static int setThresholdLevels(const char *regularExpression,
        ...
        // undefined unless the logger manager singleton has been initialized
        // and it is not in the process of being shut down.  Note that the only
    ...
    static void resetDefaultThresholdLevels();
        ...
        // logger manager singleton has been initialized and it is not in the
        // process of being shut down.
    ...
    static int recordLevel(const char *categoryName);
        ...
        // manager singleton has been initialized and it is not in the process
        // of being shut down.
    ...
    static int maxNumCategories();
        ...
        // unless the logger manager singleton has been initialized and it is
        // not in the process of being shut down.  Note that
