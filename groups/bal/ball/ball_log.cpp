...
char *Log::obtainMessageBuffer(bdlmtt::Mutex **mutex, int *bufferSize)
{
...
void Log::releaseMessageBuffer(bdlmtt::Mutex *mutex)
{
    mutex->unlock();
}
...
Log_Formatter::~Log_Formatter()
{
    ...
    bdlmtt::LockGuard<bdlmtt::Mutex> lockGuard(d_mutex_p, 1);
