...
//      'ball::Severity::BAEL_TRACE').  Note that the formatted string includes
...
//      equivalent to 'BALL_LOG_STREAM(ball::Severity::BAEL_TRACE)'.  Also note
...
//      'ball::Severity::BAEL_ERROR').  The log record will contain the
...
//      'ball::Severity::BAEL_DEBUG').  Note that the formatted message string
...
//      logs with severity 'ball::Severity::BAEL_WARN').  The behavior is
...
//      'ball::Severity::BAEL_FATAL').  The behavior is undefined unless each
...
//..
// to category "EQUITY.NASD.SUNW" at severity level 'ball::Severity::BAEL_INFO'.
...
// level 'ball::Severity::BAEL_TRACE'.  The log record that is generated for
...
// 'bael::attributeContainer' component documentation for an example.
//..
...
#define BALL_LOG_SET_CATEGORY(CATEGORY)                                    \
    static BloombergLP::ball::CategoryHolder BAEL_LOG_CATEGORYHOLDER = {    \
        BloombergLP::ball::CategoryHolder::BAEL_UNINITIALIZED_CATEGORY, 0, 0\
    };                                                                     \
...
#define BALL_LOG_SET_DYNAMIC_CATEGORY(CATEGORY)                            \
    ...
    BloombergLP::ball::CategoryHolder BAEL_LOG_CATEGORYHOLDER = {           \
        BloombergLP::ball::CategoryHolder::BAEL_DYNAMIC_CATEGORY,           \
...
#define BALL_LOG_TRACE BALL_LOG_STREAM_UNLIKELY(ball::Severity::BAEL_TRACE)

#define BALL_LOG_DEBUG BALL_LOG_STREAM_UNLIKELY(ball::Severity::BAEL_DEBUG)

#define BALL_LOG_INFO  BALL_LOG_STREAM(ball::Severity::BAEL_INFO)

#define BALL_LOG_WARN  BALL_LOG_STREAM(ball::Severity::BAEL_WARN)

#define BALL_LOG_ERROR BALL_LOG_STREAM(ball::Severity::BAEL_ERROR)

#define BALL_LOG_FATAL BALL_LOG_STREAM(ball::Severity::BAEL_FATAL)
...
#define BALL_LOGCB_DEBUG(CB) BALL_LOGCB_STREAM(ball::Severity::BAEL_DEBUG, CB)

#define BALL_LOGCB_INFO(CB) BALL_LOGCB_STREAM(ball::Severity::BAEL_INFO, CB)

#define BALL_LOGCB_WARN(CB) BALL_LOGCB_STREAM(ball::Severity::BAEL_WARN, CB)

#define BALL_LOGCB_ERROR(CB) BALL_LOGCB_STREAM(ball::Severity::BAEL_ERROR, CB)

#define BALL_LOGCB_FATAL(CB) BALL_LOGCB_STREAM(ball::Severity::BAEL_FATAL, CB)
...
#define BALL_LOG0_TRACE(MSG)                                               \
    BALL_LOG0(ball::Severity::BAEL_TRACE, MSG)

#define BALL_LOG1_TRACE(MSG, ARG1)                                         \
    BALL_LOG1(ball::Severity::BAEL_TRACE, MSG, ARG1)
...
#define BALL_LOG3_TRACE(MSG, ARG1, ARG2, ARG3)                             \
    BALL_LOG3(ball::Severity::BAEL_TRACE, MSG, ARG1, ARG2, ARG3)

#define BALL_LOG4_TRACE(MSG, ARG1, ARG2, ARG3, ARG4)                       \
    BALL_LOG4(ball::Severity::BAEL_TRACE, MSG, ARG1, ARG2, ARG3, ARG4)

#define BALL_LOG5_TRACE(MSG, ARG1, ARG2, ARG3, ARG4, ARG5)                 \
    BALL_LOG5(ball::Severity::BAEL_TRACE, MSG, ARG1, ARG2, ARG3, ARG4, ARG5)

#define BALL_LOG6_TRACE(MSG, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6)           \
    BALL_LOG6(ball::Severity::BAEL_TRACE, MSG, ARG1, ARG2, ARG3, ARG4,      \
                                              ARG5, ARG6)

#define BALL_LOG7_TRACE(MSG, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7)     \
    BALL_LOG7(ball::Severity::BAEL_TRACE, MSG, ARG1, ARG2, ARG3, ARG4,      \
                                              ARG5, ARG6, ARG7)

#define BALL_LOG8_TRACE(MSG, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7,     \
                             ARG8)                                         \
    BALL_LOG8(ball::Severity::BAEL_TRACE, MSG, ARG1, ARG2, ARG3, ARG4,      \
                                              ARG5, ARG6, ARG7, ARG8)

#define BALL_LOG9_TRACE(MSG, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7,     \
                             ARG8, ARG9)                                   \
    BALL_LOG9(ball::Severity::BAEL_TRACE, MSG, ARG1, ARG2, ARG3, ARG4,      \
                                              ARG5, ARG6, ARG7, ARG8, ARG9)

#define BALL_LOG0_DEBUG(MSG)                                               \
    BALL_LOG0(ball::Severity::BAEL_DEBUG, MSG)

#define BALL_LOG1_DEBUG(MSG, ARG1)                                         \
    BALL_LOG1(ball::Severity::BAEL_DEBUG, MSG, ARG1)
...
#define BALL_LOG3_DEBUG(MSG, ARG1, ARG2, ARG3)                             \
    BALL_LOG3(ball::Severity::BAEL_DEBUG, MSG, ARG1, ARG2, ARG3)

#define BALL_LOG4_DEBUG(MSG, ARG1, ARG2, ARG3, ARG4)                       \
    BALL_LOG4(ball::Severity::BAEL_DEBUG, MSG, ARG1, ARG2, ARG3, ARG4)

#define BALL_LOG5_DEBUG(MSG, ARG1, ARG2, ARG3, ARG4, ARG5)                 \
    BALL_LOG5(ball::Severity::BAEL_DEBUG, MSG, ARG1, ARG2, ARG3, ARG4, ARG5)

#define BALL_LOG6_DEBUG(MSG, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6)           \
    BALL_LOG6(ball::Severity::BAEL_DEBUG, MSG, ARG1, ARG2, ARG3, ARG4,      \
                                              ARG5, ARG6)

#define BALL_LOG7_DEBUG(MSG, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7)     \
    BALL_LOG7(ball::Severity::BAEL_DEBUG, MSG, ARG1, ARG2, ARG3, ARG4,      \
                                              ARG5, ARG6, ARG7)

#define BALL_LOG8_DEBUG(MSG, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7,     \
                             ARG8)                                         \
    BALL_LOG8(ball::Severity::BAEL_DEBUG, MSG, ARG1, ARG2, ARG3, ARG4,      \
                                              ARG5, ARG6, ARG7, ARG8)

#define BALL_LOG9_DEBUG(MSG, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7,     \
                             ARG8, ARG9)                                   \
    BALL_LOG9(ball::Severity::BAEL_DEBUG, MSG, ARG1, ARG2, ARG3, ARG4,      \
                                              ARG5, ARG6, ARG7, ARG8, ARG9)

#define BALL_LOG0_INFO(MSG)                                                \
    BALL_LOG0(ball::Severity::BAEL_INFO, MSG)

#define BALL_LOG1_INFO(MSG, ARG1)                                          \
    BALL_LOG1(ball::Severity::BAEL_INFO, MSG, ARG1)
...
#define BALL_LOG3_INFO(MSG, ARG1, ARG2, ARG3)                              \
    BALL_LOG3(ball::Severity::BAEL_INFO, MSG, ARG1, ARG2, ARG3)

#define BALL_LOG4_INFO(MSG, ARG1, ARG2, ARG3, ARG4)                        \
    BALL_LOG4(ball::Severity::BAEL_INFO, MSG, ARG1, ARG2, ARG3, ARG4)

#define BALL_LOG5_INFO(MSG, ARG1, ARG2, ARG3, ARG4, ARG5)                  \
    BALL_LOG5(ball::Severity::BAEL_INFO, MSG, ARG1, ARG2, ARG3, ARG4, ARG5)

#define BALL_LOG6_INFO(MSG, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6)            \
    BALL_LOG6(ball::Severity::BAEL_INFO, MSG, ARG1, ARG2, ARG3, ARG4,       \
                                             ARG5, ARG6)

#define BALL_LOG7_INFO(MSG, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7)      \
    BALL_LOG7(ball::Severity::BAEL_INFO, MSG, ARG1, ARG2, ARG3, ARG4,       \
                                             ARG5, ARG6, ARG7)

#define BALL_LOG8_INFO(MSG, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7,      \
                            ARG8)                                          \
    BALL_LOG8(ball::Severity::BAEL_INFO, MSG, ARG1, ARG2, ARG3, ARG4,       \
                                             ARG5, ARG6, ARG7, ARG8)

#define BALL_LOG9_INFO(MSG, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7,      \
                             ARG8, ARG9)                                   \
    BALL_LOG9(ball::Severity::BAEL_INFO, MSG, ARG1, ARG2, ARG3, ARG4,       \
                                             ARG5, ARG6, ARG7, ARG8, ARG9)

#define BALL_LOG0_WARN(MSG)                                                \
    BALL_LOG0(ball::Severity::BAEL_WARN, MSG)

#define BALL_LOG1_WARN(MSG, ARG1)                                          \
    BALL_LOG1(ball::Severity::BAEL_WARN, MSG, ARG1)

#define BALL_LOG2_WARN(MSG, ARG1, ARG2)                                    \
    BALL_LOG2(ball::Severity::BAEL_WARN, MSG, ARG1, ARG2)

#define BALL_LOG3_WARN(MSG, ARG1, ARG2, ARG3)                              \
    BALL_LOG3(ball::Severity::BAEL_WARN, MSG, ARG1, ARG2, ARG3)

#define BALL_LOG4_WARN(MSG, ARG1, ARG2, ARG3, ARG4)                        \
    BALL_LOG4(ball::Severity::BAEL_WARN, MSG, ARG1, ARG2, ARG3, ARG4)

#define BALL_LOG5_WARN(MSG, ARG1, ARG2, ARG3, ARG4, ARG5)                  \
    BALL_LOG5(ball::Severity::BAEL_WARN, MSG, ARG1, ARG2, ARG3, ARG4, ARG5)

#define BALL_LOG6_WARN(MSG, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6)            \
    BALL_LOG6(ball::Severity::BAEL_WARN, MSG, ARG1, ARG2, ARG3, ARG4,       \
                                             ARG5, ARG6)

#define BALL_LOG7_WARN(MSG, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7)      \
    BALL_LOG7(ball::Severity::BAEL_WARN, MSG, ARG1, ARG2, ARG3, ARG4,       \
                                             ARG5, ARG6, ARG7)

#define BALL_LOG8_WARN(MSG, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7,      \
                             ARG8)                                         \
    BALL_LOG8(ball::Severity::BAEL_WARN, MSG, ARG1, ARG2, ARG3, ARG4,       \
                                             ARG5, ARG6, ARG7, ARG8)

#define BALL_LOG9_WARN(MSG, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7,      \
                             ARG8, ARG9)                                   \
    BALL_LOG9(ball::Severity::BAEL_WARN, MSG, ARG1, ARG2, ARG3, ARG4,       \
                                             ARG5, ARG6, ARG7, ARG8, ARG9)

#define BALL_LOG0_ERROR(MSG)                                               \
    BALL_LOG0(ball::Severity::BAEL_ERROR, MSG)

#define BALL_LOG1_ERROR(MSG, ARG1)                                         \
    BALL_LOG1(ball::Severity::BAEL_ERROR, MSG, ARG1)

#define BALL_LOG2_ERROR(MSG, ARG1, ARG2)                                   \
    BALL_LOG2(ball::Severity::BAEL_ERROR, MSG, ARG1, ARG2)

#define BALL_LOG3_ERROR(MSG, ARG1, ARG2, ARG3)                             \
    BALL_LOG3(ball::Severity::BAEL_ERROR, MSG, ARG1, ARG2, ARG3)

#define BALL_LOG4_ERROR(MSG, ARG1, ARG2, ARG3, ARG4)                       \
    BALL_LOG4(ball::Severity::BAEL_ERROR, MSG, ARG1, ARG2, ARG3, ARG4)

#define BALL_LOG5_ERROR(MSG, ARG1, ARG2, ARG3, ARG4, ARG5)                 \
    BALL_LOG5(ball::Severity::BAEL_ERROR, MSG, ARG1, ARG2, ARG3, ARG4, ARG5)

#define BALL_LOG6_ERROR(MSG, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6)           \
    BALL_LOG6(ball::Severity::BAEL_ERROR, MSG, ARG1, ARG2, ARG3, ARG4,      \
                                              ARG5, ARG6)

#define BALL_LOG7_ERROR(MSG, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7)     \
    BALL_LOG7(ball::Severity::BAEL_ERROR, MSG, ARG1, ARG2, ARG3, ARG4,      \
                                              ARG5, ARG6, ARG7)

#define BALL_LOG8_ERROR(MSG, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7,     \
                             ARG8)                                         \
    BALL_LOG8(ball::Severity::BAEL_ERROR, MSG, ARG1, ARG2, ARG3, ARG4,      \
                                              ARG5, ARG6, ARG7, ARG8)

#define BALL_LOG9_ERROR(MSG, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7,     \
                             ARG8, ARG9)                                   \
    BALL_LOG9(ball::Severity::BAEL_ERROR, MSG, ARG1, ARG2, ARG3, ARG4,      \
                                              ARG5, ARG6, ARG7, ARG8, ARG9)

#define BALL_LOG0_FATAL(MSG)                                               \
    BALL_LOG0(ball::Severity::BAEL_FATAL, MSG)

#define BALL_LOG1_FATAL(MSG, ARG1)                                         \
    BALL_LOG1(ball::Severity::BAEL_FATAL, MSG, ARG1)

#define BALL_LOG2_FATAL(MSG, ARG1, ARG2)                                   \
    BALL_LOG2(ball::Severity::BAEL_FATAL, MSG, ARG1, ARG2)

#define BALL_LOG3_FATAL(MSG, ARG1, ARG2, ARG3)                             \
    BALL_LOG3(ball::Severity::BAEL_FATAL, MSG, ARG1, ARG2, ARG3)

#define BALL_LOG4_FATAL(MSG, ARG1, ARG2, ARG3, ARG4)                       \
    BALL_LOG4(ball::Severity::BAEL_FATAL, MSG, ARG1, ARG2, ARG3, ARG4)

#define BALL_LOG5_FATAL(MSG, ARG1, ARG2, ARG3, ARG4, ARG5)                 \
    BALL_LOG5(ball::Severity::BAEL_FATAL, MSG, ARG1, ARG2, ARG3, ARG4, ARG5)

#define BALL_LOG6_FATAL(MSG, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6)           \
    BALL_LOG6(ball::Severity::BAEL_FATAL, MSG, ARG1, ARG2, ARG3, ARG4,      \
                                              ARG5, ARG6)

#define BALL_LOG7_FATAL(MSG, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7)     \
    BALL_LOG7(ball::Severity::BAEL_FATAL, MSG, ARG1, ARG2, ARG3, ARG4,      \
                                              ARG5, ARG6, ARG7)

#define BALL_LOG8_FATAL(MSG, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7,     \
                             ARG8)                                         \
    BALL_LOG8(ball::Severity::BAEL_FATAL, MSG, ARG1, ARG2, ARG3, ARG4,      \
                                              ARG5, ARG6, ARG7, ARG8)

#define BALL_LOG9_FATAL(MSG, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7,     \
                             ARG8, ARG9)                                   \
    BALL_LOG9(ball::Severity::BAEL_FATAL, MSG, ARG1, ARG2, ARG3, ARG4,      \
                                              ARG5, ARG6, ARG7, ARG8, ARG9)
...
struct Log {
    ...
    static bool isCategoryEnabled(const CategoryHolder *categoryHolder,
        ...
        // or if 'Severity::BAEL_WARN >= severity' and the logger manager
