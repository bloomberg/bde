...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:
      ...
      case 1: {
        ...
        mX.setLength(4);
        mX.setValue(0, A_INT);
        mX.setValue(1, A_STRING);
        mX.setValue(2, A_DATE);

        if (veryVerbose) cout << "\ta. Check new value of 'x'." << endl;
        if (veryVeryVerbose) { T_ P(X) }

        ASSERT(4        == X.length());
        ASSERT(A_INT    == X.value(0).the<int64_t>());
        ASSERT(A_STRING == X.value(1).the<bsl::string>());
        ASSERT(A_DATE   == X.value(2).the<bdlt::DatetimeTz>());
        ASSERT(true     == X.value(3).isUnset());
        ...
        mY.setLength(4);
        mY.setValue(0, A_INT);
        mY.setValue(1, A_STRING);
        mY.setValue(2, A_DATE);
        ...
        ASSERT(4        == Y.length());
        ASSERT(A_INT    == Y.value(0).the<int64_t>());
        ASSERT(A_STRING == Y.value(1).the<bsl::string>());
        ASSERT(A_DATE   == Y.value(2).the<bdlt::DatetimeTz>());
        ASSERT(true     == Y.value(3).isUnset());
        ...
        ASSERT(4        == Z.length());
        ASSERT(A_INT    == Z.value(0).the<int64_t>());
        ASSERT(A_STRING == Z.value(1).the<bsl::string>());
        ASSERT(A_DATE   == Z.value(2).the<bdlt::DatetimeTz>());
        ASSERT(true     == Z.value(3).isUnset());
        ...
        ASSERT(4        == W.length());
        ASSERT(A_INT    == W.value(0).the<int64_t>());
        ASSERT(A_STRING == W.value(1).the<bsl::string>());
        ASSERT(A_DATE   == W.value(2).the<bdlt::DatetimeTz>());
        ASSERT(true     == W.value(3).isUnset());
