...
// 'bdlaggxxx::Aggregate' can be decoded using this 'class'.  The 'decode' function
...
//..
//
///Example 2: Decoding into a 'bdlaggxxx::Aggregate' Object from JSON data
///-----------------------------------------------------------------
// Now consider that we want to exchange an employee's information between two
// processes using a 'bdlaggxxx::Aggregate'.  To allow this information exchange we
// will define the 'bdlmxxx::Schema' to represent the meta-data, construct the
// 'bdlaggxxx::Aggregate' object with that schema, and decode that object using the
// baejsn decoder.
//
// First, we create a 'bdlmxxx::Schema' object:
//..
...
//  addressRecord->appendField(bdlmxxx::ElemType::BDEM_STRING, "city");
//  addressRecord->appendField(bdlmxxx::ElemType::BDEM_STRING, "state");
//
//  bdlmxxx::RecordDef *employeeRecord = schema->createRecord("Employee");
//  employeeRecord->appendField(bdlmxxx::ElemType::BDEM_STRING, "name");
//  employeeRecord->appendField(bdlmxxx::ElemType::BDEM_LIST,
//                              addressRecord,
//                              "homeAddress");
//  employeeRecord->appendField(bdlmxxx::ElemType::BDEM_INT, "age");
//..
// Then, we create a 'bdlaggxxx::Aggregate' object using the schema::
//..
//  bdlaggxxx::Aggregate employee(schema, "Employee");
//..
// Next, we will create a 'baljsn::Decoder' object:
//..
//  baljsn::Decoder decoder;
//..
...
//..
// Now, we will decode this object using the 'decode' function of the baejsn
// decoder by providing it a default 'baljsn::DecoderOptions' object.  Doing so
...
class Decoder {
    ...
    // particular, 'bdlaggxxx_aggregate' and the types generated by 'bas_codegen.pl'
