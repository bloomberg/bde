...
// 'bdlaggxxx::Aggregate' can be encoded using this 'class'.  The 'encode' function
...
//..
//
///Example 2: Encoding a 'bdlaggxxx::Aggregate' Object into JSON
///-------------------------------------------------------
...
// 'bdlaggxxx::Aggregate' object with that schema, populate it, and encode that
...
//..
// Then, we create a 'bdlaggxxx::Aggregate' object using the schema and populate it
// with values:
//..
...
//..
// Next, we create a 'baljsn::Encoder':
//..
//  baljsn::Encoder encoder;
//..
// Now, we will output this object in the JSON format by invoking the 'encode'
// method of the encoder.  We will pass a default 'baljsn::EncoderOptions'
