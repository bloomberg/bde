...
// ```
// * *dataType* - the `Datum` type value returned by the `type()`
// * *JSON-able* - whether the type can be `encode`d by this component.
// * *JSON type* - the JSON type used to `encode` this value, if supported.
// * *decode type* - the `Datum` type this `encode`d value would be
//    `decode`d into.
// * *strictTypes ok?* - `encode` will return 0 on success even if
