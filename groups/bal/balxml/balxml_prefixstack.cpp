...
const PredefinedPrefix& lookupPredefinedPrefix(const bdlb::StringRef& prefix)
...
int PrefixStack::pushPrefix(const bdlb::StringRef& prefix,
...
int
PrefixStack::lookupNamespaceId(const bdlb::StringRef& prefix) const
{
...
const char *
PrefixStack::lookupNamespacePrefix(const bdlb::StringRef& prefix) const
{
    PrefixVector::const_iterator i = d_prefixes.begin() + d_numPrefixes;
    while (i != d_prefixes.begin()) {
        --i;
...
const char *
PrefixStack::lookupNamespaceUri(const bdlb::StringRef& prefix) const
{
