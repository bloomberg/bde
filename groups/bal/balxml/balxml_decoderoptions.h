...
// CLASS METHODS
inline
int DecoderOptions::maxSupportedBdexVersion()
{
...
// MANIPULATORS
template <class STREAM>
STREAM& DecoderOptions::bdexStreamIn(STREAM& stream, int version)
{
    if (stream) {
        switch (version) {
          case 1: {
...
// ACCESSORS
template <class STREAM>
STREAM& DecoderOptions::bdexStreamOut(STREAM& stream, int version) const
{
    switch (version) {
      case 1: {
