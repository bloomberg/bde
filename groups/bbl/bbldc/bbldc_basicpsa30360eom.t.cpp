      ...
      case 2: {
...

        {
            static const struct {
                ...
                { L_,     2003,     2,    28,   2004,     2,    29,   0.9972 },

                { L_,     1993,    12,    15,   1993,    12,    30,   0.0417 },
                { L_,     1993,    12,    15,   1993,    12,    31,   0.0444 },
                { L_,     1993,    12,    31,   1994,     2,     1,   0.0861 },

                { L_,     1996,     1,    15,   1996,     5,    31,   0.3778 },

                { L_,     1998,     2,    27,   1998,     3,    27,   0.0833 },
                { L_,     1998,     2,    28,   1998,     3,    27,   0.0750 },

                { L_,     1999,     1,     1,   1999,     1,    29,   0.0778 },
                { L_,     1999,     1,    29,   1999,     1,    30,   0.0028 },
                { L_,     1999,     1,    29,   1999,     1,    31,   0.0056 },
                { L_,     1999,     1,    29,   1999,     3,    29,   0.1667 },
                { L_,     1999,     1,    29,   1999,     3,    30,   0.1694 },
                { L_,     1999,     1,    29,   1999,     3,    31,   0.1722 },
                { L_,     1999,     1,    30,   1999,     1,    31,        0 },
                { L_,     1999,     1,    30,   1999,     2,    27,   0.0750 },
                { L_,     1999,     1,    30,   1999,     2,    28,   0.0778 },
                { L_,     1999,     1,    30,   1999,     3,    29,   0.1639 },
                { L_,     1999,     1,    30,   1999,     3,    30,   0.1667 },
                { L_,     1999,     1,    30,   1999,     3,    31,   0.1667 },
                { L_,     1999,     1,    31,   1999,     3,    29,   0.1639 },
                { L_,     1999,     1,    31,   1999,     3,    30,   0.1667 },
                { L_,     1999,     1,    31,   1999,     3,    31,   0.1667 },

                { L_,     1999,     2,    27,   1999,     2,    27,        0 },
                { L_,     1999,     2,    27,   1999,     2,    28,   0.0028 },
                { L_,     1999,     2,    28,   1999,     2,    27,  -0.0028 },
