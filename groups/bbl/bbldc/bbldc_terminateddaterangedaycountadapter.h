// bbldc_terminateddaterangedaycountadapter.h                         -*-C++-*-
#ifndef INCLUDED_BBLDC_TERMINATEDDATERANGEDAYCOUNTADAPTER
#define INCLUDED_BBLDC_TERMINATEDDATERANGEDAYCOUNTADAPTER
...
class TerminatedDateRangeDayCountAdapter : public DateRangeDayCount {
  ...
  private:
    ...
    TerminatedDateRangeDayCountAdapter(
                                    const TerminatedDateRangeDayCountAdapter&);
    TerminatedDateRangeDayCountAdapter& operator=(
                                    const TerminatedDateRangeDayCountAdapter&);
  ...
  public:
    ...
    virtual ~TerminatedDateRangeDayCountAdapter();
        // Destroy this object.
...
template <class CONVENTION>
inline
int TerminatedDateRangeDayCountAdapter<CONVENTION>::daysDiff(
...
template <class CONVENTION>
inline
const bdlt::Date& TerminatedDateRangeDayCountAdapter<CONVENTION>::
                                                              firstDate() const
{
...
template <class CONVENTION>
inline
double TerminatedDateRangeDayCountAdapter<CONVENTION>::yearsDiff(
                                               const bdlt::Date& beginDate,
                                               const bdlt::Date& endDate) const
{
