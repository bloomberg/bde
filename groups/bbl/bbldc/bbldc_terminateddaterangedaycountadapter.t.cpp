// bbldc_terminateddaterangedaycountadapter.t.cpp                     -*-C++-*-
        ...
        {
            {
                ...
                double diff2 = 0.9972 - protocol.yearsDiff(DATE3, DATE4);
