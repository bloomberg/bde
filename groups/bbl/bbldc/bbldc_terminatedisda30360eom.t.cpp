      ...
      case 2: {
...

        {
            static const struct {
                ...
                { L_,     1996,     1,    15,   1996,     5,    31,   0.375  },
                { L_,     2000,     2,    27,   2000,     2,    27,   0.0000 },
                { L_,     2000,     2,    27,   2000,     2,    28,   0.0028 },
                { L_,     2000,     2,    27,   2000,     2,    29,   0.0083 },
                { L_,     2000,     2,    28,   2000,     2,    27,  -0.0028 },
                { L_,     2000,     2,    28,   2000,     2,    28,   0.0000 },
                { L_,     2000,     2,    28,   2000,     2,    29,   0.0056 },
                { L_,     2000,     2,    29,   2000,     2,    27,  -0.0083 },
                { L_,     2000,     2,    29,   2000,     2,    28,  -0.0056 },
      ...
      case 1: {
                          ...
                          << "==================" << endl;
        {
            static const struct {
                ...
                { L_,     1999,     2,    27,   1999,     2,    28,        3 },
                { L_,     1999,     2,    28,   1999,     2,    27,       -3 },
                ...
                { L_,     2000,     2,    27,   2000,     2,    29,        3 },
                { L_,     2000,     2,    28,   2000,     2,    27,       -1 },
                { L_,     2000,     2,    28,   2000,     2,    28,        0 },
                { L_,     2000,     2,    28,   2000,     2,    29,        2 },
                { L_,     2000,     2,    29,   2000,     2,    27,       -3 },
                { L_,     2000,     2,    29,   2000,     2,    28,       -2 },
