...
enum {
    e_BLOCKING_MODE    = bteso_Flag::BTESO_BLOCKING_MODE,
    e_NONBLOCKING_MODE = bteso_Flag::BTESO_NONBLOCKING_MODE
};
                      ...
                      const bsls::TimeInterval&                timeout)
{
    ...
    #else
    BSLS_ASSERT(0 == rc);
    BSLS_ASSERT(bteso_Flag::BTESO_NONBLOCKING_MODE == result);
    #endif
