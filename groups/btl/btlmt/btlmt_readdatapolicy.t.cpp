...
#define NL "\n"
            ...
            //----  -----  ---  ----------------------  -----------------
            { L_,     0,    4,  Obj::e_GREEDY,          "GREEDY" NL        },
            { L_,     0,    4,  Obj::e_ROUND_ROBIN,     "ROUND_ROBIN" NL   },
            ...
            { L_,     0,   -1,  Obj::e_GREEDY,            "GREEDY"               },
            { L_,     0,    0,  Obj::e_GREEDY,            "GREEDY" NL            },
            { L_,     0,    2,  Obj::e_GREEDY,            "GREEDY" NL            },
            { L_,     1,    1,  Obj::e_GREEDY,            " GREEDY" NL           },
            { L_,     1,    2,  Obj::e_GREEDY,            "  GREEDY" NL          },
            { L_,    -1,    2,  Obj::e_GREEDY,            "GREEDY" NL            },
            { L_,    -2,    1,  Obj::e_GREEDY,            "GREEDY" NL            },
            { L_,     2,    1,  Obj::e_GREEDY,            "  GREEDY" NL          },
            { L_,     1,    3,  Obj::e_GREEDY,            "   GREEDY" NL         },
#undef NL
        };
        ...
        ASSERT(Obj::e_GREEDY         == Obj::e_GREEDY);
        ASSERT(Obj::e_ROUND_ROBIN    == Obj::e_ROUND_ROBIN);
      ...
      case 2: {
        ...
        static const struct {
            ...
            //----    -----------------------     ---------------
            { L_,     Obj::e_GREEDY,              "GREEDY"           },
            { L_,     Obj::e_ROUND_ROBIN,         "ROUND_ROBIN"      },
