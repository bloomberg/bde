...
class Channel {
    ...
    bdlqq::Mutex                     d_writeMutex;       // synching access to
                                                         // the 'write' data
                                                         // members (variables
                                                         // 'd_write*', and
                                                         // 'd_isWriteActive'.
...
int Channel::initiateReadSequence(ChannelHandle self)
{
    ...
    readFunctor = bdlf::BindUtil::bindA(d_allocator_p,
                                        &Channel::readCb,
                                        this,
                                        self);
                          ...
                          const ChannelHandle& self)
{
    ...
    if (BSLS_PERFORMANCEHINT_PREDICT_LIKELY(!d_isWriteActive)) {
        ...
        bdlf::Function<void (*)()> initWriteFunctor(bdlf::BindUtil::bindA(
                                                     d_allocator_p,
...
void ChannelPool::acceptCb(int serverId, bsl::shared_ptr<ServerState> server)
{
    ...
    if (server->d_isTimedFlag) {
        ...
        bdlf::Function<void (*)()> acceptTimeoutFunctor(
                           bdlf::BindUtil::bindA(d_allocator_p,
    ...
    bdlf::Function<void (*)()> invokeChannelUpCommand(
                               bdlf::BindUtil::bindA(d_allocator_p,
    ...
    if (server->d_readEnabledFlag) {
        initiateReadCommand = bdlf::BindUtil::bindA(
                                                d_allocator_p,
                                ...
                                bsl::shared_ptr<ServerState> server)
{
    ...
    bdlf::Function<void (*)()> acceptFunctor(
                                  bdlf::BindUtil::bindA(d_allocator_p,
...
void ChannelPool::connectInitiateCb(ConnectorMap::iterator idx)
{
    ...
    if (continueFlag && socket) {
        ...
        if (0 == retCode && 0 == socket->connectionStatus()) {
          ...
          bdlf::Function<void (*)()> connectEventFunctor(
                            bdlf::BindUtil::bindA(d_allocator_p,
                    ...
                    KeepHalfOpenMode  mode)
{
    ...
    bdlf::Function<void (*)()> importFunctor(
                                  bdlf::BindUtil::bindA(d_allocator_p,
