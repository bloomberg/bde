...
// [ 1] const char *toAscii(btlmt::ResolutionMode::Enum val);
//
// FREE OPERATORS
// [ 3] operator<<(ostream& s, btlmt::ResolutionMode::Enum val);
// ----------------------------------------------------------------------------
// [ 5] USAGE EXAMPLE
...
typedef btlmt::ResolutionMode::Enum Enum;
typedef btlmt::ResolutionMode       Obj;
...
int main(int argc, char *argv[])
{
    ...
    bslma::TestAllocator defaultAllocator(1);
...
//..
      ...
      case 3: {
        ...
        //
        // Testing:
        //   operator<<(ostream& s, btlmt::ResolutionMode::Enum val);
        // --------------------------------------------------------------------
        ...
        static const struct {
            ...
            //----    ----------------------          -----------------
            { L_,     Obj::e_RESOLVE_ONCE,            "RESOLVE_ONCE"      },
            { L_,     Obj::e_RESOLVE_EACH_TIME,       "RESOLVE_EACH_TIME" },
...
#define NL "\n"
            ...
            //---- ----- --- ----------------------     --------------------
            { L_,   0,   4, Obj::e_RESOLVE_ONCE,      "RESOLVE_ONCE" NL    },
            { L_,   0,   4, Obj::e_RESOLVE_EACH_TIME, "RESOLVE_EACH_TIME" NL },
            ...
            { L_,    0,  -1, Obj::e_RESOLVE_ONCE,       "RESOLVE_ONCE"       },
            { L_,    0,   0, Obj::e_RESOLVE_ONCE,       "RESOLVE_ONCE" NL    },
            { L_,    0,   2, Obj::e_RESOLVE_ONCE,       "RESOLVE_ONCE" NL    },
            { L_,    1,   1, Obj::e_RESOLVE_ONCE,       " RESOLVE_ONCE" NL   },
            { L_,    1,   2, Obj::e_RESOLVE_ONCE,       "  RESOLVE_ONCE" NL  },
            { L_,   -1,   2, Obj::e_RESOLVE_ONCE,       "RESOLVE_ONCE" NL    },
            { L_,   -2,   1, Obj::e_RESOLVE_ONCE,       "RESOLVE_ONCE" NL    },
            { L_,    2,   1, Obj::e_RESOLVE_ONCE,       "  RESOLVE_ONCE" NL  },
            { L_,    1,   3, Obj::e_RESOLVE_ONCE,       "   RESOLVE_ONCE" NL },
#undef NL
        };
        const int NUM_DATA = sizeof DATA / sizeof *DATA;
      ...
      case 1: {
        ...
        // Testing:
        //   enum Enum { ... };
        //   const char *toAscii(btlmt::ResolutionMode::Enum val);
        // -------------------------------------------------------------------
