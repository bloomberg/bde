...
//..
      ...
      case 3: {
        ...
        ASSERT(Obj::ACCEPT         == Obj::e_ACCEPT);
        ASSERT(Obj::BTESO_ACCEPT   == Obj::e_ACCEPT);
        ASSERT(Obj::CONNECT        == Obj::e_CONNECT);
        ASSERT(Obj::BTESO_CONNECT  == Obj::e_CONNECT);
        ASSERT(Obj::READ           == Obj::e_READ);
        ASSERT(Obj::BTESO_READ     == Obj::e_READ);
        ASSERT(Obj::WRITE          == Obj::e_WRITE);
        ASSERT(Obj::BTESO_WRITE    == Obj::e_WRITE);
