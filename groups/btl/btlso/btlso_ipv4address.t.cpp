...
// [10] bslx::OutStream& bdexStreamOut(bslx::OutStream& stream) const;
// [10] bslx::OutStream& bdexStreamOut(bslx::OutStream& stream, int version) const;
// FREE OPERATORS
// [ 6] bool operator==(const bteso::IPv4Addr& lhs, const bteso::IPv4Addr& rhs);
// [ 6] bool operator!=(const bteso::IPv4Addr& lhr, const bteso::IPv4Addr& rhs);
// [ 5] ostream& operator<<(ostream& output, const btlso::IPv4Address& addr);
// ----------------------------------------------------------------------------
// [ 1] breathing test
// [13] USAGE example
//=============================================================================
...
int main(int argc, char *argv[])
{
    ...
    switch (test) {
        ...
        case 12: {
            ...
            if (verbose) cout << "\nTesting 'isValid' and 'isValidAddress'"
                              << "\n======================================"
                              << endl;
            {
                static const struct {
                ...
                for (int i = 0; i < NUM_VALUES; ++i) {
                    ...
                    LOOP2_ASSERT(i, LINE, EXPECT ==
                                       (0 == btlso::IPv4Address::isValid(IPS)));
                    LOOP2_ASSERT(i, LINE, EXPECT ==
        ...
        case 6: {
            ...
            //
            // Testing:
            //   operator==(const bteso::IPv4Addr&, const bteso::IPv4Addr&);
            //   operator!=(const bteso::IPv4Addr&, const bteso::IPv4Addr&);
            // ----------------------------------------------------------------
