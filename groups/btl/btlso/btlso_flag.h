...
// corresponding string representation, to write its string form directly to a
// standard 'ostream'.  In addition, this class supports functions that convert
// these types to a well-defined ascii representation.
