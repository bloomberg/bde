...
// addresses is 'btlso::IPv4Address'.  After a socket has been created with
...
class SocketImpUtil_Imp {
    ...
    // functions of 'SocketImpUtil'.  Templatized static member
...
inline int SocketImpUtil::accept(
                      ...
                      int                               *errorCode)
{
    return SocketImpUtil_Imp<ADDRESS>::accept(newSocket, peerAddress,
                                                    socket, errorCode);
}
...
template <class ADDRESS>
inline int SocketImpUtil::connect(
                       const SocketHandle::Handle& socket,
                       const ADDRESS&                    address,
                       int                              *errorCode)
{
    return SocketImpUtil_Imp<ADDRESS>::connect(socket, address,
                                                     errorCode);
}
...
template <class ADDRESS>
inline int SocketImpUtil::open(
            SocketHandle::Handle  *newSocket,
            SocketImpUtil::Type    type,
            int                          protocol,
            int                         *errorCode)
{
    return SocketImpUtil_Imp<ADDRESS>::open(newSocket, type,
                                                  protocol, errorCode);
}
...
inline int SocketImpUtil::readFrom(
                           ...
                           int                               *errorCode)
{
    return SocketImpUtil_Imp<ADDRESS>::readFrom(
...
template <class ADDRESS>
inline int SocketImpUtil::socketPair(
                          SocketHandle::Handle  *newSockets,
                          SocketImpUtil::Type    type,
                          int                         *errorCode)
{
    return SocketImpUtil_Imp<ADDRESS>::socketPair(newSockets, type,
                                                        0, errorCode);
}
...
template <class ADDRESS>
inline int SocketImpUtil::writeTo(
                      const SocketHandle::Handle&  socket,
                      const ADDRESS&                     toAddress,
                      const void                        *buffer,
                      int                                numBytes,
                      int                               *errorCode)
{
    return SocketImpUtil_Imp<ADDRESS>::writeTo(socket, toAddress,
                                                     buffer, numBytes,
                                                     errorCode);
}
...
template <class ADDRESS>
inline int SocketImpUtil::writevTo(
                      const SocketHandle::Handle&  socket,
                      const ADDRESS&                     toAddress,
                      const btls::Ovec                   *ovec,
                      int                                numBuffs,
                      int                               *errorCode)
{
    return SocketImpUtil_Imp<ADDRESS>::writevTo(socket, toAddress,
                                                      ovec, numBuffs,
                                                      errorCode);
}
                       ...
                       int                              *errorCode)
{
    ...
    *newSocket = ::accept(listeningSocket,
    ...
    int errorNumber = SocketImpUtil_Util::isValid(*newSocket) ? 0 :
...
template <class ADDRESS>
int SocketImpUtil_Imp<ADDRESS>::bind(
...
template <class ADDRESS>
int SocketImpUtil_Imp<ADDRESS>::connect(
                                 const SocketHandle::Handle& theSocket,
                                 const ADDRESS&                    address,
                                 int                              *errorCode)
{
...
template <class ADDRESS>
inline int SocketImpUtil_Imp<ADDRESS>::open(
                                       SocketHandle::Handle *newSocket,
                                       SocketImpUtil::Type   type,
                                       int                        *errorCode)
{
...
template <class ADDRESS>
int SocketImpUtil_Imp<ADDRESS>::open(
                                       SocketHandle::Handle *newSocket,
                                       SocketImpUtil::Type   type,
                                       int                         protocol,
                                       int                        *errorCode)
...
template <class ADDRESS>
int SocketImpUtil_Imp<ADDRESS>::writeTo(
                                const SocketHandle::Handle& socket,
                                const ADDRESS&                    toAddress,
                                const void                       *buffer,
                                int                               numBytes,
...
template <class ADDRESS>
int SocketImpUtil_Imp<ADDRESS>::socketPair(
                          SocketHandle::Handle  *newSockets,
                          SocketImpUtil::Type    type,
                          int                         *errorCode)
{
