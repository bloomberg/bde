...
//
//@CLASSES:
//  btlso::DefaultEventManager<POLLSET>: 'pollset'-based multiplexer
//
//@SEE_ALSO: btlso_eventmanager btlso_defaulteventmanager btlso_timemetrics
//
//@SEE_ALSO: btlso_tcptimereventmanager bteso_eventmanagertest btlso_platform
//
...
// to the 'btlso::EventManager' protocol.  In particular, this protocol supports
