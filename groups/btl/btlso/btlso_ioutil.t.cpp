...
// int setAsync(btlso::SocketHandle::Handle handle,
//              btlso::IoUtil::AsyncMode    option,
//              int                       *errorCode = 0);
...
// ACCESSORS
// [10] int getBlockingMode(btlso::IoUtil::BlockingMode *result,
//                          btlso::SocketHandle::Handle  handle,
//                          int                        *errorCode = 0);
// [11] int getCloseOnExec(int *result, btlso::SocketHandle::Handle handle,
//                         int *errorCode = 0);
// [12] int getAsync(btlso::IoUtil::AsyncMode    *result,
//                   btlso::SocketHandle::Handle  handle,
//                   int                        *errorCode = 0);
// ----------------------------------------------------------------------------
// [13] USAGE example
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:   // Zero is always the leading case.
        ...
        case 11: {
            ...
            //
            // Testing
            //   getCloseOnExec(int *result, btlso::SocketHandle::Handle handle,
            //                  int *errorCode = 0);
            // ----------------------------------------------------------------
            static int result;
            int ret=0, errCode = 0;
        ...
        case 9: {
            ...
            // Testing:
            //   setAsync(btlso::SocketHandle::Handle handle,
            //            int option, int *errorCode = 0);
            // ----------------------------------------------------------------
            btlso::IoUtil::AsyncMode result;
            int ret=0, errCode = 0, *errNull = NULL;
        ...
        case 3: {
            ...
            //
            // Testing
            //   setBlockingMode(btlso::SocketHandle::Handle handle,
            //                   int option, int *errorCode = 0);
            // ---------------------------------------------------------------
            btlso::IoUtil::BlockingMode result;
            int ret=0, errCode = 0, *errNull = NULL;
        ...
        case 1: {
            ...
            {
                btlso::IoUtil::AsyncMode value = ASYNCH,
                                        result;
                retCode = btlso::IoUtil::setAsync(socketHandle, value,
                                                 &errCode);
                ASSERT(0 == retCode);   ASSERT(0 == errCode);
