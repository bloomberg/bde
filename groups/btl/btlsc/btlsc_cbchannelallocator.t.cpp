...
// ----------------------------------------------------------------------------
class MyAllocator : public btlsc::CbChannelAllocator {
...
int main(int argc, char *argv[]) {
    ...
    switch (test) { case 0:
      ...
      case 1: {
        ...
        MyAllocator myA;
        btlsc::CbChannelAllocator& a = myA;
        ...
        if (verbose) cout << "\nTesting protocol interface" << endl;
        {
            ...
            btlsc::CbChannelAllocator::Callback myCb(&myCbFn);
            btlsc::CbChannelAllocator::TimedCallback myTimedCb(&myTimedCbFn);
