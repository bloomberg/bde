...
//
//@SEE_ALSO: btlsc_cbchannelallocator btemc_channelallocator
//
...
// demand.  We will use the 'btlsc::ChannelAllocator' protocol to abstract those
...
//      // single 'btlsc::Channel' and send them synchronously one by
//      // one to a peer (or similar peers) connected via channels provided via
//      // a 'btlsc::ChannelAllocator'.  Both the output channel
