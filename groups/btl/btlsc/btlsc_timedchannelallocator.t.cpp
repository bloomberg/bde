...
// virtual btlsc::Channel *timedAllocate();
// virtual btlsc::TimedChannel *allocateTimed();
// virtual btlsc::TimedChannel *timedAllocateTimed();
...
//-----------------------------------------------------------------------------
class MyAllocator : public btlsc::TimedChannelAllocator {
  ...
  public:
    ...
    virtual btlsc::Channel *timedAllocate(int                      *status,
...
int main(int argc, char *argv[]) {
    ...
    switch (test) { case 0:
      ...
      case 1: {
        ...
        MyAllocator myC;
        btlsc::TimedChannelAllocator& c = myC;
