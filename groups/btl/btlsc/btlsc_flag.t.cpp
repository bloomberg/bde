...
// [ 2] bdexStreamIn(bdlxxxx::InStream&, btesc_Flag::Flag& rhs);
// [ 2] bdexStreamOut(bdlxxxx::OutStream&, btesc_Flag::Flag rhs);
//=============================================================================
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:
      case 2: {
        ...
        //
        // Testing:
        //   bdexStreamIn(bdlxxxx::InStream&, btesc_Flag::Flag& rhs);
        //   bdexStreamOut(bdlxxxx::OutStream&, btesc_Flag::Flag rhs);
        // --------------------------------------------------------------------
        ...
        //char M1; {bdlxxxx::OutByteStream o; o<<char(-1); M1=o.data()[0];}
