...
//-----------------------------------------------------------------------------
// [ 1] ~btlsc::TimedCbChannelAllocator();
...
//                         const bsls::TimeInterval& timeout,
//                         int                      flags = 0);
// [ 1] void deallocate(btes::CbChannel *channel);
// [ 1] void invalidate();
...
//-----------------------------------------------------------------------------
class MyAllocator : public btlsc::TimedCbChannelAllocator {
  ...
  public:
    ...
    void deallocate(btlsc::CbChannel *channel)
        { d_fun = 5; }
    void invalidate()
        { d_fun = 6; d_valid = 0; }
    void cancelAll()
...
int main(int argc, char *argv[]) {
    ...
    switch (test) { case 0:
      ...
      case 1: {
        ...
        //   'btlsc::TimedCbChannelAllocator' class compiles and links when all
        ...
        //                      const bsls::TimeInterval& timeout,
        //                      int                      flags = 0);
        //   void deallocate(btes::CbChannel *channel);
        //   void invalidate();
        //   void cancelAll();
        //   int isInvalid() const;
        //
        ...
        MyAllocator myA;
        btlsc::TimedCbChannelAllocator& a = myA;
        ...
        if (verbose) cout << "\nTesting protocol interface" << endl;
        {
            ...
            btlsc::TimedCbChannelAllocator::Callback myCb(&myCbFn);

            btlsc::TimedCbChannelAllocator::TimedCallback myTimedCb(
                                                                 &myTimedCbFn);
