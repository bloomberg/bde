...
//      // transmission if it was the result of a caller-requested timeout
...
//      const bsls::TimeInterval timeout =
//         bsls::SystemTime::now(bsls::SystemClockType::e_REALTIME) + MAX_TIME;
//
//      // Create a functor.
//
//      using namespace bdlf::PlaceHolders;
...
//                          timeout));          // used to retry if interrupted
//
//      if (0 != channel->timedBufferedRead(sizeof(my_Tick),
//                                          timeout,
//                                          functor,
//                                          btlsc::Flag::k_ASYNC_INTERRUPT)) {
