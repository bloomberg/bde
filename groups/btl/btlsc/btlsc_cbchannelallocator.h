...
//
//@SEE_ALSO: btlsc_channelallocator btemc_cbchannelallocator
//
...
//
// In particular, 'btlsc::CbChannelAllocator' can allocate non-blocking channels
// of type 'btlsc::CbChannel' and 'btlsc::TimedCbChannel', i.e., untimed and
...
//
// The purpose of the 'btlsc::CbChannelAllocator' protocol is to isolate the act
...
// use of the 'btlsc::TimedChannelAllocator' and does not represent
...
// server using just the 'btlsc::CbChannelAllocator' and 'btlsc::TimedCbChannel'
...
//
//      btlsc::TimedCbChannel::TimedCallback     d_allocFunctor;  // reused
//
//    private:
...
//              bdlf::BindUtil::bind( bdlf::MemFnUtil::memFn(&readCb, this)
//                                 , _1, _2, _3
//                                 , clientChannel));
//
...
//
//      bsls::TimeInterval timeout = bdeu::SystemTime::now()
//                                + ACCEPT_TIME_LIMIT;
//
//      // load reusable allocate functor
//      d_allocFunctor = bdlf::BindUtil::bind(
//                                       bdlf::MemFnUtil::memFn(&acceptCb, this)
//                                    , _1, _2
//                                    , timeout);
//
...
//
//      bteso::Ipv4Address address(bteso::Ipv4Address::ANY, portNumber);
//      bteso::InetTimedSocketEventManager sem;    // concrete manager
//      bteso::Tcpipv4StreamSocketFactory sf;      // concrete factory
//      btlsos::TimedCbChannelAcceptor acceptor(address, &sf, &sem);
//
...
//      btesc::TImedCbChannel          *d_input_p;      // incoming packets
...
//  };
//
//  static const bsls::TimeInterval ACCEPT_TIME_LIMIT = 30;  // 30 seconds
//  static const bsls::TimeInterval  WRITE_TIME_LIMIT = 10;  // 10 seconds
//
...
//
//              btlsc::TimedCbChannelAllocator::TimedCallback functor(
//                 bdlf::BindUtil::bind(bdlf::MemFnUtil::memFn(&connectCb, this)
//                                   , _1, _2
//                                   , tick));
//
//              bsls::TimeInterval now = bdes::SystemTime::now();
//
...
//              bdlf::BindUtil::bind( bdlf::MemFnUtil::memFn(&writeCb, this)
//                                 , _1, _2
//                                 , serverChannel
//                                 , msgSize));
//
//          bsls::TimeInterval now = bdeu::SystemTime::now();
//
...
//      d_readFunctor = bdlf::MemFnUtil::memFn(&readCb, this);
//
...
//
//      bteso::Ipv4Address address;
//      btlso::ResolveUtil<bteso::Ipv4Address>::resolve(&address,
//                                                     hostName,
//                                                     portNumber);
//      bteso::Tcpipv4StreamSocketFactory sf;
//      bteso::InetTimedSocketEventManager sem;
//      btlsos::TimedCbChannelConnector connector(address, &sf, &sem);
//
//      my_TickerplantSimulator
...
class CbChannelAllocator
{
  ...
  private:
    CbChannelAllocator&
        operator=(const CbChannelAllocator&); // not implemented
