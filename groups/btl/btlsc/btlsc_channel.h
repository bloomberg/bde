...
//
//@SEE_ALSO: btlsc_timedchannel, btlsc_cbchannel, btlsc_timedchannelallocator,
...
// channel.  The 'btlsc::Channel' protocol supports efficient "buffered"
...
// available to read and write data from and to a 'btlsc::Channel'; note
