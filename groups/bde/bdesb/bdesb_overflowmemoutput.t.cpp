// bdesb_overflowmemoutput.t.cpp -*-C++-*-
...
// protocol that are implemented by the class 'bdesb_OverflowMemOutput', as
// well as each public method in the 'bdesb_OverflowMemOutput' class that is
...
//   A 'bdesb_OverflowMemOutput' is created with a client-supplied C char
...
//
//    o bdesb_OverflowMemOutput(char            *initialBuffer,
//                              int              initialBufferSize,
//                              bslma_Allocator *basicAllocator = 0);
//
// Primary Manipulators:
//   We can bring a 'bdesb_OverflowMemOutput' to any achievable white-box state
...
//   'bdesb_OverflowMemOutput' component has 'dataLength',
...
//
// CREATORS
// [ 3] bdesb_OverflowMemOutput(char            *buffer,
//                              int              size,
//                              bslma_Allocator *basicAllocator = 0);
//
// MANIPULATORS
...
//-----------------------------------------------------------------------------
              ...
              // ======================================
              // operator<< for bdesb_OverflowMemOutput
              // ======================================

// FREE OPERATORS
bsl::ostream& operator<<(bsl::ostream&                  stream,
                         const bdesb_OverflowMemOutput& streamBuffer)
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      case 11: {
        ...
        bslma_TestAllocator ta(veryVeryVerbose);
        {
            ...
            for (int i=0;i<end;i++) {
                ...
                bdesb_OverflowMemOutput sb(bytes, INITIAL_BUFSIZE, &ta);
      ...
      case 10: {
        ...
        //
        // Plan:
        //   Instantiate an 'bdesb_OverflowMemOutput', use 'sputc' to insert a
        ...
        bslma_TestAllocator ta(veryVeryVerbose);
        {
            typedef bdesb_OverflowMemOutput Obj;
      ...
      case 8: {
        ...
        }
        {
            ...
            for (int offset = offsetRangeBeg; offset < offsetRangeEnd;
                                                                offset++) {
                char buffer[INITIAL_BUFSIZE];
                bdesb_OverflowMemOutput mSB(buffer, INITIAL_BUFSIZE, &ta);
      ...
      case 7: {
        ...
        bslma_TestAllocator ta(veryVeryVerbose);
        {
            ...
            for(int i = 0; i < DATA_LEN; ++i ) {
                ...
                bdesb_OverflowMemOutput sb(bytes,
      ...
      case 5: {
        ...
        //
        // Testing:
        //   ostream& operator<<(ostream&, const bdesb_OverflowMemOutput&);
        // --------------------------------------------------------------------
...

        {
            ...
            bdesb_OverflowMemOutput mSB(buffer, INITIAL_BUFSIZE);
            const bdesb_OverflowMemOutput& SB = mSB;
      ...
      case 4: {
        ...
        //
        //   (data and length)
        //   - Create an empty 'bdesb_OverflowMemOutput' and verify its length.
        ...
        if (verbose) cout << "\nTesting sputc." << endl;
        {
            ...
            for (int i = 0; i < DATA_LEN; ++i ) {
                ...
                char buffer[INITIAL_BUFSIZE];
                memset(buffer, 'Z', INITIAL_BUFSIZE);
                bdesb_OverflowMemOutput mSB(buffer,
                                            INITIAL_BUFSIZE - 1,
                                            &ta);
                const bdesb_OverflowMemOutput& SB = mSB;
        ...
        }
        {
            ...
            for(int i = 0; i < DATA_LEN; ++i ) {
                const int LINE      = DATA[i].d_line;
                char *bytes         = new char[DATA[i].d_initSize];
                bdesb_OverflowMemOutput mSB(bytes, DATA[i].d_initSize, &ta);
                const bdesb_OverflowMemOutput& SB = mSB;
        ...
        }
        {
            ...
            char buffer[5];
            memset(buffer, 'X', 5);
            bdesb_OverflowMemOutput x(buffer, 5, &ta);
      ...
      case 3: {
                          ...
                          << endl;
        {
            if (verbose) cout <<
             ...
             char buffer[INITIAL_BUFSIZE];
             memset(buffer, 'Z', INITIAL_BUFSIZE);
             bdesb_OverflowMemOutput mSB(buffer, INITIAL_BUFSIZE - 1, &ta);
             const bdesb_OverflowMemOutput& SB = mSB;
