// bdefu_vfunc9.h                  -*-C++-*-
#ifndef INCLUDED_BDEFU_VFUNC9
#define INCLUDED_BDEFU_VFUNC9

//@PURPOSE: Provide factory methods for populating 9-arg void function objects.
//
//@CLASSES:
//   bdefu_Vfunc9: namespace for factory methods loading 9-arg void functors
//
...
//..
//   bdefu_Vfunc9::makeF:    Initialize the functor by embedding a function.
//
//   bdefu_Vfunc9::makeC:    Initialize the functor by embedding an object, and
//                           one of that object's 'const' methods.
//
//   bdefu_Vfunc9::makeM:    Initialize the functor by embedding THE ADDRESS OF
...
//
//   bdefu_Vfunc9::makeNull: Initialize the functor with an empty function.
//..
...
#ifndef INCLUDED_BDEF_VFUNC9
#include <bdef_vfunc9.h>
#endif
...
struct bdefu_Vfunc9 {
    ...
    static void makeNull(
        bdef_Vfunc9<A1, A2, A3, A4, A5, A6, A7, A8, A9> *handle)
        ...
        // the currently installed default allocator is used.
    {
        ...
        *handle = bdef_Vfunc9<A1, A2, A3, A4, A5, A6, A7, A8, A9>(
            new(*ba) bdefi_Vfunc9Null<A1, A2, A3, A4, A5, A6, A7, A8, A9>(ba));
    }
    ...
    static void makeF(bdef_Vfunc9<A1, A2, A3, A4, A5, A6, A7, A8, A9> *handle,
                      F function)
        // Initialize the specified nine-argument functor 'handle' by
        ...
        // default allocator is used.
    {
        bdema_Allocator *ba = bdema_Default::defaultAllocator();
        *handle = bdef_Vfunc9<A1, A2, A3, A4, A5, A6, A7, A8, A9>(
            new(*ba) bdefi_Vfunc9F9<F, A1, A2, A3, A4, A5, A6, A7, A8, A9>(
                function, ba));
    }
    ...
    static void makeC(bdef_Vfunc9<A1, A2, A3, A4, A5, A6, A7, A8, A9> *handle,
        ...
        // default allocator is used.
    {
        bdema_Allocator *ba = bdema_Default::defaultAllocator();
        *handle = bdef_Vfunc9<A1, A2, A3, A4, A5, A6, A7, A8, A9>(
           new(*ba) bdefi_Vfunc9C9<OBJ, C, A1, A2, A3, A4, A5, A6, A7, A8, A9>(
                object, method, ba));
    }
    ...
    template <class OBJ, class M, class A1, class A2, class A3, class A4,
              class A5, class A6, class A7, class A8, class A9>
    static void makeM(bdef_Vfunc9<A1, A2, A3, A4, A5, A6, A7, A8, A9> *handle,
                      OBJ                                     *object,
                      M                                        method)
        // Initialize the specified nine-argument functor 'handle' by
        ...
        // default allocator is used.
    {
        bdema_Allocator *ba = bdema_Default::defaultAllocator();
        *handle = bdef_Vfunc9<A1, A2, A3, A4, A5, A6, A7, A8, A9>(
           new(*ba) bdefi_Vfunc9M9<OBJ, M, A1, A2, A3, A4, A5, A6, A7, A8, A9>(
                object, method, ba));
    }
