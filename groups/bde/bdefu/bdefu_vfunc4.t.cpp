...
//
//-----------------------------------------------------------------------------
// [ 9] makeF(         bdef_Vfunc4<A1-4> *,       F, c_D1-5&);
// [ 9] makeC(         bdef_Vfunc4<A1-4> *, c_O&, C, c_D1-5&);
// [ 9] makeM(         bdef_Vfunc4<A1-4> *, OBJ*, M, c_D1-5&);
// [ 9] makeF(   bA *, bdef_Vfunc4<A1-4> *,       F, c_D1-5&);
// [ 9] makeC(   bA *, bdef_Vfunc4<A1-4> *, c_O&, C, c_D1-5&);
// [ 9] makeM(   bA *, bdef_Vfunc4<A1-4> *, OBJ*, M, c_D1-5&);
// [ 8] makeF(         bdef_Vfunc4<A1-4> *,       F, c_D1-4&);
// [ 8] makeC(         bdef_Vfunc4<A1-4> *, c_O&, C, c_D1-4&);
// [ 8] makeM(         bdef_Vfunc4<A1-4> *, OBJ*, M, c_D1-4&);
// [ 8] makeF(   bA *, bdef_Vfunc4<A1-4> *,       F, c_D1-4&);
// [ 8] makeC(   bA *, bdef_Vfunc4<A1-4> *, c_O&, C, c_D1-4&);
// [ 8] makeM(   bA *, bdef_Vfunc4<A1-4> *, OBJ*, M, c_D1-4&);
// [ 7] makeF(         bdef_Vfunc4<A1-4> *,       F, c_D1-3&);
// [ 7] makeC(         bdef_Vfunc4<A1-4> *, c_O&, C, c_D1-3&);
// [ 7] makeM(         bdef_Vfunc4<A1-4> *, OBJ*, M, c_D1-3&);
// [ 7] makeF(   bA *, bdef_Vfunc4<A1-4> *,       F, c_D1-3&);
// [ 7] makeC(   bA *, bdef_Vfunc4<A1-4> *, c_O&, C, c_D1-3&);
// [ 7] makeM(   bA *, bdef_Vfunc4<A1-4> *, OBJ*, M, c_D1-3&);
// [ 6] makeF(         bdef_Vfunc4<A1-4> *,       F, c_D1-2&);
// [ 6] makeC(         bdef_Vfunc4<A1-4> *, c_O&, C, c_D1-2&);
// [ 6] makeM(         bdef_Vfunc4<A1-4> *, OBJ*, M, c_D1-2&);
// [ 6] makeF(   bA *, bdef_Vfunc4<A1-4> *,       F, c_D1-2&);
// [ 6] makeC(   bA *, bdef_Vfunc4<A1-4> *, c_O&, C, c_D1-2&);
// [ 6] makeM(   bA *, bdef_Vfunc4<A1-4> *, OBJ*, M, c_D1-2&);
// [ 5] makeF(         bdef_Vfunc4<A1-4> *,       F, c_D1&);
// [ 5] makeC(         bdef_Vfunc4<A1-4> *, c_O&, C, c_D1&);
// [ 5] makeM(         bdef_Vfunc4<A1-4> *, OBJ*, M, c_D1&);
// [ 5] makeF(   bA *, bdef_Vfunc4<A1-4> *,       F, c_D1&);
// [ 5] makeC(   bA *, bdef_Vfunc4<A1-4> *, c_O&, C, c_D1&);
// [ 5] makeM(   bA *, bdef_Vfunc4<A1-4> *, OBJ*, M, c_D1&);
// [ 4] makeF(         bdef_Vfunc4<A1-4> *,       F);
// [ 4] makeC(         bdef_Vfunc4<A1-4> *, c_O&, C);
// [ 4] makeM(         bdef_Vfunc4<A1-4> *, OBJ*, M);
// [ 4] makeF(   bA *, bdef_Vfunc4<A1-4> *,       F);
// [ 4] makeC(   bA *, bdef_Vfunc4<A1-4> *, c_O&, C);
// [ 4] makeM(   bA *, bdef_Vfunc4<A1-4> *, OBJ*, M);
// [ 4] makeNull(      bdef_Vfunc4<A1-4> *);
// [ 4] makeNull(bA *, bdef_Vfunc4<A1-4> *);
//-----------------------------------------------------------------------------
...
//       // that 'bdefi_vfunc4X4' classes pass when calling the callback
//       // function.
//       //
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      case 9: {
        ...
        //
        // Plan:
        //   Use each function to initialize a separate 'bdef_Vfunc4' object
        //   with the 'checkArgumentValues' function, which verifies that the
        //   parameters are "wired" correctly.  Use each function to
        //   initialize 'bdef_Vfunc4' object with the 'checkParameterTypes'
        ...
        //
        // Testing:
        //    makeF(      bdef_Vfunc4<A1-4> *,        F, c_D1-5&);
        //    makeC(      bdef_Vfunc4<A1-4> *, c_O&,  C, c_D1-5&);
        //    makeM(      bdef_Vfunc4<A1-4> *, OBJ *, M, c_D1-5&);
        //    makeF(bA *, bdef_Vfunc4<A1-4> *,        F, c_D1-5&);
        //    makeC(bA *, bdef_Vfunc4<A1-4> *, c_O&,  C, c_D1-5&);
        //    makeM(bA *, bdef_Vfunc4<A1-4> *, OBJ *, M, c_D1-5&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdef_Vfunc4<int *, int *, int *, int *> x1;
                bdefu_Vfunc4::makeF(&x1, checkArgumentValues9,
                                    &a5, &a6, &a7, &a8, &a9);
                x1(&a1, &a2, &a3, &a4);
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            if (verbose) cout << "Testing 'makeF'" << endl;
            {
                bdef_Vfunc4<T1, T2, T3, T4> x1;
                bdefu_Vfunc4::makeF(&x1, checkParameterTypes9,
                                    a5, a6, a7, a8, a9);
                x1(a1, a2, a3, a4);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdef_Vfunc4<int *, int *, int *, int *> x1;
                bdefu_Vfunc4::makeF(&ta, &x1, checkArgumentValues9,
                                    &a5, &a6, &a7, &a8, &a9);
                x1(&a1, &a2, &a3, &a4);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            {
                bdef_Vfunc4<int *, int *, int *, int *> x1;
                bdefu_Vfunc4::makeC(&ta, &x1, cbObj,
                                    &CbClass::checkArgumentValues9,
                                    &a5, &a6, &a7, &a8, &a9);
                x1(&a1, &a2, &a3, &a4);
                ASSERT(ARG1_PLUS1 == a1);
            ...
            {
                bdef_Vfunc4<int *, int *, int *, int *> x1;
                bdefu_Vfunc4::makeM(&ta, &x1, &cbObj,
                                    &CbClass::checkArgumentValues9,
                                    &a5, &a6, &a7, &a8, &a9);
                x1(&a1, &a2, &a3, &a4);
                ASSERT(ARG1_PLUS1 == a1);
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdef_Vfunc4<T1, T2, T3, T4> x1;
                bdefu_Vfunc4::makeF(&ta, &x1, checkParameterTypes9,
                                    a5, a6, a7, a8, a9);
                x1(a1, a2, a3, a4);
            }
      ...
      case 8: {
        ...
        //
        // Testing:
        //    makeF(      bdef_Vfunc4<A1-4> *,        F, c_D1-4&);
        //    makeC(      bdef_Vfunc4<A1-4> *, c_O&,  C, c_D1-4&);
        //    makeM(      bdef_Vfunc4<A1-4> *, OBJ *, M, c_D1-4&);
        //    makeF(bA *, bdef_Vfunc4<A1-4> *,        F, c_D1-4&);
        //    makeC(bA *, bdef_Vfunc4<A1-4> *, c_O&,  C, c_D1-4&);
        //    makeM(bA *, bdef_Vfunc4<A1-4> *, OBJ *, M, c_D1-4&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdef_Vfunc4<int *, int *, int *, int *> x1;
                bdefu_Vfunc4::makeF(&x1, checkArgumentValues8,
                                    &a5, &a6, &a7, &a8);
                x1(&a1, &a2, &a3, &a4);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdef_Vfunc4<T1, T2, T3, T4> x1;
                bdefu_Vfunc4::makeF(&x1, checkParameterTypes8,
                                    a5, a6, a7, a8);
                x1(a1, a2, a3, a4);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdef_Vfunc4<int *, int *, int *, int *> x1;
                bdefu_Vfunc4::makeF(&ta, &x1, checkArgumentValues8,
                                    &a5, &a6, &a7, &a8);
                x1(&a1, &a2, &a3, &a4);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdef_Vfunc4<T1, T2, T3, T4> x1;
                bdefu_Vfunc4::makeF(&ta, &x1, checkParameterTypes8,
                                    a5, a6, a7, a8);
                x1(a1, a2, a3, a4);
            }
      ...
      case 7: {
        ...
        //
        // Testing:
        //    makeF(      bdef_Vfunc4<A1-4> *,        F, c_D1-3&);
        //    makeC(      bdef_Vfunc4<A1-4> *, c_O&,  C, c_D1-3&);
        //    makeM(      bdef_Vfunc4<A1-4> *, OBJ *, M, c_D1-3&);
        //    makeF(bA *, bdef_Vfunc4<A1-4> *,        F, c_D1-3&);
        //    makeC(bA *, bdef_Vfunc4<A1-4> *, c_O&,  C, c_D1-3&);
        //    makeM(bA *, bdef_Vfunc4<A1-4> *, OBJ *, M, c_D1-3&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdef_Vfunc4<int *, int *, int *, int *> x1;
                bdefu_Vfunc4::makeF(&x1, checkArgumentValues7,
                                    &a5, &a6, &a7);
                x1(&a1, &a2, &a3, &a4);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdef_Vfunc4<T1, T2, T3, T4> x1;
                bdefu_Vfunc4::makeF(&x1, checkParameterTypes7,
                                    a5, a6, a7);
                x1(a1, a2, a3, a4);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdef_Vfunc4<int *, int *, int *, int *> x1;
                bdefu_Vfunc4::makeF(&ta, &x1, checkArgumentValues7,
                                    &a5, &a6, &a7);
                x1(&a1, &a2, &a3, &a4);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdef_Vfunc4<T1, T2, T3, T4> x1;
                bdefu_Vfunc4::makeF(&ta, &x1, checkParameterTypes7,
                                    a5, a6, a7);
                x1(a1, a2, a3, a4);
            }
      ...
      case 6: {
        ...
        //
        // Testing:
        //    makeF(      bdef_Vfunc4<A1-4> *,        F, c_D1-2&);
        //    makeC(      bdef_Vfunc4<A1-4> *, c_O&,  C, c_D1-2&);
        //    makeM(      bdef_Vfunc4<A1-4> *, OBJ *, M, c_D1-2&);
        //    makeF(bA *, bdef_Vfunc4<A1-4> *,        F, c_D1-2&);
        //    makeC(bA *, bdef_Vfunc4<A1-4> *, c_O&,  C, c_D1-2&);
        //    makeM(bA *, bdef_Vfunc4<A1-4> *, OBJ *, M, c_D1-2&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdef_Vfunc4<int *, int *, int *, int *> x1;
                bdefu_Vfunc4::makeF(&x1, checkArgumentValues6,
                                    &a5, &a6);
                x1(&a1, &a2, &a3, &a4);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdef_Vfunc4<T1, T2, T3, T4> x1;
                bdefu_Vfunc4::makeF(&x1, checkParameterTypes6,
                                    a5, a6);
                x1(a1, a2, a3, a4);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdef_Vfunc4<int *, int *, int *, int *> x1;
                bdefu_Vfunc4::makeF(&ta, &x1, checkArgumentValues6,
                                    &a5, &a6);
                x1(&a1, &a2, &a3, &a4);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdef_Vfunc4<T1, T2, T3, T4> x1;
                bdefu_Vfunc4::makeF(&ta, &x1, checkParameterTypes6,
                                    a5, a6);
                x1(a1, a2, a3, a4);
            }
      ...
      case 5: {
        ...
        //
        // Testing:
        //    makeF(      bdef_Vfunc4<A1-4> *,        F, c_D1&);
        //    makeC(      bdef_Vfunc4<A1-4> *, c_O&,  C, c_D1&);
        //    makeM(      bdef_Vfunc4<A1-4> *, OBJ *, M, c_D1&);
        //    makeF(bA *, bdef_Vfunc4<A1-4> *,        F, c_D1&);
        //    makeC(bA *, bdef_Vfunc4<A1-4> *, c_O&,  C, c_D1&);
        //    makeM(bA *, bdef_Vfunc4<A1-4> *, OBJ *, M, c_D1&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdef_Vfunc4<int *, int *, int *, int *> x1;
                bdefu_Vfunc4::makeF(&x1, checkArgumentValues5, &a5);
                x1(&a1, &a2, &a3, &a4);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            }
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdef_Vfunc4<T1, T2, T3, T4> x1;
                bdefu_Vfunc4::makeF(&x1, checkParameterTypes5, a5);
                x1(a1, a2, a3, a4);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdef_Vfunc4<int *, int *, int *, int *> x1;
                bdefu_Vfunc4::makeF(&ta, &x1, checkArgumentValues5, &a5);
                x1(&a1, &a2, &a3, &a4);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdef_Vfunc4<T1, T2, T3, T4> x1;
                bdefu_Vfunc4::makeF(&ta, &x1, checkParameterTypes5, a5);
                x1(a1, a2, a3, a4);
            }
      ...
      case 4: {
        ...
        //
        // Testing:
        //    makeF(         bdef_Vfunc4<A1-4> *,        F);
        //    makeC(         bdef_Vfunc4<A1-4> *, c_O&,  C);
        //    makeM(         bdef_Vfunc4<A1-4> *, OBJ *, M);
        //    makeNull(      bdef_Vfunc4<A1-4> *);
        //    makeF(   bA *, bdef_Vfunc4<A1-4> *,        F);
        //    makeC(   bA *, bdef_Vfunc4<A1-4> *, c_O&,  C);
        //    makeM(   bA *, bdef_Vfunc4<A1-4> *, OBJ *, M);
        //    makeNull(bA *, bdef_Vfunc4<A1-4> *);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdef_Vfunc4<int *, int *, int *, int *> x1;
                bdefu_Vfunc4::makeF(&x1, checkArgumentValues4);
                x1(&a1, &a2, &a3, &a4);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            }
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdef_Vfunc4<T1, T2, T3, T4> x1;
                bdefu_Vfunc4::makeF(&x1, checkParameterTypes4);
                x1(a1, a2, a3, a4);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdef_Vfunc4<int *, int *, int *, int *> x1;
                bdefu_Vfunc4::makeF(&ta, &x1, checkArgumentValues4);
                x1(&a1, &a2, &a3, &a4);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdef_Vfunc4<T1, T2, T3, T4> x1;
                bdefu_Vfunc4::makeF(&ta, &x1, checkParameterTypes4);
                x1(a1, a2, a3, a4);
            }
