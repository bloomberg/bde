// bdefu_vfunc8.t.cpp              -*-C++-*-

#include <bdefu_vfunc8.h>
...
//
//-----------------------------------------------------------------------------
// [ 9] makeF(         bdef_Vfunc8<A1-8> *,       F, c_D1&);
// [ 9] makeC(         bdef_Vfunc8<A1-8> *, c_O&, C, c_D1&);
// [ 9] makeM(         bdef_Vfunc8<A1-8> *, OBJ*, M, c_D1&);
// [ 9] makeF(   bA *, bdef_Vfunc8<A1-8> *,       F, c_D1&);
// [ 9] makeC(   bA *, bdef_Vfunc8<A1-8> *, c_O&, C, c_D1&);
// [ 9] makeM(   bA *, bdef_Vfunc8<A1-8> *, OBJ*, M, c_D1&);
// [ 8] makeF(         bdef_Vfunc8<A1-8> *,       F);
// [ 8] makeC(         bdef_Vfunc8<A1-8> *, c_O&, C);
// [ 8] makeM(         bdef_Vfunc8<A1-8> *, OBJ*, M);
// [ 8] makeF(   bA *, bdef_Vfunc8<A1-8> *,       F);
// [ 8] makeC(   bA *, bdef_Vfunc8<A1-8> *, c_O&, C);
// [ 8] makeM(   bA *, bdef_Vfunc8<A1-8> *, OBJ*, M);
// [ 8] makeNull(      bdef_Vfunc8<A1-8> *);
// [ 8] makeNull(bA *, bdef_Vfunc8<A1-8> *);
//-----------------------------------------------------------------------------
...
class CbClass {
  public:
    void checkVfunc8ExecutionC() const
    {
        ++a0_global;
    }

    void checkVfunc8ExecutionM() const
    {
        ++a0_global;
    }
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      case 9: {
        ...
        //
        // Plan:
        //   Use each function to initialize a separate 'bdef_Vfunc8' object
        //   with the 'checkArgumentValues' function, which verifies that the
        //   parameters are "wired" correctly.  Use each function to
        //   initialize 'bdef_Vfunc8' object with the 'checkParameterTypes'
        ...
        //
        // Testing:
        //    makeF(      bdef_Vfunc8<A1-8> *,        F, c_D1&);
        //    makeC(      bdef_Vfunc8<A1-8> *, c_O&,  C, c_D1&);
        //    makeM(      bdef_Vfunc8<A1-8> *, OBJ *, M, c_D1&);
        //    makeF(bA *, bdef_Vfunc8<A1-8> *,        F, c_D1&);
        //    makeC(bA *, bdef_Vfunc8<A1-8> *, c_O&,  C, c_D1&);
        //    makeM(bA *, bdef_Vfunc8<A1-8> *, OBJ *, M, c_D1&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdef_Vfunc8<int *, int *, int *, int *, int *, int *,
                            int *, int *> x1;
                bdefu_Vfunc8::makeF(&x1, checkArgumentValues9, &a9);
                x1(&a1, &a2, &a3, &a4, &a5, &a6, &a7, &a8);
            ...
            if (verbose) cout << "Testing 'makeC'" << endl;
            {
                bdef_Vfunc8<int *, int *, int *, int *, int *, int *,
                            int *, int *> x1;
                bdefu_Vfunc8::makeC(&x1, cbObj,
                                    &CbClass::checkArgumentValues9, &a9);
                x1(&a1, &a2, &a3, &a4, &a5, &a6, &a7, &a8);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            }
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            if (verbose) cout << "Testing 'makeF'" << endl;
            {
                bdef_Vfunc8<T1, T2, T3, T4, T5, T6, T7, T8> x1;
                bdefu_Vfunc8::makeF(&x1, checkParameterTypes9, a9);
                x1(a1, a2, a3, a4, a5, a6, a7, a8);
            }
            ...
            if (verbose) cout << "Testing 'makeC'" << endl;
            {
                ...
                CbClass cbObj;
                bdefu_Vfunc8::makeC(&x1, cbObj,
                                    &CbClass::checkParameterTypesC9, a9);
                x1(a1, a2, a3, a4, a5, a6, a7, a8);
            }
            ...
            if (verbose) cout << "Testing 'makeM'" << endl;
            {
                ...
                CbClass cbObj;
                bdefu_Vfunc8::makeM(&x1, &cbObj,
                                     &CbClass::checkParameterTypesM9, a9);
                x1(a1, a2, a3, a4, a5, a6, a7, a8);
            }
        }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            if (verbose) cout << "Testing 'makeF'" << endl;
            {
                bdef_Vfunc8<int *, int *, int *, int *, int *, int *,
                            int *, int *> x1;
                bdefu_Vfunc8::makeF(&ta, &x1, checkArgumentValues9, &a9);
                x1(&a1, &a2, &a3, &a4, &a5, &a6, &a7, &a8);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            if (verbose) cout << "Testing 'makeC'" << endl;
            {
                bdef_Vfunc8<int *, int *, int *, int *, int *, int *,
                            int *, int *> x1;
                bdefu_Vfunc8::makeC(&ta, &x1, cbObj,
                                    &CbClass::checkArgumentValues9, &a9);
                x1(&a1, &a2, &a3, &a4, &a5, &a6, &a7, &a8);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            if (verbose) cout << "Testing 'makeM'" << endl;
            {
                bdef_Vfunc8<int *, int *, int *, int *, int *, int *,
                            int *, int *> x1;
                bdefu_Vfunc8::makeM(&ta, &x1, &cbObj,
                                    &CbClass::checkArgumentValues9, &a9);
                x1(&a1, &a2, &a3, &a4, &a5, &a6, &a7, &a8);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdef_Vfunc8<T1, T2, T3, T4, T5, T6, T7, T8> x1;
                bdefu_Vfunc8::makeF(&ta, &x1, checkParameterTypes9, a9);
                x1(a1, a2, a3, a4, a5, a6, a7, a8);
            }
      ...
      case 8: {
        ...
        //
        // Testing:
        //    makeF(         bdef_Vfunc8<A1-8> *,        F);
        //    makeC(         bdef_Vfunc8<A1-8> *, c_O&,  C);
        //    makeM(         bdef_Vfunc8<A1-8> *, OBJ *, M);
        //    makeNull(      bdef_Vfunc8<A1-8> *);
        //    makeF(   bA *, bdef_Vfunc8<A1-8> *,        F);
        //    makeC(   bA *, bdef_Vfunc8<A1-8> *, c_O&,  C);
        //    makeM(   bA *, bdef_Vfunc8<A1-8> *, OBJ *, M);
        //    makeNull(bA *, bdef_Vfunc8<A1-8> *);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            if (verbose) cout << "Testing 'makeF'" << endl;
            {
                bdef_Vfunc8<int *, int *, int *, int *, int *, int *,
                            int *, int *> x1;
                bdefu_Vfunc8::makeF(&x1, checkArgumentValues8);
                x1(&a1, &a2, &a3, &a4, &a5, &a6, &a7, &a8);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            }
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdef_Vfunc8<T1, T2, T3, T4, T5, T6, T7, T8> x1;
                bdefu_Vfunc8::makeF(&x1, checkParameterTypes8);
                x1(a1, a2, a3, a4, a5, a6, a7, a8);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            if (verbose) cout << "Testing 'makeF'" << endl;
            {
                bdef_Vfunc8<int *, int *, int *, int *, int *, int *,
                            int *, int *> x1;
                bdefu_Vfunc8::makeF(&ta, &x1, checkArgumentValues8);
                x1(&a1, &a2, &a3, &a4, &a5, &a6, &a7, &a8);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdef_Vfunc8<T1, T2, T3, T4, T5, T6, T7, T8> x1;
                bdefu_Vfunc8::makeF(&ta, &x1, checkParameterTypes8);
                x1(a1, a2, a3, a4, a5, a6, a7, a8);
            }
