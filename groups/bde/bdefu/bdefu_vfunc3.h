// bdefu_vfunc3.h                  -*-C++-*-
#ifndef INCLUDED_BDEFU_VFUNC3
#define INCLUDED_BDEFU_VFUNC3
...
//..
//   bdefu_Vfunc3::makeF:    Initialize the functor by embedding a function
//                           (or another functor) and any additional trailing
//                           arguments.
//
//   bdefu_Vfunc3::makeC:    Initialize the functor by embedding an object, one
//                           of that object's 'const' methods, and any
//                           additional trailing arguments for that method.
//
//   bdefu_Vfunc3::makeM:    Initialize the functor by embedding THE ADDRESS OF
...
//
//   bdefu_Vfunc3::makeNull: Initialize the functor with an empty function.
//..
...
struct bdefu_Vfunc3 {
    ...
    static void makeNull(bdef_Vfunc3<A1, A2, A3> *handle)
    ...
    static void makeF(bdef_Vfunc3<A1, A2, A3> *handle, F function)
    ...
    static void makeF(bdef_Vfunc3<A1, A2, A3> *handle,
                      F                function,
    ...
    static void makeC(bdef_Vfunc3<A1, A2, A3> *handle, const OBJ& object,
                      C                method)
        // Initialize the specified three-argument functor 'handle' by
        // embedding the specified 'function' (or functor) taking no
        // additional trailing arguments.  Optionally specify, as the *first*
    ...
    static void makeC(bdef_Vfunc3<A1, A2, A3> *handle,
                      const OBJ&       object,
                      C                method,
                      const D1&        embeddedArg1)
        // Initialize the specified three-argument functor 'handle' by
    ...
    static void makeM(bdef_Vfunc3<A1, A2, A3> *handle, OBJ *object,
                      M                method)
        // Initialize the specified three-argument functor 'handle' by
    ...
    static void makeM(bdef_Vfunc3<A1, A2, A3> *handle,
                      OBJ             *object,
                      M                method,
                      const D1&        embeddedArg1)
        // Initialize the specified three-argument functor 'handle' by
