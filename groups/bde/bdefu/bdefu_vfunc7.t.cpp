// bdefu_vfunc7.t.cpp              -*-C++-*-

#include <bdefu_vfunc7.h>
...
//
//-----------------------------------------------------------------------------
// [ 9] makeF(         bdef_Vfunc7<A1-7> *,       F, c_D1-2&);
// [ 9] makeC(         bdef_Vfunc7<A1-7> *, c_O&, C, c_D1-2&);
// [ 9] makeM(         bdef_Vfunc7<A1-7> *, OBJ*, M, c_D1-2&);
// [ 9] makeF(   bA *, bdef_Vfunc7<A1-7> *,       F, c_D1-2&);
// [ 9] makeC(   bA *, bdef_Vfunc7<A1-7> *, c_O&, C, c_D1-2&);
// [ 9] makeM(   bA *, bdef_Vfunc7<A1-7> *, OBJ*, M, c_D1-2&);
// [ 8] makeF(         bdef_Vfunc7<A1-7> *,       F, c_D1&);
// [ 8] makeC(         bdef_Vfunc7<A1-7> *, c_O&, C, c_D1&);
// [ 8] makeM(         bdef_Vfunc7<A1-7> *, OBJ*, M, c_D1&);
// [ 8] makeF(   bA *, bdef_Vfunc7<A1-7> *,       F, c_D1&);
// [ 8] makeC(   bA *, bdef_Vfunc7<A1-7> *, c_O&, C, c_D1&);
// [ 8] makeM(   bA *, bdef_Vfunc7<A1-7> *, OBJ*, M, c_D1&);
// [ 7] makeF(         bdef_Vfunc7<A1-7> *,       F);
// [ 7] makeC(         bdef_Vfunc7<A1-7> *, c_O&, C);
// [ 7] makeM(         bdef_Vfunc7<A1-7> *, OBJ*, M);
// [ 7] makeF(   bA *, bdef_Vfunc7<A1-7> *,       F);
// [ 7] makeC(   bA *, bdef_Vfunc7<A1-7> *, c_O&, C);
// [ 7] makeM(   bA *, bdef_Vfunc7<A1-7> *, OBJ*, M);
// [ 7] makeNull(      bdef_Vfunc7<A1-7> *);
// [ 7] makeNull(bA *, bdef_Vfunc7<A1-7> *);
//-----------------------------------------------------------------------------
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      case 9: {
        ...
        //
        // Plan:
        //   Use each function to initialize a separate 'bdef_Vfunc7' object
        //   with the 'checkArgumentValues' function, which verifies that the
        //   parameters are "wired" correctly.  Use each function to
        //   initialize 'bdef_Vfunc7' object with the 'checkParameterTypes'
        ...
        //
        // Testing:
        //    makeF(      bdef_Vfunc7<A1-7> *,        F, c_D1-2&);
        //    makeC(      bdef_Vfunc7<A1-7> *, c_O&,  C, c_D1-2&);
        //    makeM(      bdef_Vfunc7<A1-7> *, OBJ *, M, c_D1-2&);
        //    makeF(bA *, bdef_Vfunc7<A1-7> *,        F, c_D1-2&);
        //    makeC(bA *, bdef_Vfunc7<A1-7> *, c_O&,  C, c_D1-2&);
        //    makeM(bA *, bdef_Vfunc7<A1-7> *, OBJ *, M, c_D1-2&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdef_Vfunc7<int *, int *, int *, int *, int *, int *,
                            int *> x1;
                bdefu_Vfunc7::makeF(&x1, checkArgumentValues9, &a8, &a9);
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            if (verbose) cout << "Testing 'makeF'" << endl;
            {
                bdef_Vfunc7<T1, T2, T3, T4, T5, T6, T7> x1;
                bdefu_Vfunc7::makeF(&x1, checkParameterTypes9, a8, a9);
                x1(a1, a2, a3, a4, a5, a6, a7);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            if (verbose) cout << "Testing 'makeF'" << endl;
            {
                bdef_Vfunc7<int *, int *, int *, int *, int *, int *,
                            int *> x1;
                bdefu_Vfunc7::makeF(&ta, &x1, checkArgumentValues9, &a8, &a9);
                x1(&a1, &a2, &a3, &a4, &a5, &a6, &a7);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            if (verbose) cout << "Testing 'makeC'" << endl;
            {
                bdef_Vfunc7<int *, int *, int *, int *, int *, int *,
                            int *> x1;
                bdefu_Vfunc7::makeC(&ta, &x1, cbObj,
                                    &CbClass::checkArgumentValues9, &a8, &a9);
                x1(&a1, &a2, &a3, &a4, &a5, &a6, &a7);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            if (verbose) cout << "Testing 'makeM'" << endl;
            {
                bdef_Vfunc7<int *, int *, int *, int *, int *, int *,
                            int *> x1;
                bdefu_Vfunc7::makeM(&ta, &x1, &cbObj,
                                    &CbClass::checkArgumentValues9, &a8, &a9);
                x1(&a1, &a2, &a3, &a4, &a5, &a6, &a7);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdef_Vfunc7<T1, T2, T3, T4, T5, T6, T7> x1;
                bdefu_Vfunc7::makeF(&ta, &x1, checkParameterTypes9, a8, a9);
                x1(a1, a2, a3, a4, a5, a6, a7);
            }
      ...
      case 8: {
        ...
        //
        // Testing:
        //    makeF(      bdef_Vfunc7<A1-7> *,        F, c_D1&);
        //    makeC(      bdef_Vfunc7<A1-7> *, c_O&,  C, c_D1&);
        //    makeM(      bdef_Vfunc7<A1-7> *, OBJ *, M, c_D1&);
        //    makeF(bA *, bdef_Vfunc7<A1-7> *,        F, c_D1&);
        //    makeC(bA *, bdef_Vfunc7<A1-7> *, c_O&,  C, c_D1&);
        //    makeM(bA *, bdef_Vfunc7<A1-7> *, OBJ *, M, c_D1&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            if (verbose) cout << "Testing 'makeF'" << endl;
            {
                bdef_Vfunc7<int *, int *, int *, int *, int *, int *,
                            int *> x1;
                bdefu_Vfunc7::makeF(&x1, checkArgumentValues8, &a8);
                x1(&a1, &a2, &a3, &a4, &a5, &a6, &a7);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            }
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdef_Vfunc7<T1, T2, T3, T4, T5, T6, T7> x1;
                bdefu_Vfunc7::makeF(&x1, checkParameterTypes8, a8);
                x1(a1, a2, a3, a4, a5, a6, a7);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            if (verbose) cout << "Testing 'makeF'" << endl;
            {
                bdef_Vfunc7<int *, int *, int *, int *, int *, int *,
                            int *> x1;
                bdefu_Vfunc7::makeF(&ta, &x1, checkArgumentValues8, &a8);
                x1(&a1, &a2, &a3, &a4, &a5, &a6, &a7);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdef_Vfunc7<T1, T2, T3, T4, T5, T6, T7> x1;
                bdefu_Vfunc7::makeF(&ta, &x1, checkParameterTypes8, a8);
                x1(a1, a2, a3, a4, a5, a6, a7);
            }
      ...
      case 7: {
        ...
        //
        // Testing:
        //    makeF(         bdef_Vfunc7<A1-7> *,        F);
        //    makeC(         bdef_Vfunc7<A1-7> *, c_O&,  C);
        //    makeM(         bdef_Vfunc7<A1-7> *, OBJ *, M);
        //    makeNull(      bdef_Vfunc7<A1-7> *);
        //    makeF(   bA *, bdef_Vfunc7<A1-7> *,        F);
        //    makeC(   bA *, bdef_Vfunc7<A1-7> *, c_O&,  C);
        //    makeM(   bA *, bdef_Vfunc7<A1-7> *, OBJ *, M);
        //    makeNull(bA *, bdef_Vfunc7<A1-7> *);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            if (verbose) cout << "Testing 'makeF'" << endl;
            {
                bdef_Vfunc7<int *, int *, int *, int *, int *, int *,
                            int *> x1;
                bdefu_Vfunc7::makeF(&x1, checkArgumentValues7);
                x1(&a1, &a2, &a3, &a4, &a5, &a6, &a7);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            }
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdef_Vfunc7<T1, T2, T3, T4, T5, T6, T7> x1;
                bdefu_Vfunc7::makeF(&x1, checkParameterTypes7);
                x1(a1, a2, a3, a4, a5, a6, a7);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            if (verbose) cout << "Testing 'makeF'" << endl;
            {
                bdef_Vfunc7<int *, int *, int *, int *, int *, int *,
                            int *> x1;
                bdefu_Vfunc7::makeF(&ta, &x1, checkArgumentValues7);
                x1(&a1, &a2, &a3, &a4, &a5, &a6, &a7);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdef_Vfunc7<T1, T2, T3, T4, T5, T6, T7> x1;
                bdefu_Vfunc7::makeF(&ta, &x1, checkParameterTypes7);
                x1(a1, a2, a3, a4, a5, a6, a7);
            }
