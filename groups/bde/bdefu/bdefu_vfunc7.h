// bdefu_vfunc7.h                  -*-C++-*-
#ifndef INCLUDED_BDEFU_VFUNC7
#define INCLUDED_BDEFU_VFUNC7

//@PURPOSE: Provide factory methods for populating 7-arg void function objects.
//
//@CLASSES:
//   bdefu_Vfunc7: namespace for factory methods loading 7-arg void functors
//
...
//..
//   bdefu_Vfunc7::makeF:    Initialize the functor by embedding a function
//                           (or another functor) and any additional trailing
//                           arguments.
//
//   bdefu_Vfunc7::makeC:    Initialize the functor by embedding an object, one
//                           of that object's 'const' methods, and any
//                           additional trailing arguments for that method.
//
//   bdefu_Vfunc7::makeM:    Initialize the functor by embedding THE ADDRESS OF
...
//
//   bdefu_Vfunc7::makeNull: Initialize the functor with an empty function.
//..
...
#ifndef INCLUDED_BDEF_VFUNC7
#include <bdef_vfunc7.h>
#endif

#ifndef INCLUDED_BDEFI_VFUNC7
#include <bdefi_vfunc7.h>
#endif
...
struct bdefu_Vfunc7 {
    ...
    template <class A1, class A2, class A3, class A4, class A5, class A6,
              class A7>
    static void makeNull(bdef_Vfunc7<A1, A2, A3, A4, A5, A6, A7> *handle)
        ...
        // the currently installed default allocator is used.
    {
        ...
        *handle = bdef_Vfunc7<A1, A2, A3, A4, A5, A6, A7>(
            new(*ba) bdefi_Vfunc7Null<A1, A2, A3, A4, A5, A6, A7>(ba));
    }

    template <class A1, class A2, class A3, class A4, class A5, class A6,
              class A7>
    static void makeNull(bdema_Allocator *basicAllocator,
                         bdef_Vfunc7<A1, A2, A3, A4, A5, A6, A7> *handle)
        // Initialize the specified seven-argument empty functor 'handle'.
        // Optionally specify, as the *first* argument, a 'basicAllocator'
        // used to supply memory.  If 'basicAllocator' is 0 or unspecified,
        // the currently installed default allocator is used.
    ...
    template <class F, class A1, class A2, class A3, class A4, class A5,
              class A6, class A7>
    static void makeF(bdef_Vfunc7<A1, A2, A3, A4, A5, A6, A7> *handle,
                      F function)
        ...
        // default allocator is used.
    {
        bdema_Allocator *ba = bdema_Default::defaultAllocator();
        *handle = bdef_Vfunc7<A1, A2, A3, A4, A5, A6, A7>(
            new(*ba) bdefi_Vfunc7F7<F, A1, A2, A3, A4, A5, A6, A7>(
                function, ba));
    }
        ...
        // or unspecified, the currently installed default allocator is used.
    {
        bdema_Allocator *ba = bdema_Default::defaultAllocator();
        *handle = bdef_Vfunc7<A1, A2, A3, A4, A5, A6, A7>(
            new(*ba) bdefi_Vfunc7F8<F, A1, A2, A3, A4, A5, A6, A7, D1> (
        ...
        // or unspecified, the currently installed default allocator is used.
    {
        ...
        *handle = bdef_Vfunc7<A1, A2, A3, A4, A5, A6, A7>(
            new(*ba) bdefi_Vfunc7F9<F, A1, A2, A3, A4, A5, A6, A7, D1, D2>
    ...
    static void makeC(bdef_Vfunc7<A1, A2, A3, A4, A5, A6, A7> *handle,
        ...
        // default allocator is used.
    {
        bdema_Allocator *ba = bdema_Default::defaultAllocator();
        *handle = bdef_Vfunc7<A1, A2, A3, A4, A5, A6, A7>(
            new(*ba) bdefi_Vfunc7C7<OBJ, C, A1, A2, A3, A4, A5, A6, A7>(
                object, method, ba));
    }
        ...
        // default allocator is used.
    {
        bdema_Allocator *ba = bdema_Default::defaultAllocator();
        *handle = bdef_Vfunc7<A1, A2, A3, A4, A5, A6, A7>(
            new(*ba) bdefi_Vfunc7C8<OBJ, C, A1, A2, A3, A4, A5, A6, A7, D1>(
        ...
        // or unspecified, the currently installed default allocator is used.
    {
        bdema_Allocator *ba = bdema_Default::defaultAllocator();
        *handle = bdef_Vfunc7<A1, A2, A3, A4, A5, A6, A7>(
           new(*ba) bdefi_Vfunc7C9<OBJ, C, A1, A2, A3, A4, A5, A6, A7, D1, D2>(
    ...
    template <class OBJ, class M, class A1, class A2, class A3, class A4,
              class A5, class A6, class A7>
    static void makeM(bdef_Vfunc7<A1, A2, A3, A4, A5, A6, A7> *handle,
                      OBJ                                     *object,
                      M                                        method)
        // Initialize the specified seven-argument functor 'handle' by
        ...
        // default allocator is used.
    {
        bdema_Allocator *ba = bdema_Default::defaultAllocator();
        *handle = bdef_Vfunc7<A1, A2, A3, A4, A5, A6, A7>(
            new(*ba) bdefi_Vfunc7M7<OBJ, M, A1, A2, A3, A4, A5, A6, A7>(
                object, method, ba));
    }
        ...
        // default allocator is used.
    {
        bdema_Allocator *ba = bdema_Default::defaultAllocator();
        *handle = bdef_Vfunc7<A1, A2, A3, A4, A5, A6, A7>(
            new(*ba) bdefi_Vfunc7M8<OBJ, M, A1, A2, A3, A4, A5, A6, A7, D1>(
                object, method, embeddedArg1, ba));
    }
        ...
        // or unspecified, the currently installed default allocator is used.
    {
        bdema_Allocator *ba = bdema_Default::defaultAllocator();
        *handle = bdef_Vfunc7<A1, A2, A3, A4, A5, A6, A7>(
           new(*ba) bdefi_Vfunc7M9<OBJ, M, A1, A2, A3, A4, A5, A6, A7, D1, D2>(
                object, method, embeddedArg1, embeddedArg2, ba));
    }
