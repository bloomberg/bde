// bdefu_vfunc4.h                  -*-C++-*-
#ifndef INCLUDED_BDEFU_VFUNC4
#define INCLUDED_BDEFU_VFUNC4
...
//..
//   bdefu_Vfunc4::makeF:    Initialize the functor by embedding a function
//                           (or another functor) and any additional trailing
//                           arguments.
//
//   bdefu_Vfunc4::makeC:    Initialize the functor by embedding an object, one
//                           of that object's 'const' methods, and any
//                           additional trailing arguments for that method.
//
//   bdefu_Vfunc4::makeM:    Initialize the functor by embedding THE ADDRESS OF
...
//
//   bdefu_Vfunc4::makeNull: Initialize the functor with an empty function.
//..
...
#ifndef INCLUDED_BDEF_VFUNC4
#include <bdef_vfunc4.h>
#endif

#ifndef INCLUDED_BDEFI_VFUNC4
#include <bdefi_vfunc4.h>
#endif
...
struct bdefu_Vfunc4 {
    ...
    static void makeNull(bdef_Vfunc4<A1, A2, A3, A4> *handle)
        ...
        // the currently installed default allocator is used.
    {
        ...
        *handle = bdef_Vfunc4<A1, A2, A3, A4>(
            new(*ba) bdefi_Vfunc4Null<A1, A2, A3, A4>(ba));
    }

    template <class A1, class A2, class A3, class A4>
    static void makeNull(bslma_Allocator *basicAllocator,
                         bdef_Vfunc4<A1, A2, A3, A4> *handle)
        // Initialize the specified four-argument empty functor 'handle'.
        // Optionally specify, as the *first* argument, a 'basicAllocator'
        // used to supply memory.  If 'basicAllocator' is 0 or unspecified,
        // the currently installed default allocator is used.
    ...
    static void makeF(bdef_Vfunc4<A1, A2, A3, A4> *handle, F function)
        ...
        // default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bdef_Vfunc4<A1, A2, A3, A4>(
            new(*ba) bdefi_Vfunc4F4<F, A1, A2, A3, A4>(function, ba));
    }
    ...
    static void makeF(bdef_Vfunc4<A1, A2, A3, A4> *handle,
                      F                function,
        ...
        // or unspecified, the currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bdef_Vfunc4<A1, A2, A3, A4>(
            new(*ba) bdefi_Vfunc4F5<F, A1, A2, A3, A4, D1> (
        ...
        // or unspecified, the currently installed default allocator is used.
    {
        ...
        *handle = bdef_Vfunc4<A1, A2, A3, A4>(
            new(*ba) bdefi_Vfunc4F6<F, A1, A2, A3, A4, D1, D2>
        ...
        // or unspecified, the currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bdef_Vfunc4<A1, A2, A3, A4>(
            new(*ba) bdefi_Vfunc4F7<F, A1, A2, A3, A4, D1, D2, D3>
        ...
        // or unspecified, the currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bdef_Vfunc4<A1, A2, A3, A4>(
            new(*ba) bdefi_Vfunc4F8<F, A1, A2, A3, A4, D1, D2, D3, D4>
        ...
        // or unspecified, the currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bdef_Vfunc4<A1, A2, A3, A4>(
            new(*ba) bdefi_Vfunc4F9<F, A1, A2, A3, A4, D1, D2, D3, D4, D5>
                (function, embeddedArg1, embeddedArg2, embeddedArg3,
    ...
    static void makeC(bdef_Vfunc4<A1, A2, A3, A4> *handle, const OBJ& object,
                      C                method)
        // Initialize the specified four-argument functor 'handle' by
        // embedding the specified 'function' (or functor) taking no
        // additional trailing arguments.  Optionally specify, as the *first*
        ...
        // default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bdef_Vfunc4<A1, A2, A3, A4>(
            new(*ba) bdefi_Vfunc4C4<OBJ, C, A1, A2, A3, A4>(
                object, method, ba));
    }
    ...
    template <class OBJ, class C, class A1, class A2, class A3, class A4,
              class D1>
    static void makeC(bdef_Vfunc4<A1, A2, A3, A4> *handle,
                      const OBJ&       object,
                      C                method,
                      const D1&        embeddedArg1)
        // Initialize the specified four-argument functor 'handle' by
        ...
        // default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bdef_Vfunc4<A1, A2, A3, A4>(
            new(*ba) bdefi_Vfunc4C5<OBJ, C, A1, A2, A3, A4, D1>(
        ...
        // or unspecified, the currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bdef_Vfunc4<A1, A2, A3, A4>(
            new(*ba) bdefi_Vfunc4C6<OBJ, C, A1, A2, A3, A4, D1, D2>(
        ...
        // or unspecified, the currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bdef_Vfunc4<A1, A2, A3, A4>(
            new(*ba) bdefi_Vfunc4C7<OBJ, C, A1, A2, A3, A4, D1, D2, D3>(
        ...
        // or unspecified, the currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bdef_Vfunc4<A1, A2, A3, A4>(
            new(*ba) bdefi_Vfunc4C8<OBJ, C, A1, A2, A3, A4, D1, D2, D3, D4>(
        ...
        // or unspecified, the currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bdef_Vfunc4<A1, A2, A3, A4>(
           new(*ba) bdefi_Vfunc4C9<OBJ, C, A1, A2, A3, A4, D1, D2, D3, D4, D5>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, ba));
    }
    ...
    static void makeM(bdef_Vfunc4<A1, A2, A3, A4> *handle, OBJ *object,
                      M                method)
        // Initialize the specified four-argument functor 'handle' by
        ...
        // default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bdef_Vfunc4<A1, A2, A3, A4>(
            new(*ba) bdefi_Vfunc4M4<OBJ, M, A1, A2, A3, A4>(
                object, method, ba));
    }
    ...
    template <class OBJ, class M, class A1, class A2, class A3, class A4,
              class D1>
    static void makeM(bdef_Vfunc4<A1, A2, A3, A4> *handle,
                      OBJ             *object,
                      M                method,
                      const D1&        embeddedArg1)
        // Initialize the specified four-argument functor 'handle' by
        ...
        // default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bdef_Vfunc4<A1, A2, A3, A4>(
            new(*ba) bdefi_Vfunc4M5<OBJ, M, A1, A2, A3, A4, D1>(
                object, method, embeddedArg1, ba));
    }
        ...
        // or unspecified, the currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bdef_Vfunc4<A1, A2, A3, A4>(
            new(*ba) bdefi_Vfunc4M6<OBJ, M, A1, A2, A3, A4, D1, D2>(
                object, method, embeddedArg1, embeddedArg2, ba));
    }
...
static void makeM(bdef_Vfunc4<A1, A2, A3, A4> *handle,
        ...
        // or unspecified, the currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bdef_Vfunc4<A1, A2, A3, A4>(
            new(*ba) bdefi_Vfunc4M7<OBJ, M, A1, A2, A3, A4, D1, D2, D3>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3, ba));
    }
        ...
        // or unspecified, the currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bdef_Vfunc4<A1, A2, A3, A4>(
            new(*ba) bdefi_Vfunc4M8<OBJ, M, A1, A2, A3, A4, D1, D2, D3, D4>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, ba));
    }
        ...
        // or unspecified, the currently installed default allocator is used.
    {
        bslma_Allocator *ba = bslma_Default::defaultAllocator();
        *handle = bdef_Vfunc4<A1, A2, A3, A4>(
           new(*ba) bdefi_Vfunc4M9<OBJ, M, A1, A2, A3, A4, D1, D2, D3, D4, D5>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, ba));
    }
