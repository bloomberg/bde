// bdefu_vfunc6.t.cpp              -*-C++-*-

#include <bdefu_vfunc6.h>
...
//
//-----------------------------------------------------------------------------
// [ 9] makeF(         bdef_Vfunc6<A1-6> *,       F, c_D1-3&);
// [ 9] makeC(         bdef_Vfunc6<A1-6> *, c_O&, C, c_D1-3&);
// [ 9] makeM(         bdef_Vfunc6<A1-6> *, OBJ*, M, c_D1-3&);
// [ 9] makeF(   bA *, bdef_Vfunc6<A1-6> *,       F, c_D1-3&);
// [ 9] makeC(   bA *, bdef_Vfunc6<A1-6> *, c_O&, C, c_D1-3&);
// [ 9] makeM(   bA *, bdef_Vfunc6<A1-6> *, OBJ*, M, c_D1-3&);
// [ 8] makeF(         bdef_Vfunc6<A1-6> *,       F, c_D1-2&);
// [ 8] makeC(         bdef_Vfunc6<A1-6> *, c_O&, C, c_D1-2&);
// [ 8] makeM(         bdef_Vfunc6<A1-6> *, OBJ*, M, c_D1-2&);
// [ 8] makeF(   bA *, bdef_Vfunc6<A1-6> *,       F, c_D1-2&);
// [ 8] makeC(   bA *, bdef_Vfunc6<A1-6> *, c_O&, C, c_D1-2&);
// [ 8] makeM(   bA *, bdef_Vfunc6<A1-6> *, OBJ*, M, c_D1-2&);
// [ 7] makeF(         bdef_Vfunc6<A1-6> *,       F, c_D1&);
// [ 7] makeC(         bdef_Vfunc6<A1-6> *, c_O&, C, c_D1&);
// [ 7] makeM(         bdef_Vfunc6<A1-6> *, OBJ*, M, c_D1&);
// [ 7] makeF(   bA *, bdef_Vfunc6<A1-6> *,       F, c_D1&);
// [ 7] makeC(   bA *, bdef_Vfunc6<A1-6> *, c_O&, C, c_D1&);
// [ 7] makeM(   bA *, bdef_Vfunc6<A1-6> *, OBJ*, M, c_D1&);
// [ 6] makeF(         bdef_Vfunc6<A1-6> *,       F);
// [ 6] makeC(         bdef_Vfunc6<A1-6> *, c_O&, C);
// [ 6] makeM(         bdef_Vfunc6<A1-6> *, OBJ*, M);
// [ 6] makeF(   bA *, bdef_Vfunc6<A1-6> *,       F);
// [ 6] makeC(   bA *, bdef_Vfunc6<A1-6> *, c_O&, C);
// [ 6] makeM(   bA *, bdef_Vfunc6<A1-6> *, OBJ*, M);
// [ 6] makeNull(      bdef_Vfunc6<A1-6> *);
// [ 6] makeNull(bA *, bdef_Vfunc6<A1-6> *);
//-----------------------------------------------------------------------------
...
class CbClass {
  public:
    void checkVfunc6ExecutionC() const
    {
        ++a0_global;
    }

    void checkVfunc6ExecutionM() const
    {
        ++a0_global;
    }
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      case 9: {
        ...
        //
        // Plan:
        //   Use each function to initialize a separate 'bdef_Vfunc6' object
        //   with the 'checkArgumentValues' function, which verifies that the
        //   parameters are "wired" correctly.  Use each function to
        //   initialize 'bdef_Vfunc6' object with the 'checkParameterTypes'
        ...
        //
        // Testing:
        //    makeF(      bdef_Vfunc6<A1-6> *,        F, c_D1-3&);
        //    makeC(      bdef_Vfunc6<A1-6> *, c_O&,  C, c_D1-3&);
        //    makeM(      bdef_Vfunc6<A1-6> *, OBJ *, M, c_D1-3&);
        //    makeF(bA *, bdef_Vfunc6<A1-6> *,        F, c_D1-3&);
        //    makeC(bA *, bdef_Vfunc6<A1-6> *, c_O&,  C, c_D1-3&);
        //    makeM(bA *, bdef_Vfunc6<A1-6> *, OBJ *, M, c_D1-3&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdef_Vfunc6<int *, int *, int *, int *, int *, int *> x1;
                bdefu_Vfunc6::makeF(&x1, checkArgumentValues9,
                                    &a7, &a8, &a9);
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            if (verbose) cout << "Testing 'makeF'" << endl;
            {
                bdef_Vfunc6<T1, T2, T3, T4, T5, T6> x1;
                bdefu_Vfunc6::makeF(&x1, checkParameterTypes9,
                                    a7, a8, a9);
                x1(a1, a2, a3, a4, a5, a6);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdef_Vfunc6<int *, int *, int *, int *, int *, int *> x1;
                bdefu_Vfunc6::makeF(&ta, &x1, checkArgumentValues9,
                                    &a7, &a8, &a9);
                x1(&a1, &a2, &a3, &a4, &a5, &a6);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            {
                bdef_Vfunc6<int *, int *, int *, int *, int *, int *> x1;
                bdefu_Vfunc6::makeC(&ta, &x1, cbObj,
                                    &CbClass::checkArgumentValues9,
                                    &a7, &a8, &a9);
                x1(&a1, &a2, &a3, &a4, &a5, &a6);
                ASSERT(ARG1_PLUS1 == a1);
            ...
            {
                bdef_Vfunc6<int *, int *, int *, int *, int *, int *> x1;
                bdefu_Vfunc6::makeM(&ta, &x1, &cbObj,
                                    &CbClass::checkArgumentValues9,
                                    &a7, &a8, &a9);
                x1(&a1, &a2, &a3, &a4, &a5, &a6);
                ASSERT(ARG1_PLUS1 == a1);
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdef_Vfunc6<T1, T2, T3, T4, T5, T6> x1;
                bdefu_Vfunc6::makeF(&ta, &x1, checkParameterTypes9,
                                    a7, a8, a9);
                x1(a1, a2, a3, a4, a5, a6);
            }
      ...
      case 8: {
        ...
        //
        // Testing:
        //    makeF(      bdef_Vfunc6<A1-6> *,        F, c_D1-2&);
        //    makeC(      bdef_Vfunc6<A1-6> *, c_O&,  C, c_D1-2&);
        //    makeM(      bdef_Vfunc6<A1-6> *, OBJ *, M, c_D1-2&);
        //    makeF(bA *, bdef_Vfunc6<A1-6> *,        F, c_D1-2&);
        //    makeC(bA *, bdef_Vfunc6<A1-6> *, c_O&,  C, c_D1-2&);
        //    makeM(bA *, bdef_Vfunc6<A1-6> *, OBJ *, M, c_D1-2&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdef_Vfunc6<int *, int *, int *, int *, int *, int *> x1;
                bdefu_Vfunc6::makeF(&x1, checkArgumentValues8, &a7, &a8);
                x1(&a1, &a2, &a3, &a4, &a5, &a6);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            }
            ...
            if (verbose) cout << "Testing 'makeC'" << endl;
            {
                bdef_Vfunc6<int *, int *, int *, int *, int *, int *> x1;
                bdefu_Vfunc6::makeC(&x1, cbObj,
                                    &CbClass::checkArgumentValues8, &a7, &a8);
                x1(&a1, &a2, &a3, &a4, &a5, &a6);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            }
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdef_Vfunc6<T1, T2, T3, T4, T5, T6> x1;
                bdefu_Vfunc6::makeF(&x1, checkParameterTypes8, a7, a8);
                x1(a1, a2, a3, a4, a5, a6);
            }
            ...
            if (verbose) cout << "Testing 'makeC'" << endl;
            {
                ...
                CbClass cbObj;
                bdefu_Vfunc6::makeC(&x1, cbObj,
                                    &CbClass::checkParameterTypesC8, a7, a8);
                x1(a1, a2, a3, a4, a5, a6);
            }
            ...
            if (verbose) cout << "Testing 'makeM'" << endl;
            {
                ...
                CbClass cbObj;
                bdefu_Vfunc6::makeM(&x1, &cbObj,
                                     &CbClass::checkParameterTypesM8, a7, a8);
                x1(a1, a2, a3, a4, a5, a6);
            }
        }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdef_Vfunc6<int *, int *, int *, int *, int *, int *> x1;
                bdefu_Vfunc6::makeF(&ta, &x1, checkArgumentValues8, &a7, &a8);
                x1(&a1, &a2, &a3, &a4, &a5, &a6);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdef_Vfunc6<T1, T2, T3, T4, T5, T6> x1;
                bdefu_Vfunc6::makeF(&ta, &x1, checkParameterTypes8, a7, a8);
                x1(a1, a2, a3, a4, a5, a6);
            }
      ...
      case 7: {
        ...
        //
        // Testing:
        //    makeF(      bdef_Vfunc6<A1-6> *,        F, c_D1&);
        //    makeC(      bdef_Vfunc6<A1-6> *, c_O&,  C, c_D1&);
        //    makeM(      bdef_Vfunc6<A1-6> *, OBJ *, M, c_D1&);
        //    makeF(bA *, bdef_Vfunc6<A1-6> *,        F, c_D1&);
        //    makeC(bA *, bdef_Vfunc6<A1-6> *, c_O&,  C, c_D1&);
        //    makeM(bA *, bdef_Vfunc6<A1-6> *, OBJ *, M, c_D1&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdef_Vfunc6<int *, int *, int *, int *, int *, int *> x1;
                bdefu_Vfunc6::makeF(&x1, checkArgumentValues7, &a7);
                x1(&a1, &a2, &a3, &a4, &a5, &a6);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            }
            ...
            if (verbose) cout << "Testing 'makeC'" << endl;
            {
                bdef_Vfunc6<int *, int *, int *, int *, int *, int *> x1;
                bdefu_Vfunc6::makeC(&x1, cbObj,
                                    &CbClass::checkArgumentValues7, &a7);
                x1(&a1, &a2, &a3, &a4, &a5, &a6);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            }
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdef_Vfunc6<T1, T2, T3, T4, T5, T6> x1;
                bdefu_Vfunc6::makeF(&x1, checkParameterTypes7, a7);
                x1(a1, a2, a3, a4, a5, a6);
            }
            ...
            if (verbose) cout << "Testing 'makeC'" << endl;
            {
                ...
                CbClass cbObj;
                bdefu_Vfunc6::makeC(&x1, cbObj,
                                    &CbClass::checkParameterTypesC7, a7);
                x1(a1, a2, a3, a4, a5, a6);
            }
            ...
            if (verbose) cout << "Testing 'makeM'" << endl;
            {
                ...
                CbClass cbObj;
                bdefu_Vfunc6::makeM(&x1, &cbObj,
                                     &CbClass::checkParameterTypesM7, a7);
                x1(a1, a2, a3, a4, a5, a6);
            }
        }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdef_Vfunc6<int *, int *, int *, int *, int *, int *> x1;
                bdefu_Vfunc6::makeF(&ta, &x1, checkArgumentValues7, &a7);
                x1(&a1, &a2, &a3, &a4, &a5, &a6);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdef_Vfunc6<T1, T2, T3, T4, T5, T6> x1;
                bdefu_Vfunc6::makeF(&ta, &x1, checkParameterTypes7, a7);
                x1(a1, a2, a3, a4, a5, a6);
            }
      ...
      case 6: {
        ...
        //
        // Testing:
        //    makeF(         bdef_Vfunc6<A1-6> *,        F);
        //    makeC(         bdef_Vfunc6<A1-6> *, c_O&,  C);
        //    makeM(         bdef_Vfunc6<A1-6> *, OBJ *, M);
        //    makeNull(      bdef_Vfunc6<A1-6> *);
        //    makeF(   bA *, bdef_Vfunc6<A1-6> *,        F);
        //    makeC(   bA *, bdef_Vfunc6<A1-6> *, c_O&,  C);
        //    makeM(   bA *, bdef_Vfunc6<A1-6> *, OBJ *, M);
        //    makeNull(bA *, bdef_Vfunc6<A1-6> *);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdef_Vfunc6<int *, int *, int *, int *, int *, int *> x1;
                bdefu_Vfunc6::makeF(&x1, checkArgumentValues6);
                x1(&a1, &a2, &a3, &a4, &a5, &a6);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            }
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdef_Vfunc6<T1, T2, T3, T4, T5, T6> x1;
                bdefu_Vfunc6::makeF(&x1, checkParameterTypes6);
                x1(a1, a2, a3, a4, a5, a6);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdef_Vfunc6<int *, int *, int *, int *, int *, int *> x1;
                bdefu_Vfunc6::makeF(&ta, &x1, checkArgumentValues6);
                x1(&a1, &a2, &a3, &a4, &a5, &a6);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdef_Vfunc6<T1, T2, T3, T4, T5, T6> x1;
                bdefu_Vfunc6::makeF(&ta, &x1, checkParameterTypes6);
                x1(a1, a2, a3, a4, a5, a6);
            }
