...
//
//-----------------------------------------------------------------------------
// [ 9] makeF(         bdef_Vfunc5<A1-5> *,       F, c_D1-4&);
// [ 9] makeC(         bdef_Vfunc5<A1-5> *, c_O&, C, c_D1-4&);
// [ 9] makeM(         bdef_Vfunc5<A1-5> *, OBJ*, M, c_D1-4&);
// [ 9] makeF(   bA *, bdef_Vfunc5<A1-5> *,       F, c_D1-4&);
// [ 9] makeC(   bA *, bdef_Vfunc5<A1-5> *, c_O&, C, c_D1-4&);
// [ 9] makeM(   bA *, bdef_Vfunc5<A1-5> *, OBJ*, M, c_D1-4&);
// [ 8] makeF(         bdef_Vfunc5<A1-5> *,       F, c_D1-3&);
// [ 8] makeC(         bdef_Vfunc5<A1-5> *, c_O&, C, c_D1-3&);
// [ 8] makeM(         bdef_Vfunc5<A1-5> *, OBJ*, M, c_D1-3&);
// [ 8] makeF(   bA *, bdef_Vfunc5<A1-5> *,       F, c_D1-3&);
// [ 8] makeC(   bA *, bdef_Vfunc5<A1-5> *, c_O&, C, c_D1-3&);
// [ 8] makeM(   bA *, bdef_Vfunc5<A1-5> *, OBJ*, M, c_D1-3&);
// [ 7] makeF(         bdef_Vfunc5<A1-5> *,       F, c_D1-2&);
// [ 7] makeC(         bdef_Vfunc5<A1-5> *, c_O&, C, c_D1-2&);
// [ 7] makeM(         bdef_Vfunc5<A1-5> *, OBJ*, M, c_D1-2&);
// [ 7] makeF(   bA *, bdef_Vfunc5<A1-5> *,       F, c_D1-2&);
// [ 7] makeC(   bA *, bdef_Vfunc5<A1-5> *, c_O&, C, c_D1-2&);
// [ 7] makeM(   bA *, bdef_Vfunc5<A1-5> *, OBJ*, M, c_D1-2&);
// [ 6] makeF(         bdef_Vfunc5<A1-5> *,       F, c_D1&);
// [ 6] makeC(         bdef_Vfunc5<A1-5> *, c_O&, C, c_D1&);
// [ 6] makeM(         bdef_Vfunc5<A1-5> *, OBJ*, M, c_D1&);
// [ 6] makeF(   bA *, bdef_Vfunc5<A1-5> *,       F, c_D1&);
// [ 6] makeC(   bA *, bdef_Vfunc5<A1-5> *, c_O&, C, c_D1&);
// [ 6] makeM(   bA *, bdef_Vfunc5<A1-5> *, OBJ*, M, c_D1&);
// [ 5] makeF(         bdef_Vfunc5<A1-5> *,       F);
// [ 5] makeC(         bdef_Vfunc5<A1-5> *, c_O&, C);
// [ 5] makeM(         bdef_Vfunc5<A1-5> *, OBJ*, M);
// [ 5] makeF(   bA *, bdef_Vfunc5<A1-5> *,       F);
// [ 5] makeC(   bA *, bdef_Vfunc5<A1-5> *, c_O&, C);
// [ 5] makeM(   bA *, bdef_Vfunc5<A1-5> *, OBJ*, M);
// [ 5] makeNull(      bdef_Vfunc5<A1-5> *);
// [ 5] makeNull(bA *, bdef_Vfunc5<A1-5> *);
//-----------------------------------------------------------------------------
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      case 9: {
        ...
        //
        // Plan:
        //   Use each function to initialize a separate 'bdef_Vfunc5' object
        //   with the 'checkArgumentValues' function, which verifies that the
        //   parameters are "wired" correctly.  Use each function to
        //   initialize 'bdef_Vfunc5' object with the 'checkParameterTypes'
        ...
        //
        // Testing:
        //    makeF(      bdef_Vfunc5<A1-5> *,        F, c_D1-4&);
        //    makeC(      bdef_Vfunc5<A1-5> *, c_O&,  C, c_D1-4&);
        //    makeM(      bdef_Vfunc5<A1-5> *, OBJ *, M, c_D1-4&);
        //    makeF(bA *, bdef_Vfunc5<A1-5> *,        F, c_D1-4&);
        //    makeC(bA *, bdef_Vfunc5<A1-5> *, c_O&,  C, c_D1-4&);
        //    makeM(bA *, bdef_Vfunc5<A1-5> *, OBJ *, M, c_D1-4&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdef_Vfunc5<int *, int *, int *, int *, int *> x1;
                bdefu_Vfunc5::makeF(&x1, checkArgumentValues9,
                                    &a6, &a7, &a8, &a9);
                x1(&a1, &a2, &a3, &a4, &a5);
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            if (verbose) cout << "Testing 'makeF'" << endl;
            {
                bdef_Vfunc5<T1, T2, T3, T4, T5> x1;
                bdefu_Vfunc5::makeF(&x1, checkParameterTypes9,
                                    a6, a7, a8, a9);
                x1(a1, a2, a3, a4, a5);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdef_Vfunc5<int *, int *, int *, int *, int *> x1;
                bdefu_Vfunc5::makeF(&ta, &x1, checkArgumentValues9,
                                    &a6, &a7, &a8, &a9);
                x1(&a1, &a2, &a3, &a4, &a5);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            {
                bdef_Vfunc5<int *, int *, int *, int *, int *> x1;
                bdefu_Vfunc5::makeC(&ta, &x1, cbObj,
                                    &CbClass::checkArgumentValues9,
                                    &a6, &a7, &a8, &a9);
                x1(&a1, &a2, &a3, &a4, &a5);
                ASSERT(ARG1_PLUS1 == a1);
            ...
            {
                bdef_Vfunc5<int *, int *, int *, int *, int *> x1;
                bdefu_Vfunc5::makeM(&ta, &x1, &cbObj,
                                    &CbClass::checkArgumentValues9,
                                    &a6, &a7, &a8, &a9);
                x1(&a1, &a2, &a3, &a4, &a5);
                ASSERT(ARG1_PLUS1 == a1);
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdef_Vfunc5<T1, T2, T3, T4, T5> x1;
                bdefu_Vfunc5::makeF(&ta, &x1, checkParameterTypes9,
                                    a6, a7, a8, a9);
                x1(a1, a2, a3, a4, a5);
            }
      ...
      case 8: {
        ...
        //
        // Testing:
        //    makeF(      bdef_Vfunc5<A1-5> *,        F, c_D1-3&);
        //    makeC(      bdef_Vfunc5<A1-5> *, c_O&,  C, c_D1-3&);
        //    makeM(      bdef_Vfunc5<A1-5> *, OBJ *, M, c_D1-3&);
        //    makeF(bA *, bdef_Vfunc5<A1-5> *,        F, c_D1-3&);
        //    makeC(bA *, bdef_Vfunc5<A1-5> *, c_O&,  C, c_D1-3&);
        //    makeM(bA *, bdef_Vfunc5<A1-5> *, OBJ *, M, c_D1-3&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdef_Vfunc5<int *, int *, int *, int *, int *> x1;
                bdefu_Vfunc5::makeF(&x1, checkArgumentValues8,
                                    &a6, &a7, &a8);
                x1(&a1, &a2, &a3, &a4, &a5);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdef_Vfunc5<T1, T2, T3, T4, T5> x1;
                bdefu_Vfunc5::makeF(&x1, checkParameterTypes8,
                                    a6, a7, a8);
                x1(a1, a2, a3, a4, a5);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdef_Vfunc5<int *, int *, int *, int *, int *> x1;
                bdefu_Vfunc5::makeF(&ta, &x1, checkArgumentValues8,
                                    &a6, &a7, &a8);
                x1(&a1, &a2, &a3, &a4, &a5);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdef_Vfunc5<T1, T2, T3, T4, T5> x1;
                bdefu_Vfunc5::makeF(&ta, &x1, checkParameterTypes8,
                                    a6, a7, a8);
                x1(a1, a2, a3, a4, a5);
            }
      ...
      case 7: {
        ...
        //
        // Testing:
        //    makeF(      bdef_Vfunc5<A1-5> *,        F, c_D1-2&);
        //    makeC(      bdef_Vfunc5<A1-5> *, c_O&,  C, c_D1-2&);
        //    makeM(      bdef_Vfunc5<A1-5> *, OBJ *, M, c_D1-2&);
        //    makeF(bA *, bdef_Vfunc5<A1-5> *,        F, c_D1-2&);
        //    makeC(bA *, bdef_Vfunc5<A1-5> *, c_O&,  C, c_D1-2&);
        //    makeM(bA *, bdef_Vfunc5<A1-5> *, OBJ *, M, c_D1-2&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdef_Vfunc5<int *, int *, int *, int *, int *> x1;
                bdefu_Vfunc5::makeF(&x1, checkArgumentValues7, &a6, &a7);
                x1(&a1, &a2, &a3, &a4, &a5);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            }
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdef_Vfunc5<T1, T2, T3, T4, T5> x1;
                bdefu_Vfunc5::makeF(&x1, checkParameterTypes7, a6, a7);
                x1(a1, a2, a3, a4, a5);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdef_Vfunc5<int *, int *, int *, int *, int *> x1;
                bdefu_Vfunc5::makeF(&ta, &x1, checkArgumentValues7, &a6, &a7);
                x1(&a1, &a2, &a3, &a4, &a5);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdef_Vfunc5<T1, T2, T3, T4, T5> x1;
                bdefu_Vfunc5::makeF(&ta, &x1, checkParameterTypes7, a6, a7);
                x1(a1, a2, a3, a4, a5);
            }
      ...
      case 6: {
        ...
        //
        // Testing:
        //    makeF(      bdef_Vfunc5<A1-5> *,        F, c_D1&);
        //    makeC(      bdef_Vfunc5<A1-5> *, c_O&,  C, c_D1&);
        //    makeM(      bdef_Vfunc5<A1-5> *, OBJ *, M, c_D1&);
        //    makeF(bA *, bdef_Vfunc5<A1-5> *,        F, c_D1&);
        //    makeC(bA *, bdef_Vfunc5<A1-5> *, c_O&,  C, c_D1&);
        //    makeM(bA *, bdef_Vfunc5<A1-5> *, OBJ *, M, c_D1&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdef_Vfunc5<int *, int *, int *, int *, int *> x1;
                bdefu_Vfunc5::makeF(&x1, checkArgumentValues6, &a6);
                x1(&a1, &a2, &a3, &a4, &a5);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            }
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdef_Vfunc5<T1, T2, T3, T4, T5> x1;
                bdefu_Vfunc5::makeF(&x1, checkParameterTypes6, a6);
                x1(a1, a2, a3, a4, a5);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdef_Vfunc5<int *, int *, int *, int *, int *> x1;
                bdefu_Vfunc5::makeF(&ta, &x1, checkArgumentValues6, &a6);
                x1(&a1, &a2, &a3, &a4, &a5);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdef_Vfunc5<T1, T2, T3, T4, T5> x1;
                bdefu_Vfunc5::makeF(&ta, &x1, checkParameterTypes6, a6);
                x1(a1, a2, a3, a4, a5);
            }
      ...
      case 5: {
        ...
        //
        // Testing:
        //    makeF(         bdef_Vfunc5<A1-5> *,        F);
        //    makeC(         bdef_Vfunc5<A1-5> *, c_O&,  C);
        //    makeM(         bdef_Vfunc5<A1-5> *, OBJ *, M);
        //    makeNull(      bdef_Vfunc5<A1-5> *);
        //    makeF(   bA *, bdef_Vfunc5<A1-5> *,        F);
        //    makeC(   bA *, bdef_Vfunc5<A1-5> *, c_O&,  C);
        //    makeM(   bA *, bdef_Vfunc5<A1-5> *, OBJ *, M);
        //    makeNull(bA *, bdef_Vfunc5<A1-5> *);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdef_Vfunc5<int *, int *, int *, int *, int *> x1;
                bdefu_Vfunc5::makeF(&x1, checkArgumentValues5);
                x1(&a1, &a2, &a3, &a4, &a5);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            }
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdef_Vfunc5<T1, T2, T3, T4, T5> x1;
                bdefu_Vfunc5::makeF(&x1, checkParameterTypes5);
                x1(a1, a2, a3, a4, a5);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdef_Vfunc5<int *, int *, int *, int *, int *> x1;
                bdefu_Vfunc5::makeF(&ta, &x1, checkArgumentValues5);
                x1(&a1, &a2, &a3, &a4, &a5);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdef_Vfunc5<T1, T2, T3, T4, T5> x1;
                bdefu_Vfunc5::makeF(&ta, &x1, checkParameterTypes5);
                x1(a1, a2, a3, a4, a5);
            }
