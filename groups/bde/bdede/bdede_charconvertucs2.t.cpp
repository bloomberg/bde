...
// 'bdede_CharConvertUcs2' struct's C-style utility functions, converting a
...
void testCFunction1()
{
    ...
    int retVal =
              BloombergLP::bdede_CharConvertUcs2::utf8ToUcs2(buffer,
                                                             buffSize,
                                                             "Hello",
                                                             &charsWritten);
...
void testCFunction2()
{
    ...
    retVal =
          BloombergLP::bdede_CharConvertUcs2::ucs2ToUtf8(buffer2,
                                                         buffer2Size,
                                                         buffer,
                                                         &charsWritten,
                                                         &bytesWritten);
...
{
    int retVal =
              BloombergLP::bdede_CharConvertUcs2::utf8ToUcs2(result,
                                                             "Hello");
...
// 'bdede_CharConvertUcs2' struct's C++-style utility functions, first
...
void checkCppRoundTrip()
{
    ...
    // Reversing the conversion returns the original string:
    retVal =
          BloombergLP::bdede_CharConvertUcs2::ucs2ToUtf8(&result2,
                                                         &result.front(),
                                                         &charsWritten);
                                             ...
                                             int             veryVerbose)
{
    ...
    for(int bufSize = 0; bufSize < totalOutputLength; ++bufSize) {
        ...
        retVal = bdede_CharConvertUcs2::ucs2ToUtf8(
                outputBuffer,
                bufSize,
                input,
                &charsWritten,
                                 ...
                                 int                    veryVerbose)
{
    ...
    int retVal = bdede_CharConvertUcs2::utf8ToUcs2(outputBuffer,
                                                   characterCount - 1,
                                                   inputBuffer,
                                                   &charsWritten);
    ...
    retVal = bdede_CharConvertUcs2::utf8ToUcs2(outputBuffer,
                                               characterCount,
                                               inputBuffer,
                                               &charsWritten);
                                             ...
                                             int             veryVerbose)
{
    ...
    for(int bufSize = 0; bufSize < characterCount; ++bufSize) {
        ...
        retVal = bdede_CharConvertUcs2::utf8ToUcs2(
                outputBuffer,
                bufSize,
                input,
                &charsWritten);
    ...
    retVal = bdede_CharConvertUcs2::utf8ToUcs2(&cppOutput,
                                               input);
...
// skipping the rest of the book...
    ...
    for (int i = 0; i < iterLimit; ++i) {
        ASSERT(SUCCESS == bdede_CharConvertUcs2::utf8ToUcs2(ucs2Buffer_p,
                                                            prideLen,
                                                            prideAndPrejudice,
                                                            &charsWritten));
        ASSERT(charsWritten == prideLen);

        ASSERT(0 == bdede_CharConvertUcs2::ucs2ToUtf8(utf8Buffer_p,
                                                      prideLen,
                                                      ucs2Buffer_p,
                                                      &charsWritten,
                                                      &bytesWritten));
    ...
    for (int i = 0; i < iterLimit; ++i) {
        ASSERT(SUCCESS == bdede_CharConvertUcs2::utf8ToUcs2(&cppPrideUcs2,
                                                           prideAndPrejudice));
        ...
        ASSERT(0 == bdede_CharConvertUcs2::ucs2ToUtf8(&cppPrideUtf8,
                                                      &(cppPrideUcs2[0]),
                                                      &charsWritten));
        ASSERT(charsWritten == prideLen);
...
int main(int argc, char**argv)
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 4: {
        ...
        if (verbose) cout <<
           "\nTesting 'bdede_CharConvertUcs2::ucs2ToUtf8'." << endl;
        {
            static const struct {
...
// ^--------v
            ...
            for (int i = 0; i < NUM_DATA; ++i) {
                ...
                int retVal = bdede_CharConvertUcs2::ucs2ToUtf8(
                                      results,
                                      BUFSIZE,
                                      SPEC,
                                      &charsWritten,
      ...
      case 3: {
        ...
        if (verbose) cout <<
          "\nTesting 'bdede_CharConvertUcs2::utf8ToUcs2'." << endl;
        {
            static const struct {
                int                   d_lineNum;        // source line
                                                        // number
...
// ^--------v
            ...
            for (int i = 0; i < NUM_DATA; ++i) {
                ...
                int retVal = bdede_CharConvertUcs2::utf8ToUcs2(
                                      results,
                                      BUFSIZE,
                                      SPEC,
                                      &charsWritten);
                ...
                if (OK == RETURN || BADC == RETURN) {
                    int cppRetVal = bdede_CharConvertUcs2::utf8ToUcs2(
                                        &cppResult,
                                        SPEC);
      ...
      case 1: {
        ...
        ASSERT(SUCCESS == BloombergLP::bdede_CharConvertUcs2::utf8ToUcs2(
                      ucs2_buffer,
                      sizeof ucs2_buffer/sizeof *ucs2_buffer,
                      ecole));

        ASSERT(SUCCESS == BloombergLP::bdede_CharConvertUcs2::ucs2ToUtf8(
                      utf8_buffer,
