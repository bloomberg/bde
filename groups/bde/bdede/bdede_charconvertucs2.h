// bdede_charconvertucs2.h                  -*-C++-*-
#ifndef INCLUDED_BDEDE_CHARCONVERTUCS2
#define INCLUDED_BDEDE_CHARCONVERTUCS2
...
//
//@CLASSES:
//    bdede_CharConvertUcs2: namespace for conversions between UTF-8 and UCS-2
//
...
// 'bdede_CharConvertUcs2', on the other hand, assume that the user-provided
