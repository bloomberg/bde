...
// calculation is specified in the implementation file (bdede_md5.cpp).  We
...
//   A 'bdede_Md5' object is created with a default message length of 0 and a
...
// CREATORS
// [ 2] bdede_Md5();
// [12] bdede_Md5(const void *data, int length);
// [ 7] bdede_Md5(const bdede_Crc32& original);
// [ 2] ~bdede_Md5();

// MANIPULATORS
// [ 9] bdede_Md5& operator=(const bdede_Crc32& rhs);
...
//
// FREE OPERATORS
// [ 6] bool operator==(const bdede_Md5& lhs, const bdede_Md5& rhs);
// [ 6] bool operator!=(const bdede_Md5& lhs, const bdede_Md5& rhs);
// [ 5] bsl::ostream& operator<<(bsl::ostream& stream, const bdede_Md5&);
//-----------------------------------------------------------------------------
// [ 1] BREATHING TEST
// [15] USAGE EXAMPLE
...
// [ 3] bdede_Md5& gg(bdede_Md5 *object, const char *spec);
// [ 8] bdede_Md5   g(const char *spec);
...
int verify(const bdede_Md5::Md5Digest& result, const char *hexString)
{
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 14: {
        ...
        //
        // Testing:
        //   void loadDigestAndReset(bdede_Md5::Md5Digest result);
        // --------------------------------------------------------------------
      ...
      case 13: {
        ...
        //   each datum, create a 'bdede_Md5' object using the fully-tested
      ...
      case 12: {
        ...
        //   datum, create a 'bdede_Md5' object using the two-argument
      ...
      case 5: {
        ...
        //   bsl::ostream& operator<<(bsl::ostream&, const bdede_Md5&);
        // --------------------------------------------------------------------
      ...
      case 4: {
        ...
        //
        // Testing:
        //   void loadDigest(bdede_Md5::Md5Digest result) const;
        // --------------------------------------------------------------------
      ...
      case 3: {
        ...
        //
        // Testing:
        //   int ggg(bdede_Md5 *object, const char *spec, int vF = 1);
        //   bdede_Md5& gg(bdede_Md5 *object, const char *spec);
        // --------------------------------------------------------------------
        if (verbose)
...

        {
            ...
            for (int i = 0; i < NUM_DATA; ++i) {
                ...
                bdede_Md5::Md5Digest r1;
                X.loadDigest(&r1);
                LOOP_ASSERT(LINE, verify(r1, RESULT));

                bdede_Md5::Md5Digest r2;
                Y.loadDigest(&r2);
