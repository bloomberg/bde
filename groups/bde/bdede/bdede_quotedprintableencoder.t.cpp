// bdede_quotedprintableencoder.t.cpp            -*-C++-*-
...
//..
//  bdede_quotedprintableencoder(int maxLineLength);
//..
...
// arguments, 'bdeut_InputIterator' for 'convert' and 'bdeut_OutputIterator'
// for both of these template methods.
//
// ----------------------------------------------------------------------------
// [ 7] static int encodedLength(int numInputBytes, int maxLineLength); [ 8]
// bdede_QuotedPrintableEncoder(); [ 2] bdede_QuotedPrintableEncoder(int
// maxLineLength); [ 3] ~bdede_QuotedPrintableEncoder(); [ 7] int convert(char
...
typedef bdede_QuotedPrintableEncoder Obj;
...
class StateAccessor {
  private:
    bdede_QuotedPrintableEncoder *d_object_p;

  public:
    StateAccessor(bdede_QuotedPrintableEncoder *object)
...
void setState(bdede_QuotedPrintableEncoder *object, int state)
...
bool isState(bdede_QuotedPrintableEncoder *object, int state)
...
const char* getStateInText(bdede_QuotedPrintableEncoder *object)
{
...
encoded.");
      ...
      case 2: {
        ...
        //
        // Testing:
        //   bdede_QuotedPrintableEncoder(LineBreakMode mode = CRLF_MODE,
        //                                int maxLineLen=DEFAULT_MAX_LINELEN);
        //   bdede_QuotedPrintableEncoder(const char*   extraCharsToEncode,
      ...
      case 1: {
        ...
        {
            bdede_QuotedPrintableEncoder encoder;
