// bdede_quotedprintableencoder.h                -*-C++-*-
#ifndef INCLUDED_BDEDE_QUOTEDPRINTABLEENCODER
#define INCLUDED_BDEDE_QUOTEDPRINTABLEENCODER
...
//
//@CLASSES:
// bdede_QuotedPrintableEncoder: automaton performing Quoted-Printable encoding
//
//@AUTHOR: Alex Fung (afung8)
//
//@SEE_ALSO 'bdede_QuotedPrintableDecoder'
//
...
//      bdede_QuotedPrintableEncoder::LineBreakMode lineBreakMode
//                        = bdede_QuotedPrintableEncoder::BDEDE_CRLF_MODE,
//      int maxLineLength = bdede_QuotedPrintableEncoder::DEFAULT_MAX_LINELEN);
//..
//
...
///Usage Example
///-------------
// The following example shows how to use a 'bdede_QuotedPrintableEncoder'
...
// monitoring functionality of 'bdede_QuotedPrintableEncoder', the fixed buffer
...
//     };
//..
// We declare a 'bdede_QuotedPrintableEncoder' object 'converter', which will
...
//..
//     bdede_QuotedPrintableEncoder converter;
//
...
namespace BloombergLP {
                              ...
                              // ==================================
                              // class bdede_QuotedPrintableEncoder
                              // ==================================
...
class bdede_QuotedPrintableEncoder {
  ...
  private:
    ...
    bdede_QuotedPrintableEncoder(const bdede_QuotedPrintableEncoder&);

    bdede_QuotedPrintableEncoder& operator=(
                                          const bdede_QuotedPrintableEncoder&);
  ...
  public:
    ...
    // CREATORS
    bdede_QuotedPrintableEncoder(LineBreakMode lineBreakMode = BDEDE_CRLF_MODE,
                                 int           maxLineLength
                                                        = DEFAULT_MAX_LINELEN);
...
// CLASS METHODS
inline
const char* bdede_QuotedPrintableEncoder::lineBreakModeToAscii(
                                                            LineBreakMode mode)
{
...
// MANIPULATORS
inline
void bdede_QuotedPrintableEncoder::reset()
{
...
// ACCESSORS
inline
bool bdede_QuotedPrintableEncoder::isAccepting() const
{
    return BDEDE_INITIAL_STATE == d_state || BDEDE_DONE_STATE == d_state;
}

inline
bool bdede_QuotedPrintableEncoder::isDone() const
{
    return BDEDE_DONE_STATE == d_state && 0 == d_outBuf.size();
}

inline
bool bdede_QuotedPrintableEncoder::isError() const
{
    return BDEDE_ERROR_STATE == d_state;
}

inline
bool bdede_QuotedPrintableEncoder::isInitialState() const
{
    return BDEDE_INITIAL_STATE == d_state && 0 == d_outputLength;
}

inline
bdede_QuotedPrintableEncoder::LineBreakMode
bdede_QuotedPrintableEncoder::lineBreakMode() const
{
    return d_lineBreakMode;
}

inline
int bdede_QuotedPrintableEncoder::maxLineLength() const
{
...
inline
int bdede_QuotedPrintableEncoder::outputLength() const
{
