...
//   A 'bdede_Crc32' object is created with a default checksum value of
...
// CREATORS
// [ 2] bdede_Crc32();
// [12] bdede_Crc32(const void *data, int length);
// [ 7] bdede_Crc32(const bdede_Crc32& original);
// [ 2] ~bdede_Crc32();

// MANIPULATORS
// [ 9] bdede_Crc32& operator=(const bdede_Crc32& rhs);
...
//
// FREE OPERATORS
// [ 6] bool operator==(const bdede_Crc32& lhs, const bdede_Crc32& rhs);
// [ 6] bool operator!=(const bdede_Crc32& lhs, const bdede_Crc32& rhs);
// [ 5] bsl::ostream& operator<<(bsl::ostream& stream, const bdede_Crc32&);
//-----------------------------------------------------------------------------
// [ 1] BREATHING TEST
// [15] USAGE EXAMPLE
...
// [-1] PERFORMANCE TEST
//
// [ 3] int ggg(bdede_Crc32 *object, const char *spec, int vF = 1);
// [ 3] bdede_Crc32& gg(bdede_Crc32 *object, const char *spec);
// [ 8] bdede_Crc32   g(const char *spec);
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 14: {
        // --------------------------------------------------------------------
        // TESTING CRC_TABLE
        //   This will test the 'CRC_TABLE' array defined in bdede_crc32.cpp.
        //
        // Concerns:
        //   The CRC algorithm depends on a static constant array of unsigned
        //   integers defined in bdede_crc32.cpp as 'CRC_TABLE[256]'.  This
        ...
        //   it is internal to the bdede_crc32.cpp translation unit.  However,
        ...
        //      b. Create a 'bdede_Crc32' object 'obj' using the default
        //         constructor.
        ...
        //
        // Testing:
        //   static const unsigned int CRC_TABLE[256]; (bdede_crc32.cpp)
        // --------------------------------------------------------------------
      ...
      case 13: {
        ...
        //   each datum, create a 'bdede_Crc32' object using the fully-tested
      ...
      case 12: {
        ...
        // Plan:
        //   Create a set of test data with varying lengths from 0 to 5.  For
        //   each datum, create a 'bdede_Crc32' object using the two-argument
      ...
      case 11: {
        ...
        //   case, create two 'bdede_Crc32' objects ('obj' and 'objAccum').
      ...
      case 5: {
        ...
        //   bsl::ostream& operator<<(bsl::ostream&, const bdede_Crc32&);
        // --------------------------------------------------------------------
      ...
      case 3: {
        ...
        //
        // Testing:
        //   int ggg(bdede_Crc32 *object, const char *spec, int vF = 1);
        //   bdede_Crc32& gg(bdede_Crc32 *object, const char *spec);
        // --------------------------------------------------------------------
