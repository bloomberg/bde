...
//..
//  bdede_Base64Decoder(int unrecognizedIsErrorFlag);
//..
...
//-----------------------------------------------------------------------------
// [ 2] bdede_Base64Decoder(int unrecognizedIsErrorFlag);
// [ 3] ~bdede_Base64Decoder();
...
typedef bdede_Base64Decoder Obj;
...
int streamEncoder(bsl::ostream& os, bsl::istream& is)
{
    ...
    bdede_Base64Encoder converter(false);   // Do not report errors.
...
DEFINE_TEST_CASE(11) {
        ...
        V("Verify a text sample whose number of characters is 0 mod 3.");
        {
            ...
            int maxLineLength = 0;
            bdede_Base64Encoder encoder(maxLineLength);
...
DEFINE_TEST_CASE(2) {
        ...
        //
        // Testing:
        //   bdede_Base64Encoder(int unrecognizedIsErrorFlag);
        //   bool isUnrecognizedAnError() const;
        // --------------------------------------------------------------------
...
DEFINE_TEST_CASE(1) {
        ...
        {
            bdede_Base64Decoder decoder(true);  // strict mode
