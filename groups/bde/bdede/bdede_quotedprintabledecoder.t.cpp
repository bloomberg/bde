// bdede_quotedprintabledecoder.t.cpp            -*-C++-*-
...
//..
//  bdepu_Base64Encoder(int maxLineLength);
//..
...
// [ 8] bdepu_Base64Encoder();
// [ 2] bdepu_Base64Encoder(int maxLineLength);
// [ 3] ~bdepu_Base64Encoder();
...
typedef bdede_QuotedPrintableDecoder Obj;
...
void setState(bdede_QuotedPrintableDecoder *object, int state)
...
bool isState(bdede_QuotedPrintableDecoder *object, int state)
...
const char* getStateInText(bdede_QuotedPrintableDecoder *object)
{
      ...
      case 1: {
...

        {
            ...
            for (int ti = 0; ti < NUM_DATA; ++ti) {
                ...
                Obj obj(false, bdede_QuotedPrintableDecoder::BDEDE_LF_MODE);
                int numOut = -1;
                int numIn = -1;
