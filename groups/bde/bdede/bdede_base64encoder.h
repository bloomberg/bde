// bdede_base64encoder.h                                              -*-C++-*-
#ifndef INCLUDED_BDEDE_BASE64ENCODER
#define INCLUDED_BDEDE_BASE64ENCODER
...
//
//@CLASSES:
//   bdede_Base64Encoder: automata performing Base64 encoding operations
//
//@SEE_ALSO: bdede_base64decoder
//
...
///Usage Example
///-------------
// The following example shows how to use a 'bdede_Base64Encoder' object to
...
// monitoring functionality of 'bdede_Base64Encoder', the fixed buffer sizes
...
//     };
//..
// We declare a 'bdede_Base64Encoder' object 'converter', which will encode the
...
class bdede_Base64Encoder {
  ...
  private:
    // NOT IMPLEMENTED
    bdede_Base64Encoder(const bdede_Base64Encoder&);
    bdede_Base64Encoder& operator=(const bdede_Base64Encoder&);
    ...
    void append(OUTPUT_ITERATOR *out, char character, int maxLength);
        ...
        // append the specified 'value' character without the total number of
        ...
        // does not equal 'maxLength' at entry to this method.
  ...
  public:
    ...
    static bool isResidualOutput(int numBytes, int maxLineLength);
        ...
        // acceptable input to a 'bdede_Base64Decoder', and 'false' otherwise.
    ...
    bdede_Base64Encoder(int maxLineLength);
    ...
    int endConvert(OUTPUT_ITERATOR out, int *numOut, int maxNumOut = -1);
        ...
        // is negative, no limit is imposed.  Load into the (optionally)
        // specified 'numOut' the number of output bytes produced.  Return 0 on
        // success, the positive number of bytes *still* retained by this
        // encoder if the 'maxNumOut' limit was reached, and a negative value
        // otherwise.  Any retained bytes are available on a subsequent call to
        // 'endConvert'.  Once this method is called, no additional input may
        // be supplied without an intervening call to 'resetState'; once this
        // method returns a zero status, a subsequent call will place this
        // encoder in the error state, and return an error status.
...
// PRIVATE MANIPULATORS
template <typename OUTPUT_ITERATOR>
void bdede_Base64Encoder::append(OUTPUT_ITERATOR *out,
                                 char             value,
                                 int              maxLength)
{
    BSLS_ASSERT(out);
...
template <typename OUTPUT_ITERATOR>
void bdede_Base64Encoder::encode(OUTPUT_ITERATOR *out, int maxLength)
{
    BSLS_ASSERT(out);
...
// CLASS METHODS
inline
int bdede_Base64Encoder::encodedLength(int inputLength, int maxLineLength)
{
...
inline
int bdede_Base64Encoder::encodedLength(int inputLength)
{
    BSLS_ASSERT_SAFE(0 <= inputLength);
...
inline
int bdede_Base64Encoder::encodedLines(int inputLength, int maxLineLength)
{
    BSLS_ASSERT_SAFE(0 <= inputLength);
    BSLS_ASSERT_SAFE(0 <= maxLineLength);
...
inline
int bdede_Base64Encoder::encodedLines(int inputLength)
{
    BSLS_ASSERT_SAFE(0 <= inputLength);
...
inline
bool bdede_Base64Encoder::isResidualOutput(int numBytes, int maxLineLength)
{
...
inline
bdede_Base64Encoder::bdede_Base64Encoder(int maxLineLength)
: d_state(BDEDE_INITIAL_STATE)
...
// MANIPULATORS
template <typename OUTPUT_ITERATOR, typename INPUT_ITERATOR>
int bdede_Base64Encoder::convert(OUTPUT_ITERATOR out,
                                 INPUT_ITERATOR  begin,
                                 INPUT_ITERATOR  end)
{
    int dummyNumOut;
...
template <typename OUTPUT_ITERATOR>
int bdede_Base64Encoder::endConvert(OUTPUT_ITERATOR out)
{
    int dummyNumOut;
...
inline
void bdede_Base64Encoder::resetState()
{
    d_state        = BDEDE_INITIAL_STATE;
    d_outputLength = 0;
    d_lineLength   = 0;
...
// ACCESSORS
inline
bool bdede_Base64Encoder::isAcceptable() const
{
    return BDEDE_ERROR_STATE != d_state;
}

inline
bool bdede_Base64Encoder::isDone() const
{
...
inline
bool bdede_Base64Encoder::isError() const
{
    return BDEDE_ERROR_STATE == d_state;
}

inline
bool bdede_Base64Encoder::isInitialState() const
{
    return 0 == d_outputLength && BDEDE_INITIAL_STATE == d_state;
}

inline
bool bdede_Base64Encoder::isMaximal() const
{
    return BDEDE_DONE_STATE == d_state &&
...
inline
int bdede_Base64Encoder::maxLineLength() const
{
    return d_maxLineLength;
}

inline
int bdede_Base64Encoder::outputLength() const
{
