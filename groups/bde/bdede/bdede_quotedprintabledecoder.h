// bdede_quotedprintabledecoder.h                -*-C++-*-
#ifndef INCLUDED_BDEDE_QUOTEDPRINTABLEDECODER
#define INCLUDED_BDEDE_QUOTEDPRINTABLEDECODER
...
//
//@CLASSES:
//  bdede_QuotedPrintableDecoder: automata performing Quoted-Printable decoding
//
//@AUTHOR: Alex Fung (afung8)
//
//@SEE_ALSO 'bdede_QuotedPrintableEncoder'
//
...
class bdede_QuotedPrintableDecoder {
  ...
  private:
    ...
    bdede_QuotedPrintableDecoder(const bdede_QuotedPrintableDecoder&);

    bdede_QuotedPrintableDecoder& operator=(
                                          const bdede_QuotedPrintableDecoder&);
  ...
  public:
    ...
    bdede_QuotedPrintableDecoder(
        bool                                        detectError,
        bdede_QuotedPrintableDecoder::LineBreakMode lineBreakMode =
                                      bdede_QuotedPrintableDecoder::BDEDE_CRLF_MODE);
...
// CLASS METHODS
inline
const char* bdede_QuotedPrintableDecoder::lineBreakModeToAscii(
    LineBreakMode mode)
{
...
// MANIPULATORS
inline
void bdede_QuotedPrintableDecoder::reset()
{
    d_state = BDEDE_INPUT_STATE;
    d_outputLength = 0;
    d_bufferLength = 0;
...
// ACCESSORS
inline
bool bdede_QuotedPrintableDecoder::isAccepting() const
{
    return BDEDE_INPUT_STATE == d_state || BDEDE_DONE_STATE == d_state;
}

inline
bool bdede_QuotedPrintableDecoder::isDone() const
{
    return BDEDE_DONE_STATE == d_state && 0 == d_bufferLength;
}

inline
bool bdede_QuotedPrintableDecoder::isError() const
{
    return BDEDE_ERROR_STATE == d_state;
}

inline
bool bdede_QuotedPrintableDecoder::isInitialState() const
{
    return BDEDE_INPUT_STATE == d_state && 0 == d_outputLength;
}

inline
bool bdede_QuotedPrintableDecoder::isMaximal() const
{
    return false;
}

inline
bool bdede_QuotedPrintableDecoder::isUnrecognizedAnError() const
{
    return d_unrecognizedIsErrorFlag;
}

inline
bdede_QuotedPrintableDecoder::LineBreakMode
bdede_QuotedPrintableDecoder::lineBreakMode() const
{
    return d_lineBreakMode;
}

inline
int bdede_QuotedPrintableDecoder::numOutputPending() const
{
    return d_bufferLength;
}

inline
int bdede_QuotedPrintableDecoder::outputLength() const
{
