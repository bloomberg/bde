...
//-----------------------------------------------------------------------------
// [ 2] bdec_PtrQueue(bslma_Allocator *ba = 0);
// [11] bdec_PtrQueue(unsigned int iLen, *ba = 0);
// [11] bdec_PtrQueue(int iLen, void *iVal, *ba = 0);
// [17] bdec_PtrQueue(const InitialCapacity& ne, *ba = 0);
// [11] bdec_PtrQueue(const void **sa, int ne, *ba = 0);
// [ 7] bdec_PtrQueue(const bdec_PtrQueue& original, *ba = 0);
// [ 2] ~bdec_PtrQueue();
// [ 9] bdec_PtrQueue& operator=(const bdec_PtrQueue& rhs);
// [14] float& operator[](int index);
// [13] void append(void *item);
// [13] void append(const bdec_PtrQueue& sa);
// [13] void append(const bdec_PtrQueue& sa, int si, int ne);
// [14] float& back();
// [14] float& front();
// [13] void insert(int di, void *item);
// [13] void insert(int di, const bdec_PtrQueue& sa);
// [13] void insert(int di, const bdec_PtrQueue& sa, int si, int ne);
// [13] void popBack();
// [13] void popFront();
...
// [14] void replace(int di, const bdec_PtrQueue& sa, int si, int ne);
...
//
// [ 6] operator==(const bdec_PtrQueue&, const bdec_PtrQueue&);
// [ 6] operator!=(const bdec_PtrQueue&, const bdec_PtrQueue&);
// [ 5] operator<<(ostream&, const bdec_PtrQueue&);
// [10] operator>>(bdex_InStream&, bdec_PtrQueue&);
// [10] operator<<(bdex_OutStream&, const bdec_PtrQueue&);
//-----------------------------------------------------------------------------
// [ 1] BREATHING TEST
// [18] USAGE EXAMPLE
...
// [ 3] int ggg(bdec_PtrQueue *object, const char *spec, int vF = 1);
// [ 3] bdec_PtrQueue& gg(bdec_PtrQueue* object, const char *spec);
// [ 8] bdec_PtrQueue   g(const char *spec);
...
typedef bdec_PtrQueue<void> Obj;
...
// appended to the 'bdec_PtrQueue' object.  A tilde ('~') indicates that
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 17: {
        ...
        //
        // Testing:
        //   bdec_PtrQueue(const InitialCapacity& ne, *ba = 0);
        ...
        if (verbose) cout <<
            "\nTesting 'bdec_PtrQueue(capacity, ba)' Constructor" << endl;
...
#undef NL
      ...
      case 14: {
        ...
        //   void replace(int di, const bdec_PtrQueue& sa, int si, int ne);
      ...
      case 13: {
        ...
        //   void append(const bdec_PtrQueue& sa);
        //   void append(const bdec_PtrQueue& sa, int si, int ne);
        //
        ...
        //   void insert(int di, const bdec_PtrQueue& sa);
        //   void insert(int di, const bdec_PtrQueue& sa, int si, int ne);
        //
      ...
      case 11: {
        ...
        //
        // Testing:
        //   bdec_PtrQueue(unsigned int iLen, *ba = 0);
        //   bdec_PtrQueue(int iLen, void *iVal, *ba = 0);
        //   bdec_PtrQueue(const void **sa, int ne, *ba = 0);
        // --------------------------------------------------------------------
      ...
      case 10: {
        ...
        // The 'bdec_PtrQueue' does not need a streaming function.
        // --------------------------------------------------------------------
      ...
      case 9: {
        ...
        //
        // Testing:
        //   bdec_PtrQueue& operator=(const bdec_PtrQueue& rhs);
        // --------------------------------------------------------------------
      ...
      case 8: {
        ...
        //
        // Testing:
        //   bdec_PtrQueue g(const char *spec);
        // --------------------------------------------------------------------
      ...
      case 7: {
        ...
        //
        // Testing:
        //   bdec_PtrQueue(const bdec_PtrQueue& original, *ba = 0);
        // --------------------------------------------------------------------
      ...
      case 6: {
        ...
        //
        // Testing:
        //   operator==(const bdec_PtrQueue&, const bdec_PtrQueue&);
        //   operator!=(const bdec_PtrQueue&, const bdec_PtrQueue&);
        // --------------------------------------------------------------------
      ...
      case 5: {
        ...
        //
        // Testing:
        //   operator<<(ostream&, const bdec_PtrQueue&);
        // --------------------------------------------------------------------
      ...
      case 3: {
        ...
        //
        // Testing:
        //   bdec_PtrQueue& gg(bdec_PtrQueue* object, const char *spec);
        //   int ggg(bdec_PtrQueue *object, const char *spec, int vF = 1);
        //   void rotate(Obj *object, int numPositions);
        //   void stretch(Obj *object, int size);
        //   void stretchRemoveAll(Obj *object, int size);
      ...
      case 2: {
        ...
        //
        // Testing:
        //   bdec_PtrQueue(bslma_Allocator *ba);
        //   ~bdec_PtrQueue();
        //   void removeAll();
