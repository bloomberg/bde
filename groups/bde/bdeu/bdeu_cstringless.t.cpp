...
// [ 2] bdeu_CStringLess()
// [ 2] bdeu_CStringLess(const bdeu_CStringLess)
// [ 2] ~bdeu_CStringLess()
// [ 2] bdeu_CStringLess& operator=(const bdeu_CStringLess&)
// ----------------------------------------------------------------------------
// [ 1] BREATHING TEST
// [ 7] USAGE EXAMPLE
// [ 4] Standard typedefs
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:
      ...
      case 6: {
        ...
        //
        // Concerns:
        //: 1 class 'bdeu_CStringLess' does not increase the size of an object
        ...
        struct DerivedInts : bdeu_CStringLess {
            int a;
            int b;
        };

        struct IntsWithMember {
            bdeu_CStringLess dummy;
            int              a;
            int              b;
        };
      ...
      case 5: {
        ...
        ASSERT((bslalg::HasTrait<bdeu_CStringLess,
      ...
      case 4: {
        ...
        ASSERT((bslmf::IsSame<bool, bdeu_CStringLess::result_type>::VALUE));
        ASSERT((bslmf::IsSame<const char *,
                             bdeu_CStringLess::first_argument_type>::VALUE));
        ASSERT((bslmf::IsSame<const char *,
                             bdeu_CStringLess::second_argument_type>::VALUE));
      ...
      case 3: {
        ...
        //
        // Concerns:
        //: 1 Objects of type 'bdeu_CStringLess' can be invokes as a binary
        ...
        const bdeu_CStringLess compare = bdeu_CStringLess();
      ...
      case 2: {
        ...
        //:   'bdeu_CStringLess' object to leave scope and be destroyed. (C-6)
        //
        // Testing:
        //   bdeu_CStringLess()
        //   bdeu_CStringLess(const bdeu_CStringLess)
        //   ~bdeu_CStringLess()
        //   bdeu_CStringLess& operator=(const bdeu_CStringLess&)
        // --------------------------------------------------------------------
