...
//
//@CLASSES:
//   bdeu_CharType: namespace for pure (read-only) procedures on characters
//
//@AUTHOR: John Lakos (jlakos)
//
//@SEE_ALSO: bdeu_string
//
...
struct bdeu_CharType {
  ...
  public:
    ...
    static bool isCategory(char character, bdeu_CharType::Category category);
    ...
    static const char *stringCategory(bdeu_CharType::Category category);
        // Return a null-terminated string consisting of all characters in
    ...
    static int numCategory(bdeu_CharType::Category category);
        // Return the number of characters in the specified 'category'.

                        // *** miscellaneous ***

    static const char *toAscii(bdeu_CharType::Category category);
...
inline
const char *bdeu_CharType::stringUpper()
{
    return s_upperString_p;
}

inline
const char *bdeu_CharType::stringLower()
{
    return s_lowerString_p;
}

inline
const char *bdeu_CharType::stringAlpha()
{
    return s_alphaString_p;
}

inline
const char *bdeu_CharType::stringDigit()
{
    return s_digitString_p;
}

inline
const char *bdeu_CharType::stringXdigit()
{
    return s_xdigitString_p;
}

inline
const char *bdeu_CharType::stringAlnum()
{
    return s_alnumString_p;
}

inline
const char *bdeu_CharType::stringSpace()
{
    return s_spaceString_p;
}

inline
const char *bdeu_CharType::stringPrint()
{
    return s_printString_p;
}

inline
const char *bdeu_CharType::stringGraph()
{
    return s_graphString_p;
}

inline
const char *bdeu_CharType::stringPunct()
{
    return s_punctString_p;
}

inline
const char *bdeu_CharType::stringCntrl()
{
    return s_cntrlString_p;
}

inline
const char *bdeu_CharType::stringAscii()
{
    return s_asciiString_p;
}

inline
const char *bdeu_CharType::stringIdent()
{
    return s_identString_p;
}

inline
const char *bdeu_CharType::stringAlund()
{
    return s_alundString_p;
}

inline
const char *bdeu_CharType::stringAll()
{
    return s_allString_p;
}

inline
const char *bdeu_CharType::stringNone()
{
    return s_noneString_p;
}

inline
const char *bdeu_CharType::stringCategory(bdeu_CharType::Category category)
{
...
inline
int bdeu_CharType::numUpper()
{
    return s_upperCount;
}

inline
int bdeu_CharType::numLower()
{
    return s_lowerCount;
}

inline
int bdeu_CharType::numAlpha()
{
    return s_alphaCount;
}

inline
int bdeu_CharType::numDigit()
{
    return s_digitCount;
}

inline
int bdeu_CharType::numXdigit()
{
    return s_xdigitCount;
}

inline
int bdeu_CharType::numAlnum()
{
    return s_alnumCount;
}

inline
int bdeu_CharType::numSpace()
{
    return s_spaceCount;
}

inline
int bdeu_CharType::numPrint()
{
    return s_printCount;
}

inline
int bdeu_CharType::numGraph()
{
    return s_graphCount;
}

inline
int bdeu_CharType::numPunct()
{
    return s_punctCount;
}

inline
int bdeu_CharType::numCntrl()
{
    return s_cntrlCount;
}

inline
int bdeu_CharType::numAscii()
{
    return s_asciiCount;
}

inline
int bdeu_CharType::numIdent()
{
    return s_identCount;
}

inline
int bdeu_CharType::numAlund()
{
    return s_alundCount;
}

inline
int bdeu_CharType::numAll()
{
    return s_allCount;
}

inline
int bdeu_CharType::numNone()
{
    return s_noneCount;
}

inline
int bdeu_CharType::numCategory(bdeu_CharType::Category category)
{
...
inline
const char *bdeu_CharType::toAscii(bdeu_CharType::Category category)
{
    return s_categoryName_p[category];
}

inline
char bdeu_CharType::toLower(char input)
{
    return s_toLower_p[static_cast<unsigned char>(input)];
}

inline
char bdeu_CharType::toUpper(char input)
{
...
inline
int bdeu_CharType::maxSupportedBdexVersion()
{
    return 1;
}

template <class STREAM>
STREAM& bdeu_CharType::bdexStreamIn(STREAM&                   stream,
                                     bdeu_CharType::Category& value,
                                     int                      version)
{
    if (stream) {
        switch (version) {
          case 1: {
            ...
            if (stream) {
                if (0 <= newValue
                 && newValue < bdeu_CharType::BDEU_NUM_CATEGORIES) {
                    value = bdeu_CharType::Category(newValue);
                }
                else {
...
template <class STREAM>
STREAM& bdeu_CharType::bdexStreamOut(STREAM&                  stream,
                                      bdeu_CharType::Category value,
                                      int                     version)
{
    switch (version) {
...
STREAM& streamIn(STREAM&                  stream,
                 ...
                 int                      version)
{
    return bdeu_CharType::bdexStreamIn(stream, value, version);
}
...
inline
int maxSupportedVersion(bdeu_CharType::Category)
{
    return bdeu_CharType::maxSupportedBdexVersion();
}
...
STREAM& streamOut(STREAM&                        stream,
                  const bdeu_CharType::Category& value,
                  int                            version)
{
    return bdeu_CharType::bdexStreamOut(stream, value, version);
}
