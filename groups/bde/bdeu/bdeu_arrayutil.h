...
//
//@DESCRIPTION: This component provides a utility 'struct', 'bdeu_ArrayUtil',
...
template <class TYPE, bsl::size_t LENGTH>
inline
TYPE *bdeu_ArrayUtil::begin(TYPE (&array)[LENGTH])
{
    return array;
}
...
template <class TYPE, bsl::size_t LENGTH>
inline
TYPE *bdeu_ArrayUtil::end(TYPE (&array)[LENGTH])
{
    return array + LENGTH;
}
...
template <class TYPE, bsl::size_t LENGTH>
inline
bsl::reverse_iterator<TYPE *> bdeu_ArrayUtil::rbegin(TYPE (&array)[LENGTH])
{
...
template <class TYPE, bsl::size_t LENGTH>
inline
bsl::reverse_iterator<TYPE *> bdeu_ArrayUtil::rend(TYPE (&array)[LENGTH])
{
...
template <class TYPE, bsl::size_t LENGTH>
inline
bsl::size_t bdeu_ArrayUtil::size(TYPE (&)[LENGTH])
{
    return LENGTH;
}
...
template <class TYPE, bsl::size_t LENGTH>
inline
bsl::size_t bdeu_ArrayUtil::length(TYPE (&)[LENGTH])
{
    return LENGTH;
}
