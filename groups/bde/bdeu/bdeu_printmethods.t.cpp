...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 7: {
        ...
        //
        // Testing:
        //   bdeu_PrintMethods::print(..., const TYPE&, ...);
        // --------------------------------------------------------------------
        ...
        if (verbose) cout << "\nUsing 'BDEU_STREAM_OPERATOR'." << endl;
        {
            ...
            if (veryVerbose) cout << "\tUsing 'int'." << bsl::endl;
            {
                ...
                for (int i = 0; i < NUM_DATA; ++i) {
                    ...
                    ostream& ret = bdeu_PrintMethods::print(ss,
                                                            VALUE,
                                                            LEVEL,
                                                            SPACES_PER_LEVEL);
      ...
      case 5: {
        ...
        //
        // Testing:
        //   bdeu_PrintMethods_Imp<TYPE, BDEU_PAIR>::print(...);
        // --------------------------------------------------------------------
      ...
      case 2: {
        ...
        //
        // Testing:
        //   bdeu_PrintMethods::print(..., const vector<char, ALLOC>, ...);
        // --------------------------------------------------------------------
        ...
        if (verbose) cout << "\nTesting null hex conversion." << endl;
        {
            ...
            ostream& ret = bdeu_PrintMethods::print(ss, VALUE, 0, -1);
      ...
      case 1: {
        ...
        if (verbose) cout << "\nWith Fundamental Types." << endl;
        {
            if (veryVerbose) cout << "\tWith 'int'." << endl;
            {
                ...
                bdeu_PrintMethods::print(ss, VALUE, 0, -1);
        ...
        if (verbose) cout << "\nWith 'print' Method." << endl;
        {
            ...
            bdeu_PrintMethods::print(ss, VALUE, LEVEL, SPACES_PER_LEVEL);
