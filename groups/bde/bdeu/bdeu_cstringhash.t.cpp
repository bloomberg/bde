...
// [ 2] bdeu_CStringHash()
// [ 2] bdeu_CStringHash(const bdeu_CStringHash)
// [ 2] ~bdeu_CStringHash()
// [ 2] bdeu_CStringHash& operator=(const bdeu_CStringHash&)
// ----------------------------------------------------------------------------
// [ 1] BREATHING TEST
// [ 7] USAGE EXAMPLE
// [ 4] Standard typedefs
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:
      ...
      case 6: {
        ...
        //
        // Concerns:
        //: 1 class 'bdeu_CStringHash' does not increase the size of an object
        ...
        struct DerivedInts : bdeu_CStringHash {
            int a;
            int b;
        };

        struct IntsWithMember {
            bdeu_CStringHash dummy;
            int              a;
            int              b;
        };
      ...
      case 5: {
        ...
        ASSERT((bslalg::HasTrait<bdeu_CStringHash,
      ...
      case 2: {
        ...
        //:   'bdeu_CStringHash' object to leave scope and be destroyed. (C-6)
        //
        // Testing:
        //   bdeu_CStringHash()
        //   bdeu_CStringHash(const bdeu_CStringHash)
        //   ~bdeu_CStringHash()
        //   bdeu_CStringHash& operator=(const bdeu_CStringHash&)
        // --------------------------------------------------------------------
