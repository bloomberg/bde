// bdeut_nullableallocatedvalue.t.cpp    -*-C++-*-
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 8: {
...

        {
            ...
            typedef bdeut_NullableAllocatedValue<ValueType> Obj;
      ...
      case 7: {
        ...
        //
        // Testing:
        //   bdeut_NullableAllocatedValue(const bdeut_NullableAllocatedValue&);
        // --------------------------------------------------------------------
      ...
      case 6: {
        ...
        if (verbose) cout << "\nUsing 'bdeut_NullableAllocatedValue<int>."
                          << endl;
        {
            typedef int                                     ValueType;
            typedef bdeut_NullableAllocatedValue<ValueType> Obj;
        ...
        if (verbose) cout << "\nUsing bdeut_NullableAllocatedValue<"
                          << "bsl::string>." << endl;
        {
            typedef bsl::string                             ValueType;
            typedef bdeut_NullableAllocatedValue<ValueType> Obj;
