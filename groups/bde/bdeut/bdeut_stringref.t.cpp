...
// CREATORS
// [ 2] bdeut_StringRef();
// [ 2] bdeut_StringRef(const char *begin, const char *end);
// [ 2] bdeut_StringRef(const char *begin, int length);
// [ 2] bdeut_StringRef(const char *begin);
// [ 2] bdeut_StringRef(const bsl::string& begin);
// [ 2] bdeut_StringRef(const native_std::string& begin);
// [ 2] bdeut_StringRef(const bdeut_StringRef& original);
// [ 2] ~bdeut_StringRef();
//
// MANIPULATORS
// [ 2] bdeut_StringRef& operator=(const bdeut_StringRef& rhs);
// [ 6] void clear();
...
// [ 8] bsl::hash<BloombergLP::bdeut_StringRef>
//--------------------------------------------------------------------------
// [ 1] BREATHING TEST
// [ 9] USAGE
//=============================================================================
...
// the string that is bound to a specified 'bdeut_StringRef'.  The function
// delegates the work to the 'bsl::count' STL algorithm.  This is made possible
// by the STL-compatible iterators provided by 'bdeut_StringRef' via the
...
// 'bdeut_StringRef' argument.  First we verify tolerance of null pointers and
// 'bdeut_StringRef' objects that are unbound:
//..
...
//..
      ...
      case 8: {
        ...
        //
        // Testing:
        //   bsl::hash<BloombergLP::bdeut_StringRef>
        // --------------------------------------------------------------------
      ...
      case 4: {
        ...
        //
        // Testing:
        //   operator<<(ostream&, const bdeut_StringRef& string);
        // --------------------------------------------------------------------
