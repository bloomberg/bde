...
//
//@CLASSES:
//   bdefr_Vfunc3: reference-counted base class with an allocator
//
...
// class for all internal representations of the 'bdef_Vfunc3' family of
...
// reflect the number of 'bdef_Vfunc3' objects (envelopes) or other partial
...
// reaches '0') without any information about the details of the 'bdefr_Vfunc3'
...
// 'bdefr_Vfunc3' to declare the destructor 'private', thereby limiting object
...
//   class ConcreteDerivedClass : public bdefr_Vfunc3 <A1, A2, A3> {
//     public:
//       ConcreteDerivedClass(bslma_Allocator *basicAllocator)
//       : bdefr_Vfunc3(basicAllocator) { }
//
...
// common (instantiated) 'bdefr_Vfunc3<A1, A2, A3>' template object:
//..
//   template <class A1, class A2, class A3>
//   class EnvelopeClass {
//       // Provide an object that encapsulates a 'bdefr_Vfunc3' object.
//
//       bdefr_Vfunc3<A1, A2, A3> *d_rep_p;
//           // polymorphic functor representation
//
//     public:
//       // CREATORS
//       EnvelopeClass(bdefr_Vfunc3<A1, A2, A3> *rep) : d_rep_p(rep)
...
//           // representation using 'deleteObject' method of 'bdefr_Vfunc3'
//           // class.
//       {
...
//   typedef bdefr_Vfunc3<int, int, int> Obj;
...
class bdefr_Vfunc3 {
    ...
    // facilitates the use of 'bdefr_Vfunc3' as a reference-counted letter
    // class in the envelope-letter pattern.  'deleteObject' is used to destroy
    // and deallocate the concrete objects derived from 'bdefr_Vfunc3', which
  ...
  private:
    bdefr_Vfunc3(const bdefr_Vfunc3&);                  // not implemented
    bdefr_Vfunc3& operator=(const bdefr_Vfunc3&);       // not implemented

  protected:
    virtual ~bdefr_Vfunc3();
  ...
  public:
    // CLASS METHODS
    static void deleteObject(bdefr_Vfunc3 *object);
    ...
    // CREATORS
    bdefr_Vfunc3(bslma_Allocator *basicAllocator);
...
// PROTECTED CREATORS
template <class A1, class A2, class A3>
inline bdefr_Vfunc3<A1, A2, A3>::~bdefr_Vfunc3()
{
}
...
template <class A1, class A2, class A3>
inline
void bdefr_Vfunc3<A1, A2, A3>::deleteObject(bdefr_Vfunc3 *object)
{
    object->~bdefr_Vfunc3();
...
// CREATORS
template <class A1, class A2, class A3>
inline bdefr_Vfunc3<A1, A2, A3>::bdefr_Vfunc3(bslma_Allocator *basicAllocator)
: d_count(0)
...
// MANIPULATORS
template <class A1, class A2, class A3>
inline void bdefr_Vfunc3<A1, A2, A3>::increment()
{
    ++d_count;  // Warning: not guaranteed to be an atomic operation.
}

template <class A1, class A2, class A3>
inline int bdefr_Vfunc3<A1, A2, A3>::decrement()
{
