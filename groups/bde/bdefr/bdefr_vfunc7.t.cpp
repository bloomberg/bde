...
//                              Overview
//                              --------
// 'bdefr_Vfunc7' is an abstract class that provides a pure virtual function
...
//
// We will use the API provided by bdema_TestAllocator to verify that
// 'deleteObject' deallocates memory as expected.
//
// In order to test 'bdefr_Vfunc7' we have to implement a concrete class
...
//
//-----------------------------------------------------------------------------
// [ 2] bdefr_Vfunc7<A1-7>(bdema_Allocator *ba);
// [ 2] void increment();
// [ 2] int decrement();
// [ 2] void execute(c_A1-7&) const;
// [ 2] ~bdefr_Vfunc7<A1-7>();
// [ 2] static void deleteObject(bdefr_Vfunc7 *object);
//-----------------------------------------------------------------------------
...
template <class A1, class A2, class A3, class A4, class A5, class A6,
          class A7>
class ConcreteDerivedClass : public bdefr_Vfunc7 <A1, A2, A3, A4, A5, A6, A7> {
  public:
    ...
    virtual void execute(const A1& argument1, const A2& argument2,
        ...
        //
        // This function tests that the 'execute' method of 'bdefr_Vfunc7' is
...
class EnvelopeClass {
  ...
  public:
    ...
    ~EnvelopeClass()
        ...
        // representation using 'deleteObject' method of 'bdefr_Vfunc7' class.
    {
        if (0 == d_rep_p->decrement()) {
            bdefr_Vfunc7<A1, A2, A3, A4, A5, A6, A7>::deleteObject(
                                                                     d_rep_p);
        }
    }
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      case 3: {
                          ...
                          << "=====================" << endl;
        {
            ...
            typedef ConcreteDerivedClass<int, int, int, int,
                                         int, int, int> DerivedObj;
            typedef bdefr_Vfunc7<int, int, int, int,
                                 int, int, int> Obj;
      ...
      case 2: {
        ...
        //
        // Plan
        //   1.   Create a class instance that uses a 'bdema_TestAllocator' to
        ...
        //        memory was freed by 'bdema_TestAllocator'.
        //   4.   Invoke 'execute' method.  Verify that the global counter was
        //        incremented.
        //
        // Testing:
        //   bdefr_Vfunc7<A1-7>(bdema_Allocator *ba);
        //   void increment();
        //   int decrement();
