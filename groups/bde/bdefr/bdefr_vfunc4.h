...
//
//@CLASSES:
//   bdefr_Vfunc4: reference-counted base class with an allocator
//
...
// class for all internal representations of the 'bdef_Vfunc4' family of
...
// reflect the number of 'bdef_Vfunc4' objects (envelopes) or other partial
...
// reaches '0') without any information about the details of the 'bdefr_Vfunc4'
...
// 'bdefr_Vfunc4' to declare the destructor 'private', thereby limiting object
...
// common (instantiated) 'bdefr_Vfunc4<A1, A2, A3, A4>' template object:
//..
//   template <class A1, class A2, class A3, class A4>
//   class EnvelopeClass {
...
//           // representation using 'deleteObject' method of 'bdefr_Vfunc4'
//           // class.
//       {
//           if (0 == d_rep_p->decrement()) {
//               bdefr_Vfunc4<A1, A2, A3, A4>::
...
class bdefr_Vfunc4 {
    ...
    // facilitates the use of 'bdefr_Vfunc4' as a reference-counted letter
    // class in the envelope-letter pattern.  'deleteObject' is used to destroy
    // and deallocate the concrete objects derived from 'bdefr_Vfunc4', which
  ...
  private:
    bdefr_Vfunc4(const bdefr_Vfunc4&);                  // not implemented
    bdefr_Vfunc4& operator=(const bdefr_Vfunc4&);       // not implemented

  protected:
    virtual ~bdefr_Vfunc4();
  ...
  public:
    ...
    // CREATORS
    bdefr_Vfunc4(bslma_Allocator *basicAllocator);
...
// PROTECTED CREATORS
template <class A1, class A2, class A3, class A4>
inline bdefr_Vfunc4<A1, A2, A3, A4>::~bdefr_Vfunc4()
{
}
...
template <class A1, class A2, class A3, class A4>
inline
void bdefr_Vfunc4<A1, A2, A3, A4>::deleteObject(bdefr_Vfunc4 *object)
{
    object->~bdefr_Vfunc4();
...
// MANIPULATORS
template <class A1, class A2, class A3, class A4>
inline void bdefr_Vfunc4<A1, A2, A3, A4>::increment()
{
    ++d_count;  // Warning: not guaranteed to be an atomic operation.
}

template <class A1, class A2, class A3, class A4>
inline int bdefr_Vfunc4<A1, A2, A3, A4>::decrement()
{
