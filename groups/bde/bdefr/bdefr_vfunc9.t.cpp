...
//                              Overview
//                              --------
// 'bdefr_Vfunc9' is an abstract class that provides a pure virtual function
...
//
// In order to test 'bdefr_Vfunc9' we have to implement a concrete class
...
//
//-----------------------------------------------------------------------------
// [ 2] bdefr_Vfunc9<A1-9>(bdema_Allocator *ba);
// [ 2] void increment();
// [ 2] int decrement();
// [ 2] void execute(c_A1-9&) const;
// [ 2] ~bdefr_Vfunc9<A1-9>();
// [ 2] static void deleteObject(bdefr_Vfunc9 *object);
//-----------------------------------------------------------------------------
...
class ConcreteDerivedClass : public bdefr_Vfunc9 <A1, A2, A3, A4, A5, A6,
                                                  A7, A8, A9> {
  public:
    ...
    virtual void execute(const A1& argument1, const A2& argument2,
        ...
        //
        // This function tests that the 'execute' method of 'bdefr_Vfunc9' is
...
class EnvelopeClass {
  ...
  public:
    ...
    ~EnvelopeClass()
        ...
        // representation using 'deleteObject' method of 'bdefr_Vfunc9' class.
    {
        if (0 == d_rep_p->decrement()) {
            bdefr_Vfunc9<A1, A2, A3, A4, A5, A6, A7, A8, A9>::deleteObject(
                                                                     d_rep_p);
        }
    }
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      case 3: {
                          ...
                          << "=====================" << endl;
        {
            ...
            typedef ConcreteDerivedClass<int, int, int, int, int, int,
                                         int, int, int> DerivedObj;
            typedef bdefr_Vfunc9<int, int, int, int, int, int,
                                 int, int, int> Obj;
      ...
      case 2: {
        ...
        //
        // Testing:
        //   bdefr_Vfunc9<A1-9>(bdema_Allocator *ba);
        //   void increment();
        //   int decrement();
