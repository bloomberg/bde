...
//                              Overview
//                              --------
// 'bdefr_Vfunc2' is an abstract class that provides a pure virtual function
...
//
// In order to test 'bdefr_Vfunc2' we have to implement a concrete class
...
//
//-----------------------------------------------------------------------------
// [ 2] bdefr_Vfunc2<A1, A2>(bslma_Allocator *ba);
// [ 2] void increment();
// [ 2] int decrement();
// [ 2] void execute(const A1& argument1, const A2& argument2) const;
// [ 2] ~bdefr_Vfunc2<A1, A2>();
// [ 2] static void deleteObject(bdefr_Vfunc2 *object);
//-----------------------------------------------------------------------------
...
class ConcreteDerivedClass : public bdefr_Vfunc2 <A1, A2> {
  public:
    ...
    virtual void execute(const A1& argument1, const A2& argument2) const
        ...
        //
        // This function tests that the 'execute' method of 'bdefr_Vfunc2' is
...
class EnvelopeClass {
  ...
  public:
    ...
    ~EnvelopeClass()
        ...
        // representation using 'deleteObject' method of 'bdefr_Vfunc2' class.
    {
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 2: {
        ...
        //
        // Testing:
        //   bdefr_Vfunc2<A1, A2>(bslma_Allocator *ba);
        //   void increment();
        //   int decrement();
