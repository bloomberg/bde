...
#define INCLUDED_BDEFR_VFUNC7

//@PURPOSE: Provide a common reference-counted base class representation.
//
//@CLASSES:
//   bdefr_Vfunc7: reference-counted base class with an allocator
//
//@AUTHOR: John Lakos (jlakos)
//
//@DESCRIPTION: This component defines the common (partially implemented) base
// class for all internal representations of the 'bdef_Vfunc7' family of
...
// reflect the number of 'bdef_Vfunc7' objects (envelopes) or other partial
...
// reaches '0') without any information about the details of the 'bdefr_Vfunc7'
...
// 'bdefr_Vfunc7' to declare the destructor 'private', thereby limiting object
...
//             class A7>
//   class ConcreteDerivedClass : public bdefr_Vfunc7 <A1, A2, A3, A4, A5,
//                                                       A6, A7> {
//     public:
//       ConcreteDerivedClass(bdema_Allocator *basicAllocator)
//       : bdefr_Vfunc7(basicAllocator) { }
//
...
// common (instantiated) 'bdefr_Vfunc7<A1, A2, A3, A4, A5, A6, A7>' template
// object:
//..
//   template <class A1, class A2, class A3, class A4, class A5, class A6,
//             class A7>
//   class EnvelopeClass {
//       // Provide an object that encapsulates a 'bdefr_Vfunc7' object.
//
//       bdefr_Vfunc7<A1, A2, A3, A4, A5, A6, A7> *d_rep_p;
//           // polymorphic functor representation
//
//     public:
//       // CREATORS
//       EnvelopeClass(bdefr_Vfunc7<A1, A2, A3, A4, A5, A6, A7> *rep) :
//           d_rep_p(rep)
...
//           // representation using 'deleteObject' method of 'bdefr_Vfunc7'
//           // class.
//       {
//           if (0 == d_rep_p->decrement()) {
//               bdefr_Vfunc7<A1, A2, A3, A4, A5, A6, A7>::
...
//   typedef bdefr_Vfunc7<int, int, int, int, int, int, int> Obj;
...
//       EnvelopeClass<int, int, int, int, int, int, int> env0(x);
//                                                           //    1   0     0
//       // The reference counter is 1.
//       env0(1, 2, 3, 4, 5, 6, 7);  assert(1 == executeUsageCounter);
//                                                           //    1   1     0
//       {
//           EnvelopeClass<int, int, int, int, int, int, int> env1(x);
//                                                           //    2   1     0
//           // The reference counter is 2.
//           env1(1, 2, 3, 4, 5, 6, 7);  assert(2 == executeUsageCounter);
//                                                           //    2   2     0
//       }
//       // The reference counter is 1.
...
class bdefr_Vfunc7 {
    ...
    // facilitates the use of 'bdefr_Vfunc7' as a reference-counted letter
    // class in the envelope-letter pattern.  'deleteObject' is used to destroy
    // and deallocate the concrete objects derived from 'bdefr_Vfunc7', which
  ...
  private:
    bdefr_Vfunc7(const bdefr_Vfunc7&);                  // not implemented
    bdefr_Vfunc7& operator=(const bdefr_Vfunc7&);       // not implemented

  protected:
    virtual ~bdefr_Vfunc7();
  ...
  public:
    // CLASS METHODS
    static void deleteObject(bdefr_Vfunc7 *object);
    ...
    // CREATORS
    bdefr_Vfunc7(bdema_Allocator *basicAllocator);
...
template <class A1, class A2, class A3, class A4, class A5, class A6,
          class A7>
inline bdefr_Vfunc7<A1, A2, A3, A4, A5, A6, A7>::~bdefr_Vfunc7()
{
}
...
template <class A1, class A2, class A3, class A4, class A5, class A6,
          class A7>
inline
void bdefr_Vfunc7<A1, A2, A3, A4, A5, A6, A7>::
                                             deleteObject(bdefr_Vfunc7 *object)
{
    object->~bdefr_Vfunc7();
...
template <class A1, class A2, class A3, class A4, class A5, class A6,
          class A7>
inline void bdefr_Vfunc7<A1, A2, A3, A4, A5, A6, A7>::increment()
{
...
template <class A1, class A2, class A3, class A4, class A5, class A6,
          class A7>
inline int bdefr_Vfunc7<A1, A2, A3, A4, A5, A6, A7>::decrement()
{
