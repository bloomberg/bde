...
//
//@CLASSES:
//   bdefr_Vfunc1: reference-counted base class with an allocator
//
...
// class for all internal representations of the 'bdef_Vfunc1' family of
...
// reflect the number of 'bdef_Vfunc1' objects (envelopes) or other partial
...
// reaches '0') without any information about the details of the 'bdefr_Vfunc1'
...
// 'bdefr_Vfunc1' to declare the destructor 'private', thereby limiting object
...
// common (instantiated) 'bdefr_Vfunc1<A1>' template object:
//..
//   template <class A1>
//   class EnvelopeClass {
//       // Provide an object that encapsulates a 'bdefr_Vfunc1' object.
//
//       bdefr_Vfunc1<A1> *d_rep_p;
...
//           // representation using 'deleteObject' method of 'bdefr_Vfunc1'
//           // class.
//       {
...
class bdefr_Vfunc1 {
    ...
    // facilitates the use of 'bdefr_Vfunc1' as a reference-counted letter
    // class in the envelope-letter pattern.  'deleteObject' is used to destroy
    // and deallocate the concrete objects derived from 'bdefr_Vfunc1', which
  ...
  private:
    ...
    bdefr_Vfunc1& operator=(const bdefr_Vfunc1&);       // not implemented

  protected:
    virtual ~bdefr_Vfunc1();
...
// PROTECTED CREATORS
template <class A1>
inline bdefr_Vfunc1<A1>::~bdefr_Vfunc1()
{
}
...
template <class A1>
inline
void bdefr_Vfunc1<A1>::deleteObject(bdefr_Vfunc1 *object)
{
    object->~bdefr_Vfunc1();
...
// MANIPULATORS
template <class A1>
inline void bdefr_Vfunc1<A1>::increment()
{
    ++d_count;  // Warning: not guaranteed to be an atomic operation.
}

template <class A1>
inline int bdefr_Vfunc1<A1>::decrement()
{
