...
//                              Overview
//                              --------
// 'bdefr_Vfunc8' is an abstract class that provides a pure virtual function
...
//
// In order to test 'bdefr_Vfunc8' we have to implement a concrete class
...
//
//-----------------------------------------------------------------------------
// [ 2] bdefr_Vfunc8<A1-8>(bdema_Allocator *ba);
// [ 2] void increment();
// [ 2] int decrement();
// [ 2] void execute(c_A1-8&) const;
// [ 2] ~bdefr_Vfunc8<A1-8>();
// [ 2] static void deleteObject(bdefr_Vfunc8 *object);
//-----------------------------------------------------------------------------
...
template <class A1, class A2, class A3, class A4, class A5, class A6,
          class A7, class A8>
class ConcreteDerivedClass : public bdefr_Vfunc8 <A1, A2, A3, A4, A5, A6,
                                                  A7, A8> {
  public:
    ...
    virtual void execute(const A1& argument1, const A2& argument2,
        ...
        //
        // This function tests that the 'execute' method of 'bdefr_Vfunc8' is
...
class EnvelopeClass {
  ...
  public:
    ...
    ~EnvelopeClass()
        ...
        // representation using 'deleteObject' method of 'bdefr_Vfunc8' class.
    {
        if (0 == d_rep_p->decrement()) {
            bdefr_Vfunc8<A1, A2, A3, A4, A5, A6, A7, A8>::deleteObject(
                                                                     d_rep_p);
        }
    }
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      case 3: {
                          ...
                          << "=====================" << endl;
        {
            ...
            typedef ConcreteDerivedClass<int, int, int, int, int,
                                         int, int, int> DerivedObj;
            typedef bdefr_Vfunc8<int, int, int, int, int,
                                 int, int, int> Obj;
      ...
      case 2: {
        ...
        //
        // Testing:
        //   bdefr_Vfunc8<A1-8>(bdema_Allocator *ba);
        //   void increment();
        //   int decrement();
