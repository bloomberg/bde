...
//                              Overview
//                              --------
// 'bdefr_Vfunc5' is an abstract class that provides a pure virtual function
...
//
// In order to test 'bdefr_Vfunc5' we have to implement a concrete class
...
//
//-----------------------------------------------------------------------------
// [ 2] bdefr_Vfunc5<A1-5>(bslma_Allocator *ba);
// [ 2] void increment();
// [ 2] int decrement();
// [ 2] void execute(c_A1-5&) const;
// [ 2] ~bdefr_Vfunc5<A1-5>();
// [ 2] static void deleteObject(bdefr_Vfunc5 *object);
//-----------------------------------------------------------------------------
...
class ConcreteDerivedClass : public bdefr_Vfunc5 <A1, A2, A3, A4, A5> {
  public:
    ...
    virtual void execute(const A1& argument1, const A2& argument2,
        ...
        //
        // This function tests that the 'execute' method of 'bdefr_Vfunc5' is
...
class EnvelopeClass {
  ...
  public:
    ...
    ~EnvelopeClass()
        ...
        // representation using 'deleteObject' method of 'bdefr_Vfunc5' class.
    {
        if (0 == d_rep_p->decrement()) {
            bdefr_Vfunc5<A1, A2, A3, A4, A5>::deleteObject(
                                                                     d_rep_p);
        }
    }
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 2: {
        ...
        //
        // Testing:
        //   bdefr_Vfunc5<A1-5>(bslma_Allocator *ba);
        //   void increment();
        //   int decrement();
        //   void execute(c_A1-5&) const;
