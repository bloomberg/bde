// bdefr_vfunc2.h               -*-C++-*-
#ifndef INCLUDED_BDEFR_VFUNC2
#define INCLUDED_BDEFR_VFUNC2
...
//
//@CLASSES:
//   bdefr_Vfunc2: reference-counted base class with an allocator
//
...
// class for all internal representations of the 'bdef_Vfunc2' family of
...
// reflect the number of 'bdef_Vfunc2' objects (envelopes) or other partial
...
// reaches '0') without any information about the details of the 'bdefr_Vfunc2'
...
// 'bdefr_Vfunc2' to declare the destructor 'private', thereby limiting object
...
//   class ConcreteDerivedClass : public bdefr_Vfunc2 <A1, A2> {
//     public:
//       ConcreteDerivedClass(bslma_Allocator *basicAllocator)
//       : bdefr_Vfunc2(basicAllocator) { }
//
...
// common (instantiated) 'bdefr_Vfunc2<A1, A2>' template object:
//..
//   template <class A1, class A2>
//   class EnvelopeClass {
//       // Provide an object that encapsulates a 'bdefr_Vfunc2' object.
//
//       bdefr_Vfunc2<A1, A2> *d_rep_p;  // polymorphic functor representation
//
//     public:
//       // CREATORS
//       EnvelopeClass(bdefr_Vfunc2<A1, A2> *rep) : d_rep_p(rep)
...
//           // representation using 'deleteObject' method of 'bdefr_Vfunc2'
//           // class.
//       {
...
//   typedef bdefr_Vfunc2<int, int> Obj;
...
//       EnvelopeClass<int, int> env0(x);                    //    1   0     0
//       // The reference counter is 1.
//       env0(3, 4);  assert(1 == executeUsageCounter);      //    1   1     0
//       {
//           EnvelopeClass<int, int> env1(x);                //    2   1     0
//           // The reference counter is 2.
//           env1(5, 7);  assert(2 == executeUsageCounter);  //    2   1     0
//       }
//       // The reference counter is 1.
...
class bdefr_Vfunc2 {
    ...
    // facilitates the use of 'bdefr_Vfunc2' as a reference-counted letter
    // class in the envelope-letter pattern.  'deleteObject' is used to destroy
    // and deallocate the concrete objects derived from 'bdefr_Vfunc2', which
  ...
  private:
    bdefr_Vfunc2(const bdefr_Vfunc2&);                  // not implemented
    bdefr_Vfunc2& operator=(const bdefr_Vfunc2&);       // not implemented

  protected:
    virtual ~bdefr_Vfunc2();
  ...
  public:
    // CLASS METHODS
    static void deleteObject(bdefr_Vfunc2 *object);
        // Destroy this object.  This method is declared 'protected' to allow
        // derivation from this class but to disallow direct destruction of the
        // derived concrete object.  Clients must use the static class method
        // 'deleteObject' to destroy and deallocate the derived-class object
        // from its base class pointer.

    // CREATORS
    bdefr_Vfunc2(bslma_Allocator *basicAllocator);
...
// PROTECTED CREATORS
template <class A1, class A2>
inline bdefr_Vfunc2<A1, A2>::~bdefr_Vfunc2()
{
}
...
template <class A1, class A2>
inline
void bdefr_Vfunc2<A1, A2>::deleteObject(bdefr_Vfunc2 *object)
{
    object->~bdefr_Vfunc2();
...
// CREATORS
template <class A1, class A2>
inline bdefr_Vfunc2<A1, A2>::bdefr_Vfunc2(bslma_Allocator *basicAllocator)
: d_count(0)
...
// MANIPULATORS
template <class A1, class A2>
inline void bdefr_Vfunc2<A1, A2>::increment()
{
    ++d_count;  // Warning: not guaranteed to be an atomic operation.
}

template <class A1, class A2>
inline int bdefr_Vfunc2<A1, A2>::decrement()
{
