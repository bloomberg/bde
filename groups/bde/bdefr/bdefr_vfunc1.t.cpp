...
//                              Overview
//                              --------
// 'bdefr_Vfunc1' is an abstract class that provides a pure virtual function
...
//
// In order to test 'bdefr_Vfunc1' we have to implement a concrete class
...
//
//-----------------------------------------------------------------------------
// [ 2] bdefr_Vfunc1<A1>(bslma_Allocator *ba);
// [ 2] void increment();
// [ 2] int decrement();
// [ 2] void execute(c_A1&) const;
// [ 2] ~bdefr_Vfunc1<A1>();
// [ 2] static void deleteObject(bdefr_Vfunc1 *object);
//-----------------------------------------------------------------------------
...
class ConcreteDerivedClass : public bdefr_Vfunc1 <A1> {
  public:
    ...
    virtual void execute(const A1& argument1) const
        ...
        //
        // This function tests that the 'execute' method of 'bdefr_Vfunc1' is
...
template <class A1>
class EnvelopeClass {
    // Provide an object that encapsulates a 'bdefr_Vfunc1' object.

    bdefr_Vfunc1<A1> *d_rep_p;  // polymorphic functor representation

  public:
    // CREATORS
    EnvelopeClass(bdefr_Vfunc1<A1> *rep) : d_rep_p(rep)
    ...
    ~EnvelopeClass()
        ...
        // representation using 'deleteObject' method of 'bdefr_Vfunc1' class.
    {
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 2: {
        ...
        //
        // Testing:
        //   bdefr_Vfunc1<A1>(bslma_Allocator *ba);
        //   void increment();
        //   int decrement();
        //   void execute(c_A1&) const;
        //   static void deleteObject(bdefr_Vfunc1 *object);
        //   ~bdefr_Vfunc1<A1>();
        // --------------------------------------------------------------------
