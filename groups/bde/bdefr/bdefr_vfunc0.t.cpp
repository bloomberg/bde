...
//                              Overview
//                              --------
// 'bdefr_Vfunc0' is an abstract class that provides a pure virtual function
...
//
// In order to test 'bdefr_Vfunc0' we have to implement a concrete class
...
//
//-----------------------------------------------------------------------------
// [ 2] bdefr_Vfunc0(bslma_Allocator *ba);
// [ 2] void increment();
// [ 2] int decrement();
// [ 2] void execute() const;
// [ 2] ~bdefr_Vfunc0();
// [ 2] static void deleteObject(bdefr_Vfunc0 *object);
//-----------------------------------------------------------------------------
...
class ConcreteDerivedClass : public bdefr_Vfunc0 {
  public:
    ...
    virtual void execute() const
        ...
        //
        // This function tests that the 'execute' method of 'bdefr_Vfunc0' is
...
class EnvelopeClass {
  ...
  public:
    ...
    ~EnvelopeClass()
        ...
        // representation using 'deleteObject' method of 'bdefr_Vfunc0' class.
    {
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 2: {
        ...
        //
        // Testing:
        //   bdefr_Vfunc0(bslma_Allocator *ba);
        //   void increment();
        //   int decrement();
        //   void execute() const;
