...
#include <bsl_c_stdio.h>     // sprintf(), snprintf() [NOT <cstdio>, which does
    ...
    #define BDES_INT64_TEST__NO_64_BIT_CONSTANTS 1
#endif
...
char *hex64(char *buffer, bdes_Int64::Uint64 value)
...
void printBits(bdes_Int64::Uint64 value)
...
int main(int argc, char *argv[]) {
    ...
    switch (test) { case 0:
      case 4: {
        ...
        //
        // Testing:
        //   operator<<(ostream&, const bdes_Int64::Uint64&);
        // --------------------------------------------------------------------
        ...
        typedef bdes_Int64::Uint64 T;
        typedef bdes_Int64::Int64  S;
...
#if !defined(BDES_INT64_TEST__NO_64_BIT_CONSTANTS)
      ...
      case 3: {
        ...
        //
        // Testing:
        //   operator<<(ostream&, const bdes_Int64::Int64&);
        // --------------------------------------------------------------------
