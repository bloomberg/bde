...
//                             TEST PLAN
//-----------------------------------------------------------------------------
// bdes_ObjectBuffer is a simple template class that provides a few
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      case 3: {
        // --------------------------------------------------------------------
        // USAGE EXAMPLE
        //   Simple example showing how one might use bdem_ObjectBuffer
        //
        // Testing:
        //   USAGE EXAMPLE
        // --------------------------------------------------------------------
      ...
      case 2: {
        ...
        //
        // Plan:
        //   - Create a 'bdes_ObjectBuffer' objects with different sizes and
        //     alignments.
...
#       define TEST_METHODS(TYPE) \
            do { \
                bdes_ObjectBuffer<TYPE> buff; \
                const bdes_ObjectBuffer<TYPE>& BUFF = buff; \
