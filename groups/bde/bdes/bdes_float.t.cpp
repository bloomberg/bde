...
//..
    ...
    ASSERT(bdes_Float::BDES_POSITIVE_INFINITY == bdes_Float::classifyFine(bn));
//..
...
// This macro tests a function 'bdes_Float::f(input)', where 'f' is the name
// of one of the class functions in 'bdes_Float'.  We assume that there is a
