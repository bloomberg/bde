...
// [ 1] enum Month { ... };
// [ 1] enum { BDET_LENGTH = ... };
// [ 1] static const char *toAscii(bdet_Month::Month value);
//
// [ 1] operator<<(ostream&, bdet_Month::Month rhs);
// [ 2] static STREAM& bdexStreamIn(STREAM&, bdet_Month::Month&, int);
// [ 2] static STREAM& bdexStreamOut(STREAM&, bdet_Month::Month, int);
//=============================================================================
...
// First, create a variable 'month' of type 'bdet_Month::Month' and initialize
// it to the value 'bdet_Month::APRIL'.
//..
        bdet_Month::Month month = bdet_Month::BDET_APRIL;
//..
// Next, store its representation in a variable 'rep' of type 'const char*'.
//..
        const char *rep = bdet_Month::toAscii(month);
...
//..
      ...
      case 1: {
        // --------------------------------------------------------------------
        // Testing:
        //   static const char *toAscii(bdet_Month::Month month);
        //   ostream& operator<<(ostream& output, bdet_Month::Month month);
        // --------------------------------------------------------------------
