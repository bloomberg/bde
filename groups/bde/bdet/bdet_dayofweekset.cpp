// bdet_dayofweekset.cpp                                              -*-C++-*-
#include <bdet_dayofweekset.h>

#include <bdes_ident.h>
BDES_IDENT_RCSID(bdet_dayofweekset_cpp,"$Id$ $CSID$")
...
static const bdet_DayOfWeek::Day DAY_OF_WEEK_ARRAY[8] = {
    ...
    bdet_DayOfWeek::BDET_SATURDAY
                         ...
                         // ----------------------------
                         // class bdet_DayOfWeekSet_Iter
                         // ----------------------------

// CLASS DATA
const bdet_DayOfWeek::Day *bdet_DayOfWeekSet_Iter::s_dayOfWeekArray_p =
                                                             DAY_OF_WEEK_ARRAY;

// CREATORS
bdet_DayOfWeekSet_Iter::bdet_DayOfWeekSet_Iter(int data, int index)
: d_data((char)data)
, d_index((char)index)
{
...
// MANIPULATORS
bdet_DayOfWeekSet_Iter& bdet_DayOfWeekSet_Iter::operator++()
{
    do {
        ++d_index;
    } while (d_index < 8 && !((1 << d_index) & d_data));
...
bdet_DayOfWeekSet_Iter& bdet_DayOfWeekSet_Iter::operator--()
{
    ...
    return *this;
                         ...
                         // -----------------------
                         // class bdet_DayOfWeekSet
                         // -----------------------

// ACCESSORS
bsl::ostream& bdet_DayOfWeekSet::print(bsl::ostream& stream,
                                       int           level,
