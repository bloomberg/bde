...
#define INCLUDED_BDET_EPOCHUTIL
...
//
//@CLASSES:
//   bdet_EpochUtil: non-primitive pure procedures on epoch-related conversions
//
//@AUTHOR: Arthur Chiu (achiu21)
//
//@SEE_ALSO: bdet_datetime, bdet_datetimeinterval, bdet_timeinterval
//
//@DESCRIPTION: This component defines a namespace, 'bdet_EpochUtil', providing
...
// as 'bsl::time_t', 'bdet_EpochUtil::TimeT64', 'bdet_TimeInterval', and
...
///- - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// The following snippet of code demonstrates how to use 'bdet_EpochUtil' to
...
//
//  bdet_EpochUtil::convertFromTimeT(&datetime, myStdTime); // conversion never
//                                                          // fails
//
...
//  bsl::time_t myStdTime = 946684800;  // Midnight, January 1, 2000
//
//  bsl::cout << bdet_EpochUtil::convertFromTimeT(myStdTime) << bsl::endl;
//..
// The code above produces the following on 'stdout':
//..
//  01JAN2000_00:00:00.000
...
//
//  int status = bdet_EpochUtil::convertToTimeT(&myStdTime, datetime);
//
//  if (0 != status) {
...
//  bdet_Datetime datetime;
//
//  bdet_EpochUtil::convertFromTimeInterval(&datetime, timeInterval);
//
//  bsl::cout << datetime << bsl::endl;
//..
// The code above produces the following on 'stdout':
...
//
//  int status = bdet_EpochUtil::convertToTimeInterval(&timeInterval,
//                                                     datetime);
...
//  bdet_Datetime datetime;
//
//  bdet_EpochUtil::convertFromDatetimeInterval(&datetime, datetimeInterval);
//
//  bsl::cout << datetime << bsl::endl;
//..
// The code above produces the following on 'stdout':
...
//
//  bdet_EpochUtil::convertToDatetimeInterval(&datetimeInterval, datetime);
//      // Works when 'datetime >= epoch()'.
//
//  if (0 != status) {
//      bsl::cout << "Conversion Failure" << bsl::endl;
...
// CLASS METHODS
inline
const bdet_Datetime& bdet_EpochUtil::epoch()
{
    return *s_epoch_p;
}
...
inline
bsl::time_t bdet_EpochUtil::convertToTimeT(const bdet_Datetime& datetime)
{
...
inline
int bdet_EpochUtil::convertToTimeT(bsl::time_t          *result,
                                   const bdet_Datetime&  datetime)
{
    ...
    if (bdet_Time() != datetime.time() && datetime < *s_epoch_p) {
        return 1;                                                     // RETURN
    }
...
inline
bdet_Datetime bdet_EpochUtil::convertFromTimeT(bsl::time_t time)
{
...
inline
void bdet_EpochUtil::convertFromTimeT(bdet_Datetime *result, bsl::time_t time)
{
    BSLS_ASSERT_SAFE(result);
...
inline
bdet_EpochUtil::TimeT64
bdet_EpochUtil::convertToTimeT64(const bdet_Datetime& datetime)
{
...
inline
void bdet_EpochUtil::convertToTimeT64(TimeT64              *result,
                                      const bdet_Datetime&  datetime)
{
    BSLS_ASSERT_SAFE(result);

    *result = (TimeT64)bdet_EpochUtil::convertToTimeT64(datetime);
}

inline
bdet_Datetime bdet_EpochUtil::convertFromTimeT64(TimeT64 time)
{
...
inline
int bdet_EpochUtil::convertFromTimeT64(bdet_Datetime *result, TimeT64 time)
{
    BSLS_ASSERT_SAFE(result);
...
inline
bdet_TimeInterval bdet_EpochUtil::convertToTimeInterval(
                                                 const bdet_Datetime& datetime)
{
...
inline
int bdet_EpochUtil::convertToTimeInterval(bdet_TimeInterval    *result,
                                          const bdet_Datetime&  datetime)
{
    BSLS_ASSERT_SAFE(result);
...
inline
bdet_Datetime bdet_EpochUtil::convertFromTimeInterval(
                                         const bdet_TimeInterval& timeInterval)
{
    bdet_Datetime datetime(*s_epoch_p);
...
inline
void bdet_EpochUtil::convertFromTimeInterval(
                                        bdet_Datetime            *result,
                                        const bdet_TimeInterval&  timeInterval)
{
    BSLS_ASSERT_SAFE(result);
...
inline
bdet_DatetimeInterval bdet_EpochUtil::convertToDatetimeInterval(
                                                 const bdet_Datetime& datetime)
{
...
inline
int bdet_EpochUtil::convertToDatetimeInterval(bdet_DatetimeInterval *result,
                                              const bdet_Datetime&   datetime)
{
    BSLS_ASSERT_SAFE(result);
...
inline
bdet_Datetime bdet_EpochUtil::convertFromDatetimeInterval(
                                 const bdet_DatetimeInterval& datetimeInterval)
{
...
inline
void bdet_EpochUtil::convertFromDatetimeInterval(
                                bdet_Datetime                *result,
                                const bdet_DatetimeInterval&  datetimeInterval)
{
    BSLS_ASSERT_SAFE(result);
