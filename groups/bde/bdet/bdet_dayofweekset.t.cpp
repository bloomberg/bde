...
// CREATORS
// [ 2] bdet_DayOfWeekSet();
// [ 7] bdet_DayOfWeekSet(const bdet_DayOfWeekSet& original);
// [ 2] ~bdet_DayOfWeekSet();
//
// MANIPULATORS
// [ 9] bdet_DayOfWeekSet& operator=(const bdet_DayOfWeekSet& rhs);
// [14] bdet_DayOfWeekSet& operator|=(const bdet_DayOfWeekSet& rhs);
// [14] bdet_DayOfWeekSet& operator&=(const bdet_DayOfWeekSet& rhs);
// [14] bdet_DayOfWeekSet& operator^=(const bdet_DayOfWeekSet& rhs);
// [14] bdet_DayOfWeekSet& operator-=(const bdet_DayOfWeekSet& rhs);
...
//
// ACCESSORS
// [13] bool areMembers(const bdet_DayOfWeekSet& set) const;
...
//
// FREE OPERATORS
// [14] bdet_DayOfWeekSet  operator~(const bdet_DayOfWeekSet& set);
// [14] operator|(const bdet_DayOfWeekSet&, const bdet_DayOfWeekSet&);
// [14] operator&(const bdet_DayOfWeekSet&, const bdet_DayOfWeekSet&);
// [14] operator^(const bdet_DayOfWeekSet&, const bdet_DayOfWeekSet&);
// [14] operator-(const bdet_DayOfWeekSet&, const bdet_DayOfWeekSet&);
// [ 6] operator==(const bdet_DayOfWeekSet&, const bdet_DayOfWeekSet&);
// [ 6] operator!=(const bdet_DayOfWeekSet&, const bdet_DayOfWeekSet&);
// [ 5] operator<<(ostream&, const bdet_DayOfWeekSet&);
// ----------------------------------------------------------------------------
// [ 4] bdet_DayOfWeekSet_Iter();
// [ 4] bdet_DayOfWeekSet_Iter(int data, int index);
// [ 4] bdet_DayOfWeekSet_Iter(const bdet_DayOfWeekSet_Iter& original);
// [ 4] ~bdet_DayOfWeekSet_Iter();
// [ 4] bdet_DayOfWeekSet_Iter& operator=(c bdet_DayOfWeekSet_Iter&);
// [ 4] bdet_DayOfWeekSet_Iter& operator++();
// [ 4] bdet_DayOfWeekSet_Iter& operator--();
...
// [15] USAGE EXAMPLE
// [ 3] bdet_DayOfWeekSet& gg(bdet_DayOfWeekSet* obj, const char *spec);
// [ 3] int ggg(bdet_DayOfWeekSet *object, const char *spec, int vF = 1);
// [ 8] bdet_DayOfWeekSet g(const char *spec);
// ============================================================================
...
// added to the 'bdet_DayOfWeekSet' object.  A tilde ('~') indicates that
...
int ggg(bdet_DayOfWeekSet *object, const char *spec, int verboseFlag = 1)
...
bdet_DayOfWeekSet& gg(bdet_DayOfWeekSet *object, const char *spec)
...
//..
      ...
      case 14: {
        ...
        //   operator|(const bdet_DayOfWeekSet&, const bdet_DayOfWeekSet&);
        //   operator&(const bdet_DayOfWeekSet&, const bdet_DayOfWeekSet&);
        //   operator^(const bdet_DayOfWeekSet&, const bdet_DayOfWeekSet&);
        //   operator-(const bdet_DayOfWeekSet&, const bdet_DayOfWeekSet&);
        // --------------------------------------------------------------------
...
#undef NL
            ...
            for (int ti = 0; ti < NUM_DATA; ++ti) {
                ...
                ostringstream os;  X.print(os, IND, SPL);
      ...
      case 5: {
        ...
        //   value.  Compare the contents of the 'ostrstream' with the literal
        //   expected output format.
        //
        // Testing:
        //   operator<<(ostream&, const bdet_DayOfWeekSet&);
        // --------------------------------------------------------------------
      ...
      case 4: {
        ...
        //   ~bdet_DayOfWeekSet_Iter();
        //   bdet_DayOfWeekSet_Iter& operator=(const bdet_DayOfWeekSet_Iter&);
      ...
      case 3: {
        ...
        //
        // Testing:
        //   bdet_DayOfWeekSet& gg(bdet_DayOfWeekSet* obj, const char *spec);
        //   int ggg(bdet_DayOfWeekSet *object, const char *spec, int vF = 1);
        // --------------------------------------------------------------------
