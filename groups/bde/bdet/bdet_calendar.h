...
//
//@CLASSES:
//  bdet_Calendar: fast repository for accessing weekend/holiday information
//
//@SEE_ALSO: bdet_packedcalendar
//
...
// 'bdet_Calendar', that represents weekend and holiday information over a
// *valid* *range* of dates.  A 'bdet_Calendar' is an approximation to the
// same *mathematical* type and is capable of representing the same subset of
// *mathematical* values as a 'bdet_PackedCalendar'.  A 'bdet_Calendar'
// object (representing the same *mathematical* value) can be constructed
// directly from a reference to a non-modifiable 'bdet_PackedCalendar' object,
// and a reference to a non-modifiable 'bdet_PackedCalendar' is readily
// accessible from any 'bdes_Calendar' object.
//
// But unlike 'bdet_PackedCalendar', which is optimized for spatial
// efficiency, 'bdet_Calendar' is designed to be especially efficient at
// determining whether a given 'bdet_Date' value (within the valid range
// for a particular 'bdet_Calendar' object) is a business day -- i.e., not a
...
// compared to a binary search in a 'bdet_PackedCalendar' representing the
// same calendar value.
//
...
// set of holiday codes associated with an arbitrary date in a 'bdet_Calendar'
...
///-------------------------------------------
// 'bdet_Calendar' supports 'O[1]' (i.e., constant-time) determination of
...
// data represented in the underlying 'bdet_PackedCalendar' be maintained in a
...
// 'bdet_PackedCalendar', which can then be used efficiently to
// *value-construct* the desired 'bdet_Calendar' object.  See the
// component-level doc for 'bdet_packedcalendar' for its performance
// guarantees.
//
// All methods of the 'bdet_Calendar' are exception-safe, but in general
...
// representing New York Bank settlement days) to 'bdet_PackedCalendar'
...
class bdet_Calendar {
    ...
    // DATA
    bdet_PackedCalendar  d_packedCalendar;   // the packed calendar object,
    ...
    // FRIENDS
    friend bool operator==(const bdet_Calendar&, const bdet_Calendar&);
    friend bool operator!=(const bdet_Calendar&, const bdet_Calendar&);
  ...
  public:
    // TRAITS
    BSLALG_DECLARE_NESTED_TRAITS(bdet_Calendar,
                                 bslalg::TypeTraitUsesBslmaAllocator);

    // PUBLIC TYPES
    typedef bdet_Calendar_BusinessDayConstIter BusinessDayConstIterator;

    typedef bdet_PackedCalendar::HolidayConstIterator
                                               HolidayConstIterator;

    typedef bdet_PackedCalendar::HolidayCodeConstIterator
                                               HolidayCodeConstIterator;

    typedef bsl::reverse_iterator<BusinessDayConstIterator>
                                               BusinessDayConstReverseIterator;

    typedef bdet_PackedCalendar::HolidayConstReverseIterator
                                               HolidayConstReverseIterator;

    typedef bdet_PackedCalendar::HolidayCodeConstReverseIterator
                                               HolidayCodeConstReverseIterator;

    typedef bdet_PackedCalendar::WeekendDaysTransition
                                            WeekendDaysTransition;

    typedef bdet_PackedCalendar::WeekendDaysTransitionConstIterator
    ...
    // CREATORS
    explicit bdet_Calendar(bslma::Allocator *basicAllocator = 0);
        // Create an empty calendar having no valid range.  Optionally specify
        // a 'basicAllocator' used to supply memory.  If 'basicAllocator' is 0,
        // the currently installed default allocator is used.

    bdet_Calendar(const bdet_Date&  firstDate,
    ...
    explicit bdet_Calendar(const bdet_PackedCalendar&  packedCalendar,
                           bslma::Allocator           *basicAllocator = 0);
    ...
    bdet_Calendar(const bdet_Calendar&  original,
                  bslma::Allocator     *basicAllocator = 0);
    ...
    void intersectBusinessDays(const bdet_Calendar& other);
    ...
    void intersectNonBusinessDays(const bdet_Calendar& other);
    ...
    void unionBusinessDays(const bdet_Calendar& other);
    ...
    void unionNonBusinessDays(const bdet_Calendar& other);
    ...
    const bdet_PackedCalendar& packedCalendar() const;
        ...
        // 'bdet_PackedCalendar', which represents the same (mathematical)
...
// FREE OPERATORS
bool operator==(const bdet_Calendar& lhs, const bdet_Calendar& rhs);
...
bsl::ostream& operator<<(bsl::ostream& stream, const bdet_Calendar& calendar);
    // Write the value of the specified 'calendar' to the specified output
    // 'stream', and return a reference to the modifiable 'stream'.

// FREE FUNCTIONS
void swap(bdet_Calendar& a, bdet_Calendar& b);
...
class bdet_Calendar_BusinessDayConstIter {
    ...
    // to the business days in a 'bdet_Calendar' object.
    ...
    // FRIENDS
    friend class bdet_Calendar;
    friend bool operator==(const bdet_Calendar_BusinessDayConstIter&,
                           const bdet_Calendar_BusinessDayConstIter&);
    friend bool operator!=(const bdet_Calendar_BusinessDayConstIter&,
                           const bdet_Calendar_BusinessDayConstIter&);

  private:
    // PRIVATE CREATORS
    bdet_Calendar_BusinessDayConstIter(
  ...
  public:
    ...
    // CREATORS
    bdet_Calendar_BusinessDayConstIter(
                           const bdet_Calendar_BusinessDayConstIter& original);
    ...
    // MANIPULATORS
    bdet_Calendar_BusinessDayConstIter& operator=(
                                const bdet_Calendar_BusinessDayConstIter& rhs);
    ...
    bdet_PackedCalendar_DateRef operator*() const;
        // Return a 'bdet_PackedCalendar_DateRef' object that contains the
...
// FREE OPERATORS
bool operator==(const bdet_Calendar_BusinessDayConstIter& lhs,
                const bdet_Calendar_BusinessDayConstIter& rhs);
...
bdet_Calendar_BusinessDayConstIter operator++(
                            bdet_Calendar_BusinessDayConstIter& iterator, int);
...
// ACCESSORS
inline
bool bdet_Calendar::isInRange(const bdet_Date& date) const
{
...
// CLASS METHODS
inline
int bdet_Calendar::maxSupportedBdexVersion()
{
    return bdet_PackedCalendar::maxSupportedBdexVersion();
}

// MANIPULATORS
inline
void bdet_Calendar::intersectBusinessDays(const bdet_PackedCalendar& other)
{
...
inline
void bdet_Calendar::intersectBusinessDays(const bdet_Calendar& other)
{
...
inline
void
bdet_Calendar::intersectNonBusinessDays(const bdet_PackedCalendar& other)
{
...
inline
void bdet_Calendar::intersectNonBusinessDays(const bdet_Calendar& other)
{
    intersectNonBusinessDays(other.d_packedCalendar);
}

inline
void bdet_Calendar::unionBusinessDays(const bdet_Calendar& other)
{
    unionBusinessDays(other.d_packedCalendar);
}

inline
void bdet_Calendar::unionNonBusinessDays(const bdet_Calendar& other)
{
    unionNonBusinessDays(other.d_packedCalendar);
}

inline
void bdet_Calendar::removeAll()
{
...
inline
void bdet_Calendar::removeHolidayCode(const bdet_Date& date, int holidayCode)
{
    d_packedCalendar.removeHolidayCode(date, holidayCode);
}

template <class STREAM>
STREAM& bdet_Calendar::bdexStreamIn(STREAM& stream, int version)
{

    // The 'bdet_Calendar' delegates its streaming operations (and the format
    // version) to 'bdet_PackedCalendar' as both types can represent the exact
...
// ACCESSORS
template <class STREAM>
STREAM& bdet_Calendar::bdexStreamOut(STREAM& stream, int version) const
{
...
inline
bdet_Calendar::WeekendDaysTransitionConstIterator
bdet_Calendar::beginWeekendDaysTransitions() const
{
...
inline
bdet_Calendar::WeekendDaysTransitionConstIterator
bdet_Calendar::endWeekendDaysTransitions() const
{
    return d_packedCalendar.endWeekendDaysTransitions();
}

inline
int bdet_Calendar::numWeekendDaysTransitions() const
{
...
bdet_Calendar::beginBusinessDays(const bdet_Date& date) const
{
...
inline
bdet_Calendar::HolidayCodeConstIterator
bdet_Calendar::beginHolidayCodes(const HolidayConstIterator& iter) const
{
...
inline
bdet_Calendar::HolidayCodeConstIterator
bdet_Calendar::beginHolidayCodes(const bdet_Date& date) const
{
    BSLS_ASSERT_SAFE(isInRange(date));
...
inline
bdet_Calendar::HolidayConstIterator bdet_Calendar::beginHolidays() const
{
    return d_packedCalendar.beginHolidays();
}

inline
bdet_Calendar::HolidayConstIterator
bdet_Calendar::beginHolidays(const bdet_Date& date) const
{
    BSLS_ASSERT_SAFE(isInRange(date));
...
inline
bdet_Calendar::BusinessDayConstIterator
bdet_Calendar::endBusinessDays() const
{
...
inline
bdet_Calendar::BusinessDayConstIterator
bdet_Calendar::endBusinessDays(const bdet_Date& date) const
{
    BSLS_ASSERT_SAFE(isInRange(date));
...
inline
bdet_Calendar::HolidayCodeConstIterator
bdet_Calendar::endHolidayCodes(const HolidayConstIterator& iter) const
{
...
inline
bdet_Calendar::HolidayCodeConstIterator
bdet_Calendar::endHolidayCodes(const bdet_Date& date) const
{
    BSLS_ASSERT_SAFE(isInRange(date));
...
inline
bdet_Calendar::HolidayConstIterator bdet_Calendar::endHolidays() const
{
...
inline
bdet_Calendar::HolidayConstIterator
bdet_Calendar::endHolidays(const bdet_Date& date) const
{
    BSLS_ASSERT_SAFE(isInRange(date));
...
inline
const bdet_Date& bdet_Calendar::firstDate() const
{
    return d_packedCalendar.firstDate();
}

inline
bool bdet_Calendar::isBusinessDay(const bdet_Date& date) const
{
    BSLS_ASSERT_SAFE(isInRange(date));
...
inline
bool bdet_Calendar::isHoliday(const bdet_Date& date) const
{
    BSLS_ASSERT_SAFE(isInRange(date));
...
inline
bool bdet_Calendar::isNonBusinessDay(const bdet_Date& date) const
{
    BSLS_ASSERT_SAFE(isInRange(date));
...
inline
bool bdet_Calendar::isWeekendDay(bdet_DayOfWeek::Day dayOfWeek) const
{
    return d_packedCalendar.isWeekendDay(dayOfWeek);
}

inline
bool bdet_Calendar::isWeekendDay(const bdet_Date& date) const
{
    return d_packedCalendar.isWeekendDay(date);
}

inline
const bdet_Date& bdet_Calendar::lastDate() const
{
    return d_packedCalendar.lastDate();
}

inline
int bdet_Calendar::length() const
{
    return d_nonBusinessDays.length();
}

inline
int bdet_Calendar::numBusinessDays() const
{
    return d_nonBusinessDays.numSet0();
}

inline
int bdet_Calendar::numHolidayCodes(const bdet_Date& date) const
{
    BSLS_ASSERT_SAFE(isInRange(date));
...
inline
int bdet_Calendar::numHolidays() const
{
    return d_packedCalendar.numHolidays();
}

inline
int bdet_Calendar::numNonBusinessDays() const
{
    return d_nonBusinessDays.numSet1();
}

inline
int bdet_Calendar::numWeekendDaysInRange() const
{
    return d_packedCalendar.numWeekendDaysInRange();
}

inline
const bdet_PackedCalendar& bdet_Calendar::packedCalendar() const
{
    return d_packedCalendar;
}

inline
bsl::ostream& bdet_Calendar::print(bsl::ostream& stream,
                                   int           level,
...
inline
bdet_Calendar::BusinessDayConstReverseIterator
bdet_Calendar::rbeginBusinessDays() const
{
...
inline
bdet_Calendar::BusinessDayConstReverseIterator
bdet_Calendar::rbeginBusinessDays(const bdet_Date& date) const
{
    BSLS_ASSERT_SAFE(isInRange(date));
...
inline
bdet_Calendar::HolidayCodeConstReverseIterator
bdet_Calendar::rbeginHolidayCodes(const bdet_Date& date) const
{
    BSLS_ASSERT_SAFE(isInRange(date));
...
inline
bdet_Calendar::HolidayCodeConstReverseIterator
bdet_Calendar::rbeginHolidayCodes(const HolidayConstIterator& iter) const
{
    return d_packedCalendar.rbeginHolidayCodes(iter);
}

inline
bdet_Calendar::HolidayConstReverseIterator
bdet_Calendar::rbeginHolidays() const
{
...
inline
bdet_Calendar::HolidayConstReverseIterator
bdet_Calendar::rbeginHolidays(const bdet_Date& date) const
{
    BSLS_ASSERT_SAFE(isInRange(date));
...
inline
bdet_Calendar::BusinessDayConstReverseIterator
bdet_Calendar::rendBusinessDays() const
{
...
inline
bdet_Calendar::BusinessDayConstReverseIterator
bdet_Calendar::rendBusinessDays(const bdet_Date& date) const
{
    BSLS_ASSERT_SAFE(isInRange(date));
...
inline
bdet_Calendar::HolidayCodeConstReverseIterator
bdet_Calendar::rendHolidayCodes(const bdet_Date& date) const
{
    BSLS_ASSERT_SAFE(isInRange(date));
...
inline
bdet_Calendar::HolidayCodeConstReverseIterator
bdet_Calendar::rendHolidayCodes(const HolidayConstIterator& iter) const
{
...
inline
bdet_Calendar::HolidayConstReverseIterator
bdet_Calendar::rendHolidays() const
{
...
inline
bdet_Calendar::HolidayConstReverseIterator
bdet_Calendar::rendHolidays(const bdet_Date& date) const
{
    BSLS_ASSERT_SAFE(isInRange(date));
...
bdet_Calendar_BusinessDayConstIter operator++(
                             bdet_Calendar_BusinessDayConstIter& iterator, int)
{
    bdet_Calendar_BusinessDayConstIter tmp(iterator);
    ++iterator;
    return tmp;
}
...
bdet_Calendar_BusinessDayConstIter::operator*() const
{
    return bdet_PackedCalendar_DateRef(d_firstDate + d_currentOffset);
}
...
inline
bool
operator==(const bdet_Calendar_BusinessDayConstIter& lhs,
           const bdet_Calendar_BusinessDayConstIter& rhs)
{
