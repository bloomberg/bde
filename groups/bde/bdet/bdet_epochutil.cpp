// bdet_epochutil.cpp                                                 -*-C++-*-
#include <bdet_epochutil.h>

#include <bdes_ident.h>
BDES_IDENT_RCSID(bdet_epochutil_cpp,"$Id$ $CSID$")
...
const bdet_Datetime *bdet_EpochUtil::s_epoch_p = (bdet_Datetime *)&lucky;

#ifndef NDEBUG  // Supererogatory check in debug mode only.

static inline
int iGuessedRight() {
    BSLS_ASSERT(bdet_Datetime(1970, 1, 1) == bdet_EpochUtil::epoch());
    return 0;
}
