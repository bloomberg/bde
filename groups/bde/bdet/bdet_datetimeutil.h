// bdet_datetimeutil.h                                                -*-C++-*-
#ifndef INCLUDED_BDET_DATETIMEUTIL
#define INCLUDED_BDET_DATETIMEUTIL
...
//
//@CLASSES:
//   bdet_DatetimeUtil: non-primitive pure procedures on 'bdet_Datetime'
//
//@AUTHOR: John Lakos (jlakos)
//
//@SEE_ALSO: bdet_datetime, bdet_datetimeinterval
//
//@DESCRIPTION: This component provides non-primitive operations on
// 'bdet_Datetime' objects.  In particular, 'bdet_DatetimeUtil' supplies
...
//..
//  void convertToTm(bsl::tm *result, const bdet_Datetime& datetime);
//  int convertFromTm(bdet_Datetime *result, const bsl::tm& timeStruct);
//..
...
//                             bsl::tm                       universalTime,
//                             const bdet_DatetimeInterval&  timezoneOffset,
//                             my_TimeUtil::DstMode          mode);
//..
// that converts from UTC expressed as a 'bsl::tm' to a local 'bdet_Datetime'.
// The standard local-time offest from UTC ('timezoneOffset') as well as the
// mode ('DstMode') of daylight-saving time (e.g., 'NONE', 'EU', or 'US') are
// also supplied.  The following specific examples illustrate the expected
// result with initial universal times corresponding to 12 noon, June 30, 2005
// and 12 noon, December 30, 2005 UTC, respectively:
//..
...
//..
//  int toNycLocalTime(bdet_Datetime *result, bsl::tm universalTime)
//  {
...
//
//  int toLocalTime(bdet_Datetime *result, bsl::tm universalTime)
//  {
...
//      bdet_Datetime tmp;
//      status = bdet_DatetimeUtil::convertFromTm(&tmp, universalTime);
...
namespace BloombergLP {
                            ...
                            // ========================
                            // struct bdet_DatetimeUtil
                            // ========================

struct bdet_DatetimeUtil {
    // This 'struct' provides a namespace for a suite of non-primitive pure
    // procedures operating on objects of type 'bdet_Datetime'.  These methods
  ...
  public:
    ...
    static void convertToTm(bsl::tm *result, const bdet_Datetime& datetime);
        ...
        // except for 'tm_isdst', which is set to '-1' to indicate that no
...
// CLASS METHODS
inline
void bdet_DatetimeUtil::convertToTm(bsl::tm              *result,
...
inline
int bdet_DatetimeUtil::convertFromTm(bdet_Datetime  *result,
