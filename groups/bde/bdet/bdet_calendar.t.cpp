...
//                              Overview
//                              --------
// A 'bdet_Calendar' is a value-semantic type that represents a collection of
...
//
// We have chosen the primary manipulators for 'bdet_Calendar' to be 'addDay',
// 'addHoliday', 'addHolidayCode', 'addWeekendDay', 'addWeekendDaysTransition',
// and 'removeAll'.  We have chosen the basic accessors for 'bdet_Calendar' to
...
//
// CREATORS
// [ 2] bdet_Calendar(bslma::Allocator *basicAllocator = 0);
// [11] bdet_Calendar(const bdet_Date& firstDate, lastDate, ba = 0);
// [11] bdet_Calendar(const bdet_PackedCalendar& packedCalendar, ba = 0);
// [ 7] bdet_Calendar(const bdet_Calendar& original, ba = 0);
// [ 2] ~bdet_Calendar();
//
// MANIPULATORS
// [ 9] bdet_Calendar& operator=(const bdet_Calendar& rhs);
// [ 9] bdet_Calendar& operator=(const bdet_PackedCalendar& rhs);
...
// [17] void addWeekendDays(const bdet_DayOfWeekSet& weekendDays);
// [ 2] void addWeekendDaysTransition(date, weekendDays);
// [20] void intersectBusinessDays(const bdet_Calendar& calendar);
// [21] void intersectNonBusinessDays(const bdet_Calendar& calendar);
// [21] void unionBusinessDays(const bdet_Calendar& calendar);
// [20] void unionNonBusinessDays(const bdet_Calendar& calendar);
// [19] void removeHoliday(const bdet_Date& date);
// [19] void removeHolidayCode(const bdet_Date& date, int holidayCode);
// [ 2] void removeAll();
// [22] void swap(bdet_Calendar& other);
// [22] void swap(bdet_Calendar& lhs, bdet_Calendar& rhs);
...
// [23] const bdet_PackedCalendar& packedCalendar() const;
// [10] template <class STREAM> STREAM& bdexStreamOut(STREAM&, int) const;
// [ 5] ostream& print(ostream& stream, int level = 0, int spl = 4) const;
//
// FREE OPERATORS
// [ 6] operator==(const bdet_Calendar& lhs, rhs);
// [ 6] operator!=(const bdet_Calendar& lhs, rhs);
// [ 5] operator<<(ostream&, const bdet_Calendar&);
// ----------------------------------------------------------------------------
// [ 1] BREATHING TEST
// [24] USAGE EXAMPLE
...
// The function 'isEqualWithCache' below compares two 'bdet_Calendar' objects.
...
int ggg(bdet_Calendar *object, const char *spec, bool verboseFlag =true)
...
bdet_Calendar gg(bdet_Calendar * object, const char *spec)
...
bdet_Calendar g(const char *spec)
...
///- - - - - - - - - -
// 'bdet_Calendars' can be populated directly, but are often more efficiently
// created by first creating a corresponding 'bdet_PackedCalendar', and then
// using that object to construct the calendar.  As an example, suppose we
// want to provide efficient access to a (high-performance) 'bdet_Calendar'
...
// 'bdet_PackedCalendar' objects, containing densely packed calendar data:
//..
    class MyPackedCalendarCache {
        ...
        // DATA
        bsl::unordered_map<bsl::string, bdet_PackedCalendar *>  d_map;
      ...
      public:
        ...
        // ...
         ...
         // ACCESSORS
        const bdet_PackedCalendar *lookup(const bsl::string& name) const;
    ...
    {
        typedef bsl::unordered_map<bsl::string, bdet_PackedCalendar *> Cache;
...
// runtime-efficient, but also more space-intensive 'bdet_Calendar' objects,
...
//..
    class MyCalendarCache {
        ...
        bsl::unordered_map<bsl::string, bdet_Calendar>  d_map;
      ...
      public:
        ...
        // MANIPULATORS
        const bdet_Calendar *lookup(const bsl::string& name);
            // Return the address of calendar data associated with the
    ...
    const bdet_Calendar *MyCalendarCache::lookup(const bsl::string& name)
    {
        if (d_map.find(name) != d_map.end()) {
            const bdet_PackedCalendar *pc = d_datasource_p->lookup(name);
            if (!pc) {
...
///Using Calendars
///- - - - - - - -
// What makes a 'bdet_Calendar' substantially different from a
// 'bdet_PackedCalendar' is the speed with which the 'bdet_Calendar' can
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 23: {
        ...
        //
        // Concerns:
        //   1.  The non-modifiable reference to the 'bdet_PackedCalendar'
        //       returned must be an accurate representation of the
        //       'bdet_Calendar' in question.
        //
        // Plans:
        //   To address concern 1, we create a custom set of calendars and
        //   for each of them we obtain a 'bdet_PackedCalendar' that
        ...
        //   obtaining a new 'bdet_PackedCalendar' that represents it, we
        //   create a new calendar from its new packed representation and make
        //   sure they are equal comparing them.
        //
        // Testing:
        //   const bdet_PackedCalendar& packedCalendar() const
        // --------------------------------------------------------------------
        ...
        for (int i = 0; SPECS[i]; ++i) {
            ...
            const bdet_PackedCalendar& packedCal = mX.packedCalendar();
      ...
      case 22: {
        ...
        //
        // Testing:
        //   void swap(bdet_Calendar&);
        //   void swap(bdet_Calendar&, bdet_Calendar&);
        // --------------------------------------------------------------------
      ...
      case 21: {
        ...
        //
        // Testing:
        //   void intersectNonBusinessDays(const bdet_Calendar&)
        //   void intersectNonBusinessDays(const bdet_PackedCalendar&)
        //   void unionBusinessDays(const bdet_Calendar&)
        //   void unionBusinessDays(const bdet_PackedCalendar&)
        // --------------------------------------------------------------------
        ...
        bdet_PackedCalendar packedCals[4];
        const int NUM_DATA = sizeof(packedCals) / sizeof(bdet_PackedCalendar);
        ...
        for (int i = 0; i < NUM_DATA; ++i) {
            for (int j = 0; j < NUM_DATA; ++j) {
                bdet_PackedCalendar p1(packedCals[i]), p2(packedCals[j]);
                ...
                // Replicate test for 'bdet_PackedCalendar'.
                cal1 = CAL1;
                BEGIN_EXCEPTION_SAFE_TEST {
      ...
      case 20: {
        ...
        //
        // Testing:
        //   void intersectBusinessDays(const bdet_Calendar&)
        //   void unionNonBusinessDays(const bdet_Calendar&)
        // --------------------------------------------------------------------
      ...
      case 17: {
        ...
        //      'bdet_DayOfWeekSet' of the default weekend-days transition
        ...
        for (int i = 0; i <= 0x7F; ++i) {
            ...
            for (int j = 0; j <= 0x7F; ++j) {
                ...
                // days
                bdet_DayOfWeekSet compareSet(set);
                for (int d = 0; d < 7; ++d) {
                    if (j & (1 << d)) {
      ...
      case 15: {
...

        {
            ...
            typedef bdet_PackedCalendar_IteratorDateProxy IteratorPointer;
                // iterator's pointer typedef
            typedef bdet_PackedCalendar_DateRef           IteratorReference;
      ...
      case 11: {
        ...
        //
        // Testing:
        //   bdet_Calendar::bdet_Calendar(const bdet_Date&,
        //                                  const bdet_Date&,
        //                                  bslma::Allocator *)
        //   bdet_Calendar::bdet_Calendar(const bdet_PackedCalendar&,
        //                                  bslma::Allocator *)
        // --------------------------------------------------------------------
        ...
        if (verbose) cout << "\tWithout passing in an allocator." << endl;
        {
            for (int i = 0; i < NUM_DATA; ++i) {
                ...
                {
                    // Testing bdet_Calendar(const bdet_Date&,
                    //                        const bdet_Date&,
                    //                        bslma::Allocator *).
        ...
        if (verbose) cout << "\tIn place using a buffer allocator." << endl;
        {
            ...
            for (int i = 0; i < NUM_DATA; ++i) {
                ...
                {
                    bdet_PackedCalendar *doNotDeletePackedCal =
                                  new(a.allocate(sizeof(bdet_PackedCalendar)))
                                 bdet_PackedCalendar(dateFirst, dateLast, &a);
                    Obj *doNotDelete = new(a.allocate(sizeof(Obj)))
      ...
      case 9: {
        ...
        //
        // Testing:
        //   bdet_Calendar& operator=(const bdet_Calendar& rhs)
        //   bdet_Calendar& operator=(const bdet_PackedCalendar& rhs)
        // --------------------------------------------------------------------
        ...
        for (int i = 0; SPECS[i]; ++i) {
            for (int j = 0; SPECS[j]; ++j) {
                ...
                // Replicate for 'operator=(const bdet_PackedCalendar&)'
                {
                    Obj mX(&testAllocator);  const Obj& X = mX;
                    gg(&mX, SPECS[i]);
                    {
      ...
      case 6: {
        ...
        //
        // Testing:
        //   bool operator==(const bdet_Calendar& lhs,
        //                   const bdet_Calendar& rhs)
        //   bool operator!=(const bdet_Calendar& lhs,
        //                   const bdet_Calendar& rhs)
        // --------------------------------------------------------------------
      ...
      case 5: {
        ...
        //   'bdet_Calendar' object for output with any valid 'level' and
        ...
        //
        // Testing:
        //   bsl::ostream& bdet_Calendar::print(
        //                                 bsl::ostream& stream,
        //                                 int           level,
      ...
      case 4: {
        ...
        //   const bdet_DayOfWeekSet& weekendDays() const
      ...
      case 3: {
        ...
        //
        // Testing:
        //      int ggg(bdet_PackedCalendar *, const char *, bool=true)
        // --------------------------------------------------------------------
...
//----------v
      ...
      case 2: {
        ...
        //
        // Plan:
        //   Each 'bdet_Calendar' object contains a 'bdet_PackedCalendar'
        ...
        //
        //  Testing:
        //    bdet_Calendar(bslma::Allocator *basicAllocator = 0)
