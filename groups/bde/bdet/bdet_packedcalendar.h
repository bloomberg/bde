// bdet_packedcalendar.h                                              -*-C++-*-
#ifndef INCLUDED_BDET_PACKEDCALENDAR
#define INCLUDED_BDET_PACKEDCALENDAR
...
//
//@CLASSES:
//  bdet_PackedCalendar: compact repository of weekend/holiday information
//
//@SEE_ALSO: bdet_calendar
//
//@AUTHOR: John Lakos (jlakos), Guillaume Morin (gmorin1)
//
//@DESCRIPTION: This component provides a fully value-semantic class,
// 'bdet_PackedCalendar', that represents weekend and holiday information over
// a *valid* *range* of dates.  A 'bdet_PackedCalendar' is an approximation to
// the same *mathematical* type, and is capable of representing the same subset
// of *mathematical* values, as a 'bdet_Calendar'.
//
// But unlike 'bdet_Calendar', which is optimized for runtime efficiency,
// 'bdet_PackedCalendar' is designed to minimize the amount of in-process
...
// 'bdet_PackedCalendar' (or the current holiday referred to by a
...
//..
// Note that *all* of the non-creator methods of 'bdet_PackedCalendar' provide
// the *No-Throw* guarantee whenever sufficient capacity is already available.
//
// Note that these are largely the same as 'bdet_Calendar' *except* that the
// accessors 'isBusinessDay' and 'isNonBusinessDay' are logarithmic in the
// number of holidays in 'bdet_PackedCalendar'.
//
///Usage
///-----
...
//..
//  void load(bsl::istream& input, bdet_PackedCalendar *calendar)
...
//  {
//      for (bdet_PackedCalendar::HolidayCodeConstIterator
...
//
//  {
//      for (bdet_PackedCalendar::HolidayConstIterator
...
//  }
//..
// Finally, low-level clients may also use a populated 'bdet_PackedCalendar'
...
// holidays, can be performed *much* more efficiently (see 'bdet_Calendar'):
//..
//  bdet_Date
//  getNextBusinessDay(const bdet_PackedCalendar& calendar,
//                     const bdet_Date&           date)
...
#ifndef INCLUDED_BDET_DAYOFWEEKSET
...
class bdet_PackedCalendar_HolidayCodeConstIterator;
class bdet_PackedCalendar_HolidayConstIterator;
class bdet_PackedCalendar_WeekendDaysTransitionConstIterator;
...
class bdet_PackedCalendar {
  ...
  public:
    // PUBLIC TYPES
    typedef bsl::pair<bdet_Date, bdet_DayOfWeekSet>
  ...
  private:
    ...
    // FRIENDS
    friend class bdet_PackedCalendar_BusinessDayConstIterator;
    friend bool operator==(const bdet_PackedCalendar&,
                           const bdet_PackedCalendar&);
    friend bool operator!=(const bdet_PackedCalendar&,
                           const bdet_PackedCalendar&);
  ...
  public:
    // TRAITS
    BSLALG_DECLARE_NESTED_TRAITS(bdet_PackedCalendar,
                                 bslalg::TypeTraitUsesBslmaAllocator);

    // TYPES
    typedef bdet_PackedCalendar_BusinessDayConstIterator
                                               BusinessDayConstIterator;

    typedef bdet_PackedCalendar_HolidayConstIterator
                                               HolidayConstIterator;

    typedef bdet_PackedCalendar_HolidayCodeConstIterator
    ...
    // CREATORS
    explicit bdet_PackedCalendar(bslma::Allocator *basicAllocator = 0);
        // Create an empty calendar having no valid range.  Optionally specify
        // a 'basicAllocator' used to supply memory.  If 'basicAllocator' is 0,
        // the currently installed default allocator is used.

    bdet_PackedCalendar(const bdet_Date&  firstDate,
    ...
    bdet_PackedCalendar(const bdet_PackedCalendar&  original,
                        bslma::Allocator           *basicAllocator = 0);
    ...
    void setValidRange(const bdet_Date& firstDate, const bdet_Date& lastDate);
    ...
    void addWeekendDays(const bdet_DayOfWeekSet& weekendDays);
    ...
    void intersectBusinessDays(const bdet_PackedCalendar& other);
    ...
    void intersectNonBusinessDays(const bdet_PackedCalendar& other);
        // Merge the specified 'other' calendar into this calendar such that
        // the valid range of this calendar will become the *intersection* of
        // the two calendars' ranges, and the weekend days and holidays for
    ...
    void unionBusinessDays(const bdet_PackedCalendar& other);
        // Merge the specified 'other' calendar into this calendar such that
    ...
    void unionNonBusinessDays(const bdet_PackedCalendar& other);
        // Merge the specified 'other' calendar into this calendar such that
        // the valid range of this calendar will become the *union* of the two
        // calendars' ranges (or the minimal continuous range spanning the two
        // ranges, if the ranges are non-overlapping), and the weekend days
    ...
    void swap(bdet_PackedCalendar& other);
    ...
    bool isInRange(const bdet_Date& date) const;
        ...
        // 'bdet_PackedCalendar' is empty if its length is 0.
...
// FREE FUNCTIONS
void swap(bdet_PackedCalendar& a, bdet_PackedCalendar& b);
    ...
    // objects being swapped have non-equal allocators.
                 ...
                 // ===========================================
                 // class bdet_PackedCalendar_IteratorDateProxy
                 // ===========================================

class bdet_PackedCalendar_IteratorDateProxy {
    // This object is a proxy class for 'bdet_Date' for use by the arrow
    // operator of 'bdet_PackedCalendar_HolidayConstIterator',
    // 'bdet_Calendar_BusinessDayConstIter', and
    // 'bdet_PackedCalendar_BusinessDayConstIterator'.  An object of this
  ...
  private:
    // NOT IMPLEMENTED
    bdet_PackedCalendar_IteratorDateProxy&
    operator=(const bdet_PackedCalendar_IteratorDateProxy&);

  public:
    // CREATORS
    bdet_PackedCalendar_IteratorDateProxy(const bdet_Date& date);
    ...
    bdet_PackedCalendar_IteratorDateProxy(
                        const bdet_PackedCalendar_IteratorDateProxy& original);
    ...
    const bdet_Date *operator->() const;
        // Return the address of the proxied date object.
                        ...
                        // =================================
                        // class bdet_PackedCalendar_DateRef
                        // =================================

struct bdet_PackedCalendar_DateRef : bdet_Date {
  ...
  private:
    // NOT IMPLEMENTED
    bdet_PackedCalendar_DateRef& operator=(const bdet_PackedCalendar_DateRef&);

  public:
    // CREATORS
    explicit bdet_PackedCalendar_DateRef(const bdet_Date& date);
        // Create a new object using the specified 'date'.

    bdet_PackedCalendar_DateRef(const bdet_PackedCalendar_DateRef& original);
        // Create a new object having the value of the specified 'original'
        // object.

    ~bdet_PackedCalendar_DateRef();
        // Destroy this object.

    // ACCESSORS
    bdet_PackedCalendar_IteratorDateProxy operator&() const;
...
class bdet_PackedCalendar_HolidayConstIterator {
    ...
    // to the holidays in a 'bdet_PackedCalendar' object.
    ...
    // FRIENDS
    friend class bdet_PackedCalendar;
    friend bool operator==(const bdet_PackedCalendar_HolidayConstIterator&,
                           const bdet_PackedCalendar_HolidayConstIterator&);
    friend bool operator!=(const bdet_PackedCalendar_HolidayConstIterator&,
                           const bdet_PackedCalendar_HolidayConstIterator&);
  ...
  private:
    ...
    // PRIVATE CREATORS
    bdet_PackedCalendar_HolidayConstIterator(
  ...
  public:
    ...
    typedef bdet_PackedCalendar_IteratorDateProxy pointer;
    typedef bdet_PackedCalendar_DateRef           reference;
        // The star operator returns a 'bdet_PackedCalendar_DateRef' *by*
        // *value*.
    ...
    // CREATORS
    bdet_PackedCalendar_HolidayConstIterator(
                     const bdet_PackedCalendar_HolidayConstIterator& original);
    ...
    // MANIPULATORS
    bdet_PackedCalendar_HolidayConstIterator& operator=(
                          const bdet_PackedCalendar_HolidayConstIterator& rhs);
    ...
    // ACCESSORS
    bdet_PackedCalendar_DateRef operator*() const;
        // Return a 'bdet_PackedCalendar_DateRef' object which contains the
...
// FREE OPERATORS
bool operator==(const bdet_PackedCalendar_HolidayConstIterator& lhs,
                const bdet_PackedCalendar_HolidayConstIterator& rhs);
...
bdet_PackedCalendar_HolidayConstIterator
operator++(bdet_PackedCalendar_HolidayConstIterator& iterator, int);
...
class bdet_PackedCalendar_HolidayCodeConstIterator {
    ...
    // the holiday codes in a 'bdet_PackedCalendar' object.
    ...
    friend bool operator==(
                          const bdet_PackedCalendar_HolidayCodeConstIterator&,
                          const bdet_PackedCalendar_HolidayCodeConstIterator&);
    friend bool operator!=(
                          const bdet_PackedCalendar_HolidayCodeConstIterator&,
                          const bdet_PackedCalendar_HolidayCodeConstIterator&);
  ...
  private:
    ...
    // PRIVATE CREATORS
    bdet_PackedCalendar_HolidayCodeConstIterator(
  ...
  public:
    ...
    // CREATORS
    bdet_PackedCalendar_HolidayCodeConstIterator(
                 const bdet_PackedCalendar_HolidayCodeConstIterator& original);
    ...
    // MANIPULATORS
    bdet_PackedCalendar_HolidayCodeConstIterator& operator=(
                      const bdet_PackedCalendar_HolidayCodeConstIterator& rhs);
...
// FREE OPERATORS
bool operator==(const bdet_PackedCalendar_HolidayCodeConstIterator& lhs,
                const bdet_PackedCalendar_HolidayCodeConstIterator& rhs);
...
bdet_PackedCalendar_HolidayCodeConstIterator
operator++(bdet_PackedCalendar_HolidayCodeConstIterator& iterator, int);
...
class bdet_PackedCalendar_BusinessDayConstIterator {
    // Provide read-only, sequential access in increasing (chronological) order
    // to the business days in a 'bdet_PackedCalendar' object.

    // DATA
    bsl::vector<int>::const_iterator  d_offsetIter;     // iterator for the
                                                        // holiday offsets
    const bdet_PackedCalendar        *d_calendar_p;     // pointer to the
                                                        // calendar
    ...
    friend class bdet_PackedCalendar;
    friend bool operator==(
                          const bdet_PackedCalendar_BusinessDayConstIterator&,
                          const bdet_PackedCalendar_BusinessDayConstIterator&);
    friend bool operator!=(
                          const bdet_PackedCalendar_BusinessDayConstIterator&,
                          const bdet_PackedCalendar_BusinessDayConstIterator&);
  ...
  public:
    ...
    // CREATORS
    bdet_PackedCalendar_BusinessDayConstIterator(
                 const bdet_PackedCalendar_BusinessDayConstIterator& original);
        // Create an iterator having the value of the specified 'original'
        // iterator.
...
// FREE OPERATORS
inline
bool operator==(const bdet_PackedCalendar_BusinessDayConstIterator& lhs,
                const bdet_PackedCalendar_BusinessDayConstIterator& rhs);
    // Return 'true' if the specified 'lhs' and 'rhs' iterators point to the
    // same entry in the same calendar, and 'false' otherwise.  The behavior is
    // undefined unless 'lhs' and 'rhs' both iterate over the same calendar.
...
inline
bdet_PackedCalendar_BusinessDayConstIterator operator++(
                  bdet_PackedCalendar_BusinessDayConstIterator& iterator, int);
...
// ACCESSORS
inline
const bdet_Date *bdet_PackedCalendar_IteratorDateProxy::operator->() const
{
    return &d_date;
}
...
inline
bdet_PackedCalendar_DateRef::
bdet_PackedCalendar_DateRef(const bdet_Date& date)
: bdet_Date(date)
{
}
...
inline
bdet_PackedCalendar_DateRef::~bdet_PackedCalendar_DateRef()
{
}
...
inline
bdet_PackedCalendar_HolidayConstIterator::
bdet_PackedCalendar_HolidayConstIterator(const OffsetsConstIterator& iter,
                                         const bdet_Date             firstDate)
: d_iterator(iter)
...
bdet_PackedCalendar_HolidayConstIterator&
bdet_PackedCalendar_HolidayConstIterator::
operator=(const bdet_PackedCalendar_HolidayConstIterator& rhs)
{
...
operator++(bdet_PackedCalendar_HolidayConstIterator& iterator, int)
{
    bdet_PackedCalendar_HolidayConstIterator tmp(iterator);
    ++iterator;
    return tmp;
}
...
inline
bdet_PackedCalendar_DateRef
bdet_PackedCalendar_HolidayConstIterator::operator*() const
{
    return bdet_PackedCalendar_DateRef(d_firstDate + *d_iterator);
}
...
bdet_PackedCalendar_HolidayConstIterator::operator->() const
{
    return bdet_PackedCalendar_IteratorDateProxy(this->operator*());
}
...
inline
bdet_PackedCalendar_HolidayCodeConstIterator::
bdet_PackedCalendar_HolidayCodeConstIterator(const CodesConstIterator& iter)
: d_iterator(iter)
{
}
...
bdet_PackedCalendar_HolidayCodeConstIterator&
bdet_PackedCalendar_HolidayCodeConstIterator::
operator=(const bdet_PackedCalendar_HolidayCodeConstIterator& rhs)
{
    d_iterator = rhs.d_iterator;
    return *this;
}
...
operator++(bdet_PackedCalendar_HolidayCodeConstIterator& iterator, int)
{
    bdet_PackedCalendar_HolidayCodeConstIterator tmp(iterator);
    ++iterator;
    return tmp;
}
...
// ACCESSORS
inline
int bdet_PackedCalendar_HolidayCodeConstIterator::operator*() const
{
    return *d_iterator;
}
...
bdet_PackedCalendar_BusinessDayConstIterator operator++(
                   bdet_PackedCalendar_BusinessDayConstIterator& iterator, int)
{
    bdet_PackedCalendar_BusinessDayConstIterator tmp(iterator);
    ++iterator;
    return tmp;
}
...
inline
bdet_PackedCalendar_DateRef
bdet_PackedCalendar_BusinessDayConstIterator::operator*() const
{
    return bdet_PackedCalendar_DateRef(d_calendar_p->firstDate() +
                                       d_currentOffset);
}
...
inline
bool
operator==(const bdet_PackedCalendar_BusinessDayConstIterator& lhs,
           const bdet_PackedCalendar_BusinessDayConstIterator& rhs)
{
...
// ACCESSORS
inline
bool bdet_PackedCalendar::isInRange(const bdet_Date& date) const
{
...
// CLASS METHODS
inline
int bdet_PackedCalendar::maxSupportedBdexVersion()
{
    return 1;
}
...
// PRIVATE MANIPULATORS
inline
bdet_PackedCalendar::CodesIterator
bdet_PackedCalendar::beginHolidayCodes(const OffsetsIterator& iter)
{
...
inline
bdet_PackedCalendar::CodesIterator
bdet_PackedCalendar::endHolidayCodes(const OffsetsIterator& iter)
{
...
// PRIVATE ACCESSORS
inline
bdet_PackedCalendar::CodesConstIterator
bdet_PackedCalendar::beginHolidayCodes(const OffsetsConstIterator& iter) const
{
    const int indexOffset = static_cast<int>(iter - d_holidayOffsets.begin());
    const int codeOffset  = d_holidayCodesIndex[indexOffset];
    return d_holidayCodes.begin() + codeOffset;
...
inline
bdet_PackedCalendar::CodesConstIterator
bdet_PackedCalendar::endHolidayCodes(const OffsetsConstIterator& iter) const
{
    // Use 'OffsetsSizeType' instead of 'int' to avoid a gcc warning.
...
// MANIPULATORS
template <class STREAM>
STREAM& bdet_PackedCalendar::bdexStreamIn(STREAM& stream, int version)
{
    if (stream) {
        switch (version) {  // Switch on the schema version (starting with 1).
          case 2: {
            bdet_PackedCalendar inCal(d_allocator_p);
...
inline
void bdet_PackedCalendar::reserveHolidayCapacity(int numHolidays)
{
...
inline
void bdet_PackedCalendar::reserveHolidayCodeCapacity(int numHolidayCodes)
{
...
// ACCESSORS
template <class STREAM>
STREAM& bdet_PackedCalendar::bdexStreamOut(STREAM& stream, int version) const
{
    switch (version) {  // Switch on the schema version (starting with 1).
      case 2: {
...
bdet_PackedCalendar::beginWeekendDaysTransitions() const
{
...
inline
bdet_PackedCalendar::WeekendDaysTransitionConstIterator
bdet_PackedCalendar::endWeekendDaysTransitions() const
{
    return d_weekendDaysTransitions.end();
}

inline
bdet_PackedCalendar::BusinessDayConstIterator
bdet_PackedCalendar::beginBusinessDays() const
{
...
inline
bdet_PackedCalendar::BusinessDayConstIterator
bdet_PackedCalendar::beginBusinessDays(const bdet_Date& date) const
{
...
bdet_PackedCalendar::beginHolidayCodes(const HolidayConstIterator& iter) const
{
    return HolidayCodeConstIterator(beginHolidayCodes(iter.d_iterator));
}

inline
int bdet_PackedCalendar::numWeekendDaysTransitions() const
{
    return d_weekendDaysTransitions.size();
}

inline
bdet_PackedCalendar::HolidayConstIterator
bdet_PackedCalendar::beginHolidays() const
{
...
inline
bdet_PackedCalendar::HolidayConstIterator
bdet_PackedCalendar::beginHolidays(const bdet_Date& date) const
{
    BSLS_ASSERT_SAFE(isInRange(date));
...
inline
bdet_PackedCalendar::BusinessDayConstIterator
bdet_PackedCalendar::endBusinessDays() const
{
...
inline
bdet_PackedCalendar::BusinessDayConstIterator
bdet_PackedCalendar::endBusinessDays(const bdet_Date& date) const
{
    BSLS_ASSERT_SAFE(isInRange(date));
...
inline
bdet_PackedCalendar::HolidayCodeConstIterator
bdet_PackedCalendar::endHolidayCodes(const HolidayConstIterator& iter) const
{
...
inline
bdet_PackedCalendar::HolidayConstIterator
bdet_PackedCalendar::endHolidays() const
{
...
inline
bdet_PackedCalendar::HolidayConstIterator
bdet_PackedCalendar::endHolidays(const bdet_Date& date) const
{
    BSLS_ASSERT_SAFE(isInRange(date));
...
inline
const bdet_Date& bdet_PackedCalendar::firstDate() const
{
    return d_firstDate;
}

inline
bool bdet_PackedCalendar::isBusinessDay(const bdet_Date& date) const
{
    BSLS_ASSERT_SAFE(isInRange(date));
...
inline
bool bdet_PackedCalendar::isHoliday(const bdet_Date& date) const
{
    BSLS_ASSERT_SAFE(isInRange(date));
...
inline
bool bdet_PackedCalendar::isNonBusinessDay(const bdet_Date& date) const
{
    BSLS_ASSERT_SAFE(isInRange(date));
...
inline
bool bdet_PackedCalendar::isWeekendDay(bdet_DayOfWeek::Day dayOfWeek) const
{
...
inline
const bdet_Date& bdet_PackedCalendar::lastDate() const
{
    return d_lastDate;
}

inline
int bdet_PackedCalendar::length() const
{
    return d_firstDate <= d_lastDate ? d_lastDate - d_firstDate + 1 : 0;
}

inline
int bdet_PackedCalendar::numBusinessDays() const
{
    return length() - numNonBusinessDays();
}

inline
int bdet_PackedCalendar::numHolidayCodesTotal() const
{
    return static_cast<int>(d_holidayCodes.size());
}

inline
int bdet_PackedCalendar::numHolidays() const
{
    return static_cast<int>(d_holidayOffsets.size());
}

inline
bdet_PackedCalendar::BusinessDayConstReverseIterator
bdet_PackedCalendar::rbeginBusinessDays() const
{
...
inline
bdet_PackedCalendar::BusinessDayConstReverseIterator
bdet_PackedCalendar::rbeginBusinessDays(const bdet_Date& date) const
{
    BSLS_ASSERT_SAFE(isInRange(date));
...
inline
bdet_PackedCalendar::HolidayCodeConstReverseIterator
bdet_PackedCalendar::rbeginHolidayCodes(const bdet_Date& date) const
{
    BSLS_ASSERT_SAFE(isInRange(date));
...
inline
bdet_PackedCalendar::HolidayConstReverseIterator
bdet_PackedCalendar::rbeginHolidays() const
{
...
inline
bdet_PackedCalendar::HolidayConstReverseIterator
bdet_PackedCalendar::rbeginHolidays(const bdet_Date& date) const
{
    BSLS_ASSERT_SAFE(isInRange(date));
...
inline
bdet_PackedCalendar::BusinessDayConstReverseIterator
bdet_PackedCalendar::rendBusinessDays() const
{
...
inline
bdet_PackedCalendar::BusinessDayConstReverseIterator
bdet_PackedCalendar::rendBusinessDays(const bdet_Date& date) const
{
    BSLS_ASSERT_SAFE(isInRange(date));
...
inline
bdet_PackedCalendar::HolidayCodeConstReverseIterator
bdet_PackedCalendar::rendHolidayCodes(const bdet_Date& date) const
{
    BSLS_ASSERT_SAFE(isInRange(date));
...
inline
bdet_PackedCalendar::HolidayCodeConstReverseIterator
bdet_PackedCalendar::rendHolidayCodes(const HolidayConstIterator& iter) const
{
...
inline
bdet_PackedCalendar::HolidayConstReverseIterator
bdet_PackedCalendar::rendHolidays() const
{
...
inline
bdet_PackedCalendar::HolidayConstReverseIterator
bdet_PackedCalendar::rendHolidays(const bdet_Date& date) const
{
    BSLS_ASSERT_SAFE(isInRange(date));
