// bdet_dayofweekset.h                                                -*-C++-*-
#ifndef INCLUDED_BDET_DAYOFWEEKSET
#define INCLUDED_BDET_DAYOFWEEKSET
...
//
//@CLASSES:
//  bdet_DayOfWeekSet: ordered set of (unique) 'bdet_DayOfWeek::Day' values
//
...
// set class for elements of the 'bdet_DayOfWeek::Day' enumeration.  As there
...
// defined on 'bdet_DayOfWeekSet' objects:
//..
...
///Usage
///-----
// A 'bdet_DayOfWeekSet' is useful for recording recurring appointments,
// or special days (e.g., weekend days), in a calendar.  The following
// snippets of code illustrate how to create and use a 'bdet_DayOfWeek' set.
// We'll start by creating a couple of commonly useful sets.  First we
// define the 'bdet_dayOfWeekSet' 'weekendDays':
//..
//  bdet_DayOfWeekSet weekendDays;  assert(0 == weekendDays.length());
//..
...
//..
// Now let's create the complementary 'bdet_DayOfWeekSet' 'weekDays' directly
// from 'weekendDays' via a combination of unary negation and copy
// construction:
//..
//  bdet_DayOfWeekSet weekDays(~weekendDays);
//
...
//..
//  const bdet_DayOfWeekSet NO_DAYS;
//  const bdet_DayOfWeekSet ALL_DAYS(~NO_DAYS);
//
...
//..
//  bdet_DayOfWeekSet eDays;                 assert(0 == eDays.length());
...
//..
//  bdet_DayOfWeekSet nDays(eDays);          assert(2 == nDays.length());
//
...
//..
//  for (bdet_DayOfWeekSet::iterator it  = ALL_DAYS.begin();
//                                   it != ALL_DAYS.end();
//                                 ++it) {
...
//..
//  for (bdet_DayOfWeekSet::reverse_iterator it  = weekDays.rbegin();
//                                           it != weekDays.rend();
//                                         ++it) {
//      bsl::cout << *it << bsl::endl;
//  }
...
class bdet_DayOfWeekSet_Iter : public bsl::iterator<
    ...
    // FRIENDS
    friend bool operator==(const bdet_DayOfWeekSet_Iter&,
                           const bdet_DayOfWeekSet_Iter&);

  public:
    // CREATORS
    bdet_DayOfWeekSet_Iter();
        // Create a default (invalid) iterator.

    bdet_DayOfWeekSet_Iter(int data, int index);
    ...
    bdet_DayOfWeekSet_Iter(const bdet_DayOfWeekSet_Iter& original);
    ...
    // MANIPULATORS
    bdet_DayOfWeekSet_Iter& operator=(const bdet_DayOfWeekSet_Iter& rhs);
    ...
    bdet_DayOfWeekSet_Iter& operator++();
    ...
    const bdet_DayOfWeek::Day& operator*() const;
        ...
        // week value referenced by this iterator.
};

// FREE OPERATORS
bool operator==(const bdet_DayOfWeekSet_Iter& lhs,
                const bdet_DayOfWeekSet_Iter& rhs);
...
bdet_DayOfWeekSet_Iter operator++(bdet_DayOfWeekSet_Iter& iterator, int);
...
class bdet_DayOfWeekSet {
    ...
    // FRIENDS
    friend bool operator==(const bdet_DayOfWeekSet&, const bdet_DayOfWeekSet&);
    friend bool operator!=(const bdet_DayOfWeekSet&, const bdet_DayOfWeekSet&);
    friend bdet_DayOfWeekSet operator~(const bdet_DayOfWeekSet&);

  public:
    // TYPES
    typedef bdet_DayOfWeekSet_Iter iterator;
    ...
    bdet_DayOfWeekSet(const bdet_DayOfWeekSet& original);
    ...
    // MANIPULATORS
    bdet_DayOfWeekSet& operator=(const bdet_DayOfWeekSet& rhs);
    ...
    int remove(bdet_DayOfWeek::Day value);
        // Remove the specified 'value' from this set.  Return 1 if 'value' was
        // a member of this set, and 0 otherwise.
    ...
    // ACCESSORS
    bool areMembers(const bdet_DayOfWeekSet& set) const;
...
// FREE OPERATORS
bdet_DayOfWeekSet operator~(const bdet_DayOfWeekSet& set);
    // Return a set containing the complement of the specified 'set'
    // (i.e., those members *not* contained in 'set').

bdet_DayOfWeekSet operator|(const bdet_DayOfWeekSet& lhs,
                            const bdet_DayOfWeekSet& rhs);
...
bool operator==(const bdet_DayOfWeekSet& lhs, const bdet_DayOfWeekSet& rhs);
...
bsl::ostream& operator<<(bsl::ostream& stream, const bdet_DayOfWeekSet& rhs);
...
// CREATORS
inline
bdet_DayOfWeekSet_Iter::bdet_DayOfWeekSet_Iter()
: d_data(0)
, d_index(8)
{
}
...
inline
bdet_DayOfWeekSet_Iter::bdet_DayOfWeekSet_Iter(
                                        const bdet_DayOfWeekSet_Iter& original)
...
// ACCESSORS
inline
const bdet_DayOfWeek::Day& bdet_DayOfWeekSet_Iter::operator*() const
{
...
bdet_DayOfWeekSet_Iter operator++(bdet_DayOfWeekSet_Iter& iterator, int)
{
    bdet_DayOfWeekSet_Iter tmp(iterator);
    iterator.operator++();
    return tmp;
}
...
// CLASS METHODS
inline
int bdet_DayOfWeekSet::maxSupportedBdexVersion()
{
    return 1;
}
...
// CREATORS
inline
bdet_DayOfWeekSet::bdet_DayOfWeekSet()
: d_days(0)
{
}

inline
bdet_DayOfWeekSet::bdet_DayOfWeekSet(const bdet_DayOfWeekSet& original)
...
// MANIPULATORS
inline
bdet_DayOfWeekSet& bdet_DayOfWeekSet::operator=(const bdet_DayOfWeekSet& rhs)
{
    d_days = rhs.d_days;
    return *this;
}
...
inline
void bdet_DayOfWeekSet::add(bdet_DayOfWeek::Day value)
{
    d_days = static_cast<unsigned char>(d_days | (1 << value));
}

inline
int bdet_DayOfWeekSet::remove(bdet_DayOfWeek::Day value)
{
...
inline
void bdet_DayOfWeekSet::removeAll()
{
    d_days = 0;
}

template <class STREAM>
STREAM& bdet_DayOfWeekSet::bdexStreamIn(STREAM& stream, int version)
{
    if (stream) {
...
// ACCESSORS
inline
bool bdet_DayOfWeekSet::areMembers(const bdet_DayOfWeekSet& set) const
{
    return set.d_days == (d_days & set.d_days);
}

inline
bdet_DayOfWeekSet::iterator bdet_DayOfWeekSet::begin() const
{
    return bdet_DayOfWeekSet::iterator(bdet_DayOfWeekSet_Iter(d_days, 1));
}

inline
bdet_DayOfWeekSet::iterator bdet_DayOfWeekSet::end() const
{
    return bdet_DayOfWeekSet::iterator(bdet_DayOfWeekSet_Iter(d_days, 8));
}

inline
bool bdet_DayOfWeekSet::isMember(bdet_DayOfWeek::Day value) const
{
    const int mask = 1 << value;
...
inline
int bdet_DayOfWeekSet::length() const
{
    return bdes_BitUtil::numSetOne(d_days);
}

inline
bdet_DayOfWeekSet::reverse_iterator bdet_DayOfWeekSet::rbegin() const
{
    return bdet_DayOfWeekSet::reverse_iterator(end());
}

inline
bdet_DayOfWeekSet::reverse_iterator bdet_DayOfWeekSet::rend() const
{
    return bdet_DayOfWeekSet::reverse_iterator(begin());
}

template <class STREAM>
STREAM& bdet_DayOfWeekSet::bdexStreamOut(STREAM& stream, int version) const
{
    switch (version) {
      case 1: {
...
bdet_DayOfWeekSet operator|(const bdet_DayOfWeekSet& lhs,
                            const bdet_DayOfWeekSet& rhs)
{
    return bdet_DayOfWeekSet(lhs) |= rhs;
}
