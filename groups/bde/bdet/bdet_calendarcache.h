...
//@PURPOSE: Provide an efficient cache for 'bdet_Calendar'.
//
//@CLASSES:
//               bdet_CalendarCache: cache for loading calendars using their
//                                   names
//          bdet_CalendarCache_Pair: struct for storing the (name, calendar)
//                                   pair returned by calendar cache's
//                                   iterators
// bdet_CalendarCacheIter_PairProxy: proxy object for 'bdet_CalendarCache_Pair'
//       bdet_CalendarCache_PairRef: reference object for
//                                   'bdet_CalendarCache_Pair'
//           bdet_CalendarCacheIter: iterator for 'bdet_CalendarCache'
//
//@AUTHOR: Guillaume Morin (gmorin1), Yu Zhao (yzhao3)
//
//@SEE_ALSO: bdet_calendar
//
//@DESCRIPTION: This component provides the 'bdet_CalendarCache' class, which
// is a cache for ('bdet_Calendar') calendars.  'bdet_CalendarCache' is able
...
// ('invalidateAll').
//
// For an individual 'bdet_CalendarCache' object, the pointers returned by
...
// This pointer will remain valid as long as this 'bdet_CalendarCache' object
...
// object.
//
// 'bdet_CalendarCache' provides a complete set of STL-like 'const'
...
// one thread is using a specific 'bdet_CalendarCache' object at any time.
...
///Usage
///-----
// The subsections below illustrate how to use 'bdet_CalendarCache'.
//
///Using Calendar Cache with no timeout
///- - - - - - - - - - - - - - - - - -
// A calendar cache can be created with or without a timeout value.  The
// example below shows how to use a 'bdet_CalendarCache' object with no
...
///- - - - - - - - - - - - - - - - - - - - -
// The example below shows how to use a 'bdet_CalendarCache' object with a
...
//      bdet_CalendarCache::ConstIterator it;
...
class bdet_CalendarCache {
    ...
    // 'bdet_Calendar'.  An optional timeout value for entries in the cache
    ...
    bsl::map<bsl::string, bdet_CalendarCacheEntry *>  d_cache;
  ...
  private:
    ...
    // PRIVATE TYPES
    typedef bsl::map<bsl::string, bdet_CalendarCacheEntry *>::iterator
                                                                 CacheIterator;
  ...
  public:
    ...
    // PUBLIC TYPES
    typedef bdet_CalendarCacheIter                        ConstIterator;
    typedef ConstIterator                                 Iterator;
    typedef bsl::reverse_iterator<bdet_CalendarCacheIter> ConstReverseIterator;
    ...
    ConstIterator begin() const;
        // Return an iterator referencing the first 'bdet_CalendarCache_Pair'
    ...
    ConstIterator end() const;
        ...
        // 'bdet_CalendarCache_Pair' object in the cache.  The cache is
    ...
    ConstReverseIterator rbegin() const;
        // Return an iterator referencing the last 'bdet_CalendarCache_Pair'
        // object in the cache.  The cache is alphabetically ordered on the
        // calendar names.  If the calendar cache is empty, the returned
    ...
    ConstReverseIterator rend() const;
        ...
        // is empty, the returned iterator will be positioned at 'rbegin()'.
                        ...
                        // =============================
                        // class bdet_CalendarCache_Pair
                        // =============================

struct bdet_CalendarCache_Pair {
    ...
    const bdet_Calendar& second;  // the calendar object

    // FRIENDS
    friend bool operator==(const bdet_CalendarCache_Pair& lhs,
                           const bdet_CalendarCache_Pair& rhs);
    friend bool operator!=(const bdet_CalendarCache_Pair& lhs,
                           const bdet_CalendarCache_Pair& rhs);
  private:
    // NOT IMPLEMENTED
    bdet_CalendarCache_Pair& operator=(const bdet_CalendarCache_Pair&);

  public:
    // CREATORS
    bdet_CalendarCache_Pair(const bsl::string&   name,
                            const bdet_Calendar& calendar);
        // Create a new 'bdet_CalendarCache_Pair' object using 'name' as
        // 'first' and 'calendar' as 'second'.

    bdet_CalendarCache_Pair(const bdet_CalendarCache_Pair& original);
        // Create a new 'bdet_CalendarCache_Pair' object that has the same
        // value as 'original'.
...
// FREE OPERATORS
inline
bool operator==(const bdet_CalendarCache_Pair& lhs,
                const bdet_CalendarCache_Pair& rhs);
...
bool operator!=(const bdet_CalendarCache_Pair& lhs,
                const bdet_CalendarCache_Pair& rhs);
                     ...
                     // ======================================
                     // class bdet_CalendarCacheIter_PairProxy
                     // ======================================

class bdet_CalendarCacheIter_PairProxy {
    // This object is a proxy class for the iterator value of
    // 'bdet_CalendarCacheIter' for use by the arrow operator of
    // 'bdet_CalendarCacheIter'.  An instance of this class behaves as
    // the 'bdet_CalendarCache_Pair' object with which it was constructed.

     bdet_CalendarCache_Pair d_pair; // proxied pair

  private:
    // NOT IMPLEMENTED
    bdet_CalendarCacheIter_PairProxy&
                            operator=(const bdet_CalendarCacheIter_PairProxy&);

  public:
    // CREATORS
    bdet_CalendarCacheIter_PairProxy(const bdet_CalendarCache_Pair& pair);
   ...
   ~bdet_CalendarCacheIter_PairProxy();
    ...
    bdet_CalendarCacheIter_PairProxy(
                             const bdet_CalendarCacheIter_PairProxy& original);
        // Create a proxy object referencing the same value as the
        // specified 'original'.

    // ACCESSORS
    const bdet_CalendarCache_Pair *operator->() const;
        // Return the address of the proxied object.
};

                        // ================================
                        // class bdet_CalendarCache_PairRef
                        // ================================

struct bdet_CalendarCache_PairRef : bdet_CalendarCache_Pair {
    // This private class is used by the arrow operator of
    // 'bdet_CalendarCacheIter'.  The objects instantiated from this class
    // serve as references to 'bdet_CalendarCache_Pair' objects.

  private:
    // NOT IMPLEMENTED
    bdet_CalendarCache_PairRef& operator=(const bdet_CalendarCache_PairRef&);

  public:
    // CREATORS
    explicit bdet_CalendarCache_PairRef(const bdet_CalendarCache_Pair& pair);
        // Create a new object using the specified 'pair'.

    bdet_CalendarCache_PairRef(const bdet_CalendarCache_PairRef& original);
        // Create a new object having the value of the specified 'original'.

    ~bdet_CalendarCache_PairRef();
        // Destroy this object.

    // ACCESSORS
    bdet_CalendarCacheIter_PairProxy operator&() const;
};
...
class bdet_CalendarCacheIter {
    ...
    // to the entries in a 'bdet_CalendarCache' object.

    bsl::map<bsl::string, bdet_CalendarCacheEntry *>::const_iterator
                                                              d_iterator;
    ...
    friend bool operator==(const bdet_CalendarCacheIter& lhs,
                           const bdet_CalendarCacheIter& rhs);
    friend bool operator!=(const bdet_CalendarCacheIter& lhs,
                           const bdet_CalendarCacheIter& rhs);

  private:
    // PRIVATE TYPES
    typedef bsl::map<bsl::string, bdet_CalendarCacheEntry *>::const_iterator
                                                            CacheConstIterator;

    // PRIVATE CREATORS
    bdet_CalendarCacheIter(const CacheConstIterator&  iter,
  ...
  public:
    // PUBLIC TYPES
    typedef bdet_CalendarCache_Pair          value_type;
    typedef int                              difference_type;
    typedef bdet_CalendarCacheIter_PairProxy pointer;
    typedef bdet_CalendarCache_PairRef       reference;
    ...
    bdet_CalendarCacheIter(const bdet_CalendarCacheIter& original);
    ...
    // MANIPULATORS
    bdet_CalendarCacheIter& operator=(const bdet_CalendarCacheIter& rhs);
        // Assign to this iterator the value of the specified 'rhs' iterator.

    bdet_CalendarCacheIter& operator++();
    ...
    // ACCESSORS
    bdet_CalendarCache_PairRef operator*() const;
        // Return the 'bdet_CalendarCache_Pair' object referenced by this
...
// FREE OPERATORS
inline
bool operator==(const bdet_CalendarCacheIter& lhs,
                const bdet_CalendarCacheIter& rhs);
...
bdet_CalendarCacheIter operator++(bdet_CalendarCacheIter& iterator, int);
...
// ACCESSORS
inline
bdet_CalendarCache::ConstIterator bdet_CalendarCache::begin() const
{
...
inline
bdet_CalendarCache::ConstIterator bdet_CalendarCache::end() const
{
...
inline
bdet_CalendarCache::ConstReverseIterator bdet_CalendarCache::rbegin() const
{
    return ConstReverseIterator(end());
}

inline
bdet_CalendarCache::ConstReverseIterator bdet_CalendarCache::rend() const
{
...
// CREATORS
inline
bdet_CalendarCache_Pair::bdet_CalendarCache_Pair(const bsl::string&   name,
                                                 const bdet_Calendar& calendar)
: first(name)
, second(calendar)
{
...
inline
bdet_CalendarCache_Pair::bdet_CalendarCache_Pair(
                                       const bdet_CalendarCache_Pair& original)
...
// CREATORS
inline
bdet_CalendarCacheIter_PairProxy::bdet_CalendarCacheIter_PairProxy(
                                           const bdet_CalendarCache_Pair& pair)
: d_pair(pair)
{
}
...
inline
bdet_CalendarCache_PairRef::
bdet_CalendarCache_PairRef(const bdet_CalendarCache_Pair& pair)
:bdet_CalendarCache_Pair(pair)
{
}
...
bdet_CalendarCache_PairRef::
bdet_CalendarCache_PairRef(const bdet_CalendarCache_PairRef& original)
:bdet_CalendarCache_Pair(original)
{
}

inline
bdet_CalendarCache_PairRef::~bdet_CalendarCache_PairRef()
{
}
...
inline
bdet_CalendarCacheIter::bdet_CalendarCacheIter(
                                        const bdet_CalendarCacheIter& original)
...
// MANIPULATORS
inline
bdet_CalendarCacheIter& bdet_CalendarCacheIter::operator++()
{
    ++d_iterator;
    return *this;
}
...
inline
bdet_CalendarCacheIter_PairProxy
bdet_CalendarCacheIter::operator->() const
{
    return bdet_CalendarCacheIter_PairProxy(this->operator*());
}
