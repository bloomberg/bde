...
//
//@CLASSES:
//  bdesu_FilesystemUtil: namespace for filesystem access methods
//
...
//                                                it != logFiles.end(); ++it) {
//    assert(0 ==
//               bdesu_FilesystemUtil::getLastModificationTime(&modTime, *it));
...
// CLASS METHODS
inline
int bdesu_FilesystemUtil::createDirectories(
                                        const bsl::string& path,
...
inline
int bdesu_FilesystemUtil::remove(const bsl::string& path, bool recursiveFlag)
{
