// bdealg_typetraitbitwisecopyable.cpp                  -*-C++-*-
#include <bdes_ident.h>
BDES_IDENT_RCSID(bdealg_typetraitbitwisecopyable_cpp,"$Id$ $CSID$")
...
char bdealg_typetraitbitwisecopyable_filename[] = __FILE__;
#endif
