// bdealg_typetraithaspointersemantics.cpp                  -*-C++-*-
#include <bdes_ident.h>
BDES_IDENT_RCSID(bdealg_typetraithaspointersemantics_cpp,"$Id$ $CSID$")
...
char bdealg_typetraithaspointersemantics_filename[] = __FILE__;
#endif
