// bdealg_typetraitsgrouppod.cpp                  -*-C++-*-
#include <bdes_ident.h>
BDES_IDENT_RCSID(bdealg_typetraitsgrouppod_cpp,"$Id$ $CSID$")

#include <bdealg_typetraitsgrouppod.h>
...
char bdealg_typetraitsgrouppod_filename[] = __FILE__;
#endif
