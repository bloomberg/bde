// bdealg_constructorproxy.t.cpp    -*-C++-*-
...
//
// CREATORS
// [ 1] bdealg_ConstructorProxy(b_A*);
// [ 1] bdealg_ConstructorProxy(const b_CP<OTHER>&, b_A*);
// [ 1] bdealg_ConstructorProxy(const OTHER&, b_A*);
// [ 1] ~bdealg_ConstructorProxy();
//
// MANIPULATORS
// [ 1] TYPE& object();
//
...
class TestType_Other_Template {
    ...
    // 'bdealg_ConstructorProxy' using 'TYPE's that are generated from
...
typedef bdealg_ConstructorProxy<TestType_YesAllocator> Obj_YesAllocator;
typedef bdealg_ConstructorProxy<TestType_NoAllocator>  Obj_NoAllocator;
typedef bdealg_ConstructorProxy<TestType_Other>        Obj_Other;
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 1: {
        ...
        //       2) Constructing with 'bdealg_ConstructorProxy<OTHER>'.
        //          a) 'TYPE'  = 'TestType_YesAllocator'.
        ...
        //
        // Testing:
        //   bdealg_ConstructorProxy(b_A*);
        //   bdealg_ConstructorProxy(const b_CP<OTHER>&, b_A*);
        //   bdealg_ConstructorProxy(const OTHER&, b_A*);
        //   ~bdealg_ConstructorProxy();
        //   TYPE& object();
        ...
        if (verbose) cout << "\n2) Constructing with 'bdealg_ConstructorProxy"
                          << "<OTHER>'." << endl;
        {
            if (veryVerbose) cout << "\ta) 'TYPE'  = 'TestType_YesAllocator'."
                          ...
                          << endl;
            {
                ...
                typedef bdealg_ConstructorProxy<Type>      Obj;
                typedef bdealg_ConstructorProxy<OtherType> OriginalType;
