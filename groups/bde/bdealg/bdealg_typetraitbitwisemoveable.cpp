// bdealg_typetraitbitwisemoveable.cpp                  -*-C++-*-
#include <bdes_ident.h>
BDES_IDENT_RCSID(bdealg_typetraitbitwisemoveable_cpp,"$Id$ $CSID$")
...
char bdealg_typetraitbitwisemoveable_filename[] = __FILE__;
#endif
