// bdealg_typetraitusesbdemaallocator.cpp                  -*-C++-*-
#include <bdes_ident.h>
BDES_IDENT_RCSID(bdealg_typetraitusesbdemaallocator_cpp,"$Id$ $CSID$")
...
char bdealg_typetraitusesbdemaallocator_filename[] = __FILE__;
#endif
