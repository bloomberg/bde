// bdealg_typetraithasstliterators.cpp                  -*-C++-*-
#include <bdes_ident.h>
BDES_IDENT_RCSID(bdealg_typetraithasstliterators_cpp,"$Id$ $CSID$")
...
char bdealg_typetraithasstliterators_filename[] = __FILE__;
#endif
