...
// The following code uses pipe() and fork(), so only works on Unix.
      ...
      case 1: {
        ...
        ASSERT(X == a.lastAllocatedNumBytes());
        ASSERT(desc1.address() == a.lastAllocatedAddress());
        ASSERT(0 == a.lastDeallocatedNumBytes());
        ASSERT(0 == a.lastDeallocatedAddress());
        ...
        ASSERT(X == a.lastAllocatedNumBytes());
        ASSERT(desc2.address() == a.lastAllocatedAddress());
        ASSERT(0 == a.lastDeallocatedNumBytes());
        ASSERT(0 == a.lastDeallocatedAddress());
        ...
        ASSERT(X == a.lastAllocatedNumBytes());
        ASSERT(desc2.address() == a.lastAllocatedAddress());
        ASSERT(X == a.lastDeallocatedNumBytes());
        ASSERT(desc2.address() == a.lastDeallocatedAddress());
        ASSERT(2 == a.numAllocations());
        ...
        ASSERT(2 * X == a.lastAllocatedNumBytes());
        ASSERT(desc3.address() == a.lastAllocatedAddress());
        ASSERT(X == a.lastDeallocatedNumBytes());
        ASSERT(desc2.address() == a.lastDeallocatedAddress());
        ...
        ASSERT(2 * X == a.lastAllocatedNumBytes());
        ASSERT(desc3.address() == a.lastAllocatedAddress());
        ASSERT(2 * X == a.lastDeallocatedNumBytes());
        ASSERT(desc3.address() == a.lastDeallocatedAddress());
        ASSERT(3 == a.numAllocations());
        ...
        ASSERT(desc3.address() == a.lastAllocatedAddress());
        ASSERT(X == a.lastDeallocatedNumBytes());
        ASSERT(desc1.address() == a.lastDeallocatedAddress());
        ASSERT(3 == a.numAllocations());
