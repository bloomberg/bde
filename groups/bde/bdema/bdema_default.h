...
//
//@DEPRECATED: Use 'bslma_default' instead.
//
//@CLASSES:
...
// compiler-generated temporary object of a type that requires an allocator
// is created).
//
// Initially, both the default allocator and global allocator resolve to the
// address of the 'bdema_NewDeleteAllocator' singleton, i.e.:
//..
...
// 'bdema_Default::defaultAllocator' and 'bdema_Default::allocator' (the
// latter when called with no argument, or an explicit 0).  When
// 'bdema_Default::allocator' is supplied with a non-0 argument, it simply
...
// 'bdema_Default::allocator' method facilitates this behavior.  See the
// usage examples below for an illustration of this technique.
//
// The default allocator can be set *prior* to a call to
// 'bdema_Default::defaultAllocator', to 'bdema_Default::allocator' with no
// argument or an explicit 0, or to 'bdema_Default::lockDefaultAllocator', by
// calling 'bdema_Default::setDefaultAllocator'.  This method returns 0 on
...
// *explicitly* locked by calling 'bdema_Default::lockDefaultAllocator'.  In
// addition, the default allocator is *implicitly* locked as a *side-effect* of
// calling 'bdema_Default::defaultAllocator', or 'bdema_Default::allocator'
// with no argument or an explicit 0.  Once locked, the default allocator
// cannot be unlocked.  However, the 'bdema_Default::setDefaultAllocatorRaw'
// method will unconditionally set the default allocator regardless of whether
// it is locked.
//
// A well-behaved program should call 'bdema_Default::setDefaultAllocator'
// *once*.  It should be invoked in 'main' before starting any threads, and
// be followed immediately by a call to 'bdema_Default::lockDefaultAllocator.
// Note that 'bdema_Default::setDefaultAllocatorRaw' is provided for *testing*
// *only*, and should *never* be used in a production environment.
//
///Global Allocator
///----------------
// The interface pertaining to the global allocator is comparatively much
// simpler, consisting of just two methods.  The
// 'bdema_Default::globalAllocator' method, when called with no argument (or
...
// argument, 'bdema_Default::globalAllocator' simply returns that argument to
// the caller (i.e., it acts as a pass-through similar to
// 'bdema_Default::allocator' when it is supplied with a non-0 argument).  The
// global allocator may be set using the 'bdema_Default::setGlobalAllocator'
// method.  This method *always* succeeds.  In that respect, the global
// allocator cannot become locked like the default allocator.
// 'bdema_Default::setGlobalAllocator' returns the global allocator that is in
// effect upon entry to the function.
//
// Note that 'bdema_Default::setGlobalAllocator' should be used with *extreme*
