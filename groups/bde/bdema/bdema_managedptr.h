...
#if 0
                    // ==================================
                    // private class bslma::ManagedPtr_Ref
                    // ==================================

template <class TARGET_TYPE>
class bslma::ManagedPtr_Ref {
    ...
    // ownership of 'bslma::ManagedPtr_Members' pointers when assigning or
    // constructing 'bdema_ManagedPtr' objects.

    bslma::ManagedPtr_Members *d_base_p;  // non-null pointer to the managed
  ...
  public:
    bslma::ManagedPtr_Ref(bslma::ManagedPtr_Members *base, TARGET_TYPE *target);
        // Create a 'bslma::ManagedPtr_Ref' object having the specified 'base'
        // value for its 'base' attribute.  Behavior is undefined unless
        // '0 != base'.


    //! bslma::ManagedPtr_Ref(const bslma::ManagedPtr_Ref& original);
        // Create a 'bslma::ManagedPtr_Ref' object having the same 'd_base_p'
    ...
    //! bslma::ManagedPtr_Ref& operator=(const bslma::ManagedPtr_Ref& original);
        // Create a 'bslma::ManagedPtr_Ref' object having the same 'd_base_p'
...
class bdema_ManagedPtr : public bslma::ManagedPtr<TARGET_TYPE> {
  ...
  private:
    ...
    // DATA
    bslma::ManagedPtr_Members d_members;  // state managed by this object
...
#else
//    using bslma::ManagedPtr<TARGET_TYPE>::load;
//    using bslma::ManagedPtr<TARGET_TYPE>::reset;
...
template <class TARGET_TYPE>
inline
bslma::ManagedPtr_Ref<TARGET_TYPE>::bslma::ManagedPtr_Ref(
                                              bslma::ManagedPtr_Members *base,
                                              TARGET_TYPE              *target)
: d_base_p(base)
, d_cast_p(target)
{
...
template <class TARGET_TYPE>
inline
bslma::ManagedPtr_Members *bslma::ManagedPtr_Ref<TARGET_TYPE>::base() const
{
    return d_base_p;
}
                                         ...
                                         TARGET_TYPE                    *ptr)
{
    ...
    bslma::ManagedPtr<TARGET_TYPE>::loadAlias(alias, ptr);
}
...
{
    bslma::ManagedPtr<TARGET_TYPE>::clear();
}
...
{
    return bslma::ManagedPtr<TARGET_TYPE>::release();
}
...
{
    bslma::ManagedPtr<TARGET_TYPE>::swap(other);
}
#endif
...
#if 0
    return bslma::ManagedPtr_Ref<REFERENCED_TYPE>(&d_members,
...
{
    return bslma::ManagedPtr<TARGET_TYPE>::deleter();
}
...
{
    return bslma::ManagedPtr<TARGET_TYPE>::ptr();
}
#else
template <typename TARGET_TYPE>
bsl::pair<TARGET_TYPE *, bdema_ManagedPtrDeleter>
