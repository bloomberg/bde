...
//-----------------------------------------------------------------------------
// [ 1] bdema_TestAllocator(int verboseFlag = 0);
// [ 6] bdema_TestAllocator(const char *name, int verboseFlag = 0);
// [ 2] ~bdema_TestAllocator();
...
// [ 2] int isNoAbort() const;
// [ 2] int isQuiet() const;
// [ 2] int isVerbose() const;
...
// [ 1] int numAllocation() const;
// [ 1] int numDeallocation() const;
// [ 6] const char *name() const;
//
// [ 4] ostream& operator<<(ostream& lhs, const bdema_TestAllocator& rhs);
//-----------------------------------------------------------------------------
...
// This is copied from 'bdema_testallocator.cpp' to compare with scribbled
// deallocated memory.
...
static int verifyPrint(const bdema_TestAllocator& ta,
...
#ifdef BSLS_PLATFORM__OS_UNIX
{
    ...
    // Because bdema is a low-level utility, bdema_TestAllocator does not
...
// TBD temporarily commented out for other fix
#if 0
        if (verbose) cout << "Testing buffer over/underrun detection\n"
                             "======================================\n";

        bdema_TestAllocator alloc(veryVeryVerbose);
        char *seg;
...
// insufficient resources to handle the exception, so 'abort()' was invoked.
      ...
      case 8: {
        ...
        //   the 'bdema_TestAllocator'.  Makes sure that the number of
        ...
        //
        // Testing:
        //   'd_list' inside 'bdema_TestAllocator'
        // --------------------------------------------------------------------
        ...
        bdema_TestAllocator allocator1(veryVeryVerbose);
        allocator1.setNoAbort(verbose);
        allocator1.setQuiet(!veryVerbose);

        bdema_TestAllocator allocator2(veryVeryVerbose);
     ...
     case 7: {
        ...
        //   'bdema_TestAllocator'.  Ensures that the list of outstanding
      ...
      case 6: {
        ...
        //   Testing the 'bdema_TestAllocator' constructed with a name.
        //   Ensures that the name is accessible through the 'name()' function.
        //
        // Testing:
        //   bdema_TestAllocator(const char* name, int verboseFlag = 0);
        ...
        bdema_TestAllocator a(NAME, veryVeryVerbose);
      ...
      case 5: {
        ...
        bdema_TestAllocator mX(veryVeryVerbose);
      ...
      case 4: {
        ...
        //
        // Testing:
        //   ostream& operator<<(ostream& lhs, const bdema_TestAllocator& rhs);
        // --------------------------------------------------------------------
      ...
      case 3: {
...

        {
            ...
            bdema_TestAllocator a(veryVeryVerbose);
    ...
    // For this reason, this part of the test has been removed for now.
      ...
      case 1: {
        ...
        //
        //   bdema_TestAllocator(int verboseFlag = 0);
