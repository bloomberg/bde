// bdema_memoryblockdescriptor.t.cpp                                  -*-C++-*-
...
//                                  Overview
//                                  --------
// The 'bdema_MemoryBlockDescriptor' is a simple value object holding to
...
//-----------------------------------------------------------------------------
// [ 3] bdema_MemoryBlockDescriptor();
// [ 3] bdema_MemoryBlockDescriptor(void *, std::size_t);
// [ 5] bdema_MemoryBlockDescriptor(const bdema_MemoryBlockDescriptor&);
// [ 2] ~bdema_MemoryBlockDescriptor();
// [ 6] bdema_MemoryBlockDescriptor& operator=(
//                                  const bdema_MemoryBlockDescriptor&);
// [ 7] bool isNull() const;
// [ 2] void *address() const;
// [ 2] size_type size() const;
// [ 8] bsl::ostream& print() const;
// [ 4] operator==(const bdema_MemoryBlockDescriptor&,
//                 const bdema_MemoryBlockDescriptor&);
// [ 4] operator!=(const bdema_MemoryBlockDescriptor&,
//                 const bdema_MemoryBlockDescriptor&);
// [ 8] operator<<(bsl::ostream&, const bdema_MemoryBlockDescriptor&);
//-----------------------------------------------------------------------------
// [ 1] BREATHING TEST
// [ 9] USAGE EXAMPLE
//=============================================================================
...
typedef bdema_MemoryBlockDescriptor Obj;
...
//..
      ...
      case 8: {
        ...
        //
        // Testing:
        //   operator<<(ostream&, const bdema_MemoryBlockDescriptor&);
...
// The following code uses pipe() and fork(), so only works on Unix.
      ...
      case 4: {
        ...
        //
        // Testing:
        //   bool operator==(const bdema_MemoryBlockDescriptor&,
        //                   const bdema_MemoryBlockDescriptor&);
        //   bool operator!=(const bdema_MemoryBlockDescriptor&,
        //                   const bdema_MemoryBlockDescriptor&);
        // --------------------------------------------------------------------
      ...
      case 1: {
        ...
        if (verbose) cout << endl
                          << "Verify: bdema_MemoryBlockDescriptor"
                          << endl << "==========================="
                          << endl;
