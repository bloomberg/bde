...
// CLASS METHODS
void *bdema_BufferAllocator::allocateFromBuffer(int               *cursor,
                                                char              *buffer,
                                                size_type          bufSize,
                                                size_type          size,
...
// CREATORS
bdema_BufferAllocator::~bdema_BufferAllocator()
{
}

// MANIPULATORS
void *bdema_BufferAllocator::allocate(size_type size)
{
    BSLS_ASSERT(0 <= size);
...
// ACCESSORS
void bdema_BufferAllocator::print() const
{
    union {
    ...
    std::printf("buffer address      = %p\n"
                ...
                d_cursor,
                u.d_p,
                bdema_BufferAllocator::MAXIMUM_ALIGNMENT == d_strategy
                ? "MAXIMUM_ALIGNMENT"
                : "NATURAL_ALIGNMENT");
