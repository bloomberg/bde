...
//@PURPOSE: Provide new/delete adaptor to 'bslma::Allocator' protocol.
//
...
//
//@DESCRIPTION: This component implements the 'bslma::Allocator' protocol to
...
// user-supplied allocator derived from 'bslma::Allocator'.  To accomplish this
...
// global operator 'new', but through the 'bslma::Allocator' protocol.
//..
//   my_ShortArray a;
//..
...
typedef bslma::NewDeleteAllocator bdema_NewDeleteAllocator;
