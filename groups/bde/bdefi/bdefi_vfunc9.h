// bdefi_vfunc9.h               -*-C++-*-
#ifndef INCLUDED_BDEFI_VFUNC9
#define INCLUDED_BDEFI_VFUNC9

//@PURPOSE: Provide concrete representations for 9-arg void function objects.
//
//@CLASSES:
//
// bdefi_Vfunc9Null: a 9-arg void no-op functor
//
// bdefi_Vfunc9F9: a 9-arg void functor created from a 9-arg function
//
// bdefi_Vfunc9C9: a 9-arg void functor created from obj & 9-arg method
//
// bdefi_Vfunc9M9: a 9-arg void functor created from obj ptr & 9-arg method
//
...
// implementation of the base 'bdefr_Vfunc9' representation based on the
...
// then the "null functor" 'bdefi_Vfunc9Null' may be used.
//
///Language-Imposed Details
///------------------------
// For practical reasons, this component must distinguish among four types of
// functors.  The first type is a "null functor" 'bdefi_Vfunc9Null', which
...
// three non-null concrete implementations are named 'bdefi_Vfunc9X9' where
// 'X' is one of {'F', 'C', 'M'}.
//
...
//..
// Note that a 'const' member function may be wrapped by a 'bdefi_Vfunc9MN'
// functor, but wrapping a non-'const' method by a 'bdefi_Vfunc9CN' will
// result in compile time error in most compiler implementations.
//
// Note also that, to accommodate the preservation of 'const', the
// 'bdefi_Vfunc9C9' functors hold an object 'Obj', supplied by a 'const'
// 'Obj&' in the constructor, while 'bdefi_Vfunc9M9' functors hold a pointer
...
#ifndef INCLUDED_BDEFR_VFUNC9
#include <bdefr_vfunc9.h>
#endif
...
namespace BloombergLP {
                        ...
                        // ======================
                        // class bdefi_Vfunc9Null
                        // ======================

template <class A1, class A2, class A3, class A4, class A5, class A6,
          class A7, class A8, class A9>
class bdefi_Vfunc9Null :
                 public bdefr_Vfunc9<A1, A2, A3, A4, A5, A6, A7, A8, A9> {
  ...
  private:
    // not implemented
    bdefi_Vfunc9Null(
        const bdefi_Vfunc9Null<A1, A2, A3, A4, A5, A6, A7, A8, A9>&);
    bdefi_Vfunc9Null<A1, A2, A3, A4, A5, A6, A7, A8, A9>& operator=(
        const bdefi_Vfunc9Null<A1, A2, A3, A4, A5, A6, A7, A8, A9>&);

  public:
    // CREATORS
    inline bdefi_Vfunc9Null(bdema_Allocator *basicAllocator);
        // Create a representation for a function object (functor) taking nine
        // arguments, returning 'void', and performing no operation.

  private:
    inline ~bdefi_Vfunc9Null();
    ...
    inline void execute(const A1& argument1, const A2& argument2,
        ...
        // 'argument7', 'argument8', and 'argument9'.
                        ...
                        // ====================
                        // class bdefi_Vfunc9F9
                        // ====================

template <class F, class A1, class A2, class A3, class A4, class A5, class A6,
          class A7, class A8, class A9>
class
bdefi_Vfunc9F9 : public bdefr_Vfunc9<A1, A2, A3, A4, A5, A6, A7, A8, A9> {
    // This class defines the representation for a function object (functor),
  ...
  private:
    // not implemented
    bdefi_Vfunc9F9(
        const bdefi_Vfunc9F9<F, A1, A2, A3, A4, A5, A6, A7, A8, A9>&);
    bdefi_Vfunc9F9<F, A1, A2, A3, A4, A5, A6, A7, A8, A9>& operator=(
        const bdefi_Vfunc9F9<F, A1, A2, A3, A4, A5, A6, A7, A8, A9>&);

  public:
    // CREATORS
    inline bdefi_Vfunc9F9(F                procedure,
...
class bdefi_Vfunc9C9 :
  ...
  private:
    // not implemented
    bdefi_Vfunc9C9(
        const bdefi_Vfunc9C9<OBJ, C, A1, A2, A3, A4, A5, A6, A7, A8, A9>&);
    bdefi_Vfunc9C9<OBJ, C, A1, A2, A3, A4, A5, A6, A7, A8, A9>& operator=(
        const bdefi_Vfunc9C9<OBJ, C, A1, A2, A3, A4, A5, A6, A7, A8, A9>&);
  public:
    // CREATORS
    inline bdefi_Vfunc9C9(const OBJ&       object,
                          C                method,
                          bdema_Allocator *basicAllocator);
        // Create a representation for a function object (functor) taking nine
...
bdefi_Vfunc9M9 : public bdefr_Vfunc9<A1, A2, A3, A4, A5, A6, A7, A8, A9> {
  ...
  private:
    // not implemented
    bdefi_Vfunc9M9(
        const bdefi_Vfunc9M9<OBJ, M, A1, A2, A3, A4, A5, A6, A7, A8, A9>&);
    bdefi_Vfunc9M9<OBJ, M, A1, A2, A3, A4, A5, A6, A7, A8, A9>& operator=(
        const bdefi_Vfunc9M9<OBJ, M, A1, A2, A3, A4, A5, A6, A7, A8, A9>&);
  public:
    // CREATORS
    inline bdefi_Vfunc9M9(OBJ             *object,
                          M                method,
                          bdema_Allocator *basicAllocator);
        // Create a representation for a function object (functor) taking nine
...
inline
bdefi_Vfunc9Null<A1, A2, A3, A4, A5, A6, A7, A8, A9>::bdefi_Vfunc9Null(
                                             bdema_Allocator *basicAllocator)
: bdefr_Vfunc9<A1, A2, A3, A4, A5, A6, A7, A8, A9>(basicAllocator)
{
}
...
template <class A1, class A2, class A3, class A4,
          class A5, class A6, class A7, class A8, class A9>
inline void bdefi_Vfunc9Null<A1, A2, A3, A4, A5, A6, A7, A8, A9>::execute(
                                                   const A1& argument1,
                                                   const A2& argument2,
                                                   const A3& argument3,
                                                   const A4& argument4,
...
template <class F, class A1, class A2, class A3, class A4,
          class A5, class A6, class A7, class A8, class A9>
inline
bdefi_Vfunc9F9<F, A1, A2, A3, A4, A5, A6, A7, A8, A9>::bdefi_Vfunc9F9(
                                             F                procedure,
                                             bdema_Allocator *basicAllocator)
: bdefr_Vfunc9<A1, A2, A3, A4, A5, A6, A7, A8, A9>(basicAllocator)
, d_f(procedure)
...
template <class F, class A1, class A2, class A3, class A4, class A5, class A6,
          class A7, class A8, class A9>
inline bdefi_Vfunc9F9<F, A1, A2, A3, A4, A5, A6, A7, A8, A9>::~bdefi_Vfunc9F9()
{
}

template <class F, class A1, class A2, class A3, class A4, class A5, class A6,
          class A7, class A8, class A9>
inline void bdefi_Vfunc9F9<F, A1, A2, A3, A4, A5, A6, A7, A8, A9>::execute(
                                                   const A1& argument1,
                                                   const A2& argument2,
                                                   const A3& argument3,
                                                   const A4& argument4,
...
template <class OBJ, class C, class A1, class A2, class A3, class A4,
          class A5, class A6, class A7, class A8, class A9>
inline
bdefi_Vfunc9C9<OBJ, C, A1, A2, A3, A4, A5, A6, A7, A8, A9>::bdefi_Vfunc9C9(
                                             const OBJ&       object,
                                             C                method,
                                             bdema_Allocator *basicAllocator)
: bdefr_Vfunc9<A1, A2, A3, A4, A5, A6, A7, A8, A9>(basicAllocator)
...
template <class OBJ, class C, class A1, class A2,
          class A3, class A4, class A5, class A6, class A7, class A8, class A9>
inline
void bdefi_Vfunc9C9<OBJ, C, A1, A2, A3, A4, A5, A6, A7, A8, A9>::execute(
                                                   const A1& argument1,
                                                   const A2& argument2,
                                                   const A3& argument3,
                                                   const A4& argument4,
...
template <class OBJ, class M, class A1, class A2,
          class A3, class A4, class A5, class A6, class A7, class A8, class A9>
inline
bdefi_Vfunc9M9<OBJ, M, A1, A2, A3, A4, A5, A6, A7, A8, A9>::bdefi_Vfunc9M9(
                                             OBJ             *object,
                                             M                method,
                                             bdema_Allocator *basicAllocator)
: bdefr_Vfunc9<A1, A2, A3, A4, A5, A6, A7, A8, A9>(basicAllocator)
...
template <class OBJ, class M, class A1, class A2,
          class A3, class A4, class A5, class A6, class A7, class A8, class A9>
inline
void bdefi_Vfunc9M9<OBJ, M, A1, A2, A3, A4, A5, A6, A7, A8, A9>::execute(
                                                   const A1& argument1,
                                                   const A2& argument2,
                                                   const A3& argument3,
                                                   const A4& argument4,
