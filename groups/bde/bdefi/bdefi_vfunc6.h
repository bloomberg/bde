...
// implementations are named 'bdefi_Vfunc6XN' where 'X' is one of 'F', 'C', or
...
class bdefi_Vfunc6Null : public bdefr_Vfunc6<A1, A2, A3, A4, A5, A6> {
  ...
  public:
    // CREATORS
    bdefi_Vfunc6Null(bslma::Allocator *basicAllocator);
...
class bdefi_Vfunc6F6 : public bdefr_Vfunc6<A1, A2, A3, A4, A5, A6> {
  ...
  public:
    // CREATORS
    bdefi_Vfunc6F6(F procedure, bslma::Allocator *basicAllocator);
        // Create a representation for a function object (functor) taking six
