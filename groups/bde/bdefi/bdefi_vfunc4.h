...
// implementations are named 'bdefi_Vfunc4XN' where 'X' is one of {'F', 'C',
...
class bdefi_Vfunc4Null : public bdefr_Vfunc4<A1, A2, A3, A4> {
  ...
  public:
    // CREATORS
    bdefi_Vfunc4Null(bslma_Allocator *basicAllocator);
...
class bdefi_Vfunc4F4 : public bdefr_Vfunc4<A1, A2, A3, A4> {
  ...
  public:
    // CREATORS
    bdefi_Vfunc4F4(F procedure, bslma_Allocator *basicAllocator);
        // Create a representation for a function object (functor) taking four
