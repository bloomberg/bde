...
// non-'const' member function for every 'bdefi_Vfunc8MN' class.  Also, verify
...
//  'c_O'     for 'const OBJ'
//-----------------------------------------------------------------------------
// 'bdefi_Vfunc8Null' methods:
// [ 8] bdefi_Vfunc8Null<A1-8>(ba *);
// [ 8] void execute<A1-8>(c_A1-8&) const;
// [ 8] ~bdefi_Vfunc8Null<A1-8>();
//-----------------------------------------------------------------------------
// 'bdefi_Vfunc8F8' methods:
// [ 8] bdefi_Vfunc8F8<F, A1-8>(c_F&, ba *);
// [ 8] void execute<F, A1-8>(c_A1-8&) const;
// [ 8] ~bdefi_Vfunc8F8<F, A1-8>();
// ----------------------------------------------------------------------------
// 'bdefi_Vfunc8C8' methods:
// [ 8] bdefi_Vfunc8C8<OBJ, C, A1-8>( OBJ *, c_C&, ba *);
// [ 8] void execute<OBJ, C, A1-8>(c_A1-8&) const;
// [ 8] ~bdefi_Vfunc8C8<OBJ, C, A1-8>();
// ----------------------------------------------------------------------------
// 'bdefi_Vfunc8M8' methods:
// [ 8] bdefi_Vfunc8M8<OBJ, M, A1-8>( OBJ *, c_M&, a *);
// [ 8] void execute<OBJ, M, A1-8>(c_A1-8&) const;
// [ 8] ~bdefi_Vfunc8M8<OBJ, M, A1-8>();
//-----------------------------------------------------------------------------
// 'bdefi_Vfunc8F9' methods:
// [ 9] bdefi_Vfunc8F9<F, A1-8, D1>(c_F&, c_D1&, ba *);
// [ 9] void execute<F, A1-8, D1>(c_A1-8&) const;
// [ 9] ~bdefi_Vfunc8F9<F, A1-8, D1>();
// ----------------------------------------------------------------------------
// 'bdefi_Vfunc8C9' methods:
// [ 9] bdefi_Vfunc8C9<OBJ, C, A1-8, D1>( OBJ *, c_C&, c_D1&, ba *);
// [ 9] void execute<OBJ, C, A1-8, D1>(c_A1-8&) const;
// [ 9] ~bdefi_Vfunc8C9<OBJ, C, A1-8, D1>();
// ----------------------------------------------------------------------------
// 'bdefi_Vfunc8M9' methods:
// [ 9] bdefi_Vfunc8M9<OBJ, M, A1-8, D1>( OBJ *, c_M&, c_D1, ba *);
// [ 9] void execute<OBJ, M, A1-8, D1>(c_A1-8&) const;
// [ 9] ~bdefi_Vfunc8M9<OBJ, M, A1-8, D1>();
//-----------------------------------------------------------------------------
// [11] USAGE EXAMPLE
...
//       // that 'bdefi_vfunc8X4' classes pass when calling the callback
//       // function.
//       //
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 10: {
        ...
        //   'pragma' in 'bdefi_vfunc8.h' fixes this problem.  This test
...

        {
            ...
            typedef bdefr_Vfunc8<rrr *, rrr *, rrr *, rrr *,
                                 rrr *, rrr *, rrr *, rrr *> ObjBase;

            typedef bdefi_Vfunc8F9<CbFuncF9,
                                       rrr *, rrr *, rrr *, rrr *,
                                       rrr *, rrr *, rrr *, rrr *, rrr *> Obj1;

            typedef bdefi_Vfunc8F9<CbFuncF10,
                                       rrr *, rrr *, rrr *, rrr *,
      ...
      case 9: {
        ...
        //       functions by 'bdefi_Vfunc8M9' instances.
        //    5. Destructor of each class under test is properly executed.
        //
        // Plan:
        //   Create objects of every 'bdefi_Vfunc8X9' class.  Initialize
        //   'bdefi_Vfunc8F9' to have 'checkArgumentValues9' as the callback
        //   function.  Initialize 'bdefi_Vfunc8C9' and 'bdefi_Vfunc8M9' to
        //   have 'checkArgumentValues9' method of the 'CbClass' class as the
        //   callback function.  Call the 'execute' method for each
        //   'bdefi_Vfunc8X9' class.  The arguments in this call are
        ...
        //
        //   Create objects of every 'bdefi_Vfunc8X9' class.  Initialize
        //   'bdefi_Vfunc8F9' to have 'checkParameterTypes9' as the callback
        //   function.  Initialize 'bdefi_Vfunc8C9' to have
        //   'checkParameterTypesC9' method of the 'CbClass' class as the
        //   callback function.  Initialize 'bdefi_Vfunc8M9' to have
        //   'checkParameterTypesM9' method of the 'CbClass' class as the
        //   callback function.  The latter will test wether the
        //   'bdefi_Vfunc8M9' can have non-'const' functions as the callback
        //   function.
        //
        //   Having a function of 'checkParameterTypes' family as a callback
        //   function forces 'bdefi_Vfunc8X9' to be templatized so that each
        ...
        // Testing:
        //   'bdefi_Vfunc8F9' methods:
        //   bdefi_Vfunc8F9<F, A1-8, D1>(c_F&, c_D1&, ba *);
        //   void execute<F, A1-8, D1>(c_A1-8&) const;
        //   ~bdefi_Vfunc8F9<F, A1-8, D1>();
        // --------------------------------------------------------------------
        //   'bdefi_Vfunc8C9' methods:
        //   bdefi_Vfunc8C9<OBJ, C, A1-8, D1>( OBJ *, c_C&, c_D1&, ba *);
        //   void execute<OBJ, C, A1-8, D1>(c_A1-8&) const;
        //   ~bdefi_Vfunc8C9<OBJ, C, A1-8, D1>();
        // --------------------------------------------------------------------
        //   'bdefi_Vfunc8M9' methods:
        //   bdefi_Vfunc8M9<OBJ, M, A1-8, D1>( OBJ *, c_M&, c_D1, ba *);
        //    void execute<OBJ, M, A1-8, D1>(c_A1-8&) const;
        //   ~bdefi_Vfunc8M9<OBJ, M, A1-8, D1>();
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting constructors and argument values." << endl;
        {
            ...
            typedef void (CbClass::*CbFuncC9)(int *, int *, int *, int *,
                                              int *, int *, int *, int *,
                                              int *) const;
            typedef bdefr_Vfunc8<int *, int *, int *, int *,
            ...
            if (verbose) cout << "\t'bdefi_Vfunc8F9' object." << endl;
            {
                typedef bdefi_Vfunc8F9<CbFuncF9,
                                       int *, int *, int *, int *,
            ...
            if (verbose) cout << "\t'bdefi_Vfunc8C9' object." << endl;
            {
                typedef bdefi_Vfunc8C9<CbClass, CbFuncC9, int *, int *,
                                       int *, int *, int *, int *, int *,
                                       int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
            ...
            if (verbose) cout << "\t'bdefi_Vfunc8M9' object." << endl;
            {
                typedef bdefi_Vfunc8M9<CbClass, CbFuncC9,
                                       int *, int *, int *, int *,
                                       int *, int *, int *, int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
            ...
            cout << "\nTesting parameter types and destructors." << endl;
        {
            ...
            typedef void (CbClass::*CbFuncM9)(T1, T2, T3, T4, T5, T6, T7, T8,
                                              T9);
            typedef bdefr_Vfunc8<T1, T2, T3, T4, T5, T6, T7, T8> ObjBase;
            ...
            if (verbose)
                cout << "\tWhen calling 'bdefi_Vfunc8F9' 'execute' method."
                     << endl;
            {
                typedef bdefi_Vfunc8F9<CbFuncF9, T1, T2, T3, T4, T5, T6, T7,
                                       T8, T9> Obj;
                dcEnabled = 0;
            ...
            if (verbose)
                cout << "\tWhen calling 'bdefi_Vfunc8C9' 'execute' method."
                     << endl;
            {
                typedef bdefi_Vfunc8C9<CbClass, CbFuncC9, T1, T2,
            ...
            if (verbose)
                cout << "\tWhen calling 'bdefi_Vfunc8M9' 'execute' method."
                     << endl;
            {
                typedef bdefi_Vfunc8M9<CbClass, CbFuncM9, T1, T2, T3, T4,
                                       T5, T6, T7, T8, T9> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG8;
                numDeallocations = ta.numDeallocation();
      ...
      case 8: {
        ...
        //       those intended as argument types for the function parameters.
        //    4. Non-'const' member functions can be used as callback
        //       functions by 'bdefi_Vfunc8M8' instances.
        //    5. Destructor of each class under test is properly executed.
        //
        // Plan:
        //   Create objects of every 'bdefi_Vfunc8X8' class.  Initialize
        //   'bdefi_Vfunc8F8' to have 'checkArgumentValues8' as the callback
        //   function.  Initialize 'bdefi_Vfunc8C8' and 'bdefi_Vfunc8M8' to
        //   have 'checkArgumentValues8' method of the 'CbClass' class as the
        //   callback function.  Call the 'execute' method for each
        //   'bdefi_Vfunc8X8' class.  The arguments in this call are
        //   initialized with values of 'ARG1', 'ARG2', 'ARG3', 'ARG4',
        ...
        //
        //   Create objects of every 'bdefi_Vfunc8X8' class.  Initialize
        //   'bdefi_Vfunc8F8' to have 'checkParameterTypes8' as the callback
        //   function.  Initialize 'bdefi_Vfunc8C8' to have
        //   'checkParameterTypesC8' method of the 'CbClass' class as the
        //   callback function.  Initialize 'bdefi_Vfunc8M8' to have
        //   'checkParameterTypesM8' method of the 'CbClass' class as the
        //   callback function.  The latter will test wether the
        //   'bdefi_Vfunc8M8' can have non-'const' functions as the callback
        //   function.
        //
        //   Having a function of 'checkParameterTypes' family as a callback
        //   function forces 'bdefi_Vfunc8X8' to be templatized so that each
        //   argument to the callback function will be of unique type.  Hence,
        //   if the types of arguments passed in to the callback function is
        //   incorrect, the compiler will generate an error.
        //
        ...
        // Testing:
        //   'bdefi_Vfunc8F8' methods:
        //   bdefi_Vfunc8F8<F, A1-7, D1-3>(c_F&, c_D1-3&, ba *);
        //   void execute<F, A1-7, D1-3>(c_A1-7&) const;
        //   ~bdefi_Vfunc8F8<F, A1-7, D1-3>();
        // -------------------------------------------------------------------
        //   'bdefi_Vfunc8C8' methods:
        //   bdefi_Vfunc8C8<OBJ, C, A1-7, D1-3>( OBJ *, c_C&, c_D1-3&, ba *);
        //   void execute<OBJ, C, A1-7, D1-3>(c_A1-7&) const;
        //   ~bdefi_Vfunc8C8<OBJ, C, A1-7, D1-3>();
        // --------------------------------------------------------------------
        //   'bdefi_Vfunc8M8' methods:
        //   bdefi_Vfunc8M8<OBJ, M, A1-7, D1-3>( OBJ *, c_M&, c_D1-3, ba *);
        //    void execute<OBJ, M, A1-7, D1-3>(c_A1-7&) const;
        //   ~bdefi_Vfunc8M8<OBJ, M, A1-7, D1-3>();
        // --------------------------------------------------------------------
        //   'bdefi_Vfunc8Null' methods:
        //   bdefi_Vfunc8Null<A1-7>(ba *);
        //   void execute<A1-7>(c_A1-7&) const;
        //   ~bdefi_Vfunc8Null<A1-7>();
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting constructors and argument values." << endl;
        {
            ...
            if (verbose) cout << "\t'bdefi_Vfunc8F8' object." << endl;
            {
                typedef bdefi_Vfunc8F8<CbFuncF8,
                                       int *, int *, int *, int *,
                                       int *, int *, int *, int *> Obj;
            ...
            if (verbose) cout << "\t'bdefi_Vfunc8C8' object." << endl;
            {
                typedef bdefi_Vfunc8C8<CbClass, CbFuncC8, int *, int *,
                                       int *, int *, int *, int *,
                                       int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
            ...
            if (verbose) cout << "\t'bdefi_Vfunc8M8' object." << endl;
            {
                typedef bdefi_Vfunc8M8<CbClass, CbFuncC8,
                                       int *, int *, int *, int *,
                                       int *, int *, int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
            ...
            cout << "\nTesting parameter types and destructors." << endl;
        {
            ...
            if (verbose)
                cout << "\tWhen calling 'bdefi_Vfunc8F8' 'execute' method."
                     << endl;
            {
                typedef bdefi_Vfunc8F8<CbFuncF8, T1, T2, T3, T4, T5, T6, T7,
                                       T8> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG8;
                numDeallocations = ta.numDeallocation();
            ...
            if (verbose)
                cout << "\tWhen calling 'bdefi_Vfunc8C8' 'execute' method."
                     << endl;
            {
                typedef bdefi_Vfunc8C8<CbClass, CbFuncC8, T1, T2,
            ...
            if (verbose)
                cout << "\tWhen calling 'bdefi_Vfunc8M8' 'execute' method."
                     << endl;
            {
                typedef bdefi_Vfunc8M8<CbClass, CbFuncM8, T1, T2, T3, T4,
                                       T5, T6, T7, T8> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG8;
                numDeallocations = ta.numDeallocation();
            ...
            if (verbose)
                cout << "\nTesting bdefi_Vfunc8Null object." << endl;
            {
                destructorCheck = DESTRUCTOR_FLAG8;
                numDeallocations = ta.numDeallocation();

                typedef bdefi_Vfunc8Null<T1, T2, T3, T4, T5, T6, T7, T8> Obj;
