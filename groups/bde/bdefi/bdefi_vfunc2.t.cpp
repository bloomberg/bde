...
// non-'const' member function for every 'bdefi_Vfunc2MN' class.  Also, verify
...
//  'c_O'     for 'const OBJ'
//-----------------------------------------------------------------------------
// [ 2] 'bdefi_Vfunc2Null' methods:
// [ 2] bdefi_Vfunc2Null<A1-2>(ba *);
// [ 2] void execute<A1-2>(c_A1-2&) const;
// [ 2] ~bdefi_Vfunc2Null<A1-2>();
// ----------------------------------------------------------------------------
// 'bdefi_Vfunc2F2' methods:
// [ 2] bdefi_Vfunc2F2<F, A1-2>(c_F&, ba *);
// [ 2] void execute<F, A1-2>(c_A1-2&) const;
// [ 2] ~bdefi_Vfunc2F2<F, A1-2>();
// ----------------------------------------------------------------------------
// 'bdefi_Vfunc2C2' methods:
// [ 2] bdefi_Vfunc2C2<OBJ, C, A1-2>( OBJ *, c_C&, ba *);
// [ 2] void execute<OBJ, C, A1-2>(c_A1-2&) const;
// [ 2] ~bdefi_Vfunc2C2<OBJ, C, A1-2>();
// ----------------------------------------------------------------------------
// 'bdefi_Vfunc2M2' methods:
// [ 2] bdefi_Vfunc2M2<OBJ, M, A1-2>( OBJ *, c_M&, ba *);
// [ 2] void execute<OBJ, M, A1-2>(c_A1-2&) const;
// [ 2] ~bdefi_Vfunc2M2<OBJ, M, A1-2>();
//-----------------------------------------------------------------------------
// 'bdefi_Vfunc2F3' methods:
// [ 3] bdefi_Vfunc2F3<F, A1-2, D1>(c_F&, c_D1&, ba *);
// [ 3] void execute<F, A1-2, D1>(c_A1-2&) const;
// [ 3] ~bdefi_Vfunc2F3<F, A1-2, D1>();
// ----------------------------------------------------------------------------
// 'bdefi_Vfunc2C3' methods:
// [ 3] bdefi_Vfunc2C3<OBJ, C, A1-2, D1>( OBJ *, c_C&, c_D1&, ba *);
// [ 3] void execute<OBJ, C, A1-2, D1>(c_A1-2&) const;
// [ 3] ~bdefi_Vfunc2C3<OBJ, C, A1-2, D1>();
// ----------------------------------------------------------------------------
// 'bdefi_Vfunc2M3' methods:
// [ 3] bdefi_Vfunc2M3<OBJ, M, A1-2, D1>( OBJ *, c_M&, c_D1, ba *);
// [ 3] void execute<OBJ, M, A1-2, D1>(c_A1-2&) const;
// [ 3] ~bdefi_Vfunc2M3<OBJ, M, A1-2, D1>();
//-----------------------------------------------------------------------------
// 'bdefi_Vfunc2F4' methods:
// [ 4] bdefi_Vfunc2F4<F, A1-2, D1-2>(c_F&, c_D1-2&, ba *);
// [ 4] void execute<F, A1-2, D1-2>(c_A1-2&) const;
// [ 4] ~bdefi_Vfunc2F4<F, A1-2, D1-2>();
// ----------------------------------------------------------------------------
// 'bdefi_Vfunc2C4' methods:
// [ 4] bdefi_Vfunc2C4<OBJ, C, A1-2, D1-2>( OBJ *, c_C&, c_D1-2&, ba *);
// [ 4] void execute<OBJ, C, A1-2, D1-2>(c_A1-2&) const;
// [ 4] ~bdefi_Vfunc2C4<OBJ, C, A1-2, D1-2>();
// ----------------------------------------------------------------------------
// 'bdefi_Vfunc2M4' methods:
// [ 4] bdefi_Vfunc2M4<OBJ, M, A1-2, D1-2>( OBJ *, c_M&, c_D1-2, ba *);
// [ 4] void execute<OBJ, M, A1-2, D1-2>(c_A1-2&) const;
// [ 4] ~bdefi_Vfunc2M4<OBJ, M, A1-2, D1-2>();
//-----------------------------------------------------------------------------
// 'bdefi_Vfunc2F5' methods:
// [ 5] bdefi_Vfunc2F5<F, A1-2, D1-3>(c_F&, c_D1-3&, ba *);
// [ 5] void execute<F, A1-2, D1-3>(c_A1-2&) const;
// [ 5] ~bdefi_Vfunc2F5<F, A1-2, D1-3>();
// ----------------------------------------------------------------------------
// 'bdefi_Vfunc2C5' methods:
// [ 5] bdefi_Vfunc2C5<OBJ, C, A1-2, D1-3>( OBJ *, c_C&, c_D1-3&, ba *);
// [ 5] void execute<OBJ, C, A1-2, D1-3>(c_A1-2&) const;
// [ 5] ~bdefi_Vfunc2C5<OBJ, C, A1-2, D1-3>();
// ----------------------------------------------------------------------------
// 'bdefi_Vfunc2M5' methods:
// [ 5] bdefi_Vfunc2M5<OBJ, M, A1-2, D1-3>( OBJ *, c_M&, c_D1-3, ba *);
// [ 5] void execute<OBJ, M, A1-2, D1-3>(c_A1-2&) const;
// [ 5] ~bdefi_Vfunc2M5<OBJ, M, A1-2, D1-3>();
//-----------------------------------------------------------------------------
// 'bdefi_Vfunc2F6' methods:
// [ 6] bdefi_Vfunc2F6<F, A1-2, D1-4>(c_F&, c_D1-4&, ba *);
// [ 6] void execute<F, A1-2, D1-4>(c_A1-2&) const;
// [ 6] ~bdefi_Vfunc2F6<F, A1-2, D1-4>();
// ----------------------------------------------------------------------------
// 'bdefi_Vfunc2C6' methods:
// [ 6] bdefi_Vfunc2C6<OBJ, C, A1-2, D1-4>( OBJ *, c_C&, c_D1-4&, ba *);
// [ 6] void execute<OBJ, C, A1-2, D1-4>(c_A1-2&) const;
// [ 6] ~bdefi_Vfunc2C6<OBJ, C, A1-2, D1-4>();
// ----------------------------------------------------------------------------
// 'bdefi_Vfunc2M6' methods:
// [ 6] bdefi_Vfunc2M6<OBJ, M, A1-2, D1-4>( OBJ *, c_M&, c_D1-4, ba *);
// [ 6] void execute<OBJ, M, A1-2, D1-4>(c_A1-2&) const;
// [ 6] ~bdefi_Vfunc2M6<OBJ, M, A1-2, D1-4>();
//-----------------------------------------------------------------------------
// 'bdefi_Vfunc2F7' methods:
// [ 7] bdefi_Vfunc2F7<F, A1-2, D1-5>(c_F&, c_D1-5&, ba *);
// [ 7] void execute<F, A1-2, D1-5>(c_A1-2&) const;
// [ 7] ~bdefi_Vfunc2F7<F, A1-2, D1-5>();
// ----------------------------------------------------------------------------
// 'bdefi_Vfunc2C7' methods:
// [ 7] bdefi_Vfunc2C7<OBJ, C, A1-2, D1-5>( OBJ *, c_C&, c_D1-5&, ba *);
// [ 7] void execute<OBJ, C, A1-2, D1-5>(c_A1-2&) const;
// [ 7] ~bdefi_Vfunc2C7<OBJ, C, A1-2, D1-5>();
// ----------------------------------------------------------------------------
// 'bdefi_Vfunc2M7' methods:
// [ 7] bdefi_Vfunc2M7<OBJ, M, A1-2, D1-5>( OBJ *, c_M&, c_D1-5, ba *);
// [ 7] void execute<OBJ, M, A1-2, D1-5>(c_A1-2&) const;
// [ 7] ~bdefi_Vfunc2M7<OBJ, M, A1-2, D1-5>();
//-----------------------------------------------------------------------------
// 'bdefi_Vfunc2F8' methods:
// [ 8] bdefi_Vfunc2F8<F, A1-2, D1-6>(c_F&, c_D1-6&, ba *);
// [ 8] void execute<F, A1-2, D1-6>(c_A1-2&) const;
// [ 8] ~bdefi_Vfunc2F8<F, A1-2, D1-6>();
// ----------------------------------------------------------------------------
// 'bdefi_Vfunc2C8' methods:
// [ 8] bdefi_Vfunc2C8<OBJ, C, A1-2, D1-6>( OBJ *, c_C&, c_D1-6&, ba *);
// [ 8] void execute<OBJ, C, A1-2, D1-6>(c_A1-2&) const;
// [ 8] ~bdefi_Vfunc2C8<OBJ, C, A1-2, D1-6>();
// ----------------------------------------------------------------------------
// 'bdefi_Vfunc2M8' methods:
// [ 8] bdefi_Vfunc2M8<OBJ, M, A1-2, D1-6>( OBJ *, c_M&, c_D1-6, ba *);
// [ 8] void execute<OBJ, M, A1-2, D1-6>(c_A1-2&) const;
// [ 8] ~bdefi_Vfunc2M8<OBJ, M, A1-2, D1-6>();
//-----------------------------------------------------------------------------
// 'bdefi_Vfunc2F9' methods:
// [ 9] bdefi_Vfunc2F9<F, A1-2, D1-7>(c_F&, c_D1-7&, ba *);
// [ 9] void execute<F, A1-2, D1-7>(c_A1-2&) const;
// [ 9] ~bdefi_Vfunc2F9<F, A1-2, D1-7>();
// ----------------------------------------------------------------------------
// 'bdefi_Vfunc2C9' methods:
// [ 9] bdefi_Vfunc2C9<OBJ, C, A1-2, D1-7>( OBJ *, c_C&, c_D1-7&, ba *);
// [ 9] void execute<OBJ, C, A1-2, D1-7>(c_A1-2&) const;
// [ 9] ~bdefi_Vfunc2C9<OBJ, C, A1-2, D1-7>();
// ----------------------------------------------------------------------------
// 'bdefi_Vfunc2M9' methods:
// [ 9] bdefi_Vfunc2M9<OBJ, M, A1-2, D1-7>( OBJ *, c_M&, c_D1-7, ba *);
// [ 9] void execute<OBJ, M, A1-2, D1-7>(c_A1-2&) const;
// [ 9] ~bdefi_Vfunc2M9<OBJ, M, A1-2, D1-7>();
//-----------------------------------------------------------------------------
// [11] USAGE EXAMPLE
...
//       // that 'bdefi_vfunc2X4' classes pass when calling the callback
//       // function.
//       //
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 10: {
        ...
        //   'pragma' in 'bdefi_vfunc2.h' fixes this problem.  This test
...

        {
            ...
            typedef bdefr_Vfunc2<rrr *, rrr *> ObjBase;

            typedef bdefi_Vfunc2F9<CbFuncF9,
                                       rrr *, rrr *, rrr *, rrr *,
                                       rrr *, rrr *, rrr *, rrr *, rrr *> Obj1;

            typedef bdefi_Vfunc2F9<CbFuncF10,
                                       rrr *, rrr *, rrr *, rrr *,
      ...
      case 9: {
        ...
        //       functions by 'bdefi_Vfunc2M9' instances.
        //    5. Destructor of each class under test is properly executed.
        //
        // Plan:
        //   Create objects of every 'bdefi_Vfunc2X9' class.  Initialize
        //   'bdefi_Vfunc2F9' to have 'checkArgumentValues9' as the callback
        //   function.  Initialize 'bdefi_Vfunc2C9' and 'bdefi_Vfunc2M9' to
        //   have 'checkArgumentValues9' method of the 'CbClass' class as the
        //   callback function.  Call the 'execute' method for each
        //   'bdefi_Vfunc2X9' class.  The arguments in this call are
        ...
        //
        //   Create objects of every 'bdefi_Vfunc2X9' class.  Initialize
        //   'bdefi_Vfunc2F9' to have 'checkParameterTypes9' as the callback
        //   function.  Initialize 'bdefi_Vfunc2C9' to have
        //   'checkParameterTypesC9' method of the 'CbClass' class as the
        //   callback function.  Initialize 'bdefi_Vfunc2M9' to have
        //   'checkParameterTypesM9' method of the 'CbClass' class as the
        //   callback function.  The latter will test wether the
        //   'bdefi_Vfunc2M9' can have non-'const' functions as the callback
        //   function.
        //
        //   Having a function of 'checkParameterTypes' family as a callback
        //   function forces 'bdefi_Vfunc2X9' to be templatized so that each
        ...
        // Testing:
        //   'bdefi_Vfunc2F9' methods:
        //   bdefi_Vfunc2F9<F, A1-2, D1-7>(c_F&, c_D1-7&, ba *);
        //   void execute<F, A1-2, D1-7>(c_A1-2&) const;
        //   ~bdefi_Vfunc2F9<F, A1-2, D1-7>();
        // --------------------------------------------------------------------
        //   'bdefi_Vfunc2C9' methods:
        //   bdefi_Vfunc2C9<OBJ, C, A1-2, D1-7>( OBJ *, c_C&, c_D1-7&, ba *);
        //   void execute<OBJ, C, A1-2, D1-7>(c_A1-2&) const;
        //   ~bdefi_Vfunc2C9<OBJ, C, A1-2, D1-7>();
        // --------------------------------------------------------------------
        //   'bdefi_Vfunc2M9' methods:
        //   bdefi_Vfunc2M9<OBJ, M, A1-2, D1-7>( OBJ *, c_M&, c_D1-7, ba *);
        //    void execute<OBJ, M, A1-2, D1-7>(c_A1-2&) const;
        //   ~bdefi_Vfunc2M9<OBJ, M, A1-2, D1-7>();
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting constructors and argument values." << endl;
        {
            ...
            typedef void (CbClass::*CbFuncC9)(int *, int *, int *, int *,
                                              int *, int *, int *, int *,
                                              int *) const;
            typedef bdefr_Vfunc2<int *, int *> ObjBase;
            ...
            if (verbose) cout << "\t'bdefi_Vfunc2F9' object." << endl;
            {
                typedef bdefi_Vfunc2F9<CbFuncF9,
                                       int *, int *, int *, int *,
            ...
            if (verbose) cout << "\t'bdefi_Vfunc2C9' object." << endl;
            {
                typedef bdefi_Vfunc2C9<CbClass, CbFuncC9, int *, int *,
                                       int *, int *, int *, int *, int *,
                                       int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
            ...
            if (verbose) cout << "\t'bdefi_Vfunc2M9' object." << endl;
            {
                typedef bdefi_Vfunc2M9<CbClass, CbFuncC9,
                                       int *, int *, int *, int *,
                                       int *, int *, int *, int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
            ...
            cout << "\nTesting parameter types and destructors." << endl;
        {
            ...
            typedef void (CbClass::*CbFuncM9)(T1, T2, T3, T4, T5, T6, T7, T8,
                                              T9);
            typedef bdefr_Vfunc2<T1, T2> ObjBase;
            ...
            if (verbose)
                cout << "\tWhen calling 'bdefi_Vfunc2F9' 'execute' method."
                     << endl;
            {
                typedef bdefi_Vfunc2F9<CbFuncF9, T1, T2, T3, T4, T5, T6, T7,
                                       T8, T9> Obj;
                dcEnabled = 0;
            ...
            if (verbose)
                cout << "\tWhen calling 'bdefi_Vfunc2C9' 'execute' method."
                     << endl;
            {
                typedef bdefi_Vfunc2C9<CbClass, CbFuncC9, T1, T2,
            ...
            if (verbose)
                cout << "\tWhen calling 'bdefi_Vfunc2M9' 'execute' method."
                     << endl;
            {
                typedef bdefi_Vfunc2M9<CbClass, CbFuncM9, T1, T2, T3, T4,
                                       T5, T6, T7, T8, T9> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG2;
                numDeallocations = ta.numDeallocations();
      ...
      case 8: {
        ...
        //       those intended as argument types for the function parameters.
        //    4. Non-'const' member functions can be used as callback
        //       functions by 'bdefi_Vfunc2M8' instances.
        //    5. Destructor of each class under test is properly executed.
        //
        // Plan:
        //   Create objects of every 'bdefi_Vfunc2X8' class.  Initialize
        //   'bdefi_Vfunc2F8' to have 'checkArgumentValues8' as the callback
        //   function.  Initialize 'bdefi_Vfunc2C8' and 'bdefi_Vfunc2M8' to
        //   have 'checkArgumentValues8' method of the 'CbClass' class as the
        //   callback function.  Call the 'execute' method for each
        //   'bdefi_Vfunc2X8' class.  The arguments in this call are
        //   initialized with values of 'ARG1', 'ARG2', 'ARG3', 'ARG4',
        ...
        //
        //   Create objects of every 'bdefi_Vfunc2X8' class.  Initialize
        //   'bdefi_Vfunc2F8' to have 'checkParameterTypes8' as the callback
        //   function.  Initialize 'bdefi_Vfunc2C8' to have
        //   'checkParameterTypesC8' method of the 'CbClass' class as the
        //   callback function.  Initialize 'bdefi_Vfunc2M8' to have
        //   'checkParameterTypesM8' method of the 'CbClass' class as the
        //   callback function.  The latter will test wether the
        //   'bdefi_Vfunc2M8' can have non-'const' functions as the callback
        //   function.
        //
        //   Having a function of 'checkParameterTypes' family as a callback
        //   function forces 'bdefi_Vfunc2X8' to be templatized so that each
        //   argument to the callback function will be of unique type.  Hence,
        //   if the types of arguments passed in to the callback function is
        //   incorrect, the compiler will generate an error.
        //
        ...
        // Testing:
        //   'bdefi_Vfunc2F8' methods:
        //   bdefi_Vfunc2F8<F, A1-2, D1-6>(c_F&, c_D1-6&, ba *);
        //   void execute<F, A1-2, D1-6>(c_A1-2&) const;
        //   ~bdefi_Vfunc2F8<F, A1-2, D1-6>();
        // -------------------------------------------------------------------
        //   'bdefi_Vfunc2C8' methods:
        //   bdefi_Vfunc2C8<OBJ, C, A1-2, D1-6>( OBJ *, c_C&, c_D1-6&, ba *);
        //   void execute<OBJ, C, A1-2, D1-6>(c_A1-2&) const;
        //   ~bdefi_Vfunc2C8<OBJ, C, A1-2, D1-6>();
        // --------------------------------------------------------------------
        //   'bdefi_Vfunc2M8' methods:
        //   bdefi_Vfunc2M8<OBJ, M, A1-2, D1-6>( OBJ *, c_M&, c_D1-6, ba *);
        //    void execute<OBJ, M, A1-2, D1-6>(c_A1-2&) const;
        //   ~bdefi_Vfunc2M8<OBJ, M, A1-2, D1-6>();
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting constructors and argument values." << endl;
        {
            ...
            if (verbose) cout << "\t'bdefi_Vfunc2F8' object." << endl;
            {
                typedef bdefi_Vfunc2F8<CbFuncF8,
                                       int *, int *, int *, int *,
                                       int *, int *, int *, int *> Obj;
            ...
            if (verbose) cout << "\t'bdefi_Vfunc2C8' object." << endl;
            {
                typedef bdefi_Vfunc2C8<CbClass, CbFuncC8, int *, int *,
                                       int *, int *, int *, int *,
                                       int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
            ...
            if (verbose) cout << "\t'bdefi_Vfunc2M8' object." << endl;
            {
                typedef bdefi_Vfunc2M8<CbClass, CbFuncC8,
                                       int *, int *, int *, int *,
                                       int *, int *, int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
            ...
            cout << "\nTesting parameter types and destructors." << endl;
        {
            ...
            if (verbose)
                cout << "\tWhen calling 'bdefi_Vfunc2F8' 'execute' method."
                     << endl;
            {
                typedef bdefi_Vfunc2F8<CbFuncF8, T1, T2, T3, T4, T5, T6, T7,
                                       T8> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG2;
                numDeallocations = ta.numDeallocations();
            ...
            if (verbose)
                cout << "\tWhen calling 'bdefi_Vfunc2C8' 'execute' method."
                     << endl;
            {
                typedef bdefi_Vfunc2C8<CbClass, CbFuncC8, T1, T2,
            ...
            if (verbose)
                cout << "\tWhen calling 'bdefi_Vfunc2M8' 'execute' method."
                     << endl;
            {
                typedef bdefi_Vfunc2M8<CbClass, CbFuncM8, T1, T2, T3, T4,
                                       T5, T6, T7, T8> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG2;
                numDeallocations = ta.numDeallocations();
      ...
      case 7: {
        ...
        //       those intended as argument types for the function parameters.
        //    4. Non-'const' member functions can be used as callback
        //       functions by 'bdefi_Vfunc2M7' instances.
        //    5. Destructor of each class under test is properly executed.
        //
        // Plan:
        //   Create objects of every 'bdefi_Vfunc2X7' class.  Initialize
        //   'bdefi_Vfunc2F7' to have 'checkArgumentValues7' as the callback
        //   function.  Initialize 'bdefi_Vfunc2C7' and 'bdefi_Vfunc2M7' to
        //   have 'checkArgumentValues7' method of the 'CbClass' class as the
        //   callback function.  Call the 'execute' method for each
        //   'bdefi_Vfunc2X7' class.  The arguments in this call are
        //   initialized with values of 'ARG1', 'ARG2', 'ARG3', 'ARG4',
        ...
        //
        //   Create objects of every 'bdefi_Vfunc2X7' class.  Initialize
        //   'bdefi_Vfunc2F7' to have 'checkParameterTypes7' as the callback
        //   function.  Initialize 'bdefi_Vfunc2C7' to have
        //   'checkParameterTypesC7' method of the 'CbClass' class as the
        //   callback function.  Initialize 'bdefi_Vfunc2M7' to have
        //   'checkParameterTypesM7' method of the 'CbClass' class as the
        //   callback function.  The latter will test wether the
        //   'bdefi_Vfunc2M7' can have non-'const' functions as the callback
        //   function.
        //
        //   Having a function of 'checkParameterTypes' family as a callback
        //   function forces 'bdefi_Vfunc2X7' to be templatized so that each
        //   argument to the callback function will be of unique type.  Hence,
        //   if the types of arguments passed in to the callback function is
        //   incorrect, the compiler will generate an error.
        //
        ...
        // Testing:
        //   'bdefi_Vfunc2F7' methods:
        //   bdefi_Vfunc2F7<F, A1-2, D1-5>(c_F&, c_D1-5&, ba *);
        //   void execute<F, A1-2, D1-5>(c_A1-2&) const;
        //   ~bdefi_Vfunc2F7<F, A1-2, D1-5>();
        // --------------------------------------------------------------------
        //   'bdefi_Vfunc2C7' methods:
        //   bdefi_Vfunc2C7<OBJ, C, A1-2, D1-5>( OBJ *, c_C&, c_D1-5&, ba *);
        //   void execute<OBJ, C, A1-2, D1-5>(c_A1-2&) const;
        //   ~bdefi_Vfunc2C7<OBJ, C, A1-2, D1-5>();
        // --------------------------------------------------------------------
        //   'bdefi_Vfunc2M7' methods:
        //   bdefi_Vfunc2M7<OBJ, M, A1-2, D1-5>( OBJ *, c_M&, c_D1-5, ba *);
        //   void execute<OBJ, M, A1-2, D1-5>(c_A1-2&) const;
        //   ~bdefi_Vfunc2M7<OBJ, M, A1-2, D1-5>();
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting constructors and argument values." << endl;
        {
            ...
            if (verbose) cout << "\t'bdefi_Vfunc2F7' object." << endl;
            {
                typedef bdefi_Vfunc2F7<CbFuncF7,
                                       int *, int *, int *,
                                       int *, int *, int *, int *> Obj;
            ...
            if (verbose) cout << "\t'bdefi_Vfunc2C7' object." << endl;
            {
                typedef bdefi_Vfunc2C7<CbClass, CbFuncC7, int *,
                                       int *, int *, int *, int *,
                                       int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
            ...
            if (verbose) cout << "\t'bdefi_Vfunc2M7' object." << endl;
            {
                typedef bdefi_Vfunc2M7<CbClass, CbFuncC7,
                                       int *, int *, int *,
                                       int *, int *, int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
            ...
            cout << "\nTesting parameter types and destructors." << endl;
        {
            ...
            if (verbose)
                cout << "\tWhen calling 'bdefi_Vfunc2F7' 'execute' method."
                     << endl;
            {
                typedef bdefi_Vfunc2F7<CbFuncF7, T1, T2, T3, T4, T5, T6,
                                       T7> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG2;
                numDeallocations = ta.numDeallocations();
            ...
            if (verbose)
                cout << "\tWhen calling 'bdefi_Vfunc2C7' 'execute' method."
                     << endl;
            {
                typedef bdefi_Vfunc2C7<CbClass, CbFuncC7, T1, T2,
                                       T3, T4, T5, T6, T7> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG2;
                numDeallocations = ta.numDeallocations();
            ...
            if (verbose)
                cout << "\tWhen calling 'bdefi_Vfunc2M7' 'execute' method."
                     << endl;
            {
                typedef bdefi_Vfunc2M7<CbClass, CbFuncM7, T1, T2, T3, T4,
                                       T5, T6, T7> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG2;
                numDeallocations = ta.numDeallocations();
      ...
      case 6: {
        ...
        //       those intended as argument types for the function parameters.
        //    4. Non-'const' member functions can be used as callback
        //       functions by 'bdefi_Vfunc2M6' instances.
        //    5. Destructor of each class under test is properly executed.
        //
        // Plan:
        //   Create objects of every 'bdefi_Vfunc2X6' class.  Initialize
        //   'bdefi_Vfunc2F6' to have 'checkArgumentValues6' as the callback
        //   function.  Initialize 'bdefi_Vfunc2C6' and 'bdefi_Vfunc2M6' to
        //   have 'checkArgumentValues6' method of the 'CbClass' class as the
        //   callback function.  Call the 'execute' method for each
        //   'bdefi_Vfunc2X6' class.  The arguments in this call are
        //   initialized with values of 'ARG1', 'ARG2', 'ARG3', 'ARG4',
        ...
        //
        //   Create objects of every 'bdefi_Vfunc2X6' class.  Initialize
        //   'bdefi_Vfunc2F6' to have 'checkParameterTypes6' as the callback
        //   function.  Initialize 'bdefi_Vfunc2C6' to have
        //   'checkParameterTypesC6' method of the 'CbClass' class as the
        //   callback function.  Initialize 'bdefi_Vfunc2M6' to have
        //   'checkParameterTypesM6' method of the 'CbClass' class as the
        //   callback function.  The latter will test wether the
        //   'bdefi_Vfunc2M6' can have non-'const' functions as the callback
        //   function.
        //
        //   Having a function of 'checkParameterTypes' family as a callback
        //   function forces 'bdefi_Vfunc2X6' to be templatized so that each
        //   argument to the callback function will be of unique type.  Hence,
        //   if the types of arguments passed in to the callback function is
        //   incorrect, the compiler will generate an error.
        //
        ...
        // Testing:
        //   'bdefi_Vfunc2F6' methods:
        //   bdefi_Vfunc2F6<F, A1-2, D1-4>(c_F&, c_D1-4&, ba *);
        //   void execute<F, A1-2, D1-4>(c_A1-2&) const;
        //   ~bdefi_Vfunc2F6<F, A1-2, D1-4>();
        // --------------------------------------------------------------------
        //   'bdefi_Vfunc2C6' methods:
        //   bdefi_Vfunc2C6<OBJ, C, A1-2, D1-4>( OBJ *, c_C&, c_D1-4&, ba *);
        //   void execute<OBJ, C, A1-2, D1-4>(c_A1-2&) const;
        //   ~bdefi_Vfunc2C6<OBJ, C, A1-2, D1-4>();
        // --------------------------------------------------------------------
        //   'bdefi_Vfunc2M6' methods:
        //   bdefi_Vfunc2M6<OBJ, M, A1-2, D1-4>( OBJ *, c_M&, c_D1-4, ba *);
        //    void execute<OBJ, M, A1-2, D1-4>(c_A1-2&) const;
        //   ~bdefi_Vfunc2M6<OBJ, M, A1-2, D1-4>();
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting constructors and argument values." << endl;
        {
            ...
            if (verbose) cout << "\t'bdefi_Vfunc2F6' object." << endl;
            {
                typedef bdefi_Vfunc2F6<CbFuncF6,
                                       int *, int *, int *,
                                       int *, int *, int *> Obj;
            ...
            if (verbose) cout << "\t'bdefi_Vfunc2C6' object." << endl;
            {
                typedef bdefi_Vfunc2C6<CbClass, CbFuncC6, int *,
                                       int *, int *, int *,
                                       int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
            ...
            if (verbose) cout << "\t'bdefi_Vfunc2M6' object." << endl;
            {
                typedef bdefi_Vfunc2M6<CbClass, CbFuncC6,
                                       int *, int *, int *,
                                       int *, int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
            ...
            cout << "\nTesting parameter types and destructors." << endl;
        {
            ...
            if (verbose)
                cout << "\tWhen calling 'bdefi_Vfunc2F6' 'execute' method."
                     << endl;
            {
                typedef bdefi_Vfunc2F6<CbFuncF6, T1, T2, T3, T4, T5, T6> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG2;
                numDeallocations = ta.numDeallocations();
            ...
            if (verbose)
                cout << "\tWhen calling 'bdefi_Vfunc2C6' 'execute' method."
                     << endl;
            {
                typedef bdefi_Vfunc2C6<CbClass, CbFuncC6, T1, T2,
                                       T3, T4, T5, T6> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG2;
                numDeallocations = ta.numDeallocations();
            ...
            if (verbose)
                cout << "\tWhen calling 'bdefi_Vfunc2M6' 'execute' method."
                     << endl;
            {
                typedef bdefi_Vfunc2M6<CbClass, CbFuncM6, T1, T2, T3, T4,
                                       T5, T6> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG2;
                numDeallocations = ta.numDeallocations();
      ...
      case 5: {
        ...
        //       those intended as argument types for the function parameters.
        //    4. Non-'const' member functions can be used as callback
        //       functions by 'bdefi_Vfunc2M5' instances.
        //    5. Destructor of each class under test is properly executed.
        //
        // Plan:
        //   Create objects of every 'bdefi_Vfunc2X5' class.  Initialize
        //   'bdefi_Vfunc2F5' to have 'checkArgumentValues5' as the callback
        //   function.  Initialize 'bdefi_Vfunc2C5' and 'bdefi_Vfunc2M5' to
        //   have 'checkArgumentValues5' method of the 'CbClass' class as the
        //   callback function.  Call the 'execute' method for each
        //   'bdefi_Vfunc2X5' class.  The arguments in this call are
        ...
        //
        //   Create objects of every 'bdefi_Vfunc2X5' class.  Initialize
        //   'bdefi_Vfunc2F5' to have 'checkParameterTypes5' as the callback
        //   function.  Initialize 'bdefi_Vfunc2C5' to have
        //   'checkParameterTypesC5' method of the 'CbClass' class as the
        //   callback function.  Initialize 'bdefi_Vfunc2M5' to have
        //   'checkParameterTypesM5' method of the 'CbClass' class as the
        //   callback function.  The latter will test wether the
        //   'bdefi_Vfunc2M5' can have non-'const' functions as the callback
        //   function.
        //
        //   Having a function of 'checkParameterTypes' family as a callback
        //   function forces 'bdefi_Vfunc2X5' to be templatized so that each
        //   argument to the callback function will be of unique type.  Hence,
        //   if the types of arguments passed in to the callback function is
        //   incorrect, the compiler will generate an error.
        //
        ...
        // Testing:
        //   'bdefi_Vfunc2F5' methods:
        //   bdefi_Vfunc2F5<F, A1-2, D1-3>(c_F&, c_D1-3&, ba *);
        //   void execute<F, A1-2, D1-3>(c_A1-2&) const;
        //   ~bdefi_Vfunc2F5<F, A1-2, D1-3>();
        // --------------------------------------------------------------------
        //   'bdefi_Vfunc2C5' methods:
        //   bdefi_Vfunc2C5<OBJ, C, A1-2, D1-3>( OBJ *, c_C&, c_D1-3&, ba *);
        //   void execute<OBJ, C, A1-2, D1-3>(c_A1-2&) const;
        //   ~bdefi_Vfunc2C5<OBJ, C, A1-2, D1-3>();
        // --------------------------------------------------------------------
        //   'bdefi_Vfunc2M5' methods:
        //   bdefi_Vfunc2M5<OBJ, M, A1-2, D1-3>( OBJ *, c_M&, c_D1-3, ba *);
        //   void execute<OBJ, M, A1-2, D1-3>(c_A1-2&) const;
        //   ~bdefi_Vfunc2M5<OBJ, M, A1-2, D1-3>();
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting constructors and argument values." << endl;
        {
            ...
            if (verbose) cout << "\t'bdefi_Vfunc2F5' object." << endl;
            {
                typedef bdefi_Vfunc2F5<CbFuncF5, int *, int *,
                                       int *, int *, int *> Obj;
            ...
            if (verbose) cout << "\t'bdefi_Vfunc2C5' object." << endl;
            {
                typedef bdefi_Vfunc2C5<CbClass, CbFuncC5, int *,
                                       int *, int *, int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
                ObjBase *x = new(ta) Obj(cbObject,
            ...
            if (verbose) cout << "\t'bdefi_Vfunc2M5' object." << endl;
            {
                typedef bdefi_Vfunc2M5<CbClass, CbFuncC5,
                                       int *, int *, int *, int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
                ObjBase *x = new(ta) Obj(&cbObject,
            ...
            cout << "\nTesting parameter types and destructors." << endl;
        {
            ...
            if (verbose)
                cout << "\tWhen calling 'bdefi_Vfunc2F5' 'execute' method."
                     << endl;
            {
                typedef bdefi_Vfunc2F5<CbFuncF5, T1, T2, T3, T4, T5> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG2;
                numDeallocations = ta.numDeallocations();
            ...
            if (verbose)
                cout << "\tWhen calling 'bdefi_Vfunc2C5' 'execute' method."
                     << endl;
            {
                typedef bdefi_Vfunc2C5<CbClass, CbFuncC5, T1, T2,
                                       T3, T4, T5> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG2;
                numDeallocations = ta.numDeallocations();
            ...
            if (verbose)
                cout << "\tWhen calling 'bdefi_Vfunc2M5' 'execute' method."
                     << endl;
            {
                typedef bdefi_Vfunc2M5<CbClass, CbFuncM5, T1, T2, T3, T4,
                                       T5> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG2;
                numDeallocations = ta.numDeallocations();
      ...
      case 4: {
        ...
        //       those intended as argument types for the function parameters.
        //    4. Non-'const' member functions can be used as callback
        //       functions by 'bdefi_Vfunc2M4' instances.
        //    5. Destructor of each class under test is properly executed.
        //
        // Plan:
        //   Create objects of every 'bdefi_Vfunc2X4' class.  Initialize
        //   'bdefi_Vfunc2F4' to have 'checkArgumentValues4' as the callback
        //   function.  Initialize 'bdefi_Vfunc2C4' and 'bdefi_Vfunc2M4' to
        //   have 'checkArgumentValues4' method of the 'CbClass' class as the
        //   callback function.  Call the 'execute' method for each
        //   'bdefi_Vfunc2X4' class.  The arguments in this call are
        ...
        //
        //   Create objects of every 'bdefi_Vfunc2X4' class.  Initialize
        //   'bdefi_Vfunc2F4' to have 'checkParameterTypes4' as the callback
        //   function.  Initialize 'bdefi_Vfunc2C4' to have
        //   'checkParameterTypesC4' method of the 'CbClass' class as the
        //   callback function.  Initialize 'bdefi_Vfunc2M4' to have
        //   'checkParameterTypesM4' method of the 'CbClass' class as the
        //   callback function.  The latter will test wether the
        //   'bdefi_Vfunc2M4' can have non-'const' functions as the callback
        //   function.
        //
        //   Having a function of 'checkParameterTypes' family as a callback
        //   function forces 'bdefi_Vfunc2X4' to be templatized so that each
        //   argument to the callback function will be of unique type.  Hence,
        //   if the types of arguments passed in to the callback function is
        //   incorrect, the compiler will generate an error.
        //
        ...
        // Testing:
        //   'bdefi_Vfunc2F4' methods:
        //   bdefi_Vfunc2F4<F, A1-2, D1-2>(c_F&, c_D1-2&, ba *);
        //   void execute<F, A1-2, D1-2>(c_A1-2&) const;
        //   ~bdefi_Vfunc2F4<F, A1-2, D1-2>();
        // --------------------------------------------------------------------
        //   'bdefi_Vfunc2C4' methods:
        //   bdefi_Vfunc2C4<OBJ, C, A1-2, D1-2>( OBJ *, c_C&, c_D1-2&, ba *);
        //   void execute<OBJ, C, A1-2, D1-2>(c_A1-2&) const;
        //   ~bdefi_Vfunc2C4<OBJ, C, A1-2, D1-2>();
        // --------------------------------------------------------------------
        //   'bdefi_Vfunc2M4' methods:
        //   bdefi_Vfunc2M4<OBJ, M, A1-2, D1-2>( OBJ *, c_M&, c_D1-2, ba *);
        //   void execute<OBJ, M, A1-2, D1-2>(c_A1-2&) const;
        //   ~bdefi_Vfunc2M4<OBJ, M, A1-2, D1-2>();
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting constructors and argument values." << endl;
        {
            ...
            if (verbose) cout << "\t'bdefi_Vfunc2F4' object." << endl;
            {
                typedef bdefi_Vfunc2F4<CbFuncF4,
                                       int *, int *, int *, int *> Obj;
            ...
            if (verbose) cout << "\t'bdefi_Vfunc2C4' object." << endl;
            {
                typedef bdefi_Vfunc2C4<CbClass, CbFuncC4,
                                       int *, int *, int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
                ObjBase *x = new(ta) Obj(cbObject,
            ...
            if (verbose) cout << "\t'bdefi_Vfunc2M4' object." << endl;
            {
                typedef bdefi_Vfunc2M4<CbClass, CbFuncC4,
                                       int *, int *, int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
                ObjBase *x = new(ta) Obj(&cbObject,
            ...
            cout << "\nTesting parameter types and destructors." << endl;
        {
            ...
            if (verbose)
                cout << "\tWhen calling 'bdefi_Vfunc2F4' 'execute' method."
                     << endl;
            {
                typedef bdefi_Vfunc2F4<CbFuncF4, T1, T2, T3, T4> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG2;
                numDeallocations = ta.numDeallocations();
            ...
            if (verbose)
                cout << "\tWhen calling 'bdefi_Vfunc2C4' 'execute' method."
                     << endl;
            {
                typedef bdefi_Vfunc2C4<CbClass, CbFuncC4, T1, T2,
                                       T3, T4> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG2;
                numDeallocations = ta.numDeallocations();
            ...
            if (verbose)
                cout << "\tWhen calling 'bdefi_Vfunc2M4' 'execute' method."
                     << endl;
            {
                typedef bdefi_Vfunc2M4<CbClass, CbFuncM4, T1, T2, T3, T4> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG2;
                numDeallocations = ta.numDeallocations();
      ...
      case 3: {
        ...
        //       those intended as argument types for the function parameters.
        //    4. Non-'const' member functions can be used as callback
        //       functions by 'bdefi_Vfunc2M3' instances.
        //    5. Destructor of each class under test is properly executed.
        //
        // Plan:
        //   Create objects of every 'bdefi_Vfunc2X3' class.  Initialize
        //   'bdefi_Vfunc2F3' to have 'checkArgumentValues3' as the callback
        //   function.  Initialize 'bdefi_Vfunc2C3' and 'bdefi_Vfunc2M3' to
        //   have 'checkArgumentValues3' method of the 'CbClass' class as the
        //   callback function.  Call the 'execute' method for each
        //   'bdefi_Vfunc2X3' class.  The arguments in this call are
        ...
        //
        //   Create objects of every 'bdefi_Vfunc2X3' class.  Initialize
        //   'bdefi_Vfunc2F3' to have 'checkParameterTypes3' as the callback
        //   function.  Initialize 'bdefi_Vfunc2C3' to have
        //   'checkParameterTypesC3' method of the 'CbClass' class as the
        //   callback function.  Initialize 'bdefi_Vfunc2M3' to have
        //   'checkParameterTypesM3' method of the 'CbClass' class as the
        //   callback function.  The latter will test wether the
        //   'bdefi_Vfunc2M3' can have non-'const' functions as the callback
        //   function.
        //
        //   Having a function of 'checkParameterTypes' family as a callback
        //   function forces 'bdefi_Vfunc2X3' to be templatized so that each
        //   argument to the callback function will be of unique type.  Hence,
        //   if the types of arguments passed in to the callback function is
        //   incorrect, the compiler will generate an error.
        //
        ...
        // Testing:
        //   'bdefi_Vfunc2F3' methods:
        //   bdefi_Vfunc2F3<F, A1-2, D1>(c_F&, c_D1&, ba *);
        //   void execute<F, A1-2, D1>(c_A1-2&) const;
        //   ~bdefi_Vfunc2F3<F, A1-2, D1>();
        // --------------------------------------------------------------------
        //   'bdefi_Vfunc2C3' methods:
        //   bdefi_Vfunc2C3<OBJ, C, A1-2, D1>( OBJ *, c_C&, c_D1&, ba *);
        //   void execute<OBJ, C, A1-2, D1>(c_A1-2&) const;
        //   ~bdefi_Vfunc2C3<OBJ, C, A1-2, D1>();
        // --------------------------------------------------------------------
        //   'bdefi_Vfunc2M3' methods:
        //   bdefi_Vfunc2M3<OBJ, M, A1-2, D1>( OBJ *, c_M&, c_D1, ba *);
        //   void execute<OBJ, M, A1-2, D1>(c_A1-2&) const;
        //   ~bdefi_Vfunc2M3<OBJ, M, A1-2, D1>();
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting constructors and argument values." << endl;
        {
            ...
            if (verbose) cout << "\t'bdefi_Vfunc2F3' object." << endl;
            {
                typedef bdefi_Vfunc2F3<CbFuncF3,
                                       int *, int *, int *> Obj;
            ...
            if (verbose) cout << "\t'bdefi_Vfunc2C3' object." << endl;
            {
                typedef bdefi_Vfunc2C3<CbClass, CbFuncC3,
                                       int *, int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
                ObjBase *x = new(ta) Obj(cbObject,
            ...
            if (verbose) cout << "\t'bdefi_Vfunc2M3' object." << endl;
            {
                typedef bdefi_Vfunc2M3<CbClass, CbFuncC3,
                                       int *, int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
                ObjBase *x = new(ta) Obj(&cbObject,
            ...
            cout << "\nTesting parameter types and destructors." << endl;
        {
            ...
            if (verbose)
                cout << "\tWhen calling 'bdefi_Vfunc2F3' 'execute' method."
                     << endl;
            {
                typedef bdefi_Vfunc2F3<CbFuncF3, T1, T2, T3> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG2;
                numDeallocations = ta.numDeallocations();
            ...
            if (verbose)
                cout << "\tWhen calling 'bdefi_Vfunc2C3' 'execute' method."
                     << endl;
            {
                typedef bdefi_Vfunc2C3<CbClass, CbFuncC3, T1, T2,
                                       T3> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG2;
                numDeallocations = ta.numDeallocations();
            ...
            if (verbose)
                cout << "\tWhen calling 'bdefi_Vfunc2M3' 'execute' method."
                     << endl;
            {
                typedef bdefi_Vfunc2M3<CbClass, CbFuncM3, T1, T2, T3> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG2;
                numDeallocations = ta.numDeallocations();
      ...
      case 2: {
        ...
        //       those intended as argument types for the function parameters.
        //    4. Non-'const' member functions can be used as callback
        //       functions by 'bdefi_Vfunc2M2' instances.
        //    5. Destructor of each class under test is properly executed.
        //
        // Plan:
        //   Create objects of every 'bdefi_Vfunc2X2' class.  Initialize
        //   'bdefi_Vfunc2F2' to have 'checkArgumentValues2' as the callback
        //   function.  Initialize 'bdefi_Vfunc2C2' and 'bdefi_Vfunc2M2' to
        //   have 'checkArgumentValues2' method of the 'CbClass' class as the
        //   callback function.  Call the 'execute' method for each
        //   'bdefi_Vfunc2X2' class.  The arguments in this call are
        ...
        //
        //   Create objects of every 'bdefi_Vfunc2X2' class.  Initialize
        //   'bdefi_Vfunc2F2' to have 'checkParameterTypes2' as the callback
        //   function.  Initialize 'bdefi_Vfunc2C2' to have
        //   'checkParameterTypesC2' method of the 'CbClass' class as the
        //   callback function.  Initialize 'bdefi_Vfunc2M2' to have
        //   'checkParameterTypesM2' method of the 'CbClass' class as the
        //   callback function.  The latter will test wether the
        //   'bdefi_Vfunc2M2' can have non-'const' functions as the callback
        //   function.
        //
        //   Having a function of 'checkParameterTypes' family as a callback
        //   function forces 'bdefi_Vfunc2X2' to be templatized so that each
        //   argument to the callback function will be of unique type.  Hence,
        //   if the types of arguments passed in to the callback function is
        //   incorrect, the compiler will generate an error.
        //
        ...
        // Testing:
        //   'bdefi_Vfunc2F2' methods:
        //   bdefi_Vfunc2F2<F, A1-2>(c_F&, ba *);
        //   void execute<F, A1-2>(c_A1-2&) const;
        //   ~bdefi_Vfunc2F2<F, A1-2>();
        // -------------------------------------------------------------------
        //   'bdefi_Vfunc2C2' methods:
        //   bdefi_Vfunc2C2<OBJ, C, A1-2>( OBJ *, c_C&, ba *);
        //   void execute<OBJ, C, A1-2>(c_A1-2&) const;
        //   ~bdefi_Vfunc2C2<OBJ, C, A1-2>();
        // --------------------------------------------------------------------
        //   'bdefi_Vfunc2M2' methods:
        //   bdefi_Vfunc2M2<OBJ, M, A1-2>( OBJ *, c_M&, ba *);
        //   void execute<OBJ, M, A1-2>(c_A1-2&) const;
        //   ~bdefi_Vfunc2M2<OBJ, M, A1-2>();
        // --------------------------------------------------------------------
        //   'bdefi_Vfunc2Null' methods:
        //   bdefi_Vfunc2Null<A1, A2>(ba *);
        //   void execute<A1, A2>(c_A1&, c_A2&) const;
        //   ~bdefi_Vfunc2Null<A1, A2>();
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting constructors and argument values." << endl;
        {
            ...
            if (verbose) cout << "\t'bdefi_Vfunc2F2' object." << endl;
            {
                typedef bdefi_Vfunc2F2<CbFuncF2,
                                       int *, int *> Obj;
            ...
            if (verbose) cout << "\t'bdefi_Vfunc2C2' object." << endl;
            {
                typedef bdefi_Vfunc2C2<CbClass, CbFuncC2,
                                       int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
                ObjBase *x = new(ta) Obj(cbObject,
            ...
            if (verbose) cout << "\t'bdefi_Vfunc2M2' object." << endl;
            {
                typedef bdefi_Vfunc2M2<CbClass, CbFuncC2,
                                       int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
                ObjBase *x = new(ta) Obj(&cbObject,
            ...
            cout << "\nTesting parameter types and destructors." << endl;
        {
            ...
            if (verbose)
                cout << "\tWhen calling 'bdefi_Vfunc2F2' 'execute' method."
                     << endl;
            {
                typedef bdefi_Vfunc2F2<CbFuncF2, T1, T2> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG2;
                numDeallocations = ta.numDeallocations();
            ...
            if (verbose)
                cout << "\tWhen calling 'bdefi_Vfunc2C2' 'execute' method."
                     << endl;
            {
                typedef bdefi_Vfunc2C2<CbClass, CbFuncC2, T1, T2> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG2;
                numDeallocations = ta.numDeallocations();
            ...
            if (verbose)
                cout << "\tWhen calling 'bdefi_Vfunc2M2' 'execute' method."
                     << endl;
            {
                typedef bdefi_Vfunc2M2<CbClass, CbFuncM2, T1, T2> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG2;
                numDeallocations = ta.numDeallocations();
            ...
            if (verbose)
                cout << "\nTesting bdefi_Vfunc2Null object." << endl;
            {
                T1 a1;
                T2 a2;
                ...
                typedef bdefi_Vfunc2Null<T1, T2> Obj;
