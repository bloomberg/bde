...
class bdefi_Vfunc0Null : public bdefr_Vfunc0 {
  ...
  public:
    // CREATORS
    bdefi_Vfunc0Null(bslma_Allocator *basicAllocator);
...
class bdefi_Vfunc0F0 : public bdefr_Vfunc0 {
  ...
  public:
    // CREATORS
    bdefi_Vfunc0F0(F procedure, bslma_Allocator *basicAllocator);
        // Create a representation for a function object (functor) taking no
...
inline
bdefi_Vfunc0Null::bdefi_Vfunc0Null(bslma_Allocator *basicAllocator)
