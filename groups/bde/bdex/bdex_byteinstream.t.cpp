...
//                              Overview
//                              --------
// For all input methods in 'bdex_ByteInStream', the "unexternalization" from
...
// 'bdex_ByteOutStream' object 'oX' containing some arbitrarily chosen values.
// The values are interleaved with chosen "marker" bytes to check for alignment
// issues.  We then create a 'bdex_ByteInStream' object 'iX' initialized with
...
//-----------------------------------------------------------------------------
// [ 2] bdex_ByteInStream();
// [ 2] bdex_ByteInStream(const char *buffer, int numBytes);
// [ 2] ~bdex_ByteInStream();
...
// [ 3] int cursor() const;
//
// [ 4] ostream& operator<<(ostream& stream, const bdex_ByteInStream& obj);
//-----------------------------------------------------------------------------
// [ 1] BREATHING TEST
// [26] USAGE EXAMPLE
//=============================================================================
...
typedef bdex_ByteInStream Obj;
typedef bdex_ByteOutStream Out;
...
//     return 0;
      ...
      case 4: {
        ...
        //
        // Testing:
        //   ostream& operator<<(ostream&, const bdex_ByteInStream&);
        // --------------------------------------------------------------------
      ...
      case 3: {
        ...
        if (verbose) cout << "\nTesting operator const void *() and data()."
                          << endl;
        int i, j;
        for (i = 0; i < 5; i++) {
            Obj x;
      ...
      case 1: {
        // --------------------------------------------------------------------
        // BREATHING TEST:
        //   Create 'bdex_ByteInStream' objects containing various data.
