// bdex_testoutstreamformatter.t.cpp             -*-C++-*-
...
// the stream.
//-----------------------------------------------------------------------------
// [ 2] bdex_TestOutStreamFormatter();
// [ 2] ~bdex_TestOutStreamFormatter();
// [23] putLength(int length);
// [23] putVersion(int version);
// [10] putInt64(bsls_PlatformUtil::Int64 value);
// [10] putUint64(bsls_PlatformUtil::Int64 value);
// [ 9] putInt56(bsls_PlatformUtil::Int64 value);
// [ 9] putUint56(bsls_PlatformUtil::Int64 value);
// [ 8] putInt48(bsls_PlatformUtil::Int64 value);
...
// [ 6] putInt32(int value);
// [ 6] putUint32(int value);
// [ 5] putInt24(int value);
// [ 5] putUint24(int value);
// [ 4] putInt16(int value);
// [ 4] putUint16(int value);
// [ 2] putInt8(int value);
// [ 2] putUint8(int value);
// [12] putFloat64(double value);
// [11] putFloat32(float value);
// [20] putArrayInt64(const bsls_PlatformUtil::Int64 *array, int count);
// [20] putArrayUint64(const bsls_PlatformUtil::Uint64 *array, int count);
// [19] putArrayInt56(const bsls_PlatformUtil::Int64 *array, int count);
// [19] putArrayUint56(const bsls_PlatformUtil::Uint64 *array, int count);
// [18] putArrayInt48(const bsls_PlatformUtil::Int64 *array, int count);
// [18] putArrayUint48(const bsls_PlatformUtil::Uint64 *array, int count);
// [17] putArrayInt40(const bsls_PlatformUtil::Int64 *array, int count);
// [17] putArrayUint40(const bsls_PlatformUtil::Uint64 *array, int count);
// [16] putArrayInt32(const int *array, int count);
// [16] putArrayUint32(const unsigned int *array, int count);
// [15] putArrayInt24(const int *array, int count);
// [15] putArrayUint24(const unsigned int *array, int count);
// [14] putArrayInt16(const short *array, int count);
// [14] putArrayUint16(const unsigned short *array, int count);
// [13] putArrayInt8(const char *array, int count);
// [13] putArrayInt8(const signed char *array, int count);
// [13] putArrayUint8(const char *array, int count);
// [13] putArrayUint8(const unsigned char *array, int count);
// [22] putArrayFloat64(const double *array,int count);
// [21] putArrayFloat32(const float *array, int count);
// [ 2] void removeAll();
// [ 3] const char* data();
// [ 3] int length();
//-----------------------------------------------------------------------------
...
typedef bdex_TestOutStreamFormatter Obj;
    ...
    switch (test) { case 0:
      case 23: {
...

        {
            if (verbose) cout << "\nTesting 'putLength'." << endl;
            {
                ...
                bdex_TestOutStreamFormatter x(&sb);
      ...
      case 3: {
        ...
        for (int iLen = 0; iLen < NUM_TEST; iLen++) {
            ...
            // verify length()
            LOOP_ASSERT(iLen, sb.length() == bytes);
            // verify data()
            LOOP_ASSERT(iLen,
                        1 == eq(sb.data(),
                                DATA[iLen], bytes * 8));
      ...
      case 2: {
        ...
        //   ~bdex_TestOutStreamFormatter();  // via purify
        //   putInt8(int value);
        //   putUint8(int value);
        //   removeAll();
        // --------------------------------------------------------------------
      ...
      case 1: {
        // --------------------------------------------------------------------
        // BREATHING TEST:
        //   Create 'bdex_TestOutStreamFormatter' objects using the default
        //   constructor, and exercise these objects using some "put" methods.
        //   Verify the contents of the resulting objects with basic accessors.
        ...
        bdesb_MemOutStreamBuf sb;
        bdex_TestOutStreamFormatter x1(&sb);
        ASSERT(0 == sb.length());

        if (verbose) cout << "\nTry putInt32 with x1." << endl;
        x1.putInt32(1);
        ASSERT(SIZEOF_CODE + SIZEOF_INT32 == sb.length());
        ASSERT(1 == eq(INT32_FL "\x00\x00\x00\x01",
                       sb.data(), SIZEOF_INT32 * 8));
