...
//                              Overview
//                              --------
// For all output methods in 'bdex_ByteOutStream', the formatting of the input
...
//
// We have chosen the primary black-box manipulator for 'bdex_ByteOutStream'
// to be 'putInt8'.
//-----------------------------------------------------------------------------
// [ 2] bdex_ByteOutStream(*ba = 0);
// [ 2] bdex_ByteOutStream(int initialCapacity, *ba = 0);
// [ 2] ~bdex_ByteOutStream();
// [25] void invalidate();
...
typedef bdex_ByteOutStream Obj;
...
//     return 0;
      ...
      case 4: {
        ...
        //
        // Testing:
        //   ostream& operator<<(ostream&, const bdex_ByteOutStream&);
        // --------------------------------------------------------------------
      ...
      case 2: {
        ...
        //
        // Testing:
        //   bdex_ByteOutStream(*ba = 0);
        //   bdex_ByteOutStream(int initialCapacity, *ba = 0);
        //   ~bdex_ByteOutStream();  // via purify
        //   putInt8(int value);
        //   putUint8(int value);
        //   removeAll();
