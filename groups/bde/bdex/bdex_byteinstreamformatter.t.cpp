// bdex_byteinstreamformatter.t.cpp              -*-C++-*-
...
//                              Overview
//                              --------
// For all input methods in 'bdex_ByteInStreamFormatter', the
// "unexternalization" from byte representation to the correct fundamental-type
// value is delegated to another component.  We assume that this process has
// been rigorously tested and verified.  Therefore, we are concerned only with
// the placement of the next-byte-position cursor and the alignment of bytes in
// the input stream.  For each input method, we verify these properties by
// first creating a 'bdex_ByteOutStreamFormatter' object 'oX' containing some
// arbitrarily chosen values.  The values are interleaved with chosen "marker"
// bytes to check for alignment issues.  We then create a 'bdex_ByteInStream'
// object 'iX' initialized with the content of 'oX', and consecutively call the
// input method on 'iX' to verify that the extracted values and marker bytes
// equal to their respective chosen values.  After all values are extracted, we
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:
      case 24: {
        ...
        bdex_ByteOutStreamFormatter outStream(&osb);
        const int VERSION = 1;
        ...
        bdesb_FixedMemInStreamBuf sb(buffer, osb.length());
        bdex_ByteInStreamFormatter inStream(&sb);
        int version;
      ...
      case 23: {
        ...
        {
            char workSpace[100];
            bdesb_FixedMemOutStreamBuf osb(workSpace, 100);
            bdex_ByteOutStreamFormatter o(&osb);
            o.putLength(1);             o.putInt8(0xFF);
            o.putLength(128);           o.putInt8(0xFE);
            o.putLength(3);             o.putInt8(0xFD);

            bdesb_FixedMemInStreamBuf isb(workSpace, 9);
            bdex_ByteInStreamFormatter x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
            int val;
        ...
        }
        {
            ...
            bdesb_FixedMemInStreamBuf isb(workSpace, 12);
            bdex_ByteInStreamFormatter x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
            int val;
        ...
        if (verbose) cout << "\nTesting getVersion(int&)." << endl;
        {
            ...
            bdesb_FixedMemInStreamBuf isb(workSpace, 4);
            bdex_ByteInStreamFormatter x(&isb);
            if (veryVerbose) { P(x) }
            int val;
      ...
      case 22: {
        ...
        if (verbose) cout << "\nTesting getArrayFloat64." << endl;
        {
            ...
            bdesb_FixedMemInStreamBuf isb(workSpace, 52);
            bdex_ByteInStreamFormatter x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
            double ar[] = { V, V, V };
      ...
      case 21: {
        ...
        if (verbose) cout << "\nTesting getArrayFloat32." << endl;
        {
            ...
            bdesb_FixedMemInStreamBuf isb(workSpace, 28);
            bdex_ByteInStreamFormatter x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
            float ar[] = { V, V, V };
      ...
      case 20: {
        ...
        if (verbose) cout << "\nTesting getArrayInt64." << endl;
        {
            ...
            bdesb_FixedMemInStreamBuf isb(workSpace, 54);
            bdex_ByteInStreamFormatter x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
      ...
      case 19: {
        ...
        if (verbose) cout << "\nTesting getArrayInt56." << endl;
        {
            ...
            bdesb_FixedMemInStreamBuf isb(workSpace, 46);
            bdex_ByteInStreamFormatter x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
            bsls_PlatformUtil::Int64 ar[] = { V, V, V };
      ...
      case 18: {
        ...
        if (verbose) cout << "\nTesting getArrayInt48." << endl;
        {
            ...
            bdesb_FixedMemInStreamBuf isb(workSpace, 40);
            bdex_ByteInStreamFormatter x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
            bsls_PlatformUtil::Int64 ar[] = { V, V, V };
      ...
      case 17: {
        ...
        if (verbose) cout << "\nTesting getArrayInt40." << endl;
        {
            ...
            bdesb_FixedMemInStreamBuf isb(workSpace, 34);
            bdex_ByteInStreamFormatter x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
            bsls_PlatformUtil::Int64 ar[] = { V, V, V };
      ...
      case 15: {
        ...
        if (verbose) cout << "\nTesting getArrayInt24." << endl;
        {
            ...
            bdesb_FixedMemInStreamBuf isb(workSpace, 22);
            bdex_ByteInStreamFormatter x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
            int ar[] = { V, V, V };
      ...
      case 14: {
        ...
        if (verbose) cout << "\nTesting getArrayInt16." << endl;
        {
            ...
            bdesb_FixedMemInStreamBuf isb(workSpace, 16);
            bdex_ByteInStreamFormatter x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
            short ar[] = { V, V, V };
      ...
      case 13: {
        ...
        if (verbose) cout << "\nTesting getArrayInt8(char*, int)." << endl;
        {
            ...
            bdesb_FixedMemInStreamBuf isb(workSpace, 10);
            bdex_ByteInStreamFormatter x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
            char ar[] = { V, V, V };
      ...
      case 12: {
        ...
        if (verbose) cout << "\nTesting getFloat64." << endl;
        {
            ...
            bdesb_FixedMemInStreamBuf isb(workSpace, 27);
            bdex_ByteInStreamFormatter x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
            double val;
      ...
      case 11: {
        ...
        if (verbose) cout << "\nTesting getFloat32." << endl;
        {
            ...
            bdesb_FixedMemInStreamBuf isb(workSpace, 15);
            bdex_ByteInStreamFormatter x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
            float val;
      ...
      case 9: {
        ...
        if (verbose) cout << "\nTesting getInt56." << endl;
        {
            ...
            bdesb_FixedMemInStreamBuf isb(workSpace, 24);
            bdex_ByteInStreamFormatter x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
            bsls_PlatformUtil::Int64 val;
      ...
      case 8: {
        ...
        if (verbose) cout << "\nTesting getInt48." << endl;
        {
            ...
            bdesb_FixedMemInStreamBuf isb(workSpace, 21);
            bdex_ByteInStreamFormatter x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
            bsls_PlatformUtil::Int64 val;
      ...
      case 7: {
        ...
        if (verbose) cout << "\nTesting getInt40." << endl;
        {
            ...
            bdesb_FixedMemInStreamBuf isb(workSpace, 18);
            bdex_ByteInStreamFormatter x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
            bsls_PlatformUtil::Int64 val;
      ...
      case 2: {
        ...
        //   For each independent test, create bdex_ByteInStreamFormatter
        //   containing various data,
        //   then use primary manipulators 'getInt8' and 'invalidate' to modify
        //   the state of the bdex_ByteInStreamFormatter.  Use basic accessors
        //   to verify the final state of the bdex_ByteInStreamFormatterects.
        //
        // Testing
        //   bdex_ByteInStream();
        ...
        {
            char workSpace[100];
            bdesb_FixedMemInStreamBuf isb(workSpace, 100);
            bdex_ByteInStreamFormatter x0(&isb);
        ...
        for (int i = 0; i < 5; i++) {
            // test default bdex_ByteInStreamFormatterects
            char workSpace[100];
            bdesb_FixedMemInStreamBuf isb(workSpace, 100);
            bdex_ByteInStreamFormatter x(&isb);
      ...
      case 1: {
        // --------------------------------------------------------------------
        // BREATHING TEST:
        //   Create 'bdex_ByteInStreamFormatter' containing various data.
        //   Exercise these bdex_ByteInStreamFormatter using appropriate input
        //   methods and primary manipulators, then verify the state of the
        //   resulting bdex_ByteInStreamFormatter using basic accessors.
        //
        // Testing:
        ...
        if (verbose) cout <<
             "\nCreate bdex_ByteInStreamFormatter x1 using default ctor."
             << endl;

        int i;
        char workSpace[1];
        bdesb_FixedMemInStreamBuf sb(workSpace, 1);
        bdex_ByteInStreamFormatter x1(&sb);
      ...
      case -1: {
        ...
        if (verbose) cout << "\nTest performance on ctor+putInt8+dtor.\n";
        {
            ...
            for (int i = 0; i <= NUM_OUT_ITERS; ++i) {
                ...
                bdex_ByteInStreamFormatter xi(&sbi);
                bdex_ByteOutStreamFormatter xo(&sbo);
