...
DEFINE_TEST_CASE(14) {
        ...
        //
        // Plan:
        //   Call 'bdef_BindUtil::bindR' with the 'testFunc14'
...
DEFINE_TEST_CASE(12) {
        ...
        //   'func14' of the utility class 'bdef_Bind_TestFunctionsNoAlloc' or
...
DEFINE_TEST_CASE(11) {
     ...
     (I1,I2,I3,I4,I5,I6,I7,I8,I9,I10,I11,I12,I13,I14)); // invocation arguments
        ...
        if (verbose) printf("\t\tWith placeholder.\n");
        {
            ...
            LOOP_ASSERT(PARAMS, PARAMS == bdef_BindUtil::bindA(Z2, mX,
        _1,_2,_3,_4,_5,_6,_7,_8,_9,_10,_11,_12,_13,_14) // bound arguments
     (V1,V2,V3,V4,V5,V6,V7,V8,V9,V10,V11,V12,V13,V14)); // invocation arguments
...
DEFINE_TEST_CASE(9) {
        ...
        //   'bdef_BindUtil::bindA' with the 'testFunc14' method of the
...
DEFINE_TEST_CASE(7) {
        ...
        //   'bdef_BindUtil::bindA' with the address of the 'func14' class
...
DEFINE_TEST_CASE(4) {
        ...
        //
        // Plan:
        //   Call 'bdef_BindUtil::bind' with the 'testFunc14' method of the
...
DEFINE_TEST_CASE(2) {
        ...
        //
        // Plan:
        //   Call 'bdef_BindUtil::bind' with the address of the 'func14' class
...
DEFINE_TEST_CASE(1) {
        ...
        if (verbose) printf("\t\tWith placeholder.\n");
        {
            ...
            typedef bdef_Bind_BoundTuple14<PH1,PH2,PH3,PH4,PH5,PH6,PH7,
        ...
        if (verbose) printf("\t\tWithout placeholder.\n");
        {
            ...
            typedef NoAllocTestType                      *FUNC;
            typedef bdef_Bind_BoundTuple14<NoAllocTestArg1,
                                      NoAllocTestArg2,
                                      NoAllocTestArg3,
                                      NoAllocTestArg4,
                                      NoAllocTestArg5,
        ...
        {
            typedef AllocTestType                        *FUNC;
            typedef bdef_Bind_BoundTuple14<AllocTestArg1,
                                      AllocTestArg2,
                                      AllocTestArg3,
                                      AllocTestArg4,
                                      AllocTestArg5,
