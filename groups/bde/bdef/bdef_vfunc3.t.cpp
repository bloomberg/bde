...
//-----------------------------------------------------------------------------
// [ 1] bdef_Vfunc3<A1-3>();
// [ 1] bdef_Vfunc3<A1-3>(bdefr_Vfunc3<A1-3> *);
// [ 1] bdef_Vfunc3<A1-3>(const bdef_Vfunc3<A1-3>&);
// [ 1] ~bdef_Vfunc3<A1-3>();
// [ 2] bdef_Vfunc3<A1-3>& operator=(const bdef_Vfunc3<A1-3>&);
...
class FunctorRep : public bdefr_Vfunc3<A1, A2, A3> {
...
//-----------------------------------------------------------------------------
    ...
    typedef bdefr_Vfunc3<int *, int *, int *> ObjRep;
    typedef bdef_Vfunc3<int *, int *, int *> Obj;
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 2: {
        ...
        //    2. A new object shares a 'bdefr_Vfunc3' object with its "right
        ...
        //   'bdefr_Vfunc3<A1, A2, A3> *' object 'R'.  Call the constructor to
        //   create 'bdef_Vfunc3' objects 'Obj2' and 'Obj3' using 'R'.
        ...
        //    3c. N/A.
        //
        //   Create the 'bdefr_Vfunc3<A1, A2, A3> *' object.  Call the
        //   constructor to create the 'bdef_Vfunc3' object 'Obj1'.
        ...
        //        to verify that 'Obj1' and 'Obj2' use the same 'bdefr_Vfunc3'
        //        object.
        //    3d. Check the reference counter using the 'getCount' function.
        //        Create another object and check it again.
        //
        //   Create two 'bdefr_Vfunc3<A1, A2, A3> *' objects 'R1' and 'R2'.
        //   Create two 'bdef_Vfunc3' objects 'Obj1' and 'Obj2' using 'R1' and
        //   'R2', respectively.
        ...
        //        to verify that 'Obj2' and 'Obj3' use the same 'bdefr_Vfunc3'
        //        object.
        //    3e. Check the reference counter using the 'getCount' function
        //        before and after the assignment for both 'Obj1' and 'Obj2'
        //        representations.
        //
        //   Create a 'bdefr_Vfunc3<A1, A2, A3> *' object.  Call the
        //   constructor to create a 'bdef_Vfunc3' object 'Obj1'.
        ...
        //
        // Testing:
        //   bdef_Vfunc3<A1-3>& operator=(const bdef_Vfunc3<A1-3>&);
        // --------------------------------------------------------------------
      ...
      case 1: {
        ...
        //    b. constructor taking a pointer to a 'bdefr_Vfunc3' object
        //    c. copy constructor
        //
        ...
        //    6. The 'bdefr_Vfunc3<A1, A2, A3>' object is destroyed when the
        ...
        //       'operator const void *() const'.
        //
        //   1b. Create the 'bdefr_Vfunc3<A1, A2, A3> *' object.  Call the
        ...
        //       'bdefr_Vfunc3<A1, A2, A3> *' object.  Verify that the
        ...
        //       to verify that both 'bdef_Vfunc3' objects use the same
        //       'bdefr_Vfunc3' object.
        ...
        //
        // Testing:
        //   bdef_Vfunc3(const bdef_Vfunc3 &rhs);
        // --------------------------------------------------------------------
                          ...
                          << "==============================" << endl;
        {
            ...
            if (verbose)
                cout << "\nTesting Constructor Taking '*bdefr_Vfunc3'."
                     << endl;
