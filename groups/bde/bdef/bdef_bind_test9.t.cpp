...
DEFINE_TEST_CASE(14) {
        ...
        //
        // Plan:
        //   Call 'bdef_BindUtil::bindR' with the 'testFunc9'
...
DEFINE_TEST_CASE(13) {
     ...
     printf("\nTESTING 'bdef_BindUtil::bindR' WITH FREE FUNCTION REFERENCE"
        ...
        if (verbose) printf("\t\tWith placeholder.\n");
        {
            ...
            LOOP_ASSERT(PARAMS,
                        PARAMS == bdef_BindUtil::bindR<ConvertibleFromToInt>(
            bdef_Bind_TestFunctionsNoAlloc::func9, &mX, // invocable
                            _1,_2,_3,_4,_5,_6,_7,_8,_9) // bound arguments
                         (I1,I2,I3,I4,I5,I6,I7,I8,I9)); // invocation arguments
        ...
        if (verbose) printf("\t\tWith placeholder.\n");
        {
            ...
            LOOP_ASSERT(PARAMS,
                        PARAMS == bdef_BindUtil::bindR<ConvertibleFromToInt>(
              bdef_Bind_TestFunctionsAlloc::func9, &mX, // invocable
                            _1,_2,_3,_4,_5,_6,_7,_8,_9) // bound arguments
                         (V1,V2,V3,V4,V5,V6,V7,V8,V9)); // invocation arguments
...
DEFINE_TEST_CASE(12) {
        ...
        //   'func9' of the utility class 'bdef_Bind_TestFunctionsNoAlloc' or
...
DEFINE_TEST_CASE(9) {
        ...
        //   'bdef_BindUtil::bindA' with the 'testFunc9' method of the
...
DEFINE_TEST_CASE(7) {
        ...
        //   'bdef_BindUtil::bindA' with the address of the 'func9' class
...
DEFINE_TEST_CASE(4) {
        ...
        //
        // Plan:
        //   Call 'bdef_BindUtil::bind' with the 'testFunc9' method of the
...
DEFINE_TEST_CASE(2) {
        ...
        //
        // Plan:
        //   Call 'bdef_BindUtil::bind' with the address of the 'func9' class
...
DEFINE_TEST_CASE(1) {
        ...
        if (verbose) printf("\t\tWith placeholder.\n");
        {
            ...
            typedef bdef_Bind_BoundTuple9<PH1,PH2,PH3,PH4,PH5,PH6,PH7,
                                                            PH8,PH9>  ListType;
        ...
        if (verbose) printf("\t\tWithout placeholder.\n");
        {
            ...
            typedef NoAllocTestType                      *FUNC;
            typedef bdef_Bind_BoundTuple9<NoAllocTestArg1,
                                     NoAllocTestArg2,
                                     NoAllocTestArg3,
                                     NoAllocTestArg4,
                                     NoAllocTestArg5,
        ...
        {
            typedef AllocTestType                        *FUNC;
            typedef bdef_Bind_BoundTuple9<AllocTestArg1,
                                     AllocTestArg2,
                                     AllocTestArg3,
                                     AllocTestArg4,
                                     AllocTestArg5,
