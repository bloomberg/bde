...
//
//@CLASSES:
//   bdef_Vfunc2: signature-specific function object (functor)
//
...
//
// The 'bdef_Vfunc2' functor (envelope) holds a polymorphic, reference-counted,
...
// signature and (2) the supplied user data.  See the 'bdefu_vfunc2' component
// for more information on populating 'bdef_Vfunc2' function objects with
...
// 'bdef_Vfunc2' class specifies the number of required arguments).  However,
...
//   }
//..
// The 'bdef_Vfunc2<MyGuiContext, MyGuiLocation>' class used in 'MyGuiButton'
// class has a private member of an abstract class 'bdefr_vfunc2', whose
// 'execute' method is called when the functor is being called.  The 'execute'
// method of the 'bdefr_vfunc2' class, the functor invocation operator of the
// 'bdef_Vfunc2' class, and the 'pressButton' method of 'MyGuiButton' class
...
// signature the user implements a concrete class derived from 'bdefr_vfunc2'
// as follows:
//..
...
class bdef_Vfunc2 {
  ...
  public:
    ...
    bdef_Vfunc2<A1, A2>& operator=(const bdef_Vfunc2<A1, A2>& functionObject);
        ...
        // 'deleteObject' method of 'bdefr_Vfunc2' base class.
...
template <class A1, class A2>
inline bdef_Vfunc2<A1, A2>::bdef_Vfunc2()
: d_rep_p(0)
{
}
...
template <class A1, class A2>
inline void bdef_Vfunc2<A1, A2>::operator()(const A1& argument1,
...
template <class A1, class A2>
inline bdef_Vfunc2<A1, A2>::operator const void *() const
{
    return d_rep_p;
}
