// bdef_bind_test2.t.cpp         -*-C++-*-

#include <bdef_bind_test2.h>
...
DEFINE_TEST_CASE(14) {
        ...
        //
        // Plan:
        //   Call 'bdef_BindUtil::bindR' with the 'testFunc2'
     ...
     printf("\nTESTING 'bdef_BindUtil::bindR' WITH FREE FUNCTION REFERENCE"
        ...
        if (verbose) printf("\t\tWith placeholder.\n");
        {
            ...
            LOOP_ASSERT(PARAMS,
                        PARAMS == bdef_BindUtil::bindR<ConvertibleFromToInt>(
            bdef_Bind_TestFunctionsNoAlloc::func2, &mX, // invocable
                                              _1,_2) // bound arguments
                                           (I1,I2)); // invocation arguments
        ...
        if (verbose) printf("\t\tWith placeholder.\n");
        {
            ...
            LOOP_ASSERT(PARAMS,
                        PARAMS == bdef_BindUtil::bindR<ConvertibleFromToInt>(
              bdef_Bind_TestFunctionsAlloc::func2, &mX, // invocable
                                              _1,_2) // bound arguments
                                           (V1,V2)); // invocation arguments
...
DEFINE_TEST_CASE(12) {
        ...
        //   'func2' of the utility class 'bdef_Bind_TestFunctionsNoAlloc' or
...
DEFINE_TEST_CASE(9) {
        ...
        //   'bdef_BindUtil::bindA' with the 'testFunc2' method of the
...
DEFINE_TEST_CASE(7) {
        ...
        //   'bdef_BindUtil::bindA' with the address of the 'func2' class
...
DEFINE_TEST_CASE(4) {
        ...
        //
        // Plan:
        //   Call 'bdef_BindUtil::bind' with the 'testFunc2' method of the
...
DEFINE_TEST_CASE(2) {
        ...
        //
        // Plan:
        //   Call 'bdef_BindUtil::bind' with the address of the 'func2' class
...
DEFINE_TEST_CASE(1) {
        ...
        if (verbose) printf("\t\tWith placeholder.\n");
        {
            ...
            typedef bdef_Bind_BoundTuple2<PH1,PH2>             ListType;
        ...
        if (verbose) printf("\t\tWithout placeholder.\n");
        {
            ...
            typedef NoAllocTestType                      *FUNC;
            typedef bdef_Bind_BoundTuple2<NoAllocTestArg1,
        ...
        {
            typedef AllocTestType                        *FUNC;
            typedef bdef_Bind_BoundTuple2<AllocTestArg1,
