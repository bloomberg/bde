// bdef_bind_test4.t.cpp         -*-C++-*-

#include <bdef_bind_test4.h>
...
DEFINE_TEST_CASE(14) {
        ...
        //
        // Plan:
        //   Call 'bdef_BindUtil::bindR' with the 'testFunc4'
...
DEFINE_TEST_CASE(13) {
     ...
     printf("\nTESTING 'bdef_BindUtil::bindR' WITH FREE FUNCTION REFERENCE"
        ...
        if (verbose) printf("\t\tWith placeholder.\n");
        {
            ...
            LOOP_ASSERT(PARAMS,
                        PARAMS == bdef_BindUtil::bindR<ConvertibleFromToInt>(
            bdef_Bind_TestFunctionsNoAlloc::func4, &mX, // invocable
                                           _1,_2,_3,_4) // bound arguments
                                        (I1,I2,I3,I4)); // invocation arguments
        ...
        if (verbose) printf("\t\tWith placeholder.\n");
        {
            ...
            LOOP_ASSERT(PARAMS,
                        PARAMS == bdef_BindUtil::bindR<ConvertibleFromToInt>(
              bdef_Bind_TestFunctionsAlloc::func4, &mX, // invocable
                                           _1,_2,_3,_4) // bound arguments
                                        (V1,V2,V3,V4)); // invocation arguments
...
DEFINE_TEST_CASE(12) {
        ...
        //   'func4' of the utility class 'bdef_Bind_TestFunctionsNoAlloc' or
...
DEFINE_TEST_CASE(9) {
        ...
        //   'bdef_BindUtil::bindA' with the 'testFunc4' method of the
...
DEFINE_TEST_CASE(7) {
        ...
        //   'bdef_BindUtil::bindA' with the address of the 'func4' class
...
DEFINE_TEST_CASE(4) {
        ...
        //
        // Plan:
        //   Call 'bdef_BindUtil::bind' with the 'testFunc4' method of the
...
DEFINE_TEST_CASE(2) {
        ...
        //
        // Plan:
        //   Call 'bdef_BindUtil::bind' with the address of the 'func4' class
...
DEFINE_TEST_CASE(1) {
        ...
        if (verbose) printf("\t\tWith placeholder.\n");
        {
            ...
            typedef bdef_Bind_BoundTuple4<PH1,PH2,PH3,PH4>     ListType;
        ...
        if (verbose) printf("\t\tWithout placeholder.\n");
        {
            ...
            typedef NoAllocTestType                      *FUNC;
            typedef bdef_Bind_BoundTuple4<NoAllocTestArg1,
                                     NoAllocTestArg2,
                                     NoAllocTestArg3,
        ...
        {
            typedef AllocTestType                        *FUNC;
            typedef bdef_Bind_BoundTuple4<AllocTestArg1,
                                     AllocTestArg2,
                                     AllocTestArg3,
