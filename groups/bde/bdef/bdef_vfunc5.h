...
//
//@CLASSES:
//   bdef_Vfunc5: signature-specific function object (functor)
//
...
// returns void and takes five arguments of arbitrary type; it is invoked in a
// manner similar to that of following free function:
//..
//   void functionObject(arg1, arg2, arg3, arg4, arg5);
//..
...
//
// The 'bdef_Vfunc5' functor (envelope) holds a polymorphic, reference-counted,
...
// signature and (2) the supplied user data.  See the 'bdefu_vfunc5' component
// for more information on populating 'bdef_Vfunc5' function objects with
...
class bdef_Vfunc5 {
    ...
    //..
    // which takes five arguments and returns void.  Note that pointer (but not
  ...
  public:
    ...
    ~bdef_Vfunc5();
        ...
        // the static 'deleteObject' method of 'bdefr_Vfunc5' base class).
    ...
    bdef_Vfunc5<A1, A2, A3, A4, A5>& operator=(
        ...
        // 'deleteObject' method of 'bdefr_Vfunc5' base class.
...
template <class A1, class A2, class A3, class A4, class A5>
inline void bdef_Vfunc5<A1, A2, A3, A4, A5>::operator()(
                                                const A1& argument1,
                                                const A2& argument2,
                                                const A3& argument3,
                                                const A4& argument4,
...
template <class A1, class A2, class A3, class A4, class A5>
inline bdef_Vfunc5<A1, A2, A3, A4, A5>::operator const void *() const
{
    return d_rep_p;
}
