...
//                              Overview
//                              --------
// The 'bdef_Vfunc4' class holds a pointer to an instance of a 'bdefr_Vfunc4'
// (an abstact class), and manipulates it appropriately.  Our main objective
// is to make sure that the 'bdefr_Vfunc4' object is initialized correctly and
// that its integer data (the reference count) is modified by the methods of
// 'bdef_Vfunc4' as expected.
//
...
//-----------------------------------------------------------------------------
// [ 1] bdef_Vfunc4<A1-4>();
// [ 1] bdef_Vfunc4<A1-4>(bdefr_Vfunc4<A1-4> *);
// [ 1] bdef_Vfunc4<A1-4>(const bdef_Vfunc4<A1-4>&);
// [ 1] ~bdef_Vfunc4<A1-4>();
// [ 2] bdef_Vfunc4<A1-4>& operator=(const bdef_Vfunc4<A1-4>&);
...
class FunctorRep : public bdefr_Vfunc4<A1, A2, A3, A4> {
...
//-----------------------------------------------------------------------------
    ...
    typedef bdefr_Vfunc4<int *, int *, int *, int *> ObjRep;
    typedef bdef_Vfunc4<int *, int *, int *, int *> Obj;
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 2: {
        ...
        //    2. A new object shares a 'bdefr_Vfunc4' object with its "right
        ...
        //   'bdefr_Vfunc4<A1, A2, A3, A4> *' object 'R'.  Call the
        //   constructor to create 'bdef_Vfunc4' objects 'Obj2' and 'Obj3'
        //   using 'R'.
        ...
        //    3c. N/A.
        //
        //   Create the 'bdefr_Vfunc4<A1, A2, A3, A4> *' object.  Call the
        //   constructor to create the 'bdef_Vfunc4' object 'Obj1'.
        ...
        //        to verify that 'Obj1' and 'Obj2' use the same 'bdefr_Vfunc4'
        //        object.
        //    3d. Check the reference counter using the 'getCount' function.
        //        Create another object and check it again.
        //
        //   Create two 'bdefr_Vfunc4<A1, A2, A3, A4> *' objects 'R1' and 'R2'.
        //   Create two 'bdef_Vfunc4' objects 'Obj1' and 'Obj2' using 'R1'
        //   and 'R2', respectively.
        ...
        //        to verify that 'Obj2' and 'Obj3' use the same 'bdefr_Vfunc4'
        //        object.
        //    3e. Check the reference counter using the 'getCount' function
        //        before and after the assignment for both 'Obj1' and 'Obj2'
        //        representations.
        //
        //   Create a 'bdefr_Vfunc4<A1, A2, A3, A4> *' object.  Call the
        //   constructor to create a 'bdef_Vfunc4' object 'Obj1'.
        ...
        //
        // Testing:
        //   bdef_Vfunc4<A1-4>& operator=(const bdef_Vfunc4<A1-4>&);
        // --------------------------------------------------------------------
      ...
      case 1: {
        ...
        //    b. constructor taking a pointer to a 'bdefr_Vfunc4' object
        //    c. copy constructor
        //
        ...
        //    6. The 'bdefr_Vfunc4<A1, A2, A3, A4>' object
        ...
        //       'operator const void *() const'.
        //
        //   1b. Create the 'bdefr_Vfunc4<A1, A2, A3, A4> *' object.  Call the
        ...
        //       'bdefr_Vfunc4<A1, A2, A3, A4> *' object.  Verify that the
        ...
        //       to verify that both 'bdef_Vfunc4' objects use the same
        //       'bdefr_Vfunc4' object.
        ...
        //
        // Testing:
        //   bdef_Vfunc4(const bdef_Vfunc4 &rhs);
        // --------------------------------------------------------------------
                          ...
                          << "==============================" << endl;
        {
            ...
            if (verbose)
                cout << "\nTesting Constructor Taking '*bdefr_Vfunc4'."
                     << endl;
