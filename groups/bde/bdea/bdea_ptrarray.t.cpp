...
//-----------------------------------------------------------------------------
// [ 2] bdea_PtrArray<T>(bdema_Allocator *ba = 0);
// [11] bdea_PtrArray<T>(const Explicit& iLen, *ba = 0);
// [11] bdea_PtrArray<T>(int iLen, int iVal, *ba = 0);
// [17] bdea_PtrArray<T>(const InitialCapacity& ne, *ba = 0);
// [11] bdea_PtrArray<T>(const void **sa, int ne, *ba = 0);
// [ 7] bdea_PtrArray<T>(const bdea_PtrArray<T>& original, *ba = 0);
// [ 2] ~bdea_PtrArray<T>();
// [ 9] bdea_PtrArray<T>& operator=(const bdea_PtrArray<T>& rhs);
// [14] int& operator[](int index);
// [13] void append(T * item);
// [13] void append(const bdea_PtrArray<T>& sa);
// [13] void append(const bdea_PtrArray<T>& sa, int si, int ne);
// [13] void append(T * const *sa, int si, int ne);
// [18] T **data();
// [13] void insert(int di, T * item);
// [13] void insert(int di, const bdea_PtrArray<T>& sa);
// [13] void insert(int di, const bdea_PtrArray<T>& sa, int si, int ne);
// [13] void insert(int di, T * const *sa, int si, int ne);
// [13] void remove(int index);
// [13] void remove(int index, int ne);
// [ 2] void removeAll();
// [14] void replace(int di, T * item);
// [14] void replace(int di, const bdea_PtrArray<T>& sa, int si, int ne);
...
// [12] void setLength(int newLength, int iVal);
...
//
// [ 6] operator==(const bdea_PtrArray<T>&, const bdea_PtrArray<T>&);
// [ 6] operator!=(const bdea_PtrArray<T>&, const bdea_PtrArray<T>&);
// [ 5] operator<<(ostream&, const bdea_PtrArray<T>&);
//-----------------------------------------------------------------------------
// [ 1] BREATHING TEST
// [20] USAGE EXAMPLE
// [19] TESTING ALTERNATIVE TEMPLATE PARAMETERS
// [ 2] BOOTSTRAP: void append(T * item); // no aliasing
...
// [ 3] int ggg(bdea_PtrArray<T> *object, const char *spec, int vF = 1);
// [ 3] bdea_PtrArray<T>& gg(bdea_PtrArray<T>* object, const char *spec);
// [ 8] bdea_PtrArray<T>   g(const char *spec);
...
typedef double Ptr;
typedef Ptr * Element;
typedef bdea_PtrArray<Ptr> Obj;

class bdet_String;
typedef bdet_String Ptr2;
typedef Ptr2 * Element2;
typedef bdea_PtrArray<Ptr2> Obj2;

const Element VALUES[] = { (Ptr *) 0xa1, (Ptr *) 0xb2,
                           (Ptr *) 0xc3, (Ptr *) 0xd4,
                           (Ptr *) 0xfff5 }; // avoid DEFAULT_VALUE
...
// appended to the 'bdea_PtrArray<T>' object.  A tilde ('~') indicates that
...
template <class T>
int ggg(bdea_PtrArray<T> *object, const char *spec, int verboseFlag = 1)
...
bdea_PtrArray<Ptr>& gg(bdea_PtrArray<Ptr> *object, const char *spec)
...
bdea_PtrArray<Ptr> g(const char *spec)
    // Return, by value, a new object corresponding to the specified 'spec'.
{
    bdea_PtrArray<Ptr> object((bdema_Allocator *)0);
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 19: {
        // --------------------------------------------------------------------
        // TESTING ALTERNATIVE TEMPLATE PARAMETERS
        // Concerns:
        //   All the other test cases verify the component using void as the
        //   template parameter. This test case verifies that the Pointer
        //   Template component functions correctly for an alternate template
        //   parameter.
        //   In particular, the accessors and manipulators that returns
        //   pointers to array elements should be cast correctly.
        //
        // Plan:
        //   Create a pointer array with a different template parameter.
        //
        // Testing:
        // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
        if (verbose) cout << endl
                          << "Testing Alternate Template Parameters" << endl
                          << "=====================================" << endl;
        Element2 const A1 = (Element2) 0xf100;
        Element2 const A2 = (Element2) 0x200;
        if (verbose) cout << "\n 1. Create an object x1 (default ctor)."
                             "\t\t\t{ x1: }" << endl;
        Obj2 mX1(&testAllocator);  const Obj2& X1 = mX1;
        ...
        if (verbose) cout << "\n 2. Create a second object x2 (copy from x1)."
                             "\t\t{ x1: x2: }" << endl;
        Obj2 mX2(X1, &testAllocator);  const Obj2& X2 = mX2;
        ...
        Obj2 mX3(&testAllocator);  const Obj2& X3 = mX3;
        ...
        Obj2 mX4(X2, &testAllocator);  const Obj2& X4 = mX4;
      ...
      case 18: {
        ...
        //
        // Plan:
        //   For each object X in a set of 'bdea_PtrArray<T>' objects
      ...
      case 17: {
        ...
        //
        // Testing:
        //   bdea_PtrArray<T>(const InitialCapacity& ne, *ba = 0);
        ...
        if (verbose) cout <<
            "\nTesting 'bdea_PtrArray<T>(capacity, ba)' Constructor"
            << endl;
...
#undef NL
      ...
      case 14: {
        ...
        // Testing:
        //   void replace(int di, T * item);
        //   void replace(int di, const bdea_PtrArray<T>& sa, int si, int ne);
      ...
      case 13: {
        ...
        // Testing:
        //   void append(T * item);
        //   void append(const bdea_PtrArray<T>& sa);
        //   void append(const bdea_PtrArray<T>& sa, int si, int ne);
        //   void append(T * const *sa, int si, int ne);
        //
        //   void insert(int di, T * item);
        //   void insert(int di, const bdea_PtrArray<T>& sa);
        //   void insert(int di, const bdea_PtrArray<T>& sa, int si, int ne);
        //   void insert(int di, T * const *sa, int si, int ne);
        //
      ...
      case 12: {
        ...
        //   void setLength(int newLength, int iVal);
        // --------------------------------------------------------------------
        ...
        if (verbose) cout << "\nTesting 'setLengthRaw'" << endl;
        {
            ...
            const Element VALUE  = (Ptr *) 0x1; // ADJUST
        ...
        if (verbose) cout << "\nTesting 'setLength(int)'" << endl;
        {
            const int lengths[] = { 0, 1, 2, 3, 4, 5, 7, 8, 9, 15, 16, 17 };
            const int NUM_TESTS = sizeof lengths / sizeof lengths[0];
            const Element I_VALUE       = (Ptr *) 0x1; // ADJUST **
        ...
        if (verbose) cout << "\nTesting 'setLength(int, int)'" << endl;
        {
            ...
            const int NUM_TESTS = sizeof lengths / sizeof lengths[0];
            const Element I_VALUE = (Ptr *) 0x1;       // ADJUST **
            const Element F_VALUE = (Ptr *) 0x2;       // ADJUST **
            for (int i = 0; i < NUM_TESTS; ++i) {
                const int a1 = lengths[i];
                if (verbose) { cout << "\t"; P(a1); }
                for (int j = 0; j < NUM_TESTS; ++j) {
      ...
      case 11: {
        ...
        //
        // Testing:
        //   bdea_PtrArray<T>(const Explicit& iLen, *ba = 0);
        //   bdea_PtrArray<T>(int iLen, int iVal, *ba = 0);
        //   bdea_PtrArray<T>(const T **sa, int ne, *ba = 0);
        // --------------------------------------------------------------------
        ...
        if (verbose) cout << "\t\tWith no exceptions." << endl;
        {
            const Element VALUE = (Ptr *) 0x2; // ADJUST
            const int MAX_LENGTH = 10;
            for (int length = 0; length <= MAX_LENGTH; ++length) {
                if (verbose) P(length);
        ...
        if (verbose) cout << "\t\tWith exceptions." << endl;
        {
            const Element VALUE = (Ptr *) 0x3; // ADJUST
            const int MAX_LENGTH = 10;
            for (int length = 0; length <= MAX_LENGTH; ++length) {
              BEGIN_BDEMA_EXCEPTION_TEST {
                if (verbose) P(length);
        ...
        if (verbose) cout << "\tIn place using a buffer allocator." << endl;
        {
            char memory[1024];
            bdema_BufferAllocator a(memory, sizeof memory);
            const Element VALUE = (Ptr *) 0x4; // ADJUST
            const int MAX_LENGTH = 10;
            for (int length = 0; length <= MAX_LENGTH; ++length) {
                if (verbose) P(length);
                Obj::Explicit e(length);
                Obj *doNotDelete =
                                new(a.allocate(sizeof(Obj))) Obj(e, VALUE, &a);
                Obj &mX = *doNotDelete;  const Obj &X = mX;
                if (veryVerbose) P(X);
                LOOP_ASSERT(length, length == X.length());
                for (int i = 0; i < length; ++i) {
      ...
      case 10: {
        ...
        // The bdea_PtrArray<T> does not need a streaming function.
        // --------------------------------------------------------------------
      ...
      case 8: {
        ...
        //
        // Testing:
        //   bdea_PtrArray<T> g(const char *spec);
        // --------------------------------------------------------------------
      ...
      case 7: {
        ...
        //
        // Testing:
        //   bdea_PtrArray<T>(const bdea_PtrArray<T>& original, *ba = 0);
        // --------------------------------------------------------------------
      ...
      case 6: {
        ...
        //
        // Testing:
        //   operator==(const bdea_PtrArray<T>&,
        //              const bdea_PtrArray<T>&);
        //   operator!=(const bdea_PtrArray<T>&,
        //              const bdea_PtrArray<T>&);
        // --------------------------------------------------------------------
      ...
      case 5: {
        ...
        //
        // Testing:
        //   operator<<(ostream&, const bdea_PtrArray<T>&);
        // --------------------------------------------------------------------
      ...
      case 3: {
        ...
        //
        // Testing:
        //   bdea_PtrArray<T>& gg(bdea_PtrArray<T>* object,
        //                           const char *spec);
        //   int ggg(bdea_PtrArray<T> *object, const char *spec,
        //           int vF = 1);
        //   void stretch(Obj *object, int size);
        //   void stretchRemoveAll(Obj *object, int size);
      ...
      case 2: {
        ...
        //
        // Testing:
        //   bdea_PtrArray<T>(bdema_Allocator *ba);
        //   ~bdea_PtrArray<T>();
        //   BOOTSTRAP: void append(T * item); // no aliasing
        //   void removeAll();
        // --------------------------------------------------------------------
