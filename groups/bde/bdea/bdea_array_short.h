// bdea_array_short.h           -*-C++-*-
#ifndef INCLUDED_BDEA_ARRAY_SHORT
#define INCLUDED_BDEA_ARRAY_SHORT

//@PURPOSE: Provide an in-place array of 'short' values.
//
//@DEPRECATED: This component is being replaced with 'std::vector'.
//
//@CLASSES:
//   bdea_Array<short>: memory manager for in-place array of 'short' values
//
//@AUTHOR: John Lakos (jlakos)
//
//@SEE_ALSO: bdea_array2_short
//
//@DESCRIPTION: This component implements an in-place array of 'short' values.
...
// 'bdea_array2_short' if the memory address of each contained element must
...
// First create an empty 'bdea_Array<short>' 'a' and populate it with two
// elements 'E1' and 'E2':
//..
//      const short E1 = 100;
//      const short E2 = 200;
//
//      bdea_Array<short> a;            assert( 0 == a.length());
//
...
template <class T> class bdea_Array;
                        ...
                        // =======================
                        // class bdea_Array<short>
                        // =======================

template<>
class bdea_Array<short> {
    // This class implements an efficient, in-place array of 'short' values
    ...
    friend int operator==(const bdea_Array<short>& lhs,
                          const bdea_Array<short>& rhs);
  ...
  public:
    ...
    struct InitialCapacity { int d_i; ~InitialCapacity() { }
        ...
        //..
        //   bdea_Array<short> x(bdea_Array<short>::InitialCapacity(8));
        //..
    ...
    bdea_Array(const short     *srcArray,
               int              numElements,
               bdema_Allocator *basicAllocator = 0);
    ...
    bdea_Array(const bdea_Array<short>&  original,
               bdema_Allocator          *basicAllocator = 0);
    ...
    // MANIPULATORS
    bdea_Array<short>& operator=(const bdea_Array<short>& rhs);
    ...
    void append(const bdea_Array<short>& srcArray);
    ...
    void append(const short *srcArray,
                int          srcIndex,
                int          numElements);
        // Append to the end of this array the specified 'numElements' values
        // from the specified 'srcArray', beginning at the specified
    ...
    void insert(int dstIndex, short item);
    ...
    void insert(int dstIndex, const bdea_Array<short>& srcArray);
    ...
    void insert(int                      dstIndex,
                const bdea_Array<short>& srcArray,
                int                      srcIndex,
                int                      numElements);
    ...
    void replace(int dstIndex, short item);
    ...
    void setLength(int newLength, short initialValue);
...
// FREE OPERATORS
inline
int operator==(const bdea_Array<short>& lhs, const bdea_Array<short>& rhs);
...
inline
std::ostream& operator<<(std::ostream& stream, const bdea_Array<short>& array);
...
inline
short *bdea_Array<short>::data()
{
    return (short *)d_array.data();
}

inline
const short *bdea_Array<short>::data() const
{
    return (const short *)d_array.data();
}

inline
int bdea_Array<short>::length() const
{
    return d_array.length() / sizeof(short);
}
...
inline
bdea_Array<short>::bdea_Array(bdema_Allocator *basicAllocator)
: d_array(bdema_CharArray::InitialCapacity(sizeof(short)), basicAllocator)
{
}

inline
bdea_Array<short>::bdea_Array(const Explicit&  initialLength,
                              bdema_Allocator *basicAllocator)
: d_array(bdema_CharArray::InitialCapacity(initialLength.d_i > 0
                                           ? initialLength.d_i * sizeof(short)
                                           : sizeof(short)),
          bdema_CharArray::POWER_OF_2_HINT,
          basicAllocator)
{
    d_array.setLengthRaw(initialLength.d_i * sizeof(short));
    std::memset(data(), 0, initialLength.d_i * sizeof(short));
}

inline
bdea_Array<short>::bdea_Array(int              initialLength,
                              short            initialValue,
                              bdema_Allocator *basicAllocator)
: d_array(bdema_CharArray::InitialCapacity(initialLength > 0
                                           ? initialLength * sizeof(short)
                                           : sizeof(short)),
          bdema_CharArray::POWER_OF_2_HINT,
          basicAllocator)
{
    d_array.setLengthRaw(initialLength * sizeof(short));
    bdeimp_DuffsDevice<short>::initialize(data(), initialValue,initialLength);
}

inline
bdea_Array<short>::bdea_Array(const InitialCapacity&  numElements,
                              bdema_Allocator        *basicAllocator)
: d_array(bdema_CharArray::InitialCapacity(numElements.d_i > 0
                                           ? numElements.d_i * sizeof(short)
                                           : sizeof(short)),
          basicAllocator)
{
...
inline
bdea_Array<short>::bdea_Array(const short     *srcArray,
                              int              numElements,
                              bdema_Allocator *basicAllocator)
: d_array(bdema_CharArray::InitialCapacity(numElements > 0
          ...
          basicAllocator)
{
    d_array.setLengthRaw(numElements * sizeof(short));
    std::memcpy(data(), srcArray, numElements * sizeof(short));
}

inline
bdea_Array<short>::bdea_Array(const bdea_Array<short>&  original,
                              bdema_Allocator          *basicAllocator)
: d_array(bdema_CharArray::InitialCapacity(original.length() > 0
                                           ? original.length() * sizeof(short)
                                           : sizeof(short)),
          bdema_CharArray::POWER_OF_2_HINT,
          basicAllocator)
{
    d_array.setLengthRaw(original.length() * sizeof(short));
    std::memcpy(data(), original.data(), original.length() * sizeof(short));
}

inline
bdea_Array<short>::~bdea_Array()
{
}
...
inline
bdea_Array<short>& bdea_Array<short>::operator=(const bdea_Array<short>& rhs)
{
    d_array = rhs.d_array;
...
inline
short& bdea_Array<short>::operator[](int index)
{
    return data()[index];
}

inline
void bdea_Array<short>::append(short item)
{
    int len = length();
    d_array.setLengthRaw(d_array.length() + sizeof(short));
    data()[len] = item;
}

inline
void bdea_Array<short>::append(const bdea_Array<short>& srcArray)
{
...
{
    d_array.append(srcArray.d_array,
                   srcIndex * sizeof(short),
                   numElements * sizeof(short));
}

inline
void bdea_Array<short>::
                   append(const short *srcArray, int srcIndex, int numElements)
{
...
inline
void bdea_Array<short>::insert(int dstIndex, short item)
{
    d_array.insert(dstIndex * sizeof(short),
                   (const char *)&item,
                   0,
                   sizeof(short));
}
...
inline
void bdea_Array<short>::insert(int dstIndex, const bdea_Array<short>& srcArray)
{
    d_array.insert(dstIndex * sizeof(short), srcArray.d_array);
}

inline
void bdea_Array<short>::insert(int                      dstIndex,
                               const bdea_Array<short>& srcArray,
                               int                      srcIndex,
                               int                      numElements)
{
...
inline
void bdea_Array<short>::remove(int index)
{
    d_array.remove(index * sizeof(short), sizeof(short));
}

inline
void bdea_Array<short>::remove(int index, int numElements)
{
    d_array.remove(index * sizeof(short), numElements * sizeof(short));
}

inline
void bdea_Array<short>::removeAll()
{
    d_array.removeAll();
}

inline
void bdea_Array<short>::replace(int dstIndex, short item)
{
    data()[dstIndex] = item;
}

inline
void bdea_Array<short>::replace(int                      dstIndex,
                                const bdea_Array<short>& srcArray,
                                int                      srcIndex,
                                int                      numElements)
{
    d_array.replace(dstIndex * sizeof(short),
                    srcArray.d_array,
                    srcIndex * sizeof(short),
                    numElements * sizeof(short));
}

inline void bdea_Array<short>::reserveCapacity(int numElements)
{
    d_array.reserveCapacity(numElements * sizeof(short));
}

inline
void bdea_Array<short>::reserveCapacityRaw(int numElements)
{
    d_array.reserveCapacityRaw(numElements * sizeof(short));
}

inline
void bdea_Array<short>::setLengthRaw(int newLength)
{
    d_array.setLengthRaw(newLength * sizeof(short));
}

inline
void bdea_Array<short>::setLength(int newLength)
{
    d_array.setLength(newLength * sizeof(short));
}

inline
void bdea_Array<short>::setLength(int newLength, short initialValue)
{
    int len = length();
    d_array.setLengthRaw(newLength * sizeof(short));
    if (newLength > len) {
        bdeimp_DuffsDevice<short>::initialize(data() + len,
                                              initialValue,
                                              newLength - len);
    }
}
...
inline
void bdea_Array<short>::swap(int index1, int index2)
{
    short *array_p = data();
    short tmp = array_p[index1];
...
template <class STREAM>
inline
STREAM& bdea_Array<short>::bdexStreamIn(STREAM& stream, int version)
{
    if (stream) {
        switch (version) {  // Switch on the schema version (starting with 1).
          case 1: {
            ...
            stream.getArrayInt16(data(), newLength);
...
template <class STREAM>
inline
STREAM& bdea_Array<short>::streamInRaw(STREAM& stream, int version)
{
...
inline
const short& bdea_Array<short>::operator[](int index) const
{
    return data()[index];
}
...
template <class STREAM>
inline
STREAM& bdea_Array<short>::bdexStreamOut(STREAM& stream, int version) const
{
    switch (version) {
      case 1: {
        int len = length();
        stream.putLength(len);
        stream.putArrayInt16(data(), len);
      } break;
    }
    return stream;
}
...
template <class STREAM>
inline
STREAM& bdea_Array<short>::streamOutRaw(STREAM& stream, int version) const
{
