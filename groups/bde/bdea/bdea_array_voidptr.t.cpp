...
// [11] bdea_Array(int iLen, int iVal, *ba = 0);
// [17] bdea_Array(const InitialCapacity& ne, *ba = 0);
// [11] bdea_Array(const void **sa, int ne, *ba = 0);
// [ 7] bdea_Array(const bdea_Array<void *>& original, *ba = 0);
// [ 2] ~bdea_Array();
// [ 9] bdea_Array<void *>& operator=(const bdea_Array<void *>& rhs);
// [14] int& operator[](int index);
// [13] void append(int item);
// [13] void append(const bdea_Array<void *>& sa);
// [13] void append(const bdea_Array<void *>& sa, int si, int ne);
// [13] void append(void * const *sa, int si, int ne);
// [18] void **data();
// [13] void insert(int di, int item);
// [13] void insert(int di, const bdea_Array<void *>& sa);
// [13] void insert(int di, const bdea_Array<void *>& sa, int si, int ne);
// [13] void insert(int di, void * const *sa, int si, int ne);
// [13] void remove(int index);
// [13] void remove(int index, int ne);
// [ 2] void removeAll();
// [14] void replace(int di, int item);
// [14] void replace(int di, const bdea_Array<void *>& sa, int si, int ne);
...
// [18] const void **data() const;
// [ 4] int length() const;
// [15] ostream& print(ostream& stream, int level, int spl);
//
// [ 6] operator==(const bdea_Array<void *>&, const bdea_Array<void *>&);
// [ 6] operator!=(const bdea_Array<void *>&, const bdea_Array<void *>&);
// [ 5] operator<<(ostream&, const bdea_Array<void *>&);
//-----------------------------------------------------------------------------
// [ 1] BREATHING TEST
// [19] USAGE EXAMPLE
...
// [ 3] int ggg(bdea_Array<void *> *object, const char *spec, int vF = 1);
// [ 3] bdea_Array<void *>& gg(bdea_Array<void *>* object, const char *spec);
// [ 8] bdea_Array<void *>   g(const char *spec);
...
// appended to the 'bdea_Array<void *>' object.  A tilde ('~') indicates that
...
int ggg(bdea_Array<void *> *object, const char *spec, int verboseFlag = 1)
...
bdea_Array<void *>& gg(bdea_Array<void *> *object, const char *spec)
...
bdea_Array<void *> g(const char *spec)
    // Return, by value, a new object corresponding to the specified 'spec'.
{
    bdea_Array<void *> object((bdema_Allocator *)0);
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      case 19: {
        ...
        bdea_Array<void *> a(&testAllocator);
                                        ASSERT( 0 == a.length());
        ...
        for (int i = 0; i < len; ++i) {
            out << ' ';
            bdeu_Print::printPtr(out, a[i]);   // portable pointer print
        }
        out << " ]" << endl;
      ...
      case 18: {
        ...
        //
        // Plan:
        //   For each object X in a set of 'bdea_Array<void *>' objects ordered
...
#undef NL
      ...
      case 14: {
        ...
        //   void replace(int di, const bdea_Array<void *>& sa, int si,int ne);
      ...
      case 13: {
        ...
        //   void append(const bdea_Array<void *>& sa);
        //   void append(const bdea_Array<void *>& sa, int si, int ne);
        //   void append(void * const *sa, int si, int ne);
        //
        //   void insert(int di, int item);
        //   void insert(int di, const bdea_Array<void *>& sa);
        //   void insert(int di, const bdea_Array<void *>& sa, int si, int ne);
        //   void insert(int di, void * const *sa, int si, int ne);
        //
      ...
      case 12: {
        ...
        if (verbose) cout << "\nTesting 'setLength(int)'" << endl;
        {
            const int lengths[] = { 0, 1, 2, 3, 4, 5, 7, 8, 9, 15, 16, 17 };
            const int NUM_TESTS = sizeof lengths / sizeof lengths[0];
            const Element I_VALUE       = (void *) 0x1; // ADJUST **
        ...
        if (verbose) cout << "\nTesting 'setLength(int, int)'" << endl;
        {
            ...
            const int NUM_TESTS = sizeof lengths / sizeof lengths[0];
            const Element I_VALUE = (void *) 0x1;       // ADJUST **
            const Element F_VALUE = (void *) 0x2;       // ADJUST **
            for (int i = 0; i < NUM_TESTS; ++i) {
                const int a1 = lengths[i];
                if (verbose) { cout << "\t"; P(a1); }
                for (int j = 0; j < NUM_TESTS; ++j) {
      ...
      case 11: {
        ...
        //   bdea_Array(const void **sa, int ne, *ba = 0);
        // --------------------------------------------------------------------
      ...
      case 10: {
        ...
        // The bdea_Array<void *> does not need a streaming function.
        // --------------------------------------------------------------------
      ...
      case 7: {
        ...
        //
        // Testing:
        //   bdea_Array(const bdea_Array<void *>& original, *ba = 0);
        // --------------------------------------------------------------------
      ...
      case 6: {
        ...
        //
        // Testing:
        //   operator==(const bdea_Array<void *>&, const bdea_Array<void *>&);
        //   operator!=(const bdea_Array<void *>&, const bdea_Array<void *>&);
        // --------------------------------------------------------------------
      ...
      case 5: {
        ...
        //
        // Testing:
        //   operator<<(ostream&, const bdea_Array<void *>&);
        // --------------------------------------------------------------------
      ...
      case 3: {
        ...
        //
        // Testing:
        //   bdea_Array<void *>& gg(bdea_Array<void *>* obj, const char *spec);
        //   int ggg(bdea_Array<void *> *object, const char *spec, int vF = 1);
        //   void stretch(Obj *object, int size);
        //   void stretchRemoveAll(Obj *object, int size);
