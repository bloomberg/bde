...
//
// The 'std::string' component optimizes use of memory by storing short
...
//
// The 'bdet_Array<std::string>' component has an optional hint in its ctor
// indicating that deletes are infrequent and therefore an optimization can be
// realized involving the allocator used for the 'std::string' objects.  This
// optimization means that strings contained in 'std::string' objects within
// the 'bdet_Array<std::string>' object are not deallocated until the array
...
// 'std::string' internally.  For long strings:
...
// [19] bdea_Array(int iLen, const std::string& iVal, *ba = 0);
// [19] bdea_Array(const InitialCapacity& ne, *ba = 0);
// [19] bdea_Array(const std::string *sa, int ne, *ba = 0);
// [19] bdea_Array(const bdea_Array<std::string>& original, *ba = 0);
// [ 2] bdea_Array(Hint infreqDelHint, bdema_Allocator *ba = 0);
// [11] bdea_Array(const Explicit& iLen, Hint infreqDelHint, *ba = 0);
// [11] bdea_Array(int iLen, const std::string& iVal, Hint infdh, *ba = 0);
// [17] bdea_Array(const InitialCapacity& ne, Hint infdh, *ba = 0);
// [11] bdea_Array(const char **sa, int ne, Hint infdh, *ba = 0);
// [ 7] bdea_Array(const bdea_Array<std::string>& original,Hint infdh,*ba = 0);
// [ 2] ~bdea_Array();
// [ 9] bdea_Array<std::string>& operator=(const bdea_Array<std::string>& rhs);
// [14] int& operator[](int index);
// [13] void append(std::string & item);
// [13] void append(const bdea_Array<std::string>& sa);
// [13] void append(const bdea_Array<std::string>& sa, int si, int ne);
// [13] void insert(int di, const std::string& item);
// [13] void insert(int di, const bdea_Array<std::string>& sa);
// [13] void insert(int di, const bdea_Array<std::string>& sa, int si, int ne);
// [13] void remove(int index);
// [13] void remove(int index, int ne);
// [ 2] void removeAll();
// [14] void replace(int di, const std::string& item);
// [14] void replace(int di, const bdea_Array<std::string>& sa, int si,int ne);
// [17] void reserveCapacityRaw(int ne);
// [17] void reserveCapacity(int ne);
// [12] void setLength(int newLength);
// [12] void setLength(int newLength, const std::string& iVal);
...
//
// [ 6] operator==(const bdea_Array<std::string>&,
//                 const bdea_Array<std::string>&);
// [ 6] operator!=(const bdea_Array<std::string>&,
//                 const bdea_Array<std::string>&);
// [ 5] operator<<(ostream&, const bdea_Array<std::string>&);
// [10] operator>>(bdex_InStream&, bdea_Array<std::string>&);
// [10] operator<<(bdex_OutStream&, const bdea_Array<std::string>&);
//-----------------------------------------------------------------------------
// [ 1] BREATHING TEST
// [20] USAGE EXAMPLE
// [ 2] BOOTSTRAP: void append(std::string & item); // no aliasing
...
// [ 3] int ggg(bdea_Array<std::string> *o, const char *s,
//              const Element *v, int vF = 1);
// [ 3] bdea_Array<std::string>& gg(bdea_Array<std::string> *o,
//                                  const char *s, const Element *v);
// [ 8] bdea_Array<std::string>   g(const char *spec, const Element *values);
...
typedef bdea_Array<std::string> Obj;
...
struct Perms {
        ...
        bdea_Array<std::string>::Hint hint;     // infrequent delete hint
        const char         *text;               // description text
} PERMS[] = {
        { VALUES,  1, bdea_Array<std::string>::NO_HINT,
          "long string - no hint" },
        { VALUES2, 0, bdea_Array<std::string>::NO_HINT,
          "short string - no hint" },
        { VALUES,  1, bdea_Array<std::string>::INFREQUENT_DELETE_HINT,
          "long string - infrequent delete hint" },
        { VALUES2, 0, bdea_Array<std::string>::INFREQUENT_DELETE_HINT,
    ...
    // 'stream'.
{
    for (int i = 0; i < length; ++i) {
        bdex_OutStreamMethods<Element>::bdexStreamOut(out, array[i], 1);
    }
}
...
// appended to the 'bdea_Array<std::string>' object.  A tilde ('~') indicates
...
int ggg(bdea_Array<std::string> *object,
        const char    *spec,
        const Element *values,
        int            verboseFlag = 1)
...
bdea_Array<std::string>& gg(bdea_Array<std::string> *object,
                  const char    *spec,
                  const Element *values)
...
bdea_Array<std::string> g(const char *spec, const Element *values)
    // Return, by value, a new object corresponding to the specified 'spec'.
{
    bdea_Array<std::string> object((bdema_Allocator *)0);
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      case 19: {
        ...
        bdea_Array<std::string> a(&testAllocator);
                                        ASSERT( 0 == a.length());
...
//      ostrstream out(buf, sizeof buf);     *** MISMATCH caused by EPC bug ***
        ...
        if (verbose) cout << "\twith a 'bdema_TestAllocator':" << endl;
        {
            ...
            for (int ne = 0; ne <= MAX_NUM_ELEMS; ++ne) {
              ...
              BEGIN_BDEMA_EXCEPTION_TEST {
                ...
                if (veryVerbose) P(X);
                /* TBD applies to bdet_String not std::string
      ...
      case 16: {
        ...
        bdea_Array<std::string>::Hint HINT = bdea_Array<std::string>::NO_HINT;
        if (verbose) cout << endl
...
#undef NL
      ...
      case 14: {
        ...
        //     array, it calls the 'std::string' assignment operator that may
        ...
        // Testing:
        //   void replace(int di, std::string& item);
        //   void replace(int di, const bdea_Array<std::string>& sa,
        //                int si, int ne);
            ...
            "\nTesting replace(di, sa, si, ne) et. al. (no aliasing)" << endl;
        {
            ...
            for (int pn = 0; pn < NUM_PERMS; ++pn) {
              ...
              bdea_Array<std::string>::Hint HINT = PERMS[pn].hint;
      ...
      case 13: {
        ...
        //   void append(const bdea_Array<std::string>& sa);
        //   void append(const bdea_Array<std::string>& sa, int si, int ne);
        //
        //   void insert(int di, std::string& item);
        //   void insert(int di, const bdea_Array<std::string>& sa);
        //   void insert(int di,const bdea_Array<std::string>& s,int s,int ne);
        //
      ...
      case 12: {
        ...
        //   void setLength(int newLength, const std::string& iVal);
        // --------------------------------------------------------------------
        bdea_Array<std::string>::Hint HINT = bdea_Array<std::string>::NO_HINT;
      ...
      case 11: {
        ...
        //   bdea_Array(int iLen, const std::string& iVal, *ba = 0);
      ...
      case 10: {
        ...
        //   operator>>(bdex_InStream&, bdea_Array<std::string>&);
        //   operator<<(bdex_OutStream&, const bdea_Array<std::string>&);
        // --------------------------------------------------------------------
      ...
      case 9: {
                        ...
                        << endl;
        {
            ...
            for (int hintn = 0; hintn < 2; ++hintn) {
              bdea_Array<std::string>::Hint hintv;
              if (hintn == 0) {
                    if (verbose) cout << "\tWithout frequent delete hint\n";
                    hintv = bdea_Array<std::string>::NO_HINT;
              }
              else {
                    if (verbose) cout << "\tWith frequent delete hint\n";
                    hintv = bdea_Array<std::string>::INFREQUENT_DELETE_HINT;
              }
      ...
      case 8: {
        ...
        //
        // Testing:
        //   bdea_Array<std::string> g(const char *spec);
        // --------------------------------------------------------------------
      ...
      case 7: {
        ...
        //
        // Testing:
        //   bdea_Array(const bdea_Array<std::string>& original, *ba = 0);
        // --------------------------------------------------------------------
            ...
            "\nCopy construct values with varied representations." << endl;
        {
            ...
            const int NUM_EXTEND = sizeof EXTEND / sizeof *EXTEND;
            bdea_Array<std::string>::Hint
                                    hintval = bdea_Array<std::string>::NO_HINT;
            ...
            for (int ti = 0; SPECS[ti]; ++ti) {
                ...
                for (int ei = 0; ei < NUM_EXTEND; ++ei) {
                    ...
                    BEGIN_BDEMA_EXCEPTION_TEST {    // Test allocator + hint
                        const Obj Y3(X,
                            bdea_Array<std::string>::INFREQUENT_DELETE_HINT,
                            &testAllocator);
      ...
      case 6: {
        ...
        //
        // Testing:
        //   operator==(const bdea_Array<std::string>&,
        //              const bdea_Array<std::string>&);
        //   operator!=(const bdea_Array<std::string>&,
        //              const bdea_Array<std::string>&);
        // --------------------------------------------------------------------
      ...
      case 5: {
        ...
        //
        // Testing:
        //   operator<<(ostream&, const bdea_Array<std::string>&);
        // --------------------------------------------------------------------
      ...
      case 3: {
        ...
        if (verbose) cout << "\nTesting generator on valid specs." << endl;
        {
            ...
            for (int ti = 0; ti < NUM_DATA ; ++ti) {
                ...
                Obj mX(bdea_Array<std::string>::INFREQUENT_DELETE_HINT,
                       &testAllocator);
                ...
                Obj mY(bdea_Array<std::string>::INFREQUENT_DELETE_HINT,
                       &testAllocator);
      ...
      case 2: {
        ...
        //   ~bdea_Array();
        //   BOOTSTRAP: void append(std::string& item); // no aliasing
        //   void removeAll();
        // --------------------------------------------------------------------

        bdea_Array<std::string>::Hint NOHINT =
                                              bdea_Array<std::string>::NO_HINT;
        if (verbose) cout << endl
      ...
      case 1: {
        ...
        // long strings are longer than 'std::string'.  For tests to be valid
        // long strings must use the allocator and so must be longer than or
        // equal in size to 'std::string'.
        /* TBD applies to bdet_String not std::string
        for (int i = 0; i< NUM_VALUES; ++i) {
            // this platform
            ASSERT(VALUES[i].length() >= sizeof(VALUES[0]));
