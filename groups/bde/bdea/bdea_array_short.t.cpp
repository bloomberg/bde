...
// [11] bdea_Array(int iLen, short iVal, *ba = 0);
// [17] bdea_Array(const InitialCapacity& ne, *ba = 0);
// [11] bdea_Array(const short *sa, int ne, *ba = 0);
// [ 7] bdea_Array(const bdea_Array<short>& original, *ba = 0);
// [ 2] ~bdea_Array();
// [ 9] bdea_Array<short>& operator=(const bdea_Array<short>& rhs);
// [14] short& operator[](int index);
// [13] void append(short item);
// [13] void append(const bdea_Array<short>& sa);
// [13] void append(const bdea_Array<short>& sa, int si, int ne);
// [13] void append(const short *sa, int si, int ne);
// [18] short *data();
// [13] void insert(int di, short item);
// [13] void insert(int di, const bdea_Array<short>& sa);
// [13] void insert(int di, const bdea_Array<short>& sa, int si, int ne);
// [13] void insert(int di, const short *sa, int si, int ne);
// [13] void remove(int index);
// [13] void remove(int index, int ne);
// [ 2] void removeAll();
// [14] void replace(int di, short item);
// [14] void replace(int di, const bdea_Array<short>& sa, int si, int ne);
...
// [12] void setLength(int newLength, short iVal);
...
// [ 4] const short& operator[](int index) const;
// [18] const short *data() const;
// [ 4] int length() const;
...
//
// [ 6] operator==(const bdea_Array<short>&, const bdea_Array<short>&);
// [ 6] operator!=(const bdea_Array<short>&, const bdea_Array<short>&);
// [ 5] operator<<(ostream&, const bdea_Array<short>&);
// [10] operator>>(bdex_InStream&, bdea_Array<short>&);
// [10] operator<<(bdex_OutStream&, const bdea_Array<short>&);
//-----------------------------------------------------------------------------
// [ 1] BREATHING TEST
// [19] USAGE EXAMPLE
// [ 2] BOOTSTRAP: void append(short item); // no aliasing
...
// [ 3] int ggg(bdea_Array<short> *object, const char *spec, int vF = 1);
// [ 3] bdea_Array<short>& gg(bdea_Array<short>* object, const char *spec);
// [ 8] bdea_Array<short>   g(const char *spec);
...
// letters [A .. E] correspond to arbitrary (but unique) short values to be
// appended to the 'bdea_Array<short>' object.  A tilde ('~') indicates that
...
int ggg(bdea_Array<short> *object, const char *spec, int verboseFlag = 1)
...
bdea_Array<short>& gg(bdea_Array<short> *object, const char *spec)
...
bdea_Array<short> g(const char *spec)
    // Return, by value, a new object corresponding to the specified 'spec'.
{
    bdea_Array<short> object((bdema_Allocator *)0);
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      case 19: {
        ...
        bdea_Array<short> a(&testAllocator);
                                        ASSERT( 0 == a.length());
      ...
      case 18: {
        ...
        //
        // Plan:
        //   For each object X in a set of 'bdea_Array<short>' objects ordered
...
#define NL "\n"
        {
            static const struct {
                ...
                //line  spec    indent +/-  spaces/Tab  format
                //----  ----    ----------  ----------  ------------------
                { L_,   "",        0,         0,        "["           NL
                                                        "]"           NL  },
...
#undef NL
      ...
      case 14: {
        ...
        // Testing:
        //   void replace(int di, short item);
        //   void replace(int di, const bdea_Array<short>& sa, int si, int ne);
      ...
      case 13: {
        ...
        //   void append(const bdea_Array<short>& sa);
        //   void append(const bdea_Array<short>& sa, int si, int ne);
        //   void append(const short *sa, int si, int ne);
        //
        //   void insert(int di, short item);
        //   void insert(int di, const bdea_Array<short>& sa);
        //   void insert(int di, const bdea_Array<short>& sa, int si, int ne);
        //   void insert(int di, const short *sa, int si, int ne);
        //
      ...
      case 12: {
        ...
        //   void setLength(int newLength, short iVal);
        // --------------------------------------------------------------------
        ...
        if (verbose) cout << "\nTesting 'setLength(int, short)'" << endl;
        {
            const int lengths[] = { 0, 1, 2, 3, 4, 5, 7, 8, 9, 15, 16, 17 };
            const int NUM_TESTS = sizeof lengths / sizeof lengths[0];
            const Element I_VALUE = 1;
      ...
      case 11: {
        ...
        //   bdea_Array(int iLen, short iVal, *ba = 0);
        //   bdea_Array(const short *sa, int ne, *ba = 0);
        // --------------------------------------------------------------------
      ...
      case 10: {
        ...
        //   operator>>(bdex_InStream&, bdea_Array<short>&);
        //   operator<<(bdex_OutStream&, const bdea_Array<short>&);
        // --------------------------------------------------------------------
        ...
        if (verbose) cout << "\nWire format direct tests." << endl;
        {
            static const struct {
                ...
                { L_,   "",              1,   1, "\x00"                     },
                { L_,   "A",             1,   3, "\x01\x00\x01"             },
                { L_,   "AB",            1,   5, "\x02\x00\x01\x00\x02"     },
                { L_,   "ABC",           1,   7,
                                             "\x03\x00\x01\x00\x02\x00\x03" },
                { L_,   "ABCD",          1,   9,
                                     "\x04\x00\x01\x00\x02\x00\x03\x00\x04" },
                { L_,   "ABCDE",         1,  11,
                             "\x05\x00\x01\x00\x02\x00\x03\x00\x04\xff\xfb" },
            };
            const int NUM_DATA = sizeof DATA / sizeof *DATA;
      ...
      case 7: {
        ...
        //
        // Testing:
        //   bdea_Array(const bdea_Array<short>& original, *ba = 0);
        // --------------------------------------------------------------------
      ...
      case 6: {
        ...
        //
        // Testing:
        //   operator==(const bdea_Array<short>&, const bdea_Array<short>&);
        //   operator!=(const bdea_Array<short>&, const bdea_Array<short>&);
        // --------------------------------------------------------------------
      ...
      case 5: {
        ...
        //
        // Testing:
        //   operator<<(ostream&, const bdea_Array<short>&);
        // --------------------------------------------------------------------
      ...
      case 3: {
        ...
        // Testing:
        //   bdea_Array<short>& gg(bdea_Array<short>* object,const char *spec);
        //   int ggg(bdea_Array<short> *object, const char *spec, int vF = 1);
        //   void stretch(Obj *object, int size);
        //   void stretchRemoveAll(Obj *object, int size);
      ...
      case 2: {
        ...
        //   ~bdea_Array();
        //   BOOTSTRAP: void append(short item); // no aliasing
        //   void removeAll();
        // --------------------------------------------------------------------
