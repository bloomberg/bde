...
#define INCLUDED_BDEA_ARRAY_INT

//@PURPOSE: Provide an in-place array of 'int' values.
//
//@DEPRECATED: This component is being replaced with 'std::vector'.
//
//@CLASSES:
//   bdea_Array<int>: memory manager for in-place array of 'int' values
//
//@AUTHOR: Paul Staniforth (pstaniforth)
//
//@SEE_ALSO: bdea_array2_int
//
//@DESCRIPTION: This component implements an in-place array of 'int' values.
...
// 'bdea_array2_int' if the memory address of each contained element must
...
// First create an empty 'bdea_Array<int>' 'a' and populate it with two
// elements 'E1' and 'E2':
//..
//      const int E1 = 100;
//      const int E2 = 200;
//
//      bdea_Array<int> a;              assert( 0 == a.length());
//
...
template <class T> class bdea_Array;
                       ...
                       // =====================
                       // class bdea_Array<int>
                       // =====================

template<>
class bdea_Array<int> {
    // This class implements an efficient, in-place array of 'int' values
    ...
    friend int operator==(const bdea_Array<int>& lhs,
                          const bdea_Array<int>& rhs);
  ...
  public:
    ...
    struct InitialCapacity { int d_i; ~InitialCapacity() { }
        ...
        //..
        //   bdea_Array<int> x(bdea_Array<int>::InitialCapacity(8));
        //..
    ...
    bdea_Array(const bdea_Array<int>&  original,
               bdema_Allocator        *basicAllocator = 0);
    ...
    // MANIPULATORS
    bdea_Array<int>& operator=(const bdea_Array<int>& rhs);
    ...
    void append(const bdea_Array<int>& srcArray);
    ...
    void append(const int *srcArray, int srcIndex, int numElements);
        // Append to the end of this array the specified 'numElements' values
        // from the specified 'srcArray', beginning at the specified
        // 'srcIndex'.  The behavior is undefined unless 0 <= srcIndex,
        // 0 <= numElements, and srcIndex + numElements <= srcArray.length().
    ...
    void insert(int dstIndex, int item);
    ...
    void insert(int dstIndex, const bdea_Array<int>& srcArray);
    ...
    void replace(int dstIndex, int item);
    ...
    void setLength(int newLength, int initialValue);
...
// FREE OPERATORS
inline
int operator==(const bdea_Array<int>& lhs, const bdea_Array<int>& rhs);
...
inline
std::ostream& operator<<(std::ostream& stream, const bdea_Array<int>& array);
...
inline
int *bdea_Array<int>::data()
{
    return (int *)d_array.data();
}

inline
const int *bdea_Array<int>::data() const
{
    return (const int *)d_array.data();
}

inline
int bdea_Array<int>::length() const
{
    return d_array.length() / sizeof(int);
}
...
inline
bdea_Array<int>::bdea_Array(bdema_Allocator *basicAllocator)
: d_array(bdema_CharArray::InitialCapacity(sizeof(int)), basicAllocator)
{
}

inline
bdea_Array<int>::bdea_Array(const Explicit&  initialLength,
                            bdema_Allocator *basicAllocator)
: d_array(bdema_CharArray::InitialCapacity(initialLength.d_i > 0
                                           ? initialLength.d_i * sizeof(int)
                                           : sizeof(int)),
          bdema_CharArray::POWER_OF_2_HINT,
          basicAllocator)
{
    d_array.setLengthRaw(initialLength.d_i * sizeof(int));
    std::memset(data(), 0, initialLength.d_i * sizeof(int));
}

inline
bdea_Array<int>::bdea_Array(int              initialLength,
                            int              initialValue,
                            bdema_Allocator *basicAllocator)
: d_array(bdema_CharArray::InitialCapacity(initialLength > 0
                                           ? initialLength * sizeof(int)
                                           : sizeof(int)),
          bdema_CharArray::POWER_OF_2_HINT,
          basicAllocator)
{
    d_array.setLengthRaw(initialLength * sizeof(int));
    bdeimp_DuffsDevice<int>::initialize(data(), initialValue, initialLength);
}

inline
bdea_Array<int>::bdea_Array(const InitialCapacity&  numElements,
                            bdema_Allocator        *basicAllocator)
: d_array(bdema_CharArray::InitialCapacity(numElements.d_i > 0
                                           ? numElements.d_i * sizeof(int)
                                           : sizeof(int)),
          basicAllocator)
{
...
inline
bdea_Array<int>::bdea_Array(const int       *srcArray,
                            int              numElements,
                            bdema_Allocator *basicAllocator)
: d_array(bdema_CharArray::InitialCapacity(numElements > 0
          ...
          basicAllocator)
{
    d_array.setLengthRaw(numElements * sizeof(int));
    std::memcpy(data(), srcArray, numElements * sizeof(int));
}

inline
bdea_Array<int>::bdea_Array(const bdea_Array<int>&  original,
                            bdema_Allocator        *basicAllocator)
: d_array(bdema_CharArray::InitialCapacity(original.length() > 0
                                           ? original.length() * sizeof(int)
                                           : sizeof(int)),
          bdema_CharArray::POWER_OF_2_HINT,
          basicAllocator)
{
    d_array.setLengthRaw(original.length() * sizeof(int));
    std::memcpy(data(), original.data(), original.length() * sizeof(int));
}

inline
bdea_Array<int>::~bdea_Array()
{
}
...
inline
bdea_Array<int>& bdea_Array<int>::operator=(const bdea_Array<int>& rhs)
{
    d_array = rhs.d_array;
...
inline
int& bdea_Array<int>::operator[](int index)
{
    return data()[index];
}

inline
void bdea_Array<int>::append(int item)
{
    int len = length();
    d_array.setLengthRaw(d_array.length() + sizeof(int));
    data()[len] = item;
}

inline
void bdea_Array<int>::append(const bdea_Array<int>& srcArray)
{
...
inline
void bdea_Array<int>::append(const int *srcArray, int srcIndex,int numElements)
{
...
inline
void bdea_Array<int>::insert(int dstIndex, int item)
{
    d_array.insert(dstIndex * sizeof(int), (const char *)&item, 0,sizeof(int));
}

inline
void bdea_Array<int>::insert(int dstIndex, const bdea_Array<int>& srcArray)
{
    d_array.insert(dstIndex * sizeof(int), srcArray.d_array);
}

inline
void bdea_Array<int>::insert(int                    dstIndex,
                             const bdea_Array<int>& srcArray,
                             int                    srcIndex,
                             int                    numElements)
{
    d_array.insert(dstIndex * sizeof(int),
                   srcArray.d_array,
                   srcIndex * sizeof(int),
                   numElements * sizeof(int));
}
...
inline
void bdea_Array<int>::remove(int index)
{
    d_array.remove(index * sizeof(int), sizeof(int));
}

inline
void bdea_Array<int>::remove(int index, int numElements)
{
    d_array.remove(index * sizeof(int), numElements * sizeof(int));
}

inline
void bdea_Array<int>::removeAll()
{
    d_array.removeAll();
}

inline
void bdea_Array<int>::replace(int dstIndex, int item)
{
    data()[dstIndex] = item;
}

inline
void bdea_Array<int>::replace(int                    dstIndex,
                              const bdea_Array<int>& srcArray,
                              int                    srcIndex,
                              int                    numElements)
{
    d_array.replace(dstIndex * sizeof(int),
                    srcArray.d_array,
                    srcIndex * sizeof(int),
                    numElements * sizeof(int));
}

inline void bdea_Array<int>::reserveCapacity(int numElements)
{
    d_array.reserveCapacity(numElements * sizeof(int));
}

inline
void bdea_Array<int>::reserveCapacityRaw(int numElements)
{
    d_array.reserveCapacityRaw(numElements * sizeof(int));
}

inline
void bdea_Array<int>::setLengthRaw(int newLength)
{
    d_array.setLengthRaw(newLength * sizeof(int));
}

inline
void bdea_Array<int>::setLength(int newLength)
{
    d_array.setLength(newLength * sizeof(int));
}

inline
void bdea_Array<int>::setLength(int newLength, int initialValue)
{
    int len = length();
    d_array.setLengthRaw(newLength * sizeof(int));
    if (newLength > len) {
        bdeimp_DuffsDevice<int>::initialize(data() + len,
                                            initialValue,
                                            newLength - len);
    }
}
...
inline
void bdea_Array<int>::swap(int index1, int index2)
{
    int *array_p = data();
    int tmp = array_p[index1];
...
template <class STREAM>
inline
STREAM& bdea_Array<int>::bdexStreamIn(STREAM& stream, int version)
{
    if (stream) {
        switch (version) {  // Switch on the schema version (starting with 1).
          case 1: {
            ...
            stream.getArrayInt32(data(), newLength);
...
template <class STREAM>
inline
STREAM& bdea_Array<int>::streamInRaw(STREAM& stream, int version)
{
...
inline
const int& bdea_Array<int>::operator[](int index) const
{
    return data()[index];
}
...
template <class STREAM>
inline
STREAM& bdea_Array<int>::bdexStreamOut(STREAM& stream, int version) const
{
    switch (version) {
      case 1: {
        int len = length();
        stream.putLength(len);
        stream.putArrayInt32(data(), len);
      } break;
    }
    return stream;
}
...
template <class STREAM>
inline
STREAM& bdea_Array<int>::streamOutRaw(STREAM& stream, int version) const
{
