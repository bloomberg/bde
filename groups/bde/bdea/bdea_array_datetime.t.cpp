...
// [11] bdea_Array(int iLen, const bdet_Datetime& iVal, *ba = 0);
// [17] bdea_Array(const InitialCapacity& ne, *ba = 0);
// [ 7] bdea_Array(const bdea_Array<bdet_Datetime>& original, *ba = 0);
// [ 2] ~bdea_Array();
// [ 9] bdea_Array<bdet_Datetime>&
//                             operator=(const bdea_Array<bdet_Datetime>& rhs);
// [14] bdet_Datetime& operator[](int index);
// [13] void append(const bdet_Datetime& item);
// [13] void append(const bdea_Array<bdet_Datetime>& sa);
// [13] void append(const bdea_Array<bdet_Datetime>& sa, int si, int ne);
// [13] void append(const bdet_Datetime *sa, int si, int ne);
// [18] bdet_Datetime *data();
// [13] void insert(int di, const bdet_Datetime& item);
// [13] void insert(int di, const bdea_Array<bdet_Datetime>& sa);
// [13] void insert(int di, const bdea_Array<bdet_Datetime>& sa,int si,int ne);
// [13] void insert(int di, const bdet_Datetime *sa, int si, int ne);
// [13] void remove(int index);
// [13] void remove(int index, int ne);
// [ 2] void removeAll();
// [14] void replace(int di, const bdet_Datetime& item);
// [14] void replace(int di,const bdea_Array<bdet_Datetime>& sa,int si,int ne);
...
// [12] void setLength(int newLength, const bdet_Datetime& iVal);
...
// [ 4] const bdet_Datetime& operator[](int index) const;
// [18] const bdet_Datetime *data() const;
// [ 4] int length() const;
...
//
// [ 6] operator==(const bdea_Array<bdet_Datetime>&,
//                 const bdea_Array<bdet_Datetime>&);
// [ 6] operator!=(const bdea_Array<bdet_Datetime>&,
//                 const bdea_Array<bdet_Datetime>&);
// [ 5] operator<<(ostream&, const bdea_Array<bdet_Datetime>&);
// [10] operator>>(bdex_InStream&, bdea_Array<bdet_Datetime>&);
// [10] operator<<(bdex_OutStream&, const bdea_Array<bdet_Datetime>&);
//-----------------------------------------------------------------------------
// [ 1] BREATHING TEST
// [19] USAGE EXAMPLE
// [ 2] BOOTSTRAP: void append(const bdet_Datetime& item); // no aliasing
...
// [ 3] int ggg(bdea_Array<bdet_Datetime> *object,const char *spec,int vF = 1);
// [ 3] bdea_Array<bdet_Datetime>& gg(bdea_Array<bdet_Datetime>* object,
//                                    const char *spec);
// [ 8] bdea_Array<bdet_Datetime>   g(const char *spec);
...
typedef bdea_Array<bdet_Datetime> Obj;
typedef bdet_Datetime Element;

// Avoid DEFAULT Value.
const Element VALUES[] = {
       bdet_Datetime(bdet_Date(2001,  5, 20), bdet_Time(0, 0, 10)),
       bdet_Datetime(bdet_Date(2002,  7, 21), bdet_Time(0, 0, 11)),
       bdet_Datetime(bdet_Date(2003,  4, 22), bdet_Time(0, 0, 12)),
       bdet_Datetime(bdet_Date(2004,  8, 23), bdet_Time(0, 0, 13)),
       bdet_Datetime(bdet_Date(2005, 12, 24), bdet_Time(0, 0, 14)),
};

// The default value.
const Element VDEFAULT = Element();
...
// letters [A .. E] correspond to arbitrary (but unique) bdet_Datetime values
// to be appended to the 'bdea_Array<bdet_Datetime>' object.  A tilde ('~')
...
int ggg(bdea_Array<bdet_Datetime> *object,const char *spec,int verboseFlag = 1)
...
bdea_Array<bdet_Datetime>& gg(bdea_Array<bdet_Datetime> *object,
                              const char                *spec)
...
bdea_Array<bdet_Datetime> g(const char *spec)
    // Return, by value, a new object corresponding to the specified 'spec'.
{
    bdea_Array<bdet_Datetime> object((bdema_Allocator *)0);
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      case 19: {
        ...
        bdea_Array<bdet_Datetime> a(&testAllocator);
                                        ASSERT( 0 == a.length());
...
//      ostrstream out(buf, sizeof buf);     *** MISMATCH caused by EPC bug ***
        ...
        const char *const EXPECTED =
            "[ 07DEC2003_03:19:07.000 01JAN2004_04:01:01.000"
            " 03OCT2002_02:10:03.001 ]\n";
      ...
      case 18: {
        ...
        //
        // Plan:
        //   For each object X in a set of 'bdea_Array<bdet_Datetime>' objects
        //   ordered by increasing length L:
...
#define NL "\n"
        {
            static const struct {
                ...
                { L_,  "BC",    1,    2,   "  ["                          NL
                                           "    21JUL2002_00:00:11.000"   NL
                                           "    22APR2003_00:00:12.000"   NL
                                           "  ]"                          NL },
                ...
                { L_,  "ABCDE", 1,    3,   "   ["                         NL
                                           ...
                                           "      21JUL2002_00:00:11.000" NL
                                           "      22APR2003_00:00:12.000" NL
                                           "      23AUG2004_00:00:13.000" NL
                                           "      24DEC2005_00:00:14.000" NL
                                           "   ]"                         NL },
            };
#undef  NL
      ...
      case 14: {
        ...
        // Testing:
        //   void replace(int di, bdet_Datetime item);
        //   void replace(int di, const bdea_Array<bdet_Datetime>& sa,
        //                int s, int n);
      ...
      case 13: {
        ...
        //
        // Testing:
        //   void append(bdet_Datetime item);
        //   void append(const bdea_Array<bdet_Datetime>& sa);
        //   void append(const bdea_Array<bdet_Datetime>& sa, int si, int ne);
        //   void append(const bdet_Datetime *sa, int si, int ne);
        //
        //   void insert(int di, bdet_Datetime item);
        //   void insert(int di, const bdea_Array<bdet_Datetime>& sa);
        //   void insert(int di, const bdea_Array<bdet_Datetime>& sa,
        //               int si, int ne);
        //   void insert(int di, const bdet_Datetime *sa, int si, int ne);
        //
      ...
      case 12: {
        ...
        //   void setLength(int newLength, bdet_Datetime iVal);
        // --------------------------------------------------------------------
        ...
        if (verbose) cout << "\nTesting 'setLengthRaw'" << endl;
        {
            ...
            const Element VALUE(bdet_Date(2006, 12, 23), bdet_Time(6, 0, 10));
        ...
        if (verbose) cout << "\nTesting 'setLength(int)'" << endl;
        {
            const int lengths[] = { 0, 1, 2, 3, 4, 5, 7, 8, 9, 15, 16, 17 };
            const int NUM_TESTS = sizeof lengths / sizeof lengths[0];
            const Element I_VALUE(bdet_Date(2002, 2, 23), bdet_Time(6, 0, 10));
            const Element DEFAULT_VALUE = VDEFAULT;
            for (int i = 0; i < NUM_TESTS; ++i) {
                const int a1 = lengths[i];
                if (verbose) { cout << "\t"; P(a1); }
                for (int j = 0; j < NUM_TESTS; ++j) {
        ...
        if (verbose) cout <<
               "\nTesting 'setLength(int, bdet_Datetime)'" << endl;
        {
            const int lengths[] = { 0, 1, 2, 3, 4, 5, 7, 8, 9, 15, 16, 17 };
            const int NUM_TESTS = sizeof lengths / sizeof lengths[0];
            const Element I_VALUE(bdet_Date(1999, 1, 20), bdet_Time(0, 0, 10));
            const Element F_VALUE(bdet_Date(2002, 2, 21), bdet_Time(0, 0, 20));
            for (int i = 0; i < NUM_TESTS; ++i) {
                const int a1 = lengths[i];
                if (verbose) { cout << "\t"; P(a1); }
                for (int j = 0; j < NUM_TESTS; ++j) {
      ...
      case 11: {
        ...
        //   bdea_Array(int iLen, bdet_Datetime iVal, *ba = 0);
        //   bdea_Array(const bdet_Datetime *sa, int ne, *ba = 0);
        // --------------------------------------------------------------------
        ...
        if (verbose) cout << "\tWithout passing in an allocator." << endl;
        {
            const Element VALUE(bdet_Date(2001, 1, 1), bdet_Time(1, 0, 20));
            const int MAX_LENGTH = 10;
            for (int length = 0; length <= MAX_LENGTH; ++length) {
                if (verbose) P(length);
        ...
        if (verbose) cout << "\t\tWith no exceptions." << endl;
        {
            const Element VALUE(bdet_Date(1961, 1, 23), bdet_Time(0, 0, 10));
            const int MAX_LENGTH = 10;
            for (int length = 0; length <= MAX_LENGTH; ++length) {
                if (verbose) P(length);
        ...
        if (verbose) cout << "\t\tWith exceptions." << endl;
        {
            const Element VALUE(bdet_Date(1967, 6, 23), bdet_Time(0, 0, 10));
            const int MAX_LENGTH = 10;
            for (int length = 0; length <= MAX_LENGTH; ++length) {
              BEGIN_BDEMA_EXCEPTION_TEST {
                if (verbose) P(length);
        ...
        if (verbose) cout << "\tIn place using a buffer allocator." << endl;
        {
            char memory[1024];
            bdema_BufferAllocator a(memory, sizeof memory);
            const Element VALUE(bdet_Date(1964, 6, 23), bdet_Time(0, 0, 10));
            const int MAX_LENGTH = 10;
            for (int length = 0; length <= MAX_LENGTH; ++length) {
                if (verbose) P(length);
                Obj *doNotDelete =
        ...
        {
            const Element DA[] = // ADJUST
                { Element(bdet_Date(1600, 1, 1), bdet_Time(1, 10, 11, 800)),
                  Element(bdet_Date(1752, 9, 14), bdet_Time(3, 29, 12)),
                  Element(bdet_Date(1999, 12, 28), bdet_Time(5, 38, 13, 600)),
                  Element(bdet_Date(2000, 1, 1), bdet_Time(7, 47, 14)),
                  Element(bdet_Date(1987, 11, 7), bdet_Time(9, 56, 15, 400)),
                  Element(bdet_Date(1944, 6, 6), bdet_Time(2, 55, 16)),
                  Element(bdet_Date(2002, 12, 31), bdet_Time(4, 44, 17, 200)),
                  Element(bdet_Date(9999, 12, 31), bdet_Time(6, 33, 18)),
                  Element(bdet_Date(1996, 2, 28), bdet_Time(8, 22, 19, 100)),
                  Element(bdet_Date(2004, 10, 31), bdet_Time(10, 11, 20)) };
      ...
      case 10: {
        ...
        //   operator>>(bdex_InStream&, bdea_Array<bdet_Datetime>&);
        //   operator<<(bdex_OutStream&, const bdea_Array<bdet_Datetime>&);
        // --------------------------------------------------------------------
        ...
        if (verbose) cout << "\nWire format direct tests." << endl;
        {
            static const struct {
                ...
                { L_,   "",              1,   1, "\x00"                     },
                { L_,   "A",             1,   8,
                                         "\x01\x0b\x26\x03\x00\x00\x27\x10" },
                { L_,   "AB",            1,  15,
             "\x02\x0b\x26\x03\x00\x00\x27\x10\x0b\x27\xae\x00\x00\x2a\xf8" },
                { L_,   "ABC",           1,  22,
                             "\x03\x0b\x26\x03\x00\x00\x27\x10\x0b\x27\xae"
                             "\x00\x00\x2a\xf8\x0b\x28\xc1\x00\x00\x2e\xe0" },
                { L_,   "ABCD",          1,  29,
                               "\x04\x0b\x26\x03\x00\x00\x27\x10\x0b\x27"
                               "\xae\x00\x00\x2a\xf8\x0b\x28\xc1\x00\x00"
                                     "\x2e\xe0\x0b\x2a\xaa\x00\x00\x32\xc8" },
                { L_,   "ABCDE",         1,  36,
                               "\x05\x0b\x26\x03\x00\x00\x27\x10\x0b\x27"
                               "\xae\x00\x00\x2a\xf8\x0b\x28\xc1\x00\x00"
                               "\x2e\xe0\x0b\x2a\xaa\x00\x00\x32\xc8\x0b"
                                                 "\x2c\x92\x00\x00\x36\xb0" },
            };
            const int NUM_DATA = sizeof DATA / sizeof *DATA;
      ...
      case 7: {
        ...
        // Testing:
        //   bdea_Array<bdet_Datetime>
        //                (const bdea_Array<bdet_Datetime>& original, *ba = 0);
        // --------------------------------------------------------------------
      ...
      case 6: {
        ...
        //
        // Testing:
        //   operator==(const bdea_Array<bdet_Datetime>&,
        //              const bdea_Array<bdet_Datetime>&);
        //   operator!=(const bdea_Array<bdet_Datetime>&,
        //              const bdea_Array<bdet_Datetime>&);
        // --------------------------------------------------------------------
      ...
      case 5: {
        ...
        //
        // Testing:
        //   operator<<(ostream&, const bdea_Array<bdet_Datetime>&);
        // --------------------------------------------------------------------
        ...
        if (verbose) cout << "\nTesting 'operator<<' (ostream)." << endl;
        {
            static const struct {
                ...
                //----  --------------  ---------------------------------
                { L_,   "",             "[ ]"                           },
                { L_,   "A",            "[ 20MAY2001_00:00:10.000 ]"    },
                { L_,   "BC",           "[ 21JUL2002_00:00:11.000 "
                                        "22APR2003_00:00:12.000 ]"      },
                { L_,   "ABCDE",        "[ 20MAY2001_00:00:10.000 "
                                        "21JUL2002_00:00:11.000 "
                                        "22APR2003_00:00:12.000 "
                                        "23AUG2004_00:00:13.000 "
                                        "24DEC2005_00:00:14.000 ]"      },
            };
      ...
      case 4: {
        ...
        // Testing:
        //   int length() const;
        //   const bdet_Date& operator[](int index) const;
        // --------------------------------------------------------------------
      ...
      case 3: {
        ...
        //
        // Testing:
        //   bdea_DateArray& gg(bdea_DateArray* object, const char *spec);
        //   int ggg(bdea_DateArray *object, const char *spec, int vF = 1);
        //   void stretch(Obj *object, int size);
        //   void stretchRemoveAll(Obj *object, int size);
      ...
      case 2: {
        ...
        //   ~bdea_Array();
        //   BOOTSTRAP: void append(bdet_Datetime item); // no aliasing
        //   void removeAll();
        // --------------------------------------------------------------------
