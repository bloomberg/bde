...
// [11] bdea_Array(int iLen, const bdet_Time& iVal, *ba = 0);
// [17] bdea_Array(const InitialCapacity& ne, *ba = 0);
// [ 7] bdea_Array(const bdea_Array<bdet_Time>& original, *ba = 0);
// [ 2] ~bdea_Array();
// [ 9] bdea_Array<bdet_Time>& operator=(const bdea_Array<bdet_Time>& rhs);
// [14] bdet_Time& operator[](int index);
// [13] void append(const bdet_Time& item);
// [13] void append(const bdea_Array<bdet_Time>& sa);
// [13] void append(const bdea_Array<bdet_Time>& sa, int si, int ne);
// [13] void append(const bdet_Time *sa, int si, int ne);
// [18] bdet_Time *data();
// [13] void insert(int di, const bdet_Time& item);
// [13] void insert(int di, const bdea_Array<bdet_Time>& sa);
// [13] void insert(int di, const bdea_Array<bdet_Time>& sa, int si, int ne);
// [13] void insert(int di, const bdet_Time *sa, int si, int ne);
// [13] void remove(int index);
// [13] void remove(int index, int ne);
// [ 2] void removeAll();
// [14] void replace(int di, const bdet_Time& item);
// [14] void replace(int di, const bdea_Array<bdet_Time>& sa, int si, int ne);
...
// [12] void setLength(int newLength, const bdet_Time& iVal);
...
// [ 4] const bdet_Time& operator[](int index) const;
// [18] const bdet_Time *data() const;
// [ 4] int length() const;
...
//
// [ 6] operator==(const bdea_Array<bdet_Time>&, const bdea_Array<bdet_Time>&);
// [ 6] operator!=(const bdea_Array<bdet_Time>&, const bdea_Array<bdet_Time>&);
// [ 5] operator<<(ostream&, const bdea_Array<bdet_Time>&);
// [10] operator>>(bdex_InStream&, bdea_Array<bdet_Time>&);
// [10] operator<<(bdex_OutStream&, const bdea_Array<bdet_Time>&);
//-----------------------------------------------------------------------------
// [ 1] BREATHING TEST
// [19] USAGE EXAMPLE
// [ 2] BOOTSTRAP: void append(const bdet_Time& item); // no aliasing
...
// [ 3] int ggg(bdea_Array<bdet_Time> *object, const char *spec, int vF = 1);
// [ 3] bdea_Array<bdet_Time>& gg(bdea_Array<bdet_Time>* object,
//                                const char *spec);
// [ 8] bdea_Array<bdet_Time>   g(const char *spec);
...
typedef bdea_Array<bdet_Time> Obj;
typedef bdet_Time Element;

// Avoid DEFAULT Value.
const Element VALUES[] = { Element( 1, 5, 20, 9 ),
                           Element( 2, 5, 21, 8 ),
                           Element( 3, 5, 22, 7 ),
                           Element( 4, 5, 23, 6 ),
                           Element( 5, 5, 24, 5 ),
...
// letters [A .. E] correspond to arbitrary (but unique) bdet_Time values to be
// appended to the 'bdea_Array<bdet_Time>' object.  A tilde ('~') indicates
...
int ggg(bdea_Array<bdet_Time> *object, const char *spec, int verboseFlag = 1)
...
bdea_Array<bdet_Time>& gg(bdea_Array<bdet_Time> *object, const char *spec)
...
bdea_Array<bdet_Time> g(const char *spec)
    // Return, by value, a new object corresponding to the specified 'spec'.
{
    bdea_Array<bdet_Time> object((bdema_Allocator *)0);
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      case 19: {
        ...
        const bdet_Time E1(1, 30, 0);
        const bdet_Time E2(2, 10, 3, 1);

        bdea_Array<bdet_Time> a(&testAllocator);
                                        ASSERT( 0 == a.length());
        ...
        const bdet_Time E3(3, 19, 7);

        a[0] = E3;                      ASSERT( 2 == a.length());
                                        ASSERT(E3 == a[0]);
                                        ASSERT(E2 == a[1]);

        const bdet_Time E4(4, 1, 1);
...
//      ostrstream out(buf, sizeof buf);     *** MISMATCH caused by EPC bug ***
        ...
        const char *const EXPECTED =
              "[ 03:19:07.000 04:01:01.000 02:10:03.001 ]\n";
      ...
      case 18: {
        ...
        //
        // Plan:
        //   For each object X in a set of 'bdea_Array<bdet_Time>' objects
...
#undef  NL
      ...
      case 14: {
        ...
        // Testing:
        //   void replace(int di, bdet_Time item);
        //   void replace(int di, const bdea_Array<bdet_Time>& sa,
        //                int si, int ne);
        //   bdet_Time& operator[](int index);
        // --------------------------------------------------------------------
      ...
      case 13: {
        ...
        //
        // Testing:
        //   void append(bdet_Time item);
        //   void append(const bdea_Array<bdet_Time>& sa);
        //   void append(const bdea_Array<bdet_Time>& sa, int si, int ne);
        //   void append(const bdet_Time *sa, int si, int ne);
        //
        //   void insert(int di, bdet_Time item);
        //   void insert(int di, const bdea_Array<bdet_Time>& sa);
        //   void insert(int di, const bdea_Array<bdet_Time>& sa,
        //               int si, int ne);
        //   void insert(int di, const bdet_Time *sa, int si, int ne);
        //
      ...
      case 12: {
        ...
        //   void setLength(int newLength, bdet_Time iVal);
        // --------------------------------------------------------------------
        ...
        if (verbose) cout << "\nTesting 'setLength(int, bdet_Time)'" << endl;
        {
            const int lengths[] = { 0, 1, 2, 3, 4, 5, 7, 8, 9, 15, 16, 17 };
            const int NUM_TESTS = sizeof lengths / sizeof lengths[0];
            const Element I_VALUE(1, 2, 0, 0);
            const Element F_VALUE(2, 4, 0, 0);
            for (int i = 0; i < NUM_TESTS; ++i) {
                const int a1 = lengths[i];
                if (verbose) { cout << "\t"; P(a1); }
                for (int j = 0; j < NUM_TESTS; ++j) {
      ...
      case 11: {
        ...
        //   bdea_Array(int iLen, bdet_Time iVal, *ba = 0);
        //   bdea_Array(const bdet_Time *sa, int ne, *ba = 0);
        // --------------------------------------------------------------------
        ...
        {
            const Element DA[] =
                { Element(1, 10, 11, 800), Element(3, 29, 12),
                  Element(5, 38, 13, 600), Element(7, 47, 14),
                  Element(9, 56, 15, 400), Element(2, 55, 16),
                  Element(4, 44, 17, 200), Element(6, 33, 18),
                  Element(8, 22, 19, 100), Element(10, 11, 20) }; // ADJUST
      ...
      case 10: {
        ...
        //   operator>>(bdex_InStream&, bdea_Array<bdet_Time>&);
        //   operator<<(bdex_OutStream&, const bdea_Array<bdet_Time>&);
        // --------------------------------------------------------------------
        ...
        if (verbose) cout << "\nWire format direct tests." << endl;
        {
            static const struct {
                ...
                { L_,   "",              1,   1, "\x00"                     },
                { L_,   "A",             1,   5, "\x01\x00\x3b\xd0\x89"     },
                { L_,   "AB",            1,   9,
                                     "\x02\x00\x3b\xd0\x89\x00\x72\xc2\xf0" },
                { L_,   "ABC",           1,  13,
                     "\x03\x00\x3b\xd0\x89\x00\x72\xc2\xf0\x00\xa9\xb5\x57" },
                { L_,   "ABCD",          1,  17,
     "\x04\x00\x3b\xd0\x89\x00\x72\xc2\xf0\x00\xa9\xb5\x57\x00\xe0\xa7\xbe" },
                { L_,   "ABCDE",         1,  21,
                         "\x05\x00\x3b\xd0\x89\x00\x72\xc2\xf0\x00\xa9\xb5"
                                     "\x57\x00\xe0\xa7\xbe\x01\x17\x9a\x25" },
            };
            const int NUM_DATA = sizeof DATA / sizeof *DATA;
      ...
      case 9: {
        ...
        //
        // Testing:
        //   bdea_Array<bdet_Time>& operator=(const bdea_Array<bdet_Time>&);
        // --------------------------------------------------------------------
      ...
      case 7: {
        ...
        //
        // Testing:
        //   bdea_Array(const bdea_Array<bdet_Time>& original, *ba = 0);
        // --------------------------------------------------------------------
      ...
      case 6: {
        ...
        //
        // Testing:
        //   operator==(const bdea_Array<bdet_Time>&,
        //              const bdea_Array<bdet_Time>&);
        //   operator!=(const bdea_Array<bdet_Time>&,
        //              const bdea_Array<bdet_Time>&);
        // --------------------------------------------------------------------
      ...
      case 5: {
        ...
        //
        // Testing:
        //   operator<<(ostream&, const bdea_Array<bdet_Time>&);
        // --------------------------------------------------------------------
        ...
        if (verbose) cout << "\nTesting 'operator<<' (ostream)." << endl;
        {
            static const struct {
                ...
                { L_,   "",             "[ ]"                           },
                { L_,   "A",            "[ 01:05:20.009 ]"              },
                { L_,   "BC",           "[ 02:05:21.008 03:05:22.007 ]" },
                { L_,   "ABCDE",        "[ 01:05:20.009 "
                                        "02:05:21.008 "
                                        "03:05:22.007 "
                                        "04:05:23.006 "
                                        "05:05:24.005 ]"                },
      ...
      case 2: {
        ...
        //   ~bdea_Array();
        //   BOOTSTRAP: void append(bdet_Time item); // no aliasing
        //   void removeAll();
        // --------------------------------------------------------------------
