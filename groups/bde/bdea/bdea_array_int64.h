// bdea_array_int64.h           -*-C++-*-
#ifndef INCLUDED_BDEA_ARRAY_INT64
#define INCLUDED_BDEA_ARRAY_INT64

//@PURPOSE: Provide an in-place array of '64-bit integer' values.
//
//@DEPRECATED: This component is being replaced with 'std::vector'.
//
//@CLASSES:
//   bdea_Array<bdes_PlatformUtil::Int64>: memory manager for in-place array of
...
//@SEE_ALSO:
//
//@DESCRIPTION: This component implements an in-place array of 64-bit integer
// values.  The contained elements are stored contiguously in memory and can be
// accessed, appended, inserted, and removed from the container.  Note that
// appending, inserting, and removing elements can potentially alter
// the memory addresses of other elements in the array.
//
// At least one other component of the BDEA package (bdea_Array<double>) has a
// related component (bdea_Array2<double>) for which the memory location of a
// given contained element remains constant for the lifetime of the element.
// While no such corresponding component exists for
// bdea_Array<bdes_PlatformUtil::Int64> at this time, it could be developed to
// support analogous requirements.  Also, note that such an implementation will
// improve runtime performance where insert/remove operations are frequent.
//
///PERFORMANCE
///-----------
...
// First create an empty 'bdea_Array<bdes_PlatformUtil::Int64>' 'a' and
// populate it with two elements 'E1' and 'E2':
//..
//      const bdes_PlatformUtil::Int64 E1 = 100;
//      const bdes_PlatformUtil::Int64 E2 = 200;
//
//      bdea_Array<bdes_PlatformUtil::Int64> a;
//                                      assert( 0 == a.length());
//
...
// array 'a'.
//..
//      const bdes_PlatformUtil::Int64 E3 = 300;
//
...
//..
//      const bdes_PlatformUtil::Int64 E4 = 400;
//
...
template <class T> class bdea_Array;
                 ...
                 // ==========================================
                 // class bdea_Array<bdes_PlatformUtil::Int64>
                 // ==========================================

template <>
class bdea_Array<bdes_PlatformUtil::Int64> {
    // This class implements an efficient, in-place array of
    // 'bdes_PlatformUtil::Int64' values stored contiguously in memory.
    // The physical capacity of this array may grow, but never shrinks.
    // Capacity may be reserved initially via a constructor, or at any
    // time thereafter by using the 'reserveCapacity' method;
    // otherwise capacity will be increased automatically as needed.  The
    ...
    friend int operator==(const bdea_Array<bdes_PlatformUtil::Int64>& lhs,
                          const bdea_Array<bdes_PlatformUtil::Int64>& rhs);
  ...
  public:
    ...
    struct InitialCapacity { int d_i; ~InitialCapacity() { }
        ...
        //..
        //   bdea_Array<bdes_PlatformUtil::Int64>
        //         x(bdea_Array<bdes_PlatformUtil::Int64>::InitialCapacity(8));
        //..
    ...
    bdea_Array(int                       initialLength,
               bdes_PlatformUtil::Int64  initialValue,
               bdema_Allocator          *basicAllocator = 0);
    ...
    bdea_Array(const bdes_PlatformUtil::Int64 *srcArray,
               int                             numElements,
               bdema_Allocator                *basicAllocator = 0);
    ...
    bdea_Array(const bdea_Array<bdes_PlatformUtil::Int64>& original,
               bdema_Allocator                            *basicAllocator = 0);
    ...
    void append(bdes_PlatformUtil::Int64 item);
    ...
    void append(const bdea_Array<bdes_PlatformUtil::Int64>& srcArray);
    ...
    void append(const bdes_PlatformUtil::Int64 *srcArray,
                int                             srcIndex,
                int                             numElements);
        // Append to the end of this array the specified 'numElements' values
        // from the specified 'srcArray', beginning at the specified
    ...
    void insert(int dstIndex, bdes_PlatformUtil::Int64 item);
    ...
    void insert(int                                         dstIndex,
                const bdea_Array<bdes_PlatformUtil::Int64>& srcArray);
    ...
    void insert(int                             dstIndex,
                const bdes_PlatformUtil::Int64 *srcArray,
                int                             srcIndex,
                int                             numElements);
        // Insert into this array, beginning at the specified 'dstIndex', the
        // specified 'numElements' values from the specified 'srcArray',
    ...
    void replace(int dstIndex, bdes_PlatformUtil::Int64 item);
    ...
    void setLength(int newLength, bdes_PlatformUtil::Int64 initialValue);
    ...
    // ACCESSORS
    const bdes_PlatformUtil::Int64& operator[](int index) const;
    ...
    const bdes_PlatformUtil::Int64 *data() const;
        // Return the address of the internal memory representation of the
...
// FREE OPERATORS
inline
int operator==(const bdea_Array<bdes_PlatformUtil::Int64>& lhs,
               const bdea_Array<bdes_PlatformUtil::Int64>& rhs);
...
std::ostream& operator<<(std::ostream&                               stream,
                         const bdea_Array<bdes_PlatformUtil::Int64>& array);
...
inline
bdes_PlatformUtil::Int64 *bdea_Array<bdes_PlatformUtil::Int64>::data()
{
    return (bdes_PlatformUtil::Int64 *)d_array.data();
}

inline
const bdes_PlatformUtil::Int64 *bdea_Array<bdes_PlatformUtil::Int64>::
                                                                   data() const
{
    return (const bdes_PlatformUtil::Int64 *)d_array.data();
}

inline
int bdea_Array<bdes_PlatformUtil::Int64>::length() const
{
    return d_array.length() / sizeof(bdes_PlatformUtil::Int64);
}
...
inline
bdea_Array<bdes_PlatformUtil::Int64>::bdea_Array(
                                               bdema_Allocator *basicAllocator)
: d_array(bdema_CharArray::InitialCapacity(sizeof(bdes_PlatformUtil::Int64)),
          basicAllocator)
{
}
...
inline
bdea_Array<bdes_PlatformUtil::Int64>::bdea_Array(
                                               const Explicit&  initialLength,
                                               bdema_Allocator *basicAllocator)
: d_array(bdema_CharArray::InitialCapacity(
                         initialLength.d_i > 0
                         ? initialLength.d_i * sizeof(bdes_PlatformUtil::Int64)
                         : sizeof(bdes_PlatformUtil::Int64)),
          bdema_CharArray::POWER_OF_2_HINT,
          basicAllocator)
{
    d_array.setLengthRaw(initialLength.d_i * sizeof(bdes_PlatformUtil::Int64));
    std::memset(data(), 0,
                initialLength.d_i * sizeof(bdes_PlatformUtil::Int64));
}
...
: d_array(bdema_CharArray::InitialCapacity(
                             initialLength > 0
                             ? initialLength * sizeof(bdes_PlatformUtil::Int64)
                             : sizeof(bdes_PlatformUtil::Int64)),
          bdema_CharArray::POWER_OF_2_HINT,
          basicAllocator)
{
    d_array.setLengthRaw(initialLength * sizeof(bdes_PlatformUtil::Int64));
    bdeimp_DuffsDevice<bdes_PlatformUtil::Int64>::initialize(data(),
                                                             initialValue,
                                                             initialLength);
}
...
: d_array(bdema_CharArray::InitialCapacity(
                           numElements.d_i > 0
                           ? numElements.d_i * sizeof(bdes_PlatformUtil::Int64)
                           : sizeof(bdes_PlatformUtil::Int64)),
          basicAllocator)
{
...
: d_array(bdema_CharArray::InitialCapacity(
                               numElements > 0
                               ? numElements * sizeof(bdes_PlatformUtil::Int64)
                               : sizeof(bdes_PlatformUtil::Int64)),
          bdema_CharArray::POWER_OF_2_HINT,
          basicAllocator)
{
    d_array.setLengthRaw(numElements * sizeof(bdes_PlatformUtil::Int64));
    std::memcpy(data(), srcArray,
                numElements * sizeof(bdes_PlatformUtil::Int64));
}

inline
bdea_Array<bdes_PlatformUtil::Int64>::bdea_Array(
                   const bdea_Array<bdes_PlatformUtil::Int64>&  original,
                   bdema_Allocator                             *basicAllocator)
: d_array(bdema_CharArray::InitialCapacity(
                         original.length() > 0
                         ? original.length() * sizeof(bdes_PlatformUtil::Int64)
                         : sizeof(bdes_PlatformUtil::Int64)),
          bdema_CharArray::POWER_OF_2_HINT,
          basicAllocator)
{
    d_array.setLengthRaw(original.length() * sizeof(bdes_PlatformUtil::Int64));
...
inline
bdea_Array<bdes_PlatformUtil::Int64>& bdea_Array<bdes_PlatformUtil::Int64>::
                     operator=(const bdea_Array<bdes_PlatformUtil::Int64>& rhs)
{
    d_array = rhs.d_array;
...
inline
bdes_PlatformUtil::Int64& bdea_Array<bdes_PlatformUtil::Int64>::
                                                          operator[](int index)
{
    return data()[index];
}
...
inline
void bdea_Array<bdes_PlatformUtil::Int64>::append(
                                                 bdes_PlatformUtil::Int64 item)
{
    int len = length();
    d_array.setLengthRaw(d_array.length() + sizeof(bdes_PlatformUtil::Int64));
    data()[len] = item;
}
...
inline
void bdea_Array<bdes_PlatformUtil::Int64>::
                append(const bdea_Array<bdes_PlatformUtil::Int64>& srcArray,
                       int                                         srcIndex,
                       int                                         numElements)
{
    d_array.append(srcArray.d_array,
                   srcIndex * sizeof(bdes_PlatformUtil::Int64),
                   numElements * sizeof(bdes_PlatformUtil::Int64));
}
...
inline
void bdea_Array<bdes_PlatformUtil::Int64>::
                            insert(int dstIndex, bdes_PlatformUtil::Int64 item)
{
    d_array.insert(dstIndex * sizeof(bdes_PlatformUtil::Int64),
                   (const char *)&item, 0, sizeof(bdes_PlatformUtil::Int64));
}

inline
void bdea_Array<bdes_PlatformUtil::Int64>::
     insert(int dstIndex, const bdea_Array<bdes_PlatformUtil::Int64>& srcArray)
{
    d_array.insert(dstIndex * sizeof(bdes_PlatformUtil::Int64),
                   srcArray.d_array);
}
...
inline
void bdea_Array<bdes_PlatformUtil::Int64>::insert(
                          int                                         dstIndex,
                          const bdea_Array<bdes_PlatformUtil::Int64>& srcArray,
                          int                    srcIndex,
                          int                    numElements)
...
inline
void bdea_Array<bdes_PlatformUtil::Int64>::remove(int index)
{
    d_array.remove(index * sizeof(bdes_PlatformUtil::Int64),
                   sizeof(bdes_PlatformUtil::Int64));
}

inline
void bdea_Array<bdes_PlatformUtil::Int64>::remove(int index, int numElements)
{
    d_array.remove(index * sizeof(bdes_PlatformUtil::Int64),
                   numElements * sizeof(bdes_PlatformUtil::Int64));
}
...
inline
void bdea_Array<bdes_PlatformUtil::Int64>::removeAll()
{
    d_array.removeAll();
}
...
inline
void bdea_Array<bdes_PlatformUtil::Int64>::
                           replace(int dstIndex, bdes_PlatformUtil::Int64 item)
{
    data()[dstIndex] = item;
}

inline
void bdea_Array<bdes_PlatformUtil::Int64>::replace(
                       int                                         dstIndex,
                       const bdea_Array<bdes_PlatformUtil::Int64>& srcArray,
                       int                                         srcIndex,
                       int                                         numElements)
{
    d_array.replace(dstIndex * sizeof(bdes_PlatformUtil::Int64),
                    srcArray.d_array,
                    srcIndex * sizeof(bdes_PlatformUtil::Int64),
                    numElements * sizeof(bdes_PlatformUtil::Int64));
}

inline void bdea_Array<bdes_PlatformUtil::Int64>::
                                               reserveCapacity(int numElements)
{
    d_array.reserveCapacity(numElements * sizeof(bdes_PlatformUtil::Int64));
}

inline
void bdea_Array<bdes_PlatformUtil::Int64>::reserveCapacityRaw(int numElements)
{
    d_array.reserveCapacityRaw(numElements * sizeof(bdes_PlatformUtil::Int64));
}

inline
void bdea_Array<bdes_PlatformUtil::Int64>::setLengthRaw(int newLength)
{
    d_array.setLengthRaw(newLength * sizeof(bdes_PlatformUtil::Int64));
}

inline
void bdea_Array<bdes_PlatformUtil::Int64>::setLength(int newLength)
{
    d_array.setLength(newLength * sizeof(bdes_PlatformUtil::Int64));
}

inline
void bdea_Array<bdes_PlatformUtil::Int64>::
                setLength(int newLength, bdes_PlatformUtil::Int64 initialValue)
{
    int len = length();
    d_array.setLengthRaw(newLength * sizeof(bdes_PlatformUtil::Int64));
    if (newLength > len) {
        bdeimp_DuffsDevice<bdes_PlatformUtil::Int64>::initialize(
                                                              data() + len,
                                                              initialValue,
                                                              newLength - len);
    }
...
inline
void bdea_Array<bdes_PlatformUtil::Int64>::swap(int index1, int index2)
{
    bdes_PlatformUtil::Int64 *array_p = data();
    bdes_PlatformUtil::Int64 tmp = array_p[index1];
...
template <class STREAM>
inline
STREAM& bdea_Array<bdes_PlatformUtil::Int64>::
    ...
    if (stream) {
        switch (version) {  // Switch on the schema version (starting with 1).
          case 1: {
            ...
            stream.getArrayInt64(data(), newLength);
...
inline
STREAM& bdea_Array<bdes_PlatformUtil::Int64>::
                                       streamInRaw(STREAM& stream, int version)
{
...
inline
STREAM& bdea_Array<bdes_PlatformUtil::Int64>::
                                streamOutRaw(STREAM& stream, int version) const
{
