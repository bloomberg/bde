...
#define INCLUDED_BDEA_ARRAY_DATE

//@PURPOSE: Provide an in-place array of 'bdet_Date' values.
//
//@DEPRECATED: This component is being replaced with 'std::vector'.
//
//@CLASSES:
//   bdea_Array<bdet_Date>: memory manager for in-place array of 'bdet_Date'
//
//@AUTHOR: Paul Staniforth (pstaniforth)
//
//@SEE_ALSO: bdea_array2_date
//
//@DESCRIPTION: This component implements an in-place array of 'bdet_Date'
...
// 'bdea_array2_date' if the memory address of each contained element must
...
// First create an empty 'bdea_Array<bdet_Date>' 'a' and populate it with two
// elements 'E1' and 'E2':
//..
//
...
//
//      bdea_Array<bdet_Date> a;        assert( 0 == a.length());
//
...
template <class T> class bdea_Array;
                     ...
                     // ===========================
                     // class bdea_Array<bdet_Date>
                     // ===========================

template <>
class bdea_Array<bdet_Date> {
    // This class implements an efficient, in-place array of 'bdet_Date' values
    ...
    friend int operator==(const bdea_Array<bdet_Date>& lhs,
                          const bdea_Array<bdet_Date>& rhs);
  ...
  public:
    ...
    struct InitialCapacity { int d_i; ~InitialCapacity() { }
        ...
        //..
        //  bdea_Array<bdet_Date> x(bdea_Array<bdet_Date>::InitialCapacity(8));
        //..
    ...
    bdea_Array(int              initialLength,
        ...
        // value using the default constructor of 'bdet_Date' if 'initialValue'
    ...
    bdea_Array(const bdet_Date *srcArray,
               int              numElements,
               bdema_Allocator *basicAllocator = 0);
    ...
    bdea_Array(const bdea_Array<bdet_Date>&  original,
               bdema_Allocator              *basicAllocator = 0);
    ...
    // MANIPULATORS
    bdea_Array<bdet_Date>& operator=(const bdea_Array<bdet_Date>& rhs);
    ...
    void append(const bdet_Date& item);
    ...
    void append(const bdea_Array<bdet_Date>& srcArray);
    ...
    void append(const bdet_Date *srcArray,
                int              srcIndex,
                int              numElements);
        // Append to the end of this array the specified 'numElements' values
        // from the specified 'srcArray', beginning at the specified
    ...
    void insert(int dstIndex, const bdet_Date& item);
    ...
    void insert(int dstIndex, const bdea_Array<bdet_Date>& srcArray);
    ...
    void insert(int                          dstIndex,
                const bdea_Array<bdet_Date>& srcArray,
                int                          srcIndex,
                int                          numElements);
    ...
    void replace(int dstIndex, const bdet_Date& item);
    ...
    void setLength(int newLength, const bdet_Date& initialValue);
        ...
        // constructor of 'bdet_Date' if 'initialValue' is not specified.  The
...
// FREE OPERATORS
inline
int operator==(const bdea_Array<bdet_Date>& lhs,
               const bdea_Array<bdet_Date>& rhs);
...
std::ostream& operator<<(std::ostream&                stream,
                         const bdea_Array<bdet_Date>& array);
...
inline
bdet_Date *bdea_Array<bdet_Date>::data()
{
    return (bdet_Date *)d_array.data();
}

inline
const bdet_Date *bdea_Array<bdet_Date>::data() const
{
    return (const bdet_Date *)d_array.data();
}

inline
int bdea_Array<bdet_Date>::length() const
{
    return d_array.length() / sizeof(bdet_Date);
}
...
inline
bdea_Array<bdet_Date>::bdea_Array(bdema_Allocator *basicAllocator)
: d_array(bdema_CharArray::InitialCapacity(sizeof(bdet_Date)), basicAllocator)
{
}

inline
bdea_Array<bdet_Date>::bdea_Array(const Explicit&  initialLength,
                                  bdema_Allocator *basicAllocator)
: d_array(bdema_CharArray::InitialCapacity(
                                        initialLength.d_i > 0
                                        ? initialLength.d_i * sizeof(bdet_Date)
                                        : sizeof(bdet_Date)),
          bdema_CharArray::POWER_OF_2_HINT,
          basicAllocator)
{
    d_array.setLengthRaw(initialLength.d_i * sizeof(bdet_Date));
    bdeimp_DuffsDevice<bdet_Date>::initialize(data(),
                                              bdet_Date(),
                                              initialLength.d_i);
}

inline
bdea_Array<bdet_Date>::bdea_Array(int               initialLength,
                                  const bdet_Date&  initialValue,
                                  bdema_Allocator  *basicAllocator)
: d_array(bdema_CharArray::InitialCapacity(initialLength > 0
                                           ? initialLength * sizeof(bdet_Date)
                                           : sizeof(bdet_Date)),
          bdema_CharArray::POWER_OF_2_HINT,
          basicAllocator)
{
    d_array.setLengthRaw(initialLength * sizeof(bdet_Date));
    bdeimp_DuffsDevice<bdet_Date>::initialize(data(),
                                              initialValue,
                                              initialLength);
}
...
inline
bdea_Array<bdet_Date>::bdea_Array(const InitialCapacity&  numElements,
                                  bdema_Allocator        *basicAllocator)
: d_array(bdema_CharArray::InitialCapacity(numElements.d_i > 0
                                          ? numElements.d_i * sizeof(bdet_Date)
                                          : sizeof(bdet_Date)),
          basicAllocator)
{
...
inline
bdea_Array<bdet_Date>::bdea_Array(const bdet_Date *srcArray,
                                  int              numElements,
                                  bdema_Allocator *basicAllocator)
: d_array(bdema_CharArray::InitialCapacity(numElements > 0
                                           ? numElements * sizeof(bdet_Date)
                                           : sizeof(bdet_Date)),
          bdema_CharArray::POWER_OF_2_HINT,
          basicAllocator)
{
    d_array.setLengthRaw(numElements * sizeof(bdet_Date));
    std::memcpy(data(), srcArray, numElements * sizeof(bdet_Date));
}

inline
bdea_Array<bdet_Date>::bdea_Array(const bdea_Array<bdet_Date>&  original,
                                  bdema_Allocator              *basicAllocator)
: d_array(bdema_CharArray::InitialCapacity(
                                        original.length() > 0
                                        ? original.length() * sizeof(bdet_Date)
                                        : sizeof(bdet_Date)),
          bdema_CharArray::POWER_OF_2_HINT,
          basicAllocator)
{
    d_array.setLengthRaw(original.length() * sizeof(bdet_Date));
    std::memcpy(data(),
                original.data(), original.length() * sizeof(bdet_Date));
}

inline
bdea_Array<bdet_Date>::~bdea_Array()
{
}
...
inline
bdea_Array<bdet_Date>& bdea_Array<bdet_Date>::
                                    operator=(const bdea_Array<bdet_Date>& rhs)
{
    d_array = rhs.d_array;
...
inline
bdet_Date& bdea_Array<bdet_Date>::operator[](int index)
{
    return data()[index];
}

inline
void bdea_Array<bdet_Date>::append(const bdet_Date& item)
{
    const bdet_Date itemTmp = item;  // guard against alias
    int len = length();
    d_array.setLengthRaw(d_array.length() + sizeof(bdet_Date));
    data()[len] = itemTmp;
}

inline
void bdea_Array<bdet_Date>::append(const bdea_Array<bdet_Date>& srcArray)
{
...
{
    d_array.append(srcArray.d_array,
                   srcIndex * sizeof(bdet_Date),
                   numElements * sizeof(bdet_Date));
}

inline
void bdea_Array<bdet_Date>::
               append(const bdet_Date *srcArray, int srcIndex, int numElements)
{
...
inline
void bdea_Array<bdet_Date>::insert(int dstIndex, const bdet_Date& item)
{
    d_array.insert(dstIndex * sizeof(bdet_Date),
                   (const char *)&item,
                   0,
                   sizeof(bdet_Date));
}
...
inline
void bdea_Array<bdet_Date>::
                    insert(int dstIndex, const bdea_Array<bdet_Date>& srcArray)
{
    d_array.insert(dstIndex * sizeof(bdet_Date), srcArray.d_array);
}

inline
void bdea_Array<bdet_Date>::insert(int                          dstIndex,
                                   const bdea_Array<bdet_Date>& srcArray,
                                   int                          srcIndex,
                                   int                          numElements)
{
...
inline
void bdea_Array<bdet_Date>::remove(int index)
{
    d_array.remove(index * sizeof(bdet_Date), sizeof(bdet_Date));
}

inline
void bdea_Array<bdet_Date>::remove(int index, int numElements)
{
    d_array.remove(index * sizeof(bdet_Date), numElements * sizeof(bdet_Date));
}

inline
void bdea_Array<bdet_Date>::removeAll()
{
    d_array.removeAll();
}

inline
void bdea_Array<bdet_Date>::replace(int dstIndex, const bdet_Date& item)
{
    data()[dstIndex] = item;
}

inline
void bdea_Array<bdet_Date>::replace(int                          dstIndex,
                                    const bdea_Array<bdet_Date>& srcArray,
                                    int                          srcIndex,
                                    int                          numElements)
{
    d_array.replace(dstIndex * sizeof(bdet_Date),
                    srcArray.d_array,
                    srcIndex * sizeof(bdet_Date),
                    numElements * sizeof(bdet_Date));
}

inline void bdea_Array<bdet_Date>::reserveCapacity(int numElements)
{
    d_array.reserveCapacity(numElements * sizeof(bdet_Date));
}

inline
void bdea_Array<bdet_Date>::reserveCapacityRaw(int numElements)
{
    d_array.reserveCapacityRaw(numElements * sizeof(bdet_Date));
}

inline
void bdea_Array<bdet_Date>::setLengthRaw(int newLength)
{
    d_array.setLengthRaw(newLength * sizeof(bdet_Date));
}

inline
void bdea_Array<bdet_Date>::setLength(int newLength)
{
    int len = length();
    d_array.setLengthRaw(newLength * sizeof(bdet_Date));
    if (newLength > len) {
        bdeimp_DuffsDevice<bdet_Date>::initialize(data() + len,
                                                  bdet_Date(),
                                                  newLength - len);
    }
}
                                      ...
                                      const bdet_Date& initialValue)
{
    ...
    d_array.setLengthRaw(newLength * sizeof(bdet_Date));
    if (newLength > len) {
        const bdet_Date initialValueTmp = initialValue;  // may be alias
        bdeimp_DuffsDevice<bdet_Date>::initialize(data() + len,
                                                  initialValueTmp,
                                                  newLength - len);
    }
...
inline
void bdea_Array<bdet_Date>::swap(int index1, int index2)
{
    bdet_Date *array_p = data();
    bdet_Date tmp = array_p[index1];
...
template <class STREAM>
inline
STREAM& bdea_Array<bdet_Date>::bdexStreamIn(STREAM& stream, int version)
{
    if (stream) {
...
template <class STREAM>
inline
STREAM& bdea_Array<bdet_Date>::streamInRaw(STREAM& stream, int version)
{
...
inline
const bdet_Date& bdea_Array<bdet_Date>::operator[](int index) const
{
    return data()[index];
}
...
template <class STREAM>
inline
STREAM& bdea_Array<bdet_Date>::bdexStreamOut(STREAM& stream, int version) const
{
    switch (version) {
      case 1: {
        int len = length();
...
template <class STREAM>
inline
STREAM& bdea_Array<bdet_Date>::streamOutRaw(STREAM& stream, int version) const
{
