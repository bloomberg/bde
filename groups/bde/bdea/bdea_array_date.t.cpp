...
// [11] bdea_Array(int iLen, const bdet_Date& iVal, *ba = 0);
// [17] bdea_Array(const InitialCapacity& ne, *ba = 0);
// [ 7] bdea_Array(const bdea_Array<bdet_Date>& original, *ba = 0);
// [ 2] ~bdea_Array();
// [ 9] bdea_Array<bdet_Date>& operator=(const bdea_Array<bdet_Date>& rhs);
// [14] bdet_Date& operator[](int index);
// [13] void append(const bdet_Date& item);
// [13] void append(const bdea_Array<bdet_Date>& sa);
// [13] void append(const bdea_Array<bdet_Date>& sa, int si, int ne);
// [13] void append(const bdet_Date *sa, int si, int ne);
// [18] bdet_Date *data();
// [13] void insert(int di, const bdet_Date& item);
// [13] void insert(int di, const bdea_Array<bdet_Date>& sa);
// [13] void insert(int di, const bdea_Array<bdet_Date>& sa, int si, int ne);
// [13] void insert(int di, const bdet_Date *sa, int si, int ne);
// [13] void remove(int index);
// [13] void remove(int index, int ne);
// [ 2] void removeAll();
// [14] void replace(int di, const bdet_Date& item);
// [14] void replace(int di, const bdea_Array<bdet_Date>& sa, int si, int ne);
...
// [12] void setLength(int newLength, const bdet_Date& iVal);
...
// [ 4] const bdet_Date& operator[](int index) const;
// [18] const bdet_Date *data() const;
// [ 4] int length() const;
...
//
// [ 6] operator==(const bdea_Array<bdet_Date>&, const bdea_Array<bdet_Date>&);
// [ 6] operator!=(const bdea_Array<bdet_Date>&, const bdea_Array<bdet_Date>&);
// [ 5] operator<<(ostream&, const bdea_Array<bdet_Date>&);
// [10] operator>>(bdex_InStream&, bdea_Array<bdet_Date>&);
// [10] operator<<(bdex_OutStream&, const bdea_Array<bdet_Date>&);
//-----------------------------------------------------------------------------
// [ 1] BREATHING TEST
// [19] USAGE EXAMPLE
// [ 2] BOOTSTRAP: void append(const bdet_Date& item); // no aliasing
...
// [ 3] int ggg(bdea_Array<bdet_Date> *object, const char *spec, int vF = 1);
// [ 3] bdea_Array<bdet_Date>& gg(bdea_Array<bdet_Date>* object,
//                                const char *spec);
// [ 8] bdea_Array<bdet_Date>   g(const char *spec);
...
#define BEGIN_BDEMA_EXCEPTION_TEST {                                       \
    {                                                                      \
        static int firstDate = 1;                                          \
        if (veryVerbose && firstDate) cout <<                              \
...
typedef bdea_Array<bdet_Date> Obj;
typedef bdet_Date Element;

// Avoid DEFAULT Value.
const Element VALUES[] = { Element(2001, 5, 20),
                           Element(2002, 7, 21),
                           Element(2003, 4, 22),
                           Element(2004, 8, 23),
                           Element(2005, 12, 24),
...
// letters [A .. E] correspond to arbitrary (but unique) bdet_Date values to be
// appended to the 'bdea_Array<bdet_Date>' object.  A tilde ('~') indicates
...
int ggg(bdea_Array<bdet_Date> *object, const char *spec, int verboseFlag = 1)
...
bdea_Array<bdet_Date>& gg(bdea_Array<bdet_Date> *object, const char *spec)
...
bdea_Array<bdet_Date> g(const char *spec)
    // Return, by value, a new object corresponding to the specified 'spec'.
{
    bdea_Array<bdet_Date> object((bdema_Allocator *)0);
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      case 19: {
        ...
        const bdet_Date E1(2001, 3, 1);
        const bdet_Date E2(2002, 10, 3);

        bdea_Array<bdet_Date> a(&testAllocator);
                                        ASSERT( 0 == a.length());
        ...
        const bdet_Date E3(2003, 12, 7);

        a[0] = E3;                      ASSERT( 2 == a.length());
                                        ASSERT(E3 == a[0]);
                                        ASSERT(E2 == a[1]);

        const bdet_Date E4(2004, 1, 1);
...
//      ostrstream out(buf, sizeof buf);     *** MISMATCH caused by EPC bug ***
      ...
      case 18: {
        ...
        //
        // Plan:
        //   For each object X in a set of 'bdea_Array<bdet_Date>' objects
...
#undef  NL
      ...
      case 14: {
        ...
        // Testing:
        //   void replace(int di, bdet_Date item);
        //   void replace(int di,const bdea_Array<bdet_Date>& s,int si,int ne);
        //   bdet_Date& operator[](int index);
        // --------------------------------------------------------------------
      ...
      case 13: {
        ...
        //
        // Testing:
        //   void append(bdet_Date item);
        //   void append(const bdea_Array<bdet_Date>& sa);
        //   void append(const bdea_Array<bdet_Date>& sa, int si, int ne);
        //   void append(const bdet_Date *sa, int si, int ne);
        //
        //   void insert(int di, bdet_Date item);
        //   void insert(int di, const bdea_Array<bdet_Date>& sa);
        //   void insert(int di,const bdea_Array<bdet_Date>& sa,int si,int ne);
        //   void insert(int di, const bdet_Date *sa, int si, int ne);
        //
      ...
      case 12: {
        ...
        //   void setLength(int newLength, bdet_Date iVal);
        // --------------------------------------------------------------------
        ...
        if (verbose) cout << "\nTesting 'setLength(int)'" << endl;
        {
            const int lengths[] = { 0, 1, 2, 3, 4, 5, 7, 8, 9, 15, 16, 17 };
            const int NUM_TESTS = sizeof lengths / sizeof lengths[0];
            const Element I_VALUE(2001, 2, 1);
        ...
        if (verbose) cout << "\nTesting 'setLength(int, bdet_Date)'" << endl;
        {
            const int lengths[] = { 0, 1, 2, 3, 4, 5, 7, 8, 9, 15, 16, 17 };
            const int NUM_TESTS = sizeof lengths / sizeof lengths[0];
            const Element I_VALUE(2001, 2, 1);
            const Element F_VALUE(2002, 4, 0);
            for (int i = 0; i < NUM_TESTS; ++i) {
                const int a1 = lengths[i];
                if (verbose) { cout << "\t"; P(a1); }
                for (int j = 0; j < NUM_TESTS; ++j) {
      ...
      case 11: {
        ...
        //   bdea_Array(int iLen, bdet_Date iVal, *ba = 0);
        //   bdea_Array(const bdet_Date *sa, int ne, *ba = 0);
        // --------------------------------------------------------------------
        ...
        {
            const Element DA[] =
                { Element(1600, 1, 1),    Element(1752, 9, 14),
                  Element(1999, 12, 28),  Element(2000, 1, 1),
                  Element(1987, 11, 7),   Element(1944, 6, 6),
                  Element(2002, 12, 31),  Element(9999, 12, 31),
                  Element(1996, 2, 28),   Element(2004, 10, 31) }; // ADJUST
      ...
      case 10: {
        ...
        //   operator>>(bdex_InStream&, bdea_Array<bdet_Date>&);
        //   operator<<(bdex_OutStream&, const bdea_Array<bdet_Date>&);
        // --------------------------------------------------------------------
        ...
        if (verbose) cout << "\nWire format direct tests." << endl;
        {
            static const struct {
                ...
                { L_,   "",              1,   1, "\x00"                     },
                { L_,   "A",             1,   4, "\x01\x0b\x26\x03"         },
                { L_,   "AB",            1,   7,
                                             "\x02\x0b\x26\x03\x0b\x27\xae" },
                { L_,   "ABC",           1,  10,
                                 "\x03\x0b\x26\x03\x0b\x27\xae\x0b\x28\xc1" },
                { L_,   "ABCD",          1,  13,
                     "\x04\x0b\x26\x03\x0b\x27\xae\x0b\x28\xc1\x0b\x2a\xaa" },
                { L_,   "ABCDE",         1,  16,
         "\x05\x0b\x26\x03\x0b\x27\xae\x0b\x28\xc1\x0b\x2a\xaa\x0b\x2c\x92" },
            };
            const int NUM_DATA = sizeof DATA / sizeof *DATA;
      ...
      case 9: {
        ...
        //
        // Testing:
        //   bdea_Array<bdet_Date>& operator=(const bdea_Array<bdet_Date>& r);
        // --------------------------------------------------------------------
      ...
      case 7: {
        ...
        //
        // Testing:
        //   bdea_Array(const bdea_Array<bdet_Date>& original, *ba = 0);
        // --------------------------------------------------------------------
      ...
      case 6: {
        ...
        //
        // Testing:
        //   operator==(const bdea_Array<bdet_Date>&,
        //              const bdea_Array<bdet_Date>&);
        //   operator!=(const bdea_Array<bdet_Date>&,
        //              const bdea_Array<bdet_Date>&);
        // --------------------------------------------------------------------
      ...
      case 5: {
        ...
        //
        // Testing:
        //   operator<<(ostream&, const bdea_Array<bdet_Date>&);
        // --------------------------------------------------------------------
      ...
      case 3: {
        ...
        //
        // Testing:
        //   bdea_Array<bdet_Date>& gg(bdea_Array<bdet_Date> *object,
        //                             const char            *spec);
        //   int ggg(bdea_Array<bdet_Date> *object,
        //           const char            *spec,
        //           int                    vF = 1);
        //   void stretch(Obj *object, int size);
        //   void stretchRemoveAll(Obj *object, int size);
      ...
      case 2: {
        ...
        //   ~bdea_Array();
        //   BOOTSTRAP: void append(bdet_Date item); // no aliasing
        //   void removeAll();
        // --------------------------------------------------------------------
