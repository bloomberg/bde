...
enum {
    C0 = 1 + bdemf_MetaInt<0>::VALUE,  // 1
    C1 = 1 + bdemf_MetaInt<1>::VALUE,  // 2
    C2 = 1 + bdemf_MetaInt<2>::VALUE   // 3
};
...
{
    bdemf_MetaInt<V> i;
    bsl::cout << i.VALUE << bsl::endl;
    bsl::cout << bdemf_MetaInt<V>::VALUE << bsl::endl;
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 1: {
        // --------------------------------------------------------------------
        // Test Plan:
        //   Instantiate 'bdemf_MetaValue' with various constant integral
        //   values and verify that their 'VALUE' member is initialized
        //   properly.
        // --------------------------------------------------------------------

        if (verbose) cout << endl
                          << "bdemf_MetaValue" << endl
                          << "==============" << endl;
        ...
        bdemf_MetaInt<0> i0; ASSERT(0 == i0.VALUE);
        bdemf_MetaInt<1> i1; ASSERT(1 == i1.VALUE);
        bdemf_MetaInt<2> i2; ASSERT(2 == i2.VALUE);

        ASSERT(-5 == bdemf_MetaInt<(unsigned)-5>::VALUE);
      } break;
      default: {
