      ...
      case 5: {
...

        {
            ...
            static const struct {
                ...
                { L_,   "0.125",             5,    0,  0.125  },
                { L_,  "-0.125",             6,    0, -0.125  },
                { L_,   "0.0625",            6,    0,  0.0625 },
                { L_,  "-0.0625",            7,    0, -0.0625 },
                { L_,   "0.3125",            6,    0,  0.3125 },
                { L_,  "-0.3125",            7,    0, -0.3125 },
      ...
      case 4: {
...

        {
            ...
            static const struct {
                ...
                { L_,   "1e308",             5,    0, 1.0e308 },
                { L_,   "1.7e308",           7,    0, 1.7e308 },
                { L_,   "1.8e308",           7,    1,         },
                { L_,   "-1e308",            6,    0, -1.0e308 },
                { L_,   "-1.7e308",          8,    0, -1.7e308 },
                { L_,   "-1.8e308",          8,    1,         },

                // Stress tests for converting decimal to 64-bit double.
                { L_,   "5e125",             5,    0, 5.0e125 },
                { L_,   "6.9e268",           7,    0, 6.9e268 },
                { L_,   "9.99e-24",          8,    0,
                                                     9.99e-24 },
                { L_,   "7.861e-31",         9,    0,
                                                    7.861e-31 },
                ...
                { L_,   "2.7235667517e-99", 16,    0,
                                             2.7235667517e-99 },
                { L_,   "6.53532977297e-112",
                                             18,    0,
                                           6.53532977297e-112 },
                { L_,   "3.142213164987e-282",
                                             19,    0,
                                          3.142213164987e-282 },
                { L_,   "4.6202199371337e-59",
                                             19,    0,
                                          4.6202199371337e-59 },
                { L_,   "2.31010996856685e-59",
                                             20,    0,
                                         2.31010996856685e-59 },
                { L_,   "9.324754620109615e227",
                                             21,    0,
                                        9.324754620109615e227 },
                { L_,   "7.8459735791271921e65",
                                             21,    0,
                                        7.8459735791271921e65 },
                { L_,   "2.72104041512242479e217",
                                             23,    0,
                                      2.72104041512242479e217 },
                { L_,   "6.802601037806061975e216",
                                             24,    0,
                                     6.802601037806061975e216 },
                { L_,   "2.0505426358836677347e-202",
                                             26,    0,
                                   2.0505426358836677347e-202 },
                { L_,   "8.36168422905420598437e-214",
                                             27,    0,
                                  8.36168422905420598437e-214 },
                { L_,   "4.891559871276714924261e243",
                                             27,    0,
