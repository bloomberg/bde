...
class bdem_BerEncoderOptions {
  ...
  public:
    ...
    enum {
      ...
      , ATTRIBUTE_ID_ENCODE_EMPTY_VECTOR     = 2
    };
    ...
    enum {
      ...
      , ATTRIBUTE_INDEX_ENCODE_EMPTY_VECTOR     = 2
    };
    ...
    static const bool DEFAULT_INITIALIZER_ENCODE_EMPTY_VECTOR;
...
// GENERATED BY BLP_BAS_CODEGEN_3.6.9 Thu Jan 19 14:48:12 2012
// ----------------------------------------------------------------------------
// NOTICE:
