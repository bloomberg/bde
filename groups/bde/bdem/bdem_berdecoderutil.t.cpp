...
#include <bdem_berencoderutil.h>        // for testing only
...
typedef bdem_BerDecoderUtil Obj;
typedef bdem_BerEncoderUtil Encoder;
...
//      </xs:complexType>
//
//      <xs:complexType name="basicRecord2">
//          <xs:annotation>
//              <xs:documentation>
//                  A representative small record type without date/time
//              </xs:documentation>
//          </xs:annotation>
//          <xs:sequence>
//              <xs:element name="i1" type="xs:int"/>
...
//      </xs:complexType>
//
//      <xs:complexType name="bigRecord2">
//          <xs:annotation>
//              <xs:documentation>
//                  A bigger record containing an array of smaller records
//                  without date/time
...
//          <xs:sequence>
//              <xs:element name="name" type="xs:string" minOccur="0"/>
//              <xs:element name="array" type="basicRecord2"
//                          minOccurs="0" maxOccurs="unbounded"/>
//          </xs:sequence>
//      </xs:complexType>
//
...
//              <xs:element name="big2" type="bigRecord2"/>
//          </xs:choice>
//      </xs:complexType>
//
...
// test::BasicRecord2: TODO: Provide purpose
...
// test::BigRecord2: TODO: Provide purpose
...
namespace test { class BasicRecord2; }
...
namespace test { class BigRecord2; }
...
class BasicRecord2 {
  ...
  public:
    // CONSTANTS
    static const char CLASS_NAME[];
        // the name of this class (i.e., "BasicRecord2")
  ...
  public:
    ...
    // CREATORS
    explicit BasicRecord2(bslma_Allocator *basicAllocator = 0);
        // Create an object of type 'BasicRecord2' having the default value.
        // Use the optionally specified 'basicAllocator' to supply memory.  If
        // 'basicAllocator' is 0, the currently installed default allocator is
        // used.

    BasicRecord2(const BasicRecord2& original,
                 bslma_Allocator *basicAllocator = 0);
        // Create an object of type 'BasicRecord2' having the value of the
        // specified 'original' object.  Use the optionally specified
        // 'basicAllocator' to supply memory.  If 'basicAllocator' is 0, the
        // currently installed default allocator is used.
    ...
    // MANIPULATORS
    BasicRecord2& operator=(const BasicRecord2& rhs);
        // Assign to this object the value of the specified 'rhs' object.
...
// FREE OPERATORS
inline
bool operator==(const BasicRecord2& lhs, const BasicRecord2& rhs);
    // Return 'true' if the specified 'lhs' and 'rhs' attribute objects have
    // the same value, and 'false' otherwise.  Two attribute objects have the
    // same value if each respective attribute has the same value.
...
inline
bsl::ostream& operator<<(bsl::ostream& stream, const BasicRecord2& rhs);
    // Format the specified 'rhs' to the specified output 'stream' and
    // return a reference to the modifiable 'stream'.
...
BDEAT_DECL_SEQUENCE_WITH_ALLOCATOR_TRAITS(test::BasicRecord2)
...
class BigRecord2 {
    // A bigger record containing an array of smaller records without date/time

  private:
    bsl::string                d_name;
    bsl::vector<BasicRecord2>  d_array;
  ...
  public:
    // CONSTANTS
    static const char CLASS_NAME[];
        // the name of this class (i.e., "BigRecord2")
  ...
  public:
    ...
    // CREATORS
    explicit BigRecord2(bslma_Allocator *basicAllocator = 0);
        // Create an object of type 'BigRecord2' having the default value.  Use
        // the optionally specified 'basicAllocator' to supply memory.  If
        // 'basicAllocator' is 0, the currently installed default allocator is
        // used.

    BigRecord2(const BigRecord2& original,
               bslma_Allocator *basicAllocator = 0);
        // Create an object of type 'BigRecord2' having the value of the
        // specified 'original' object.  Use the optionally specified
        // 'basicAllocator' to supply memory.  If 'basicAllocator' is 0, the
        // currently installed default allocator is used.
    ...
    // MANIPULATORS
    BigRecord2& operator=(const BigRecord2& rhs);
        // Assign to this object the value of the specified 'rhs' object.
    ...
    const bsl::vector<BasicRecord2>& array() const;
...
// FREE OPERATORS
inline
bool operator==(const BigRecord2& lhs, const BigRecord2& rhs);
    // Return 'true' if the specified 'lhs' and 'rhs' attribute objects have
    // the same value, and 'false' otherwise.  Two attribute objects have the
    // same value if each respective attribute has the same value.
...
inline
bsl::ostream& operator<<(bsl::ostream& stream, const BigRecord2& rhs);
    // Format the specified 'rhs' to the specified output 'stream' and
    // return a reference to the modifiable 'stream'.
...
BDEAT_DECL_SEQUENCE_WITH_ALLOCATOR_TRAITS(test::BigRecord2)
...
class TimingRequest {
  ...
  private:
    union {
        ...
        bsls_ObjectBuffer< BigRecord2 >  d_big2;
    };
  ...
  public:
    // TYPES
    enum {
        NUM_SELECTIONS = 4 // the number of selections in this class
    };
    ...
    enum {
        ...
        SELECTION_INDEX_BIG2 = 3
            // index for "Big2" selection
    };
  ...
  public:
    ...
    BigRecord2& makeBig2();
    BigRecord2& makeBig2(const BigRecord2& value);
        // Set the value of this object to be a "Big2" value.  Optionally
        // specify the 'value' of the "Big2".  If 'value' is not specified, the
        // default "Big2" value is used.
    ...
    BigRecord2& big2();
        // Return a reference to the modifiable "Big2" selection of this object
        // if "Big2" is the current selection.  The behavior is undefined
        // unless "Big2" is the selection of this object.
    ...
    const BigRecord2& big2() const;
        // Return a reference to the non-modifiable "Big2" selection of this
        // object if "Big2" is the current selection.  The behavior is
        // undefined unless "Big2" is the selection of this object.
    ...
    bool isBig2Value() const;
        // Return 'true' if the value of this object is a "Big2" value, and
        // return 'false' otherwise.
...
// CLASS METHODS
inline
int BasicRecord2::maxSupportedBdexVersion()
{
    return 1;  // versions start at 1.
}
...
// CREATORS
inline
BasicRecord2::BasicRecord2(bslma_Allocator *basicAllocator)
: d_i1()
, d_i2()
, d_s(basicAllocator)
{
...
inline
BasicRecord2::BasicRecord2(
        const BasicRecord2& original,
        bslma_Allocator *basicAllocator)
: d_i1(original.d_i1)
, d_i2(original.d_i2)
...
template <class STREAM>
inline
STREAM& BasicRecord2::bdexStreamIn(STREAM& stream, int version)
{
    if (stream) {
        switch (version) {  // Switch on the schema version (starting with 1).
          case 1: {
...
template <class MANIPULATOR>
inline
int BasicRecord2::manipulateAttributes(MANIPULATOR& manipulator)
{
    int ret;
...
template <class MANIPULATOR>
inline
int BasicRecord2::manipulateAttribute(MANIPULATOR& manipulator, int id)
{
    enum { NOT_FOUND = -1 };
...
template <class MANIPULATOR>
inline
int BasicRecord2::manipulateAttribute(
        MANIPULATOR&  manipulator,
        const char   *name,
        int           nameLength)
{
...
template <class STREAM>
inline
STREAM& BasicRecord2::bdexStreamOut(STREAM& stream, int version) const
{
    switch (version) {
      case 1: {
...
template <class ACCESSOR>
inline
int BasicRecord2::accessAttributes(ACCESSOR& accessor) const
{
    int ret;
...
template <class ACCESSOR>
inline
int BasicRecord2::accessAttribute(ACCESSOR& accessor, int id) const
{
    enum { NOT_FOUND = -1 };
...
template <class ACCESSOR>
inline
int BasicRecord2::accessAttribute(
        ACCESSOR&   accessor,
        const char *name,
        int         nameLength) const
{
...
inline
const int& BasicRecord2::i1() const
{
    return d_i1;
}

inline
const int& BasicRecord2::i2() const
{
    return d_i2;
}

inline
const bsl::string& BasicRecord2::s() const
{
    return d_s;
}
...
// CLASS METHODS
inline
int BigRecord2::maxSupportedBdexVersion()
{
    return 1;  // versions start at 1.
}
...
// CREATORS
inline
BigRecord2::BigRecord2(bslma_Allocator *basicAllocator)
: d_name(basicAllocator)
...
inline
BigRecord2::BigRecord2(
        const BigRecord2& original,
        bslma_Allocator *basicAllocator)
: d_name(original.d_name, basicAllocator)
...
template <class STREAM>
inline
STREAM& BigRecord2::bdexStreamIn(STREAM& stream, int version)
{
    if (stream) {
        switch (version) {  // Switch on the schema version (starting with 1).
          case 1: {
...
template <class MANIPULATOR>
inline
int BigRecord2::manipulateAttributes(MANIPULATOR& manipulator)
{
    int ret;
...
template <class MANIPULATOR>
inline
int BigRecord2::manipulateAttribute(MANIPULATOR& manipulator, int id)
{
    enum { NOT_FOUND = -1 };
...
template <class MANIPULATOR>
inline
int BigRecord2::manipulateAttribute(
        MANIPULATOR&  manipulator,
        const char   *name,
        int           nameLength)
{
...
inline
bsl::string& BigRecord2::name()
{
    return d_name;
}

inline
bsl::vector<BasicRecord2>& BigRecord2::array()
{
    return d_array;
}
...
template <class STREAM>
inline
STREAM& BigRecord2::bdexStreamOut(STREAM& stream, int version) const
{
    switch (version) {
      case 1: {
        bdex_OutStreamFunctions::streamOut(stream, d_name, 1);
...
template <class ACCESSOR>
inline
int BigRecord2::accessAttributes(ACCESSOR& accessor) const
{
    int ret;
...
template <class ACCESSOR>
inline
int BigRecord2::accessAttribute(ACCESSOR& accessor, int id) const
{
    enum { NOT_FOUND = -1 };
...
template <class ACCESSOR>
inline
int BigRecord2::accessAttribute(
        ACCESSOR&   accessor,
        const char *name,
        int         nameLength) const
{
...
inline
const bsl::string& BigRecord2::name() const
{
    return d_name;
}

inline
const bsl::vector<BasicRecord2>& BigRecord2::array() const
{
    return d_array;
}
...
, d_allocator_p(bslma_Default::allocator(basicAllocator))
{
    switch (d_selectionId) {
      ...
      case SELECTION_ID_BIG2: {
        new (d_big2.buffer())
            BigRecord2(
                original.d_big2.object(), d_allocator_p);
      } break;
      default:
        BSLS_ASSERT_SAFE(SELECTION_ID_UNDEFINED == d_selectionId);
    }
...
inline
BigRecord2& TimingRequest::makeBig2()
{
    if (SELECTION_ID_BIG2 == d_selectionId) {
        bdeat_ValueTypeFunctions::reset(&d_big2.object());
    }
    else {
        reset();
        new (d_big2.buffer())
                BigRecord2(d_allocator_p);

        d_selectionId = SELECTION_ID_BIG2;
    }

    return d_big2.object();
}

inline
BigRecord2& TimingRequest::makeBig2(const BigRecord2& value)
{
    if (SELECTION_ID_BIG2 == d_selectionId) {
        d_big2.object() = value;
    }
        ...
        reset();
        new (d_big2.buffer())
                BigRecord2(value, d_allocator_p);
        d_selectionId = SELECTION_ID_BIG2;
    }
...
int TimingRequest::manipulateSelection(MANIPULATOR& manipulator)
{
    ...
    switch (d_selectionId) {
      ...
      case TimingRequest::SELECTION_ID_BIG2:
        return manipulator(&d_big2.object(),
                SELECTION_INFO_ARRAY[SELECTION_INDEX_BIG2]);        // RETURN
      default:
...
inline
BigRecord2& TimingRequest::big2()
{
    BSLS_ASSERT_SAFE(SELECTION_ID_BIG2 == d_selectionId);
    return d_big2.object();
}
...
inline
const BigRecord2& TimingRequest::big2() const
{
    BSLS_ASSERT_SAFE(SELECTION_ID_BIG2 == d_selectionId);
    return d_big2.object();
}
...
inline
bool TimingRequest::isBig2Value() const
{
    return SELECTION_ID_BIG2 == d_selectionId;
}
...
inline
bool test::operator==(
        const test::BasicRecord2& lhs,
        const test::BasicRecord2& rhs)
{
...
inline
bool test::operator==(
        const test::BigRecord2& lhs,
        const test::BigRecord2& rhs)
{
    return  lhs.name() == rhs.name()
         && lhs.array() == rhs.array();
}
        ...
        switch (rhs.selectionId()) {
          ...
          case Class::SELECTION_ID_BIG:
            return lhs.big() == rhs.big();
                                                                    // RETURN
          case Class::SELECTION_ID_BIG2:
            return lhs.big2() == rhs.big2();
                                                                    // RETURN
          default:
            BSLS_ASSERT_SAFE(Class::SELECTION_ID_UNDEFINED
                            == rhs.selectionId());
...
const char BasicRecord2::CLASS_NAME[] = "BasicRecord2";
    // the name of this class

const bdeat_AttributeInfo BasicRecord2::ATTRIBUTE_INFO_ARRAY[] = {
    {
        ATTRIBUTE_ID_I1,
        "i1",             // name
...
const bdeat_AttributeInfo *BasicRecord2::lookupAttributeInfo(
        const char *name,
        int         nameLength)
{
    switch(nameLength) {
        ...
        case 2: {
            if (bdeu_CharType::toUpper(name[0])=='I')
            {
...
const bdeat_AttributeInfo *BasicRecord2::lookupAttributeInfo(int id)
{
    switch (id) {
      case ATTRIBUTE_ID_I1:
        return &ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_I1];
...
bsl::ostream& BasicRecord2::print(
    bsl::ostream& stream,
    int           level,
    int           spacesPerLevel) const
{
...
const char BigRecord2::CLASS_NAME[] = "BigRecord2";
    // the name of this class

const bdeat_AttributeInfo BigRecord2::ATTRIBUTE_INFO_ARRAY[] = {
    {
        ATTRIBUTE_ID_NAME,
        "name",             // name
        sizeof("name") - 1, // name length
...
const bdeat_AttributeInfo *BigRecord2::lookupAttributeInfo(
        const char *name,
        int         nameLength)
{
    switch(nameLength) {
...
const bdeat_AttributeInfo *BigRecord2::lookupAttributeInfo(int id)
{
    switch (id) {
      case ATTRIBUTE_ID_NAME:
        return &ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_NAME];
        ...
        int         nameLength)
{
    switch(nameLength) {
        ...
        case 4: {
            switch(bdeu_CharType::toUpper(name[0])) {
                case 'B': {
                    if (bdeu_CharType::toUpper(name[1])=='I'
                     && bdeu_CharType::toUpper(name[2])=='G'
                     && bdeu_CharType::toUpper(name[3])=='2')
                    {
                        return &SELECTION_INFO_ARRAY[SELECTION_INDEX_BIG2];
                    }
                } break;
                case 'S': {
                    if (bdeu_CharType::toUpper(name[1])=='Q'
                     && bdeu_CharType::toUpper(name[2])=='R'
                     && bdeu_CharType::toUpper(name[3])=='T')
                    {
    ...
    int           spacesPerLevel) const
{
    ...
    if (0 <= spacesPerLevel) {
        ...
        switch (d_selectionId) {
          ...
          case SELECTION_ID_BIG2: {
            stream << "Big2 = ";
            bdeu_PrintMethods::print(stream, d_big2.object(),
                                     -levelPlus1, spacesPerLevel);
          } break;
          default:
            stream << "SELECTION UNDEFINED\n";
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 11: {
        ...
        if (verbose) bsl::cout << "\nTesting with null value." << bsl::endl;
        {
            ...
            bdesb_FixedMemInStreamBuf isb(osb.data(), osb.length());
            ASSERT(0 == Obj::decode(&isb, &valueIn));
                                       ...
                                       << bsl::endl;
            {
                ...
                bdesb_FixedMemInStreamBuf isb(&nokalvaData[0],
                                              nokalvaData.size());
                ASSERT(0 == Obj::decode(&isb, &valueFromNokalva));
      ...
      case 6: {
        ...
        for (int i = 0; i < DATA_LEN; ++i)
        {
            ...
            int ret = Obj::decode(&isb, &valueFromNokalva);
        ...
        for (int i = 0; i < DATA_LEN; ++i)
        {
            ...
            int ret = Obj::decode(&isb, &valueFromNokalva, opts);
      ...
      case 2: {
...

        {
            ...
            {
                bdesb_MemOutStreamBuf osb;
                ASSERT(0 == bdem_BerEncoderUtil::encode(&osb, XA1));
                ...
                bdesb_FixedMemInStreamBuf isb(osb.data(), osb.length());
                ASSERT(0 == Obj::decode(&isb, &XA2));
                LOOP2_ASSERT(XA1, XA2, XA1 == XA2);
            }
            {
                bdesb_MemOutStreamBuf osb;
                ASSERT(0 == bdem_BerEncoderUtil::encode(&osb, XB1));
                ...
                bdesb_FixedMemInStreamBuf isb(osb.data(), osb.length());
                ASSERT(0 == Obj::decode(&isb, &XB2));
                LOOP2_ASSERT(XB1, XB2, XB1 == XB2);
            }
            {
                bdesb_MemOutStreamBuf osb;
                ASSERT(0 == bdem_BerEncoderUtil::encode(&osb, XC1));
                ...
                bdesb_FixedMemInStreamBuf isb(osb.data(), osb.length());
                ASSERT(0 == Obj::decode(&isb, &XC2));
                LOOP2_ASSERT(XC1, XC2, XC1 == XC2);
            }
            {
                bdesb_MemOutStreamBuf osb;
                ASSERT(0 == bdem_BerEncoderUtil::encode(&osb, XD1));
                ...
                bdesb_FixedMemInStreamBuf isb(osb.data(), osb.length());
                ASSERT(0 == Obj::decode(&isb, &XD2));
                LOOP2_ASSERT(XD1, XD2, XD1 == XD2);
            }
            {
                bdesb_MemOutStreamBuf osb;
                ASSERT(0 == bdem_BerEncoderUtil::encode(&osb, XE1));
                ...
                bdesb_FixedMemInStreamBuf isb(osb.data(), osb.length());
                ASSERT(0 == Obj::decode(&isb, &XE2));
                LOOP2_ASSERT(XE1, XE2, XE1 == XE2);
            }
            {
                bdesb_MemOutStreamBuf osb;
                ASSERT(0 == bdem_BerEncoderUtil::encode(&osb, XF1));
                ...
                bdesb_FixedMemInStreamBuf isb(osb.data(), osb.length());
                ASSERT(0 == Obj::decode(&isb, &XF2));
                LOOP2_ASSERT(XF1, XF2, XF1 == XF2);
            }
            {
                bdesb_MemOutStreamBuf osb;
                ASSERT(0 == bdem_BerEncoderUtil::encode(&osb, XG1));
                ...
                bdesb_FixedMemInStreamBuf isb(osb.data(), osb.length());
                ASSERT(0 == Obj::decode(&isb, &XG2));
                LOOP2_ASSERT(XG1, XG2, XG1 == XG2);
            }
            {
                bdesb_MemOutStreamBuf osb;
                ASSERT(0 == bdem_BerEncoderUtil::encode(&osb, XH1));
                ...
                bdesb_FixedMemInStreamBuf isb(osb.data(), osb.length());
                ASSERT(0 == Obj::decode(&isb, &XH2));
                LOOP2_ASSERT(XH1, XH2, XH1 == XH2);
            }
            {
                bdesb_MemOutStreamBuf osb;
                ASSERT(0 == bdem_BerEncoderUtil::encode(&osb, XI1));
                ...
                bdesb_FixedMemInStreamBuf isb(osb.data(), osb.length());
                ASSERT(0 == Obj::decode(&isb, &XI2));
                LOOP2_ASSERT(XI1, XI2, XI1 == XI2);
            }
            {
                bdesb_MemOutStreamBuf osb;
                ASSERT(0 == bdem_BerEncoderUtil::encode(&osb, XJ1));
                ...
                bdesb_FixedMemInStreamBuf isb(osb.data(), osb.length());
                ASSERT(0 == Obj::decode(&isb, &XJ2));
                LOOP2_ASSERT(XJ1, XJ2, XJ1 == XJ2);
            }
            {
                bdesb_MemOutStreamBuf osb;
                ASSERT(0 == bdem_BerEncoderUtil::encode(&osb, XK1));
                ...
                bdesb_FixedMemInStreamBuf isb(osb.data(), osb.length());
                ASSERT(0 == Obj::decode(&isb, &XK2));
                LOOP2_ASSERT(XK1, XK2, XK1 == XK2);
            }
            {
                bdesb_MemOutStreamBuf osb;
                ASSERT(0 == bdem_BerEncoderUtil::encode(&osb, XL1));
                ...
                bdesb_FixedMemInStreamBuf isb(osb.data(), osb.length());
                ASSERT(0 == Obj::decode(&isb, &XL2));
                LOOP2_ASSERT(XL1, XL2, XL1 == XL2);
            }
            {
                bdesb_MemOutStreamBuf osb;
                ASSERT(0 == bdem_BerEncoderUtil::encode(&osb, XM1));
                ...
                bdesb_FixedMemInStreamBuf isb(osb.data(), osb.length());
                ASSERT(0 == Obj::decode(&isb, &XM2));
                LOOP2_ASSERT(XM1, XM2, XM1 == XM2);
            }
            {
                bdesb_MemOutStreamBuf osb;
                ASSERT(0 == bdem_BerEncoderUtil::encode(&osb, XN1));
                ...
                bdesb_FixedMemInStreamBuf isb(osb.data(), osb.length());
                ASSERT(0 == Obj::decode(&isb, &XN2));
                LOOP2_ASSERT(XN1, XN2, XN1 == XN2);
            }
            {
                bdesb_MemOutStreamBuf osb;
                ASSERT(0 == bdem_BerEncoderUtil::encode(&osb, XO1));
                ...
                bdesb_FixedMemInStreamBuf isb(osb.data(), osb.length());
                ASSERT(0 == Obj::decode(&isb, &XO2));
                LOOP2_ASSERT(XO1, XO2, XO1 == XO2);
            }
            {
                bdesb_MemOutStreamBuf osb;
                ASSERT(0 == bdem_BerEncoderUtil::encode(&osb, XP1));
                ...
                bdesb_FixedMemInStreamBuf isb(osb.data(), osb.length());
                ASSERT(0 == Obj::decode(&isb, &XP2));
                LOOP2_ASSERT(XP1, XP2, XP1 == XP2);
            }
            {
                bdesb_MemOutStreamBuf osb;
                ASSERT(0 == bdem_BerEncoderUtil::encode(&osb, XQ1));
                ...
                bdesb_FixedMemInStreamBuf isb(osb.data(), osb.length());
                ASSERT(0 == Obj::decode(&isb, &XQ2));
                LOOP2_ASSERT(XQ1, XQ2, XQ1 == XQ2);
            }
            {
                bdesb_MemOutStreamBuf osb;
                ASSERT(0 == bdem_BerEncoderUtil::encode(&osb, XR1));
                ...
                bdesb_FixedMemInStreamBuf isb(osb.data(), osb.length());
                ASSERT(0 == Obj::decode(&isb, &XR2));
                LOOP2_ASSERT(XR1, XR2, XR1 == XR2);
            }
            {
                bdesb_MemOutStreamBuf osb;
                ASSERT(0 == bdem_BerEncoderUtil::encode(&osb, XS1));
                ...
                bdesb_FixedMemInStreamBuf isb(osb.data(), osb.length());
                ASSERT(0 == Obj::decode(&isb, &XS2));
                LOOP2_ASSERT(XS1, XS2, XS1 == XS2);
            }
            {
                bdesb_MemOutStreamBuf osb;
                ASSERT(0 == bdem_BerEncoderUtil::encode(&osb, XT1));
                ...
                bdesb_FixedMemInStreamBuf isb(osb.data(), osb.length());
                ASSERT(0 == Obj::decode(&isb, &XT2));
                LOOP2_ASSERT(XT1, XT2, XT1 == XT2);
            }
            {
                bdesb_MemOutStreamBuf osb;
                ASSERT(0 == bdem_BerEncoderUtil::encode(&osb, XU1));
      ...
      case 1: {
...

        {
            ...
            {
                bdesb_MemOutStreamBuf osb;
                ASSERT(0 == bdem_BerEncoderUtil::encode(&osb, XV1));
                ...
                bdesb_FixedMemInStreamBuf isb(osb.data(), osb.length());
                ASSERT(0 == Obj::decode(&isb, &XV2));
                LOOP2_ASSERT(XV1, XV2, XV1 == XV2);
            }
            {
                bdesb_MemOutStreamBuf osb;
                ASSERT(0 == bdem_BerEncoderUtil::encode(&osb, XW1));
                ...
                bdesb_FixedMemInStreamBuf isb(osb.data(), osb.length());
                ASSERT(0 == Obj::decode(&isb, &XW2));
                LOOP2_ASSERT(XW1, XW2, XW1 == XW2);
            }
            {
                bdesb_MemOutStreamBuf osb;
                ASSERT(0 == bdem_BerEncoderUtil::encode(&osb, XX1));
                ...
                bdesb_FixedMemInStreamBuf isb(osb.data(), osb.length());
                ASSERT(0 == Obj::decode(&isb, &XX2));
                LOOP2_ASSERT(XX1, XX2, XX1 == XX2);
            }
            {
                bdesb_MemOutStreamBuf osb;
                ASSERT(0 == bdem_BerEncoderUtil::encode(&osb, XY1));
                ...
                bdesb_FixedMemInStreamBuf isb(osb.data(), osb.length());
                ASSERT(0 == Obj::decode(&isb, &XY2));
                LOOP2_ASSERT(XY1, XY2, XY1 == XY2);
            }
            {
                bdesb_MemOutStreamBuf osb;
                ASSERT(0 == bdem_BerEncoderUtil::encode(&osb, XZ1));
      ...
      case -1: {
        ...
        switch (requestType) {
          ...
          case '2': {
              bsl::cout << "bigRecord2 request with array size of "
                        << arraySize << bsl::endl;

              test::BasicRecord2 basicRec;
              basicRec.i1() = 11;
              basicRec.i2() = 22;
              basicRec.s() = "The quick brown fox jumped over the lazy dog.";
              int minBasicRecSize =
                  minOutputSize = 2 * sizeof(int) + basicRec.s().length();

              test::BigRecord2   bigRec;
              bigRec.name() = "This record is so big, it has its own gravity.";
        ...
        for (int i = 0; i < reps; ++i) {
            osb.pubseekpos(0);
            bdem_BerEncoderUtil::encode(&osb, request);
        }
        stopwatch.stop();
        ...
        bsl::cout << "bdem_BerDecoderUtil: " << elapsed << " seconds, "
        ...
        for (int i = 0; i < reps; ++i) {
            osb.pubseekpos(0);
            bdex_OutStreamFunctions::streamOut(bdexOutStream, request, 1);
        }
        stopwatch.stop();
        ...
        for (int i = 0; i < reps; ++i) {
            isb.pubseekpos(0);
            bdex_InStreamFunctions::streamIn(bdexInStream, inRequests[i], 1);
        }
        stopwatch.stop();
        ...
        bsl::cout << "BerDecoderUtil is " << (slowDown * 100.0)
                  << "% slower than bdex" << bsl::endl;

        slowDown = 1.0 - ((berEncodeSpeed + berDecodeSpeed) /
                          (bdexEncodeSpeed + bdexDecodeSpeed));
        bsl::cout << "BerEn/DecoderUtil is " << (slowDown * 100.0)
                  << "% slower than bdex" << bsl::endl;
      } break;
      default: {
