...
class BasicRecord2 {
  ...
  public:
    ...
    // CREATORS
    explicit BasicRecord2(bslma::Allocator *basicAllocator = 0);
...
class BigRecord2 {
  ...
  public:
    ...
    // CREATORS
    explicit BigRecord2(bslma::Allocator *basicAllocator = 0);
...
class TimingRequest {
  ...
  private:
    union {
        ...
        bsls::ObjectBuffer< BigRecord2 >  d_big2;
    };
...
// CREATORS
inline
BasicRecord2::BasicRecord2(bslma::Allocator *basicAllocator)
: d_i1()
, d_i2()
, d_s(basicAllocator)
{
...
// CREATORS
inline
BigRecord2::BigRecord2(bslma::Allocator *basicAllocator)
: d_name(basicAllocator)
