...
typedef bbedc_Sia30360neom Obj;
      ...
      case 2: {
...

        {
            static const struct {
                ...
                { L_,     2000,     1,    30,   2004,     3,    31,   4.1694 },
                { L_,     2000,     1,    31,   2004,     3,    29,   4.1611 },
                { L_,     2000,     1,    31,   2004,     3,    30,   4.1639 },
                { L_,     2000,     1,    31,   2004,     3,    31,   4.1667 },

                { L_,     2004,     1,    29,   2000,     1,    30,  -3.9972 },
                { L_,     2004,     1,    29,   2000,     1,    31,  -3.9944 },
                { L_,     2004,     1,    29,   2000,     3,    29,  -3.8333 },
                { L_,     2004,     1,    29,   2000,     3,    30,  -3.8306 },
                { L_,     2004,     1,    29,   2000,     3,    31,  -3.8278 },
                { L_,     2004,     1,    30,   2000,     1,    31,  -3.9972 },
                ...
                { L_,     2004,     1,    30,   2000,     3,    31,  -3.8306 },
                { L_,     2004,     1,    31,   2000,     3,    29,  -3.8389 },
                { L_,     2004,     1,    31,   2000,     3,    30,  -3.8361 },
      ...
      case 1: {
...

        {
            static const struct {
                ...
                { L_,     1993,     3,    31,   1993,     4,     1,        0 },
                { L_,     1993,     3,    31,   1993,     4,    30,       29 },
                ...
                { L_,     1999,     1,    30,   1999,     3,    31,       61 },
                { L_,     1999,     1,    31,   1999,     3,    29,       58 },
                { L_,     1999,     1,    31,   1999,     3,    30,       59 },
                ...
                { L_,     2000,     1,    30,   2004,     3,    31,     1501 },
                { L_,     2000,     1,    31,   2004,     3,    29,     1498 },
                { L_,     2000,     1,    31,   2004,     3,    30,     1499 },
                { L_,     2000,     1,    31,   2004,     3,    31,     1500 },

                { L_,     2004,     1,    29,   2000,     1,    30,    -1439 },
                { L_,     2004,     1,    29,   2000,     1,    31,    -1438 },
                { L_,     2004,     1,    29,   2000,     3,    29,    -1380 },
                { L_,     2004,     1,    29,   2000,     3,    30,    -1379 },
                { L_,     2004,     1,    29,   2000,     3,    31,    -1378 },
                { L_,     2004,     1,    30,   2000,     1,    31,    -1439 },
                ...
                { L_,     2004,     1,    30,   2000,     3,    31,    -1379 },
                { L_,     2004,     1,    31,   2000,     3,    29,    -1382 },
                { L_,     2004,     1,    31,   2000,     3,    30,    -1381 },
                ...
                { L_,     2000,     7,    30,   2000,     8,    31,       31 },
                { L_,     2000,     7,    30,   2000,     9,     1,       31 },
                { L_,     2000,     7,    31,   2000,     8,    31,       30 },
                { L_,     2000,     7,    31,   2000,     9,     1,       30 },
