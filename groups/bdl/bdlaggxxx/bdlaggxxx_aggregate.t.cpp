...
// component is implemented in the 'bdlmxxx::Convert' component.  Similarly, all
// the meta-data functionality resides in the 'bdlmxxx::Schema' component, and
...
// CLASS METHODS
// [ 9] bool areEquivalent(const bdlaggxxx::Aggregate& lhs,
//                         const bdlaggxxx::Aggregate& rhs);
// [ 9] bool areIdentical(const bdlaggxxx::Aggregate& lhs,
//                        const bdlaggxxx::Aggregate& rhs);
//
// CREATORS
// [10] bdlaggxxx::Aggregate(bslma::Allocator *basicAllocator = 0);
// [10] template <typename VALTYPE>
//      bdlaggxxx::Aggregate(const ET::Type    dataType,
//                     const VALTYPE&    value,
//                     bslma::Allocator *basicAllocator);
// [10] explicit bdlaggxxx::Aggregate(const ConstRecDefShdPtr&  recordDefPtr,
//                              bslma::Allocator         *basicAllocator);
// [10] explicit bdlaggxxx::Aggregate(const RecDefShdPtr&  recordDefPtr,
//                              bslma::Allocator    *basicAllocator);
// [10] bdlaggxxx::Aggregate(const ConstRecDefShdPtr&  recordDefPtr,
//                     ET::Type                  elemType,
//                     bslma::Allocator         *basicAllocator);
// [10] bdlaggxxx::Aggregate(const RecDefShdPtr&  recordDefPtr,
//                     ET::Type             elemType,
//                     bslma::Allocator    *basicAllocator);
// [10] bdlaggxxx::Aggregate(const ConstSchemaShdPtr&  schemaPtr,
//                     const bsl::string&        recordName,
//                     ET::Type                  elemType,
//                     bslma::Allocator         *basicAllocator);
// [10] bdlaggxxx::Aggregate(const SchemaShdPtr&  schemaPtr,
//                     const bsl::string&   recordName,
//                     ET::Type             elemType,
//                     bslma::Allocator    *basicAllocator);
// [21] bdlaggxxx::Aggregate(const bdlaggxxx::Aggregate&  other,
//                     bslma::Allocator      *basicAllocator);
// [10] ~bdlaggxxx::Aggregate();

// MANIPULATORS
// [12] bdlaggxxx::Aggregate& operator=(const bdlaggxxx::Aggregate& rhs);
// [14] void makeNull();
// [14] void reset();
// [ 7] bdlmxxx::ElemRef asElemRef();
...
// [29] const bdlaggxxx::Aggregate reserveRaw(size_t numItems) const;
// [16] template <typename VALTYPE>
...
// [19] bdlaggxxx::Aggregate makeSelection(const char         *newSelector) const;
// [19] bdlaggxxx::Aggregate makeSelection(const bsl::string&  newSelector) const;
// [19] template <typename VALTYPE>
//      bdlaggxxx::Aggregate makeSelection(const char        *newSelector,
//                                   const VALTYPE&     value) const;
// [19] template <typename VALTYPE>
//      bdlaggxxx::Aggregate makeSelection(const bsl::string& newSelector,
//                                   const VALTYPE&     value) const;
// [20] bdlaggxxx::Aggregate makeSelectionById(int newSelectorId) const;
// [20] template <typename VALTYPE>
//      bdlaggxxx::Aggregate makeSelectionById(int            newSelectorId,
//                                       const VALTYPE& value) const;
// [23] bdlaggxxx::Aggregate makeValue() const;
...
// [ 6] bdlt::Datetime asDatetime() const;
// [ 6] bdlt::DatetimeTz asDatetimeTz() const;
// [ 6] bdlt::Date asDate() const;
// [ 6] bdlt::DateTz asDateTz() const;
// [ 6] bdlt::Time asTime() const;
// [ 6] bdlt::TimeTz asTimeTz() const;
// [ 7] bdlmxxx::ConstElemRef asElemRef() const;
// [30] bsl::size_t capacityRaw() const;
// [ 5] bool hasField(const char *fieldName) const;
// [ 5] bdlaggxxx::Aggregate field(NameOrIndex fieldOrIdx) const;
// [ 5] bdlaggxxx::Aggregate field(NameOrIndex fieldOrIdx1,
//                           NameOrIndex fieldOrIdx2,
...
// [ 8] bdlaggxxx::Aggregate fieldById(int fieldId) const;
// [ 5] ET::Type
...
// [ 5] bdlmxxx::ElemRef fieldRef(NameOrIndex fieldOrIdx1,
//                            NameOrIndex fieldOrIdx2 = NameOrIndex(),
//                            NameOrIndex fieldOrIdx3 = NameOrIndex(),
//                            NameOrIndex fieldOrIdx4 = NameOrIndex(),
//                            NameOrIndex fieldOrIdx5 = NameOrIndex(),
...
//                            NameOrIndex fieldOrIdx9 = NameOrIndex(),
//                            NameOrIndex fieldOrIdx10 = NameOrIndex()) const;
// [ 8] bdlmxxx::ElemRef fieldRefById(int fieldId) const;
// [ 5] const bdlmxxx::FieldDef *fieldDef() const;
// [13] bdlaggxxx::Aggregate operator[](int index) const;
// [13] int length() const;
// [13] int size() const;
// [14] bool isNul2() const;
// [19] bdlaggxxx::Aggregate selection() const;
// [14] int numSelections() const;
// [19] const char *selector() const;
// [20] int selectorId() const;
// [22] bdlaggxxx::Aggregate clone(bslma::Allocator *basicAllocator) const;
// [22] bdlaggxxx::Aggregate cloneData(bslma::Allocator *basicAllocator) const;
// [ 7] ET::Type dataType() const;
// [10] const bdlmxxx::RecordDef& recordDef() const;
// [10] const void *data() const;
// [10] ConstRecDefShdPtr recordDefPtr() const;
// [10] bsl::shared_ptr<void> dataPtr() const;
...
//                               const bdlaggxxx::Aggregate& obj);
//
// BDEAT FRAMEWORK
// [24] namespace bdlat_TypeCategoryFunctions
// [24] namespace bdlat_SequenceFunctions
// [24] namespace bdlat_ChoiceFunctions
// [24] namespace bdlat_ArrayFunctions
// [24] namespace bdlat_EnumFunctions
// [24] namespace bdlat_NullableValueFunctions
// [24] namespace bdlat_ValueTypeFunctions
//
//-----------------------------------------------------------------------------
// [ 1] BREATHING TEST
...
const int BDEM_NULL_FIELD_ID = bdlmxxx::RecordDef::BDEM_NULL_FIELD_ID;

typedef bdlaggxxx::Aggregate        Obj;
typedef bdlaggxxx::ErrorAttributes  Err;
typedef bdlaggxxx::ErrorCode        ErrorCode;
...
void aSsErTAggError(const bdlaggxxx::Aggregate& agg, const char *aggNm,
...
typedef bdlmxxx::FieldDefAttributes FldAttr;
typedef bdlmxxx::RecordDef          RecDef;
typedef RecDef::RecordType      RecType;
typedef bdlmxxx::EnumerationDef     EnumDef;
typedef bdlmxxx::Schema             Schema;

typedef bdlmxxx::SchemaUtil          SchemaUtil;
typedef bdlmxxx::SchemaAggregateUtil SchemaAggUtil;
typedef bdlat_FormattingMode     Format;

typedef bsl::shared_ptr<const RecDef>        ConstRecDefShdPtr;
typedef bsl::shared_ptr<RecDef>              RecDefShdPtr;
typedef bsl::shared_ptr<const Schema>        ConstSchemaShdPtr;
typedef bsl::shared_ptr<Schema>              SchemaShdPtr;
typedef bsl::shared_ptr<const List>          ConstListShdPtr;
typedef bsl::shared_ptr<List>                ListShdPtr;
typedef bsl::shared_ptr<const Row>           ConstRowShdPtr;
typedef bsl::shared_ptr<Row>                 RowShdPtr;
typedef bsl::shared_ptr<const Table>         ConstTableShdPtr;
typedef bsl::shared_ptr<Table>               TableShdPtr;
typedef bsl::shared_ptr<const Choice>        ConstChoiceShdPtr;
typedef bsl::shared_ptr<Choice>              ChoiceShdPtr;
typedef bsl::shared_ptr<const ChoiceItem>    ConstChoiceItemShdPtr;
typedef bsl::shared_ptr<ChoiceItem>          ChoiceItemShdPtr;
typedef bsl::shared_ptr<const ChoiceArray>   ConstChoiceArrayShdPtr;
typedef bsl::shared_ptr<ChoiceArray>         ChoiceArrayShdPtr;
typedef bsl::shared_ptr<void>                VoidDataShdPtr;

typedef bslstl::SharedPtrNilDeleter NilDeleter;
...
bdlt::Date        mA08;           const bdlt::Date&        A08 = mA08;
bdlt::Date        mB08;           const bdlt::Date&        B08 = mB08;
bdlt::Date        mN08;           const bdlt::Date&        N08 = mN08;

bdlt::Time        mA09;           const bdlt::Time&        A09 = mA09;
bdlt::Time        mB09;           const bdlt::Time&        B09 = mB09;
bdlt::Time        mN09;           const bdlt::Time&        N09 = mN09;

bdlt::Datetime    mA07;           const bdlt::Datetime&    A07 = mA07;
bdlt::Datetime    mB07;           const bdlt::Datetime&    B07 = mB07;
bdlt::Datetime    mN07;           const bdlt::Datetime&    N07 = mN07;

bdlt::DateTz      mA24;           const bdlt::DateTz&      A24 = mA24;
bdlt::DateTz      mB24;           const bdlt::DateTz&      B24 = mB24;
bdlt::DateTz      mN24;           const bdlt::DateTz&      N24 = mN24;

bdlt::TimeTz      mA25;           const bdlt::TimeTz&      A25 = mA25;
bdlt::TimeTz      mB25;           const bdlt::TimeTz&      B25 = mB25;
bdlt::TimeTz      mN25;           const bdlt::TimeTz&      N25 = mN25;

bdlt::DatetimeTz  mA23;           const bdlt::DatetimeTz&  A23 = mA23;
bdlt::DatetimeTz  mB23;           const bdlt::DatetimeTz&  B23 = mB23;
bdlt::DatetimeTz  mN23;           const bdlt::DatetimeTz&  N23 = mN23;
...
bsl::vector<bdlt::Datetime> mA17;
bsl::vector<bdlt::Datetime> mB17;
bsl::vector<bdlt::Datetime> mN17;
const bsl::vector<bdlt::Datetime>& A17 = mA17;
const bsl::vector<bdlt::Datetime>& B17 = mB17;
const bsl::vector<bdlt::Datetime>& N17 = mN17;

bsl::vector<bdlt::Date> mA18;
bsl::vector<bdlt::Date> mB18;
bsl::vector<bdlt::Date> mN18;
const bsl::vector<bdlt::Date>& A18 = mA18;
const bsl::vector<bdlt::Date>& B18 = mB18;
const bsl::vector<bdlt::Date>& N18 = mN18;

bsl::vector<bdlt::Time> mA19;
bsl::vector<bdlt::Time> mB19;
bsl::vector<bdlt::Time> mN19;
const bsl::vector<bdlt::Time>& A19 = mA19;
const bsl::vector<bdlt::Time>& B19 = mB19;
const bsl::vector<bdlt::Time>& N19 = mN19;

bsl::vector<bdlt::DatetimeTz> mA27;
bsl::vector<bdlt::DatetimeTz> mB27;
bsl::vector<bdlt::DatetimeTz> mN27;
const bsl::vector<bdlt::DatetimeTz>& A27 = mA27;
const bsl::vector<bdlt::DatetimeTz>& B27 = mB27;
const bsl::vector<bdlt::DatetimeTz>& N27 = mN27;

bsl::vector<bdlt::DateTz> mA28;
bsl::vector<bdlt::DateTz> mB28;
bsl::vector<bdlt::DateTz> mN28;
const bsl::vector<bdlt::DateTz>& A28 = mA28;
const bsl::vector<bdlt::DateTz>& B28 = mB28;
const bsl::vector<bdlt::DateTz>& N28 = mN28;

bsl::vector<bdlt::TimeTz> mA29;
bsl::vector<bdlt::TimeTz> mB29;
bsl::vector<bdlt::TimeTz> mN29;
const bsl::vector<bdlt::TimeTz>& A29 = mA29;
const bsl::vector<bdlt::TimeTz>& B29 = mB29;
const bsl::vector<bdlt::TimeTz>& N29 = mN29;
...
void initStaticData ()
{
    mA22 = true;
    mB22 = false;
    mN22 = bdltuxxx::Unset<bool>::unsetValue();

    mA00 = 'A';
    mB00 = 'B';
    mN00 = bdltuxxx::Unset<char>::unsetValue();

    mA01 = -1;
    mB01 = -2;
    mN01 = bdltuxxx::Unset<short>::unsetValue();

    mA02 = 5;
    mB02 = 6;
    mN02 = bdltuxxx::Unset<int>::unsetValue();

    mA03 = -100;
    mB03 = -200;
    mN03 = bdltuxxx::Unset<bsls::Types::Int64>::unsetValue();

    mA04 = -1.5;
    mB04 = -2.5;
    mN04 = bdltuxxx::Unset<float>::unsetValue();

    mA05 = 10.5;
    mB05 = 20.5;
    mN05 = bdltuxxx::Unset<double>::unsetValue();

    mA06 = "you";
    mB06 = "vee";
    mN06 = bdltuxxx::Unset<bsl::string>::unsetValue();

    // Note: bdlt::Datetime X07 implemented in terms of X08 and X09.

    mA08 = bdlt::Date(2000,  1, 1);
    mB08 = bdlt::Date(9999, 12,31);
    mN08 = bdltuxxx::Unset<bdlt::Date>::unsetValue();

    mA09 = bdlt::Time(0, 1, 2, 3);
    mB09 = bdlt::Time(4, 5, 6, 789);
    mN09 = bdltuxxx::Unset<bdlt::Time>::unsetValue();

    mA07 = bdlt::Datetime(mA08, mA09);
    mB07 = bdlt::Datetime(mB08, mB09);
    mN07 = bdltuxxx::Unset<bdlt::Datetime>::unsetValue();

    mA24 = bdlt::DateTz(mA08, -5);
    mB24 = bdlt::DateTz(mB08, -4);
    mN24 = bdltuxxx::Unset<bdlt::DateTz>::unsetValue();

    mA25 = bdlt::TimeTz(mA09, -5);
    mB25 = bdlt::TimeTz(mB09, -5);
    mN25 = bdltuxxx::Unset<bdlt::TimeTz>::unsetValue();

    mA23 = bdlt::DatetimeTz(mA07, -5);
    mB23 = bdlt::DatetimeTz(mB07, -5);
    mN23 = bdltuxxx::Unset<bdlt::DatetimeTz>::unsetValue();
    ...
    bdlmxxx::Table t(types, NUM_TYPES);
    ...
    bdlmxxx::Choice c(types, NUM_TYPES);
    ...
    bdlmxxx::ChoiceArray x(types, NUM_TYPES);
...
// The following code creates a 'bdlmxxx::Schema' object given a specification.
// It was copied verbatim from bdlmxxx_binding.t.cpp.  The only difference is
...
static const char *ggElemTypeNames[] = {
    "bdlmxxx::ElemType::BDEM_CHAR",                       //  0
    "bdlmxxx::ElemType::BDEM_SHORT",                      //  1
    "bdlmxxx::ElemType::BDEM_INT",                        //  2
    "bdlmxxx::ElemType::BDEM_INT64",                      //  3
    "bdlmxxx::ElemType::BDEM_FLOAT",                      //  4
    "bdlmxxx::ElemType::BDEM_DOUBLE",                     //  5
    "bdlmxxx::ElemType::BDEM_STRING",                     //  6
    "bdlmxxx::ElemType::BDEM_DATETIME",                   //  7
    "bdlmxxx::ElemType::BDEM_DATE",                       //  8
    "bdlmxxx::ElemType::BDEM_TIME",                       //  9
    "bdlmxxx::ElemType::BDEM_CHAR_ARRAY",                 // 10
    "bdlmxxx::ElemType::BDEM_SHORT_ARRAY",                // 11
    "bdlmxxx::ElemType::BDEM_INT_ARRAY",                  // 12
    "bdlmxxx::ElemType::BDEM_INT64_ARRAY",                // 13
    "bdlmxxx::ElemType::BDEM_FLOAT_ARRAY",                // 14
    "bdlmxxx::ElemType::BDEM_DOUBLE_ARRAY",               // 15
    "bdlmxxx::ElemType::BDEM_STRING_ARRAY",               // 16
    "bdlmxxx::ElemType::BDEM_DATETIME_ARRAY",             // 17
    "bdlmxxx::ElemType::BDEM_DATE_ARRAY",                 // 18
    "bdlmxxx::ElemType::BDEM_TIME_ARRAY",                 // 19
    "bdlmxxx::ElemType::BDEM_LIST",                       // 20
    "bdlmxxx::ElemType::BDEM_TABLE",                      // 21
    "bdlmxxx::ElemType::BDEM_BOOL",                       // 22
    "bdlmxxx::ElemType::BDEM_DATETIMETZ",                 // 23
    "bdlmxxx::ElemType::BDEM_DATETZ",                     // 24
    "bdlmxxx::ElemType::BDEM_TIMETZ",                     // 25
    "bdlmxxx::ElemType::BDEM_BOOL_ARRAY",                 // 26
    "bdlmxxx::ElemType::BDEM_DATETIMETZ_ARRAY",           // 27
    "bdlmxxx::ElemType::BDEM_DATETZ_ARRAY",               // 28
    "bdlmxxx::ElemType::BDEM_TIMETZ_ARRAY",               // 29
    "bdlmxxx::ElemType::BDEM_CHOICE",                     // 30
    "bdlmxxx::ElemType::BDEM_CHOICE_ARRAY",               // 31
    "bdlmxxx::ElemType::BDEM_LIST (constrained)",         // 32
    "bdlmxxx::ElemType::BDEM_TABLE (constrainted)",       // 33
    "bdlmxxx::ElemType::BDEM_CHOICE (constrained)",       // 34
    "bdlmxxx::ElemType::BDEM_CHOICE_ARRAY (constrainted)",// 35
    "bdlmxxx::ElemType::BDEM_INT (enumeration)",          // 36
    "bdlmxxx::ElemType::BDEM_STRING (enumeration)",       // 37
    "bdlmxxx::ElemType::BDEM_INT_ARRAY (enumeration)",    // 38
    "bdlmxxx::ElemType::BDEM_STRING_ARRAY (enumeration)"  // 39
};
                      ...
                      const char *p)
{
    ...
    while (isFieldType(*p)) {       // add a field
        ...
        if (bdlat_FormattingMode::e_NILLABLE & fmt
         ...
         && -1 == dfltIndex) {
            bdlmxxx::RecordDef *tmpRecord = object->createRecord(
                                         0,
                                         bdlmxxx::RecordDef::BDEM_SEQUENCE_RECORD);
            bdlmxxx::ElemType::Type baseType = EType::fromArrayType(fieldType);
...
static
const char *recName(const bdlmxxx::RecordDef& record)
    ...
    // less-convenient 'bdlmxxx_schema' functionality.
{
...
void addElementToList(bdlmxxx::List *list, ET::Type type)
...
void assignElement(bdlmxxx::ElemRef elemRef, ET::Type type)
...
void ggTable(bdlmxxx::Table           *table,
             const bdlmxxx::RecordDef *record,
             bool                  replaceElement = false);
void ggChoice(bdlmxxx::Choice          *choice,
              const bdlmxxx::RecordDef *constraint,
              bool                  replaceElement = false);
void ggChoiceArray(bdlmxxx::ChoiceArray     *choiceArray,
                   const bdlmxxx::RecordDef *constraint,
                   bool                  replaceElement = false);

void ggList(bdlmxxx::List            *list,
            const bdlmxxx::RecordDef *record,
            bool                  replaceElement = false)
...
void ggSimpleTypeList(bdlmxxx::List            *list,
                      ET::Type              type,
                      const bdlmxxx::RecordDef *constraint)
...
void initAggregate(const Obj *obj, const RecDef& record)
{
    ...
    if (bdlmxxx::RecordDef::BDEM_CHOICE_RECORD == record.recordType()) {
        ...
        ASSERT(bdlmxxx::RecordDef::BDEM_SEQUENCE_RECORD == record.recordType());
...
static bool compareNillableElement(bdlaggxxx::Aggregate agg, const CERef& elemRef)
{
    bdlmxxx::ElemType::Type type = elemRef.type();
    switch (type) {
      case bdlmxxx::ElemType::BDEM_CHAR:
...
static void assignToNillableTable(bdlaggxxx::Aggregate *agg, const CERef& arrayRef)
{
    bdlmxxx::ElemType::Type arrayType = arrayRef.type();
    switch (arrayType) {
      case bdlmxxx::ElemType::BDEM_CHAR_ARRAY:
...
static bool compareNillableElement(bdlaggxxx::Aggregate agg,
                                   const CERef&   elemRef,
                                   int            index)
{
    bdlmxxx::ElemType::Type arrayType = elemRef.type();
    bdlmxxx::ElemType::Type subType   = bdlmxxx::ElemType::fromArrayType(arrayType);
    switch (arrayType) {
      case bdlmxxx::ElemType::BDEM_CHAR_ARRAY:
...
static bool compareNillableTable(bdlaggxxx::Aggregate agg, const CERef& elemRef)
{
...
template <class VALTYPE>
void enumTest(const bdlaggxxx::Aggregate&  AGG,
              const char            *fldcodes,
              const VALTYPE&         value,
              int                    expInt,
...
{
    int intValue = -2;
    bdlmxxx::Convert::convert(&intValue, value);
    if (d_isNullable) {
        intValue = -intValue;
    }
    d_values.push_back(intValue);
...
{
    const CERef& ref = d_elements.front();
    int rc = bdlmxxx::Convert::convert(value, ref);
    d_elements.pop_front();
    return rc;
}
...
int AggManipulator::operator()(T* value, const TC::Simple&)
{
    ...
    bdlmxxx::Convert::convert(value, intValue);
    return 0;
}
...
struct Accumulator {
    ...
    int operator()(const bdlaggxxx::AggregateRaw& value) {
        d_count += value.asInt();
        return 0;
    }

    int operator()(const bdlaggxxx::Aggregate& value) {
        d_count += value.asInt();
        return 0;
...
static void runBerBenchmark(bool verbose, bool veryVerbose,
    ...
    bdlaggxxx::Aggregate testMessage(schema, "c");
    bdlaggxxx::Aggregate gRecord = testMessage.makeSelection("g");
    gRecord.setField("ex", 4);

    bsl::string theString(STR_LENGTH, 'X');

    bdlaggxxx::Aggregate requestEntries = gRecord.field("j");
    ...
    for (int i = 0; i < NUM_REQUEST_ENTRIES; ++i) {
        ...
        bdlaggxxx::Aggregate entryFields = requestEntries[i].field("j");
    ...
    for (int i = 0; i < NUM_ITER; ++i) {
        bdlsb::FixedMemOutStreamBuf osb(ENCODE_BUFFER, ENCODE_BUFFER_SIZE);
    ...
    balber::BerDecoder berDecoder(&berDecoderOptions);

    timer.start(true);
    bdlaggxxx::Aggregate testResponse(schema, "c");

    for (int i = 0; i < NUM_ITER; ++i) {
        bdlsb::FixedMemInStreamBuf isb(ENCODE_BUFFER, length);
...
static void testCase36(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
        ...
        //
        // Plan:
        //: 1 Create a 'bdlaggxxx::Aggregate' object, 'mX', and assign a table to
        //:   it.
        //:
        ...
        bdlmxxx::ElemType::Type TYPES[] = {
            bdlmxxx::ElemType::BDEM_INT,
            bdlmxxx::ElemType::BDEM_STRING
        };
        const int NUM_TYPES = sizeof TYPES / sizeof *TYPES;

        bdlmxxx::Table table(TYPES, NUM_TYPES);

        Obj mX(bdlmxxx::ElemType::BDEM_TABLE, table);  const Obj& X = mX;
        ...
        ASSERT(bdlmxxx::ElemType::BDEM_ROW == A.dataType());

        Obj mB = mA.fieldByIndex(0);  const Obj& B = mB;
        ASSERT(bdlmxxx::ElemType::BDEM_INT == B.dataType());
        ...
        ASSERT(bdlmxxx::ElemType::BDEM_STRING == C.dataType());
...
static void testCase35(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
        ...
        //
        // Concerns:
        //   - 'bdlat_TypeName::className(bdlaggxxx::Aggregate)' returns the
        ...
        //   - 'bdlat_TypeCategory::Select<bdlaggxxx::Aggregate>::
        //      e_SELECTION' is '0'
        //   - 'bdlat_TypeCategoryFunctions::select(bdem::AggregateRawPtr)'
        ...
        // - Create an 'bdlaggxxx::Aggregate' object that conforms to the root
        //   record of the schema.
        // - Call 'bdlat_TypeName::className(bdlaggxxx::Aggregate)' on each
        //   field and check for expected result.
        // - Check that
        //   'bdlat_TypeCategory::Select<bdlaggxxx::Aggregate>::
        //    e_SELECTION' is '0'.
        // - Call 'bdlat_TypeCategoryFunctions::select(bdem::AggregateRawPtr)'
        ...
        //   a complex aggregate using 'balber_berencoder' and decode
        ...
        ASSERT(0 == TC::Select<bdlaggxxx::Aggregate>::e_SELECTION);
        ...
        ASSERT(0 ==
                  bdlat_TypeCategory::Select<bdlaggxxx::Aggregate>::e_SELECTION);
        ASSERT(TC::e_SEQUENCE_CATEGORY    == TCF::select(A1));
        ASSERT(TC::e_SIMPLE_CATEGORY      ==
        ...
        bsl::string res;
        if (verbose) tst::cout << "Testing bdlat_SequenceFunctions"<<bsl::endl;
        ASSERT(SF::IsSequence<bdlaggxxx::Aggregate>::VALUE);
        ...
        Obj mB(schema, "r"); const bdlaggxxx::Aggregate& B = mB;
        ...
        newManipulator.reset();
        int selector = 0;
        const CERef  RefSelector(&selector, &bdlmxxx::Properties::s_intAttr);
        ...
        newManipulator.reset();
        int numItems = 1;
        const CERef  RefNI(&numItems, &bdlmxxx::Properties::s_intAttr);
        ...
        newManipulator.reset();
        int s1 = 0, s2 = 1;
        const CERef  RefS1(&s1, &bdlmxxx::Properties::s_intAttr);
        const CERef  RefS2(&s2, &bdlmxxx::Properties::s_intAttr);
        ...
        newManipulator.reset();
        int enumId = 1;
        const CERef enumRef1(&enumId, &bdlmxxx::Properties::s_intAttr);
        ...
        const CERef enumRef2(&enumString, &bdlmxxx::Properties::s_stringAttr);
        ...
        bdlaggxxx::Aggregate mA2f = mA2.field("f");
        ...
        if (verbose) tst::cout << "Testing bdlat_ChoiceFunctions" << bsl::endl;
        ASSERT(CF::IsChoice<bdlaggxxx::Aggregate>::VALUE);
        int id = 99;
        ...
        bdlaggxxx::Aggregate mA2h(mA2.field("h"));
        ...
        if (verbose) tst::cout << "Testing bdlat_ArrayFunctions" << bsl::endl;
        ASSERT(AF::IsArray<bdlaggxxx::Aggregate>::VALUE);
        ...
        bdlaggxxx::Aggregate mA2i(mA2.field("i"));
        ...
        if (verbose) tst::cout << "Testing bdlat_ArrayFunctions on TABLEs"
                               << bsl::endl;
        ...
        bdlaggxxx::Aggregate mA2j(mA2.field("j"));
        ...
        if (verbose) tst::cout << "Testing bdlat_ArrayFunctions on "
        ...
        bdlaggxxx::Aggregate mA2k(mA2.field("k"));
        ...
        if (verbose) tst::cout << "Testing bdlat_NullableValueFunctions:"
                               << bsl::endl;
        typedef bdlaggxxx::Aggregate_NullableAdapter NullableAdapter;
        ASSERT(! NVF::IsNullableValue<bdlaggxxx::Aggregate>::VALUE);
        ASSERT(NVF::IsNullableValue<NullableAdapter>::VALUE);
        bdlaggxxx::Aggregate mA1b(mA1.field("b"));
        bdlaggxxx::Aggregate mA1br(mA1.field("b"));
        NullableAdapter nmA1b  = { &mA1br };
        ASSERT(NVF::isNull(nmA1b));
        bdlaggxxx::Aggregate mA1g(mA1.field("g"));
        bdlaggxxx::Aggregate mA1gr = mA1g;
        NullableAdapter nmA1g  = { &mA1gr };
        ASSERT(!NVF::isNull(nmA1g));
        bdlaggxxx::Aggregate mA1gd(mA1.field("g", "d"));
        ...
        bdlaggxxx::Aggregate mA2b(mA2.field("b"));
        ...
        bdlaggxxx::Aggregate mA2g(mA2.field("g"));
        ...
        if (verbose) tst::cout << "Testing bdlat_EnumFunctions:" << bsl::endl;
        ASSERT(EF::IsEnumeration<bdlaggxxx::Aggregate>::VALUE);
        int intValue;
        ...
        bdlaggxxx::Aggregate mA2magg(mA2.field("m"));
        const bdlaggxxx::Aggregate &A2m = mA2magg;
        bdlaggxxx::Aggregate mA2mr = mA2magg;
        int status;
        ...
        bdlaggxxx::Aggregate mA2n(mA2.field("n"));
        const bdlaggxxx::Aggregate &A2n = mA2n;
        bdlaggxxx::Aggregate mA2nr = mA2n;
        ...
        if (verbose) tst::cout << "Testing bdlat_ValueTypeFunctions on STRING"
                               << bsl::endl;
        bdlaggxxx::Aggregate mA3d(mA1["d"].clone());
        const bdlaggxxx::Aggregate& A3d = mA3d;
        ...
        bdlat_ValueTypeFunctions::reset(&mA3d);
        ASSERT(ET::BDEM_STRING == A3d.dataType());
        LOOP_ASSERT(A3d.asString(), "vee" == A3d.asString());
        bdlat_ValueTypeFunctions::assign(&mA3d, mA1["c"]);
        ...
        balber::BerEncoder berEncoder(&berEncoderOptions);
        ...
        bdlaggxxx::Aggregate mA4(schema, "r"); const bdlaggxxx::Aggregate& A4 = mA4;
        ASSERT(! bdlaggxxx::Aggregate::areEquivalent(mA1, A4));
        bdlaggxxx::Aggregate a4Ptr = A4;
...
static void testCase34(bool verbose, bool veryVerbose, bool veryVeryVerbose)
{
    ...
    //
    // Concerns:
    //   - bdlat_arrayAccessElement() works properly when the argument is
    //     bcem_AggregateRaw.
    //
    //
    // Plan:
    ...
    // Testing:
    //
    //  bdlat_arrayAccessElement(bdlaggxxx::AggregateRaw, ...)
    // --------------------------------------------------------------------
    ...
    for (int numElements = 1; numElements <= 3; ++numElements) {
        ...
        bdlaggxxx::Aggregate scalarArrayAggregate(bdlmxxx::ElemType::BDEM_INT_ARRAY,
                                            scalarArray, &ta);

        bdlaggxxx::AggregateRaw data = scalarArrayAggregate.aggregateRaw();

        Accumulator accumulator;

        ASSERT(TC::e_ARRAY_CATEGORY == TCF::select(data));
...
//..
    ...
    const bdlaggxxx::Aggregate bbAgg = addr1.field("Entities", 0, "Corp", "Name");
...
// the original 'bdlaggxxx::Aggregate' and its clone are equivalent, but return
...
static void testCase30(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
    ...
    //:   'bdlaggxxx::Aggregate' whose type is not an array-type.
    //
    // Plan:
    ...
    //: 2 Instantiate a 'bdlaggxxx::Aggregate' with an underlying non-array
    //:   'BDE_ELEM' type and verify that an error-aggregate is returned.
    //:   [C-3]
    //
    // Testing the following functions:
    //   const bdlaggxxx::Aggregate capacityRaw() const;
    // --------------------------------------------------------------------
    ...
    {
        bdlmxxx::Table table;
        bdlaggxxx::Aggregate tableAggregate(bdlmxxx::ElemType::BDEM_TABLE,
                                      table);
        ...
        const bdlaggxxx::Aggregate RESULT =
        ...
        LOOP2_ASSERT(i,
                     aggregateCapacity,
                     i == aggregateCapacity);
        LOOP_ASSERT(i, bdlaggxxx::Aggregate::areEquivalent(RESULT, tableAggregate));
    }
    ...
    {
        bdlmxxx::ChoiceArray choiceArray;
        bdlaggxxx::Aggregate choiceArrayAggregate(bdlmxxx::ElemType::BDEM_CHOICE_ARRAY,
                                            choiceArray);
        ...
        LOOP_ASSERT(
                  i,
                  bdlaggxxx::Aggregate::areEquivalent(RESULT, choiceArrayAggregate));
    }
    ...
    for (int i = 1; i <= 4096; i <<= 1)
    {
        ...
        LOOP_ASSERT(
                  i,
                  bdlaggxxx::Aggregate::areEquivalent(RESULT, scalarArrayAggregate));
    }

    if (verbose) cout << "Testing with a non-array type aggregate" << endl;
    {
        bdlmxxx::List list;
        bdlaggxxx::Aggregate listAggregate(bdlmxxx::ElemType::BDEM_LIST, list);

        size_t capacity = 1492;  // arbitrary flag value
        const bdlaggxxx::Aggregate RESULT = listAggregate.capacityRaw(&capacity);
        ASSERT(!bdlaggxxx::Aggregate::areEquivalent(RESULT, listAggregate));
        ASSERT(RESULT.isError());
...
static void testCase29(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
    ...
    //
    // Testing the following functions:
    //     const bdlaggxxx::Aggregate reserveRaw(size_t numItems) const;
    // --------------------------------------------------------------------
    ...
    for (int i = 1; i <= 4096; i <<= 1)
    {
        ...
        table.reserveRaw(i);
        const bdlaggxxx::Aggregate RESULT = tableAggregate.reserveRaw(i);
        LOOP_ASSERT(i, bdlaggxxx::Aggregate::areEquivalent(RESULT, tableAggregate));
    ...
    for (int i = 1; i <= 4096; i <<= 1)
    {
        ...
        bdlmxxx::ChoiceArray choiceArray(&ca);
        bdlaggxxx::Aggregate choiceArrayAggregate(bdlmxxx::ElemType::BDEM_CHOICE_ARRAY,
                                            choiceArray,
                                            &aa);
        ...
        choiceArray.reserveRaw(i);
        const bdlaggxxx::Aggregate RESULT = choiceArrayAggregate.reserveRaw(i);
        LOOP_ASSERT(
                  i,
                  bdlaggxxx::Aggregate::areEquivalent(RESULT, choiceArrayAggregate));
    ...
    for (int i = 1; i <= 4096; i <<= 1)
    {
        ...
        scalarArray.reserve(i);
        const bdlaggxxx::Aggregate RESULT = scalarArrayAggregate.reserveRaw(i);
        LOOP_ASSERT(
                  i,
                  bdlaggxxx::Aggregate::areEquivalent(RESULT, scalarArrayAggregate));
    ...
    if (verbose) cout << "Testing with a non-array type aggregate" << endl;
    {
        ...
        bdlmxxx::List list(&la);
        bdlaggxxx::Aggregate listAggregate(bdlmxxx::ElemType::BDEM_LIST, list, &aa);

        const size_t NUM_BYTES_SCALARARRAY = la.numBytesTotal();
        const size_t NUM_BYTES_AGGREGATE = aa.numBytesTotal();

        const bdlaggxxx::Aggregate RESULT = listAggregate.reserveRaw(1);
...
static void testCase28(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
        ...
        //   - For each test vector, construct a 'bdlmxxx::Schema' from the script
        //     and a bdlaggxxx::Aggregate from record "a" in the schema.
        ...
        //     const bdlaggxxx::Aggregate makeSelection(const char *newSel) const;
        //     const char *selector() const;
        //     int selectorIndex() const;
        //     int selectorId() const;
        //     int numSelections() const;
        //     const bdlaggxxx::Aggregate selection() const;
        //     bool hasField(const char *fieldName) const;
        //     template <typename VALTYPE>
        //     const bdlaggxxx::Aggregate setField(NameOrIndex    fieldOrIdx,
        //                                   const VALTYPE& value) const;
        //     const bdlaggxxx::Aggregate field(NameOrIndex fieldOrIdx) const;
        // --------------------------------------------------------------------
        ...
        for (int i = 0; i < DATA_SIZE; ++i) {
            ...
            Obj theAgg(ConstRecDefShdPtr(recA,
            ...
            for (int depth = 0; depth < EXPECTED_DEPTH; ++depth) {
                // Using 'bdem' primitives (not 'bdlaggxxx::Aggregate' methods),
...
static void testCase27(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
        ...
        //
        // Testing:
        //     const bdlaggxxx::Aggregate anonymousField(int n) const;
        //     const bdlaggxxx::Aggregate anonymousField() const;
        // --------------------------------------------------------------------
        ...
        if (verbose) tst::cout << "Testing valid calls" << bsl::endl;
        {
            ...
            for (int i = 0; i < NUM_DATA; ++i) {
                ...
                bdlaggxxx::Aggregate expected = agg.fieldByIndex(FIELD_INDEX);
                bdlaggxxx::Aggregate result = agg.anonymousField(ANON_INDEX);
                ...
                if (schema->lookupRecord("r")->numAnonymousFields() == 1) {
                    bdlaggxxx::Aggregate result2 = agg.anonymousField();
...

        {
            ...
            bdlaggxxx::Aggregate result = agg.anonymousField();
            LOOP_ASSERT(result, result.isError());
...
static void testCase26(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
        ...
        //     object of that type, then streamed back into a bdlaggxxx_aggregate
        //     holding that type.
        ...
        //     bdlaggxxx::Aggregate and compare with the original.
        //   - Stream the bdlaggxxx::Aggregate back out to another memory stream.
        //   - Compare the original and second memory stream.
        //   - Test that data that does not conform to the schema will put the
        //     stream in the invalid state set the bdlaggxxx::Aggregate to null.
        //
        // Testing:
...
//                 {   L_,   ":aCbFcGdQf :g+ha&NF"             },
            ...
            for (int i = 0; i < NUM_DATA; ++i) {
                ...
                for (; version <= MAX_VERSION; ++version) {
                    ...
                    bdlxxxx::TestOutStream out1, out2;
                    ...
                    bdlxxxx::TestInStream in1(out1.data(), out1.length());
                    ...
                    bdlxxxx::TestInStream testInStream(out2.data(), out2.length());
...
static void testCase25(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
        ...
        //
        // Testing:
        //     const bdlaggxxx::Aggregate setValue(const VALTYPE& value) const;
        //     const bdlaggxxx::Aggregate setField(NameOrIndex    fieldOrIdx1,
        //                                   const VALTYPE& value) const;
        //     int asInt() const;
        ...
        ASSERT(NI == bdltuxxx::Unset<int>::unsetValue());
        ...
        for (int i = 0; i < NUM_DATA; ++i) {
            ...
            short  SHORT_VAL  = (INT_VAL == NI ?
                                 bdltuxxx::Unset<short>::unsetValue() : INT_VAL);
            double DOUBLE_VAL = (INT_VAL == NI ?
                               bdltuxxx::Unset<double>::unsetValue() : INT_VAL+.1);
...
#           undef SIMPLE_ENUM_TEST
        ...
        ASSERT(bdltuxxx::Unset<bdlt::Date>::isUnset(dateRet)); // Invalid conversion
...
static void testCase24(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
        ...
        //
        // Concerns:
        //   - 'bdlat_TypeName::className(bdlaggxxx::Aggregate)' returns the record
        //     name for aggregates that are constrained by a record
        //     definition, and a zero pointer for aggregates that are not
        //     constrained by a record definition.
        //   - 'bdlat_TypeCategory::Select<bdlaggxxx::Aggregate>::e_SELECTION' is
        //     '0'
        //   - 'bdlat_TypeCategoryFunctions::select(bdem::Aggregate)' returns
        ...
        // - Create an 'bdlaggxxx::Aggregate' object that conforms to the root
        //   record of the schema.
        // - Call 'bdlat_TypeName::className(bdlaggxxx::Aggregate)' on each field
        //   and check for expected result.
        // - Check that
        //   'bdlat_TypeCategory::Select<bdlaggxxx::Aggregate>::e_SELECTION' is
        //   '0'.
        // - Call 'bdlat_TypeCategoryFunctions::select(bdem::Aggregate)' on
        ...
        bdlaggxxx::Aggregate mA1(schema, "r"), &A1 = mA1;
        mA1.setField("a", 4.0);
        mA1.setField("c", "22");
        mA1.setField("d", "33");
        mA1.setField("f", "c", 99);
        ...
        bdlaggxxx::Aggregate mA2(schema, "r"), &A2 = mA2;
        if (veryVerbose) P(A2);
        ...
        ASSERT(0 ==
                  bdlat_TypeCategory::Select<bdlaggxxx::Aggregate>::e_SELECTION);
        ASSERT(TC::e_SEQUENCE_CATEGORY    == TCF::select(A1));
        ASSERT(TC::e_SIMPLE_CATEGORY      == TCF::select(A1.field("a")));
        ASSERT(TC::e_SIMPLE_CATEGORY      == TCF::select(A1.field("b")));
        ASSERT(TC::e_SIMPLE_CATEGORY      == TCF::select(A1.field("c")));
        ASSERT(TC::e_SIMPLE_CATEGORY      == TCF::select(A1.field("d")));
        ASSERT(TC::e_SEQUENCE_CATEGORY    == TCF::select(A1.field("f")));
        ASSERT(TC::e_SEQUENCE_CATEGORY    == TCF::select(A1.field("g")));
        ASSERT(TC::e_CHOICE_CATEGORY      == TCF::select(A1.field("h")));
        ASSERT(TC::e_ARRAY_CATEGORY       == TCF::select(A1.field("i")));
        ASSERT(TC::e_ARRAY_CATEGORY       == TCF::select(A1.field("j")));
        ASSERT(TC::e_ARRAY_CATEGORY       == TCF::select(A1.field("k")));
        ASSERT(TC::e_ENUMERATION_CATEGORY == TCF::select(A1.field("m")));
        ASSERT(TC::e_ENUMERATION_CATEGORY == TCF::select(A1.field("n")));
        ASSERT(TC::e_ARRAY_CATEGORY       == TCF::select(A1.field("o")));
        ASSERT(TC::e_ARRAY_CATEGORY       == TCF::select(A1.field("p")));
        ASSERT(TC::e_ARRAY_CATEGORY       == TCF::select(A1.field("q")));
        ...
        bdlaggxxx::Aggregate mB(schema, "r"); const bdlaggxxx::Aggregate& B = mB;
        ...
        bdlaggxxx::Aggregate mA2i(A2.field("i"));
        AF::manipulateElement(&mA2i, theManipulator, 1);
        ...
        bdlaggxxx::Aggregate mA2j(A2.field("j"));
        AF::manipulateElement(&mA2j, theManipulator, 0);
        ...
        bdlaggxxx::Aggregate mA2k(A2.field("k"));
        AF::manipulateElement(&mA2k, theManipulator, 0);
        ...
        ASSERT(! NVF::IsNullableValue<bdlaggxxx::Aggregate>::VALUE);
        ASSERT(NVF::IsNullableValue<NullableAdapter>::VALUE);
        bdlaggxxx::Aggregate mA1b(A1.field("b"));
        NullableAdapter nmA1b  = { &mA1b };
        ASSERT(NVF::isNull(nmA1b));
        bdlaggxxx::Aggregate mA1g(A1.field("g"));
        NullableAdapter nmA1g  = { &mA1g };
        ASSERT(!NVF::isNull(nmA1g));
        bdlaggxxx::Aggregate mA1gd(A1.field("g", "d"));
        NullableAdapter nmA1gd = { &mA1gd };
        ASSERT(! NVF::isNull(nmA1gd));
        NVF::accessValue(nmA1gd, theAccessor);
        ASSERT(theAccessor.matchValue(888));
        ...
        bdlaggxxx::Aggregate mA2b(A2.field("b"));
        NullableAdapter nmA2b  = { &mA2b };
        ASSERT(NVF::isNull(nmA2b));
        NVF::manipulateValue(&nmA2b, theManipulator);
        ASSERT(! NVF::isNull(nmA2b));
        ASSERT(114 == mA2b.asDouble());
        // Note: mA2b is a COPY.  A2.field("b") is still null.
        bdlaggxxx::Aggregate mA2g(A2.field("g"));
        NullableAdapter nmA2g  = { &mA2g };
        ASSERT(NVF::isNull(nmA2g));
        mA2g.makeNull();
        NVF::makeValue(&nmA2g);
        ...
        bdlaggxxx::Aggregate mA2m(A2.field("m")); const bdlaggxxx::Aggregate &A2m = mA2m;
        int status;
        ...
        bdlaggxxx::Aggregate mA2n(A2.field("n")); const bdlaggxxx::Aggregate &A2n = mA2n;
        ...
        if (verbose) tst::cout << "Testing bdlat_ValueTypeFunctions on STRING"
                               << bsl::endl;
        bdlaggxxx::Aggregate mA3d(A1["d"].clone());
        const bdlaggxxx::Aggregate& A3d = mA3d;
        ASSERT("33" == A3d.asString());
        bdlat_ValueTypeFunctions::reset(&mA3d);
        ASSERT(ET::BDEM_STRING == A3d.dataType());
        LOOP_ASSERT(A3d.asString(), "vee" == A3d.asString());
        bdlat_ValueTypeFunctions::assign(&mA3d, A1["c"]);
        ASSERT("22" == A3d.asString());
        ...
        bdlaggxxx::Aggregate mA4(schema, "r"); const bdlaggxxx::Aggregate& A4 = mA4;
        ASSERT(! bdlaggxxx::Aggregate::areEquivalent(A1, A4));
...
static void testCase23(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
        ...
        //     'bdlmxxx::SchemaAggregateUtil::initListDeep' function after checking
        ...
        //
        // Testing:
        //   bdlaggxxx::Aggregate makeValue() const;
        // --------------------------------------------------------------------
        ...
        for (int i = 0; i < NUM_DATA; ++i) {
            ...
            const bdlmxxx::FieldDef& FIELD_DEF = RECORD->field(0);
            ET::Type TYPE = NSA
                        ? ET::toArrayType(SCHEMA.record(1).field(0).elemType())
                        : RECORD->field(0).elemType();
            const char *fldName     = RECORD->fieldName(0);
         ...
         BSLMA_TESTALLOCATOR_EXCEPTION_TEST_BEGIN(testAllocator) {
            ...
            if (ET::isScalarType(TYPE) && HAS_DEFAULT) {
                ...
                const bdlmxxx::ElemRef&   ELEM_REF   = Y.asElemRef();
                const bdlmxxx::RecordDef& CONSTRAINT = SCHEMA.record(0);
                ...
                const bdlmxxx::Table& T = Y.asElemRef().theTable();
...
static void testCase22(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
        ...
        //
        // Testing:
        //   bdlaggxxx::Aggregate clone(bslma::Allocator *basicAllocator) const;
        //   bdlaggxxx::Aggregate cloneData(bslma::Allocator *basicAllocator) const;
        // --------------------------------------------------------------------
...
static void testCase21(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
        ...
        //
        // Testing:
        //   bdlaggxxx::Aggregate(const bdlaggxxx::Aggregate&  other,
        //                  bslma::Allocator      *basicAllocator);
        // --------------------------------------------------------------------
...
static void testCase20(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
        ...
        //
        // Testing:
        //   bdlaggxxx::Aggregate makeSelectionById(int newSelectorId) const;
        //   template <typename VALTYPE>
        //   bdlaggxxx::Aggregate makeSelectionById(int            newSelectorId,
        //                                    const VALTYPE& value) const;
        //   int selectorId() const;
...
static void testCase19(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
        ...
        //  bdlaggxxx::Aggregate makeSelection(const bsl::string& newSelector,
        //                               const VALTYPE&     value) const;
        //  bdlaggxxx::Aggregate selection() const;
        //  const char *selector() const;
        //
        //  Private functions:
        //    bdlaggxxx::Aggregate makeSelectionByIndex(int selectorIndex) const;
        //    template <typename VALTYPE>
        //    bdlaggxxx::Aggregate makeSelectionByIndex(int            selectorIndex,
        //                                        const VALTYPE& value) const;
        //    void initField(void *data, const bdlmxxx::FieldDef& fieldDef);
        // --------------------------------------------------------------------
                               ...
                               << "\n=========================" << bsl::endl;
        {
            ...
            for (int i = 0; i < NUM_DATA; ++i) {
                ...
                ASSERT(bdlmxxx::ElemType::BDEM_VOID == N.dataType());
...
static void testCase17(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
                                     ...
                                     << bsl::endl; }
        {
            ...
            for (int i = 0; i < NUM_DATA; ++i) {
                ...
                bdlmxxx::List theList;  const bdlmxxx::List& THE_LIST = theList;
...
static void testCase16(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
        ...
        //     data types (and just use a bdlmxxx::ConstElemRef to store the
        ...
        // Testing:
        //   template <typename VALTYPE>
        //   const bdlaggxxx::Aggregate append(const VALTYPE& newItem) const;
        //   const bdlaggxxx::Aggregate appendNull(const VALTYPE& newItem) const;
        //   template <typename VALTYPE>
        //   const bdlaggxxx::Aggregate insert(int            pos,
        //                               const VALTYPE& newItem) const;
        //   const bdlaggxxx::Aggregate insertNull(int pos) const;
        // --------------------------------------------------------------------
...
static void testCase13(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
        ...
        //
        // Testing:
        //   bdlaggxxx::Aggregate operator[](int index) const;
        //   int length() const;
        //   int size() const;
        // --------------------------------------------------------------------
...
static void testCase12(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
        ...
        //
        // Testing:
        //   bdem::Aggregate& operator=(const bdem::Aggregate& rhs);
        // --------------------------------------------------------------------
...
static void testCase11(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
        ...
        //   'bdlmxxx::SchemaAggregateUtil::print' function.  So we can just test
        ...
        //   ostream& operator<<(ostream&, const bdlaggxxx::Aggregate&);
        // --------------------------------------------------------------------
                                   ...
                                   << "\n\tTest aggregate values" << bsl::endl;
        {
            ...
            for (int i = 0; i < NUM_DATA; ++i) {
                ...
                if (ET::BDEM_LIST == TYPE) {
                    ...
                    const CERef CL(&list, &bdlmxxx::ListImp::s_listAttr);
                    const CERef CT(&table, &bdlmxxx::TableImp::s_tableAttr);
                    ...
                    const CERef CC(&choice, &bdlmxxx::ChoiceImp::s_choiceAttr);
...
static void testCase10(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
    // Execute the test case for creating instances of 'bdlaggxxx::Aggregate'.  Note
    ...
    //
    // Testing:
    //   bdlaggxxx::Aggregate(bslma::Allocator *basicAllocator);
    //   template <typename VALTYPE>
    //       bdlaggxxx::Aggregate(const ET::Type    dataType,
    //                      const VALTYPE&    value,
    //                      bslma::Allocator *basicAllocator);
    //   explicit bdlaggxxx::Aggregate(const ConstRecDefShdPtr&  recordDefPtr,
    //                           bslma::Allocator         *basicAllocator);
    //   explicit bdlaggxxx::Aggregate(const RecDefShdPtr&  recordDefPtr,
    //                           bslma::Allocator    *basicAllocator);
    //   bdlaggxxx::Aggregate(const ConstRecDefShdPtr&  recordDefPtr,
    //                  ET::Type                  elemType,
    //                  bslma::Allocator         *basicAllocator);
    //   bdlaggxxx::Aggregate(const RecDefShdPtr&  recordDefPtr,
    //                  ET::Type             elemType,
    //                  bslma::Allocator    *basicAllocator);
    //   bdlaggxxx::Aggregate(const ConstSchemaShdPtr&  schemaPtr,
    //                  const bsl::string&        recordName,
    //                  ET::Type                  elemType,
    //                  bslma::Allocator         *basicAllocator);
    //   bdlaggxxx::Aggregate(const SchemaShdPtr&  schemaPtr,
    //                  const bsl::string&   recordName,
    //                  ET::Type             elemType,
    //                  bslma::Allocator    *basicAllocator);
    //   ~bdlaggxxx::Aggregate();
                           ...
                           << bsl::endl;
    {
        for (int i = 0; i < ET::BDEM_NUM_TYPES; ++i) {
            ...
            bdlmxxx::Convert::convert(&sa, CEA);
            ...
            BSLMA_TESTALLOCATOR_EXCEPTION_TEST_BEGIN(testAllocator) {
                // Test constructor that are explicitly supplied a ctor
                {
                    ...
                    if (ET::BDEM_LIST == TYPE) {
                        ...
                        bdlmxxx::SchemaAggregateUtil::initListDeep(&list, *RECORD);
                        bdlmxxx::SchemaAggregateUtil::initTable(&table, *RECORD);
                        ...
                        bdlmxxx::SchemaAggregateUtil::initChoice(&choice, *RECORD);
                        bdlmxxx::SchemaAggregateUtil::initChoiceArray(&choiceArray,
                                                                  *RECORD);
        ...
        for (int i = 0; i < NUM_DATA; ++i) {
            ...
            if (ET::BDEM_LIST == TYPE) {
                ...
                BSLMA_TESTALLOCATOR_EXCEPTION_TEST_BEGIN(testAllocator) {
                    ...
                    ASSERT(LIST       == A.asElemRef().theList());
                    ASSERT(LIST       == B.asElemRef().theList());
                    ASSERT(*ROW.get() == C.asElemRef().theList().row());
                    ASSERT(*ROW.get() == D.asElemRef().theList().row());
...
static void testCase9(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
        ...
        //
        // Testing:
        //   bool areIdentical(const bdlaggxxx::Aggregate&, const bdlaggxxx::Aggregate&);
        //   bool areEquivalent(const bdlaggxxx::Aggregate&, const bdlaggxxx::Aggregate&);
        // --------------------------------------------------------------------
...
static void testCase8(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
        ...
        //   bdlaggxxx::Aggregate fieldById(int fieldId) const;
...
static void testCase7(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
        ...
        //     correct type (bdlmxxx::ConstElemRef and bdlmxxx::ElemRef).
        ...
        //
        // Testing:
        //   bdlmxxx::ElemRef asElemRef();
        //   bsl::string asString() const;
        //   bdlmxxx::ConstElemRef asElemRef() const;
                                   ...
                                   << endl; }
        {
            for (int i = 0; i < ET::BDEM_NUM_TYPES; ++i) {
                ...
                const bdlmxxx::ElemRef ER = X.asElemRef();
        ...
        if (veryVerbose) { T_ cout << "Testing for aggregates" << endl; }
        {
            ...
            for (int i = 0; i < NUM_DATA; ++i) {
                ...
                const bdlmxxx::ElemRef ERX = X.asElemRef();
                LOOP_ASSERT(LINE, !ERX.isNull());

                bdlaggxxx::Aggregate mA = X.field(fldName);
                const bdlaggxxx::Aggregate& A = mA;

                const bdlmxxx::ElemRef ERA = A.asElemRef();
...
static void testCase6(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
        ...
        //   'convertScalar' itself just calls 'bdlmxxx::Convert::fromBdemType'.
        ...
        if (veryVerbose) { T_ cout << "Test error message output" << endl; }
        {
            ...
            ASSERT(0 == X.asChar());
            ASSERT(bdltuxxx::Unset<bdlt::Datetime>::isUnset(Y.asDatetime()));
        }
}
...
static void testCase5(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
        ...
        // Testing:
        //   bool hasField(const char *fieldName) const;
        //   bdlaggxxx::Aggregate field(NameOrIndex fieldOrIdx) const;
        //   bdlaggxxx::Aggregate field(NameOrIndex fieldOrIdx1,
        //                        NameOrIndex fieldOrIdx2,
        //                        NameOrIndex fieldOrIdx3 = NameOrIndex(),
        //                        NameOrIndex fieldOrIdx4 = NameOrIndex(),
        //                        NameOrIndex fieldOrIdx5 = NameOrIndex(),
        ...
        //             NameOrIndex fieldOrIdx9 = NameOrIndex(),
        //             NameOrIndex fieldOrIdx10 = NameOrIndex()) const;
        //   bdlmxxx::ElemRef fieldRef(NameOrIndex fieldOrIdx1,
        //                         NameOrIndex fieldOrIdx2 = NameOrIndex(),
        //                         NameOrIndex fieldOrIdx3 = NameOrIndex(),
        //                         NameOrIndex fieldOrIdx4 = NameOrIndex(),
        //                         NameOrIndex fieldOrIdx5 = NameOrIndex(),
        ...
        //   bdlaggxxx::Aggregate operator[](const char *fieldOrIdx) const;
        //   bdlaggxxx::Aggregate operator[](const bsl::string &fieldOrIdx) const;
        // --------------------------------------------------------------------
...
static void testCase3(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
        ...
        //      bdlmxxx::ConstElemRef, a bdlmxxx::ElemRef or as an aggregate.
        //
        // Plan:
        //   Note that this function after performing error checking calls the
        //   'bdlmxxx::Convert::toBdemType' function to set the value.  Thus we
        ...
        //   bdlmxxx::ConstElemRef, bdlmxxx::ElemRef, bdlaggxxx::Aggregate and a value of
        //   that type.
        //
        ...
        //   bool bdlaggxxx::Aggregate::descendIntoField(
        //                             bdlaggxxx::Aggregate_NameOrIndex fieldOrIdx);
        // --------------------------------------------------------------------
                                     ...
                                     << bsl::endl; }
        {
            ...
            for (int i = 0; i < NUM_DATA; ++i) {
                ...
                // Test setField with bdlmxxx::ConstElemRef and bdlmxxx::ElemRef
                ...
                // Test setValue with bdlmxxx::ConstElemRef and bdlmxxx::ElemRef
                bdlaggxxx::Aggregate mXfld(X.field(fldName));
                const bdlaggxxx::Aggregate& Xfld = mXfld;
                Xfld.setValue(CEA);
...
static void testCase2(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
        ...
        //   bdlmxxx_binding.t.cpp, the test cases for them were also copied from
        //   that test driver.
        // --------------------------------------------------------------------
        // TESTING HELPER FUNCTIONS
        //   Verify that the helper functions used to create instances of
        //   'bdlmxxx::Schema', 'bdlmxxx::List', and 'bdlmxxx::Table' work correctly.
        //
        // Concerns:
        ...
        //   function 'gg' in 'bdlmxxx_schema'.  First, the test case verifies
        //   that, given a spec, the 'ggSchema' function creates a valid
        //   'bdlmxxx::Schema'.  Then we check that the 'ggList' and
        //   'ggTable' methods create correct 'bdlmxxx::List' and 'bdlmxxx::Table'
        //   instances, respectively, from records in that 'bdlmxxx::Schema'.
        //
        ...
        //
        //   After 'bdlmxxx::Schema' creation, use records in that schema to create
        //   instances of 'bdlmxxx::List' and 'bdlmxxx::Table' using the 'ggList'
        ...
        //   the corresponding 'bdlmxxx::Schema' records.
        //
        // Testing:
        //   void ggSchema(bdlmxxx::Schema *schema, const char *spec);
        //   void ggList(bdlmxxx::List *list, const bdlmxxx::RecordDef *record);
        //   void ggTable(bdlmxxx::Table *table, const bdlmxxx::RecordDef *record);
        // --------------------------------------------------------------------
...
static void testCase1(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
        ...
        if (verbose) tst::cout << "Testing scalar constructors" << bsl::endl;
        {
            ...
            bdlaggxxx::Aggregate agg1;
            ASSERT(agg1.dataType() == ET::BDEM_VOID);
            ASSERT(agg1.isNul2());
            if (verbose) P(agg1);

            bdlaggxxx::Aggregate agg2(ET::BDEM_INT, 55, &ta);
            ...
            bdlaggxxx::Aggregate agg3(ET::BDEM_STRING, "", &ta);
        ...
        bsl::shared_ptr<bdlmxxx::Schema> schema(new(sa) bdlmxxx::Schema(&sa), &sa);

        bdlmxxx::RecordDef *level2 = schema->createRecord("Level2");
        level2->appendField(ET::BDEM_STRING_ARRAY, "StringArray2.1");
        bdlmxxx::FieldDefAttributes doubleArrayAttr(ET::BDEM_DOUBLE_ARRAY);
        ...
        bdlmxxx::RecordDef *level1 = schema->createRecord("Level1");
...

        {
            ...
            if (verbose) tst::cout << "Testing record def constructor"
                                   << bsl::endl;
            bdlaggxxx::Aggregate agg1(schema, "Level1", ET::BDEM_VOID, &ta);
            ASSERT(! agg1.isNul2());
            ...
            bdlt::Date date1 = agg1.field("List1.3", "Date2.3").asDate();
            ASSERT(2006 == date1.year());

            bdlaggxxx::Aggregate agg2(bdlmxxx::ElemType::BDEM_DATE, "1996-04-05");
            bdlaggxxx::Aggregate agg3 = agg1.field("List1.3");
            agg3.setField("Date2.3", agg2);
            bdlt::Date date2 = agg1.field("List1.3", "Date2.3").asDate();
            ...
            bdlaggxxx::Aggregate agg4 = agg1.field("List1.3", "StringArray2.1");
            agg4.resize(2);
            ...
            bdlaggxxx::Aggregate dblArray = agg1.field("List1.3", "DoubleArray2.2");
        ...
        bdlmxxx::RecordDef *table1Row = schema->createRecord("Table1Row");
...

        {
            ...
            bdlaggxxx::Aggregate agg1(schema, "Table1Row", ET::BDEM_TABLE, &ta);
            ASSERT(ET::BDEM_TABLE == agg1.dataType());
            ASSERT(0 == agg1.length());

            static const double nullDouble = bdltuxxx::Unset<double>::unsetValue();
            ...
            bdlaggxxx::Aggregate agg1Row;
            ASSERT(bdlmxxx::ElemType::BDEM_VOID == agg1Row.dataType());
            agg1Row = agg1[1];
            ASSERT(!agg1Row.isNul2());
            ASSERT(bdlmxxx::ElemType::BDEM_ROW == agg1Row.dataType());
            ASSERT("Goodbye" == agg1Row.field("StringField").asString());
            ASSERT(nullDouble == agg1Row.field("DoubleField").asDouble());
            if (veryVerbose) P(agg1);

            agg1Row = bdlaggxxx::Aggregate(schema, "Table1Row");
        ...
        bdlmxxx::RecordDef *choice1 = schema->createRecord(
            "Choice1", bdlmxxx::RecordDef::BDEM_CHOICE_RECORD);
...

        {
            ...
            bdlaggxxx::Aggregate agg1(schema, "Choice1", ET::BDEM_CHOICE, &ta);
...

        {
            ...
            bsl::shared_ptr<bdlmxxx::RecordDef> lev1(schema, level1);
            bsl::shared_ptr<const bdlmxxx::RecordDef> lev1c(schema, level1);
            bsl::shared_ptr<bdlmxxx::RecordDef> ch1(schema, choice1);
            bsl::shared_ptr<const bdlmxxx::RecordDef> ch1c(schema, choice1);

            if (veryVerbose)
                tst::cout << "Testing bdlaggxxx::Aggregate(recordDefPtr)"
                          << bsl::endl;

            // list record (const)
            bdlaggxxx::Aggregate aggLev1c(lev1c);
            ASSERT(aggLev1c.dataType() == ET::BDEM_LIST);
            ASSERT(! aggLev1c.isNul2());
            ASSERT(ET::BDEM_STRING == aggLev1c.fieldById(0).dataType());
            ASSERT(aggLev1c.recordDefPtr().get() == level1);
            if (veryVerbose) P(aggLev1c);

            // list record - non-const (same as const)
            bdlaggxxx::Aggregate aggLev1(lev1);
            ASSERT(aggLev1.dataType() == ET::BDEM_LIST);
            ASSERT(! aggLev1.isNul2());
            ASSERT(aggLev1.recordDefPtr().get() == level1);
            ASSERT(! Obj::areIdentical(aggLev1, aggLev1c));
            ASSERT(  Obj::areEquivalent(aggLev1, aggLev1c));

            // choice record (const)
            bdlaggxxx::Aggregate aggCh1c(ch1c);
            ASSERT(aggCh1c.dataType() == ET::BDEM_CHOICE);
            aggCh1c.makeSelection(bsl::string("IdSelection"), 3);
            ASSERT(3 == aggCh1c.selection().asInt());
            ASSERT(aggCh1c.recordDefPtr().get() == choice1);
            if (veryVerbose) P(aggCh1c);

            // choice record non-const (same as const)
            bdlaggxxx::Aggregate aggCh1(ch1);
            ASSERT(aggCh1.dataType() == ET::BDEM_CHOICE);
            ASSERT(aggCh1.recordDefPtr().get() == choice1);
            ...
            if (veryVerbose)
                tst::cout << "Testing bdlaggxxx::Aggregate(recordDefPtr, elemType)"
                          << bsl::endl;

            // table record (const)
            bdlaggxxx::Aggregate tblLev1c(lev1c, ET::BDEM_TABLE);
            ASSERT(tblLev1c.dataType() == ET::BDEM_TABLE);
            ASSERT(tblLev1c.recordDefPtr().get() == level1);
            ...
            bdlaggxxx::Aggregate tblLev1(lev1, ET::BDEM_TABLE);
            ASSERT(tblLev1.recordDefPtr().get() == level1);
            ...
            bdlaggxxx::Aggregate arrCh1c(ch1c, ET::BDEM_CHOICE_ARRAY);
            ASSERT(arrCh1c.dataType() == ET::BDEM_CHOICE_ARRAY);
            ASSERT(arrCh1c.recordDefPtr().get() == choice1);
            ...
            bdlaggxxx::Aggregate arrCh1(ch1, ET::BDEM_CHOICE_ARRAY);
            ASSERT(arrCh1.recordDefPtr().get() == choice1);
        ...
        if (verbose) tst::cout << "Testing clone" << bsl::endl;
        {
            ...
            bslma::DefaultAllocatorGuard allocGuard(&da);
            bdlaggxxx::Aggregate agg1(schema, recName, ET::BDEM_VOID, &ta1);
            agg1.setField("Double1.2", 3.4);
            agg1.setField("List1.3", "Date2.3", "2006-02-16");
            agg1.field("List1.4").makeValue();
            agg1.setField("List1.4", "String1.1", "List in list");
            ...
            ASSERT(0 == da.numBlocksInUse());
            {
                bdlaggxxx::Aggregate agg2(agg1.clone(&ta2));
            ...
            {
                bdlaggxxx::Aggregate agg2(agg1.cloneData(&ta2));
