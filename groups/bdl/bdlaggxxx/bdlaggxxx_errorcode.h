...
//
//@CLASSES:
//  bdlaggxxx::ErrorCode: namespace for errors associated with 'bcem' types
//
//@SEE_ALSO: bdlaggxxx_errorattributes, bdlaggxxx_aggregate
//
//@AUTHOR: Rohan Bhindwale (rbhindwa)
//
//@DESCRIPTION: This component provides a namespace for the 'enum' type
// 'bdlaggxxx::ErrorCode::Code', which enumerates the set of error codes that users
...
struct ErrorCode {
  ...
  public:
    ...
    static const char *toAscii(ErrorCode::Code value);
...
// FREE OPERATORS
bsl::ostream& operator<<(bsl::ostream& stream, ErrorCode::Code value);
}  // close package namespace
    // Write the string representation of the specified enumeration 'value' to
    // the specified output 'stream' in a single-line format, and return a
    // reference to 'stream'.  See 'toAscii' for what constitutes the string
    // representation of a 'bdlaggxxx::ErrorCode::Code' value.  Note that
...
// FREE OPERATORS
inline
bsl::ostream& bdlaggxxx::operator<<(bsl::ostream& stream, ErrorCode::Code value)
{
