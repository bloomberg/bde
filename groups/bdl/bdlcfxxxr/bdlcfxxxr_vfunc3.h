// bdlcfxxxr_vfunc3.h               -*-C++-*-
#ifndef INCLUDED_BDLCFXXXR_VFUNC3
#define INCLUDED_BDLCFXXXR_VFUNC3
...
//
//@CLASSES:
//   bdlcfxxxr::Vfunc3: thread-safe reference-counted base class with an allocator
//
...
// class for all internal representations of the 'bdlcfxxx::Vfunc3' family of
...
// reflect the number of 'bdlcfxxx::Vfunc3' objects (envelopes) or other partial
...
// information about the details of the 'bdlcfxxxr::Vfunc3' object memory management
...
// classes derived from 'bdlcfxxxr::Vfunc3' to declare destructor 'private' and
...
//..
// Instantiate a 'ConcreteDerivedClass' class derived from 'bdlcfxxxr::Vfunc3'.
//..
//   template <class A1, class A2, class A3>
//   class ConcreteDerivedClass : public bdlcfxxxr::Vfunc3 <A1, A2, A3> {
//     public:
//       ConcreteDerivedClass(bslma::Allocator *basicAllocator)
//       : bdlcfxxxr::Vfunc3(basicAllocator) { }
//
...
// bdlcfxxxr::Vfunc3<A1, A2, A3>
//..
//   template <class A1, class A2, class A3>
//   class EnvelopeClass {
//       // Provide an object that encapsulates a 'bdlcfxxxr::Vfunc3' object.
//
//       bdlcfxxxr::Vfunc3<A1, A2, A3> *d_rep_p;
//           // polymorphic functor representation
//
//     public:
//       // CREATORS
//       EnvelopeClass(bdlcfxxxr::Vfunc3<A1, A2, A3> *rep) : d_rep_p(rep)
...
//           // representation using 'deleteObject' method of 'bdlcfxxxr::Vfunc3'
//           // class.
//       {
//           if (0 == d_rep_p->decrement()) {
//               bdlcfxxxr::Vfunc3<A1, A2, A3>::deleteObject(d_rep_p);
//           }
//       }
//
//
...
//   dtorUsageCounter = 0;
//
//   typedef ConcreteDerivedClass<int, int, int> DerivedObj;
//   typedef bdlcfxxxr::Vfunc3<int, int, int> Obj;
...
//       EnvelopeClass<int, int, int> env1(x);
//       // The reference counter is 1
//       env1(3, 4, 5);        ASSERT(1 == executeUsageCounter);
//       {
//           EnvelopeClass<int, int, int> env1(x);
//           // The reference counter is 2
//           env1(5, 7, 9);    ASSERT(2 == executeUsageCounter);
//       }
//       // The reference counter is 1
...
class Vfunc3 {
    ...
    // facilitates the use of 'Vfunc3' as a reference-counted letter
    // class in the envelope-letter pattern.  'deleteObject' is used to to
    // destroy and deallocate the concrete objects derived from 'Vfunc3',
  ...
  private:
    Vfunc3(const Vfunc3&);                  // not implemented
    Vfunc3& operator=(const Vfunc3&);       // not implemented
  ...
  public:
    // CLASS METHODS
    static void deleteObject(Vfunc3 *object);
    ...
    // CREATORS
    Vfunc3(bslma::Allocator *basicAllocator);
...
// PROTECTED CREATORS
template <class A1, class A2, class A3>
inline Vfunc3<A1, A2, A3>::~Vfunc3()
{
}

// CLASS METHODS
template <class A1, class A2, class A3>
void Vfunc3<A1, A2, A3>::deleteObject(Vfunc3 *object)
{
    object->~Vfunc3();
