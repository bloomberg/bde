...
//                              Overview
//                              --------
// 'bdlcfxxxr::Vfunc4' is an abstract class that provides a pure virtual function
...
//
//-----------------------------------------------------------------------------
// [ 2] bdlcfxxxr::Vfunc4<A1-4>(bslma::Allocator *ba);
// [ 2] void increment();
// [ 2] int decrement();
// [ 2] void execute(c_A1-4&) const;
// [ 2] ~bdlcfxxxr::Vfunc4<A1-4>();
// [ 2] static void deleteObject(bdlcfxxxr::Vfunc4 *object);
//-----------------------------------------------------------------------------
...
class ConcreteDerivedClass : public bdlcfxxxr::Vfunc4 <A1, A2, A3, A4> {
  public:
    ...
    virtual void execute(const A1& argument1, const A2& argument2,
        ...
        //
        // This function tests that the 'execute' method of 'bdlcfxxxr::Vfunc4' is
...
class EnvelopeClass {
  ...
  public:
    ...
    ~EnvelopeClass()
        ...
        // representation using 'deleteObject' method of 'bdlcfxxxr::Vfunc4' class.
    {
        if (0 == d_rep_p->decrement()) {
            bdlcfxxxr::Vfunc4<A1, A2, A3, A4>::deleteObject(
                                                                     d_rep_p);
        }
    }
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 2: {
        ...
        //
        // Testing:
        //   bdlcfxxxr::Vfunc4<A1-4>(bslma::Allocator *ba);
        //   void increment();
        //   int decrement();
        //   void execute(c_A1-4&) const;
        //   static void deleteObject(bdlcfxxxr::Vfunc4 *object);
        //   ~bdlcfxxxr::Vfunc4<A1-4>();
        // --------------------------------------------------------------------
