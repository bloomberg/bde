...
//                              Overview
//                              --------
// 'bdlcfxxxr::Vfunc5' is an abstract class that provides a pure virtual function
...
//
//-----------------------------------------------------------------------------
// [ 2] bdlcfxxxr::Vfunc5<A1-5>(bslma::Allocator *ba);
// [ 2] void increment();
// [ 2] int decrement();
// [ 2] void execute(c_A1-5&) const;
// [ 2] ~bdlcfxxxr::Vfunc5<A1-5>();
// [ 2] static void deleteObject(bdlcfxxxr::Vfunc5 *object);
//-----------------------------------------------------------------------------
...
class ConcreteDerivedClass : public bdlcfxxxr::Vfunc5 <A1, A2, A3, A4, A5> {
  public:
    ...
    virtual void execute(const A1& argument1, const A2& argument2,
        ...
        //
        // This function tests that the 'execute' method of 'bdlcfxxxr::Vfunc5' is
...
class EnvelopeClass {
  ...
  public:
    ...
    ~EnvelopeClass()
        ...
        // representation using 'deleteObject' method of 'bdlcfxxxr::Vfunc5' class.
    {
        if (0 == d_rep_p->decrement()) {
            bdlcfxxxr::Vfunc5<A1, A2, A3, A4, A5>::deleteObject(
                                                                     d_rep_p);
        }
    }
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 2: {
        ...
        //
        // Testing:
        //   bdlcfxxxr::Vfunc5<A1-5>(bslma::Allocator *ba);
        //   void increment();
        //   int decrement();
        //   void execute(c_A1-5&) const;
        //   static void deleteObject(bdlcfxxxr::Vfunc5 *object);
        //   ~bdlcfxxxr::Vfunc5<A1-5>();
        // --------------------------------------------------------------------
