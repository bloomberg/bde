// bdlcfxxxr_vfunc5.h               -*-C++-*-
#ifndef INCLUDED_BDLCFXXXR_VFUNC5
#define INCLUDED_BDLCFXXXR_VFUNC5
...
//
//@CLASSES:
//   bdlcfxxxr::Vfunc5: thread-safe reference-counted base class with an allocator
//
...
// class for all internal representations of the 'bdlcfxxx::Vfunc5' family of
...
// reflect the number of 'bdlcfxxx::Vfunc5' objects (envelopes) or other partial
...
// information about the details of the 'bdlcfxxxr::Vfunc5' object memory management
...
// classes derived from 'bdlcfxxxr::Vfunc5' to declare destructor 'private' and
...
//..
// Instantiate a 'ConcreteDerivedClass' class derived from 'bdlcfxxxr::Vfunc5'.
//..
//   template <class A1, class A2, class A3, class A4, class A5>
//   class ConcreteDerivedClass : public bdlcfxxxr::Vfunc5 <A1, A2, A3, A4, A5>
//   {
//     public:
//       ConcreteDerivedClass(bslma::Allocator *basicAllocator)
//       : bdlcfxxxr::Vfunc5(basicAllocator) { }
//
...
// bdlcfxxxr::Vfunc5<A1, A2, A3, A4, A5>
//..
//   template <class A1, class A2, class A3, class A4, class A5>
//   class EnvelopeClass {
//       // Provide an object that encapsulates a 'bdlcfxxxr::Vfunc5' object.
//
...
//     public:
//       // CREATORS
//       EnvelopeClass(bdlcfxxxr::Vfunc5<A1, A2, A3, A4, A5> *rep) :
//           d_rep_p(rep)
...
//           // representation using 'deleteObject' method of 'bdlcfxxxr::Vfunc5'
//           // class.
//       {
...
//   typedef bdlcfxxxr::Vfunc5<int, int, int, int, int> Obj;
...
class Vfunc5 {
    ...
    // destroy and deallocate the concrete objects derived from 'Vfunc5',
