...
//                              Overview
//                              --------
// 'bdlcfxxxr::Vfunc1' is an abstract class that provides a pure virtual function
...
//
// In order to test 'bdlcfxxxr::Vfunc1' we have to implement a concrete class
...
//
//-----------------------------------------------------------------------------
// [ 2] bdlcfxxxr::Vfunc1<A1>(bslma::Allocator *ba);
// [ 2] void increment();
// [ 2] int decrement();
// [ 2] void execute(c_A1&) const;
// [ 2] ~bdlcfxxxr::Vfunc1<A1>();
// [ 2] static void deleteObject(bdlcfxxxr::Vfunc1 *object);
//-----------------------------------------------------------------------------
...
template <class A1>
class ConcreteDerivedClass : public bdlcfxxxr::Vfunc1 <A1> {
  public:
    ...
    virtual void execute(const A1& argument1) const
        ...
        //
        // This function tests that the 'execute' method of 'bdlcfxxxr::Vfunc1' is
...
template <class A1>
class EnvelopeClass {
    // Provide an object that encapsulates a 'bdlcfxxxr::Vfunc1' object.

    bdlcfxxxr::Vfunc1<A1> *d_rep_p;  // polymorphic functor representation

  public:
    // CREATORS
    EnvelopeClass(bdlcfxxxr::Vfunc1<A1> *rep) : d_rep_p(rep)
    ...
    ~EnvelopeClass()
        ...
        // representation using 'deleteObject' method of 'bdlcfxxxr::Vfunc1' class.
    {
        if (0 == d_rep_p->decrement()) {
            bdlcfxxxr::Vfunc1<A1>::deleteObject(d_rep_p);
        }
    }
...
typedef bdlcfxxxr::Vfunc1<int> Obj;
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      case 4: {
                          ...
                          << "=====================" << endl;
        {
            ...
            Obj *x = new(*myAllocator) DerivedObj(myAllocator);
            {
                ...
                env1(3);        ASSERT(1 == executeUsageCounter);
      ...
      case 2: {
        ...
        //
        // Testing:
        //   bdlcfxxxr::Vfunc1<A1>(bslma::Allocator *ba);
        //   void increment();
        //   int decrement();
        //   void execute(c_A1&) const;
        //   static void deleteObject(bdlcfxxxr::Vfunc1 *object);
        //   ~bdlcfxxxr::Vfunc1<A1>();
        // --------------------------------------------------------------------
