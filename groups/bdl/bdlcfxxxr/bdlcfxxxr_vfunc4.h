// bdlcfxxxr_vfunc4.h               -*-C++-*-
#ifndef INCLUDED_BDLCFXXXR_VFUNC4
#define INCLUDED_BDLCFXXXR_VFUNC4
...
//
//@CLASSES:
//   bdlcfxxxr::Vfunc4: thread-safe reference-counted base class with an allocator
//
...
// class for all internal representations of the 'bdlcfxxx::Vfunc4' family of
...
// reflect the number of 'bdlcfxxx::Vfunc4' objects (envelopes) or other partial
...
// information about the details of the 'bdlcfxxxr::Vfunc4' object memory management
...
// classes derived from 'bdlcfxxxr::Vfunc4' to declare destructor 'private' and
...
//..
// Instantiate a 'ConcreteDerivedClass' class derived from 'bdlcfxxxr::Vfunc4'.
//..
//   template <class A1, class A2, class A3, class A4>
//   class ConcreteDerivedClass : public bdlcfxxxr::Vfunc4 <A1, A2, A3, A4>
//   {
//     public:
//       ConcreteDerivedClass(bslma::Allocator *basicAllocator)
//       : bdlcfxxxr::Vfunc4(basicAllocator) { }
//
...
// bdlcfxxxr::Vfunc4<A1, A2, A3, A4>
//..
//   template <class A1, class A2, class A3, class A4>
//   class EnvelopeClass {
//       // Provide an object that encapsulates a 'bdlcfxxxr::Vfunc4' object.
//
//       bdlcfxxxr::Vfunc4<A1, A2, A3, A4> *d_rep_p;
//           // polymorphic functor representation
//
//     public:
//       // CREATORS
//       EnvelopeClass(bdlcfxxxr::Vfunc4<A1, A2, A3, A4> *rep) :
//           d_rep_p(rep)
...
//           // representation using 'deleteObject' method of 'bdlcfxxxr::Vfunc4'
//           // class.
//       {
...
//   typedef bdlcfxxxr::Vfunc4<int, int, int, int> Obj;
...
//       env1(1, 2, 3, 4);    ASSERT(1 == executeUsageCounter);
//       {
//           EnvelopeClass<int, int, int, int> env1(x);
...
class Vfunc4 {
    ...
    // destroy and deallocate the concrete objects derived from 'Vfunc4',
