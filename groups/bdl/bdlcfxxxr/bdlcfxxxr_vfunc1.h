// bdlcfxxxr_vfunc1.h               -*-C++-*-
#ifndef INCLUDED_BDLCFXXXR_VFUNC1
#define INCLUDED_BDLCFXXXR_VFUNC1
...
//
//@CLASSES:
//   bdlcfxxxr::Vfunc1: thread-safe reference-counted base class with an allocator
//
...
// class for all internal representations of the 'bdlcfxxx::Vfunc1' family of
...
// reflect the number of 'bdlcfxxx::Vfunc1' objects (envelopes) or other partial
...
// information about the details of the 'bdlcfxxxr::Vfunc1' object memory management
...
// classes derived from 'bdlcfxxxr::Vfunc1' to declare destructor 'private' and
...
//           // representation using 'deleteObject' method of 'bdlcfxxxr::Vfunc1'
//           // class.
//       {
...
class Vfunc1 {
    ...
    // destroy and deallocate the concrete objects derived from 'Vfunc1',
