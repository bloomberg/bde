...
const char bdeat_TypeName_Imp::BDEAT_NAME_DATE[]           = "bdlt::Date";
const char bdeat_TypeName_Imp::BDEAT_NAME_DATE_TZ[]        = "bdlt::DateTz";
const char bdeat_TypeName_Imp::BDEAT_NAME_DATETIME[]       = "bdlt::Datetime";
const char bdeat_TypeName_Imp::BDEAT_NAME_DATETIME_TZ[]    = "bdlt::DatetimeTz";
const char bdeat_TypeName_Imp::BDEAT_NAME_TIME[]           = "bdlt::Time";
const char bdeat_TypeName_Imp::BDEAT_NAME_TIME_TZ[]        = "bdlt::TimeTz";
