...
BSLS_IDENT_RCSID(bdlat_symbolicconverter_cpp,"$Id$ $CSID$")
...
#include <bdlat_enumeratorinfo.h>      // for testing only
#include <bdlat_attributeinfo.h>       // for testing only
#include <bdlat_selectioninfo.h>       // for testing only
#include <bdlat_typetraits.h>          // for testing only
