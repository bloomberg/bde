...
//   A 'bdlsb::OverflowMemOutput' is created with a client-supplied C char
//   array, a length specification, and an allocator.  The allocator is
//   used for the overflow buffer.  This is the only constructor, so our set of
//   primary constructors will be:
//
//    o bdlsb::OverflowMemOutput(char             *initialBuffer,
...
//   'bdlsb::OverflowMemOutput' component has 'dataLength',
...
//
// CREATORS
// [ 3] bdlsb::OverflowMemOutput(char             *buffer,
//                              int               size,
//                              bslma::Allocator *basicAllocator = 0);
//
// MANIPULATORS
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      case 11: {
        ...
        bslma::TestAllocator ta(veryVeryVerbose);
        {
            ...
            for (int i=0;i<end;i++) {
                ...
                bdlsb::OverflowMemOutput sb(bytes, INITIAL_BUFSIZE, &ta);
      ...
      case 10: {
        ...
        //
        // Plan:
        //   Instantiate an 'bdlsb::OverflowMemOutput', use 'sputc' to insert a
        //   EOF at the beginning of the initial buffer, the end of the initial
        //   buffer and the first char of overflow buffer via the 'overflow'
        //   method.  Then seek to the end of the overflow buffer, and use
        //   'putc' to insert a EOF there, and trigger an overflow buffer
        //   expansion.  Repeat using 'sputn'.
        //
        // Testing:
...
//..
      ...
      case 8: {
        ...
        }
        {
            ...
            for (int offset = offsetRangeBeg; offset < offsetRangeEnd;
                                                                offset++) {
                char buffer[INITIAL_BUFSIZE];
                bdlsb::OverflowMemOutput mSB(buffer, INITIAL_BUFSIZE, &ta);
      ...
      case 5: {
        ...
        //
        // Testing:
        //   ostream& operator<<(ostream&, const bdlsb::OverflowMemOutput&);
        // --------------------------------------------------------------------
...

        {
            ...
            bdlsb::OverflowMemOutput mSB(buffer, INITIAL_BUFSIZE);
            const bdlsb::OverflowMemOutput& SB = mSB;
      ...
      case 4: {
        ...
        if (verbose) cout << "\nTesting sputc." << endl;
        {
            ...
            for (int i = 0; i < DATA_LEN; ++i ) {
                ...
                char buffer[INITIAL_BUFSIZE];
                memset(buffer, 'Z', INITIAL_BUFSIZE);
                bdlsb::OverflowMemOutput mSB(buffer,
                                            INITIAL_BUFSIZE - 1,
                                            &ta);
                const bdlsb::OverflowMemOutput& SB = mSB;
      ...
      case 3: {
        ...
        //
        // Testing:
        //   bdlsb::OverflowMemOutput(char             *buffer,
        //                           int               size,
        //                           bslma::Allocator *basicAllocator = 0)
        // --------------------------------------------------------------------
        bslma::TestAllocator ta(veryVeryVerbose);
                          ...
                          << endl;
        {
            if (verbose) cout <<
             ...
             char buffer[INITIAL_BUFSIZE];
             memset(buffer, 'Z', INITIAL_BUFSIZE);
             bdlsb::OverflowMemOutput mSB(buffer, INITIAL_BUFSIZE - 1, &ta);
             const bdlsb::OverflowMemOutput& SB = mSB;
