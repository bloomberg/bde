...
//   A 'bdlsb::FixedMemOutStreamBuf' is created with a client-supplied C char
...
//
//    o bdlsb::FixedMemOutStreamBuf(char *buffer, bsl::streamsize length);
//
// Primary Manipulators:
//   We can bring a 'bdlsb::FixedMemOutStreamBuf' to any achievable white-box
...
//   'bdlsb::FixedMemOutStreamBuf' component has only 'length' and 'data' as
...
//-----------------------------------------------------------------------------
// CREATORS
// [ 3] bdlsb::FixedMemOutStreamBuf(char *buffer, bsl::streamsize length);
// [ 6] ~bdlsb::FixedMemOutStreamBuf();
// MANIPULATORS
...
// [ 1] BREATHING TEST
// [ 2] TEST APPARATUS
// [ 5] ostream& operator<<(ostream&, const bdlsb::FixedMemOutStreamBuf&);
//
// USAGE EXAMPLE
...
bsl::ostream& operator<<(bsl::ostream&                     stream,
                         const bdlsb::FixedMemOutStreamBuf& streamBuffer);
...
int main(int argc, char **argv)
{
    ...
    switch (test) { case 0:
      ...
      case 9: {
        ...
        bdlsb::FixedMemOutStreamBuf mSB(buffer, INITIAL_BUFSIZE);
      ...
      case 8: {
...

        {
            static const struct {
                ...
                bdlsb::FixedMemOutStreamBuf::off_type
            ...
            for (int i = 0; i < DATA_LEN; ++i ) {
                ...
                bdlsb::FixedMemOutStreamBuf::int_type ret;
                          ...
                          << endl;
        {
            ...
            for (int i = 0; i < DATA_LEN; ++i ) {
                ...
                memset(buffer, 'Z', INITIAL_BUFSIZE);
                bdlsb::FixedMemOutStreamBuf mSB(buffer, INITIAL_BUFSIZE);
                const bdlsb::FixedMemOutStreamBuf& SB = mSB;
    ...
    "There are no non-primary constructors, and the destructor does nothing."
      ...
      case 5: {
...

        {
            ...
            char buffer[INITIAL_BUFSIZE];
            memset(buffer, 'Z', INITIAL_BUFSIZE);
            bdlsb::FixedMemOutStreamBuf mSB(buffer,
                                            INITIAL_BUFSIZE);
            const bdlsb::FixedMemOutStreamBuf& SB = mSB;
      ...
      case 4: {
        ...
        if (verbose) cout << "\nTesting sputc." << endl;
        {
            typedef bdlsb::FixedMemOutStreamBuf::char_type T;
        ...
        }
        {
            ...
            static const struct {
                ...
                bdlsb::FixedMemOutStreamBuf::pos_type  d_amount;
                                              // amount to seek
                int         d_retVal;         // expected return value
            } DATA[] = {
      ...
      case 3: {
        ...
        //
        // Testing:
        //   bdlsb::FixedMemOutStreamBuf(char *buffer, bsl::streamsize length);
        //
        // --------------------------------------------------------------------
