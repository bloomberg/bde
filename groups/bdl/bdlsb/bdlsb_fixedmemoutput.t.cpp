...
//   A 'bdlsb::FixedMemOutput' is created with a client-supplied C char
...
//
//    o bdlsb::FixedMemOutput(char *buffer, bsl::streamsize length);
//
// Primary Manipulators:
//   We can bring a 'bdlsb::FixedMemOutput' to any achievable white-box
...
//   'bdlsb::FixedMemOutput' component has only 'length', 'data' and 'capacity'
...
//-----------------------------------------------------------------------------
// CREATORS
// [ 3] bdlsb::FixedMemOutput(char *buffer, bsl::streamsize length);
// [ 6] ~bdlsb::FixedMemOutput();
//
// MANIPULATORS
...
// [ 1] BREATHING TEST
// [ 2] TEST APPARATUS
// [ 5] ostream& operator<<(ostream&, const bdlsb::FixedMemOutput&);
//
// USAGE EXAMPLE
...
//..
 class my_CapitalizingStream {
   ...
   public:
     ...
     // ACCESSORS
     const bdlsb::FixedMemOutput* streamBuf() { return d_streamBuf; }
...
int main(int argc, char **argv)
{
      ...
      case 8: {
...

        {
            ...
            for (int i = 0; i < DATA_LEN; ++i ) {
                ...
                bdlsb::FixedMemOutput mSB(buffer, INITIAL_BUFSIZE);

                bdlsb::FixedMemOutput::int_type ret;
                          ...
                          << endl;
        {
            ...
            for (int i = 0; i < DATA_LEN; ++i ) {
                ...
                memset(buffer, 'Z', INITIAL_BUFSIZE);
                bdlsb::FixedMemOutput mSB(buffer, INITIAL_BUFSIZE);
                const bdlsb::FixedMemOutput& SB = mSB;
    ...
    "There are no non-primary constructors, and the destructor does nothing."
      ...
      case 5: {
        ...
        //
        // Testing:
        //   ostream& operator<<(ostream&, const bdesb::MemOutput&);
        // --------------------------------------------------------------------
...

        {
            ...
            char buffer[INITIAL_BUFSIZE];
            memset(buffer, 'Z', INITIAL_BUFSIZE);
            bdlsb::FixedMemOutput mSB(buffer,
                                            INITIAL_BUFSIZE);
            const bdlsb::FixedMemOutput& SB = mSB;
      ...
      case 4: {
        ...
        //
        //   (data and length)
        //   - Create an empty 'bdesb::MemOutput' and verify its length.
        ...
        if (verbose) cout << "\nTesting sputc." << endl;
        {
            typedef bdlsb::FixedMemOutput::char_type T;
        ...
        }
        {
            ...
            static const struct {
                ...
                bdlsb::FixedMemOutput::pos_type  d_amount;
                                              // amount to seek
                int         d_retVal;         // expected return value
            } DATA[] = {
      ...
      case 3: {
        ...
        //
        // Testing:
        //   bdlsb::FixedMemOutput(char *buffer, bsl::streamsize length);
        //
        // --------------------------------------------------------------------
