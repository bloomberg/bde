// bdlpuxxx_typesparser.h                                                -*-C++-*-
#ifndef INCLUDED_BDLPUXXX_TYPESPARSER
#define INCLUDED_BDLPUXXX_TYPESPARSER
...
//
//@CLASSES:
//  bdlpuxxx::TypesParser: namespace for types- and array-parsing functions
//
...
//                  <TIME> must be valid as specified in 'bdlt::Time'.
...
//                  'bdlt::Time', but is also computationally equivalent to
...
//      // argument is 0.
//  {
//      bdlpuxxx_parserimputil::skipWhitespace(&s, s);
...
struct TypesParser {
  ...
  public:
    ...
    static int parseDate(const char **endPos,
        ...
        // <MONTH>, and <DAY> is invalid as specified in 'bdlt::Date', the
    ...
    static int parseDelimitedString(const char  **endPos,
        ...
        //      'TypesParserImpUtil::parseCharRaw'.
        //..
        ...
        // 'TypesParserImpUtil::parseCharRaw' and compares its' result
    ...
    static int parseQuotedString(const char  **endPos,
        ...
        //      defined in 'TypesParserImpUtil::parseCharRaw'.
        //..
    ...
    static int parseString(const char  **endPos,
        ...
        //      in 'TypesParserImpUtil::parseCharRaw'.
        //..
...
// CLASS METHODS
inline
void TypesParser::stripNull(bsl::vector<char> *buffer)
{
...
inline
void TypesParser::generateCharRaw(bsl::vector<char> *buffer,
                                        char               value,
                                        int                level,
                                        int                spacesPerLevel)
{
...
inline
void TypesParser::generateChar(bsl::vector<char> *buffer,
                                     char               value,
                                     int                level,
                                     int                spacesPerLevel)
{
...
inline
void TypesParser::generateCharArray(
                                      bsl::vector<char>        *buffer,
                                      const bsl::vector<char>&  value,
                                      int                       level,
                                      int                       spacesPerLevel)
...
inline
void TypesParser::generateDateRaw(bsl::vector<char> *buffer,
                                        const bdlt::Date&   value,
                                        int                level,
                                        int                spacesPerLevel)
{
...
inline
void TypesParser::generateDate(bsl::vector<char> *buffer,
                                     const bdlt::Date&   value,
                                     int                level,
                                     int                spacesPerLevel)
{
...
inline
void TypesParser::generateDateArray(
                                 bsl::vector<char>             *buffer,
                                 const bsl::vector<bdlt::Date>&  value,
                                 int                            level,
                                 int                            spacesPerLevel)
...
inline
void TypesParser::generateDateTzRaw(bsl::vector<char>  *buffer,
                                          const bdlt::DateTz&  value,
                                          int                 level,
                                          int                 spacesPerLevel)
{
...
inline
void TypesParser::generateDateTz(bsl::vector<char>  *buffer,
                                       const bdlt::DateTz&  value,
                                       int                 level,
                                       int                 spacesPerLevel)
{
...
inline
void TypesParser::generateDateTzArray(
                               bsl::vector<char>               *buffer,
                               const bsl::vector<bdlt::DateTz>&  value,
                               int                              level,
                               int                              spacesPerLevel)
...
inline
void TypesParser::generateDatetimeRaw(
                                          bsl::vector<char>    *buffer,
                                          const bdlt::Datetime&  value,
                                          int                   level,
                                          int                   spacesPerLevel)
...
inline
void TypesParser::generateDatetime(bsl::vector<char>    *buffer,
                                         const bdlt::Datetime&  value,
                                         int                   level,
                                         int                   spacesPerLevel)
{
...
inline
void TypesParser::generateDatetimeArray(
                             bsl::vector<char>                 *buffer,
                             const bsl::vector<bdlt::Datetime>&  value,
                             int                                level,
                             int                                spacesPerLevel)
...
inline
void TypesParser::generateDatetimeTzRaw(
                                        bsl::vector<char>      *buffer,
                                        const bdlt::DatetimeTz&  value,
                                        int                     level,
                                        int                     spacesPerLevel)
...
inline
void TypesParser::generateDatetimeTz(
                                        bsl::vector<char>      *buffer,
                                        const bdlt::DatetimeTz&  value,
                                        int                     level,
                                        int                     spacesPerLevel)
...
inline
void TypesParser::generateDatetimeTzArray(
                           bsl::vector<char>                   *buffer,
                           const bsl::vector<bdlt::DatetimeTz>&  value,
                           int                                  level,
                           int                                  spacesPerLevel)
...
inline
void TypesParser::generateDoubleRaw(bsl::vector<char> *buffer,
                                          double             value,
                                          int                level,
                                          int                spacesPerLevel)
{
...
inline
void TypesParser::generateDouble(bsl::vector<char> *buffer,
                                       double             value,
                                       int                level,
                                       int                spacesPerLevel)
{
...
inline
void TypesParser::generateDoubleArray(
                                    bsl::vector<char>          *buffer,
                                    const bsl::vector<double>&  value,
                                    int                         level,
                                    int                         spacesPerLevel)
...
inline
void TypesParser::generateFloatRaw(bsl::vector<char> *buffer,
                                         float              value,
                                         int                level,
                                         int                spacesPerLevel)
{
...
inline
void TypesParser::generateFloat(bsl::vector<char> *buffer,
                                      float              value,
                                      int                level,
                                      int                spacesPerLevel)
{
...
inline
void TypesParser::generateFloatArray(
                                     bsl::vector<char>         *buffer,
                                     const bsl::vector<float>&  value,
                                     int                        level,
                                     int                        spacesPerLevel)
...
inline
void TypesParser::generateIntRaw(bsl::vector<char> *buffer,
                                       int                value,
                                       int                level,
                                       int                spacesPerLevel)
{
...
inline
void TypesParser::generateInt(bsl::vector<char> *buffer,
                                    int                value,
                                    int                level,
                                    int                spacesPerLevel)
{
...
inline
void TypesParser::generateIntArray(
                                       bsl::vector<char>       *buffer,
                                       const bsl::vector<int>&  value,
                                       int                      level,
                                       int                      spacesPerLevel)
...
inline
void TypesParser::generateInt64Raw(bsl::vector<char>  *buffer,
                                         bsls::Types::Int64  value,
                                         int                 level,
                                         int                 spacesPerLevel)
{
...
inline
void TypesParser::generateInt64(bsl::vector<char>  *buffer,
                                      bsls::Types::Int64  value,
                                      int                 level,
                                      int                 spacesPerLevel)
{
...
inline
void TypesParser::generateInt64Array(
                        bsl::vector<char>                      *buffer,
                        const bsl::vector<bsls::Types::Int64>&  value,
                        int                                     level,
                        int                                     spacesPerLevel)
...
inline
void TypesParser::generateIntegerLocatorRaw(
                                             bsl::vector<char> *buffer,
                                             int                value,
                                             int                level,
                                             int                spacesPerLevel)
...
inline
void TypesParser::generateIntegerLocator(
                                             bsl::vector<char> *buffer,
                                             int                value,
                                             int                level,
                                             int                spacesPerLevel)
...
inline
void TypesParser::generateShortRaw(bsl::vector<char> *buffer,
                                         short              value,
                                         int                level,
                                         int                spacesPerLevel)
{
...
inline
void TypesParser::generateShort(bsl::vector<char> *buffer,
                                      short              value,
                                      int                level,
                                      int                spacesPerLevel)
{
...
inline
void TypesParser::generateShortArray(
                                     bsl::vector<char>         *buffer,
                                     const bsl::vector<short>&  value,
                                     int                        level,
                                     int                        spacesPerLevel)
...
inline
void TypesParser::generateStringRaw(bsl::vector<char> *buffer,
                                          const char        *value,
                                          int                level,
                                          int                spacesPerLevel)
{
...
inline
void TypesParser::generateString(bsl::vector<char> *buffer,
                                       const char        *value,
                                       int                level,
                                       int                spacesPerLevel)
{
...
inline
void TypesParser::generateStringArray(
                               bsl::vector<char>               *buffer,
                               const bsl::vector<bsl::string>&  value,
                               int                              level,
                               int                              spacesPerLevel)
...
inline
void TypesParser::generateTimeRaw(bsl::vector<char> *buffer,
                                        const bdlt::Time&   value,
                                        int                level,
                                        int                spacesPerLevel)
{
...
inline
void TypesParser::generateTime(bsl::vector<char> *buffer,
                                     const bdlt::Time&   value,
                                     int                level,
                                     int                spacesPerLevel)
{
...
inline
void TypesParser::generateTimeArray(
                                 bsl::vector<char>             *buffer,
                                 const bsl::vector<bdlt::Time>&  value,
                                 int                            level,
                                 int                            spacesPerLevel)
...
inline
void TypesParser::generateTimeTzRaw(bsl::vector<char>  *buffer,
                                          const bdlt::TimeTz&  value,
                                          int                 level,
                                          int                 spacesPerLevel)
{
...
inline
void TypesParser::generateTimeTz(bsl::vector<char>  *buffer,
                                       const bdlt::TimeTz&  value,
                                       int                 level,
                                       int                 spacesPerLevel)
{
...
inline
void TypesParser::generateTimeTzArray(
                               bsl::vector<char>               *buffer,
                               const bsl::vector<bdlt::TimeTz>&  value,
                               int                              level,
                               int                              spacesPerLevel)
...
inline
int TypesParser::parseChar(const char **endPos,
                                 char        *result,
                                 const char  *inputString)
{
...
inline
int TypesParser::parseCharArray(const char        **endPos,
                                      bsl::vector<char>  *result,
                                      const char         *inputString)
{
    BSLS_ASSERT_SAFE(endPos);
    ...
    ParserImpUtil::skipWhiteSpace(&inputString, inputString);
    return ArrayParserImpUtil::parseCharArray(endPos,
                                                    result,
                                                    inputString);
}

inline
int TypesParser::parseDate(const char **endPos,
                                 bdlt::Date   *result,
                                 const char  *inputString)
{
    BSLS_ASSERT_SAFE(endPos);
...
inline
int TypesParser::parseDateArray(const char             **endPos,
                                      bsl::vector<bdlt::Date>  *result,
                                      const char              *inputString)
{
    BSLS_ASSERT_SAFE(endPos);
    ...
    ParserImpUtil::skipWhiteSpace(&inputString, inputString);
    return ArrayParserImpUtil::parseDateArray(endPos,
                                                    result,
                                                    inputString);
}

inline
int TypesParser::parseDatetime(const char    **endPos,
                                     bdlt::Datetime  *result,
                                     const char     *inputString)
{
    BSLS_ASSERT_SAFE(endPos);
...
inline
int TypesParser::parseDatetimeArray(
                                      const char                 **endPos,
                                      bsl::vector<bdlt::Datetime>  *result,
                                      const char                  *inputString)
{
    ...
    ParserImpUtil::skipWhiteSpace(&inputString, inputString);
    return ArrayParserImpUtil::parseDatetimeArray(endPos,
                                                        result,
                                                        inputString);
}

inline
int TypesParser::parseDatetimeTz(const char      **endPos,
                                       bdlt::DatetimeTz  *result,
                                       const char       *inputString)
{
    BSLS_ASSERT_SAFE(endPos);
...
inline
int TypesParser::parseDatetimeTzArray(
                                    const char                   **endPos,
                                    bsl::vector<bdlt::DatetimeTz>  *result,
                                    const char                    *inputString)
{
    ...
    ParserImpUtil::skipWhiteSpace(&inputString, inputString);
    return ArrayParserImpUtil::parseDatetimeTzArray(endPos,
                                                          result,
                                                          inputString);
}

inline
int TypesParser::parseDateTz(const char   **endPos,
                                   bdlt::DateTz   *result,
                                   const char    *inputString)
{
    BSLS_ASSERT_SAFE(endPos);
...
inline
int TypesParser::parseDateTzArray(const char               **endPos,
                                        bsl::vector<bdlt::DateTz>  *result,
                                        const char                *inputString)
{
    BSLS_ASSERT_SAFE(endPos);
    ...
    ParserImpUtil::skipWhiteSpace(&inputString, inputString);
    return ArrayParserImpUtil::parseDateTzArray(endPos,
                                                      result,
                                                      inputString);
}

inline
int TypesParser::parseDouble(const char **endPos,
                                   double      *result,
                                   const char  *inputString)
{
    BSLS_ASSERT_SAFE(endPos);
...
inline
int TypesParser::parseDoubleArray(const char          **endPos,
                                        bsl::vector<double>  *result,
                                        const char           *inputString)
{
    BSLS_ASSERT_SAFE(endPos);
    ...
    ParserImpUtil::skipWhiteSpace(&inputString, inputString);
    return ArrayParserImpUtil::parseDoubleArray(endPos,
                                                      result,
                                                      inputString);
}

inline
int TypesParser::parseFloat(const char **endPos,
                                  float       *result,
                                  const char  *inputString)
{
    BSLS_ASSERT_SAFE(endPos);
...
inline
int TypesParser::parseFloatArray(const char         **endPos,
                                       bsl::vector<float>  *result,
                                       const char          *inputString)
{
    BSLS_ASSERT_SAFE(endPos);
    ...
    ParserImpUtil::skipWhiteSpace(&inputString, inputString);
    return ArrayParserImpUtil::parseFloatArray(endPos,
                                                     result,
                                                     inputString);
}

inline
int TypesParser::parseInt(const char **endPos,
                                int         *result,
                                const char  *inputString,
                                int          base)
{
...
inline
int TypesParser::parseIntArray(const char       **endPos,
                                     bsl::vector<int>  *result,
                                     const char        *inputString)
{
    BSLS_ASSERT_SAFE(endPos);
    ...
    ParserImpUtil::skipWhiteSpace(&inputString, inputString);
    return ArrayParserImpUtil::parseIntArray(endPos,
                                                   result,
                                                   inputString);
}

inline
int TypesParser::parseInt64(const char         **endPos,
                                  bsls::Types::Int64  *result,
                                  const char          *inputString,
                                  int                  base)
{
...
inline
int TypesParser::parseInt64Array(
                                 const char                      **endPos,
                                 bsl::vector<bsls::Types::Int64>  *result,
                                 const char                       *inputString)
{
    ...
    ParserImpUtil::skipWhiteSpace(&inputString, inputString);
    return ArrayParserImpUtil::parseInt64Array(endPos,
                                                     result,
                                                     inputString);
}

inline
int TypesParser::parseShort(const char **endPos,
                                  short       *result,
                                  const char  *inputString,
                                  int          base)
{
...
inline
int TypesParser::parseShortArray(const char         **endPos,
                                       bsl::vector<short>  *result,
                                       const char          *inputString)
{
    BSLS_ASSERT_SAFE(endPos);
    ...
    ParserImpUtil::skipWhiteSpace(&inputString, inputString);
    return ArrayParserImpUtil::parseShortArray(endPos,
                                                     result,
                                                     inputString);
}

inline
int TypesParser::parseDelimitedString(const char  **endPos,
                                            bsl::string  *result,
                                            const char   *inputString,
                                            char          leftDelimiter,
                                            char          rightDelimiter)
...
inline
int TypesParser::parseQuotedString(const char  **endPos,
                                         bsl::string  *result,
                                         const char   *inputString)
{
    BSLS_ASSERT_SAFE(endPos);
...
inline
int TypesParser::parseSpaceSeparatedString(const char  **endPos,
                                                 bsl::string  *result,
                                                 const char   *inputString)
{
    BSLS_ASSERT_SAFE(endPos);
...
inline
int TypesParser::parseString(const char  **endPos,
                                   bsl::string  *result,
                                   const char   *inputString)
{
    BSLS_ASSERT_SAFE(endPos);
...
inline
int TypesParser::parseUnquotedString(const char  **endPos,
                                           bsl::string  *result,
                                           const char   *inputString)
{
    BSLS_ASSERT_SAFE(endPos);
...
inline
int TypesParser::parseStringArray(const char               **endPos,
                                        bsl::vector<bsl::string>  *result,
                                        const char                *inputString)
{
    BSLS_ASSERT_SAFE(endPos);
    ...
    ParserImpUtil::skipWhiteSpace(&inputString, inputString);
    return ArrayParserImpUtil::parseStringArray(endPos,
                                                      result,
                                                      inputString);
}

inline
int TypesParser::parseTime(const char **endPos,
                                 bdlt::Time   *result,
                                 const char  *inputString)
{
    BSLS_ASSERT_SAFE(endPos);
...
inline
int TypesParser::parseTimeArray(const char             **endPos,
                                      bsl::vector<bdlt::Time>  *result,
                                      const char              *inputString)
{
    BSLS_ASSERT_SAFE(endPos);
    ...
    ParserImpUtil::skipWhiteSpace(&inputString, inputString);
    return ArrayParserImpUtil::parseTimeArray(endPos,
                                                    result,
                                                    inputString);
}

inline
int TypesParser::parseTimeTzArray(const char               **endPos,
                                        bsl::vector<bdlt::TimeTz>  *result,
                                        const char                *inputString)
{
    BSLS_ASSERT_SAFE(endPos);
    ...
    ParserImpUtil::skipWhiteSpace(&inputString, inputString);
    return ArrayParserImpUtil::parseTimeTzArray(endPos,
                                                      result,
                                                      inputString);
}

inline
int TypesParser::parseTimeTz(const char   **endPos,
                                   bdlt::TimeTz   *result,
                                   const char    *inputString)
{
    BSLS_ASSERT_SAFE(endPos);
