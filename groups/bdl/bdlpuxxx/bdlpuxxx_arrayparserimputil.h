...
//
//@CLASSES:
//  bdlpuxxx::ArrayParserImpUtil: namespace for array parsing functions
//
...
//      bdlpuxxx::ArrayParserImpUtil::generateIntArray(&buffer, initial);
...
//      const char *pos;
//      bdlpuxxx::ArrayParserImpUtil::parseIntArray(&pos, &final, buffer.data());
...
struct ArrayParserImpUtil {
  ...
  public:
    ...
    static int parseCharArray(const char        **endPos,
        ...
        // parsable by 'TypesParserImpUtil::parseChar' (i.e., a possibly
    ...
    static int parseDateArray(const char             **endPos,
        ...
        // parsable by 'TypesParserImpUtil::parseDate' (i.e., a possibly
    ...
    static int parseDatetimeArray(const char                 **endPos,
        ...
        // 'TypesParserImpUtil::parseDatetime' (i.e., a possibly empty
    ...
    static int parseDatetimeTzArray(
        ...
        // represents a value parsable by
        // 'TypesParserImpUtil::parseDatetimeTz' (i.e., a possibly empty
    ...
    static int parseDateTzArray(const char               **endPos,
        ...
        // value parsable by 'TypesParserImpUtil::parseDateTz' (i.e., a
    ...
    static int parseDoubleArray(const char          **endPos,
        ...
        // value parsable by 'TypesParserImpUtil::parseDouble' (i.e., a
    ...
    static int parseFloatArray(const char         **endPos,
        ...
        // parsable by 'TypesParserImpUtil::parseFloat' (i.e., a possibly
    ...
    static int parseInt64Array(const char                      **endPos,
        ...
        // parsable by 'TypesParserImpUtil::parseInt64' (i.e., a possibly
    ...
    static int parseIntArray(const char       **endPos,
        ...
        // parsable by 'TypesParserImpUtil::parseInt' (i.e., a possibly
    ...
    static int parseShortArray(const char         **endPos,
        ...
        // parsable by 'TypesParserImpUtil::parseShort' (i.e., a possibly
    ...
    static int parseStringArray(const char               **endPos,
        ...
        // value parsable by 'TypesParserImpUtil::parseString' (i.e., a
    ...
    static int parseTimeArray(const char             **endPos,
        ...
        // parsable by 'TypesParserImpUtil::parseTime' (i.e., a possibly
    ...
    static int parseTimeTzArray(const char               **endPos,
        ...
        // value parsable by 'TypesParserImpUtil::parseTime' (i.e., a
