...
BSLS_IDENT_RCSID(bdlpuxxx_iso8601_cpp,"$Id$ $CSID$")
...
int Iso8601::parse(bdlt::Date  *result,
                         const char *input,
                         int         inputLength)
{
    BSLS_ASSERT(result);
...
int Iso8601::parse(bdlt::Time  *result,
                         const char *input,
                         int         inputLength)
{
    BSLS_ASSERT(result);
...
int Iso8601::parse(bdlt::Datetime *result,
                         const char    *input,
                         int            inputLength)
{
    BSLS_ASSERT(result);
...
int Iso8601::parse(bdlt::DateTz *result,
                         const char  *input,
                         int          inputLength)
{
    BSLS_ASSERT(result);
...
int Iso8601::parse(bdlt::TimeTz *result,
                         const char  *input,
                         int          inputLength)
{
    BSLS_ASSERT(result);
...
int Iso8601::parse(bdlt::DatetimeTz *result,
                         const char      *input,
                         int              inputLength)
{
    BSLS_ASSERT(result);
    ...
    return 0;
                        ...
                        // ---------------------------------
                        // struct bdlpuxxx::Iso8601Configuration
                        // ---------------------------------

// GLOBAL CONFIGURATION
bool bdlpuxxx::Iso8601Configuration::s_useZAbbreviationForUtc = false;

namespace bdlpuxxx {
// CLASS METHODS
void Iso8601Configuration::setUseZAbbreviationForUtc(
                                               bool useZAbbreviationForUtcFlag)
{
    s_useZAbbreviationForUtc = useZAbbreviationForUtcFlag;
}

bool Iso8601Configuration::useZAbbreviationForUtc()
{
