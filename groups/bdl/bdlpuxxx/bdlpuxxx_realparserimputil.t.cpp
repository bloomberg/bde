                ...
                for (int DECEXP = -307; DECEXP <= 307; ++DECEXP) {
                    ...
                    bdlpuxxx::RealParserImpUtil::
                        convertDecimalExponentToBinary(&binFrac,
                                                       &binExp,
                                                       DECEXP - 1);
                    bdlpuxxx::RealParserImpUtil::convertBinaryToDecimal(&decFrac,
                                                                    &decExp,
                                                                    binFrac,
                                                                    binExp);
                    if (decExp < DECEXP) {
      ...
      case 8: {
...

        {
            ...
            for (int ti = 0; ti < NUM_DATA ; ++ti) {
                ...
                {
                    double value;
                    bdlpuxxx::RealParserImpUtil::convertBinaryToDouble(&value,
                                                                   binSign,
                                                                   binFrac,
                                                                   binExp);
...
{ L_,  000000000000000001uLL, -646456992,   0, 0x0000000000000000uLL,      0 },
            ...
            for (int ti = 0; ti < NUM_DATA ; ++ti) {
                ...
                Uint64 binFrac;
                int binExp;
                int rv = bdlpuxxx::RealParserImpUtil::
                    convertDecimalToBinary(&binFrac, &binExp, DECFRAC, DECEXP);
