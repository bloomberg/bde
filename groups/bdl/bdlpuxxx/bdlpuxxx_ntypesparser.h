// bdlpuxxx_ntypesparser.h                                            -*-C++-*-
#ifndef INCLUDED_BDLPUXXX_NTYPESPARSER
#define INCLUDED_BDLPUXXX_NTYPESPARSER
...
//
//@CLASSES:
//  bdlpuxxx::NTypesParser: namespace for scalar and array parsing functions
//
...
//      whole <DATE> must be valid as specified in 'bdlt::Date'.
...
//      be valid as specified in 'bdlt::Time'.  Specifically, the only valid
...
// <NCHAR>: [<NULL><CHAR>] (if <NULL>, value is determined by 'bdltuxxx_unset')
// <NSHORT>: [<NULL><SHORT>] (if <NULL>, value is determined by 'bdltuxxx_unset')
// <NINT>: [<NULL><INT>] (if <NULL>, value is determined by 'bdltuxxx_unset')
// <NINT64>: [<NULL><INT64>] (if <NULL>, value is determined by 'bdltuxxx_unset')
// <NFLOAT>: [<NULL><FLOAT>] (if <NULL>, value is determined by 'bdltuxxx_unset')
// <NDOUBLE>: [<NULL><DOUBLE>] (if <NULL>, value is determined by
//                              'bdltuxxx_unset')
// <NSTRING>: [<NULL><STRING>] (if <NULL>, value is determined by
//                              'bdltuxxx_unset')
// <NDATE>: [<NULL><DATE>] (if <NULL>, value is determined by 'bdltuxxx_unset')
// <NTIME>: [<NULL><TIME>] (if <NULL>, value is determined by 'bdltuxxx_unset')
...
// 'bdlimpxxx_fuzzy' component for functions that compare floating point values
...
//  ( 1.2, 3.4 )
//..
// We can use the functions in the 'bdlpuxxx_typesparser' component to write a
...
//      //  argument is 0.
//  {
//      FAIL_UNLESS(0 == bdlpuxxx_parserimputil::skipRequiredToken(&s, s, '('));
//      FAIL_UNLESS(0 == bdlpuxxx_typesparser::parseDouble(&s, &point.x, s));
//      FAIL_UNLESS(0 == bdlpuxxx_parserimputil::skipRequiredToken(&s, s, ','));
//      FAIL_UNLESS(0 == bdlpuxxx_typesparser::parseDouble(&s, &point.y, s));
//      FAIL_UNLESS(0 == bdlpuxxx_parserimputil::skipRequiredToken(&s, s, ')'));
...
//  enum { SUCCESS = 0, FAILURE };
//  #define FAIL_UNLESS(c) if (!(c)) { *endPos = s; return FAILURE; }
//  typedef bdlpuxxx_typesparser TP;  // notational convenience
//  typedef bdlpuxxx_parserimputil PIU; // notational convenience
//
...
//  typedef bdlpuxxx::NTypesParser TP;
//  typedef bdlpuxxx::ParserImpUtil PIU;
//
...
struct NTypesParser {
    ...
    // refer to values of types defined in 'bdltuxxx::Unset'.
  ...
  public:
    ...
    static int parseDatetimeArray(const char                 **endPos,
                                  bsl::vector<bdlt::Datetime>  *result,
                                  const char                  *inputString);
        // Parse the specified 'inputString' for a sequence of characters
        // matching the regular expression <WHITESPACE>* [ <WHITESPACE>*
    ...
    static int parseDatetimeTzArray(
                                   const char                   **endPos,
                                   bsl::vector<bdlt::DatetimeTz>  *result,
                                   const char                    *inputString);
        // Parse the specified 'inputString' for a sequence of characters
        // matching the regular expression <WHITESPACE>* [ <WHITESPACE>*
    ...
    static void generateCharRaw(bsl::vector<char> *buffer,
        ...
        // in 'bdltuxxx_unset' it will be formatted as "NULL".  Otherwise, the
    ...
    static void generateShortRaw(bsl::vector<char> *buffer,
        ...
        // indentation 'level' and append the result to the specified
        // 'buffer'.  If the specified 'value' matches the unset value defined
        // in 'bdltuxxx_unset' it will be formatted as "NULL".  If 'level' is
        // specified, optionally specify 'spacesPerLevel'.  The formatted
    ...
    static void generateDateRaw(bsl::vector<char> *buffer,
        ...
        // 'buffer'.  If the specified 'value' matches the unset value defined
        // in 'bdltuxxx_unset' it will be formatted as "NULL".  Otherwise, the
        // 'bdlt::Date' is formatted as follows: four digits to represent the
        ...
        // specify  'spacesPerLevel'.  The formatted 'bdlt::Date' will be
    ...
    static void generateDateTzRaw(bsl::vector<char>  *buffer,
        ...
        // 'buffer'.  If the specified 'value' matches the unset value defined
        // in 'bdltuxxx_unset' it will be formatted as "NULL".  Otherwise, the
        // 'bdlt::DateTz' is formatted as follows: four digits to represent the
        // year followed by a slash followed by two digits to represent the
        // month followed by a slash followed by to two digits to represent
        // the day.  All values will have leading zeros to reach the
        // proscribed number of digits.  If 'level' is specified, optionally
    ...
    static void generateTimeRaw(bsl::vector<char> *buffer,
        ...
        // 'buffer'.  If the specified 'value' matches the unset value defined
        // in 'bdltuxxx_unset' it will be formatted as "NULL".  Otherwise, the
        // 'bdlt::Time' is formatted as follows: two digits to represent hours
        ...
        // proscribed number of digits.  If 'level' is specified, optionally
        // specify 'spacesPerLevel'.  The formatted 'bdlt::Time' will be
        // indented by (level * spacesPerLevel) spaces.  Making 'level'
        // negative suppresses indentation.  The behavior is undefined if
        // 'buffer == 0', '&value == 0', or 'spacesPerLevel < 0'.  Note that
        // 'value' is output as a textual representation that is parsable by
    ...
    static void generateTimeTzRaw(bsl::vector<char>  *buffer,
        ...
        // 'buffer'.  If the specified 'value' matches the unset value defined
        // in 'bdltuxxx_unset' it will be formatted as "NULL".  Otherwise, the
        // 'bdlt::TimeTz' is formatted as follows: two digits to represent hours
        // followed by a colon followed by two digits to represent minutes
        // followed by a colon followed by two digits to represent seconds
        // followed by a colon followed by three digits to represent
        // milliseconds.  All values will have leading zeros to reach the
    ...
    static void generateDatetimeRaw(bsl::vector<char>    *buffer,
        ...
        // 'buffer'.  If the specified 'value' matches the unset value defined
        // in 'bdltuxxx_unset' it will be formatted as "NULL".  Otherwise, the
        // 'bdlt::Datetime' is formatted as a <DATE> (see the above function)
        // followed by a single space followed by a <TIME> (see the above
        // function).  If 'level' is specified, optionally specify
        // 'spacesPerLevel'.  The formatted 'bdlt::Datetime will be indented by
    ...
    static void generateDatetimeTzRaw(
        ...
        // 'buffer'.  If the specified 'value' matches the unset value defined
        // in 'bdltuxxx_unset' it will be formatted as "NULL".  Otherwise, the
        // 'bdlt::DatetimeTz' is formatted as a <DATE> (see the above function)
        // followed by a single space followed by a <TIME> (see the above
        // function).  If 'level' is specified, optionally specify
        // 'spacesPerLevel'.  The formatted 'bdlt::Datetime will be indented by
        // (level * spacesPerLevel) spaces.  Making 'level' negative
    ...
    static void generateCharArrayRaw(
        ...
        // unset value for the element type defined in 'bdltuxxx_unset' it will be
    ...
    static void generateChar(bsl::vector<char> *buffer,
        ...
        // 'value' matches the unset value defined in 'bdltuxxx_unset' it will be
    ...
    static void generateDate(bsl::vector<char> *buffer,
        ...
        // while maintaining null-character termination.  If the specified
        // 'value' matches the unset value defined in 'bdltuxxx_unset' it will be
        // formatted as "NULL".  Otherwise, the 'bdlt::Date' is formatted as
        ...
        // formatted 'bdlt::Date' will be indented by (level * spacesPerLevel)
    ...
    static void generateDateTz(bsl::vector<char>  *buffer,
        ...
        // while maintaining null-character termination.  If the specified
        // 'value' matches the unset value defined in 'bdltuxxx_unset' it will be
        // formatted as "NULL".  Otherwise, the 'bdlt::DateTz' is formatted as
        // follows: four digits to represent the year followed by a slash
        // followed by two digits to represent the month followed by a slash
        // followed by to two digits to represent the day.  All values will
        // have leading zeros to reach the proscribed number of digits.  If
    ...
    static void generateTime(bsl::vector<char> *buffer,
        ...
        // while maintaining null-character termination.  If the specified
        // 'value' matches the unset value defined in 'bdltuxxx_unset' it will be
        // formatted as "NULL".  Otherwise, the 'bdlt::Time' is formatted as
        ...
        // 'bdlt::Time' will be indented by (level * spacesPerLevel) spaces.
    ...
    static void generateTimeTz(bsl::vector<char>  *buffer,
        ...
        // while maintaining null-character termination.  If the specified
        // 'value' matches the unset value defined in 'bdltuxxx_unset' it will be
        // formatted as "NULL".  Otherwise, the 'bdlt::TimeTz' is formatted as
        // follows: two digits to represent hours followed by a colon followed
        // by two digits to represent minutes followed by a colon followed by
        // two digits to represent seconds followed by a colon followed by
        // three digits to represent milliseconds.  All values will have
    ...
    static void generateDatetime(bsl::vector<char>    *buffer,
        ...
        // while maintaining null-character termination.  If the specified
        // 'value' matches the unset value defined in 'bdltuxxx_unset' it will be
        // formatted as "NULL".  Otherwise, the 'bdlt::Datetime' is formatted
        // as a <DATE> (see the above function) followed by a single space
        // followed by a <TIME> (see the above function).  If 'level' is
        // specified, optionally specify 'spacesPerLevel'.  The formatted
        // 'bdlt::Datetime will be indented by (level * spacesPerLevel) spaces.
        // Making 'level' negative suppresses indentation.  The behavior is
        // undefined if buffer == 0, value == 0, or spacesPerLevel < 0.  Note
        // that 'value' is output as a textual representation that is parsable
        // by the corresponding 'parseTime' function.
    ...
    static void generateDatetimeTz(bsl::vector<char>      *buffer,
        ...
        // while maintaining null-character termination.  If the specified
        // 'value' matches the unset value defined in 'bdltuxxx_unset' it will be
        // formatted as "NULL".  Otherwise, the 'bdlt::DatetimeTz' is formatted
        // as a <DATE> (see the above function) followed by a single space
        // followed by a <TIME> (see the above function).  If 'level' is
        // specified, optionally specify 'spacesPerLevel'.  The formatted
        // 'bdlt::Datetime will be indented by (level * spacesPerLevel) spaces.
    ...
    static void generateCharArray(
        ...
        // type defined in 'bdltuxxx_unset' it will be formatted as "NULL".
...
// CLASS METHODS
inline
int NTypesParser::parseDelimitedString(const char  **endPos,
                                             bsl::string  *result,
                                             const char   *inputString,
                                             char          leftDelimiter,
                                             char          rightDelimiter)
{
    ...
    return TypesParserImpUtil::parseDelimitedString(endPos,
                                                          result,
                                                          inputString,
                                                          leftDelimiter,
                                                          rightDelimiter);
...
// 'TypesParser' because calling it there would be the *only* dependency
// 'bdlpuxxx_ntypesparser' would have on 'bdlpuxxx_typesparser', so adding the
// function here reduces dependencies by one level.

inline
void NTypesParser::stripNull(bsl::vector<char> *buffer)
{
