// bdlpuxxx_parserimputil.t.cpp                                       -*-C++-*-
...
// 'bdlpuxxx::ParserImpUtil': 'parse', 'generate', 'skip', and 'append'.
//
      ...
      case 13: {
...

        {
            ...
            for (int ti = 0; ti < NUM_DATA ; ++ti) {
                ...
                const bsl::string SPECSTR = SPEC;
                buffer.insert(buffer.end(), SPECSTR.begin(), SPECSTR.end());
                bdlpuxxx::ParserImpUtil::generateIndentation(&buffer, LEVEL, SPL);
                const bsl::size_t LEN = bsl::strlen(EXP);
                LOOP_ASSERT(LINE, LEN == buffer.size());
                for (bsl::size_t i = 0; i < LEN; ++i) {
                    LOOP2_ASSERT(LINE, i, EXP[i] == buffer[i]);
      ...
      case 9: {
...

        {
            ...
            for (int ti = 0; ti < NUM_DATA ; ++ti) {
                ...
                const char *endPos = 0;
                int rv = bdlpuxxx::ParserImpUtil::skipWhiteSpace(&endPos, SPEC);
                LOOP_ASSERT(LINE, SPEC + NUM == endPos);
                LOOP_ASSERT(LINE, FAIL == !!rv);
            }
        }
            ...
            for (int ti = 0; ti < NUM_DATA ; ++ti) {
                ...
                for (int si = 0; si < 2; ++si) {
                    ...
                    {  // test with first initial value
                        ...
                        const char *endPos = 0;
                        int rv = bdlpuxxx::ParserImpUtil::parseIdentifier(&endPos,
                                                                      &result,
                                                                      buffer);
                        ...
                        LOOP2_ASSERT(LINE, si,
                            FAIL || bdlpuxxx::ParserImpUtil::isIdentifier(result));
                    }
      ...
      case 7: {
...

        {
            ...
            for (int ti = 0; ti < NUM_DATA ; ++ti) {
                ...
                int rv = bdlpuxxx::ParserImpUtil::isIdentifier(str);
...

        {
            ...
            for (int ti = 0; ti < NUM_DATA ; ++ti) {
                ...
                for (int si = 0; si < 2; ++si) {
                    ...
                    const char *endPos = 0;
                    int rv = bdlpuxxx::ParserImpUtil::parseNull(&endPos, buffer);
                    LOOP2_ASSERT(LINE, si, buffer + NUM == endPos);
                    LOOP2_ASSERT(LINE, si, FAIL == !!rv);
                }
            }
      ...
      case 5: {
...

        {
            ...
            for (int ti = 0; ti < NUM_DATA ; ++ti) {
                ...
                bsl::string str(SPEC, &testAllocator);
                bdlpuxxx::ParserImpUtil::compactMultibyteChars(&str);
      ...
      case 1: {
...

        {
            ...
            for (int ti = 0; ti < NUM_DATA ; ++ti) {
                ...
                int rv = bdlpuxxx::ParserImpUtil::characterToDigit(SPEC, BASE);
