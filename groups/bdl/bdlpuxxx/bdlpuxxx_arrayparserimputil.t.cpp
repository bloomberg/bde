// bdlpuxxx_arrayparserimputil.t.cpp              -*-C++-*-
...
//  'ArDate'     for 'vector<bdlt::Date>'
//  'ArTime'     for 'vector<bdlt::Time>'
//  'ArDT'       for 'vector<bdlt::Datetime>'
//
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      case 27: {
        ...
        vector<int> final;
        const char *pos;
        bdlpuxxx::ArrayParserImpUtil::parseIntArray(&pos, &final, &buffer.front());
      ...
      case 26: {
        ...
        for (int ti = 0; ti < NUM_DATA; ++ti) {
            ...
            bdlpuxxx::ArrayParserImpUtil::generateDatetimeTzArray(&buffer, VALUES);

            LOOP_ASSERT(LINE, expected == buffer);

            bsl::vector<bdlt::DatetimeTz> verify(&testAllocator);
            const char *endPos = 0;
            int rv = bdlpuxxx::ArrayParserImpUtil::
      ...
      case 25: {
        ...
        for (int ti = 0; ti < NUM_DATA; ++ti) {
            ...
            const bdlt::Time VALUED(HOUR, MINUTE, SECOND, MILLISECOND);
            const bdlt::TimeTz VALUE(VALUED, OFFSET);
            VALUES.push_back(VALUE);
            ...
            vector<char> buffer(&testAllocator);
            bdlpuxxx::ArrayParserImpUtil::generateTimeTzArray(&buffer, VALUES);

            LOOP_ASSERT(LINE, expected == buffer);

            bsl::vector<bdlt::TimeTz> verify(&testAllocator);
            const char *endPos = 0;
            int rv = bdlpuxxx::ArrayParserImpUtil::
      ...
      case 24: {
        ...
        for (int ti = 0; ti < NUM_DATA; ++ti) {
            ...
            vector<char> buffer(&testAllocator);
            bdlpuxxx::ArrayParserImpUtil::generateDateTzArray(&buffer, VALUES);

            LOOP_ASSERT(LINE, expected == buffer);

            bsl::vector<bdlt::DateTz> verify(&testAllocator);
            const char *endPos = 0;
            int rv = bdlpuxxx::ArrayParserImpUtil::
      ...
      case 23: {
        ...
        bsl::vector<bdlt::TimeTz> result(&testAllocator);
        ...
        for (int ti = 0; ti < NUM_DATA1 ; ++ti) {
            ...
            for (int tj = 0; tj <= ti ; ++tj) {
                ...
                rv = bdlpuxxx::ArrayParserImpUtil::
      ...
      case 22: {
        ...
        bsl::vector<bdlt::DatetimeTz> result(&testAllocator);
        ...
        for (int ti = 0; ti < NUM_DATA1 ; ++ti) {
            ...
            const bdlt::Time VALUET(HOUR, MINS, SECS, MILLI);
            const int OFFSET       = DATA1[ti].d_tz;
            const bdlt::Datetime VALUEDT(VALUED, VALUET);
            const bdlt::DatetimeTz VALUE(VALUEDT, OFFSET);
      ...
      case 21: {
        ...
        bsl::vector<bdlt::DateTz> result(&testAllocator);
      ...
      case 20: {
        ...
        for (int ti = 0; ti < NUM_DATA; ++ti) {
            ...
            vector<char> buffer(&testAllocator);
            bdlpuxxx::ArrayParserImpUtil::generateTimeArray(&buffer, VALUES);

            LOOP_ASSERT(LINE, expected == buffer);

            bsl::vector<bdlt::Time> verify(&testAllocator);
            const char *endPos = 0;
            int rv = bdlpuxxx::ArrayParserImpUtil::
      ...
      case 19: {
...

        {
            ...
            for (int ti = 0; ti < NUM_DATA ; ++ti) {
                ...
                LOOP_ASSERT(LINE, 0 == bdlpuxxx::ArrayParserImpUtil::
                ...
                bdlpuxxx::ArrayParserImpUtil::generateStringArray(&result, spec);
      ...
      case 18: {
...

        {
            ...
            for (int ti = 0; ti < NUM_DATA ; ++ti) {
                ...
                vector<char> result(&testAllocator);
                result.insert(result.end(), INITSTR.begin(), INITSTR.end());
                bdlpuxxx::ArrayParserImpUtil::generateShortArray(&result, spec);
                LOOP_ASSERT(LINE, strlen(EXP) == result.size());
                LOOP_ASSERT(LINE,
                            0 == strncmp(EXP, &result.front(), result.size()));
            }
      ...
      case 17: {
...

        {
            ...
            for (int ti = 0; ti < NUM_DATA ; ++ti) {
                ...
                vector<char> result(&testAllocator);
                result.insert(result.end(), INITSTR.begin(), INITSTR.end());
                bdlpuxxx::ArrayParserImpUtil::generateInt64Array(&result, spec);
                LOOP_ASSERT(LINE, strlen(EXP) == result.size());
                LOOP_ASSERT(LINE,
                            0 == strncmp(EXP, &result.front(), result.size()));
            }
      ...
      case 16: {
...

        {
            ...
            for (int ti = 0; ti < NUM_DATA ; ++ti) {
                ...
                vector<char> result(&testAllocator);
                result.insert(result.end(), INITSTR.begin(), INITSTR.end());
                bdlpuxxx::ArrayParserImpUtil::generateIntArray(&result, spec);
                LOOP_ASSERT(LINE, strlen(EXP) == result.size());
                LOOP_ASSERT(LINE,
                            0 == strncmp(EXP, &result.front(), result.size()));
            }
      ...
      case 15: {
...

        {
            ...
            for (int ti = 0; ti < NUM_DATA ; ++ti) {
                ...
                vector<char> result(&testAllocator);
                result.insert(result.end(), INITSTR.begin(), INITSTR.end());
                bdlpuxxx::ArrayParserImpUtil::generateFloatArray(&result, spec);
                LOOP_ASSERT(LINE, strlen(EXP) == result.size());
                LOOP_ASSERT(LINE,
                            0 == strncmp(EXP, &result.front(), result.size()));
            }
      ...
      case 14: {
...

        {
            ...
            for (int ti = 0; ti < NUM_DATA ; ++ti) {
                ...
                vector<char> result(&testAllocator);
                result.insert(result.end(), INITSTR.begin(), INITSTR.end());
                bdlpuxxx::ArrayParserImpUtil::generateDoubleArray(&result, spec);
                LOOP_ASSERT(LINE, strlen(EXP) == result.size());
                LOOP_ASSERT(LINE,
                            0 == strncmp(EXP, &result.front(), result.size()));
            }
      ...
      case 13: {
        ...
        for (int ti = 0; ti < NUM_DATA; ++ti) {
            ...
            vector<char> buffer(&testAllocator);
            bdlpuxxx::ArrayParserImpUtil::generateDatetimeArray(&buffer, VALUES);

            LOOP_ASSERT(LINE, expected == buffer);

            bsl::vector<bdlt::Datetime> verify(&testAllocator);
            const char *endPos = 0;
            int rv = bdlpuxxx::ArrayParserImpUtil::
      ...
      case 12: {
        ...
        for (int ti = 0; ti < NUM_DATA; ++ti) {
            ...
            vector<char> buffer(&testAllocator);
            bdlpuxxx::ArrayParserImpUtil::generateDateArray(&buffer, VALUES);

            LOOP_ASSERT(LINE, expected == buffer);

            bsl::vector<bdlt::Date> verify(&testAllocator);
            const char *endPos = 0;
            int rv = bdlpuxxx::ArrayParserImpUtil::
      ...
      case 11: {
...

        {
            ...
            for (int ti = 0; ti < NUM_DATA ; ++ti) {
                ...
                vector<char> result(&testAllocator);
                result.insert(result.end(), INITSTR.begin(), INITSTR.end());
                bdlpuxxx::ArrayParserImpUtil::generateCharArray(&result, spec);
                LOOP_ASSERT(LINE, strlen(EXP) == result.size());
                LOOP_ASSERT(LINE,
                            0 == strncmp(EXP, &result.front(), result.size()));
            }
      ...
      case 3: {
        ...
        for (int ti = 0; ti < NUM_DATA1 ; ++ti) {
            ...
            const bdlt::Date VALUED(YEAR, MONTH, DAY);
            const bdlt::Time VALUET(HOUR, MINS, SECS, MILLI);
            const bdlt::Datetime VALUE(VALUED, VALUET);
