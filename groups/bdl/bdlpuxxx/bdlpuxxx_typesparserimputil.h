...
//
//@CLASSES:
//  bdlpuxxx::TypesParserImpUtil: namespace for types parsing functions
//
...
// 'long double', 'bdlt::Date', 'bdlt::DateTz', 'bdlt::Time', 'bdlt::TimeTz',
// 'bdlt::Datetime', 'bdlt::DatetimeTz', and several parse methods for
// 'bsl::string'.
//
...
// 'flags' incorporates the value 'bdlpuxxx::TypesParserImpUtil::BDEPU_HAS_ESCAPE'
...
//      int final;
//      const char *pos;
//      bdlpuxxx::TypesParserImpUtil::parseInt(&pos, &final, buffer.data());
...
struct TypesParserImpUtil {
  ...
  public:
    ...
    static int parseCharRaw(const char **endPos,
        ...
        // 'TypesParserImpUtil::BDEPU_HAS_ESCAPE' in the optionally
    ...
    static void generateDate(bsl::vector<char> *buffer,
        ...
        // Format the specified 'value' and append the result to the specified
        // 'buffer'.  The 'bdlt::Date' is formatted as follows: four digits to
    ...
    static void generateDatetime(bsl::vector<char>    *buffer,
        ...
        // Format the specified 'value' and append the result to the specified
        // 'buffer'.  The 'bdlt::Datetime' is formatted as a formatted
        // 'bdlt::Date' followed by a single space followed by a formatted
        // 'bdlt::Time'.  Note that 'value' is emitted in a form parsable by
        // the corresponding 'parse' function.

    static void generateDatetimeTz(bsl::vector<char>      *buffer,
                                   const bdlt::DatetimeTz&  value);
        // Format the specified 'value' and append the result to the specified
        // 'buffer'.  The 'bdlt::DatetimeTz' is formatted as a formatted
        // 'bdlt::Date' followed by a single space followed by a formatted
        // 'bdlt::Time'.  Note that 'value' is emitted in a form parsable by
        // the corresponding 'parse' function.
    ...
    static void generateDateTz(bsl::vector<char>  *buffer,
        ...
        // Format the specified 'value' and append the result to the specified
        // 'buffer'.  The 'bdlt::DateTz' is formatted as follows: four digits to
        // represent the year followed by a forward slash ('/') followed by
        // two digits to represent the month followed by a forward slash ('/')
        // followed by two digits to represent the day.  All values will have
        // as many leading zeros as necessary to reach the specified number
    ...
    static void generateTime(bsl::vector<char> *buffer,
        ...
        // Format the specified 'value' and append the result to the specified
        // 'buffer'.  The 'bdlt::Time' is formatted as follows: two digits to
    ...
    static void generateTimeTz(bsl::vector<char>  *buffer,
        ...
        // Format the specified 'value' and append the result to the specified
        // 'buffer'.  The 'bdlt::TimeTz' is formatted as follows: two digits to
        // represent hours followed by a colon followed by two digits to
        // represent minutes followed by a colon followed by two digits to
        // represent seconds followed by a colon followed by three digits to
        // represent milliseconds.  All values will have leading zeros to
...
// CLASS METHODS
inline
int TypesParserImpUtil::parseQuotedString(const char  **endPos,
                                                bsl::string  *result,
                                                const char   *inputString)
{
...
inline
int TypesParserImpUtil::parseString(const char  **endPos,
                                          bsl::string  *result,
                                          const char   *inputString)
{
    BSLS_ASSERT_SAFE(endPos);
...
inline
int TypesParserImpUtil::generateShort(char  *buffer,
                                            short  value,
                                            int    length)
{
...
inline
int TypesParserImpUtil::generateShortRaw(char *buffer, short value)
{
    BSLS_ASSERT_SAFE(buffer);
...
inline
int TypesParserImpUtil::generateShortRaw(char  *buffer,
                                               short  value,
                                               int    base)
{
    BSLS_ASSERT_SAFE(buffer);
...
inline
void TypesParserImpUtil::generateChar(bsl::vector<char> *buffer,
                                            char               value)
{
    BSLS_ASSERT_SAFE(buffer);
...
inline
void TypesParserImpUtil::generateShort(bsl::vector<char> *buffer,
                                             short              value,
                                             int                base)
{
    BSLS_ASSERT_SAFE(buffer);
...
inline
void TypesParserImpUtil::generateDatetime(bsl::vector<char>    *buffer,
                                                const bdlt::Datetime&  value)
{
    BSLS_ASSERT_SAFE(buffer);
...
inline
void TypesParserImpUtil::generateDatetimeTz(
                                                bsl::vector<char>      *buffer,
                                                const bdlt::DatetimeTz&  value)
{
    BSLS_ASSERT_SAFE(buffer);
...
inline
void TypesParserImpUtil::generateDateTz(bsl::vector<char>  *buffer,
                                              const bdlt::DateTz&  value)
{
    BSLS_ASSERT_SAFE(buffer);
...
inline
void TypesParserImpUtil::generateTimeTz(bsl::vector<char>  *buffer,
                                              const bdlt::TimeTz&  value)
{
    BSLS_ASSERT_SAFE(buffer);
