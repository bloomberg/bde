...
//                              Overview
//                              --------
// This driver tests parsing and generating functions of 'bdlpuxxx::NTypesParser'.
...
//  'ArDate'     for 'bsl::vector<bdlt::Date>'
//  'ArDatez'    for 'bsl::vector<bdlt::DateTz>'
//  'ArTime'     for 'bsl::vector<bdlt::Time>'
//  'ArTimez'    for 'bsl::vector<bdlt::TimeTz>'
//  'ArDT'       for 'bsl::vector<bdlt::Datetime>'
//  'ArDTz'      for 'bsl::vector<bdlt::DatetimeTz>'
//
...
int main(int argc, char *argv[])
{
      ...
      case 41: {
...

        {
            ...
            for (int ti = 0; ti < NUM_DATA ; ++ti) {
                ...
                const char *endPos;
                bdlpuxxx::NTypesParser::parseStringArray(&endPos, &val, VALUE);
      ...
      case 40: {
...

        {
            ...
            for (int ti = 0; ti < NUM_DATA ; ++ti) {
                ...
                const char *endPos;
                bdlpuxxx::NTypesParser::parseShortArray(&endPos, &val, VALUE);
      ...
      case 39: {
...

        {
            ...
            for (int ti = 0; ti < NUM_DATA ; ++ti) {
                ...
                const char *endPos;
                bdlpuxxx::NTypesParser::parseInt64Array(&endPos, &val, VALUE);
      ...
      case 38: {
...

        {
            ...
            for (int ti = 0; ti < NUM_DATA ; ++ti) {
                ...
                const char *endPos;
                bdlpuxxx::NTypesParser::parseIntArray(&endPos, &val, VALUE);
                ...
                buffer.push_back('\0');
                exp.push_back('\0');
                bdlpuxxx::NTypesParser::generateIntArray(&buffer, val, LEVEL, SPL);
                if (veryVerbose) {
                    P(&exp.front());
                    P(&buffer.front());
                    cout << endl;
      ...
      case 37: {
...

        {
            ...
            for (int ti = 0; ti < NUM_DATA ; ++ti) {
                ...
                const char *endPos;
                bdlpuxxx::NTypesParser::parseFloatArray(&endPos, &val, VALUE);
      ...
      case 36: {
...

        {
            ...
            for (int ti = 0; ti < NUM_DATA ; ++ti) {
                ...
                const char *endPos;
                bdlpuxxx::NTypesParser::parseDoubleArray(&endPos, &val, VALUE);
    ...
    "x[\n      1993/04/12 11:33:00.000\n      1712/11/17 01:29:00.000\n   ]" },
            ...
            for (int ti = 0; ti < NUM_DATA ; ++ti) {
                ...
                bsl::vector<bdlt::Datetime> val(&testAllocator);
                const char *endPos;
                bdlpuxxx::NTypesParser::parseDatetimeArray(&endPos, &val, VALUE);
      ...
      case 34: {
...

        {
            ...
            for (int ti = 0; ti < NUM_DATA ; ++ti) {
                ...
                bsl::vector<bdlt::Date> val(&testAllocator);
                const char *endPos;
                bdlpuxxx::NTypesParser::parseDateArray(&endPos, &val, VALUE);
      ...
      case 33: {
...

        {
            ...
            for (int ti = 0; ti < NUM_DATA ; ++ti) {
                ...
                const char *endPos;
                bdlpuxxx::NTypesParser::parseCharArray(&endPos, &val, VALUE);
      ...
      case 32: {
        ...
        {
            const bdlt::Time VALUE( 1, 2, 3, 456);
            ...
            for (int ti = 0; ti < NUM_DATA ; ++ti) {
                ...
                buffer.push_back('\0');
                exp.push_back('\0');
                bdlpuxxx::NTypesParser::generateTime(&buffer, VALUE, LEVEL, SPL);
                LOOP_ASSERT(LINE, exp == buffer);
            }
        }
      } break;
      case 31: {
...

        {
            ...
            for (int ti = 0; ti < NUM_DATA ; ++ti) {
                ...
                buffer.push_back('\0');
                exp.push_back('\0');
                bdlpuxxx::NTypesParser::generateString(&buffer, VALUE, LEVEL, SPL);
      ...
      case 30: {
...

        {
            ...
            for (int ti = 0; ti < NUM_DATA ; ++ti) {
                ...
                buffer.push_back('\0');
                exp.push_back('\0');
                bdlpuxxx::NTypesParser::generateShort(&buffer, VALUE, LEVEL, SPL);
                LOOP_ASSERT(LINE, exp == buffer);
            }
        }
      } break;
      case 29: {
...

        {
            ...
            for (int ti = 0; ti < NUM_DATA ; ++ti) {
                ...
                buffer.push_back('\0');
                exp.push_back('\0');
                bdlpuxxx::NTypesParser::generateInt64(&buffer, VALUE, LEVEL, SPL);
                LOOP_ASSERT(LINE, exp == buffer);
            }
        }
      } break;
      case 28: {
...

        {
            ...
            for (int ti = 0; ti < NUM_DATA ; ++ti) {
                ...
                const bsl::string JUNKSTR = JUNK;
                buffer.insert(buffer.end(), JUNKSTR.begin(), JUNKSTR.end());
                bdlpuxxx::NTypesParser::generateIntRaw(&buffer, VALUE, LEVEL, SPL);
                const bsl::string EXPSTR = EXP;
                bsl::vector<char> exp(&testAllocator);
                exp.insert(exp.end(), EXPSTR.begin(), EXPSTR.end());
                LOOP_ASSERT(LINE, exp == buffer);
                ...
                buffer.push_back('\0');
                exp.push_back('\0');
                bdlpuxxx::NTypesParser::generateInt(&buffer, VALUE, LEVEL, SPL);
                LOOP_ASSERT(LINE, exp == buffer);
            }
        }
      } break;
      case 27: {
...

        {
            ...
            for (int ti = 0; ti < NUM_DATA ; ++ti) {
                ...
                buffer.push_back('\0');
                exp.push_back('\0');
                bdlpuxxx::NTypesParser::generateFloat(&buffer, VALUE, LEVEL, SPL);
                LOOP_ASSERT(LINE, exp == buffer);
            }
        }
      } break;
      case 26: {
...

        {
            ...
            for (int ti = 0; ti < NUM_DATA ; ++ti) {
                ...
                buffer.push_back('\0');
                exp.push_back('\0');
                bdlpuxxx::NTypesParser::generateDouble(&buffer, VALUE, LEVEL, SPL);
                LOOP_ASSERT(LINE, exp == buffer);
            }
        }
      } break;
      case 25: { // TBD datetime not date
        ...
        {
            const bdlt::Date MATCH_DATE(   1, 2, 3);
            const bdlt::Time MATCH_TIME(23, 45, 21, 789);
            const bdlt::Datetime MATCH(MATCH_DATE, MATCH_TIME);
            ...
            for (int ti = 0; ti < NUM_DATA ; ++ti) {
                ...
                buffer.push_back('\0');
                exp.push_back('\0');
                bdlpuxxx::NTypesParser::generateDatetime(
      ...
      case 24: {
...

        {
            ...
            for (int ti = 0; ti < NUM_DATA ; ++ti) {
                ...
                buffer.push_back('\0');
                exp.push_back('\0');
                bdlpuxxx::NTypesParser::generateDate(&buffer, VALUE, LEVEL, SPL);
                LOOP_ASSERT(LINE, exp == buffer);
            }
        }
      } break;
      case 23: {
...

        {
            ...
            for (int ti = 0; ti < NUM_DATA ; ++ti) {
                ...
                buffer.push_back('\0');
                exp.push_back('\0');
                bdlpuxxx::NTypesParser::generateChar(&buffer, VALUE, LEVEL, SPL);
                LOOP_ASSERT(LINE, exp == buffer);
            }
        }
      } break;
      case 22: {
...

        {
            ...
            for (int ti = 0; ti < NUM_DATA ; ++ti) {
                ...
                bdlpuxxx::NTypesParser::stripNull(&result);
      ...
      case 21: {
        ...
        {
            const bdlt::Time INIT_VALUE_1( 1, 1, 1);  // first init. value
            const bdlt::Time INIT_VALUE_2(19, 7, 9);  // second init. value

            const bdlt::Time MATCH_0(11,  1,  2);
            const bdlt::Time MATCH_1(22, 34, 29);
            ...
            for (int ti = 0; ti < NUM_DATA ; ++ti) {
                ...
                {  // test with first initial value
                    bsl::vector<bdlt::Time> result(&testAllocator);
                    result.resize(1, INIT_VALUE_1);
                    const char *endPos = 0;
                    int rv = bdlpuxxx::NTypesParser::
            ...
            for (int ti = 0; ti < NUM_DATA ; ++ti) {
                ...
                {  // test with first initial value
                    ...
                    if (rv) {
                        ...
                        LOOP_ASSERT(LINE,
                                    LENGTH < 1 || (
                                        !BloombergLP::bdlimpxxx::Fuzzy::compare(
                                                         result[0], MATCH_0)));
                        LOOP_ASSERT(LINE,
                                    LENGTH < 2 || (
                                        !BloombergLP::bdlimpxxx::Fuzzy::compare(
      ...
      case 14: {
...

        {
            ...
            const bdlt::Date I3(1993, 1, 2);
            const bdlt::Date I4(2000, 3,30);

            const bdlt::Time IT1(23, 45, 21);
            const bdlt::Time IT2(17, 22, 18);
            const bdlt::Time IT3( 3,  4,  5);
            const bdlt::Time IT4(15, 17, 28);

            const bdlt::Datetime INIT_VALUE_1(I1, IT1);
            const bdlt::Datetime INIT_VALUE_2(I2, IT2);
            const bdlt::Datetime MATCH_0(I3, IT3);
            const bdlt::Datetime MATCH_1(I4, IT4);
            ...
            for (int ti = 0; ti < NUM_DATA ; ++ti) {
                ...
                {  // test with first initial value
                    bsl::vector<bdlt::Datetime> result(&testAllocator);
                    result.resize(1, INIT_VALUE_1);
                    const char *endPos = 0;
                    int rv = bdlpuxxx::NTypesParser::
      ...
      case 13: {
        ...
        {
            const bdlt::Date INIT_VALUE_1(   1, 1, 1);  // first init. value
            const bdlt::Date INIT_VALUE_2(1923, 7, 9);  // second init. value

            const bdlt::Date MATCH_0(1993, 1,  2);
            const bdlt::Date MATCH_1(2000, 3, 31);
            ...
            for (int ti = 0; ti < NUM_DATA ; ++ti) {
                ...
                {  // test with first initial value
                    bsl::vector<bdlt::Date> result(&testAllocator);
                    result.resize(1, INIT_VALUE_1);
                    const char *endPos = 0;
                    int rv = bdlpuxxx::NTypesParser::
