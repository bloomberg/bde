...
//
//@CLASSES:
//   bdlpuxxx::ParserImpUtil: namespace for primitive utility parsing functions
//
...
//      result->resize(0);
//
//      FAIL_UNLESS(0 == bdlpuxxx::ParserImpUtil::skipRequiredToken(&s, s, '['));
//      bdlpuxxx::ParserImpUtil::skipWhiteSpace(&s, s);
//
//      while (1) {
//          if (0 == bdlpuxxx::ParserImpUtil::skipRequiredToken(&s2, s, ']')) {
//              s = s2;
//              SUCCEED;
//          }
//
//          if (valueCount) {
//              FAIL_UNLESS(0 == bdlpuxxx::ParserImpUtil::
...
struct ParserImpUtil {
  ...
  public:
    ...
    static void generateIdentifier(bsl::vector<char> *buffer,
        ...
        // '<STRING>' (see 'bdlpuxxx_typesparserimputil').
                                                   ...
                                                   char         token)
{
    ...
    *endPos = inputString;
    if (bdlb::CharType::toUpper(token) == bdlb::CharType::toUpper(**endPos)) {
        ++*endPos;
...
inline
void ParserImpUtil::generateIndentation(
