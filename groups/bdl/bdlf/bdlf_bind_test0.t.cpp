...
DEFINE_TEST_CASE(16) {
        ...
        //
        // Plan:
        //   Call 'bdlf::BindUtil::bindR' with an instance 'mX' of the classes
...

        {
            ...
            ASSERT(0 == bdlf::BindUtil::bindR<ConvertibleFromToInt>(mX) ());
            ASSERT(EXPECTED == X);
...

        {
            ...
            // 'bdlf::BindUtil::bind' and another for the privately held copy
            // inside the binder).
...
DEFINE_TEST_CASE(14) {
        ...
        //
        // Plan:
        //   Call 'bdlf::BindUtil::bindR' with the 'testFunc0' method of the
     ...
     printf("\nTESTING 'bdlf::BindUtil::bindR' WITH MEMBER FUNCTION POINTER"
...

        {
            ...
            ASSERT(0 == bdlf::BindUtil::bindR<ConvertibleFromToInt>(
...
DEFINE_TEST_CASE(13) {
     ...
     printf("\nTESTING 'bdlf::BindUtil::bindR' WITH FREE FUNCTION REFERENCE"
...

        {
            ...
            ASSERT(0 == bdlf::BindUtil::bindR<ConvertibleFromToInt>(
                                bdlf::Bind_TestFunctionsNoAlloc::func0, &mX)());
            ASSERT(EXPECTED == X);
...

        {
            ...
            ASSERT(0 == bdlf::BindUtil::bindR<ConvertibleFromToInt>(
                                  bdlf::Bind_TestFunctionsAlloc::func0, &mX)());
            ASSERT(EXPECTED == X);
...
DEFINE_TEST_CASE(12) {
        ...
        //
        // Plan:
        //   Call 'bdlf::BindUtil::bindR' with the address of the 'func0'
        //   class method of the 'bdlf::Bind_TestFunctionsNoAlloc' or
        //   'bdlf::Bind_TestFunctionsAlloc' utility classes, that takes a
...
DEFINE_TEST_CASE(11) {
        ...
        //
        // Plan:
        //  The plan is similar to case 6 of 'bdlf::BindUtil::bind':  call
        //  'bdlf::BindUtil::bindA' with an instance 'mX' of the classes
        //  'NoAllocTestType' or 'AllocTestType', constructed with or without
        //  an allocator, invoked with no parameters.  Upon invocation, verify
        //  that the return value and state of 'mX' are as expected, and that
       ...
       printf("\nTESTING 'bdlf::BindUtil::bindA' WITH FUNCTION OBJECT VALUE"
...

        {
            ...
            ASSERT(0 == bdlf::BindUtil::bindA(Z2, mX) ());
            ASSERT(EXPECTED == X);
...

        {
            ...
            // 'bdlf::BindUtil::bind'; note that the privately held copy inside
            // the binder uses 'Z2').
...
DEFINE_TEST_CASE(10) {
        ...
        //   'bdlf::BindUtil::bindA' with the address of an instance 'mX' of the
...
DEFINE_TEST_CASE(9) {
        ...
        //   'bdlf::BindUtil::bindA' with the 'testFunc0' method of the classes
     ...
     printf("\nTESTING 'bdlf::BindUtil::bindA' WITH MEMBER FUNCTION POINTER"
...

        {
            ...
            ASSERT(0 == bdlf::BindUtil::bindA(Z2,
                                         &NoAllocTestType::testFunc0, &mX) ());
            ASSERT(EXPECTED == X);
...
DEFINE_TEST_CASE(7) {
        ...
        //   'bdlf::BindUtil::bindA' with the 'func0' function of the
        //   'bdlf::Bind_TestFunctionsNoAlloc' or 'bdlf::Bind_TestFunctionsAlloc'
...
DEFINE_TEST_CASE(6) {
        ...
        //
        // Plan:
        //   Call 'bdlf::BindUtil::bind' with an instance 'mX' of the classes
        //   'NoAllocTestType' or 'AllocTestType', constructed with or without
        //   an allocator, invoked with no parameters.  Upon invocation, verify
        //   that the return value and state of 'mX' are as expected, and that
        //   the proper amount of allocation took place.
...

        {
            ...
            ASSERT(0 == bdlf::BindUtil::bind(mX)());
            ASSERT(EXPECTED == X);
...
DEFINE_TEST_CASE(5) {
        ...
        //
        // Plan:
        //   Call 'bdlf::BindUtil::bind' with the address of an instance 'mX' of
...
DEFINE_TEST_CASE(4) {
        ...
        //
        // Plan:
        //   Call 'bdlf::BindUtil::bind' with the 'testFunc0' method of
...
DEFINE_TEST_CASE(2) {
        ...
        //
        // Plan:
        //   Call 'bdlf::BindUtil::bind' with the address of the 'func0' class
        //   method of the utility classes 'bdlf::Bind_TestFunctionsNoAlloc' or
...
DEFINE_TEST_CASE(1) {
        ...
        // 0 arguments to function object.
        {
            ...
            typedef bdlf::Bind_BoundTuple0 ListType;
