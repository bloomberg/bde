...
#define MIDDLE_ARG_TS int,int,int
#define MIDDLE_ARGS 2,3,4

        typedef bdlf::Bind_BoundTuple5<int,MIDDLE_ARG_TS,int> IntList;
        typedef bdlf::Bind_BoundTuple5<bdlf::PlaceHolder<1>,MIDDLE_ARG_TS,
...
DEFINE_TEST_CASE(14) {
        ...
        //
        // Plan:
        //   Call 'bdlf::BindUtil::bindR' with the 'testFunc5'
...
DEFINE_TEST_CASE(13) {
     ...
     printf("\nTESTING 'bdlf::BindUtil::bindR' WITH FREE FUNCTION REFERENCE"
        ...
        if (verbose) printf("\t\tWith placeholder.\n");
        {
            ...
            LOOP_ASSERT(PARAMS,
                        PARAMS == bdlf::BindUtil::bindR<ConvertibleFromToInt>(
            bdlf::Bind_TestFunctionsNoAlloc::func5, &mX, // invocable
                                        _1,_2,_3,_4,_5) // bound arguments
                                     (I1,I2,I3,I4,I5)); // invocation arguments
        ...
        if (verbose) printf("\t\tWith placeholder.\n");
        {
            ...
            LOOP_ASSERT(PARAMS,
                        PARAMS == bdlf::BindUtil::bindR<ConvertibleFromToInt>(
              bdlf::Bind_TestFunctionsAlloc::func5, &mX, // invocable
                                        _1,_2,_3,_4,_5) // bound arguments
                                     (V1,V2,V3,V4,V5)); // invocation arguments
...
DEFINE_TEST_CASE(12) {
        ...
        //   'func5' of the utility class 'bdlf::Bind_TestFunctionsNoAlloc' or
...
DEFINE_TEST_CASE(9) {
        ...
        //   'bdlf::BindUtil::bindA' with the 'testFunc5' method of the
...
DEFINE_TEST_CASE(7) {
        ...
        //   'bdlf::BindUtil::bindA' with the address of the 'func5' class
...
DEFINE_TEST_CASE(4) {
        ...
        //
        // Plan:
        //   Call 'bdlf::BindUtil::bind' with the 'testFunc5' method of the
...
DEFINE_TEST_CASE(2) {
        ...
        //
        // Plan:
        //   Call 'bdlf::BindUtil::bind' with the address of the 'func5' class
...
DEFINE_TEST_CASE(1) {
        ...
        if (verbose) printf("\t\tWith placeholder.\n");
        {
            ...
            typedef bdlf::Bind_BoundTuple5<PH1,PH2,PH3,PH4,PH5>  ListType;
        ...
        if (verbose) printf("\t\tWithout placeholder.\n");
        {
            ...
            typedef NoAllocTestType                       *FUNC;
            typedef bdlf::Bind_BoundTuple5<NoAllocTestArg1,
                                     NoAllocTestArg2,
                                     NoAllocTestArg3,
                                     NoAllocTestArg4,
        ...
        {
            typedef AllocTestType                         *FUNC;
            typedef bdlf::Bind_BoundTuple5<AllocTestArg1,
                                     AllocTestArg2,
                                     AllocTestArg3,
                                     AllocTestArg4,
