...
DEFINE_TEST_CASE(17) {
        ...
        typedef bdlf::Bind_BoundTuple1<int>                   IntList;
        typedef bdlf::Bind_BoundTuple1<bdlf::PlaceHolder<1> > BitwiseList;
        typedef bdlf::Bind_BoundTuple1<NonBitwiseArg>         NonBitwiseList;

        typedef bdlf::Bind_TestUtil TU;

        BitwiseArg           bwLastArg(1);
        BitwiseInvocable     bwFunc;
        NonBitwiseArg        nonBwLastArg(1);
...
#define BWM_TEST(RET,FUNC,ARG,EXPECT)                                         \
        ASSERT(!EXPECT == !(TU::isBitwiseMoveableType(                        \
                                bdlf::BindUtil::bind((FUNC),(ARG)))));        \
        ASSERT(!EXPECT == !(TU::isBitwiseMoveableType(                        \
                                bdlf::BindUtil::bindR<RET>((FUNC),(ARG)))));  \
        ASSERT(!EXPECT == !(TU::isBitwiseMoveableType(                        \
                                bdlf::BindUtil::bindA(&alloc0,(FUNC),(ARG)))))

        if (veryVerbose) printf("Testing BindUtil::bind[RA]\n");
        //       Return type    Invocable  Arg           Exp
        //       =============  =========  ============  =====
        BWM_TEST(bslmf::Nil   , bwFunc   , bwLastArg   , true );
        BWM_TEST(BitwiseRet   , bwFunc   , bwLastArg   , true );
        BWM_TEST(BitwiseRet   , nonBwFunc, bwLastArg   , false);
        BWM_TEST(BitwiseRet   , bwFunc   , nonBwLastArg, false);
        BWM_TEST(NonBitwiseRet, bwFunc   , bwLastArg   , true );
#undef BWM_TEST
...
DEFINE_TEST_CASE(14) {
        ...
        //
        // Plan:
        //   Call 'bdlf::BindUtil::bindR' with the 'testFunc1'
...
DEFINE_TEST_CASE(13) {
     ...
     printf("\nTESTING 'bdlf::BindUtil::bindR' WITH FREE FUNCTION REFERENCE"
        ...
        if (verbose) printf("\t\tWith placeholder.\n");
        {
            ...
            LOOP_ASSERT(PARAMS,
                        PARAMS == bdlf::BindUtil::bindR<ConvertibleFromToInt>(
            bdlf::Bind_TestFunctionsNoAlloc::func1, &mX, // invocable
                                              _1) // bound arguments
                                           (I1)); // invocation arguments
        ...
        if (verbose) printf("\t\tWith placeholder.\n");
        {
            ...
            LOOP_ASSERT(PARAMS,
                        PARAMS == bdlf::BindUtil::bindR<ConvertibleFromToInt>(
              bdlf::Bind_TestFunctionsAlloc::func1, &mX, // invocable
                                              _1) // bound arguments
                                           (V1)); // invocation arguments
...
DEFINE_TEST_CASE(12) {
        ...
        //   'func1' of the utility class 'bdlf::Bind_TestFunctionsNoAlloc' or
...
DEFINE_TEST_CASE(9) {
        ...
        //   'bdlf::BindUtil::bindA' with the 'testFunc1' method of the
...
DEFINE_TEST_CASE(7) {
        ...
        //   'bdlf::BindUtil::bindA' with the address of the 'func1' class
...
DEFINE_TEST_CASE(4) {
        ...
        //
        // Plan:
        //   Call 'bdlf::BindUtil::bind' with the 'testFunc1' method of the
...
DEFINE_TEST_CASE(2) {
        ...
        //
        // Plan:
        //   Call 'bdlf::BindUtil::bind' with the address of the 'func1' class
...
DEFINE_TEST_CASE(1) {
        ...
        if (verbose) printf("\t\tWith placeholder.\n");
        {
            ...
            typedef bdlf::Bind_BoundTuple1<PH1>             ListType;
        ...
        if (verbose) printf("\t\tWithout placeholder.\n");
        {
            ...
            typedef NoAllocTestType                        *FUNC;
            typedef bdlf::Bind_BoundTuple1<NoAllocTestArg1>  ListType;
            typedef bdlf::Bind<bslmf::Nil, FUNC, ListType>   Bind;
        ...
        {
            typedef AllocTestType                         *FUNC;
            typedef bdlf::Bind_BoundTuple1<AllocTestArg1>   ListType;
            typedef bdlf::Bind<bslmf::Nil, FUNC, ListType>  Bind;
