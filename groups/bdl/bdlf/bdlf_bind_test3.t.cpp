...
#define MIDDLE_ARG_TS int
#define MIDDLE_ARGS 2

        typedef bdlf::Bind_BoundTuple3<int,MIDDLE_ARG_TS,int> IntList;
        typedef bdlf::Bind_BoundTuple3<bdlf::PlaceHolder<1>,MIDDLE_ARG_TS,
...
DEFINE_TEST_CASE(14) {
        ...
        //
        // Plan:
        //   Call 'bdlf::BindUtil::bindR' with the 'testFunc3'
...
DEFINE_TEST_CASE(13) {
     ...
     printf("\nTESTING 'bdlf::BindUtil::bindR' WITH FREE FUNCTION REFERENCE"
        ...
        if (verbose) printf("\t\tWith placeholder.\n");
        {
            ...
            LOOP_ASSERT(PARAMS,
                        PARAMS == bdlf::BindUtil::bindR<ConvertibleFromToInt>(
            bdlf::Bind_TestFunctionsNoAlloc::func3, &mX, // invocable
                                              _1,_2,_3) // bound arguments
                                           (I1,I2,I3)); // invocation arguments
        ...
        if (verbose) printf("\t\tWith placeholder.\n");
        {
            ...
            LOOP_ASSERT(PARAMS,
                        PARAMS == bdlf::BindUtil::bindR<ConvertibleFromToInt>(
              bdlf::Bind_TestFunctionsAlloc::func3, &mX, // invocable
                                              _1,_2,_3) // bound arguments
                                           (V1,V2,V3)); // invocation arguments
...
DEFINE_TEST_CASE(12) {
        ...
        //   'func3' of the utility class 'bdlf::Bind_TestFunctionsNoAlloc' or
...
DEFINE_TEST_CASE(9) {
        ...
        //   'bdlf::BindUtil::bindA' with the 'testFunc3' method of the
...
DEFINE_TEST_CASE(7) {
        ...
        //   'bdlf::BindUtil::bindA' with the address of the 'func3' class
...
DEFINE_TEST_CASE(4) {
        ...
        //
        // Plan:
        //   Call 'bdlf::BindUtil::bind' with the 'testFunc3' method of the
...
DEFINE_TEST_CASE(2) {
        ...
        //
        // Plan:
        //   Call 'bdlf::BindUtil::bind' with the address of the 'func3' class
...
DEFINE_TEST_CASE(1) {
        ...
        if (verbose) printf("\t\tWith placeholder.\n");
        {
            ...
            typedef bdlf::Bind_BoundTuple3<PH1,PH2,PH3>     ListType;
        ...
        if (verbose) printf("\t\tWithout placeholder.\n");
        {
            ...
            typedef NoAllocTestType                       *FUNC;
            typedef bdlf::Bind_BoundTuple3<NoAllocTestArg1,
                                     NoAllocTestArg2,
        ...
        {
            typedef AllocTestType                         *FUNC;
            typedef bdlf::Bind_BoundTuple3<AllocTestArg1,
                                     AllocTestArg2,
