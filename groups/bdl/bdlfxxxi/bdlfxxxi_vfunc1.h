// bdlfxxxi_vfunc1.h                                                  -*-C++-*-
#ifndef INCLUDED_BDLFXXXI_VFUNC1
#define INCLUDED_BDLFXXXI_VFUNC1
...
//
//@CLASSES:
// bdlfxxxi::Vfunc1Null: a 1-arg void no-op functor
//
// bdlfxxxi::Vfunc1F1: a 1-arg void functor created from a 1-arg function
// bdlfxxxi::Vfunc1F2: a 1-arg void functor created from a 2-arg function
// bdlfxxxi::Vfunc1F3: a 1-arg void functor created from a 3-arg function
// bdlfxxxi::Vfunc1F4: a 1-arg void functor created from a 4-arg function
// bdlfxxxi::Vfunc1F5: a 1-arg void functor created from a 5-arg function
// bdlfxxxi::Vfunc1F6: a 1-arg void functor created from a 6-arg function
// bdlfxxxi::Vfunc1F7: a 1-arg void functor created from a 7-arg function
// bdlfxxxi::Vfunc1F8: a 1-arg void functor created from a 8-arg function
// bdlfxxxi::Vfunc1F9: a 1-arg void functor created from a 9-arg function
//
// bdlfxxxi::Vfunc1C1: a 1-arg void functor created from obj & 1-arg method
// bdlfxxxi::Vfunc1C2: a 1-arg void functor created from obj & 2-arg method
// bdlfxxxi::Vfunc1C3: a 1-arg void functor created from obj & 3-arg method
// bdlfxxxi::Vfunc1C4: a 1-arg void functor created from obj & 4-arg method
// bdlfxxxi::Vfunc1C5: a 1-arg void functor created from obj & 5-arg method
// bdlfxxxi::Vfunc1C6: a 1-arg void functor created from obj & 6-arg method
// bdlfxxxi::Vfunc1C7: a 1-arg void functor created from obj & 7-arg method
// bdlfxxxi::Vfunc1C8: a 1-arg void functor created from obj & 8-arg method
// bdlfxxxi::Vfunc1C9: a 1-arg void functor created from obj & 9-arg method
//
// bdlfxxxi::Vfunc1M1: a 1-arg void functor created from obj ptr & 1-arg method
// bdlfxxxi::Vfunc1M2: a 1-arg void functor created from obj ptr & 2-arg method
// bdlfxxxi::Vfunc1M3: a 1-arg void functor created from obj ptr & 3-arg method
// bdlfxxxi::Vfunc1M4: a 1-arg void functor created from obj ptr & 4-arg method
// bdlfxxxi::Vfunc1M5: a 1-arg void functor created from obj ptr & 5-arg method
// bdlfxxxi::Vfunc1M6: a 1-arg void functor created from obj ptr & 6-arg method
// bdlfxxxi::Vfunc1M7: a 1-arg void functor created from obj ptr & 7-arg method
// bdlfxxxi::Vfunc1M8: a 1-arg void functor created from obj ptr & 8-arg method
// bdlfxxxi::Vfunc1M9: a 1-arg void functor created from obj ptr & 9-arg method
//
...
// implementation of the base 'bdlfxxxr::Vfunc1' representation based on the
...
// then the "null functor" 'bdlfxxxi::Vfunc1Null' may be used.
//
///Language-Imposed Details
///------------------------
// For practical reasons, this component must distinguish among four types of
// functors.  The first type is a "null functor" 'bdlfxxxi::Vfunc1Null', which
...
// implementations are named 'bdefi::Vfunc1XN' where 'X' is one of 'F', 'C', or
...
//..
// Note that a 'const' member function may be wrapped by a 'bdefi::Vfunc1MN'
// functor, but wrapping a non-'const' method by a 'bdefi::Vfunc1CN' will
// result in compile time error in most compiler implementations.
//
// Note also that, to accommodate the preservation of 'const', the
// 'bdefi::Vfunc1CN' functors hold an object 'Obj', supplied by a 'const'
// 'Obj&' in the constructor, while 'bdefi::Vfunc1MN' functors hold a pointer
...
//..
//   bdlfxxxr::Vfunc1<int>::deleteObject(rep);
//..
...
template <class A1>
class Vfunc1Null : public bdlfxxxr::Vfunc1<A1> {
...
class Vfunc1F1 : public bdlfxxxr::Vfunc1<A1> {
    // This class defines the representation for a function object (functor),
...
class Vfunc1F2 : public bdlfxxxr::Vfunc1<A1> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking one argument and
    // returning 'void', that holds a pure procedure (i.e., free function,
...
class Vfunc1F3 : public bdlfxxxr::Vfunc1<A1> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking one argument and
    // returning 'void', that holds a pure procedure (i.e., free function,
...
class Vfunc1F4 : public bdlfxxxr::Vfunc1<A1> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking one argument and
    // returning 'void', that holds a pure procedure (i.e., free function,
...
class Vfunc1F5 : public bdlfxxxr::Vfunc1<A1> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking one argument and
    // returning 'void', that holds a pure procedure (i.e., free function,
...
template <class F, class A1, class D1, class D2, class D3, class D4,
          class D5>
class Vfunc1F6 : public bdlfxxxr::Vfunc1<A1> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking one argument and
    // returning 'void', that holds a pure procedure (i.e., free function,
...
template <class  F, class A1, class D1, class D2, class D3, class D4,
          class D5, class D6>
class Vfunc1F7 : public bdlfxxxr::Vfunc1<A1> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking one argument and
    // returning 'void', that holds a pure procedure (i.e., free function,
...
class Vfunc1F8 : public bdlfxxxr::Vfunc1<A1> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking one argument and
    // returning 'void', that holds a pure procedure (i.e., free function,
...
class Vfunc1F9 : public bdlfxxxr::Vfunc1<A1> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking one argument and
    // returning 'void', that holds a pure procedure (i.e., free function,
...
class Vfunc1C1 : public bdlfxxxr::Vfunc1<A1> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking one argument and
...
class Vfunc1C2 : public bdlfxxxr::Vfunc1<A1> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking one argument and
    // returning 'void', that holds an object and one of that object's 'const'
...
class Vfunc1C3 : public bdlfxxxr::Vfunc1<A1> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking one argument and
    // returning 'void', that holds an object and one of that object's 'const'
...
class Vfunc1C4 : public bdlfxxxr::Vfunc1<A1> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking one argument and
    // returning 'void', that holds an object and one of that object's 'const'
...
template <class OBJ, class C, class A1, class D1, class D2, class D3,
          class D4>
class Vfunc1C5 : public bdlfxxxr::Vfunc1<A1> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking one argument and
    // returning 'void', that holds an object and one of that object's 'const'
...
template <class OBJ, class C, class A1, class D1, class D2, class D3,
          class D4, class D5>
class Vfunc1C6 : public bdlfxxxr::Vfunc1<A1> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking one argument and
    // returning 'void', that holds an object and one of that object's 'const'
...
class Vfunc1C7 : public bdlfxxxr::Vfunc1<A1> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking one argument and
    // returning 'void', that holds an object and one of that object's 'const'
...
class Vfunc1C8 : public bdlfxxxr::Vfunc1<A1> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking one argument and
    // returning 'void', that holds an object and one of that object's 'const'
...
class Vfunc1C9 : public bdlfxxxr::Vfunc1<A1> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking one argument and
    // returning 'void', that holds an object and one of that object's 'const'
...
class Vfunc1M1 : public bdlfxxxr::Vfunc1<A1> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking one argument and
...
class Vfunc1M2 : public bdlfxxxr::Vfunc1<A1> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking one argument and
    // returning 'void', that holds the address of an object and one of that
...
class Vfunc1M3 : public bdlfxxxr::Vfunc1<A1> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking one argument and
    // returning 'void', that holds the address of an object and one of that
...
class Vfunc1M4 : public bdlfxxxr::Vfunc1<A1> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking one argument and
    // returning 'void', that holds the address of an object and one of that
...
template <class OBJ, class M, class A1, class D1, class D2, class D3,
          class D4>
class Vfunc1M5 : public bdlfxxxr::Vfunc1<A1> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking one argument and
    // returning 'void', that holds the address of an object and one of that
...
template <class OBJ, class M, class A1, class D1, class D2, class D3,
          class D4, class D5>
class Vfunc1M6 : public bdlfxxxr::Vfunc1<A1> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking one argument and
    // returning 'void', that holds the address of an object and one of that
...
template <class OBJ, class M, class A1, class D1, class D2, class D3,
          class D4, class D5, class D6>
class Vfunc1M7 : public bdlfxxxr::Vfunc1<A1> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking one argument and
    // returning 'void', that holds the address of an object and one of that
...
template <class OBJ, class M, class A1, class D1, class D2, class D3,
          class D4, class D5, class D6, class D7>
class Vfunc1M8 : public bdlfxxxr::Vfunc1<A1> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking one argument and
    // returning 'void', that holds the address of an object and one of that
...
template <class OBJ, class M, class A1, class D1, class D2, class D3,
          class D4, class D5, class D6, class D7, class D8>
class Vfunc1M9 : public bdlfxxxr::Vfunc1<A1> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking one argument and
    // returning 'void', that holds the address of an object and one of that
