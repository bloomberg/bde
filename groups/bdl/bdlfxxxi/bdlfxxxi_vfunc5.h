...
#define INCLUDED_BDLFXXXI_VFUNC5
...
//
//@CLASSES:
// bdlfxxxi::Vfunc5Null: a 5-arg void no-op functor
//
// bdlfxxxi::Vfunc5F5: a 5-arg void functor created from a 5-arg function
// bdlfxxxi::Vfunc5F6: a 5-arg void functor created from a 6-arg function
// bdlfxxxi::Vfunc5F7: a 5-arg void functor created from a 7-arg function
// bdlfxxxi::Vfunc5F8: a 5-arg void functor created from a 8-arg function
// bdlfxxxi::Vfunc5F9: a 5-arg void functor created from a 9-arg function
//
// bdlfxxxi::Vfunc5C5: a 5-arg void functor created from obj & 5-arg method
// bdlfxxxi::Vfunc5C6: a 5-arg void functor created from obj & 6-arg method
// bdlfxxxi::Vfunc5C7: a 5-arg void functor created from obj & 7-arg method
// bdlfxxxi::Vfunc5C8: a 5-arg void functor created from obj & 8-arg method
// bdlfxxxi::Vfunc5C9: a 5-arg void functor created from obj & 9-arg method
//
// bdlfxxxi::Vfunc5M5: a 5-arg void functor created from obj ptr & 5-arg method
// bdlfxxxi::Vfunc5M6: a 5-arg void functor created from obj ptr & 6-arg method
// bdlfxxxi::Vfunc5M7: a 5-arg void functor created from obj ptr & 7-arg method
// bdlfxxxi::Vfunc5M8: a 5-arg void functor created from obj ptr & 8-arg method
// bdlfxxxi::Vfunc5M9: a 5-arg void functor created from obj ptr & 9-arg method
//
...
// implementation of the base 'bdlfxxxr::Vfunc5' representation based on the
...
// then the "null functor" 'bdlfxxxi::Vfunc5Null' may be used.
//
///Language-Imposed Details
///------------------------
// For practical reasons, this component must distinguish among four types of
// functors.  The first type is a "null functor" 'bdlfxxxi::Vfunc5Null', which
...
// implementations are named 'bdefi::Vfunc5XN' where 'X' is one of 'F', 'C', or
...
//..
// Note that a 'const' member function may be wrapped by a 'bdefi::Vfunc5MN'
// functor, but wrapping a non-'const' method by a 'bdefi::Vfunc5CN' will
// result in compile time error in most compiler implementations.
//
// Note also that, to accommodate the preservation of 'const', the
// 'bdefi::Vfunc5CN' functors hold an object 'Obj', supplied by a 'const'
// 'Obj&' in the constructor, while 'bdefi::Vfunc5MN' functors hold a pointer
...
class Vfunc5Null : public bdlfxxxr::Vfunc5<A1, A2, A3, A4, A5> {
...
class Vfunc5F5 : public bdlfxxxr::Vfunc5<A1, A2, A3, A4, A5> {
    // This class defines the representation for a function object (functor),
...
class Vfunc5F6 : public bdlfxxxr::Vfunc5<A1, A2, A3, A4, A5> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking five arguments and
    // returning 'void', that holds a pure procedure (i.e., free function,
...
class Vfunc5F7 : public bdlfxxxr::Vfunc5<A1, A2, A3, A4, A5> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking five arguments and
    // returning 'void', that holds a pure procedure (i.e., free function,
...
class Vfunc5F8 : public bdlfxxxr::Vfunc5<A1, A2, A3, A4, A5> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking five arguments and
    // returning 'void', that holds a pure procedure (i.e., free function,
    // static member function, or functor) taking three additional trailing
...
class Vfunc5F9 : public bdlfxxxr::Vfunc5<A1, A2, A3, A4, A5> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking five arguments and
    // returning 'void', that holds a pure procedure (i.e., free function,
...
template <class OBJ, class C, class A1, class A2,
          class A3, class A4, class A5>
class Vfunc5C5 : public bdlfxxxr::Vfunc5<A1, A2, A3, A4, A5> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking five arguments and
...
template <class OBJ, class C, class A1, class A2,
          class A3, class A4, class A5, class D1>
class Vfunc5C6 : public bdlfxxxr::Vfunc5<A1, A2, A3, A4, A5> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking five arguments and
    // returning 'void', that holds an object and one of that object's 'const'
...
template <class OBJ, class C, class A1, class A2,
          class A3, class A4, class A5,
          class D1, class D2>
class Vfunc5C7 : public bdlfxxxr::Vfunc5<A1, A2, A3, A4, A5> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking five arguments and
    // returning 'void', that holds an object and one of that object's 'const'
...
template <class OBJ, class C, class A1, class A2,
          class A3, class A4, class A5,
          class D1, class D2, class D3>
class Vfunc5C8 : public bdlfxxxr::Vfunc5<A1, A2, A3, A4, A5> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking five arguments and
    // returning 'void', that holds an object and one of that object's 'const'
    // member functions taking three additional trailing arguments, and the
...
template <class OBJ, class C, class A1, class A2,
          ...
          class D1, class D2, class D3,
          class D4>
class Vfunc5C9 : public bdlfxxxr::Vfunc5<A1, A2, A3, A4, A5> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking five arguments and
    // returning 'void', that holds an object and one of that object's 'const'
...
template <class OBJ, class M, class A1, class A2,
          class A3, class A4, class A5>
class Vfunc5M5 : public bdlfxxxr::Vfunc5<A1, A2, A3, A4, A5> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking five arguments and
...
template <class OBJ, class M, class A1, class A2,
          class A3, class A4, class A5, class D1>
class Vfunc5M6 : public bdlfxxxr::Vfunc5<A1, A2, A3, A4, A5> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking five arguments and
    // returning 'void', that holds the address of an object and one of that
...
template <class OBJ, class M, class A1, class A2,
          class A3, class A4, class A5,
          class D1, class D2>
class Vfunc5M7 : public bdlfxxxr::Vfunc5<A1, A2, A3, A4, A5> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking five arguments and
    // returning 'void', that holds the address of an object and one of that
...
template <class OBJ, class M, class A1, class A2,
          class A3, class A4, class A5,
          class D1, class D2, class D3>
class Vfunc5M8 : public bdlfxxxr::Vfunc5<A1, A2, A3, A4, A5> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking five arguments and
    // returning 'void', that holds the address of an object and one of that
    // object's ('const' or non-'const') member functions taking three
...
template <class OBJ, class M, class A1, class A2,
          ...
          class D1, class D2, class D3,
          class D4>
class Vfunc5M9 : public bdlfxxxr::Vfunc5<A1, A2, A3, A4, A5> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking five arguments and
    // returning 'void', that holds the address of an object and one of that
...
Vfunc5Null<A1, A2, A3, A4, A5>::Vfunc5Null(
                                             bslma::Allocator *basicAllocator)
: bdlfxxxr::Vfunc5<A1, A2, A3, A4, A5>(basicAllocator)
{
}
