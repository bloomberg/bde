...
// non-'const' member function for every 'bdefi::Vfunc4MN' class.  Also, verify
...
//  'c_O'     for 'const OBJ'
//-----------------------------------------------------------------------------
// [ 4] 'bdlfxxxi::Vfunc4Null' methods:
// [ 4] bdlfxxxi::Vfunc4Null<A1-4>(ba *);
// [ 4] void execute<A1-4>(c_A1-4&) const;
// [ 4] ~bdlfxxxi::Vfunc4Null<A1-4>();
// ----------------------------------------------------------------------------
// 'bdlfxxxi::Vfunc4F4' methods:
// [ 4] bdlfxxxi::Vfunc4F4<F, A1-4>(c_F&, ba *);
// [ 4] void execute<F, A1-4>(c_A1-4&) const;
// [ 4] ~bdlfxxxi::Vfunc4F4<F, A1-4>();
// ----------------------------------------------------------------------------
// 'bdlfxxxi::Vfunc4C4' methods:
// [ 4] bdlfxxxi::Vfunc4C4<OBJ, C, A1-4>( OBJ *, c_C&, ba *);
// [ 4] void execute<OBJ, C, A1-4>(c_A1-4&) const;
// [ 4] ~bdlfxxxi::Vfunc4C4<OBJ, C, A1-4>();
// ----------------------------------------------------------------------------
// 'bdlfxxxi::Vfunc4M4' methods:
// [ 4] bdlfxxxi::Vfunc4M4<OBJ, M, A1-4>( OBJ *, c_M&, ba *);
// [ 4] void execute<OBJ, M, A1-4>(c_A1-4&) const;
// [ 4] ~bdlfxxxi::Vfunc4M4<OBJ, M, A1-4>();
//-----------------------------------------------------------------------------
// 'bdlfxxxi::Vfunc4F5' methods:
// [ 5] bdlfxxxi::Vfunc4F5<F, A1-4, D1>(c_F&, c_D1&, ba *);
// [ 5] void execute<F, A1-4, D1>(c_A1-4&) const;
// [ 5] ~bdlfxxxi::Vfunc4F5<F, A1-4, D1>();
// ----------------------------------------------------------------------------
// 'bdlfxxxi::Vfunc4C5' methods:
// [ 5] bdlfxxxi::Vfunc4C5<OBJ, C, A1-4, D1>( OBJ *, c_C&, c_D1&, ba *);
// [ 5] void execute<OBJ, C, A1-4, D1>(c_A1-4&) const;
// [ 5] ~bdlfxxxi::Vfunc4C5<OBJ, C, A1-4, D1>();
// ----------------------------------------------------------------------------
// 'bdlfxxxi::Vfunc4M5' methods:
// [ 5] bdlfxxxi::Vfunc4M5<OBJ, M, A1-4, D1>( OBJ *, c_M&, c_D1, ba *);
// [ 5] void execute<OBJ, M, A1-4, D1>(c_A1-4&) const;
// [ 5] ~bdlfxxxi::Vfunc4M5<OBJ, M, A1-4, D1>();
//-----------------------------------------------------------------------------
// 'bdlfxxxi::Vfunc4F6' methods:
// [ 6] bdlfxxxi::Vfunc4F6<F, A1-4, D1-2>(c_F&, c_D1-2&, ba *);
// [ 6] void execute<F, A1-4, D1-2>(c_A1-4&) const;
// [ 6] ~bdlfxxxi::Vfunc4F6<F, A1-4, D1-2>();
// ----------------------------------------------------------------------------
// 'bdlfxxxi::Vfunc4C6' methods:
// [ 6] bdlfxxxi::Vfunc4C6<OBJ, C, A1-4, D1-2>( OBJ *, c_C&, c_D1-2&, ba *);
// [ 6] void execute<OBJ, C, A1-4, D1-2>(c_A1-4&) const;
// [ 6] ~bdlfxxxi::Vfunc4C6<OBJ, C, A1-4, D1-2>();
// ----------------------------------------------------------------------------
// 'bdlfxxxi::Vfunc4M6' methods:
// [ 6] bdlfxxxi::Vfunc4M6<OBJ, M, A1-4, D1-2>( OBJ *, c_M&, c_D1-2, ba *);
// [ 6] void execute<OBJ, M, A1-4, D1-2>(c_A1-4&) const;
// [ 6] ~bdlfxxxi::Vfunc4M6<OBJ, M, A1-4, D1-2>();
//-----------------------------------------------------------------------------
// 'bdlfxxxi::Vfunc4F7' methods:
// [ 7] bdlfxxxi::Vfunc4F7<F, A1-4, D1-3>(c_F&, c_D1-3&, ba *);
// [ 7] void execute<F, A1-4, D1-3>(c_A1-4&) const;
// [ 7] ~bdlfxxxi::Vfunc4F7<F, A1-4, D1-3>();
// ----------------------------------------------------------------------------
// 'bdlfxxxi::Vfunc4C7' methods:
// [ 7] bdlfxxxi::Vfunc4C7<OBJ, C, A1-4, D1-3>( OBJ *, c_C&, c_D1-3&, ba *);
// [ 7] void execute<OBJ, C, A1-4, D1-3>(c_A1-4&) const;
// [ 7] ~bdlfxxxi::Vfunc4C7<OBJ, C, A1-4, D1-3>();
// ----------------------------------------------------------------------------
// 'bdlfxxxi::Vfunc4M7' methods:
// [ 7] bdlfxxxi::Vfunc4M7<OBJ, M, A1-4, D1-3>( OBJ *, c_M&, c_D1-3, ba *);
// [ 7] void execute<OBJ, M, A1-4, D1-3>(c_A1-4&) const;
// [ 7] ~bdlfxxxi::Vfunc4M7<OBJ, M, A1-4, D1-3>();
//-----------------------------------------------------------------------------
// 'bdlfxxxi::Vfunc4F8' methods:
// [ 8] bdlfxxxi::Vfunc4F8<F, A1-4, D1-4>(c_F&, c_D1-4&, ba *);
// [ 8] void execute<F, A1-4, D1-4>(c_A1-4&) const;
// [ 8] ~bdlfxxxi::Vfunc4F8<F, A1-4, D1-4>();
// ----------------------------------------------------------------------------
// 'bdlfxxxi::Vfunc4C8' methods:
// [ 8] bdlfxxxi::Vfunc4C8<OBJ, C, A1-4, D1-4>( OBJ *, c_C&, c_D1-4&, ba *);
// [ 8] void execute<OBJ, C, A1-4, D1-4>(c_A1-4&) const;
// [ 8] ~bdlfxxxi::Vfunc4C8<OBJ, C, A1-4, D1-4>();
// ----------------------------------------------------------------------------
// 'bdlfxxxi::Vfunc4M8' methods:
// [ 8] bdlfxxxi::Vfunc4M8<OBJ, M, A1-4, D1-4>( OBJ *, c_M&, c_D1-4, ba *);
// [ 8] void execute<OBJ, M, A1-4, D1-4>(c_A1-4&) const;
// [ 8] ~bdlfxxxi::Vfunc4M8<OBJ, M, A1-4, D1-4>();
//-----------------------------------------------------------------------------
// 'bdlfxxxi::Vfunc4F9' methods:
// [ 9] bdlfxxxi::Vfunc4F9<F, A1-4, D1-5>(c_F&, c_D1-5&, ba *);
// [ 9] void execute<F, A1-4, D1-5>(c_A1-4&) const;
// [ 9] ~bdlfxxxi::Vfunc4F9<F, A1-4, D1-5>();
// ----------------------------------------------------------------------------
// 'bdlfxxxi::Vfunc4C9' methods:
// [ 9] bdlfxxxi::Vfunc4C9<OBJ, C, A1-4, D1-5>( OBJ *, c_C&, c_D1-5&, ba *);
// [ 9] void execute<OBJ, C, A1-4, D1-5>(c_A1-4&) const;
// [ 9] ~bdlfxxxi::Vfunc4C9<OBJ, C, A1-4, D1-5>();
// ----------------------------------------------------------------------------
// 'bdlfxxxi::Vfunc4M9' methods:
// [ 9] bdlfxxxi::Vfunc4M9<OBJ, M, A1-4, D1-5>( OBJ *, c_M&, c_D1-5, ba *);
// [ 9] void execute<OBJ, M, A1-4, D1-5>(c_A1-4&) const;
// [ 9] ~bdlfxxxi::Vfunc4M9<OBJ, M, A1-4, D1-5>();
//-----------------------------------------------------------------------------
// [11] USAGE EXAMPLE
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 10: {
        ...
        //   'pragma' in 'bdlfxxxi_vfunc4.h' fixes this problem.  This test
...

        {
            ...
            typedef bdlfxxxr::Vfunc4<rrr *, rrr *, rrr *, rrr *> ObjBase;

            typedef bdlfxxxi::Vfunc4F9<CbFuncF9,
                                       rrr *, rrr *, rrr *, rrr *,
                                       rrr *, rrr *, rrr *, rrr *, rrr *> Obj1;

            typedef bdlfxxxi::Vfunc4F9<CbFuncF10,
                                       rrr *, rrr *, rrr *, rrr *,
      ...
      case 9: {
        ...
        //       functions by 'bdlfxxxi::Vfunc4M9' instances.
        //    5. Destructor of each class under test is properly executed.
        //
        // Plan:
        //   Create objects of every 'bdefi::Vfunc4X9' class.  Initialize
        //   'bdlfxxxi::Vfunc4F9' to have 'checkArgumentValues9' as the callback
        //   function.  Initialize 'bdlfxxxi::Vfunc4C9' and 'bdlfxxxi::Vfunc4M9' to
        //   have 'checkArgumentValues9' method of the 'CbClass' class as the
        //   callback function.  Call the 'execute' method for each
        //   'bdefi::Vfunc4X9' class.  The arguments in this call are
        ...
        //
        //   Create objects of every 'bdefi::Vfunc4X9' class.  Initialize
        //   'bdlfxxxi::Vfunc4F9' to have 'checkParameterTypes9' as the callback
        //   function.  Initialize 'bdlfxxxi::Vfunc4C9' to have
        //   'checkParameterTypesC9' method of the 'CbClass' class as the
        //   callback function.  Initialize 'bdlfxxxi::Vfunc4M9' to have
        //   'checkParameterTypesM9' method of the 'CbClass' class as the
        //   callback function.  The latter will test wether the
        //   'bdlfxxxi::Vfunc4M9' can have non-'const' functions as the callback
        //   function.
        //
        //   Having a function of 'checkParameterTypes' family as a callback
        //   function forces 'bdefi::Vfunc4X9' to be templatized so that each
        ...
        // Testing:
        //   'bdlfxxxi::Vfunc4F9' methods:
        //   bdlfxxxi::Vfunc4F9<F, A1-4, D1-5>(c_F&, c_D1-5&, ba *);
        //   void execute<F, A1-4, D1-5>(c_A1-4&) const;
        //   ~bdlfxxxi::Vfunc4F9<F, A1-4, D1-5>();
        // --------------------------------------------------------------------
        //   'bdlfxxxi::Vfunc4C9' methods:
        //   bdlfxxxi::Vfunc4C9<OBJ, C, A1-4, D1-5>( OBJ *, c_C&, c_D1-5&, ba *);
        //   void execute<OBJ, C, A1-4, D1-5>(c_A1-4&) const;
        //   ~bdlfxxxi::Vfunc4C9<OBJ, C, A1-4, D1-5>();
        // --------------------------------------------------------------------
        //   'bdlfxxxi::Vfunc4M9' methods:
        //   bdlfxxxi::Vfunc4M9<OBJ, M, A1-4, D1-5>( OBJ *, c_M&, c_D1-5, ba *);
        //    void execute<OBJ, M, A1-4, D1-5>(c_A1-4&) const;
        //   ~bdlfxxxi::Vfunc4M9<OBJ, M, A1-4, D1-5>();
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting constructors and argument values." << endl;
        {
            ...
            typedef void (CbClass::*CbFuncC9)(int *, int *, int *, int *,
                                              int *, int *, int *, int *,
                                              int *) const;
            typedef bdlfxxxr::Vfunc4<int *, int *, int *, int *> ObjBase;
            ...
            if (verbose) cout << "\t'bdlfxxxi::Vfunc4F9' object." << endl;
            {
                typedef bdlfxxxi::Vfunc4F9<CbFuncF9,
                                       int *, int *, int *, int *,
            ...
            if (verbose) cout << "\t'bdlfxxxi::Vfunc4C9' object." << endl;
            {
                typedef bdlfxxxi::Vfunc4C9<CbClass, CbFuncC9, int *, int *,
                                       int *, int *, int *, int *, int *,
                                       int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
            ...
            if (verbose) cout << "\t'bdlfxxxi::Vfunc4M9' object." << endl;
            {
                typedef bdlfxxxi::Vfunc4M9<CbClass, CbFuncC9,
                                       int *, int *, int *, int *,
                                       int *, int *, int *, int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
            ...
            cout << "\nTesting parameter types and destructors." << endl;
        {
            ...
            typedef void (CbClass::*CbFuncM9)(T1, T2, T3, T4, T5, T6, T7, T8,
                                              T9);
            typedef bdlfxxxr::Vfunc4<T1, T2, T3, T4> ObjBase;
            ...
            if (verbose)
                cout << "\tWhen calling 'bdlfxxxi::Vfunc4F9' 'execute' method."
                     << endl;
            {
                typedef bdlfxxxi::Vfunc4F9<CbFuncF9, T1, T2, T3, T4, T5, T6, T7,
                                       T8, T9> Obj;
                dcEnabled = 0;
            ...
            if (verbose)
                cout << "\tWhen calling 'bdlfxxxi::Vfunc4C9' 'execute' method."
                     << endl;
            {
                typedef bdlfxxxi::Vfunc4C9<CbClass, CbFuncC9, T1, T2,
            ...
            if (verbose)
                cout << "\tWhen calling 'bdlfxxxi::Vfunc4M9' 'execute' method."
                     << endl;
            {
                typedef bdlfxxxi::Vfunc4M9<CbClass, CbFuncM9, T1, T2, T3, T4,
                                       T5, T6, T7, T8, T9> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG4;
                numDeallocations = ta.numDeallocations();
      ...
      case 8: {
        ...
        //       those intended as argument types for the function parameters.
        //    4. Non-'const' member functions can be used as callback
        //       functions by 'bdlfxxxi::Vfunc4M8' instances.
        //    5. Destructor of each class under test is properly executed.
        //
        // Plan:
        //   Create objects of every 'bdefi::Vfunc4X8' class.  Initialize
        //   'bdlfxxxi::Vfunc4F8' to have 'checkArgumentValues8' as the callback
        //   function.  Initialize 'bdlfxxxi::Vfunc4C8' and 'bdlfxxxi::Vfunc4M8' to
        //   have 'checkArgumentValues8' method of the 'CbClass' class as the
        //   callback function.  Call the 'execute' method for each
        //   'bdefi::Vfunc4X8' class.  The arguments in this call are
        //   initialized with values of 'ARG1', 'ARG2', 'ARG3', 'ARG4',
        ...
        //
        //   Create objects of every 'bdefi::Vfunc4X8' class.  Initialize
        //   'bdlfxxxi::Vfunc4F8' to have 'checkParameterTypes8' as the callback
        //   function.  Initialize 'bdlfxxxi::Vfunc4C8' to have
        //   'checkParameterTypesC8' method of the 'CbClass' class as the
        //   callback function.  Initialize 'bdlfxxxi::Vfunc4M8' to have
        //   'checkParameterTypesM8' method of the 'CbClass' class as the
        //   callback function.  The latter will test wether the
        //   'bdlfxxxi::Vfunc4M8' can have non-'const' functions as the callback
        //   function.
        //
        //   Having a function of 'checkParameterTypes' family as a callback
        //   function forces 'bdefi::Vfunc4X8' to be templatized so that each
        //   argument to the callback function will be of unique type.  Hence,
        //   if the types of arguments passed in to the callback function is
        //   incorrect, the compiler will generate an error.
        //
        ...
        // Testing:
        //   'bdlfxxxi::Vfunc4F8' methods:
        //   bdlfxxxi::Vfunc4F8<F, A1-4, D1-4>(c_F&, c_D1-4&, ba *);
        //   void execute<F, A1-4, D1-4>(c_A1-4&) const;
        //   ~bdlfxxxi::Vfunc4F8<F, A1-4, D1-4>();
        // -------------------------------------------------------------------
        //   'bdlfxxxi::Vfunc4C8' methods:
        //   bdlfxxxi::Vfunc4C8<OBJ, C, A1-4, D1-4>( OBJ *, c_C&, c_D1-4&, ba *);
        //   void execute<OBJ, C, A1-4, D1-4>(c_A1-4&) const;
        //   ~bdlfxxxi::Vfunc4C8<OBJ, C, A1-4, D1-4>();
        // --------------------------------------------------------------------
        //   'bdlfxxxi::Vfunc4M8' methods:
        //   bdlfxxxi::Vfunc4M8<OBJ, M, A1-4, D1-4>( OBJ *, c_M&, c_D1-4, ba *);
        //    void execute<OBJ, M, A1-4, D1-4>(c_A1-4&) const;
        //   ~bdlfxxxi::Vfunc4M8<OBJ, M, A1-4, D1-4>();
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting constructors and argument values." << endl;
        {
            ...
            if (verbose) cout << "\t'bdlfxxxi::Vfunc4F8' object." << endl;
            {
                typedef bdlfxxxi::Vfunc4F8<CbFuncF8,
                                       int *, int *, int *, int *,
                                       int *, int *, int *, int *> Obj;
            ...
            if (verbose) cout << "\t'bdlfxxxi::Vfunc4C8' object." << endl;
            {
                typedef bdlfxxxi::Vfunc4C8<CbClass, CbFuncC8, int *, int *,
                                       int *, int *, int *, int *,
                                       int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
            ...
            if (verbose) cout << "\t'bdlfxxxi::Vfunc4M8' object." << endl;
            {
                typedef bdlfxxxi::Vfunc4M8<CbClass, CbFuncC8,
                                       int *, int *, int *, int *,
                                       int *, int *, int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
            ...
            cout << "\nTesting parameter types and destructors." << endl;
        {
            ...
            if (verbose)
                cout << "\tWhen calling 'bdlfxxxi::Vfunc4F8' 'execute' method."
                     << endl;
            {
                typedef bdlfxxxi::Vfunc4F8<CbFuncF8, T1, T2, T3, T4, T5, T6, T7,
                                       T8> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG4;
                numDeallocations = ta.numDeallocations();
            ...
            if (verbose)
                cout << "\tWhen calling 'bdlfxxxi::Vfunc4C8' 'execute' method."
                     << endl;
            {
                typedef bdlfxxxi::Vfunc4C8<CbClass, CbFuncC8, T1, T2,
            ...
            if (verbose)
                cout << "\tWhen calling 'bdlfxxxi::Vfunc4M8' 'execute' method."
                     << endl;
            {
                typedef bdlfxxxi::Vfunc4M8<CbClass, CbFuncM8, T1, T2, T3, T4,
                                       T5, T6, T7, T8> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG4;
                numDeallocations = ta.numDeallocations();
      ...
      case 7: {
        ...
        //       those intended as argument types for the function parameters.
        //    4. Non-'const' member functions can be used as callback
        //       functions by 'bdlfxxxi::Vfunc4M7' instances.
        //    5. Destructor of each class under test is properly executed.
        //
        // Plan:
        //   Create objects of every 'bdefi::Vfunc4X7' class.  Initialize
        //   'bdlfxxxi::Vfunc4F7' to have 'checkArgumentValues7' as the callback
        //   function.  Initialize 'bdlfxxxi::Vfunc4C7' and 'bdlfxxxi::Vfunc4M7' to
        //   have 'checkArgumentValues7' method of the 'CbClass' class as the
        //   callback function.  Call the 'execute' method for each
        //   'bdefi::Vfunc4X7' class.  The arguments in this call are
        //   initialized with values of 'ARG1', 'ARG2', 'ARG3', 'ARG4',
        ...
        //
        //   Create objects of every 'bdefi::Vfunc4X7' class.  Initialize
        //   'bdlfxxxi::Vfunc4F7' to have 'checkParameterTypes7' as the callback
        //   function.  Initialize 'bdlfxxxi::Vfunc4C7' to have
        //   'checkParameterTypesC7' method of the 'CbClass' class as the
        //   callback function.  Initialize 'bdlfxxxi::Vfunc4M7' to have
        //   'checkParameterTypesM7' method of the 'CbClass' class as the
        //   callback function.  The latter will test wether the
        //   'bdlfxxxi::Vfunc4M7' can have non-'const' functions as the callback
        //   function.
        //
        //   Having a function of 'checkParameterTypes' family as a callback
        //   function forces 'bdefi::Vfunc4X7' to be templatized so that each
        //   argument to the callback function will be of unique type.  Hence,
        //   if the types of arguments passed in to the callback function is
        //   incorrect, the compiler will generate an error.
        //
        ...
        // Testing:
        //   'bdlfxxxi::Vfunc4F7' methods:
        //   bdlfxxxi::Vfunc4F7<F, A1-4, D1-3>(c_F&, c_D1-3&, ba *);
        //   void execute<F, A1-4, D1-3>(c_A1-4&) const;
        //   ~bdlfxxxi::Vfunc4F7<F, A1-4, D1-3>();
        // --------------------------------------------------------------------
        //   'bdlfxxxi::Vfunc4C7' methods:
        //   bdlfxxxi::Vfunc4C7<OBJ, C, A1-4, D1-3>( OBJ *, c_C&, c_D1-3&, ba *);
        //   void execute<OBJ, C, A1-4, D1-3>(c_A1-4&) const;
        //   ~bdlfxxxi::Vfunc4C7<OBJ, C, A1-4, D1-3>();
        // --------------------------------------------------------------------
        //   'bdlfxxxi::Vfunc4M7' methods:
        //   bdlfxxxi::Vfunc4M7<OBJ, M, A1-4, D1-3>( OBJ *, c_M&, c_D1-3, ba *);
        //   void execute<OBJ, M, A1-4, D1-3>(c_A1-4&) const;
        //   ~bdlfxxxi::Vfunc4M7<OBJ, M, A1-4, D1-3>();
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting constructors and argument values." << endl;
        {
            ...
            if (verbose) cout << "\t'bdlfxxxi::Vfunc4F7' object." << endl;
            {
                typedef bdlfxxxi::Vfunc4F7<CbFuncF7,
                                       int *, int *, int *,
                                       int *, int *, int *, int *> Obj;
            ...
            if (verbose) cout << "\t'bdlfxxxi::Vfunc4C7' object." << endl;
            {
                typedef bdlfxxxi::Vfunc4C7<CbClass, CbFuncC7, int *,
                                       int *, int *, int *, int *,
                                       int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
            ...
            if (verbose) cout << "\t'bdlfxxxi::Vfunc4M7' object." << endl;
            {
                typedef bdlfxxxi::Vfunc4M7<CbClass, CbFuncC7,
                                       int *, int *, int *,
                                       int *, int *, int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
            ...
            cout << "\nTesting parameter types and destructors." << endl;
        {
            ...
            if (verbose)
                cout << "\tWhen calling 'bdlfxxxi::Vfunc4F7' 'execute' method."
                     << endl;
            {
                typedef bdlfxxxi::Vfunc4F7<CbFuncF7, T1, T2, T3, T4, T5, T6,
                                       T7> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG4;
                numDeallocations = ta.numDeallocations();
            ...
            if (verbose)
                cout << "\tWhen calling 'bdlfxxxi::Vfunc4C7' 'execute' method."
                     << endl;
            {
                typedef bdlfxxxi::Vfunc4C7<CbClass, CbFuncC7, T1, T2,
                                       T3, T4, T5, T6, T7> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG4;
                numDeallocations = ta.numDeallocations();
            ...
            if (verbose)
                cout << "\tWhen calling 'bdlfxxxi::Vfunc4M7' 'execute' method."
                     << endl;
            {
                typedef bdlfxxxi::Vfunc4M7<CbClass, CbFuncM7, T1, T2, T3, T4,
                                       T5, T6, T7> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG4;
                numDeallocations = ta.numDeallocations();
      ...
      case 6: {
        ...
        //       those intended as argument types for the function parameters.
        //    4. Non-'const' member functions can be used as callback
        //       functions by 'bdlfxxxi::Vfunc4M6' instances.
        //    5. Destructor of each class under test is properly executed.
        //
        // Plan:
        //   Create objects of every 'bdefi::Vfunc4X6' class.  Initialize
        //   'bdlfxxxi::Vfunc4F6' to have 'checkArgumentValues6' as the callback
        //   function.  Initialize 'bdlfxxxi::Vfunc4C6' and 'bdlfxxxi::Vfunc4M6' to
        //   have 'checkArgumentValues6' method of the 'CbClass' class as the
        //   callback function.  Call the 'execute' method for each
        //   'bdefi::Vfunc4X6' class.  The arguments in this call are
        //   initialized with values of 'ARG1', 'ARG2', 'ARG3', 'ARG4',
        ...
        //
        //   Create objects of every 'bdefi::Vfunc4X6' class.  Initialize
        //   'bdlfxxxi::Vfunc4F6' to have 'checkParameterTypes6' as the callback
        //   function.  Initialize 'bdlfxxxi::Vfunc4C6' to have
        //   'checkParameterTypesC6' method of the 'CbClass' class as the
        //   callback function.  Initialize 'bdlfxxxi::Vfunc4M6' to have
        //   'checkParameterTypesM6' method of the 'CbClass' class as the
        //   callback function.  The latter will test wether the
        //   'bdlfxxxi::Vfunc4M6' can have non-'const' functions as the callback
        //   function.
        //
        //   Having a function of 'checkParameterTypes' family as a callback
        //   function forces 'bdefi::Vfunc4X6' to be templatized so that each
        //   argument to the callback function will be of unique type.  Hence,
        //   if the types of arguments passed in to the callback function is
        //   incorrect, the compiler will generate an error.
        //
        ...
        // Testing:
        //   'bdlfxxxi::Vfunc4F6' methods:
        //   bdlfxxxi::Vfunc4F6<F, A1-4, D1-2>(c_F&, c_D1-2&, ba *);
        //   void execute<F, A1-4, D1-2>(c_A1-4&) const;
        //   ~bdlfxxxi::Vfunc4F6<F, A1-4, D1-2>();
        // --------------------------------------------------------------------
        //   'bdlfxxxi::Vfunc4C6' methods:
        //   bdlfxxxi::Vfunc4C6<OBJ, C, A1-4, D1-2>( OBJ *, c_C&, c_D1-2&, ba *);
        //   void execute<OBJ, C, A1-4, D1-2>(c_A1-4&) const;
        //   ~bdlfxxxi::Vfunc4C6<OBJ, C, A1-4, D1-2>();
        // --------------------------------------------------------------------
        //   'bdlfxxxi::Vfunc4M6' methods:
        //   bdlfxxxi::Vfunc4M6<OBJ, M, A1-4, D1-2>( OBJ *, c_M&, c_D1-2, ba *);
        //    void execute<OBJ, M, A1-4, D1-2>(c_A1-4&) const;
        //   ~bdlfxxxi::Vfunc4M6<OBJ, M, A1-4, D1-2>();
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting constructors and argument values." << endl;
        {
            ...
            if (verbose) cout << "\t'bdlfxxxi::Vfunc4F6' object." << endl;
            {
                typedef bdlfxxxi::Vfunc4F6<CbFuncF6,
                                       int *, int *, int *,
                                       int *, int *, int *> Obj;
            ...
            if (verbose) cout << "\t'bdlfxxxi::Vfunc4C6' object." << endl;
            {
                typedef bdlfxxxi::Vfunc4C6<CbClass, CbFuncC6, int *,
                                       int *, int *, int *,
                                       int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
            ...
            if (verbose) cout << "\t'bdlfxxxi::Vfunc4M6' object." << endl;
            {
                typedef bdlfxxxi::Vfunc4M6<CbClass, CbFuncC6,
                                       int *, int *, int *,
                                       int *, int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
            ...
            cout << "\nTesting parameter types and destructors." << endl;
        {
            ...
            if (verbose)
                cout << "\tWhen calling 'bdlfxxxi::Vfunc4F6' 'execute' method."
                     << endl;
            {
                typedef bdlfxxxi::Vfunc4F6<CbFuncF6, T1, T2, T3, T4, T5, T6> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG4;
                numDeallocations = ta.numDeallocations();
            ...
            if (verbose)
                cout << "\tWhen calling 'bdlfxxxi::Vfunc4C6' 'execute' method."
                     << endl;
            {
                typedef bdlfxxxi::Vfunc4C6<CbClass, CbFuncC6, T1, T2,
                                       T3, T4, T5, T6> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG4;
                numDeallocations = ta.numDeallocations();
            ...
            if (verbose)
                cout << "\tWhen calling 'bdlfxxxi::Vfunc4M6' 'execute' method."
                     << endl;
            {
                typedef bdlfxxxi::Vfunc4M6<CbClass, CbFuncM6, T1, T2, T3, T4,
                                       T5, T6> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG4;
                numDeallocations = ta.numDeallocations();
      ...
      case 5: {
        ...
        //       those intended as argument types for the function parameters.
        //    4. Non-'const' member functions can be used as callback
        //       functions by 'bdlfxxxi::Vfunc4M5' instances.
        //    5. Destructor of each class under test is properly executed.
        //
        // Plan:
        //   Create objects of every 'bdefi::Vfunc4X5' class.  Initialize
        //   'bdlfxxxi::Vfunc4F5' to have 'checkArgumentValues5' as the callback
        //   function.  Initialize 'bdlfxxxi::Vfunc4C5' and 'bdlfxxxi::Vfunc4M5' to
        //   have 'checkArgumentValues5' method of the 'CbClass' class as the
        //   callback function.  Call the 'execute' method for each
        //   'bdefi::Vfunc4X5' class.  The arguments in this call are
        ...
        //
        //   Create objects of every 'bdefi::Vfunc4X5' class.  Initialize
        //   'bdlfxxxi::Vfunc4F5' to have 'checkParameterTypes5' as the callback
        //   function.  Initialize 'bdlfxxxi::Vfunc4C5' to have
        //   'checkParameterTypesC5' method of the 'CbClass' class as the
        //   callback function.  Initialize 'bdlfxxxi::Vfunc4M5' to have
        //   'checkParameterTypesM5' method of the 'CbClass' class as the
        //   callback function.  The latter will test wether the
        //   'bdlfxxxi::Vfunc4M5' can have non-'const' functions as the callback
        //   function.
        //
        //   Having a function of 'checkParameterTypes' family as a callback
        //   function forces 'bdefi::Vfunc4X5' to be templatized so that each
        //   argument to the callback function will be of unique type.  Hence,
        //   if the types of arguments passed in to the callback function is
        //   incorrect, the compiler will generate an error.
        //
        ...
        // Testing:
        //   'bdlfxxxi::Vfunc4F5' methods:
        //   bdlfxxxi::Vfunc4F5<F, A1-4, D1>(c_F&, c_D1&, ba *);
        //   void execute<F, A1-4, D1>(c_A1-4&) const;
        //   ~bdlfxxxi::Vfunc4F5<F, A1-4, D1>();
        // --------------------------------------------------------------------
        //   'bdlfxxxi::Vfunc4C5' methods:
        //   bdlfxxxi::Vfunc4C5<OBJ, C, A1-4, D1>( OBJ *, c_C&, c_D1&, ba *);
        //   void execute<OBJ, C, A1-4, D1>(c_A1-4&) const;
        //   ~bdlfxxxi::Vfunc4C5<OBJ, C, A1-4, D1>();
        // --------------------------------------------------------------------
        //   'bdlfxxxi::Vfunc4M5' methods:
        //   bdlfxxxi::Vfunc4M5<OBJ, M, A1-4, D1>( OBJ *, c_M&, c_D1, ba *);
        //   void execute<OBJ, M, A1-4, D1>(c_A1-4&) const;
        //   ~bdlfxxxi::Vfunc4M5<OBJ, M, A1-4, D1>();
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting constructors and argument values." << endl;
        {
            ...
            if (verbose) cout << "\t'bdlfxxxi::Vfunc4F5' object." << endl;
            {
                typedef bdlfxxxi::Vfunc4F5<CbFuncF5, int *, int *,
                                       int *, int *, int *> Obj;
            ...
            if (verbose) cout << "\t'bdlfxxxi::Vfunc4C5' object." << endl;
            {
                typedef bdlfxxxi::Vfunc4C5<CbClass, CbFuncC5, int *,
                                       int *, int *, int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
                ObjBase *x = new(ta) Obj(cbObject,
            ...
            if (verbose) cout << "\t'bdlfxxxi::Vfunc4M5' object." << endl;
            {
                typedef bdlfxxxi::Vfunc4M5<CbClass, CbFuncC5,
                                       int *, int *, int *, int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
                ObjBase *x = new(ta) Obj(&cbObject,
            ...
            cout << "\nTesting parameter types and destructors." << endl;
        {
            ...
            if (verbose)
                cout << "\tWhen calling 'bdlfxxxi::Vfunc4F5' 'execute' method."
                     << endl;
            {
                typedef bdlfxxxi::Vfunc4F5<CbFuncF5, T1, T2, T3, T4, T5> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG4;
                numDeallocations = ta.numDeallocations();
            ...
            if (verbose)
                cout << "\tWhen calling 'bdlfxxxi::Vfunc4C5' 'execute' method."
                     << endl;
            {
                typedef bdlfxxxi::Vfunc4C5<CbClass, CbFuncC5, T1, T2,
                                       T3, T4, T5> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG4;
                numDeallocations = ta.numDeallocations();
            ...
            if (verbose)
                cout << "\tWhen calling 'bdlfxxxi::Vfunc4M5' 'execute' method."
                     << endl;
            {
                typedef bdlfxxxi::Vfunc4M5<CbClass, CbFuncM5, T1, T2, T3, T4,
                                       T5> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG4;
                numDeallocations = ta.numDeallocations();
      ...
      case 4: {
        ...
        //       those intended as argument types for the function parameters.
        //    4. Non-'const' member functions can be used as callback
        //       functions by 'bdlfxxxi::Vfunc4M4' instances.
        //    5. Destructor of each class under test is properly executed.
        //
        // Plan:
        //   Create objects of every 'bdefi::Vfunc4X4' class.  Initialize
        //   'bdlfxxxi::Vfunc4F4' to have 'checkArgumentValues4' as the callback
        //   function.  Initialize 'bdlfxxxi::Vfunc4C4' and 'bdlfxxxi::Vfunc4M4' to
        //   have 'checkArgumentValues4' method of the 'CbClass' class as the
        //   callback function.  Call the 'execute' method for each
        //   'bdefi::Vfunc4X4' class.  The arguments in this call are
        ...
        //
        //   Create objects of every 'bdefi::Vfunc4X4' class.  Initialize
        //   'bdlfxxxi::Vfunc4F4' to have 'checkParameterTypes4' as the callback
        //   function.  Initialize 'bdlfxxxi::Vfunc4C4' to have
        //   'checkParameterTypesC4' method of the 'CbClass' class as the
        //   callback function.  Initialize 'bdlfxxxi::Vfunc4M4' to have
        //   'checkParameterTypesM4' method of the 'CbClass' class as the
        //   callback function.  The latter will test wether the
        //   'bdlfxxxi::Vfunc4M4' can have non-'const' functions as the callback
        //   function.
        //
        //   Having a function of 'checkParameterTypes' family as a callback
        //   function forces 'bdefi::Vfunc4X4' to be templatized so that each
        //   argument to the callback function will be of unique type.  Hence,
        //   if the types of arguments passed in to the callback function is
        //   incorrect, the compiler will generate an error.
        //
        ...
        // Testing:
        //   'bdlfxxxi::Vfunc4F4' methods:
        //   bdlfxxxi::Vfunc4F4<F, A1-4>(c_F&, ba *);
        //   void execute<F, A1-4>(c_A1-4&) const;
        //   ~bdlfxxxi::Vfunc4F4<F, A1-4>();
        // --------------------------------------------------------------------
        //   'bdlfxxxi::Vfunc4C4' methods:
        //   bdlfxxxi::Vfunc4C4<OBJ, C, A1-4>( OBJ *, c_C&, ba *);
        //   void execute<OBJ, C, A1-4>(c_A1-4&) const;
        //   ~bdlfxxxi::Vfunc4C4<OBJ, C, A1-4>();
        // --------------------------------------------------------------------
        //   'bdlfxxxi::Vfunc4M4' methods:
        //   bdlfxxxi::Vfunc4M4<OBJ, M, A1-4>( OBJ *, c_M&, ba *);
        //   void execute<OBJ, M, A1-4>(c_A1-4&) const;
        //   ~bdlfxxxi::Vfunc4M4<OBJ, M, A1-4>();
        // --------------------------------------------------------------------
        //   'bdlfxxxi::Vfunc4Null' methods:
        //   bdlfxxxi::Vfunc4Null<A1-4>(ba *);
        //   void execute<A1-4>(c_A1-4&) const;
        //   ~bdlfxxxi::Vfunc4Null<A1-4>();
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting constructors and argument values." << endl;
        {
            ...
            if (verbose) cout << "\t'bdlfxxxi::Vfunc4F4' object." << endl;
            {
                typedef bdlfxxxi::Vfunc4F4<CbFuncF4,
                                       int *, int *, int *, int *> Obj;
            ...
            if (verbose) cout << "\t'bdlfxxxi::Vfunc4C4' object." << endl;
            {
                typedef bdlfxxxi::Vfunc4C4<CbClass, CbFuncC4,
                                       int *, int *, int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
                ObjBase *x = new(ta) Obj(cbObject,
            ...
            if (verbose) cout << "\t'bdlfxxxi::Vfunc4M4' object." << endl;
            {
                typedef bdlfxxxi::Vfunc4M4<CbClass, CbFuncC4,
                                       int *, int *, int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
                ObjBase *x = new(ta) Obj(&cbObject,
            ...
            cout << "\nTesting parameter types and destructors." << endl;
        {
            ...
            if (verbose)
                cout << "\tWhen calling 'bdlfxxxi::Vfunc4F4' 'execute' method."
                     << endl;
            {
                typedef bdlfxxxi::Vfunc4F4<CbFuncF4, T1, T2, T3, T4> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG4;
                numDeallocations = ta.numDeallocations();
            ...
            if (verbose)
                cout << "\tWhen calling 'bdlfxxxi::Vfunc4C4' 'execute' method."
                     << endl;
            {
                typedef bdlfxxxi::Vfunc4C4<CbClass, CbFuncC4, T1, T2,
                                       T3, T4> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG4;
                numDeallocations = ta.numDeallocations();
            ...
            if (verbose)
                cout << "\tWhen calling 'bdlfxxxi::Vfunc4M4' 'execute' method."
                     << endl;
            {
                typedef bdlfxxxi::Vfunc4M4<CbClass, CbFuncM4, T1, T2, T3, T4> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG4;
                numDeallocations = ta.numDeallocations();
            ...
            if (verbose)
                cout << "\nTesting bdlfxxxi::Vfunc4Null object." << endl;
            {
                destructorCheck = DESTRUCTOR_FLAG4;
                numDeallocations = ta.numDeallocations();

                typedef bdlfxxxi::Vfunc4Null<T1, T2, T3, T4> Obj;
