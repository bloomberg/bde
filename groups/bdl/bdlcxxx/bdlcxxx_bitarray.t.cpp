...
// 'bdlxxxx_testinstream' (and 'bdlxxxx_testoutstream').
//
// Note that places where test drivers in this family are likely to require
// adjustment are indicated by the tag: "ADJ".
//-----------------------------------------------------------------------------
// [ 2] bdlcxxx::BitArray(bslma::Allocator *ba = 0);
// [11] bdlcxxx::BitArray(int iLen, *ba = 0);
// [11] bdlcxxx::BitArray(int iLen, bool iVal, *ba = 0);
// [17] bdlcxxx::BitArray(const InitialCapacity& ne, *ba = 0);
// [17] bdlcxxx::BitArray(const InitialCapacity& ne, int iLen, *ba = 0);
// [17] bdlcxxx::BitArray(const InitialCapacity& ne, int iLen, bool val, *ba = 0);
// [ 7] bdlcxxx::BitArray(const bdlcxxx::BitArray& original, *ba = 0);
// [ 2] ~bdlcxxx::BitArray();
// [ 9] bdlcxxx::BitArray& operator=(const bdlcxxx::BitArray& rhs);
// [ 9] void swap(bdlcxxx::BitArray& other);
// [27] bdlcxxx::BitArray& operator&=(const bdlcxxx::BitArray& rhs);
// [27] bdlcxxx::BitArray& operator|=(const bdlcxxx::BitArray& rhs);
// [27] bdlcxxx::BitArray& operator^=(const bdlcxxx::BitArray& rhs);
// [27] bdlcxxx::BitArray& operator-=(const bdlcxxx::BitArray& rhs);
// [21] bdlcxxx::BitArray& operator<<=(int numBits);
// [21] bdlcxxx::BitArray& operator>>=(int numBits);
...
// [13] void append(const bdlcxxx::BitArray& sa);
// [13] void append(const bdlcxxx::BitArray& sa, int si, int ne);
// [13] void insert(int di, bool value);
// [13] void insert(int di, const bdlcxxx::BitArray& sa);
// [13] void insert(int di, const bdlcxxx::BitArray& sa, int si, int ne);
// [13] void remove(int index);
// [13] void remove(int index, int ne);
// [ 2] void removeAll();
// [14] void replace(int di, bool value);
// [14] void replace(int di, const bdlcxxx::BitArray& sa, int si, int ne);
...
//
// [ 6] operator==(const bdlcxxx::BitArray&, const bdlcxxx::BitArray&);
// [ 6] operator!=(const bdlcxxx::BitArray&, const bdlcxxx::BitArray&);
// [19] operator~(const bdlcxxx::BitArray& bitArray);
// [21] operator<<(const bdlcxxx::BitArray& bitArray, int numBits);
// [21] operator>>(const bdlcxxx::BitArray& bitArray, int numBits);
// [27] operator&(const bdlcxxx::BitArray&, const bdlcxxx::BitArray&);
// [27] operator|(const bdlcxxx::BitArray&, const bdlcxxx::BitArray&);
// [27] operator^(const bdlcxxx::BitArray&, const bdlcxxx::BitArray&);
// [27] operator-(const bdlcxxx::BitArray&, const bdlcxxx::BitArray&);
// [ 5] operator<<(ostream&, const bdlcxxx::BitArray&);
//-----------------------------------------------------------------------------
// [ 1] BREATHING TEST
// [32] USAGE EXAMPLE
...
// [ 3] int ggg(bdlcxxx::BitArray *object, const char *spec, int vF = 1);
// [ 3] bdlcxxx::BitArray& gg(bdlcxxx::BitArray* object, const char *spec);
// [ 8] bdlcxxx::BitArray   g(const char *spec);
...
//-----------------------------------------------------------------------------
 ...
 class NullableVector {
   ...
   public:
     ...
     // ...
     explicit
     NullableVector(int initialLength, bslma::Allocator *basicAllocator = 0);
...
// 0 and 1 correspond to bit values to be appended to the 'bdlcxxx::BitArray'
...
int ggg(bdlcxxx::BitArray *object, const char *spec, int verboseFlag = 1)
...
bdlcxxx::BitArray& gg(bdlcxxx::BitArray *object, const char *spec)
...
bdlcxxx::BitArray g(const char *spec)
    // Return, by value, a new object corresponding to the specified 'spec'.
{
    bdlcxxx::BitArray object((bslma::Allocator *)0);
...
//..
      ...
      case 26: {
        ...
        //
        // Testing:
        //   bdlcxxx::BitArray& operator&=(const bdlcxxx::BitArray& rhs);
        //   bdlcxxx::BitArray& operator|=(const bdlcxxx::BitArray& rhs);
        //   bdlcxxx::BitArray& operator^=(const bdlcxxx::BitArray& rhs);
        //   bdlcxxx::BitArray& operator-=(const bdlcxxx::BitArray& rhs);
        //   operator&(const bdlcxxx::BitArray&, const bdlcxxx::BitArray&);
        //   operator|(const bdlcxxx::BitArray&, const bdlcxxx::BitArray&);
        //   operator^(const bdlcxxx::BitArray&, const bdlcxxx::BitArray&);
        //   operator-(const bdlcxxx::BitArray&, const bdlcxxx::BitArray&);
        // --------------------------------------------------------------------
      ...
      case 20: {
        ...
        //
        // Testing:
        //   bdlcxxx::BitArray& operator<<=(int numBits);
        //   bdlcxxx::BitArray& operator>>=(int numBits);
        //   operator<<(const bdlcxxx::BitArray& bitArray, int numBits);
        //   operator>>(const bdlcxxx::BitArray& bitArray, int numBits);
        // --------------------------------------------------------------------
      ...
      case 18: {
        ...
        //   operator~(const bdlcxxx::BitArray& bitArray);
        // --------------------------------------------------------------------
...
//                 1, 2, 3, 4, 5, 8, 16, 31, 32, 33, 63, 64, 65, 100
      ...
      case 16: {
        ...
        //
        // Testing:
        //   bdlcxxx::BitArray(const InitialCapacity& ne, *ba = 0);
        //   bdlcxxx::BitArray(const InitialCapacity& ne, int iLen, *ba = 0);
        //   bdlcxxx::BitArray(const InitialCapacity& ne, iLen, value, *ba = 0);
        ...
        if (verbose) cout <<
            "\nTesting 'bdlcxxx::BitArray(capacity, ba)' Constructor" << endl;
      ...
      case 14: {
        ...
        //   void replace(int di, const bdlcxxx::BitArray& sa, int si, int ne);
        // --------------------------------------------------------------------
      ...
      case 13: {
        ...
        //   void append(const bdlcxxx::BitArray& sa);
        //   void append(const bdlcxxx::BitArray& sa, int si, int ne);
        //
        //   void insert(int di, bool value);
        //   void insert(int di, const bdlcxxx::BitArray& sa);
        //   void insert(int di, const bdlcxxx::BitArray& sa, int si, int ne);
        //
      ...
      case 11: {
        ...
        //
        // Testing:
        //   bdlcxxx::BitArray(int iLen, *ba = 0);
        //   bdlcxxx::BitArray(int iLen, int iVal, *ba = 0);
        // --------------------------------------------------------------------
      ...
      case 10: {
        ...
        if (verbose) cout << "\t\tBad version." << endl;
        {
            ...
            Obj t(X);   ASSERT(W != t);    ASSERT(X == t);      ASSERT(Y != t);
            bdlxxxx::TestInStream in(OD, LOD);
            in.setSuppressVersionCheck(1);
            ASSERT(in);
            bdex_InStreamFunctions::streamIn(in, t, version);
            ASSERT(!in);
        ...
        if (verbose) cout << "\nWire format direct tests." << endl;
        {
            ...
            for (int i = 0; i < NUM_DATA; ++i) {
                ...
                mX = g(SPEC);
                const Obj& X = mX;
                bdlxxxx::ByteOutStream out;  X.bdexStreamOut(out, VERSION);
                ...
                if (LEN) { // version is supported
                    bdlxxxx::ByteInStream in(out.data(),
                                         out.length());
                    mY.bdexStreamIn(in, VERSION);
                }
                else { // version is not supported
                    mY = X;
                    bdlxxxx::ByteInStream in;
                    mY.bdexStreamIn(in, VERSION);
                    LOOP_ASSERT(LINE, !in);
                }
      ...
      case 7: {
        ...
        //
        // Testing:
        //   bdlcxxx::BitArray(const bdlcxxx::BitArray& original, *ba = 0);
        // --------------------------------------------------------------------
      ...
      case 5: {
        ...
        //   operator<<(ostream&, const bdlcxxx::BitArray&);
        // --------------------------------------------------------------------
...
#undef NL
      ...
      case 3: {
        ...
        // Testing:
        //   bdlcxxx::BitArray& gg(bdlcxxx::BitArray* object, const char *spec);
        //   int ggg(bdlcxxx::BitArray *object, const char *spec, int vF = 1);
        //   void stretch(Obj *object, int size);
        //   void stretchRemoveAll(Obj *object, int size);
      ...
      case 2: {
        ...
        //   the value of the object and the 'bslma::TestAllocator' to confirm
        ...
        //
        // Testing:
        //   bdlcxxx::BitArray(bslma::Allocator *ba);
        //   ~bdlcxxx::BitArray();
