...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:
      case 1: {
        ...
        {
            bdlar::AnyConstRefData any = ref.valueConstRef();
            ASSERT(any.d_category == bdlat_TypeCategory::e_SIMPLE_CATEGORY);
            bdlar::SimpleTypeConstRef value(any.d_object_p,
                                            any.d_vtable.d_simple_p);
            value.access(accessor);
        }
        {
            bdlar::AnyRefData any = ref.valueRef();
            ASSERT(any.d_category == bdlat_TypeCategory::e_SIMPLE_CATEGORY);
            bdlar::SimpleTypeRef value(any.d_object_p,
                                       any.d_vtable.d_simple_p);
            value.access(accessor);
        }

        {
            ...
            {
                bdlar::AnyConstRefData any = cref.valueConstRef();
                ASSERT(any.d_category ==
