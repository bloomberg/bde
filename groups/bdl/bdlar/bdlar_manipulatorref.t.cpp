...
struct ConstManipulator {
    template <class t_TYPE>
    int operator()(t_TYPE *) const { return 0; }

    template <class t_TYPE, class t_INFO>
    int operator()(t_TYPE *, const t_INFO&) const { return 0; }
};

struct NonConstManipulator {
    template <class t_TYPE>
    int operator()(t_TYPE *) { return 0; }

    template <class t_TYPE, class t_INFO>
    int operator()(t_TYPE *, const t_INFO&) { return 0; }
};
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:
      case 1: {
        ...
        ValueType value;
        {
            ConstManipulator manipulator;
            bdlar::ManipulatorRef manipulatorRef(manipulator);
            manipulatorRef(&value);
        }
        {
            const ConstManipulator manipulator;
            bdlar::ManipulatorRef manipulatorRef(manipulator);
            manipulatorRef(&value);
        }
        {
            NonConstManipulator manipulator;
            bdlar::ManipulatorRef manipulatorRef(manipulator);
            manipulatorRef(&value);
        }
        ...
        {
            ConstManipulator manipulator;
            bdlar::ManipulatorWithInfoRef manipulatorRef(manipulator);
            manipulatorRef(&value, info);
        }
        {
            const ConstManipulator manipulator;
            bdlar::ManipulatorWithInfoRef manipulatorRef(manipulator);
