...
int accessElement(const void *, bdlar::AccessorRef&, int)
{
    return 0;
}

bsl::size_t size(const void *)
{
    return 0;
}

int manipulateElement(void *, bdlar::ManipulatorRef&, int)
{
    return 0;
}
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:
      case 1: {
        ...
        {
            bdlar::ArrayConstVtable vtable;

            vtable.d_elementCategory_fp = u::elementCategory;
            vtable.d_accessElement_fp = u::accessElement;
            vtable.d_size_fp = u::size;

            (void)vtable;
        }
        {
            bdlar::ArrayVtable vtable;

            vtable.d_manipulateElement_fp = u::manipulateElement;
            vtable.d_reset_fp = u::reset;
            vtable.d_resize_fp = u::resize;
