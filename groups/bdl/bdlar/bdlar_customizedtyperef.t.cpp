// bdlar_customizedtyperef.t.cpp                                      -*-C++-*-
...
bool isEqual(bdlar::AnyConstRef any, const bsl::string& baseValue)
{
    ASSERT(any.typeCategory() == bdlat_TypeCategory::e_SIMPLE_CATEGORY);

    bdlar::SimpleTypeConstRef ref =
