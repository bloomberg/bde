...
void toInt(int *, const void *)
{
}

void toString(bsl::string *, const void *)
{
}

bool hasFallback(const void *)
{
    return false;
}

bool isFallback(const void *)
{
    return false;
}

int fromInt(void *, int)
{
    return 0;
}

int fromString(void *, const char *, int)
{
    return 0;
}

int makeFallback(void *)
{
    return 0;
}
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:
      case 1: {
        ...
        {
            bdlar::EnumConstVtable vtable;

            vtable.d_toInt_fp = u::toInt;
            vtable.d_toString_fp = u::toString;
            vtable.d_hasFallback_fp = u::hasFallback;
            vtable.d_isFallback_fp = u::isFallback;

            (void)vtable;
        }
        {
            bdlar::EnumVtable vtable;

            vtable.d_fromInt_fp = u::fromInt;
            vtable.d_fromString_fp = u::fromString;
            vtable.d_makeFallback_fp = u::makeFallback;
