// bdlar_simpletypevtable.t.cpp                                       -*-C++-*-
...
bdlar::SimpleTypeId typeId()
{
    return bdlar::SimpleTypeId();
}
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:
      case 1: {
        ...
        {
            bdlar::SimpleTypeConstVtable vtable;

            vtable.d_typeId_fp = u::typeId;

            (void)vtable;
        }
        {
            bdlar::SimpleTypeVtable vtable;
