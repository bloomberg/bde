...
struct ConstAccessor {
    ...
    int operator()(const t_TYPE&) const { return 0; }

    template <class t_TYPE, class t_INFO>
    int operator()(const t_TYPE&, const t_INFO&) const { return 0; }
};

struct NonConstAccessor {
    template <class t_TYPE>
    int operator()(const t_TYPE&) { return 0; }

    template <class t_TYPE, class t_INFO>
    int operator()(const t_TYPE&, const t_INFO&) { return 0; }
};
    ...
    switch (test) { case 0:
      case 1: {
        ...
        const ValueType value;
        {
            ...
            bdlar::AccessorRef accessorRef(accessor);
            accessorRef(value);
        }
        {
            const ConstAccessor accessor;
            bdlar::AccessorRef accessorRef(accessor);
            accessorRef(value);
        }
        {
            NonConstAccessor accessor;
            bdlar::AccessorRef accessorRef(accessor);
            accessorRef(value);
        }
        ...
        {
            ConstAccessor accessor;
            bdlar::AccessorWithInfoRef accessorRef(accessor);
            accessorRef(value, info);
        }
        {
            const ConstAccessor accessor;
            bdlar::AccessorWithInfoRef accessorRef(accessor);
