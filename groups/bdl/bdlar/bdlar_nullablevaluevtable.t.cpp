// bdlar_nullablevaluevtable.t.cpp                                    -*-C++-*-
...
int accessValue(const void *, bdlar::AccessorRef&)
{
    return 0;
}
...
int manipulateValue(void *, bdlar::ManipulatorRef&)
{
    return 0;
}
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:
      case 1: {
        ...
        {
            bdlar::NullableValueConstVtable vtable;

            vtable.d_valueCategory_fp = u::valueCategory;
            vtable.d_accessValue_fp = u::accessValue;
            vtable.d_isNull_fp = u::isNull;

            (void)vtable;
        }
        {
            bdlar::NullableValueVtable vtable;

            vtable.d_manipulateValue_fp = u::manipulateValue;
            vtable.d_makeValue_fp = u::makeValue;
