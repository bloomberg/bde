// bdlar_dynamictypevtable.t.cpp                                      -*-C++-*-
...
bdlat_TypeCategory::Value typeCategory(const void *)
{
...
bdlar::AnyConstRefData valueRef(const void *)
{
    return bdlar::AnyConstRefData();
}

bdlar::AnyRefData valueRef(void *)
{
    return bdlar::AnyRefData();
}
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:
      case 1: {
        ...
        {
            bdlar::DynamicTypeConstVtable vtable;

            vtable.d_typeCategory_fp = u::typeCategory;
            vtable.d_valueRef_fp = u::valueRef;

            (void)vtable;
        }
        {
            bdlar::DynamicTypeVtable vtable;
