...
//-----------------------------------------------------------------------------
// 'bdlmxxx::ElemType' public interface:
// [ 1] enum Type { ... };
// [ 1] enum { BDEM_NUM_TYPES = ... };
// [ 1] char *toAscii(Type value);
// [ 2] int maxSupportedBdexVersion
// [ 3] bdexStreamOut(bdlxxxx::OutStream& s, bdlmxxx::ElemType::Type rhs, int ver);
// [ 3] bdexStreamIn(bdlxxxx::InStream& s, bdlmxxx::ElemType::Type& rhs, int ver);
// [ 3] bdexStreamOut(bdlxxxx::OutStream& s, bdlmxxx::ElemType::Type rhs);
// [ 3] bdexStreamIn(bdlxxxx::InStream& s, bdlmxxx::ElemType::Type& rhs);
// [ 3] operator<<(bdlxxxx::OutStream&, bdlmxxx::ElemType::Type rhs);
// [ 3] operator>>(bdlxxxx::InStream&, bdlmxxx::ElemType::Type& rhs);
// [ 4] bdlmxxx::ElemType::Type toArrayType(bdlmxxx::ElemType::Type value);
// [ 4] bdlmxxx::ElemType::Type fromArrayType(bdlmxxx::ElemType::Type value);
// [ 5] bool isArrayType(bdlmxxx::ElemType::Type value);
// [ 5] bool isAggregateType(bdlmxxx::ElemType::Type value);
// [ 5] bool isChoiceType(bdlmxxx::ElemType::Type value);
// [ 5] bool isScalarType(bdlmxxx::ElemType::Type value);
// [ 6] USAGE EXAMPLE
//
// 'bdlmxxx::ElemType' private methods (tested indirectly):
// [ 1] print(bsl::ostream& stream, bdlmxxx::ElemType::Type rhs);
...
//..
      ...
      case 5: {
        ...
        //   'bdlmxxx::ElemType::Type' enumerator.  Integral values that do not
        //   correspond to any value in the 'bdlmxxx::ElemType::Type' enumeration
        //   should return false
        //
        // Plan:
        //   Define a data array with a test vector corresponding to each
        //   value in the 'bdlmxxx::ElemType::Type' enumeration.  Exercise
        //   'isArrayType' 'isAggregateType' and 'isScalarType' on each test
        //   vector.  Also test out-of-band values (both too small and too
        //   large).
        //
        // Testing:
        //   bool isArrayType(bdlmxxx::ElemType::Type value);
        //   bool isAggregateType(bdlmxxx::ElemType::Type value);
        //   bool isChoiceType(bdlmxxx::ElemType::Type value);
        //   bool isScalarType(bdlmxxx::ElemType::Type value);
        // --------------------------------------------------------------------
...
{ Et::BDEM_TABLE,              true,        true,      false,      false },
      ...
      case 4: {
        ...
        //   'bdlmxxx::ElemType::Type' enumerator.  Integral values that do not
        //   correspond to any value in the 'bdlmxxx::ElemType::Type' enumeration
        //   should map to 'bdlmxxx::ElemType::BDEM_VOID'.
        //
        // Plan:
        //   Define a data array with a test vector corresponding to each value
        //   in the 'bdlmxxx::ElemType::Type' enumeration.  Exercise
        //   'toArrayType' and 'fromArrayType' on each test vector.  Also test
        //   out-of-band values (both too small and too large).
        //
        // Testing:
        //   bdlmxxx::ElemType::Type toArrayType(bdlmxxx::ElemType::Type value);
        //   bdlmxxx::ElemType::Type fromArrayType(bdlmxxx::ElemType::Type value);
        // --------------------------------------------------------------------
...
{ Et::BDEM_TABLE,             Et::BDEM_VOID,            Et::BDEM_LIST       }
      ...
      case 3: {
        ...
        //
        // Testing:
        //   bdexStreamOut(bdlxxxx::OutStream& s,bdlmxxx::ElemType::Type rhs, int ver);
        //   bdexStreamIn(bdlxxxx::InStream& s, bdlmxxx::ElemType::Type& rhs, int ver);
        //   bdexStreamIn(bdlxxxx::InStream& s, bdlmxxx::ElemType::Type& rhs);
        //   bdexStreamOut(bdlxxxx::OutStream& s, bdlmxxx::ElemType::Type rhs);
        //   operator>>(bdlxxxx::InStream&, bdlmxxx::ElemType::Type& rhs);
        //   operator<<(bdlxxxx::OutStream&, bdlmxxx::ElemType::Type rhs);
        // --------------------------------------------------------------------
      ...
      case 1: {
        ...
        //  ^print(bsl::ostream& stream, bdlmxxx::ElemType::Type rhs);
        //
