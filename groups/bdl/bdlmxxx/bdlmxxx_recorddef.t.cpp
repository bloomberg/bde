...
///- - - - - - - - - - - - - - - - - - - - - - - - - - - -
// The following section demontrates how to create a 'bdem::RecordRef' (and
// 'bdlmxxx::EnumerationDef') in isolation -- this is *not* the recommended usage
// of 'bdlmxxx::RecordDef' (or 'bdlmxxx::EnumerationDef').  A 'bdlmxxx::RecordDef' is
// meant to be used in conjuction with the types defined in 'bdlmxxx_schema'.
// Clients should not create a 'bdlmxxx::RecordDef' directly, but obtain one from
// a 'bdlmxxx::Schema'.  For the purpose of this usage example, we define a dummy
// stand-in type for 'bdlmxxx::Schema'.  This type is used in name-only by
// 'bdlmxxx::RecordDef', so its definition is not necessary:
//..
//  namespace BloombergLP {
//
//  class bdlmxxx::Schema {
...
//..
    ...
    bdlmxxx::EnumerationDef ccTypeEnumDef(&dummySchema,
                                      0,
                                      "CREDIT_CARD_TYPE",
                                      &seqAllocator);
    bdlmxxx::RecordDef ccPaymentRecDef(&dummySchema,
                                   0,
                                   "CREDIT_CARD_PAYMENT",
                                   bdlmxxx::RecordDef::BDEM_SEQUENCE_RECORD,
                                   &seqAllocator,
                                   allocator);
    bdlmxxx::RecordDef checkPaymentRecDef(&dummySchema,
                                      1,
                                      "CHECK_PAYMENT",
                                      bdlmxxx::RecordDef::BDEM_SEQUENCE_RECORD,
                                      &seqAllocator,
                                      allocator);
    bdlmxxx::RecordDef paymentInfoRecDef(&dummySchema,
                                     2,
                                     "PAYMENT_INFO",
                                     bdlmxxx::RecordDef::BDEM_CHOICE_RECORD,
                                     &seqAllocator,
                                     allocator);
    bdlmxxx::RecordDef saleRecDef(&dummySchema,
                              3,
                              "SALE",
                              bdlmxxx::RecordDef::BDEM_SEQUENCE_RECORD,
                              &seqAllocator,
...
//..
//
///Maniupulating and Accessing a 'bdlmxxx::RecordDef'
///- - - - - - - - - - - - - - - - - - - - - - -
...
// clients should obtain these definitions from a schema (see 'bdlmxxx_schema').
//
...
//..
    ...
    ASSERT(0 == bsl::strcmp(ccPaymentRecDef.recordName(),
                            "CREDIT_CARD_PAYMENT"));
    ASSERT(bdlmxxx::RecordDef::BDEM_SEQUENCE_RECORD ==
...
//..
    ...
    ASSERT(0 == bsl::strcmp(paymentInfoRecDef.recordName(),
                            "PAYMENT_INFO"));
    ASSERT(bdlmxxx::RecordDef::BDEM_CHOICE_RECORD ==
...
// 'bdlmxxx_enumerationdef' for more information):
//..
...
//..
    ...
    ASSERT(bdlmxxx::RecordDef::BDEM_NULL_FIELD_ID == cardTypeFldDef.fieldId());
...
// field "quantity" we create a 'bdlmxxx::FieldDefAttributes' that we supply to
