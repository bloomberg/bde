...
//                                Overview
//                                --------
// The majority of methods in 'bdlmxxx::ListImp' perform simple delegation by
// calling (usually) a single method via the (private) 'bdlmxxx::RowData' data
...
// 'bdlmxxx::AggregateOption::AllocationStrategy' is correctly passed through.
//
...
//  'D'       for 'const bdlmxxx::Descriptor'
//  'ET'      for 'const bdlmxxx::ElemType::Type'
//  'AS'      for 'bdlmxxx::AggregateOption::AllocationStrategy'
//  'SO'      for 'bdlmxxx::DescriptorStreamOut<STREAM>'
//  'SI'      for 'bdlmxxx::DescriptorStreamIn<STREAM>'
//-----------------------------------------------------------------------------
// [ 6] bdlmxxx::ListImp(AS, bslma::Allocator);
// [ 6] bdlmxxx::ListImp(ET, int, D *const [], AS, bslma::Allocator);
// [ 6] bdlmxxx::ListImp(const bdlmxxx::RowData&, AS, bslma::Allocator);
// [ 6] bdlmxxx::ListImp(const bdlmxxx::ListImp&, AS, bslma::Allocator);
// [ 2] void *insertElement(int, const void *, D *);
// [ 2] int length() const;
// [ 2] ET elemType(int) const;
// [ 2] const bdlmxxx::RowData& row() const;
// [ 2] bdlmxxx::RowData& row();
// [ 2] ~bdlmxxx::ListImp();
// [ 3] bool operator==(const bdlmxxx::ListImp&, const bdlmxxx::ListImp&);
// [ 3] bool operator!=(const bdlmxxx::ListImp&, const bdlmxxx::ListImp&);
// [ 4] void *insertElementRaw(int, const bdlmxxx::Descriptor *);
// [ 4] void insertElements(int, bdlmxxx::RowData&, int, int);
// [ 4] void *insertNullElement(int, const bdlmxxx::Descriptor *);
...
// [ 4] bdlmxxx::ListImp& operator=(const bdlmxxx::RowData&);
// [ 4] bdlmxxx::ListImp& operator=(const bdlmxxx::ListImp&);
// [ 4] void replaceElement(int,const bdlmxxx::ConstElemRef&);
// [ 4] void resetElement(int, D *);
// [ 4] void reset(ET [], , D *const);
// [ 5] bsl::string& insertString(int, const char *);
// [ 5] bdlmxxx::ListImp& insertList(int, const bdlmxxx::RowData&);
...
static
bdlmxxx::DescriptorStreamIn<In> STREAMIN_TABLE[] = {
    &bdlmxxx::FunctionTemplates::streamInFundamental<char,In>,
    &bdlmxxx::FunctionTemplates::streamInFundamental<short,In>,
    &bdlmxxx::FunctionTemplates::streamInFundamental<int,In>,
    &bdlmxxx::FunctionTemplates::
    streamInFundamental<bsls::Types::Int64,In>,
    &bdlmxxx::FunctionTemplates::streamInFundamental<float,In>,
    &bdlmxxx::FunctionTemplates::streamInFundamental<double,In>,
    &bdlmxxx::FunctionTemplates::streamInFundamental<bsl::string,In>,
    &bdlmxxx::FunctionTemplates::streamIn<bdlt::Datetime,In>,
    &bdlmxxx::FunctionTemplates::streamIn<bdlt::Date,In>,
    &bdlmxxx::FunctionTemplates::streamIn<bdlt::Time,In>,
    &bdlmxxx::FunctionTemplates::streamInArray<char,In>,
    &bdlmxxx::FunctionTemplates::streamInArray<short,In>,
    &bdlmxxx::FunctionTemplates::streamInArray<int,In>,
    &bdlmxxx::FunctionTemplates::streamInArray<bsls::Types::Int64,In>,
    &bdlmxxx::FunctionTemplates::streamInArray<float,In>,
    &bdlmxxx::FunctionTemplates::streamInArray<double,In>,
    &bdlmxxx::FunctionTemplates::streamInArray<bsl::string,In>,
    &bdlmxxx::FunctionTemplates::streamInArray<bdlt::Datetime,In>,
    &bdlmxxx::FunctionTemplates::streamInArray<bdlt::Date,In>,
    &bdlmxxx::FunctionTemplates::streamInArray<bdlt::Time, In>
};

static
bdlmxxx::DescriptorStreamOut<Out> STREAMOUT_TABLE[] = {
    &bdlmxxx::FunctionTemplates::streamOutFundamental<char,Out>,
    &bdlmxxx::FunctionTemplates::streamOutFundamental<short,Out>,
    &bdlmxxx::FunctionTemplates::streamOutFundamental<int,Out>,
    &bdlmxxx::FunctionTemplates::
    streamOutFundamental<bsls::Types::Int64,Out>,
    &bdlmxxx::FunctionTemplates::streamOutFundamental<float,Out>,
    &bdlmxxx::FunctionTemplates::streamOutFundamental<double,Out>,
    &bdlmxxx::FunctionTemplates::streamOutFundamental<bsl::string,Out>,
    &bdlmxxx::FunctionTemplates::streamOut<bdlt::Datetime,Out>,
    &bdlmxxx::FunctionTemplates::streamOut<bdlt::Date,Out>,
    &bdlmxxx::FunctionTemplates::streamOut<bdlt::Time,Out>,
    &bdlmxxx::FunctionTemplates::streamOutArray<char,Out>,
    &bdlmxxx::FunctionTemplates::streamOutArray<short,Out>,
    &bdlmxxx::FunctionTemplates::streamOutArray<int,Out>,
    &bdlmxxx::FunctionTemplates::streamOutArray<bsls::Types::Int64,Out>,
    &bdlmxxx::FunctionTemplates::streamOutArray<float,Out>,
    &bdlmxxx::FunctionTemplates::streamOutArray<double,Out>,
    &bdlmxxx::FunctionTemplates::streamOutArray<bsl::string,Out>,
    &bdlmxxx::FunctionTemplates::streamOutArray<bdlt::Datetime,Out>,
    &bdlmxxx::FunctionTemplates::streamOutArray<bdlt::Date,Out>,
    &bdlmxxx::FunctionTemplates::streamOutArray<bdlt::Time, Out>
};
...
static const int         UNSET_INT    = bdltuxxx::Unset<int>::unsetValue();
static const bsl::string UNSET_STRING = bdltuxxx::Unset<bsl::string>::unsetValue();
...
int replaceLoop(Obj &o, bslma::TestAllocator &a, int veryVerbose) {
    ...
    for (int index = 0; index < 64; index++) {
        if (index % 2) {  // INT64
            ...
            bdlmxxx::ConstElemRef cer(&index64, EDA[3]);
            o.replaceElement(0, cer);
        }
        else {            // INT
            bdlmxxx::ConstElemRef cer(&index, EDA[2]);
            o.replaceElement(0, cer);
        }
...
void testConstructorAllocationPT(Obj *list, bslma::TestAllocator& testAlloc) {
    ...
    // 'bdlmxxx::AggregateOption::BDEM_PASS_THROUGH' as its
    // 'bdlmxxx::AggregateOption::AllocationStrategy' and tests that
    ...
    bdlmxxx::RowData& rh = list->rowData();
...
void testConstructorAllocationWM(Obj *list, bslma::TestAllocator& testAlloc) {
    // Determine if the allocator the specified 'list' was created with is used
    // correctly.  This method assumes that 'list' uses
    // 'bdlmxxx::AggregateOption::WRITE_MANY' as its
    // 'bdlmxxx::AggregateOption::AllocationStrategy' and tests that
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 11: {
        ...
        //   increases the size of the 'bdlmxxx::ListImp' in a non-stationary way
        //
        // Plan:
        ...
        //                       const bdlmxxx::ConstElemRef& srcElem);
        // --------------------------------------------------------------------
...
//         ASSERT(highWaterMark >= highWaterMark2);
      ...
      case 10: {
        ...
        //   does not increase the size of the 'bdlmxxx::ListImp'.
        //
        // Plan:
      ...
      case 9: {
        ...
        {
            bslma::TestAllocator allocator;
            bdlmxxx::ListImp mX(bdlmxxx::AggregateOption::BDEM_WRITE_ONCE, &allocator);
        ...
        {
            bslma::TestAllocator allocator;
            bdlmxxx::ListImp mX(WM, &allocator);
      ...
      case 8: {
        ...
        if (verbose) cout << "\nWith allocMode only." << endl;
        {
            if (veryVerbose) cout << "\tUsing 'BDEM_WRITE_ONCE'." << endl;
            {
                ...
                bdlmxxx::ListImp mX(bdlmxxx::AggregateOption::BDEM_WRITE_ONCE,
                                bdlmxxx::ListImp::InitialMemory(SIZE),
                                &allocator);
        ...
        if (verbose) cout << "\nWith row header." << endl;
        {
            ...
            {
                bslma::TestAllocator allocator;
                bdlmxxx::RowLayout rowLayout(&allocator);

                const int SIZE = 128;
                char memory[SIZE];
                bdlma::BufferedSequentialAllocator ba(memory, SIZE);
                bdlmxxx::RowData rowData(&rowLayout, PT, &ba);

                const int startSize = allocator.numBytesInUse();

                bdlmxxx::ListImp mX(rowData,
                                bdlmxxx::AggregateOption::BDEM_WRITE_ONCE,
                                bdlmxxx::ListImp::InitialMemory(SIZE),
                                &allocator);
            ...
            if (veryVerbose) cout << "\tUsing 'BDEM_WRITE_MANY'." << endl;
            {
                ...
                char memory[SIZE];
                bdlma::BufferedSequentialAllocator ba(memory, SIZE);
                bdlmxxx::RowData rowData(&rowLayout, WM, &ba);
        ...
        if (verbose) cout << "\nWith copy ctor." << endl;
        {
            ...
            {
                bslma::TestAllocator allocator;
                bdlmxxx::ListImp original(bdlmxxx::AggregateOption::BDEM_PASS_THROUGH,
                                      &allocator);

                const int startSize = allocator.numBytesInUse();

                bdlmxxx::ListImp mX(original,
                                bdlmxxx::AggregateOption::BDEM_WRITE_ONCE,
                                bdlmxxx::ListImp::InitialMemory(SIZE),
                                &allocator);
            ...
            for (int v = 1; v <= 2; ++v) {
                ...
                for (int i = 0; i < NUM_TESTS; ++i) {
...

                    {
                        ...
                        Out out;
                        bdlmxxx::ListImp::streamOutList(&ref, out, VERSION,
                                                    STREAMOUT_TABLE);
                        const char *const OD  = out.data();
                        const int         LOD = out.length();
                        In in(OD, LOD);
                        in.setSuppressVersionCheck(1);
                        bdlmxxx::ListImp::streamInList(&list, in, VERSION,
                                                   STREAMIN_TABLE, EDA);
                        LOOP_ASSERT(i, list == ref);
                    }
                }
      ...
      case 6: {
        ...
        //
        // Testing:
        //   bdlmxxx::ListImp(AS, ALLOC);
        //   bdlmxxx::ListImp(AS, IM, ALLOC);
        //   bdlmxxx::ListImp(ET, NE, ALT, AS, ALLOC);
        //   bdlmxxx::ListImp(ET, NE, ALT, AS, IM, ALLOC);
        //   bdlmxxx::ListImp(RH, AS, ALLOC);
        //   bdlmxxx::ListImp(RH, AS, IM, ALLOC);
        //   bdlmxxx::ListImp(LI, AS, ALLOC);
        //   bdlmxxx::ListImp(LI, AS, IM, ALLOC);
        //--------------------------------------------------------------------
        ...
        if (verbose)
            cout << "bdlmxxx::ListImp(AS, ALLOC)" << endl <<
                    "-----------------------" << endl;
        ...
        if (verbose)
            cout << "bdlmxxx::ListImp(AS, IM, ALLOC)" << endl <<
            "-----------------------------------" << endl;
        ...
        if (verbose)
            cout << "bdlmxxx::ListImp(ET, NE, ALT, AS, ALLOC)" << endl <<
                    "------------------------------------" << endl;
        ...
        if (verbose)
            cout << "bdlmxxx::ListImp(ET, NE, ALT, AS, IM, ALLOC)" << endl <<
                    "----------------------------------------" << endl;
        ...
        if (verbose)
            cout << "bdlmxxx::ListImp(RH, AS, ALLOC)" << endl <<
                    "---------------------------" << endl;
        ...
        if (verbose) cout << "\ttesting BDEM_PASS_THROUGH" << endl;
        {
            ...
            bdlmxxx::RowLayout rowLayout(&testAlloc);
            const int SIZE = 128;
            char memory[SIZE];
            bdlma::BufferedSequentialAllocator ba(memory, SIZE);
        ...
        if (verbose)
            cout << "bdlmxxx::ListImp(RH, AS, IM, ALLOC)" << endl <<
                    "-------------------------------" << endl;
        ...
        if (verbose) cout << "\ttesting BDEM_PASS_THROUGH" << endl;
        {
            ...
            bdlmxxx::RowLayout rowLayout(&alloc);
            const int SIZE = 128;
            char memory[SIZE];
            bdlma::BufferedSequentialAllocator ba(memory, SIZE);
            RowData rh(&rowLayout, PT, &ba);
        ...
        if (verbose)
            cout << "bdlmxxx::ListImp(LI, AS, ALLOC)" << endl <<
                    "---------------------------" << endl;
      ...
      case 4: {
        ...
        //
        // Testing:
        //   bdlmxxx::ListImp& operator=(const bdlmxxx::RowData& rhs);
        //   bdlmxxx::ListImp& operator=(const bdlmxxx::ListImp& rhs);
        ...
        //   void replaceElement(int dI, const bdlmxxx::ConstElemRef& srcElem);
...

        {
            ...
            bdlmxxx::ConstElemRef cer1(&STRING_VALUE2, EDA[6]);
            ...
            bdlmxxx::ConstElemRef cer2(&INT_VALUE1, EDA[2]);
            ...
            bdlmxxx::ElemRef er1(&s2, EDA[6], &nullBits, 0);
            er1.makeNull();
            ...
            int i1 = 999;
            bdlmxxx::ElemRef er2(&i1, EDA[2], &nullBits, 1);
            er2.makeNull();
      ...
      case 3: {
        ...
        // Plan:
        // Testing:
        //   bool operator==(const bdlmxxx::ListImp& lhs, const bdlmxxx::ListImp& rhs);
        //   bool operator!=(const bdlmxxx::ListImp& lhs, const bdlmxxx::ListImp& rhs);
        //--------------------------------------------------------------------
      ...
      case 2: {
        ...
        //
        // Testing:
        //   BOOTSTRAP: bdlmxxx::ListImp(AS allocMode, bslma::Allocator *alloc=0);
        //   void *insertElement(int dstIndex, const void *value, D *elemAttr);
        //   int length() const;
        //   bdlmxxx::ElemType::Type elemType(int index) const;
        //   const bdlmxxx::RowData& rowData() const;
        //   bdlmxxx::RowData& rowData();
        //--------------------------------------------------------------------
      ...
      case 1: {
        ...
        // BREATHING TEST
        // Concerns:
        //   We are concerned that the basic functionality of 'bdlmxxx::ListImp'
        //   works properly.
        //
        // Plan:
        //
