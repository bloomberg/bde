// bdlmxxx_bdemdecoderutil.t.cpp                                      -*-C++-*-

#include <bdlmxxx_bdemdecoderutil.h>

#include <bdlmxxx_bdemencoderutil.h>         // for testing only
#include <bdlmxxx_elemtype.h>                // for testing only
...
#include <bdlxxxx_byteinstreamraw.h>         // for testing only
...
#include <bdlb_string.h>                  // for testing only
...
typedef bdlmxxx::BdemDecoderUtil Decoder;  // alias for 'struct' under test
typedef bdlmxxx::BdemEncoderUtil Encoder;
...
class MySequenceWithNullables {
  ...
  private:
    ...
    bdlb::NullableValue<bsl::vector<int> > d_attribute4;
                                                    // todo: provide annotation
    bdlb::NullableValue<MyEnumeration::Value> d_attribute5;
                                                    // todo: provide annotation
  public:
    // TYPES
    enum {
  ...
  public:
    ...
    bdlb::NullableValue<MySequence>& attribute3();
        ...
        // object.
    bdlb::NullableValue<bsl::vector<int> >& attribute4();
        // Return a reference to the modifiable "Attribute4" attribute of this
        // object.
    bdlb::NullableValue<MyEnumeration::Value>& attribute5();
    ...
    const bdlb::NullableValue<MySequence>& attribute3() const;
        ...
        // this object.
    const bdlb::NullableValue<bsl::vector<int> >& attribute4() const;
        // Return a reference to the non-modifiable "Attribute4" attribute of
        // this object.
    const bdlb::NullableValue<MyEnumeration::Value>& attribute5() const;
...
inline
bdlb::NullableValue<bsl::vector<int> >& MySequenceWithNullables::attribute4()
{
    return d_attribute4;
}
inline
bdlb::NullableValue<MyEnumeration::Value>&
...
inline
const bdlb::NullableValue<bsl::vector<int> >&
                                    MySequenceWithNullables::attribute4() const
{
    return d_attribute4;
}
inline
const bdlb::NullableValue<MyEnumeration::Value>&
...
{
    bdlat_ValueTypeFunctions::reset(&d_contained);
}
template <class MANIPULATOR>
inline
...
template <class ACCESSOR>
inline
int MySequenceWithNullablesContainer::accessAttributes(
...
inline
const MySequenceWithNullables& MySequenceWithNullablesContainer::contained()
                                                                          const
{
    return d_contained;
}
...
const bdlat_AttributeInfo
                   MySequenceWithNullablesContainer::ATTRIBUTE_INFO_ARRAY[] = {
    {
        ...
        bdlat_FormattingMode::e_DEFAULT // formatting mode
                               ...
                               // -------------
const bdlat_AttributeInfo *
MySequenceWithNullablesContainer::lookupAttributeInfo(const char *name,
                                                      int         nameLength)
{
    switch(nameLength) {
        case 9: {
            if (bdlb::CharType::toUpper(name[0])=='C'
             ...
             && bdlb::CharType::toUpper(name[6])=='N'
             && bdlb::CharType::toUpper(name[7])=='E'
             && bdlb::CharType::toUpper(name[8])=='D') {
    ...
    int           spacesPerLevel) const
{
    ...
    if (0 <= spacesPerLevel) {
        ...
        bdlb::Print::indent(stream, levelPlus1, spacesPerLevel);
        stream << "Contained = ";
        bdlb::PrintMethods::print(stream, d_contained,
                             -levelPlus1, spacesPerLevel);
        bdlb::Print::indent(stream, level, spacesPerLevel);
        stream << "]\n";
    }
...
class MySequenceWithManyNullables {
  private:
    bdlb::NullableValue<int> d_attribute01; // todo: provide annotation
    bdlb::NullableValue<int> d_attribute02; // todo: provide annotation
    bdlb::NullableValue<int> d_attribute03; // todo: provide annotation
    bdlb::NullableValue<int> d_attribute04; // todo: provide annotation
    bdlb::NullableValue<int> d_attribute05; // todo: provide annotation
    bdlb::NullableValue<int> d_attribute06; // todo: provide annotation
    bdlb::NullableValue<int> d_attribute07; // todo: provide annotation
    bdlb::NullableValue<int> d_attribute08; // todo: provide annotation
    bdlb::NullableValue<int> d_attribute09; // todo: provide annotation
    bdlb::NullableValue<int> d_attribute10; // todo: provide annotation
    bdlb::NullableValue<int> d_attribute11; // todo: provide annotation
    bdlb::NullableValue<int> d_attribute12; // todo: provide annotation
    bdlb::NullableValue<int> d_attribute13; // todo: provide annotation
    bdlb::NullableValue<int> d_attribute14; // todo: provide annotation
    bdlb::NullableValue<int> d_attribute15; // todo: provide annotation
    bdlb::NullableValue<int> d_attribute16; // todo: provide annotation
    bdlb::NullableValue<int> d_attribute17; // todo: provide annotation
    bdlb::NullableValue<int> d_attribute18; // todo: provide annotation
    bdlb::NullableValue<int> d_attribute19; // todo: provide annotation
    bdlb::NullableValue<int> d_attribute20; // todo: provide annotation
    bdlb::NullableValue<int> d_attribute21; // todo: provide annotation
    bdlb::NullableValue<int> d_attribute22; // todo: provide annotation
    bdlb::NullableValue<int> d_attribute23; // todo: provide annotation
    bdlb::NullableValue<int> d_attribute24; // todo: provide annotation
    bdlb::NullableValue<int> d_attribute25; // todo: provide annotation
    bdlb::NullableValue<int> d_attribute26; // todo: provide annotation
    bdlb::NullableValue<int> d_attribute27; // todo: provide annotation
    bdlb::NullableValue<int> d_attribute28; // todo: provide annotation
    bdlb::NullableValue<int> d_attribute29; // todo: provide annotation
    bdlb::NullableValue<int> d_attribute30; // todo: provide annotation
    bdlb::NullableValue<int> d_attribute31; // todo: provide annotation
    bdlb::NullableValue<int> d_attribute32; // todo: provide annotation
    bdlb::NullableValue<int> d_attribute33; // todo: provide annotation
    bdlb::NullableValue<int> d_attribute34; // todo: provide annotation
    bdlb::NullableValue<int> d_attribute35; // todo: provide annotation
    bdlb::NullableValue<int> d_attribute36; // todo: provide annotation
    bdlb::NullableValue<int> d_attribute37; // todo: provide annotation
    bdlb::NullableValue<int> d_attribute38; // todo: provide annotation
    bdlb::NullableValue<int> d_attribute39; // todo: provide annotation
    bdlb::NullableValue<int> d_attribute40; // todo: provide annotation
  public:
    // TYPES
    enum {
  ...
  public:
    ...
    int manipulateAttribute(MANIPULATOR&  manipulator,
        ...
        // returned from the invocation of 'manipulator' if 'name' identifies
        // an attribute of this class, and -1 otherwise.
    bdlb::NullableValue<int>& attribute01();
        // Return a reference to the modifiable "Attribute01" attribute of this
        // object.
    bdlb::NullableValue<int>& attribute02();
        // Return a reference to the modifiable "Attribute02" attribute of this
        // object.
    bdlb::NullableValue<int>& attribute03();
        // Return a reference to the modifiable "Attribute03" attribute of this
        // object.
    bdlb::NullableValue<int>& attribute04();
        // Return a reference to the modifiable "Attribute04" attribute of this
        // object.
    bdlb::NullableValue<int>& attribute05();
        // Return a reference to the modifiable "Attribute05" attribute of this
        // object.
    bdlb::NullableValue<int>& attribute06();
        // Return a reference to the modifiable "Attribute06" attribute of this
        // object.
    bdlb::NullableValue<int>& attribute07();
        // Return a reference to the modifiable "Attribute07" attribute of this
        // object.
    bdlb::NullableValue<int>& attribute08();
        // Return a reference to the modifiable "Attribute08" attribute of this
        // object.
    bdlb::NullableValue<int>& attribute09();
        // Return a reference to the modifiable "Attribute09" attribute of this
        // object.
    bdlb::NullableValue<int>& attribute10();
        // Return a reference to the modifiable "Attribute10" attribute of this
        // object.
    bdlb::NullableValue<int>& attribute11();
        // Return a reference to the modifiable "Attribute11" attribute of this
        // object.
    bdlb::NullableValue<int>& attribute12();
        // Return a reference to the modifiable "Attribute12" attribute of this
        // object.
    bdlb::NullableValue<int>& attribute13();
        // Return a reference to the modifiable "Attribute13" attribute of this
        // object.
    bdlb::NullableValue<int>& attribute14();
        // Return a reference to the modifiable "Attribute14" attribute of this
        // object.
    bdlb::NullableValue<int>& attribute15();
        // Return a reference to the modifiable "Attribute15" attribute of this
        // object.
    bdlb::NullableValue<int>& attribute16();
        // Return a reference to the modifiable "Attribute16" attribute of this
        // object.
    bdlb::NullableValue<int>& attribute17();
        // Return a reference to the modifiable "Attribute17" attribute of this
        // object.
    bdlb::NullableValue<int>& attribute18();
        // Return a reference to the modifiable "Attribute18" attribute of this
        // object.
    bdlb::NullableValue<int>& attribute19();
        // Return a reference to the modifiable "Attribute19" attribute of this
        // object.
    bdlb::NullableValue<int>& attribute20();
        // Return a reference to the modifiable "Attribute20" attribute of this
        // object.
    bdlb::NullableValue<int>& attribute21();
        // Return a reference to the modifiable "Attribute21" attribute of this
        // object.
    bdlb::NullableValue<int>& attribute22();
        // Return a reference to the modifiable "Attribute22" attribute of this
        // object.
    bdlb::NullableValue<int>& attribute23();
        // Return a reference to the modifiable "Attribute23" attribute of this
        // object.
    bdlb::NullableValue<int>& attribute24();
        // Return a reference to the modifiable "Attribute24" attribute of this
        // object.
    bdlb::NullableValue<int>& attribute25();
        // Return a reference to the modifiable "Attribute25" attribute of this
        // object.
    bdlb::NullableValue<int>& attribute26();
        // Return a reference to the modifiable "Attribute26" attribute of this
        // object.
    bdlb::NullableValue<int>& attribute27();
        // Return a reference to the modifiable "Attribute27" attribute of this
        // object.
    bdlb::NullableValue<int>& attribute28();
        // Return a reference to the modifiable "Attribute28" attribute of this
        // object.
    bdlb::NullableValue<int>& attribute29();
        // Return a reference to the modifiable "Attribute29" attribute of this
        // object.
    bdlb::NullableValue<int>& attribute30();
        // Return a reference to the modifiable "Attribute30" attribute of this
        // object.
    bdlb::NullableValue<int>& attribute31();
        // Return a reference to the modifiable "Attribute31" attribute of this
        // object.
    bdlb::NullableValue<int>& attribute32();
        // Return a reference to the modifiable "Attribute32" attribute of this
        // object.
    bdlb::NullableValue<int>& attribute33();
        // Return a reference to the modifiable "Attribute33" attribute of this
        // object.
    bdlb::NullableValue<int>& attribute34();
        // Return a reference to the modifiable "Attribute34" attribute of this
        // object.
    bdlb::NullableValue<int>& attribute35();
        // Return a reference to the modifiable "Attribute35" attribute of this
        // object.
    bdlb::NullableValue<int>& attribute36();
        // Return a reference to the modifiable "Attribute36" attribute of this
        // object.
    bdlb::NullableValue<int>& attribute37();
        // Return a reference to the modifiable "Attribute37" attribute of this
        // object.
    bdlb::NullableValue<int>& attribute38();
        // Return a reference to the modifiable "Attribute38" attribute of this
        // object.
    bdlb::NullableValue<int>& attribute39();
        // Return a reference to the modifiable "Attribute39" attribute of this
        // object.
    bdlb::NullableValue<int>& attribute40();
        // Return a reference to the modifiable "Attribute40" attribute of this
        // object.
...
{
    bdlat_ValueTypeFunctions::reset(&d_attribute01);
    bdlat_ValueTypeFunctions::reset(&d_attribute02);
    bdlat_ValueTypeFunctions::reset(&d_attribute03);
    bdlat_ValueTypeFunctions::reset(&d_attribute04);
    bdlat_ValueTypeFunctions::reset(&d_attribute05);
    bdlat_ValueTypeFunctions::reset(&d_attribute06);
    bdlat_ValueTypeFunctions::reset(&d_attribute07);
    bdlat_ValueTypeFunctions::reset(&d_attribute08);
    bdlat_ValueTypeFunctions::reset(&d_attribute09);
    bdlat_ValueTypeFunctions::reset(&d_attribute10);
    bdlat_ValueTypeFunctions::reset(&d_attribute11);
    bdlat_ValueTypeFunctions::reset(&d_attribute12);
    bdlat_ValueTypeFunctions::reset(&d_attribute13);
    bdlat_ValueTypeFunctions::reset(&d_attribute14);
    bdlat_ValueTypeFunctions::reset(&d_attribute15);
    bdlat_ValueTypeFunctions::reset(&d_attribute16);
    bdlat_ValueTypeFunctions::reset(&d_attribute17);
    bdlat_ValueTypeFunctions::reset(&d_attribute18);
    bdlat_ValueTypeFunctions::reset(&d_attribute19);
    bdlat_ValueTypeFunctions::reset(&d_attribute20);
    bdlat_ValueTypeFunctions::reset(&d_attribute21);
    bdlat_ValueTypeFunctions::reset(&d_attribute22);
    bdlat_ValueTypeFunctions::reset(&d_attribute23);
    bdlat_ValueTypeFunctions::reset(&d_attribute24);
    bdlat_ValueTypeFunctions::reset(&d_attribute25);
    bdlat_ValueTypeFunctions::reset(&d_attribute26);
    bdlat_ValueTypeFunctions::reset(&d_attribute27);
    bdlat_ValueTypeFunctions::reset(&d_attribute28);
    bdlat_ValueTypeFunctions::reset(&d_attribute29);
    bdlat_ValueTypeFunctions::reset(&d_attribute30);
    bdlat_ValueTypeFunctions::reset(&d_attribute31);
    bdlat_ValueTypeFunctions::reset(&d_attribute32);
    bdlat_ValueTypeFunctions::reset(&d_attribute33);
    bdlat_ValueTypeFunctions::reset(&d_attribute34);
    bdlat_ValueTypeFunctions::reset(&d_attribute35);
    bdlat_ValueTypeFunctions::reset(&d_attribute36);
    bdlat_ValueTypeFunctions::reset(&d_attribute37);
    bdlat_ValueTypeFunctions::reset(&d_attribute38);
    bdlat_ValueTypeFunctions::reset(&d_attribute39);
    bdlat_ValueTypeFunctions::reset(&d_attribute40);
}
template <class MANIPULATOR>
inline
...
inline
bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute01()
{
    return d_attribute01;
}
inline
bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute02()
{
    return d_attribute02;
}
inline
bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute03()
{
    return d_attribute03;
}
inline
bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute04()
{
    return d_attribute04;
}
inline
bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute05()
{
    return d_attribute05;
}
inline
bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute06()
{
    return d_attribute06;
}
inline
bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute07()
{
    return d_attribute07;
}
inline
bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute08()
{
    return d_attribute08;
}
inline
bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute09()
{
    return d_attribute09;
}
inline
bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute10()
{
    return d_attribute10;
}
inline
bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute11()
{
    return d_attribute11;
}
inline
bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute12()
{
    return d_attribute12;
}
inline
bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute13()
{
    return d_attribute13;
}
inline
bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute14()
{
    return d_attribute14;
}
inline
bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute15()
{
    return d_attribute15;
}
inline
bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute16()
{
    return d_attribute16;
}
inline
bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute17()
{
    return d_attribute17;
}
inline
bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute18()
{
    return d_attribute18;
}
inline
bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute19()
{
    return d_attribute19;
}
inline
bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute20()
{
    return d_attribute20;
}
inline
bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute21()
{
    return d_attribute21;
}
inline
bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute22()
{
    return d_attribute22;
}
inline
bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute23()
{
    return d_attribute23;
}
inline
bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute24()
{
    return d_attribute24;
}
inline
bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute25()
{
    return d_attribute25;
}
inline
bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute26()
{
    return d_attribute26;
}
inline
bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute27()
{
    return d_attribute27;
}
inline
bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute28()
{
    return d_attribute28;
}
inline
bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute29()
{
    return d_attribute29;
}
inline
bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute30()
{
    return d_attribute30;
}
inline
bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute31()
{
    return d_attribute31;
}
inline
bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute32()
{
    return d_attribute32;
}
inline
bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute33()
{
    return d_attribute33;
}
inline
bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute34()
{
    return d_attribute34;
}
inline
bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute35()
{
    return d_attribute35;
}
inline
bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute36()
{
    return d_attribute36;
}
inline
bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute37()
{
    return d_attribute37;
}
inline
bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute38()
{
    return d_attribute38;
}
inline
bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute39()
{
    return d_attribute39;
}
inline
bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute40()
{
...
inline
const bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute01()
                                                                          const
{
    return d_attribute01;
}
inline
const bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute02()
                                                                          const
{
    return d_attribute02;
}
inline
const bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute03()
                                                                          const
{
    return d_attribute03;
}
inline
const bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute04()
                                                                          const
{
    return d_attribute04;
}
inline
const bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute05()
                                                                          const
{
    return d_attribute05;
}
inline
const bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute06()
                                                                          const
{
    return d_attribute06;
}
inline
const bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute07()
                                                                          const
{
    return d_attribute07;
}
inline
const bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute08()
                                                                          const
{
    return d_attribute08;
}
inline
const bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute09()
                                                                          const
{
    return d_attribute09;
}
inline
const bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute10()
                                                                          const
{
    return d_attribute10;
}
inline
const bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute11()
                                                                          const
{
    return d_attribute11;
}
inline
const bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute12()
                                                                          const
{
    return d_attribute12;
}
inline
const bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute13()
                                                                          const
{
    return d_attribute13;
}
inline
const bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute14()
                                                                          const
{
    return d_attribute14;
}
inline
const bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute15()
                                                                          const
{
    return d_attribute15;
}
inline
const bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute16()
                                                                          const
{
    return d_attribute16;
}
inline
const bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute17()
                                                                          const
{
    return d_attribute17;
}
inline
const bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute18()
                                                                          const
{
    return d_attribute18;
}
inline
const bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute19()
                                                                          const
{
    return d_attribute19;
}
inline
const bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute20()
                                                                          const
{
    return d_attribute20;
}
inline
const bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute21()
                                                                          const
{
    return d_attribute21;
}
inline
const bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute22()
                                                                          const
{
    return d_attribute22;
}
inline
const bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute23()
                                                                          const
{
    return d_attribute23;
}
inline
const bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute24()
                                                                          const
{
    return d_attribute24;
}
inline
const bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute25()
                                                                          const
{
    return d_attribute25;
}
inline
const bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute26()
                                                                          const
{
    return d_attribute26;
}
inline
const bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute27()
                                                                          const
{
    return d_attribute27;
}
inline
const bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute28()
                                                                          const
{
    return d_attribute28;
}
inline
const bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute29()
                                                                          const
{
    return d_attribute29;
}
inline
const bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute30()
                                                                          const
{
    return d_attribute30;
}
inline
const bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute31()
                                                                          const
{
    return d_attribute31;
}
inline
const bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute32()
                                                                          const
{
    return d_attribute32;
}
inline
const bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute33()
                                                                          const
{
    return d_attribute33;
}
inline
const bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute34()
                                                                          const
{
    return d_attribute34;
}
inline
const bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute35()
                                                                          const
{
    return d_attribute35;
}
inline
const bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute36()
                                                                          const
{
    return d_attribute36;
}
inline
const bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute37()
                                                                          const
{
    return d_attribute37;
}
inline
const bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute38()
                                                                          const
{
    return d_attribute38;
}
inline
const bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute39()
                                                                          const
{
    return d_attribute39;
}
inline
const bdlb::NullableValue<int>& MySequenceWithManyNullables::attribute40()
                                                                          const
{
    return d_attribute40;
}
...
// TRAITS
BDLAT_DECL_SEQUENCE_TRAITS(test::MySequenceWithManyNullables)
// FREE OPERATORS
inline
...
const bdlat_AttributeInfo
    ...
    },
    {
        ...
        bdlat_FormattingMode::e_DEC // formatting mode
                               ...
                               // CLASS METHODS
                               // -------------
const bdlat_AttributeInfo *MySequenceWithManyNullables::lookupAttributeInfo(
        const char *name,
        int         nameLength)
{
    switch(nameLength) {
        case 11: {
            if (bdlb::CharType::toUpper(name[0])=='A'
             ...
             && bdlb::CharType::toUpper(name[8])=='E') {
                switch(bdlb::CharType::toUpper(name[9])) {
                    case '0': {
                        switch(bdlb::CharType::toUpper(name[10])) {
                            case '1': {
...
const bdlat_AttributeInfo *
                       MySequenceWithManyNullables::lookupAttributeInfo(int id)
{
    switch (id) {
      case ATTRIBUTE_ID_ATTRIBUTE01:
    ...
    int           spacesPerLevel) const
{
    ...
    if (0 <= spacesPerLevel) {
        ...
        bdlb::Print::indent(stream, levelPlus1, spacesPerLevel);
        stream << "Attribute01 = ";
        bdlb::PrintMethods::print(stream, d_attribute01,
                             -levelPlus1, spacesPerLevel);
        bdlb::Print::indent(stream, levelPlus1, spacesPerLevel);
        stream << "Attribute02 = ";
        bdlb::PrintMethods::print(stream, d_attribute02,
                             -levelPlus1, spacesPerLevel);
        bdlb::Print::indent(stream, levelPlus1, spacesPerLevel);
        stream << "Attribute03 = ";
        bdlb::PrintMethods::print(stream, d_attribute03,
                             -levelPlus1, spacesPerLevel);
        bdlb::Print::indent(stream, levelPlus1, spacesPerLevel);
        stream << "Attribute04 = ";
        bdlb::PrintMethods::print(stream, d_attribute04,
                             -levelPlus1, spacesPerLevel);
        bdlb::Print::indent(stream, levelPlus1, spacesPerLevel);
        stream << "Attribute05 = ";
        bdlb::PrintMethods::print(stream, d_attribute05,
                             -levelPlus1, spacesPerLevel);
        bdlb::Print::indent(stream, levelPlus1, spacesPerLevel);
        stream << "Attribute06 = ";
        bdlb::PrintMethods::print(stream, d_attribute06,
                             -levelPlus1, spacesPerLevel);
        bdlb::Print::indent(stream, levelPlus1, spacesPerLevel);
        stream << "Attribute07 = ";
        bdlb::PrintMethods::print(stream, d_attribute07,
                             -levelPlus1, spacesPerLevel);
        bdlb::Print::indent(stream, levelPlus1, spacesPerLevel);
        stream << "Attribute08 = ";
        bdlb::PrintMethods::print(stream, d_attribute08,
                             -levelPlus1, spacesPerLevel);
        bdlb::Print::indent(stream, levelPlus1, spacesPerLevel);
        stream << "Attribute09 = ";
        bdlb::PrintMethods::print(stream, d_attribute09,
                             -levelPlus1, spacesPerLevel);
        bdlb::Print::indent(stream, levelPlus1, spacesPerLevel);
        stream << "Attribute10 = ";
        bdlb::PrintMethods::print(stream, d_attribute10,
                             -levelPlus1, spacesPerLevel);
        bdlb::Print::indent(stream, levelPlus1, spacesPerLevel);
        stream << "Attribute11 = ";
        bdlb::PrintMethods::print(stream, d_attribute11,
                             -levelPlus1, spacesPerLevel);
        bdlb::Print::indent(stream, levelPlus1, spacesPerLevel);
        stream << "Attribute12 = ";
        bdlb::PrintMethods::print(stream, d_attribute12,
                             -levelPlus1, spacesPerLevel);
        bdlb::Print::indent(stream, levelPlus1, spacesPerLevel);
        stream << "Attribute13 = ";
        bdlb::PrintMethods::print(stream, d_attribute13,
                             -levelPlus1, spacesPerLevel);
        bdlb::Print::indent(stream, levelPlus1, spacesPerLevel);
        stream << "Attribute14 = ";
        bdlb::PrintMethods::print(stream, d_attribute14,
                             -levelPlus1, spacesPerLevel);
        bdlb::Print::indent(stream, levelPlus1, spacesPerLevel);
        stream << "Attribute15 = ";
        bdlb::PrintMethods::print(stream, d_attribute15,
                             -levelPlus1, spacesPerLevel);
        bdlb::Print::indent(stream, levelPlus1, spacesPerLevel);
        stream << "Attribute16 = ";
        bdlb::PrintMethods::print(stream, d_attribute16,
                             -levelPlus1, spacesPerLevel);
        bdlb::Print::indent(stream, levelPlus1, spacesPerLevel);
        stream << "Attribute17 = ";
        bdlb::PrintMethods::print(stream, d_attribute17,
                             -levelPlus1, spacesPerLevel);
        bdlb::Print::indent(stream, levelPlus1, spacesPerLevel);
        stream << "Attribute18 = ";
        bdlb::PrintMethods::print(stream, d_attribute18,
                             -levelPlus1, spacesPerLevel);
        bdlb::Print::indent(stream, levelPlus1, spacesPerLevel);
        stream << "Attribute19 = ";
        bdlb::PrintMethods::print(stream, d_attribute19,
                             -levelPlus1, spacesPerLevel);
        bdlb::Print::indent(stream, levelPlus1, spacesPerLevel);
        stream << "Attribute20 = ";
        bdlb::PrintMethods::print(stream, d_attribute20,
                             -levelPlus1, spacesPerLevel);
        bdlb::Print::indent(stream, levelPlus1, spacesPerLevel);
        stream << "Attribute21 = ";
        bdlb::PrintMethods::print(stream, d_attribute21,
                             -levelPlus1, spacesPerLevel);
        bdlb::Print::indent(stream, levelPlus1, spacesPerLevel);
        stream << "Attribute22 = ";
        bdlb::PrintMethods::print(stream, d_attribute22,
                             -levelPlus1, spacesPerLevel);
        bdlb::Print::indent(stream, levelPlus1, spacesPerLevel);
        stream << "Attribute23 = ";
        bdlb::PrintMethods::print(stream, d_attribute23,
                             -levelPlus1, spacesPerLevel);
        bdlb::Print::indent(stream, levelPlus1, spacesPerLevel);
        stream << "Attribute24 = ";
        bdlb::PrintMethods::print(stream, d_attribute24,
                             -levelPlus1, spacesPerLevel);
        bdlb::Print::indent(stream, levelPlus1, spacesPerLevel);
        stream << "Attribute25 = ";
        bdlb::PrintMethods::print(stream, d_attribute25,
                             -levelPlus1, spacesPerLevel);
        bdlb::Print::indent(stream, levelPlus1, spacesPerLevel);
        stream << "Attribute26 = ";
        bdlb::PrintMethods::print(stream, d_attribute26,
                             -levelPlus1, spacesPerLevel);
        bdlb::Print::indent(stream, levelPlus1, spacesPerLevel);
        stream << "Attribute27 = ";
        bdlb::PrintMethods::print(stream, d_attribute27,
                             -levelPlus1, spacesPerLevel);
        bdlb::Print::indent(stream, levelPlus1, spacesPerLevel);
        stream << "Attribute28 = ";
        bdlb::PrintMethods::print(stream, d_attribute28,
                             -levelPlus1, spacesPerLevel);
        bdlb::Print::indent(stream, levelPlus1, spacesPerLevel);
        stream << "Attribute29 = ";
        bdlb::PrintMethods::print(stream, d_attribute29,
                             -levelPlus1, spacesPerLevel);
        bdlb::Print::indent(stream, levelPlus1, spacesPerLevel);
        stream << "Attribute30 = ";
        bdlb::PrintMethods::print(stream, d_attribute30,
                             -levelPlus1, spacesPerLevel);
        bdlb::Print::indent(stream, levelPlus1, spacesPerLevel);
        stream << "Attribute31 = ";
        bdlb::PrintMethods::print(stream, d_attribute31,
                             -levelPlus1, spacesPerLevel);
        bdlb::Print::indent(stream, levelPlus1, spacesPerLevel);
        stream << "Attribute32 = ";
        bdlb::PrintMethods::print(stream, d_attribute32,
                             -levelPlus1, spacesPerLevel);
        bdlb::Print::indent(stream, levelPlus1, spacesPerLevel);
        stream << "Attribute33 = ";
        bdlb::PrintMethods::print(stream, d_attribute33,
                             -levelPlus1, spacesPerLevel);
        bdlb::Print::indent(stream, levelPlus1, spacesPerLevel);
        stream << "Attribute34 = ";
        bdlb::PrintMethods::print(stream, d_attribute34,
                             -levelPlus1, spacesPerLevel);
        bdlb::Print::indent(stream, levelPlus1, spacesPerLevel);
        stream << "Attribute35 = ";
        bdlb::PrintMethods::print(stream, d_attribute35,
                             -levelPlus1, spacesPerLevel);
        bdlb::Print::indent(stream, levelPlus1, spacesPerLevel);
        stream << "Attribute36 = ";
        bdlb::PrintMethods::print(stream, d_attribute36,
                             -levelPlus1, spacesPerLevel);
        bdlb::Print::indent(stream, levelPlus1, spacesPerLevel);
        stream << "Attribute37 = ";
        bdlb::PrintMethods::print(stream, d_attribute37,
                             -levelPlus1, spacesPerLevel);
        bdlb::Print::indent(stream, levelPlus1, spacesPerLevel);
        stream << "Attribute38 = ";
        bdlb::PrintMethods::print(stream, d_attribute38,
                             -levelPlus1, spacesPerLevel);
        bdlb::Print::indent(stream, levelPlus1, spacesPerLevel);
        stream << "Attribute39 = ";
        bdlb::PrintMethods::print(stream, d_attribute39,
                             -levelPlus1, spacesPerLevel);
        bdlb::Print::indent(stream, levelPlus1, spacesPerLevel);
        stream << "Attribute40 = ";
        bdlb::PrintMethods::print(stream, d_attribute40,
                             -levelPlus1, spacesPerLevel);
        bdlb::Print::indent(stream, level, spacesPerLevel);
        stream << "]\n";
    }
...
class Employee {
  private:
    ...
    bdlt::DateTz d_dateJoined; // todo: provide annotation
  public:
    // TYPES
    enum {
  ...
  public:
    ...
    const int& age() const;
        ...
        // attribute of this object.
    const bdlt::DateTz& dateJoined() const;
...
void Employee::reset()
{
    ...
    bdlat_ValueTypeFunctions::reset(&d_dateJoined);
}
template <class MANIPULATOR>
inline
...
inline
bdlt::DateTz& Employee::dateJoined()
{
    return d_dateJoined;
}
// ACCESSORS
...
inline
const bdlt::DateTz& Employee::dateJoined() const
{
    return d_dateJoined;
}
}  // close namespace test
    ...
    switch(nameLength) {
        ...
        case 10: {
            if (bdlb::CharType::toUpper(name[0])=='D'
             ...
             && bdlb::CharType::toUpper(name[2])=='T'
             && bdlb::CharType::toUpper(name[3])=='E'
             && bdlb::CharType::toUpper(name[4])=='J'
             && bdlb::CharType::toUpper(name[5])=='O'
             && bdlb::CharType::toUpper(name[6])=='I'
             && bdlb::CharType::toUpper(name[7])=='N'
             && bdlb::CharType::toUpper(name[8])=='E'
             && bdlb::CharType::toUpper(name[9])=='D') {
    ...
    int           spacesPerLevel) const
{
    ...
    if (0 <= spacesPerLevel) {
        ...
        bdlb::Print::indent(stream, levelPlus1, spacesPerLevel);
        stream << "DateJoined = ";
        bdlb::PrintMethods::print(stream, d_dateJoined,
                             -levelPlus1, spacesPerLevel);
        bdlb::Print::indent(stream, level, spacesPerLevel);
        stream << "]\n";
    }
...
struct TestValueFunctions_Imp {
    ...
    template <class TYPE>
    static
    int loadTestValue(TYPE *object, int index, bdlat_TypeCategory::Array);
    ...
    template <class TYPE>
    static
    int loadTestValue(TYPE *object, int index, bdlat_TypeCategory::Choice);
    ...
    template <class TYPE>
    static
    int loadTestValue(TYPE *object, int index, bdlat_TypeCategory::Sequence);
...
namespace TestValueFunctions {
    ...
    int loadTestValue(bsl::string *object, int index);
        ...
        // non-zero value otherwise with no effect on 'object'.  The behavior
        // is undefined unless index >= 0.
    int loadTestValue(bdlt::Date *object, int index);
        // Load into the specified 'object' a test value of 'bdlt::Date' type
        // indicated by the specified 'index'.  Return 0 on success, and a
        // non-zero value otherwise with no effect on 'object'.  The behavior
        // is undefined unless index >= 0.
    int loadTestValue(bdlt::Datetime *object, int index);
        // Load into the specified 'object' a test value of 'bdlt::Datetime'
        // type indicated by the specified 'index'.  Return 0 on success, and a
        // non-zero value otherwise with no effect on 'object'.  The behavior
        // is undefined unless index >= 0.
    int loadTestValue(bdlt::Time *object, int index);
        // Load into the specified 'object' a test value of 'bdlt::Time' type
        // indicated by the specified 'index'.  Return 0 on success, and a
        // non-zero value otherwise with no effect on 'object'.  The behavior
        // is undefined unless index >= 0.
    int loadTestValue(bdlt::DateTz *object, int index);
        // Load into the specified 'object' a test value of 'bdlt::Date' type
        // indicated by the specified 'index'.  Return 0 on success, and a
        // non-zero value otherwise with no effect on 'object'.  The behavior
        // is undefined unless index >= 0.
    int loadTestValue(bdlt::DatetimeTz *object, int index);
        // Load into the specified 'object' a test value of 'bdlt::Datetime'
        // type indicated by the specified 'index'.  Return 0 on success, and a
        // non-zero value otherwise with no effect on 'object'.  The behavior
        // is undefined unless index >= 0.
    int loadTestValue(bdlt::TimeTz *object, int index);
        // Load into the specified 'object' a test value of 'bdlt::Time' type
        // indicated by the specified 'index'.  Return 0 on success, and a
        // non-zero value otherwise with no effect on 'object'.  The behavior
        // is undefined unless index >= 0.
                                          ...
                                          bdlat_TypeCategory::Array)
{
    ...
    bdlat_ArrayFunctions::resize(object, arraySize);
    for (int i = 0; i < arraySize; ++i) {
        TestValueFunctions_Imp manipulator = { index + i };
        if (0 != bdlat_ArrayFunctions::manipulateElement(object,
                                                         manipulator,
                                                         i)) {
            return FAILURE;                                           // RETURN
        }
...
{
    BSLMF_ASSERT((bdlat_ChoiceFunctions::IsChoice<TYPE>::VALUE));
    BSLS_ASSERT_SAFE(index >= 0);
                                          ...
                                          bdlat_TypeCategory::Enumeration)
{
    ...
    bdlat_EnumeratorInfo info = Wrapper::ENUMERATOR_INFO_ARRAY[index];
...
{
    BSLMF_ASSERT((bdlat_SequenceFunctions::IsSequence<TYPE>::VALUE));
    BSLS_ASSERT_SAFE(index >= 0);
...
{
    typedef typename bdlat_TypeCategory::Select<TYPE>::Type Type;
...
#endif
inline
int TestValueFunctions::loadTestValue(bdlt::Date *object, int index)
{
    BSLS_ASSERT_SAFE(index >= 0);
...
inline
int TestValueFunctions::loadTestValue(bdlt::Datetime *object, int index)
{
    BSLS_ASSERT_SAFE(index >= 0);
    bdlt::Date date;
...
inline
int TestValueFunctions::loadTestValue(bdlt::Time *object, int index)
{
    BSLS_ASSERT_SAFE(index >= 0);
    ...
    BSLS_ASSERT_SAFE(bdlt::Time::isValid(hours,
                                        minutes,
                                        seconds,
                                        milliseconds));
...
inline
int TestValueFunctions::loadTestValue(bdlt::DateTz *object, int index)
{
    BSLS_ASSERT_SAFE(index >= 0);
    bdlt::Date local;
    int       offset;
...
inline
int TestValueFunctions::loadTestValue(bdlt::DatetimeTz *object, int index)
{
    BSLS_ASSERT_SAFE(index >= 0);
    bdlt::Datetime local;
    int           offset;
...
inline
int TestValueFunctions::loadTestValue(bdlt::TimeTz *object, int index)
{
    BSLS_ASSERT_SAFE(index >= 0);
    bdlt::Time local;
    int       offset;
...
void usageExample()
{
    ...
    list.appendNullList();                      // homeAddress
    ...
    list.appendNullList();                      // dateJoined
    list.theModifiableList(3).appendDate(bdlt::Date(2003,
                                         3,
                                         20));  // dateJoined.localDate
...
// that we will use 'bdesb' stream buffers for in-core buffer management:
//..
...
//..
    bdlsb::FixedMemInStreamBuf isb(os.data(), os.length());
    test::Employee            bob;
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
                                   ...
                                   << bsl::endl;
        {
            ...
            for (int i = 0; i < NUM_DATA; ++i) {
                for (int j = 0; j < NUM_DATA; ++j) {
                    // Note: When i == 3 (attribute is nullable bsl::vector),
                    // then we cannot test for nullable because of ambiguities
                    // in the 'bdem' wire format.
                    if (i == j && 3 != i) {
                        SetToNull setToNull;
                        LOOP2_ASSERT(
                               i, j,
            ...
            for (int bdemVersion = 1; bdemVersion <= 2; ++bdemVersion) {
                for (int i = 0; i < NUM_DATA; ++i) {
                    bdlxxxx::ByteOutStreamRaw   outStream(buffer, BUFSIZE);
                    bdlmxxx::BdemEncoderOptions options;
                    ...
                    bdlxxxx::ByteInStreamRaw    inStream(buffer, BUFSIZE);
                    bdlmxxx::BdemDecoderOptions decodeOpts;
                    decodeOpts.setBdemVersion(bdemVersion);
                    Type mY; const Type& Y = mY;
                    LOOP2_ASSERT(bdemVersion, i,
                                 Decoder::decode(inStream, &mY, decodeOpts));
                    LOOP2_ASSERT(bdemVersion, i,
                                 inStream.cursor() == outStream.length());
                    LOOP2_ASSERT(bdemVersion, i, X == Y);
        ...
        if (verbose) bsl::cout << "\tCustomizedString" << bsl::endl;
        {
            ...
            for (int bdemVersion = 1; bdemVersion <= 2; ++bdemVersion) {
                for (int ti = 0; ti < NUM_DATA; ++ti) {
                    ...
                    LOOP2_ASSERT(bdemVersion, ti,
                                 inStream.cursor() == outStream.length());
                    LOOP2_ASSERT(bdemVersion, ti, X == Y);
                    if (veryVerbose) { P(inStream.cursor())  P(Y) }
                }
            }
        }
      ...
      case 13: {
        ...
        if (veryVerbose) bsl::cout << "\tTesting CustomizedString from string"
                                   << bsl::endl;
        {
            typedef test::CustomizedString Type;
            const bsl::string DATA[] = { "", "a", "bc", "def", "ghij",
                                         "klmno" };
            const int  NUM_DATA = sizeof DATA / sizeof *DATA;
            for (int bdemVersion = 1; bdemVersion <= 2; ++bdemVersion) {
                for (int i = 0; i < NUM_DATA; ++i) {
                    ...
                    bdlmxxx::BdemEncoderOptions options;
                    options.setBdemVersion(bdemVersion);
                    bsl::string mX = DATA[i];  const bsl::string& X = mX;
                    LOOP2_ASSERT(bdemVersion, i,
                                 Encoder::encode(outStream, X, options));
                    LOOP2_ASSERT(bdemVersion, i, outStream);
                    if (veryVerbose) { P(outStream.length())  P(X) }
                    ...
                    LOOP2_ASSERT(bdemVersion, i,
                                 inStream.cursor() == outStream.length());
                    LOOP2_ASSERT(bdemVersion, i, Type(X) == Y);
                    if (veryVerbose) { P(inStream.cursor())  P(Y) }
                }
            }
        }
        ...
        {
            typedef test::CustomizedString Type;
            const bsl::string DATA[]   = { "abcdef", "ghijklm", "nopqrest" };
            const int         NUM_DATA = sizeof DATA / sizeof *DATA;
            for (int bdemVersion = 1; bdemVersion <= 2; ++bdemVersion) {
                for (int i = 0; i < NUM_DATA; ++i) {
                    bdlxxxx::ByteOutStreamRaw   outStream(buffer, BUFSIZE);
      ...
      case 11: {
        ...
        if (veryVerbose) bsl::cout << "\tTesting MyEnumeration from int"
                                   << bsl::endl;
        {
            typedef test::MyEnumeration Wrapper;
            typedef Wrapper::Value      Type;
            const int DATA[]   = { Wrapper::VALUE1, Wrapper::VALUE2 };
            const int NUM_DATA = sizeof DATA / sizeof *DATA;
            for (int bdemVersion = 1; bdemVersion <= 2; ++bdemVersion) {
                for (int i = 0; i < NUM_DATA; ++i) {
                    bdlxxxx::ByteOutStreamRaw   outStream(buffer, BUFSIZE);
                                   ...
                                   << "(bad data)" << bsl::endl;
        {
            typedef test::MyEnumeration Wrapper;
            typedef Wrapper::Value      Type;
            const int DATA[]   = { 343, 2432, 908, -334 };
            const int NUM_DATA = sizeof DATA / sizeof *DATA;
            for (int bdemVersion = 1; bdemVersion <= 2; ++bdemVersion) {
                for (int i = 0; i < NUM_DATA; ++i) {
                    bdlxxxx::ByteOutStreamRaw   outStream(buffer, BUFSIZE);
      ...
      case 9: {
                                   ...
                                   << bsl::endl;
        {
            ...
            for (int bdemVersion = 1; bdemVersion <= 2; ++bdemVersion) {
                ...
                decodeOpts.setBdemVersion(bdemVersion);
                Type mY; const Type& Y = mY;
                mY.makeSelection1(123);
                LOOP_ASSERT(bdemVersion,
                            Decoder::decode(inStream, &mY, decodeOpts));
                LOOP_ASSERT(bdemVersion,
                            inStream.cursor() == outStream.length());
                LOOP_ASSERT(bdemVersion, X == Y);
                if (veryVerbose) { P(inStream.cursor())  P(Y) }
            }
        }
      ...
      case 7: {
        ...
        if (veryVerbose) bsl::cout << "\tTesting MySequence" << bsl::endl;
        {
            ...
            for (int ti = 0; ti < NUM_DATA; ++ti) {
                ...
                bdlxxxx::ByteInStreamRaw    inStream(buffer, BUFSIZE);
                bdlmxxx::BdemDecoderOptions decodeOpts;
                decodeOpts.setBdemVersion(VERSION);
                Type mY; const Type& Y = mY;
                LOOP_ASSERT(LINE, X != Y);
                LOOP_ASSERT(LINE, Decoder::decode(inStream, &mY, decodeOpts));
      ...
      case 4: {
                                   ...
                                   << bsl::endl;
        {
            ...
            for (int ti = 0; ti < NUM_DATA; ++ti) {
                ...
                Type mY;  const Type& Y = mY;
                bdlxxxx::ByteInStreamRaw inStream(buffer, BUFSIZE);
                LOOP_ASSERT(ti, Decoder::decode(inStream, &mY));
      ...
      case 3: {
        ...
        if (veryVerbose) bsl::cout << "\tTesting 'bool'" << bsl::endl;
        {
            ...
            for (int ti = 0; ti < NUM_DATA; ++ti) {
                ...
                LOOP_ASSERT(LINE, X != Y);
                LOOP_ASSERT(LINE, Decoder::decode(inStream, &mY));
                LOOP_ASSERT(LINE, inStream.cursor() == outStream.length());
                LOOP_ASSERT(LINE, X == Y);
                if (veryVerbose) { P(inStream.cursor())  P(Y) }
            }
      ...
      case 2: {
        ...
        {
            typedef bsl::vector<bdlt::Datetime> Type;  // 'bdem' element type
                                                      // 'DATETIME_ARRAY'
            typedef             bdlt::Datetime  EType;
            const int SIZES[]  = { 0, 1, 2, 3, 5 };
            const int NUM_DATA = sizeof SIZES / sizeof *SIZES;
            int tvi = 0;  // test value index
            for (int ti = 0; ti < NUM_DATA; ++ti) {
        ...
        {
            typedef bsl::vector<bdlt::Date> Type;  // 'bdem' element type
                                                  // 'DATE_ARRAY'
            typedef             bdlt::Date  EType;
            const int SIZES[]  = { 0, 1, 2, 3, 5 };
            const int NUM_DATA = sizeof SIZES / sizeof *SIZES;
            int tvi = 0;  // test value index
            for (int ti = 0; ti < NUM_DATA; ++ti) {
        ...
        {
            typedef bsl::vector<bdlt::Time> Type;  // 'bdem' element type
                                                  // 'TIME_ARRAY'
            typedef             bdlt::Time  EType;
            const int SIZES[]  = { 0, 1, 2, 3, 5 };
            const int NUM_DATA = sizeof SIZES / sizeof *SIZES;
            int tvi = 0;  // test value index
            for (int ti = 0; ti < NUM_DATA; ++ti) {
      ...
      case 1: {
        ...
        {
            typedef bdlt::Datetime Type;  // 'bdem' element type 'DATETIME'
            static const struct {
                int d_lineNum;  // source line number
                int d_year;     // value for year
                int d_month;    // value for month
        ...
        {
            typedef bdlt::Date Type;  // 'bdem' element type 'DATE'
            static const struct {
                int d_lineNum;  // source line number
                int d_year;     // value for year
                int d_month;    // value for month
        ...
        {
            typedef bdlt::Time Type;  // 'bdem' element type 'TIME'
            static const struct {
                int d_lineNum;  // source line number
                int d_hour;     // value for hour
                int d_minute;   // value for minute
