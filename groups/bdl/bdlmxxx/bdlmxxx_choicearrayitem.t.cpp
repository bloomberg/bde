// bdlmxxx_choicearrayitem.t.cpp                                      -*-C++-*-
...
// object of any 'bdem' type.  A 'bdlmxxx::ChoiceArrayItem' contains a pointer to
// an externally-managed catalog of type descriptors, along with an index into
// that catalog (the "selector") that specifies which type the 'bdlmxxx::Choice'
// object is currently holding.  The interface to 'bdlmxxx::ChoiceArrayItem' is
// essentially a subset of the interface to 'bdlmxxx::Choice'.  Because the
// descriptor catalog is externally managed, there are no manipulators within
// 'bdlmxxx::ChoiceArrayItem' to change the descriptor catalog (i.e. the
...
//
// MANIPULATORS
// [ 7] bdlmxxx::ElemRef makeSelection(int index)
...
// [ 8] bdlt::Datetime& theModifiableDatetime();
// [ 8] bdlt::DatetimeTz& theModifiableDatetimeTz();
// [ 8] bdlt::Date& theModifiableDate();
// [ 8] bdlt::DateTz& theModifiableDateTz();
// [ 8] bdlt::Time& theModifiableTime();
// [ 8] bdlt::TimeTz& theModifiableTimeTz();
...
// [ 8] bsl::vector<bdlt::Datetime>& theModifiableDatetimeArray();
// [ 8] bsl::vector<bdlt::DatetimeTz>& theModifiableDatetimeTzArray();
// [ 8] bsl::vector<bdlt::Date>& theModifiableDateArray();
// [ 8] bsl::vector<bdlt::DateTz>& theModifiableDateTzArray();
// [ 8] bsl::vector<bdlt::Time>& theModifiableTimeArray();
// [ 8] bsl::vector<bdlt::TimeTz>& theModifiableTimeTzArray();
// [ 8] bdlmxxx::List& theModifiableList();
// [ 8] bdlmxxx::Table& theModifiableTable();
// [ 8] bdlmxxx::Choice& theModifiableChoice();
// [ 8] bdlmxxx::ChoiceArray& theModifiableChoiceArray();
// [11] void reset();
...
// [ 8] const bdlt::Datetime& theDatetime() const;
// [ 8] const bdlt::DatetimeTz& theDatetimeTz() const;
// [ 8] const bdlt::Date& theDate() const;
// [ 8] const bdlt::DateTz& theDateTz() const;
// [ 8] const bdlt::Time& theTime() const;
// [ 8] const bdlt::TimeTz& theTimeTz() const;
...
// [ 8] const bsl::vector<bdlt::Datetime>& theDatetimeArray() const;
// [ 8] const bsl::vector<bdlt::DatetimeTz>& theDatetimeTzArray() const;
// [ 8] const bsl::vector<bdlt::Date>& theDateArray() const;
// [ 8] const bsl::vector<bdlt::DateTz>& theDateTzArray() const;
// [ 8] const bsl::vector<bdlt::Time>& theTimeArray() const;
// [ 8] const bsl::vector<bdlt::TimeTz>& theTimeTzArray() const;
// [ 8] const bdlmxxx::List& theList() const;
// [ 8] const bdlmxxx::Table& theTable() const;
// [ 8] const bdlmxxx::Choice& theChoice() const;
// [ 8] const bdlmxxx::ChoiceArray& theChoiceArray() const;
...
// USAGE EXAMPLE
//
// 'bdlmxxx::ChoiceArrayItem' free operators
// [ 5] bool operator==(const bdlmxxx::ChoiceArrayItem& lhs,
//                      const bdlmxxx::ChoiceArrayItem& rhs);
// [ 5] bool operator!=(const bdlmxxx::ChoiceArrayItem& lhs,
//                      const bdlmxxx::ChoiceArrayItem& rhs);
...
typedef bdlmxxx::ChoiceArrayItem                 Obj;

typedef bdlmxxx::ChoiceHeader                    CHead;
typedef bdlmxxx::ChoiceHeader::DescriptorCatalog DescCatalog;
...
class Choice {
    ...
    friend bool operator==(const Choice& lhs,
                           const Choice& rhs);
  public:
    // CREATORS
    Choice();
    Choice(const EType::Type types[], int numTypes);
...
Choice::Choice(const EType::Type types[], int numTypes)
: d_choiceImp(types,
              numTypes,
...
// 'bdlmxxx::ChoiceHeader' objects, which are cast to 'bdlmxxx::ChoiceArrayItem'
// on access.
...
#       define TEST_THEMODIFIABLE2(TYPE, DESC, NR)                      \
        ...
        TEST_THEMODIFIABLE2(List, &bdlmxxx::ListImp::s_listAttr, 20);
        TEST_THEMODIFIABLE2(Table, &bdlmxxx::TableImp::s_tableAttr, 21);
        TEST_THEMODIFIABLE2(Choice, &bdlmxxx::ChoiceImp::s_choiceAttr, 30);
        TEST_THEMODIFIABLE2(ChoiceArray,
                                  &bdlmxxx::ChoiceArrayImp::s_choiceArrayAttr, 31);
...
#       undef TEST_THEMODIFIABLE2
      ...
      case 8: {
        ...
        //   bdlmxxx::List& theModifiableList();
        //   bdlmxxx::Table& theModifiableTable();
        //   bdlmxxx::Choice& theModifiableChoice();
        //   bdlmxxx::ChoiceArray& theModifiableChoiceArray();
...
#       define TEST_THEMODIFIABLE4(TYPE, DESC, NR)                      \
        ...
        TEST_THEMODIFIABLE4(List, &bdlmxxx::ListImp::s_listAttr, 20);
        TEST_THEMODIFIABLE4(Table, &bdlmxxx::TableImp::s_tableAttr, 21);
        TEST_THEMODIFIABLE4(Choice, &bdlmxxx::ChoiceImp::s_choiceAttr, 30);
...
#       undef TEST_THEMODIFIABLE4
        ...
        for (int i = 0; i < 4; ++i) {
            ...
            for (int j = 0; j < NUM_DATA; ++j) {
                ...
                BSLMA_TESTALLOCATOR_EXCEPTION_TEST_BEGIN(testAllocator) {
                  bdlma::SequentialAllocator  seqAllocator(&testAllocator);
                  ...
                  for (int k = 0; k < NUM_DATA; ++k) {
                      ...
                      bdlmxxx::ElemRef XELEM = X.makeSelection(j - 1);
                      ...
                      if (EType::BDEM_VOID == KTYPE) {
                          bdlmxxx::ElemRef AELEM = X.makeSelection(k - 1);
                      ...
                      const bdlmxxx::ElemRef      EREF_A(const_cast<void *>(VAL_A),
                                                     KDESC);
                      const bdlmxxx::ConstElemRef CEREF_A(VAL_A, KDESC);

                      const bdlmxxx::ElemRef      EREF_B(const_cast<void *>(VAL_B),
                                                     KDESC);
                      const bdlmxxx::ConstElemRef CEREF_B(VAL_B, KDESC);
                      ...
                      const bdlmxxx::ElemRef      EREF_N(const_cast<void *>(VAL_N),
                                                     KDESC,
                                                     &nullBit, 0);
                      const bdlmxxx::ConstElemRef CEREF_N(VAL_N, KDESC,
                                                      &NULLBIT, 0);
                      ...
                      bdlmxxx::ElemRef BELEM = X.makeSelection(k - 1);
      ...
      case 6: {
        ...
        //   operator>>(bdlxxxx::InStream&, bdlmxxx::Choice&);
        //   operator<<(bdlxxxx::OutStream&, const bdlmxxx::Choice&);
        // --------------------------------------------------------------------
        ...
        for (int VERSION = 1; VERSION < MAX_VERSION; ++VERSION) {
            for (int i1 = 0; i1 < NUM_DATA; ++i1) {
                ...
                for (int j1 = 0; j1 < LEN1; ++j1) {
                    ...
                    bdlxxxx::TestOutStream os1(&alloc1);
                    bdlxxxx::TestOutStream os2(&alloc1);
                    ...
                    // Stream from an empty and invalid stream
                    {
                        ...
                        bdlxxxx::TestInStream is1(&tmpAlloc);  // Empty stream
                        bdlxxxx::TestInStream is2(&tmpAlloc);  // Empty stream
                        ...
                        bdlxxxx::TestInStream is3(os2.data(),
                                              os2.length(),
                                              &tmpAlloc);
                        is3.invalidate();  // Invalid stream
                        bdlxxxx::TestInStream is4(os2.data(),
                                              os2.length(),
                                              &tmpAlloc);
                    ...
                    // Stream an empty obj to a constructed obj
                    {
                        ...
                        bdlxxxx::TestOutStream os1(&tmpAlloc);
                        bdlxxxx::TestOutStream os2(&tmpAlloc);
      ...
      case 5: {
        ...
        //
        // Testing:
        //   operator==(const bdlmxxx::ChoiceArrayItem&,
      ...
      case 3: {
        ...
        //
        // Concerns:
        //   We are able to cast to a 'bdlmxxx::ChoiceArrayItem' from a
        //   'bdlmxxx::ChoiceHeader' object and put it into any legal state.
        //   Need to cast because the (de)constructor(s) for
        //   'bdlmxxx::ChoiceArrayItem' are private and not implemented.
        //   We are not concerned in this test about trying to move the object
        //   from one state to another.
        //
        // Plan:
        //   A 'bdlmxxx::ChoiceArrayItem' object can be put into any state using
...

        {
          for (int j = 0; j < NUM_DATA; ++j) {
            ...
            for (int k = 0; k < LEN; ++k) {
              ...
              const bdlmxxx::ElemRef      EREF_A(const_cast<void *>(VAL_A), DESC);
              const bdlmxxx::ConstElemRef CEREF_A(VAL_A, DESC);

              const bdlmxxx::ElemRef      EREF_B(const_cast<void *>(VAL_B), DESC);
              const bdlmxxx::ConstElemRef CEREF_B(VAL_B, DESC);

              const bdlmxxx::ElemRef      EREF_N(const_cast<void *>(VAL_N), DESC);
              const bdlmxxx::ConstElemRef CEREF_N(VAL_N, DESC);

              int nullBits = 1;
              const bdlmxxx::ElemRef      EREF_NN(const_cast<void *>(VAL_N),
                                              DESC,
                                              &nullBits, 0);
              const bdlmxxx::ConstElemRef CEREF_NN(VAL_N, DESC, &nullBits, 0);
      ...
      case 1: {
        ...
        //   bdlmxxx::ChoiceArrayItem object are as expected, check that memory is
