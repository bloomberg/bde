...
//                                 Overview
//                                 --------
// This component exposes three classes, 'bdlmxxx::FieldDef', 'bdlmxxx::RecordDef', and
// 'bdlmxxx::Schema', to implement the "schema" (logical) object.  Since only
// 'bdlmxxx::Schema' has public constructors, the test strategy is similar to that
...
// highest-level (true 'bdlmxxx::Schema' methods) in case 4 to lowest-level
// ('bdlmxxx::FieldDef' methods) in case 8 because, given a schema (the only
...
//     'bdlmxxx::Schema::createRecord'
//     'bdlmxxx::RecordDef::appendField'
// Because of the way that 'bdlmxxx::Schema' is implemented, there is no (untested,
...
//
//-----------------------------------------------------------------------------
// 'bdlmxxx::FieldSpec' public interface:
// [16] bdlmxxx::FieldSpec(EType type, const bdlmxxx::RecordDef *c=0, *ba=0);
// [17] bdlmxxx::FieldSpec(EType type, *c, formattingMode, isNullable, *ba=0);
// [22] bdlmxxx::FieldSpec(const bdlmxxx::FieldSpec& original, *ba=0);
// [16] ~bdlmxxx::FieldSpec();
//
// [20] bdlmxxx::FieldSpec& operator=(const bdlmxxx::FieldSpec& rhs);
// [16] bdlmxxx::ElemRef defaultValue();
// [21] int reset(EType type, const bdlmxxx::RecordDef *c=0);
// [21] int reset(EType type, *c, formattingMode, isNullable);
// [21] int setConstraint(const bdlmxxx::RecordDef *constraint);
// [21] int setFormattingMode(int formattingMode);
// [21] int setIsNullable(bool isNullable);
//
// [16] const bdlmxxx::RecordDef *recordConstraint() const;
// [16] bdlmxxx::ConstElemRef defaultValue() const;
...
//
// [19] operator==(const bdlmxxx::FieldSpec& lhs, const bdlmxxx::FieldSpec& rhs);
// [19] operator!=(const bdlmxxx::FieldSpec& lhs, const bdlmxxx::FieldSpec& rhs);
//-----------------------------------------------------------------------------
// 'bdlmxxx::FieldDef' private methods (tested indirectly):
// [ 2] bdlmxxx::FieldDef(*name, int id, const bdlmxxx::FieldSpec&, *ba);
// [ 2] ~bdlmxxx::FieldDef();
// [ ?] int setIsNullable(bool isNullable);
// [25] int fieldId() const;
// [ 7] const char *fieldName() const;
//
// 'bdlmxxx::FieldDef' public interface:
// [ 9] const bdlmxxx::RecordDef *recordConstraint() const;
// [22] bdlmxxx::ConstElemRef defaultValue() const;
// [ 9] EType elemType() const;
// [24] const bdlmxxx::FieldSpec& fieldSpec() const;
// [24] int formattingMode() const;
// [24] bool hasDefaultValue() const;
// [24] bool isNullable() const;
//
// [ 9] operator==(const bdlmxxx::FieldDef& lhs, const bdlmxxx::FieldDef& rhs);
// [ 9] operator!=(const bdlmxxx::FieldDef& lhs, const bdlmxxx::FieldDef& rhs);
//-----------------------------------------------------------------------------
// 'bdlmxxx::EnumerationDef' private methods (tested indirectly):
// [ 2] bdlmxxx::EnumerationDef(Schema *, index, *name, *writeOnceAllocator);
// [ 2] ~bdlmxxx::EnumerationDef();
...
//
// 'bdlmxxx::EnumerationDef' public interface:
...
// [ 6] static bool canHaveEnumConstraint(bdlmxxx::ElemType::Type type);
...
// [ 6] const bdlmxxx::Schema& schema() const;
//
//-----------------------------------------------------------------------------
// 'bdlmxxx::RecordDef' private methods (tested indirectly):
// [ 2] bdlmxxx::RecordDef(const Schema *s, index, *name, type, *pool, *ba);
// [ 2] ~bdlmxxx::RecordDef();                // purify
// [  ] STREAM& bdexStreamIn(STREAM& stream, int detailedVersion);
...
// [ 2] bslma::Allocator *writeOnceAllocator() const;
//
// 'bdlmxxx::RecordDef' public interface:
...
// [ 7] const bdlmxxx::FieldDef& field(int index) const;
...
// [ 5] int length() const;
// [ 7] const bdlmxxx::FieldDef *lookupField(const char *name) const;
// [25] const bdlmxxx::FieldDef *lookupField(int id) const;
...
// [ 5] const bdlmxxx::Schema& schema() const;
//-----------------------------------------------------------------------------
// 'bdlmxxx::Schema' private interface (tested indirectly):
// [15] streamInRecordDef(STREAM& stream, *schema, *ba, major, minor);
// [15] int bdexMinorVersion() const;
//
// 'bdlmxxx::Schema' public interface:
// [15] static int maxSupportedBdexVersion();
// [ 2] bdlmxxx::Schema(bslma::Allocator *ba=0);
// [12] bdlmxxx::Schema(const bdlmxxx::Schema& original, *ba=0);
// [ 2] ~bdlmxxx::Schema();                // purify
// [14] bdlmxxx::Schema& operator=(const bdlmxxx::Schema& rhs);
// [26] bdlmxxx::RecordDef *createRecord(bdlmxxx::RecordDef::RecordType type);
// [ 2] bdlmxxx::RecordDef *createRecord(*name=0, type=BDEM_SEQUENCE_RECORD);
// [ 2] bdlmxxx::EnumerationDef *createEnumeration(const char *name = 0);
// [ 2] void removeAll();
// [26] int setRecordName(bdlmxxx::RecordDef *record, const char *name);
...
// [ 4] const bdlmxxx::RecordDef *lookupRecord(const char *name) const;
// [ 4] const bdlmxxx::RecordDef& record(int index) const;
// [ 4] int recordIndex(const char *name) const;
// [ 4] const char *recordName(int index) const;
// [ 4] const bdlmxxx::EnumerationDef *lookupEnumeration(const char *name) const;
// [ 4] const bdlmxxx::EnumerationDef& enumeration(int index) const;
...
//
// [11] bool operator==(const bdlmxxx::Schema& lhs, const bdlmxxx::Schema& rhs);
// [11] bool operator!=(const bdlmxxx::Schema& lhs, const bdlmxxx::Schema& rhs);
// [10] stream& operator<<(ostream& stream, const bdlmxxx::Schema& schema);
//-----------------------------------------------------------------------------
// [ 1] BREATHING TEST
// [ 3] bdlmxxx::Schema& gg(bdlmxxx::Schema *s, const char *spec); (generator function)
// [ 5] const char *recName(const bdlmxxx::RecordDef&);      (test helper function)
// [11] bdlmxxx::Schema g(const char *spec);                   (generator function)
...
void makeDefaultValueUnset(const bdlmxxx::ElemRef& elemRef)
{
    switch (elemRef.type()) {
...
// fields.
      ...
      case 33: {
        ...
        const double unsetBool   = bdltuxxx::Unset<bool>::unsetValue();
        const double unsetInt    = bdltuxxx::Unset<int>::unsetValue();
        const double unsetDouble = bdltuxxx::Unset<double>::unsetValue();
      ...
      case 32: {
        ...
        //    const bdlmxxx::FieldDef *lookupFieldExtended(const char *name) const;
        ...
        for (int i = 0; i < DATA_SIZE; ++i) {
            ...
            const bdlmxxx::RecordDef *recA = schema.lookupRecord("a");
            ASSERT(0 != recA);

            const bdlmxxx::FieldDef *EXPECTED_FLD = (EXPECTED_IDX < 0 ? 0 :
      ...
      case 31: {
        ...
        //
        // Testing:
        //   isSuperset(const bdlmxxx::EnumerationDef& super,
      ...
      case 30: {
        ...
        //
        // Testing:
        //   areEquivalent(const bdlmxxx::EnumerationDef& lhs,
        //                 const bdlmxxx::EnumerationDef& rhs);
        // --------------------------------------------------------------------
        const struct {
          int         d_line;
          const char *d_spec;
      ...
      case 28: {
        ...
        //
        // Testing:
        //  ^bdlmxxx::RecordDef::bdexStreamOut(STREAM& stream, major, minor) const;
      ...
      case 27: {
        ...
        //
        // Testing:
        //   bdlmxxx::EnumerationDef *createEnumeration(const char *name = 0);
        //   int setEnumerationName(bdlmxxx::EnumerationDef *e, const char *name);
        // --------------------------------------------------------------------
      ...
      case 26: {
        ...
        //
        // Testing:
        //   RecordType bdlmxxx::RecordDef::recordType() const;
        //   bdlmxxx::RecordDef *createRecord(bdlmxxx::RecordDef::RecordType type);
        //   bdlmxxx::RecordDef *createRecord(*name=0, type=BDEM_SEQUENCE_RECORD);
        //   int setRecordName(bdlmxxx::RecordDef *record, const char *name);
        // --------------------------------------------------------------------
      ...
      case 25: {
        ...
        //
        // Testing:
        //  ^int bdlmxxx::FieldDef::fieldId() const;
        ...
        //   const bdlmxxx::FieldDef *lookupField(int id) const;
        // --------------------------------------------------------------------
      ...
      case 24: {
        // --------------------------------------------------------------------
        // TESTING 'bdlmxxx::FieldDef' ACCESSORS
        //
        // Concerns:
        //   The 'bdlmxxx::FieldDef' accessors that have analogous accessors in
        //   'bdlmxxx::FieldSpec' return the correct result.
        //
        // Plan:
        //   Using the 'appendField(const FldSpec&)' method, create fields from
        //   various field specs.  Verify that the 'bdlmxxx::FieldDef' accessors
        ...
        //   const bdlmxxx::FieldSpec& fieldSpec() const;
      ...
      case 23: {
        // --------------------------------------------------------------------
        // TESTING 'bdlmxxx::FieldSpec' PRINT METHOD
        //
        // Concerns:
      ...
      case 22: {
        // --------------------------------------------------------------------
        // TESTING 'bdlmxxx::FieldSpec' COPY CONSTRUCTOR
        //
        // Concerns:
        ...
        //
        // Testing:
        //   bdlmxxx::FieldSpec(const bdlmxxx::FieldSpec& original, *ba=0);
        // --------------------------------------------------------------------
      ...
      case 21: {
        // --------------------------------------------------------------------
        // TESTING 'bdlmxxx::FieldSpec' RESET AND SETTER METHODS
        //
        // Concerns:
        ...
        //
        // Testing:
        //   int reset(EType type, const bdlmxxx::RecordDef *c=0);
        //   int reset(EType type, *c, formattingMode, isNullable);
        //   int setConstraint(const bdlmxxx::RecordDef *constraint);
        //   int setFormattingMode(int formattingMode);
        //   int setIsNullable(bool isNullable);
        // --------------------------------------------------------------------

        if (verbose)
            bsl::cout << "\nTesting 'bdlmxxx::FieldSpec' 'reset' & Setter Methods"
                      << "\n================================================="
                      << bsl::endl;
      ...
      case 20: {
        // --------------------------------------------------------------------
        // TESTING 'bdlmxxx::FieldSpec' ASSIGNMENT OPERATOR
        //
        // Concerns:
        ...
        //
        // Testing:
        //   bdlmxxx::FieldSpec& operator=(const bdlmxxx::FieldSpec& rhs);
        // --------------------------------------------------------------------
      ...
      case 19: {
        // --------------------------------------------------------------------
        // TESTING 'bdlmxxx::FieldSpec' EQUALITY OPERATORS
        //
        // Concerns:
        ...
        //
        // Testing:
        //   operator==(const bdlmxxx::FieldSpec& lhs, const bdlmxxx::FieldSpec& rhs);
        //   operator!=(const bdlmxxx::FieldSpec& lhs, const bdlmxxx::FieldSpec& rhs);
        // --------------------------------------------------------------------
      ...
      case 18: {
        // --------------------------------------------------------------------
        // TESTING 'bdlmxxx::FieldSpec' DEFAULT VALUES
        //
        // Concerns:
      ...
      case 17: {
        // --------------------------------------------------------------------
        // TESTING 'bdlmxxx::FieldSpec' FIVE-ARGUMENT CONSTRUCTOR
        //
        // Concerns:
        ...
        //
        // Testing:
        //   bdlmxxx::FieldSpec(EType type, *c, formattingMode, isNullable, *ba=0);
        //   int formattingMode() const;
        //   bool isNullable() const;
        // --------------------------------------------------------------------

        if (verbose)
            bsl::cout << "\nTesting 'bdlmxxx::FieldSpec' 5-Argument Constructor"
                      << "\n==============================================="
                      << bsl::endl;
      ...
      case 16: {
        // --------------------------------------------------------------------
        // TESTING 'bdlmxxx::FieldSpec' THREE-ARGUMENT CONSTRUCTOR
        //
        // Concerns:
        ...
        //
        // Testing:
        //   bdlmxxx::FieldSpec(EType type, const bdlmxxx::RecordDef *c=0, *ba=0);
        //   ~bdlmxxx::FieldSpec();
        ...
        if (verbose)
            bsl::cout << "\nTesting 'bdlmxxx::FieldSpec' 3-Argument Constructor"
                      << "\n==============================================="
                      << bsl::endl;
      ...
      case 15: {
        ...
        //   bdexStreamIn(STREAM& stream, int version);
        //   bdexStreamOut(STREAM& stream, int version) const;
        //   operator>>(STREAM& stream, bdlmxxx::Schema& schema);
        //   operator<<(STREAM& stream, const bdlmxxx::Schema& schema);
        //
        // Note: '^' indicates a private method, which is tested indirectly
        // --------------------------------------------------------------------
        ...
        if (verbose) bsl::cout << "\tOn corrupted data." << bsl::endl;
        {
            ...
            if (verbose) bsl::cout << "\t\tBad record data." << bsl::endl;
            {
                                       ...
                                       << bsl::endl;
                {
                    ...
                    out.putLength(1);             // field count
                    out.putLength(0);             // field name length
                    bdlmxxx::ElemType::bdexStreamOut(out, EType::BDEM_INT, 1);
                                                  // field type
      ...
      case 14: {
        // --------------------------------------------------------------------
        // TESTING 'bdlmxxx::Schema' ASSIGNMENT OPERATOR
        //
        // Concerns:
        ...
        //
        // Testing:
        //   bdlmxxx::Schema& operator=(const bdlmxxx::Schema& rhs);
        // --------------------------------------------------------------------

        if (verbose) bsl::cout << "\nTesting 'bdlmxxx::Schema' 'operator='"
                               << "\n================================="
                               << bsl::endl;
      ...
      case 13: {
        ...
        //
        // Testing:
        //   bdlmxxx::Schema g(const char *spec);              (generator function)
        // --------------------------------------------------------------------
      ...
      case 12: {
        // --------------------------------------------------------------------
        // TESTING 'bdlmxxx::Schema' COPY CONSTRUCTOR
        //
        // Concerns:
        ...
        //
        // Testing:
        //   bdlmxxx::Schema(const bdlmxxx::Schema& original, *ba=0);
        // --------------------------------------------------------------------

        if (verbose) bsl::cout << "\nTesting 'bdlmxxx::Schema' Copy C'tor"
                                  "\n================================"
                               << bsl::endl;
      ...
      case 11: {
        // --------------------------------------------------------------------
        // TESTING 'bdlmxxx::Schema' EQUALITY OPERATORS
        //
        // Concerns:
        //   'operator==' for 'bdlmxxx::Schema' is relatively complex, since a
        ...
        //
        // Testing:
        //   bool operator==(const bdlmxxx::Schema& lhs, const bdlmxxx::Schema& rhs);
        //   bool operator!=(const bdlmxxx::Schema& lhs, const bdlmxxx::Schema& rhs);
        // --------------------------------------------------------------------
      ...
      case 10: {
        ...
        //
        // Testing:
        //  ^bdlmxxx::RecordDef::print(ostream& stream, int level, int spl) const;
        //  ^bdlmxxx::EnumerationDef::print(ostream&
        //                              stream, level, spacesPerLevel) const;
        //   bdlmxxx::Schema::print(ostream& stream, int level, int spl) const;
        //   operator<<(ostream& stream, const bdlmxxx::Schema& schema);
        //
        // Note: '^' indicates a private method, which is tested indirectly
        // --------------------------------------------------------------------

        if (verbose)
            bsl::cout << "\nTesting 'bdlmxxx::Schema' 'operator<<' and 'print'"
                      << "\n=============================================="
                      << bsl::endl;
      ...
      case 9: {
        // --------------------------------------------------------------------
        // TESTING 'bdlmxxx::FieldDef' ACCESSORS CONSTRAINT & ELEMTYPE
        //
        // Concerns:
        //   The 'bdlmxxx::FieldDef' accessors are straightforward, given a valid
        //   field definition.  We are concerned only that they return the
        //   appropriate 'bdlmxxx::FieldDef' data member.  The ('friend') equality
        ...
        //   1) Verify that the 'bdlmxxx::FieldDef' accessors return the expected
        ...
        //   const bdlmxxx::RecordDef *recordConstraint() const;
        //   EType elemType() const;
        //   operator==(const bdlmxxx::FieldDef& lhs, const bdlmxxx::FieldDef& rhs);
        //   operator!=(const bdlmxxx::FieldDef& lhs, const bdlmxxx::FieldDef& rhs);
        // --------------------------------------------------------------------
      ...
      case 8: {
        // --------------------------------------------------------------------
        // TESTING ENUMERATOR-RELATED 'bdlmxxx::EnumerationDef' ACCESSORS
        //
        // Concerns:
                               ...
                               << bsl::endl;
        {
            ...
            ASSERT(bdltuxxx::Unset<int>::unsetValue() == E.lookupId("foo"));
            ASSERT(bdltuxxx::Unset<int>::unsetValue() == E.lookupId("bar"));
      ...
      case 7: {
        // --------------------------------------------------------------------
        // TESTING FIELD-RELATED 'bdlmxxx::RecordDef' ACCESSORS
        //
        // Concerns:
        ...
        //   'bdlmxxx::RecordDef::numFields()' has already been tested in case 5).
        //
        ...
        //      'field' (which return a 'bdlmxxx::FieldDef' pointer and
        ...
        //
        // Testing:
        //   const bdlmxxx::FieldDef& field(int index) const;
        //   const bdlmxxx::FieldDef *lookupField(const char *name) const;
        //   int fieldIndex(const char *name) const;
        //   const char *fieldName(int index) const;
        // --------------------------------------------------------------------

        if (verbose) bsl::cout << bsl::endl
            << "Testing Field-Related 'bdlmxxx::RecordDef' Accessors" << bsl::endl
            << "================================================" << bsl::endl;
      ...
      case 6: {
        // --------------------------------------------------------------------
        // TESTING ENUMERATION-RELATED 'bdlmxxx::EnumerationDef' ACCESSORS
        //
        // Concerns:
        ...
        //   const char *enumName(const bdlmxxx::EnumerationDef&);
        //                                               (test helper function)
        //   static bool canHaveEnumConstraint(bdlmxxx::ElemType::Type type);
        //   int maxId() const;
        ...
        if (verbose)
            bsl::cout << bsl::endl
                      << "Testing Enumeration-related 'bdlmxxx::EnumerationDef' "
                      "Accessors"
                      << bsl::endl
                      << "=================================================="
                      "========="
...

        {
          ...
          ASSERT(bdltuxxx::Unset<int>::unsetValue() == namePair.second);

          bsl::pair<const char *, int> idPair = e1->nextLargerId(0);
          ASSERT(0 == idPair.first);
          ASSERT(bdltuxxx::Unset<int>::unsetValue() == idPair.second);
      ...
      case 5: {
        // --------------------------------------------------------------------
        // TESTING RECORD-RELATED 'bdlmxxx::RecordDef' ACCESSORS
        //
        // Concerns:
        //   Each of the accessors under test directly returns either a data
        //   member, or a single operation or method on a data member, and so
        ...
        //   const bdlmxxx::Schema& schema() const;
        //   const char *recName(const bdlmxxx::RecordDef&); (test helper function)
        // --------------------------------------------------------------------
      ...
      case 4: {
        // --------------------------------------------------------------------
        // TESTING 'bdlmxxx::Schema' ACCESSORS
        //
        // Concerns:
        //   For convenience, the (logical) schema accessors are tested in four
        //   test cases.  The 'bdlmxxx::Schema' accessors are tested first, since
        ...
        //      'record' (which return a 'bdlmxxx::RecordDef' pointer and
        ...
        //   const bdlmxxx::RecordDef *lookupRecord(const char *name) const;
        //   const bdlmxxx::RecordDef& record(int index) const;
        ...
        //   const bdlmxxx::EnumerationDef& enumeration(int index) const;
        ...
        if (verbose) bsl::cout << "\nTesting bdlmxxx::Schema::numRecords()."
                               << bsl::endl;
        {
            static const struct {
                int         d_lineNum;  // source line number
        ...
        if (verbose) bsl::cout << "\nTesting bdlmxxx::Schema::numEnumerations()."
                               << bsl::endl;
        {
            static const struct {
                int         d_lineNum;  // source line number
...
#undef OUT
      ...
      case 3: {
        ...
        //
        // Testing:
        //   bdlmxxx::Schema& gg(bdlmxxx::Schema *s, const char *spec); (generator fnc)
        // --------------------------------------------------------------------
      ...
      case 2: {
        ...
        //   component.
        //
        //   The first concern is that the default 'bdlmxxx::Schema' constructor
        ...
        //
        //   Next, the true 'bdlmxxx::Schema' manipulator 'createRecord', with or
        ...
        //   successfully augmented using the 'bdlmxxx::RecordDef' and
        //   'bdlmxxx::EnumerationDef manipulators.  Finally, 'removeAll' should
        ...
        //         fields using, in turn, each of the 'bdlmxxx::RecordDef' and
        //         'bdlmxxx::EnumerationDef' manipulators.  In particular, attempt
        ...
        //
        // Testing:
        //  ^bdlmxxx::FieldDef(*name, int id, const bdlmxxx::FieldSpec&, *ba);
        //  ^~bdlmxxx::FieldDef();                 // purify
        //
        //  ^bdlmxxx::RecordDef(const Schema *s, index, *name, type, *pool, *ba);
        //  ^~bdlmxxx::RecordDef();                // purify
        ...
        //
        //  ^bdlmxxx::EnumerationDef(const Schema *s, index, *name, woa);
        //  ^~bdlmxxx::EnumerationDef();
        //  ^setEnumerationName();
        //   int addEnumerator(const char *name);
        //   int addEnumerator(const char *name, int id);
        //   void assignAlphabeticalIDs(int firstId = 0);
        //
        //   bdlmxxx::Schema(bslma::Allocator *ba=0);
        //   ~bdlmxxx::Schema();                   // purify
        //   bdlmxxx::RecordDef *createRecord(*name=0, type=BDEM_SEQUENCE_RECORD);
        //   bdlmxxx::EnumerationDef *createEnumeration(const char *name = 0);
        //   void removeAll();
        //
        ...
        if (verbose) bsl::cout << "\nTesting 'bdlmxxx::Schema()' Constructor."
                               << bsl::endl;
        ...
        if (verbose)
                bsl::cout << "\nTesting 'createRecord' and 'bdlmxxx::RecordDef' "
        ...
        if (verbose)
            bsl::cout << "\nTesting 'createEnumeration' and "
                      << "'bdlmxxx::EnumerationDef' constructor."
                      << bsl::endl;
        {
          BSLMA_TESTALLOCATOR_EXCEPTION_TEST_BEGIN(testAllocator) {
            Obj x1(Z);  const Obj& X1 = x1;
          ...
          BSLMA_TESTALLOCATOR_EXCEPTION_TEST_BEGIN(testAllocator) {
            ...
            for (int loop = 0; loop < 2; ++loop) {
                ...
                // Add enumerator at boundaries.
                {
                  ...
                  // 'bdltuxxx::Unset<int>::unsetValue()') unless 'name' is unique
                  // among the enumerators in this enumeration definition,
                  // 'id != bdltuxxx::Unset<int>::unsetValue()', and 'id' is
                  // distinct from any integer ID currently used by an
                  // enumerator in this enumeration.  Here we use 'INT_MIN'
                  // instead of 'bdltuxxx::Unset<int>::unsetValue()' so we must
                  // assert 'bdltuxxx::Unset<int>::unsetValue()' == 'INT_MIN'

                  ASSERT(bdltuxxx::Unset<int>::unsetValue() == INT_MIN);
                  int unsetInt = INT_MAX;
                  ++unsetInt;
                  ASSERT(bdltuxxx::Unset<int>::unsetValue() == unsetInt);
...

                {
                  ...
                  ASSERT(bdltuxxx::Unset<int>::unsetValue() ==
        ...
        if (verbose)
            bsl::cout << "\nTesting appendField and "
                      << "bdlmxxx::FieldDef constructor." << bsl::endl;
        {
          BSLMA_TESTALLOCATOR_EXCEPTION_TEST_BEGIN(testAllocator) {
            Obj x1(Z);  const Obj& X1 = x1;
            // On the first loop, we operate on the new object.  On the
            ...
            for (int loop = 0; loop < 2; ++loop) {
                ...
                // 'bdlmxxx_schema' rejected such forward-use of records.
      ...
      case 1: {
        ...
        //   'bdlmxxx_schema' works properly.  We are also concerned that the
        ...
        //   functionality.
        //
        //   The test cases for 'bdlmxxx::Schema' are slightly more complex
        //   than those for 'bsl::vector<double>', since we need to exercise
        //   'bdlmxxx::RecordDef' and 'bdlmxxx::FieldDef' as well, and neither of
        //   these types can be tested outside of 'bdlmxxx::Schema'.
        //
        ...
        BSLMA_TESTALLOCATOR_EXCEPTION_TEST_BEGIN(testAllocator) {
          ...
          bdlmxxx::EnumerationDef *colors = x1.createEnumeration("COLORS");
          ...
          ASSERT(bdltuxxx::Unset<int>::unsetValue() == colors->lookupId("yellow"));
          ...
          bdlmxxx::EnumerationDef *colors2 = colors;  // Save for later
          ...
          ASSERT(bdltuxxx::Unset<int>::unsetValue() == colors->lookupId("yellow"));
          ASSERT(bdltuxxx::Unset<int>::unsetValue() == colors->lookupId(0));
          ...
          const bdlmxxx::EnumerationDef* x2colors = X2.lookupEnumeration("COLORS");
          ...
          ASSERT(redId == idIter);
          idIter = x2colors->nextLargerId(idIter).second;
          ASSERT(bdltuxxx::Unset<int>::unsetValue() == idIter);
