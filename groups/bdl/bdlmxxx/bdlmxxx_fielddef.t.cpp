...
///- - - - - - - - - - - - - - - - - - - - - - - - - - - -
// The following example demontrates how to create a 'bdlmxxx::FieldDef' in
// isolation -- this is *not* the recommended usage of 'bdlmxxx::FieldDef'.  A
// 'bdlmxxx::FieldDef' is meant to be used in conjuction with the types defined in
// 'bdlmxxx_recorddef', 'bdlmxxx_enumerationdef', and 'bdlmxxx_schema'.  Clients should
// not create a 'bdlmxxx::FieldDef' directly, but obtain one from a
// 'bdlmxxx::RecordDef'.  For the purpose of this usage example, we define dummy
// stand-in types for, 'bdlmxxx::RecordDef, and 'bdlmxxx::EnumerationDef'.  These
...
//..
    ...
    bdlma::SequentialAllocator  seqAllocator;
//
...
//
    bdlmxxx::FieldDef  intField("intField",  0,  intAttr, allocator);
    bdlmxxx::FieldDef listField("listField", 1, listAttr, allocator);
//..
// We now provide constraints for these fields using objects of the dummy
// 'bdlmxxx::RecordDef', and 'bdlmxxx::EnumerationDef' types defined above.  Clients
// of 'bdem' should refer to the documentation of 'bdlmxxx_schema' and
// 'bdlmxxx_recorddef' for more information on field constraints.
//..
    bdlmxxx::Schema         schema;
    bdlmxxx::EnumerationDef enumerationDef(&schema, 0, "enum", &seqAllocator);
    bdlmxxx::RecordDef      recordDef;
//
