...
//                          *** Overview ***
//
// 'bdlmxxx::TableImp' provides the innards of a bdem_Table.  It has most, but
// not all, of the manipulators and accessors of bdlmxxx::Table, especially
...
// behavior.
//
// Note that since this component is at a lower level than 'bdlmxxx::List' or
// 'bdlmxxx::Table' we do not do any testing of 'bdlmxxx::TableImp's that contain
// aggregate types.
//
// Much of the behavior is supported by 'bdlmxxx::RowData', which is beneath this
// component.  It is assumed in these tests that 'bdlmxxx::RowData' is tested
// and sound.
//
...
//
////CREATORS
// [ 2] bdlmxxx::TableImp(allocMode, Z)
// [ 2] reset(elemTypes[], numElements, attrLookupTbl)
// [ 2] bdlmxxx::TableImp(allocMode, initialMemory, Z)
// [ 2] bdlmxxx::TableImp(elemTypes[], numElements, attrLookupTbl, allocMode, Z)
// [ 2] bdlmxxx::TableImp(elemTypes[], numElements, attrLookupTbl, allocMode,
//                                                            initialMemory, Z)
// [ 2] bdlmxxx::TableImp(rowDef&, allocMode, Z)
// [ 2] bdlmxxx::TableImp(rowDef&, allocMode, initialMemory, Z)
// [ 2] bdlmxxx::TableImp(original&, allocMode, Z)
// [ 2] bdlmxxx::TableImp(original&, allocMode, initialMemory, Z)
// [ 2] ~bdlmxxx::TableImp()
//
////MANIPULATORS
// [ 7] insertRow()
...
// [13] bdlmxxx::TableImp_enableGeometricMemoryGrowth()
// [13] bdlmxxx::TableImp_disableGeometricMemoryGrowth()
...
static const char        UNSET_CHAR   = bdltuxxx::Unset<char>::unsetValue();
...
// so 'bdlmxxx::TableImp's can be printed out by LOOP_ASSERT
...
static
bdlmxxx::ConstElemRef getElemRef(const bdlmxxx::TableImp& table, int row, int col) {
    const bdlmxxx::RowData *TRH = &table.theRow(row);
...
// helps make up for the lack of 'operator[]'
static
bdlmxxx::ElemRef getModElemRef(bdlmxxx::TableImp *table, int row, int col) {
    bdlmxxx::RowData& trh = table->theModifiableRow(row);

    return trh.elemRef(col);
}

bool compareTablesWithoutNullnessBits(const bdlmxxx::TableImp& lhs,
                                      const bdlmxxx::TableImp& rhs)
    ...
    // equal and 'false' otherwise.
{
    ...
    for (int i = 0; i < numRows; ++i) {
        const bdlmxxx::RowData& lhsRowHdr = lhs.theRow(i);
        const bdlmxxx::RowData& rhsRowHdr = rhs.theRow(i);
        for (int j = 0; j < numCols; ++j) {
            const bdlmxxx::Descriptor *lhsDesc =
                                      (*lhsRowHdr.rowLayout())[j].attributes();
            const bdlmxxx::Descriptor *rhsDesc =
                                      (*rhsRowHdr.rowLayout())[j].attributes();
            if (lhsDesc != rhsDesc) {
                return false;                                         // RETURN
            }

            const bdlmxxx::ConstElemRef  lhsERef = lhsRowHdr.elemRef(j);
            const bdlmxxx::ConstElemRef  rhsERef = rhsRowHdr.elemRef(j);
...
static
void fillTable(bdlmxxx::TableImp *table, int pattern) {
...
int main(int argc, char *argv[])
{
    ...
    const bdlmxxx::Descriptor* ATTR_LOOKUP_TBL[] = {
    ...
    bdlmxxx::DescriptorStreamIn<In> STREAMIN_TABLE_TEST[] = {
    ...
    typedef bdlxxxx::ByteInStream In2;
    bdlmxxx::DescriptorStreamIn<In2> STREAMIN_TABLE_BYTE[] = {
        { &bdlmxxx::FunctionTemplates::streamInFundamental<char,In2> },
        { &bdlmxxx::FunctionTemplates::streamInFundamental<short,In2> },
        { &bdlmxxx::FunctionTemplates::streamInFundamental<int,In2> },
        { &bdlmxxx::FunctionTemplates::
                                 streamInFundamental<bsls::Types::Int64,In2> },
        { &bdlmxxx::FunctionTemplates::streamInFundamental<float,In2> },
        { &bdlmxxx::FunctionTemplates::streamInFundamental<double,In2> },
        { &bdlmxxx::FunctionTemplates::streamInFundamental<bsl::string,In2> },
        { &bdlmxxx::FunctionTemplates::streamIn<bdlt::Datetime,In2> },
        { &bdlmxxx::FunctionTemplates::streamIn<bdlt::Date,In2> },
        { &bdlmxxx::FunctionTemplates::streamIn<bdlt::Time,In2> },
        { &bdlmxxx::FunctionTemplates::streamInArray<char,In2> },
        { &bdlmxxx::FunctionTemplates::streamInArray<short,In2> },
        { &bdlmxxx::FunctionTemplates::streamInArray<int,In2> },
        { &bdlmxxx::FunctionTemplates::streamInArray<bsls::Types::Int64,In2> },
        { &bdlmxxx::FunctionTemplates::streamInArray<float,In2> },
        { &bdlmxxx::FunctionTemplates::streamInArray<double,In2> },
        { &bdlmxxx::FunctionTemplates::streamInArray<bsl::string,In2> },
        { &bdlmxxx::FunctionTemplates::streamInArray<bdlt::Datetime,In2> },
        { &bdlmxxx::FunctionTemplates::streamInArray<bdlt::Date,In2> },
        { &bdlmxxx::FunctionTemplates::streamInArray<bdlt::Time, In2> }
    };

    typedef bdlxxxx::TestOutStream Out;
    bdlmxxx::DescriptorStreamOut<Out> STREAMOUT_TABLE_TEST[] = {
    ...
    typedef bdlxxxx::ByteOutStream Out2;
    bdlmxxx::DescriptorStreamOut<Out2> STREAMOUT_TABLE_BYTE[] = {
        { &bdlmxxx::FunctionTemplates::streamOutFundamental<char,Out2> },
        { &bdlmxxx::FunctionTemplates::streamOutFundamental<short,Out2> },
        { &bdlmxxx::FunctionTemplates::streamOutFundamental<int,Out2> },
        { &bdlmxxx::FunctionTemplates::
                               streamOutFundamental<bsls::Types::Int64,Out2> },
        { &bdlmxxx::FunctionTemplates::streamOutFundamental<float,Out2> },
        { &bdlmxxx::FunctionTemplates::streamOutFundamental<double,Out2> },
        { &bdlmxxx::FunctionTemplates::streamOutFundamental<bsl::string,Out2> },
        { &bdlmxxx::FunctionTemplates::streamOut<bdlt::Datetime,Out2> },
        { &bdlmxxx::FunctionTemplates::streamOut<bdlt::Date,Out2> },
        { &bdlmxxx::FunctionTemplates::streamOut<bdlt::Time,Out2> },
        { &bdlmxxx::FunctionTemplates::streamOutArray<char,Out2> },
        { &bdlmxxx::FunctionTemplates::streamOutArray<short,Out2> },
        { &bdlmxxx::FunctionTemplates::streamOutArray<int,Out2> },
        { &bdlmxxx::FunctionTemplates::streamOutArray<bsls::Types::Int64,Out2> },
        { &bdlmxxx::FunctionTemplates::streamOutArray<float,Out2> },
        { &bdlmxxx::FunctionTemplates::streamOutArray<double,Out2> },
        { &bdlmxxx::FunctionTemplates::streamOutArray<bsl::string,Out2> },
        { &bdlmxxx::FunctionTemplates::streamOutArray<bdlt::Datetime,Out2> },
        { &bdlmxxx::FunctionTemplates::streamOutArray<bdlt::Date,Out2> },
        { &bdlmxxx::FunctionTemplates::streamOutArray<bdlt::Time, Out2> }
    };
#endif
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      case 13: {
        ...
        //:   'bdem::TableImp_disableGeometricMemoryGrowth' and verify that the
        //:    memory does not grow geometrically for progressive insertions.
        //:    [C-1,3,5]
        //: 3 Enable geometric growth with
        //:   'bdem::TableImp_enableGeometricMemoryGrowth' and verify that
        ...
        //
        //  Testing:
        //    bdlmxxx::TableImp_enableGeometricMemoryGrowth();
                ...
                for (int j = 1; j <= MAX_NUM_ROWS; j <<= 1) {
                    ...
                    if (veryVerbose) {  P(i) P_(j) }
                     ...
                     if (BDEM_PASS_THROUGH == STRATEGY) {
                         ...
                         // Add extra memory for Pass Through - 'bdlmxxx::RowData'
...
// TBD: Uncomment
        ...
        for (int i = 0; i < DATA_LEN; ++i) {
            ...
            for (int len = 0; len <= LENGTH; ++len) {
                bdlxxxx::ByteInStream testInStream(STREAM_DATA, len);
                ASSERT(testInStream);
            ...
            for (int rows = 0;
                ...
                for (int cols = 0;
                    ...
                    for (int pattern = 0; pattern < 4; ++pattern) {
                        ...
                        bdlxxxx::TestInStream testInStream(DATA, LENGTH);
      ...
      case 7: {
        ...
        bdlmxxx::ElemType::Type COL_TYPES[] = {
            ET::BDEM_INT, ET::BDEM_STRING, ET::BDEM_CHAR
        };
        ...
        bdlmxxx::RowLayout rowLayout(COL_TYPES,
                                 COL_TYPES_LEN,
                                 ATTR_LOOKUP_TBL,
                                 Z);
        bdlmxxx::RowData  rowData(&rowLayout, BDEM_PASS_THROUGH, Z);
        ...
        for (int row = 0; row < 3; ++row) {
            const bdlmxxx::RowData& TRH = T1.theRow(row);
        ...
        for (int row = 0; row < 3; ++row) {
            const bdlmxxx::RowData& TRH = T2.theRow(row);
            ASSERT(TRH.elemRef(0).type() == ET::BDEM_INT);
            ASSERT(TRH.elemRef(1).type() == ET::BDEM_STRING);
            ASSERT(TRH.elemRef(2).type() == ET::BDEM_CHAR);
      ...
      case 4: {
        ...
        //    has been allocated.  Note that a 'bdlmxxx::TableImp' allocates
        ...
        if (verbose) cout << "With copy ctor.\n";
        {
            ...
            {
                bslma::TestAllocator allocator;
                Obj original(bdlmxxx::AggregateOption::BDEM_PASS_THROUGH,
                             &allocator);
        ...
        if (verbose) cout << "With row def.\n";
        {
            if (veryVerbose) cout << "\tUsing 'BDEM_WRITE_ONCE'.\n";
            {
                ...
                bdlmxxx::RowData   rowData(&rowLayout,
                                       BDEM_PASS_THROUGH,
                                       &allocator);
      ...
      case 3: {
        ...
        bdlmxxx::RowLayout rowLayout(COL_TYPES,
                                 ...
                                 ATTR_LOOKUP_TBL,
                                 Z1);
        bdlmxxx::RowData rowData(&rowLayout, BDEM_PASS_THROUGH, Z1);
        rowData.setValue(0, &INT_VALUE1);;
        rowData.setValue(1, &STRING_VALUE1);;
        ...
        bdlmxxx::RowData& trh1 = t1.theModifiableRow(0);
        ...
        bdlmxxx::RowData& trh2 = t2.theModifiableRow(0);
        ...
        // are not equal
        bdlmxxx::ElemType::Type COL_TYPES2[] = { ET::BDEM_INT, ET::BDEM_STRING };
      ...
      case 2: {
        ...
        //
        // Testing:
        //   bdlmxxx::TableImp(allocMode, Z)
        //   reset(elemTypes[], numElements, attrLookupTbl)
        //   bdlmxxx::TableImp(allocMode, initialMemory, Z)
        //   bdlmxxx::TableImp(elemTypes[], numElements, attrLookupTbl,allocMode,Z)
        //   bdlmxxx::TableImp(elemTypes[], numElements, attrLookupTbl, allocMode,
        //                                                    initialMemory, Z)
        //   bdlmxxx::TableImp(rowDef&, allocMode, Z)
        //   bdlmxxx::TableImp(rowDef&, allocMode, initialMemory, Z)
        //   bdlmxxx::TableImp(original&, allocMode, Z)
        //   bdlmxxx::TableImp(original&, allocMode, initialMemory, Z)
        //   ~bdlmxxx::TableImp()
        //--------------------------------------------------------------------
        ...
        for (int i = 0; i < DATA_LEN; ++i) {
            ...
            for (int ctor = 0; !leave; ++ctor) {
                ...
                const bdlmxxx::RowLayout rowLayout(COL_TYPES,
                                               COL_TYPES_LEN,
                                               ATTR_LOOKUP_TBL,
                                               Z);
                bdlmxxx::RowData rowData(&rowLayout, BDEM_PASS_THROUGH, Z);
                ...
                bdlmxxx::RowData& trh = pObj->theModifiableRow(0);
      ...
      case 1: {
        ...
        // BREATHING TEST
        // Concerns:
        //   We are concerned that the basic functionality of 'bdlmxxx::TableImp'
        //   works properly.
        //
        // Plan:
