...
#include <bdlmxxx_choicearrayimp.h>          // for dummy bdlmxxx::ChoiceArray
#include <bdlmxxx_choicearrayitem.h>         // used by choicearray
#include <bdlmxxx_choiceimp.h>               // for dummy bdlmxxx::Choice
#include <bdlmxxx_elemattrlookup.h>          // for dummy bdlmxxx::Table
#include <bdlmxxx_row.h>                     // used by list and table
#include <bdlmxxx_tableimp.h>                // for dummy bdlmxxx::Table
...
//                          *** Overview ***
//
// With its nearly 200 methods, the 'bdlmxxx::List' class serves as the
// presentation view for 'bdem' list functionality, and "knows about" all
// 'bdem' element types.  As part of its contract, 'bdlmxxx::List' contains exactly
// one data member of type 'bdlmxxx::ListImp' -- hence it is possible to cast
// safely from one list type (address) to the other.  Although 'bdlmxxx::List' is
// a fully value-semantic class, all of the substantive implementation reides
// in 'bdlmxxx::ListImp', which in turn resides in a separate (lower-level)
// component.
//
...
// of 'bdlmxxx::Table' (implemented in terms of 'bdlmxxx::TableImp'); i.e.,
// 'bdlmxxx_list.t.cpp' will NOT depend on 'bdlmxxx_table', leaving open the
// possibility that 'bdlmxxx_table.t.cpp' (and therefore -- by fiat --  also
// 'bdlmxxx_table.cpp') to depend on 'bdlmxxx_list.h' just as 'bdlmxxx_list.t.cpp (and
// therefore -- by fiat -- also 'bdlmxxx_list.cpp') currently depends on
// 'bdlmxxx::Row'.
//
//       Primary Constructors, Primary Manipulators, and Basic Accessors
//       ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
// Primary Constructors:
//   A 'bdlmxxx::List' is created with an allocation mode and an allocator,
...
//   'bdlmxxx_listimp' component.  The default constructor, therefore will be
//   sufficient for our purposes here.
//
//    o bdlmxxx::List(bslma::Allocator *basicAllocator = 0);
//
...
//   such have already been tested thoroughly (in 'bdlmxxx_listimp'), it will
...
//   (const bdlmxxx::Row&) are only conveniences and are not necessary):
//
...
//    o void appendDatetime(const bdlt::Datetime& value);
//    o void appendDatetime(const bdlt::Datetime& value);
//    o void appendDate(const bdlt::Date& value);
//    o void appendDate(const bdlt::Date& value);
//    o void appendTime(const bdlt::Time& value);
//    o void appendTime(const bdlt::Time& value);
...
//    o void appendDatetimeArray(const bsl::vector<bdlt::Datetime>& value);
//    o void appendDatetimeArray(const bsl::vector<bdlt::Datetime>& value);
//    o void appendDateArray(const bsl::vector<bdlt::Date>& value);
//    o void appendDateArray(const bsl::vector<bdlt::Date>& value);
//    o void appendTimeArray(const bsl::vector<bdlt::Time>& value);
//    o void appendTimeArray(const bsl::vector<bdlt::Time>& value);
//    o void appendChoice(const bdlmxxx::Choice& value);
//    o void appendChoiceArray(const bdlmxxx::ChoiceArray& value);
//    o void appendList(const bdlmxxx::List& value);
//    o void appendList(const bdlmxxx::List& value);
//    o void appendTable(const bdlmxxx::Table& value);
//
// Basic Accessors:
...
//
//    o int length() const;
//    o bdlmxxx::ElemType::Type elemType(int index) const;
//    o void elemTypes(bsl::vector<bdlmxxx::ElemType::Type> *result) const;
//    o bdlmxxx::ConstElemRef operator[](int index) const;
...
//    o const bdlt::Datetime& theDatetime(int index) const;
//    o const bdlt::Datetime& theDatetime(int index) const;
//    o const bdlt::Date& theDate(int index) const;
//    o const bdlt::DateTz& theDateTz(int index) const;
//    o const bdlt::Time& theTime(int index) const;
//    o const bdlt::Time& theTime(int index) const;
...
//    o const bsl::vector<bdlt::Datetime>& theDatetimeArray(int i) const;
//    o const bsl::vector<bdlt::Datetime>& theDatetimeArray(int i) const;
//    o const bsl::vector<bdlt::Date>& theDateArray(int index) const;
//    o const bsl::vector<bdlt::DateTz>& theDateTzArray(int index) const;
//    o const bsl::vector<bdlt::Time>& theTimeArray(int index) const;
//    o const bsl::vector<bdlt::Time>& theTimeArray(int index) const;
//    o const bdlmxxx::Choice& theChoice(int index) const;
//    o const bdlmxxx::ChoiceArray& theChoiceArray(int index) const;
//    o const bdlmxxx::List& theList(int index) const;
//    o const bdlmxxx::List& theList(int index) const;
//    o const bdlmxxx::Table& theTable(int index) const;
//- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// NESTED TYPES
...
//
// CREATORS
// [ 3] bdlmxxx::List(bslma::Allocator *basicAllocator = 0);
// [11] bdlmxxx::List(bdlmxxx::AggregateOption::AllocationStrategy am, ba);
// [11] bdlmxxx::List(am, const InitialMemory& im, ba);
// [11] bdlmxxx::List(const bdlmxxx::ElemType::Type elemType[], int ne, ba);
// [11] bdlmxxx::List(const bdlmxxx::ElemType::Type elemType[], int ne, am, ba);
// [21] bdlmxxx::List(const bdlmxxx::ElemType::Type elemType[], int ne, am, im, ba);
// [11] bdlmxxx::List(const bsl::vector<bdlmxxx::ElemType::Type>& et, ba);
// [11] bdlmxxx::List(const bsl::vector<bdlmxxx::ElemType::Type>& et, am, ba);
// [21] bdlmxxx::List(const bsl::vector<bdlmxxx::ElemType::Type>& et, am, im, ba);
// [ 7] bdlmxxx::List(const bdlmxxx::Row& original, ba);
// [ 7] bdlmxxx::List(const bdlmxxx::List& original, ba);
// [11] bdlmxxx::List(const bdlmxxx::Row& original, am, ba);
// [21] bdlmxxx::List(const bdlmxxx::Row& original, am, im, ba);
// [11] bdlmxxx::List(const bdlmxxx::List& original, am, ba);
// [21] bdlmxxx::List(const bdlmxxx::List& original, am, im, ba);
// [11] ~bdlmxxx::List();
//
// MANIPULATORS
// [ 9] bdlmxxx::List& operator=(const bdlmxxx::List& rhs);
// [ 9] bdlmxxx::List& operator=(const bdlmxxx::Row& rhs);
// [ 6] bdlmxxx::ElemRef operator[](int index);
// [12] bdlmxxx::Row& row();
...
// [ 4] bdlt::Datetime& theModifiableDatetime(int index);
// [ 4] bdlt::DatetimeTz& theModifiableDatetimeTz(int index);
// [ 4] bdlt::Date& theModifiableDate(int index);
// [ 4] bdlt::DateTz& theModifiableDateTz(int index);
// [ 4] bdlt::Time& theModifiableTime(int index);
// [ 4] bdlt::TimeTz& theModifiableTimeTz(int index);
...
// [ 4] bsl::vector<bdlt::Datetime>& theModifiableDatetimeArray(int index);
// [ 4] bsl::vector<bdlt::DatetimeTz>& theModifiableDatetimeTzArray(int index);
// [ 4] bsl::vector<bdlt::Date>& theModifiableDateArray(int index);
// [ 4] bsl::vector<bdlt::DateTz>& theModifiableDateTzArray(int index);
// [ 4] bsl::vector<bdlt::Time>& theModifiableTimeArray(int index);
// [ 4] bsl::vector<bdlt::TimeTz>& theModifiableTimeTzArray(int index);
// [ 4] bdlmxxx::Choice& theModifiableChoice(int index);
// [ 4] bdlmxxx::ChoiceArray& theModifiableChoiceArray(int index);
// [ 4] bdlmxxx::List& theModifiableList(int index);
// [ 4] bdlmxxx::Table& theModifiableTable(int index);
...
// [ 4] void appendDatetime(const bdlt::Datetime& value);
// [13] void appendNullDatetimeTz();
// [ 4] void appendDatetimeTz(const bdlt::DatetimeTz& value);
// [13] void appendNullDate();
// [ 4] void appendDate(const bdlt::Date& value);
// [13] void appendNullDateTz();
// [ 4] void appendDateTz(const bdlt::DateTz& value);
// [13] void appendNullTime();
// [ 4] void appendTime(const bdlt::Time& value);
// [13] void appendNullTimeTz();
// [ 4] void appendTimeTz(const bdlt::TimeTz& value);
...
// [ 4] void appendDatetimeArray(const bsl::vector<bdlt::Datetime>& value);
// [ 4] void appendDatetimeTzArray(const bsl::vector<bdlt::DatetimeTz>& value);
// [13] void appendNullDateArray();
// [ 4] void appendDateArray(const bsl::vector<bdlt::Date>& value);
// [13] void appendNullDateTzArray();
// [ 4] void appendDateTzArray(const bsl::vector<bdlt::DateTz>& value);
// [13] void appendNullTimeArray();
// [ 4] void appendTimeArray(const bsl::vector<bdlt::Time>& value);
// [13] void appendNullTimeTzArray();
// [ 4] void appendTimeTzArray(const bsl::vector<bdlt::TimeTz>& value);
// [13] void appendNullChoice();
// [ 4] void appendChoice(const bdlmxxx::Choice& value);
// [13] void appendNullChoiceArray();
// [ 4] void appendChoiceArray(const bdlmxxx::ChoiceArray& value);
// [13] void appendNullList();
// [ 4] void appendList(const bdlmxxx::List& value);
// [15] void appendList(const bdlmxxx::Row& value);
// [13] void appendNullTable();
// [ 4] void appendTable(const bdlmxxx::Table& value);
// [13] void appendNullElement(bdlmxxx::ElemType::Type elementType);
// [13] void appendNullElements(const bdlmxxx::ElemType::Type et[], int ne);
// [13] void appendNullElements(const bsl::vector<bdlmxxx::ElemType::Type>&);
// [ 6] void appendElement(const bdlmxxx::ConstElemRef& srcElement);
// [16] void appendElements(const bdlmxxx::Row& srcElements);
// [16] void appendElements(const bdlmxxx::List& srcElements);
// [16] void appendElements(const bdlmxxx::Row&  se, int si, int ne);
// [16] void appendElements(const bdlmxxx::List& se, int si, int ne);
...
// [15] void insertDatetime(int dstIndex, const bdlt::Datetime& value);
// [14] void insertNullDatetimeTz(int dstIndex);
// [15] void insertDatetimeTz(int dstIndex, const bdlt::DatetimeTz& value);
// [14] void insertNullDate(int dstIndex);
// [15] void insertDate(int dstIndex, const bdlt::Date& value);
// [14] void insertNullDateTz(int dstIndex);
// [15] void insertDateTz(int dstIndex, const bdlt::DateTz& value);
// [14] void insertNullTime(int dstIndex);
// [15] void insertTime(int dstIndex, const bdlt::Time& value);
// [14] void insertNullTimeTz(int dstIndex);
// [15] void insertTimeTz(int dstIndex, const bdlt::TimeTz& value);
...
// [15] void insertDateArray(int di, const bsl::vector<bdlt::Date>& value);
// [14] void insertNullDateTzArray(int dstIndex);
// [15] void insertDateTzArray(int di, const bsl::vector<bdlt::DateTz>& value);
// [14] void insertNullTimeArray(int dstIndex);
// [15] void insertTimeArray(int di, const bsl::vector<bdlt::Time>& value);
// [14] void insertNullTimeTzArray(int dstIndex);
// [15] void insertTimeTzArray(int di, const bsl::vector<bdlt::TimeTz>& value);
// [14] void insertNullChoice(int dstIndex);
// [15] void insertChoice(int dstIndex, const bdlmxxx::Choice& value);
// [14] void insertNullChoiceArray(int dstIndex);
// [15] void insertChoiceArray(int dstIndex, const bdlmxxx::ChoiceArray& value);
// [14] void insertNullList(int dstIndex);
// [15] void insertList(int dstIndex, const bdlmxxx::List& value);
// [15] void insertList(int dstIndex, const bdlmxxx::Row& value);
// [14] void insertNullTable(int dstIndex);
// [15] void insertTable(int dstIndex, const bdlmxxx::Table& value);
// [14] void insertNullElement(int dstIndex, bdlmxxx::ElemType::Type et);
// [14] void insertNullElements(int, const bdlmxxx::ElemType::Type [], int);
// [14] void insertNullElements(int, const bsl::vector<bdlmxxx::ElemType::Type>&);
// [16] void insertElement(int di, const bdlmxxx::ConstElemRef& srcElement);
// [16] void insertElements(int dstIndex, const bdlmxxx::Row& srcElements);
// [16] void insertElements(int dstIndex, const bdlmxxx::List& srcElements);
// [16] void insertElements(int di, const bdlmxxx::Row&  sr, int si, int ne);
// [16] void insertElements(int di, const bdlmxxx::List& sl, int si, int ne);
// [18] void makeAllNull();
// [22] void reserveMemory(int numBytes);
// [16] void removeElement(int index);
// [16] void removeElements(int startIndex, int numElements);
// [16] void removeAll();
// [17] void replaceElement(int dstIndex, const bdlmxxx::ConstElemRef& se);
// [17] void resetElement(int dstIndex, bdlmxxx::ElemType::Type elemType);
// [17] void reset(const bdlmxxx::ElemType::Type elementTypes[], int ne);
// [17] void reset(const bsl::vector<bdlmxxx::ElemType::Type>& et);
// [20] void compact();
// [19] void swapElements(int index1, int index2);
// [10] STREAM& bdexStreamIn(STREAM& stream, int version);
//
// ACCESSORS
// [ 4] bdlmxxx::ConstElemRef operator[](int index) const;
// [ 4] bdlmxxx::ElemType::Type elemType(int index) const;
// [ 4] void elemTypes(bsl::vector<bdlmxxx::ElemType::Type> *result) const;
// [ 4] int length() const;
// [18] bool isAnyNull() const;
// [18] bool isAnyNonNull() const;
// [ 7] const bdlmxxx::Row& row() const;
...
// [ 4] const bdlt::Datetime& theDatetime(int index) const;
// [ 4] const bdlt::DatetimeTz& theDatetimeTz(int index) const;
// [ 4] const bdlt::Date& theDate(int index) const;
// [ 4] const bdlt::DateTz& theDateTz(int index) const;
// [ 4] const bdlt::Time& theTime(int index) const;
// [ 4] const bdlt::TimeTz& theTimeTz(int index) const;
...
// [ 4] const bsl::vector<bdlt::Datetime>& theDatetimeArray(int i) const;
// [ 4] const bsl::vector<bdlt::DatetimeTz>& theDatetimeTzArray(int i) const;
// [ 4] const bsl::vector<bdlt::Date>& theDateArray(int index) const;
// [ 4] const bsl::vector<bdlt::DateTz>& theDateTzArray(int index) const;
// [ 4] const bsl::vector<bdlt::Time>& theTimeArray(int index) const;
// [ 4] const bsl::vector<bdlt::TimeTz>& theTimeTzArray(int index) const;
// [ 4] const bdlmxxx::Choice& theChoice(int index) const;
// [ 4] const bdlmxxx::ChoiceArray& theChoiceArray(int index) const;
// [ 4] const bdlmxxx::List& theList(int index) const;
// [ 4] const bdlmxxx::Table& theTable(int index) const;
// [10] STREAM& bdexStreamOut(STREAM& stream, int version) const;
// [ 5] bsl::ostream& print(bsl::ostream& s, int l, int spl) const;
//
// // FREE OPERATORS
// [ 6] operator==(const bdlmxxx::List& lhs, const bdlmxxx::List& rhs);
// [ 6] operator!=(const bdlmxxx::List& lhs, const bdlmxxx::List& rhs);
// [10] operator>>(STREAM& stream, bdlmxxx::List& rhs);
// ----------------------------------------------------------------------------
// [ 1] BREATHING TEST
...
// [ 6] void loadReferenceB(bdlmxxx::List *result);
// [13] void loadReferenceN(bdlmxxx::List *result);
// [ 8] bdlmxxx::List g(const char *spec, const bdlmxxx::List& referenceList)
// [25] USAGE EXAMPLE
//-----------------------------------------------------------------------------
...
class Choice {
    // This class is a dummy Choice class to facilitate testing.
    // Note that it contains only the functions called in this test driver
    // and not the entire interface of bdem_ChoiceArray.

    ChoiceImp     d_choiceImp;

    friend bool operator==(const Choice& lhs, const Choice& rhs);
    friend bsl::ostream& operator<<(bsl::ostream& os, const Choice& rhs);

    public:
    // CREATORS
    Choice();
    Choice(const ElemType::Type types[], int numTypes);
...
bool operator!=(const Choice& lhs, const Choice& rhs);
bsl::ostream& operator<<(bsl::ostream& os, const Choice& rhs);

                        // ============================
                        // DUMMY class ChoiceArray
                        // ============================

class ChoiceArray {
    // This class is a dummy ChoiceArray class to facilitate testing.
    // Note that it contains only the functions called in this test driver
    // and not the entire interface of ChoiceArray.

    ChoiceArrayImp d_choiceArrayImp;

    friend bool operator==(const ChoiceArray& lhs,
  ...
  public:
    // CREATORS
    ChoiceArray();
    ChoiceArray(const ElemType::Type types[], int numTypes);

    // MANIPULATORS
    void appendNullItems(int elemCount);
    ChoiceArrayItem& operator[](int index);
};

bool operator==(const ChoiceArray& lhs, const ChoiceArray& rhs);
bool operator!=(const ChoiceArray& lhs, const ChoiceArray& rhs);
bsl::ostream& operator<<(bsl::ostream& os, const ChoiceArray& rhs);
...
class Table {
    // This class is a dummy Table class to facilitate testing

    TableImp d_tableImp;

    friend bool operator==(const Table& lhs, const Table& rhs);
    friend bsl::ostream& operator<<(bsl::ostream& os, const Table& rhs);

  public:
    // CREATORS
    Table();
    Table(const ElemType::Type types[], int numTypes);
...
bool operator!=(const Table& lhs, const Table& rhs);
bsl::ostream& operator<<(bsl::ostream& os, const Table& rhs);
...
Choice::Choice(const ElemType::Type types[], int numTypes)
: d_choiceImp(types,
              numTypes,
...
ChoiceArray::ChoiceArray(const ElemType::Type types[],
                                   int                       numTypes)
...
void ChoiceArray::appendNullItems(int elemCount)
{
    d_choiceArrayImp.insertNullItems(d_choiceArrayImp.length(), elemCount);
}

ChoiceArrayItem& ChoiceArray::operator[](int index)
{
    return (ChoiceArrayItem&) d_choiceArrayImp.theModifiableItem(index);
}
}  // close package namespace
...
Table::Table()
: d_tableImp(AggregateOption::BDEM_PASS_THROUGH)
{
}

Table::Table(const ElemType::Type types[], int numTypes)
: d_tableImp(types,
             numTypes,
             ElemAttrLookup::lookupTable(),
             AggregateOption::BDEM_PASS_THROUGH)
...
: d_tableImp(original.d_tableImp, AggregateOption::BDEM_PASS_THROUGH)
{
}
...
{
    return (Row&) d_tableImp.theModifiableRow(index);
}
}  // close package namespace
...
bsl::ostream& bdlmxxx::operator<<(bsl::ostream& stream, const Table& rhs)
{
...
const bsls::Types::Int64 N03 = bdltuxxx::Unset<bsls::Types::Int64>::unsetValue();
...
static bdlmxxx::List                                fA20() {
       bdlmxxx::List t;              t.appendInt(A02);
                                 t.appendDouble(A05);
                                 t.appendString(A06);
                                 t.appendStringArray(A16); return t; }
static bdlmxxx::List                            fB20() {
       bdlmxxx::List t;              t.appendInt(B02);
                                 t.appendDouble(B05);
                                 t.appendString(B06);
                                 t.appendStringArray(B16); return t; }

// Note: on Windows, the function pointers in bdlmxxx::Properties::s_intAttr are
...
bdlmxxx::List                                       mA20; // Initialized in main
bdlmxxx::List                                       mB20; // Initialized in main
const  bdlmxxx::List&                                A20 = mA20;
const  bdlmxxx::List&                                B20 = mB20;
#else
const  bdlmxxx::List                                 A20 = fA20();
const  bdlmxxx::List                                 B20 = fB20();
#endif
const  bdlmxxx::List                                 N20;

static bdlmxxx::Table                               fA21() {
    ...
    bdlmxxx::Table t(types, NUM_TYPES); t.appendNullRow();
...
bdlmxxx::Table                                      mA21;
bdlmxxx::Table                                      mB21;
const  bdlmxxx::Table&                               A21 = mA21;
const  bdlmxxx::Table&                               B21 = mB21;
#else
const  bdlmxxx::Table                                A21 = fA21();
const  bdlmxxx::Table                                B21 = fB21();
#endif
const  bdlmxxx::Table                                N21;
...
bdlmxxx::Choice                                     mA30;
bdlmxxx::Choice                                     mB30;
const  bdlmxxx::Choice&                              A30 = mA30;
const  bdlmxxx::Choice&                              B30 = mB30;
#else
const  bdlmxxx::Choice                               A30 = fA30();
const  bdlmxxx::Choice                               B30 = fB30();
#endif
const  bdlmxxx::Choice                               N30;
...
#ifdef BSLS_PLATFORM_CMP_MSVC
bdlmxxx::ChoiceArray                                mA31;
bdlmxxx::ChoiceArray                                mB31;
const  bdlmxxx::ChoiceArray&                         A31 = mA31;
const  bdlmxxx::ChoiceArray&                         B31 = mB31;
#else
const  bdlmxxx::ChoiceArray                          A31 = fA31();
const  bdlmxxx::ChoiceArray                          B31 = fB31();
#endif
const  bdlmxxx::ChoiceArray                          N31;
...
bsl::ostream& operator<<(bsl::ostream& stream,
                         const AggregateOption::AllocationStrategy mode);
}  // close package namespace
...
{
    switch(mode) {
      case AggregateOption::BDEM_PASS_THROUGH: {
      ...
      case AggregateOption::BDEM_SUBORDINATE: {
                      stream << "BDEM_SUBORDINATE" << bsl::flush;
      } break;
      default: {
          stream << "Unknown AggregateOption: "
                 << (int) mode << bsl::flush;
      }
    };
    return stream;
...
void loadReferenceNull(bdlmxxx::List *result)
...
bdlmxxx::List g(const char *spec, const bdlmxxx::List& referenceList)
    ...
    // the 'bdlmxxx::List' copy constructor and its 'appendElement' method have
...
bool isUnset(const bdlmxxx::ConstElemRef& ref)
...
// re-hydrate a temporary local 'bdlmxxx::List':
//..
//      bdlxxxx::ByteInStream in(data, length);
//      bdlmxxx::List tmpList(result->allocator());
//
//      int version;
//      in.getVersion(version);
//      bdex_InStreamFunctions::streamIn(in, tmpList, version);
...
static void testCase24(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
 ...
 // v-------------------^
    if (DI == DD.length() && NE == SS.length())
    {
        ...
        if (PRINT) cout <<
            "\t\tappendElements(const bdlmxxx::Row& srcElements);" << endl;
...
//             LOOP3_ASSERT(LINE, ri, ai, 0 == da.numBlocksTotal());
    ...
    if (DI == DD.length() && NE == SS.length())
    {
        ...
        if (PRINT) cout <<
            "\t\tappendElements(const bdlmxxx::List& srcElements);" << endl;
...
//             LOOP3_ASSERT(LINE, ri, ai, 0 == da.numBlocksTotal());
    ...
    if (DI == DD.length())
    {
        ...
        if (PRINT) cout <<
           "\t\tappendElements(const bdlmxxx::Row& se, int si, int ne);" << endl;
...
//             LOOP3_ASSERT(LINE, ri, ai, 0 == da.numBlocksTotal());
    ...
    if (DI == DD.length())
    {
        ...
        if (PRINT) cout <<
            "\t\tappendElements(const bdlmxxx::List& se, int si, int ne);" << endl;
...
//             LOOP3_ASSERT(LINE, ri, ai, 0 == da.numBlocksTotal());
    ...
    if (1 == NE)
    {
        ...
        if (PRINT) cout <<
           "\t\tinsertElement(int di, const bdlmxxx::ConstElemRef& srcElement);"
                        << endl;
        BSLMA_TESTALLOCATOR_EXCEPTION_TEST_BEGIN(testAllocator)
            Obj mX(DD, MODE, &ta);  const Obj &X = mX;
            {
...
//             LOOP3_ASSERT(LINE, ri, ai, 0 == da.numBlocksTotal());
    ...
    if (NE == SS.length())
    {
        ...
        if (PRINT) cout <<
            "\t\tinsertElements(int dstIndex, const bdlmxxx::Row& srcElements);"
                        << endl;
        BSLMA_TESTALLOCATOR_EXCEPTION_TEST_BEGIN(testAllocator)
            Obj mX(DD, MODE, &ta);  const Obj &X = mX;
            {
...
//             LOOP3_ASSERT(LINE, ri, ai, 0 == da.numBlocksTotal());
    ...
    if (NE == SS.length())
    {
        ...
        if (PRINT) cout <<
            "\t\tinsertElements(int dstIndex, const bdlmxxx::List& srcElements);"
                        << endl;
        BSLMA_TESTALLOCATOR_EXCEPTION_TEST_BEGIN(testAllocator)
            Obj mX(DD, MODE, &ta);  const Obj &X = mX;
            {
...
//             LOOP3_ASSERT(LINE, ri, ai, 0 == da.numBlocksTotal());
    ...
    if (1)
    {
        ...
        if (PRINT) cout <<
            "\t\tinsertElements(int di, const bdlmxxx::Row&  sr, int si, int ne);"
                        << endl;
        BSLMA_TESTALLOCATOR_EXCEPTION_TEST_BEGIN(testAllocator)
            Obj mX(DD, MODE, &ta);  const Obj &X = mX;
            {
...
//             LOOP3_ASSERT(LINE, ri, ai, 0 == da.numBlocksTotal());
    ...
    if (1)
    {
        ...
        if (PRINT) cout <<
            "\t\tinsertElements(int di, const bdlmxxx::List& sl, int si, int ne);"
                        << endl;
        BSLMA_TESTALLOCATOR_EXCEPTION_TEST_BEGIN(testAllocator)
            Obj mX(DD, MODE, &ta);  const Obj &X = mX;
            {
...
static void testCase22(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
        ...
        if (verbose) cout << "\nUsing 'BDEM_WRITE_ONCE'" << endl;
        {
            ...
            bdlmxxx::List mX(bdlmxxx::AggregateOption::BDEM_WRITE_ONCE, &allocator);
        ...
        {
            bslma::TestAllocator allocator;
            bdlmxxx::List mX(bdlmxxx::AggregateOption::BDEM_WRITE_MANY, &allocator);
...
static void testCase21(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
        ...
        if (verbose) cout << "\nWith allocMode only." << endl;
        {
            if (veryVerbose) cout << "\tUsing 'BDEM_WRITE_ONCE'." << endl;
            {
                ...
                bdlmxxx::List mX(bdlmxxx::AggregateOption::BDEM_WRITE_ONCE,
                             bdlmxxx::List::InitialMemory(SIZE),
                             &allocator);
            ...
            if (veryVerbose) cout << "\tUsing 'BDEM_WRITE_MANY'." << endl;
            {
                ...
                bdlmxxx::List mX(bdlmxxx::AggregateOption::BDEM_WRITE_MANY,
                             bdlmxxx::List::InitialMemory(SIZE),
                             &allocator);
        ...
        if (verbose) cout << "\nWith copy ctor." << endl;
        {
            ...
            {
                bslma::TestAllocator allocator;
                bdlmxxx::List original;

                bdlmxxx::List mX(original,
                             bdlmxxx::AggregateOption::BDEM_WRITE_ONCE,
                             bdlmxxx::List::InitialMemory(SIZE),
                             &allocator);
...
static void testCase20(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
...

        {
            ...
            bdlmxxx::List mL1(&ta1), mL2(&ta2);
            const bdlmxxx::List& L1 = mL1;
            const bdlmxxx::List& L2 = mL2;
            ...
            const bdlmxxx::List L2b(L2, &ta2b);
...
static void testCase19(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
        ...
        if (verbose) cout << "\ntest all two-element-list swaps." << endl;
        {
            for (int i = 0; i < 32; ++i) {
                ...
                for (int j = 0; j < 32; ++j) {
                    ...
                    bdlmxxx::List mX; const bdlmxxx::List& X = mX;
                    mX.appendElement(A[i]);
                    mX.appendElement(A[j]);
                    if (veryVeryVerbose) { T_ T_ P(X) }

                    bdlmxxx::List mY; const bdlmxxx::List& Y = mY;
                    ...
                    for (int ai = 0; ai < NUM_MODES; ++ai) { // ALLOCATION MODE
                        ...
                        bdlmxxx::List mZ(X, MODE); bdlmxxx::List& Z = mZ;
        ...
        if (verbose) cout << "\nReverse list of all 32 element types." << endl;
        {
            ...
            bdlmxxx::List mX(A, &a); const bdlmxxx::List& X = mX;
            ...
            "\nVerify that element addresses do not change." << endl;
        {
            ...
            bdlmxxx::List mX(L); const bdlmxxx::List& X = mX;
...
static void testCase18(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
        ...
        bdlmxxx::List mNN; const bdlmxxx::List& NN = mNN;ASSERT(     0 == NN.length());
        ...
        {
            {
                bdlmxxx::List mX(A); const bdlmxxx::List& X = mX;
                ASSERT(U != X);
            ...
            {
                bdlmxxx::List mX(B); const bdlmxxx::List& X = mX;
                ASSERT(U != X);
                ASSERT(1 == X.isAnyNonNull());
                ASSERT(1 == isAnySet(X));
                ASSERT(0 == X.isAnyNull());
            ...
            {
                bdlmxxx::List mX(U); const bdlmxxx::List& X = mX;
                ASSERT(U == X);
                ASSERT(1 == X.isAnyNonNull());
                ASSERT(0 == isAnySet(X));
                ASSERT(0 == X.isAnyNull());
            ...
            {
                bdlmxxx::List mX(N); const bdlmxxx::List& X = mX;
                ASSERT(N == X);
                ASSERT(0 == X.isAnyNonNull());
                ASSERT(0 == isAnySet(X));
                ASSERT(1 == X.isAnyNull());
            ...
            {
                bdlmxxx::List mX(NN); const bdlmxxx::List& X = mX;
                ASSERT(NN == X);
                ASSERT(0 == X.isAnyNonNull());
                ASSERT(0 == isAnySet(X));
                ASSERT(1 == X.isAnyNull());
...
static void testCase17(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
        ...
        //
        // Testing:
        //   void replaceElement(int dstIndex, const bdlmxxx::ConstElemRef& se);
        //   void resetElement(int dstIndex, bdlmxxx::ElemType::Type elemType);
        //   void reset(const bdlmxxx::ElemType::Type elementTypes[], int ne);
        //   void reset(const bsl::vector<bdlmxxx::ElemType::Type>& et);
        // --------------------------------------------------------------------
        ...
        const bdlmxxx::List AA(A), BB(B), UU(U), NN(N);
        ...
        if (verbose) cout << "\nTesting 'replaceElement'." << endl;
        {
            ...
            bdlmxxx::List mX(A, &ta); bdlmxxx::List& X = mX;
        ...
        {
            bslma::TestAllocator ta(veryVeryVerbose);
            bdlmxxx::List mX(N, &ta); bdlmxxx::List& X = mX;
            for (int i = 0; i < N_ELEM; ++i) {    // for each element
                mX.replaceElement(i, X[i]);       // Change i'th entry.
                if (veryVerbose) { T_ T_ P_(i)
                    cout << ", changed list X: "; X.print(cout, -2, 8);
        ...
        if (verbose) cout << "\nTesting 'reset'." << endl;
        {
            ...
            //   Extract the 'bdlmxxx::ElemType[]' array.
            ...
            for (int ei = 0; ei < NUM_SPECS; ++ei) {
                const bdlmxxx::List EXPECTED_VALUE = g(SPECS[ei], N);

                bsl::vector<bdlmxxx::ElemType::Type> elementTypes;
                EXPECTED_VALUE.elemTypes(&elementTypes);
                const int                  LENGTH = EXPECTED_VALUE.length();
                const bdlmxxx::ElemType::Type *ETA    = 0;
                if (LENGTH > 0) {
                    ETA = &elementTypes[0];
                }
                ...
                for (int si = 0; si < NUM_SPECS; ++si) { // INITIAL VALUES
                    const bdlmxxx::List INITIAL_VALUE = g(SPECS[si], A);
                    if (veryVerbose) {
                         cout << "\t\t-------------------------------------\n";
                    ...
                    for (int ai = 0; ai < NUM_MODES; ++ai) { // ALLOCATION MODE
                        ...
                        bslma::TestAllocator ta;
                        bdlmxxx::List mX(INITIAL_VALUE, MODE, &ta);
                        bdlmxxx::List mY(INITIAL_VALUE, MODE, &ta);
                        const bdlmxxx::List& X = mX; const bdlmxxx::List& Y = mY;
...
static void testCase16(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
        ...
        //
        // Testing:
        //   void appendElements(const bdlmxxx::Row& srcElements);
        //   void appendElements(const bdlmxxx::List& srcElements);
        //   void appendElements(const bdlmxxx::Row&  se, int si, int ne);
        //   void appendElements(const bdlmxxx::List& se, int si, int ne);
        //
        //   void insertElement(int di, const bdlmxxx::ConstElemRef& srcElement);
        //   void insertElements(int dstIndex, const bdlmxxx::Row& srcElements);
        //   void insertElements(int dstIndex, const bdlmxxx::List& srcElements);
        //   void insertElements(int di, const bdlmxxx::Row&  sr, int si, int ne);
        //   void insertElements(int di, const bdlmxxx::List& sl, int si, int ne);
        //
 ...
 // ^-------------------v
        ...
        if (verbose) cout << "\nremoveAll();" << endl;
        {
            ASSERT(96 == L.length());
            {
                ...
                bdlmxxx::List mX(L, bdlmxxx::AggregateOption::BDEM_PASS_THROUGH);
                ASSERT(96 == mX.length());
                mX.removeAll();
                ASSERT( 0 == mX.length());
            }
            {
                ...
                bslma::TestAllocator da; bslma::DefaultAllocatorGuard dag(&da);
                bdlmxxx::List mX(L, bdlmxxx::AggregateOption::BDEM_WRITE_ONCE);
                ASSERT(96 == mX.length());
                mX.removeAll();
                ASSERT( 0 == mX.length());
            }
            {
                ...
                bslma::TestAllocator da; bslma::DefaultAllocatorGuard dag(&da);
                bdlmxxx::List mX(L, bdlmxxx::AggregateOption::BDEM_WRITE_MANY);
                ASSERT(96 == mX.length());
                mX.removeAll();
                ASSERT( 0 == mX.length());
            }
...
static void testCase15(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
        ...
        //      'const char *' and 'bdlmxxx::Row') work the same as the normal
        //      methods taking 'bsl::string' and 'bdlmxxx::List'.
        //
        // Plan:
        ...
        //      corresponding 'const char *' and 'bdlmxxx::Row'.
        //
        // Tactics:
        ...
        //   void insertDateArray(int di, const bsl::vector<bdlt::Date>& value);
        //   void insertTimeArray(int di, const bsl::vector<bdlt::Time>& value);
        //   void insertList(int dstIndex, const bdlmxxx::List& value);
        //   void insertTable(int dstIndex, const bdlmxxx::Table& value);
        //   void insertChoice(int dstIndex, const bdlmxxx::Choice& value);
        //   void insertChoiceArray(int dstIndex, const bdlmxxx::ChoiceArray&);
        //
        //   void appendString(const char *value);
        //   void insertString(int dstIndex, const char *value);
        //
        //   void appendList(const bdlmxxx::Row& value);
        //   void insertList(int dstIndex, const bdlmxxx::Row& value);
        // --------------------------------------------------------------------
        ...
        bdlmxxx::List mL2; const bdlmxxx::List& L2 = mL2;  ASSERT( 0 == L2.length());
        ...
        bdlmxxx::List mL3; const bdlmxxx::List& L3 = mL3;  ASSERT( 0 == L3.length());
        ...
        bdlmxxx::List mL4; const bdlmxxx::List& L4 = mL4;  ASSERT( 0 == L4.length());
...
static void testCase14(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
        ...
        //      array of all 32 'bdlmxxx::ElemType::Type' values and making
        ...
        //   void insertNullElement(bdlmxxx::ElemType::Type elementType);
        //   void insertNullElements(int, const bdlmxxx::ElemType::Type [], int);
        //   void insertNullElements(int, const vector<bdlmxxx::ElemType::Type>&);
        // -------------------------------------------------------------------
        ...
        {
            bdlmxxx::List mX; const bdlmxxx::List& X = mX;  ASSERT( 0 == X.length());
            loadReferenceN(&mX);                    ASSERT(32 == X.length());
            bdlmxxx::List mY; const bdlmxxx::List& Y = mY;  ASSERT( 0 == Y.length());
                                                                        ...
                                                                        <<endl;
        {
            bdlmxxx::List x;
            for (int i = 0; i < 32; ++i) {
                x.insertNullElement(0, bdlmxxx::ElemType::Type(31 - i));
            }
            ASSERT(L == x);
        }
                                                                       ...
                                                                       << endl;
        {
            bdlmxxx::List x;
            for (int i = 0; i < 32; ++i) {
                x.insertNullElement(i, bdlmxxx::ElemType::Type(i));
            }
            ASSERT(L == x);
        }
        ...
        const bsl::vector<bdlmxxx::ElemType::Type> TYPES_VEC(TYPES,
                                                         TYPES + NUM_TYPES);
        ...
        {
            bdlmxxx::List x, y;
            const bsl::vector<bdlmxxx::ElemType::Type> EMPTY_TYPES_VEC;

            x.insertNullElements(0, TYPES, 0);
            y.insertNullElements(0, EMPTY_TYPES_VEC);

            ASSERT(bdlmxxx::List() == x);
            ASSERT(bdlmxxx::List() == y);
        }
                                                                       ...
                                                                       << endl;
        {
            for (int i = 0; i < 32; ++i) {
                ...
                bsl::vector<bdlmxxx::ElemType::Type> ONE_TYPE_VEC(1, TYPES_VEC[i]);
            ...
            "\tTest each length 1 in a different position (reverse)." << endl;
        {
            bdlmxxx::List x, y;
            for (int i = 0; i < 32; ++i) {
                bsl::vector<bdlmxxx::ElemType::Type> ONE_TYPE_VEC(
                                                            1,
                                                            TYPES_VEC[31 - i]);
        ...
        if (verbose) cout << "\tTest 11 + 11 (append)." << endl;
        {
            ...
            bsl::vector<bdlmxxx::ElemType::Type> MULTIPLE_TYPES_VEC1(TYPES,
                                                                 TYPES + 11);
            bsl::vector<bdlmxxx::ElemType::Type> MULTIPLE_TYPES_VEC2(
                                                            TYPES + 11,
                                                            TYPES + NUM_TYPES);
        ...
        if (verbose) cout << "\tTest 11 * 2 (insert)." << endl;
        {
            ...
            for (int i = 0; i < 32; i += 2) {
                bsl::vector<bdlmxxx::ElemType::Type> TWO_TYPES_VEC(TYPES + 30 - i,
                                                               TYPES + 32 - i);
        ...
        bdlmxxx::List mN2; const bdlmxxx::List& N2 = mN2;  ASSERT( 0 == N2.length());
        ...
        bdlmxxx::List mN3; const bdlmxxx::List& N3 = mN3;ASSERT(0      == N3.length());
...
static void testCase13(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
        ...
        //   void appendNullElement(bdlmxxx::ElemType::Type elementType);
        //   void appendNullElements(const bdlmxxx::ElemType::Type et[], int ne);
        //   void appendNullElements(const bsl::vector<bdlmxxx::ElemType::Type>&);
        // --------------------------------------------------------------------
                                                                       ...
                                                                       << endl;
        {
            bdlmxxx::List x;
            for (int i = 0; i < 32; ++i) {
                x.appendNullElement(bdlmxxx::ElemType::Type(i));
            }
            ASSERT(L == x);
        }

        static bdlmxxx::ElemType::Type TYPES[] = {
            bdlmxxx::ElemType::BDEM_CHAR,
            bdlmxxx::ElemType::BDEM_SHORT,
            bdlmxxx::ElemType::BDEM_INT,
            bdlmxxx::ElemType::BDEM_INT64,
...
static void testCase11(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
        ...
        //
        // Testing:
        //   bdlmxxx::List(bdlmxxx::AggregateOption::AllocationStrategy am, ba);
        //
        //   bdlmxxx::List(const bdlmxxx::ElemType::Type elemType[], int ne, ba);
        //   bdlmxxx::List(const bdlmxxx::ElemType::Type elemType[], int ne, am, ba);
        //
        //   bdlmxxx::List(const bsl::vector<bdlmxxx::ElemType::Type>& et, ba);
        //   bdlmxxx::List(const bsl::vector<bdlmxxx::ElemType::Type>& et, am, ba);
        //
        //   bdlmxxx::List(const bdlmxxx::List& original, am, ba);
        //   bdlmxxx::List(const bdlmxxx::Row& original, am, ba);
        //
        //   ~bdlmxxx::List();
        // --------------------------------------------------------------------
        ...
        int usage1_one,   usage2_one;    // bdlmxxx::List(am, ba);
        int usage1_two,   usage2_two;    // bdlmxxx::List(et, ne, ba);
        int usage1_three, usage2_three;  // bdlmxxx::List(et, ne, am, ba);
        int usage1_four,  usage2_four;   // bdlmxxx::List(originalList, am, ba);
        int usage1_five,  usage2_five;   // bdlmxxx::List(originalRow, am, ba);
        int usage1_six,   usage2_six;    // bdlmxxx::List(et, ba);
        int usage1_seven, usage2_seven;  // bdlmxxx::List(et, am, ba);

        // - - - - - - - - - - - - - - - ONE - - - - - - - - - - - - - - - - -

        if (verbose) cout << "\tONE: bdlmxxx::List(am, ba);" << endl;
        {
            ...
            bdlmxxx::List list(bdlmxxx::AggregateOption::BDEM_PASS_THROUGH, &a);
        ...
        if (verbose) cout << "\tTWO: bdlmxxx::List(et, ne, ba);" << endl;
        {
            const bdlmxxx::ElemType::Type TYPES[] = {
                bdlmxxx::ElemType::BDEM_SHORT,
                bdlmxxx::ElemType::BDEM_INT
        ...
        if (verbose) cout << "\tTHREE: bdlmxxx::List(et, ne, am, ba);" << endl;
        {
            const bdlmxxx::ElemType::Type TYPES[] = {
                bdlmxxx::ElemType::BDEM_SHORT,
                bdlmxxx::ElemType::BDEM_INT
            ...
            bdlmxxx::List list(TYPES, N,
                           bdlmxxx::AggregateOption::BDEM_PASS_THROUGH, &a);
            int usage1 = a.numBlocksTotal();
            if (veryVerbose) { T_ T_ P(usage1) }
            ASSERT(usage1 > usage0);
        ...
        if (verbose) cout << "\tFOUR: bdlmxxx::List(originalList, am, ba);"
                          << endl;
        {
            ...
            bdlmxxx::List listA(bdlmxxx::AggregateOption::BDEM_PASS_THROUGH, &aA);
            bdlmxxx::List listB(listA,
                            bdlmxxx::AggregateOption::BDEM_PASS_THROUGH, &aB);
        ...
        if (verbose) cout << "\tFIVE: bdlmxxx::List(originalRow, am, ba);" << endl;
        {
            bslma::TestAllocator aA;                // A: original list
            bslma::TestAllocator aB;                // B: copy constructed list
        ...
        if (verbose) cout << "\tSIX: bdlmxxx::List(et, ba);" << endl;
        {
        ...
        if (verbose) cout << "\tSEVEN: bdlmxxx::List(et, am, ba);" << endl;
        {
            bsl::vector<bdlmxxx::ElemType::Type> TYPES;
            TYPES.push_back(bdlmxxx::ElemType::BDEM_SHORT);
            TYPES.push_back(bdlmxxx::ElemType::BDEM_INT);
            ...
            bdlmxxx::List list(TYPES, bdlmxxx::AggregateOption::BDEM_PASS_THROUGH, &a);
            int usage1 = a.numBlocksTotal();
            if (veryVerbose) { T_ T_ P(usage1) }
            ASSERT(usage1 > usage0);
        ...
        if (verbose) cout << "\tONE: bdlmxxx::List(am);" << endl;
        {
            bslma::TestAllocator a;
            const bslma::DefaultAllocatorGuard dag(&a);
            {
                ...
                bdlmxxx::List list(bdlmxxx::AggregateOption::BDEM_PASS_THROUGH);
                int usage1 = a.numBlocksTotal();
                if (veryVerbose) { T_ T_ P(usage1) }
                ASSERT(usage1 > usage0);
        ...
        if (verbose) cout << "\tTWO: bdlmxxx::List(et, ne);" << endl;
        {
            bslma::TestAllocator a;
            const bslma::DefaultAllocatorGuard dag(&a);
            {
        ...
        if (verbose) cout << "\tTHREE: bdlmxxx::List(et, ne, am);" << endl;
        {
            bslma::TestAllocator a;
            const bslma::DefaultAllocatorGuard dag(&a);
            {
        ...
        if (verbose) cout << "\tFOUR: bdlmxxx::List(originalList, am);" << endl;
        {
            bslma::TestAllocator aB;                // B: copy constructed list
        ...
        if (verbose) cout << "\tSIX: bdlmxxx::List(et);" << endl;
        {
            bslma::TestAllocator a;
            bsl::vector<bdlmxxx::ElemType::Type> TYPES;
            TYPES.push_back(bdlmxxx::ElemType::BDEM_SHORT);
        ...
        if (verbose) cout << "\tSEVEN: bdlmxxx::List(et, am);" << endl;
        {
            bslma::TestAllocator a;
            bsl::vector<bdlmxxx::ElemType::Type> TYPES;
            TYPES.push_back(bdlmxxx::ElemType::BDEM_SHORT);
            ...
            const bslma::DefaultAllocatorGuard dag(&a);
            {
                ...
                bdlmxxx::List list(TYPES, bdlmxxx::AggregateOption::BDEM_PASS_THROUGH);
                int usage1 = a.numBlocksTotal();
                if (veryVerbose) { T_ T_ P(usage1) }
                ASSERT(usage1 > usage0);
        ...
        if (verbose) cout << "\tONE: bdlmxxx::List(am, ba);" << endl;
        {
            ...
            bdlma::MultipoolAllocator ma4(20, &a4);  // to handle
                                                    // BDEM_SUBORDINATE

            bdlmxxx::List mL(     &a);  const bdlmxxx::List& L  = mL;
            bdlmxxx::List mL1(S1, &a1); const bdlmxxx::List& L1 = mL1;
            bdlmxxx::List mL2(S2, &a2); const bdlmxxx::List& L2 = mL2;
            bdlmxxx::List mL3(S3, &a3); const bdlmxxx::List& L3 = mL3;
            bdlmxxx::List *p = new(ma4) bdlmxxx::List(S4, &ma4);
            bdlmxxx::List& mL4 = *p;    const bdlmxxx::List& L4 = mL4;
        ...
        if (verbose) cout << "\tTWO/THREE: bdlmxxx::List(et, ne, am, ba);" <<endl;
        {
            const bdlmxxx::ElemType::Type TYPES[] = {
                bdlmxxx::ElemType::BDEM_INT
            };
            ...
            bdlmxxx::List  mL(TYPES, N,     &a);  const bdlmxxx::List& L  = mL;
            bdlmxxx::List mL1(TYPES, N, S1, &a1); const bdlmxxx::List& L1 = mL1;
            bdlmxxx::List mL2(TYPES, N, S2, &a2); const bdlmxxx::List& L2 = mL2;
            bdlmxxx::List mL3(TYPES, N, S3, &a3); const bdlmxxx::List& L3 = mL3;
            bdlmxxx::List *p = new(ma4) bdlmxxx::List(TYPES, N, S4, &ma4);
            bdlmxxx::List& mL4 = *p;    const bdlmxxx::List& L4 = mL4;
            // Note that if BDEM_SUBORDINATE were the default, it would leek
            // memory, which would be reported by the bslma::TestAllocator a4.
        ...
        if (verbose) cout << "\tFOUR: bdlmxxx::List(originalList, am, ba);" <<endl;
        {
            bdlmxxx::List mZ(S2); const bdlmxxx::List& Z = mZ;  // non-default mode
            mZ.appendDouble(A05);
            ...
            bdlmxxx::List  mL(Z,     &a);  const bdlmxxx::List& L  = mL;
            bdlmxxx::List mL1(Z, S1, &a1); const bdlmxxx::List& L1 = mL1;
            bdlmxxx::List mL2(Z, S2, &a2); const bdlmxxx::List& L2 = mL2;
            bdlmxxx::List mL3(Z, S3, &a3); const bdlmxxx::List& L3 = mL3;
            bdlmxxx::List *p = new(ma4) bdlmxxx::List(Z, S4, &ma4);
            bdlmxxx::List& mL4 = *p;    const bdlmxxx::List& L4 = mL4;
            // Note that if BDEM_SUBORDINATE were the default, it would leek
            // memory, which would be reported by the bslma::TestAllocator a4.
        ...
        if (verbose) cout << "\tFIVE: bdlmxxx::List(originalRow, am, ba);" << endl;
        {
            bdlmxxx::List mZ(S3); const bdlmxxx::List& Z = mZ; // non-default mode
            mZ.appendDouble(A05);
            ...
            bdlmxxx::List  mL(Z.row(),     &a);  const bdlmxxx::List& L  = mL;
            bdlmxxx::List mL1(Z.row(), S1, &a1); const bdlmxxx::List& L1 = mL1;
            bdlmxxx::List mL2(Z.row(), S2, &a2); const bdlmxxx::List& L2 = mL2;
            bdlmxxx::List mL3(Z.row(), S3, &a3); const bdlmxxx::List& L3 = mL3;
            bdlmxxx::List *p = new(ma4) bdlmxxx::List(Z.row(), S4, &ma4);
            bdlmxxx::List& mL4 = *p;    const bdlmxxx::List& L4 = mL4;
            // Note that if BDEM_SUBORDINATE were the default, it would leek
            // memory, which would be reported by the bslma::TestAllocator a4.
        ...
        if (verbose) cout << "\tSIX/SEVEN: bdlmxxx::List(et, am, ba);" <<endl;
        {
            bsl::vector<bdlmxxx::ElemType::Type> TYPES;
            TYPES.push_back(bdlmxxx::ElemType::BDEM_INT);
            ...
            bdlmxxx::List  mL(TYPES,     &a);  const bdlmxxx::List& L  = mL;
            bdlmxxx::List mL1(TYPES, S1, &a1); const bdlmxxx::List& L1 = mL1;
            bdlmxxx::List mL2(TYPES, S2, &a2); const bdlmxxx::List& L2 = mL2;
            bdlmxxx::List mL3(TYPES, S3, &a3); const bdlmxxx::List& L3 = mL3;
            bdlmxxx::List *p = new(ma4) bdlmxxx::List(TYPES, S4, &ma4);
            bdlmxxx::List& mL4 = *p;    const bdlmxxx::List& L4 = mL4;
            // Note that if BDEM_SUBORDINATE were the default, it would leek
            // memory, which would be reported by the bslma::TestAllocator a4.
...
static void testCase10(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
        // --------------------------------------------------------------------
        // BDEX STREAMING
        //   Ensure that a 'bdlmxxx::List' can convert itself to/from byte stream.
        //
        // Concerns:
        //
        // Plan:
...
static void testCase9(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
        ...
        //   - That it works with a const bdlmxxx::List or const bdlmxxx::Row argument.
        ...
        //
        // Testing:
        //   bdlmxxx::List& operator=(const bdlmxxx::List& rhs);
        //   bdlmxxx::List& operator=(const bdlmxxx::Row& rhs);
        // --------------------------------------------------------------------
        ...
        if (verbose) cout << "\nVerify Allocators aren't modified." << endl;
        {
            bslma::TestAllocator a1;
            bslma::TestAllocator a2;
            bdlmxxx::List list1(&a1);
            bdlmxxx::List list2(&a2);
        ...
        if (verbose) cout << "\nVerify Strategies aren't modified." << endl;
        {
            ...
            if (verbose)
                cout << "\tCreate 4 lists where 1 is BDEM_PASS_THROUGH."
                     << endl;
            bdlmxxx::List list1(S1, &a1);   // PASS THROUGH
            bdlmxxx::List list2(S2, &a2);
            bdlmxxx::List listX(S2, &aX);
            bdlmxxx::List listY(S2, &aY);
             ...
             "\nVerify various lengths and all types are copied." << endl;
        {
            ...
            bdlmxxx::List mZ; const bdlmxxx::List& Z = mZ;
            const int LEN = 44;
            ASSERT(LEN <= L.length());
            ...
            for (int i = 0; i < LEN; ++i) {
                ...
                bdlmxxx::List x0;       // empty lists

                bdlmxxx::List x1;       // one-element lists
                x1.appendElement(L[(i + 1) % LEN]);

                bdlmxxx::List x2;       // two-element lists
                x2.appendElement(L[i]);
                x2.appendElement(L[(i + 2) % LEN]);

                if (veryVerbose) { P_(x0) P_(x1) P(x2) }

                bdlmxxx::List Y0(x0);   // Keep these as "controls".
                bdlmxxx::List Y1(x1);
                bdlmxxx::List Y2(x2);
                ...
                x1 = Y1.row();      // via a 'const bdlmxxx::Row'.
                x2 = Y2.row();
...
static void testCase8(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
        ...
        {
            const bdlmxxx::List RESULT = g("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdef", L);
            if (veryVerbose) {
        ...
        if (verbose) cout << "\tCreate a list with unset and nulls." << endl;
        {
            ...
            const bdlmxxx::List  RESULT     = g(SPEC, L);
            const char       UNSET_CHAR = '@';
            const char       NULL_CHAR  = '*';
        ...
        {
            const bdlmxxx::List RESULT = g("dAdA", L);
            if (veryVerbose) {
                cout << "\t\tRESULT: "; RESULT.print(cout, -3, 4);
            }
        ...
        {
            const bdlmxxx::List RESULT = g("JIHBCE", L);
            if (veryVerbose) {
                cout << "\t\tRESULT: "; RESULT.print(cout, -3, 4);
            }
...
static void testCase7(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
        ...
        //         applied to a const 'bdlmxxx::Row').
        ...
        //   bdlmxxx::List(const bdlmxxx::Row& original, ba);
        //
        ...
        if (verbose) cout << "\nVerify Allocators aren't copied." << endl;
        {
            ...
            bdlmxxx::List list2a(list1a, &ta2);
        ...
        if (verbose) cout << "\nVerify Strategies aren't copied." << endl;
        {
            ...
            bdlmxxx::List listAA(SA, &ta);
            bdlmxxx::List listBB(SB, &ta);
            bdlmxxx::List listCC(SC, &ta);
            ...
            bdlmxxx::List listA(listAA, SA, &taA);
            bdlmxxx::List listB(listBB, SB, &taB);
            bdlmxxx::List listC(listCC, SC, &taC);
            bdlmxxx::List listX(listBB,     &taX);         // should act like listA
             ...
             "\tVerify various lengths and all types are copied." << endl;
        {
            ...
            for (int i = 0; i < 44; ++i) {
                ...
                {
                    bdlmxxx::List mX1; const bdlmxxx::List& X1 = mX1;
                    mX1.appendElement(L[i]);
                    const bdlmxxx::List Y1(X1);
                    if (veryVerbose) P(Y1)
                    LOOP_ASSERT(i, X1 == Y1);
                }
                ...
                {
                    bdlmxxx::List mX2; const bdlmxxx::List& X2 = mX2;
                    mX2.appendElement(L[i]);
                    mX2.appendElement(L[(i + 1) % 44]);
                    const bdlmxxx::List Y2(X2);
                    if (veryVerbose) P(Y2)
                    LOOP_ASSERT(i, X2 == Y2);
                }

                // triples of elements: explicitly use const 'bdlmxxx::Row'
                {
                    bdlmxxx::List mX3; const bdlmxxx::List& X3 = mX3;
                    mX3.appendElement(L[i]);
                    mX3.appendElement(L[(i + 2) % 44]);
                    mX3.appendElement(L[(i + 4) % 44]);
                    const bdlmxxx::List Y3(X3.row());
                    if (veryVerbose) P(Y3)
...
static void testCase6(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
        ...
        //   void loadReferenceB(bdlmxxx::List *result);
        //
        //   void appendElement(const bdlmxxx::ConstElemRef& srcElement);
        //   bdlmxxx::ElemRef operator[](int index);
        //   operator==(const bdlmxxx::List& lhs, const bdlmxxx::List& rhs);
        //   operator!=(const bdlmxxx::List& lhs, const bdlmxxx::List& rhs);
        // --------------------------------------------------------------------
        ...
        bdlmxxx::List mLN; const bdlmxxx::List& LN = mLN; ASSERT(0 == LN.length());
        ...
        bdlmxxx::List mLN2; const bdlmxxx::List& LN2 = mLN2; ASSERT(0 == LN2.length());
        ...
        // single null element
        bdlmxxx::List mLN3; const bdlmxxx::List& LN3 = mLN3; ASSERT(0 == LN3.length());
        ...
        bdlmxxx::List mLB; const bdlmxxx::List& LB = mLB;  ASSERT( 0 == LB.length());
        ...
        ASSERT(1 == (bdlmxxx::List() == bdlmxxx::List()));
        ASSERT(0 == (bdlmxxx::List() != bdlmxxx::List()));
        ...
        for (i = 0; i < N_ELEM; ++i) {
            ...
            bdlmxxx::List mX; const bdlmxxx::List& X = mX;
            LOOP_ASSERT(i, 1 == (bdlmxxx::List() == X));
            LOOP_ASSERT(i, 0 == (bdlmxxx::List() != X));
            ...
            bdlmxxx::List mZ; const bdlmxxx::List& Z = mZ;
            LOOP_ASSERT(i, 1 == (bdlmxxx::List() == Z));
            LOOP_ASSERT(i, 0 == (bdlmxxx::List() != Z));
            ...
            for (int j = 0; j < N_ELEM; ++j) {
                ...
                bdlmxxx::List mY; const bdlmxxx::List& Y = mY;
                LOOP2_ASSERT(i, j, bdlmxxx::List() == Y);
        ...
        if (verbose) cout << "Append extra element to make !=." << endl;
        {
             ...
             const bdlmxxx::AggregateOption::AllocationStrategy S4 =
               ...
               bdlmxxx::List mX(S1, &a1); const bdlmxxx::List& X = mX;
               bdlmxxx::List mY(S2, &a2); const bdlmxxx::List& Y = mY;
               bdlmxxx::List mZ(S3, &a3); const bdlmxxx::List& Z = mZ;
               bdlmxxx::List *p = new(ma4) bdlmxxx::List(S4, &ma4);
               bdlmxxx::List& mW = *p;    const bdlmxxx::List& W = mW;
...
static void testCase5(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
        ...
        //   operator<<(ostream&, const bdlmxxx::List&);
        // --------------------------------------------------------------------
        ...
        const bdlmxxx::List L;
        bdlmxxx::List mL_A00; const bdlmxxx::List& L_A00 = mL_A00;
        mL_A00.appendChar(A00);
        bdlmxxx::List mL_A01; const bdlmxxx::List& L_A01 = mL_A01;
        mL_A01.appendShort(A01);
        bdlmxxx::List mL_A02; const bdlmxxx::List& L_A02 = mL_A02;
        mL_A02.appendInt(A02);
        bdlmxxx::List mL_A03; const bdlmxxx::List& L_A03 = mL_A03;
        mL_A03.appendInt64(A03);
        bdlmxxx::List mL_A04; const bdlmxxx::List& L_A04 = mL_A04;
        mL_A04.appendFloat(A04);
        bdlmxxx::List mL_A05; const bdlmxxx::List& L_A05 = mL_A05;
        mL_A05.appendDouble(A05);
        bdlmxxx::List mL_A06; const bdlmxxx::List& L_A06 = mL_A06;
        mL_A06.appendString(A06);
        bdlmxxx::List mL_A07; const bdlmxxx::List& L_A07 = mL_A07;
        mL_A07.appendDatetime(A07);
        bdlmxxx::List mL_A08; const bdlmxxx::List& L_A08 = mL_A08;
        mL_A08.appendDate(A08);
        bdlmxxx::List mL_A09; const bdlmxxx::List& L_A09 = mL_A09;
        mL_A09.appendTime(A09);

        bdlmxxx::List mL_A10; const bdlmxxx::List& L_A10 = mL_A10;
        mL_A10.appendCharArray(A10);
        bdlmxxx::List mL_A11; const bdlmxxx::List& L_A11 = mL_A11;
        mL_A11.appendShortArray(A11);
        bdlmxxx::List mL_A12; const bdlmxxx::List& L_A12 = mL_A12;
        mL_A12.appendIntArray(A12);
        bdlmxxx::List mL_A13; const bdlmxxx::List& L_A13 = mL_A13;
        mL_A13.appendInt64Array(A13);
        bdlmxxx::List mL_A14; const bdlmxxx::List& L_A14 = mL_A14;
        mL_A14.appendFloatArray(A14);
        bdlmxxx::List mL_A15; const bdlmxxx::List& L_A15 = mL_A15;
        mL_A15.appendDoubleArray(A15);
        bdlmxxx::List mL_A16; const bdlmxxx::List& L_A16 = mL_A16;
        mL_A16.appendStringArray(A16);
        bdlmxxx::List mL_A17; const bdlmxxx::List& L_A17 = mL_A17;
        mL_A17.appendDatetimeArray(A17);
        bdlmxxx::List mL_A18; const bdlmxxx::List& L_A18 = mL_A18;
        mL_A18.appendDateArray(A18);
        bdlmxxx::List mL_A19; const bdlmxxx::List& L_A19 = mL_A19;
        mL_A19.appendTimeArray(A19);

        bdlmxxx::List mL_A20; const bdlmxxx::List& L_A20 = mL_A20;
        mL_A20.appendList(A20);
        bdlmxxx::List mL_A21; const bdlmxxx::List& L_A21 = mL_A21;
        mL_A21.appendTable(A21);
        bdlmxxx::List mL_A30; const bdlmxxx::List& L_A30 = mL_A30;
        mL_A30.appendChoice(A30);
        bdlmxxx::List mL_A31; const bdlmxxx::List& L_A31 = mL_A31;
        ...
        if (verbose) cout << "\nTesting 'operator<<' (ostream)." << endl;
        {
            static const struct {
                int              d_lineNum; // source line number
                const bdlmxxx::List *d_obj_p;   // address of object to be printed
            ...
            for (int ti = 0; ti < NUM_DATA; ++ti) {
                const int LINE        =  DATA[ti].d_lineNum;
                const bdlmxxx::List& LIST = *DATA[ti].d_obj_p;
        ...
        if (verbose) cout << "\nTesting 'print'." << endl;
        {
            bdlmxxx::List mL_A02_A16; const bdlmxxx::List& L_A02_A16 = mL_A02_A16;
...
static void testCase4(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
        ...
        //   Verify the most basic functionality of a 'bdlmxxx::List'
        //
        // Concerns:
        ...
        //   void appendList(const bdlmxxx::List& value);
        //   void appendTable(const bdlmxxx::Table& value);
        //
        //   int length() const;
        //   bdlmxxx::ElemType::Type elemType(int index) const;
        //   void elemTypes(bsl::vector<bdlmxxx::ElemType::Type> *result) const;
        ...
        //   bsl::vector<bdlt::DatetimeTz>& theModifiableDatetimeTzArray(int);
        ...
        if (verbose) cout << "\nEmpty list." << endl;
        {
            const bdlmxxx::List LIST; ASSERT(0 == LIST.length());
        }

        bsl::vector<bdlmxxx::ElemType::Type> elemTypesVec;
        if (verbose) cout << "\nAll kinds of one-element list." << endl;
        {
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_BOOL == L.elemType(0));
            ASSERT(bdlmxxx::ElemType::BDEM_BOOL == elemTypesVec[0]);
        ...
        }
        {
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_CHAR == elemTypesVec[0]);
            ASSERT(A00 == L[0].theChar());
        ...
        }
        {
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_SHORT == L.elemType(0));
            ASSERT(bdlmxxx::ElemType::BDEM_SHORT == elemTypesVec[0]);
        ...
        }
        {
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_INT == L.elemType(0));
            ASSERT(bdlmxxx::ElemType::BDEM_INT == elemTypesVec[0]);
        ...
        }
        {
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_INT64 == L.elemType(0));
            ASSERT(bdlmxxx::ElemType::BDEM_INT64 == elemTypesVec[0]);
        ...
        }
        {
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_FLOAT == L.elemType(0));
            ASSERT(bdlmxxx::ElemType::BDEM_FLOAT == elemTypesVec[0]);
        ...
        }
        {
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_DOUBLE == L.elemType(0));
            ASSERT(bdlmxxx::ElemType::BDEM_DOUBLE == elemTypesVec[0]);
        ...
        }
        {
            ...
            bslma::TestAllocator ta;
            bdlmxxx::List mL(&ta); const bdlmxxx::List& L = mL;
            mL.appendString(A06); ASSERT(1 == L.length());
            L.elemTypes(&elemTypesVec);

            ASSERT(bdlmxxx::ElemType::BDEM_STRING == L.elemType(0));
            ASSERT(bdlmxxx::ElemType::BDEM_STRING == elemTypesVec[0]);
        ...
        }
        {
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_DATETIME == L.elemType(0));
            ASSERT(bdlmxxx::ElemType::BDEM_DATETIME == elemTypesVec[0]);
        ...
        }
        {
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_DATETIMETZ == L.elemType(0));
            ASSERT(bdlmxxx::ElemType::BDEM_DATETIMETZ == elemTypesVec[0]);
        ...
        }
        {
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_DATE == L.elemType(0));
            ASSERT(bdlmxxx::ElemType::BDEM_DATE == elemTypesVec[0]);
        ...
        }
        {
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_DATETZ == L.elemType(0));
            ASSERT(bdlmxxx::ElemType::BDEM_DATETZ == elemTypesVec[0]);
        ...
        }
        {
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_TIME == L.elemType(0));
            ASSERT(bdlmxxx::ElemType::BDEM_TIME == elemTypesVec[0]);
        ...
        }
        {
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_TIMETZ == L.elemType(0));
            ASSERT(bdlmxxx::ElemType::BDEM_TIMETZ == elemTypesVec[0]);
        ...
        }
        {
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_BOOL_ARRAY == L.elemType(0));
            ASSERT(bdlmxxx::ElemType::BDEM_BOOL_ARRAY == elemTypesVec[0]);
        ...
        }
        {
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_CHAR_ARRAY == L.elemType(0));
            ASSERT(bdlmxxx::ElemType::BDEM_CHAR_ARRAY == elemTypesVec[0]);
        ...
        }
        {
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_SHORT_ARRAY == L.elemType(0));
            ASSERT(bdlmxxx::ElemType::BDEM_SHORT_ARRAY == elemTypesVec[0]);
        ...
        }
        {
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_INT_ARRAY == L.elemType(0));
            ASSERT(bdlmxxx::ElemType::BDEM_INT_ARRAY == elemTypesVec[0]);
        ...
        }
        {
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_INT64_ARRAY == L.elemType(0));
            ASSERT(bdlmxxx::ElemType::BDEM_INT64_ARRAY == elemTypesVec[0]);
        ...
        }
        {
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_FLOAT_ARRAY == L.elemType(0));
            ASSERT(bdlmxxx::ElemType::BDEM_FLOAT_ARRAY == elemTypesVec[0]);
        ...
        }
        {
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_DOUBLE_ARRAY == L.elemType(0));
            ASSERT(bdlmxxx::ElemType::BDEM_DOUBLE_ARRAY == elemTypesVec[0]);
        ...
        }
        {
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_STRING_ARRAY == L.elemType(0));
            ASSERT(bdlmxxx::ElemType::BDEM_STRING_ARRAY == elemTypesVec[0]);
        ...
        }
        {
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_DATETIME_ARRAY == L.elemType(0));
            ASSERT(bdlmxxx::ElemType::BDEM_DATETIME_ARRAY == elemTypesVec[0]);
        ...
        }
        {
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_DATETIMETZ_ARRAY == L.elemType(0));
            ASSERT(bdlmxxx::ElemType::BDEM_DATETIMETZ_ARRAY == elemTypesVec[0]);
        ...
        }
        {
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_DATE_ARRAY == L.elemType(0));
            ASSERT(bdlmxxx::ElemType::BDEM_DATE_ARRAY == elemTypesVec[0]);
        ...
        }
        {
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_DATETZ_ARRAY == L.elemType(0));
            ASSERT(bdlmxxx::ElemType::BDEM_DATETZ_ARRAY == elemTypesVec[0]);
        ...
        }
        {
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_TIME_ARRAY == L.elemType(0));
            ASSERT(bdlmxxx::ElemType::BDEM_TIME_ARRAY == elemTypesVec[0]);
        ...
        }
        {
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_TIMETZ_ARRAY == L.elemType(0));
            ASSERT(bdlmxxx::ElemType::BDEM_TIMETZ_ARRAY == elemTypesVec[0]);
        ...
        }
        {
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_LIST == L.elemType(0));
            ASSERT(bdlmxxx::ElemType::BDEM_LIST == elemTypesVec[0]);
        ...
        }
        {
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_TABLE == elemTypesVec[0]);
...

        {
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_CHOICE == L.elemType(0));
            ASSERT(bdlmxxx::ElemType::BDEM_CHOICE == elemTypesVec[0]);
        ...
        }
        {
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_CHOICE_ARRAY == L.elemType(0));
            ASSERT(bdlmxxx::ElemType::BDEM_CHOICE_ARRAY == elemTypesVec[0]);
        ...
        if (verbose) cout << "\nForward List with all element types." << endl;
        {
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_SHORT == elemTypesVec[1]);
            ASSERT(A01 == L[1].theShort());
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_INT == elemTypesVec[2]);
            ASSERT(A02 == L[2].theInt());
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_INT64 == elemTypesVec[3]);
            ASSERT(A03 == L[3].theInt64());
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_FLOAT == elemTypesVec[4]);
            ASSERT(A04 == L[4].theFloat());
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_DOUBLE == elemTypesVec[5]);
            ASSERT(A05 == L[5].theDouble());
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_STRING == elemTypesVec[6]);
            ASSERT(A06 == L[6].theString());
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_DATETIME == elemTypesVec[7]);
            ASSERT(A07 == L[7].theDatetime());
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_DATE == elemTypesVec[8]);
            ASSERT(A08 == L[8].theDate());
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_TIME == elemTypesVec[9]);
            ASSERT(A09 == L[9].theTime());
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_CHAR_ARRAY == elemTypesVec[10]);
            ASSERT(A10 == L[10].theCharArray());
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_SHORT_ARRAY == elemTypesVec[11]);
            ASSERT(A11 == L[11].theShortArray());
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_INT_ARRAY == elemTypesVec[12]);
            ASSERT(A12 == L[12].theIntArray());
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_INT64_ARRAY == elemTypesVec[13]);
            ASSERT(A13 == L[13].theInt64Array());
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_FLOAT_ARRAY == elemTypesVec[14]);
            ASSERT(A14 == L[14].theFloatArray());
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_DOUBLE_ARRAY == elemTypesVec[15]);
            ASSERT(A15 == L[15].theDoubleArray());
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_STRING_ARRAY == elemTypesVec[16]);
            ASSERT(A16 == L[16].theStringArray());
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_DATETIME_ARRAY == elemTypesVec[17]);
            ASSERT(A17 == L[17].theDatetimeArray());
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_DATE_ARRAY == elemTypesVec[18]);
            ASSERT(A18 == L[18].theDateArray());
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_TIME_ARRAY == elemTypesVec[19]);
            ASSERT(A19 == L[19].theTimeArray());
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_LIST == elemTypesVec[20]);
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_TABLE == elemTypesVec[21]);
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_BOOL == elemTypesVec[22]);
            ASSERT(A22 == L[22].theBool());
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_DATETIMETZ == elemTypesVec[23]);
            ASSERT(A23 == L[23].theDatetimeTz());
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_DATETZ == elemTypesVec[24]);
            ASSERT(A24 == L[24].theDateTz());
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_TIMETZ == elemTypesVec[25]);
            ASSERT(A25 == L[25].theTimeTz());
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_BOOL_ARRAY == elemTypesVec[26]);
            ASSERT(A26 == L[26].theBoolArray());
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_DATETIMETZ_ARRAY == elemTypesVec[27]);
            ASSERT(A27 == L[27].theDatetimeTzArray());
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_DATETZ_ARRAY == elemTypesVec[28]);
            ASSERT(A28 == L[28].theDateTzArray());
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_TIMETZ_ARRAY == elemTypesVec[29]);
            ASSERT(A29 == L[29].theTimeTzArray());
            ASSERT(A29 == L.theTimeTzArray(29));
            ASSERT(A29 == mL.theModifiableTimeTzArray(29));

            if (veryVerbose) cout << "\tCHOICE " << endl;
            ASSERT(bdlmxxx::ElemType::BDEM_CHOICE == L.elemType(30));
            ASSERT(bdlmxxx::ElemType::BDEM_CHOICE == elemTypesVec[30]);
            ASSERT(A30 == L[30].theChoice());
            ASSERT(A30 == L.theChoice(30));
            ASSERT(A30 == mL.theModifiableChoice(30));

            if (veryVerbose) cout << "\tCHOICE_ARRAY" << endl;
            ASSERT(bdlmxxx::ElemType::BDEM_CHOICE_ARRAY == L.elemType(31));
            ASSERT(bdlmxxx::ElemType::BDEM_CHOICE_ARRAY == elemTypesVec[31]);
            ASSERT(A31 == L[31].theChoiceArray());
        ...
        if (verbose) cout << "\nBackward List with all element types." << endl;
        {
            ...
            if (veryVerbose) cout << "\tCHAR" << endl;
            ASSERT(bdlmxxx::ElemType::BDEM_CHAR == L.elemType(31 - 0));
            ASSERT(bdlmxxx::ElemType::BDEM_CHAR == elemTypesVec[31 - 0]);
            ASSERT(A00 == L[31 - 0].theChar());
            ASSERT(A00 == L.theChar(31 - 0));
            ASSERT(A00 == mL.theModifiableChar(31 - 0));

            if (veryVerbose) cout << "\tSHORT" << endl;
            ASSERT(bdlmxxx::ElemType::BDEM_SHORT == L.elemType(31 - 1));
            ASSERT(bdlmxxx::ElemType::BDEM_SHORT == elemTypesVec[31 - 1]);
            ASSERT(A01 == L[31 - 1].theShort());
            ASSERT(A01 == L.theShort(31 - 1));
            ASSERT(A01 == mL.theModifiableShort(31 - 1));

            if (veryVerbose) cout << "\tINT" << endl;
            ASSERT(bdlmxxx::ElemType::BDEM_INT == L.elemType(31 - 2));
            ASSERT(bdlmxxx::ElemType::BDEM_INT == elemTypesVec[31 - 2]);
            ASSERT(A02 == L[31 - 2].theInt());
            ASSERT(A02 == L.theInt(31 - 2));
            ASSERT(A02 == mL.theModifiableInt(31 - 2));

            if (veryVerbose) cout << "\tINT64" << endl;
            ASSERT(bdlmxxx::ElemType::BDEM_INT64 == L.elemType(31 - 3));
            ASSERT(bdlmxxx::ElemType::BDEM_INT64 == elemTypesVec[31 - 3]);
            ASSERT(A03 == L[31 - 3].theInt64());
            ASSERT(A03 == L.theInt64(31 - 3));
            ASSERT(A03 == mL.theModifiableInt64(31 - 3));

            if (veryVerbose) cout << "\tFLOAT" << endl;
            ASSERT(bdlmxxx::ElemType::BDEM_FLOAT == L.elemType(31 - 4));
            ASSERT(bdlmxxx::ElemType::BDEM_FLOAT == elemTypesVec[31 - 4]);
            ASSERT(A04 == L[31 - 4].theFloat());
            ASSERT(A04 == L.theFloat(31 - 4));
            ASSERT(A04 == mL.theModifiableFloat(31 - 4));

            if (veryVerbose) cout << "\tDOUBLE" << endl;
            ASSERT(bdlmxxx::ElemType::BDEM_DOUBLE == L.elemType(31 - 5));
            ASSERT(bdlmxxx::ElemType::BDEM_DOUBLE == elemTypesVec[31 - 5]);
            ASSERT(A05 == L[31 - 5].theDouble());
            ASSERT(A05 == L.theDouble(31 - 5));
            ASSERT(A05 == mL.theModifiableDouble(31 - 5));

            if (veryVerbose) cout << "\tSTRING" << endl;
            ASSERT(bdlmxxx::ElemType::BDEM_STRING == L.elemType(31 - 6));
            ASSERT(bdlmxxx::ElemType::BDEM_STRING == elemTypesVec[31 - 6]);
            ASSERT(A06 == L[31 - 6].theString());
            ASSERT(A06 == L.theString(31 - 6));
            ASSERT(A06 == mL.theModifiableString(31 - 6));

            if (veryVerbose) cout << "\tDATETIME" << endl;
            ASSERT(bdlmxxx::ElemType::BDEM_DATETIME == L.elemType(31 - 7));
            ASSERT(bdlmxxx::ElemType::BDEM_DATETIME == elemTypesVec[31 - 7]);
            ASSERT(A07 == L[31 - 7].theDatetime());
            ASSERT(A07 == L.theDatetime(31 - 7));
            ASSERT(A07 == mL.theModifiableDatetime(31 - 7));

            if (veryVerbose) cout << "\tDATE" << endl;
            ASSERT(bdlmxxx::ElemType::BDEM_DATE == L.elemType(31 - 8));
            ASSERT(bdlmxxx::ElemType::BDEM_DATE == elemTypesVec[31 - 8]);
            ASSERT(A08 == L[31 - 8].theDate());
            ASSERT(A08 == L.theDate(31 - 8));
            ASSERT(A08 == mL.theModifiableDate(31 - 8));

            if (veryVerbose) cout << "\tTIME" << endl;
            ASSERT(bdlmxxx::ElemType::BDEM_TIME == L.elemType(31 - 9));
            ASSERT(bdlmxxx::ElemType::BDEM_TIME == elemTypesVec[31 - 9]);
            ASSERT(A09 == L[31 - 9].theTime());
            ASSERT(A09 == L.theTime(31 - 9));
            ASSERT(A09 == mL.theModifiableTime(31 - 9));

            if (veryVerbose) cout << "\tCHAR_ARRAY" << endl;
            ASSERT(bdlmxxx::ElemType::BDEM_CHAR_ARRAY == L.elemType(31 - 10));
            ASSERT(bdlmxxx::ElemType::BDEM_CHAR_ARRAY == elemTypesVec[31 - 10]);
            ASSERT(A10 == L[31 - 10].theCharArray());
            ASSERT(A10 == L.theCharArray(31 - 10));
            ASSERT(A10 == mL.theModifiableCharArray(31 - 10));

            if (veryVerbose) cout << "\tSHORT_ARRAY" << endl;
            ASSERT(bdlmxxx::ElemType::BDEM_SHORT_ARRAY == L.elemType(31 - 11));
            ASSERT(bdlmxxx::ElemType::BDEM_SHORT_ARRAY == elemTypesVec[31 - 11]);
            ASSERT(A11 == L[31 - 11].theShortArray());
            ASSERT(A11 == L.theShortArray(31 - 11));
            ASSERT(A11 == mL.theModifiableShortArray(31 - 11));

            if (veryVerbose) cout << "\tINT_ARRAY" << endl;
            ASSERT(bdlmxxx::ElemType::BDEM_INT_ARRAY == L.elemType(31 - 12));
            ASSERT(bdlmxxx::ElemType::BDEM_INT_ARRAY == elemTypesVec[31 - 12]);
            ASSERT(A12 == L[31 - 12].theIntArray());
            ASSERT(A12 == L.theIntArray(31 - 12));
            ASSERT(A12 == mL.theModifiableIntArray(31 - 12));

            if (veryVerbose) cout << "\tINT64_ARRAY" << endl;
            ASSERT(bdlmxxx::ElemType::BDEM_INT64_ARRAY == L.elemType(31 - 13));
            ASSERT(bdlmxxx::ElemType::BDEM_INT64_ARRAY == elemTypesVec[31 - 13]);
            ASSERT(A13 == L[31 - 13].theInt64Array());
            ASSERT(A13 == L.theInt64Array(31 - 13));
            ASSERT(A13 == mL.theModifiableInt64Array(31 - 13));

            if (veryVerbose) cout << "\tFLOAT_ARRAY" << endl;
            ASSERT(bdlmxxx::ElemType::BDEM_FLOAT_ARRAY == L.elemType(31 - 14));
            ASSERT(bdlmxxx::ElemType::BDEM_FLOAT_ARRAY == elemTypesVec[31 - 14]);
            ASSERT(A14 == L[31 - 14].theFloatArray());
            ASSERT(A14 == L.theFloatArray(31 - 14));
            ASSERT(A14 == mL.theModifiableFloatArray(31 - 14));

            if (veryVerbose) cout << "\tDOUBLE_ARRAY" << endl;
            ASSERT(bdlmxxx::ElemType::BDEM_DOUBLE_ARRAY == L.elemType(31 - 15));
            ASSERT(bdlmxxx::ElemType::BDEM_DOUBLE_ARRAY == elemTypesVec[31 - 15]);
            ASSERT(A15 == L[31 - 15].theDoubleArray());
            ASSERT(A15 == L.theDoubleArray(31 - 15));
            ASSERT(A15 == mL.theModifiableDoubleArray(31 - 15));

            if (veryVerbose) cout << "\tSTRING_ARRAY" << endl;
            ASSERT(bdlmxxx::ElemType::BDEM_STRING_ARRAY == L.elemType(31 - 16));
            ASSERT(bdlmxxx::ElemType::BDEM_STRING_ARRAY == elemTypesVec[31 - 16]);
            ASSERT(A16 == L[31 - 16].theStringArray());
            ASSERT(A16 == L.theStringArray(31 - 16));
            ASSERT(A16 == mL.theModifiableStringArray(31 - 16));

            if (veryVerbose) cout << "\tDATETIME_ARRAY" << endl;
            ASSERT(bdlmxxx::ElemType::BDEM_DATETIME_ARRAY == L.elemType(31 - 17));
            ASSERT(bdlmxxx::ElemType::BDEM_DATETIME_ARRAY ==
                                                        elemTypesVec[31 - 17]);
            ...
            if (veryVerbose) cout << "\tDATE_ARRAY" << endl;
            ASSERT(bdlmxxx::ElemType::BDEM_DATE_ARRAY == L.elemType(31 - 18));
            ASSERT(bdlmxxx::ElemType::BDEM_DATE_ARRAY == elemTypesVec[31 - 18]);
            ASSERT(A18 == L[31 - 18].theDateArray());
            ASSERT(A18 == L.theDateArray(31 - 18));
            ASSERT(A18 == mL.theModifiableDateArray(31 - 18));

            if (veryVerbose) cout << "\tTIME_ARRAY" << endl;
            ASSERT(bdlmxxx::ElemType::BDEM_TIME_ARRAY == L.elemType(31 - 19));
            ASSERT(bdlmxxx::ElemType::BDEM_TIME_ARRAY == elemTypesVec[31 - 19]);
            ASSERT(A19 == L[31 - 19].theTimeArray());
            ASSERT(A19 == L.theTimeArray(31 - 19));
            ASSERT(A19 == mL.theModifiableTimeArray(31 - 19));

            if (veryVerbose) cout << "\tLIST" << endl;
            ASSERT(bdlmxxx::ElemType::BDEM_LIST == L.elemType(31 - 20));
            ASSERT(bdlmxxx::ElemType::BDEM_LIST == elemTypesVec[31 - 20]);
            ASSERT(A20 == L[31 - 20].theList());
            ASSERT(A20 == L.theList(31 - 20));
            ASSERT(A20 == mL.theModifiableList(31 - 20));

            if (veryVerbose) cout << "\tTABLE" << endl;
            ASSERT(bdlmxxx::ElemType::BDEM_TABLE == L.elemType(31 - 21));
            ASSERT(bdlmxxx::ElemType::BDEM_TABLE == elemTypesVec[31 - 21]);
            ...
            if (veryVerbose) cout << "\tBOOL" << endl;
            L.elemTypes(&elemTypesVec);
            ASSERT(bdlmxxx::ElemType::BDEM_BOOL == L.elemType(31 - 22));
            ASSERT(bdlmxxx::ElemType::BDEM_BOOL == elemTypesVec[31 - 22]);
            ASSERT(A22 == L[31 - 22].theBool());
            ASSERT(A22 == L.theBool(31 - 22));
            ASSERT(A22 == mL.theModifiableBool(31 - 22));

            if (veryVerbose) cout << "\tDATETIMETZ" << endl;
            ASSERT(bdlmxxx::ElemType::BDEM_DATETIMETZ == L.elemType(31 - 23));
            ASSERT(bdlmxxx::ElemType::BDEM_DATETIMETZ == elemTypesVec[31 - 23]);
            ASSERT(A23 == L[31 - 23].theDatetimeTz());
            ASSERT(A23 == L.theDatetimeTz(31 - 23));
            ASSERT(A23 == mL.theModifiableDatetimeTz(31 - 23));

            if (veryVerbose) cout << "\tDATETZ" << endl;
            ASSERT(bdlmxxx::ElemType::BDEM_DATETZ == L.elemType(31 - 24));
            ASSERT(bdlmxxx::ElemType::BDEM_DATETZ == elemTypesVec[31 - 24]);
            ASSERT(A24 == L[31 - 24].theDateTz());
            ASSERT(A24 == L.theDateTz(31 - 24));
            ASSERT(A24 == mL.theModifiableDateTz(31 - 24));

            if (veryVerbose) cout << "\tTIMETZ" << endl;
            ASSERT(bdlmxxx::ElemType::BDEM_TIMETZ == L.elemType(31 - 25));
            ASSERT(bdlmxxx::ElemType::BDEM_TIMETZ == elemTypesVec[31 - 25]);
            ASSERT(A25 == L[31 - 25].theTimeTz());
            ASSERT(A25 == L.theTimeTz(31 - 25));
            ASSERT(A25 == mL.theModifiableTimeTz(31 - 25));

            if (veryVerbose) cout << "\tBOOL_ARRAY" << endl;
            ASSERT(bdlmxxx::ElemType::BDEM_BOOL_ARRAY == L.elemType(31 - 26));
            ASSERT(bdlmxxx::ElemType::BDEM_BOOL_ARRAY == elemTypesVec[31 - 26]);
            ASSERT(A26 == L[31 - 26].theBoolArray());
            ASSERT(A26 == L.theBoolArray(31 - 26));
            ASSERT(A26 == mL.theModifiableBoolArray(31 - 26));

            if (veryVerbose) cout << "\tDATETIMETZ_ARRAY" << endl;
            ASSERT(bdlmxxx::ElemType::BDEM_DATETIMETZ_ARRAY ==
                                                          L.elemType(31 - 27));
            ASSERT(bdlmxxx::ElemType::BDEM_DATETIMETZ_ARRAY ==
                                                        elemTypesVec[31 - 27]);
            ...
            if (veryVerbose) cout << "\tDATETZ_ARRAY" << endl;
            ASSERT(bdlmxxx::ElemType::BDEM_DATETZ_ARRAY == L.elemType(31 - 28));
            ASSERT(bdlmxxx::ElemType::BDEM_DATETZ_ARRAY == elemTypesVec[31 - 28]);
            ASSERT(A28 == L[31 - 28].theDateTzArray());
            ASSERT(A28 == L.theDateTzArray(31 - 28));
            ASSERT(A28 == mL.theModifiableDateTzArray(31 - 28));

            if (veryVerbose) cout << "\tTIMETZ_ARRAY" << endl;
            ASSERT(bdlmxxx::ElemType::BDEM_TIMETZ_ARRAY == L.elemType(31 - 29));
            ASSERT(bdlmxxx::ElemType::BDEM_TIMETZ_ARRAY == elemTypesVec[31 - 29]);
            ASSERT(A29 == L[31 - 29].theTimeTzArray());
            ASSERT(A29 == L.theTimeTzArray(31 - 29));
            ASSERT(A29 == mL.theModifiableTimeTzArray(31 - 29));

            if (veryVerbose) cout << "\tCHOICE " << endl;
            ASSERT(bdlmxxx::ElemType::BDEM_CHOICE == L.elemType(31 - 30));
            ASSERT(bdlmxxx::ElemType::BDEM_CHOICE == elemTypesVec[31 - 30]);
            ASSERT(A30 == L[31 - 30].theChoice());
            ASSERT(A30 == L.theChoice(31 - 30));
            ASSERT(A30 == mL.theModifiableChoice(31 - 30));

            if (veryVerbose) cout << "\tCHOICE_ARRAY" << endl;
            ASSERT(bdlmxxx::ElemType::BDEM_CHOICE_ARRAY == L.elemType(31 - 31));
            ASSERT(bdlmxxx::ElemType::BDEM_CHOICE_ARRAY == elemTypesVec[31 - 31]);
...
static void testCase3(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
        ...
        //      no effect on an existing 'bdlmxxx::List' object.
        ...
        //
        // Testing:
        //   bdlmxxx::List(bslma::Allocator *basicAllocator = 0);
        //
        // --------------------------------------------------------------------
        ...
        bslma::TestAllocator aX, aA, aB, aC, aD;
        {
            ...
            bdlmxxx::List listX(                                         &aX);
            bdlmxxx::List listA(bdlmxxx::AggregateOption::BDEM_PASS_THROUGH, &aA);
            bdlmxxx::List listB(bdlmxxx::AggregateOption::BDEM_WRITE_ONCE,   &aB);
            bdlmxxx::List listC(bdlmxxx::AggregateOption::BDEM_WRITE_MANY,   &aC);
            //bdlmxxx::List listD(bdlmxxx::AggregateOption::BDEM_SUBORDINATE,&aD);
            bdlmxxx::List listD(bdlmxxx::AggregateOption::BDEM_WRITE_MANY,   &aD);
                                                                      // dummy
...
static void testCase2(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
        ...
        //   - That '==' and !=' for 'bdlmxxx::List' work as expected (and
        ...
        ASSERT(1 == bdltuxxx::Unset<char>::isUnset(N00));
        ASSERT(1 == bdltuxxx::Unset<short>::isUnset(N01));
        ASSERT(1 == bdltuxxx::Unset<int>::isUnset(N02));
        ASSERT(1 == bdltuxxx::Unset<bsls::Types::Int64>::isUnset(N03));
        ASSERT(1 == bdltuxxx::Unset<float>::isUnset(N04));
        ASSERT(1 == bdltuxxx::Unset<double>::isUnset(N05));
        ASSERT(1 == bdltuxxx::Unset<bsl::string>::isUnset(N06));
        ASSERT(1 == bdltuxxx::Unset<bdlt::Datetime>::isUnset(N07));
        ASSERT(1 == bdltuxxx::Unset<bdlt::Date>::isUnset(N08));
        ASSERT(1 == bdltuxxx::Unset<bdlt::Time>::isUnset(N09));

        ASSERT(1 == bdltuxxx::Unset<bool>::isUnset(N22));
        ASSERT(1 == bdltuxxx::Unset<bdlt::DatetimeTz>::isUnset(N23));
        ASSERT(1 == bdltuxxx::Unset<bdlt::DateTz>::isUnset(N24));
        ASSERT(1 == bdltuxxx::Unset<bdlt::TimeTz>::isUnset(N25));
        ...
        ASSERT(4 == A20.length());
        ASSERT(bdlmxxx::ElemType::BDEM_INT == A20.elemType(0));
                                        ASSERT(A02 == A20[0].theInt());
        ASSERT(bdlmxxx::ElemType::BDEM_DOUBLE == A20.elemType(1));
                                        ASSERT(A05 == A20[1].theDouble());
        ASSERT(bdlmxxx::ElemType::BDEM_STRING == A20.elemType(2));
                                        ASSERT(A06 == A20[2].theString());
        ASSERT(bdlmxxx::ElemType::BDEM_STRING_ARRAY == A20.elemType(3));
                                        ASSERT(A16 == A20[3].theStringArray());
        ASSERT(4 == B20.length());
        ASSERT(bdlmxxx::ElemType::BDEM_INT == B20.elemType(0));
                                        ASSERT(B02 == B20[0].theInt());
        ASSERT(bdlmxxx::ElemType::BDEM_DOUBLE == B20.elemType(1));
                                        ASSERT(B05 == B20[1].theDouble());
        ASSERT(bdlmxxx::ElemType::BDEM_STRING == B20.elemType(2));
                                        ASSERT(B06 == B20[2].theString());
        ASSERT(bdlmxxx::ElemType::BDEM_STRING_ARRAY == B20.elemType(3));
...
static void testCase1(bool verbose, bool veryVerbose, bool veryVeryVerbose) {
        ...
        //   - Ensure we can create and use a simplified *dummy* 'bdlmxxx::Table'.
        ...
        if (verbose) cout << "\tSizeof bdlmxxx::List :"
                          << sizeof(bdlmxxx::List) << bsl::endl;
            ...
            "\nExercise append, length, elemType, op[], and printing." << endl;
        {
            ...
            ASSERT(2 == L.length());
            ASSERT(bdlmxxx::ElemType::BDEM_INT == L.elemType(0));
            ASSERT(bdlmxxx::ElemType::BDEM_DOUBLE == L.elemType(1));
            ASSERT(123 == L[0].theInt());
            ASSERT(123 == L.theInt(0));
            ...
            ASSERT(bdlmxxx::ElemType::BDEM_INT == L.elemType(0));
            ASSERT(bdlmxxx::ElemType::BDEM_DOUBLE == L.elemType(1));
            ASSERT(bdlmxxx::ElemType::BDEM_STRING == L.elemType(2));
            ASSERT(123 == L[0].theInt());
        ...
        if (verbose) cout << "\tElement Type: LIST { INT }" << endl;
        {
            ...
            if (verbose) cout << "\t\tAppend a bdlmxxx::List{int} to list." <<endl;
            ...
            "\nThe following used to dump core on an old Cygwin." << endl;
        {
            ...
            const bdlmxxx::AggregateOption::AllocationStrategy S =
                // bdlmxxx::AggregateOption::BDEM_PASS_THROUGH; // was no leak with
                                                            // this
                bdlmxxx::AggregateOption::BDEM_WRITE_ONCE;      // this caused a
                                                            // leak
                // bdlmxxx::AggregateOption::BDEM_WRITE_MANY;   // this caused a
                                                            // leak
