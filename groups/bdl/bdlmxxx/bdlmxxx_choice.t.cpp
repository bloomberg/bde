...
//                             TEST PLAN
//-----------------------------------------------------------------------------
// Although 'bdlmxxx::Choice' is a fully value-semantic class, all of the
// substantive implementation resides in 'bdlmxxx::ChoiceImp', which in turn
...
//
// CREATORS
// [10] bdlmxxx::Choice(bslma::Allocator *alloc = 0);
// [10] bdlmxxx::Choice(AggOptionAllocationStrategy  mode,
//                  bslma::Allocator            *alloc = 0);
// [10] bdlmxxx::Choice(const bdlmxxx::ElemType::Type    typesCatalog[],
//                  int                          typesCatalogLen,
//                  bslma::Allocator            *alloc = 0);
// [10] bdlmxxx::Choice(const bdlmxxx::ElemType::Type    typesCatalog[],
//                  int                          typesCatalogLen,
...
//                  bslma::Allocator            *alloc = 0);
// [10] bdlmxxx::Choice(const TypesCatalog&          typesCatalog,
//                  bslma::Allocator            *alloc = 0);
// [10] bdlmxxx::Choice(const TypesCatalog&          typesCatalog,
//                  AggOptionAllocationStrategy  allocMode,
//                  bslma::Allocator            *alloc = 0);
// [ 6] bdlmxxx::Choice(const bdlmxxx::Choice&           original,
//                  bslma::Allocator            *alloc = 0);
// [ 6] bdlmxxx::Choice(const bdlmxxx::Choice&           original,
//                  AggOptionAllocationStrategy  allocMode,
//                  bslma::Allocator            *alloc = 0);
// [ 6] bdlmxxx::Choice(const bdlmxxx::ChoiceArrayItem&  original,
//                  bslma::Allocator            *alloc = 0);
// [ 6] bdlmxxx::Choice(const bdlmxxx::ChoiceArrayItem&  original,
//                  AggOptionAllocationStrategy  allocMode,
//                  bslma::Allocator            *alloc = 0);
...
//
// MANIPULATORS
// [ 7] bdlmxxx::Choice& operator=(const bdlmxxx::ChoiceArrayItem& rhs);
// [ 7] bdlmxxx::Choice& operator=(const bdlmxxx::Choice& rhs);
// [ 3] bdlmxxx::ChoiceArrayItem& item();
// [ 3] bdlmxxx::ElemRef makeSelection(int index)
// [ 3] bdlmxxx::ElemRef selection()
// [12] bool& theBool();
// [12] char& theChar();
// [12] short& theShort();
// [12] int& theInt();
...
// [12] bdlt::Datetime& theDatetime();
// [12] bdlt::DatetimeTz& theDatetimeTz();
// [12] bdlt::Date& theDate();
// [12] bdlt::DateTz& theDateTz();
// [12] bdlt::Time& theTime();
// [12] bdlt::TimeTz& theTimeTz();
...
// [12] bsl::vector<bdlt::Datetime>& theDatetimeArray();
// [12] bsl::vector<bdlt::DatetimeTz>& theDatetimeTzArray();
// [12] bsl::vector<bdlt::Date>& theDateArray();
// [12] bsl::vector<bdlt::DateTz>& theDateTzArray();
// [12] bsl::vector<bdlt::Time>& theTimeArray();
// [12] bsl::vector<bdlt::TimeTz>& theTimeTzArray();
// [12] bdlmxxx::List& theList();
// [12] bdlmxxx::Table& theTable();
// [12] bdlmxxx::Choice& theChoice();
// [12] bdlmxxx::ChoiceArray& theChoiceArray();
...
// [ 9] void addSelection(bdlmxxx::ElemType::Type elemType);
// [11] void reset();
// [11] void reset(const bdlmxxx::ElemType::Type typesCatalog[],
//                 int                       typesCatalogLen);
// [11] void reset(const bsl::vector<bdlmxxx::ElemType::Type>& typesCatalog);
// [ 8] STREAM& bdexStreamIn(STREAM& stream, int version)
//
// ACCESSORS
// [ 3] int numSelections() const
// [ 3] int selector() const
// [ 3] const bdlmxxx::ChoiceArrayItem& item() const;
// [ 3] bdlmxxx::ElemType::Type selectionType() const
// [ 3] bdlmxxx::ElemType::Type selectionType(int index) const
// [ 3] void selectionTypes(bsl::vector<bdlmxxx::ElemType::Type> *result) const
// [ 3] bdlmxxx::ConstElemRef selection() const
...
// [12]  const bdlt::Datetime& theDatetime() const;
// [12]  const bdlt::DatetimeTz& theDatetimeTz() const;
// [12]  const bdlt::Date& theDate() const;
// [12]  const bdlt::DateTz& theDateTz() const;
// [12]  const bdlt::Time& theTime() const;
// [12]  const bdlt::TimeTz& theTimeTz() const;
...
// [12]  const bsl::vector<bdlt::Datetime>& theDatetimeArray() const;
// [12]  const bsl::vector<bdlt::DatetimeTz>& theDatetimeTzArray() const;
// [12]  const bsl::vector<bdlt::Date>& theDateArray() const;
// [12]  const bsl::vector<bdlt::DateTz>& theDateTzArray() const;
// [12]  const bsl::vector<bdlt::Time>& theTimeArray() const;
// [12]  const bsl::vector<bdlt::TimeTz>& theTimeTzArray() const;
// [12]  const bdlmxxx::List& theList() const;
// [12]  const bdlmxxx::Table& theTable() const;
// [12]  const bdlmxxx::Choice& theChoice() const;
// [12]  const bdlmxxx::ChoiceArray& theChoiceArray() const;
// [ 8] STREAM& bdexStreamOut(STREAM& stream, int version) const
// [ 4] bsl::ostream& print(bsl::ostream& stream,
//                          int           level = 0,
//                          int           spacesPerLevel = 4) const;
// FREE OPERATORS
// [ 5] bool operator==(const bdlmxxx::Choice& lhs, const bdlmxxx::Choice& rhs);
// [ 5] bool operator!=(const bdlmxxx::Choice& lhs, const bdlmxxx::Choice& rhs);
// [ 4] bsl::ostream& operator<<(bsl::ostream& stream, const bdlmxxx::Choice& rhs);
//
// [ 1] BREATHING TEST
// [ 2] TEST APPARATUS
// [15] USAGE EXAMPLE
...
typedef bdlmxxx::Choice              Obj;

typedef bdlmxxx::ChoiceArrayItem     ChoiceArrayItem;
...
class ChoiceArray {
  ...
  public:
    // CREATORS
    ChoiceArray();
    ChoiceArray(const EType::Type types[], int numTypes);
...
class RowRef {
    // This class is a dummy Row class to facilitate testing
    // Note that it contains only the functions called in this test driver
...
class Table {
  ...
  public:
    // CREATORS
    Table();
    Table(const EType::Type types[], int numTypes);
    Table(const Table& original);

    // MANIPULATORS
    void appendNullRow();
    RowRef operator[](int index);
};
...
ChoiceArray::ChoiceArray(const EType::Type types[], int numTypes)
...
List::List()
: d_listImp(AggregateOption::BDEM_PASS_THROUGH)
{
}

List::List(const List&  original)
: d_listImp((const ListImp &) original,
            AggregateOption::BDEM_PASS_THROUGH)
{
}
...
RowRef::RowRef(RowData *row)
: d_rowImp(row)
{
}

RowRef::RowRef(const RowRef& original)
: d_rowImp(original.d_rowImp)
{
}

ElemRef RowRef::operator[](int index)
{
...
Table::Table(const EType::Type types[], int numTypes)
: d_tableImp(types,
             numTypes,
             ElemAttrLookup::lookupTable(),
             AggregateOption::BDEM_PASS_THROUGH)
...
RowRef Table::operator[](int index)
{
    return RowRef(&d_tableImp.theModifiableRow(index));
}
}  // close package namespace
...
// a 'bdlmxxx::Choice' which can store either a 'double' or a 'string'.  The
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      case 15: {
        ...
        // Scenario 1
        {
            ...
            bdlxxxx::ByteInStream input(out.data(), out.length());
        ...
        // Scenario 2
        {
            ...
            bdlxxxx::ByteInStream  in(output.data(), output.length());
            bdlxxxx::ByteOutStream out;
            divide(in, out);
      ...
      case 12: {
        ...
        //   vector<bdlt::Datetime>& theDatetimeArray() const;
        //   vector<bdlt::Date>& theDateArray() const;
        //   vector<bdlt::Time>& theTimeArray() const;
        //   bdlmxxx::List& theList() const;
        //   bdlmxxx::Table& theTable() const;
        //   bdlmxxx::Choice& theChoice() const;
        //   bdlmxxx::ChoiceArray& theChoiceArray() const;
        // --------------------------------------------------------------------
      ...
      case 11: {
        ...
        // Testing:
        //   void reset();
        //   void reset(const bdlmxxx::ElemType::Type typesCatalog[],
        //              int                       typesCatalogLen);
      ...
      case 10: {
        ...
        //
        // Testing:
        //   bdlmxxx::Choice(bslma::Allocator              *alloc = 0);
        //   bdlmxxx::Choice(AggOption::AllocationStrategy  allocMode,
        //               bslma::Allocator              *alloc = 0);
        //   bdlmxxx::Choice(const bdlmxxx::ElemType::Type      typesCatalog[],
        //               int                            typesCatalogLen,
        //               bslma::Allocator              *alloc = 0);
        //   bdlmxxx::Choice(const bdlmxxx::ElemType::Type      typesCatalog[],
        //               int                            typesCatalogLen,
        ...
        //               bslma::Allocator              *alloc = 0);
        //   bdlmxxx::Choice(const TypesCatalog&            typesCatalog,
        //               bslma::Allocator              *alloc = 0);
        //   bdlmxxx::Choice(const TypesCatalog&            typesCatalog,
        //               AggOption::AllocationStrategy  allocMode,
        //               bslma::Allocator              *alloc = 0);
        //   bdlmxxx::Choice(const bdlmxxx::ChoiceArrayItem&    original,
        //               bslma::Allocator              *alloc = 0);
        //   bdlmxxx::Choice(const bdlmxxx::ChoiceArrayItem&    original,
        //               AggOption::AllocationStrategy  allocMode,
        //               bslma::Allocator              *alloc = 0);
      ...
      case 8: {
        ...
        //   configure the 'bdlxxxx::TestInStream' object appropriately in a
        //   loop.
        ...
        for (int VERSION = 1; VERSION <= MAX_VERSION; ++VERSION) {
            for (int i1 = 0; i1 < NUM_DATA; ++i1) {
                ...
                for (int j1 = 0; j1 < LEN1; ++j1) {
                    ...
                    bdlxxxx::TestOutStream os3;
                    bdlxxxx::TestOutStream os4;
                    ...
                    // Stream a constructed obj to an empty obj.
                    {
                        ...
                        bdlxxxx::TestInStream is2(os2.data(), os2.length());
                        bdlxxxx::TestInStream is3(os3.data(), os3.length());
                        bdlxxxx::TestInStream is4(os4.data(), os4.length());
                    ...
                    for (int i2 = 0; i2 < NUM_DATA; ++i2) {
                        ...
                        for (int j2 = 0; j2 < LEN2; ++j2) {
                            ...
                            BSLMA_TESTALLOCATOR_EXCEPTION_TEST_BEGIN(
                                ...
                                bdlxxxx::TestInStream is1(os1.data(),
                                                      os1.length());
                                bdlxxxx::TestInStream is2(os2.data(),
                                                      os2.length());
                                bdlxxxx::TestInStream is3(os3.data(),
                                                      os3.length());
                                bdlxxxx::TestInStream is4(os4.data(),
                                                      os4.length());
                    ...
                    // Stream from an empty and invalid stream.
                    {
                        ...
                        bdlxxxx::TestInStream is3;  // empty stream
                        bdlxxxx::TestInStream is4;  // empty stream
                        ...
                        bdlxxxx::TestInStream is5(os2.data(), os2.length());
                        is5.invalidate();  // invalid stream
                        bdlxxxx::TestInStream is6(os2.data(), os2.length());
                        is6.invalidate();  // invalid stream
                        bdlxxxx::TestInStream is7(os2.data(), os2.length());
                        is7.invalidate();  // invalid stream
                        bdlxxxx::TestInStream is8(os2.data(), os2.length());
      ...
      case 7: {
        ...
        //
        // Testing:
        //   bdlmxxx::Choice& operator=(const bdlmxxx::Choice& rhs);
        //   bdlmxxx::Choice& operator=(const bdlmxxx::ChoiceArrayItem& rhs);
        // --------------------------------------------------------------------
...
#undef IN
      ...
      case 6: {
        ...
        //
        // Testing:
        //   bdlmxxx::Choice(const bdlmxxx::Choice& original, alloc = 0);
        //   bdlmxxx::Choice(const bdlmxxx::Choice& original, allocMode, alloc = 0);
        //   bdlmxxx::Choice(const Item& item, alloc = 0);
        //   bdlmxxx::Choice(const Item& item, allocMode, alloc = 0);
        // --------------------------------------------------------------------
      ...
      case 5: {
        ...
        //
        // Testing:
        //   operator==(const bdlmxxx::Choice&, const bdlmxxx::Choice&);
        //   operator!=(const bdlmxxx::Choice&, const bdlmxxx::Choice&);
        // --------------------------------------------------------------------
      ...
      case 4: {
        ...
        //                       int           level = 0,
        //                       int           spacesPerLevel = 4) const;
        //   operator<<(ostream&, const bdlmxxx::Choice&);
        // --------------------------------------------------------------------
      ...
      case 3: {
        ...
        //
        // Concerns:
        //   We are able to create a 'bdlmxxx::Choice' object and put it into
        //   any legal state.  We are not concerned in this test about trying
        //   to move the object from one state to another.
        //
        // Plan:
        //   A 'bdlmxxx::Choice' object can be put into any state using the
        ...
        //
        // Testing:
        //   bdlmxxx::Choice(const vector<EType::Type>&  typesCatalog,
        //               bslma::Allocator           *basicAlloc = 0);
        //   ~bdlmxxx::Choice();
        //   bdlmxxx::ElemRef  makeSelection(int index);
        //   bdlmxxx::ChoiceArrayItem& item();
        //   bdlmxxx::ElemRef& selection();
          ...
          for (int i = 0; i < NUM_DATA; ++i) {
            ...
            BSLMA_TESTALLOCATOR_EXCEPTION_TEST_BEGIN(testAllocator) {
              ...
              for (int j = 0; j < LEN; ++j) {
                ...
                bdlmxxx::ElemRef elem = mX.makeSelection(j);
                LOOP_ASSERT(S, CATALOG.size() == (unsigned) X.numSelections());
                LOOP_ASSERT(S, j     == X.selector());
                LOOP_ASSERT(S, TYPE  == X.selectionType());
                LOOP_ASSERT(S, TYPE  == X.selectionType(j));
      ...
      case 2: {
            ...
            bsl::cout << "\nTesting 'getValueA'." << bsl::endl;
        {
            ...
            ASSERT(A20   == *(bdlmxxx::List *) getValueA(SPEC[20]));
            ASSERT(A21   == *(bdlmxxx::Table *) getValueA(SPEC[21]));
            ...
            ASSERT(A30   == *(bdlmxxx::Choice *) getValueA(SPEC[30]));
            ASSERT(A31   == *(bdlmxxx::ChoiceArray *) getValueA(SPEC[31]));
        }
            ...
            bsl::cout << "\nTesting 'getValueB'." << bsl::endl;
        {
            ...
            ASSERT(B20   == *(bdlmxxx::List *) getValueB(SPEC[20]));
            ASSERT(B21   == *(bdlmxxx::Table *) getValueB(SPEC[21]));
            ...
            ASSERT(B30   == *(bdlmxxx::Choice *) getValueB(SPEC[30]));
            ASSERT(B31   == *(bdlmxxx::ChoiceArray *) getValueB(SPEC[31]));
        }
            ...
            bsl::cout << "\nTesting 'getValueN'." << bsl::endl;
        {
            ...
            ASSERT(N20       == *(bdlmxxx::List *) getValueN(SPEC[20]));
            ASSERT(N21       == *(bdlmxxx::Table *) getValueN(SPEC[21]));
            ...
            ASSERT(N30       == *(bdlmxxx::Choice *) getValueN(SPEC[30]));
            ASSERT(N31       == *(bdlmxxx::ChoiceArray *) getValueN(SPEC[31]));
        }
      } break;
      case 1: {
        // --------------------------------------------------------------------
        ...
        //   bdlmxxx::Choice object are as expected, check that memory is
        ...
        if (verbose) bsl::cout << "\tSizeof bdlmxxx::Choice :"
                               << sizeof(bdlmxxx::Choice) << bsl::endl;
