...
//                                 Overview
//                                 --------
// This component expose four classes, 'bdlmxxx::RowData', 'bdlmxxx::Row', 'bdlmxxx::List'
// and 'bdlmxxx::Table'.  Since 'bdlmxxx::RowData' does not have public constructors it
// is not tested directly.  The majority of the manipulators and accessors
// of 'bdlmxxx::Row' are used by 'bdlmxxx::List' for forwarding.  These functions of
// 'bdlmxxx::Row' are tested as part of 'bdlmxxx::List' tests.
//
...
//-----------------------------------------------------------------------------
//
// 'bdlmxxx::Row' public interface
// [19]  bdlmxxx::Row& operator=(const bdlmxxx::Row& rhs);
// [10]  void makeAllNull();
// [10]  void makeValueNull(int index);
// [10]  void makeRangeNull(int si, int ne);
// [25]  void replaceValue(int di, const bdlmxxx::Row& sr, int si);
// [25]  void replaceValues(int di, const bdlmxxx::Row& sr, int si, int ne);
...
// [29]  bdlt::Datetime& theDatetime(int index);
// [29]  bdlt::Date& theDate(int index);
// [29]  bdlt::Time& theTime(int index);
...
// [29]  vector<bdlt::Datetime>& theDatetimeArray(int index);
// [29]  vector<bdlt::Date>& theDateArray(int index);
// [29]  vector<bdlt::Time>& theTimeArray(int index);
// [29]  bdlmxxx::List& theList(int index);
// [29]  bdlmxxx::Table& theTable(int index);
// [  ]  bdlxxxx::InStream& bdexStreamIn(bdlxxxx::InStream& stream);
// [31]  int length() const;
// [31]  bdlmxxx::ElemType::Type elemType(int index) const;
...
// [29]  const bdlt::Datetime& theDatetime(int index) const;
// [29]  const bdlt::Date& theDate(int index) const;
// [29]  const bdlt::Time& theTime(int index) const;
...
// [29]  const vector<bdlt::Datetime>& theDatetimeArray(int index) const;
// [29]  const vector<bdlt::Date>& theDateArray(int index) const;
// [29]  const vector<bdlt::Time>& theTimeArray(int index) const;
// [29]  const bdlmxxx::List& theList(int index) const;
// [29]  const bdlmxxx::Table& theTable(int index) const;
// [  ]  bdlxxxx::OutStream& bdexStreamOut(bdlxxxx::OutStream& stream) const;
// [30]  ostream& print(ostream& stream, int level, int spl) const;
//
// [ 6]  bool operator==(const bdlmxxx::Row& lhs, const bdlmxxx::Row& rhs);
// [ 6]  bool operator!=(const bdlmxxx::Row& lhs, const bdlmxxx::Row& rhs);
// [ 5]  ostream& operator<<(ostream& stream, const bdlmxxx::Row& rhs);
//
// 'bdlmxxx::List' public interface
// [11]  bdlmxxx::List(bslma::Allocator *ba = 0);
// [11]  bdlmxxx::List(bdlmxxx::AggregateOption::AllocationStrategy allocMode, *ba=0);
// [11]  bdlmxxx::List(const ExplicitRow& original, *ba = 0);
// [11]  bdlmxxx::List(const bdlmxxx::List& original, *ba = 0);
// [11]  bdlmxxx::List(const ExplicitRow& original, allocationMode, *ba = 0);
// [11]  bdlmxxx::List(const bdlmxxx::List& original, allocationMode, *ba = 0);
// [ 1]  ~bdlmxxx::List();
// [19]  bdlmxxx::List& operator=(const bdlmxxx::Row& rhs);
// [19]  bdlmxxx::List& operator=(const bdlmxxx::List& rhs);
// [29]  bdlmxxx::Row& theRow();
// [29]  char& theChar(int index);
// [29]  short& theShort(int index);
// [29]  int& theInt(int index);
...
// [16]  bdlt::Datetime& appendDatetime(const bdlt::Datetime& v);
// [16]  bdlt::Date& appendDate(const bdlt::Date& v);
// [16]  bdlt::Time& appendTime(const bdlt::Time& v);
...
// [16]  vector<bdlt::Datetime>&
//               appendDatetimeArray(const const vector<bdlt::Datetime>& v);
// [16]  vector<bdlt::Date>& appendDateArray(const vector<bdlt::Date>& v);
// [16]  vector<bdlt::Time>& appendTimeArray(const vector<bdlt::Time>& v);
// [16]  bdlmxxx::List& appendList(const bdlmxxx::List& list);
// [16]  bdlmxxx::List& appendList(const bdlmxxx::Row& row);
// [16]  bdlmxxx::Table& appendTable(const bdlmxxx::Table& table);
// [16]  int appendElement(const bdlmxxx::Row& sr, int si);
// [16]  int appendElement(const bdlmxxx::List& sl, int si);
// [16]  void appendElements(const bdlmxxx::Row& sr);
// [16]  void appendElements(const bdlmxxx::List& sl);
// [16]  void appendElements(const bdlmxxx::Row& sr, int si, int ne);
// [16]  void appendElements(const bdlmxxx::List& sl, int si, int ne);
...
// [16]  bdlt::Datetime& insertDatetime(int di, const bdlt::Datetime& v);
// [16]  bdlt::Date& insertDate(int di, const bdlt::Date& v);
// [16]  bdlt::Time& insertTime(int di, const bdlt::Time& v);
...
// [16]  vector<bdlt::Datetime>&
//             insertDatetimeArray(int di, const vector<bdlt::Datetime>& v);
// [16]  vector<bdlt::Date>&
//                     insertDateArray(int di, const vector<bdlt::Date>& v);
// [16]  vector<bdlt::Time>&
//                     insertTimeArray(int di, const vector<bdlt::Time>& v);
// [16]  bdlmxxx::List& insertList(int di, const bdlmxxx::List& sl);
// [16]  bdlmxxx::List& insertList(int di, const bdlmxxx::Row& sr);
// [16]  bdlmxxx::Table& insertTable(int di, const bdlmxxx::Table& st);
// [16]  void insertElement(int di, const bdlmxxx::Row& sr, int si);
// [16]  void insertElement(int di, const bdlmxxx::List& sl, int si);
// [16]  void insertElements(int di, const bdlmxxx::Row& sr);
// [16]  void insertElements(int di, const bdlmxxx::List& sl);
...
// [16]  void removeAll();
// [17]  void replace(int di, const bdlmxxx::Row& sr, int si);
// [17]  void replace(int di, const bdlmxxx::List& sl, int si);
// [17]  void replace(int di, const bdlmxxx::Row& sr, int si, int ne);
// [17]  void replace(int di, const bdlmxxx::List& sl, int si, int ne);
// [15]  void replaceType(int di, bdlmxxx::ElemType::Type elemType);
// [15]  void compact();
// [ 7]  void swap(int index1, int index2);
// [13]  bdlxxxx::InStream& bdexStreamIn(bdlxxxx::InStream& stream);
// [31]  int length() const;
// [31]  bdlmxxx::ElemType::Type elemType(int index) const;
// [29]  const bdlmxxx::Row& theRow() const;
// [29]  const char& theChar(int index) const;
// [29]  const short& theShort(int index) const;
// [29]  const int& theInt(int index) const;
// [29]  const Int64& theInt64(int index) const;
...
// [29]  const bdlmxxx::List& theList(int index) const;
// [29]  const bdlmxxx::Table& theTable(int index) const;
// [13]  bdlxxxx::OutStream& bdexStreamOut(bdlxxxx::OutStream& stream) const;
// [30]  ostream& print(ostream& stream, int level, int spl) const;
//
// [ 6]  bool operator==(const bdlmxxx::List& lhs, const bdlmxxx::List& rhs);
// [ 6]  bool operator!=(const bdlmxxx::List& lhs, const bdlmxxx::List& rhs);
// [ 5]  ostream& operator<<(ostream& stream, const bdlmxxx::List& rhs);
//
// 'bdlmxxx::Table' public interface
// [12]  bdlmxxx::Table(bslma::Allocator *ba = 0);
// [12]  bdlmxxx::Table(bdem::AggregateAllocationMode::AllocationStrategy, *ba = 0);
// [12]  bdlmxxx::Table(const bdlmxxx::Table& original, *ba = 0);
// [12]  bdlmxxx::Table(const bdlmxxx::Table& original, allocationMode, *ba = 0);
// [ 2]  ~bdlmxxx::Table();
// [20]  bdlmxxx::Table& operator=(const bdlmxxx::Table& rhs);
// [29]  bdlmxxx::Row& theRow(int ri);
...
// [29]  bdlt::Datetime& theDatetime(int ri, int ci);
// [29]  bdlt::Date& theDate(int ri, int ci);
// [29]  bdlt::Time& theTime(int ri, int ci);
...
// [29]  vector<bdlt::Datetime>& theDatetimeArray(int ri, int ci);
// [29]  vector<bdlt::Date>& theDateArray(int ri, int ci);
// [29]  vector<bdlt::Time>& theTimeArray(int ri, int ci);
// [29]  bdlmxxx::List& theList(int ri, int ci);
// [29]  bdlmxxx::Table& theTable(int ri, int ci);
// [23]  void makeValueNull(int ri, int ci);
// [23]  void makeColumnNull(int index);
// [23]  void makeRowsNull(int si, int rc);
// [23]  void makeAllNull();
// [18]  bdlmxxx::Row& appendRow(const bdlmxxx::List& sl);
// [18]  bdlmxxx::Row& appendRow(const bdlmxxx::Table& st, int si);
// [18]  void appendRows(const bdlmxxx::Table& st);
// [18]  void appendRows(const bdlmxxx::Table& st, int si, int rc);
// [18]  bdlmxxx::Row& insertRow(int di, const bdlmxxx::List& sl);
// [18]  bdlmxxx::Row& insertRow(int di, const bdlmxxx::Table& st, int si);
// [18]  void insertRows(int di, const bdlmxxx::Table& st);
// [18]  void insertRows(int di, const bdlmxxx::Table& st, int si, int rc);
// [21]  void replaceRow(int di, const bdlmxxx::Row& sr);
// [21]  void replaceRow(int di, const bdlmxxx::List& sl);
// [21]  void replaceRow(int di, const bdlmxxx::Table& st, int si);
// [21]  void replaceRows(int di, const bdlmxxx::Table& st, int si, int rc);
// [27]  void swapRows(int ri1, int ri2);
// [18]  void removeRow(int index);
// [18]  void removeRows(int index, int rc);
// [18]  void removeAllRows();
// [18]  void removeAll();
// [14]  bdlxxxx::InStream& bdexStreamIn(bdlxxxx::InStream& stream);
// [31]  int numRows() const;
// [31]  int numColumns() const;
// [31]  bdlmxxx::ElemType::Type columnType(int index) const;
// [29]  const bdlmxxx::Row& theRow(int ri) const;
...
// [29]  const bdlt::Datetime& theDatetime(int ri, int ci) const;
// [29]  const bdlt::Date& theDate(int ri, int ci) const;
// [29]  const bdlt::Time& theTime(int ri, int ci) const;
...
// [29]  const vector<bdlt::Datetime>&
//                                      theDatetimeArray(int ri, int ci) const;
// [29]  const vector<bdlt::Date>& theDateArray(int ri, int ci) const;
// [29]  const vector<bdlt::Time>& theTimeArray(int ri, int ci) const;
// [29]  const bdlmxxx::List& theList(int ri, int ci) const;
// [29]  const bdlmxxx::Table& theTable(int ri, int ci) const;
// [14]  bdlxxxx::OutStream& bdexStreamOut(bdlxxxx::OutStream& stream) const;
// [30]  ostream& print(ostream& stream, int level, int spl) const;
//
// [24]  bool operator==(const bdlmxxx::Table& lhs, const bdlmxxx::Table& rhs);
// [24]  bool operator!=(const bdlmxxx::Table& lhs, const bdlmxxx::Table& rhs);
// [ 5]  ostream& operator<<(ostream& stream, const bdlmxxx::Table& rhs);
//-----------------------------------------------------------------------------
// [ 1]  'bdlmxxx::List' Breathing Test
// [ 2]  'bdlmxxx::Table' Breathing Test
// [ 3]  bdlmxxx::List& gg(bdlmxxx::List *address, const char *spec);
// [ 3]  int ggg(bdlmxxx::List *address, const char *spec, int showErrorFlag);
// [ 4]  int hhh(bdlmxxx::Table *address, const char *spec, int showErrorFlag);
// [ 4]  bdlmxxx::Table& hh(bdlmxxx::Table *object, const char *spec);
// [ 8]  void reverseList(bdlmxxx::List *list); helper function
...
inline
void getElemTypes(my_ElemTypeArray *types, const bdlmxxx::List& list)
    // Fill types with element types from list
{
    getElemTypes(types, list.row());
}

void getElemTypes(my_ElemTypeArray *types, const bdlmxxx::Table& table)
...
void replaceListElements(bdlmxxx::List&       list,
                         int              dstIndex,
                         const bdlmxxx::Row&  srcRow,
                         int              srcIndex,
                         int              numElements)
{
    bdlmxxx::List tempList(srcRow);
    for(int i = 0; i < numElements; ++i) {
        list.replaceElement(dstIndex + i, tempList[srcIndex + i]);
    }
}

void resetListElements(bdlmxxx::List&       list,
                       int              dstIndex,
...
void makeRangeNull(bdlmxxx::Row&  row, int startIndex, int numElements)
{
    for(int i = 0; i < numElements; ++i) {
...
void replaceRows(bdlmxxx::Table&       table,
                 int               dstIndex,
                 const bdlmxxx::Table& src,
                 int               srcIndex,
                 int               numElems)
{
...
struct Assertions {
    char assert1[0 == bdlmxxx::AggregateOption::BDEM_PASS_THROUGH];
    char assert2[1 == bdlmxxx::AggregateOption::BDEM_WRITE_MANY];
    char assert3[2 == bdlmxxx::AggregateOption::BDEM_SUBORDINATE];
    char assert4[3 == bdlmxxx::AggregateOption::BDEM_WRITE_ONCE];
};

const char *optionToString(bdlmxxx::AggregateOption::AllocationStrategy optval)
...
static const bdlt::DatetimeTz           *G_VALUES_X[3];
static const bdlt::DateTz               *G_VALUES_Y[3];
static const bdlt::TimeTz               *G_VALUES_Z[3];
static const bsl::vector<bool>         *G_VALUES_a[3];
static const bsl::vector<bdlt::DatetimeTz> *G_VALUES_b[3];
static const bsl::vector<bdlt::DateTz>  *G_VALUES_c[3];
static const bsl::vector<bdlt::TimeTz>  *G_VALUES_d[3];
static const bdlmxxx::Choice               *G_VALUES_e[3];
static const bdlmxxx::ChoiceArray          *G_VALUES_f[3];
...
listInvariants(const List& list) {
    ...
    bool isOk;
    for (int i = 0; i < len; ++i) {
        bdlmxxx::ConstElemRef elemRef(list[i]);
...
bool isUnset(const bdlmxxx::ConstElemRef& e)
{
    switch (e.type()) {
    ...
    for (const char *p = spec; *p; ++p) {
        if ('!' == *p) {
            ...
            for (numCols = 0; isTypeChar(*p) && numCols < MAX; ++numCols) {
                tempElems.push_back(bdlmxxx::ElemType::Type(typeCharToIndex(*p)));
...
static int getNumRows(const char *spec)
    // return the number of rows in the 'bdlmxxx::Table' created by the specified
    // 'spec'.
{
    int size = 0;
    for (; *spec; ++spec) {
...
static void assignElemRef(const bdlmxxx::ElemRef *lhs,
                          const bdlmxxx::ConstElemRef& rhs)
...
void reverseSpec(char *spec)
    ...
    // by the 'bdlmxxx::List' 'g' generator functions.  The behavior is undefined
    ...
    // representations.
{
    ...
    for (int i = 0; i < len; ++i) {
        ...
        if (offset > maxOffset)
        {
            int len = bdlmxxx::ElemAttrLookup::lookupTable()[srcRow.elemType(i)]->
                                                                        d_size;
...
#define DECLARE_MAIN_VARIABLES                                                \
    ...
    const bdlmxxx::Table                 UV;                                      \
                                                                              \
    const bool                       UW = bdltuxxx::Unset<bool>::unsetValue();    \
    const bdlt::DatetimeTz            UX;                                      \
    const bdlt::DateTz                UY;                                      \
    const bdlt::TimeTz                UZ;                                      \
    const bsl::vector<bool>          Ua;                                      \
    const bsl::vector<bdlt::DatetimeTz> Ub;                                    \
    const bsl::vector<bdlt::DateTz>   Uc;                                      \
    const bsl::vector<bdlt::TimeTz>   Ud;                                      \
    const bdlmxxx::Choice                Ue;                                      \
    const bdlmxxx::ChoiceArray           Uf;                                      \
                                                                              \
    /* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - */ \
                                                                              \
    ...
    XV_.theModifiableRow(1)[1].theModifiableString() = UG;                    \
                                                                              \
    const bool                       XW = true;                               \
    const bdlt::DatetimeTz            XX(XH, 120);                             \
    const bdlt::DateTz                XY(XI, 120);                             \
    const bdlt::TimeTz                XZ(XJ, 120);                             \
                                                                              \
    bsl::vector<bool>                Xa_;                                     \
    ...
    Xa_.push_back(true);                                                      \
                                                                              \
    bsl::vector<bdlt::DatetimeTz>    Xb_;                                      \
    const bsl::vector<bdlt::DatetimeTz>& Xb = Xb_;                             \
    Xb_.push_back(XX);                                                        \
    Xb_.push_back(UX);                                                        \
                                                                              \
    bsl::vector<bdlt::DateTz>        Xc_;                                      \
    const bsl::vector<bdlt::DateTz>& Xc = Xc_;                                 \
    Xc_.push_back(XY);                                                        \
    Xc_.push_back(UY);                                                        \
                                                                              \
    bsl::vector<bdlt::TimeTz>        Xd_;                                      \
    const bsl::vector<bdlt::TimeTz>& Xd = Xd_;                                 \
    Xd_.push_back(XZ);                                                        \
    Xd_.push_back(UZ);                                                        \
                                                                              \
    bdlmxxx::Choice                     Xe_;                                      \
    const bdlmxxx::Choice&              Xe = Xe_;                                 \
    Xe_.addSelection(bdlmxxx::ElemType::BDEM_INT);                                \
    Xe_.addSelection(bdlmxxx::ElemType::BDEM_DOUBLE);                             \
    Xe_.makeSelection(0).theModifiableInt() = 5;                              \
                                                                              \
    bdlmxxx::ChoiceArray                Xf_;                                      \
    const bdlmxxx::ChoiceArray&         Xf = Xf_;                                 \
    {                                                                         \
        bdlmxxx::ElemType::Type catalog[] = { bdlmxxx::ElemType::BDEM_INT,            \
                                          bdlmxxx::ElemType::BDEM_DOUBLE };       \
        Xf_.reset(catalog, 2);                                                \
        bdlmxxx::Choice choice(catalog, 2, Z);                                    \
    ...
    YU_.appendString(YG);                                                     \
                                                                              \
    getElemTypes(&e, YU);                                                     \
    bdlmxxx::Table                       YV_(vectorData(e), e.size(), Z);         \
    ...
    YV_.theModifiableRow(1)[1].theModifiableString() = UG;                    \
                                                                              \
    const bool                       YW = true;                               \
    const bdlt::DatetimeTz            YX(YH, 180);                             \
    const bdlt::DateTz                YY(YI, 180);                             \
    const bdlt::TimeTz                YZ(YJ, 180);                             \
                                                                              \
    bsl::vector<bool>                Ya_;                                     \
    ...
    Ya_.push_back(true);                                                      \
                                                                              \
    bsl::vector<bdlt::DatetimeTz>    Yb_;                                      \
    const bsl::vector<bdlt::DatetimeTz>& Yb = Yb_;                             \
    Yb_.push_back(YX);                                                        \
    Yb_.push_back(UX);                                                        \
                                                                              \
    bsl::vector<bdlt::DateTz>        Yc_;                                      \
    const bsl::vector<bdlt::DateTz>& Yc = Yc_;                                 \
    Yc_.push_back(YY);                                                        \
    Yc_.push_back(UY);                                                        \
                                                                              \
    bsl::vector<bdlt::TimeTz>        Yd_;                                      \
    const bsl::vector<bdlt::TimeTz>& Yd = Yd_;                                 \
    Yd_.push_back(YZ);                                                        \
    Yd_.push_back(UZ);                                                        \
                                                                              \
    bdlmxxx::Choice                     Ye_;                                      \
    const bdlmxxx::Choice&              Ye = Ye_;                                 \
    Ye_.addSelection(bdlmxxx::ElemType::BDEM_INT);                                \
    Ye_.addSelection(bdlmxxx::ElemType::BDEM_DOUBLE);                             \
    Ye_.makeSelection(1).theModifiableDouble() = 7.5;                         \
                                                                              \
    bdlmxxx::ChoiceArray                Yf_;                                      \
    const bdlmxxx::ChoiceArray&         Yf = Yf_;                                 \
    {                                                                         \
        bdlmxxx::ElemType::Type catalog[] = { bdlmxxx::ElemType::BDEM_INT,            \
                                          bdlmxxx::ElemType::BDEM_DOUBLE };       \
        Yf_.reset(catalog, 2);                                                \
...
DEFINE_TEST_CASE(41) {
                          ...
                          << "Testing setColumnString()" << endl;
        {
            ...
            for (int ti = 0; ti < NUM_DATA; ++ti) {
                ...
                const bdlmxxx::ConstElemRef
                                      TEST_VAL(LX[bdlmxxx::ElemType::BDEM_STRING]);
...
DEFINE_TEST_CASE(40) {
        // ------------------------------------------------------------------
        // USAGE EXAMPLE
        //   Create a 'bdlmxxx::List' holding the data that would normally be
...

        {
            ...
            const bdlmxxx::ElemType::Type timeElemTypes[] = {
            ...
            const bdlmxxx::ElemType::Type securityElemTypes[] = {
            ...
            const bdlmxxx::ElemType::Type equitySaleElemTypes[] = {
                bdlmxxx::ElemType::BDEM_STRING,
                bdlmxxx::ElemType::BDEM_STRING
            };
            ...
            const bdlmxxx::ElemType::Type priceElemTypes[] = {
                bdlmxxx::ElemType::BDEM_FLOAT,
                bdlmxxx::ElemType::BDEM_STRING
            };
            ...
            const bdlmxxx::ElemType::Type equityTradeElemTypes[] = {
                bdlmxxx::ElemType::BDEM_STRING,
        ...
        bdlxxxx::ByteInStream inStream(PD, NPB);

        {
            bdlmxxx::List equityTradeList;
            ...
            bdlmxxx::List *timeListPtr = &equityTradeList.theModifiableList(
                                                                timeListIndex);
            bdlt::Datetime someval2 = timeListPtr->theModifiableDatetime(
                                                                datetimeIndex);
...
//
    list.appendNullList();
    bdlmxxx::List *subListPtr = &list.theModifiableList(0);
...
//
    const bdlmxxx::List& firstList = list.theList(0);
    ASSERT(  2 == firstList.length());
    ASSERT(100 == firstList.theInt(0));
    ASSERT(200 == firstList.theDouble(1));
//
    const bdlmxxx::List& secondList = list.theList(1);
...
DEFINE_TEST_CASE(39) {
        ...
        //
        // Plan:
        //   Since the 'bdlmxxx::List' and 'bdlmxxx::Table' basic accessors
        //   forward to the 'bdlmxxx::Row' basic accessors, it is sufficient
        //   to verify that the 'bdlmxxx::Row' methods operate for a single
        //   test value and then thoroughly test the 'bdlmxxx::List' and
        //   'bdlmxxx::Table' methods.
        //
        ...
        //
        // Testing:
        //   int                       bdlmxxx::Row::length() const;
        //   const my_ElemTypeArray& bdlmxxx::Row::elemTypes() const;
        //   bdlmxxx::ElemType::Type       bdlmxxx::Row::elemType(int index) const;
        //
        //   int                       bdlmxxx::List::length() const;
        //   const my_ElemTypeArray& bdlmxxx::List::elemTypes() const;
        //   bdlmxxx::ElemType::Type       bdlmxxx::List::elemType(int index) const;
        //
        //   int                       bdlmxxx::Table::numRows() const;
        //   int                       bdlmxxx::Table::numColumns() const;
        //   const my_ElemTypeArray& bdlmxxx::Table::columnTypes() const;
        //   bdlmxxx::ElemType::Type       bdlmxxx::Table::columnType(int index) const;
        // --------------------------------------------------------------------
        ...
        if (verbose) cout << endl
                          << "Testing 'bdlmxxx::Row' basic accessors." << endl;
        {
            ...
            for (int ei = 0; ei < NUM_ELTS; ++ei) {
                const bdlmxxx::ElemType::Type ET = bdlmxxx::ElemType::Type
        ...
        if (verbose) cout << endl
                          << "Testing 'bdlmxxx::List' basic accessors." << endl;
        {
            static const struct {
                int         d_lineNum;   // source line number
        ...
        if (verbose) cout << endl
                          << "Testing 'bdlmxxx::Table' basic accessors." << endl;
        {
            static const struct {
                int         d_lineNum;  // source line number
...
DEFINE_TEST_CASE(38) {
        // --------------------------------------------------------------------
        // TESTING 'bdlmxxx::Row', 'bdlmxxx::List', 'bdlmxxx::Table' PRINT METHODS
        //
        ...
        // Plan:
        //   Since the 'bdlmxxx::List' and 'bdlmxxx::Table' 'print' methods both
        //   forward to the 'bdlmxxx::Row' 'print' method, it is sufficient
        //   to verify that the 'bdlmxxx::Row' method operates for a single
        //   test value and then thoroughly test the 'bdlmxxx::List' and
        //   'bdlmxxx::Table' methods.
        //
        //   Values from all of the 22 element types are used in the tests
        //   of the 'bdlmxxx::List' and 'bdlmxxx::Table' 'print' methods.  For each
        ...
        //
        // Testing:
        //   ostream& bdlmxxx::Row::print(ostream& os, int level, int spl) const;
        //   ostream& bdlmxxx::List::print(ostream& os, int level, int spl) const;
        //   ostream& bdlmxxx::Table::print(ostream& os, int level, int spl) const;
        // --------------------------------------------------------------------
        ...
        if (verbose) cout << "\nTesting 'bdlmxxx::Row' 'print' method" << endl;
        {
        ...
        if (verbose) cout << "\nTesting 'bdlmxxx::List' 'print' method" << endl;
#define NL "\n"
        {
            static const struct {
                int         d_lineNum;   // source line number
...
#undef NL
        ...
        if (verbose) cout << "\nTesting 'bdlmxxx::Table' 'print' method" << endl;
        {
            static const struct {
                int         d_lineNum;   // source line number
                const char *d_spec_p;    // specification string
...
DEFINE_TEST_CASE(37) {
        ...
        //
        // Plan:
        //   Since the 'bdlmxxx::List' and 'bdlmxxx::Table' methods forward to
        //   the 'bdlmxxx::Row' methods, it is sufficient to verify that the
        //   'bdlmxxx::Row' methods operate for a single test value and then
        //   thoroughly test the 'bdlmxxx::List' and 'bdlmxxx::Table' methods.
        //   Values from all of the 22 element types are used in the tests.
        //
        //   Apart from thoroughness, the strategy for testing the 'the'
        //   methods of 'bdlmxxx::Row', 'bdlmxxx::List' and 'bdlmxxx::Table' is similar.
        ...
        //   bdlt::Datetime& theDatetime(int ri, int ci);
        //   bdlt::Date& theDate(int ri, int ci);
        //   bdlt::Time& theTime(int ri, int ci);
        ...
        //   bsl::vector<bdlt::Datetime>& theDatetimeArray(int ri, int ci);
        //   bsl::vector<bdlt::Date>& theDateArray(int ri, int ci);
        //   bsl::vector<bdlt::Time>& theTimeArray(int ri, int ci);
        //   bdlmxxx::List& theList(int ri, int ci);
        //   bdlmxxx::Table& theTable(int ri, int ci);
        //   const bdlmxxx::Row&.row(int ri) const;
        ...
        //   const bdlt::Datetime& theDatetime(int ri, int ci) const;
        //   const bdlt::Date& theDate(int ri, int ci) const;
        //   const bdlt::Time& theTime(int ri, int ci) const;
        ...
        //                              theDatetimeArray(int ri, int ci) const;
        //   const bsl::vector<bdlt::Date>& theDateArray(int ri, int ci) const;
        //   const bsl::vector<bdlt::Time>& theTimeArray(int ri, int ci) const;
        //   const bdlmxxx::List& theList(int ri, int ci) const;
        //   const bdlmxxx::Table& theTable(int ri, int ci) const;
        // --------------------------------------------------------------------
        ...
        if (verbose) cout << endl
                          << "Testing bdlmxxx::Table 'the' Methods" << endl
                          << "================================" << endl;
                      ...
                      for (int ri = 0; ri < NROWS; ++ri) {
                          ...
                          for (int ci = 0; ci < NCOLS; ++ci) {
                              switch (X.columnType(ci)) {
                                ...
                                case bdlmxxx::ElemType::BDEM_DATETIME_ARRAY: {
                                  typedef bsl::vector<bdlt::Datetime> T;
                                ...
                                case bdlmxxx::ElemType::BDEM_DATE_ARRAY: {
                                  typedef bsl::vector<bdlt::Date> T;
                                ...
                                case bdlmxxx::ElemType::BDEM_TIME_ARRAY: {
                                  typedef bsl::vector<bdlt::Time> T;
...
DEFINE_TEST_CASE(36) {
        ...
        //   bdlt::Datetime& theDatetime(int index);
        //   bdlt::Date& theDate(int index);
        //   bdlt::Time& theTime(int index);
        ...
        //   bsl::vector<bdlt::Datetime>& theDatetimeArray(int index);
        //   bsl::vector<bdlt::Date>& theDateArray(int index);
        //   bsl::vector<bdlt::Time>& theTimeArray(int index);
        //   bdlmxxx::List& theList(int index);
        //   bdlmxxx::Table& theTable(int index);
        ...
        if (verbose) cout << endl
                          << "Testing bdlmxxx::List 'the' Methods" << endl
                          << "===============================" << endl;
...
DEFINE_TEST_CASE(35) {
        ...
        if (verbose) cout << endl
                          << "Testing bdlmxxx::Row 'the' Methods" << endl
                          << "==============================" << endl;
...
DEFINE_TEST_CASE(34) {
        // --------------------------------------------------------------------
        // TESTING 'bdlmxxx::Table' reset METHOD
        //
        // Concerns:
        //   The function operates correctly when the source types object is
        //   within the table (within a 'bdlmxxx::Table' or 'bdlmxxx::List'.
        //   The function operates correctly when the source types object is
        ...
        //   parameter to the function is contained within the 'bdlmxxx::List'
        //   itself, i.e., a list with these types or a table with these types.
        //   The test is performed with a 'bdlmxxx::List' using an allocator that
            ...
            for (int ti = 0; ti < NUM_DATA; ++ti) {
                ...
                if (veryVerbose) cout << "\t\treset(se)" << endl;
                {
                  ...
                  BSLMA_TESTALLOCATOR_EXCEPTION_TEST_BEGIN(testAllocator) {
                    ...
                    Table x(DD, bdlmxxx::AggregateOption::BDEM_PASS_THROUGH,
                            &ta);
                    const Table &X = x;
                    {
        ...
        for (int ii = 0; ii < NUM_DATA; ++ii) {
            ...
            BSLMA_TESTALLOCATOR_EXCEPTION_TEST_BEGIN(testAllocator) {
              ...
              Table U(bdlmxxx::AggregateOption::BDEM_PASS_THROUGH,
                      Z);
        ...
        if (verbose) cout << endl
                          << "Testing overlap cases with 'bdlmxxx::Table'"
                          << endl;
        ...
        for (int ii = 0; ii < NUM_DATA; ++ii) {
            ...
            for (int jj = 0; jj < NUM_DATA; ++jj) {
                ...
                my_ElemTypeArray PS;
                PS.push_back(bdlmxxx::ElemType::BDEM_TABLE);
                appendToElemTypeArray(&PS, P_SPEC);
                ...
                BSLMA_TESTALLOCATOR_EXCEPTION_TEST_BEGIN(testAllocator) {
                  const int AL = testAllocator.allocationLimit();
                  testAllocator.setAllocationLimit(-1);
                  Table U(bdlmxxx::AggregateOption::BDEM_PASS_THROUGH, Z);
        ...
        if (verbose)
            cout << endl << "Testing overlap cases with 'bdlmxxx::List'" << endl;
        ...
        for (int ii = 0; ii < NUM_DATA; ++ii) {
            ...
            for (int jj = 0; jj < NUM_DATA; ++jj) {
                ...
                if (veryVerbose) P(S_SPEC);
                my_ElemTypeArray PS;
                PS.push_back(bdlmxxx::ElemType::BDEM_LIST);
                appendToElemTypeArray(&PS, P_SPEC);
...
DEFINE_TEST_CASE(33) {
        // --------------------------------------------------------------------
        // TESTING 'bdlmxxx::Table' SWAPROWS METHOD
        //
        // Concerns:
        ...
        if (verbose) cout << endl
                          << "Testing bdlmxxx::Table 'swapRows' Method" << endl
                          << "====================================" << endl;
...
DEFINE_TEST_CASE(32) {
        // --------------------------------------------------------------------
        // TESTING 'bdlmxxx::Table' ISNULL, ISNONNULL, ETC. METHODS
        //
        // Concerns:
        ...
        if (verbose) cout << endl
                          << "Testing bdlmxxx::Table 'IsNull' Accessors" << endl
                          << "=====================================" << endl;
            ...
            for (int ti = 0; ti < NUM_DATA; ++ti) {
                ...
                for (int row = 0; row < U.numRows(); ++row) {
                    for (int col = 0; col < U.numColumns(); ++col) {
                        bdlmxxx::ElemRef ref = mU.theModifiableRow(row)[col];
                        if ((bdlmxxx::ElemType::BDEM_CHAR == ref.type() &&
                                                        UA == ref.theChar()) ||
                           (bdlmxxx::ElemType::BDEM_SHORT == ref.type() &&
                                                       UB == ref.theShort())) {
                            ref.makeNull();
                        }
                    }
...
DEFINE_TEST_CASE(31) {
        // --------------------------------------------------------------------
        // TESTING 'bdlmxxx::Row' REPLACEVALUE METHOD
        // Concerns:
        //   For the 'bdlmxxx::Row' 'replaceValue' method, the following
        ...
        //
        // Testing:
        //   void replaceValues(int di, const bdlmxxx::Row& sr, int si, int ne);
        //   void replaceValue(int di, const bdlmxxx::Row& sr, int si);
        // --------------------------------------------------------------------
        ...
        if (verbose) cout << endl
                          << "Testing 'bdlmxxx::Row' 'replaceValue'" << endl
                          << "=================================" << endl;
            ...
            << endl;
        {
            ...
            for (int ti = 0; ti < NUM_DATA; ++ti) {
                ...
                bdlmxxx::AggregateOption::AllocationStrategy optval =
                      option == 0 ? bdlmxxx::AggregateOption::BDEM_PASS_THROUGH
                    : option == 1 ? bdlmxxx::AggregateOption::BDEM_WRITE_MANY
...
DEFINE_TEST_CASE(27) {
        // --------------------------------------------------------------------
        // TESTING 'bdlmxxx::Table' EQUALITY OPERATORS
        // Concerns:
...
DEFINE_TEST_CASE(26) {
        // --------------------------------------------------------------------
        // TESTING 'bdlmxxx::Table' makeValueNull MANIPULATORS
        // Concerns: BUG
        //
        // Plan: BUG
        //
        ...
        if (verbose)
            cout << endl
                 << "Testing bdlmxxx::Table makeValueNull Manipulators" << endl
                 << "=============================================" << endl;
...
DEFINE_TEST_CASE(25) {
        // --------------------------------------------------------------------
        // TESTING 'bdlmxxx::Table' APPENDNULLROW, INSERTNULLROW METHODS
        // Concerns:
        ...
        //
        // Testing:
        //   bdlmxxx::Row& appendNullRow();
        //   void appendNullRows(int ne);
        //
        //   bdlmxxx::Row& insertNullRow(int di);
...
DEFINE_TEST_CASE(24) {
        // --------------------------------------------------------------------
        // TESTING 'bdlmxxx::Table' REPLACEROW METHODS
        // Concerns:
        ...
        //
        // Testing:
        //   void replaceRow(int di, const bdlmxxx::Row& sr);
        //   void replaceRow(int di, const bdlmxxx::List& sl);
        //   void replaceRow(int di, const bdlmxxx::Table& st, int si);
        //   void replaceRows(int di, const bdlmxxx::Table& st, int si, int ne);
        // --------------------------------------------------------------------
...
DEFINE_TEST_CASE(23) {
        // --------------------------------------------------------------------
        // TESTING 'bdlmxxx::Table' ASSIGNMENT OPERATOR
        ...
        if (verbose) cout << endl
                          << "Testing bdlmxxx::Table Assignment Operator" << endl
                          << "======================================" << endl;
...
DEFINE_TEST_CASE(22) {
        // --------------------------------------------------------------------
        // TESTING 'bdlmxxx::List' ASSIGNMENT OPERATOR
        // We have the following concerns:
        //   1.  The value represented by any instance can be assigned to any
        //       other instance regardless of how either value is represented
        //       internally.
        ...
        //
        // Testing:
        //   bdlmxxx::List& bdlmxxx::List::operator=(const bdlmxxx::Row& rhs);
        //   bdlmxxx::List& bdlmxxx::List::operator=(const bdlmxxx::List& rhs);
        // --------------------------------------------------------------------
...
DEFINE_TEST_CASE(21) {
        // --------------------------------------------------------------------
        // TESTING 'bdlmxxx::Table' APPENDROW, INSERTROW, REMOVEROW METHODS
        // Concerns:
        //   For the 'append' and 'insert' methods, the following properties
        //   must hold:
        //    1. The source is left unaffected (apart from aliasing).
        ...
        //
        // Testing:
        //   bdlmxxx::Row& appendRow(const bdlmxxx::List& sl);
        //   bdlmxxx::Row& appendRow(const bdlmxxx::Table& st, int si);
        //   void appendRows(const bdlmxxx::Table& st);
        //   void appendRows(const bdlmxxx::Table& st, int si, int ne);
        //
        //   bdlmxxx::Row& insertRow(int di, const bdlmxxx::List& sl);
        //   bdlmxxx::Row& insertRow(int di, const bdlmxxx::Table& st, int si);
        //   void insertRows(int di, const bdlmxxx::Table& st);
        //   void insertRows(int di, const bdlmxxx::Table& st, int si, int ne);
        //
...
DEFINE_TEST_CASE(20) {
        // --------------------------------------------------------------------
        // TESTING 'bdlmxxx::List' REPLACE METHODS
        // Concerns:
        //   For the 'bdlmxxx::List' 'replace' method, the following properties
        //   must hold:
        //    1. The source is left unaffected (apart from aliasing).
        //    2. The subsequent existence of the source has no effect on the
        //       result object (apart from aliasing).
        ...
        //
        // Testing:
        //   void replace(int di, const bdlmxxx::Row& sr, int si);
        //   void replace(int di, const bdlmxxx::List& sl, int si);
        //   void replace(int di, const bdlmxxx::Row& sr, int si, int ne);
        //   void replace(int di, const bdlmxxx::List& sl, int si, int ne);
        // --------------------------------------------------------------------
        ...
        if (verbose) cout << endl
                          << "Testing 'bdlmxxx::List' 'replace'" << endl
                          << "=============================" << endl;
...
DEFINE_TEST_CASE(16) {
        // --------------------------------------------------------------------
        // TESTING 'bdlmxxx::List' APPEND, INSERT, REMOVE METHODS
        // Concerns:
        //   For the 'append' and 'insert' methods, the following properties
        //   must hold:
        //    1. The source is left unaffected (apart from aliasing).
        ...
        //   bdlt::Datetime& appendDatetime(const bdlt::Datetime& v);
        //   void appendNullDate();
        //   bdlt::Date& appendDate(const bdlt::Date& v);
        //   void appendNullTime();
        //   bdlt::Time& appendTime(const bdlt::Time& v);
        ...
        //            appendDatetimeArray(const bsl::vector<bdlt::Datetime>& v);
        //   void appendNullDateArray();
        //   bsl::vector<bdlt::Date>&
        //                    appendDateArray(const bsl::vector<bdlt::Date>& v);
        //   void appendNullTimeArray();
        //   bsl::vector<bdlt::Time>&
        //                    appendTimeArray(const bsl::vector<bdlt::Time>& v);
        //   void appendNullList();
        //   bdlmxxx::List& appendList(const bdlmxxx::List& list);
        //   bdlmxxx::List& appendList(const bdlmxxx::Row& row);
        //   void appendNullTable();
        //   bdlmxxx::Table& appendTable(const bdlmxxx::Table& table);
        //
        //   void appendNullBool();
        //   bool& appendBool();
        //   void appendNullDatetimeTz();
        //   bdem::DatetimeTz& appendDatetimeTz();
        //   void appendNullDateTz();
        //   bdem::DateTz& appendDateTz();
        //   void appendNullTimeTz();
        //   bdem::TimeTz& appendTimeTz();
        //   void appendNullBoolArray();
        //   bsl::vector<bool>& appendBoolArray();
        //   void appendNullDatetimeTz();
        //   bsl::vector<bdem::DatetimeTz>& appendDatetimeTz();
        //   void appendNullDateTz();
        //   bsl::vector<bdem::DateTz>& appendDateTz();
        //   void appendNullTimeTz();
        //   bsl::vector<bdem::TimeTz>& appendTimeTz();
        //   void appendNullChoice();
        //   bdlmxxx::Choice& appendChoice();
        //   void appendNullChoiceArray();
        //   bdlmxxx::ChoiceArray& appendChoiceArray();
        //
        //   int appendElement(const bdlmxxx::Row& sr, int si);
        //   int appendElement(const bdlmxxx::List& sl, int si);
        //   void appendElements(const bdlmxxx::Row& sr);
        //   void appendElements(const bdlmxxx::List& sl);
        //   void appendElements(const bdlmxxx::Row& sr, int si, int ne);
        //   void appendElements(const bdlmxxx::List& sl, int si, int ne);
        //
        ...
        //   bdlt::Datetime& insertDatetime(int di, const bdlt::Datetime& v);
        //   bdlt::Date& insertDate(int di, const bdlt::Date& v);
        //   bdlt::Time& insertTime(int di, const bdlt::Time& v);
        //   bsl::vector<char>&
        ...
        //   bsl::vector<bdlt::Datetime>&
        //    insertDatetimeArray(int di, const bsl::vector<bdlt::Datetime>& v);
        //   bsl::vector<bdlt::Date>&
        //            insertDateArray(int di, const bsl::vector<bdlt::Date>& v);
        //   bsl::vector<bdlt::Time>&
        //            insertTimeArray(int di, const bsl::vector<bdlt::Time>& v);
        //   bdlmxxx::List& insertList(int di, const bdlmxxx::List& sl);
        //   bdlmxxx::List& insertList(int di, const bdlmxxx::Row& sr);
        //   bdlmxxx::Table& insertTable(int di, const bdlmxxx::Table& st);
        //
        //   void insertElement(int di, const bdlmxxx::Row& sr, int si);
        //   void insertElement(int di, const bdlmxxx::List& sl, int si);
        //   void insertElements(int di, const bdlmxxx::Row& sr);
        //   void insertElements(int di, const bdlmxxx::List& sl);
            ...
            for (int ti = 0; ti < NUM_DATA; ++ti) {
                ...
                if ((int)strlen(D_SPEC)/2 == DI && 1 == NE) {
                  ...
                  BSLMA_TESTALLOCATOR_EXCEPTION_TEST_BEGIN(testAllocator) {
                      ...
                      List x(DD, &testAllocator);  const List &X = x;
                      bdlmxxx::List mExp(EE, &testAllocator);
...
DEFINE_TEST_CASE(15) {
        // --------------------------------------------------------------------
        // TESTING 'bdlmxxx::List' APPENDUNSETELEMENT, INSERTUNSETELEMENT METHODS
        // Concerns:
        //   For the 'append' and 'insert' methods, the following properties
        //   must hold:
        //    1. The source is left unaffected (apart from aliasing).
        ...
        //    5. The function preserves object invariants.
        //    6. The function is independent of internal representation.
        //   The elemtype array within the 'bdlmxxx::Row', 'bdlmxxx::List' and
        //   'bdlmxxx::Table' can be accessed using accessors.  Since this array
        ...
        //
        // Testing:
        //   void appendNullElement(bdlmxxx::ElemType::Type elemType);
        //   void appendNullElements(const my_ElemTypeArray&);
        //
        //   void insertNullElement(int di, bdlmxxx::ElemType::Type elemType);
        //   void insertNullElements(int di, const my_ElemTypeArray&);
        //
        //   void replaceType(int di, bdlmxxx::ElemType::Type elemType);
            ...
            for (int ti = 0; ti < NUM_DATA; ++ti) {
                ...
                if (1 == NE) {
                  ...
                  BSLMA_TESTALLOCATOR_EXCEPTION_TEST_BEGIN(testAllocator) {
                    List x(DD, &testAllocator);  const List &X = x;
                    {
                        bdlmxxx::ElemType::Type elemType = SS[0];
                        if (veryVerbose) { cout << "\t\t\tBEFORE: "; P(X); }
            ...
            for (int ti = 0; ti < NUM_DATA; ++ti) {
                ...
                if (1 == NE) {
                  BSLMA_TESTALLOCATOR_EXCEPTION_TEST_BEGIN(testAllocator) {
                    List x(DD, &testAllocator);  const List &X = x;
                    {
                        bdlmxxx::ElemType::Type elemType = SS[SI];
                        if (veryVerbose) { cout << "\t\t\tBEFORE: "; P(X); }
...
DEFINE_TEST_CASE(14) {
        // --------------------------------------------------------------------
        // TESTING 'bdlmxxx::Table' STREAMING FUNCTIONALITY
        ...
        //
        // Testing:
        //   bdlxxxx::InStream& bdlmxxx::Table::bdexStreamIn(bdlxxxx::InStream& is);
        //   bdlxxxx::OutStream& bdlmxxx::Table::bdexStreamOut(bdlxxxx::OutStream&) const;
        // --------------------------------------------------------------------
        ...
        for (int ti = 0; ti < NUM_DATA; ++ti) {
            ...
            bdlxxxx::ByteInStream testInStream((const char *) BINARY, LENGTH);
...
DEFINE_TEST_CASE(13) {
        // --------------------------------------------------------------------
        // TESTING 'bdlmxxx::Row' AND 'bdlmxxx::List' STREAMING FUNCTIONALITY
        ...
        //
        // Testing:
        //   bdlxxxx::InStream& bdexStreamIn(bdlxxxx::InStream& stream); (indirectly)
        //   bdlxxxx::OutStream& bdexStreamOut(bdlxxxx::OutStream& stream) const;
        //                                                       (indirectly)
        //   bdlxxxx::InStream& bdlmxxx::List::bdexStreamIn(bdlxxxx::InStream& stream);
        //                                                       (indirectly)
        //   bdlxxxx::OutStream& bdlmxxx::List::bdexStreamOut(bdlxxxx::OutStream& stream)
        //                                                 const (indirectly)
        // --------------------------------------------------------------------
        ...
        if (verbose) cout << "\tOn valid, non-empty stream data." << endl;
        {
            ...
            for (int ui = 0; SPECS[ui]; ++ui) {
                ...
                // Must reset stream for each iteration of inner loop.
                bdlxxxx::TestInStream testInStream("abcdefghijkl", 12);
                LOOP_ASSERT(U_SPEC, testInStream);
                LOOP_ASSERT(U_SPEC, !testInStream.isEmpty());
...
//                 },
            ...
            for (int ti = 0; ti < NUM_DATA; ++ti) {
                ...
                bdlxxxx::ByteInStream testInStream(BINARY, LENGTH);
...
DEFINE_TEST_CASE(12) {
        // --------------------------------------------------------------------
        // TESTING 'bdlmxxx::Table' CONSTRUCTORS
        // Concerns:
        ...
        //   default is BDEM_PASS_THROUGH.  For these bdlmxxx::Table objects, a
        ...
        //   a) For bdlmxxx::Table objects with BDEM_PASS_THROUGH, adding and
        //      removing the array causes memory allocation and deallocation.
        //   b) For bdlmxxx::Table objects with BDEM_WRITE_MANY, adding causes
        //      memory allocation.  However, removing and re-adding does not
        //      cause any memory allocation or deallocation.
        //   c) For bdlmxxx::Table objects with BDEM_WRITE_ONCE.  Adding may cause
        //      memory allocation from the testAllocator, but usually not.
        //      Removing the array does not cause any deallocation.
        //
        // Testing:
        //   bdlmxxx::Table(bslma::Allocator *ba = 0);
        //   bdlmxxx::Table(bdlmxxx::AggregateOption::AllocationStrategy aM, *ba = 0);
        //   bdlmxxx::Table(const my_ElemTypeArray& et, *ba = 0);
        //   bdlmxxx::Table(const my_ElemTypeArray& et, allocationMode, *ba = 0);
        //   bdlmxxx::Table(const bdlmxxx::Table& original, *ba = 0);
        //   bdlmxxx::Table(const bdlmxxx::Table& original, allocationMode, *ba = 0);
        // --------------------------------------------------------------------

        DECLARE_TEST_ALLOCATOR
        DECLARE_MAIN_VARIABLES

        if (verbose) cout << "bdlmxxx::Table(alloc)" << endl;
        ...
        BSLMA_TESTALLOCATOR_EXCEPTION_TEST_BEGIN(testAllocator) {
            ...
            const bdlmxxx::ElemType::Type ETA[] = {
        ...
        if (verbose) cout << "verify BDEM_PASS_THROUGH default" << endl;
        {
            ...
            const bdlmxxx::ElemType::Type ETA2[] = {
                bdlmxxx::ElemType::BDEM_STRING_ARRAY
            };
        ...
        if (verbose) cout << "bdlmxxx::Table(option, alloc)" << endl;

        static const struct {
            int                        d_lineNum; // source line number
            bdlmxxx::AggregateOption::AllocationStrategy d_option;
           ...
           { L_, bdlmxxx::AggregateOption::BDEM_PASS_THROUGH,         10,
                 COMPARE_GT, COMPARE_EQ, COMPARE_EQ },
           { L_, bdlmxxx::AggregateOption::BDEM_WRITE_MANY,       10,
                 COMPARE_EQ, COMPARE_EQ, COMPARE_EQ },
           { L_, bdlmxxx::AggregateOption::BDEM_WRITE_ONCE, 10,
        ...
        for (int ti = 0; ti < NUM_OPTDATA; ++ti) {
            ...
            if (veryVerbose)
                cout << "bdlmxxx::Table(" << optionToString(OPTVAL)
                     << ", alloc)" << endl;
            ...
            const bdlmxxx::ElemType::Type ETA3[] = {
                bdlmxxx::ElemType::BDEM_CHAR_ARRAY
            };
        ...
        {
            Table T2(bdlmxxx::AggregateOption::BDEM_PASS_THROUGH, Z);
        ...
        const bdlmxxx::ElemType::Type elems[] = {
            bdlmxxx::ElemType::BDEM_CHAR,
            bdlmxxx::ElemType::BDEM_LIST
        };

        if (verbose) cout << "bdlmxxx::Table(elems, alloc)" << endl;
        BSLMA_TESTALLOCATOR_EXCEPTION_TEST_BEGIN(testAllocator) {
        ...
        for (int ti = 0; ti < NUM_OPTDATA; ++ti) {
            ...
            if (veryVerbose)
                cout << "bdlmxxx::Table(elems, " << optionToString(OPTVAL)
                     << ", alloc)" << endl;
...

        {
            for (int ti = 0; ti < NUM_DATA; ++ti) {
                ...
                Table T3(vectorData(e1), e1.size(),
                         bdlmxxx::AggregateOption::BDEM_WRITE_MANY, Z);
        ...
        if (verbose) cout << "\nCopy construct values." << endl;
        {
            for (int ti = 0; ti < NUM_DATA; ++ti) {
                ...
                {                           // Table, Option, Allocator
                    const Table Y(X, bdlmxxx::AggregateOption::BDEM_WRITE_MANY, Z);
                    if (veryVerbose) { cout << "\t\t\t"; P(Y); }
                    LOOP_ASSERT(SPEC, W == Y);
                    LOOP_ASSERT(SPEC, W == X);
                }
        ...
        for (int ti = 0; ti < NUM_OPTDATA; ++ti) {
            ...
            if (veryVerbose)
                cout << "bdlmxxx::Table(Table, " << optionToString(OPTVAL)
                     << ", alloc)" << endl;
            ...
            BSLMA_TESTALLOCATOR_EXCEPTION_TEST_BEGIN(testAllocator) {
                ...
                ASSERT(T3.numRows() == 0 && T3.numColumns() == 0);
                ETA.clear();
                ETA.push_back(bdlmxxx::ElemType::BDEM_CHAR);
                ETA.push_back(bdlmxxx::ElemType::BDEM_CHAR_ARRAY);
                ETA.push_back(bdlmxxx::ElemType::BDEM_STRING_ARRAY);
...
DEFINE_TEST_CASE(11) {
        // --------------------------------------------------------------------
        // TESTING 'bdlmxxx::List' CONSTRUCTORS
        // Concerns:
        //   a. The Pool option must be used as specified.
        //   b. The internal state is valid for all possible options
        //      settings, and for different source elements.
        ...
        //   For these bdlmxxx::List objects, a string array is created.
        ...
        //   a) For bdlmxxx::List object with BDEM_PASS_THROUGH.  Adding and
        //      removing the array causes memory allocation and deallocation.
        //   b) For bdlmxxx::List object with BDEM_WRITE_MANY.  Adding causes
        //      memory allocation.  However, removing and re-adding does not
        //      cause any memory allocation or deallocation.
        //   c) For bdlmxxx::List object with BDEM_WRITE_ONCE.  Adding causes
        //      memory allocation.  Removing the array does not cause any
        //      deallocation.  Re-adding the array causes memory allocation.
        //
        // Testing:
        //   bdlmxxx::List(bslma::Allocator *ba = 0);
        //   bdlmxxx::List(bdlmxxx::AggregateOption::AllocationStrategy, *ba = 0);
        //   bdlmxxx::List(const my_ElemTypeArray& et, *ba = 0);
        //   bdlmxxx::List(const my_ElemTypeArray& et, option, *ba = 0);
        //   bdlmxxx::List(const ExplicitRow& original, *ba = 0);
        //   bdlmxxx::List(const bdlmxxx::List& original, *ba = 0);
        //   bdlmxxx::List(const ExplicitRow& original, option, *ba = 0);
        //   bdlmxxx::List(const bdlmxxx::List& original, option, *ba = 0);
        // --------------------------------------------------------------------

        DECLARE_TEST_ALLOCATOR
        DECLARE_MAIN_VARIABLES

        if (verbose) cout << "bdlmxxx::List(alloc)" << endl;
        ...
        if (verbose) cout << "bdlmxxx::List(option, alloc)" << endl;
        ...
        for (int ti = 0; ti < NUM_DATA; ++ti) {
            ...
            if (veryVerbose)
                cout << "bdlmxxx::List(" << optionToString(OPTVAL)
                     << ", alloc)" << endl;
...

        {
            ...
            List L2(bdlmxxx::AggregateOption::BDEM_WRITE_ONCE, Z);
        ...
        if (verbose) cout << "verify NO_HINT option" << endl;
        {
            List L2(bdlmxxx::AggregateOption::BDEM_PASS_THROUGH, Z);
        ...
        elems.push_back(bdlmxxx::ElemType::BDEM_CHAR);
        elems.push_back(bdlmxxx::ElemType::BDEM_LIST);

        if (verbose) cout << "bdlmxxx::List(elems, alloc)" << endl;
        BSLMA_TESTALLOCATOR_EXCEPTION_TEST_BEGIN(testAllocator) {
        ...
        for (int ti = 0; ti < NUM_DATA; ++ti) {
            ...
            if (veryVerbose)
                cout << "bdlmxxx::List(elems, " << optionToString(OPTVAL)
                     << ", alloc)" << endl;
        ...
        if (verbose) cout << "\nCopy construct values." << endl;
        {
            ...
            for (int ti = 0; SPECS[ti]; ++ti) {
                ...
                {                           // Allocator.  Option, List
                    const List Y4(X, bdlmxxx::AggregateOption::BDEM_WRITE_MANY,
                                     Z);
        ...
        for (int ti = 0; ti < NUM_DATA; ++ti) {
            ...
            if (veryVerbose)
                cout << "bdlmxxx::List(List, " << optionToString(OPTVAL)
                     << ", " << ", alloc)" << endl;
...
DEFINE_TEST_CASE(10) {
        // --------------------------------------------------------------------
        // TESTING 'bdlmxxx::Row' AND 'bdlmxxx::List' makeValueNull, ETC. MANIPULATORS
        // Concerns:
        ...
        //
        // Plan:
        //   The 'bdlmxxx::List' methods forward to the 'bdlmxxx::Row' functions.
        //   Therefore, after verifying the 'bdlmxxx::Row' functions for a single
        //   value, the complete testing can be performed with the 'bdlmxxx::List'
        //   functions.
        //    a) Test with values from all 22 types.
        //    b) Verify exception neutrality.
        //
        // Testing:
        //   void bdlmxxx::Row::makeAllNull();
        //   void bdlmxxx::Row::makeValueNull(int index);
        //   void bdlmxxx::Row::makeRangeNull(int si, int ne);
        //
        //   void bdlmxxx::List::makeAllNull();
        //   void bdlmxxx::List::makeValueNull(int index);
        //   void bdlmxxx::List::makeRangeNull(int si, int ne);
        // --------------------------------------------------------------------
        ...
        if (verbose) {
            cout << endl
                 << "Testing bdlmxxx::Row and bdlmxxx::List 'makeValueNull' Manip."
                 << endl
                 << "======================================================"
                 << endl;
        }

        if (verbose) cout << "\tTesting 'bdlmxxx::Row' functions." << endl;
        {
            if (verbose) cout << "\t\tTesting 'bdlmxxx::Row::makeAllNull'."
                              << endl;
        ...
        {
            if (verbose) cout << "\t\tTesting 'bdlmxxx::Row::makeValueNull'."
                              << endl;
        ...
        {
            if (verbose) cout << "\t\tTesting 'bdlmxxx::Row::makeRangeNull'."
                              << endl;
        ...
        if (verbose) cout << "Testing bdlmxxx::List functions." << endl;
        {
            static const struct {
                int         d_lineNum;  // source line number
                const char *d_spec;     // source list
...
DEFINE_TEST_CASE(9) {
        // --------------------------------------------------------------------
        // TESTING 'bdlmxxx::Row' and 'bdlmxxx::List' ISNULL, ETC. ACCESSORS
        // Concerns:
        ...
        //
        // Testing:
        //   int bdlmxxx::Row::isAnyNonNull() const;
        //   int bdlmxxx::Row::isAnyNull() const;
        //   int bdlmxxx::Row::isNonNull(int index) const;
        //   int bdlmxxx::Row::operator[](int index) const;
        //
        //   int bdlmxxx::List::isAnyNonNull() const;
        //   int bdlmxxx::List::isAnyNull() const;
        //   int bdlmxxx::List::operator[](int index) const;
        //
        //   int bdem::Elemref::isNull(int index) const;
        //   int bdem::Elemref::isNonNull(int index) const;
        // --------------------------------------------------------------------
        ...
        if (verbose) cout << endl
                          << "Testing bdlmxxx::List IsSet Accessors" << endl
                          << "=================================" << endl;

        {
            ...
            // Specific test for bdlmxxx::List
            {
                List mU(&testAllocator);
                mU.appendNullList();
            ...
            // Specific test for bdlmxxx::Table
            {
                List mU(&testAllocator);
                mU.appendNullTable();
...
DEFINE_TEST_CASE(8) {
        ...
        //
        // Testing
        //   void reverseList(bdlmxxx::List *list);
        //   void reverseSpec(char *spec);
        // --------------------------------------------------------------------
...
DEFINE_TEST_CASE(7) {
        // --------------------------------------------------------------------
        // TESTING 'bdlmxxx::List' SWAP METHOD
        // Concerns:
        ...
        if (verbose) cout << endl
                          << "Testing bdlmxxx::List 'swap' Method" << endl
                          << "===============================" << endl;
...
DEFINE_TEST_CASE(6) {
        // --------------------------------------------------------------------
        // TESTING 'bdlmxxx::Row' AND 'bdlmxxx::List' EQUALITY OPERATORS
        // Concerns:
        ...
        //   bool operator!=(const bdlmxxx::Row& lhs, const bdlmxxx::Row& rhs);
        //
        //   bool operator==(const bdlmxxx::List&, const bdlmxxx::List&);
        //   bool operator!=(const bdlmxxx::List&, const bdlmxxx::List&);
        // --------------------------------------------------------------------
...
DEFINE_TEST_CASE(5) {
        // --------------------------------------------------------------------
        // TESTING 'bdlmxxx::Row', 'bdlmxxx::List', 'bdlmxxx::Table' OUTPUT (<<) OPERATORS
        ...
        //
        //   Since the 'bdlmxxx::List' and 'bdlmxxx::Table' functions both forward to
        //   the 'bdlmxxx::Row' function, it is sufficient to verify that the
        //   'bdlmxxx::Row' function operates for a single test value and then
        //   thoroughly test the 'bdlmxxx::List' and 'bdlmxxx::Table' functions.
        //
        // Testing:
        //   ostream& operator<<(ostream& stream, const bdlmxxx::Row& rhs);
        //   ostream& operator<<(ostream& stream, const bdlmxxx::List& rhs);
        //   ostream& operator<<(ostream& stream, const bdlmxxx::Table& rhs);
        // --------------------------------------------------------------------
        ...
        if (verbose)
            cout << "\nTesting 'operator<<' (ostream, bdlmxxx::Row&)." << endl;
        {
        ...
        if (verbose)
            cout << "\nTesting 'operator<<' (ostream, bdlmxxx::List&)." << endl;
        {
            static const struct {
                int         d_lineNum;  // source line number
                const char *d_spec_p;   // specification string
        ...
        if (verbose)
            cout << "\nTesting 'operator<<' (ostream, bdlmxxx::Table&)." << endl;
        {
            static const struct {
                int         d_lineNum;  // source line number
                const char *d_spec_p;   // specification string
...
DEFINE_TEST_CASE(4) {
        // --------------------------------------------------------------------
        // TESTING GENERATOR FUNCTIONS 'HH' AND 'HHH' ('bdlmxxx::Table')
        // Plan:
        ...
        //
        // Testing:
        //   int hhh(bdlmxxx::Table *address, const char *spec, int showErrorFlag);
        //   bdlmxxx::Table& hh(bdlmxxx::Table *object, const char *spec);
        // --------------------------------------------------------------------
...
DEFINE_TEST_CASE(2) {
        // --------------------------------------------------------------------
        // BREATHING TEST FOR 'bdlmxxx::Table'
        // Concerns:
        //   The Breathing Test concerns for 'bdlmxxx::Table' are similar to those
        //   for 'bdlmxxx::List'.
        //
        // Plan:
        //   See the 12-step Test Plan for 'bdlmxxx::List' in case 1 below,
        ...
        //
        //   bdlmxxx::Table::~bdlmxxx::Table()
        // --------------------------------------------------------------------

        DECLARE_TEST_ALLOCATOR
        DECLARE_MAIN_VARIABLES

        if (verbose) cout << "\nBreathing Test -- 'bdlmxxx::Table':"
                          << "\n===============================" << endl;
        ...
        const bdlmxxx::ElemType::Type t1Types[] = {
            bdlmxxx::ElemType::BDEM_CHAR,
...
DEFINE_TEST_CASE(1) {
        // --------------------------------------------------------------------
        // BREATHING TEST FOR 'bdlmxxx::List'
        // Concerns:
        //   We are concerned that the basic (value-semantic) functionality of
        //   'bdlmxxx::List' works properly.  We are also concerned that the
        ...
        //   'bdlmxxx::Schema' breathing test, which is in turn inspired by
        //   'bsl::vector<double>'.
        //
        ...
        //         checking bdlmxxx::List::length(), and validating using the
        //         accessors.
        ...
        //   to the thorough testing done in subsequent cases.
        //
        //   bdlmxxx::List::~bdlmxxx::List()
        // --------------------------------------------------------------------

        DECLARE_TEST_ALLOCATOR
        DECLARE_MAIN_VARIABLES

        if (verbose) cout << "\nBreathing Test -- 'bdlmxxx::List':"
                          << "\n==============================" << endl;
