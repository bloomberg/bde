...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:
      case 4: {
        ...
        bdlmxxx::FunctionTemplates::printArray<bsl::vector<char> >(&v1, stream,
                                                               0, -1);
      ...
      case 3: {
        ...
        a1.push_back('t');
        a1.push_back('a');
        bdlxxxx::TestOutStream strm1;

        bdlmxxx::FunctionTemplates::streamOutArray<char, bdlxxxx::TestOutStream>(
            &a1, strm1, 0,
            (const bdlmxxx::DescriptorStreamOut<bdlxxxx::TestOutStream> *) 0);
        ...
        bdlxxxx::TestInStream strm2(strm1.data(), strm1.length());

        bdlmxxx::FunctionTemplates::streamInArray<char, bdlxxxx::TestInStream>(
                &a2, strm2, 0,
                (const bdlmxxx::DescriptorStreamIn<bdlxxxx::TestInStream> *) 0,
      ...
      case 2: {
        ...
        bdlmxxx::FunctionTemplates::streamOutFundamental<int, bdlxxxx::TestOutStream>(
            &a, strm, 1,
            (const bdlmxxx::DescriptorStreamOut<bdlxxxx::TestOutStream> *) 0);
      ...
      case 1: {
        int val = 0;
        bdlmxxx::FunctionTemplates::makeUnset<int>(&val);
        ASSERT(val == INT_MIN);
      } break;
