// bdlmxxx_configschema.cpp   -*-C++-*-   GENERATED FILE -- DO NOT EDIT

#include <bsls_ident.h>
BSLS_IDENT_RCSID(bdlmxxx_configschema_cpp,"$Id$ $CSID$")

#include <bdlmxxx_configschema.h>

namespace BloombergLP {

// CONSTANTS

const char bdlmxxx::ConfigSchema::TEXT[] =
