...
// is verified using 'bdlxxxx_testinstream' (and 'bdlxxxx_testoutstream').
//
// Note further that the 'bdlmxxx::RowLayout' is a parameterized type therefore
...
// we provide a helper function to set the 'bdlmxxx::RowLayout' total offset
// (i.e., the cursor position).
//
//-----------------------------------------------------------------------------
// [ 2] bdlmxxx::RowLayout(bslma::Allocator *ba = 0);
// [16] bdlmxxx::RowLayout(const InitialCapacity& ne, *ba = 0);
// [11] bdlmxxx::RowLayout(const my_ElemTypeArray& sa, *ba = 0);
// [ 7] bdlmxxx::RowLayout(const bdlmxxx::RowLayout& original, *ba = 0);
// [ 2] ~bdlmxxx::RowLayout();
// [12] void append(bdlmxxx::ElemType::Type item);
// [12] void append(const my_ElemTypeArray& sa);
// [12] void append(const my_ElemTypeArray& sa, int si, int ne);
// [12] void insert(int di, bdlmxxx::ElemType::Type item);
...
// [ 2] void removeAll();
// [13] void replace(int di, bdlmxxx::ElemType::Type item);
...
// [10] static int typeAlignment(bdlmxxx::ElemType::Type item);
// [10] static int typeSize(bdlmxxx::ElemType::Type item);
// [17] void compact();
...
// [ 4] bdlmxxx::ElemType::Type getType(int index) const;
...
//-----------------------------------------------------------------------------
// [ 6] bool operator==(const bdlmxxx::RowLayout& lhs,
//                      const bdlmxxx::RowLayout& rhs);
// [ 6] bool operator!=(const bdlmxxx::RowLayout& lhs,
//                      const bdlmxxx::RowLayout& rhs);
// [ 5] ostream& operator<<(ostream& os, const bdlmxxx::RowLayout& rhs);
//-----------------------------------------------------------------------------
// [ 1] BREATHING TEST
// [21] USAGE EXAMPLE
// [ 2] BOOTSTRAP: void insert(int di, bdlmxxx::ElemType::Type item);  // !aliasing
...
typedef bdlmxxx::RowLayout         Obj;
typedef const bdlmxxx::Descriptor *Element;
...
const bdlmxxx::Descriptor *const typesLookupTable[NUM_TYPES] =
{
    &ElemAttGenerator<bdlmxxx::ElemType::BDEM_CHAR,char>::s,
    &ElemAttGenerator<bdlmxxx::ElemType::BDEM_SHORT,short>::s,
    &ElemAttGenerator<bdlmxxx::ElemType::BDEM_INT,int>::s,
    &ElemAttGenerator<bdlmxxx::ElemType::BDEM_INT64,Int64>::s,
    &ElemAttGenerator<bdlmxxx::ElemType::BDEM_FLOAT,float>::s,
    &ElemAttGenerator<bdlmxxx::ElemType::BDEM_DOUBLE,double>::s,
    &ElemAttGenerator<bdlmxxx::ElemType::BDEM_STRING,bsl::string>::s,
    &ElemAttGenerator<bdlmxxx::ElemType::BDEM_DATETIME,bdlt::Datetime>::s,
    &ElemAttGenerator<bdlmxxx::ElemType::BDEM_DATE,bdlt::Date>::s,
    &ElemAttGenerator<bdlmxxx::ElemType::BDEM_TIME,bdlt::Time>::s,
    &ElemAttGenerator<bdlmxxx::ElemType::BDEM_CHAR_ARRAY,bsl::vector<char> >::s,
    &ElemAttGenerator<bdlmxxx::ElemType::BDEM_SHORT_ARRAY,bsl::vector<short> >::s,
    &ElemAttGenerator<bdlmxxx::ElemType::BDEM_INT_ARRAY,bsl::vector<int> >::s,
    &ElemAttGenerator<bdlmxxx::ElemType::BDEM_INT64_ARRAY,bsl::vector<Int64> >::s,
    &ElemAttGenerator<bdlmxxx::ElemType::BDEM_FLOAT_ARRAY,bsl::vector<float> >::s,
    &ElemAttGenerator<bdlmxxx::ElemType::BDEM_DOUBLE_ARRAY,
                      bsl::vector<double> >::s,
    &ElemAttGenerator<bdlmxxx::ElemType::BDEM_STRING_ARRAY,
                                               bsl::vector<bsl::string> >::s,
    &ElemAttGenerator<bdlmxxx::ElemType::BDEM_DATETIME_ARRAY,
                                               bsl::vector<bdlt::Datetime> >::s,
    &ElemAttGenerator<bdlmxxx::ElemType::BDEM_DATE_ARRAY,
                      bsl::vector<bdlt::Date> >::s,
    &ElemAttGenerator<bdlmxxx::ElemType::BDEM_TIME_ARRAY,
                      bsl::vector<bdlt::Time> >::s,
    &ElemAttGenerator<bdlmxxx::ElemType::BDEM_LIST,ListRep>::s,
    &ElemAttGenerator<bdlmxxx::ElemType::BDEM_TABLE,TableRep>::s,
    // New types added
    &ElemAttGenerator<bdlmxxx::ElemType::BDEM_BOOL,bool>::s,
    &ElemAttGenerator<bdlmxxx::ElemType::BDEM_DATETIMETZ,bdlt::DatetimeTz>::s,
    &ElemAttGenerator<bdlmxxx::ElemType::BDEM_DATETZ,bdlt::DateTz>::s,
    &ElemAttGenerator<bdlmxxx::ElemType::BDEM_TIMETZ,bdlt::TimeTz>::s,
    &ElemAttGenerator<bdlmxxx::ElemType::BDEM_BOOL_ARRAY,bsl::vector<bool> >::s,
    &ElemAttGenerator<bdlmxxx::ElemType::BDEM_DATETIMETZ_ARRAY,
                                             bsl::vector<bdlt::DatetimeTz> >::s,
    &ElemAttGenerator<bdlmxxx::ElemType::BDEM_DATETZ_ARRAY,
                                                 bsl::vector<bdlt::DateTz> >::s,
    &ElemAttGenerator<bdlmxxx::ElemType::BDEM_TIMETZ_ARRAY,
                                                 bsl::vector<bdlt::TimeTz> >::s,
    &ElemAttGenerator<bdlmxxx::ElemType::BDEM_CHOICE,ChoiceRep>::s,
    &ElemAttGenerator<bdlmxxx::ElemType::BDEM_CHOICE_ARRAY,ChoiceArrayRep>::s,
};

const Element VALUES[] = {
    typesLookupTable[bdlmxxx::ElemType::BDEM_CHAR],
    typesLookupTable[bdlmxxx::ElemType::BDEM_SHORT],
    typesLookupTable[bdlmxxx::ElemType::BDEM_INT],
    typesLookupTable[bdlmxxx::ElemType::BDEM_INT64],
    typesLookupTable[bdlmxxx::ElemType::BDEM_FLOAT],
}; // avoid DEFAULT_VALUE
...
void getElemTypeArray(my_ElemTypeArray         *retArray,
                      const bdlmxxx::RowLayout&     map)
{
    int myLength = map.length();

    retArray->resize(myLength);
    for (int i = 0; i < myLength; ++i) {
        (*retArray)[i] = (bdlmxxx::ElemType::Type)map[i].attributes()->d_elemEnum;
    }
}

void getElemAttrArray(bsl::vector<const bdlmxxx::Descriptor*> *retArray,
                      const bdlmxxx::RowLayout&                map)
{
    int  myLength = map.length();
    retArray->resize(myLength);
...
void getOffsetArray(bsl::vector<int> *retArray, const bdlmxxx::RowLayout& map)
{
    int  myLength = map.length();
    retArray->resize(myLength);
    for (int i = 0; i < myLength; ++i) {
    ...
    // The behavior is undefined unless 0 <= size.
{
    ...
    for (int i = 0; i < size; ++i) {
        object->append(typesLookupTable[bdlmxxx::ElemType::BDEM_CHAR]);
    }
...
// of 'bdlmxxx::RowLayout'.  They are defined here to facilitate testing.

bool operator==(const bdlmxxx::RowLayout& lhs, const bdlmxxx::RowLayout& rhs)
{
...
bsl::ostream& operator<<(bsl::ostream& stream, const bdlmxxx::RowLayout& rhs)
{
    bsl::vector<int> rhsOffsets;
    my_ElemTypeArray rhsTypes;
    getElemTypeArray(&rhsTypes, rhs);
    ...
    stream << "Types: ";
    bdlb::PrintMethods::print(stream, rhsTypes, 0, -1);
    stream << " Offsets: ";
    bdlb::PrintMethods::print(stream, rhsOffsets, 0, -1);
...
// inserted into the 'bdlmxxx::RowLayout' object.  A tilde ('~') indicates that
    ...
    // syntax error detection.
{
    ...
    for (int i = 0; i < len; i++) {
        if (spec[i] == '~') {
            ...
            bdlmxxx::ElemType::Type item = (bdlmxxx::ElemType::Type)(spec[i]-'A');
            obj->insert(obj->length(), typesLookupTable[item]);
        }
        else if (spec[i] >= 'a' && spec[i] <= 'j') {
            // New types added at the 22nd position
            bdlmxxx::ElemType::Type item = (bdlmxxx::ElemType::Type)(spec[i]-'a'+22);
            obj->insert(obj->length(), typesLookupTable[item]);
        }
        else {
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      case 20: {
        ...
        enum {
            CHAR_TYPE  = bdlmxxx::ElemType::BDEM_CHAR,
            SHORT_TYPE = bdlmxxx::ElemType::BDEM_SHORT,
            INT_TYPE   = bdlmxxx::ElemType::BDEM_INT
        };
      ...
      case 19: {
        ...
        if (verbose) bsl::cout << "\tOn corrupted data." << bsl::endl;
        {
                                   ...
                                   << bsl::endl;
            {
                Out out;
                out.putLength(1);
                bdlmxxx::ElemType::bdexStreamOut(out, bdlmxxx::ElemType::BDEM_INT, 1);
  ...
  || defined(BSLS_PLATFORM_OS_AIX)
        ...
        for (int ti = 0; ti < NUM_DATA; ti++) {
            ...
            z.append(typesLookupTable[bdlmxxx::ElemType::BDEM_CHAR]);
            getElemTypeArray(&eta,x);
  ...
  || defined(BSLS_PLATFORM_OS_AIX)
      ...
      case 16: {
        ...
        //
        // Testing:
        //   bdlmxxx::RowLayout(const InitialCapacity& ne, *ba = 0);
        //
        ...
        if (verbose) cout <<
            "\nTesting 'bdlmxxx::RowLayout(capacity, ba)' Constructor" << endl;
...
#undef NL
      ...
      case 13: {
        ...
        //
        // Testing:
        //   void replace(int di, bdlmxxx::ElemType::Type item);
      ...
      case 12: {
        ...
        //    void append(const bdlmxxx::RowLayout<T>& srcMap, int si, int ne);
        //    void append(const bdlmxxx::RowLayout<T>& srcMap);
        //
        ...
        //
        // Testing:
        //   void append(bdlmxxx::ElemType::Type item);
        //   void append(const my_ElemTypeArray& sa);
        //   void append(const my_ElemTypeArray& sa, int si, int ne);
        //
        //   void insert(int di, bdlmxxx::ElemType::Type item);
        //   void insert(int di, const my_ElemTypeArray& sa);
      ...
      case 11: {
        ...
        //
        // Testing:
        //   bdlmxxx::RowLayout(const my_ElemTypeArray& sa, *ba = 0);
        // --------------------------------------------------------------------
        ...
        if (verbose) cout << "\nTesting ctor using my_ElemTypeArray."
                          << endl;
        {
            const bdlmxxx::ElemType::Type da[] = {
            ...
            for (int ti = 0; ti < NUM_TYPES; ++ti) {
              switch (bdemType[ti]) {  // AB...UVab..gh
                case 'A': {
                  ...
                  ASSERT(sizeof(char) ==
                         typesLookupTable[bdlmxxx::ElemType::BDEM_CHAR]->d_size);
                  if (veryVerbose) {
                      P(typesLookupTable[
                                             bdlmxxx::ElemType::BDEM_CHAR
                                        ]->d_alignment);
                      T_(); P(bsls::AlignmentFromType<char>::VALUE);
                      P(typesLookupTable[bdlmxxx::ElemType::BDEM_CHAR]->d_size);
                      T_(); P(sizeof(char));
                  }
                } break;
                case 'B': {
                  ...
                  ASSERT(sizeof(short) ==
                         typesLookupTable[bdlmxxx::ElemType::BDEM_SHORT]->d_size);
                  if (veryVerbose) {
                      P(typesLookupTable[
                                             bdlmxxx::ElemType::BDEM_SHORT
                                        ]->d_alignment);
                      T_(); P(bsls::AlignmentFromType<short>::VALUE);
                      P(typesLookupTable[bdlmxxx::ElemType::BDEM_SHORT]->d_size);
                      T_(); P(sizeof(short));
                  }
                } break;
                case 'C': {
                  ...
                  ASSERT(sizeof(int) ==
                         typesLookupTable[bdlmxxx::ElemType::BDEM_INT]->d_size);
                  if (veryVerbose) {
                      P(typesLookupTable[
                                             bdlmxxx::ElemType::BDEM_INT
                                        ]->d_alignment);
                      T_(); P(bsls::AlignmentFromType<int>::VALUE);
                      P(typesLookupTable[bdlmxxx::ElemType::BDEM_INT]->d_size);
                      T_(); P(sizeof(int));
                  }
                } break;
                case 'D': {
                  ...
                  ASSERT(sizeof(Int64) ==
                         typesLookupTable[bdlmxxx::ElemType::BDEM_INT64]->d_size);
                  if (veryVerbose) {
                      P(typesLookupTable[
                                             bdlmxxx::ElemType::BDEM_INT64
                                        ]->d_alignment);
                      T_(); P(bsls::AlignmentFromType<Int64>::VALUE);
                      P(typesLookupTable[bdlmxxx::ElemType::BDEM_INT64]->d_size);
                      T_(); P(sizeof(Int64));
                  }
                } break;
                case 'E': {
                  ...
                  ASSERT(sizeof(float) ==
                         typesLookupTable[bdlmxxx::ElemType::BDEM_FLOAT]->d_size);
                  if (veryVerbose) {
                      P(typesLookupTable[
                                             bdlmxxx::ElemType::BDEM_FLOAT
                                        ]->d_alignment);
                      T_(); P(bsls::AlignmentFromType<float>::VALUE);
                      P(typesLookupTable[bdlmxxx::ElemType::BDEM_FLOAT]->d_size);
                                      T_(); P(sizeof(float));
                  }
                } break;
                case 'F': {
                  ...
                  ASSERT(sizeof(double) ==
                         typesLookupTable[bdlmxxx::ElemType::BDEM_DOUBLE]->d_size);
                  if (veryVerbose) {
                      P(typesLookupTable[
                                             bdlmxxx::ElemType::BDEM_DOUBLE
                                        ]->d_alignment);
                      T_(); P(bsls::AlignmentFromType<double>::VALUE);
                      P(typesLookupTable[bdlmxxx::ElemType::BDEM_DOUBLE]->d_size);
                      T_(); P(sizeof(double));
                  }
                } break;
                case 'G': {
                  ...
                  ASSERT(sizeof(bsl::string) ==
                         typesLookupTable[bdlmxxx::ElemType::BDEM_STRING]->d_size);
                  if (veryVerbose) {
                      P(typesLookupTable[
                                             bdlmxxx::ElemType::BDEM_STRING
                                        ]->d_alignment);
                      T_(); P(bsls::AlignmentFromType<bsl::string>::VALUE);
                      P(typesLookupTable[bdlmxxx::ElemType::BDEM_STRING]->d_size);
                      T_(); P(sizeof(bsl::string));
                  }
                } break;
                case 'H': {
                  ASSERT(bsls::AlignmentFromType<bdlt::Datetime>::VALUE ==
                       typesLookupTable[
                                            bdlmxxx::ElemType::BDEM_DATETIME
                                       ]->d_alignment);
                  ASSERT(sizeof(bdlt::Datetime) ==
                         typesLookupTable[
                                              bdlmxxx::ElemType::BDEM_DATETIME
                                         ]->d_size);
                  if (veryVerbose) {
                      ...
                      T_(); P(bsls::AlignmentFromType<bdlt::Datetime>::VALUE);
                      P(typesLookupTable[
                                             bdlmxxx::ElemType::BDEM_DATETIME
                                        ]->d_size);
                      T_(); P(sizeof(bdlt::Datetime));
                  }
                } break;
                case 'I': {
                  ASSERT(bsls::AlignmentFromType<bdlt::Date>::VALUE ==
                         typesLookupTable[
                                              bdlmxxx::ElemType::BDEM_DATE
                                         ]->d_alignment);
                  ASSERT(sizeof(bdlt::Date) ==
                         typesLookupTable[bdlmxxx::ElemType::BDEM_DATE]->d_size);
                  if (veryVerbose) {
                      P(typesLookupTable[
                                             bdlmxxx::ElemType::BDEM_DATE
                                        ]->d_alignment);
                      T_(); P(bsls::AlignmentFromType<bdlt::Date>::VALUE);
                      P(typesLookupTable[bdlmxxx::ElemType::BDEM_DATE]->d_size);
                      T_(); P(sizeof(bdlt::Date));
                  }
                } break;
                case 'J': {
                  ASSERT(bsls::AlignmentFromType<bdlt::Time>::VALUE ==
                         typesLookupTable[
                                              bdlmxxx::ElemType::BDEM_TIME
                                         ]->d_alignment);
                  ASSERT(sizeof(bdlt::Time) ==
                         typesLookupTable[bdlmxxx::ElemType::BDEM_TIME]->d_size);
                  if (veryVerbose) {
                      P(typesLookupTable[
                                             bdlmxxx::ElemType::BDEM_TIME
                                        ]->d_alignment);
                      T_(); P(bsls::AlignmentFromType<bdlt::Time>::VALUE);
                      P(typesLookupTable[bdlmxxx::ElemType::BDEM_TIME]->d_size);
                      T_(); P(sizeof(bdlt::Time));
                  }
                } break;
                case 'K': {
                ...
                case 'R': {
                  ASSERT(
                    bsls::AlignmentFromType<bsl::vector<bdlt::Datetime> >::VALUE
                     == typesLookupTable[bdlmxxx::ElemType::BDEM_DATETIME_ARRAY]->
                                                                  d_alignment);
                  ASSERT(sizeof(bsl::vector<bdlt::Datetime>) ==
                      typesLookupTable[
                                           bdlmxxx::ElemType::BDEM_DATETIME_ARRAY
                                      ]->d_size);
                  if (veryVerbose) {
                      P(typesLookupTable[bdlmxxx::ElemType::BDEM_DATETIME_ARRAY]->
                                                                  d_alignment);
                      T_();
                      P(
                  bsls::AlignmentFromType<bsl::vector<bdlt::Datetime> >::VALUE);
                      P(typesLookupTable[bdlmxxx::ElemType::BDEM_DATETIME_ARRAY]->
                                                                       d_size);
                      T_(); P(sizeof(bsl::vector<bdlt::Datetime>));
                  }
                } break;
                case 'S': {
                  ASSERT(
                     bsls::AlignmentFromType<bsl::vector<bdlt::Date> >::VALUE ==
                         typesLookupTable[bdlmxxx::ElemType::BDEM_DATE_ARRAY]->
                                                                  d_alignment);
                  ASSERT(sizeof(bsl::vector<bdlt::Date>) ==
                         typesLookupTable[
                                              bdlmxxx::ElemType::BDEM_DATE_ARRAY
                                         ]->d_size);
                  if (veryVerbose) {
                      P(typesLookupTable[bdlmxxx::ElemType::BDEM_DATE_ARRAY]->
                              d_alignment);
                      T_(); P(bsls::AlignmentFromType<
                      ...
                      T_(); P(sizeof(bsl::vector<bdlt::Date>));
                  }
                } break;
                case 'T': {
                  ASSERT(
                     bsls::AlignmentFromType<bsl::vector<bdlt::Time> >::VALUE ==
                         typesLookupTable[bdlmxxx::ElemType::BDEM_TIME_ARRAY]->
                                                                  d_alignment);
                  ASSERT(sizeof(bsl::vector<bdlt::Time>) ==
                         typesLookupTable[
                                              bdlmxxx::ElemType::BDEM_TIME_ARRAY
                                         ]->d_size);
                  if (veryVerbose) {
                      P(typesLookupTable[bdlmxxx::ElemType::BDEM_TIME_ARRAY]->
                              d_alignment);
                      T_(); P(bsls::AlignmentFromType<
                      ...
                      T_(); P(sizeof(bsl::vector<bdlt::Time>));
                  }
                } break;
                case 'U': {
                  ...
                  ASSERT(sizeof(ListRep) ==
                         typesLookupTable[bdlmxxx::ElemType::BDEM_LIST]->d_size);
                  if (veryVerbose) {
                      P(typesLookupTable[
                                             bdlmxxx::ElemType::BDEM_LIST
                                        ]->d_alignment);
                      T_(); P(bsls::AlignmentFromType<ListRep>::VALUE);
                      P(typesLookupTable[bdlmxxx::ElemType::BDEM_LIST]->d_size);
                      T_(); P(sizeof(ListRep));
                  }
                } break;
                case 'V': {
                  ...
                  ASSERT(sizeof(TableRep) ==
                         typesLookupTable[bdlmxxx::ElemType::BDEM_TABLE]->d_size);
                  if (veryVerbose) {
                      P(typesLookupTable[
                                             bdlmxxx::ElemType::BDEM_TABLE
                                        ]->d_alignment);
                      T_(); P(bsls::AlignmentFromType<TableRep>::VALUE);
                      P(typesLookupTable[bdlmxxx::ElemType::BDEM_TABLE]->d_size);
                ...
                case 'a': {
                  ...
                  ASSERT(sizeof(bool) ==
                         typesLookupTable[bdlmxxx::ElemType::BDEM_BOOL]->d_size);
                  if (veryVerbose) {
                      P(typesLookupTable[
                                             bdlmxxx::ElemType::BDEM_BOOL
                                        ]->d_alignment);
                      T_(); P(bsls::AlignmentFromType<bool>::VALUE);
                      P(typesLookupTable[bdlmxxx::ElemType::BDEM_BOOL]->d_size);
                      T_(); P(sizeof(bool));
                  }
                } break;
                case 'b': {
                  ASSERT(bsls::AlignmentFromType<bdlt::DatetimeTz>::VALUE ==
                         typesLookupTable[bdlmxxx::ElemType::BDEM_DATETIMETZ]->
                                                                  d_alignment);
                  ASSERT(sizeof(bdlt::DatetimeTz) ==
                         typesLookupTable[
                  ...
                  if (veryVerbose) {
                      ...
                      T_();
                      P(bsls::AlignmentFromType<bdlt::DatetimeTz>::VALUE);
                      P(typesLookupTable[
                                             bdlmxxx::ElemType::BDEM_DATETIMETZ
                                        ]->d_size);
                      T_(); P(sizeof(bdlt::DatetimeTz));
                  }
                } break;
                case 'c': {
                  ASSERT(bsls::AlignmentFromType<bdlt::DateTz>::VALUE ==
                         typesLookupTable[
                                              bdlmxxx::ElemType::BDEM_DATETZ
                                         ]->d_alignment);
                  ASSERT(sizeof(bdlt::DateTz) ==
                         typesLookupTable[bdlmxxx::ElemType::BDEM_DATETZ]->d_size);
                  if (veryVerbose) {
                      P(typesLookupTable[
                                             bdlmxxx::ElemType::BDEM_DATETZ
                                        ]->d_alignment);
                      T_(); P(bsls::AlignmentFromType<bdlt::DateTz>::VALUE);
                      P(typesLookupTable[bdlmxxx::ElemType::BDEM_DATETZ]->d_size);
                      T_(); P(sizeof(bdlt::DateTz));
                  }
                } break;
                case 'd': {
                  ASSERT(bsls::AlignmentFromType<bdlt::TimeTz>::VALUE ==
                         typesLookupTable[
                                              bdlmxxx::ElemType::BDEM_TIMETZ
                                         ]->d_alignment);
                  ASSERT(sizeof(bdlt::TimeTz) ==
                         typesLookupTable[bdlmxxx::ElemType::BDEM_TIMETZ]->d_size);
                  if (veryVerbose) {
                      P(typesLookupTable[
                                             bdlmxxx::ElemType::BDEM_TIMETZ
                                        ]->d_alignment);
                      T_(); P(bsls::AlignmentFromType<bdlt::TimeTz>::VALUE);
                      P(typesLookupTable[bdlmxxx::ElemType::BDEM_TIMETZ]->d_size);
                      T_(); P(sizeof(bdlt::TimeTz));
                  }
                } break;
                case 'e': {
                  ASSERT(bsls::AlignmentFromType<bsl::vector<bool> >::VALUE ==
                         typesLookupTable[bdlmxxx::ElemType::BDEM_BOOL_ARRAY]->
                                                                  d_alignment);
                ...
                case 'f': {
                  ASSERT(
                      bsls::AlignmentFromType<bsl::vector<bdlt::DatetimeTz> >::
                                                                       VALUE ==
                         typesLookupTable[
                                           bdlmxxx::ElemType::BDEM_DATETIMETZ_ARRAY
                                         ]->d_alignment);
                  ASSERT(sizeof(bsl::vector<bdlt::DatetimeTz>) ==
                         typesLookupTable[
                                           bdlmxxx::ElemType::BDEM_DATETIMETZ_ARRAY
                                         ]->d_size);
                  if (veryVerbose) {
                      ...
                      T_(); P(sizeof(bsl::vector<bdlt::DatetimeTz>));
                  }
                } break;
                case 'g': {
                  ASSERT(
                   bsls::AlignmentFromType<bsl::vector<bdlt::DateTz> >::VALUE ==
                         typesLookupTable[bdlmxxx::ElemType::BDEM_DATETZ_ARRAY]->
                                                                  d_alignment);
                  ASSERT(sizeof(bsl::vector<bdlt::DateTz>) ==
                         typesLookupTable[bdlmxxx::ElemType::BDEM_DATETZ_ARRAY]->
                                                                       d_size);
                  if (veryVerbose) {
                      P(typesLookupTable[
                      ...
                      T_();
                      P(bsls::AlignmentFromType<bsl::vector<bdlt::DateTz> >
                              ::VALUE);
                      P(typesLookupTable[
                                             bdlmxxx::ElemType::BDEM_DATETZ_ARRAY
                                        ]->d_size);
                      T_(); P(sizeof(bsl::vector<bdlt::DateTz>));
                  }
                } break;
                case 'h': {
                  ASSERT(
                   bsls::AlignmentFromType<bsl::vector<bdlt::TimeTz> >::VALUE ==
                         typesLookupTable[bdlmxxx::ElemType::BDEM_TIMETZ_ARRAY]->
                                                                  d_alignment);
                  ASSERT(sizeof(bsl::vector<bdlt::TimeTz>) ==
                         typesLookupTable[bdlmxxx::ElemType::BDEM_TIMETZ_ARRAY]->
                                                                       d_size);
                  if (veryVerbose) {
                      P(typesLookupTable[bdlmxxx::ElemType::BDEM_TIMETZ_ARRAY]->
                              d_alignment);
                      T_();
                      P(
                    bsls::AlignmentFromType<bsl::vector<bdlt::TimeTz> >::VALUE);
                      ...
                      T_(); P(sizeof(bsl::vector<bdlt::TimeTz>));
                  }
                } break;
                case 'i': {
                  ...
                  if (veryVerbose) {
                      ...
                      P(typesLookupTable[bdlmxxx::ElemType::BDEM_CHOICE]->d_size);
                      T_(); P(sizeof(ChoiceRep));
                  }
                } break;
                case 'j': {
                  ASSERT(bsls::AlignmentFromType<ChoiceArrayRep>::VALUE ==
                         typesLookupTable[bdlmxxx::ElemType::BDEM_CHOICE_ARRAY]->
                                                                  d_alignment);
                  ...
                  if (veryVerbose) {
                      P(typesLookupTable[bdlmxxx::ElemType::BDEM_CHOICE_ARRAY]->
                              d_alignment);
                      T_();
      ...
      case 9: {
        ...
        //
        // Testing:
        //   bdlmxxx::RowLayout& operator=(const bdlmxxx::RowLayout& rhs);
        // -------------------------------------------------------------------
      ...
      case 7: {
        ...
        //
        // Testing:
        //   bdlmxxx::RowLayout(const bdlmxxx::RowLayout& original, *ba = 0);
        // --------------------------------------------------------------------
      ...
      case 6: {
        ...
        //
        // Testing:
        //   bool operator==(const bdlmxxx::RowLayout& lhs,
        //                   const bdlmxxx::RowLayout& rhs);
        //   bool operator!=(const bdlmxxx::RowLayout& lhs,
        //                   const bdlmxxx::RowLayout& rhs);
        // --------------------------------------------------------------------
      ...
      case 5: {
        ...
        //
        // Testing:
        //   ostream& operator<<(ostream& os, const bdlmxxx::RowLayout& rhs);
        // --------------------------------------------------------------------
      ...
      case 4: {
        ...
        //     - length() const
        //     - bdlmxxx::ElemType::Type getType(int index) const
        ...
        //   'bdlmxxx::RowLayout'.  Based on input from table DATA, the size and
            ...
            for (int i = 0; i < NUM_DATA; i++) {
                ...
                for (int j = 0; j < NUM_TYPES; j++) {
                    ...
                    DD.insert(DD.totalOffset(),
                              typesLookupTable[(bdlmxxx::ElemType::Type) j]);
                   ...
                   LOOP_ASSERT(LINE, j == DD[CURSOR].attributes()->d_elemEnum);
                    ...
                    const int JTH_ALIGN =
                         typesLookupTable[(bdlmxxx::ElemType::Type)j]->d_alignment;
                    ...
                    LOOP_ASSERT(LINE,
                                JTH_OFFSET +
                               typesLookupTable[(bdlmxxx::ElemType::Type)j]->d_size
                                                          == DD.totalOffset());
      ...
      case 2: {
        ...
        // Concerns:
        //   1. The default 'bdlmxxx::RowLayout' constructor
        ...
        //
        //      void insert(int di, bdlmxxx::ElemType::Type item); (black-box)
        ...
        //        - call 'removeAll'
        //          * Verify that the 'bdlmxxx::RowLayout' has no elements
        //            after the call.
        //          * Verify that the total offset is 0.
        //
        // Testing:
        //   bdlmxxx::RowLayout(bslma::Allocator *ba = 0);
        //   ~bdlmxxx::RowLayout();
        //   void removeAll();
        //   BOOTSTRAP: void insert(int di, bdlmxxx::ElemType::Type item);
        //--------------------------------------------------------------------
        ...
        // a.
        if (verbose) cout
            << "\nTesting 'bdlmxxx::RowLayout()' Constructor." << endl;
        if (verbose) cout << "\tWithout passing in an allocator." << endl;
        {
        ...
        if (verbose) cout << "\nTesting insert of INT." << endl;
        {
            for (int i = 0; i < NUM_DATA; i++) {
                ...
                for (int j = 0; j < CURSOR; j++) {
                    DD.append(typesLookupTable[bdlmxxx::ElemType::BDEM_CHAR]);
                }
                ...
                LOOP_ASSERT(LINE, bdlmxxx::ElemType::BDEM_INT ==
            ...
            for (int i = 0; i < NUM_DATA; i++) {
                ...
                for (int j = 0; j < NUM_TYPES; j++) {
                    ...
                    for (int k = 0; k < CURSOR; k++) {
                        DD1.append(typesLookupTable[bdlmxxx::ElemType::BDEM_CHAR]);
                    }
        ...
        if (verbose) cout << "\nTesting 'removeAll'." << endl;
        {
            Obj DD2;
            for (int i = 0; i < 2; i++) {
                DD2.insert(0, typesLookupTable[bdlmxxx::ElemType::BDEM_CHAR]);
                DD2.insert(1, typesLookupTable[bdlmxxx::ElemType::BDEM_INT]);
                DD2.insert(2, typesLookupTable[bdlmxxx::ElemType::BDEM_DOUBLE]);
                DD2.insert(3, typesLookupTable[bdlmxxx::ElemType::BDEM_LIST]);
                DD2.insert(4, typesLookupTable[bdlmxxx::ElemType::BDEM_TABLE]);
                DD2.removeAll();
                ASSERT(0 == DD2.length());
      ...
      case 1: {
        ...
        //   'bdlmxxx::RowLayout' works properly.  We are concerned that the
        //   basic (value-semantic) functionality of 'bdlmxxx::RowLayout' works
        //   properly.
        //
        // Plan:
        ...
        //          a) 0 == x3.length()
        //          b) x3 == x1 x3 != x2
        //      8) Create bdlmxxx::RowLayout x4(x2)
        //          a) 1 == x4.length()
        //          b) x4 == x2 x4 != x1 x4 != x3
        ...
        if (verbose) cout << "\n 3. Append a char to x1."
                             "\t\t\t{ x1:V x2: }" << endl;
        x1.append(typesLookupTable[bdlmxxx::ElemType::BDEM_CHAR]);
        ASSERT(X1 != X2);
        ASSERT( 1 == X1.length());
        ...
        if (verbose) cout << "\n 4. Append a char to x2."
                             "\t\t{ x1:V x2:V }" << endl;
        x2.append(typesLookupTable[bdlmxxx::ElemType::BDEM_CHAR]);
        ASSERT(X1 == X2);
        ASSERT( 1 == X2.length());
