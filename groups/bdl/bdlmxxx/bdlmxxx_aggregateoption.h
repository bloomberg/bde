// bdlmxxx_aggregateoption.h                                             -*-C++-*-
#ifndef INCLUDED_BDLMXXX_AGGREGATEOPTION
#define INCLUDED_BDLMXXX_AGGREGATEOPTION
...
//
//@CLASSES:
//  bdlmxxx::AggregateOption: namespace for 'enum' of memory management strategies
//
//@SEE_ALSO
//
...
// within the namespace of the 'struct' 'bdlmxxx::AggregateOption'.  The
...
//..
//  bdlmxxx::AggregateOption::AllocationStrategy strategy;
//
//  strategy = bdlmxxx::AggregateOption::BDEM_PASS_THROUGH;
//         assert(0 == strategy);
//         assert(!(strategy & bdlmxxx::AggregateOption::BDEM_OWN_ALLOCATOR_FLAG));
//         assert(!(strategy & bdlmxxx::AggregateOption::BDEM_NODESTRUCT_FLAG));
//
//  strategy = bdlmxxx::AggregateOption::BDEM_WRITE_MANY;
//         assert(1 == strategy);
//         assert(  strategy & bdlmxxx::AggregateOption::BDEM_OWN_ALLOCATOR_FLAG);
//         assert(!(strategy & bdlmxxx::AggregateOption::BDEM_NODESTRUCT_FLAG));
//
//  strategy = bdlmxxx::AggregateOption::BDEM_WRITE_ONCE;
//         assert(3 == strategy);
//         assert(  strategy & bdlmxxx::AggregateOption::BDEM_OWN_ALLOCATOR_FLAG);
//         assert(  strategy & bdlmxxx::AggregateOption::BDEM_NODESTRUCT_FLAG);
//
//  strategy = bdlmxxx::AggregateOption::BDEM_SUBORDINATE;
//         assert(2 == strategy);
//         assert(!(strategy & bdlmxxx::AggregateOption::BDEM_OWN_ALLOCATOR_FLAG));
//         assert(  strategy & bdlmxxx::AggregateOption::BDEM_NODESTRUCT_FLAG);
//..
