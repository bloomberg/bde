...
// family providing indexed and *by-name* access to a proxied 'bdlmxxx::Row', a
// proxied 'bdlmxxx::Table', a proxied column in a 'bdlmxxx::Table',
// a proxied 'bdlmxxx::Choice', or a proxied 'bdlmxxx::ChoiceArray'.  Within the
...
// class binds data (a 'bdlmxxx::Row', 'bdlmxxx::Table', 'bdlmxxx::Choice' or
// 'bdlmxxx::ChoiceArray') to meta-data (a 'bdlmxxx::RecordDef' or a 'bdlmxxx::FieldDef').
...
//
// In the following, we use "underlying data" to refer to the 'bdlmxxx::Row',
// 'bdlmxxx::Table', 'bdlmxxx::Choice', or 'bdlmxxx::ChoiceArray' proxied by the
// binding.  We use "constraint" to refer to the 'bdlmxxx::RecordDef' or
// 'bdlmxxx::FieldDef' (meta-data) held by the binding.
//
...
//   o To test the binding methods, we need instances of 'bdlmxxx::List',
//     'bdlmxxx::Table', 'bdlmxxx::Choice', 'bdlmxxx::ChoiceArray', and 'bdlmxxx::Schema'.
...
//
// ACCESSORS
// [8] bdlmxxx::ConstElemRef operator[](int) const;
// [8] bdlmxxx::ConstElemRef element(*name) const;
// [8] bdlmxxx::ConstElemRef element(int) const;
// [8] bdlmxxx::ElemType::Type elemType(*name) const;
// [8] bdlmxxx::ElemType::Type elemType(int) const;
// [ 3] int length() const;
// [ 3] const bdlmxxx::RecordDef& record() const;
// [ 3] const bdlmxxx::Row& row() const;
...
// [8] const bdlt::Datetime& theDatetime(*name) const;
// [8] const bdlt::Date& theDate(*name) const;
// [8] const bdlt::Time& theTime(*name) const;
...
// [8] const bdlmxxx::List& theList(*name) const;
// [8] const bdlmxxx::Table& theTable(*name) const;
// [8] const bdem::Bool& theBool(*name) const;
// [8] const bdem::DatetimeTz& theDatetimeTz(*name) const;
// [8] const bdem::DateTz& theDateTz(*name) const;
// [8] const bdem::TimeTz& theTimeTz(*name) const;
// [8] const bdem::BoolArray& theBoolArray(*name) const;
// [8] const bdem::DatetimeTzArray& theDatetimeTzArray(*name) const;
// [8] const bdem::DateTzArray& theDateTzArray(*name) const;
// [8] const bdem::TimeTzArray& theTimeTzArray(*name) const;
// [8] const bdlmxxx::Choice& theChoice(*name) const;
// [8] const bdlmxxx::ChoiceArray& theChoiceArray(int) const;
...
//
// ACCESSORS
// [8] bdlmxxx::ElemRef operator[](int) const;
// [8] bdlmxxx::ElemRef element(*name) const;
// [8] bdlmxxx::ElemRef element(int) const;
// [3] bdlmxxx::Row& row() const;
...
// [8] bdlt::Datetime& theDatetime(*name) const;
// [8] bdlt::Time& theTime(*name) const;
// [8] bdlt::Date& theDate(*name) const;
...
// [8] bdlmxxx::List& theList(*name) const;
// [8] bdlmxxx::Table& theTable(*name) const;
// [8] bdem::Bool& theBool(*name) const;
// [8] bdem::DatetimeTz& theDatetimeTz(*name) const;
// [8] bdem::DateTz& theDateTz(*name) const;
// [8] bdem::TimeTz& theTimeTz(*name) const;
// [8] bdem::BoolArray& theBoolArray(*name) const;
// [8] bdem::DatetimeTzArray& theDatetimeTzArray(*name) const;
// [8] bdem::DateTzArray& theDateTzArray(*name) const;
// [8] bdem::TimeTzArray& theTimeTzArray(*name) const;
// [8] bdlmxxx::Choice& theChoice(*name) const;
// [8] bdlmxxx::ChoiceArray& theChoiceArray(int) const;
...
//
// ACCESSORS
// [ 4] const bdlmxxx::Row& operator[](int) const;
// [ 9] bdlmxxx::ConstElemRef element(int, *name) const;
// [ 9] bdlmxxx::ConstElemRef element(int, int) const;
// [ 9] bdlmxxx::ElemType::Type elemType(*name) const;
// [ 9] bdlmxxx::ElemType::Type elemType(int) const;
// [ 4] int numColumns() const;
// [ 4] int numRows() const;
// [ 4] const bdlmxxx::RecordDef& record() const;
// [ 4] const bdlmxxx::Table& table() const;
...
// [ 9] const bdlt::Datetime& theDatetime(int, *name) const;
// [ 9] const bdlt::Date& theDate(int, *name) const;
// [ 9] const bdlt::Time& theTime(int, *name) const;
...
// [ 9] const bdlmxxx::List& theList(int, *name) const;
// [ 9] const bdlmxxx::Table& theTable(int, *name) const;
// [ 9] const bdem::Bool& theBool(int, *name) const;
// [ 9] const bdem::DatetimeTz& theDatetimeTz(int, *name) const;
// [ 9] const bdem::DateTz& theDateTz(int, *name) const;
// [ 9] const bdem::TimeTz& theTimeTz(int, *name) const;
// [ 9] const bdem::BoolArray& theBoolArray(int, *name) const;
// [ 9] const bdem::DatetimeTzArray& theDatetimeTzArray(int, *name) const;
// [ 9] const bdem::DateTzArray& theDateTzArray(int, *name) const;
// [ 9] const bdem::TimeTzArray& theTimeTzArray(int, *name) const;
// [ 9] const bdlmxxx::Choice& theChoice(int, *name) const;
// [ 9] const bdlmxxx::ChoiceArray& theChoiceArray(int, *name) const;
...
//
// ACCESSORS
// [ 4] bdlmxxx::Row& operator[](int) const;
// [ 9] bdlmxxx::ElemRef element(int, *name) const;
// [ 9] bdlmxxx::ElemRef element(int, int) const;
// [ 4] bdlmxxx::Table& table() const;
...
// [ 9] bdlt::Datetime& theDatetime(int, *name) const;
// [ 9] bdlt::Date& theDate(int, *name) const;
// [ 9] bdlt::Time& theTime(int, *name) const;
...
// [ 9] bdem::Bool& theBool(int, *name) const;
// [ 9] bdem::DatetimeTz& theDatetimeTz(int, *name) const;
// [ 9] bdem::DateTz& theDateTz(int, *name) const;
// [ 9] bdem::TimeTz& theTimeTz(int, *name) const;
// [ 9] bdem::BoolArray& theBoolArray(int, *name) const;
// [ 9] bdem::DatetimeTzArray& theDatetimeTzArray(int, *name) const;
// [ 9] bdem::DateTzArray& theDateTzArray(int, *name) const;
// [ 9] bdem::TimeTzArray& theTimeTzArray(int, *name) const;
// [ 9] bdlmxxx::Choice& theChoice(int, *name) const;
// [ 9] bdlmxxx::ChoiceArray& theChoiceArray(int, *name) const;
// [ 9] bdlmxxx::List& theList(int, *name) const;
// [ 9] bdlmxxx::Table& theTable(int, *name) const;
...
//
// ACCESSORS
// [ 5] bdlmxxx::ConstElemRef operator[](int) const;
// [ 5] bdlmxxx::ConstElemRef element(int) const;
// [ 5] bdlmxxx::ElemType::Type elemType() const;
// [ 5] int numRows() const;
// [ 5] int columnIndex() const;
// [ 5] const bdlmxxx::FieldDef& field() const;
// [24] bdem_ConstRowBinding rowBinding(int) const;
// [ 5] const bdlmxxx::Table& table() const;
...
//
// ACCESSORS
// [ 5] bdlmxxx::ElemRef operator[](int) const;
// [ 5] bdlmxxx::ElemRef element(int) const;
// [24] bdem_RowBinding rowBinding(int) const;
// [ 5] bdlmxxx::Table& table() const;
...
// [31] bdlmxxx::ElemRef makeSelection(int)
// [31] bdlmxxx::ElemRef makeSelection(const char *);
//
// ACCESSORS
// [10] bdlmxxx::ElemRef selection() const;
// [ 6] bdlmxxx::ChoiceArrayItem& item() const;
// [ 6] bdlmxxx::RecordDef &record() const;
...
// [10] bdlt::Datetime& theDatetime() const;
// [10] bdlt::Date& theDate() const;
// [10] bdlt::Time& theTime() const;
...
// [10] bdlmxxx::List& theList() const;
// [10] bdlmxxx::Table& theTable() const;
// [10] bdem::Bool& theBool() const;
// [10] bdem::DatetimeTz& theDatetimeTz() const;
// [10] bdem::DateTz& theDateTz() const;
// [10] bdem::TimeTz& theTimeTz() const;
// [10] bdem::BoolArray& theBoolArray() const;
// [10] bdem::DatetimeTzArray& theDatetimeTzArray() const;
// [10] bdem::DateTzArray& theDateTzArray() const;
// [10] bdem::TimeTzArray& theTimeTzArray() const;
// [10] bdlmxxx::Choice& theChoice() const;
// [10] bdlmxxx::ChoiceArray& theChoiceArray() const;
...
//
// ACCESSORS
// [10] const bdlmxxx::ElemRef selection() const;
// [ 6] const bdlmxxx::ChoiceArrayItem& item() const;
// [ 6] const bdlmxxx::RecordDef &record() const;
...
// [10] const bdlt::Datetime& theDatetime() const;
// [10] const bdlt::Date& theDate() const;
// [10] const bdlt::Time& theTime() const;
...
// [10] const bdlmxxx::List& theList() const;
// [10] const bdlmxxx::Table& theTable() const;
// [10] const bdem::Bool& theBool() const;
// [10] const bdem::DatetimeTz& theDatetimeTz() const;
// [10] const bdem::DateTz& theDateTz() const;
// [10] const bdem::TimeTz& theTimeTz() const;
// [10] const bdem::BoolArray& theBoolArray() const;
// [10] const bdem::DatetimeTzArray& theDatetimeTzArray() const;
// [10] const bdem::DateTzArray& theDateTzArray() const;
// [10] const bdem::TimeTzArray& theTimeTzArray() const;
// [10] const bdlmxxx::Choice& theChoice() const;
// [10] const bdlmxxx::ChoiceArray& theChoiceArray() const;
...
// [32] bdlmxxx::ElemRef makeSelection(int,int)
// [32] bdlmxxx::ElemRef makeSelection(int,char *)
//
// ACCESSORS
// [11] bdlmxxx::ElemRef selection(int) const;
// [ 7] bdlmxxx::ChoiceArrayItem& operator[](int) const;
// [ 7] bdlmxxx::ChoiceArray& choiceArray() const;
// [ 7] bdlmxxx::RecordDef &record() const;
...
// [11] bdlt::Datetime& theDatetime(int) const;
// [11] bdlt::Date& theDate(int) const;
// [11] bdlt::Time& theTime(int) const;
...
// [11] bdlmxxx::List& theList(int) const;
// [11] bdlmxxx::Table& theTable(int) const;
// [11] bdem::Bool& theBool(int) const;
// [11] bdem::DatetimeTz& theDatetimeTz(int) const;
// [11] bdem::DateTz& theDateTz(int) const;
// [11] bdem::TimeTz& theTimeTz(int) const;
// [11] bdem::BoolArray& theBoolArray(int) const;
// [11] bdem::DatetimeTzArray& theDatetimeTzArray(int) const;
// [11] bdem::DateTzArray& theDateTzArray(int) const;
// [11] bdem::TimeTzArray& theTimeTzArray(int) const;
// [11] bdlmxxx::Choice& theChoice(int) const;
// [11] bdlmxxx::ChoiceArray& theChoiceArray(int) const;
...
//
// ACCESSORS
// [11] const bdlmxxx::ElemRef selection(int) const;
// [ 7] const bdlmxxx::ChoiceArrayItem& operator[](int) const;
// [ 7] const bdlmxxx::ChoiceArray& choiceArray() const;
// [ 7] const bdlmxxx::RecordDef &record() const;
...
// [11] const bdlt::Datetime& theDatetime(int) const;
// [11] const bdlt::Date& theDate(int) const;
// [11] const bdlt::Time& theTime(int) const;
...
// [11] const bdlmxxx::List& theList(int) const;
// [11] const bdlmxxx::Table& theTable(int) const;
// [11] const bdem::Bool& theBool(int) const;
// [11] const bdem::DatetimeTz& theDatetimeTz(int) const;
// [11] const bdem::DateTz& theDateTz(int) const;
// [11] const bdem::TimeTz& theTimeTz(int) const;
// [11] const bdem::BoolArray& theBoolArray(int) const;
// [11] const bdem::DatetimeTzArray& theDatetimeTzArray(int) const;
// [11] const bdem::DateTzArray& theDateTzArray(int) const;
// [11] const bdem::TimeTzArray& theTimeTzArray(int) const;
// [11] const bdlmxxx::Choice& theChoice(int) const;
// [11] const bdlmxxx::ChoiceArray& theChoiceArray(int) const;
...
typedef bdlmxxx::ConstElemRef                CElemRef;
typedef bdlmxxx::ElemRef                      ElemRef;

typedef bdlmxxx::ElemType                     ElemType;
...
// It was copied verbatim from bdlmxxx_schema.t.cpp.
...
//=============================================================================
//                'bdlmxxx::Schema' HELPER DATA AND FUNCTIONS
//=============================================================================
...
static
const bdlmxxx::RecordDef *getConstraint(bdlmxxx::Schema *object, char token)
{
...
bdlmxxx::Schema& createSchema(bdlmxxx::Schema *object, const char *spec)
    // Configure the specified schema 'object' according to the specified
    // 'spec' using the primary manipulators and accessors of 'bdlmxxx::Schema'
        ...
        if ('~' == *p) {                    // removeAll
            ...
            while (isFieldType(*p)) {       // add a field
                if (isUnconstrainedFieldType(*p)) {
                    ...
                    ASSERT(isName(*p));
                    const char *fieldName = getName(*p++);
                    const bdlmxxx::RecordDef *constr = getConstraint(object, *p++);
                    ASSERT(constr);
...
{
    // create first table
    const bdlmxxx::ElemType::Type colTypes1[] = {
    ...
    // create second table
    const bdlmxxx::ElemType::Type colTypes2[] = {
    ...
    // create third table
    const bdlmxxx::ElemType::Type colTypes3[] = {
...
void addElementToList(bdlmxxx::List *list, ElemType::Type type)
...
void createTable(bdlmxxx::Table *table, const bdlmxxx::RecordDef *record);
void createChoice(bdlmxxx::Choice *choice, const bdlmxxx::RecordDef *constraint);
void createChoiceArray(bdlmxxx::ChoiceArray *choiceArray,
                       const bdlmxxx::RecordDef *constraint);

void createList(bdlmxxx::List *list, const bdlmxxx::RecordDef *record)
...
void createTable(bdlmxxx::Table *table, const bdlmxxx::RecordDef *constraint)
    ...
    // works with createList, createCHoice,createChoiceArray
{
    ...
    bsl::vector<bdlmxxx::ElemType::Type> typesCatalog;
...
void appendElementToList(bdlmxxx::List *list, ElemType::Type type,
              const bdlmxxx::RecordDef *constraint)
...
// Specs for creating instances of 'bdlmxxx::Schema', and instances of 'bdlmxxx::List'
...
// Specs for creating instances of 'bdlmxxx::Schema', and instances of 'bdlmxxx::Table'
// that satisfy those schemas.
//
// NOTE: Code that uses these specs require that the last element in the last
//       'record' is a 'bdlmxxx::Table'.
...
#define DECLARE_TEST_SCHEMA                                                   \
    ...
    /* ----------------------------- Test schema --------------------------*/ \
                                                                              \
    Schema S1_;  const bdlmxxx::Schema& S1 = S1_;                                 \
...
#define DECLARE_TEST_LIST_OBJECTS                                             \
    ...
    XU_.appendString(XG);                                                     \
                                                                              \
    const bdlmxxx::ElemType::Type colTypes[] = {                                  \
        bdlmxxx::ElemType::BDEM_INT,                                              \
        bdlmxxx::ElemType::BDEM_STRING                                            \
    };                                                                        \
                                                                              \
    const int numColTypes = sizeof(colTypes) / sizeof(*colTypes);             \
                                                                              \
    bdlmxxx::Table                        XV_(colTypes, numColTypes);             \
    ...
    YU_.appendString(YG);                                                     \
                                                                              \
    bdlmxxx::Table                        YV_(colTypes, numColTypes);             \
...
#define DECLARE_TABLE_OBJECTS                                                 \
    ...
    bsl::vector<const char *> listRecordName(NUM_LIST_SPECS);                 \
                                                                              \
    /* Create vectors of 'bdlmxxx::List' and 'bdlmxxx::Schema' from 'listSpecs'. */   \
                                                                              \
    ...
    bsl::vector<Table>          tableVec(NUM_TABLE_SPECS);                    \
                                                                              \
    /* Create vectors of 'bdlmxxx::Table' and 'bdlmxxx::Schema' from 'tableSpecs'.    \
...
#define DECLARE_CHOICE_OBJECTS                                                \
    ...
    bsl::vector<const char *>        choiceRecordName(NUM_CHOICE_SPECS);      \
                                                                              \
    /* Create vectors of 'bdlmxxx::Choice' and 'bdlmxxx::Schema' from 'listChoice'.*/ \
...
DEFINE_TEST_CASE(32) {
        ...
        //
        // Plan:
        //   Create two instance of 'bdlmxxx::ChoiceArray' and bindings for the
        //   choice objects.  Loop through the possible values for
        //  makeSelection.  Verify that:
        //     1) After making a selection via the binding the 'bdlmxxx::Choice'
        ...
        //             ~~~~~~~~~~~~~~~
        //   bdlmxxx::ElemRef makeSelection(int, int)
        //   bdlmxxx::ElemRef makeSelection(int, const char *)
        //
        // --------------------------------------------------------------------
                          ...
                          << "============================" << endl;
        {
            ...
            bdlmxxx::ElemRef rt1 = cab1.makeSelection(0,-1);
            ...
            for (int i = 0; i < CA1.numSelections(); ++i) {
                ...
                bdlmxxx::ElemRef r1 = cab1.makeSelection(i,i);
                bdlmxxx::ElemRef r2 = cab2.makeSelection(i,name);
...
DEFINE_TEST_CASE(31) {
        ...
        //
        // Plan:
        //   Create two instance of 'bdlmxxx::Choice' and bindings for the
        //   choice objects.  Loop through the possible values for
        ...
        //             bdem_ChoiceBinding
        //             ~~~~~~~~~~~~~~~
        //   bdlmxxx::ElemRef makeSelection(int)
        //   bdlmxxx::ElemRef makeSelection(const char *)
        //
        // --------------------------------------------------------------------
                          ...
                          << "============================" << endl;
        {
            ...
            bdlmxxx::ElemRef rt1 = cb1.makeSelection(-1);
            ASSERT( C1.selection() == rt1);
            ASSERT( C1.selector() == -1);
            for (int i = 0; i < C1.numSelections(); ++i) {
                const char *name = rec->fieldName(i);
                bdlmxxx::ElemRef r1 = cb1.makeSelection(i);
                bdlmxxx::ElemRef r2 = cb2.makeSelection(name);
...
DEFINE_TEST_CASE(30) {
        ...
        //
        // Plan:
        //   Create two instance of 'bdlmxxx::ChoiceArray'.
        //   Create choice array bindings with one and rebind
        //   to the other.  Verify that:
        //     1) The 'bdlmxxx::ChoiceArray' after rebinding refers to the
...
DEFINE_TEST_CASE(29) {
        ...
        //
        // Plan:
        //   Create two instance of 'bdlmxxx::Choice' and two instances of
        //   'bdlmxxx::ChoiceArray' satisfying the same meta-data, but having
        //   different *data*.  Create choice bindings with one and rebind
        //   to the other.  Verify that:
        //     1) The 'bdlmxxx::Choice' after rebinding refers to the appropriate
        //        Choice in the second 'bdlmxxx::Choice' or in the
        //        'bdlmxxx::ChoiceArray'.
        //     2) Ensure that the meta-data is not effected.
        //
        // Testing:
...
DEFINE_TEST_CASE(28) {
        ...
        //
        // Plan:
        //   Create two instances of 'bdlmxxx::Table' having different *data*, but
        //   satisfying the same 'bdlmxxx::RecordDef' meta-data.  Create a table
...
DEFINE_TEST_CASE(27) {
        ...
        //
        // Plan:
        //   Create two instance of 'bdlmxxx::List' and two instances of
        //   'bdlmxxx::Table' satisfying the same meta-data, but having different
        //   *data*.  Create row bindings with one and rebind to the other.
        //   Verify that:
        //     1) The 'bdlmxxx::Row' after rebinding refers to the appropriate row
        //        in the second 'bdlmxxx::List' or 'bdlmxxx::Table'.
        //     2) Ensure that the meta-data is not effected.
        //
        // Testing:
...
DEFINE_TEST_CASE(26) {
        ...
        //     Create a 'bdlmxxx::List' containing an element of an unconstrained
        //     type.  Create a 'bdlmxxx::ChoiceArray' having the
        //     'bdlmxxx::List' as an element.  Create "const" and
        //     non-"const" choice array bindings from
        //     the 'bdlmxxx::ChoiceArray' and call the 'rowBinding' methods to
        //     obtain new choice array bindings for the first 'bdlmxxx::List'.
        //     Use the direct accessors to verify that the row and record
        //     have been installed correctly in the returned bindings.
        //
        //     Perform the same test when the first 'bdlmxxx::ChoiceArray'
        //     contains an element of a constrained type.
        //
        //   - Functions returning Table Bindings
        //     Create a 'bdlmxxx::Table' containing rows of an unconstrained type.
        //     Create a 'bdlmxxx::ChoiceArray' having the 'bdlmxxx::Table' as an
        //     element.  Create "const" and non-"const" choice array bindings
        //     from the 'bdlmxxx::ChoiceArray' and call the 'tableBinding' methods
        //      o obtain new table bindings for the 'bdlmxxx::Table'.
        //     Use the direct accessors to verify that
        //     the table and record have been installed correctly in the
        //     returned bindings.
        //
        //     Perform the same test when the 'bdlmxxx::Table' contains rows of a
        //     constrained type.
        //
        ...
        //     i)
        //     Create a 'bdlmxxx::ChoiceArray' having choice elements of
        //     unconstrained type.  Create "const" and non-"const" choice array
        //     bindings from the 'bdlmxxx::ChoiceArray' and call the
        ...
        //     Create a 'bdlmxxx::ChoiceArray' containing rows of an
        //     unconstrained type.  Create a second 'bdlmxxx::ChoiceArray'
        //     having the first 'bdlmxxx::ChoiceArray' as an element.
        //     Create "const" and non-"const" choice array bindings from the
        //     second 'bdlmxxx::ChoiceArray' and call the 'choiceArrayBinding'
        //     methods to obtain new choice array bindings for the
        //      'bdlmxxx::ChoiceArray'.  Use the direct accessors to verify that
        //     the choice array and record have been installed correctly in the
        //     returned bindings.
        //
        //     Perform the same test when the 'bdlmxxx::ChoiceArray' contains
...
DEFINE_TEST_CASE(25) {
        ...
        //   - Functions returning Row Bindings
        //     Create a 'bdlmxxx::List' containing an element of an unconstrained
        //     type.  Create a 'bdlmxxx::Choice' having the
        //     'bdlmxxx::List' as an element.  Create "const" and
        //     non-"const" choice bindings from
        //     the 'bdlmxxx::Choice' and call the 'rowBinding' methods to
        //     obtain new choice bindings for the 'bdlmxxx::Row'.  Use the
        //     direct accessors to verify that the row and record have been
        //     installed correctly in the returned bindings.
        //
        //     Perform the same test when the first 'bdlmxxx::Choice' contains an
        //     element of a constrained type.
        //
        //   - Functions returning Table Bindings
        //     Create a 'bdlmxxx::Table' containing rows of an unconstrained type.
        //     Create a 'bdlmxxx::Choice' having the 'bdlmxxx::Table' as an element.
        //     Create "const" and non-"const" choice bindings from the
        //     'bdlmxxx::Choice' and call the 'tableBinding' methods to
        //     obtain new table bindings for the 'bdlmxxx::Table'.
        //     Use the direct accessors to verify that
        //     the table and record have been installed correctly in the
        //     returned bindings.
        //
        ...
        //
        //   - Functions returning Choice Bindings
        //     Create a 'bdlmxxx::Choice' containing an element of an unconstrained
        //     type.  Create a second 'bdlmxxx::Choice' having the first
        //     'bdlmxxx::Choice' as an element.  Create "const" and
        //     non-"const" choice bindings from
        //     the second 'bdlmxxx::Choice' and call the 'choiceBinding' methods to
        //     obtain new choice bindings for the first 'bdlmxxx::Choice'.  Use the
        //     direct accessors to verify that the choice and record have been
        //     installed correctly in the returned bindings.
        //
        //     Perform the same test when the first 'bdlmxxx::Choice' contains an
        //     element of a constrained type.
        //   - Functions returning Choice Array Bindings
        //     Create a 'bdlmxxx::ChoiceArray' containing selections of an
        //     unconstrained type.  Create a 'bdlmxxx::Choice'
        //     having the 'bdlmxxx::ChoiceArray' as an element.
        //     Create "const" and non-"const" choice bindings from the
        //     'bdlmxxx::Choice' and call the 'choiceArrayBinding' methods to
        //     obtain new choice array bindings for the 'bdlmxxx::ChoiceArray'.
        //     Use the direct accessors to verify that
        //     the table and record have been installed correctly in the
        //     returned bindings.
        //
...
DEFINE_TEST_CASE(24) {
        ...
        // Plan:
        //   - Functions returning Row Bindings
        //     Create a 'bdlmxxx::Table' whose rows have a 'bdlmxxx::List' that
        //     contain an element of an unconstrained type.  Create "const"
        //     and non-"const" column bindings from the 'bdlmxxx::Table' and the
        //     column index corresponding to the 'bdlmxxx::List' and call the
        //     'rowBinding' methods to obtain new row bindings for the
        //     'bdlmxxx::List'.  Use the direct accessors to verify that the row
        //     and record have been installed correctly in the returned
        //     bindings.
        //
        //     Perform the same test when the 'bdlmxxx::List' contains an element
        //     of a constrained type.
        //
        //   - Functions returning Table Bindings
        //     Create a 'bdlmxxx::Table' whose rows have a 'bdlmxxx::Table' where each
        //     row of the second 'bdlmxxx::Table' contains an element of an
        //     unconstrained type.  Create "const" and non-"const" column
        //     bindings from the second 'bdlmxxx::Table' and the column index
        //     corresponding to the first 'bdlmxxx::Table', and call the
        //     'tableBinding' methods to obtain new table bindings for the
        //     second 'bdlmxxx::Table'.  Use the direct accessors to verify that
        //     the table and record have been installed correctly in the
        //     returned bindings.
        //
        //     Perform the same test when the second 'bdlmxxx::Table' contains
        //     elements of a constrained type.
        //
        //   - Functions returning Choice Bindings
        //     Create a 'bdlmxxx::Choice' containing an element of an unconstrained
        //     type.  Create a 'bdlmxxx::Table' having the first
        //     'bdlmxxx::Choice' as an element.  Create "const" and
        //     non-"const" column bindings from
        //     the 'bdlmxxx::Table' and call the 'choiceBinding' methods to
        //     obtain new choice bindings for the first 'bdlmxxx::Choice'.  Use the
        //     direct accessors to verify that the choice and record have been
        //     installed correctly in the returned bindings.
        //
        ...
        //   - Functions returning Choice Array Bindings
        //     Create a 'bdlmxxx::ChoiceArray' containing rows of an
        //     unconstrained type.  Create a 'bdlmxxx::Table'
        //     having the 'bdlmxxx::ChoiceArray' as an element.
...
DEFINE_TEST_CASE(23) {
        ...
        //     and non-"const" table bindings from the 'bdlmxxx::Table' and call
        //     the 'rowBinding' methods to obtain new row bindings for the
        //     'bdlmxxx::List'.  Use the direct accessors to verify that the row
        //     and record have been installed correctly in the returned
        //     bindings.
        //
        //     Perform the same test when the 'bdlmxxx::List' contains elements of
        //     a constrained type.
        //
        //   - Functions returning Table Bindings
        //     Create a 'bdlmxxx::Table' whose rows have a 'bdlmxxx::Table' where each
        ...
        //     bindings from the first 'bdlmxxx::Table' and call the 'tableBinding'
        //     methods to obtain new table bindings for the second
        //     'bdlmxxx::Table'.  Use the direct accessors to verify that the table
        //     and record have been installed correctly in the returned
        //     bindings.
        //
        //     Perform the same test when the second 'bdlmxxx::Table' contains
        ...
        //     Create a 'bdlmxxx::Table' whose rows contain elements of an
        //     unconstrained type.  Create "const" and non-"const" table
        //     bindings from that 'bdlmxxx::Table' and call the 'columnBinding'
        ...
        //
        //     Perform the same test when the 'bdlmxxx::Table' contains elements of
        //     a constrained type.
        //
        //   - Functions returning Choice Bindings
        //     Create a 'bdlmxxx::Choice' containing an element of an unconstrained
...
DEFINE_TEST_CASE(22) {
        ...
        //   - Functions returning Row Bindings
        //     Create a 'bdlmxxx::List' containing an element of an unconstrained
        //     type.  Create a second 'bdlmxxx::List' having the first 'bdlmxxx::List'
        //     as an element.  Create "const" and non-"const" row bindings from
        //     the second 'bdlmxxx::List' and call the 'rowBinding' methods to
        //     obtain new row bindings for the first 'bdlmxxx::List'.  Use the
        //     direct accessors to verify that the row and record have been
        //     installed correctly in the returned bindings.
        //
        //     Perform the same test when the first 'bdlmxxx::List' contains an
        //     element of a constrained type.
        //
        //   - Functions returning Table Bindings
        //     Create a 'bdlmxxx::Table' containing rows of an unconstrained type.
        //     Create a 'bdlmxxx::List' having the 'bdlmxxx::Table' as an element.
        //     Create "const" and non-"const" row bindings from the 'bdlmxxx::List'
        //     and call the 'tableBinding' methods to obtain new table bindings
        //     for the 'bdlmxxx::Table'.  Use the direct accessors to verify that
        //     the table and record have been installed correctly in the
        //     returned bindings.
        //
        //     Perform the same test when the 'bdlmxxx::Table' contains rows of a
        ...
        //   - Functions returning Choice Bindings
        //     Create a 'bdlmxxx::Choice' containing an element of an unconstrained
        //     type.  Create a 'bdlmxxx::List' having the first
        //     'bdlmxxx::Choice' as an element.  Create "const" and
        //     non-"const" Row bindings from
        //     the 'bdlmxxx::List' and call the 'choiceBinding' methods to
        //     obtain new choice bindings for the first 'bdlmxxx::Choice'.  Use the
        //     direct accessors to verify that the choice and record have been
        //     installed correctly in the returned bindings.
        //
        ...
        //   - Functions returning Choice Array Bindings
        //     Create a 'bdlmxxx::ChoiceArray' containing rows of an
        //     unconstrained type.  Create a 'bdlmxxx::List'
        //     having the 'bdlmxxx::ChoiceArray' as an element.
        //     Create "const" and non-"const" row bindings from the
        //     'bdlmxxx::Table' and call the 'choiceArrayBinding' methods to
        //     obtain new bindings for the 'bdlmxxx::ChoiceArray'.
        //     Use the direct accessors to verify that
        //     the choice array and record have been installed correctly in the
        //     returned bindings.
        //
...
DEFINE_TEST_CASE(21) {
        ...
        //     'bdlmxxx::ChoiceArray' pointer and the same 'bdlmxxx::RecordDef'.
        //   - The two bindings being compared store different
        //     'bdlmxxx::ChoiceArray' pointers and the same 'bdlmxxx::RecordDef',
        //     with the two choice arrays having identical data.
        //   - The two bindings being compared store different
        //     'bdlmxxx::ChoiceArray' pointers and the same 'bdlmxxx::RecordDef',
        //     with the two choice arrays having different data.
        //   - The two bindings being compared store the same 'bdlmxxx::Choice'
        //     pointer, but different 'bdlmxxx::RecordDef's.
        //
        //   To check these conditions we:
        //   1) Create a 'bdlmxxx::ChoiceArray' and a 'bdlmxxx::RecordDef' and
        ...
        //   2) Create a 'bdlmxxx::ChoiceArray' and a 'bdlmxxx::RecordDef' and
        //      initialize two choice array bindings
        //      with that 'bdlmxxx::ChoiceArray' and
        //      'bdlmxxx::RecordDef'.  On comparing the two bindings,
        //      'operator==' should return 'true' and 'operator!=' should
        //      return 'false'.
        //   3) Create two 'bdlmxxx::ChoiceArray's having the *same* value
        //      and the same 'bdlmxxx::RecordDef', and use them to initialize
        //      two choice array bindings.  The 'bdlmxxx::RecordDef' used for
        //      creating the choice array bindings is the same
        //      'bdlmxxx::RecordDef'.  On comparing the two bindings,
        //      'operator==' should return 'true' and 'operator!=' should
        //      return 'false'.
        //   4) Create two 'bdlmxxx::ChoiceArray's having *different* values, but
        //      satisfying the same 'bdlmxxx::RecordDef', and use them to
        //      initialize two choice array bindings.  The 'bdlmxxx::RecordDef'
        //      used for creating the choice bindings is the same
        //      'bdlmxxx::RecordDef'.  On comparing the two bindings,
        //      'operator==' should return 'false' and 'operator!=' should
        //      return 'true'.
        //   5) Create two choice bindings using the same 'bdlmxxx::ChoiceArray',
        //      but different 'bdlmxxx::RecordDef' instances (having the
...
DEFINE_TEST_CASE(20) {
        ...
        //   - Comparison to self (X == X).
        //   - The two bindings being compared store the same 'bdlmxxx::Choice'
        //     pointer and the same 'bdlmxxx::RecordDef'.
        //   - The two bindings being compared store different 'bdlmxxx::Choice'
        //     pointers and the same 'bdlmxxx::RecordDef', with the two choices
        ...
        //
        //   To check these conditions we:
        //   1) Create a 'bdlmxxx::Choice' and a 'bdlmxxx::RecordDef' and initialize
        ...
        //   2) Create a 'bdlmxxx::Choice' and a 'bdlmxxx::RecordDef' and initialize
        //      two choice bindings with that 'bdlmxxx::Choice' and
        //      'bdlmxxx::RecordDef'.  On comparing the two bindings,
        //      'operator==' should return 'true' and 'operator!=' should
        //      return 'false'.
        //   3) Create two 'bdlmxxx::Choice's having the *same* value and the same
        //      'bdlmxxx::RecordDef', and use them to initialize two choice
        //      bindings.  The 'bdlmxxx::RecordDef' used for creating the
        //      choice bindings is the same 'bdlmxxx::RecordDef'.
        //      On comparing the two bindings,
        //      'operator==' should return 'true' and 'operator!=' should
        //      return 'false'.
        //   4) Create two 'bdlmxxx::Choice's having *different* values, but
        //      satisfying the same 'bdlmxxx::RecordDef', and use them to
        //      initialize two choice bindings.  The 'bdlmxxx::RecordDef' used for
        //      creating the choice bindings is the same 'bdlmxxx::RecordDef'.  On
        //      comparing the two bindings, 'operator==' should return 'false'
        //      and 'operator!=' should return 'true'.
        //   5) Create two row bindings using the same 'bdlmxxx::Choice', but
        //      different 'bdlmxxx::RecordDef' instances (having the same value).
...
DEFINE_TEST_CASE(19) {
        ...
        //   The operators are tested for the following conditions:
        //   - Comparison to self (X == X).
        //   - The two bindings being compared store the same 'bdlmxxx::Table'
        //     pointer, column index, and 'bdlmxxx::FieldDef'.
        //   - The two bindings being compared store different 'bdlmxxx::Table'
        //     pointers and the same 'bdlmxxx::FieldDef', where the two columns
        //     bound by the bindings have identical data.
        //   - The two bindings being compared store different 'bdlmxxx::Table'
        //     pointers and the same 'bdlmxxx::FieldDef', where the two columns
        //     bound by the bindings have different data.
        //   - The two bindings being compared store the same 'bdlmxxx::Table'
        //     pointer and column index, but different 'bdlmxxx::FieldDef'
        //     instances.
        //
        //   To check these conditions we:
        //   1) Create a 'bdlmxxx::Table' and a 'bdlmxxx::FieldDef', initialize a
        //      column binding from them and test the operators for comparison
        //      to self.  'operator==' should return 'true' and 'operator!='
        //      should return 'false'.
        //   2) Create a 'bdlmxxx::Table' and a 'bdlmxxx::FieldDef' and initialize two
        //      column bindings with that 'bdlmxxx::Table', using the same column
        //      index and 'bdlmxxx::FieldDef'.  On comparing the two bindings,
        //      'operator==' should return 'true' and 'operator!=' should
        //      return 'false'.
        //   3) Create two 'bdlmxxx::Table' instances having the same value for
        //      some column 'x' and the same 'bdlmxxx::FieldDef', and use them to
        ...
        //   4) Create two 'bdlmxxx::Table' instances having different data for
        //      some column 'x' and satisfying the same 'bdlmxxx::FieldDef', and
        ...
        //   5) Create two column bindings using the same 'bdlmxxx::Table' and the
        //      same column index, but different 'bdlmxxx::FieldDef' instances
...
DEFINE_TEST_CASE(18) {
        ...
        //     pointer and the same 'bdlmxxx::RecordDef'.
        //   - The two bindings being compared store different 'bdlmxxx::Table'
        //     pointers and the same 'bdlmxxx::RecordDef', with the two
        //     'bdlmxxx::Table's having identical data.
        //   - The two bindings being compared store different 'bdlmxxx::Table'
        //     pointers and the same 'bdlmxxx::RecordDef', with the two
        //     'bdlmxxx::Table's having different data.
        //   - The two bindings being compared store the same 'bdlmxxx::Table'
        //     pointer but different 'bdlmxxx::RecordDef's.
        //
        //   To check these conditions we:
        //   1)  Create a 'bdlmxxx::Table' and a 'bdlmxxx::RecordDef', initialize a
        //      table binding from them and test the operators for comparison
        //      to self.  'operator==' should return 'true' and 'operator!='
        //      should return 'false'.
        //   2) Create a 'bdlmxxx::Table' and a 'bdlmxxx::RecordDef' and initialize two
        //      table bindings with that 'bdlmxxx::Table' and 'bdlmxxx::RecordDef'.  On
        //      comparing the two bindings, 'operator==' should return 'true'
        //      and 'operator!=' should return 'false'.
        //   3) Create two 'bdlmxxx::Table' instances having the same value and the
        //      same 'bdlmxxx::RecordDef' definition, and use them to initialize
        //      two table bindings.  The 'bdlmxxx::RecordDef' used for creating the
        //      table bindings is the same 'bdlmxxx::RecordDef'.  On comparing the
        //      two bindings, 'operator==' should return 'true' and
        //      'operator!=' should return 'false'.
        //   4) Create two 'bdlmxxx::Table' instances having different values and
        //      the same 'bdlmxxx::RecordDef' definition, and use them to
        //      initialize two table bindings.  The 'bdlmxxx::RecordDef' used for
        //      creating the table bindings is the same 'bdlmxxx::RecordDef'.  On
        //      comparing the two bindings, 'operator==' should return 'false'
        //      and 'operator!=' should return 'true'.
        //   5) Create two table bindings using the same 'bdlmxxx::Table', but
        //      different 'bdlmxxx::RecordDef' instances (having the same value).
...
DEFINE_TEST_CASE(17) {
        ...
        //   The operators are tested for the following conditions:
        //   - Comparison to self (X == X).
        //   - The two bindings being compared store the same 'bdlmxxx::Row'
        //     pointer and the same 'bdlmxxx::RecordDef'.
        //   - The two bindings being compared store different 'bdlmxxx::Row'
        //     pointers and the same 'bdlmxxx::RecordDef', with the two rows having
        //     identical data.
        //   - The two bindings being compared store different 'bdlmxxx::Row'
        //     pointers and the same 'bdlmxxx::RecordDef', with the two rows having
        //     different data.
        ...
        //
        //   To check these conditions we:
        //   1) Create a 'bdlmxxx::Row' and a 'bdlmxxx::RecordDef' and initialize a row
        //      binding from them and test the operators for comparison to
        //      self.  'operator==' should return 'true' and 'operator!='
        //      should return 'false'.
        //   2) Create a 'bdlmxxx::Row' and a 'bdlmxxx::RecordDef' and initialize two
        //      row bindings with that 'bdlmxxx::Row' and 'bdlmxxx::RecordDef'.  On
        //      comparing the two bindings, 'operator==' should return 'true'
        //      and 'operator!=' should return 'false'.
        //   3) Create two 'bdlmxxx::Row's having the *same* value and the same
        //      'bdlmxxx::RecordDef', and use them to initialize two row bindings.
        //      The 'bdlmxxx::RecordDef' used for creating the row bindings is the
        //      same 'bdlmxxx::RecordDef'.  On comparing the two bindings,
        //      'operator==' should return 'true' and 'operator!=' should
        //      return 'false'.
        //   4) Create two 'bdlmxxx::Row's having *different* values, but
        //      satisfying the same 'bdlmxxx::RecordDef', and use them to
        //      initialize two row bindings.  The 'bdlmxxx::RecordDef' used for
        //      creating the row bindings is the same 'bdlmxxx::RecordDef'.  On
        //      comparing the two bindings, 'operator==' should return 'false'
        //      and 'operator!=' should return 'true'.
        //   5) Create two row bindings using the same 'bdlmxxx::Row', but
        //      different 'bdlmxxx::RecordDef' instances (having the same value).
        //      On comparing the two row bindings, 'operator==' should return
        //      'true' and 'operator!=' should return 'false'.
        //
...
DEFINE_TEST_CASE(16) {
        ...
        //     1) A vector of 'bdlmxxx::Schema' objects.
        //     2) A vector of 'bdlmxxx::ChoiceArray' objects that satisfy the final
        ...
        //   void rebind(const bdlmxxx::ChoiceArray *,  *record);
        //   void rebind(const bdlmxxx::ChoiceArray *,  *schema, *name);
        //   void rebind(const bdlmxxx::ChoiceArray *,  *schema, int);
        //
        //             bdem_ChoiceArrayBinding
        //             ~~~~~~~~~~~~~~~~~~~~
        //   void rebind(bdem_ChoiceArrayBinding& binding);
        //   void rebind(bdlmxxx::ChoiceArray *, *record);
        //   void rebind(bdlmxxx::ChoiceArray *, *schema, *name);
        //   void rebind(bdlmxxx::ChoiceArray *, *schema, int);
        // -------------------------------------------------------------------
...
DEFINE_TEST_CASE(15) {
        ...
        //   The data used for this test is a collection of vectors as follows:
        //     1) A vector of 'bdlmxxx::Schema' objects.
        //     2) A vector of 'bdlmxxx::Choice' objects that satisfy the final
        //        records contained in the schemas from 1)
        //     3) A vector of record names.  This vector stores the *names* of
        //        the records in the schemas from 1) corresponding to the data
        //        in the lists from 2).
        //     4) A second vector of 'bdlmxxx::Schema' objects.
        //     5) A vector of 'bdlmxxx::ChoiceArray' objects that satisfy the final
        ...
        //   void rebind(const bdlmxxx::ChoiceArrayItem *, *record);
        //   void rebind(const bdlmxxx::ChoiceArrayItem *, *schema, *name);
        //   void rebind(const bdlmxxx::ChoiceArrayItem *, *schema, int);
        //   void rebind(const bdlmxxx::Choice *, *record);
        //   void rebind(const bdlmxxx::Choice *, *schema, *name);
        //   void rebind(const bdlmxxx::Choice *, *schema, int);
        //   void rebind(const bdlmxxx::ChoiceArray *, int, *record);
        //   void rebind(const bdlmxxx::ChoiceArray *, int, *schema, *name);
        //   void rebind(const bdlmxxx::ChoiceArray *, int, *schema, int);
        //
        //             bdem_ChoiceBinding
        //             ~~~~~~~~~~~~~~~~~~~~
        //   void rebind(bdem_ChoiceBinding& binding);
        //   void rebind(bdlmxxx::ChoiceArrayItem *, *record);
        //   void rebind(bdlmxxx::ChoiceArrayItem *, *schema, *name);
        //   void rebind(bdlmxxx::ChoiceArrayItem *, *schema, int);
        //   void rebind(bdlmxxx::Choice *, *record);
        //   void rebind(bdlmxxx::Choice *, *schema, *name);
        //   void rebind(bdlmxxx::Choice *, *schema, int);
        //   void rebind(bdlmxxx::ChoiceArray *, int, *record);
        //   void rebind(bdlmxxx::ChoiceArray *, int, *schema, *name);
        //   void rebind(bdlmxxx::ChoiceArray *, int, *schema, int);
        // -------------------------------------------------------------------
...
DEFINE_TEST_CASE(14) {
        ...
        //   The data used for this test is a collection of vectors as follows:
        //     1) A vector of 'bdlmxxx::Schema' objects.
        //     2) A vector of 'bdlmxxx::Table' objects that satisfy the final
        //        records contained in the schemas from 1).
...
DEFINE_TEST_CASE(12) {
        ...
        //   The data used for this test is a collection of vectors as follows:
        //     1) A vector of 'bdlmxxx::Schema' objects.
        //     2) A vector of 'bdlmxxx::List' objects that satisfy the final
        //        records contained in the schemas from 1).
        //     3) A vector of record names.  This vector stores the *names* of
        //        the records in the schemas from 1) corresponding to the data
        //        in the lists from 2).
        //     4) A second vector of 'bdlmxxx::Schema' objects.
        //     5) A vector of 'bdlmxxx::Table' objects that satisfy the final
        //        records contained in the schemas from 4).
        //     6) A second vector of record names.  This vector stores the
        //        *names* of the records in the schemas from 4) corresponding
        //        to the data in the tables from 5).
...
DEFINE_TEST_CASE(11) {
        ...
        //
        // Plan:
        //   Create a 'bdlmxxx::ChoiceArray' containing a selection for each
        //   'bdlmxxx::ElemType::Type'.  Using that 'bdlmxxx::ChoiceArray',
        //   create instances of both Choice binding classes.
        //   Loop through the all the types using the
        //   bdlmxxx::ChoiceArray object to set the selection and value then
        //   access the 'bdlmxxx::ChoiceArray' using the non-modifiable
        ...
        //   references to change the value of the 'bdem::Array'.
        //   Check that the value of the original 'bdlmxxx::ChoiceArray'
        ...
        //             bdem_ConstChoiceArrayBinding
        //             ~~~~~~~~~~~~~~~
        //   bdlmxxx::ConstElemRef selection(int) const;
        //   bdlmxxx::ElemType::Type selectionType(int ) const;
        //   bdlmxxx::ElemType::Type selectionType(const char *elementName) const;
        //   bdlmxxx::ElemType::Type selectorType(int) const;
        ...
        //   bdlt::Datetime& theDatetime(int) const;
        //   bdlt::Time& theTime(int) const;
        //   bdlt::Date& theDate(int) const;
        ...
        //   bdlmxxx::List& theList(int) const;
        //   bdlmxxx::Table& theTable(int) const;
        //   bdem::Bool&  theBool(int)  const;
        //   bdem::DatetimeTz&  theDatetimeTz(int)  const;
        //   bdem::DateTz&  theDateTz(int)  const;
        //   bdem::TimeTz&  theTimeTz(int)  const;
        //   bdem::BoolArray&  theBoolArray(int)  const;
        //   bdem::DatetimeTzArray&  theDatetimeTzArray(int)  const;
        //   bdem::DateTzArray&  theDateTzArray(int)  const;
        //   bdem::TimeTzArray&  theTimeTzArray(int)  const;
        //   bdlmxxx::Choice&  theChoice(int)  const;
        //   bdlmxxx::ChoiceArray&  theChoiceArray(int)  const;
        //
        //             bdem_ChoiceArrayBinding
        //             ~~~~~~~~~~~~~~~
        //   bdlmxxx::ConstElemRef selection(int) const;
       ...
       ":a?AaBbCcDdEeFfGgHhIiJjKkLlMmNnOoPpQqRrSsTtUuVvWwXxYyZzaAbBcCdDeEfF";
            ...
            for (int i = 0; i < rec->numFields(); ++i ) {
                ...
                const bdlmxxx::FieldDef &field = rec->field(i);
                ...
                ASSERT (bdlmxxx::ElemType::BDEM_VOID == CAB.selectorType(i));
                ASSERT (bdlmxxx::ElemType::BDEM_VOID == CCAB.selectorType(i));
...
DEFINE_TEST_CASE(10) {
        ...
        //
        // Plan:
        //   Create a 'bdlmxxx::Choice' containing a selection for each
        //   'bdlmxxx::ElemType::Type'.  Using that 'bdlmxxx::Choice', create instances
        //   of both Choice binding classes.  Loop through the all the types
        //   using the bdlmxxx::Choice object to set the selection and value then
        //   access the 'bdlmxxx::Choice' using the non-modifiable accessor
        ...
        //   'bdlmxxx::List'.  Check that the value of the original 'bdlmxxx::List'
        ...
        //   bdem::Bool&  theBool()  const;
        //   bdem::DatetimeTz&  theDatetimeTz()  const;
        //   bdem::DateTz&  theDateTz()  const;
        //   bdem::TimeTz&  theTimeTz()  const;
        //   bdem::BoolArray&  theBoolArray()  const;
        //   bdem::DatetimeTzArray&  theDatetimeTzArray()  const;
        //   bdem::DateTzArray&  theDateTzArray()  const;
        //   bdem::TimeTzArray&  theTimeTzArray()  const;
...
DEFINE_TEST_CASE(9) {
        ...
        //
        // Plan:
        //   Create a 'bdlmxxx::Table' having a column for each
        //   'bdlmxxx::ElemType::Type' and containing at least one row of data.
        //   Using that 'bdlmxxx::Table', create instances of all 4 table binding
        //   classes.  Access the elements in the original 'bdlmxxx::Table' using
        ...
        //   references to change the value of the 'bdlmxxx::Table'.  Check that
        //   the value of the original 'bdlmxxx::Table' has been correctly modified
        ...
        //             bdem_ConstTableBinding
        //             ~~~~~~~~~~~~~~~~~~~~~~
        //   bdlmxxx::ConstElemRef element(int, *name) const;
        //   bdlmxxx::ConstElemRef element(int, int) const;
        //   bdlmxxx::ElemType::Type elemType(*name) const;
        //   bdlmxxx::ElemType::Type elemType(int) const;
        ...
        //   const bdlt::Datetime& theDatetime(int, *name) const;
        //   const bdlt::Date& theDate(int, *name) const;
        //   const bdlt::Time& theTime(int, *name) const;
        ...
        //   const bdlmxxx::List& theList(int, *name) const;
        //   const bdlmxxx::Table& theTable(int, *name) const;
        //   const bdem::Bool&  theBool(*name)  const;
        //   const bdem::DatetimeTz&  theDatetimeTz(*name)  const;
        //   const bdem::DateTz&  theDateTz(*name)  const;
        //   const bdem::TimeTz&  theTimeTz(*name)  const;
        //   const bdem::BoolArray&  theBoolArray(*name)  const;
        //   const bdem::DatetimeTzArray&  theDatetimeTzArray(*name)  const;
        //   const bdem::DateTzArray&  theDateTzArray(*name)  const;
        //   const bdem::TimeTzArray&  theTimeTzArray(*name)  const;
        //   const bdlmxxx::Choice&  theChoice(*name)  const;
        //   const bdlmxxx::ChoiceArray&  theChoiceArray(*name)  const;
        //
        //             bdem_TableBinding
        //             ~~~~~~~~~~~~~~~~~
        //   bdlmxxx::ElemRef element(int, *name) const;
        //   bdlmxxx::ElemRef element(int, int) const;
        ...
        //   bdlt::Datetime& theDatetime(int, *name) const;
        //   bdlt::Date& theDate(int, *name) const;
        //   bdlt::Time& theTime(int, *name) const;
        ...
        //   bdlmxxx::List& theList(int, *name) const;
        //   bdlmxxx::Table& theTable(int, *name) const;
        //   bdem::Bool&  theBool(*name)  const;
        //   bdem::DatetimeTz&  theDatetimeTz(*name)  const;
        //   bdem::DateTz&  theDateTz(*name)  const;
        //   bdem::TimeTz&  theTimeTz(*name)  const;
        //   bdem::BoolArray&  theBoolArray(*name)  const;
        //   bdem::DatetimeTzArray&  theDatetimeTzArray(*name)  const;
        //   bdem::DateTzArray&  theDateTzArray(*name)  const;
        //   bdem::TimeTzArray&  theTimeTzArray(*name)  const;
        //   bdlmxxx::Choice&  theChoice(*name)  const;
        //   bdlmxxx::ChoiceArray&  theChoiceArray(*name)  const;
        // --------------------------------------------------------------------
...
DEFINE_TEST_CASE(8) {
        ...
        //
        // Plan:
        //   Create a 'bdlmxxx::List' containing one data element for each
        //   'bdlmxxx::ElemType::Type'.  Using that 'bdlmxxx::List', create instances
        //   of all 4 row binding classes.  Access the elements in the original
        //   'bdlmxxx::List' using the non-modifiable accessor functions provided
        //   by the row bindings and verify that the references returned match
        //   the original data.  Use the accessors that return modifiable
        //   references to change the value of the 'bdlmxxx::List'.  Check that the
        //   value of the original 'bdlmxxx::List' has been correctly modified via
        ...
        //             bdem_ConstRowBinding
        //             ~~~~~~~~~~~~~~~~~~~~
        //   bdlmxxx::ConstElemRef operator[](int) const;
        //   bdlmxxx::ConstElemRef element(*name) const;
        //   bdlmxxx::ConstElemRef element(int) const;
        //   bdlmxxx::ElemType::Type elemType(*name) const;
        //   bdlmxxx::ElemType::Type elemType(int) const;
        ...
        //   const bdlt::Datetime& theDatetime(*name) const;
        //   const bdlt::Date& theDate(*name) const;
        //   const bdlt::Time& theTime(*name) const;
        ...
        //   const bdlmxxx::List& theList(*name) const;
        //   const bdlmxxx::Table& theTable(*name) const;
        //   const bdem::Bool&  theBool(*name)  const;
        //   const bdem::DatetimeTz&  theDatetimeTz(*name)  const;
        //   const bdem::DateTz&  theDateTz(*name)  const;
        //   const bdem::TimeTz&  theTimeTz(*name)  const;
        ...
        //             bdem_RowBinding
        //             ~~~~~~~~~~~~~~~
        //   bdlmxxx::ElemRef operator[](int) const;
        //   bdlmxxx::ElemRef element(*name) const;
        //   bdlmxxx::ElemRef element(int) const;
        ...
        //   bdlt::Datetime& theDatetime(*name) const;
        //   bdlt::Time& theTime(*name) const;
        //   bdlt::Date& theDate(*name) const;
        ...
        //   bdlmxxx::List& theList(*name) const;
        //   bdlmxxx::Table& theTable(*name) const;
        //   bdem::Bool&  theBool(*name)  const;
        //   bdem::DatetimeTz&  theDatetimeTz(*name)  const;
        //   bdem::DateTz&  theDateTz(*name)  const;
        //   bdem::TimeTz&  theTimeTz(*name)  const;
...
DEFINE_TEST_CASE(7) {
        ...
        //   ever element of vector 'bdlmxxx::Choice's.  Use the direct accessors
        ...
        //             bdem_ConstChoiceArrayBinding
        //             ~~~~~~~~~~~~~~~~~~~~~~~
        //  bdem_ConstChoiceArrayBinding(const bdlmxxx::ChoiceArray *,
        //                               const bdlmxxx::RecordDef *);
        //  bdem_ConstChoiceArrayBinding(const bdlmxxx::ChoiceArray *,
        //                               const bdlmxxx::Schema *);
        //  bdem_ConstChoiceArrayBinding(const bdlmxxx::ChoiceArray *,
        //                               const bdlmxxx::Schema &, int);
        ...
        //  const bdlmxxx::ChoiceArrayItem& choiceArray() const;
        //  int length();
        //  const bdlmxxx::RecordDef& record() const;
        //
        //             bdem_ChoiceArrayBinding
        //             ~~~~~~~~~~~~~~~~~~~~~~~
        //  bdem_ChoiceArrayBinding(const bdlmxxx::ChoiceArray *,
        //                               const bdlmxxx::RecordDef *);
        //  bdem_ChoiceArrayBinding(const bdlmxxx::ChoiceArray *,
        //                               const bdlmxxx::Schema *);
        //  bdem_ChoiceArrayBinding(const bdlmxxx::ChoiceArray *,
        ...
        if (veryVerbose) { cout << "'const'-correctness." << endl; }
        {
...

            {
                ...
                const bdlmxxx::ChoiceArray&   CA = CCAB.choiceArray();
                ASSERT(CA.length());
            ...
            }
            {
                ...
                bdlmxxx::ChoiceArray&  CA = CAB.choiceArray();
                ASSERT(CA.length());
            }
        }
      }
...
DEFINE_TEST_CASE(6) {
        ...
        //             bdem_ConstChoiceBinding
        //             ~~~~~~~~~~~~~~~~~~~~~~~
        //  bdem_ConstChoiceBinding(const bdlmxxx::ChoiceArrayItem *,
        //                          const bdlmxxx::RecordDef *);
        //  bdem_ConstChoiceBinding(const bdlmxxx::ChoiceArrayItem *,
        //                          const bdlmxxx::Schema *);
        //  bdem_ConstChoiceBinding(const bdlmxxx::ChoiceArrayItem *,
        //                          const bdlmxxx::Schema &, int);
        //  bdem_ConstChoiceBinding(const bdlmxxx::Choice *,
        //                          const bdlmxxx::RecordDef *);
        //  bdem_ConstChoiceBinding(const bdlmxxx::Choice *,
        //                          const bdlmxxx::Schema, const char *);
        //  bdem_ConstChoiceBinding(const bdlmxxx::Choice *,
        //                          const bdlmxxx::Schema *, int);
        //  bdem_ConstChoiceBinding(const bdlmxxx::ChoiceArray *,
        //                          int , const bdlmxxx::RecordDef *);
        //  bdem_ConstChoiceBinding(const bdlmxxx::ChoiceArray *,
        //                          int , const bdlmxxx_schema *, const char *);
        //  bdem_ConstChoiceBinding(const bdlmxxx::ChoiceArray *, int ,
        //                          const bdlmxxx_schema *, int);
        ...
        //             bdem_ChoiceBinding
        //             ~~~~~~~~~~~~~~~~~~~~~~~
        //  bdem_ChoiceBinding(const bdlmxxx::ChoiceArrayItem *,
        //                          const bdlmxxx::RecordDef *);
        //  bdem_ChoiceBinding(const bdlmxxx::ChoiceArrayItem *,
        //                          const bdlmxxx::Schema *);
        //  bdem_ChoiceBinding(const bdlmxxx::ChoiceArrayItem *,
        //                          const bdlmxxx::Schema &, int);
        //  bdem_ChoiceBinding(const bdlmxxx::Choice *,
        //                          const bdlmxxx::RecordDef *);
        //  bdem_ChoiceBinding(const bdlmxxx::Choice *,
        //                          const bdlmxxx::Schema, const char *);
        //  bdem_ChoiceBinding(const bdlmxxx::Choice *,
        //                          const bdlmxxx::Schema *, int);
        //  bdem_ChoiceBinding(const bdlmxxx::ChoiceArray *,
        //                          int , const bdlmxxx::RecordDef *);
        //  bdem_ChoiceBinding(const bdlmxxx::ChoiceArray *,
        //                          int , const bdlmxxx_schema *, const char *);
        //  bdem_ChoiceBinding(const bdlmxxx::ChoiceArray *, int ,
        //                          const bdlmxxx_schema *, int);
        ...
        if (veryVerbose) { cout << "'const'-correctness." << endl; }
        {
...

            {
                ...
                const bdlmxxx::ChoiceArrayItem&   CAI = CCB.item();
            ...
            }
            {
                ...
                bdlmxxx::ChoiceArrayItem&  CAI = CB.item();
                ASSERT(CAI.numSelections());
            }
        }
...
DEFINE_TEST_CASE(5) {
        ...
        //   of every element in the vector of 'bdlmxxx::Table's.  Use the direct
...
DEFINE_TEST_CASE(4) {
        ...
        //   the vector of 'bdlmxxx::Table's.  Use the direct accessors to verify
        ...
        //   ~bdem_ConstTableBinding();
        //   const bdlmxxx::Row& operator[](int) const;
        ...
        //   ~bdem_TableBinding();
        //   bdlmxxx::Row& operator[](int) const;
        //   bdlmxxx::Table& table() const;
        // --------------------------------------------------------------------
...
DEFINE_TEST_CASE(3) {
        ...
        //   'bdlmxxx::List's, and each row of every element in the vector of
        //   'bdlmxxx::Table's.  Use the direct accessors to verify that the bound
...
DEFINE_TEST_CASE(2) {
        ...
        //   'bdlmxxx::Schema'.  Then we check that the 'createList' and
        //   'createTable' methods create correct 'bdlmxxx::List' and 'bdlmxxx::Table'
        ...
        //   instances of 'bdlmxxx::List' and 'bdlmxxx::Table' using the 'createList'
        ...
        //
        // Testing:
        //   void createSchema(bdlmxxx::Schema *schema, const char *spec);
        //   void createList(bdlmxxx::List *list, const bdlmxxx::RecordDef *record);
        //   void createTable(bdlmxxx::Table *table, const bdlmxxx::RecordDef *record);
        // --------------------------------------------------------------------
...
DEFINE_TEST_CASE(1) {
        ...
        //
        // Plan:
        //   From a 'bdlmxxx::Schema', create a 'bdlmxxx::List' that satisfies that
        //   schema, and a 'bdlmxxx::Table' having rows that satisfy the schema.
        //   Using the 'bdlmxxx::Schema', 'bdlmxxx::List', and 'bdlmxxx::Table', construct
        ...
        bdlmxxx::EnumerationDef *pSex = S.createEnumeration("SEX");
        ...
        bdlmxxx::EnumerationDef *pLeagues = S.createEnumeration("LEAGUES");
                pLeagues->addEnumerator("Minor");
                pLeagues->addEnumerator("Major");

        bdlmxxx::EnumerationDef *pDivision = S.createEnumeration("DIVISIONS");
        ...
        const bdlmxxx::ElemType::Type levelTypes[] = {
            bdlmxxx::ElemType::BDEM_STRING,
            bdlmxxx::ElemType::BDEM_INT
        };
        const int numLevelTypes =
            sizeof(levelTypes)/sizeof(bdlmxxx::ElemType::Type);
        ...
        const bdlmxxx::ElemType::Type numberTypes[] = {
            bdlmxxx::ElemType::BDEM_STRING,
            bdlmxxx::ElemType::BDEM_LIST
        };
        const int numNumberTypes =
            sizeof(numberTypes)/sizeof(bdlmxxx::ElemType::Type);
        ...
        const bdlt::Date   leaderHireDate1(memberHireDate1);
        ...
        const bdlt::Date   leaderHireDate2(memberHireDate2);
        ...
        const bdlt::Date   leaderHireDate3(memberHireDate3);
