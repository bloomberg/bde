// bdlmxxx_bdemencoderutil.t.cpp                                      -*-C++-*-
...
#include <bdlxxxx_byteinstreamformatter.h>   // for testing only
...
typedef bdlmxxx::BdemEncoderUtil Encoder;  // alias for 'struct' under test
...
//-----------------------------------------------------------------------------
namespace {
bool isEqual(const bdlt::DatetimeTz& lhs, const bdlmxxx::List& rhs)
{
    return 2                       == rhs.length()
        && bdlmxxx::ElemType::BDEM_DATETIME == rhs.elemType(0)
        && bdlmxxx::ElemType::BDEM_INT      == rhs.elemType(1)
        && lhs.localDatetime()     == rhs.theDatetime(0)
        && lhs.offset()            == rhs.theInt(1);
}
bool isEqual(const bdlt::DateTz& lhs, const bdlmxxx::List& rhs)
{
    return 2                   == rhs.length()
        && bdlmxxx::ElemType::BDEM_DATE == rhs.elemType(0)
        && bdlmxxx::ElemType::BDEM_INT  == rhs.elemType(1)
        && lhs.localDate()     == rhs.theDate(0)
        && lhs.offset()        == rhs.theInt(1);
}
bool isEqual(const bdlt::TimeTz& lhs, const bdlmxxx::List& rhs)
{
    return 2                   == rhs.length()
        && bdlmxxx::ElemType::BDEM_TIME == rhs.elemType(0)
        && bdlmxxx::ElemType::BDEM_INT  == rhs.elemType(1)
        && lhs.localTime()     == rhs.theTime(0)
        && lhs.offset()        == rhs.theInt(1);
}
bool isEqual(const test::MySequence& lhs, const bdlmxxx::List& rhs)
{
    return 2                     == rhs.length()
        && bdlmxxx::ElemType::BDEM_INT    == rhs.elemType(0)
        && bdlmxxx::ElemType::BDEM_STRING == rhs.elemType(1)
        && lhs.attribute1()      == rhs.theInt(0)
        && lhs.attribute2()      == rhs.theString(1);
}
bool isEqual(const test::MyChoice& lhs, const bdlmxxx::List& rhs)
{
    const int selectionId = lhs.selectionId();
    if (test::MyChoice::SELECTION_ID_UNDEFINED == selectionId) {
        if (1                     != rhs.length()
         || bdlmxxx::ElemType::BDEM_STRING != rhs.elemType(0)
...
bool isEqual(const test::MySequenceWithNullables& lhs,
             const bdlmxxx::List&                     rhs)
{
    if (5                        != rhs.length()
     || bdlmxxx::ElemType::BDEM_INT       != rhs.elemType(0)
     || bdlmxxx::ElemType::BDEM_STRING    != rhs.elemType(1)
     || bdlmxxx::ElemType::BDEM_LIST      != rhs.elemType(2)
     || bdlmxxx::ElemType::BDEM_INT_ARRAY != rhs.elemType(3)
     || bdlmxxx::ElemType::BDEM_INT       != rhs.elemType(4)) {
        return false;                                                 // RETURN
    }
    if ((lhs.attribute1().isNull()
      && !bdltuxxx::Unset<int>::isUnset(rhs.theInt(0)))
     || (!lhs.attribute1().isNull()
                               && lhs.attribute1().value() != rhs.theInt(0))) {
        return false;                                                 // RETURN
    }
    if ((lhs.attribute2().isNull()
      && !bdltuxxx::Unset<bsl::string>::isUnset(rhs.theString(1)))
    ...
    if ((lhs.attribute5().isNull()
      && !bdltuxxx::Unset<int>::isUnset(rhs.theInt(4)))
...
{
    return (1                   == rhs.length()
         && bdlmxxx::ElemType::BDEM_LIST == rhs.elemType(0)
             ...
             const bdlmxxx::List&                         rhs)
{
    if (40                 != rhs.length()
     || bdlmxxx::ElemType::BDEM_INT != rhs.elemType(0)
     || bdlmxxx::ElemType::BDEM_INT != rhs.elemType(1)
     || bdlmxxx::ElemType::BDEM_INT != rhs.elemType(2)
     || bdlmxxx::ElemType::BDEM_INT != rhs.elemType(3)
     || bdlmxxx::ElemType::BDEM_INT != rhs.elemType(4)
     || bdlmxxx::ElemType::BDEM_INT != rhs.elemType(5)
     || bdlmxxx::ElemType::BDEM_INT != rhs.elemType(6)
     || bdlmxxx::ElemType::BDEM_INT != rhs.elemType(7)
     || bdlmxxx::ElemType::BDEM_INT != rhs.elemType(8)
     || bdlmxxx::ElemType::BDEM_INT != rhs.elemType(9)
     || bdlmxxx::ElemType::BDEM_INT != rhs.elemType(10)
     || bdlmxxx::ElemType::BDEM_INT != rhs.elemType(11)
     || bdlmxxx::ElemType::BDEM_INT != rhs.elemType(12)
     || bdlmxxx::ElemType::BDEM_INT != rhs.elemType(13)
     || bdlmxxx::ElemType::BDEM_INT != rhs.elemType(14)
     || bdlmxxx::ElemType::BDEM_INT != rhs.elemType(15)
     || bdlmxxx::ElemType::BDEM_INT != rhs.elemType(16)
     || bdlmxxx::ElemType::BDEM_INT != rhs.elemType(17)
     || bdlmxxx::ElemType::BDEM_INT != rhs.elemType(18)
     || bdlmxxx::ElemType::BDEM_INT != rhs.elemType(19)
     || bdlmxxx::ElemType::BDEM_INT != rhs.elemType(20)
     || bdlmxxx::ElemType::BDEM_INT != rhs.elemType(21)
     || bdlmxxx::ElemType::BDEM_INT != rhs.elemType(22)
     || bdlmxxx::ElemType::BDEM_INT != rhs.elemType(23)
     || bdlmxxx::ElemType::BDEM_INT != rhs.elemType(24)
     || bdlmxxx::ElemType::BDEM_INT != rhs.elemType(25)
     || bdlmxxx::ElemType::BDEM_INT != rhs.elemType(26)
     || bdlmxxx::ElemType::BDEM_INT != rhs.elemType(27)
     || bdlmxxx::ElemType::BDEM_INT != rhs.elemType(28)
     || bdlmxxx::ElemType::BDEM_INT != rhs.elemType(29)
     || bdlmxxx::ElemType::BDEM_INT != rhs.elemType(30)
     || bdlmxxx::ElemType::BDEM_INT != rhs.elemType(31)
     || bdlmxxx::ElemType::BDEM_INT != rhs.elemType(32)
     || bdlmxxx::ElemType::BDEM_INT != rhs.elemType(33)
     || bdlmxxx::ElemType::BDEM_INT != rhs.elemType(34)
     || bdlmxxx::ElemType::BDEM_INT != rhs.elemType(35)
     || bdlmxxx::ElemType::BDEM_INT != rhs.elemType(36)
     || bdlmxxx::ElemType::BDEM_INT != rhs.elemType(37)
     || bdlmxxx::ElemType::BDEM_INT != rhs.elemType(38)
     || bdlmxxx::ElemType::BDEM_INT != rhs.elemType(39)) {
        return false;                                                 // RETURN
    }
    int i = 0;
    if (( lhs.attribute01().isNull()
      && !bdltuxxx::Unset<int>::isUnset(rhs.theInt(i)))
