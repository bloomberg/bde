...
//
//@CLASSES:
//            bdem_ConstRowBinding: binding to "const" 'bdlmxxx::Row'
//                 bdem_RowBinding: binding to modifiable 'bdlmxxx::Row'
//          bdem_ConstTableBinding: binding to "const" 'bdlmxxx::Table'
//               bdem_TableBinding: binding to modifiable 'bdlmxxx::Table'
//         bdem_ConstColumnBinding: binding to "const" column
//              bdem_ColumnBinding: binding to modifiable column
//         bdem_ConstChoiceBinding: binding to "const" 'bdlmxxx::Choice'
//              bdem_ChoiceBinding: binding to modifiable 'bdlmxxx::Choice'
//    bdem_ConstChoiceArrayBinding: binding to "const" 'bdlmxxx::ChoiceArray'
//         bdem_ChoiceArrayBinding: binding to modifiable 'bdlmxxx::ChoiceArray'
//
//@AUTHOR: Rohan Bhindwale (rbhindwale)
//
//@SEE_ALSO: bdlmxxx_row, bdlmxxx_table, bdlmxxx_schema, bdlmxxx_schemaaggregateutil,
//           bdlmxxx_elemref, bdlmxxx_choice, bdlmxxx_choicearray
//
...
// instance of 'bdlmxxx::Row' or 'bdlmxxx::Table').  A "row binding" acts as a proxy to
// an instance of 'bdlmxxx::Row' ("row"), whereas a "table binding" acts as a proxy
// to an instance of 'bdlmxxx::Table' ("table").  A "column binding", acts as a
// proxy to a single column within an instance of 'bdlmxxx::Table' ("column").  A
// "choice binding" acts as a proxy to an instance of 'bdlmxxx::Choice' ("choice"),
...
// 'bdlmxxx::RecordDef' ("record") to a row or table, respectively; a column
// binding binds a 'bdlmxxx::FieldDef' ("field") to a column.  Typically the record
...
// (See the component-level documentation of 'bdlmxxx_schema' for information on
// 'bdlmxxx::RecordDef', 'bdlmxxx::EnumerationDef', 'bdlmxxx::FieldDef', and schemas.)
//
...
///-----------------------------------
// The native 'bdem' interfaces (e.g., 'bdlmxxx_row' and 'bdlmxxx_table') provide
...
// field.  (See the component-level documentation of 'bdlmxxx_schemaaggregateutil'
// for information on schema/aggregate conformance.  Also see the overloaded
// 'bdlmxxx::SchemaAggregateUtil::canSatisfyRecord' methods in that component for
...
//                 ( bdem::XXXBinding )         to enable modification
//                  `---------------'          of non-const elements,
//                          |                  but no additional data.
//                          v
//                ,--------------------.
//               ( bdem::ConstXXXBinding )      No virtual functions.
//                `--------------------'
//..
...
// contained in a 'bdlmxxx::List', a 'bdlmxxx::Table', or other container, because
...
// 'bdlmxxx::Schema' corresponding to the schema in Figure 1:
//..
//  bdlmxxx::Schema deptSchema;
//  {
//      // EMPLOYEE record
//
//      bdlmxxx::RecordDef *employee = deptSchema.createRecord("EMPLOYEE");
//
//      employee->appendField(bdlmxxx::ElemType::BDEM_STRING, "empName");
//      employee->appendField(bdlmxxx::ElemType::BDEM_INT,    "salary");
//      employee->appendField(bdlmxxx::ElemType::BDEM_DATE,   "dateOfHire");
//
//      // TEAM record
//
//      bdlmxxx::RecordDef *team = deptSchema.createRecord("TEAM");
//
//      team->appendField(bdlmxxx::ElemType::BDEM_STRING, "teamName");
//      team->appendField(bdlmxxx::ElemType::BDEM_DOUBLE, "revenue");
//
//      team->appendField(bdlmxxx::ElemType::BDEM_LIST,  employee, "leader");
//      team->appendField(bdlmxxx::ElemType::BDEM_TABLE, employee, "members");
//
//      // DEPARTMENT record
//
//      bdlmxxx::RecordDef *department = deptSchema.createRecord("DEPARTMENT");
//
//      department->appendField(bdlmxxx::ElemType::BDEM_STRING, "deptName");
//      department->appendField(bdlmxxx::ElemType::BDEM_DOUBLE, "revenue");
//
//      department->appendField(bdlmxxx::ElemType::BDEM_TABLE, team, "teams");
//  }
//..
...
//      bsl::string d_name;
//      int         d_salary;
//      bdlt::Date   d_hireDate;
//  } EMPLOYEES[] = {
//      // name                salary (knuts x K)   hireDate
//      // -----------------   ------------------   -----------------------
//      {  "Alice Field",      135,                 bdlt::Date(2001,  1, 27)  },
//      {  "Martina Hingis",   107,                 bdlt::Date(1999, 11,  9)  },
//      {  "Sean O'Casey",     126,                 bdlt::Date(1998,  5,  5)  },
//      {  "Harry Tonto",       95,                 bdlt::Date(2003,  4,  9)  },
//      {  "Michael Blix",     125,                 bdlt::Date(1998,  5,  5)  },
//      {  "Jen-Pi Huang",     110,                 bdlt::Date(2004,  2, 16)  },
//      {  "John Smith",       105,                 bdlt::Date(2004,  7, 17)  },
//      {  "Sandra Mueller",    95,                 bdlt::Date(2004,  8,  8)  },
//  };
//  const int numEmployees = sizeof(EMPLOYEES) / sizeof(*EMPLOYEES);
//
//  const bdlmxxx::ElemType::Type EmpTypes[] = {
...
//
//  const bdlmxxx::ElemType::Type TeamTypes[] = {
//      bdlmxxx::ElemType::BDEM_STRING,
...
//
//  const bdlmxxx::ElemType::Type DeptTypes[] = {
//      bdlmxxx::ElemType::BDEM_STRING,
//      bdlmxxx::ElemType::BDEM_DOUBLE,
//      bdlmxxx::ElemType::BDEM_TABLE
//  };
...
//..
// Teams and team leaders are instances of 'bdlmxxx::List'.  The team leaders for
// our two teams are 'leaderA' and 'leaderB':
//..
//  bdlmxxx::List leaderA(EmpTypes, numEmpTypes);
...
//
//  bdlmxxx::List leaderB(EmpTypes, numEmpTypes);
...
// respectively:
//..
//  bdlmxxx::List teamA(TeamTypes, numTeamTypes);
//  teamA[0].theModifiableString() = TEAMS[0].d_name;
//  teamA[1].theModifiableDouble() = TEAMS[0].d_revenue;
//  teamA[2].theModifiableList()   = leaderA;
//  teamA[3].theModifiableTable()  = bdlmxxx::Table(EmpTypes, numEmpTypes);
//  int i;
//  for (i = 0; i < 4; ++i) {
//      bdlmxxx::List member(EmpTypes, numEmpTypes);
...
//  }
//..
// Finally, we create a 'bdlmxxx::List' comprised of 'teamA' and 'teamB' to
// represent the "Widgets" department:
//..
//  bdlmxxx::List widgetsDept(DeptTypes, numDeptTypes);
//  widgetsDept[0].theModifiableString() = "Widgets";  // department name
//  widgetsDept[1].theModifiableDouble() = 195.7;      // revenue (knuts x M)
//  widgetsDept[2].theModifiableTable()  = bdlmxxx::Table(TeamTypes, numTeamTypes);
...
// that takes a 'const bdlmxxx::List *', a 'const bdlmxxx::Schema *', and a
...
// 'bdlmxxx::ConstElemRef' (an element reference):
//..
...
//      const bdlt::Date      hiredOn    = leader.theDate  ("dateOfHire");
//
...
//                << bsl::endl;
//..
// The 'leader' binding may be rebound to another 'bdlmxxx::List' that satisfies
...
class bdem_ConstRowBinding {
    // This class binds a non-modifiable 'bdlmxxx::Row' ("row") to a non-modifiable
    // 'bdlmxxx::RecordDef' ("record"), and provides both by-name and indexed
  ...
  public:
    // TYPES
    typedef bdlmxxx::ConstElemRef            ElemRef;
    ...
    typedef const bdlmxxx::Row               Row;
    typedef const bdlmxxx::List              List;

  private:
    // DATA
    const bdlmxxx::Row       *d_row_p;         // data (held, not owned)
    const bdlmxxx::RecordDef *d_constraint_p;  // meta-data (held, not owned)
  ...
  public:
    // CREATORS
    bdem_ConstRowBinding(const bdlmxxx::Row *row, const bdlmxxx::RecordDef *record);
    ...
    bdem_ConstRowBinding(const bdlmxxx::Row    *row,
    ...
    bdem_ConstRowBinding(const bdlmxxx::List      *list,
    ...
    bdem_ConstRowBinding(const bdlmxxx::Table     *table,
                         int                   rowIndex,
                         const bdlmxxx::RecordDef *record);
    ...
    void rebind(const bdlmxxx::Row *row);
    ...
    void rebind(const bdlmxxx::List *list);
    ...
    void rebind(const bdlmxxx::Table *table, int rowIndex);
    ...
    void rebind(const bdlmxxx::Row *row, const bdlmxxx::RecordDef *record);
        // Reinitialize this row binding to bind the specified non-modifiable
        // 'row' to the specified non-modifiable 'record'.  The behavior is
        // undefined unless the 'row' data can satisfy the 'record' meta-data.
    ...
    void rebind(const bdlmxxx::List *list, const bdlmxxx::RecordDef *record);
        // Reinitialize this row binding to bind the non-modifiable row in the
    ...
    void rebind(const bdlmxxx::Table     *table,
                int                   rowIndex,
                const bdlmxxx::RecordDef *record);
        // Reinitialize this row binding to bind the non-modifiable row at the
    ...
    bdlmxxx::ConstElemRef element(const char *elementName) const;
        // Return a "const" element reference that refers to the non-modifiable
        // element having the specified 'elementName' in this binding.  The
        // behavior is undefined unless this binding has a field named
        // 'elementName'.

    bdlmxxx::ConstElemRef element(int index) const;
        // Return a "const" element reference that refers to the non-modifiable
        // element at the specified 'index' in this binding.  The behavior is
        // undefined unless '0 <= index < row().length()'.

    bdlmxxx::ElemType::Type elemType(const char *elementName) const;
        // Return the 'bdlmxxx::ElemType::Type' value of the element having the
    ...
    bdlmxxx::ElemType::Type elemType(int index) const;
        // Return the 'bdlmxxx::ElemType::Type' value of the element at the
    ...
    const bdlmxxx::RecordDef& record() const;
        // Return a reference to the non-modifiable record held by this
        // binding.

    const bdlmxxx::Row& row() const;
    ...
    const bdlt::Datetime& theDatetime(const char *elementName) const;
    const bdlt::DatetimeTz& theDatetimeTz(const char *elementName) const;
    const bdlt::Date& theDate(const char *elementName) const;
    const bdlt::DateTz& theDateTz(const char *elementName) const;
    const bdlt::Time& theTime(const char *elementName) const;
    const bdlt::TimeTz& theTimeTz(const char *elementName) const;
    ...
    const bsl::vector<bdlt::Datetime>& theDatetimeArray(
                                                const char *elementName) const;
    const bsl::vector<bdlt::DatetimeTz>& theDatetimeTzArray(
                                                const char *elementName) const;
    const bsl::vector<bdlt::Date>& theDateArray(const char *elementName) const;
    const bsl::vector<bdlt::DateTz>& theDateTzArray(
                                                const char *elementName) const;
    const bsl::vector<bdlt::Time>& theTimeArray(const char *elementName) const;
    const bsl::vector<bdlt::TimeTz>& theTimeTzArray(
                                                const char *elementName) const;
    const bdlmxxx::Choice& theChoice(const char *elementName) const;
    const bdlmxxx::ChoiceArray& theChoiceArray(const char *elementName) const;
    const bdlmxxx::List& theList(const char *elementName) const;
    const bdlmxxx::Table& theTable(const char *elementName) const;
    ...
    bdem_ConstChoiceBinding choiceBinding(int index) const;
        ...
        // and the indexed field constrains a 'bdlmxxx::Choice'.
    ...
    bdem_ConstChoiceArrayBinding choiceArrayBinding(
        ...
        // 'elementName' in this binding.  The behavior is undefined unless
        // this binding has a field named 'elementName' and the field
        // constrains a 'bdlmxxx::ChoiceArray'.
    ...
    bdem_ConstRowBinding rowBinding(const char *elementName) const;
        ...
        // field named 'elementName' and the field constrains a 'bdlmxxx::List'.
    ...
    bdem_ConstRowBinding rowBinding(int index) const;
        ...
        // non-modifiable constraint record in the field at 'index' in this
        // binding.  The behavior is undefined unless '0 <= index < length()'
        // and the indexed field constrains a 'bdlmxxx::List'.
    ...
    bdem_ConstTableBinding tableBinding(const char *elementName) const;
        ...
        // non-modifiable constraint record in the field named 'elementName' in
        // this binding.  The behavior is undefined unless this binding has a
        // field named 'elementName' and the field constrains a 'bdlmxxx::Table'.
    ...
    bdem_ConstTableBinding tableBinding(int index) const;
        ...
        // field constrains a 'bdlmxxx::Table'.
    ...
    int enumerationAsInt(const char *elementName) const;
        ...
        // 'bdltuxxx::Unset<int>::unsetValue()' if the element has an unset
    ...
    int enumerationAsInt(int index) const;
        ...
        // 'index' in this binding.  Return 'bdltuxxx::Unset<int>::unsetValue()'
...
bool operator==(const bdem_ConstRowBinding& lhs,
    ...
    // 'bdlmxxx::SchemaUtil::areEquivalent', and 'false' otherwise.
...
bool operator!=(const bdem_ConstRowBinding& lhs,
    ...
    // deemed by 'bdlmxxx::SchemaUtil::areEquivalent', and 'false' otherwise.
...
class bdem_RowBinding : public bdem_ConstRowBinding {
    // This class binds a modifiable 'bdlmxxx::Row' ("row") to a non-modifiable
    // 'bdlmxxx::RecordDef' ("record"), and provides both by-name and indexed
    // access to the elements of the row.  Indexed access is an efficient
    // constant-time operation; by-name access is somewhat less efficient, but
    // no less so than by-name access using the record 'lookup' methods.  For
  ...
  public:
    // TYPES
    typedef bdlmxxx::ElemRef            ElemRef;
  ...
  public:
    // CREATORS
    bdem_RowBinding(bdlmxxx::Row *row, const bdlmxxx::RecordDef *record);
    ...
    bdem_RowBinding(bdlmxxx::Row          *row,
                    const bdlmxxx::Schema *schema,
                    const char        *recordName);
        // Create a row binding that binds the specified modifiable 'row' to
    ...
    bdem_RowBinding(bdlmxxx::List *list, const bdlmxxx::RecordDef *record);
    ...
    bdem_RowBinding(bdlmxxx::List         *list,
                    const bdlmxxx::Schema *schema,
                    const char        *recordName);
        // Create a row binding that binds the modifiable row in the specified
    ...
    bdem_RowBinding(bdlmxxx::Table           *table,
                    int                   rowIndex,
                    const bdlmxxx::RecordDef *record);
    ...
    void rebind(bdlmxxx::List *list);
        // Reinitialize this row binding to bind the modifiable row in the
        // specified 'list' to the non-modifiable record already held by this
        // binding.  The behavior is undefined unless the row data in 'list'
        // can satisfy the record meta-data.

    void rebind(bdlmxxx::Table *table, int rowIndex);
    ...
    void rebind(bdlmxxx::Row *row, const bdlmxxx::RecordDef *record);
        // Reinitialize this row binding to bind the specified modifiable 'row'
    ...
    void rebind(bdlmxxx::Table           *table,
                int                   rowIndex,
                const bdlmxxx::RecordDef *record);
        // Reinitialize this row binding to bind the modifiable row at the
        // specified 'rowIndex' in the specified 'table' to the specified
    ...
    int setEnumeration(const char         *elementName,
        ...
        // 'bdlmxxx::ElemType::BDEM_STRING', store the specified 'enumeratorName'
        // in the element.  If the element is of type
        // 'bdlmxxx::ElemType::BDEM_INT', look up 'enumeratorName' in the element's
    ...
    int setEnumeration(const char *elementName, int enumeratorId) const;
        // Set the value of the enumeration element having the specified
        // 'elementName' in this binding.  If the element is of type
        // 'bdlmxxx::ElemType::BDEM_INT', store the specified 'enumeratorId' in the
        // element.  If the element is of type 'bdlmxxx::ElemType::BDEM_STRING,
    ...
    // ACCESSORS
    bdlmxxx::ElemRef operator[](int index) const;
    ...
    bdlmxxx::ElemRef element(const char *elementName) const;
    ...
    bdlmxxx::ElemRef element(int index) const;
        // Return an element reference that refers to the modifiable element at
        // the specified 'index' in this binding.  The behavior is undefined
        // unless '0 <= index < row().length()'.

    bdlmxxx::Row& row() const;
    ...
    bdlt::Datetime& theModifiableDatetime(const char *elementName) const;
    bdlt::DatetimeTz& theModifiableDatetimeTz(const char *elementName) const;
    bdlt::Date& theModifiableDate(const char *elementName) const;
    bdlt::DateTz& theModifiableDateTz(const char *elementName) const;
    bdlt::Time& theModifiableTime(const char *elementName) const;
    bdlt::TimeTz& theModifiableTimeTz(const char *elementName) const;
    ...
    bsl::vector<bdlt::TimeTz>& theModifiableTimeTzArray(
                                                const char *elementName) const;
    bdlmxxx::Choice& theModifiableChoice(const char *elementName) const;
    bdlmxxx::ChoiceArray& theModifiableChoiceArray(const char *elementName) const;
    bdlmxxx::List& theModifiableList(const char *elementName) const;
    bdlmxxx::Table& theModifiableTable(const char *elementName) const;
    ...
    bdem_ChoiceBinding choiceBinding(int index) const;
        ...
        // constraint record in the field at 'index' in this binding.  The
        // behavior is undefined unless '0 <= index < length()' and the indexed
        // field constrains a 'bdlmxxx::Choice'.
    ...
    bdem_ChoiceArrayBinding choiceArrayBinding(int index) const;
        ...
        // non-modifiable constraint record in the field at 'index' in this
        // binding.  The behavior is undefined unless '0 <= index < length()'
        // and the indexed field constrains a 'bdlmxxx::ChoiceArray'.
    ...
    bdem_RowBinding rowBinding(int index) const;
        ...
        // constraint record in the field at 'index' in this binding.  The
        // behavior is undefined unless '0 <= index < length()' and the indexed
        // field constrains a 'bdlmxxx::List'.
    ...
    bdem_TableBinding tableBinding(const char *elementName) const;
        ...
        // The behavior is undefined unless this binding has a field named
        // 'elementName' and the field constrains a 'bdlmxxx::Table'.
...
class bdem_ConstTableBinding {
    // This class binds a non-modifiable 'bdlmxxx::Table' ("table") to a
    // non-modifiable 'bdlmxxx::RecordDef' ("record"), and provides both by-name
  ...
  public:
    ...
    typedef const bdlmxxx::Table        Table;
    typedef const bdlmxxx::Row          Row;

  private:
    // DATA
    const bdlmxxx::Table     *d_table_p;       // data (held, not owned)
    const bdlmxxx::RecordDef *d_constraint_p;  // meta-data (held, not owned)
  ...
  public:
    // CREATORS
    bdem_ConstTableBinding(const bdlmxxx::Table     *table,
                           const bdlmxxx::RecordDef *record);
    ...
    void rebind(const bdlmxxx::Table *table, const bdlmxxx::RecordDef *record);
        // Reinitialize this table binding to bind the specified non-modifiable
    ...
    bdlmxxx::ConstElemRef element(int rowIndex, int columnIndex) const;
        // Return a "const" element reference that refers to the non-modifiable
    ...
    bdlmxxx::ElemType::Type elemType(const char *columnName) const;
        // Return the 'bdlmxxx::ElemType::Type' value of the elements in the column
    ...
    bdlmxxx::ElemType::Type elemType(int columnIndex) const;
        // Return the 'bdlmxxx::ElemType::Type' value of the elements at the
    ...
    const bdlmxxx::Table& table() const;
    ...
    const bdlt::Datetime& theDatetime(int         rowIndex,
                                     const char *columnName) const;
    const bdlt::DatetimeTz& theDatetimeTz(int         rowIndex,
                                         const char *columnName) const;
    const bdlt::Date& theDate(int rowIndex, const char *columnName) const;
    const bdlt::DateTz& theDateTz(int rowIndex, const char *columnName) const;
    const bdlt::Time& theTime(int rowIndex, const char *columnName) const;
    const bdlt::TimeTz& theTimeTz(int rowIndex, const char *columnName) const;
    ...
    const bsl::vector<bdlt::DatetimeTz>& theDatetimeTzArray(
                                                int         rowIndex,
                                                const char *columnName) const;
    const bsl::vector<bdlt::Date>& theDateArray(int         rowIndex,
                                               const char *columnName) const;
    const bsl::vector<bdlt::DateTz>& theDateTzArray(int         rowIndex,
                                               const char *columnName) const;
    const bsl::vector<bdlt::Time>& theTimeArray(int         rowIndex,
                                               const char *columnName) const;
    const bsl::vector<bdlt::TimeTz>& theTimeTzArray(
                                               int         rowIndex,
                                               const char *columnName) const;
    const bdlmxxx::Choice& theChoice(int rowIndex, const char *columnName) const;
    const bdlmxxx::ChoiceArray& theChoiceArray(int         rowIndex,
                                           const char *columnName) const;
    const bdlmxxx::List& theList(int rowIndex, const char *columnName) const;
    const bdlmxxx::Table& theTable(int rowIndex, const char *columnName) const;
    ...
    bdem_ConstChoiceBinding choiceBinding(int rowIndex, int columnIndex) const;
        ...
        // the indexed field constrains a 'bdlmxxx::Choice'.
    ...
    bdem_ConstChoiceArrayBinding choiceArrayBinding(
        ...
        // 'columnName', and the field constrains a 'bdlmxxx::ChoiceArray'.
    ...
    bdem_ConstRowBinding rowBinding(int rowIndex, int columnIndex) const;
        ...
        // this binding.  The behavior is undefined unless
        // '0 <= rowIndex < numRows()', '0 <= columnIndex < numColumns()', and
        // the indexed field constrains a 'bdlmxxx::List'.
    ...
    bdem_ConstTableBinding tableBinding(int         rowIndex,
        ...
        // field named 'columnName', and the field constrains a 'bdlmxxx::Table'.
    ...
    int enumerationAsInt(int rowIndex, const char *elementName) const;
        ...
        // 'bdltuxxx::Unset<int>::unsetValue()' if the element has an unset value.
        // The behavior is undefined unless '0 <= rowIndex < numRows()', this
...
class bdem_TableBinding: public bdem_ConstTableBinding {
    // This class binds a modifiable 'bdlmxxx::Table' ("table") to a non-modifiable
    // 'bdlmxxx::RecordDef' ("record"), and provides both by-name and indexed
  ...
  public:
    ...
    void rebind(bdlmxxx::Table *table, const bdlmxxx::RecordDef *record);
        // Reinitialize this table binding to bind the specified modifiable
        // 'table' to the specified non-modifiable 'record'.  The behavior is
        // undefined unless the 'table' data can satisfy the 'record'
        /// meta-data.
    ...
    int setEnumeration(int                 rowIndex,
        ...
        // type 'bdlmxxx::ElemType::BDEM_STRING', store the specified
    ...
    int setEnumeration(int         rowIndex,
        ...
        // Set the value of the enumeration element having the specified
        // 'rowIndex' and 'elementName' in this binding.  If the element is of
        // type 'bdlmxxx::ElemType::BDEM_INT', store the specified 'enumeratorId'
        // in the element.  If the element is of type
        // 'bdlmxxx::ElemType::BDEM_STRING, look up 'enumeratorId' in the element's
    ...
    // ACCESSORS
    bdlmxxx::Row& operator[](int rowIndex) const;
    ...
    bdlmxxx::ElemRef element(int rowIndex, const char *columnName) const;
        // Return an element reference that refers to the modifiable element at
    ...
    bsl::string& theModifiableString(int         rowIndex,
                                     const char *columnName) const;
    bdlt::Datetime& theModifiableDatetime(int         rowIndex,
                                         const char *columnName) const;
    bdlt::DatetimeTz& theModifiableDatetimeTz(int         rowIndex,
                                             const char *columnName) const;
    bdlt::Date& theModifiableDate(int rowIndex, const char *columnName) const;
    bdlt::DateTz& theModifiableDateTz(int         rowIndex,
                                     const char *columnName) const;
    bdlt::Time& theModifiableTime(int rowIndex, const char *columnName) const;
    bdlt::TimeTz& theModifiableTimeTz(int         rowIndex,
                                     const char *columnName) const;
    ...
    bsl::vector<bdlt::TimeTz>& theModifiableTimeTzArray(
                                                 int         rowIndex,
                                                 const char *columnName) const;
    bdlmxxx::Choice& theModifiableChoice(int         rowIndex,
                                     const char *columnName) const;
    bdlmxxx::ChoiceArray& theModifiableChoiceArray(int         rowIndex,
                                               const char *columnName) const;
    bdlmxxx::List& theModifiableList(int rowIndex, const char *columnName) const;
    bdlmxxx::Table& theModifiableTable(int rowIndex, const char *columnName) const;
    ...
    bdem_RowBinding rowBinding(int rowIndex, const char *columnName) const;
        ...
        // in the field named 'columnName' in this binding.  The behavior is
        // undefined unless '0 <= rowIndex < numRows()', this binding has a
        // field named 'columnName', and the field constrains a 'bdlmxxx::List'.
    ...
    bdem_TableBinding tableBinding(int rowIndex, const char *columnName) const;
        ...
        // unless '0 <= rowIndex < numRows()', this binding has a field named
        // 'columnName', and the field constrains a 'bdlmxxx::Table'.
...
class bdem_ConstColumnBinding {
    // This class binds a non-modifiable column in a 'bdlmxxx::Table' ("column") to
    // a non-modifiable 'bdlmxxx::FieldDef' ("field"), and provides indexed access
  ...
  private:
    ...
    const bdlmxxx::FieldDef *d_constraint_p;  // meta-data (held, not owned)
  ...
  private:
    ...
    // PRIVATE ACCESSORS
    bool canSatisfyColumn(const bdlmxxx::Table    *table,
                          int                  columnIndex,
  ...
  public:
    // CREATORS
    bdem_ConstColumnBinding(const bdlmxxx::Table    *table,
                            int                  columnIndex,
                            const bdlmxxx::FieldDef *field);
    ...
    // ACCESSORS
    bdlmxxx::ConstElemRef operator[](int rowIndex) const;
        // Return a "const" element reference that refers to the non-modifiable
        // element at the specified 'rowIndex' in this binding.  The behavior
        // is undefined unless '0 <= rowIndex < numRows()'.

    bdlmxxx::ConstElemRef element(int rowIndex) const;
        // Return a "const" element reference that refers to the non-modifiable
        // element at the specified 'rowIndex' in this binding.  The behavior
        // is undefined unless '0 <= rowIndex < numRows()'.

    bdlmxxx::ElemType::Type elemType() const;
        // Return the 'bdlmxxx::ElemType::Type' value of the elements in this
        // binding.
    ...
    const bdlmxxx::FieldDef& field() const;
    ...
    bdem_ConstTableBinding tableBinding(int rowIndex) const;
        ...
        // behavior is undefined unless '0 <= rowIndex < numRows()', and
        // the field constrains a 'bdlmxxx::Table'.
    ...
    int enumerationAsInt(int rowIndex) const;
        // Return the integer ID of the enumeration element at the specified
        // 'rowIndex' in this binding.  Return 'bdltuxxx::Unset<int>::unsetValue()'
        // if the element has an unset value.  The behavior is undefined unless
        // '0 <= rowIndex < numRows()', the type of the indexed element is
        // 'INT' or 'STRING', and the element is constrained by an enumeration
        // definition.
...
bool operator==(const bdem_ConstColumnBinding& lhs,
    ...
    // constraints as deemed by 'bdlmxxx::SchemaUtil::areEquivalent', and reference
...
bool operator!=(const bdem_ConstColumnBinding& lhs,
    ...
    // (non-null) constraints as deemed by 'bdlmxxx::SchemaUtil::areEquivalent', or
...
class bdem_ColumnBinding: public bdem_ConstColumnBinding {
    // This class binds a modifiable column in a 'bdlmxxx::Table' ("column") to a
    // non-modifiable 'bdlmxxx::FieldDef' ("field"), and provides indexed access
    // to the elements of the column (by-name access is not provided by column
    // bindings).  Indexed access is an efficient constant-time operation.
    // The column data must satisfy the field meta-data to ensure that this
    // binding can create valid row and table bindings ('rowBinding' and
  ...
  public:
    // CREATORS
    bdem_ColumnBinding(bdlmxxx::Table          *table,
                       int                  columnIndex,
                       const bdlmxxx::FieldDef *field);
    ...
    // ACCESSORS
    bdlmxxx::ElemRef operator[](int rowIndex) const;
        // Return an element reference that refers to the modifiable element at
    ...
    bdlmxxx::ElemRef element(int rowIndex) const;
        // Return an element reference that refers to the modifiable element at
        // the specified 'rowIndex' in this binding.  The behavior is undefined
        // unless '0 <= rowIndex < numRows()'.
    ...
    bdem_ChoiceBinding choiceBinding(int rowIndex) const;
        ...
        // constraint record held by the field bound by this binding.  The
        // behavior is undefined unless '0 <= rowIndex < numRows()', and
        // the field constrains a 'bdlmxxx::Choice'.
    ...
    bdem_RowBinding rowBinding(int rowIndex) const;
        ...
        // constraint record held by the field bound by this binding.  The
        // behavior is undefined unless '0 <= rowIndex < numRows()', and
        // the field constrains a 'bdlmxxx::List'.
...
namespace bdlmxxx {class ConstChoiceArrayItem;
...
class bdem_ConstChoiceBinding {
    // This class binds a non-modifiable 'bdlmxxx::ChoiceArrayItem' ("item") to a
    // non-modifiable 'bdlmxxx::RecordDef' ("record"), and provides access to the
  ...
  public:
    ...
    typedef bdem_ConstChoiceBinding      ChoiceBinding;
    typedef bdem_ConstChoiceArrayBinding ChoiceArrayBinding;
    typedef const bdlmxxx::Choice            Choice;

  private:
    // DATA
    const bdlmxxx::ChoiceArrayItem *d_item_p;        // data (held, not owned)
    const bdlmxxx::RecordDef       *d_constraint_p;  // meta-data (held, not owned)
  ...
  public:
    // CREATORS
    bdem_ConstChoiceBinding(const bdlmxxx::ChoiceArrayItem *item,
                            const bdlmxxx::RecordDef       *record);
    ...
    bdem_ConstChoiceBinding(const bdlmxxx::Choice    *choice,
                            const bdlmxxx::RecordDef *record);
        // Create a "const" choice binding that binds the specified
    ...
    bdem_ConstChoiceBinding(const bdlmxxx::ChoiceArray *choiceArray,
                            int                     choiceIndex,
                            const bdlmxxx::RecordDef   *record);
    ...
    void rebind(const bdlmxxx::ChoiceArrayItem *item);
    ...
    void rebind(const bdlmxxx::Choice *choice);
        // Reinitialize this choice binding to bind the specified
    ...
    void rebind(const bdlmxxx::ChoiceArray *choiceArray, int choiceIndex);
    ...
    void rebind(const bdlmxxx::Choice *choice, const bdlmxxx::RecordDef *record);
        // Reinitialize this choice binding to bind the specified
        // non-modifiable 'choice' to the specified non-modifiable 'record'.
        // The behavior is undefined unless the 'choice' data can satisfy the
        // 'record' meta-data.
    ...
    void rebind(const bdlmxxx::ChoiceArray *choiceArray,
                int                     choiceIndex,
                const bdlmxxx::RecordDef   *record);
    ...
    const bdlmxxx::ChoiceArrayItem& item() const;
    ...
    bdlmxxx::ElemType::Type selectionType(const char *elementName) const;
        // Return the 'bdlmxxx::ElemType::Type' value of the element having the
        // specified 'elementName' in this binding.  The behavior is undefined
        // unless this binding stores a field named 'elementName' in its
        // 'record'.

    bdlmxxx::ElemType::Type selectionType() const;
        // Return the 'bdlmxxx::ElemType::Type' value of the selection stored in
        // this binding or 'bdlmxxx::ElemType::BDEM_VOID' if no element is
    ...
    int selectorId() const;
        ...
        // 'bdlmxxx::RecordDef::BDEM_NULL_FIELD_ID' if no element is currently
        // selected.
    ...
    bdem_ConstChoiceBinding choiceBinding() const;
        ...
        // a 'bdlmxxx::Choice' and the choice array item satisfies the indexed
        // record.
    ...
    bdem_ConstChoiceArrayBinding choiceArrayBinding() const;
        ...
        // The behavior is undefined unless
        // '0 <= selector() < numSelections()', the indexed record constrains
        // a 'bdlmxxx::ChoiceArray' and the choice array satisfies the indexed
        // record.
    ...
    bdem_ConstRowBinding rowBinding() const;
        ...
        // The behavior is undefined unless
        // '0 <= selector() < numSelections()', the indexed record constrains
        // a 'bdlmxxx::List' and the row satisfies the indexed record.
    ...
    bdem_ConstTableBinding tableBinding() const;
        ...
        // The behavior is undefined unless
        // '0 <= selector() < numSelections()', the indexed record constrains
        // a 'bdlmxxx::Table' and the table satisfies the indexed record.
...
class bdem_ChoiceBinding : public bdem_ConstChoiceBinding {
    // This class binds a modifiable 'bdlmxxx::ChoiceArrayItem' ("item") to a
    // non-modifiable 'bdlmxxx::RecordDef' ("record"), and provides access to the
    // elements of the item.  This class also provides by-name and by-index
  ...
  public:
    // CREATORS
    bdem_ChoiceBinding(bdlmxxx::ChoiceArrayItem *item,
                       const bdlmxxx::RecordDef *record);
    ...
    bdem_ChoiceBinding(bdlmxxx::Choice          *choice,
                       const bdlmxxx::RecordDef *record);
        // Create a choice binding that binds the specified modifiable
    ...
    bdem_ChoiceBinding(bdlmxxx::ChoiceArray     *choiceArray,
                       int                   choiceIndex,
                       const bdlmxxx::RecordDef *record);
    ...
    void rebind(bdlmxxx::ChoiceArrayItem *item);
        // Reinitialize this choice binding to bind the specified
        // modifiable 'item' to the non-modifiable record already held
        // by this binding.  The behavior is undefined unless the 'item'
        // data can satisfy the record meta-data.

    void rebind(bdlmxxx::Choice *choice);
    ...
    void rebind(bdlmxxx::ChoiceArray *choiceArray, int choiceIndex);
    ...
    void rebind(bdlmxxx::ChoiceArrayItem *item, const bdlmxxx::RecordDef *record);
        // Reinitialize this choice binding to bind the specified
    ...
    void rebind(bdlmxxx::Choice *choice, const bdlmxxx::RecordDef *record);
        // Reinitialize this choice binding to bind the specified modifiable
        // 'choice' to the specified non-modifiable 'record'.  The behavior is
        // undefined unless the 'choice' data can satisfy the 'record'
        // meta-data.
    ...
    void rebind(bdlmxxx::ChoiceArray     *choiceArray,
                int                   choiceIndex,
                const bdlmxxx::RecordDef *record);
    ...
    bdlmxxx::ElemRef makeSelection(int newSelector);
    ...
    bdlmxxx::ElemRef makeSelection(const char *selectionName);
    ...
    bdem_ChoiceBinding choiceBinding() const;
        ...
        // record constrains a 'bdlmxxx::Choice' and the choice array item
    ...
    bdem_RowBinding rowBinding() const;
        ...
        // record constrains a 'bdlmxxx::List' and the row satisfies the indexed
        // record.
    ...
    bdem_TableBinding tableBinding() const;
        ...
        // 'bdlmxxx::Table' and the table satisfies the indexed record.
};
...
class bdem_ConstChoiceArrayBinding {
    // This class binds a non-modifiable 'bdlmxxx::ChoiceArray' ("choice array")
    // to a non-modifiable 'bdlmxxx::RecordDef' ("record"), and provides access to
  ...
  public:
    ...
    typedef bdem_ConstRowBinding          RowBinding;
    typedef bdem_ConstTableBinding        TableBinding;
    typedef const bdlmxxx::ChoiceArrayItem    Item;
    typedef const bdlmxxx::Choice             Choice;
    typedef const bdlmxxx::ChoiceArray        ChoiceArray;
    typedef const bdlmxxx::Row                Row;
    typedef const bdlmxxx::List               List;
    typedef const bdlmxxx::Table              Table;
  ...
  private:
    // DATA
    const bdlmxxx::ChoiceArray *d_choiceArray_p;  // data (held, not owned)
    const bdlmxxx::RecordDef   *d_constraint_p;   // meta-data (held, not owned)
  ...
  public:
    // CREATORS
    bdem_ConstChoiceArrayBinding(const bdlmxxx::ChoiceArray *choiceArray,
                                 const bdlmxxx::RecordDef   *record);
    ...
    // ACCESSORS
    const bdlmxxx::ChoiceArrayItem& operator[](int itemIndex) const;
    ...
    const bdlmxxx::ChoiceArray& choiceArray() const;
    ...
    bdlmxxx::ElemType::Type selectionType(int selectionIndex) const;
    ...
    const bdlt::Datetime& theDatetime(int itemIndex) const;
    const bdlt::DatetimeTz& theDatetimeTz(int itemIndex) const;
    const bdlt::Date& theDate(int itemIndex) const;
    const bdlt::DateTz& theDateTz(int itemIndex) const;
    const bdlt::Time& theTime(int itemIndex) const;
    const bdlt::TimeTz& theTimeTz(int itemIndex) const;
    ...
    const bsl::vector<bdlt::Datetime>& theDatetimeArray(int itemIndex) const;
    const bsl::vector<bdlt::DatetimeTz>& theDatetimeTzArray(
                                                          int itemIndex) const;
    const bsl::vector<bdlt::Date>& theDateArray(int itemIndex) const;
    const bsl::vector<bdlt::DateTz>& theDateTzArray(int itemIndex) const;
    const bsl::vector<bdlt::Time>& theTimeArray(int itemIndex) const;
    const bsl::vector<bdlt::TimeTz>& theTimeTzArray(int itemIndex) const;
    const bdlmxxx::Choice& theChoice(int itemIndex) const;
    const bdlmxxx::ChoiceArray& theChoiceArray(int itemIndex) const;
    const bdlmxxx::List& theList(int itemIndex) const;
    const bdlmxxx::Table& theTable(int itemIndex) const;
    ...
    bdem_ConstChoiceArrayBinding choiceArrayBinding(int itemIndex) const;
        ...
        // record constrains a 'bdlmxxx::Choice'.
    ...
    bdem_ConstRowBinding rowBinding(int itemIndex) const;
        ...
        // unless '0 <= selector(itemIndex) < numSelections()' and the indexed
        // record constrains a 'bdlmxxx::List'.
...
class bdem_ChoiceArrayBinding : public bdem_ConstChoiceArrayBinding {
    // This class binds a modifiable 'bdlmxxx::ChoiceArray' ("choice array")
    // to a non-modifiable 'bdlmxxx::RecordDef' ("record"), and provides access to
    // the 'choice array item's in the choice array.  This class also provides
    // by-name and by-index access to the selections of the stored 'choice
    // array item's of the underlying choice array.  For correct by-name
  ...
  public:
    ...
    typedef bdem_RowBinding          RowBinding;
    typedef bdem_TableBinding        TableBinding;
    typedef bdlmxxx::ChoiceArrayItem     Item;
    typedef bdlmxxx::Choice              Choice;
    typedef bdlmxxx::ChoiceArray         ChoiceArray;
    typedef bdlmxxx::Row                 Row;
    typedef bdlmxxx::List                List;
    typedef bdlmxxx::Table               Table;
  ...
  public:
    // CREATORS
    bdem_ChoiceArrayBinding(bdlmxxx::ChoiceArray     *choiceArray,
                            const bdlmxxx::RecordDef *record);
    ...
    void rebind(bdlmxxx::ChoiceArray *choiceArray, const bdlmxxx::RecordDef *record);
        // Reinitialize this choice array binding to bind the specified
    ...
    bdlmxxx::ElemRef makeSelection(int itemIndex, int newSelector);
    ...
    // TBD makeSelection using Id
    bdlmxxx::ElemRef makeSelection(int itemIndex, const char *selectionName);
        // For the choice array item stored at the specified 'itemIndex', if
    ...
    // ACCESSORS
    bdlmxxx::ChoiceArrayItem& operator[](int itemIndex) const;
    ...
    bdlmxxx::ChoiceArray& choiceArray() const;
        // Return a reference to the modifiable choice array held by this
        // binding.

    bdlmxxx::ElemRef selection(int itemIndex) const;
    ...
    bdlmxxx::ChoiceArrayItem& theModifiableItem(int itemIndex) const;
        // Return a reference to the modifiable choice array item at the
    ...
    bdlt::Datetime& theModifiableDatetime(int itemIndex) const;
    bdlt::DatetimeTz& theModifiableDatetimeTz(int itemIndex) const;
    bdlt::Date& theModifiableDate(int itemIndex) const;
    bdlt::DateTz& theModifiableDateTz(int itemIndex) const;
    bdlt::Time& theModifiableTime(int itemIndex) const;
    bdlt::TimeTz& theModifiableTimeTz(int itemIndex) const;
    ...
    bsl::vector<bdlt::DatetimeTz>& theModifiableDatetimeTzArray(
                                                          int itemIndex) const;
    bsl::vector<bdlt::Date>& theModifiableDateArray(int itemIndex) const;
    bsl::vector<bdlt::DateTz>& theModifiableDateTzArray(int itemIndex) const;
    bsl::vector<bdlt::Time>& theModifiableTimeArray(int itemIndex) const;
    bsl::vector<bdlt::TimeTz>& theModifiableTimeTzArray(int itemIndex) const;
    bdlmxxx::Choice& theModifiableChoice(int itemIndex) const;
    bdlmxxx::ChoiceArray& theModifiableChoiceArray(int itemIndex) const;
    bdlmxxx::List& theModifiableList(int itemIndex) const;
    bdlmxxx::Table& theModifiableTable(int itemIndex) const;
...
// CREATORS
inline
bdem_ConstRowBinding::bdem_ConstRowBinding(const bdlmxxx::Row       *row,
                                           const bdlmxxx::RecordDef *record)
: d_row_p(row)
, d_constraint_p(record)
{
    ...
    BSLS_ASSERT_SAFE(bdlmxxx::SchemaAggregateUtil::canSatisfyRecord(*row,
                                                                *record));
}
...
, d_constraint_p(0)
{
    ...
    BSLS_ASSERT_SAFE(bdlmxxx::SchemaAggregateUtil::canSatisfyRecord(
                                                             *row,
                                                             *d_constraint_p));
}
...
inline
bdem_ConstRowBinding::bdem_ConstRowBinding(const bdlmxxx::List      *list,
                                           const bdlmxxx::RecordDef *record)
: d_row_p(0)
, d_constraint_p(record)
{
    ...
    BSLS_ASSERT_SAFE(bdlmxxx::SchemaAggregateUtil::canSatisfyRecord(*d_row_p,
                                                                *record));
}
...
inline
bdem_ConstRowBinding::bdem_ConstRowBinding(const bdlmxxx::Table     *table,
                                           int                   rowIndex,
                                           const bdlmxxx::RecordDef *record)
: d_row_p(0)
, d_constraint_p(record)
{
    ...
    BSLS_ASSERT_SAFE(record);
    BSLS_ASSERT_SAFE(bdlmxxx::SchemaAggregateUtil::canSatisfyRecord(*table,
                                                                *record));
...
inline
void bdem_ConstRowBinding::rebind(const bdlmxxx::Row *row)
{
    BSLS_ASSERT_SAFE(row);
    BSLS_ASSERT_SAFE(bdlmxxx::SchemaAggregateUtil::canSatisfyRecord(
                                                             *row,
...
inline
void bdem_ConstRowBinding::rebind(const bdlmxxx::List *list)
{
    BSLS_ASSERT_SAFE(list);
...
inline
void bdem_ConstRowBinding::rebind(const bdlmxxx::Table *table, int rowIndex)
{
    BSLS_ASSERT_SAFE(table);
    BSLS_ASSERT_SAFE(0 <= rowIndex);
    BSLS_ASSERT_SAFE(     rowIndex < table->numRows());
...
inline
void bdem_ConstRowBinding::rebind(const bdlmxxx::Table     *table,
                                  int                   rowIndex,
                                  const bdlmxxx::RecordDef *record)
{
    BSLS_ASSERT_SAFE(table);
...
// ACCESSORS
inline
bdlmxxx::ConstElemRef bdem_ConstRowBinding::operator[](int index) const
{
...
inline
bdlmxxx::ConstElemRef bdem_ConstRowBinding::element(const char *elementName) const
{
...
inline
bdlmxxx::ConstElemRef bdem_ConstRowBinding::element(int index) const
{
    BSLS_ASSERT_SAFE(0 <= index);
    BSLS_ASSERT_SAFE(     index < d_row_p->length());
...
inline
bdlmxxx::ElemType::Type bdem_ConstRowBinding::elemType(
                                                 const char *elementName) const
{
    BSLS_ASSERT_SAFE(elementName);
...
inline
bdlmxxx::ElemType::Type bdem_ConstRowBinding::elemType(int index) const
{
    BSLS_ASSERT_SAFE(0 <= index);
    BSLS_ASSERT_SAFE(     index < d_row_p->length());
...
inline
const bdlmxxx::RecordDef& bdem_ConstRowBinding::record() const
{
    return *d_constraint_p;
}

inline
const bdlmxxx::Row& bdem_ConstRowBinding::row() const
{
    return *d_row_p;
}
...
const bool& bdem_ConstRowBinding::theBool(const char *elementName) const
{
    ...
    BSLS_ASSERT_SAFE(0 <= fieldIndex);
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_BOOL == elemType(fieldIndex));
...
const char& bdem_ConstRowBinding::theChar(const char *elementName) const
{
    ...
    BSLS_ASSERT_SAFE(0 <= fieldIndex);
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_CHAR == elemType(fieldIndex));
...
const short& bdem_ConstRowBinding::theShort(const char *elementName) const
{
    ...
    BSLS_ASSERT_SAFE(0 <= fieldIndex);
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_SHORT == elemType(fieldIndex));
...
const int& bdem_ConstRowBinding::theInt(const char *elementName) const
{
    ...
    BSLS_ASSERT_SAFE(0 <= fieldIndex);
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_INT == elemType(fieldIndex));
...
bdem_ConstRowBinding::theInt64(const char *elementName) const
{
    ...
    BSLS_ASSERT_SAFE(0 <= fieldIndex);
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_INT64 == elemType(fieldIndex));
...
const float& bdem_ConstRowBinding::theFloat(const char *elementName) const
{
    ...
    BSLS_ASSERT_SAFE(0 <= fieldIndex);
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_FLOAT == elemType(fieldIndex));
...
const double& bdem_ConstRowBinding::theDouble(const char *elementName) const
{
    ...
    BSLS_ASSERT_SAFE(0 <= fieldIndex);
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_DOUBLE == elemType(fieldIndex));
...
bdem_ConstRowBinding::theString(const char *elementName) const
{
    ...
    BSLS_ASSERT_SAFE(0 <= fieldIndex);
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_STRING == elemType(fieldIndex));
...
bdem_ConstRowBinding::theDatetime(const char *elementName) const
{
    ...
    BSLS_ASSERT_SAFE(0 <= fieldIndex);
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_DATETIME == elemType(fieldIndex));
...
bdem_ConstRowBinding::theDatetimeTz(const char *elementName) const
{
    ...
    BSLS_ASSERT_SAFE(0 <= fieldIndex);
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_DATETIMETZ == elemType(fieldIndex));

    return d_row_p->theDatetimeTz(fieldIndex);
}

inline
const bdlt::Date& bdem_ConstRowBinding::theDate(const char *elementName) const
{
    BSLS_ASSERT_SAFE(elementName);
    ...
    BSLS_ASSERT_SAFE(0 <= fieldIndex);
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_DATE == elemType(fieldIndex));
...
bdem_ConstRowBinding::theDateTz(const char *elementName) const
{
    ...
    BSLS_ASSERT_SAFE(0 <= fieldIndex);
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_DATETZ == elemType(fieldIndex));

    return d_row_p->theDateTz(fieldIndex);
}

inline
const bdlt::Time& bdem_ConstRowBinding::theTime(const char *elementName) const
{
    BSLS_ASSERT_SAFE(elementName);
    ...
    BSLS_ASSERT_SAFE(0 <= fieldIndex);
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_TIME == elemType(fieldIndex));
...
bdem_ConstRowBinding::theTimeTz(const char *elementName) const
{
    ...
    BSLS_ASSERT_SAFE(0 <= fieldIndex);
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_TIMETZ == elemType(fieldIndex));
...
bdem_ConstRowBinding::theBoolArray(const char *elementName) const
{
    ...
    BSLS_ASSERT_SAFE(0 <= fieldIndex);
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_BOOL_ARRAY == elemType(fieldIndex));
...
bdem_ConstRowBinding::theCharArray(const char *elementName) const
{
    ...
    BSLS_ASSERT_SAFE(0 <= fieldIndex);
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_CHAR_ARRAY == elemType(fieldIndex));
...
bdem_ConstRowBinding::theShortArray(const char *elementName) const
{
    ...
    BSLS_ASSERT_SAFE(0 <= fieldIndex);
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_SHORT_ARRAY == elemType(fieldIndex));
...
bdem_ConstRowBinding::theIntArray(const char *elementName) const
{
    ...
    BSLS_ASSERT_SAFE(0 <= fieldIndex);
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_INT_ARRAY == elemType(fieldIndex));
...
bdem_ConstRowBinding::theInt64Array(const char *elementName) const
{
    ...
    BSLS_ASSERT_SAFE(0 <= fieldIndex);
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_INT64_ARRAY == elemType(fieldIndex));
...
bdem_ConstRowBinding::theFloatArray(const char *elementName) const
{
    ...
    BSLS_ASSERT_SAFE(0 <= fieldIndex);
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_FLOAT_ARRAY == elemType(fieldIndex));
...
bdem_ConstRowBinding::theDoubleArray(const char *elementName) const
{
    ...
    BSLS_ASSERT_SAFE(0 <= fieldIndex);
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_DOUBLE_ARRAY == elemType(fieldIndex));
...
bdem_ConstRowBinding::theStringArray(const char *elementName) const
{
    ...
    BSLS_ASSERT_SAFE(0 <= fieldIndex);
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_STRING_ARRAY == elemType(fieldIndex));
...
bdem_ConstRowBinding::theDatetimeArray(const char *elementName) const
{
    ...
    BSLS_ASSERT_SAFE(0 <= fieldIndex);
    BSLS_ASSERT_SAFE(
                   bdlmxxx::ElemType::BDEM_DATETIME_ARRAY == elemType(fieldIndex));
...
bdem_ConstRowBinding::theDatetimeTzArray(const char *elementName) const
{
    ...
    BSLS_ASSERT_SAFE(0 <= fieldIndex);
    BSLS_ASSERT_SAFE(
                 bdlmxxx::ElemType::BDEM_DATETIMETZ_ARRAY == elemType(fieldIndex));
...
bdem_ConstRowBinding::theDateArray(const char *elementName) const
{
    ...
    BSLS_ASSERT_SAFE(0 <= fieldIndex);
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_DATE_ARRAY == elemType(fieldIndex));
...
bdem_ConstRowBinding::theDateTzArray(const char *elementName) const
{
    ...
    BSLS_ASSERT_SAFE(0 <= fieldIndex);
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_DATETZ_ARRAY == elemType(fieldIndex));
...
bdem_ConstRowBinding::theTimeArray(const char *elementName) const
{
    ...
    BSLS_ASSERT_SAFE(0 <= fieldIndex);
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_TIME_ARRAY == elemType(fieldIndex));
...
bdem_ConstRowBinding::theTimeTzArray(const char *elementName) const
{
    ...
    BSLS_ASSERT_SAFE(0 <= fieldIndex);
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_TIMETZ_ARRAY == elemType(fieldIndex));

    return d_row_p->theTimeTzArray(fieldIndex);
}

inline
const bdlmxxx::Choice&
bdem_ConstRowBinding::theChoice(const char *elementName) const
{
    ...
    BSLS_ASSERT_SAFE(0 <= fieldIndex);
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_CHOICE == elemType(fieldIndex));

    return d_row_p->theChoice(fieldIndex);
}

inline
const bdlmxxx::ChoiceArray&
bdem_ConstRowBinding::theChoiceArray(const char *elementName) const
{
    ...
    BSLS_ASSERT_SAFE(0 <= fieldIndex);
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_CHOICE_ARRAY == elemType(fieldIndex));

    return d_row_p->theChoiceArray(fieldIndex);
}

inline
const bdlmxxx::List& bdem_ConstRowBinding::theList(const char *elementName) const
{
    BSLS_ASSERT_SAFE(elementName);
    ...
    BSLS_ASSERT_SAFE(0 <= fieldIndex);
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_LIST == elemType(fieldIndex));
...
bdem_ConstRowBinding::theTable(const char *elementName) const
{
    ...
    BSLS_ASSERT_SAFE(0 <= fieldIndex);
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_TABLE == elemType(fieldIndex));
...
bdem_ConstChoiceBinding bdem_ConstRowBinding::choiceBinding(int index) const
{
    BSLS_ASSERT_SAFE(0 <= index);
    BSLS_ASSERT_SAFE(     index < d_row_p->length());
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_CHOICE == elemType(index));
...
bdem_ConstRowBinding::choiceArrayBinding(int index) const
{
    BSLS_ASSERT_SAFE(0 <= index);
    BSLS_ASSERT_SAFE(     index < d_row_p->length());
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_CHOICE_ARRAY == elemType(index));
...
bdem_ConstRowBinding bdem_ConstRowBinding::rowBinding(int index) const
{
    BSLS_ASSERT_SAFE(0 <= index);
    BSLS_ASSERT_SAFE(     index < d_row_p->length());
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_LIST == elemType(index));
...
bdem_ConstTableBinding bdem_ConstRowBinding::tableBinding(int index) const
{
    BSLS_ASSERT_SAFE(0 <= index);
    BSLS_ASSERT_SAFE(     index < d_row_p->length());
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_TABLE == elemType(index));
...
bool operator==(const bdem_ConstRowBinding& lhs,
                const bdem_ConstRowBinding& rhs)
{
    return bdlmxxx::SchemaUtil::areEquivalent(*lhs.d_constraint_p,
                                          *rhs.d_constraint_p)
...
// ACCESSORS
inline
bdlmxxx::Row& bdem_RowBinding::row() const
{
    return *const_cast<bdlmxxx::Row *>(d_row_p);
}

// CREATORS
inline
bdem_RowBinding::bdem_RowBinding(bdlmxxx::Row *row, const bdlmxxx::RecordDef *record)
: bdem_ConstRowBinding(row, record)
{
}

inline
bdem_RowBinding::bdem_RowBinding(bdlmxxx::Row          *row,
                                 const bdlmxxx::Schema *schema,
                                 const char        *recordName)
...
inline
bdem_RowBinding::bdem_RowBinding(bdlmxxx::List *list, const bdlmxxx::RecordDef *record)
: bdem_ConstRowBinding(list, record)
{
}

inline
bdem_RowBinding::bdem_RowBinding(bdlmxxx::List         *list,
                                 const bdlmxxx::Schema *schema,
                                 const char        *recordName)
...
inline
bdem_RowBinding::bdem_RowBinding(bdlmxxx::Table           *table,
                                 int                   rowIndex,
                                 const bdlmxxx::RecordDef *record)
...
inline
void bdem_RowBinding::rebind(bdlmxxx::Row *row)
{
    bdem_ConstRowBinding::rebind(row);
}

inline
void bdem_RowBinding::rebind(bdlmxxx::List *list)
{
    bdem_ConstRowBinding::rebind(list);
}

inline
void bdem_RowBinding::rebind(bdlmxxx::Table *table, int rowIndex)
{
    bdem_ConstRowBinding::rebind(table, rowIndex);
}

inline
void bdem_RowBinding::rebind(bdlmxxx::Row *row, const bdlmxxx::RecordDef *record)
{
...
inline
void bdem_RowBinding::rebind(bdlmxxx::List *list, const bdlmxxx::RecordDef *record)
{
...
inline
void bdem_RowBinding::rebind(bdlmxxx::Table           *table,
                             int                   rowIndex,
                             const bdlmxxx::RecordDef *record)
{
...
// ACCESSORS
inline
bdlmxxx::ElemRef bdem_RowBinding::operator[](int index) const
{
    BSLS_ASSERT_SAFE(0 <= index);
    BSLS_ASSERT_SAFE(     index < d_row_p->length());
...
inline
bdlmxxx::ElemRef bdem_RowBinding::element(int index) const
{
    BSLS_ASSERT_SAFE(0 <= index);
    BSLS_ASSERT_SAFE(     index < d_row_p->length());
...
inline
bdlmxxx::ElemRef bdem_RowBinding::element(const char *elementName) const
{
    BSLS_ASSERT_SAFE(elementName);
...
inline
bdlt::Date& bdem_RowBinding::theModifiableDate(const char *elementName) const
{
    BSLS_ASSERT_SAFE(elementName);
...
inline
bdlt::DateTz& bdem_RowBinding::theModifiableDateTz(
                                                 const char *elementName) const
{
    BSLS_ASSERT_SAFE(elementName);
...
inline
bdlt::Time& bdem_RowBinding::theModifiableTime(const char *elementName) const
{
    BSLS_ASSERT_SAFE(elementName);
...
inline
bdlt::TimeTz& bdem_RowBinding::theModifiableTimeTz(
                                                 const char *elementName) const
{
    BSLS_ASSERT_SAFE(elementName);
...
inline
bdlmxxx::Choice& bdem_RowBinding::theModifiableChoice(
                                                 const char *elementName) const
{
    BSLS_ASSERT_SAFE(elementName);
...
inline
bdlmxxx::List& bdem_RowBinding::theModifiableList(const char *elementName) const
{
    BSLS_ASSERT_SAFE(elementName);
...
// CREATORS
inline
bdem_ConstTableBinding::bdem_ConstTableBinding(const bdlmxxx::Table     *table,
                                               const bdlmxxx::RecordDef *record)
: d_table_p(table)
, d_constraint_p(record)
{
...
inline
void bdem_ConstTableBinding::rebind(const bdlmxxx::Table *table)
{
    BSLS_ASSERT_SAFE(table);
    BSLS_ASSERT_SAFE(bdlmxxx::SchemaAggregateUtil::canSatisfyRecord(
                                                             *table,
...
// ACCESSORS
inline
const bdlmxxx::Row& bdem_ConstTableBinding::operator[](int rowIndex) const
{
    BSLS_ASSERT_SAFE(0 <= rowIndex);
...
inline
bdlmxxx::ConstElemRef bdem_ConstTableBinding::element(int rowIndex,
                                                  int columnIndex) const
{
    BSLS_ASSERT_SAFE(0 <= rowIndex);
    BSLS_ASSERT_SAFE(     rowIndex    < d_table_p->numRows());
...
bdem_ConstTableBinding::elemType(const char *columnName) const
{
    ...
    const bdlmxxx::FieldDef *fieldDef = d_constraint_p->lookupField(columnName);
...
inline
bdlmxxx::ElemType::Type bdem_ConstTableBinding::elemType(int columnIndex) const
{
    BSLS_ASSERT_SAFE(0 <= columnIndex);
    BSLS_ASSERT_SAFE(     columnIndex < d_table_p->numColumns());
...
inline
const bdlmxxx::RecordDef& bdem_ConstTableBinding::record() const
{
    return *d_constraint_p;
}

inline
const bdlmxxx::Table& bdem_ConstTableBinding::table() const
{
    return *d_table_p;
}
...
bdem_ConstTableBinding::choiceBinding(int rowIndex, int columnIndex) const
{
    ...
    BSLS_ASSERT_SAFE(0 <= columnIndex);
    BSLS_ASSERT_SAFE(     columnIndex < d_table_p->numColumns());
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_CHOICE == elemType(columnIndex));
...
bdem_ConstTableBinding::choiceArrayBinding(int rowIndex, int columnIndex) const
{
    ...
    BSLS_ASSERT_SAFE(     columnIndex < d_table_p->numColumns());
    BSLS_ASSERT_SAFE(
                    bdlmxxx::ElemType::BDEM_CHOICE_ARRAY == elemType(columnIndex));
                                                        ...
                                                        int columnIndex) const
{
    ...
    BSLS_ASSERT_SAFE(0 <= columnIndex);
    BSLS_ASSERT_SAFE(     columnIndex < d_table_p->numColumns());
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_LIST == elemType(columnIndex));
...
bdem_ConstTableBinding::tableBinding(int rowIndex, int columnIndex) const
{
    ...
    BSLS_ASSERT_SAFE(0 <= columnIndex);
    BSLS_ASSERT_SAFE(     columnIndex < d_table_p->numColumns());
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_TABLE == elemType(columnIndex));
...
// ACCESSORS
inline
bdlmxxx::Table& bdem_TableBinding::table() const
{
    return *const_cast<bdlmxxx::Table *>(d_table_p);
}

// CREATORS
inline
bdem_TableBinding::bdem_TableBinding(bdlmxxx::Table           *table,
                                     const bdlmxxx::RecordDef *record)
...
inline
void bdem_TableBinding::rebind(bdlmxxx::Table *table)
{
    bdem_ConstTableBinding::rebind(table);
}

inline
void bdem_TableBinding::rebind(bdlmxxx::Table *table, const bdlmxxx::RecordDef *record)
{
...
// ACCESSORS
inline
bdlmxxx::Row& bdem_TableBinding::operator[](int rowIndex) const
{
    BSLS_ASSERT_SAFE(0 <= rowIndex);
    BSLS_ASSERT_SAFE(     rowIndex < d_table_p->numRows());
...
inline
bdlmxxx::ElemRef bdem_TableBinding::element(int rowIndex, int columnIndex) const
{
    BSLS_ASSERT_SAFE(0 <= rowIndex);
    BSLS_ASSERT_SAFE(     rowIndex    < d_table_p->numRows());
    BSLS_ASSERT_SAFE(0 <= columnIndex);
...
inline
bdlmxxx::Row& bdem_TableBinding::theModifiableRow(int rowIndex) const
{
    BSLS_ASSERT_SAFE(0 <= rowIndex);
    BSLS_ASSERT_SAFE(     rowIndex < d_table_p->numRows());
...
inline
bdlmxxx::List& bdem_TableBinding::theModifiableList(int         rowIndex,
                                                const char *columnName) const
{
    BSLS_ASSERT_SAFE(0 <= rowIndex);
    BSLS_ASSERT_SAFE(     rowIndex < d_table_p->numRows());
...
inline
bdlmxxx::Table& bdem_TableBinding::theModifiableTable(int         rowIndex,
                                                  const char *columnName) const
{
    BSLS_ASSERT_SAFE(0 <= rowIndex);
    BSLS_ASSERT_SAFE(     rowIndex < d_table_p->numRows());
...
inline
void bdem_ConstColumnBinding::rebind(const bdlmxxx::Table    *table,
                                     int                  columnIndex,
                                     const bdlmxxx::FieldDef *field)
{
    BSLS_ASSERT_SAFE(table);
...
// ACCESSORS
inline
bdlmxxx::ConstElemRef bdem_ConstColumnBinding::operator[](int rowIndex) const
{
    BSLS_ASSERT_SAFE(0 <= rowIndex);
    BSLS_ASSERT_SAFE(     rowIndex < d_table_p->numRows());
...
inline
bdlmxxx::ConstElemRef bdem_ConstColumnBinding::element(int rowIndex) const
{
    BSLS_ASSERT_SAFE(0 <= rowIndex);
    BSLS_ASSERT_SAFE(     rowIndex < d_table_p->numRows());
...
inline
bdlmxxx::ElemType::Type bdem_ConstColumnBinding::elemType() const
{
...
inline
const bdlmxxx::FieldDef& bdem_ConstColumnBinding::field() const
{
    return *d_constraint_p;
}

inline
const bdlmxxx::Table& bdem_ConstColumnBinding::table() const
{
    return *d_table_p;
}
...
bdem_ConstColumnBinding::choiceBinding(int rowIndex) const
{
    BSLS_ASSERT_SAFE(0 <= rowIndex);
    BSLS_ASSERT_SAFE(     rowIndex < d_table_p->numRows());
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_CHOICE == elemType());
...
bdem_ConstColumnBinding::choiceArrayBinding(int rowIndex) const
{
    BSLS_ASSERT_SAFE(0 <= rowIndex);
    BSLS_ASSERT_SAFE(     rowIndex < d_table_p->numRows());
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_CHOICE_ARRAY == elemType());
...
bdem_ConstRowBinding bdem_ConstColumnBinding::rowBinding(int rowIndex) const
{
    BSLS_ASSERT_SAFE(0 <= rowIndex);
    BSLS_ASSERT_SAFE(     rowIndex < d_table_p->numRows());
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_LIST == elemType());
...
bdem_ConstColumnBinding::tableBinding(int rowIndex) const
{
    BSLS_ASSERT_SAFE(0 <= rowIndex);
    BSLS_ASSERT_SAFE(     rowIndex < d_table_p->numRows());
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_TABLE == elemType());
...
// ACCESSORS
inline
bdlmxxx::Table& bdem_ColumnBinding::table() const
{
    return *const_cast<bdlmxxx::Table *>(d_table_p);
}
...
// CREATORS
inline
bdem_ColumnBinding::bdem_ColumnBinding(bdlmxxx::Table          *table,
                                       int                  columnIndex,
                                       const bdlmxxx::FieldDef *field)
...
inline
void bdem_ColumnBinding::rebind(bdlmxxx::Table          *table,
                                int                  columnIndex,
                                const bdlmxxx::FieldDef *field)
{
...
// ACCESSORS
inline
bdlmxxx::ElemRef bdem_ColumnBinding::operator[](int rowIndex) const
{
    BSLS_ASSERT_SAFE(0 <= rowIndex);
    BSLS_ASSERT_SAFE(     rowIndex < d_table_p->numRows());
...
inline
bdlmxxx::ElemRef bdem_ColumnBinding::element(int rowIndex) const
{
    BSLS_ASSERT_SAFE(0 <= rowIndex);
    BSLS_ASSERT_SAFE(     rowIndex < d_table_p->numRows());
...
, d_constraint_p(record)
{
    ...
    BSLS_ASSERT_SAFE(record);
    BSLS_ASSERT_SAFE(bdlmxxx::SchemaAggregateUtil::canSatisfyRecord(*item,
                                                                *record));
}
...
inline
bdem_ConstChoiceBinding::bdem_ConstChoiceBinding(const bdlmxxx::Choice    *choice,
                                                 const bdlmxxx::RecordDef *record)
: d_item_p(0)
, d_constraint_p(record)
{
...
inline
bdem_ConstChoiceBinding::bdem_ConstChoiceBinding(
                                           const bdlmxxx::ChoiceArray *choiceArray,
                                           int                     choiceIndex,
                                           const bdlmxxx::RecordDef   *record)
: d_item_p(0)
, d_constraint_p(record)
...
inline
void bdem_ConstChoiceBinding::rebind(const bdlmxxx::ChoiceArrayItem *item)
{
    BSLS_ASSERT_SAFE(item);
    BSLS_ASSERT_SAFE(bdlmxxx::SchemaAggregateUtil::canSatisfyRecord(
                                                             *item,
...
inline
void bdem_ConstChoiceBinding::rebind(const bdlmxxx::Choice *choice)
{
    BSLS_ASSERT_SAFE(choice);
    BSLS_ASSERT_SAFE(bdlmxxx::SchemaAggregateUtil::canSatisfyRecord(
                                                             choice->item(),
...
inline
void bdem_ConstChoiceBinding::rebind(const bdlmxxx::ChoiceArray *choiceArray,
                                     int                     choiceIndex)
{
    BSLS_ASSERT_SAFE(choiceArray);
    BSLS_ASSERT_SAFE(0 <= choiceIndex);
                                     ...
                                     const bdlmxxx::RecordDef *record)
{
    BSLS_ASSERT_SAFE(choice);
    BSLS_ASSERT_SAFE(record);
    BSLS_ASSERT_SAFE(bdlmxxx::SchemaAggregateUtil::canSatisfyRecord(choice->item(),
                                                                *record));
...
inline
const bdlmxxx::ChoiceArrayItem& bdem_ConstChoiceBinding::item() const
{
    return *d_item_p;
}

inline
const bdlmxxx::RecordDef& bdem_ConstChoiceBinding::record() const
{
    return *d_constraint_p;
}

inline
bdlmxxx::ConstElemRef bdem_ConstChoiceBinding::selection() const
{
    return d_item_p->selection();
}

inline
bdlmxxx::ElemType::Type bdem_ConstChoiceBinding::selectionType(int index) const
{
    BSLS_ASSERT_SAFE(0 <= index);
...
bdem_ConstChoiceBinding::selectionType(const char *selectionName) const
{
    ...
    const bdlmxxx::FieldDef *fieldDef = d_constraint_p->lookupField(selectionName);
...
inline
bdlmxxx::ElemType::Type bdem_ConstChoiceBinding::selectionType() const
{
...
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_BOOL == selectionType());
...
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_CHAR == selectionType());
...
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_SHORT == selectionType());
...
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_INT == selectionType());
...
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_INT64 == selectionType());
...
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_FLOAT == selectionType());
...
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_DOUBLE == selectionType());
...
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_STRING == selectionType());

    return d_item_p->theString();
}

inline
const bdlt::Datetime& bdem_ConstChoiceBinding::theDatetime() const
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_DATETIME == selectionType());

    return d_item_p->theDatetime();
}

inline
const bdlt::DatetimeTz& bdem_ConstChoiceBinding::theDatetimeTz() const
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_DATETIMETZ == selectionType());

    return d_item_p->theDatetimeTz();
}

inline
const bdlt::Date& bdem_ConstChoiceBinding::theDate() const
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_DATE == selectionType());

    return d_item_p->theDate();
}

inline
const bdlt::DateTz& bdem_ConstChoiceBinding::theDateTz() const
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_DATETZ == selectionType());

    return d_item_p->theDateTz();
}

inline
const bdlt::Time& bdem_ConstChoiceBinding::theTime() const
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_TIME == selectionType());

    return d_item_p->theTime();
}

inline
const bdlt::TimeTz& bdem_ConstChoiceBinding::theTimeTz() const
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_TIMETZ == selectionType());
...
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_BOOL_ARRAY == selectionType());
...
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_CHAR_ARRAY == selectionType());
...
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_SHORT_ARRAY == selectionType());
...
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_INT_ARRAY == selectionType());
...
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_INT64_ARRAY == selectionType());
...
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_FLOAT_ARRAY == selectionType());
...
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_DOUBLE_ARRAY == selectionType());
...
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_STRING_ARRAY == selectionType());
...
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_DATETIME_ARRAY == selectionType());
...
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_DATETIMETZ_ARRAY == selectionType());

    return d_item_p->theDatetimeTzArray();
}

inline
const bsl::vector<bdlt::Date>& bdem_ConstChoiceBinding::theDateArray() const
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_DATE_ARRAY == selectionType());

    return d_item_p->theDateArray();
}

inline
const bsl::vector<bdlt::DateTz>& bdem_ConstChoiceBinding::theDateTzArray() const
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_DATETZ_ARRAY == selectionType());

    return d_item_p->theDateTzArray();
}

inline
const bsl::vector<bdlt::Time>& bdem_ConstChoiceBinding::theTimeArray() const
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_TIME_ARRAY == selectionType());

    return d_item_p->theTimeArray();
}

inline
const bsl::vector<bdlt::TimeTz>& bdem_ConstChoiceBinding::theTimeTzArray() const
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_TIMETZ_ARRAY == selectionType());

    return d_item_p->theTimeTzArray();
}

inline
const bdlmxxx::Choice& bdem_ConstChoiceBinding::theChoice() const
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_CHOICE == selectionType());

    return d_item_p->theChoice();
}

inline
const bdlmxxx::ChoiceArray& bdem_ConstChoiceBinding::theChoiceArray() const
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_CHOICE_ARRAY == selectionType());

    return d_item_p->theChoiceArray();
}

inline
const bdlmxxx::List& bdem_ConstChoiceBinding::theList() const
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_LIST == selectionType());

    return d_item_p->theList();
}

inline
const bdlmxxx::Table& bdem_ConstChoiceBinding::theTable() const
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_TABLE == selectionType());
...
// ACCESSORS
inline
bdlmxxx::ChoiceArrayItem& bdem_ChoiceBinding::item() const
{
    return *const_cast<bdlmxxx::ChoiceArrayItem *>(d_item_p);
}

// CREATORS
inline
bdem_ChoiceBinding::bdem_ChoiceBinding(bdlmxxx::ChoiceArrayItem *item,
                                       const bdlmxxx::RecordDef *record)
...
inline
bdem_ChoiceBinding::bdem_ChoiceBinding(bdlmxxx::Choice          *choice,
                                       const bdlmxxx::RecordDef *record)
...
inline
bdem_ChoiceBinding::bdem_ChoiceBinding(bdlmxxx::ChoiceArray     *choiceArray,
                                       int                   choiceIndex,
                                       const bdlmxxx::RecordDef *record)
...
inline
void bdem_ChoiceBinding::rebind(bdlmxxx::ChoiceArrayItem *item)
{
    bdem_ConstChoiceBinding::rebind(item);
}

inline
void bdem_ChoiceBinding::rebind(bdlmxxx::Choice *choice)
{
    bdem_ConstChoiceBinding::rebind(choice);
}

inline
void bdem_ChoiceBinding::rebind(bdlmxxx::ChoiceArray *choiceArray,
                                int               choiceIndex)
{
...
inline
bdlmxxx::ElemRef bdem_ChoiceBinding::makeSelection(int newSelector)
{
...
inline
bdlmxxx::ElemRef bdem_ChoiceBinding::makeSelection(const char *selectionName)
{
    BSLS_ASSERT_SAFE(selectionName);
...
// ACCESSORS
inline
bdlmxxx::ElemRef bdem_ChoiceBinding::selection() const
{
...
inline
bdlt::Datetime& bdem_ChoiceBinding::theModifiableDatetime() const
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_DATETIME == selectionType());
...
inline
bdlt::DatetimeTz& bdem_ChoiceBinding::theModifiableDatetimeTz() const
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_DATETIMETZ == selectionType());
...
inline
bdlt::Date& bdem_ChoiceBinding::theModifiableDate() const
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_DATE == selectionType());
...
inline
bdlt::DateTz& bdem_ChoiceBinding::theModifiableDateTz() const
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_DATETZ == selectionType());
...
inline
bdlt::Time& bdem_ChoiceBinding::theModifiableTime() const
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_TIME == selectionType());
...
inline
bdlt::TimeTz& bdem_ChoiceBinding::theModifiableTimeTz() const
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_TIMETZ == selectionType());
...
inline
bsl::vector<bdlt::Date>& bdem_ChoiceBinding::theModifiableDateArray() const
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_DATE_ARRAY == selectionType());
...
inline
bsl::vector<bdlt::DateTz>& bdem_ChoiceBinding::theModifiableDateTzArray() const
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_DATETZ_ARRAY == selectionType());
...
inline
bsl::vector<bdlt::Time>& bdem_ChoiceBinding::theModifiableTimeArray() const
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_TIME_ARRAY == selectionType());
...
inline
bsl::vector<bdlt::TimeTz>& bdem_ChoiceBinding::theModifiableTimeTzArray() const
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_TIMETZ_ARRAY == selectionType());
...
inline
bdlmxxx::Choice& bdem_ChoiceBinding::theModifiableChoice() const
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_CHOICE == selectionType());
...
inline
bdlmxxx::ChoiceArray& bdem_ChoiceBinding::theModifiableChoiceArray() const
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_CHOICE_ARRAY == selectionType());
...
inline
bdlmxxx::List& bdem_ChoiceBinding::theModifiableList() const
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_LIST == selectionType());
...
inline
bdlmxxx::Table& bdem_ChoiceBinding::theModifiableTable() const
{
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_TABLE == selectionType());
...
inline
void bdem_ConstChoiceArrayBinding::rebind(const bdlmxxx::ChoiceArray *choiceArray)
{
    BSLS_ASSERT_SAFE(choiceArray);
    BSLS_ASSERT_SAFE(bdlmxxx::SchemaAggregateUtil::canSatisfyRecord(
                                                             *choiceArray,
                                          ...
                                          const bdlmxxx::RecordDef   *record)
{
    BSLS_ASSERT_SAFE(choiceArray);
    BSLS_ASSERT_SAFE(record);
    BSLS_ASSERT_SAFE(bdlmxxx::SchemaAggregateUtil::canSatisfyRecord(*choiceArray,
                                                                *record));
...
inline
const bdlmxxx::ChoiceArray& bdem_ConstChoiceArrayBinding::choiceArray() const
{
    return *d_choiceArray_p;
}

inline
const bdlmxxx::RecordDef& bdem_ConstChoiceArrayBinding::record() const
{
    return *d_constraint_p;
}
...
inline
bdlmxxx::ConstElemRef bdem_ConstChoiceArrayBinding::selection(int itemIndex) const
{
    BSLS_ASSERT_SAFE(0 <= itemIndex);
    BSLS_ASSERT_SAFE(     itemIndex < length());
...
const bool& bdem_ConstChoiceArrayBinding::theBool(int itemIndex) const
{
    BSLS_ASSERT_SAFE(0 <= itemIndex);
    BSLS_ASSERT_SAFE(     itemIndex < length());
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_BOOL == selectorType(itemIndex));
...
const char& bdem_ConstChoiceArrayBinding::theChar(int itemIndex) const
{
    BSLS_ASSERT_SAFE(0 <= itemIndex);
    BSLS_ASSERT_SAFE(     itemIndex < length());
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_CHAR == selectorType(itemIndex));
...
const short& bdem_ConstChoiceArrayBinding::theShort(int itemIndex) const
{
    BSLS_ASSERT_SAFE(0 <= itemIndex);
    BSLS_ASSERT_SAFE(     itemIndex < length());
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_SHORT == selectorType(itemIndex));
...
const int& bdem_ConstChoiceArrayBinding::theInt(int itemIndex) const
{
    BSLS_ASSERT_SAFE(0 <= itemIndex);
    BSLS_ASSERT_SAFE(     itemIndex < length());
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_INT == selectorType(itemIndex));
...
bdem_ConstChoiceArrayBinding::theInt64(int itemIndex) const
{
    BSLS_ASSERT_SAFE(0 <= itemIndex);
    BSLS_ASSERT_SAFE(     itemIndex < length());
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_INT64 == selectorType(itemIndex));
...
const float& bdem_ConstChoiceArrayBinding::theFloat(int itemIndex) const
{
    BSLS_ASSERT_SAFE(0 <= itemIndex);
    BSLS_ASSERT_SAFE(     itemIndex < length());
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_FLOAT == selectorType(itemIndex));
...
const double& bdem_ConstChoiceArrayBinding::theDouble(int itemIndex) const
{
    BSLS_ASSERT_SAFE(0 <= itemIndex);
    BSLS_ASSERT_SAFE(     itemIndex < length());
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_DOUBLE == selectorType(itemIndex));
...
const bsl::string& bdem_ConstChoiceArrayBinding::theString(int itemIndex) const
{
    BSLS_ASSERT_SAFE(0 <= itemIndex);
    BSLS_ASSERT_SAFE(     itemIndex < length());
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_STRING == selectorType(itemIndex));
...
bdem_ConstChoiceArrayBinding::theDatetime(int itemIndex) const
{
    BSLS_ASSERT_SAFE(0 <= itemIndex);
    BSLS_ASSERT_SAFE(     itemIndex < length());
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_DATETIME == selectorType(itemIndex));
...
bdem_ConstChoiceArrayBinding::theDatetimeTz(int itemIndex) const
{
    ...
    BSLS_ASSERT_SAFE(     itemIndex < length());
    BSLS_ASSERT_SAFE(
                    bdlmxxx::ElemType::BDEM_DATETIMETZ == selectorType(itemIndex));

    return (*d_choiceArray_p)[itemIndex].theDatetimeTz();
}

inline
const bdlt::Date& bdem_ConstChoiceArrayBinding::theDate(int itemIndex) const
{
    BSLS_ASSERT_SAFE(0 <= itemIndex);
    BSLS_ASSERT_SAFE(     itemIndex < length());
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_DATE == selectorType(itemIndex));

    return (*d_choiceArray_p)[itemIndex].theDate();
}

inline
const bdlt::DateTz& bdem_ConstChoiceArrayBinding::theDateTz(int itemIndex) const
{
    BSLS_ASSERT_SAFE(0 <= itemIndex);
    BSLS_ASSERT_SAFE(     itemIndex < length());
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_DATETZ == selectorType(itemIndex));

    return (*d_choiceArray_p)[itemIndex].theDateTz();
}

inline
const bdlt::Time& bdem_ConstChoiceArrayBinding::theTime(int itemIndex) const
{
    BSLS_ASSERT_SAFE(0 <= itemIndex);
    BSLS_ASSERT_SAFE(     itemIndex < length());
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_TIME == selectorType(itemIndex));

    return (*d_choiceArray_p)[itemIndex].theTime();
}

inline
const bdlt::TimeTz& bdem_ConstChoiceArrayBinding::theTimeTz(int itemIndex) const
{
    BSLS_ASSERT_SAFE(0 <= itemIndex);
    BSLS_ASSERT_SAFE(     itemIndex < length());
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_TIMETZ == selectorType(itemIndex));
...
bdem_ConstChoiceArrayBinding::theBoolArray(int itemIndex) const
{
    ...
    BSLS_ASSERT_SAFE(     itemIndex < length());
    BSLS_ASSERT_SAFE(
                    bdlmxxx::ElemType::BDEM_BOOL_ARRAY == selectorType(itemIndex));
...
bdem_ConstChoiceArrayBinding::theCharArray(int itemIndex) const
{
    ...
    BSLS_ASSERT_SAFE(     itemIndex < length());
    BSLS_ASSERT_SAFE(
                    bdlmxxx::ElemType::BDEM_CHAR_ARRAY == selectorType(itemIndex));
...
bdem_ConstChoiceArrayBinding::theShortArray(int itemIndex) const
{
    ...
    BSLS_ASSERT_SAFE(     itemIndex < length());
    BSLS_ASSERT_SAFE(
                   bdlmxxx::ElemType::BDEM_SHORT_ARRAY == selectorType(itemIndex));
...
bdem_ConstChoiceArrayBinding::theIntArray(int itemIndex) const
{
    BSLS_ASSERT_SAFE(0 <= itemIndex);
    BSLS_ASSERT_SAFE(     itemIndex < length());
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_INT_ARRAY == selectorType(itemIndex));
...
bdem_ConstChoiceArrayBinding::theInt64Array(int itemIndex) const
{
    ...
    BSLS_ASSERT_SAFE(     itemIndex < length());
    BSLS_ASSERT_SAFE(
                   bdlmxxx::ElemType::BDEM_INT64_ARRAY == selectorType(itemIndex));
...
bdem_ConstChoiceArrayBinding::theFloatArray(int itemIndex) const
{
    ...
    BSLS_ASSERT_SAFE(     itemIndex < length());
    BSLS_ASSERT_SAFE(
                   bdlmxxx::ElemType::BDEM_FLOAT_ARRAY == selectorType(itemIndex));
...
bdem_ConstChoiceArrayBinding::theDoubleArray(int itemIndex) const
{
    ...
    BSLS_ASSERT_SAFE(     itemIndex < length());
    BSLS_ASSERT_SAFE(
                  bdlmxxx::ElemType::BDEM_DOUBLE_ARRAY == selectorType(itemIndex));
...
bdem_ConstChoiceArrayBinding::theStringArray(int itemIndex) const
{
    ...
    BSLS_ASSERT_SAFE(     itemIndex < length());
    BSLS_ASSERT_SAFE(
                  bdlmxxx::ElemType::BDEM_STRING_ARRAY == selectorType(itemIndex));
...
bdem_ConstChoiceArrayBinding::theDatetimeArray(int itemIndex) const
{
    ...
    BSLS_ASSERT_SAFE(     itemIndex < length());
    BSLS_ASSERT_SAFE(
                bdlmxxx::ElemType::BDEM_DATETIME_ARRAY == selectorType(itemIndex));
...
bdem_ConstChoiceArrayBinding::theDatetimeTzArray(int itemIndex) const
{
    ...
    BSLS_ASSERT_SAFE(     itemIndex < length());
    BSLS_ASSERT_SAFE(
              bdlmxxx::ElemType::BDEM_DATETIMETZ_ARRAY == selectorType(itemIndex));
...
bdem_ConstChoiceArrayBinding::theDateArray(int itemIndex) const
{
    ...
    BSLS_ASSERT_SAFE(     itemIndex < length());
    BSLS_ASSERT_SAFE(
                    bdlmxxx::ElemType::BDEM_DATE_ARRAY == selectorType(itemIndex));
...
bdem_ConstChoiceArrayBinding::theDateTzArray(int itemIndex) const
{
    ...
    BSLS_ASSERT_SAFE(     itemIndex < length());
    BSLS_ASSERT_SAFE(
                  bdlmxxx::ElemType::BDEM_DATETZ_ARRAY == selectorType(itemIndex));
...
bdem_ConstChoiceArrayBinding::theTimeArray(int itemIndex) const
{
    ...
    BSLS_ASSERT_SAFE(     itemIndex < length());
    BSLS_ASSERT_SAFE(
                    bdlmxxx::ElemType::BDEM_TIME_ARRAY == selectorType(itemIndex));
...
bdem_ConstChoiceArrayBinding::theTimeTzArray(int itemIndex) const
{
    ...
    BSLS_ASSERT_SAFE(     itemIndex < length());
    BSLS_ASSERT_SAFE(
                  bdlmxxx::ElemType::BDEM_TIMETZ_ARRAY == selectorType(itemIndex));
...
bdem_ConstChoiceArrayBinding::theChoice(int itemIndex) const
{
    BSLS_ASSERT_SAFE(0 <= itemIndex);
    BSLS_ASSERT_SAFE(     itemIndex < length());
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_CHOICE == selectorType(itemIndex));
...
bdem_ConstChoiceArrayBinding::theChoiceArray(int itemIndex) const
{
    ...
    BSLS_ASSERT_SAFE(     itemIndex < length());
    BSLS_ASSERT_SAFE(
                  bdlmxxx::ElemType::BDEM_CHOICE_ARRAY == selectorType(itemIndex));
...
bdem_ConstChoiceArrayBinding::theList(int itemIndex) const
{
    BSLS_ASSERT_SAFE(0 <= itemIndex);
    BSLS_ASSERT_SAFE(     itemIndex < length());
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_LIST == selectorType(itemIndex));
...
bdem_ConstChoiceArrayBinding::theTable(int itemIndex) const
{
    BSLS_ASSERT_SAFE(0 <= itemIndex);
    BSLS_ASSERT_SAFE(     itemIndex < length());
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_TABLE == selectorType(itemIndex));
...
// ACCESSORS
inline
bdlmxxx::ChoiceArray& bdem_ChoiceArrayBinding::choiceArray() const
{
    return *const_cast<bdlmxxx::ChoiceArray *>(d_choiceArray_p);
}
...
inline
void bdem_ChoiceArrayBinding::rebind(bdlmxxx::ChoiceArray *choiceArray)
{
...
inline
bdlmxxx::ElemRef bdem_ChoiceArrayBinding::makeSelection(int         itemIndex,
...
inline
bdlmxxx::ElemRef bdem_ChoiceArrayBinding::selection(int itemIndex) const
{
    BSLS_ASSERT_SAFE(0 <= itemIndex);
    BSLS_ASSERT_SAFE(     itemIndex < length());
...
bool& bdem_ChoiceArrayBinding::theModifiableBool(int itemIndex) const
{
    ...
    bdlmxxx::ChoiceArrayItem& item = theModifiableItem(itemIndex);

    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_BOOL == item.selectionType());
...
char& bdem_ChoiceArrayBinding::theModifiableChar(int itemIndex) const
{
    ...
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_CHAR == item.selectionType());
...
short& bdem_ChoiceArrayBinding::theModifiableShort(int itemIndex) const
{
    ...
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_SHORT == item.selectionType());
...
int& bdem_ChoiceArrayBinding::theModifiableInt(int itemIndex) const
{
    ...
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_INT == item.selectionType());
...
bdem_ChoiceArrayBinding::theModifiableInt64(int itemIndex) const
{
    ...
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_INT64 == item.selectionType());
...
float& bdem_ChoiceArrayBinding::theModifiableFloat(int itemIndex) const
{
    ...
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_FLOAT == item.selectionType());
...
double& bdem_ChoiceArrayBinding::theModifiableDouble(int itemIndex) const
{
    ...
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_DOUBLE == item.selectionType());
...
bsl::string& bdem_ChoiceArrayBinding::theModifiableString(int itemIndex) const
{
    ...
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_STRING == item.selectionType());
...
bdem_ChoiceArrayBinding::theModifiableDatetime(int itemIndex) const
{
    ...
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_DATETIME == item.selectionType());
...
bdem_ChoiceArrayBinding::theModifiableDatetimeTz(int itemIndex) const
{
    ...
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_DATETIMETZ == item.selectionType());

    return item.theModifiableDatetimeTz();
}

inline
bdlt::Date& bdem_ChoiceArrayBinding::theModifiableDate(int itemIndex) const
{
    BSLS_ASSERT_SAFE(0 <= itemIndex);
    BSLS_ASSERT_SAFE(     itemIndex < length());
    ...
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_DATE == item.selectionType());

    return item.theModifiableDate();
}

inline
bdlt::DateTz& bdem_ChoiceArrayBinding::theModifiableDateTz(int itemIndex) const
{
    BSLS_ASSERT_SAFE(0 <= itemIndex);
    BSLS_ASSERT_SAFE(     itemIndex < length());
    ...
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_DATETZ == item.selectionType());

    return item.theModifiableDateTz();
}

inline
bdlt::Time& bdem_ChoiceArrayBinding::theModifiableTime(int itemIndex) const
{
    BSLS_ASSERT_SAFE(0 <= itemIndex);
    BSLS_ASSERT_SAFE(     itemIndex < length());
    ...
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_TIME == item.selectionType());

    return item.theModifiableTime();
}

inline
bdlt::TimeTz& bdem_ChoiceArrayBinding::theModifiableTimeTz(int itemIndex) const
{
    BSLS_ASSERT_SAFE(0 <= itemIndex);
    BSLS_ASSERT_SAFE(     itemIndex < length());
    ...
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_TIMETZ == item.selectionType());
...
bdem_ChoiceArrayBinding::theModifiableBoolArray(int itemIndex) const
{
    ...
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_BOOL_ARRAY == item.selectionType());
...
bdem_ChoiceArrayBinding::theModifiableCharArray(int itemIndex) const
{
    ...
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_CHAR_ARRAY == item.selectionType());
...
bdem_ChoiceArrayBinding::theModifiableShortArray(int itemIndex) const
{
    ...
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_SHORT_ARRAY == item.selectionType());
...
bdem_ChoiceArrayBinding::theModifiableIntArray(int itemIndex) const
{
    ...
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_INT_ARRAY == item.selectionType());
...
bdem_ChoiceArrayBinding::theModifiableInt64Array(int itemIndex) const
{
    ...
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_INT64_ARRAY == item.selectionType());
...
bdem_ChoiceArrayBinding::theModifiableFloatArray(int itemIndex) const
{
    ...
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_FLOAT_ARRAY == item.selectionType());
...
bdem_ChoiceArrayBinding::theModifiableDoubleArray(int itemIndex) const
{
    ...
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_DOUBLE_ARRAY == item.selectionType());
...
bdem_ChoiceArrayBinding::theModifiableStringArray(int itemIndex) const
{
    ...
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_STRING_ARRAY == item.selectionType());
...
bdem_ChoiceArrayBinding::theModifiableDatetimeArray(int itemIndex) const
{
    ...
    BSLS_ASSERT_SAFE(
                   bdlmxxx::ElemType::BDEM_DATETIME_ARRAY == item.selectionType());
...
bdem_ChoiceArrayBinding::theModifiableDatetimeTzArray(int itemIndex) const
{
    ...
    BSLS_ASSERT_SAFE(
                 bdlmxxx::ElemType::BDEM_DATETIMETZ_ARRAY == item.selectionType());
...
bdem_ChoiceArrayBinding::theModifiableDateArray(int itemIndex) const
{
    ...
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_DATE_ARRAY == item.selectionType());
...
bdem_ChoiceArrayBinding::theModifiableDateTzArray(int itemIndex) const
{
    ...
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_DATETZ_ARRAY == item.selectionType());
...
bdem_ChoiceArrayBinding::theModifiableTimeArray(int itemIndex) const
{
    ...
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_TIME_ARRAY == item.selectionType());
...
bdem_ChoiceArrayBinding::theModifiableTimeTzArray(int itemIndex) const
{
    ...
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_TIMETZ_ARRAY == item.selectionType());

    return item.theModifiableTimeTzArray();
}

inline
bdlmxxx::Choice& bdem_ChoiceArrayBinding::theModifiableChoice(int itemIndex) const
{
    BSLS_ASSERT_SAFE(0 <= itemIndex);
    BSLS_ASSERT_SAFE(     itemIndex < length());
    ...
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_CHOICE == item.selectionType());
...
bdem_ChoiceArrayBinding::theModifiableChoiceArray(int itemIndex) const
{
    ...
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_CHOICE_ARRAY == item.selectionType());

    return item.theModifiableChoiceArray();
}

inline
bdlmxxx::List& bdem_ChoiceArrayBinding::theModifiableList(int itemIndex) const
{
    BSLS_ASSERT_SAFE(0 <= itemIndex);
    BSLS_ASSERT_SAFE(     itemIndex < length());
    ...
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_LIST == item.selectionType());

    return item.theModifiableList();
}

inline
bdlmxxx::Table& bdem_ChoiceArrayBinding::theModifiableTable(int itemIndex) const
{
    BSLS_ASSERT_SAFE(0 <= itemIndex);
    BSLS_ASSERT_SAFE(     itemIndex < length());
    ...
    BSLS_ASSERT_SAFE(bdlmxxx::ElemType::BDEM_TABLE == item.selectionType());
