...
//
//@CLASSES:
//  bdlmxxx::SchemaAggregateUtil: namespace for functions on schemas & aggregates
//
//@SEE_ALSO: bdlmxxx_schema, bdlmxxx_aggregate, bdlmxxx_recorddef,
//           bdlmxxx_schemaenumerationutil
//
//@AUTHOR: John Lakos (jlakos)
//
//@DESCRIPTION: This component provides a suite of utility functions that
// operate simultaneously on a 'bdlmxxx::RecordDef' object (henceforth referred to
// as a record definition) and an object of 'bdem' aggregate type (i.e.,
// 'bdlmxxx::Choice', 'bdlmxxx::ChoiceArray', 'bdlmxxx::ChoiceArrayItem', 'bdlmxxx::List',
// 'bdlmxxx::Row', and 'bdlmxxx::Table', which are henceforth referred to as "choice",
...
// *sequence* (meaning
// 'bdlmxxx::RecordDef::BDEM_SEQUENCE_RECORD == bdlmxxx::RecordDef::recordType()') or
// *choice* (meaning
// 'bdlmxxx::RecordDef::BDEM_CHOICE_RECORD == bdlmxxx::RecordDef::recordType()').  A
...
// the component 'bdlmxxx_schemaenumerationutil' evaluates such conformance.
//
///Shallow Conformance
///-  -  -  -  -  -  -
...
//..
//  bdlmxxx::Schema mS;    const bdlmxxx::Schema& S = mS;
//..
// Next, we create the "RATING" enumeration constraint.
//..
//  bdlmxxx::EnumerationDef *rating = mS.createEnumeration("RATING");
...
//..
//  bdlmxxx::RecordDef *location = mS.createRecord("LOCATION");
//  location->appendField(bdlmxxx::ElemType::BDEM_STRING, "state");
//  location->appendField(bdlmxxx::ElemType::BDEM_DOUBLE, "percent");
//
...
//..
//  bdlmxxx::RecordDef *delinquency = mS.createRecord("DELINQUENCY");
//  delinquency->appendField(bdlmxxx::ElemType::BDEM_DOUBLE,
//                           "percentDelinq60Plus");
//  delinquency->appendField(bdlmxxx::ElemType::BDEM_DOUBLE,
//                           "percentDelinq90Plus");
//  delinquency->appendField(bdlmxxx::ElemType::BDEM_DOUBLE,
...
//..
//  bdlmxxx::RecordDef *bond = mS.createRecord("BOND");
//  bond->appendField(bdlmxxx::ElemType::BDEM_STRING, "name");
//  {
//      bdlmxxx::FieldDefAttributes fieldAttr(bdlmxxx::ElemType::BDEM_STRING);
//      fieldAttr.defaultValue().theModifiableString() = "AAA";
//      bond->appendField(fieldAttr, rating, "rating");
//  }
//  bond->appendField(bdlmxxx::ElemType::BDEM_TABLE,
//                    location,
//                    "locationOfHomes");
//  assert(0 == bond->lookupField("locationOfHomes")->isNullable());
//  bond->appendField(bdlmxxx::ElemType::BDEM_LIST,
//                    delinquency,
//                    "delinquency");
//  assert(0 == bond->lookupField("delinquency")->isNullable());
//  bond->appendField(bdlmxxx::ElemType::BDEM_INT, "avgFICOScore");
//  bond->appendField(bdlmxxx::ElemType::BDEM_DOUBLE, "percentInterest");
//
...
//..
//  bdlmxxx::List acme04DA;
//  typedef bdlmxxx::SchemaAggregateUtil Util;
//..
...
//..
//  assert(acme04DA[ratingIndex].type() == bdlmxxx::ElemType::BDEM_STRING);
//  assert(acme04DA[ratingIndex].isNull());
//  assert(acme04DA[locationIndex].type() == bdlmxxx::ElemType::BDEM_TABLE);
//  assert(acme04DA[locationIndex].isNull());
//  assert(acme04DA[delinquencyIndex].type() == bdlmxxx::ElemType::BDEM_LIST);
...
//  assert(!acme04DA[delinquencyIndex].isNull());
//
//  bdlmxxx::Table *table = &acme04DA[locationIndex].theModifiableTable();
//  bdlmxxx::List  *list  = &acme04DA[delinquencyIndex].theModifiableList();
//
...
//..
//  bdlmxxx::List acme04DJ = acme04DA;
//
...
//..
//  bdlmxxx::List testBond(acme04DJ);
...
//  assert(testBond[interestIndex].type() == bdlmxxx::ElemType::BDEM_DOUBLE);
//  testBond.removeElement(interestIndex);
//  testBond.appendNullElement(bdlmxxx::ElemType::BDEM_INT);
//  assert(!Util::isListShallowConformant(testBond, *bond));
//  assert(!Util::isListConformant(       testBond, *bond));
//  assert(!Util::isListDeepConformant(   testBond, *bond));
//  assert(!Util::canSatisfyRecord(       testBond, *bond));
//
//  testBond.removeElement(interestIndex);
//  testBond.appendNullElement(bdlmxxx::ElemType::BDEM_DOUBLE);
//  assert( Util::isListDeepConformant(   testBond, *bond));
//..
...
struct SchemaAggregateUtil {
    ...
    // operate simultaneously on 'RecordDef' objects and objects of
    // 'bdem' aggregate type (i.e., 'Choice', 'ChoiceArray',
    // 'ChoiceArrayItem', 'List', 'Row', and 'Table').

    // CLASS METHODS
    static
    bool canSatisfyRecord(const Row&       object,
                          const RecordDef& record);
    static
    bool canSatisfyRecord(const List&      object,
                          const RecordDef& record);
    static
    bool canSatisfyRecord(const Table&     object,
                          const RecordDef& record);
    static
    bool canSatisfyRecord(const Choice&    object,
                          const RecordDef& record);
    static
    bool canSatisfyRecord(const ChoiceArray& object,
                          const RecordDef&   record);
    static
    bool canSatisfyRecord(const ChoiceArrayItem& object,
                          const RecordDef&       record);
    ...
    static
    void initRowShallow(Row *row, const RecordDef& record);
    ...
    static
    void initRowDeep(Row *row, const RecordDef& record);
        // Set each element of scalar type in the specified 'row' to the
        // default value indicated by the corresponding field of the specified
        // 'record', if such a default values exists, and initialize all other
    ...
    static
    void initListAllNull(List *list, const RecordDef& record);
    ...
    static
    void initListShallow(List *list, const RecordDef& record);
    ...
    static
    void initListDeep(List *list, const RecordDef& record);
        // Set each element of scalar type in the specified 'list' to the
        // default value indicated by the corresponding field of the specified
        // 'record', if such a default values exists, and initialize all other
        // scalar elements to null.  Set each element of aggregate type in
    ...
    static
    void initTable(Table *table, const RecordDef& record);
    ...
    static
    void initChoice(Choice *choice, const RecordDef& record);
    ...
    static
    void initChoiceArray(ChoiceArray      *choiceArray,
                         const RecordDef&  record);
    ...
    static
    bool isRowShallowConformant(const Row&       row,
                                const RecordDef& record);
    ...
    static
    bool isRowConformant(const Row& row, const RecordDef& record);
    ...
    static
    bool isRowDeepConformant(const Row&       row,
                             const RecordDef& record);
    ...
    static
    bool isListShallowConformant(const List&      list,
                                 const RecordDef& record);
    ...
    static
    bool isListConformant(const List& list, const RecordDef& record);
    ...
    static
    bool isListDeepConformant(const List&      list,
                              const RecordDef& record);
    ...
    static
    bool isTableShallowConformant(const Table&     table,
                                  const RecordDef& record);
    ...
    static
    bool isTableConformant(const Table&     table,
                           const RecordDef& record);
    ...
    static
    bool isTableDeepConformant(const Table&     table,
                               const RecordDef& record);
    ...
    static
    bool isChoiceShallowConformant(const Choice&    choice,
                                   const RecordDef& record);
    ...
    static
    bool isChoiceConformant(const Choice&    choice,
                            const RecordDef& record);
    ...
    static
    bool isChoiceDeepConformant(const Choice&    choice,
                                const RecordDef& record);
    ...
    static
    bool isChoiceArrayShallowConformant(const ChoiceArray& choiceArray,
                                        const RecordDef&   record);
    ...
    static
    bool isChoiceArrayConformant(const ChoiceArray& choiceArray,
                                 const RecordDef&   record);
    ...
    static
    bool isChoiceArrayDeepConformant(const ChoiceArray& choiceArray,
                                     const RecordDef&   record);
...
// CLASS METHODS
inline
bool SchemaAggregateUtil::canSatisfyRecord(const List&      list,
                                                const RecordDef& record)
{
...
inline
bool SchemaAggregateUtil::canSatisfyRecord(const Choice&    choice,
                                                const RecordDef& record)
{
...
inline
bool SchemaAggregateUtil::isChoiceShallowConformant(
                                                  const Choice&    choice,
                                                  const RecordDef& record)
{
...
inline
bool SchemaAggregateUtil::isChoiceConformant(const Choice&    choice,
                                                  const RecordDef& record)
{
...
inline
bool SchemaAggregateUtil::isChoiceDeepConformant(
                                                  const Choice&    choice,
                                                  const RecordDef& record)
{
...
inline
bool SchemaAggregateUtil::isListConformant(const List&      list,
                                                const RecordDef& record)
{
...
inline
bool SchemaAggregateUtil::isListShallowConformant(
                                                  const List&      list,
                                                  const RecordDef& record)
{
...
inline
bool SchemaAggregateUtil::isListDeepConformant(
                                                  const List&      list,
                                                  const RecordDef& record)
{
