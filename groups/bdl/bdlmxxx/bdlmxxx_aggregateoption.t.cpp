// bdlmxxx_aggregateoption.t.cpp                   -*-C++-*-
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:
      ...
      case 1: {
        ...
        //   USAGE EXAMPLE
        // --------------------------------------------------------------------
        bdlmxxx::AggregateOption::AllocationStrategy y;
        y = bdlmxxx::AggregateOption::BDEM_PASS_THROUGH;
                  ASSERT(0 == y);
                  ASSERT(!(y & bdlmxxx::AggregateOption::BDEM_OWN_ALLOCATOR_FLAG));
                  ASSERT(!(y & bdlmxxx::AggregateOption::BDEM_NODESTRUCT_FLAG));
        y = bdlmxxx::AggregateOption::BDEM_WRITE_MANY;
                  ASSERT(1 == y);
                  ASSERT(  y & bdlmxxx::AggregateOption::BDEM_OWN_ALLOCATOR_FLAG);
                  ASSERT(!(y & bdlmxxx::AggregateOption::BDEM_NODESTRUCT_FLAG));
        y = bdlmxxx::AggregateOption::BDEM_WRITE_ONCE;
                  ASSERT(3 == y);
                  ASSERT(  y & bdlmxxx::AggregateOption::BDEM_OWN_ALLOCATOR_FLAG);
                  ASSERT(  y & bdlmxxx::AggregateOption::BDEM_NODESTRUCT_FLAG);
        y = bdlmxxx::AggregateOption::BDEM_SUBORDINATE;
                  ASSERT(2 == y);
                  ASSERT(!(y & bdlmxxx::AggregateOption::BDEM_OWN_ALLOCATOR_FLAG));
                  ASSERT(  y & bdlmxxx::AggregateOption::BDEM_NODESTRUCT_FLAG);
      } break;
