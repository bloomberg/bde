...
//                             TEST PLAN
//-----------------------------------------------------------------------------
// The bdlmxxx::ChoiceArrayImp serves as the underlying implementation of
...
//
// CREATORS
// [ 3] bdlmxxx::ChoiceArrayImp(bslma::Allocator *basicAlloc = 0);
// [ 3] bdlmxxx::ChoiceArrayImp(bslma::Allocator::AllocationStrategy,
//                       bslma::Allocator *);
// [ 3] bdlmxxx::ChoiceArrayImpl(const bdlmxxx::ElemType::Type[], int, const
//                        bdlmxxx::Descriptor *const *,
//                        bdem::Allocator::AllocationStrategy,
//                        bdem::Allocator *);
// [ 3] ~bdlmxxx::ChoiceArrayImpl();
// [ 8] bdlmxxx::ChoiceArrayImp(const bdlmxxx::ChoiceArrayImp& original,
//                     bslma::Allocator *);
// [ 8] bdlmxxx::ChoiceArrayImp(const bdlmxxx::ChoiceArrayImp& original,
...
// [ 4] void insertNullItems(int dstIndex, int elemCount);
// [ 4] bdlmxxx::ChoiceHeader& operator[] (int index);
// [ 9] bdlmxxx::ChoiceArrayImp& operator=(const bdlmxxx::ChoiceArrayImp& rhs);
// [10] bdlxxxx::InStream& streamIn(bdlxxxx::InStream& stream);
// [10] bdlxxxx::InStream& streamIn(bdlxxxx::InStream& stream, int version);
// [11] bdlmxxx::ElemRef makeSelection(int index, int selection);
// [12] void clear();
// [16] void reserveRaw(bsl::size_t);
// [12] void reset();
// [12] void reset(const bdlmxxx::ElemType::Type [], int,
//                 const bdlmxxx::Descriptor *const);
// [13] void insertItem(int, const bdlmxxx::ChoiceHeader&);
...
// [ 3] bdlmxxx::ElemType::Type selectionType(int selection) const;
// [ 4] const bdlmxxx::ChoiceHeader& operator[] (int index) const;
// [ 4] int length() const;
// [ 6] bsl::ostream& print(bsl::ostream& stream,
//                       int           level = 0,
//                       int           spacesPerLevel = 4) const;
// [ 6] operator<<(ostream&, const bdlmxxx::ChoiceArrayImp&);
// [ 7] operator==(const bdlmxxx::ChoiceArrayImp&, const bdlmxxx::ChoiceArrayImp&);
// [ 7] operator!=(const bdlmxxx::ChoiceArrayImp&, const bdlmxxx::ChoiceArrayImp&);
...
// [15] static const bdlmxxx::Descriptor bdlmxxx::ChoiceArrayImp::s_choiceArrayAttr;
//-----------------------------------------------------------------------------
// [ 1] BREATHING TEST
// [ 2] populateCatalog
// [ 5] populateData
...
typedef bdlmxxx::ChoiceArrayImp CAImp; // The preferred 'CAI' conflicts on Windows
typedef bdlmxxx::ChoiceArrayImp Obj;
...
const bdlmxxx::Descriptor tableAttr = {
    bdlmxxx::ElemType::BDEM_TABLE,                               // type
    0,                                                  // size
    0,                                                  // alignment
    0,
    0,
...
const bdlmxxx::Descriptor choiceAttr = {
    bdlmxxx::ElemType::BDEM_CHOICE,                              // type
    0,                                                  // size
    0,                                                  // alignment
    0,
    0,
...
const bdlmxxx::Descriptor choiceArrayAttr = {
    bdlmxxx::ElemType::BDEM_CHOICE_ARRAY,                        // type
    0,                                                  // size
    0,                                                  // alignment
    0,
    0,
...
streamInAttrLookup<STREAM>::lookupTable()
{
        ...
        table[] =
    {
        ...
        { &bdlmxxx::FunctionTemplates::streamInArray<bsls::Types::Int64,STREAM> },
...
streamOutAttrLookup<STREAM>::lookupTable()
{
        ...
        table[] =
    {
        ...
        { &bdlmxxx::FunctionTemplates::streamOutArray<bsls::Types::Int64,STREAM> },
        ...
        // TBD uncomment when bdlmxxx::Choice, bdlmxxx::ChoiceArray is ready
        { 0 },
        { 0 },
    };
    ...
    // type specified in the spec string.
{
    ...
    &A18,
    &A19,
    0, // Empty Value for bdlmxxx::List
    0, // Empty Value for bdlmxxx::Table
    &A22,
    &A23,
    &A24,
    &A25,
    ...
    &A28,
    &A29,
    0, // Empty Value for bdlmxxx::Choice
    0, // Empty Value for bdlmxxx::ChoiceArray
};
...
static void populateCatalog(Catalog *catalog, const char *spec)
    ...
    // bdlmxxx::ElemType values.  Thus 'A' - CHAR, 'B' - SHORT .. 'Z' - TIMETZ, 'a'
...
///Usage
///-----
// The class bdlmxxx::ChoiceArrayImp class can be used to store arrays of choice
...
// above data:
//..
 bdlmxxx::ChoiceArrayImp computeResults() {
//..
// First, we create the types catalog:
//..
       const bdlmxxx::ElemType::Type CHOICE_TYPES[] = {
           bdlmxxx::ElemType::BDEM_INT,     // result value
...
//..
       bdlmxxx::ChoiceArrayImp result(CHOICE_TYPES,
                                  NUM_CHOICES,
                                  MY_DESCRIPTORS,
                                  bdlmxxx::AggregateOption::BDEM_PASS_THROUGH);
//..
...
//..
// The normal usage of 'bdlmxxx::ChoiceArray' is create 5 elements, and then
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      case 19: {
        ...
        bdlmxxx::ChoiceArrayImp mX = computeResults();
      } break;
      case 18: {
        // --------------------------------------------------------------------
      ...
      case 15: {
        ...
        //   1. 'd_elemEnum == 31'
        //   2. 'd_size == sizeof(bdlmxxx::ChoiceArrayImp)'
        //   3.
        // 'd_alignment == bsls::AlignmentFromType<bdlmxxx::ChoiceArrayImp>::VALUE'
        ...
        //   12. Function 'print' calls the 'bdlmxxx::ChoiceArrayImp::print'.
        //
        // Plan:
        ...
        //
        // Testing:
        //   static const bdlmxxx::Descriptor s_choiceArrayAttr;
        // --------------------------------------------------------------------
        ...
        }
        {
            ...
            ASSERT(d.d_size == sizeof(bdlmxxx::ChoiceArrayImp));
        }
        {
            // TEST 3. d_alignment
      ...
      case 13: {
        ...
        //
        // Testing:
        //   void insertItem(int, const bdlmxxx::ChoiceHeader&);
        // --------------------------------------------------------------------
        ...
        {
            if (verbose) {
                cout << "\tTest insert(i,bdlmxxx::ChoiceHeader) for choice arrays"
            ...
            for (int i = 0; i < NUM_DATA; ++i) {
                ...
                BSLMA_TESTALLOCATOR_EXCEPTION_TEST_BEGIN(testAllocator) {
                    ...
                    for (int index = 0; index < LEN + 1; ++index) {
                        ...
                        bdlmxxx::ChoiceHeader hdr(DUMMY.theItem(0));
                        const bdlmxxx::ChoiceHeader& HDR = hdr;
        ...
        {
            if (verbose) {
                cout << "\tTest insert(i, bdlmxxx::ChoiceHeader) for aliasing "
                     << "issues" << endl;
            }
            // don't use aggregate types in the test spec
            const char *testSpec = "ABCDEFGHIJKLMNOPQRSTWXYZabcd";
      ...
      case 11: {
        ...
        //
        // Testing:
        //   bdlmxxx::ElemRef makeSelection(int index, int selection);
        // --------------------------------------------------------------------
            ...
            for (int i = 0; i < NUM_DATA; ++i) {
                ...
                BSLMA_TESTALLOCATOR_EXCEPTION_TEST_BEGIN(testAllocator) {
                    ...
                    for (int j = 0; j < LEN; ++j) {
                        ...
                        Ref.replaceValue(bdlmxxx::ConstElemRef(valueA,DESC));
                        LOOP2_ASSERT(i, j, !Ref.isNull());
                    }
                    LOOP_ASSERT(i, X == Y);
                } BSLMA_TESTALLOCATOR_EXCEPTION_TEST_END
      ...
      case 9: {
        ...
        //
        // Testing:
        //   bdlmxxx::ChoiceArrayImp& operator=(const bdlmxxx::ChoiceArrayImp& rhs);
        // --------------------------------------------------------------------
      ...
      case 8: {
        ...
        //
        // Testing:
        //   bdlmxxx::ChoiceArrayImp(const bdlmxxx::ChoiceArrayImp&  original,
        //                       bslma::Allocator           *basicAllocator);
        //   bdlmxxx::ChoiceArrayImp(const bdlmxxx::ChoiceArrayImp&  original,
        //                       bdem::AllocationStrategy     allocMode,
        //                       bslma::Allocator           *basicAllocator);
        // --------------------------------------------------------------------
        ...
        for (int testI = 0; testI < NUM_DATA; ++testI) {
            ...
            bdlma::SequentialAllocator  sAlloc2(&tAlloc2);
            bdlma::SequentialAllocator  sAlloc4(&tAlloc4);
            bdlma::SequentialAllocator  sAlloc5(&tAlloc5);
      ...
      case 7: {
        ...
        //
        // Testing:
        //  operator==(const bdlmxxx::ChoiceArrayImp&, const bdlmxxx::ChoiceArrayImp&);
        //  operator!=(const bdlmxxx::ChoiceArrayImp&, const bdlmxxx::ChoiceArrayImp&);
        // --------------------------------------------------------------------
      ...
      case 6: {
        ...
        //                       int           level = 0,
        //                       int           spacesPerLevel = 4) const;
        //   operator<<(ostream&, const bdlmxxx::ChoiceArrayImp&);
        // --------------------------------------------------------------------
      ...
      case 4: {
        ...
        //   'bdem::ChoiceArrayImpl'.  Note the ChoiceArrayImpl delegates a
        //   majority of it's functionality.  We only need to ensure the
        //   delegation happens correctly.
        //
        // Concerns:
        //   We are able to create a 'bdlmxxx::ChoiceArrayImp' object and put it
        ...
        // Testing:
        //   int length() const;
        //   bdlmxxx::ChoiceHeader& theModifiableItem(int index);
        //   const bdlmxxx::ChoiceHeader& theItem(int index) const;
      ...
      case 3: {
        ...
        //
        // Testing:
        //   bdlmxxx::ChoiceArrayImp(bslma::Allocator *basicAlloc = 0);
        //   bdlmxxx::ChoiceArrayImp(bslma::Allocator::AllocationStrategy,
        //                       bslma::Allocator *);
        //   bdlmxxx::ChoiceArrayImpl(const bdlmxxx::ElemType::Type[], int, const
        //                        bdlmxxx::Descriptor *const *,
        //                        bdem::Allocator::AllocationStrategy,
        //                        bdem::Allocator *);
        //   int numSelections() const;
        //   bdlmxxx::ElemType::Type selectionType(int selection) const;
        //   ~bdlmxxx::ChoiceArrayImpl();
        //
        // --------------------------------------------------------------------
            ...
            for (int i = 0; i < 4; ++i) {
                ...
                for (int j = 0; j < NUM_DATA; ++j) {
                    ...
                    BSLMA_TESTALLOCATOR_EXCEPTION_TEST_BEGIN(testAllocator) {
                      ...
                      mX.insertNullItems(0,1);
                      const bdlmxxx::ChoiceHeader &CH = X.theItem(0);
      ...
      case 1: {
        ...
        //   bdlmxxx::ChoiceArrayImp object are as expected, check that memory is
            ...
            for (int j = NUM_DATA - 1; j < NUM_DATA; ++j) {
              ...
              BSLMA_TESTALLOCATOR_EXCEPTION_TEST_BEGIN(testAllocator) {
                ...
                for (int k = 0; k < LEN; ++k) {
                    ...
                    const bdlmxxx::ChoiceHeader mI = mX.theModifiableItem(k);
                    LOOP_ASSERT(S, catalog.size() == X.numSelections());
                    LOOP_ASSERT(S, k + 1          == X.length());
                    LOOP_ASSERT(S, TYPE           == X.selectionType(k));
                    ...
                    bdlmxxx::ChoiceHeader mJ = mX.theModifiableItem(k + 1);
                    LOOP_ASSERT(S, catalog.size() == X.numSelections());
                    LOOP_ASSERT(S, k + 2          == X.length());
                    LOOP_ASSERT(S, TYPE           == X.selectionType(k));
