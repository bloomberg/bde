...
//                             TEST PLAN
//-----------------------------------------------------------------------------
// Although 'bdlmxxx::ChoiceArray' is a fully value-semantic class, all of the
// substantive implementation resides in 'bdlmxxx::ChoiceArrayImp'.
//
...
//
//                         ==========================
//                         class bdlmxxx::ChoiceArray
//                         ==========================
// CREATORS
// [ 3]  bdlmxxx::ChoiceArray(const vector<EType::Type>&  typesCatalog,
//                        AggOption::AllocationStrategy allocMode,
//                        bslma::Allocator           *basicAlloc = 0);
// [ 8]  bdlmxxx::ChoiceArray(bslma::Allocator *basicAllocator = 0);
// [ 8]  bdlmxxx::ChoiceArray(
//                  bdlmxxx::AggregateOption::AllocationStrategy  allocMode,
//                  bslma::Allocator  *basicAllocator = 0);
// [ 8]  bdlmxxx::ChoiceArray(
//                        const bdlmxxx::ElemType::Type       typesCatalog[],
//                        int                             typesCatalogLen,
//                        bslma::Allocator               *basicAllocator = 0);
// [ 8]  bdlmxxx::ChoiceArray(
//                        const bdlmxxx::ElemType::Type        typesCatalog[],
...
//                        bslma::Allocator                *basicAllocator = 0);
// [ 8] bdlmxxx::ChoiceArray(
//                       const bsl::vector<bdlmxxx::ElemType::Type>&  typesCatalog,
//                       bdlmxxx::AggregateOption::AllocationStrategy  allocMode,
//                       bslma::Allocator                 *basicAllocator =
//                       0);
// [ 9]  bdlmxxx::ChoiceArray(const bdlmxxx::ChoiceArrayImp& original,
//                        bslma::Allocator *);
// [ 9]  bdlmxxx::ChoiceArray(const bdlmxxx::ChoiceArrayImp& original,
//                        bdem::AllocationStrategy,
//                        bslma::Allocator *);
// [ 3]  ~bdlmxxx::ChoiceArray();
// MANIPULATORS
// [ 4]  void appendItem(const bdlmxxx::Choice& src);
// [10]  bdlxxxx::InStream& streamIn(bdlxxxx::InStream& stream);
// [10]  bdlxxxx::InStream& streamIn(bdlxxxx::InStream& stream, int version);
// [11]  bdlmxxx::ChoiceArray& operator=(const bdlmxxx::ChoiceArray& rhs);
// [12]  bdlmxxx::ChoiceArrayItem& theModifiableItem(int index);
// [13]  void reset(const bdlmxxx::ElemType::Type [], int);
// [13]  void reset(const bsl::vector<bdlmxxx::ElemType::Type>& );
// [14]  void appendNullItems(int elemCount);
// [14]  void appendItem(int, const bdem::ChoiceArryItem&);
// [15]  void insertItem(int, const bdlmxxx::Choice&);
// [15]  void insertItem(int, const bdlmxxx::ChoiceArrayItem&);
...
// [ 3]  bdlmxxx::ElemType::Type selectionType(int selectionIndex) const;
// [ 3]  void selectionTypes(bsl::vector<EType::Type> *result) const;
// [17]  bsl::size_t capacityRaw() const;
// [ 4]  void int length() const;
// [ 4]  const bdlmxxx::ChoiceArrayItem& operator[](int index) const;
// [ 4]  bool isEmpty() const;
// [ 6]  bsl::ostream& print(bsl::ostream& stream,
//                           int           level = 0,
//                           int           spacesPerLevel = 4) const;
// [ 6]  operator<<(ostream&, const bdlmxxx::Choice&);
// [ 7]  operator==(const bdlmxxx::ChoiceArray&, const bdlmxxx::ChoiceArray&);
// [ 7]  operator!=(const bdlmxxx::ChoiceArray&, const bdlmxxx::ChoiceArray&);
// [10]  int maxSupportedBdexVersion() const;
// [10]  bdlxxxx::OutStream& streamOut(bdlxxxx::OutStream& stream) const;
// [10]  bdlxxxx::OutStream& streamOut(bdlxxxx::OutStream& stream, int) const;
// [ 4]  const bdlmxxx::ChoiceArrayItem& theItem(int index) const;
//-----------------------------------------------------------------------------
// [ 1] BREATHING TEST
// [ 2] populateCatalog
// [ 5] populateData
...
typedef bdlmxxx::ChoiceArray              Obj;
typedef bdlmxxx::ChoiceArrayImp           ObjImp;
...
class List {
    // This class is a dummy List class to facilitate testing.
    // Note that it contains only the functions called in this test driver
    // and not the entire interface of List.
...
class Table {
    ...
    // Note that it contains only the functions called in this test driver
    // and not the entire interface of Table.
  ...
  public:
    ...
    // MANIPULATORS
    void appendNullRow();
    RowRef theModifiableRow(int index);
};
...
RowRef Table::theModifiableRow(int index)
{
...
//         { L_,       "GALKacKASJDKSWEIO" },
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 19: {
        ...
        ///Example 2
        ///- - - - -
        // The class bdlmxxx::ChoiceArray class can be used to store arrays
        ...
        // ChoiceArray itself.  The catalog is an array of bdem::ElemTypes
      ...
      case 18: {
        ...
        ///Example 1
        ///---------
        // In the following example, we create a couple of 'bdlmxxx::ChoiceArray'
        ...
        // See 'bdlmxxx::Choice' for a more complete description of how choices
        // work.
        //..
      ...
      case 17: {
        ...
        //:   'bdlmxxx::ChoiceArray::reserveRaw'.
        //: 2 'capacityRaw' correctly forwards to the method
        //:   'bdlmxxx::ChoiceArray::capacityRaw'.
        //
        // Plan:
        //: 1 Invoke 'reserveRaw' on a 'bdlmxxx::ChoiceArray' object and on a
        //:   'bdlmxxx::ChoiceArrayImp' object and verify that the same amount of
      ...
      case 15: {
        ...
        //
        // Testing:
        //   void insertItem(int, const bdlmxxx::Choice&);
        //   void insertItem(int, const bdlmxxx::ChoiceArrayItem&);
        ...
        {
            if (verbose) {
                bsl::cout << "\tTest insert(i,bdlmxxx::ChoiceHeader) for choice"
      ...
      case 14: {
        ...
        //   void appendItem(int, const bdem::ChoiceArryItem&);
        // --------------------------------------------------------------------
            ...
            for (int i = 0; i < NUM_DATA; ++i) {
                ...
                for (int j = 0; j < LEN; ++j) {
                    BSLMA_TESTALLOCATOR_EXCEPTION_TEST_BEGIN(testAllocator) {
                        ...
                        bdlmxxx::Choice tmpC(getChoiceA(SPEC,SPEC[j]).item(),
                                         &tAlloc);
                        mX.appendItem(tmpC);
        ...
        {
            if (verbose) {
                bsl::cout << "\tTest appendItem(bdlmxxx::Choice) for aliasing "
                          << "issues"
                          << endl;
            }
            bslma::TestAllocator testAllocator(veryVeryVerbose);
            ...
            for (int i = 0; i < NUM_DATA; ++i) {
                ...
                BSLMA_TESTALLOCATOR_EXCEPTION_TEST_BEGIN(testAllocator) {
                    ...
                    bdlmxxx::Choice tmpC(A.theItem(0), &testAllocator);
                    mA.appendItem(tmpC);
      ...
      case 13: {
        ...
        // Testing:
        //   void reset(const bdlmxxx::ElemType::Type [], int);
        //   void reset(const bsl::vector<bdlmxxx::ElemType::Type>& );
        // --------------------------------------------------------------------
      ...
      case 12: {
        ...
        // Testing:
        //     bdlmxxx::ChoiceArrayItem& theModifiableItem(int );
        // --------------------------------------------------------------------
      ...
      case 11: {
        ...
        //
        // Testing:
        //   bdlmxxx::ChoiceArray& operator=(const bdlmxxx::ChoiceArray& rhs);
        // --------------------------------------------------------------------
        if (verbose) bsl::cout << "\nTesting Assignment Operator"
                               << "\n===========================" << bsl::endl;
      ...
      case 10: {
        ...
        // --------------------------------------------------------------------
          ...
          {
              ASSERT(MAX_VERSION ==
                                  bdlmxxx::ChoiceArray::maxSupportedBdexVersion());
          }
      ...
      case 9: {
        ...
        //
        // Testing:
        //   bdlmxxx::ChoiceArray(const bdlmxxx::ChoiceArrayImp& original,
        //                  bslma::Allocator *);
        //   bdlmxxx::ChoiceArray(const bdlmxxx::ChoiceArrayImp& original,
        //                   bdem::AllocationStrategy,
        //                   bslma::Allocator *);
        ...
        }
        {
            ...
            bslma::TestAllocator badAlloc,alloc1,alloc2;
      ...
      case 8: {
        ...
        // Testing:
        //
        //    bdlmxxx::ChoiceArray(bslma::Allocator *basicAllocator = 0);
        //    bdlmxxx::ChoiceArray(
        //          bdlmxxx::AggregateOption::AllocationStrategy  allocMode,
        //          bslma::Allocator                    *basicAllocator = 0);
        //    bdlmxxx::ChoiceArray(
      ...
      case 7: {
        ...
        //
        // Testing:
        //   operator==(const bdlmxxx::ChoiceArray&, const bdlmxxx::ChoiceArray&);
        //   operator!=(const bdlmxxx::ChoiceArray&, const bdlmxxx::ChoiceArray&);
        // --------------------------------------------------------------------
...

        {
            ...
            bdlma::SequentialAllocator  testAllocator2(&tempAlloc);
      ...
      case 5: {
        ...
        //
        // Testing:
        //   void populateData(bdlmxxx::ChoiceArrayImp *, const char *);
        //
        // --------------------------------------------------------------------
      ...
      case 4: {
        ...
        //
        // Concerns:
        //   We are able to create a 'bdlmxxx::ChoiceArray' object and put it into
        //   any legal state.  We are not concerned in this test about trying
        //   to move the object from one state to another.
        //
        // Plan:
        //   A 'bdlmxxx::ChoiceArray' object can be put into any state using the
        ...
        //
        // Testing:
        //   void appendItem(const bdlmxxx::Choice& src);
        //   int length() const;
        //   const bdlmxxx::ChoiceArrayItem& operator[](int index) const;
        //   const bdlmxxx::ChoiceArrayItem& theItem(int index) const;
        //   bool isEmpty() const;
        // --------------------------------------------------------------------
        ...
        }
        {
            ...
            if (verbose) {
                cout << "\tTest appendItem(bdlmxxx::Choice) for aliasing "
                     << "issues"
                     << endl;
            }
      ...
      case 3: {
        ...
        //
        // Concerns:
        //   - We are able to create a 'bdlmxxx::ChoiceArray' with a catalog.
        ...
        //
        // Testing:
        //   bdlmxxx::ChoiceArray(const vector<EType::Type>&  typesCatalog,
        //                    AggOption::AllocationStrategy allocMode,
        //                    bslma::Allocator           *basicAlloc = 0);
        //   ~bdlmxxx::ChoiceArray();
        ...
        }
        {
            ...
            bslma::TestAllocator alloc1,alloc2, alloc3;

            // Set a default alloc guard
            const bslma::DefaultAllocatorGuard dag1(&alloc3);
            int NA1,NA2,NB1,NB2;
      ...
      case 1: {
        ...
        //   bdlmxxx::ChoiceArray object are as expected, check that memory is
        ...
        if (verbose) bsl::cout << "\tSizeof bdlmxxx::ChoiceArray :"
                               << sizeof(bdlmxxx::ChoiceArray) << bsl::endl;
...
//                 BSLMA_TESTALLOCATOR_EXCEPTION_TEST_BEGIN(testAllocator) {
                     ...
                     for (int k = 0; k < LEN; ++k) {
                        ...
                        const bdlmxxx::ElemRef    EREF_A(const_cast<void *>(VAL_A),
                                                        DESC);
                        const bdlmxxx::ConstElemRef CEREF_A(VAL_A, DESC);

                        const bdlmxxx::ElemRef    EREF_B(const_cast<void *>(VAL_B),
                                                        DESC);
                        const bdlmxxx::ConstElemRef CEREF_B(VAL_B, DESC);

                        const bdlmxxx::ElemRef    EREF_N(const_cast<void *>(VAL_N),
                                                        DESC);
                        const bdlmxxx::ConstElemRef CEREF_N(VAL_N, DESC);
                        ...
                        bdlmxxx::ChoiceArrayItem& mI = mX.theModifiableItem(k);
                        mI.makeSelection(k);
                        assign(&mI, CEREF_A, S);
                        if (veryVeryVerbose) { PL(LINE) P_(i) P_(k) P_(X) N_}
                        LOOP_ASSERT(S, catalog.size() == X.numSelections());
                        ...
                        bdlmxxx::ChoiceArrayItem& mJ = mX.theModifiableItem(k + 1);
                        assign(&mJ, CEREF_B, S);
                        if (veryVeryVerbose) { PL(LINE) P_(i) P_(k) P_(X) N_}
                        LOOP_ASSERT(S, catalog.size() == X.numSelections());
                        LOOP_ASSERT(S, k + 2          == X.length());
