// bdlmxxx_schemaenumerationutil.t.cpp                                -*-C++-*-
...
//-----------------------------------------------------------------------------
// CLASS METHODS
// [ 6] bool isConformant(int,                   const bdlmxxx::EnumerationDef&)
// [ 7] bool isConformant(const string&,         const bdlmxxx::EnumerationDef&)
// [ 8] bool isConformant(const vector<int>&,    const bdlmxxx::EnumerationDef&)
// [ 9] bool isConformant(const vector<string>&, const bdlmxxx::EnumerationDef&)
//-----------------------------------------------------------------------------
// [ 1] VERIFY CONSTANTS
...
static const int unsetInt       = bdltuxxx::Unset<int>::unsetValue();
static const string unsetString = bdltuxxx::Unset<string>::unsetValue();
...
const bdlmxxx::EnumerationDef& ggEnum(
    bdlmxxx::EnumerationDef *eDef,
    const char *string)
{
    // This routine deliberately leaks tiny amounts of memory
    char *pc = strdup(string);
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:
      case 10: {
        ...
        bdlmxxx::Schema mS(Z);     const bdlmxxx::Schema& S = mS;

        bdlmxxx::EnumerationDef& eDef = *mS.createEnumeration();
        const bdlmxxx::EnumerationDef& EDef = eDef;
      ...
      case 9: {
        ...
        for (int i = 0; i < DATA_LEN; ++i) {
...

            {
                ...
                bdlmxxx::EnumerationDef& emptyEDef = *mS.createEnumeration();
                const bdlmxxx::EnumerationDef& EmptyEDef = emptyEDef;

                ASSERT(0 == Util::isConformant(StringVec, EmptyEDef));
            }

            bdlmxxx::EnumerationDef& eDef = *mS.createEnumeration();
            const bdlmxxx::EnumerationDef& EDef = ggEnum(&eDef, GG_ENUM_STR);
      ...
      case 2: {
...

        {
            ...
            {
                bdlmxxx::EnumerationDef& empty = *mS.createEnumeration();
                const bdlmxxx::EnumerationDef& EMPTY = ggEnum(&empty, "");
            ...
            {
                bdlmxxx::EnumerationDef& eAbc = *mS.createEnumeration();
                const bdlmxxx::EnumerationDef& EAbc = ggEnum(&eAbc, "a 1 b 2 c 3");
            ...
            {
                bdlmxxx::EnumerationDef& eBig = *mS.createEnumeration();
                const bdlmxxx::EnumerationDef& EBig = ggEnum(&eBig,
      ...
      case 1: {
        ...
        // Util::isConformant(int, const bdem::Enumeration&) uses INT_MIN for
        // efficiency when it really means 'bdltuxxx::Unset<int>::unsetValue()',
        // verify here that they have the same value.
        ASSERT(bdltuxxx::Unset<int>::unsetValue() == INT_MIN);

        // Util::isConformant(string, const bdem::Enumeration&) uses ""
        // for the unset string while it really means
        // 'bdltuxxx::Unset<string>::unsetValue()', verify here that they have the
        // same value.
        ASSERT(bdltuxxx::Unset<string>::unsetValue() == "");
      } break;
      default: {
