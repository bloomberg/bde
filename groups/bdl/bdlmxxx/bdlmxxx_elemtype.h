...
//
//@CLASSES:
//  bdlmxxx::ElemType: namespace for enumerating the set of 'bdem' element types
//
...
// 'bdlmxxx::ElemType::Type'.  'Type' enumerates the set of scalar, array, and
...
// 'bdlmxxx::ElemType' operation.
//
// First, create a variable 'elemType' of type 'bdlmxxx::ElemType::Type' and
// initialize it to the value 'bdlmxxx::ElemType::BDEM_DATETIME':
//..
//  bdlmxxx::ElemType::Type elemType = bdlmxxx::ElemType::BDEM_DATETIME;
//..
// Next, store its string representation in a variable named 'rep' of type
// 'const char *':
//..
//  const char *rep = bdlmxxx::ElemType::toAscii(bdlmxxx::ElemType::BDEM_DATETIME);
...
struct ElemType {
  ...
  public:
    ...
    static ElemType::Type toArrayType(ElemType::Type value);
        // Return the array 'bdem' element type corresponding to the specified
        // 'value'; return 'ElemType::BDEM_VOID' if 'value' has no
    ...
    static ElemType::Type fromArrayType(ElemType::Type value);
    ...
    static bool isArrayType(ElemType::Type value);
    ...
    static bool isAggregateType(ElemType::Type value);
    ...
    static void print(bsl::ostream& stream, ElemType::Type value);
        ...
        // elided.  For example:
        //..
        //  print(bsl::cout, ElemType::BDEM_DATETIME);
        //..
    ...
    static const char *toAscii(ElemType::Type value);
        ...
        // example:
        //..
        //  print(bsl::cout, toAscii(ElemType::BDEM_DATETIME));
        //..
        // will print the following on standard output:
        //..
        //  DATETIME
...
// FREE OPERATORS
bsl::ostream& operator<<(bsl::ostream& stream, ElemType::Type value);
    // Write to the specified 'stream' the string representation of the
    ...
    // example:
    //..
    //  bsl::cout << ElemType::BDEM_DATETIME;
    //..
    // will print the following on standard output:
    //..
    //  DATETIME
...
// CLASS METHODS
inline
int ElemType::maxSupportedBdexVersion()
{
    return 1;
}

template <class STREAM>
STREAM& ElemType::bdexStreamIn(STREAM&              stream,
                                    ElemType::Type& value,
                                    int                  version)
{
    switch(version) {
      case 1: {
        ...
        if (stream) {
            if (0 <= newValue && newValue < ElemType::BDEM_NUM_TYPES) {
                value = ElemType::Type(newValue);
            }
            else {
...
template <class STREAM>
STREAM& ElemType::bdexStreamOut(STREAM&             stream,
                                     ElemType::Type value,
                                     int                 version)
{
    switch (version) {
...
namespace bdlmxxx {
inline
int ElemType::maxSupportedVersion()
{
...
// FREE OPERATORS
inline
bsl::ostream& bdlmxxx::operator<<(bsl::ostream& stream, ElemType::Type value)
{
    ElemType::print(stream, value);
    return stream;
}
...
inline
int maxSupportedVersion(bdlmxxx::ElemType::Type)
{
...
STREAM& streamOut(STREAM&                    stream,
                  ...
                  int                        version)
{
    return bdlmxxx::ElemType::bdexStreamOut(stream, value, version);
}
