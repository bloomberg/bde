...
//
//@CLASSES:
//  bdlmxxx::Schema: collection of record definitions defining a schema for data
//
//@SEE_ALSO: bdlmxxx_aggregate, bdlmxxx_schemaaggregateutil
//
//@AUTHOR: Tom Marshall, Henry Verschell
//
//@DESCRIPTION: This component defines a fully *value-semantic* type,
// 'bdlmxxx::Schema', for representing the structure of hierarchal data values.
// Each 'bdlmxxx::Schema' object comprises an indexed sequence of enumeration
...
// such as those defined in 'bdlmxxx_choice', 'bdlmxxx_choicearray', 'bdlmxxx_list',
// and 'bdlmxxx_table', but is otherwise logically as well as physically
// independent of those components.
//
///Schema Structure
///----------------
// Each 'bdlmxxx::Schema' object contains an indexed sequence of zero or more
// 'bdlmxxx::EnumerationDef' enumeration definitions, each comprising a set of
// enumerated (int, string) pair values.  Each 'bdlmxxx::Schema' object also
// contains an indexed sequence of zero or more 'bdlmxxx::RecordDef' objects
// (record definitions), each comprised of a sequence of zero or more
// 'bdlmxxx::FieldDef' objects (field definitions).  Each field definition
...
//  |-----------------------------------------------------------|
//  | INT          | bdlmxxx::EnumerationDef                        |
//  | STRING       |                                            |
//  | INT_ARRAY    |                                            |
//  | STRING_ARRAY |                                            |
//  |-----------------------------------------------------------|
//  | LIST         | bdlmxxx::RecordDef (type BDEM_SEQUENCE_RECORD) |
//  | TABLE        |                                            |
//  |-----------------------------------------------------------|
//  | CHOICE       | bdlmxxx::RecordDef (type BDEM_CHOICE_RECORD)   |
//  | CHOICE_ARRAY |                                            |
//  `==========================================================='
//..
...
// 'bdlmxxx::EnumerationDef' object defined within the *same* schema.  To satisfy
...
// is specified using a *sequence* 'bdlmxxx::RecordDef' object (i.e., a record
...
// 'bdlmxxx::RecordDef' object (i.e., a record definition of type
...
// 'bdlmxxx::RecordDef'.  If one or more field definitions within a record
...
///- - - - - - - - - - - -
// A 'bdlmxxx::Schema' object (like a graph having distinct node and edge objects)
...
// 'bdlmxxx::EnumerationDef::areEquivalent'), meaning they (a) have the same name
...
///Recursive Schemas
///- - - - - - - - -
// A 'bdlmxxx::RecordDef' may indicate, either directly or indirectly, a
...
// 'bdlmxxx::Schema'.  Note that using "ALL_CAPITALS' for record names, and
...
//  bdlmxxx::Schema schema(allocator);
//..
// We create a new record definition "SALE" of type 'BDEM_SEQUENCE_RECORD',
// which is the default:
//..
//  bdlmxxx::RecordDef *saleRecDef = schema.createRecord("SALE");
//..
...
// requires an explicit 'bdlmxxx::RecordDef::BDEM_CHOICE_RECORD' argument to the
// 'createRecord' method (see example 2).
//
// Next we append the fields to this record:
//..
//  const bdlmxxx::FieldDef *productIdFldDef =
//         saleRecDef->appendField(bdlmxxx::ElemType::BDEM_INT,    "productId");
//  const bdlmxxx::FieldDef *customerNameFldDef =
//         saleRecDef->appendField(bdlmxxx::ElemType::BDEM_STRING, "customerName");
//  const bdlmxxx::FieldDef *priceFldDef =
//         saleRecDef->appendField(bdlmxxx::ElemType::BDEM_DOUBLE, "price");
//  const bdlmxxx::FieldDef *dateFldDef =
//         saleRecDef->appendField(bdlmxxx::ElemType::BDEM_DATE,   "date");
//..
...
//  bdlmxxx::Schema schema(allocator);
//
//  bdlmxxx::EnumerationDef *ccTypeEnumDef =
...
//..
//  bdlmxxx::RecordDef *ccPaymentRecDef = schema.createRecord(
//                                                      "CREDIT_CARD_PAYMENT");
//  ccPaymentRecDef->appendField(bdlmxxx::ElemType::BDEM_STRING,
//                               ccTypeEnumDef,
//                               "cardType");
//  ccPaymentRecDef->appendField(bdlmxxx::ElemType::BDEM_STRING,
//                               "name");
//  ccPaymentRecDef->appendField(bdlmxxx::ElemType::BDEM_INT,
//                               "cardNumber");
//..
// Next we create the *sequential* record definition for "CHECK_PAYMENT", and
// append its fields:
//..
//  bdlmxxx::RecordDef *checkPaymentRecDef = schema.createRecord("CHECK_PAYMENT");
//  checkPaymentRecDef->appendField(bdlmxxx::ElemType::BDEM_STRING,
//                                  "bankName");
//  checkPaymentRecDef->appendField(bdlmxxx::ElemType::BDEM_INT,
//                                  "routingNumber");
//..
...
// 'bdlmxxx::RecordDef::BDEM_CHOICE_RECORD' to 'createRecord':
//..
//  bdlmxxx::RecordDef *paymentInfoRecDef = schema.createRecord(
//                                         "PAYMENT_INFO",
...
//..
//  paymentInfoRecDef->appendField(bdlmxxx::ElemType::BDEM_LIST,
//                                 ccPaymentRecDef,
//                                 "creditCardPayment");
//  paymentInfoRecDef->appendField(bdlmxxx::ElemType::BDEM_LIST,
//                                 checkPaymentRecDef,
//                                 "checkPayment");
//  paymentInfoRecDef->appendField(bdlmxxx::ElemType::BDEM_BOOL,
//                                 "cashPayment");
//..
...
//  saleRecDef->appendField(bdlmxxx::ElemType::BDEM_INT, "productId");
//..
// For the "quantity" field, we create a 'bdlmxxx::FieldDefAttributes' so we can
// provide it a default value of 1.  We then append the "quantity" field, and
// the remaining fields to the "SALE" record definition:
//..
//  bdlmxxx::FieldDefAttributes quantityType(bdlmxxx::ElemType::BDEM_INT);
...
//  saleRecDef->appendField(bdlmxxx::ElemType::BDEM_DOUBLE, "price");
//  saleRecDef->appendField(bdlmxxx::ElemType::BDEM_DATE,   "date");
//  saleRecDef->appendField(bdlmxxx::ElemType::BDEM_LIST,
//                          paymentInfoRecDef,
//                          "paymentInfo");
//..
...
// sub-fields (see 'bdlmxxx::ElemType::isAggregateType').  Field definitions of
...
//  `------------------------------'
//..
// First we create an empty 'bdlmxxx::Schema' object, 'schema':
//..
//  bdlmxxx::Schema schema;
//..
// Next we append a record definition named "TREE" to 'schema':
//..
//  bdlmxxx::RecordDef *treeRecDef = schema.createRecord("TREE");
//..
...
//..
//  treeRecDef->appendField(bdlmxxx::ElemType::BDEM_STRING, "key");
//  treeRecDef->appendField(bdlmxxx::ElemType::BDEM_LIST, treeRecDef, "left");
//  treeRecDef->appendField(bdlmxxx::ElemType::BDEM_LIST, treeRecDef, "right");
//..
...
class Schema {
    ...
    // defined in 'bdlmxxx_elemtype'.  Each object of this class comprises two
  ...
  private:
    // PRIVATE TYPES
    typedef bsl::map<const char *, int, bdlb::CStringLess> CharptrIntMap;
    ...
    // DATA
    bdlma::SequentialAllocator          d_writeOnceAlloc;  // arena for
                                                          // allocating
                                                          // sub-parts

    bsl::vector<RecordDef *>      d_recordDefs;      // sequence of record
                                                          // defs
    ...
    bsl::vector<EnumerationDef *> d_enumDefs;        // sequence of
                                                          // enumeration defs
  ...
  private:
    ...
    STREAM& bdexStreamInRecordDef(
                                 ...
                                 RecordDef::RecordType  recordType,
                                 STREAM&                     stream,
                                 int                         detailedVersion);
    ...
    int setRecordConstraints(RecordDef    *recordDef,
                             bsl::vector<int>&  constraintIndices);
    ...
    int bdexMinorVersion() const;
        ...
        // features of 'Schema' are cannot be represented in the original
    ...
    STREAM& bdexStreamOutEnumerationDef(
                             STREAM&                    stream,
                             const EnumerationDef& enumerationDef,
  ...
  public:
    // TRAITS
    BSLALG_DECLARE_NESTED_TRAITS(Schema,
    ...
    // CREATORS
    Schema(bslma::Allocator *basicAllocator = 0);
    ...
    RecordDef *createRecord(RecordDef::RecordType  type);
    RecordDef *createRecord(const char                 *name = 0,
                                 RecordDef::RecordType  type =
                                         RecordDef::BDEM_SEQUENCE_RECORD);
    ...
    EnumerationDef *createEnumeration(const char *name = 0);
    ...
    const RecordDef *lookupRecord(const char *name) const;
    ...
    const RecordDef& record(int index) const;
    ...
    const EnumerationDef& enumeration(int index) const;
...
bool operator==(const Schema& lhs, const Schema& rhs);
    ...
    // 'EnumerationDef::areEquivalent'), meaning they (a) have the same
...
bool operator!=(const Schema& lhs, const Schema& rhs);
    ...
    // position, are not equivalent (see 'EnumerationDef::areEquivalent'),
...
bsl::ostream& operator<<(bsl::ostream& stream, const Schema& schema);
...
// PRIVATE MANIPULATORS
template <class STREAM>
STREAM& Schema::bdexStreamInEnumerationDef(STREAM& stream,
                                                int     detailedVersion)
{
    ...
    EnumerationDef *enumerationDef = createEnumeration(enumName);
    if (0 == enumerationDef) {
        stream.invalidate();
        return stream;                                                // RETURN
    }
...
template <class STREAM>
STREAM& Schema::bdexStreamInRecordDef(
                                 bsl::vector<int>           *constraintIndices,
                                 RecordDef::RecordType  recordType,
                                 STREAM&                     stream,
                                 int                         detailedVersion)
{
    ...
    switch (version) {  // Switch on the schema version (starting with 1).
      case 1: {
        ...
        RecordDef *recordDef = createRecord(recordName, recordType);
        if (0 == recordDef) {
            stream.invalidate();
            return stream;                                            // RETURN
        }
        ...
        for (int i = 0; i < numFields; ++i) {
            ...
            int fieldId = RecordDef::BDEM_NULL_FIELD_ID;
            ...
            ElemType::bdexStreamIn(stream, elemType, 1);
            ...
            if (detailedVersion >= 1001
             && !ElemType::isAggregateType(elemType)) {
                ...
                const ElemRef& defaultValue = attributes.defaultValue();
                ElemType::Type defaultValueType = defaultValue.type();
                ...
                if (detailedVersion < 1003 || hasDefault) {
                    const DescriptorStreamIn<STREAM> *inLookup =
            ...
            const FieldDef *newField = recordDef->appendField(attributes,
                                                                   0,
                                                                   fieldName,
                                                                   fieldId);
...
// PRIVATE ACCESSORS
template <class STREAM>
STREAM& Schema::bdexStreamOutEnumerationDef(
                      STREAM&                          stream,
                      const EnumerationDef& enumerationDef,
                      int                              detailedVersion) const
{
    ...
    for (EnumerationDefIterator i = enumerationDef.begin();
...
template <class STREAM>
STREAM& Schema::bdexStreamOutRecordDef(
                                   STREAM&               stream,
                                   const RecordDef& recordDef,
                                   int                   detailedVersion) const
{
    ...
    switch (version) {  // Switch on the schema version (starting with 1).
      case 1: {
        ...
        for (int i = 0; i < numFields; ++i) {
            ...
            const FieldDef& fieldDef = recordDef.field(i);
            ...
            ElemType::bdexStreamOut(stream, fieldType, 1);
                                                     // version deliberately 1
            ...
            if (EnumerationDef::canHaveEnumConstraint(fieldType)) {

                // Enumeration constraint

                const EnumerationDef *constraint =
            ...
            else if (ElemType::isAggregateType(fieldType)) {
            ...
            if (detailedVersion >= 1001) {
                ...
                if (!ElemType::isAggregateType(fieldDef.elemType())) {
                    ...
                    if (detailedVersion < 1003 || hasDefault) {
                        const ConstElemRef& defaultValue =
                                                       fieldDef.defaultValue();
                        ElemType::Type defaultValueType =
                                                      defaultValue.type();

                        const DescriptorStreamOut<STREAM> *outLookup =
...
// CLASS METHODS
inline
int Schema::maxSupportedBdexVersion()
{
...
// MANIPULATORS
inline
RecordDef *Schema::createRecord(RecordDef::RecordType type)
{
    return createRecord(0, type);
}

template <class STREAM>
STREAM& Schema::bdexStreamIn(STREAM& stream, int version)
{
    if (stream) {
        ...
        switch (version) {  // Switch on the schema version (starting with 1).
          case 1: {
            ...
            bsl::vector<RecordDef::RecordType> recordTypes;
            ...
            for (int r = 0; r < numRecords; ++r) {
                ...
                if (detailedVersion >= 1001) {
                    ...
                    if (readValue > RecordDef::BDEM_CHOICE_RECORD) {
                        stream.invalidate();
                        return stream;                                // RETURN
                    }
                    recordType =
                            static_cast<RecordDef::RecordType>(readValue);
                }
...
// ACCESSORS
inline
bslma::Allocator *Schema::allocator() const
{
...
inline
int Schema::length() const
{
    return numRecords();
}

inline
int Schema::numRecords() const
{
    return static_cast<int>(d_recordDefs.size());
}

inline
int Schema::numEnumerations() const
{
    return static_cast<int>(d_enumDefs.size());
}

inline
const RecordDef *Schema::lookupRecord(const char *name) const
{
...
inline
const RecordDef& Schema::record(int index) const
{
...
inline
int Schema::recordIndex(const char *name) const
{
    CharptrIntMap::const_iterator iter = d_recordNames.find(name);
...
inline
const char *Schema::recordName(int index) const
{
    BSLS_ASSERT_SAFE(0 <= index);
    BSLS_ASSERT_SAFE(     index < numRecords());
...
Schema::lookupEnumeration(const char *name) const
{
...
inline
const EnumerationDef& Schema::enumeration(int index) const
{
    BSLS_ASSERT_SAFE(0 <= index);
...
inline
int Schema::enumerationIndex(const char *name) const
{
    CharptrIntMap::const_iterator iter = d_enumNames.find(name);
...
inline
const char *Schema::enumerationName(int index) const
{
    BSLS_ASSERT_SAFE(0 <= index);
    BSLS_ASSERT_SAFE(     index < numEnumerations());
...
template <class STREAM>
STREAM& Schema::bdexStreamOut(STREAM& stream, int version) const
{
    switch (version) {  // Switch on the schema version (starting with 1).
      case 1: {
...
inline
bsl::ostream& bdlmxxx::operator<<(bsl::ostream& stream, const Schema& schema)
{
