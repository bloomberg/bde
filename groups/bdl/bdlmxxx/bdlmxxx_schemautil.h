// bdlmxxx_schemautil.h                                                  -*-C++-*-
#ifndef INCLUDED_BDLMXXX_SCHEMAUTIL
#define INCLUDED_BDLMXXX_SCHEMAUTIL
...
//
//@CLASSES:
//  bdlmxxx::SchemaUtil: non-primitive operations on schemas and record definitions
//
//@SEE_ALSO: bdlmxxx_schema, bdlmxxx_schemaaggregateutil, bdlmxxx_schemaenumerationutil
//
//@AUTHOR: John Lakos, Tom Marshall
//
//@DESCRIPTION: This component provides a utility, 'bdlmxxx::SchemaUtil', that
// serves as a namespace for a suite of pure procedures that operate on
// objects of types that comprise a data schema: 'bdlmxxx::EnumerationDef',
// 'bdlmxxx::RecordDef', and 'bdlmxxx::Schema'.  In particular, 'bdlmxxx::SchemaUtil'
// defines functions for comparing pairs of 'bdlmxxx::EnumerationDef' objects
// ("enumeration definitions"), pairs of 'bdlmxxx::RecordDef' objects ("record
// definitions"), and pairs of 'bdlmxxx::Schema' objects ("schemas").
//
...
// package-level documentation (also see the 'bdlmxxx_aggregate' component).
//
...
//..
//  (const bdlmxxx::Schema&,         const bdlmxxx::Schema&)
//  (const bdlmxxx::EnumerationDef&, const bdlmxxx::EnumerationDef&)
//  (const bdlmxxx::RecordDef&,      const bdlmxxx::RecordDef&)
//  (const bdlmxxx::RecordDef&,      const bdlmxxx::RecordDef&, int attributeMask)
//..
...
// defined in the 'bdlmxxx_schema' component (and for that reason alone is not
// implemented here).  The definition of *exact* is somewhat less obvious when
// applied to record/enumeration definitions, since 'bdlmxxx::RecordDef' and
// 'bdlmxxx::EnumerationDef' are *not* value-semantic types.  In particular, the
...
///- - - - - - - - - - - - - - -
//..
//  bool isSuperset(const bdlmxxx::Schema&, const bdlmxxx::Schema&);
//..
//
///Comparison Methods on Enumeration Definitions
///- - - - - - - - - - - - - - - - - - - - - - -
//..
//  bool isSuperset(const bdlmxxx::EnumerationDef& super,
//                  const bdlmxxx::EnumerationDef& sub);
//
//  bool areEquivalent(const bdlmxxx::EnumerationDef& e1,
//                     const bdlmxxx::EnumerationDef& e2);
//..
//
///Comparison Methods on Record Definitions
/// - - - - - - - - - - - - - - - - - - - -
//..
//  bool isSuperset(const bdlmxxx::RecordDef&, const bdlmxxx::RecordDef&);
//  bool areEquivalent(const bdlmxxx::RecordDef&, const bdlmxxx::RecordDef&);
//
//  bool isStructuralSuperset(const bdlmxxx::RecordDef&, const bdlmxxx::RecordDef&);
//  bool areStructurallyEquivalent(const bdlmxxx::RecordDef&,
//                                 const bdlmxxx::RecordDef&);
//
//  bool isSymbolicSuperset(const bdlmxxx::RecordDef&, const bdlmxxx::RecordDef&);
//  bool areSymbolicallyEquivalent(const bdlmxxx::RecordDef&,
//                                 const bdlmxxx::RecordDef&);
//
//  bool isStructuralSuperset(const bdlmxxx::RecordDef&,
//                            const bdlmxxx::RecordDef&,
//                            int   attributeMask);
//  bool areStructurallyEquivalent(const bdlmxxx::RecordDef&,
//                                 const bdlmxxx::RecordDef&,
//                                 int   attributeMask);
//
//  bool isSymbolicSuperset(const bdlmxxx::RecordDef&,
//                          const bdlmxxx::RecordDef&,
//                          int   attributeMask);
//  bool areSymbolicallyEquivalent(const bdlmxxx::RecordDef&,
//                                 const bdlmxxx::RecordDef&,
...
//
///Technical Details Regarding 'bdlmxxx::Schema'
///- - - - - - - - - - - - - - - - - - - - -
// We assume that the reader is reasonably familiar with the components that,
// collectively, define a schema (i.e., 'bdlmxxx_schema', 'bdlmxxx_enumerationdef',
// 'bdlmxxx_recorddef', and 'bdlmxxx_fielddef') but we focus here on a few details,
...
// component and the conformance methods of 'bdlmxxx_schemaaggregateutil'.  Once
...
// See the 'bdlmxxx_schema' component for details on how to build a schema object,
...
// meta-data as a 'bdlmxxx::Schema'.  In the initial data model, the data is to be
...
// "priceVal" will now have a third element of type 'bdlt::DateTime'.  The new
...
// follows:
//..
//  const bdlmxxx::RecordDef *serverRec = serverSchema.lookupRecord("Stock");
//  const bdlmxxx::RecordDef *clientRec = clientSchema.lookupRecord("Stock");
//
...
//  const bdlmxxx::RecordDef&  serverRec = serverSchema.record(serverRecIdx);
//  int                    priceIdx  = serverRec.fieldIndex("priceVal");
//  const bdlmxxx::FieldDef   *priceFld  = serverRec.field(priceListIdx);
//  const bdlmxxx::RecordDef  *priceRec  = priceFld.constraint();
...
namespace bdlmxxx {class EnumerationDef;
class RecordDef;
class Schema;
...
struct SchemaUtil {
    ...
    // (1) 'EnumerationDef' objects, (2) 'RecordDef' objects,
    // and (3) 'Schema' objects.  These comparisons operations include
    ...
    // CLASS METHODS
    static bool areEquivalent(const EnumerationDef& e1,
    ...
    static bool areEquivalent(const RecordDef& r1,
                              const RecordDef& r2);
    ...
    static bool areStructurallyEquivalent(const RecordDef& r1,
                                          const RecordDef& r2);
    static bool areStructurallyEquivalent(const RecordDef& r1,
                                          const RecordDef& r2,
                                          int                   attributeMask);
        ...
        //..
        //  SchemaUtil::areStructurallyEquivalent(r1, r2);
        //  SchemaUtil::areStructurallyEquivalent(r1, r2, 0);
        //..

    static bool areSymbolicallyEquivalent(const RecordDef& r1,
                                          const RecordDef& r2);
    static bool areSymbolicallyEquivalent(const RecordDef& r1,
                                          const RecordDef& r2,
                                          int                   attributeMask);
        ...
        //..
        //  SchemaUtil::areSymbolicallyEquivalent(r1, r2);
        //  SchemaUtil::areSymbolicallyEquivalent(r1, r2, 0);
        //..
    ...
    static bool isSuperset(const RecordDef& super,
                           const RecordDef& sub);
        // Return 'true' if the specified 'super' is a *superset* of the
        // specified 'sub', and 'false' otherwise.  'super' is a *superset* of
    ...
    static bool isSuperset(const Schema& super, const Schema& sub);
        // Return 'true' if the specified 'super' is a *superset* of the
        // specified 'sub', and 'false' otherwise.  'super' is a *superset* of
    ...
    static bool isStructuralSuperset(const RecordDef& super,
                                     const RecordDef& sub);
    static bool isStructuralSuperset(const RecordDef& super,
                                     const RecordDef& sub,
                                     int                   attributeMask);
        ...
        // note that the following are equivalent:
        //..
        //  SchemaUtil::isStructuralSuperset(r1, r2);
        //  SchemaUtil::isStructuralSuperset(r1, r2, 0);
        //..

    static bool isSymbolicSuperset(const RecordDef& super,
                                   const RecordDef& sub);
    static bool isSymbolicSuperset(const RecordDef& super,
                                   const RecordDef& sub,
                                   int                   attributeMask);
        ...
        // explicit id.  Also note that the following are equivalent:
        //..
        //  SchemaUtil::isSymbolicSuperset(r1, r2);
        //  SchemaUtil::isSymbolicSuperset(r1, r2, 0);
        //..
};
