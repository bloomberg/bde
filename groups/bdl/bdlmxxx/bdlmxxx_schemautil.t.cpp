...
//-----------------------------------------------------------------------------
// [ 1] BREATHING TEST
// [ 2] bdlmxxx::Schema& gg(bdlmxxx::Schema *s, const char *spec) (generator function)
// [ 3] bdlmxxx::Schema g(const char *spec)
//
//=============================================================================
...
typedef bdlmxxx::SchemaUtil          Util;  // component under test
...
const Int64           A03 = -100;
const Int64           B03 = -200;
const Int64           N03 = bdltuxxx::Unset<Int64>::unsetValue();
...
static
void setDefaultValueForType(bdlmxxx::ElemRef ref, bool other = false)
...
//
//=============================================================================
//                bdlmxxx::Schema g LANGUAGE INTERNALS
//=============================================================================
...
//=============================================================================
//                bdlmxxx::Schema gg HELPER DATA AND FUNCTIONS
//=============================================================================
           ...
           RecType recordType, const char *p)
{
    ...
    while (isFieldType(*p)) {       // add a field
        ...
        if (!hasNoDefault) {
            BSLS_ASSERT(! bdlmxxx::ElemType::isAggregateType(fieldType));
...
int main(int argc, char *argv[])
{
  ...
  //--------v
      ...
      case 3: {
        // --------------------------------------------------------------------
        // TESTING 'g'
        //   <Test taken from 'bdlmxxx_schema.t.cpp' case 11>
      ...
      case 2: {
        ...
        //   <Test taken from 'bdlmxxx_schema.t.cpp' case 3>
        ...
        //
        // Testing:
        //   bdlmxxx::Schema& gg(bdlmxxx::Schema *object, const char *spec)
        // --------------------------------------------------------------------
      ...
      case 1: {
        ...
        //   'bdlmxxx_schemautil' operates sanely.
        //
        // Plan:
        //   Create simple 'bdlmxxx::Schema' objects (using default constructor),
