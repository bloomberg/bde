// bdlfxxx_vfunc3.h                                                      -*-C++-*-
#ifndef INCLUDED_BDLFXXX_VFUNC3
#define INCLUDED_BDLFXXX_VFUNC3
...
//
//@CLASSES:
//   bdlfxxx::Vfunc3: signature-specific function object (functor)
//
...
//
// The 'bdlfxxx::Vfunc3' functor (envelope) holds a polymorphic, reference-counted,
...
// signature and (2) the supplied user data.  See the 'bdlfxxxu_vfunc3' component
// for more information on populating 'bdlfxxx::Vfunc3' function objects with
...
class Vfunc3 {
    ...
    bdlfxxxr::Vfunc3<A1, A2, A3> *d_rep_p;  // polymorphic functor representation

  private:
    // NOT IMPLEMENTED
    bool operator==(const Vfunc3&) const;
    bool operator!=(const Vfunc3&) const;

    template<class B1, class B2, class B3>
    bool operator==(const Vfunc3<B1, B2, B3>&) const;
    template<class B1, class B2, class B3>
    bool operator!=(const Vfunc3<B1, B2, B3>&) const;
  ...
  public:
    ...
    Vfunc3(bdlfxxxr::Vfunc3<A1, A2, A3> *representation);          // IMPLICIT
        ...
        // components (see 'bdlfxxxu_vfunc3') to create an appropriate
        // representation and load it into an existing functor.

    Vfunc3(const Vfunc3& functionObject);
    ...
    ~Vfunc3();
        ...
        // the static 'deleteObject' method of 'bdlfxxxr::Vfunc3' base class).

    // MANIPULATORS
    Vfunc3<A1, A2, A3>& operator=(const Vfunc3& functionObject);
        ...
        // 'deleteObject' method of 'bdlfxxxr::Vfunc3' base class.
...
template <class A1, class A2, class A3>
inline
Vfunc3<A1, A2, A3>::Vfunc3(bdlfxxxr::Vfunc3<A1, A2, A3> *representation)
...
template <class A1, class A2, class A3>
inline Vfunc3<A1, A2, A3>::Vfunc3(const Vfunc3& functionObject)
...
template <class A1, class A2, class A3>
inline void Vfunc3<A1, A2, A3>::operator()(const A1& argument1,
                                                const A2& argument2,
                                                const A3& argument3) const
{
...
template <class A1, class A2, class A3>
inline bdlfxxx::Vfunc3<A1, A2, A3>::operator const void *() const
{
    return d_rep_p;
}
