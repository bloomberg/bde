...
//                              Overview
//                              --------
// The 'bdlfxxx::Vfunc2' class holds a pointer to an instance of a 'bdlfxxxr::Vfunc2'
// (an abstract class), and manipulates it appropriately.  Our main objective
// is to make sure that the 'bdlfxxxr::Vfunc2' object is initialized correctly and
// that its integer data (the reference count) is modified by the methods of
// 'bdlfxxx::Vfunc2' as expected.
//
...
//
//-----------------------------------------------------------------------------
// [ 1] bdlfxxx::Vfunc2<A1-2>();
// [ 1] bdlfxxx::Vfunc2<A1-2>(bdlfxxxr::Vfunc2<A1-2> *);
// [ 1] bdlfxxx::Vfunc2<A1-2>(const bdlfxxx::Vfunc2<A1-2>&);
// [ 1] ~bdlfxxx::Vfunc2<A1-2>();
// [ 2] bdlfxxx::Vfunc2<A1-2>& operator=(const bdlfxxx::Vfunc2<A1-2>&);
...
class FunctorRep : public bdlfxxxr::Vfunc2<A1, A2> {
...
//-----------------------------------------------------------------------------
    ...
    typedef bdlfxxxr::Vfunc2<int *, int *> ObjRep;
    typedef bdlfxxx::Vfunc2<int *, int *> Obj;
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 2: {
        ...
        //       const A2&) const'
        //    2. A new object shares a 'bdlfxxxr::Vfunc2' object with its "right
        ...
        //   'bdlfxxxr::Vfunc2<A1, A2> *' object 'R'.  Call the constructor to
        //   create 'bdlfxxx::Vfunc2' objects 'Obj2' and 'Obj3' using 'R'.
        ...
        //    3c. N/A.
        //
        //   Create the 'bdlfxxxr::Vfunc2<A1, A2> *' object.  Call the constructor
        //   to create the 'bdlfxxx::Vfunc2' object 'Obj1'.
        ...
        //        to verify that 'Obj1' and 'Obj2' use the same 'bdlfxxxr::Vfunc2'
        //        object.
        //    3d. Check the reference counter using the 'getCount' function.
        //        Create another object and check it again.
        //
        //   Create two 'bdlfxxxr::Vfunc2<A1, A2> *' objects 'R1' and 'R2'.  Create
        //   two 'bdlfxxx::Vfunc2' objects 'Obj1' and 'Obj2' using 'R1' and 'R2',
        //   respectively.
        ...
        //        to verify that 'Obj2' and 'Obj3' use the same 'bdlfxxxr::Vfunc2'
        //        object.
        //    3e. Check the reference counter using the 'getCount' function
        //        before and after the assignment for both 'Obj1' and 'Obj2'
        //        representations.
        //
        //   Create a 'bdlfxxxr::Vfunc2<A1, A2> *' object.  Call the constructor to
        //   create a 'bdlfxxx::Vfunc2' object 'Obj1'.
        ...
        //
        // Testing:
        //   bdlfxxx::Vfunc2<A1-2>& operator=(const bdlfxxx::Vfunc2<A1-2>&);
        // --------------------------------------------------------------------
      ...
      case 1: {
        ...
        //    b. constructor taking a pointer to a 'bdlfxxxr::Vfunc2' object
        //    c. copy constructor
        //
        ...
        //    6. The 'bdlfxxxr::Vfunc2<A1, A2>' object is destroyed when the
        ...
        //       'operator const void *() const'.
        //
        //   1b. Create the 'bdlfxxxr::Vfunc2<A1, A2> *' object.  Call the
        ...
        //       'bdlfxxxr::Vfunc2<A1, A2> *' object.  Verify that the reference
        ...
        //       to verify that both 'bdlfxxx::Vfunc2' objects use the same
        //       'bdlfxxxr::Vfunc2' object.
        ...
        //
        // Testing:
        //   bdlfxxx::Vfunc2(const bdlfxxx::Vfunc2 &rhs);
        // --------------------------------------------------------------------
                          ...
                          << "==============================" << endl;
        {
            ...
            if (verbose)
                cout << "\nTesting Constructor Taking '*bdlfxxxr::Vfunc2'."
                     << endl;
