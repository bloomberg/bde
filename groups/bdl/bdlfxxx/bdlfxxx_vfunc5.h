...
#define INCLUDED_BDLFXXX_VFUNC5
...
//
//@CLASSES:
//   bdlfxxx::Vfunc5: signature-specific function object (functor)
//
...
//
// The 'bdlfxxx::Vfunc5' functor (envelope) holds a polymorphic, reference-counted,
...
// signature and (2) the supplied user data.  See the 'bdlfxxxu_vfunc5' component
// for more information on populating 'bdlfxxx::Vfunc5' function objects with
...
class Vfunc5 {
  ...
  public:
    ...
    Vfunc5(bdlfxxxr::Vfunc5<A1, A2, A3, A4, A5> *representation);  // IMPLICIT
        ...
        // components (see 'bdlfxxxu_vfunc5') to create an appropriate
        // representation and load it into an existing functor.

    Vfunc5(const Vfunc5& functionObject);
    ...
    ~Vfunc5();
        ...
        // the static 'deleteObject' method of 'bdlfxxxr::Vfunc5' base class).

    // MANIPULATORS
    Vfunc5<A1, A2, A3, A4, A5>& operator=(
                                            const Vfunc5& functionObject);
        ...
        // 'deleteObject' method of 'bdlfxxxr::Vfunc5' base class.
...
Vfunc5<A1, A2, A3, A4, A5>::Vfunc5(
    bdlfxxxr::Vfunc5<A1, A2, A3, A4, A5> *representation)
...
inline Vfunc5<A1, A2, A3, A4, A5>::~Vfunc5()
{
    if (d_rep_p && 0 == d_rep_p->decrement()) {
        bdlfxxxr::Vfunc5<A1, A2, A3, A4, A5>::deleteObject(d_rep_p);
    }
}

template <class A1, class A2, class A3, class A4, class A5> inline
Vfunc5<A1, A2, A3, A4, A5>&
Vfunc5<A1, A2, A3, A4, A5>::operator=(const Vfunc5& functionObject)
{
...
template <class A1, class A2, class A3, class A4, class A5>
inline bdlfxxx::Vfunc5<A1, A2, A3, A4, A5>::operator const void *() const
{
    return d_rep_p;
}
