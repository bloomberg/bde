...
//                              Overview
//                              --------
// The 'bdlfxxx::Vfunc5' class holds a pointer to an instance of a 'bdlfxxxr::Vfunc5'
// (an abstract class), and manipulates it appropriately.  Our main objective
// is to make sure that the 'bdlfxxxr::Vfunc5' object is initialized correctly and
// that its integer data (the reference count) is modified by the methods of
// 'bdlfxxx::Vfunc5' as expected.
//
...
//
//-----------------------------------------------------------------------------
// [ 1] bdlfxxx::Vfunc5<A1-5>();
// [ 1] bdlfxxx::Vfunc5<A1-5>(bdlfxxxr::Vfunc5<A1-5> *);
// [ 1] bdlfxxx::Vfunc5<A1-5>(const bdlfxxx::Vfunc5<A1-5>&);
// [ 1] ~bdlfxxx::Vfunc5<A1-5>();
// [ 2] bdlfxxx::Vfunc5<A1-5>& operator=(const bdlfxxx::Vfunc5<A1-5>&);
...
class FunctorRep : public bdlfxxxr::Vfunc5<A1, A2, A3, A4, A5> {
...
//-----------------------------------------------------------------------------
    ...
    typedef bdlfxxxr::Vfunc5<int *, int *, int *, int *, int *> ObjRep;
    typedef bdlfxxx::Vfunc5<int *, int *, int *, int *, int *> Obj;
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 2: {
        ...
        //    2. A new object shares a 'bdlfxxxr::Vfunc5' object with its "right
        ...
        //   'bdlfxxxr::Vfunc5<A1, A2, A3, A4, A5> *' object 'R'.  Call the
        //   constructor to create 'bdlfxxx::Vfunc5' objects 'Obj2' and 'Obj3'
        //   using 'R'.
        ...
        //    3c. N/A.
        //
        //   Create the 'bdlfxxxr::Vfunc5<A1, A2, A3, A4, A5> *' object.  Call the
        //   constructor to create the 'bdlfxxx::Vfunc5' object 'Obj1'.
        ...
        //        to verify that 'Obj1' and 'Obj2' use the same 'bdlfxxxr::Vfunc5'
        //        object.
        //    3d. Check the reference counter using the 'getCount' function.
        //        Create another object and check it again.
        //
        //   Create two 'bdlfxxxr::Vfunc5<A1, A2, A3, A4, A5> *' objects 'R1' and
        //   'R2'.  Create two 'bdlfxxx::Vfunc5' objects 'Obj1' and 'Obj2' using
        ...
        //        to verify that 'Obj2' and 'Obj3' use the same 'bdlfxxxr::Vfunc5'
        //        object.
        //    3e. Check the reference counter using the 'getCount' function
        //        before and after the assignment for both 'Obj1' and 'Obj2'
        //        representations.
        //
        //   Create a 'bdlfxxxr::Vfunc5<A1, A2, A3, A4, A5> *' object.  Call the
        //   constructor to create a 'bdlfxxx::Vfunc5' object 'Obj1'.
        ...
        //
        // Testing:
        //   bdlfxxx::Vfunc5<A1-5>& operator=(const bdlfxxx::Vfunc5<A1-5>&);
        // --------------------------------------------------------------------
      ...
      case 1: {
        ...
        //    b. constructor taking a pointer to a 'bdlfxxxr::Vfunc5' object
        //    c. copy constructor
        //
        ...
        //    6. The 'bdlfxxxr::Vfunc5<A1, A2, A3, A4, A5>' object
        ...
        //       'operator const void *() const'.
        //
        //   1b. Create the 'bdlfxxxr::Vfunc5<A1, A2, A3, A4, A5> *' object.
        ...
        //       'bdlfxxxr::Vfunc5<A1, A2, A3, A4, A5> *' object.  Verify that the
        ...
        //       to verify that both 'bdlfxxx::Vfunc5' objects use the same
        //       'bdlfxxxr::Vfunc5' object.
        ...
        //
        // Testing:
        //   bdlfxxx::Vfunc5(const bdlfxxx::Vfunc5 &rhs);
        // --------------------------------------------------------------------
                          ...
                          << "==============================" << endl;
        {
            ...
            if (verbose)
                cout << "\nTesting Constructor Taking '*bdlfxxxr::Vfunc5'."
                     << endl;
