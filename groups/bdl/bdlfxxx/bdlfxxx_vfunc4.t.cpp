...
//                              Overview
//                              --------
// The 'bdlfxxx::Vfunc4' class holds a pointer to an instance of a 'bdlfxxxr::Vfunc4'
// (an abstract class), and manipulates it appropriately.  Our main objective
// is to make sure that the 'bdlfxxxr::Vfunc4' object is initialized correctly and
// that its integer data (the reference count) is modified by the methods of
// 'bdlfxxx::Vfunc4' as expected.
//
...
//
//-----------------------------------------------------------------------------
// [ 1] bdlfxxx::Vfunc4<A1-4>();
// [ 1] bdlfxxx::Vfunc4<A1-4>(bdlfxxxr::Vfunc4<A1-4> *);
// [ 1] bdlfxxx::Vfunc4<A1-4>(const bdlfxxx::Vfunc4<A1-4>&);
// [ 1] ~bdlfxxx::Vfunc4<A1-4>();
// [ 2] bdlfxxx::Vfunc4<A1-4>& operator=(const bdlfxxx::Vfunc4<A1-4>&);
...
class FunctorRep : public bdlfxxxr::Vfunc4<A1, A2, A3, A4> {
...
//-----------------------------------------------------------------------------
    ...
    typedef bdlfxxxr::Vfunc4<int *, int *, int *, int *> ObjRep;
    typedef bdlfxxx::Vfunc4<int *, int *, int *, int *> Obj;
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 2: {
        ...
        //    2. A new object shares a 'bdlfxxxr::Vfunc4' object with its "right
        ...
        //   'bdlfxxxr::Vfunc4<A1, A2, A3, A4> *' object 'R'.  Call the
        //   constructor to create 'bdlfxxx::Vfunc4' objects 'Obj2' and 'Obj3'
        //   using 'R'.
        ...
        //    3c. N/A.
        //
        //   Create the 'bdlfxxxr::Vfunc4<A1, A2, A3, A4> *' object.  Call the
        //   constructor to create the 'bdlfxxx::Vfunc4' object 'Obj1'.
        ...
        //        to verify that 'Obj1' and 'Obj2' use the same 'bdlfxxxr::Vfunc4'
        //        object.
        //    3d. Check the reference counter using the 'getCount' function.
        //        Create another object and check it again.
        //
        //   Create two 'bdlfxxxr::Vfunc4<A1, A2, A3, A4> *' objects 'R1' and 'R2'.
        //   Create two 'bdlfxxx::Vfunc4' objects 'Obj1' and 'Obj2' using 'R1'
        //   and 'R2', respectively.
        ...
        //        to verify that 'Obj2' and 'Obj3' use the same 'bdlfxxxr::Vfunc4'
        //        object.
        //    3e. Check the reference counter using the 'getCount' function
        //        before and after the assignment for both 'Obj1' and 'Obj2'
        //        representations.
        //
        //   Create a 'bdlfxxxr::Vfunc4<A1, A2, A3, A4> *' object.  Call the
        //   constructor to create a 'bdlfxxx::Vfunc4' object 'Obj1'.
        ...
        //
        // Testing:
        //   bdlfxxx::Vfunc4<A1-4>& operator=(const bdlfxxx::Vfunc4<A1-4>&);
        // --------------------------------------------------------------------
      ...
      case 1: {
        ...
        //    b. constructor taking a pointer to a 'bdlfxxxr::Vfunc4' object
        //    c. copy constructor
        //
        ...
        //    6. The 'bdlfxxxr::Vfunc4<A1, A2, A3, A4>' object
        ...
        //       'operator const void *() const'.
        //
        //   1b. Create the 'bdlfxxxr::Vfunc4<A1, A2, A3, A4> *' object.  Call the
        ...
        //       'bdlfxxxr::Vfunc4<A1, A2, A3, A4> *' object.  Verify that the
        ...
        //       to verify that both 'bdlfxxx::Vfunc4' objects use the same
        //       'bdlfxxxr::Vfunc4' object.
        ...
        //
        // Testing:
        //   bdlfxxx::Vfunc4(const bdlfxxx::Vfunc4 &rhs);
        // --------------------------------------------------------------------
                          ...
                          << "==============================" << endl;
        {
            ...
            if (verbose)
                cout << "\nTesting Constructor Taking '*bdlfxxxr::Vfunc4'."
                     << endl;
