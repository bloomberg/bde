// bdlfxxx_vfunc2.h                                                   -*-C++-*-
#ifndef INCLUDED_BDLFXXX_VFUNC2
#define INCLUDED_BDLFXXX_VFUNC2
...
//
//@CLASSES:
//   bdlfxxx::Vfunc2: signature-specific function object (functor)
//
...
//
// The 'bdlfxxx::Vfunc2' functor (envelope) holds a polymorphic, reference-counted,
...
// signature and (2) the supplied user data.  See the 'bdlfxxxu_vfunc2' component
// for more information on populating 'bdlfxxx::Vfunc2' function objects with
...
//..
//   class MyGuiButton  {
//       bdlfxxx::Vfunc2<MyGuiContext *, MyGuiLocation> d_callback;
//           // Functor to execute when button is pressed.
//
//     public:
//       MyGuiButton(const bdlfxxx::Vfunc2<MyGuiContext *,
...
//   };
//
//   MyGuiButton::MyGuiButton(const bdlfxxx::Vfunc2<MyGuiContext *,
//                            MyGuiLocation>& buttonPressCallback)
...
// 'bdlfxxx::Vfunc2' class specifies the number of required arguments).  However,
...
//   }
//..
// The 'bdlfxxx::Vfunc2<MyGuiContext, MyGuiLocation>' class used in 'MyGuiButton'
// class has a private member of an abstract class 'bdlfxxxr_vfunc2', whose
// 'execute' method is called when the functor is being called.  The 'execute'
// method of the 'bdlfxxxr_vfunc2' class, the functor invocation operator of the
// 'bdlfxxx::Vfunc2' class, and the 'pressButton' method of 'MyGuiButton' class
...
// signature the user implements a concrete class derived from 'bdlfxxxr_vfunc2'
// as follows:
//..
//   template <class F, class A1, class A2, class D1>
//   class FuncRep : public bdlfxxxr::Vfunc2<A1, A2> {
...
//   int globalCounter = 0;
//
//   bdlfxxxr::Vfunc2<MyGuiContext *, MyGuiLocation>  *rep = new(*myAllocator)
...
//
//   bdlfxxx::Vfunc2<MyGuiContext *, MyGuiLocation> callbackFunctor(rep);
//
...
class Vfunc2 {
    ...
    bdlfxxxr::Vfunc2<A1, A2> *d_rep_p;  // polymorphic functor representation
  ...
  public:
    ...
    Vfunc2(bdlfxxxr::Vfunc2<A1, A2> *representation);              // IMPLICIT
        ...
        // components (see 'bdlfxxxu_vfunc2') to create an appropriate
        // representation and load it into an existing functor.

    Vfunc2(const Vfunc2& functionObject);
    ...
    ~Vfunc2();
        ...
        // the static 'deleteObject' method of 'bdlfxxxr::Vfunc2' base class).

    // MANIPULATORS
    Vfunc2<A1, A2>& operator=(const Vfunc2& functionObject);
        ...
        // 'deleteObject' method of 'bdlfxxxr::Vfunc2' base class.
...
template <class A1, class A2>
inline Vfunc2<A1, A2>::Vfunc2(bdlfxxxr::Vfunc2<A1, A2> *representation)
...
template <class A1, class A2>
inline Vfunc2<A1, A2>::Vfunc2(const Vfunc2& functionObject)
...
inline Vfunc2<A1, A2>::~Vfunc2()
{
    if (d_rep_p && 0 == d_rep_p->decrement()) {
        bdlfxxxr::Vfunc2<A1, A2>::deleteObject(d_rep_p);
    }
}
...
template <class A1, class A2>
inline bdlfxxx::Vfunc2<A1, A2>::operator const void *() const
{
    return d_rep_p;
}
