...
//                              Overview
//                              --------
// The 'bdlfxxx::Vfunc1' class holds a pointer to an instance of a 'bdlfxxxr::Vfunc1'
// (an abstract class), and manipulates it appropriately.  Our main objective
// is to make sure that the 'bdlfxxxr::Vfunc1' object is initialized correctly and
// that its integer data (the reference count) is modified by the methods of
// 'bdlfxxx::Vfunc1' as expected.
//
...
//-----------------------------------------------------------------------------
// [ 1] bdlfxxx::Vfunc1<A1>();
// [ 1] bdlfxxx::Vfunc1<A1>(bdlfxxxr::Vfunc1<A1> *);
// [ 1] bdlfxxx::Vfunc1<A1>(const bdlfxxx::Vfunc1<A1>&);
// [ 1] ~bdlfxxx::Vfunc1<A1>();
// [ 2] bdlfxxx::Vfunc1<A1>& operator=(const bdlfxxx::Vfunc1<A1>&);
...
class FunctorRep : public bdlfxxxr::Vfunc1<A1> {
...
//-----------------------------------------------------------------------------
    ...
    typedef bdlfxxxr::Vfunc1<int *> ObjRep;
    typedef bdlfxxx::Vfunc1<int *> Obj;
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 2: {
        ...
        //    2. A new object shares a 'bdlfxxxr::Vfunc1' object with its "right
        ...
        //   'bdlfxxxr::Vfunc1<A1> *' object 'R'.  Call the constructor to
        //   create 'bdlfxxx::Vfunc1' objects 'Obj2' and 'Obj3' using 'R'.
        ...
        //    3c. N/A.
        //
        //   Create the 'bdlfxxxr::Vfunc1<A1> *' object.  Call the constructor
        //   to create the 'bdlfxxx::Vfunc1' object 'Obj1'.
        ...
        //        to verify that 'Obj1' and 'Obj2' use the same 'bdlfxxxr::Vfunc1'
        //        object.
        //    3d. Check the reference counter using the 'getCount' function.
        //        Create another object and check it again.
        //
        //   Create two 'bdlfxxxr::Vfunc1<A1> *' objects 'R1' and 'R2'.  Create
        //   two 'bdlfxxx::Vfunc1' objects 'Obj1' and 'Obj2' using 'R1' and 'R2',
        //   respectively.
        ...
        //        to verify that 'Obj2' and 'Obj3' use the same 'bdlfxxxr::Vfunc1'
        //        object.
        //    3e. Check the reference counter using the 'getCount' function
        //        before and after the assignment for both 'Obj1' and 'Obj2'
        //        representations.
        //
        //   Create a 'bdlfxxxr::Vfunc1<A1> *' object.  Call the constructor to
        //   create a 'bdlfxxx::Vfunc1' object 'Obj1'.
        ...
        //
        // Testing:
        //   bdlfxxx::Vfunc1<A1>& operator=(const bdlfxxx::Vfunc1<A1>&);
        // --------------------------------------------------------------------
      ...
      case 1: {
        ...
        //    b. constructor taking a pointer to a 'bdlfxxxr::Vfunc1' object
        //    c. copy constructor
        //
        ...
        //    6. The 'bdlfxxxr::Vfunc1<A1>' object is destroyed when the
        ...
        //       'operator const void *() const'.
        //
        //   1b. Create the 'bdlfxxxr::Vfunc1<A1> *' object.  Call the
        ...
        //       'bdlfxxxr::Vfunc1<A1> *' object.  Verify that the reference
        ...
        //       to verify that both 'bdlfxxx::Vfunc1' objects use the same
        //       'bdlfxxxr::Vfunc1' object.
        ...
        //
        // Testing:
        //   bdlfxxx::Vfunc1(const bdlfxxx::Vfunc1 &rhs);
        // --------------------------------------------------------------------
                          ...
                          << "==============================" << endl;
        {
            ...
            if (verbose)
                cout << "\nTesting Constructor Taking '*bdlfxxxr::Vfunc1'."
                     << endl;
