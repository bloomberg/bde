...
//                              Overview
//                              --------
// The 'bdlfxxx::Vfunc0' class holds a pointer to an instance of a 'bdlfxxxr::Vfunc0'
// (an abstract class), and manipulates it appropriately.  Our main objective
// is to make sure that the 'bdlfxxxr::Vfunc0' object is initialized correctly and
// that its integer data (the reference count) is modified by the methods of
// 'bdlfxxx::Vfunc0' as expected.
//
...
//-----------------------------------------------------------------------------
// [ 1] bdlfxxx::Vfunc0();
// [ 1] bdlfxxx::Vfunc0(bdlfxxxr::Vfunc0 *);
// [ 1] bdlfxxx::Vfunc0(const bdlfxxx::Vfunc0&);
// [ 1] ~bdlfxxx::Vfunc0();
// [ 2] bdlfxxx::Vfunc0& operator=(const bdlfxxx::Vfunc0&);
...
class FunctorRep : public bdlfxxxr::Vfunc0 {
...
//-----------------------------------------------------------------------------
    ...
    typedef bdlfxxxr::Vfunc0 ObjRep;
    typedef bdlfxxx::Vfunc0 Obj;
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 2: {
        ...
        //    2. A new object shares a 'bdlfxxxr::Vfunc0' object with its "right
        ...
        //   'bdlfxxxr::Vfunc0 *' object 'R'.  Call the constructor to create
        //   'bdlfxxx::Vfunc0' objects 'Obj2' and 'Obj3' using 'R'.
        ...
        //    3c. N/A.
        //
        //   Create the 'bdlfxxxr::Vfunc0 *' object.  Call the constructor to
        //   create the 'bdlfxxx::Vfunc0' object 'Obj1'.
        ...
        //        to verify that 'Obj1' and 'Obj2' use the same 'bdlfxxxr::Vfunc0'
        //        object.
        //    3d. Check the reference counter using the 'getCount' function.
        //        Create another object and check it again.
        //
        //   Create two 'bdlfxxxr::Vfunc0 *' objects 'R1' and 'R2'.  Create two
        //   'bdlfxxx::Vfunc0' objects 'Obj1' and 'Obj2' using 'R1' and 'R2',
        //   respectively.
        ...
        //        to verify that 'Obj2' and 'Obj3' use the same 'bdlfxxxr::Vfunc0'
        //        object.
        //    3e. Check the reference counter using the 'getCount' function
        //        before and after the assignment for both 'Obj1' and 'Obj2'
        //        representations.
        //
        //   Create a 'bdlfxxxr::Vfunc0 *' object.  Call the constructor to create
        //   a 'bdlfxxx::Vfunc0' object 'Obj1'.
        ...
        //
        // Testing:
        //   bdlfxxx::Vfunc0& operator=(const bdlfxxx::Vfunc0&);
        // --------------------------------------------------------------------
      ...
      case 1: {
        ...
        //    b. constructor taking a pointer to a 'bdlfxxxr::Vfunc0' object
        //    c. copy constructor
        //
        ...
        //    6. The 'bdlfxxxr::Vfunc0' object is destroyed when the
        ...
        //       'operator const void *() const'.
        //
        //   1b. Create the 'bdlfxxxr::Vfunc0 *' object.  Call the
        ...
        //       'bdlfxxxr::Vfunc0 *' object.  Verify that the reference counter
        //       is incremented.
        //
        ...
        //       to verify that both 'bdlfxxx::Vfunc0' objects use the same
        //       'bdlfxxxr::Vfunc0' object.
        ...
        //
        // Testing:
        //   bdlfxxx::Vfunc0(const bdlfxxx::Vfunc0 &rhs);
        // --------------------------------------------------------------------
                          ...
                          << "==============================" << endl;
        {
            ...
            if (verbose)
                cout << "\nTesting Constructor Taking '*bdlfxxxr::Vfunc0'."
                     << endl;
