...
#define INCLUDED_BDLFXXX_VFUNC1
...
//
//@CLASSES:
//   bdlfxxx::Vfunc1: signature-specific function object (functor)
//
...
//
// The 'bdlfxxx::Vfunc1' functor (envelope) holds a polymorphic, reference-counted,
...
// signature and (2) the supplied user data.  See the 'bdlfxxxu_vfunc1' component
// for more information on populating 'bdlfxxx::Vfunc1' function objects with
...
//..
//   class MyGuiButton  {
//       bdlfxxx::Vfunc1<MyGuiContext *, MyGuiLocation> d_callback;
//           // Functor to execute when button is pressed.
//
//     public:
//       MyGuiButton(const bdlfxxx::Vfunc1<MyGuiContext *,
...
//   };
//
//   MyGuiButton::MyGuiButton(const bdlfxxx::Vfunc1<MyGuiContext *,
//                            MyGuiLocation>& buttonPressCallback)
...
// 'bdlfxxx::Vfunc1' class specifies the number of required arguments).  However,
...
//   }
//..
// The 'bdlfxxx::Vfunc1<MyGuiContext, MyGuiLocation>' class used in 'MyGuiButton'
// class has a private member of an abstract class 'bdlfxxxr_vfunc1', whose
// 'execute' method is called when the functor is being called.  The 'execute'
// method of the 'bdlfxxxr_vfunc1' class, the functor invocation operator of the
// 'bdlfxxx::Vfunc1' class, and the 'pressButton' method of 'MyGuiButton' class
...
// signature the user implements a concrete class derived from 'bdlfxxxr_vfunc1'
// as follows:
//..
//   template <class F, class A1, class D1>
//   class FuncRep : public bdlfxxxr::Vfunc1<A1> {
...
//   int globalCounter = 0;
//
//   bdlfxxxr::Vfunc1<MyGuiContext *, MyGuiLocation>  *rep = new(myAllocator)
...
//
//   bdlfxxx::Vfunc1<MyGuiContext *, MyGuiLocation> callbackFunctor(rep);
//
...
class Vfunc1 {
  ...
  private:
    // NOT IMPLEMENTED
    bool operator==(const Vfunc1&) const;
    bool operator!=(const Vfunc1&) const;

    template<class B1>
    bool operator==(const Vfunc1<B1>&) const;
    template<class B1>
    bool operator!=(const Vfunc1<B1>&) const;
  ...
  public:
    ...
    Vfunc1(bdlfxxxr::Vfunc1<A1> *representation);                  // IMPLICIT
        ...
        // components (see 'bdlfxxxu_vfunc1') to create an appropriate
        // representation and load it into an existing functor.

    Vfunc1(const Vfunc1& functionObject);
    ...
    ~Vfunc1();
        ...
        // the static 'deleteObject' method of 'bdlfxxxr::Vfunc1' base class).

    // MANIPULATORS
    Vfunc1<A1>& operator=(const Vfunc1& functionObject);
        ...
        // 'deleteObject' method of 'bdlfxxxr::Vfunc1' base class.
...
template <class A1>
inline Vfunc1<A1>::Vfunc1(bdlfxxxr::Vfunc1<A1> *representation)
...
template <class A1>
inline Vfunc1<A1>::Vfunc1(const Vfunc1& functionObject)
...
template <class A1>
inline void Vfunc1<A1>::operator()(const A1& argument1) const
{
...
template <class A1>
inline bdlfxxx::Vfunc1<A1>::operator const void *() const
{
    return d_rep_p;
}
