...
#define INCLUDED_BDLFXXX_VFUNC0
...
//
//@CLASSES:
//   bdlfxxx::Vfunc0: signature-specific function object (functor)
//
...
//
// The 'bdlfxxx::Vfunc0' functor (envelope) holds a polymorphic, reference-counted,
...
// signature and (2) the supplied user data.  See the 'bdlfxxxu_vfunc0' component
// for more information on populating 'bdlfxxx::Vfunc0' function objects with
...
class Vfunc0 {
    ...
    bdlfxxxr::Vfunc0 *d_rep_p;  // polymorphic functor representation
  ...
  public:
    ...
    Vfunc0(bdlfxxxr::Vfunc0 *representation);                      // IMPLICIT
        ...
        // components (see 'bdlfxxxu_vfunc0') to create an appropriate
    ...
    ~Vfunc0();
        ...
        // the static 'deleteObject' method of 'bdlfxxxr::Vfunc0' base class).
    ...
    Vfunc0& operator=(const Vfunc0& functionObject);
        ...
        // 'deleteObject' method of 'bdlfxxxr::Vfunc0' base class.
...
inline Vfunc0::Vfunc0(bdlfxxxr::Vfunc0 *representation)
...
inline Vfunc0::Vfunc0(const Vfunc0& functionObject)
...
inline Vfunc0& Vfunc0::operator=(const Vfunc0& functionObject)
{
...
inline bdlfxxx::Vfunc0::operator const void *() const
{
    return d_rep_p;
}
