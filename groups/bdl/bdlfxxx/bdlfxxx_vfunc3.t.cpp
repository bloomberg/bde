// bdlfxxx_vfunc3.t.cpp                                                  -*-C++-*-

#include <bdlfxxx_vfunc3.h>
...
//                              Overview
//                              --------
// The 'bdlfxxx::Vfunc3' class holds a pointer to an instance of a 'bdlfxxxr::Vfunc3'
// (an abstract class), and manipulates it appropriately.  Our main objective
// is to make sure that the 'bdlfxxxr::Vfunc3' object is initialized correctly and
// that its integer data (the reference count) is modified by the methods of
// 'bdlfxxx::Vfunc3' as expected.
//
...
//
//-----------------------------------------------------------------------------
// [ 1] bdlfxxx::Vfunc3<A1-3>();
// [ 1] bdlfxxx::Vfunc3<A1-3>(bdlfxxxr::Vfunc3<A1-3> *);
// [ 1] bdlfxxx::Vfunc3<A1-3>(const bdlfxxx::Vfunc3<A1-3>&);
// [ 1] ~bdlfxxx::Vfunc3<A1-3>();
// [ 2] bdlfxxx::Vfunc3<A1-3>& operator=(const bdlfxxx::Vfunc3<A1-3>&);
...
class FunctorRep : public bdlfxxxr::Vfunc3<A1, A2, A3> {
...
//-----------------------------------------------------------------------------
    ...
    typedef bdlfxxxr::Vfunc3<int *, int *, int *> ObjRep;
    typedef bdlfxxx::Vfunc3<int *, int *, int *> Obj;
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 2: {
        ...
        //    2. A new object shares a 'bdlfxxxr::Vfunc3' object with its "right
        ...
        //   'bdlfxxxr::Vfunc3<A1, A2, A3> *' object 'R'.  Call the constructor to
        //   create 'bdlfxxx::Vfunc3' objects 'Obj2' and 'Obj3' using 'R'.
        ...
        //    3c. N/A.
        //
        //   Create the 'bdlfxxxr::Vfunc3<A1, A2, A3> *' object.  Call the
        //   constructor to create the 'bdlfxxx::Vfunc3' object 'Obj1'.
        ...
        //        to verify that 'Obj1' and 'Obj2' use the same 'bdlfxxxr::Vfunc3'
        //        object.
        //    3d. Check the reference counter using the 'getCount' function.
        //        Create another object and check it again.
        //
        //   Create two 'bdlfxxxr::Vfunc3<A1, A2, A3> *' objects 'R1' and 'R2'.
        //   Create two 'bdlfxxx::Vfunc3' objects 'Obj1' and 'Obj2' using 'R1' and
        //   'R2', respectively.
        ...
        //        to verify that 'Obj2' and 'Obj3' use the same 'bdlfxxxr::Vfunc3'
        //        object.
        //    3e. Check the reference counter using the 'getCount' function
        //        before and after the assignment for both 'Obj1' and 'Obj2'
        //        representations.
        //
        //   Create a 'bdlfxxxr::Vfunc3<A1, A2, A3> *' object.  Call the
        //   constructor to create a 'bdlfxxx::Vfunc3' object 'Obj1'.
        ...
        //
        // Testing:
        //   bdlfxxx::Vfunc3<A1-3>& operator=(const bdlfxxx::Vfunc3<A1-3>&);
        // --------------------------------------------------------------------
      ...
      case 1: {
        ...
        //    b. constructor taking a pointer to a 'bdlfxxxr::Vfunc3' object
        //    c. copy constructor
        //
        ...
        //    6. The 'bdlfxxxr::Vfunc3<A1, A2, A3>' object is destroyed when the
        ...
        //       'operator const void *() const'.
        //
        //   1b. Create the 'bdlfxxxr::Vfunc3<A1, A2, A3> *' object.  Call the
        ...
        //       'bdlfxxxr::Vfunc3<A1, A2, A3> *' object.  Verify that the
        ...
        //       to verify that both 'bdlfxxx::Vfunc3' objects use the same
        //       'bdlfxxxr::Vfunc3' object.
        ...
        //
        // Testing:
        //   bdlfxxx::Vfunc3(const bdlfxxx::Vfunc3 &rhs);
        // --------------------------------------------------------------------
                          ...
                          << "==============================" << endl;
        {
            ...
            if (verbose)
                cout << "\nTesting Constructor Taking '*bdlfxxxr::Vfunc3'."
                     << endl;
