...
#define INCLUDED_BDLFXXX_VFUNC4
...
//
//@CLASSES:
//   bdlfxxx::Vfunc4: signature-specific function object (functor)
//
...
//
// The 'bdlfxxx::Vfunc4' functor (envelope) holds a polymorphic, reference-counted,
...
// signature and (2) the supplied user data.  See the 'bdlfxxxu_vfunc4' component
// for more information on populating 'bdlfxxx::Vfunc4' function objects with
...
class Vfunc4 {
  ...
  public:
    ...
    Vfunc4(bdlfxxxr::Vfunc4<A1, A2, A3, A4> *representation);      // IMPLICIT
        ...
        // components (see 'bdlfxxxu_vfunc4') to create an appropriate
        // representation and load it into an existing functor.

    Vfunc4(const Vfunc4& functionObject);
    ...
    ~Vfunc4();
        ...
        // the static 'deleteObject' method of 'bdlfxxxr::Vfunc4' base class).

    // MANIPULATORS
    Vfunc4<A1, A2, A3, A4>& operator=(const Vfunc4& functionObject);
        ...
        // 'deleteObject' method of 'bdlfxxxr::Vfunc4' base class.
...
Vfunc4<A1, A2, A3, A4>::Vfunc4(
    bdlfxxxr::Vfunc4<A1, A2, A3, A4> *representation)
...
template <class A1, class A2, class A3, class A4>
inline
Vfunc4<A1, A2, A3, A4>::Vfunc4(const Vfunc4& functionObject)
...
inline Vfunc4<A1, A2, A3, A4>::~Vfunc4()
{
    if (d_rep_p && 0 == d_rep_p->decrement()) {
        bdlfxxxr::Vfunc4<A1, A2, A3, A4>::deleteObject(d_rep_p);
    }
}
...
template <class A1, class A2, class A3, class A4>
inline bdlfxxx::Vfunc4<A1, A2, A3, A4>::operator const void *() const
{
    return d_rep_p;
}
