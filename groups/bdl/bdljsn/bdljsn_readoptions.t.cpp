...
// ----------------------------------------------------------------------------
// CREATORS
// [ 2] bdljsn::ReadOptions();
// [ 7] bdljsn::ReadOptions(const bdljsn::ReadOptions & o);
// [ 2] bdljsn::~ReadOptions();
//
// MANIPULATORS
...
//
// FREE OPERATORS
// [ 6] bool operator==(const bdljsn::ReadOptions & lhs, rhs);
// [ 6] bool operator!=(const bdljsn::ReadOptions & lhs, rhs);
// [ 5] operator<<(ostream& s, const bdljsn::ReadOptions & d);
// ----------------------------------------------------------------------------
// [ 1] BREATHING TEST
// [10] USAGE EXAMPLE
...
typedef bdljsn::ReadOptions                     Obj;
...
// ```
      ...
      case 7: {
        ...
        //
        // Testing:
        //   bdljsn::ReadOptions(const bdljsn::ReadOptions & o);
        // --------------------------------------------------------------------
        ...
        for (int ti = 0; ti < NUM_DATA; ++ti) {
            ...
            const int   DEPTH   = DATA[ti].d_maxNestedDepth;

            Obj mZ;  const Obj& Z = mZ;
            mZ.setMaxNestedDepth(DEPTH);

            Obj mZZ;  const Obj& ZZ = mZZ;
            mZZ.setMaxNestedDepth(DEPTH);
      ...
      case 6: {
        ...
        //
        // Testing:
        //   bool operator==(const bdljsn::ReadOptions & lhs, rhs);
        //   bool operator!=(const bdljsn::ReadOptions & lhs, rhs);
        // --------------------------------------------------------------------
      ...
      case 5: {
        ...
        //   operator<<(ostream& s, const bdljsn::ReadOptions & d);
        // --------------------------------------------------------------------
