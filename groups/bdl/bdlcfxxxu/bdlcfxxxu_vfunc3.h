// bdlcfxxxu_vfunc3.h                  -*-C++-*-
#ifndef INCLUDED_BDLCFXXXU_VFUNC3
#define INCLUDED_BDLCFXXXU_VFUNC3
...
//
//@CLASSES:
//   bdlcfxxxu::Vfunc3: namespace for factory methods loading 3-arg void functors
//
...
//..
//   bdlcfxxxu::Vfunc3::makeF:    Initialize the functor by embedding a function
//                           (or another functor) and any additional trailing
//                           arguments.
//
//   bdlcfxxxu::Vfunc3::makeC:    Initialize the functor by embedding an object, one
//                           of that object's 'const' methods, and any
//                           additional trailing arguments for that method.
//
//   bdlcfxxxu::Vfunc3::makeM:    Initialize the functor by embedding THE ADDRESS OF
...
//
//   bdlcfxxxu::Vfunc3::makeNull: Initialize the functor with an empty function.
//..
...
#include <bdlcfxxx_vfunc3.h>
#endif

#ifndef INCLUDED_BDLCFXXXI_VFUNC3
#include <bdlcfxxxi_vfunc3.h>
#endif
...
struct Vfunc3 {
    ...
    static void makeNull(bdlcfxxx::Vfunc3<A1, A2, A3> *handle)
        ...
        // currently installed default allocator is used.
    {
        ...
        *handle = bdlcfxxx::Vfunc3<A1, A2, A3>(
            new(*ba) bdlcfxxxi::Vfunc3Null<A1, A2, A3>(ba));
    }

    template <class A1, class A2, class A3>
    static void makeNull(bslma::Allocator *basicAllocator,
                         bdlcfxxx::Vfunc3<A1, A2, A3> *handle)
        // Initialize the specified three-argument empty functor 'handle'.
        // Optionally specify, as the *first* argument, a 'basicAllocator' used
        // to supply memory.  If 'basicAllocator' is 0 or unspecified, the
        // currently installed default allocator is used.
    ...
    static void makeF(bdlcfxxx::Vfunc3<A1, A2, A3> *handle, F function)
        ...
        // unspecified, the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc3<A1, A2, A3>(
            new(*ba) bdlcfxxxi::Vfunc3F3<F, A1, A2, A3>(function, ba));
    }
    ...
    static void makeF(bdlcfxxx::Vfunc3<A1, A2, A3> *handle,
                      F                function,
        ...
        // unspecified, the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc3<A1, A2, A3>(
            new(*ba) bdlcfxxxi::Vfunc3F4<F, A1, A2, A3, D1> (
        ...
        // unspecified, the currently installed default allocator is used.
    {
        ...
        *handle = bdlcfxxx::Vfunc3<A1, A2, A3>(
            new(*ba) bdlcfxxxi::Vfunc3F5<F, A1, A2, A3, D1, D2>
        ...
        // unspecified, the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc3<A1, A2, A3>(
            new(*ba) bdlcfxxxi::Vfunc3F6<F, A1, A2, A3, D1, D2, D3>
        ...
        // unspecified, the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc3<A1, A2, A3>(
            new(*ba) bdlcfxxxi::Vfunc3F7<F, A1, A2, A3, D1, D2, D3, D4>
        ...
        // unspecified, the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc3<A1, A2, A3>(
            new(*ba) bdlcfxxxi::Vfunc3F8<F, A1, A2, A3, D1, D2, D3, D4, D5>
                (function, embeddedArg1, embeddedArg2, embeddedArg3,
        ...
        // unspecified, the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc3<A1, A2, A3>(
            new(*ba) bdlcfxxxi::Vfunc3F9<F, A1, A2, A3, D1, D2, D3, D4, D5, D6>
                (function, embeddedArg1, embeddedArg2, embeddedArg3,
    ...
    static void makeC(bdlcfxxx::Vfunc3<A1, A2, A3> *handle, const OBJ& object,
                      C                method)
        // Initialize the specified three-argument functor 'handle' by
        // embedding the specified 'function' (or functor) taking no additional
        // trailing arguments.  Optionally specify, as the *first* argument, a
        ...
        // unspecified, the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc3<A1, A2, A3>(
            new(*ba) bdlcfxxxi::Vfunc3C3<OBJ, C, A1, A2, A3>(object, method, ba));
    }
    ...
    static void makeC(bdlcfxxx::Vfunc3<A1, A2, A3> *handle,
                      const OBJ&       object,
                      C                method,
                      const D1&        embeddedArg1)
        // Initialize the specified three-argument functor 'handle' by
        ...
        // default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc3<A1, A2, A3>(
            new(*ba) bdlcfxxxi::Vfunc3C4<OBJ, C, A1, A2, A3, D1>(
        ...
        // unspecified, the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc3<A1, A2, A3>(
            new(*ba) bdlcfxxxi::Vfunc3C5<OBJ, C, A1, A2, A3, D1, D2>(
        ...
        // unspecified, the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc3<A1, A2, A3>(
            new(*ba) bdlcfxxxi::Vfunc3C6<OBJ, C, A1, A2, A3, D1, D2, D3>(
        ...
        // unspecified, the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc3<A1, A2, A3>(
            new(*ba) bdlcfxxxi::Vfunc3C7<OBJ, C, A1, A2, A3, D1, D2, D3, D4>(
        ...
        // unspecified, the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc3<A1, A2, A3>(
            new(*ba) bdlcfxxxi::Vfunc3C8<OBJ, C, A1, A2, A3, D1, D2, D3, D4, D5>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, ba));
    }
        ...
        // unspecified, the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc3<A1, A2, A3>(
           new(*ba) bdlcfxxxi::Vfunc3C9<OBJ, C, A1, A2, A3, D1, D2, D3, D4, D5, D6>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, embeddedArg6, ba));
    }
    ...
    static void makeM(bdlcfxxx::Vfunc3<A1, A2, A3> *handle, OBJ *object,
                      M                method)
        // Initialize the specified three-argument functor 'handle' by
        ...
        // unspecified, the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc3<A1, A2, A3>(
            new(*ba) bdlcfxxxi::Vfunc3M3<OBJ, M, A1, A2, A3>(object, method, ba));
    }
    ...
    static void makeM(bdlcfxxx::Vfunc3<A1, A2, A3> *handle,
                      OBJ             *object,
                      M                method,
                      const D1&        embeddedArg1)
        // Initialize the specified three-argument functor 'handle' by
        ...
        // default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc3<A1, A2, A3>(
            new(*ba) bdlcfxxxi::Vfunc3M4<OBJ, M, A1, A2, A3, D1>(
                object, method, embeddedArg1, ba));
    }
        ...
        // currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc3<A1, A2, A3>(
            new(*ba) bdlcfxxxi::Vfunc3M5<OBJ, M, A1, A2, A3, D1, D2>(
                object, method, embeddedArg1, embeddedArg2, ba));
    }
...
static void makeM(bdlcfxxx::Vfunc3<A1, A2, A3> *handle,
        ...
        // unspecified, the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc3<A1, A2, A3>(
            new(*ba) bdlcfxxxi::Vfunc3M6<OBJ, M, A1, A2, A3, D1, D2, D3>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3, ba));
    }
        ...
        // currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc3<A1, A2, A3>(
            new(*ba) bdlcfxxxi::Vfunc3M7<OBJ, M, A1, A2, A3, D1, D2, D3, D4>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, ba));
    }
        ...
        // currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc3<A1, A2, A3>(
            new(*ba) bdlcfxxxi::Vfunc3M8<OBJ, M, A1, A2, A3, D1, D2, D3, D4, D5>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, ba));
    }
        ...
        // currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc3<A1, A2, A3>(
           new(*ba) bdlcfxxxi::Vfunc3M9<OBJ, M, A1, A2, A3, D1, D2, D3, D4, D5, D6>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, embeddedArg6, ba));
    }
