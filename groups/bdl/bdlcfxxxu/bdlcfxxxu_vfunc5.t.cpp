// bdlcfxxxu_vfunc5.t.cpp              -*-C++-*-

#include <bdlcfxxxu_vfunc5.h>
...
//
//-----------------------------------------------------------------------------
// [ 9] makeF(         bdlcfxxx::Vfunc5<A1-5> *,       F, c_D1-4&);
// [ 9] makeC(         bdlcfxxx::Vfunc5<A1-5> *, c_O&, C, c_D1-4&);
// [ 9] makeM(         bdlcfxxx::Vfunc5<A1-5> *, OBJ*, M, c_D1-4&);
// [ 9] makeF(   bA *, bdlcfxxx::Vfunc5<A1-5> *,       F, c_D1-4&);
// [ 9] makeC(   bA *, bdlcfxxx::Vfunc5<A1-5> *, c_O&, C, c_D1-4&);
// [ 9] makeM(   bA *, bdlcfxxx::Vfunc5<A1-5> *, OBJ*, M, c_D1-4&);
// [ 8] makeF(         bdlcfxxx::Vfunc5<A1-5> *,       F, c_D1-3&);
// [ 8] makeC(         bdlcfxxx::Vfunc5<A1-5> *, c_O&, C, c_D1-3&);
// [ 8] makeM(         bdlcfxxx::Vfunc5<A1-5> *, OBJ*, M, c_D1-3&);
// [ 8] makeF(   bA *, bdlcfxxx::Vfunc5<A1-5> *,       F, c_D1-3&);
// [ 8] makeC(   bA *, bdlcfxxx::Vfunc5<A1-5> *, c_O&, C, c_D1-3&);
// [ 8] makeM(   bA *, bdlcfxxx::Vfunc5<A1-5> *, OBJ*, M, c_D1-3&);
// [ 7] makeF(         bdlcfxxx::Vfunc5<A1-5> *,       F, c_D1-2&);
// [ 7] makeC(         bdlcfxxx::Vfunc5<A1-5> *, c_O&, C, c_D1-2&);
// [ 7] makeM(         bdlcfxxx::Vfunc5<A1-5> *, OBJ*, M, c_D1-2&);
// [ 7] makeF(   bA *, bdlcfxxx::Vfunc5<A1-5> *,       F, c_D1-2&);
// [ 7] makeC(   bA *, bdlcfxxx::Vfunc5<A1-5> *, c_O&, C, c_D1-2&);
// [ 7] makeM(   bA *, bdlcfxxx::Vfunc5<A1-5> *, OBJ*, M, c_D1-2&);
// [ 6] makeF(         bdlcfxxx::Vfunc5<A1-5> *,       F, c_D1&);
// [ 6] makeC(         bdlcfxxx::Vfunc5<A1-5> *, c_O&, C, c_D1&);
// [ 6] makeM(         bdlcfxxx::Vfunc5<A1-5> *, OBJ*, M, c_D1&);
// [ 6] makeF(   bA *, bdlcfxxx::Vfunc5<A1-5> *,       F, c_D1&);
// [ 6] makeC(   bA *, bdlcfxxx::Vfunc5<A1-5> *, c_O&, C, c_D1&);
// [ 6] makeM(   bA *, bdlcfxxx::Vfunc5<A1-5> *, OBJ*, M, c_D1&);
// [ 5] makeF(         bdlcfxxx::Vfunc5<A1-5> *,       F);
// [ 5] makeC(         bdlcfxxx::Vfunc5<A1-5> *, c_O&, C);
// [ 5] makeM(         bdlcfxxx::Vfunc5<A1-5> *, OBJ*, M);
// [ 5] makeF(   bA *, bdlcfxxx::Vfunc5<A1-5> *,       F);
// [ 5] makeC(   bA *, bdlcfxxx::Vfunc5<A1-5> *, c_O&, C);
// [ 5] makeM(   bA *, bdlcfxxx::Vfunc5<A1-5> *, OBJ*, M);
// [ 5] makeNull(      bdlcfxxx::Vfunc5<A1-5> *);
// [ 5] makeNull(bA *, bdlcfxxx::Vfunc5<A1-5> *);
//-----------------------------------------------------------------------------
...
//       // that 'bcefi::vfunc5X4' classes pass when calling the callback
//       // function.
//       //
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      case 9: {
        ...
        //
        // Plan:
        //   Use each function to initialize a separate 'bdlcfxxx::Vfunc5' object
        //   with the 'checkArgumentValues' function, which verifies that the
        //   parameters are "wired" correctly.  Use each function to
        //   initialize 'bdlcfxxx::Vfunc5' object with the 'checkParameterTypes'
        ...
        //
        // Testing:
        //    makeF(      bdlcfxxx::Vfunc5<A1-5> *,        F, c_D1-4&);
        //    makeC(      bdlcfxxx::Vfunc5<A1-5> *, c_O&,  C, c_D1-4&);
        //    makeM(      bdlcfxxx::Vfunc5<A1-5> *, OBJ *, M, c_D1-4&);
        //    makeF(bA *, bdlcfxxx::Vfunc5<A1-5> *,        F, c_D1-4&);
        //    makeC(bA *, bdlcfxxx::Vfunc5<A1-5> *, c_O&,  C, c_D1-4&);
        //    makeM(bA *, bdlcfxxx::Vfunc5<A1-5> *, OBJ *, M, c_D1-4&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlcfxxx::Vfunc5<int *, int *, int *, int *, int *> x1;
                bdlcfxxxu::Vfunc5::makeF(&x1, checkArgumentValues9,
                                    &a6, &a7, &a8, &a9);
                x1(&a1, &a2, &a3, &a4, &a5);
            ...
            {
                bdlcfxxx::Vfunc5<int *, int *, int *, int *, int *> x1;
                bdlcfxxxu::Vfunc5::makeC(&x1, cbObj,
            ...
            {
                bdlcfxxx::Vfunc5<int *, int *, int *, int *, int *> x1;
                bdlcfxxxu::Vfunc5::makeM(&x1, &cbObj,
                                    &CbClass::checkArgumentValues9,
                                    &a6, &a7, &a8, &a9);
                x1(&a1, &a2, &a3, &a4, &a5);
                ASSERT(ARG1_PLUS1 == a1);
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            if (verbose) cout << "Testing 'makeF'" << endl;
            {
                bdlcfxxx::Vfunc5<T1, T2, T3, T4, T5> x1;
                bdlcfxxxu::Vfunc5::makeF(&x1, checkParameterTypes9,
                                    a6, a7, a8, a9);
                x1(a1, a2, a3, a4, a5);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlcfxxx::Vfunc5<int *, int *, int *, int *, int *> x1;
                bdlcfxxxu::Vfunc5::makeF(&ta, &x1, checkArgumentValues9,
                                    &a6, &a7, &a8, &a9);
                x1(&a1, &a2, &a3, &a4, &a5);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            {
                bdlcfxxx::Vfunc5<int *, int *, int *, int *, int *> x1;
                bdlcfxxxu::Vfunc5::makeC(&ta, &x1, cbObj,
                                    &CbClass::checkArgumentValues9,
                                    &a6, &a7, &a8, &a9);
                x1(&a1, &a2, &a3, &a4, &a5);
                ASSERT(ARG1_PLUS1 == a1);
            ...
            {
                bdlcfxxx::Vfunc5<int *, int *, int *, int *, int *> x1;
                bdlcfxxxu::Vfunc5::makeM(&ta, &x1, &cbObj,
                                    &CbClass::checkArgumentValues9,
                                    &a6, &a7, &a8, &a9);
                x1(&a1, &a2, &a3, &a4, &a5);
                ASSERT(ARG1_PLUS1 == a1);
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdlcfxxx::Vfunc5<T1, T2, T3, T4, T5> x1;
                bdlcfxxxu::Vfunc5::makeF(&ta, &x1, checkParameterTypes9,
                                    a6, a7, a8, a9);
                x1(a1, a2, a3, a4, a5);
            }
      ...
      case 8: {
        ...
        //
        // Testing:
        //    makeF(      bdlcfxxx::Vfunc5<A1-5> *,        F, c_D1-3&);
        //    makeC(      bdlcfxxx::Vfunc5<A1-5> *, c_O&,  C, c_D1-3&);
        //    makeM(      bdlcfxxx::Vfunc5<A1-5> *, OBJ *, M, c_D1-3&);
        //    makeF(bA *, bdlcfxxx::Vfunc5<A1-5> *,        F, c_D1-3&);
        //    makeC(bA *, bdlcfxxx::Vfunc5<A1-5> *, c_O&,  C, c_D1-3&);
        //    makeM(bA *, bdlcfxxx::Vfunc5<A1-5> *, OBJ *, M, c_D1-3&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlcfxxx::Vfunc5<int *, int *, int *, int *, int *> x1;
                bdlcfxxxu::Vfunc5::makeF(&x1, checkArgumentValues8,
                                    &a6, &a7, &a8);
                x1(&a1, &a2, &a3, &a4, &a5);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdlcfxxx::Vfunc5<T1, T2, T3, T4, T5> x1;
                bdlcfxxxu::Vfunc5::makeF(&x1, checkParameterTypes8,
                                    a6, a7, a8);
                x1(a1, a2, a3, a4, a5);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlcfxxx::Vfunc5<int *, int *, int *, int *, int *> x1;
                bdlcfxxxu::Vfunc5::makeF(&ta, &x1, checkArgumentValues8,
                                    &a6, &a7, &a8);
                x1(&a1, &a2, &a3, &a4, &a5);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdlcfxxx::Vfunc5<T1, T2, T3, T4, T5> x1;
                bdlcfxxxu::Vfunc5::makeF(&ta, &x1, checkParameterTypes8,
                                    a6, a7, a8);
                x1(a1, a2, a3, a4, a5);
            }
      ...
      case 7: {
        ...
        //
        // Testing:
        //    makeF(      bdlcfxxx::Vfunc5<A1-5> *,        F, c_D1-2&);
        //    makeC(      bdlcfxxx::Vfunc5<A1-5> *, c_O&,  C, c_D1-2&);
        //    makeM(      bdlcfxxx::Vfunc5<A1-5> *, OBJ *, M, c_D1-2&);
        //    makeF(bA *, bdlcfxxx::Vfunc5<A1-5> *,        F, c_D1-2&);
        //    makeC(bA *, bdlcfxxx::Vfunc5<A1-5> *, c_O&,  C, c_D1-2&);
        //    makeM(bA *, bdlcfxxx::Vfunc5<A1-5> *, OBJ *, M, c_D1-2&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlcfxxx::Vfunc5<int *, int *, int *, int *, int *> x1;
                bdlcfxxxu::Vfunc5::makeF(&x1, checkArgumentValues7, &a6, &a7);
                x1(&a1, &a2, &a3, &a4, &a5);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            }
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdlcfxxx::Vfunc5<T1, T2, T3, T4, T5> x1;
                bdlcfxxxu::Vfunc5::makeF(&x1, checkParameterTypes7, a6, a7);
                x1(a1, a2, a3, a4, a5);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlcfxxx::Vfunc5<int *, int *, int *, int *, int *> x1;
                bdlcfxxxu::Vfunc5::makeF(&ta, &x1, checkArgumentValues7, &a6, &a7);
                x1(&a1, &a2, &a3, &a4, &a5);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdlcfxxx::Vfunc5<T1, T2, T3, T4, T5> x1;
                bdlcfxxxu::Vfunc5::makeF(&ta, &x1, checkParameterTypes7, a6, a7);
                x1(a1, a2, a3, a4, a5);
            }
      ...
      case 6: {
        ...
        //
        // Testing:
        //    makeF(      bdlcfxxx::Vfunc5<A1-5> *,        F, c_D1&);
        //    makeC(      bdlcfxxx::Vfunc5<A1-5> *, c_O&,  C, c_D1&);
        //    makeM(      bdlcfxxx::Vfunc5<A1-5> *, OBJ *, M, c_D1&);
        //    makeF(bA *, bdlcfxxx::Vfunc5<A1-5> *,        F, c_D1&);
        //    makeC(bA *, bdlcfxxx::Vfunc5<A1-5> *, c_O&,  C, c_D1&);
        //    makeM(bA *, bdlcfxxx::Vfunc5<A1-5> *, OBJ *, M, c_D1&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlcfxxx::Vfunc5<int *, int *, int *, int *, int *> x1;
                bdlcfxxxu::Vfunc5::makeF(&x1, checkArgumentValues6, &a6);
                x1(&a1, &a2, &a3, &a4, &a5);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            }
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdlcfxxx::Vfunc5<T1, T2, T3, T4, T5> x1;
                bdlcfxxxu::Vfunc5::makeF(&x1, checkParameterTypes6, a6);
                x1(a1, a2, a3, a4, a5);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlcfxxx::Vfunc5<int *, int *, int *, int *, int *> x1;
                bdlcfxxxu::Vfunc5::makeF(&ta, &x1, checkArgumentValues6, &a6);
                x1(&a1, &a2, &a3, &a4, &a5);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdlcfxxx::Vfunc5<T1, T2, T3, T4, T5> x1;
                bdlcfxxxu::Vfunc5::makeF(&ta, &x1, checkParameterTypes6, a6);
                x1(a1, a2, a3, a4, a5);
            }
      ...
      case 5: {
        ...
        //
        // Testing:
        //    makeF(         bdlcfxxx::Vfunc5<A1-5> *,        F);
        //    makeC(         bdlcfxxx::Vfunc5<A1-5> *, c_O&,  C);
        //    makeM(         bdlcfxxx::Vfunc5<A1-5> *, OBJ *, M);
        //    makeNull(      bdlcfxxx::Vfunc5<A1-5> *);
        //    makeF(   bA *, bdlcfxxx::Vfunc5<A1-5> *,        F);
        //    makeC(   bA *, bdlcfxxx::Vfunc5<A1-5> *, c_O&,  C);
        //    makeM(   bA *, bdlcfxxx::Vfunc5<A1-5> *, OBJ *, M);
        //    makeNull(bA *, bdlcfxxx::Vfunc5<A1-5> *);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlcfxxx::Vfunc5<int *, int *, int *, int *, int *> x1;
                bdlcfxxxu::Vfunc5::makeF(&x1, checkArgumentValues5);
                x1(&a1, &a2, &a3, &a4, &a5);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            }
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdlcfxxx::Vfunc5<T1, T2, T3, T4, T5> x1;
                bdlcfxxxu::Vfunc5::makeF(&x1, checkParameterTypes5);
                x1(a1, a2, a3, a4, a5);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlcfxxx::Vfunc5<int *, int *, int *, int *, int *> x1;
                bdlcfxxxu::Vfunc5::makeF(&ta, &x1, checkArgumentValues5);
                x1(&a1, &a2, &a3, &a4, &a5);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            {
                bdlcfxxx::Vfunc5<int *, int *, int *, int *, int *> x1;
                bdlcfxxxu::Vfunc5::makeNull(&ta, &x1);
                x1(&a1, &a2, &a3, &a4, &a5);
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdlcfxxx::Vfunc5<T1, T2, T3, T4, T5> x1;
                bdlcfxxxu::Vfunc5::makeF(&ta, &x1, checkParameterTypes5);
                x1(a1, a2, a3, a4, a5);
            }
