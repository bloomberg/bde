// bdlcfxxxu_vfunc5.h                  -*-C++-*-
#ifndef INCLUDED_BDLCFXXXU_VFUNC5
#define INCLUDED_BDLCFXXXU_VFUNC5
...
//
//@CLASSES:
//   bdlcfxxxu::Vfunc5: namespace for factory methods loading 5-arg void functors
//
...
//..
//   bdlcfxxxu::Vfunc5::makeF:    Initialize the functor by embedding a function
//                           (or another functor) and any additional trailing
//                           arguments.
//
//   bdlcfxxxu::Vfunc5::makeC:    Initialize the functor by embedding an object, one
//                           of that object's 'const' methods, and any
//                           additional trailing arguments for that method.
//
//   bdlcfxxxu::Vfunc5::makeM:    Initialize the functor by embedding THE ADDRESS OF
...
//
//   bdlcfxxxu::Vfunc5::makeNull: Initialize the functor with an empty function.
//..
...
#ifndef INCLUDED_BDLCFXXX_VFUNC5
#include <bdlcfxxx_vfunc5.h>
#endif
...
struct Vfunc5 {
    ...
    static void makeNull(bdlcfxxx::Vfunc5<A1, A2, A3, A4, A5> *handle)
        ...
        // currently installed default allocator is used.
    {
        ...
        *handle = bdlcfxxx::Vfunc5<A1, A2, A3, A4, A5>(
            new(*ba) bdlcfxxxi::Vfunc5Null<A1, A2, A3, A4, A5>(ba));
    }

    template <class A1, class A2, class A3, class A4, class A5>
    static void makeNull(bslma::Allocator *basicAllocator,
                         bdlcfxxx::Vfunc5<A1, A2, A3, A4, A5> *handle)
        // Initialize the specified five-argument empty functor 'handle'.
        // Optionally specify, as the *first* argument, a 'basicAllocator' used
        // to supply memory.  If 'basicAllocator' is 0 or unspecified, the
        // currently installed default allocator is used.
    ...
    static void makeF(bdlcfxxx::Vfunc5<A1, A2, A3, A4, A5> *handle, F function)
        ...
        // unspecified, the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc5<A1, A2, A3, A4, A5>(
            new(*ba) bdlcfxxxi::Vfunc5F5<F, A1, A2, A3, A4, A5>(function, ba));
    }
    ...
    template <class F, class A1, class A2, class A3, class A4,
              class A5, class D1>
    static void makeF(bdlcfxxx::Vfunc5<A1, A2, A3, A4, A5> *handle,
                      F                function,
        ...
        // installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc5<A1, A2, A3, A4, A5>(
            new(*ba) bdlcfxxxi::Vfunc5F6<F, A1, A2, A3, A4, A5, D1> (
        ...
        // currently installed default allocator is used.
    {
        ...
        *handle = bdlcfxxx::Vfunc5<A1, A2, A3, A4, A5>(
            new(*ba) bdlcfxxxi::Vfunc5F7<F, A1, A2, A3, A4, A5, D1, D2>
        ...
        // currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc5<A1, A2, A3, A4, A5>(
            new(*ba) bdlcfxxxi::Vfunc5F8<F, A1, A2, A3, A4, A5, D1, D2, D3>
        ...
        // currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc5<A1, A2, A3, A4, A5>(
            new(*ba) bdlcfxxxi::Vfunc5F9<F, A1, A2, A3, A4, A5, D1, D2, D3, D4>
    ...
    template <class OBJ, class C, class A1, class A2, class A3, class A4,
              class A5>
    static void makeC(bdlcfxxx::Vfunc5<A1, A2, A3, A4, A5> *handle,
        ...
        // unspecified, the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc5<A1, A2, A3, A4, A5>(
            new(*ba) bdlcfxxxi::Vfunc5C5<OBJ, C, A1, A2, A3, A4, A5>(
                object, method, ba));
    }
        ...
        // default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc5<A1, A2, A3, A4, A5>(
            new(*ba) bdlcfxxxi::Vfunc5C6<OBJ, C, A1, A2, A3, A4, A5, D1>(
        ...
        // currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc5<A1, A2, A3, A4, A5>(
            new(*ba) bdlcfxxxi::Vfunc5C7<OBJ, C, A1, A2, A3, A4, A5, D1, D2>(
        ...
        // currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc5<A1, A2, A3, A4, A5>(
            new(*ba) bdlcfxxxi::Vfunc5C8<OBJ, C, A1, A2, A3, A4, A5, D1, D2, D3>(
        ...
        // currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc5<A1, A2, A3, A4, A5>(
           new(*ba) bdlcfxxxi::Vfunc5C9<OBJ, C, A1, A2, A3, A4, A5, D1, D2, D3, D4>(
    ...
    template <class OBJ, class M, class A1, class A2, class A3, class A4,
              class A5>
    static void makeM(bdlcfxxx::Vfunc5<A1, A2, A3, A4, A5> *handle, OBJ *object,
                      M                method)
        // Initialize the specified five-argument functor 'handle' by embedding
        ...
        // unspecified, the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc5<A1, A2, A3, A4, A5>(
            new(*ba) bdlcfxxxi::Vfunc5M5<OBJ, M, A1, A2, A3, A4, A5>(
                object, method, ba));
    }
    ...
    template <class OBJ, class M, class A1, class A2, class A3, class A4,
              class A5, class D1>
    static void makeM(bdlcfxxx::Vfunc5<A1, A2, A3, A4, A5> *handle,
                      OBJ             *object,
                      M                method,
                      const D1&        embeddedArg1)
        // Initialize the specified five-argument functor 'handle' by embedding
        ...
        // default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc5<A1, A2, A3, A4, A5>(
            new(*ba) bdlcfxxxi::Vfunc5M6<OBJ, M, A1, A2, A3, A4, A5, D1>(
                object, method, embeddedArg1, ba));
    }
        ...
        // currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc5<A1, A2, A3, A4, A5>(
            new(*ba) bdlcfxxxi::Vfunc5M7<OBJ, M, A1, A2, A3, A4, A5, D1, D2>(
                object, method, embeddedArg1, embeddedArg2, ba));
    }
...
static void makeM(bdlcfxxx::Vfunc5<A1, A2, A3, A4, A5> *handle,
        ...
        // currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc5<A1, A2, A3, A4, A5>(
            new(*ba) bdlcfxxxi::Vfunc5M8<OBJ, M, A1, A2, A3, A4, A5, D1, D2, D3>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3, ba));
    }
        ...
        // currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc5<A1, A2, A3, A4, A5>(
           new(*ba) bdlcfxxxi::Vfunc5M9<OBJ, M, A1, A2, A3, A4, A5, D1, D2, D3, D4>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, ba));
    }
