// bdlcfxxxu_vfunc4.t.cpp                                             -*-C++-*-

#include <bdlcfxxxu_vfunc4.h>
...
//
//-----------------------------------------------------------------------------
// [ 9] makeF(         bdlcfxxx::Vfunc4<A1-4> *,       F, c_D1-5&);
// [ 9] makeC(         bdlcfxxx::Vfunc4<A1-4> *, c_O&, C, c_D1-5&);
// [ 9] makeM(         bdlcfxxx::Vfunc4<A1-4> *, OBJ*, M, c_D1-5&);
// [ 9] makeF(   bA *, bdlcfxxx::Vfunc4<A1-4> *,       F, c_D1-5&);
// [ 9] makeC(   bA *, bdlcfxxx::Vfunc4<A1-4> *, c_O&, C, c_D1-5&);
// [ 9] makeM(   bA *, bdlcfxxx::Vfunc4<A1-4> *, OBJ*, M, c_D1-5&);
// [ 8] makeF(         bdlcfxxx::Vfunc4<A1-4> *,       F, c_D1-4&);
// [ 8] makeC(         bdlcfxxx::Vfunc4<A1-4> *, c_O&, C, c_D1-4&);
// [ 8] makeM(         bdlcfxxx::Vfunc4<A1-4> *, OBJ*, M, c_D1-4&);
// [ 8] makeF(   bA *, bdlcfxxx::Vfunc4<A1-4> *,       F, c_D1-4&);
// [ 8] makeC(   bA *, bdlcfxxx::Vfunc4<A1-4> *, c_O&, C, c_D1-4&);
// [ 8] makeM(   bA *, bdlcfxxx::Vfunc4<A1-4> *, OBJ*, M, c_D1-4&);
// [ 7] makeF(         bdlcfxxx::Vfunc4<A1-4> *,       F, c_D1-3&);
// [ 7] makeC(         bdlcfxxx::Vfunc4<A1-4> *, c_O&, C, c_D1-3&);
// [ 7] makeM(         bdlcfxxx::Vfunc4<A1-4> *, OBJ*, M, c_D1-3&);
// [ 7] makeF(   bA *, bdlcfxxx::Vfunc4<A1-4> *,       F, c_D1-3&);
// [ 7] makeC(   bA *, bdlcfxxx::Vfunc4<A1-4> *, c_O&, C, c_D1-3&);
// [ 7] makeM(   bA *, bdlcfxxx::Vfunc4<A1-4> *, OBJ*, M, c_D1-3&);
// [ 6] makeF(         bdlcfxxx::Vfunc4<A1-4> *,       F, c_D1-2&);
// [ 6] makeC(         bdlcfxxx::Vfunc4<A1-4> *, c_O&, C, c_D1-2&);
// [ 6] makeM(         bdlcfxxx::Vfunc4<A1-4> *, OBJ*, M, c_D1-2&);
// [ 6] makeF(   bA *, bdlcfxxx::Vfunc4<A1-4> *,       F, c_D1-2&);
// [ 6] makeC(   bA *, bdlcfxxx::Vfunc4<A1-4> *, c_O&, C, c_D1-2&);
// [ 6] makeM(   bA *, bdlcfxxx::Vfunc4<A1-4> *, OBJ*, M, c_D1-2&);
// [ 5] makeF(         bdlcfxxx::Vfunc4<A1-4> *,       F, c_D1&);
// [ 5] makeC(         bdlcfxxx::Vfunc4<A1-4> *, c_O&, C, c_D1&);
// [ 5] makeM(         bdlcfxxx::Vfunc4<A1-4> *, OBJ*, M, c_D1&);
// [ 5] makeF(   bA *, bdlcfxxx::Vfunc4<A1-4> *,       F, c_D1&);
// [ 5] makeC(   bA *, bdlcfxxx::Vfunc4<A1-4> *, c_O&, C, c_D1&);
// [ 5] makeM(   bA *, bdlcfxxx::Vfunc4<A1-4> *, OBJ*, M, c_D1&);
// [ 4] makeF(         bdlcfxxx::Vfunc4<A1-4> *,       F);
// [ 4] makeC(         bdlcfxxx::Vfunc4<A1-4> *, c_O&, C);
// [ 4] makeM(         bdlcfxxx::Vfunc4<A1-4> *, OBJ*, M);
// [ 4] makeF(   bA *, bdlcfxxx::Vfunc4<A1-4> *,       F);
// [ 4] makeC(   bA *, bdlcfxxx::Vfunc4<A1-4> *, c_O&, C);
// [ 4] makeM(   bA *, bdlcfxxx::Vfunc4<A1-4> *, OBJ*, M);
// [ 4] makeNull(      bdlcfxxx::Vfunc4<A1-4> *);
// [ 4] makeNull(bA *, bdlcfxxx::Vfunc4<A1-4> *);
//-----------------------------------------------------------------------------
...
//       // that 'bcefi::vfunc4X4' classes pass when calling the callback
//       // function.
//       //
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      case 9: {
        ...
        //
        // Plan:
        //   Use each function to initialize a separate 'bdlcfxxx::Vfunc4' object
        //   with the 'checkArgumentValues' function, which verifies that the
        //   parameters are "wired" correctly.  Use each function to
        //   initialize 'bdlcfxxx::Vfunc4' object with the 'checkParameterTypes'
        ...
        //
        // Testing:
        //    makeF(      bdlcfxxx::Vfunc4<A1-4> *,        F, c_D1-5&);
        //    makeC(      bdlcfxxx::Vfunc4<A1-4> *, c_O&,  C, c_D1-5&);
        //    makeM(      bdlcfxxx::Vfunc4<A1-4> *, OBJ *, M, c_D1-5&);
        //    makeF(bA *, bdlcfxxx::Vfunc4<A1-4> *,        F, c_D1-5&);
        //    makeC(bA *, bdlcfxxx::Vfunc4<A1-4> *, c_O&,  C, c_D1-5&);
        //    makeM(bA *, bdlcfxxx::Vfunc4<A1-4> *, OBJ *, M, c_D1-5&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlcfxxx::Vfunc4<int *, int *, int *, int *> x1;
                bdlcfxxxu::Vfunc4::makeF(&x1, checkArgumentValues9,
                                    &a5, &a6, &a7, &a8, &a9);
                x1(&a1, &a2, &a3, &a4);
            ...
            {
                bdlcfxxx::Vfunc4<int *, int *, int *, int *> x1;
                bdlcfxxxu::Vfunc4::makeC(&x1, cbObj,
            ...
            {
                bdlcfxxx::Vfunc4<int *, int *, int *, int *> x1;
                bdlcfxxxu::Vfunc4::makeM(&x1, &cbObj,
                                    &CbClass::checkArgumentValues9,
                                    &a5, &a6, &a7, &a8, &a9);
                x1(&a1, &a2, &a3, &a4);
                ASSERT(ARG1_PLUS1 == a1);
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            if (verbose) cout << "Testing 'makeF'" << endl;
            {
                bdlcfxxx::Vfunc4<T1, T2, T3, T4> x1;
                bdlcfxxxu::Vfunc4::makeF(&x1, checkParameterTypes9,
                                    a5, a6, a7, a8, a9);
                x1(a1, a2, a3, a4);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlcfxxx::Vfunc4<int *, int *, int *, int *> x1;
                bdlcfxxxu::Vfunc4::makeF(&ta, &x1, checkArgumentValues9,
                                    &a5, &a6, &a7, &a8, &a9);
                x1(&a1, &a2, &a3, &a4);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            {
                bdlcfxxx::Vfunc4<int *, int *, int *, int *> x1;
                bdlcfxxxu::Vfunc4::makeC(&ta, &x1, cbObj,
                                    &CbClass::checkArgumentValues9,
                                    &a5, &a6, &a7, &a8, &a9);
                x1(&a1, &a2, &a3, &a4);
                ASSERT(ARG1_PLUS1 == a1);
            ...
            {
                bdlcfxxx::Vfunc4<int *, int *, int *, int *> x1;
                bdlcfxxxu::Vfunc4::makeM(&ta, &x1, &cbObj,
                                    &CbClass::checkArgumentValues9,
                                    &a5, &a6, &a7, &a8, &a9);
                x1(&a1, &a2, &a3, &a4);
                ASSERT(ARG1_PLUS1 == a1);
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdlcfxxx::Vfunc4<T1, T2, T3, T4> x1;
                bdlcfxxxu::Vfunc4::makeF(&ta, &x1, checkParameterTypes9,
                                    a5, a6, a7, a8, a9);
                x1(a1, a2, a3, a4);
            }
      ...
      case 8: {
        ...
        //
        // Testing:
        //    makeF(      bdlcfxxx::Vfunc4<A1-4> *,        F, c_D1-4&);
        //    makeC(      bdlcfxxx::Vfunc4<A1-4> *, c_O&,  C, c_D1-4&);
        //    makeM(      bdlcfxxx::Vfunc4<A1-4> *, OBJ *, M, c_D1-4&);
        //    makeF(bA *, bdlcfxxx::Vfunc4<A1-4> *,        F, c_D1-4&);
        //    makeC(bA *, bdlcfxxx::Vfunc4<A1-4> *, c_O&,  C, c_D1-4&);
        //    makeM(bA *, bdlcfxxx::Vfunc4<A1-4> *, OBJ *, M, c_D1-4&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlcfxxx::Vfunc4<int *, int *, int *, int *> x1;
                bdlcfxxxu::Vfunc4::makeF(&x1, checkArgumentValues8,
                                    &a5, &a6, &a7, &a8);
                x1(&a1, &a2, &a3, &a4);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdlcfxxx::Vfunc4<T1, T2, T3, T4> x1;
                bdlcfxxxu::Vfunc4::makeF(&x1, checkParameterTypes8,
                                    a5, a6, a7, a8);
                x1(a1, a2, a3, a4);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlcfxxx::Vfunc4<int *, int *, int *, int *> x1;
                bdlcfxxxu::Vfunc4::makeF(&ta, &x1, checkArgumentValues8,
                                    &a5, &a6, &a7, &a8);
                x1(&a1, &a2, &a3, &a4);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdlcfxxx::Vfunc4<T1, T2, T3, T4> x1;
                bdlcfxxxu::Vfunc4::makeF(&ta, &x1, checkParameterTypes8,
                                    a5, a6, a7, a8);
                x1(a1, a2, a3, a4);
            }
      ...
      case 7: {
        ...
        //
        // Testing:
        //    makeF(      bdlcfxxx::Vfunc4<A1-4> *,        F, c_D1-3&);
        //    makeC(      bdlcfxxx::Vfunc4<A1-4> *, c_O&,  C, c_D1-3&);
        //    makeM(      bdlcfxxx::Vfunc4<A1-4> *, OBJ *, M, c_D1-3&);
        //    makeF(bA *, bdlcfxxx::Vfunc4<A1-4> *,        F, c_D1-3&);
        //    makeC(bA *, bdlcfxxx::Vfunc4<A1-4> *, c_O&,  C, c_D1-3&);
        //    makeM(bA *, bdlcfxxx::Vfunc4<A1-4> *, OBJ *, M, c_D1-3&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlcfxxx::Vfunc4<int *, int *, int *, int *> x1;
                bdlcfxxxu::Vfunc4::makeF(&x1, checkArgumentValues7,
                                    &a5, &a6, &a7);
                x1(&a1, &a2, &a3, &a4);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdlcfxxx::Vfunc4<T1, T2, T3, T4> x1;
                bdlcfxxxu::Vfunc4::makeF(&x1, checkParameterTypes7,
                                    a5, a6, a7);
                x1(a1, a2, a3, a4);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlcfxxx::Vfunc4<int *, int *, int *, int *> x1;
                bdlcfxxxu::Vfunc4::makeF(&ta, &x1, checkArgumentValues7,
                                    &a5, &a6, &a7);
                x1(&a1, &a2, &a3, &a4);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdlcfxxx::Vfunc4<T1, T2, T3, T4> x1;
                bdlcfxxxu::Vfunc4::makeF(&ta, &x1, checkParameterTypes7,
                                    a5, a6, a7);
                x1(a1, a2, a3, a4);
            }
      ...
      case 6: {
        ...
        //
        // Testing:
        //    makeF(      bdlcfxxx::Vfunc4<A1-4> *,        F, c_D1-2&);
        //    makeC(      bdlcfxxx::Vfunc4<A1-4> *, c_O&,  C, c_D1-2&);
        //    makeM(      bdlcfxxx::Vfunc4<A1-4> *, OBJ *, M, c_D1-2&);
        //    makeF(bA *, bdlcfxxx::Vfunc4<A1-4> *,        F, c_D1-2&);
        //    makeC(bA *, bdlcfxxx::Vfunc4<A1-4> *, c_O&,  C, c_D1-2&);
        //    makeM(bA *, bdlcfxxx::Vfunc4<A1-4> *, OBJ *, M, c_D1-2&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlcfxxx::Vfunc4<int *, int *, int *, int *> x1;
                bdlcfxxxu::Vfunc4::makeF(&x1, checkArgumentValues6,
                                    &a5, &a6);
                x1(&a1, &a2, &a3, &a4);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdlcfxxx::Vfunc4<T1, T2, T3, T4> x1;
                bdlcfxxxu::Vfunc4::makeF(&x1, checkParameterTypes6,
                                    a5, a6);
                x1(a1, a2, a3, a4);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlcfxxx::Vfunc4<int *, int *, int *, int *> x1;
                bdlcfxxxu::Vfunc4::makeF(&ta, &x1, checkArgumentValues6,
                                    &a5, &a6);
                x1(&a1, &a2, &a3, &a4);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdlcfxxx::Vfunc4<T1, T2, T3, T4> x1;
                bdlcfxxxu::Vfunc4::makeF(&ta, &x1, checkParameterTypes6,
                                    a5, a6);
                x1(a1, a2, a3, a4);
            }
      ...
      case 5: {
        ...
        //
        // Testing:
        //    makeF(      bdlcfxxx::Vfunc4<A1-4> *,        F, c_D1&);
        //    makeC(      bdlcfxxx::Vfunc4<A1-4> *, c_O&,  C, c_D1&);
        //    makeM(      bdlcfxxx::Vfunc4<A1-4> *, OBJ *, M, c_D1&);
        //    makeF(bA *, bdlcfxxx::Vfunc4<A1-4> *,        F, c_D1&);
        //    makeC(bA *, bdlcfxxx::Vfunc4<A1-4> *, c_O&,  C, c_D1&);
        //    makeM(bA *, bdlcfxxx::Vfunc4<A1-4> *, OBJ *, M, c_D1&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlcfxxx::Vfunc4<int *, int *, int *, int *> x1;
                bdlcfxxxu::Vfunc4::makeF(&x1, checkArgumentValues5, &a5);
                x1(&a1, &a2, &a3, &a4);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            }
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdlcfxxx::Vfunc4<T1, T2, T3, T4> x1;
                bdlcfxxxu::Vfunc4::makeF(&x1, checkParameterTypes5, a5);
                x1(a1, a2, a3, a4);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlcfxxx::Vfunc4<int *, int *, int *, int *> x1;
                bdlcfxxxu::Vfunc4::makeF(&ta, &x1, checkArgumentValues5, &a5);
                x1(&a1, &a2, &a3, &a4);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdlcfxxx::Vfunc4<T1, T2, T3, T4> x1;
                bdlcfxxxu::Vfunc4::makeF(&ta, &x1, checkParameterTypes5, a5);
                x1(a1, a2, a3, a4);
            }
      ...
      case 4: {
        ...
        //
        // Testing:
        //    makeF(         bdlcfxxx::Vfunc4<A1-4> *,        F);
        //    makeC(         bdlcfxxx::Vfunc4<A1-4> *, c_O&,  C);
        //    makeM(         bdlcfxxx::Vfunc4<A1-4> *, OBJ *, M);
        //    makeNull(      bdlcfxxx::Vfunc4<A1-4> *);
        //    makeF(   bA *, bdlcfxxx::Vfunc4<A1-4> *,        F);
        //    makeC(   bA *, bdlcfxxx::Vfunc4<A1-4> *, c_O&,  C);
        //    makeM(   bA *, bdlcfxxx::Vfunc4<A1-4> *, OBJ *, M);
        //    makeNull(bA *, bdlcfxxx::Vfunc4<A1-4> *);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlcfxxx::Vfunc4<int *, int *, int *, int *> x1;
                bdlcfxxxu::Vfunc4::makeF(&x1, checkArgumentValues4);
                x1(&a1, &a2, &a3, &a4);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            }
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdlcfxxx::Vfunc4<T1, T2, T3, T4> x1;
                bdlcfxxxu::Vfunc4::makeF(&x1, checkParameterTypes4);
                x1(a1, a2, a3, a4);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlcfxxx::Vfunc4<int *, int *, int *, int *> x1;
                bdlcfxxxu::Vfunc4::makeF(&ta, &x1, checkArgumentValues4);
                x1(&a1, &a2, &a3, &a4);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            {
                bdlcfxxx::Vfunc4<int *, int *, int *, int *> x1;
                bdlcfxxxu::Vfunc4::makeNull(&ta, &x1);
                x1(&a1, &a2, &a3, &a4);
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdlcfxxx::Vfunc4<T1, T2, T3, T4> x1;
                bdlcfxxxu::Vfunc4::makeF(&ta, &x1, checkParameterTypes4);
                x1(a1, a2, a3, a4);
            }
