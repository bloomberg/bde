// bdlcfxxxu_vfunc4.h                  -*-C++-*-
#ifndef INCLUDED_BDLCFXXXU_VFUNC4
#define INCLUDED_BDLCFXXXU_VFUNC4
...
//
//@CLASSES:
//   bdlcfxxxu::Vfunc4: namespace for factory methods loading 4-arg void functors
//
...
//..
//   bdlcfxxxu::Vfunc4::makeF:    Initialize the functor by embedding a function
//                           (or another functor) and any additional trailing
//                           arguments.
//
//   bdlcfxxxu::Vfunc4::makeC:    Initialize the functor by embedding an object, one
//                           of that object's 'const' methods, and any
//                           additional trailing arguments for that method.
//
//   bdlcfxxxu::Vfunc4::makeM:    Initialize the functor by embedding THE ADDRESS OF
...
//
//   bdlcfxxxu::Vfunc4::makeNull: Initialize the functor with an empty function.
//..
...
#ifndef INCLUDED_BDLCFXXXI_VFUNC4
#include <bdlcfxxxi_vfunc4.h>
#endif
...
struct Vfunc4 {
    ...
    static void makeNull(bdlcfxxx::Vfunc4<A1, A2, A3, A4> *handle)
        ...
        // currently installed default allocator is used.
    {
        ...
        *handle = bdlcfxxx::Vfunc4<A1, A2, A3, A4>(
            new(*ba) bdlcfxxxi::Vfunc4Null<A1, A2, A3, A4>(ba));
    }

    template <class A1, class A2, class A3, class A4>
    static void makeNull(bslma::Allocator *basicAllocator,
                         bdlcfxxx::Vfunc4<A1, A2, A3, A4> *handle)
        // Initialize the specified four-argument empty functor 'handle'.
        // Optionally specify, as the *first* argument, a 'basicAllocator' used
        // to supply memory.  If 'basicAllocator' is 0 or unspecified, the
        // currently installed default allocator is used.
    ...
    static void makeF(bdlcfxxx::Vfunc4<A1, A2, A3, A4> *handle, F function)
        ...
        // unspecified, the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc4<A1, A2, A3, A4>(
            new(*ba) bdlcfxxxi::Vfunc4F4<F, A1, A2, A3, A4>(function, ba));
    }
    ...
    static void makeF(bdlcfxxx::Vfunc4<A1, A2, A3, A4> *handle,
                      F                function,
        ...
        // installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc4<A1, A2, A3, A4>(
            new(*ba) bdlcfxxxi::Vfunc4F5<F, A1, A2, A3, A4, D1> (
        ...
        // currently installed default allocator is used.
    {
        ...
        *handle = bdlcfxxx::Vfunc4<A1, A2, A3, A4>(
            new(*ba) bdlcfxxxi::Vfunc4F6<F, A1, A2, A3, A4, D1, D2>
        ...
        // currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc4<A1, A2, A3, A4>(
            new(*ba) bdlcfxxxi::Vfunc4F7<F, A1, A2, A3, A4, D1, D2, D3>
        ...
        // currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc4<A1, A2, A3, A4>(
            new(*ba) bdlcfxxxi::Vfunc4F8<F, A1, A2, A3, A4, D1, D2, D3, D4>
        ...
        // currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc4<A1, A2, A3, A4>(
            new(*ba) bdlcfxxxi::Vfunc4F9<F, A1, A2, A3, A4, D1, D2, D3, D4, D5>
                (function, embeddedArg1, embeddedArg2, embeddedArg3,
    ...
    static void makeC(bdlcfxxx::Vfunc4<A1, A2, A3, A4> *handle, const OBJ& object,
                      C                method)
        // Initialize the specified four-argument functor 'handle' by embedding
        // the specified 'function' (or functor) taking no additional trailing
        // arguments.  Optionally specify, as the *first* argument, a
        ...
        // unspecified, the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc4<A1, A2, A3, A4>(
            new(*ba) bdlcfxxxi::Vfunc4C4<OBJ, C, A1, A2, A3, A4>(
                object, method, ba));
    }
    ...
    template <class OBJ, class C, class A1, class A2, class A3, class A4,
              class D1>
    static void makeC(bdlcfxxx::Vfunc4<A1, A2, A3, A4> *handle,
                      const OBJ&       object,
                      C                method,
                      const D1&        embeddedArg1)
        // Initialize the specified four-argument functor 'handle' by embedding
        ...
        // default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc4<A1, A2, A3, A4>(
            new(*ba) bdlcfxxxi::Vfunc4C5<OBJ, C, A1, A2, A3, A4, D1>(
        ...
        // currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc4<A1, A2, A3, A4>(
            new(*ba) bdlcfxxxi::Vfunc4C6<OBJ, C, A1, A2, A3, A4, D1, D2>(
        ...
        // currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc4<A1, A2, A3, A4>(
            new(*ba) bdlcfxxxi::Vfunc4C7<OBJ, C, A1, A2, A3, A4, D1, D2, D3>(
        ...
        // currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc4<A1, A2, A3, A4>(
            new(*ba) bdlcfxxxi::Vfunc4C8<OBJ, C, A1, A2, A3, A4, D1, D2, D3, D4>(
        ...
        // currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc4<A1, A2, A3, A4>(
           new(*ba) bdlcfxxxi::Vfunc4C9<OBJ, C, A1, A2, A3, A4, D1, D2, D3, D4, D5>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, ba));
    }
    ...
    static void makeM(bdlcfxxx::Vfunc4<A1, A2, A3, A4> *handle, OBJ *object,
                      M                method)
        // Initialize the specified four-argument functor 'handle' by embedding
        ...
        // unspecified, the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc4<A1, A2, A3, A4>(
            new(*ba) bdlcfxxxi::Vfunc4M4<OBJ, M, A1, A2, A3, A4>(
                object, method, ba));
    }
    ...
    template <class OBJ, class M, class A1, class A2, class A3, class A4,
              class D1>
    static void makeM(bdlcfxxx::Vfunc4<A1, A2, A3, A4> *handle,
                      OBJ             *object,
                      M                method,
                      const D1&        embeddedArg1)
        // Initialize the specified four-argument functor 'handle' by embedding
        ...
        // default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc4<A1, A2, A3, A4>(
            new(*ba) bdlcfxxxi::Vfunc4M5<OBJ, M, A1, A2, A3, A4, D1>(
                object, method, embeddedArg1, ba));
    }
        ...
        // currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc4<A1, A2, A3, A4>(
            new(*ba) bdlcfxxxi::Vfunc4M6<OBJ, M, A1, A2, A3, A4, D1, D2>(
                object, method, embeddedArg1, embeddedArg2, ba));
    }
...
static void makeM(bdlcfxxx::Vfunc4<A1, A2, A3, A4> *handle,
        ...
        // currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc4<A1, A2, A3, A4>(
            new(*ba) bdlcfxxxi::Vfunc4M7<OBJ, M, A1, A2, A3, A4, D1, D2, D3>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3, ba));
    }
        ...
        // currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc4<A1, A2, A3, A4>(
            new(*ba) bdlcfxxxi::Vfunc4M8<OBJ, M, A1, A2, A3, A4, D1, D2, D3, D4>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, ba));
    }
        ...
        // currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlcfxxx::Vfunc4<A1, A2, A3, A4>(
           new(*ba) bdlcfxxxi::Vfunc4M9<OBJ, M, A1, A2, A3, A4, D1, D2, D3, D4, D5>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, ba));
    }
