// bdlmca_xxxprotectablemultipoolallocator.t.cpp                         -*-C++-*-
...
//                                  Overview
//                                  --------
// The 'bdlmca::ProtectableMultipoolAllocator' class consists of one
...
// [ 3] bdlmca::ProtectableMultipoolAllocator(
//                            int                                    numPools,
//                            bcema::ProtectableBlockDispenser *ba);
// [ 3] ~bdlmca::ProtectableMultipoolAllocator();
...
typedef bdlmca::ProtectableMultipoolAllocator Obj;
typedef bdlma::ProtectableBlockList          PBList;
typedef bdlma::ProtectableBlockDispenser     PBDisp;
...
int main(int argc, char *argv[])
{
    ...
    int ACTUAL_PG_SIZE = bdlma::NativeProtectableBlockDispenser::pageSize();
...
///Usage
///-----
// The following snippets of code depict basic usage of 'bdlmca::Multipool'.
...
//..
// Next create a 'bdlmca::ProtectableMultipoolAllocator' that manages three
// pools:
//..
        const int NUM_POOLS = 3;
        bdlmca::ProtectableMultipoolAllocator mp(NUM_POOLS);
//..
...
//..
      ...
      case 3: {
        ...
        //
        // Testing:
        //   bdlmca::ProtectableMultipoolAllocator(int numPools,
        //                                       bslma::Allocator *ba = 0);
        //   ~bdlmca::ProtectableMultipoolAllocator();
        // --------------------------------------------------------------------
      ...
      case 1: {
        ...
        //   'bdlmca::ProtectableMultipoolAllocator' works properly.
        //
        // Plan:
