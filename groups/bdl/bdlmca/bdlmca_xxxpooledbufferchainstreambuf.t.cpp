// bdlmca_xxxpooledbufferchainstreambuf.t.cpp        -*-C++-*-
...
//                                  --------
//-----------------------------------------------------------------------------
// 'bdlmca::PooledBufferChainStreamBuf' private interface
// MANIPULATORS
...
//
// 'bdlmca::PooledBufferChainStreamBuf' protected interface
// MANIPULATORS
...
//                             bsl::streamsize  numChars);
//
// 'bdlmca::PooledBufferChainStreamBuf' public interface
// CREATORS
// [ 2] bdlmca::PooledBufferChainStreamBuf(
//                                 bdlmca::PooledBufferChain *pooledBufferChain);
// [ 2] ~bdlmca::PooledBufferChainStreamBuf();
//
// MANIPULATORS
// [  ] bdlmca::PooledBufferChain *data();
// [ 6] void reset(bdlmca::PooledBufferChain *pooledBufferChain);
//
// ACCESSORS
// [ 2] const bdlmca::PooledBufferChain *data() const;
//-----------------------------------------------------------------------------
// [ 1] BREATHING TEST
...
//-----------------------------------------------------------------------------
typedef bdlmca::PooledBufferChainStreamBuf Obj;
typedef bdlmca::PooledBufferChainFactory   Factory;
...
int main(int argc, char *argv[]) {
    ...
    switch (test) { case 0:
      ...
      case 1: {
        ...
        //   'bdlmca::PooledBufferChainStreamBuf' class.  We want to ensure that
        ...
        //   modifiable 'bdlmca::PooledBufferChainStreamBuf' object 'mX', and a
