 // bdlmca_xxxprotectableblockdispenseradapter.t.cpp  -*-C++-*-
...
//                                  Overview
//                                  --------
// The 'bcema::ProtectableblockdispenserAdapter' class consists of
...
// testing.
//-----------------------------------------------------------------------------
// [2] bdlmca::ProtectableblockdispenserAdapter(int               numPools,
//                                            bslma::Allocator *ba = 0);
// [2] ~bdlmca::ProtectableblockdispenserAdapter();
...
typedef bdlmca::ProtectableBlockDispenserAdapter Obj;
typedef bdlma::TestProtectableBlockDispenser    TestDisp;
...
class NoopProtectableBlockDispenser :
        ...
        // 'bdlma::ProtectableBlockDispenser' interface that tracks the
        // methods called and verifies the 'bdema::ProtectedBlockDispener'
        // protocol.
  ...
  public:
    ...
    // MANIPULATORS
    virtual bdlma::MemoryBlockDescriptor allocate(size_type size);
...
NoopProtectableBlockDispenser::allocate(size_type size)
{
    *d_lastMethod = "allocate";
    return bdlma::MemoryBlockDescriptor();
}
...
extern "C" void *workerThread(void *arg) {
    ...
    bsl::vector<bdlma::MemoryBlockDescriptor>
    ...
    class ThreadEnabledProtectablePool {
      ...
      public:
        ...
        ThreadEnabledProtectablePool(
            ...
            // 'bdlma::NativeProtectableBlockDispenser::singleton()' will be
            // used.
...
//..
    ...
    class ThreadEnabledProtectableMultipool {
        ...
        // a size supplied at construction.  The 'bdlmca::Multipool' 'allocate'
        ...
        // supplied both a 'bdlma::ProtectableBlockDispenser' and a
      ...
      public:
        ...
        ThreadEnabledProtectableMultipool(
            ...
            // 'bdema::NativeProtectableMemoryBlockDispenser::singleton()' is
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:
      ...
      case 1: {
        ...
        //   'bcema::ProtectableblockdispenserAdapter' works
        //   properly.
        //
        // Plan:
        //   Create a NoopProtectableBlockDispenser and supply it to a
        //   'bcema::ProtectableBlockDispenser' under test.  Verify that
        ...
        {
            bdlmca::ProtectableBlockDispenserAdapter mX(&mutex, &noopDispenser);
