// bdlmca_xxxprotectablesequentialallocator.t.cpp  -*-C++-*-
...
//
// PRIMARY CREATORS
// [ 3] bdlmca::ProtectableSequentialAllocator(bdema::PBD *d = 0);
// [ 3] ~bdlmca::ProtectableSequentialAllocator();
// [12] bdlmca::ProtectableSA(Align::Strat, bdema::PBD *d = 0);
// [11] bdlmca::ProtectableSA(Align::Strat, BG:Strat, s_t, PBD *d = 0);
//
// MANIPULATORS
...
typedef bdlmca::ProtectableSequentialAllocator            Obj;
typedef bdlma::TestProtectableBlockDispenser             TestDisp;
typedef bdlma::MemoryBlockDescriptor                     Block;
typedef bdlmca::ProtectableSequentialAllocator::size_type SizeType;
...
extern "C" void *workerThread(void *arg)
{
    ...
    // operations on the 'bdlma::TestProtectableBlockDispenser' and verify
...
int main(int argc, char *argv[])
{
    ...
    int HEADER_SIZE    = bdlma::ProtectableBlockList::blockHeaderSize();
    ...
    switch (test) { case 0:
      ...
      case 12: {
        ...
        //
        // Testing:
        //   bdlmca::ProtectableSA(Align::Strat, bdema::PBD *d = 0);
      ...
      case 11: {
        ...
        //
        // Testing:
        //   bdlmca::ProtectableSA(Align::Strat, BG:Strat, s_t, PBD *d = 0);
      ...
      case 5: {
        ...
        // bdlma::TestProtectableBlockDispenser - which verifies that the
      ...
      case 3: {
        ...
        //
        // Testing:
        //   bdlmca::ProtectableSequentialAllocator(bdema::PBD *d = 0);
        //   ~bdlmca::ProtectableSequentialAllocator();
        // -------------------------------------------------------------------
        if (verbose) {
