...
//                   const bdlmca::PooledBufferChain& source,
//                   int                            srcOffset,
//                   int                            numBytes);
// [ 2] void setLength(int newLength);
// [ 2] void setLength(int newLength, bdlmca::PooledBufferChain *source);
//
// ACCESSORS
...
//-----------------------------------------------------------------------------
// 'bdlmca::PooledBufferChainFactory' public interface
// CREATORS
// [ 6] bdlmca::PooledBufferChainFactory(int               bufferSize,
//                                     bslma::Allocator *basicAllocator = 0);
// [ 6] ~bdlmca::PooledBufferChainFactory();
//
// MANIPULATORS
// [ 6] bdlmca::PooledBufferChain *allocate(int length);
// [ 6] void deleteObject(bdlmca::PooledBufferChain *object);
//-----------------------------------------------------------------------------
// [ 1] BREATHING TEST
...
//-----------------------------------------------------------------------------
typedef bdlmca::PooledBufferChain Obj;
...
int main(int argc, char *argv[]) {
    ...
    switch (test) { case 0:
      ...
      case 12: {
        ...
        bdlma::TestAllocator ta(veryVeryVerbose);
        {
            for (int i = 0; i < DATA_SIZE; ++i) {
                ...
                bdlmca::PooledBufferChainFactory  mFd(DST_BUFSIZE, &ta);
                bdlmca::PooledBufferChain        *mCd =
      ...
      case 11: {
        ...
        //                const btemt::PooledBufferChain& source,
        //                int                            srcOffset,
        //                int                            numBytes);
        // --------------------------------------------------------------------
        ...
        bdlma::TestAllocator ta(veryVeryVerbose);
        {
            for (int i = 0; i < DATA_SIZE; ++i) {
                ...
                bdlmca::PooledBufferChainFactory  mFs(SRC_BUFSIZE, &ta);
                bdlmca::PooledBufferChain        *mCs =
      ...
      case 7: {
        // --------------------------------------------------------------------
        // TESTING 'bdlmca::PooledBufferChainFactory' CLASS
        //
        // Concerns:
        ...
        //
        // Testing:
        //   class bdlmca::PooledBufferChainFactory;
        // --------------------------------------------------------------------

        if (verbose) cout << endl
              << "TESTING 'bdlmca::PooledBufferChainFactory' CLASS" << endl
              << "==============================================" << endl;
      ...
      case 6: {
        ...
        //   'bdlmca::PooledBufferChain' or 'bdlmca::PooledBufferChainFactory',
