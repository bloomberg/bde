// bdlmca_xxxprotectablemultipool.t.cpp                                   -*-C++-*-
...
//                                  Overview
//                                  --------
// The 'bdlmca::ProtectableMultipool' class consists of one
...
// [ 3] bdlmca::ProtectableMultipool(
//                            int                                    numPools,
//                            bdlma::ProtectableBlockDispenser *ba);
// [ 3] ~bdlmca::ProtectableMultipool();
...
typedef bdlmca::ProtectableMultipool          Obj;
...
///Usage
///-----
// The following example uses the 'bdlmca::ProtectableMultipool'
  ...
  // ...
      ...
      public:
        ...
        IntegerStack(
            ...
            // the 'bdlma::NativeProtectableBlockDispenser' is used as
            // the default.
        : d_data_p()
        , d_numElements(0)
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:
      ...
      case 3: {
        ...
        //
        // Testing:
        //   bdlmca::ProtectableMultipool(int numPools,
      ...
      case 1: {
        ...
        //   'bdlmca::ProtectableMultipool' works properly.
        //
        // Plan:
