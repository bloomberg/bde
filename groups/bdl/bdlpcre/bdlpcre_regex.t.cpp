...
//-----------------------------------------------------------------------------
// CREATORS
// [ 2] bdlpcre::RegEx(bslma::Allocator *basicAllocator = 0);
// [ 2] ~bdlpcre::RegEx();
//
// MANIPULATORS
// [ 2] void clear();
...
// occurred, respectively).  Two flags, 'bdlpcre::RegEx::BDEPCRE_FLAG_CASELESS'
// and 'bdlpcre::RegEx::BDEPCRE_FLAG_MULTILINE', are used in preparing the
...
//..
        ...
        int returnValue = regEx.prepare(&errorMessage,
                                        &errorOffset,
                                        PATTERN,
                                        bdlpcre::RegEx::BDEPCRE_FLAG_CASELESS |
                                        bdlpcre::RegEx::BDEPCRE_FLAG_MULTILINE);
...
//..
      ...
      case 11: {
        ...
        ASSERT(x.depthLimit() == bdlpcre::RegEx::defaultDepthLimit());

        int previousGlobalLimit = bdlpcre::RegEx::setDefaultDepthLimit(3);
        ASSERT(3                  == bdlpcre::RegEx::defaultDepthLimit());
        ...
        ASSERT(y.depthLimit() == bdlpcre::RegEx::defaultDepthLimit());
      ...
      case 3: {
        ...
        if (verbose) cout << "\nNegative Testing." << endl;
        {
            ...
            bsl::pair<int, int>               p, *zp = 0;
            bsl::vector<bsl::pair<int, int> > v, *zv = 0;
            ...
            // basic 'match
            {
                ...
                ASSERT_SAFE_PASS(X.match(          0,  0,  0));
                ASSERT_SAFE_FAIL(X.match(          0,  1,  0));
      ...
      case 2: {
        ...
        //
        // Testing:
        //   bdlpcre::RegEx(bslma::Allocator *basicAllocator);
        //   ~bdlpcre::RegEx();
        //   void clear();
