...
///------------------------------------
// * `InitialCapacity` has been eliminated.  Instead, construct your
...
// * The mutex and condition variables are no longer directly exposed, in
...
// * A new, thread-safe `length` accessor is provided, eliminating the need to
