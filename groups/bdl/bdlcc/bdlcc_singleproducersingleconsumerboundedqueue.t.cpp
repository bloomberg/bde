// bdlcc_singleproducersingleconsumerboundedqueue.t.cpp               -*-C++-*-
...
typedef bdlcc::SingleProducerSingleConsumerBoundedQueue<int>          Obj;

typedef bdlcc::SingleProducerSingleConsumerBoundedQueue<bsl::string>  AllocObj;
...
typedef bdlcc::SingleProducerSingleConsumerBoundedQueue<OrderingValue>
                                                                   OrderingObj;
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 10: {
        ...
        bdlcc::SingleProducerSingleConsumerBoundedQueue<
                                         TemplateRequirementTestType> queue(8);
      ...
      case 9: {
        ...
        // higher.  See internal bug report 99039150.
        {
            ...
            bdlcc::SingleProducerSingleConsumerBoundedQueue<MoveTester>
                                                                queue(42, &ta);
        ...
        if (veryVerbose) cout << "Move-only allocating type" << endl;
        {
            ...
            bdlcc::SingleProducerSingleConsumerBoundedQueue<ValueType>
                                                                queue(42, &ta);
      ...
      case 7: {
...
#ifdef BDE_BUILD_TARGET_EXC
        {
            ...
            bdlcc::SingleProducerSingleConsumerBoundedQueue<
                                              AllocExceptionHelper> mX(8, &sa);
            const bdlcc::SingleProducerSingleConsumerBoundedQueue<
                                             AllocExceptionHelper>& X = mX;
      ...
      case 6: {
...
#ifdef BSLMF_MOVABLEREF_USES_RVALUE_REFERENCES
        {
            ...
            bdlcc::SingleProducerSingleConsumerBoundedQueue<MoveTester>
                                                                    mX(8, &sa);
            const bdlcc::SingleProducerSingleConsumerBoundedQueue<MoveTester>&
                                                                    X = mX;
