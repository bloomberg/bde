...
// that type supplies 'void(*)(TYPE*)').  In 'bdlcc::ObjectPoolFunctors', the
...
// to 'getObject').  No other method of 'bdlcc::SharedObjectPool' can throw.
//
...
// a class which maintains a pool of 'bdlmca::Blob' objects and provides shared
// pointers to them.  Using 'bdlcc::ObjectPool', the class might be implemented
// like this:
//..
//  class SlowBlobPool {
...
class SharedObjectPool {
  ...
  public:
    ...
    SharedObjectPool(
        ...
        // 'ObjectPoolFunctors::DefaultCreator'), a function
