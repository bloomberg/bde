// bdlcc_singleproducerqueue.t.cpp                                    -*-C++-*-
...
// ----------------------------------------------------------------------------
// [ 2] SingleProducerQueue(bslma::Allocator *basicAllocator = 0);
// [ 5] SingleProducerQueue(capacity, *bA = 0);
// [ 2] ~SingleProducerQueue();
...
class IncorrectlyMatchingMoveConstructorTestType {
    ...
    // implementation of 'bdlcc::SingleProducerQueue' does not pass a
...
typedef bdlcc::SingleProducerQueue<int>          Obj;

typedef bdlcc::SingleProducerQueue<bsl::string>  AllocObj;
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 11: {
        ...
        bdlcc::SingleProducerQueue<TemplateRequirementTestType> queue(10);
      ...
      case 10: {
        ...
        // higher.  See internal bug report 99039150.
        {
            ...
            bdlcc::SingleProducerQueue<MoveTester> queue(42, &ta);
        ...
        if (veryVerbose) cout << "Move-only allocating type" << endl;
        {
            ...
            bdlcc::SingleProducerQueue<ValueType> queue(42, &ta);
      ...
      case 8: {
...
#ifdef BDE_BUILD_TARGET_EXC
        {
            ...
            bdlcc::SingleProducerQueue<AllocExceptionHelper>        mX(&sa);
            const bdlcc::SingleProducerQueue<AllocExceptionHelper>& X = mX;
...
#ifdef BSLMF_MOVABLEREF_USES_RVALUE_REFERENCES
        {
            bdlcc::SingleProducerQueue<MoveTester>        mX;
            const bdlcc::SingleProducerQueue<MoveTester>& X =  mX;
            ASSERT(0 == X.numElements());
      ...
      case 5: {
        ...
        //
        // Testing:
        //   SingleProducerQueue(capacity, *bA = 0);
        // --------------------------------------------------------------------
