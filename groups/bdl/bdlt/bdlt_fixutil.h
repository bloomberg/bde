...
// or 'bsl::ostream', and writes an FIX representation of the object to the
...
//
// When a leap second is detected during parsing of an FIX string, the 'second'
...
//
// The following table shows some examples of parsing an FIX string containing
...
struct FixUtil {
    ...
    // from the result of parsing an FIX representation.
