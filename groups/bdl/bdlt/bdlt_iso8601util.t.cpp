...
// [ 7] void bdlt::Iso8601UtilConfiguration::setUseZAbbreviationForUtc(bool)
// [ 7] bool bdlt::Iso8601UtilConfiguration::useZAbbreviationForUtc()
//-----------------------------------------------------------------------------
// [ 1] BREATHING TEST
// [ 8] USAGE EXAMPLE
...
void testCase2TestingGenerate()
{
    ...
    for (int i = 0; i < NUM_UTC_OFFSETS; ++i ) {
        ...
        bdlt::Iso8601UtilConfiguration::setUseZAbbreviationForUtc(true);
        {
            bsl::vector<char> dateOutput(100, '*');
            bsl::vector<char> timeOutput(100, '*');
            bsl::vector<char> datetimeOutput(100, '*');
        ...
        bdlt::Iso8601UtilConfiguration::setUseZAbbreviationForUtc(false);
        {
            bsl::vector<char> dateOutput(100, '*');
            bsl::vector<char> timeOutput(100, '*');
            bsl::vector<char> datetimeOutput(100, '*');
...
// the offset from UTC was converted to minutes.
      ...
      case 7: {
        // --------------------------------------------------------------------
        // TESTING: bdlt::Iso8601UtilConfiguration
        //
        // Concerns:
        ...
        ASSERT(false == bdlt::Iso8601UtilConfiguration::useZAbbreviationForUtc());

        bdlt::Iso8601UtilConfiguration::setUseZAbbreviationForUtc(false);
        ASSERT(false == bdlt::Iso8601UtilConfiguration::useZAbbreviationForUtc());

        bdlt::Iso8601UtilConfiguration::setUseZAbbreviationForUtc(true);
        ASSERT(true == bdlt::Iso8601UtilConfiguration::useZAbbreviationForUtc());
