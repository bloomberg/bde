      ...
      case 8: {
        ...
        }
        {
            const struct {
                ...
                // leap seconds
                { L_, "00:00:60.000",     0,  1,  0,   0,   0 },
                { L_, "22:59:60.999",    23,  0,  0, 999,   0 },
                { L_, "23:59:60.999",     0,  0,  0, 999,   0 },

                // fractional seconds
                { L_, "00:00:00.0001",    0,  0,  0,   0,   0 },
                { L_, "00:00:00.0009",    0,  0,  0,   1,   0 },
                { L_, "00:00:00.00001",   0,  0,  0,   0,   0 },
                { L_, "00:00:00.00049",   0,  0,  0,   0,   0 },
                { L_, "00:00:00.00050",   0,  0,  0,   1,   0 },
                { L_, "00:00:00.00099",   0,  0,  0,   1,   0 },
                { L_, "00:00:00.9994",    0,  0,  0, 999,   0 },
                { L_, "00:00:00.9995",    0,  0,  1,   0,   0 },
                { L_, "00:00:00.9999",    0,  0,  1,   0,   0 },
                { L_, "00:00:59.9999",    0,  1,  0,   0,   0 },
                { L_, "22:59:60.9999",   23,  0,  1,   0,   0 },
                { L_, "23:59:60.9999",    0,  0,  1,   0,   0 },

                // omit fractional seconds
                { L_, "00:00:60",         0,  1,  0,   0,   0 },
                { L_, "12:34:45",        12, 34, 45,   0,   0 },
                { L_, "12:34:45Z",       12, 34, 45,   0,   0 },
                { L_, "12:34:45+00:30",  12, 34, 45,   0,  30 },
                { L_, "00:00:00+00:30",   0,  0,  0,   0,  30 },
                { L_, "12:34:45-01:30",  12, 34, 45,   0, -90 },
                { L_, "23:59:59-01:30",  23, 59, 59,   0, -90 },
            };
            const int NUM_DATA = static_cast<int>(sizeof DATA / sizeof *DATA);
