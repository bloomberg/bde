// bdlcfxxxi_vfunc4.h                                                 -*-C++-*-
#ifndef INCLUDED_BDLCFXXXI_VFUNC4
#define INCLUDED_BDLCFXXXI_VFUNC4
...
//
//@CLASSES:
// bdlcfxxxi::Vfunc4Null: a 4-arg void no-op functor
//
// bdlcfxxxi::Vfunc4F4: a 4-arg void functor created from a 4-arg function
// bdlcfxxxi::Vfunc4F5: a 4-arg void functor created from a 5-arg function
// bdlcfxxxi::Vfunc4F6: a 4-arg void functor created from a 6-arg function
// bdlcfxxxi::Vfunc4F7: a 4-arg void functor created from a 7-arg function
// bdlcfxxxi::Vfunc4F8: a 4-arg void functor created from a 8-arg function
// bdlcfxxxi::Vfunc4F9: a 4-arg void functor created from a 9-arg function
//
// bdlcfxxxi::Vfunc4C4: a 4-arg void functor created from obj & 4-arg method
// bdlcfxxxi::Vfunc4C5: a 4-arg void functor created from obj & 5-arg method
// bdlcfxxxi::Vfunc4C6: a 4-arg void functor created from obj & 6-arg method
// bdlcfxxxi::Vfunc4C7: a 4-arg void functor created from obj & 7-arg method
// bdlcfxxxi::Vfunc4C8: a 4-arg void functor created from obj & 8-arg method
// bdlcfxxxi::Vfunc4C9: a 4-arg void functor created from obj & 9-arg method
//
// bdlcfxxxi::Vfunc4M4: a 4-arg void functor created from obj ptr & 4-arg method
// bdlcfxxxi::Vfunc4M5: a 4-arg void functor created from obj ptr & 5-arg method
// bdlcfxxxi::Vfunc4M6: a 4-arg void functor created from obj ptr & 6-arg method
// bdlcfxxxi::Vfunc4M7: a 4-arg void functor created from obj ptr & 7-arg method
// bdlcfxxxi::Vfunc4M8: a 4-arg void functor created from obj ptr & 8-arg method
// bdlcfxxxi::Vfunc4M9: a 4-arg void functor created from obj ptr & 9-arg method
//
...
// implementation of the base 'bdlcfxxxr::Vfunc4' representation based on the
...
// then the "null functor" 'bdlcfxxxi::Vfunc4Null' may be used.
//
///Language-Imposed Details
///------------------------
// For practical reasons, this component must distinguish among four types of
// functors.  The first type is a "null functor" 'bdlcfxxxi::Vfunc4Null', which
...
// implementations are named 'bcefi::Vfunc4XN' where 'X' is one of 'F', 'C', or
...
//..
// Note that a 'const' member function may be wrapped by a 'bcefi::Vfunc4MN'
// functor, but wrapping a non-'const' method by a 'bcefi::Vfunc4CN' will
// result in compile time error in most compiler implementations.
//
// Note also that, to accommodate the preservation of 'const', the
// 'bcefi::Vfunc4CN' functors hold an object 'Obj', supplied by a 'const'
// 'Obj&' in the constructor, while 'bcefi::Vfunc4MN' functors hold a pointer
...
#ifndef INCLUDED_BDLCFXXXR_VFUNC4
...
class Vfunc4Null : public bdlcfxxxr::Vfunc4<A1, A2, A3, A4> {
...
class Vfunc4F4 : public bdlcfxxxr::Vfunc4<A1, A2, A3, A4> {
    // This class defines the representation for a function object (functor),
...
class Vfunc4F5 : public bdlcfxxxr::Vfunc4<A1, A2, A3, A4> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking four arguments and
    // returning 'void', that holds a pure procedure (i.e., free function,
...
class Vfunc4F6 : public bdlcfxxxr::Vfunc4<A1, A2, A3, A4> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking four arguments and
    // returning 'void', that holds a pure procedure (i.e., free function,
...
class Vfunc4F7 : public bdlcfxxxr::Vfunc4<A1, A2, A3, A4> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking four arguments and
    // returning 'void', that holds a pure procedure (i.e., free function,
    // static member function, or functor) taking three additional trailing
...
class Vfunc4F8 : public bdlcfxxxr::Vfunc4<A1, A2, A3, A4> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking four arguments and
    // returning 'void', that holds a pure procedure (i.e., free function,
...
template <class F, class A1, class A2, class A3, class A4,
          ...
          class D5>
class Vfunc4F9 : public bdlcfxxxr::Vfunc4<A1, A2, A3, A4> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking four arguments and
    // returning 'void', that holds a pure procedure (i.e., free function,
...
class Vfunc4C4 : public bdlcfxxxr::Vfunc4<A1, A2, A3, A4> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking four arguments and
...
class Vfunc4C5 : public bdlcfxxxr::Vfunc4<A1, A2, A3, A4> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking four arguments and
    // returning 'void', that holds an object and one of that object's 'const'
...
template <class OBJ, class C, class A1, class A2, class A3, class A4,
          class D1, class D2>
class Vfunc4C6 : public bdlcfxxxr::Vfunc4<A1, A2, A3, A4> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking four arguments and
    // returning 'void', that holds an object and one of that object's 'const'
...
template <class OBJ, class C, class A1, class A2, class A3, class A4,
          class D1, class D2, class D3>
class Vfunc4C7 : public bdlcfxxxr::Vfunc4<A1, A2, A3, A4> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking four arguments and
    // returning 'void', that holds an object and one of that object's 'const'
    // member functions taking three additional trailing arguments, and the
...
template <class OBJ, class C, class A1, class A2, class A3, class A4,
          class D1, class D2, class D3,
          class D4>
class Vfunc4C8 : public bdlcfxxxr::Vfunc4<A1, A2, A3, A4> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking four arguments and
    // returning 'void', that holds an object and one of that object's 'const'
...
template <class OBJ, class C, class A1, class A2, class A3, class A4,
          class D1, class D2, class D3,
          class D4, class D5>
class Vfunc4C9 : public bdlcfxxxr::Vfunc4<A1, A2, A3, A4> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking four arguments and
    // returning 'void', that holds an object and one of that object's 'const'
...
class Vfunc4M4 : public bdlcfxxxr::Vfunc4<A1, A2, A3, A4> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking four arguments and
...
class Vfunc4M5 : public bdlcfxxxr::Vfunc4<A1, A2, A3, A4> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking four arguments and
    // returning 'void', that holds the address of an object and one of that
...
template <class OBJ, class M, class A1, class A2, class A3, class A4,
          class D1, class D2>
class Vfunc4M6 : public bdlcfxxxr::Vfunc4<A1, A2, A3, A4> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking four arguments and
    // returning 'void', that holds the address of an object and one of that
...
template <class OBJ, class M, class A1, class A2, class A3, class A4,
          class D1, class D2, class D3>
class Vfunc4M7 : public bdlcfxxxr::Vfunc4<A1, A2, A3, A4> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking four arguments and
    // returning 'void', that holds the address of an object and one of that
    // object's ('const' or non-'const') member functions taking three
...
template <class OBJ, class M, class A1, class A2, class A3, class A4,
          class D1, class D2, class D3,
          class D4>
class Vfunc4M8 : public bdlcfxxxr::Vfunc4<A1, A2, A3, A4> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking four arguments and
    // returning 'void', that holds the address of an object and one of that
...
template <class OBJ, class M, class A1, class A2, class A3, class A4,
          class D1, class D2, class D3,
          class D4, class D5>
class Vfunc4M9 : public bdlcfxxxr::Vfunc4<A1, A2, A3, A4> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking four arguments and
    // returning 'void', that holds the address of an object and one of that
...
template <class F, class A1, class A2, class A3, class A4>
inline
void Vfunc4F4<F, A1, A2, A3, A4>::execute(const A1& argument1,
                                                const A2& argument2,
                                                const A3& argument3,
...
template <class F, class A1, class A2, class A3, class A4, class D1>
inline
void Vfunc4F5<F, A1, A2, A3, A4, D1>::execute(const A1& argument1,
                                                    const A2& argument2,
                                                    const A3& argument3,
                                                    const A4& argument4) const
{
...
template <class OBJ, class C, class A1, class A2, class A3, class A4>
inline
void Vfunc4C4<OBJ, C, A1, A2, A3, A4>::execute(const A1& argument1,
                                                     const A2& argument2,
                                                     const A3& argument3,
                                                     const A4& argument4) const
{
