// bdlcfxxxi_vfunc2.h               -*-C++-*-
#ifndef INCLUDED_BDLCFXXXI_VFUNC2
#define INCLUDED_BDLCFXXXI_VFUNC2
...
//
//@CLASSES:
// bdlcfxxxi::Vfunc2Null: a 2-arg void no-op functor
//
// bdlcfxxxi::Vfunc2F2: a 2-arg void functor created from a 2-arg function
// bdlcfxxxi::Vfunc2F3: a 2-arg void functor created from a 3-arg function
// bdlcfxxxi::Vfunc2F4: a 2-arg void functor created from a 4-arg function
// bdlcfxxxi::Vfunc2F5: a 2-arg void functor created from a 5-arg function
// bdlcfxxxi::Vfunc2F6: a 2-arg void functor created from a 6-arg function
// bdlcfxxxi::Vfunc2F7: a 2-arg void functor created from a 7-arg function
// bdlcfxxxi::Vfunc2F8: a 2-arg void functor created from a 8-arg function
// bdlcfxxxi::Vfunc2F9: a 2-arg void functor created from a 9-arg function
//
// bdlcfxxxi::Vfunc2C2: a 2-arg void functor created from obj & 2-arg method
// bdlcfxxxi::Vfunc2C3: a 2-arg void functor created from obj & 3-arg method
// bdlcfxxxi::Vfunc2C4: a 2-arg void functor created from obj & 4-arg method
// bdlcfxxxi::Vfunc2C5: a 2-arg void functor created from obj & 5-arg method
// bdlcfxxxi::Vfunc2C6: a 2-arg void functor created from obj & 6-arg method
// bdlcfxxxi::Vfunc2C7: a 2-arg void functor created from obj & 7-arg method
// bdlcfxxxi::Vfunc2C8: a 2-arg void functor created from obj & 8-arg method
// bdlcfxxxi::Vfunc2C9: a 2-arg void functor created from obj & 9-arg method
//
// bdlcfxxxi::Vfunc2M2: a 2-arg void functor created from obj ptr & 2-arg method
// bdlcfxxxi::Vfunc2M3: a 2-arg void functor created from obj ptr & 3-arg method
// bdlcfxxxi::Vfunc2M4: a 2-arg void functor created from obj ptr & 4-arg method
// bdlcfxxxi::Vfunc2M5: a 2-arg void functor created from obj ptr & 5-arg method
// bdlcfxxxi::Vfunc2M6: a 2-arg void functor created from obj ptr & 6-arg method
// bdlcfxxxi::Vfunc2M7: a 2-arg void functor created from obj ptr & 7-arg method
// bdlcfxxxi::Vfunc2M8: a 2-arg void functor created from obj ptr & 8-arg method
// bdlcfxxxi::Vfunc2M9: a 2-arg void functor created from obj ptr & 9-arg method
//
...
// implementation of the base 'bdlcfxxxr::Vfunc2' representation based on the
...
// then the "null functor" 'bdlcfxxxi::Vfunc2Null' may be used.
//
///Language-Imposed Details
///------------------------
// For practical reasons, this component must distinguish among four types of
// functors.  The first type is a "null functor" 'bdlcfxxxi::Vfunc2Null', which
...
// implementations are named 'bcefi::Vfunc2XN' where 'X' is one of 'F', 'C', or
...
//..
// Note that a 'const' member function may be wrapped by a 'bcefi::Vfunc2MN'
// functor, but wrapping a non-'const' method by a 'bcefi::Vfunc2CN' will
// result in compile time error in most compiler implementations.
//
// Note also that, to accommodate the preservation of 'const', the
// 'bcefi::Vfunc2CN' functors hold an object 'Obj', supplied by a 'const'
// 'Obj&' in the constructor, while 'bcefi::Vfunc2MN' functors hold a pointer
...
// arguments, and subsequently refer to this 'bdlcfxxxi::Vfunc2F4' functor only
// through its base class, 'bdlcfxxxr::Vfunc2':
//..
...
// through the 'bdlcfxxxr::Vfunc2' base class pointer 'rep'.  This method will, in
...
class Vfunc2Null : public bdlcfxxxr::Vfunc2<A1, A2> {
...
class Vfunc2F2 : public bdlcfxxxr::Vfunc2<A1, A2> {
    // This class defines the representation for a function object (functor),
...
class Vfunc2F3 : public bdlcfxxxr::Vfunc2<A1, A2> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking two arguments and
    // returning 'void', that holds a pure procedure (i.e., free function,
...
class Vfunc2F4 : public bdlcfxxxr::Vfunc2<A1, A2> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking two arguments and
    // returning 'void', that holds a pure procedure (i.e., free function,
    ...
    // DATA
    bslalg::ConstructorProxy<F>  d_f;   // function pointer (functor)
    bslalg::ConstructorProxy<D1> d_d1;  // first embedded argument
...
class Vfunc2F5 : public bdlcfxxxr::Vfunc2<A1, A2> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking two arguments and
    // returning 'void', that holds a pure procedure (i.e., free function,
...
class Vfunc2F6 : public bdlcfxxxr::Vfunc2<A1, A2> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking two arguments and
    // returning 'void', that holds a pure procedure (i.e., free function,
...
template <class F, class A1, class A2, class D1, class D2, class D3, class D4,
          class D5>
class Vfunc2F7 : public bdlcfxxxr::Vfunc2<A1, A2> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking two arguments and
    // returning 'void', that holds a pure procedure (i.e., free function,
...
template <class  F, class A1, class A2, class D1, class D2, class D3, class D4,
          class D5, class D6>
class Vfunc2F8 : public bdlcfxxxr::Vfunc2<A1, A2> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking two arguments and
    // returning 'void', that holds a pure procedure (i.e., free function,
...
class Vfunc2F9 : public bdlcfxxxr::Vfunc2<A1, A2> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking two arguments and
    // returning 'void', that holds a pure procedure (i.e., free function,
...
class Vfunc2C2 : public bdlcfxxxr::Vfunc2<A1, A2> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking two arguments and
...
class Vfunc2C3 : public bdlcfxxxr::Vfunc2<A1, A2> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking two arguments and
    // returning 'void', that holds an object and one of that object's 'const'
...
class Vfunc2C4 : public bdlcfxxxr::Vfunc2<A1, A2> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking two arguments and
    // returning 'void', that holds an object and one of that object's 'const'
...
class Vfunc2C5 : public bdlcfxxxr::Vfunc2<A1, A2> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking two arguments and
    // returning 'void', that holds an object and one of that object's 'const'
...
template <class OBJ, class C, class A1, class A2, class D1, class D2, class D3,
          class D4>
class Vfunc2C6 : public bdlcfxxxr::Vfunc2<A1, A2> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking two arguments and
    // returning 'void', that holds an object and one of that object's 'const'
...
template <class OBJ, class C, class A1, class A2, class D1, class D2, class D3,
          class D4, class D5>
class Vfunc2C7 : public bdlcfxxxr::Vfunc2<A1, A2> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking two arguments and
    // returning 'void', that holds an object and one of that object's 'const'
...
class Vfunc2C8 : public bdlcfxxxr::Vfunc2<A1, A2> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking two arguments and
    // returning 'void', that holds an object and one of that object's 'const'
...
class Vfunc2C9 : public bdlcfxxxr::Vfunc2<A1, A2> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking two arguments and
    // returning 'void', that holds an object and one of that object's 'const'
...
class Vfunc2M2 : public bdlcfxxxr::Vfunc2<A1, A2> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking two arguments and
...
class Vfunc2M3 : public bdlcfxxxr::Vfunc2<A1, A2> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking two arguments and
    // returning 'void', that holds the address of an object and one of that
...
class Vfunc2M4 : public bdlcfxxxr::Vfunc2<A1, A2> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking two arguments and
    // returning 'void', that holds the address of an object and one of that
...
class Vfunc2M5 : public bdlcfxxxr::Vfunc2<A1, A2> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking two arguments and
    // returning 'void', that holds the address of an object and one of that
...
template <class OBJ, class M, class A1, class A2, class D1, class D2, class D3,
          class D4>
class Vfunc2M6 : public bdlcfxxxr::Vfunc2<A1, A2> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking two arguments and
    // returning 'void', that holds the address of an object and one of that
...
template <class OBJ, class M, class A1, class A2, class D1, class D2, class D3,
          class D4, class D5>
class Vfunc2M7 : public bdlcfxxxr::Vfunc2<A1, A2> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking two arguments and
    // returning 'void', that holds the address of an object and one of that
...
template <class OBJ, class M, class A1, class A2, class D1, class D2, class D3,
          class D4, class D5, class D6>
class Vfunc2M8 : public bdlcfxxxr::Vfunc2<A1, A2> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking two arguments and
    // returning 'void', that holds the address of an object and one of that
...
template <class OBJ, class M, class A1, class A2, class D1, class D2, class D3,
          class D4, class D5, class D6, class D7>
class Vfunc2M9 : public bdlcfxxxr::Vfunc2<A1, A2> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking two arguments and
    // returning 'void', that holds the address of an object and one of that
...
: bdlcfxxxr::Vfunc2<A1, A2>(basicAllocator)
{
}
...
template <class OBJ, class C, class A1, class A2>
inline
Vfunc2C2<OBJ, C, A1, A2>::Vfunc2C2(const OBJ&       object,
                                               C                method,
                                               bslma::Allocator*basicAllocator)
: bdlcfxxxr::Vfunc2<A1, A2>(basicAllocator)
...
template <class OBJ, class C, class A1, class A2, class D1, class D2>
inline
void Vfunc2C4<OBJ, C, A1, A2, D1, D2>::execute(
                                                   const A1& argument1,
                                                   const A2& argument2) const
{
    const OBJ& obj = d_obj.object();  // for readability
...
template <class OBJ, class M, class A1, class A2>
inline
Vfunc2M2<OBJ, M, A1, A2>::Vfunc2M2(OBJ             *object,
                                               M                method,
                                               bslma::Allocator*basicAllocator)
: bdlcfxxxr::Vfunc2<A1, A2>(basicAllocator)
, d_obj_p(object)
