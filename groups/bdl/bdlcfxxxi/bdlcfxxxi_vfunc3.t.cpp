...
// non-'const' member function for every 'bcefi::Vfunc3MN' class.  Also, verify
...
//  'c_O'     for 'const OBJ'
//-----------------------------------------------------------------------------
// [ 3] 'bdlcfxxxi::Vfunc3Null' methods:
// [ 3] bdlcfxxxi::Vfunc3Null<A1-3>(ba *);
// [ 3] void execute<A1-3>(c_A1-3&) const;
// [ 3] ~bdlcfxxxi::Vfunc3Null<A1-3>();
// ----------------------------------------------------------------------------
// 'bdlcfxxxi::Vfunc3F3' methods:
// [ 3] bdlcfxxxi::Vfunc3F3<F, A1-3>(c_F&, ba *);
// [ 3] void execute<F, A1-3>(c_A1-3&) const;
// [ 3] ~bdlcfxxxi::Vfunc3F3<F, A1-3>();
// ----------------------------------------------------------------------------
// 'bdlcfxxxi::Vfunc3C3' methods:
// [ 3] bdlcfxxxi::Vfunc3C3<OBJ, C, A1-3>( OBJ *, c_C&, ba *);
// [ 3] void execute<OBJ, C, A1-3>(c_A1-3&) const;
// [ 3] ~bdlcfxxxi::Vfunc3C3<OBJ, C, A1-3>();
// ----------------------------------------------------------------------------
// 'bdlcfxxxi::Vfunc3M3' methods:
// [ 3] bdlcfxxxi::Vfunc3M3<OBJ, M, A1-3>( OBJ *, c_M&, ba *);
// [ 3] void execute<OBJ, M, A1-3>(c_A1-3&) const;
// [ 3] ~bdlcfxxxi::Vfunc3M3<OBJ, M, A1-3>();
//-----------------------------------------------------------------------------
// 'bdlcfxxxi::Vfunc3F4' methods:
// [ 4] bdlcfxxxi::Vfunc3F4<F, A1-3, D1>(c_F&, c_D1&, ba *);
// [ 4] void execute<F, A1-3, D1>(c_A1-3&) const;
// [ 4] ~bdlcfxxxi::Vfunc3F4<F, A1-3, D1>();
// ----------------------------------------------------------------------------
// 'bdlcfxxxi::Vfunc3C4' methods:
// [ 4] bdlcfxxxi::Vfunc3C4<OBJ, C, A1-3, D1>( OBJ *, c_C&, c_D1&, ba *);
// [ 4] void execute<OBJ, C, A1-3, D1>(c_A1-3&) const;
// [ 4] ~bdlcfxxxi::Vfunc3C4<OBJ, C, A1-3, D1>();
// ----------------------------------------------------------------------------
// 'bdlcfxxxi::Vfunc3M4' methods:
// [ 4] bdlcfxxxi::Vfunc3M4<OBJ, M, A1-3, D1>( OBJ *, c_M&, c_D1, ba *);
// [ 4] void execute<OBJ, M, A1-3, D1>(c_A1-3&) const;
// [ 4] ~bdlcfxxxi::Vfunc3M4<OBJ, M, A1-3, D1>();
//-----------------------------------------------------------------------------
// 'bdlcfxxxi::Vfunc3F5' methods:
// [ 5] bdlcfxxxi::Vfunc3F5<F, A1-3, D1-2>(c_F&, c_D1-2&, ba *);
// [ 5] void execute<F, A1-3, D1-2>(c_A1-3&) const;
// [ 5] ~bdlcfxxxi::Vfunc3F5<F, A1-3, D1-2>();
// ----------------------------------------------------------------------------
// 'bdlcfxxxi::Vfunc3C5' methods:
// [ 5] bdlcfxxxi::Vfunc3C5<OBJ, C, A1-3, D1-2>( OBJ *, c_C&, c_D1-2&, ba *);
// [ 5] void execute<OBJ, C, A1-3, D1-2>(c_A1-3&) const;
// [ 5] ~bdlcfxxxi::Vfunc3C5<OBJ, C, A1-3, D1-2>();
// ----------------------------------------------------------------------------
// 'bdlcfxxxi::Vfunc3M5' methods:
// [ 5] bdlcfxxxi::Vfunc3M5<OBJ, M, A1-3, D1-2>( OBJ *, c_M&, c_D1-2, ba *);
// [ 5] void execute<OBJ, M, A1-3, D1-2>(c_A1-3&) const;
// [ 5] ~bdlcfxxxi::Vfunc3M5<OBJ, M, A1-3, D1-2>();
//-----------------------------------------------------------------------------
// 'bdlcfxxxi::Vfunc3F6' methods:
// [ 6] bdlcfxxxi::Vfunc3F6<F, A1-3, D1-3>(c_F&, c_D1-3&, ba *);
// [ 6] void execute<F, A1-3, D1-3>(c_A1-3&) const;
// [ 6] ~bdlcfxxxi::Vfunc3F6<F, A1-3, D1-3>();
// ----------------------------------------------------------------------------
// 'bdlcfxxxi::Vfunc3C6' methods:
// [ 6] bdlcfxxxi::Vfunc3C6<OBJ, C, A1-3, D1-3>( OBJ *, c_C&, c_D1-3&, ba *);
// [ 6] void execute<OBJ, C, A1-3, D1-3>(c_A1-3&) const;
// [ 6] ~bdlcfxxxi::Vfunc3C6<OBJ, C, A1-3, D1-3>();
// ----------------------------------------------------------------------------
// 'bdlcfxxxi::Vfunc3M6' methods:
// [ 6] bdlcfxxxi::Vfunc3M6<OBJ, M, A1-3, D1-3>( OBJ *, c_M&, c_D1-3, ba *);
// [ 6] void execute<OBJ, M, A1-3, D1-3>(c_A1-3&) const;
// [ 6] ~bdlcfxxxi::Vfunc3M6<OBJ, M, A1-3, D1-3>();
//-----------------------------------------------------------------------------
// 'bdlcfxxxi::Vfunc3F7' methods:
// [ 7] bdlcfxxxi::Vfunc3F7<F, A1-3, D1-4>(c_F&, c_D1-4&, ba *);
// [ 7] void execute<F, A1-3, D1-4>(c_A1-3&) const;
// [ 7] ~bdlcfxxxi::Vfunc3F7<F, A1-3, D1-4>();
// ----------------------------------------------------------------------------
// 'bdlcfxxxi::Vfunc3C7' methods:
// [ 7] bdlcfxxxi::Vfunc3C7<OBJ, C, A1-3, D1-4>( OBJ *, c_C&, c_D1-4&, ba *);
// [ 7] void execute<OBJ, C, A1-3, D1-4>(c_A1-3&) const;
// [ 7] ~bdlcfxxxi::Vfunc3C7<OBJ, C, A1-3, D1-4>();
// ----------------------------------------------------------------------------
// 'bdlcfxxxi::Vfunc3M7' methods:
// [ 7] bdlcfxxxi::Vfunc3M7<OBJ, M, A1-3, D1-4>( OBJ *, c_M&, c_D1-4, ba *);
// [ 7] void execute<OBJ, M, A1-3, D1-4>(c_A1-3&) const;
// [ 7] ~bdlcfxxxi::Vfunc3M7<OBJ, M, A1-3, D1-4>();
//-----------------------------------------------------------------------------
// 'bdlcfxxxi::Vfunc3F8' methods:
// [ 8] bdlcfxxxi::Vfunc3F8<F, A1-3, D1-5>(c_F&, c_D1-5&, ba *);
// [ 8] void execute<F, A1-3, D1-5>(c_A1-3&) const;
// [ 8] ~bdlcfxxxi::Vfunc3F8<F, A1-3, D1-5>();
// ----------------------------------------------------------------------------
// 'bdlcfxxxi::Vfunc3C8' methods:
// [ 8] bdlcfxxxi::Vfunc3C8<OBJ, C, A1-3, D1-5>( OBJ *, c_C&, c_D1-5&, ba *);
// [ 8] void execute<OBJ, C, A1-3, D1-5>(c_A1-3&) const;
// [ 8] ~bdlcfxxxi::Vfunc3C8<OBJ, C, A1-3, D1-5>();
// ----------------------------------------------------------------------------
// 'bdlcfxxxi::Vfunc3M8' methods:
// [ 8] bdlcfxxxi::Vfunc3M8<OBJ, M, A1-3, D1-5>( OBJ *, c_M&, c_D1-5, ba *);
// [ 8] void execute<OBJ, M, A1-3, D1-5>(c_A1-3&) const;
// [ 8] ~bdlcfxxxi::Vfunc3M8<OBJ, M, A1-3, D1-5>();
//-----------------------------------------------------------------------------
// 'bdlcfxxxi::Vfunc3F9' methods:
// [ 9] bdlcfxxxi::Vfunc3F9<F, A1-3, D1-6>(c_F&, c_D1-6&, ba *);
// [ 9] void execute<F, A1-3, D1-6>(c_A1-3&) const;
// [ 9] ~bdlcfxxxi::Vfunc3F9<F, A1-3, D1-6>();
// ----------------------------------------------------------------------------
// 'bdlcfxxxi::Vfunc3C9' methods:
// [ 9] bdlcfxxxi::Vfunc3C9<OBJ, C, A1-3, D1-6>( OBJ *, c_C&, c_D1-6&, ba *);
// [ 9] void execute<OBJ, C, A1-3, D1-6>(c_A1-3&) const;
// [ 9] ~bdlcfxxxi::Vfunc3C9<OBJ, C, A1-3, D1-6>();
// ----------------------------------------------------------------------------
// 'bdlcfxxxi::Vfunc3M9' methods:
// [ 9] bdlcfxxxi::Vfunc3M9<OBJ, M, A1-3, D1-6>( OBJ *, c_M&, c_D1-6, ba *);
// [ 9] void execute<OBJ, M, A1-3, D1-6>(c_A1-3&) const;
// [ 9] ~bdlcfxxxi::Vfunc3M9<OBJ, M, A1-3, D1-6>();
//-----------------------------------------------------------------------------
// [11] USAGE EXAMPLE
...
//       // that 'bcefi::vfunc3X4' classes pass when calling the callback
//       // function.
//       //
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 10: {
        ...
        //   'pragma' in 'bdlcfxxxi_vfunc3.h' fixes this problem.  This test
...

        {
            ...
            typedef bdlcfxxxr::Vfunc3<rrr *, rrr *, rrr *> ObjBase;

            typedef bdlcfxxxi::Vfunc3F9<CbFuncF9,
                                       rrr *, rrr *, rrr *, rrr *,
                                       rrr *, rrr *, rrr *, rrr *, rrr *> Obj1;

            typedef bdlcfxxxi::Vfunc3F9<CbFuncF10,
                                       rrr *, rrr *, rrr *, rrr *,
      ...
      case 9: {
        ...
        //       functions by 'bdlcfxxxi::Vfunc3M9' instances.
        //    5. Destructor of each class under test is properly executed.
        //
        // Plan:
        //   Create objects of every 'bcefi::Vfunc3X9' class.  Initialize
        //   'bdlcfxxxi::Vfunc3F9' to have 'checkArgumentValues9' as the callback
        //   function.  Initialize 'bdlcfxxxi::Vfunc3C9' and 'bdlcfxxxi::Vfunc3M9' to
        //   have 'checkArgumentValues9' method of the 'CbClass' class as the
        //   callback function.  Call the 'execute' method for each
        //   'bcefi::Vfunc3X9' class.  The arguments in this call are
        ...
        //
        //   Create objects of every 'bcefi::Vfunc3X9' class.  Initialize
        //   'bdlcfxxxi::Vfunc3F9' to have 'checkParameterTypes9' as the callback
        //   function.  Initialize 'bdlcfxxxi::Vfunc3C9' to have
        //   'checkParameterTypesC9' method of the 'CbClass' class as the
        //   callback function.  Initialize 'bdlcfxxxi::Vfunc3M9' to have
        //   'checkParameterTypesM9' method of the 'CbClass' class as the
        //   callback function.  The latter will test wether the
        //   'bdlcfxxxi::Vfunc3M9' can have non-'const' functions as the callback
        //   function.
        //
        //   Having a function of 'checkParameterTypes' family as a callback
        //   function forces 'bcefi::Vfunc3X9' to be templatized so that each
        ...
        // Testing:
        //   'bdlcfxxxi::Vfunc3F9' methods:
        //   bdlcfxxxi::Vfunc3F9<F, A1-3, D1-6>(c_F&, c_D1-6&, ba *);
        //   void execute<F, A1-3, D1-6>(c_A1-3&) const;
        //   ~bdlcfxxxi::Vfunc3F9<F, A1-3, D1-6>();
        // --------------------------------------------------------------------
        //   'bdlcfxxxi::Vfunc3C9' methods:
        //   bdlcfxxxi::Vfunc3C9<OBJ, C, A1-3, D1-6>( OBJ *, c_C&, c_D1-6&, ba *);
        //   void execute<OBJ, C, A1-3, D1-6>(c_A1-3&) const;
        //   ~bdlcfxxxi::Vfunc3C9<OBJ, C, A1-3, D1-6>();
        // --------------------------------------------------------------------
        //   'bdlcfxxxi::Vfunc3M9' methods:
        //   bdlcfxxxi::Vfunc3M9<OBJ, M, A1-3, D1-6>( OBJ *, c_M&, c_D1-6, ba *);
        //    void execute<OBJ, M, A1-3, D1-6>(c_A1-3&) const;
        //   ~bdlcfxxxi::Vfunc3M9<OBJ, M, A1-3, D1-6>();
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting constructors and argument values." << endl;
        {
            ...
            typedef void (CbClass::*CbFuncC9)(int *, int *, int *, int *,
                                              int *, int *, int *, int *,
                                              int *) const;
            typedef bdlcfxxxr::Vfunc3<int *, int *, int *> ObjBase;
            ...
            if (verbose) cout << "\t'bdlcfxxxi::Vfunc3F9' object." << endl;
            {
                typedef bdlcfxxxi::Vfunc3F9<CbFuncF9,
                                       int *, int *, int *, int *,
            ...
            if (verbose) cout << "\t'bdlcfxxxi::Vfunc3C9' object." << endl;
            {
                typedef bdlcfxxxi::Vfunc3C9<CbClass, CbFuncC9, int *, int *,
                                       int *, int *, int *, int *, int *,
                                       int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
            ...
            if (verbose) cout << "\t'bdlcfxxxi::Vfunc3M9' object." << endl;
            {
                typedef bdlcfxxxi::Vfunc3M9<CbClass, CbFuncC9,
                                       int *, int *, int *, int *,
                                       int *, int *, int *, int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
            ...
            cout << "\nTesting parameter types and destructors." << endl;
        {
            ...
            typedef void (CbClass::*CbFuncM9)(T1, T2, T3, T4, T5, T6, T7, T8,
                                              T9);
            typedef bdlcfxxxr::Vfunc3<T1, T2, T3> ObjBase;
            ...
            if (verbose)
                cout << "\tWhen calling 'bdlcfxxxi::Vfunc3F9' 'execute' method."
                     << endl;
            {
                typedef bdlcfxxxi::Vfunc3F9<CbFuncF9, T1, T2, T3, T4, T5, T6, T7,
                                       T8, T9> Obj;
                dcEnabled = 0;
            ...
            if (verbose)
                cout << "\tWhen calling 'bdlcfxxxi::Vfunc3C9' 'execute' method."
                     << endl;
            {
                typedef bdlcfxxxi::Vfunc3C9<CbClass, CbFuncC9, T1, T2,
            ...
            if (verbose)
                cout << "\tWhen calling 'bdlcfxxxi::Vfunc3M9' 'execute' method."
                     << endl;
            {
                typedef bdlcfxxxi::Vfunc3M9<CbClass, CbFuncM9, T1, T2, T3, T4,
                                       T5, T6, T7, T8, T9> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG3;
                numDeallocations = ta.numDeallocations();
      ...
      case 8: {
        ...
        //       those intended as argument types for the function parameters.
        //    4. Non-'const' member functions can be used as callback
        //       functions by 'bdlcfxxxi::Vfunc3M8' instances.
        //    5. Destructor of each class under test is properly executed.
        //
        // Plan:
        //   Create objects of every 'bcefi::Vfunc3X8' class.  Initialize
        //   'bdlcfxxxi::Vfunc3F8' to have 'checkArgumentValues8' as the callback
        //   function.  Initialize 'bdlcfxxxi::Vfunc3C8' and 'bdlcfxxxi::Vfunc3M8' to
        //   have 'checkArgumentValues8' method of the 'CbClass' class as the
        //   callback function.  Call the 'execute' method for each
        //   'bcefi::Vfunc3X8' class.  The arguments in this call are
        //   initialized with values of 'ARG1', 'ARG2', 'ARG3', 'ARG4',
        ...
        //
        //   Create objects of every 'bcefi::Vfunc3X8' class.  Initialize
        //   'bdlcfxxxi::Vfunc3F8' to have 'checkParameterTypes8' as the callback
        //   function.  Initialize 'bdlcfxxxi::Vfunc3C8' to have
        //   'checkParameterTypesC8' method of the 'CbClass' class as the
        //   callback function.  Initialize 'bdlcfxxxi::Vfunc3M8' to have
        //   'checkParameterTypesM8' method of the 'CbClass' class as the
        //   callback function.  The latter will test wether the
        //   'bdlcfxxxi::Vfunc3M8' can have non-'const' functions as the callback
        //   function.
        //
        //   Having a function of 'checkParameterTypes' family as a callback
        //   function forces 'bcefi::Vfunc3X8' to be templatized so that each
        //   argument to the callback function will be of unique type.  Hence,
        //   if the types of arguments passed in to the callback function is
        //   incorrect, the compiler will generate an error.
        //
        ...
        // Testing:
        //   'bdlcfxxxi::Vfunc3F8' methods:
        //   bdlcfxxxi::Vfunc3F8<F, A1-3, D1-5>(c_F&, c_D1-5&, ba *);
        //   void execute<F, A1-3, D1-5>(c_A1-3&) const;
        //   ~bdlcfxxxi::Vfunc3F8<F, A1-3, D1-5>();
        // -------------------------------------------------------------------
        //   'bdlcfxxxi::Vfunc3C8' methods:
        //   bdlcfxxxi::Vfunc3C8<OBJ, C, A1-3, D1-5>( OBJ *, c_C&, c_D1-5&, ba *);
        //   void execute<OBJ, C, A1-3, D1-5>(c_A1-3&) const;
        //   ~bdlcfxxxi::Vfunc3C8<OBJ, C, A1-3, D1-5>();
        // --------------------------------------------------------------------
        //   'bdlcfxxxi::Vfunc3M8' methods:
        //   bdlcfxxxi::Vfunc3M8<OBJ, M, A1-3, D1-5>( OBJ *, c_M&, c_D1-5, ba *);
        //    void execute<OBJ, M, A1-3, D1-5>(c_A1-3&) const;
        //   ~bdlcfxxxi::Vfunc3M8<OBJ, M, A1-3, D1-5>();
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting constructors and argument values." << endl;
        {
            ...
            if (verbose) cout << "\t'bdlcfxxxi::Vfunc3F8' object." << endl;
            {
                typedef bdlcfxxxi::Vfunc3F8<CbFuncF8,
                                       int *, int *, int *, int *,
                                       int *, int *, int *, int *> Obj;
            ...
            if (verbose) cout << "\t'bdlcfxxxi::Vfunc3C8' object." << endl;
            {
                typedef bdlcfxxxi::Vfunc3C8<CbClass, CbFuncC8, int *, int *,
                                       int *, int *, int *, int *,
                                       int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
            ...
            if (verbose) cout << "\t'bdlcfxxxi::Vfunc3M8' object." << endl;
            {
                typedef bdlcfxxxi::Vfunc3M8<CbClass, CbFuncC8,
                                       int *, int *, int *, int *,
                                       int *, int *, int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
            ...
            cout << "\nTesting parameter types and destructors." << endl;
        {
            ...
            if (verbose)
                cout << "\tWhen calling 'bdlcfxxxi::Vfunc3F8' 'execute' method."
                     << endl;
            {
                typedef bdlcfxxxi::Vfunc3F8<CbFuncF8, T1, T2, T3, T4, T5, T6, T7,
                                       T8> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG3;
                numDeallocations = ta.numDeallocations();
            ...
            if (verbose)
                cout << "\tWhen calling 'bdlcfxxxi::Vfunc3C8' 'execute' method."
                     << endl;
            {
                typedef bdlcfxxxi::Vfunc3C8<CbClass, CbFuncC8, T1, T2,
            ...
            if (verbose)
                cout << "\tWhen calling 'bdlcfxxxi::Vfunc3M8' 'execute' method."
                     << endl;
            {
                typedef bdlcfxxxi::Vfunc3M8<CbClass, CbFuncM8, T1, T2, T3, T4,
                                       T5, T6, T7, T8> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG3;
                numDeallocations = ta.numDeallocations();
      ...
      case 7: {
        ...
        //       those intended as argument types for the function parameters.
        //    4. Non-'const' member functions can be used as callback
        //       functions by 'bdlcfxxxi::Vfunc3M7' instances.
        //    5. Destructor of each class under test is properly executed.
        //
        // Plan:
        //   Create objects of every 'bcefi::Vfunc3X7' class.  Initialize
        //   'bdlcfxxxi::Vfunc3F7' to have 'checkArgumentValues7' as the callback
        //   function.  Initialize 'bdlcfxxxi::Vfunc3C7' and 'bdlcfxxxi::Vfunc3M7' to
        //   have 'checkArgumentValues7' method of the 'CbClass' class as the
        //   callback function.  Call the 'execute' method for each
        //   'bcefi::Vfunc3X7' class.  The arguments in this call are
        //   initialized with values of 'ARG1', 'ARG2', 'ARG3', 'ARG4',
        ...
        //
        //   Create objects of every 'bcefi::Vfunc3X7' class.  Initialize
        //   'bdlcfxxxi::Vfunc3F7' to have 'checkParameterTypes7' as the callback
        //   function.  Initialize 'bdlcfxxxi::Vfunc3C7' to have
        //   'checkParameterTypesC7' method of the 'CbClass' class as the
        //   callback function.  Initialize 'bdlcfxxxi::Vfunc3M7' to have
        //   'checkParameterTypesM7' method of the 'CbClass' class as the
        //   callback function.  The latter will test wether the
        //   'bdlcfxxxi::Vfunc3M7' can have non-'const' functions as the callback
        //   function.
        //
        //   Having a function of 'checkParameterTypes' family as a callback
        //   function forces 'bcefi::Vfunc3X7' to be templatized so that each
        //   argument to the callback function will be of unique type.  Hence,
        //   if the types of arguments passed in to the callback function is
        //   incorrect, the compiler will generate an error.
        //
        ...
        // Testing:
        //   'bdlcfxxxi::Vfunc3F7' methods:
        //   bdlcfxxxi::Vfunc3F7<F, A1-3, D1-4>(c_F&, c_D1-4&, ba *);
        //   void execute<F, A1-3, D1-4>(c_A1-3&) const;
        //   ~bdlcfxxxi::Vfunc3F7<F, A1-3, D1-4>();
        // --------------------------------------------------------------------
        //   'bdlcfxxxi::Vfunc3C7' methods:
        //   bdlcfxxxi::Vfunc3C7<OBJ, C, A1-3, D1-4>( OBJ *, c_C&, c_D1-4&, ba *);
        //   void execute<OBJ, C, A1-3, D1-4>(c_A1-3&) const;
        //   ~bdlcfxxxi::Vfunc3C7<OBJ, C, A1-3, D1-4>();
        // --------------------------------------------------------------------
        //   'bdlcfxxxi::Vfunc3M7' methods:
        //   bdlcfxxxi::Vfunc3M7<OBJ, M, A1-3, D1-4>( OBJ *, c_M&, c_D1-4, ba *);
        //   void execute<OBJ, M, A1-3, D1-4>(c_A1-3&) const;
        //   ~bdlcfxxxi::Vfunc3M7<OBJ, M, A1-3, D1-4>();
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting constructors and argument values." << endl;
        {
            ...
            if (verbose) cout << "\t'bdlcfxxxi::Vfunc3F7' object." << endl;
            {
                typedef bdlcfxxxi::Vfunc3F7<CbFuncF7,
                                       int *, int *, int *,
                                       int *, int *, int *, int *> Obj;
            ...
            if (verbose) cout << "\t'bdlcfxxxi::Vfunc3C7' object." << endl;
            {
                typedef bdlcfxxxi::Vfunc3C7<CbClass, CbFuncC7, int *,
                                       int *, int *, int *, int *,
                                       int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
            ...
            if (verbose) cout << "\t'bdlcfxxxi::Vfunc3M7' object." << endl;
            {
                typedef bdlcfxxxi::Vfunc3M7<CbClass, CbFuncC7,
                                       int *, int *, int *,
                                       int *, int *, int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
            ...
            cout << "\nTesting parameter types and destructors." << endl;
        {
            ...
            if (verbose)
                cout << "\tWhen calling 'bdlcfxxxi::Vfunc3F7' 'execute' method."
                     << endl;
            {
                typedef bdlcfxxxi::Vfunc3F7<CbFuncF7, T1, T2, T3, T4, T5, T6,
                                       T7> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG3;
                numDeallocations = ta.numDeallocations();
            ...
            if (verbose)
                cout << "\tWhen calling 'bdlcfxxxi::Vfunc3C7' 'execute' method."
                     << endl;
            {
                typedef bdlcfxxxi::Vfunc3C7<CbClass, CbFuncC7, T1, T2,
                                       T3, T4, T5, T6, T7> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG3;
                numDeallocations = ta.numDeallocations();
            ...
            if (verbose)
                cout << "\tWhen calling 'bdlcfxxxi::Vfunc3M7' 'execute' method."
                     << endl;
            {
                typedef bdlcfxxxi::Vfunc3M7<CbClass, CbFuncM7, T1, T2, T3, T4,
                                       T5, T6, T7> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG3;
                numDeallocations = ta.numDeallocations();
      ...
      case 6: {
        ...
        //       those intended as argument types for the function parameters.
        //    4. Non-'const' member functions can be used as callback
        //       functions by 'bdlcfxxxi::Vfunc3M6' instances.
        //    5. Destructor of each class under test is properly executed.
        //
        // Plan:
        //   Create objects of every 'bcefi::Vfunc3X6' class.  Initialize
        //   'bdlcfxxxi::Vfunc3F6' to have 'checkArgumentValues6' as the callback
        //   function.  Initialize 'bdlcfxxxi::Vfunc3C6' and 'bdlcfxxxi::Vfunc3M6' to
        //   have 'checkArgumentValues6' method of the 'CbClass' class as the
        //   callback function.  Call the 'execute' method for each
        //   'bcefi::Vfunc3X6' class.  The arguments in this call are
        //   initialized with values of 'ARG1', 'ARG2', 'ARG3', 'ARG4',
        ...
        //
        //   Create objects of every 'bcefi::Vfunc3X6' class.  Initialize
        //   'bdlcfxxxi::Vfunc3F6' to have 'checkParameterTypes6' as the callback
        //   function.  Initialize 'bdlcfxxxi::Vfunc3C6' to have
        //   'checkParameterTypesC6' method of the 'CbClass' class as the
        //   callback function.  Initialize 'bdlcfxxxi::Vfunc3M6' to have
        //   'checkParameterTypesM6' method of the 'CbClass' class as the
        //   callback function.  The latter will test wether the
        //   'bdlcfxxxi::Vfunc3M6' can have non-'const' functions as the callback
        //   function.
        //
        //   Having a function of 'checkParameterTypes' family as a callback
        //   function forces 'bcefi::Vfunc3X6' to be templatized so that each
        //   argument to the callback function will be of unique type.  Hence,
        //   if the types of arguments passed in to the callback function is
        //   incorrect, the compiler will generate an error.
        //
        ...
        // Testing:
        //   'bdlcfxxxi::Vfunc3F6' methods:
        //   bdlcfxxxi::Vfunc3F6<F, A1-3, D1-3>(c_F&, c_D1-3&, ba *);
        //   void execute<F, A1-3, D1-3>(c_A1-3&) const;
        //   ~bdlcfxxxi::Vfunc3F6<F, A1-3, D1-3>();
        // --------------------------------------------------------------------
        //   'bdlcfxxxi::Vfunc3C6' methods:
        //   bdlcfxxxi::Vfunc3C6<OBJ, C, A1-3, D1-3>( OBJ *, c_C&, c_D1-3&, ba *);
        //   void execute<OBJ, C, A1-3, D1-3>(c_A1-3&) const;
        //   ~bdlcfxxxi::Vfunc3C6<OBJ, C, A1-3, D1-3>();
        // --------------------------------------------------------------------
        //   'bdlcfxxxi::Vfunc3M6' methods:
        //   bdlcfxxxi::Vfunc3M6<OBJ, M, A1-3, D1-3>( OBJ *, c_M&, c_D1-3, ba *);
        //    void execute<OBJ, M, A1-3, D1-3>(c_A1-3&) const;
        //   ~bdlcfxxxi::Vfunc3M6<OBJ, M, A1-3, D1-3>();
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting constructors and argument values." << endl;
        {
            ...
            if (verbose) cout << "\t'bdlcfxxxi::Vfunc3F6' object." << endl;
            {
                typedef bdlcfxxxi::Vfunc3F6<CbFuncF6,
                                       int *, int *, int *,
                                       int *, int *, int *> Obj;
            ...
            if (verbose) cout << "\t'bdlcfxxxi::Vfunc3C6' object." << endl;
            {
                typedef bdlcfxxxi::Vfunc3C6<CbClass, CbFuncC6, int *,
                                       int *, int *, int *,
                                       int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
            ...
            if (verbose) cout << "\t'bdlcfxxxi::Vfunc3M6' object." << endl;
            {
                typedef bdlcfxxxi::Vfunc3M6<CbClass, CbFuncC6,
                                       int *, int *, int *,
                                       int *, int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
            ...
            cout << "\nTesting parameter types and destructors." << endl;
        {
            ...
            if (verbose)
                cout << "\tWhen calling 'bdlcfxxxi::Vfunc3F6' 'execute' method."
                     << endl;
            {
                typedef bdlcfxxxi::Vfunc3F6<CbFuncF6, T1, T2, T3, T4, T5, T6> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG3;
                numDeallocations = ta.numDeallocations();
            ...
            if (verbose)
                cout << "\tWhen calling 'bdlcfxxxi::Vfunc3C6' 'execute' method."
                     << endl;
            {
                typedef bdlcfxxxi::Vfunc3C6<CbClass, CbFuncC6, T1, T2,
                                       T3, T4, T5, T6> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG3;
                numDeallocations = ta.numDeallocations();
            ...
            if (verbose)
                cout << "\tWhen calling 'bdlcfxxxi::Vfunc3M6' 'execute' method."
                     << endl;
            {
                typedef bdlcfxxxi::Vfunc3M6<CbClass, CbFuncM6, T1, T2, T3, T4,
                                       T5, T6> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG3;
                numDeallocations = ta.numDeallocations();
      ...
      case 5: {
        ...
        //       those intended as argument types for the function parameters.
        //    4. Non-'const' member functions can be used as callback
        //       functions by 'bdlcfxxxi::Vfunc3M5' instances.
        //    5. Destructor of each class under test is properly executed.
        //
        // Plan:
        //   Create objects of every 'bcefi::Vfunc3X5' class.  Initialize
        //   'bdlcfxxxi::Vfunc3F5' to have 'checkArgumentValues5' as the callback
        //   function.  Initialize 'bdlcfxxxi::Vfunc3C5' and 'bdlcfxxxi::Vfunc3M5' to
        //   have 'checkArgumentValues5' method of the 'CbClass' class as the
        //   callback function.  Call the 'execute' method for each
        //   'bcefi::Vfunc3X5' class.  The arguments in this call are
        ...
        //
        //   Create objects of every 'bcefi::Vfunc3X5' class.  Initialize
        //   'bdlcfxxxi::Vfunc3F5' to have 'checkParameterTypes5' as the callback
        //   function.  Initialize 'bdlcfxxxi::Vfunc3C5' to have
        //   'checkParameterTypesC5' method of the 'CbClass' class as the
        //   callback function.  Initialize 'bdlcfxxxi::Vfunc3M5' to have
        //   'checkParameterTypesM5' method of the 'CbClass' class as the
        //   callback function.  The latter will test wether the
        //   'bdlcfxxxi::Vfunc3M5' can have non-'const' functions as the callback
        //   function.
        //
        //   Having a function of 'checkParameterTypes' family as a callback
        //   function forces 'bcefi::Vfunc3X5' to be templatized so that each
        //   argument to the callback function will be of unique type.  Hence,
        //   if the types of arguments passed in to the callback function is
        //   incorrect, the compiler will generate an error.
        //
        ...
        // Testing:
        //   'bdlcfxxxi::Vfunc3F5' methods:
        //   bdlcfxxxi::Vfunc3F5<F, A1-3, D1-2>(c_F&, c_D1-2&, ba *);
        //   void execute<F, A1-3, D1-2>(c_A1-3&) const;
        //   ~bdlcfxxxi::Vfunc3F5<F, A1-3, D1-2>();
        // --------------------------------------------------------------------
        //   'bdlcfxxxi::Vfunc3C5' methods:
        //   bdlcfxxxi::Vfunc3C5<OBJ, C, A1-3, D1-2>( OBJ *, c_C&, c_D1-2&, ba *);
        //   void execute<OBJ, C, A1-3, D1-2>(c_A1-3&) const;
        //   ~bdlcfxxxi::Vfunc3C5<OBJ, C, A1-3, D1-2>();
        // --------------------------------------------------------------------
        //   'bdlcfxxxi::Vfunc3M5' methods:
        //   bdlcfxxxi::Vfunc3M5<OBJ, M, A1-3, D1-2>( OBJ *, c_M&, c_D1-2, ba *);
        //   void execute<OBJ, M, A1-3, D1-2>(c_A1-3&) const;
        //   ~bdlcfxxxi::Vfunc3M5<OBJ, M, A1-3, D1-2>();
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting constructors and argument values." << endl;
        {
            ...
            if (verbose) cout << "\t'bdlcfxxxi::Vfunc3F5' object." << endl;
            {
                typedef bdlcfxxxi::Vfunc3F5<CbFuncF5, int *, int *,
                                       int *, int *, int *> Obj;
            ...
            if (verbose) cout << "\t'bdlcfxxxi::Vfunc3C5' object." << endl;
            {
                typedef bdlcfxxxi::Vfunc3C5<CbClass, CbFuncC5, int *,
                                       int *, int *, int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
                ObjBase *x = new(ta) Obj(cbObject,
            ...
            if (verbose) cout << "\t'bdlcfxxxi::Vfunc3M5' object." << endl;
            {
                typedef bdlcfxxxi::Vfunc3M5<CbClass, CbFuncC5,
                                       int *, int *, int *, int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
                ObjBase *x = new(ta) Obj(&cbObject,
            ...
            cout << "\nTesting parameter types and destructors." << endl;
        {
            ...
            if (verbose)
                cout << "\tWhen calling 'bdlcfxxxi::Vfunc3F5' 'execute' method."
                     << endl;
            {
                typedef bdlcfxxxi::Vfunc3F5<CbFuncF5, T1, T2, T3, T4, T5> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG3;
                numDeallocations = ta.numDeallocations();
            ...
            if (verbose)
                cout << "\tWhen calling 'bdlcfxxxi::Vfunc3C5' 'execute' method."
                     << endl;
            {
                typedef bdlcfxxxi::Vfunc3C5<CbClass, CbFuncC5, T1, T2,
                                       T3, T4, T5> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG3;
                numDeallocations = ta.numDeallocations();
            ...
            if (verbose)
                cout << "\tWhen calling 'bdlcfxxxi::Vfunc3M5' 'execute' method."
                     << endl;
            {
                typedef bdlcfxxxi::Vfunc3M5<CbClass, CbFuncM5, T1, T2, T3, T4,
                                       T5> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG3;
                numDeallocations = ta.numDeallocations();
      ...
      case 4: {
        ...
        //       those intended as argument types for the function parameters.
        //    4. Non-'const' member functions can be used as callback
        //       functions by 'bdlcfxxxi::Vfunc3M4' instances.
        //    5. Destructor of each class under test is properly executed.
        //
        // Plan:
        //   Create objects of every 'bcefi::Vfunc3X4' class.  Initialize
        //   'bdlcfxxxi::Vfunc3F4' to have 'checkArgumentValues4' as the callback
        //   function.  Initialize 'bdlcfxxxi::Vfunc3C4' and 'bdlcfxxxi::Vfunc3M4' to
        //   have 'checkArgumentValues4' method of the 'CbClass' class as the
        //   callback function.  Call the 'execute' method for each
        //   'bcefi::Vfunc3X4' class.  The arguments in this call are
        ...
        //
        //   Create objects of every 'bcefi::Vfunc3X4' class.  Initialize
        //   'bdlcfxxxi::Vfunc3F4' to have 'checkParameterTypes4' as the callback
        //   function.  Initialize 'bdlcfxxxi::Vfunc3C4' to have
        //   'checkParameterTypesC4' method of the 'CbClass' class as the
        //   callback function.  Initialize 'bdlcfxxxi::Vfunc3M4' to have
        //   'checkParameterTypesM4' method of the 'CbClass' class as the
        //   callback function.  The latter will test wether the
        //   'bdlcfxxxi::Vfunc3M4' can have non-'const' functions as the callback
        //   function.
        //
        //   Having a function of 'checkParameterTypes' family as a callback
        //   function forces 'bcefi::Vfunc3X4' to be templatized so that each
        //   argument to the callback function will be of unique type.  Hence,
        //   if the types of arguments passed in to the callback function is
        //   incorrect, the compiler will generate an error.
        //
        ...
        // Testing:
        //   'bdlcfxxxi::Vfunc3F4' methods:
        //   bdlcfxxxi::Vfunc3F4<F, A1-3, D1>(c_F&, c_D1&, ba *);
        //   void execute<F, A1-3, D1>(c_A1-3&) const;
        //   ~bdlcfxxxi::Vfunc3F4<F, A1-3, D1>();
        // --------------------------------------------------------------------
        //   'bdlcfxxxi::Vfunc3C4' methods:
        //   bdlcfxxxi::Vfunc3C4<OBJ, C, A1-3, D1>( OBJ *, c_C&, c_D1&, ba *);
        //   void execute<OBJ, C, A1-3, D1>(c_A1-3&) const;
        //   ~bdlcfxxxi::Vfunc3C4<OBJ, C, A1-3, D1>();
        // --------------------------------------------------------------------
        //   'bdlcfxxxi::Vfunc3M4' methods:
        //   bdlcfxxxi::Vfunc3M4<OBJ, M, A1-3, D1>( OBJ *, c_M&, c_D1, ba *);
        //   void execute<OBJ, M, A1-3, D1>(c_A1-3&) const;
        //   ~bdlcfxxxi::Vfunc3M4<OBJ, M, A1-3, D1>();
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting constructors and argument values." << endl;
        {
            ...
            if (verbose) cout << "\t'bdlcfxxxi::Vfunc3F4' object." << endl;
            {
                typedef bdlcfxxxi::Vfunc3F4<CbFuncF4,
                                       int *, int *, int *, int *> Obj;
            ...
            if (verbose) cout << "\t'bdlcfxxxi::Vfunc3C4' object." << endl;
            {
                typedef bdlcfxxxi::Vfunc3C4<CbClass, CbFuncC4,
                                       int *, int *, int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
                ObjBase *x = new(ta) Obj(cbObject,
            ...
            if (verbose) cout << "\t'bdlcfxxxi::Vfunc3M4' object." << endl;
            {
                typedef bdlcfxxxi::Vfunc3M4<CbClass, CbFuncC4,
                                       int *, int *, int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
                ObjBase *x = new(ta) Obj(&cbObject,
            ...
            cout << "\nTesting parameter types and destructors." << endl;
        {
            ...
            if (verbose)
                cout << "\tWhen calling 'bdlcfxxxi::Vfunc3F4' 'execute' method."
                     << endl;
            {
                typedef bdlcfxxxi::Vfunc3F4<CbFuncF4, T1, T2, T3, T4> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG3;
                numDeallocations = ta.numDeallocations();
            ...
            if (verbose)
                cout << "\tWhen calling 'bdlcfxxxi::Vfunc3C4' 'execute' method."
                     << endl;
            {
                typedef bdlcfxxxi::Vfunc3C4<CbClass, CbFuncC4, T1, T2,
                                       T3, T4> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG3;
                numDeallocations = ta.numDeallocations();
            ...
            if (verbose)
                cout << "\tWhen calling 'bdlcfxxxi::Vfunc3M4' 'execute' method."
                     << endl;
            {
                typedef bdlcfxxxi::Vfunc3M4<CbClass, CbFuncM4, T1, T2, T3, T4> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG3;
                numDeallocations = ta.numDeallocations();
      ...
      case 3: {
        ...
        //       those intended as argument types for the function parameters.
        //    4. Non-'const' member functions can be used as callback
        //       functions by 'bdlcfxxxi::Vfunc3M3' instances.
        //    5. Destructor of each class under test is properly executed.
        //
        // Plan:
        //   Create objects of every 'bcefi::Vfunc3X3' class.  Initialize
        //   'bdlcfxxxi::Vfunc3F3' to have 'checkArgumentValues3' as the callback
        //   function.  Initialize 'bdlcfxxxi::Vfunc3C3' and 'bdlcfxxxi::Vfunc3M3' to
        //   have 'checkArgumentValues3' method of the 'CbClass' class as the
        //   callback function.  Call the 'execute' method for each
        //   'bcefi::Vfunc3X3' class.  The arguments in this call are
        ...
        //
        //   Create objects of every 'bcefi::Vfunc3X3' class.  Initialize
        //   'bdlcfxxxi::Vfunc3F3' to have 'checkParameterTypes3' as the callback
        //   function.  Initialize 'bdlcfxxxi::Vfunc3C3' to have
        //   'checkParameterTypesC3' method of the 'CbClass' class as the
        //   callback function.  Initialize 'bdlcfxxxi::Vfunc3M3' to have
        //   'checkParameterTypesM3' method of the 'CbClass' class as the
        //   callback function.  The latter will test wether the
        //   'bdlcfxxxi::Vfunc3M3' can have non-'const' functions as the callback
        //   function.
        //
        //   Having a function of 'checkParameterTypes' family as a callback
        //   function forces 'bcefi::Vfunc3X3' to be templatized so that each
        //   argument to the callback function will be of unique type.  Hence,
        //   if the types of arguments passed in to the callback function is
        //   incorrect, the compiler will generate an error.
        //
        ...
        // Testing:
        //   'bdlcfxxxi::Vfunc3F3' methods:
        //   bdlcfxxxi::Vfunc3F3<F, A1-3>(c_F&, ba *);
        //   void execute<F, A1-3>(c_A1-3&) const;
        //   ~bdlcfxxxi::Vfunc3F3<F, A1-3>();
        // --------------------------------------------------------------------
        //   'bdlcfxxxi::Vfunc3C3' methods:
        //   bdlcfxxxi::Vfunc3C3<OBJ, C, A1-3>( OBJ *, c_C&, ba *);
        //   void execute<OBJ, C, A1-3>(c_A1-3&) const;
        //   ~bdlcfxxxi::Vfunc3C3<OBJ, C, A1-3>();
        // --------------------------------------------------------------------
        //   'bdlcfxxxi::Vfunc3M3' methods:
        //   bdlcfxxxi::Vfunc3M3<OBJ, M, A1-3>( OBJ *, c_M&, ba *);
        //   void execute<OBJ, M, A1-3>(c_A1-3&) const;
        //   ~bdlcfxxxi::Vfunc3M3<OBJ, M, A1-3>();
        // --------------------------------------------------------------------
        //   'bdlcfxxxi::Vfunc3Null' methods:
        //   bdlcfxxxi::Vfunc3Null<A1-3>(ba *);
        //   void execute<A1-3>(c_A1-3&) const;
        //   ~bdlcfxxxi::Vfunc3Null<A1-3>();
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting constructors and argument values." << endl;
        {
            ...
            if (verbose) cout << "\t'bdlcfxxxi::Vfunc3F3' object." << endl;
            {
                typedef bdlcfxxxi::Vfunc3F3<CbFuncF3,
                                       int *, int *, int *> Obj;
            ...
            if (verbose) cout << "\t'bdlcfxxxi::Vfunc3C3' object." << endl;
            {
                typedef bdlcfxxxi::Vfunc3C3<CbClass, CbFuncC3,
                                       int *, int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
                ObjBase *x = new(ta) Obj(cbObject,
            ...
            if (verbose) cout << "\t'bdlcfxxxi::Vfunc3M3' object." << endl;
            {
                typedef bdlcfxxxi::Vfunc3M3<CbClass, CbFuncC3,
                                       int *, int *, int *> Obj;
                CbClass cbObject;
                if (verbose) cout << "\t\tTesting constructor." << endl;
                ObjBase *x = new(ta) Obj(&cbObject,
            ...
            cout << "\nTesting parameter types and destructors." << endl;
        {
            ...
            if (verbose)
                cout << "\tWhen calling 'bdlcfxxxi::Vfunc3F3' 'execute' method."
                     << endl;
            {
                typedef bdlcfxxxi::Vfunc3F3<CbFuncF3, T1, T2, T3> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG3;
                numDeallocations = ta.numDeallocations();
            ...
            if (verbose)
                cout << "\tWhen calling 'bdlcfxxxi::Vfunc3C3' 'execute' method."
                     << endl;
            {
                typedef bdlcfxxxi::Vfunc3C3<CbClass, CbFuncC3, T1, T2,
                                       T3> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG3;
                numDeallocations = ta.numDeallocations();
            ...
            if (verbose)
                cout << "\tWhen calling 'bdlcfxxxi::Vfunc3M3' 'execute' method."
                     << endl;
            {
                typedef bdlcfxxxi::Vfunc3M3<CbClass, CbFuncM3, T1, T2, T3> Obj;
                dcEnabled = 0;
                destructorCheck = DESTRUCTOR_FLAG3;
                numDeallocations = ta.numDeallocations();
            ...
            if (verbose)
                cout << "\nTesting bdlcfxxxi::Vfunc3Null object." << endl;
            {
                destructorCheck = DESTRUCTOR_FLAG3;
                numDeallocations = ta.numDeallocations();

                typedef bdlcfxxxi::Vfunc3Null<T1, T2, T3> Obj;
