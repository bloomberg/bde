...
//
//@CLASSES:
// bdlcfxxxi::Vfunc3Null: a 3-arg void no-op functor
//
// bdlcfxxxi::Vfunc3F3: a 3-arg void functor created from a 3-arg function
// bdlcfxxxi::Vfunc3F4: a 3-arg void functor created from a 4-arg function
// bdlcfxxxi::Vfunc3F5: a 3-arg void functor created from a 5-arg function
// bdlcfxxxi::Vfunc3F6: a 3-arg void functor created from a 6-arg function
// bdlcfxxxi::Vfunc3F7: a 3-arg void functor created from a 7-arg function
// bdlcfxxxi::Vfunc3F8: a 3-arg void functor created from a 8-arg function
// bdlcfxxxi::Vfunc3F9: a 3-arg void functor created from a 9-arg function
//
// bdlcfxxxi::Vfunc3C3: a 3-arg void functor created from obj & 3-arg method
// bdlcfxxxi::Vfunc3C4: a 3-arg void functor created from obj & 4-arg method
// bdlcfxxxi::Vfunc3C5: a 3-arg void functor created from obj & 5-arg method
// bdlcfxxxi::Vfunc3C6: a 3-arg void functor created from obj & 6-arg method
// bdlcfxxxi::Vfunc3C7: a 3-arg void functor created from obj & 7-arg method
// bdlcfxxxi::Vfunc3C8: a 3-arg void functor created from obj & 8-arg method
// bdlcfxxxi::Vfunc3C9: a 3-arg void functor created from obj & 9-arg method
//
// bdlcfxxxi::Vfunc3M3: a 3-arg void functor created from obj ptr & 3-arg method
// bdlcfxxxi::Vfunc3M4: a 3-arg void functor created from obj ptr & 4-arg method
// bdlcfxxxi::Vfunc3M5: a 3-arg void functor created from obj ptr & 5-arg method
// bdlcfxxxi::Vfunc3M6: a 3-arg void functor created from obj ptr & 6-arg method
// bdlcfxxxi::Vfunc3M7: a 3-arg void functor created from obj ptr & 7-arg method
// bdlcfxxxi::Vfunc3M8: a 3-arg void functor created from obj ptr & 8-arg method
// bdlcfxxxi::Vfunc3M9: a 3-arg void functor created from obj ptr & 9-arg method
//
...
// implementation of the base 'bdlcfxxxr::Vfunc3' representation based on the
...
// then the "null functor" 'bdlcfxxxi::Vfunc3Null' may be used.
//
///Language-Imposed Details
///------------------------
// For practical reasons, this component must distinguish among four types of
// functors.  The first type is a "null functor" 'bdlcfxxxi::Vfunc3Null', which
...
// implementations are named 'bcefi::Vfunc3XN' where 'X' is one of 'F', 'C', or
...
//..
// Note that a 'const' member function may be wrapped by a 'bcefi::Vfunc3MN'
// functor, but wrapping a non-'const' method by a 'bcefi::Vfunc3CN' will
// result in compile time error in most compiler implementations.
//
// Note also that, to accommodate the preservation of 'const', the
// 'bcefi::Vfunc3CN' functors hold an object 'Obj', supplied by a 'const'
// 'Obj&' in the constructor, while 'bcefi::Vfunc3MN' functors hold a pointer
...
class Vfunc3Null : public bdlcfxxxr::Vfunc3<A1, A2, A3> {
...
class Vfunc3F3 : public bdlcfxxxr::Vfunc3<A1, A2, A3> {
    // This class defines the representation for a function object (functor),
...
class Vfunc3F4 : public bdlcfxxxr::Vfunc3<A1, A2, A3> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking three arguments and
    // returning 'void', that holds a pure procedure (i.e., free function,
...
class Vfunc3F5 : public bdlcfxxxr::Vfunc3<A1, A2, A3> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking three arguments and
    // returning 'void', that holds a pure procedure (i.e., free function,
...
class Vfunc3F6 : public bdlcfxxxr::Vfunc3<A1, A2, A3> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking three arguments and
    // returning 'void', that holds a pure procedure (i.e., free function,
    // static member function, or functor) taking three additional trailing
...
class Vfunc3F7 : public bdlcfxxxr::Vfunc3<A1, A2, A3> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking three arguments and
    // returning 'void', that holds a pure procedure (i.e., free function,
...
template <class F, class A1, class A2, class A3,
          ...
          class D5>
class Vfunc3F8 : public bdlcfxxxr::Vfunc3<A1, A2, A3> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking three arguments and
    // returning 'void', that holds a pure procedure (i.e., free function,
...
template <class  F, class A1, class A2, class A3,
          class D1, class D2, class D3, class D4,
          class D5, class D6>
class Vfunc3F9 : public bdlcfxxxr::Vfunc3<A1, A2, A3> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking three arguments and
    // returning 'void', that holds a pure procedure (i.e., free function,
...
class Vfunc3C3 : public bdlcfxxxr::Vfunc3<A1, A2, A3> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking three arguments and
...
class Vfunc3C4 : public bdlcfxxxr::Vfunc3<A1, A2, A3> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking three arguments and
    // returning 'void', that holds an object and one of that object's 'const'
...
template <class OBJ, class C, class A1, class A2, class A3,
          class D1, class D2>
class Vfunc3C5 : public bdlcfxxxr::Vfunc3<A1, A2, A3> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking three arguments and
    // returning 'void', that holds an object and one of that object's 'const'
...
template <class OBJ, class C, class A1, class A2, class A3,
          class D1, class D2, class D3>
class Vfunc3C6 : public bdlcfxxxr::Vfunc3<A1, A2, A3> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking three arguments and
    // returning 'void', that holds an object and one of that object's 'const'
    // member functions taking three additional trailing arguments, and the
...
template <class OBJ, class C, class A1, class A2, class A3,
          class D1, class D2, class D3,
          class D4>
class Vfunc3C7 : public bdlcfxxxr::Vfunc3<A1, A2, A3> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking three arguments and
    // returning 'void', that holds an object and one of that object's 'const'
...
template <class OBJ, class C, class A1, class A2, class A3,
          class D1, class D2, class D3,
          class D4, class D5>
class Vfunc3C8 : public bdlcfxxxr::Vfunc3<A1, A2, A3> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking three arguments and
    // returning 'void', that holds an object and one of that object's 'const'
...
class Vfunc3C9 : public bdlcfxxxr::Vfunc3<A1, A2, A3> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking three arguments and
    // returning 'void', that holds an object and one of that object's 'const'
    ...
    // NOT IMPLEMENTED
    Vfunc3C9(
            const Vfunc3C9<OBJ, C, A1, A2, A3, D1, D2, D3, D4, D5, D6>&);
...
class Vfunc3M3 : public bdlcfxxxr::Vfunc3<A1, A2, A3> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking three arguments and
...
class Vfunc3M4 : public bdlcfxxxr::Vfunc3<A1, A2, A3> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking three arguments and
    // returning 'void', that holds the address of an object and one of that
...
template <class OBJ, class M, class A1, class A2, class A3,
          class D1, class D2>
class Vfunc3M5 : public bdlcfxxxr::Vfunc3<A1, A2, A3> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking three arguments and
    // returning 'void', that holds the address of an object and one of that
...
template <class OBJ, class M, class A1, class A2, class A3,
          class D1, class D2, class D3>
class Vfunc3M6 : public bdlcfxxxr::Vfunc3<A1, A2, A3> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking three arguments and
    // returning 'void', that holds the address of an object and one of that
    // object's ('const' or non-'const') member functions taking three
...
template <class OBJ, class M, class A1, class A2, class A3,
          class D1, class D2, class D3,
          class D4>
class Vfunc3M7 : public bdlcfxxxr::Vfunc3<A1, A2, A3> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking three arguments and
    // returning 'void', that holds the address of an object and one of that
...
template <class OBJ, class M, class A1, class A2, class A3,
          class D1, class D2, class D3,
          class D4, class D5>
class Vfunc3M8 : public bdlcfxxxr::Vfunc3<A1, A2, A3> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking three arguments and
    // returning 'void', that holds the address of an object and one of that
...
template <class OBJ, class M, class A1, class A2, class A3,
          class D1, class D2, class D3,
          class D4, class D5, class D6>
class Vfunc3M9 : public bdlcfxxxr::Vfunc3<A1, A2, A3> {
    // This class defines the representation for a function object (functor),
    // characterized by a function-call operator taking three arguments and
    // returning 'void', that holds the address of an object and one of that
    ...
    // NOT IMPLEMENTED
    Vfunc3M9(
            const Vfunc3M9<OBJ, M, A1, A2, A3, D1, D2, D3, D4, D5, D6>&);
...
template <class F, class A1, class A2, class A3, class D1>
inline
void Vfunc3F4<F, A1, A2, A3, D1>::execute(const A1& argument1,
                                                const A2& argument2,
                                                const A3& argument3) const
{
    const F& f = d_f.object();  // for readability
...
template <class OBJ, class M, class A1, class A2, class A3>
inline
void Vfunc3M3<OBJ, M, A1, A2, A3>::execute(const A1& argument1,
                                                 const A2& argument2,
                                                 const A3& argument3) const
{
