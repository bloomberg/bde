...
//
//@CLASSES:
//   bdlqq::AtomicUtil: namespace for platform-independent atomic operations
//
...
//
// 'bdlqq::AtomicUtil' manipulators whose names end in "Nv" (e.g., 'addIntNv',
...
//             bdlqq::AtomicUtil::incrementInt64(&failureCount);
//         }
//         else {
//             bdlqq::AtomicUtil::incrementInt64(&successCount);
//         }
//         bdlqq::AtomicUtil::incrementInt64(&transactionCount);
//     }
// }
//..
...
// using any thread support package.  Component 'bdlqq_xxxthread' provides the
// required functionality in functions 'bdlqq::ThreadUtil::create()' and
// bdlqq::ThreadUtil::join()'.
//
...
// information, see class 'bdlqq::Mutex' in component 'bdlqq_xxxthread'.
//..
// template <class INSTANCE, class FACTORY>
// inline
...
// {
//     return d_rep_p ? bdlqq::AtomicUtil::getInt(d_count) : 0;
// }
//..
//
