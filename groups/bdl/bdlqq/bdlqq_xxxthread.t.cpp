...
{
    for(int i = 0; i < 5; ++i) {
        bdlqq::ThreadUtil::microSleep(1000);  // 1 msec used for efficiency
...
{
    d_lock.lock(); // consider using 'bcemt::AutoLock'
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 3: {
        ...
        bdlqq::ThreadUtil::create(&validH1, attributes, myThreadFunction, 0);
        bdlqq::ThreadUtil::create(&validH2, attributes, myThreadFunction, 0);
