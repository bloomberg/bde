...
//-----------------------------------------------------------------------------
//
// [2 ] initInt(bdlqq::AtomicUtil::Int *aInt);
// [2 ] initInt64(bdlqq::AtomicUtil::Int64 *aInt);
// [2 ] initPointer(bdlqq::AtomicUtil::Pointer *aPointer);
// [6 ] initSpinLock(bdlqq::AtomicUtil::SpinLock *aSpin);
// [3 ] addInt(bdlqq::AtomicUtil::Int *aInt, int value);
// [5 ] incrementInt(bdlqq::AtomicUtil::Int *aInt);
// [5 ] decrementInt(bdlqq::AtomicUtil::Int *aInt);
// [4 ] swapInt64(bdlqq::AtomicUtil::Int *aInt, int value);
// [4 ] testAndSwapInt(bdlqq::AtomicUtil::Int *, int, int);
// [2 ] setInt(bdlqq::AtomicUtil::Int *aInt, int value);
// [2 ] getInt(const bdlqq::AtomicUtil::Int &aInt);
// [3 ] addIntNv(bdlqq::AtomicUtil::Int *aInt, int val);
// [5 ] incrementIntNv(bdlqq::AtomicUtil::Int *aInt);
// [5 ] decrementIntNv(bdlqq::AtomicUtil::Int *aInt);
// [3 ] addInt64(bdlqq::AtomicUtil::Int64 *, bsls::Types::Int64);
// [5 ] incrementInt64(bdlqq::AtomicUtil::Int64 *aInt);
// [5 ] decrementInt64(bdlqq::AtomicUtil::Int64 *aInt);
// [4 ] swapInt64(bdlqq::AtomicUtil::Int64 *, bsls::Types::Int64);
// [4 ] testAndSwapInt64(bdlqq::AtomicUtil::Int64 *, bsls::Types::Int64,
//                       bsls::Types::Int64);
// [3 ] addInt64Nv(bdlqq::AtomicUtil::Int64 *, bsls::Types::Int64);
// [5 ] incrementInt64Nv(bdlqq::AtomicUtil::Int64 *);
// [5 ] decrementInt64Nv(bdlqq::AtomicUtil::Int64 *);
// [2 ] setInt64(bdlqq::AtomicUtil::Int64 *, bsls::Types::Int64);
// [2 ] getInt64(const bdlqq::AtomicUtil::Int64 &aInt);
// [2 ] getPtr(const bdlqq::AtomicUtil::Pointer &aPointer);
// [2 ] setPtr(bdlqq::AtomicUtil::Pointer *aPointer, void *value);
// [4 ] swapPtr(bdlqq::AtomicUtil::Pointer *aPointer, void *value);
// [4 ] testAndSwapPtr(bdlqq::AtomicUtil::Pointer *, void *, void *);
// [6 ] spinLock(bdlqq::AtomicUtil::SpinLock *aSpin);
// [6 ] spinTryLock(bdlqq::AtomicUtil::SpinLock *aSpin, int retries);
// [6 ] spinUnlock(bdlqq::AtomicUtil::SpinLock *aSpin);
//-----------------------------------------------------------------------------
// [1 ] Breathing test
// [7 ] Usage examples
//-----------------------------------------------------------------------------
...
static bdlqq::AtomicUtil::Int64 transactionCount;
static bdlqq::AtomicUtil::Int64 successCount;
static bdlqq::AtomicUtil::Int64 failureCount;

void serverMain()
{
    const int num_threads = 10;
    bdlqq::AtomicUtil::initInt64(&transactionCount, 0);
    bdlqq::AtomicUtil::initInt64(&successCount, 0);
    bdlqq::AtomicUtil::initInt64(&failureCount, 0);
...
class my_CountedHandleRep {
    bdlqq::AtomicUtil::Int  d_count;       // number of active references
...
{
    bdlqq::AtomicUtil::initInt(&d_count,1);
}
...
{
    return d_rep_p ? bdlqq::AtomicUtil::getInt(d_rep_p->d_count) : 0;
}
...
class my_PtrStack {
    ...
    bdlqq::AtomicUtil::Pointer  d_list_p;
    bdlqq::AtomicUtil::Pointer  d_freeList_p;
...
{
    bdlqq::AtomicUtil::initPointer(&d_freeList_p,0);
    bdlqq::AtomicUtil::initPointer(&d_list_p,0);
}
...
typename my_PtrStack<TYPE>::Node* my_PtrStack<TYPE>::allocateNode()
{
    Node *node;
    do {
        node = (Node*)bdlqq::AtomicUtil::getPtr(d_freeList_p);
        if (!node) break;
    }while (bdlqq::AtomicUtil::testAndSwapPtr(&d_freeList_p,
                                            node,
                                            node->d_next
                                           ) != node);
    if (!node) {
...
{
    do {
        node->d_next = (Node*)bdlqq::AtomicUtil::getPtr(d_freeList_p);
    }while (bdlqq::AtomicUtil::testAndSwapPtr(&d_freeList_p,
                                            node->d_next,
                                            node
                                           ) != node->d_next);
...
inline void my_PtrStack<TYPE>::push( TYPE* item )
{
    ...
    node->d_item = item;
    do {
        node->d_next = (Node*)bdlqq::AtomicUtil::getPtr(d_list_p);
    }while (bdlqq::AtomicUtil::testAndSwapPtr(&d_list_p,
                                            node->d_next,
                                            node
                                           ) != node->d_next);
}
...
inline TYPE *my_PtrStack<TYPE>::pop()
{
    Node *node;
    do {
        node = (Node*)bdlqq::AtomicUtil::getPtr(d_list_p);
        if (!node) break;
    }while (bdlqq::AtomicUtil::testAndSwapPtr(&d_freeList_p,
                                            node,
                                            node->d_next
...
int main(int argc, char *argv[]) {
    ...
    switch (test) {
      ...
      case 9: {
        ...
        static bdlqq::AtomicUtil::Int i     = { -2 };
        static bdlqq::AtomicUtil::Int64 j   = { 0x1234abcd1234abcdLL };
        static bdlqq::AtomicUtil::Pointer p = { &i };

        ASSERT(bdlqq::AtomicUtil::getInt(i)   == -2);
        ASSERT(bdlqq::AtomicUtil::getInt64(j) == 0x1234abcd1234abcdLL);
        ASSERT(bdlqq::AtomicUtil::getPtr(p)   == &i);
      } break;
      ...
      case 6: {
        ...
        //   iterations.
        // Testing:
        //   initSpinLock(bdlqq::AtomicUtil::SpinLock *aSpin);
        //   spinLock(bdlqq::AtomicUtil::SpinLock *aSpin);
        //   spinTryLock(bdlqq::AtomicUtil::SpinLock *aSpin, int retries);
        //   spinUnlock(bdlqq::AtomicUtil::SpinLock *aSpin);
        // --------------------------------------------------------------------
        if (verbose) cout << "\nTesting Spinlocks"
                          << "\n================="
                          << endl;
      ...
      case 5: {
        ...
        //
        // Testing:
        //   incrementInt(bdlqq::AtomicUtil::Int *aInt);
        //   decrementInt(bdlqq::AtomicUtil::Int *aInt);
        //   incrementIntNv(bdlqq::AtomicUtil::Int *aInt);
        //   decrementIntNv(bdlqq::AtomicUtil::Int *aInt);
        //   incrementInt64(bdlqq::AtomicUtil::Int64 *aInt);
        //   decrementInt64(bdlqq::AtomicUtil::Int64 *aInt);
        //   incrementInt64Nv(bdlqq::AtomicUtil::Int64 *);
        //   decrementInt64Nv(bdlqq::AtomicUtil::Int64 *);
        // --------------------------------------------------------------------
      ...
      case 4: {
        ...
        //
        // Testing:
        //   swapInt64(bdlqq::AtomicUtil::Int *aInt, int value);
        //   testAndSwapInt(bdlqq::AtomicUtil::Int *, int, int);
        //   swapInt64(bdlqq::AtomicUtil::Int64 *, bsls::Types::Int64);
        //   testAndSwapInt64(bdlqq::AtomicUtil::Int64 *, bsls::Types::Int6
        //                    bsls::Types::Int64 );
        //   swapPtr(bdlqq::AtomicUtil::Pointer *aPointer, void *value);
        //   testAndSwapPtr(bdlqq::AtomicUtil::Pointer *, void *, void *);
        // --------------------------------------------------------------------
        if (verbose) cout << "\nTesting SWAP Manipulators"
                          << "\n========================================="
                          << endl;
                          ...
                          << endl;
        {
            ...
            for (int i=0; i < NITERATIONS; ++i) {
                int oldValue = bdlqq::AtomicUtil::swapInt( &mInt,
                                                         INT_SWAPTEST_VALUE1);
                if (oldValue == INT_SWAPTEST_VALUE1) ++value1Count;
                else if(oldValue == INT_SWAPTEST_VALUE2) ++value2Count;
                else ++errorCount;
                          ...
                          << endl;
        {
            ...
            for (int i=0; i < NITERATIONS; ++i) {
                void* oldValue =
                    bdlqq::AtomicUtil::swapPtr(&mPtr, POINTER_SWAPTEST_VALUE1);
                if (oldValue == POINTER_SWAPTEST_VALUE1) ++value1Count;
                else if(oldValue == POINTER_SWAPTEST_VALUE2) ++value2Count;
                else ++errorCount;
      ...
      case 3: {
        ...
        //   threads.
        // Testing:
        //   addInt(bdlqq::AtomicUtil::Int *aInt, int value);
        //   addInt64(bdlqq::AtomicUtil::Int64 *, bsls::Types::Int64);
        //   addIntNv(bdlqq::AtomicUtil::Int *aInt, int value);
        //   addInt64Nv(bdlqq::AtomicUtil::Int64 *, bsls::Types::Int64);
        // --------------------------------------------------------------------
      ...
      case 2: {
        ...
        //
        // Testing:
        //   initInt(bdlqq::AtomicUtil::Int *aInt, int initialValue);
        //   initInt64(bdlqq::AtomicUtil::Int64 *aInt);
        //   initPointer(bdlqq::AtomicUtil::Pointer *aPointer);
        //   setInt(bdlqq::AtomicUtil::Int *aInt, int value);
        //   getInt(const bdlqq::AtomicUtil::Int &aInt);
        //   setInt64(bdlqq::AtomicUtil::Int64 *, bsls::Types::Int64);
        //   getInt64(const bdlqq::AtomicUtil::Int64 &aInt);
        //   getPtr(const bdlqq::AtomicUtil::Pointer &aPointer);
        //   setPtr(bdlqq::AtomicUtil::Pointer *aPointer, void *value);
        //
        // --------------------------------------------------------------------
