// bdlmtt_xxxatomicutil.h                                                  -*-C++-*-
#ifndef INCLUDED_BDLMTT_XXXATOMICUTIL
#define INCLUDED_BDLMTT_XXXATOMICUTIL
...
//
//@CLASSES:
//   bdlmtt::AtomicUtil: namespace for platform-independent atomic operations
//
...
//
// The 'bdlmtt_xxxatomicutil' component provides three types of atomic operations:
//..
...
//
// Instead, an atomic operation (in this case, 'bdlmtt::AtomicUtil::incrementInt')
...
//
// 'bdlmtt::AtomicUtil' manipulators whose names end in "Nv" (e.g., 'addIntNv',
...
// Compare these examples to the corresponding examples in 'bdlmtt_xxxatomictypes'.
//
...
//..
// static bdlmtt::AtomicUtil::Int64 transactionCount;
// static bdlmtt::AtomicUtil::Int64 successCount;
// static bdlmtt::AtomicUtil::Int64 failureCount;
//..
...
//             bdlmtt::AtomicUtil::incrementInt64(&failureCount);
//         }
//         else {
//             bdlmtt::AtomicUtil::incrementInt64(&successCount);
//         }
//         bdlmtt::AtomicUtil::incrementInt64(&transactionCount);
//     }
// }
//..
...
//..
//     bdlmtt::AtomicUtil::initInt64(&transactionCount, 0);
//     bdlmtt::AtomicUtil::initInt64(&successCount, 0);
//     bdlmtt::AtomicUtil::initInt64(&failureCount, 0);
//..
...
// using any thread support package.  Component 'bdlmtt_xxxthread' provides the
// required functionality in functions 'bdlmtt::ThreadUtil::create()' and
// bdlmtt::ThreadUtil::join()'.
//
///Example 2: Thread-safe Counted Handle
///- - - - - - - - - - - - - - - - - - -
// The next example demonstrates the use of atomic integer operations to
// implement a thread safe counted handle similar to 'bdema::SharedPtr'.
...
// returned to a pool.  See, for instance, 'bdlmca_deleter' and
...
// class my_CountedHandleRep {
//     bdlmtt::AtomicUtil::Int  d_count;        // number of active references
...
// counter to one reference using 'bdlmtt::AtomicUtil::initInt'; this reflects the
...
// {
//     bdlmtt::AtomicUtil::initInt(&d_count, 1);
// }
//
// template <class INSTANCE, class FACTORY>
// inline
...
// information, see class 'bdlmtt::Mutex' in component 'bdlmtt_xxxthread'.
//..
// template <class INSTANCE, class FACTORY>
// inline
...
// {
//     return d_rep_p ? bdlmtt::AtomicUtil::getInt(d_count) : 0;
// }
//..
//
...
//           Node *d_next;
//       };
//       bdlmtt::AtomicUtil::Pointer  d_list_p;
//       bdlmtt::AtomicUtil::Pointer  d_freeList_p;
...
//   : d_allocator_p(allocator)
//   {
//       bdlmtt::AtomicUtil::initPointer(&d_freeList_p, 0);
//       bdlmtt::AtomicUtil::initPointer(&d_list_p, 0);
//   }
//
//   template <class TYPE>
...
//..
//       do {
//           node = (Node*)bdlmtt::AtomicUtil::getPtr(d_freeList_p);
//           if (!node) break;
//       } while (bdlmtt::AtomicUtil::testAndSwapPtr(&d_freeList_p,
//                                                node,
//                                                node->d_next) != node);
//..
...
//   {
//       do {
//           node->d_next = (Node*)bdlmtt::AtomicUtil::getPtr(d_freeList_p);
//       } while (bdlmtt::AtomicUtil::testAndSwapPtr(&d_freeList_p,
//                                                node->d_next,
//                                                node) != node->d_next);
//   }
...
//       node->d_item = item;
//       do {
//           node->d_next = (Node*)bdlmtt::AtomicUtil::getPtr(d_list_p);
//       } while (bdlmtt::AtomicUtil::testAndSwapPtr(&d_list_p,
//                                                node->d_next,
//                                                node) != node->d_next);
//   }
//..
...
//       Node *node;
//       do {
//           node = (Node*)bdlmtt::AtomicUtil::getPtr(d_list_p);
//           if (!node) break;
//       } while (bdlmtt::AtomicUtil::testAndSwapPtr(&d_freeList_p,
//                                                node,
//                                                node->d_next) != node);
