// bdlmtt_recursivemutex.t.cpp                                         -*-C++-*-
#include <bdlmtt_recursivemutex.h>
...
typedef bdlmtt::RecursiveMutex Obj;
...
{
    bdlmtt::ThreadUtil::microSleep(1000 * ms);
}
...
void My_CreateDetachedThread(ThreadFunction function,
    ...
    bdlmtt::ThreadUtil::create(&dum, attr, function, userData);
}
