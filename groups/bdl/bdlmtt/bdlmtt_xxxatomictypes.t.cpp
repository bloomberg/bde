...
// 'bdlmtt::AtomicUtil' types and operations.  Since the provided classes are
...
// respective 'bdlmtt::AtomicUtil' type and operation.
//
//-----------------------------------------------------------------------------
// bdlmtt::AtomicInt
// --------------
// [ 2] bdlmtt::AtomicInt();
// [ 3] bdlmtt::AtomicInt(const bdlmtt::AtomicInt& rhs);
// [ 3] bdlmtt::AtomicInt(int value);
// [ 2] ~bdlmtt::AtomicInt();
...
// [ 6] int operator --();
// [ 6] int operator --(int);
// [ 3] bdlmtt::AtomicInt& operator= (const bdlmtt::AtomicInt& rhs);
// [ 2] bdlmtt::AtomicInt& operator= (int value);
...
// bdlmtt::AtomicInt64
// ----------------
// [ 2] bdlmtt::AtomicInt64();
// [ 3] bdlmtt::AtomicInt64(const bdlmtt::AtomicInt64& original);
// [ 3] bdlmtt::AtomicInt64(bsls::Types::Int64 value);
// [ 2] ~bdlmtt::AtomicInt64();
...
// [ 6] bsls::Types::Int64 operator --();
// [ 6] bsls::Types::Int64 operator --(int);
// [ 3] bdlmtt::AtomicInt64& operator= (const bdlmtt::AtomicInt64& rhs);
// [ 2] bdlmtt::AtomicInt64& operator= (bsls::Types::Int64 value);
// [ 4] void operator +=(bsls::Types::Int64 value);
// [ 4] void operator -=(bsls::Types::Int64 value);
// [ 2] operator bsls::Types::Int64() const;
//
// bdlmtt::AtomicPointer
// ------------------
// [ 2] bdlmtt::AtomicPointer();
// [ 3] bdlmtt::AtomicPointer(const bdlmtt::AtomicPointer<T>& original);
// [ 3] bdlmtt::AtomicPointer(const T* value);
// [ 2] ~bdlmtt::AtomicPointer();
// [ 5] T* swap(const T* swapValue);
// [ 5] T* testAndSwap(const T* compareValue, const T* swapValue);
// [ 3] bdlmtt::AtomicPointer<T>& operator= (const bdlmtt::AtomicPointer<T>& rhs);
// [ 2] bdlmtt::AtomicPointer<T>& operator= (const T *value);
// [ 2] T& operator*() const;
// [ 3] T* operator->() const;
// [ 2] operator T*() const;
//
...
typedef bdlmtt::AtomicInt                      AI;
typedef bdlmtt::AtomicInt64                    AI64;
typedef bdlmtt::AtomicPointer<APTestObj>       AP;
typedef bdlmtt::AtomicPointer<const APTestObj> CAP;
typedef bdlmtt::SpinLock                       SL;
...
public:
    struct Data
    {
        bdlmtt::AtomicInt  flags[2];
        bdlmtt::AtomicInt  turn;     // 0 or 1 - index into d_flags
    };
...
bdlmtt::AtomicInt s_data1(0);
bdlmtt::AtomicInt s_data2(0);
bdlmtt::AtomicInt s_data3(1);
...
static bdlmtt::AtomicInt64 transactionCount;
static bdlmtt::AtomicInt64 successCount;
static bdlmtt::AtomicInt64 failureCount;
...
class my_CountedHandleRep {
    bdlmtt::AtomicInt    d_count;       // number of active references
...
{
    return d_rep_p ? bdlmtt::AtomicUtil::getInt(d_rep_p->d_count) : 0;
}
...
class my_PtrStack {
    struct Node {
        TYPE                 *d_item;
        Node                 *d_next;
        bdlmtt::AtomicUtil::Int  d_dirtyBit;
    };
    bdlmtt::AtomicPointer<Node>  d_list_p;
    bdlmtt::AtomicPointer<Node>  d_freeList_p;
...
typename my_PtrStack<TYPE>::Node* my_PtrStack<TYPE>::allocateNode()
{
    ...
    do {
        ...
        if (bdlmtt::AtomicUtil::swapInt(&node->d_dirtyBit, 1)) {
            continue;
        }
        if (d_freeList_p.testAndSwap(node, node->d_next) == node) {
            break;
        }
        bdlmtt::AtomicUtil::setInt(&node->d_dirtyBit, 0);
    } while (1);
    if (!node) {
        bslma::Allocator *ba = bslma::Default::allocator(d_allocator_p);
        node = new(*ba) Node();
        bdlmtt::AtomicUtil::setInt(&node->d_dirtyBit, 1);
    }
    return node;
}
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:
      ...
      case 7: {
        ...
        //
        // Testing:
        //   initSpinLock(bdlmtt::AtomicUtil::SpinLock *aSpin);
        //   spinLock(bdlmtt::AtomicUtil::SpinLock *aSpin);
        //   spinTryLock(bdlmtt::AtomicUtil::SpinLock *aSpin, int retries);
        //   spinUnlock(bdlmtt::AtomicUtil::SpinLock *aSpin);
        // --------------------------------------------------------------------
      ...
      case 3: {
        ...
        //
        // Testing:
        //   bdlmtt::AtomicInt(const bdlmtt::AtomicInt& rhs);
        //   bdlmtt::AtomicInt(int value);
        //   bdlmtt::AtomicInt& operator= (const bdlmtt::AtomicInt& rhs);
        //   bdlmtt::AtomicInt64(const bdlmtt::AtomicInt64& original);
        //   bdlmtt::AtomicInt64(bsls::Types::Int64 value);
        //   bdlmtt::AtomicInt64& operator= (const bdlmtt::AtomicInt64& rhs);
        //   bdlmtt::AtomicPointer(const bdlmtt::AtomicPointer<T>& original);
        //   bdlmtt::AtomicPointer(const T* value);
        //   bdlmtt::AtomicPointer<T>& operator=(const bdlmtt::AtomicPointer<T>&);
        // --------------------------------------------------------------------
        ...
        if (verbose) cout <<
                          "\nTesting 'bdlmtt::AtomicPointer' Primary Manipulators"
                          << endl;
        {
            static const struct {
                int        d_lineNum;  // source line number
      ...
      case 2: {
        ...
        //   bdlmtt::AtomicInt();
        //   ~bdlmtt::AtomicInt()
        //   bdlmtt::AtomicInt& operator= (int value);
        //   operator int() const;;
        //   bdlmtt::AtomicInt64();
        //   ~bdlmtt::AtomicInt64();
        //   bdlmtt::AtomicInt64& operator= (bsls::Types::Int64 value);
        //   operator bsls::Types::Int64() const;
        //   bdlmtt::AtomicPointer();
        //   bdlmtt::AtomicPointer<T>& operator= (const T *value);
        //   ~bdlmtt::AtomicPointer();
        //   T& operator*() const;
        //   T* operator->() const;
        //   operator T*() const;
        ...
        if (verbose) cout << "\nTesting 'bdlmtt::AtomicInt' Primary Manipulators"
                          << endl;
        {
            static const struct {
                int d_lineNum;  // source line number
        ...
        if (verbose)
            cout << "\nTesting 'bdlmtt::AtomicInt64' Primary Manipulators"
                 << endl;
        {
            static const struct {
                int   d_lineNum;  // source line number
