// bdlmtt_recursivemuteximpl_pthread.h                                 -*-C++-*-
#ifndef INCLUDED_BDLMTT_RECURSIVEMUTEXIMPL_PTHREAD
#define INCLUDED_BDLMTT_RECURSIVEMUTEXIMPL_PTHREAD
...
//@PURPOSE: Provide a POSIX implementation of 'bdlmtt::RecursiveMutex'.
//
//@CLASSES:
//  bdlmtt::RecursiveMutexImpl<PosixThreads>: POSIX specialization
//
...
// 'bdlmtt::RecursiveMutex' for POSIX threads ("pthreads") via the template
// specialization:
//..
//  bdlmtt::RecursiveMutexImpl<bdlmtt::Platform::PosixThreads>
//..
...
#ifndef PTHREAD_MUTEX_RECURSIVE
    bdlmtt::SpinLock   d_spin;       // spin lock controlling access to this
                                  // object
