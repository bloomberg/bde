// bdlmtt_condition.h                                                  -*-C++-*-
#ifndef INCLUDED_BDLMTT_CONDITION
#define INCLUDED_BDLMTT_CONDITION
...
//
//@CLASSES:
//  bdlmtt::Condition: portable intra-process signaling mechanism
//
//@SEE_ALSO: bdlmtt_mutex
//
//@DESCRIPTION: The 'bdlmtt::Condition' class provided by this component
...
// methods of 'bdlmtt::Condition':
//..
//  int wait(bdlmtt::Mutex *mutex);
//  int timedWait(bdlmtt::Mutex *mutex, const bsls::TimeInterval& absoluteTime);
//..
// The caller must lock the mutex before invoking these functions.  The
// 'bdlmtt::Condition' atomically releases the lock and waits, thereby preventing
...
// time according to the clock type the 'bdlmtt::Condition' object is constructed
...
// broadcasting the same 'bdlmtt::Condition' object.  A broadcast wakes up all
...
///Usage
///-----
// Suppose we have a 'bdlmtt::Condition' object, 'condition', and a boolean
...
#ifndef INCLUDED_BDLMTT_CONDITIONIMPL_WIN32
...
class Condition {
    ...
    // DATA
    ConditionImpl<bdlmtt::Platform::ThreadPolicy>
