...
//
//@CLASSES:
//  bdlmtt::Mutex: platform-independent mutex
//
//@SEE_ALSO: bdlmtt_recursivemutex, bdlmtt_mutex
//
...
// 'bdlmtt::Mutex' class provides the following operations: 'lock', 'tryLock',
// and 'unlock'.
//
// The behavior is undefined if 'unlock' is invoked on a 'bdlmtt::Mutex' object
...
// 'bdlmtt::Mutex' is non-recursive).  In particular, 'lock' *may* or *may* *not*
// deadlock if the current thread holds the lock.
//
///Usage
///-----
// The following snippets of code illustrate the use of 'bdlmtt::Mutex' to write
...
// brevity.
//
// Next, we use a 'bdlmtt::Mutex' object to render atomic the function calls of a
...
//      mutable bdlmtt::Mutex  d_lock;       // guard access to 'd_account_p'
//
//      // NOT IMPLEMENTED
...
//  };
//..
// The implementation show-casing the use of 'bdlmtt::Mutex' follows:
//..
//  // CREATORS
...
// See 'bdlmtt_lockguard' for more information:
//..
//      d_lock.lock();  // consider using 'bdlmtt::LockGuard'
...
//
//  handle.lock();  // consider using 'bdlmtt::LockGuard'
//
...
class Mutex {
    ...
    // DATA
    MutexImpl<bdlmtt::Platform::ThreadPolicy>
  ...
  public:
    // PUBLIC TYPES
    typedef MutexImpl<bdlmtt::Platform::ThreadPolicy>::NativeType
                                                                    NativeType;
