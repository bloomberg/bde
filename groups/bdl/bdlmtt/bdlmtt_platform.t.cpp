...
int typeTest(const bdlmtt::Platform::PosixThreads&) { return 1; }
int typeTest(const bdlmtt::Platform::Win32Threads&) { return 2; }
...
int main(int argc, char *argv[]) {
    ...
    switch (test) { case 0:
      case 1: {
        ...
        bdlmtt::Platform::ThreadPolicy policy;
        ...
        if (verbose) {
            cout << endl << "Print sefined symbols" << endl;
                ...
                ASSERT(0 <= BDLMTT_PLATFORM_POSIX_THREADS);
                cout  << "\tBCES_PLATFORM_POSIX_THREADS = "
                      <<    BDLMTT_PLATFORM_POSIX_THREADS << endl;
            #endif

            #if defined(BDLMTT_PLATFORM_WIN32_THREADS)
                ASSERT(0 <= BDLMTT_PLATFORM_WIN32_THREADS);
                cout  << "\tBCES_PLATFORM_WIN32_THREADS = "
                      <<    BDLMTT_PLATFORM_WIN32_THREADS << endl;
            #endif
