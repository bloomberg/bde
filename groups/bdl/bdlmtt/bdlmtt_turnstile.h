// bdlmtt_turnstile.h                                                  -*-C++-*-
#ifndef INCLUDED_BDLMTT_TURNSTILE
#define INCLUDED_BDLMTT_TURNSTILE
...
//
//@CLASSES:
//  bdlmtt::Turnstile: mechanism to meter time
//
//@AUTHOR: David Rubin (drubin6@bloomberg.net)
//
//@DESCRIPTION: This component provides a mechanism, 'bdlmtt::Turnstile', to
...
// (e.g., 'bdlmtt::ThreadUtil::microSleep') with a computed rate after each
...
// 'bdlmtt::ThreadUtil::microSleep' with duration '1000000 / rate', respectively;
// the elapsed time for each call results in the following table, showing that
// the 'bdlmtt::Turnstile' implementation maintains the correct rate while the
...
// instances or a shared instance of a 'bdlmtt::Turnstile' object, provided that
...
// 'bdlmtt::Turnstile' cannot guarantee that all turns can be taken in each one
// second interval if a rate higher than 100 turns per second is specified.
//
///Usage
///-----
// The following example illustrates the use of 'bdlmtt::Turnstile' to control
...
//  }
//..
// The benefits of using 'bdlmtt::Turnstile' in the above example, as opposed to
// simply calling 'sleep' in a loop, are twofold.  Firstly, 'bdlmtt::Turnstile'
