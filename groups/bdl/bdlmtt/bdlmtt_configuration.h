// bdlmtt_configuration.h                                              -*-C++-*-
#ifndef INCLUDED_BDLMTT_CONFIGURATION
#define INCLUDED_BDLMTT_CONFIGURATION
...
//
//@CLASSES:
//  bdlmtt::Configuration: namespace for utilities managing default BCE values
//
//@AUTHOR: Bill Chapman (bchapman2)
//
//@SEE_ALSO: bdlmtt_threadattributes, bdlmtt_threadutil
//
//@DESCRIPTION: This component defines a utility 'struct',
// 'bdlmtt::Configuration', that is a name space for pure functions used for
// providing access to, and configuring, default values for BCE-relevant
// parameters.  The 'bdlmtt::Configuration' utility currently provides static
...
// 'bdlmtt::ThreadAttributes::BCEMT_UNSET_STACK_SIZE', in which case thread
