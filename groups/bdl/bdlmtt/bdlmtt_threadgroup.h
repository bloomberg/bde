// bdlmtt_threadgroup.h                                                -*-C++-*-
#ifndef INCLUDED_BDLMTT_THREADGROUP
#define INCLUDED_BDLMTT_THREADGROUP
...
//
//@CLASSES:
// bdlmtt::ThreadGroup: A container that manages a group of threads.
//
...
// 'bdlmtt::ThreadGroup' class.  To use this component, the client code calls
...
// 'bdlmtt::ThreadGroup' object.
//
///Usage
///-----
// The following usage example illustrates how 'bdlmtt::ThreadGroup' might be
...
// stress-test for the 'bdlmtt::Mutex' class.  The test is controlled by two
...
//
//      bdlmtt::Mutex   mutex;                     // object under test
//      int           value = 0;
//
