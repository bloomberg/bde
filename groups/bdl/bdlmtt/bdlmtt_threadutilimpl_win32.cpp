// bdlmtt_threadutilimpl_win32.cpp                                     -*-C++-*-
#include <bdlmtt_threadutilimpl_win32.h>

#include <bsls_ident.h>
BSLS_IDENT_RCSID(bdlmtt_threadutilimpl_win32_cpp,"$Id$ $CSID$")
...
// CLASS DATA
const bdlmtt::ThreadUtilImpl<bdlmtt::Platform::Win32Threads>::Handle
    bdlmtt::ThreadUtilImpl<bdlmtt::Platform::Win32Threads>::INVALID_HANDLE =
...
struct ThreadStartupInfo{
    ...
    bdlmtt::ThreadUtilImpl<bdlmtt::Platform::Win32Threads>::Handle  d_handle;
...
struct ThreadSpecificDestructor {
    ...
    bdlmtt::ThreadUtilImpl<bdlmtt::Platform::Win32Threads>::Key  d_key;
...
namespace bdlmtt {
            // -------------------------------------------------------
            // class ThreadUtilImpl<bdlmtt::Platform::Win32Threads>
            // -------------------------------------------------------

// CLASS METHODS
int ThreadUtilImpl<bdlmtt::Platform::Win32Threads>::create(
                                                Handle               *thread,
...
int ThreadUtilImpl<bdlmtt::Platform::Win32Threads>::create(
          ThreadUtilImpl<bdlmtt::Platform::Win32Threads>::Handle *handle,
...
int ThreadUtilImpl<bdlmtt::Platform::Win32Threads>::join(
           ThreadUtilImpl<bdlmtt::Platform::Win32Threads>::Handle&   handle,
           void                                                       **status)
{
    // Cannot self - join
...
int ThreadUtilImpl<bdlmtt::Platform::Win32Threads>::detach(
             ThreadUtilImpl<bdlmtt::Platform::Win32Threads>::Handle& handle)
{
    if (handle.d_handle == GetCurrentThread()
     && handle.d_id     == GetCurrentThreadId()) {
        ThreadUtilImpl<bdlmtt::Platform::Win32Threads>::Handle *realHandle;
        realHandle =
            (ThreadUtilImpl<bdlmtt::Platform::Win32Threads>::Handle *)
...
void ThreadUtilImpl<bdlmtt::Platform::Win32Threads>::exit(void *status)
{
    invokeDestructors();
#ifdef BCEMT_USE_RETURN_VALUE_MAP
    EnterCriticalSection(&s_returnValueMapLock);
...
int ThreadUtilImpl<bdlmtt::Platform::Win32Threads>::createKey(
                                       Key                         *key,
...
int ThreadUtilImpl<bdlmtt::Platform::Win32Threads>::deleteKey(Key& key)
{
...
bool ThreadUtilImpl<bdlmtt::Platform::Win32Threads>::areEqual(
            const ThreadUtilImpl<bdlmtt::Platform::Win32Threads>::Handle& a,
            const ThreadUtilImpl<bdlmtt::Platform::Win32Threads>::Handle& b)
{
    return a.d_id == b.d_id;
}

int ThreadUtilImpl<bdlmtt::Platform::Win32Threads>::sleepUntil(
