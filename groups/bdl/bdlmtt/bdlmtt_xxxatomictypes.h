// bdlmtt_xxxatomictypes.h                                                 -*-C++-*-
#ifndef INCLUDED_BDLMTT_XXXATOMICTYPES
#define INCLUDED_BDLMTT_XXXATOMICTYPES
...
//
//@CLASSES:
//       bdlmtt::AtomicInt: atomic 32-bit integer wrapper
//     bdlmtt::AtomicInt64: atomic 64-bit integer wrapper
//   bdlmtt::AtomicPointer: parameterized atomic pointer wrapper
//        bdlmtt::SpinLock: spin lock wrapper
//
...
// operations provided by the 'bdlmtt_xxxatomicutil' component.  Classes
// 'bdlmtt::AtomicInt' and 'bdlmtt::AtomicInt64' wrap the corresponding atomic
// integers, and provide overloaded operators and functions for common
// arithmetic operations.  The class 'bdlmtt::AtomicPointer' provides atomic
// operations to manipulate and dereference a pointer.  The class
// 'bdlmtt::SpinLock' provides an object wrapper for a spin lock.
//
//@DEPRECATED: Use bsls_atomic components instead of bdlmtt_xxxatomictypes, except
// for 'bdlmtt::SpinLock'.
...
inline
bdlmtt::AtomicInt::operator int() const
{
    return bsls::AtomicInt::operator int();
}

inline
bdlmtt::AtomicInt64::operator bsls::Types::Int64() const
{
