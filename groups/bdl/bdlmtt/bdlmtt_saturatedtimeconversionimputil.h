// bdlmtt_saturatedtimeconversionimputil.h                             -*-C++-*-
#ifndef INCLUDED_BDLMTT_SATURATEDTIMECONVERSIONIMPUTIL
#define INCLUDED_BDLMTT_SATURATEDTIMECONVERSIONIMPUTIL
...
//
//@CLASSES:
//   bdlmtt::SaturatedTimeConversionImpUtil: saturating time conversions.
//
//@SEE_ALSO:
//
...
// functions with a time-out (e.g., 'bdlmtt::Condition::timedWait') where a
...
// time interval).  'bdlmtt::SaturatedTimeConversionImpUtil' handles values
...
//  bdlmtt::SaturatedTimeConversionImpUtil::toMillisec(
