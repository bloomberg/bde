// bdlmtt_threadattributes.t.cpp                                       -*-C++-*-
...
typedef bdlmtt::ThreadAttributes Obj;
...
// First we create a default-constructed 'bdlmtt::ThreadAttributes' object and
...
//..
      ...
      case 1: {
        ...
        typedef bdlmtt::ThreadAttributes::Imp Imp;
        ...
        ASSERT(bdlmtt::ThreadAttributes::BCEMT_SCHED_OTHER ==
                                                   Imp::BCEMT_SCHED_OTHER);
        ASSERT(bdlmtt::ThreadAttributes::BCEMT_SCHED_FIFO  ==
                                                   Imp::BCEMT_SCHED_FIFO);
        ASSERT(bdlmtt::ThreadAttributes::BCEMT_SCHED_RR    ==
                                                   Imp::BCEMT_SCHED_RR);
#endif
      } break;
      case -1: {
...
#define MAXPRI(policy)  (bdlmtt::ThreadAttributes::getMaxSchedPriority(policy))
#define MINPRI(policy)  (bdlmtt::ThreadAttributes::getMinSchedPriority(policy))

        typedef bdlmtt::ThreadAttributes::SchedulingPolicy Policy;

        const Policy OTHER = bdlmtt::ThreadAttributes::BCEMT_SCHED_OTHER;
        const Policy FIFO  = bdlmtt::ThreadAttributes::BCEMT_SCHED_FIFO;
        const Policy RR    = bdlmtt::ThreadAttributes::BCEMT_SCHED_RR;
