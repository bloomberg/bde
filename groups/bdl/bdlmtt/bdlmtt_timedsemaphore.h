// bdlmtt_timedsemaphore.h                                             -*-C++-*-
#ifndef INCLUDED_BDLMTT_TIMEDSEMAPHORE
#define INCLUDED_BDLMTT_TIMEDSEMAPHORE
...
//
//@CLASSES:
//  bdlmtt::TimedSemaphore: timed semaphore class
//
...
// synchronization primitive.  In particular, 'bdlmtt::TimedSemaphore' is an
// efficient synchronization primitive that enables sharing of a counted number
// of resources or exclusive access.
//
// 'bdlmtt::TimedSemaphore' differs from 'bdlmtt::Semaphore' in that the former
// supports a 'timedWait' method, whereas the latter does not.  In addition,
// 'bdlmtt::Semaphore' has a 'getValue' accessor, whereas 'bdlmtt::TimedSemaphore'
...
//      bdlmtt::TimedSemaphore d_mutexSem;     // mutual-access semaphore
//      bdlmtt::TimedSemaphore d_resourceSem;  // resource-availability semaphore
//
//      // NOT IMPLEMENTED
...
class TimedSemaphore {
    ...
    // DATA
    TimedSemaphoreImpl<bdlmtt::Platform::TimedSemaphorePolicy>
