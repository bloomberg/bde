// bdlmtt_sluice.h                                                     -*-C++-*-
#ifndef INCLUDED_BDLMTT_SLUICE
#define INCLUDED_BDLMTT_SLUICE
...
//
//@CLASSES:
//  bdlmtt::Sluice: thread-aware sluice class
//
//@SEE_ALSO: bdlmtt_conditionimpl_win32
//
//@AUTHOR: Vlad Kliatchko (vkliatch)
//
//@DESCRIPTION: This component provides a "sluice" class, 'bdlmtt::Sluice'.
// A sluice is useful for controlling the release of threads from a common
// synchronization point.  One or more threads may "enter" a 'bdlmtt::Sluice'
...
// may be signaled for release.  In either case, 'bdlmtt::Sluice' provides a
...
///Usage
///-----
// 'bdlmtt::Sluice' is intended to be used to implement other synchronization
// mechanisms.  In particular, the functionality provided by 'bdlmtt::Sluice' is
// useful for implementing a condition variable:
//..
//  class MyCondition {
//      // This class implements a condition variable based on 'bdlmtt::Sluice'.
//
//      // DATA
//      bdlmtt::Sluice d_waitSluice;  // sluice object
//
//    public:
//      // MANIPULATORS
//      void wait(bdlmtt::Mutex *mutex)
//      {
...
#ifndef INCLUDED_BDLMTT_TIMEDSEMAPHORE
