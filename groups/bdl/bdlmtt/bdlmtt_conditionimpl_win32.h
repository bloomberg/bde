// bdlmtt_conditionimpl_win32.h                                        -*-C++-*-
#ifndef INCLUDED_BDLMTT_CONDITIONIMPL_WIN32
#define INCLUDED_BDLMTT_CONDITIONIMPL_WIN32
...
//@PURPOSE: Provide a win32 implementation of 'bdlmtt::Condition'.
//
//@CLASSES:
//  bdlmtt::ConditionImpl<Win32Threads>: win32 specialization
//
...
//..
//  bdlmtt::ConditionImpl<bdlmtt::Platform::Win32Threads>
//..
...
// CREATORS
inline
ConditionImpl<bdlmtt::Platform::Win32Threads>::ConditionImpl(
...
// MANIPULATORS
inline
void ConditionImpl<bdlmtt::Platform::Win32Threads>::broadcast()
{
    d_waitSluice.signalAll();
}

inline
void ConditionImpl<bdlmtt::Platform::Win32Threads>::signal()
{
