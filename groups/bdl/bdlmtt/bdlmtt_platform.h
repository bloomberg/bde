...
#define INCLUDED_BDLMTT_PLATFORM
...
//
//@CLASSES:
//   bdlmtt::Platform: namespace for platform-dependent thread-related traits
//
//@SEE_ALSO:
//
...
// actually types declared in the 'bdlmtt::Platform' 'struct'.  These types are
...
struct Platform {
    ...
    #define BDLMTT_PLATFORM_POSIX_THREADS 1
    ...
    #define BDLMTT_PLATFORM_WIN32_THREADS 1
    ...
    // 'bdlmtt::Semaphore' also supported 'INT_MAX'.  On AIX, use a semaphore
    ...
    #define BDLMTT_PLATFORM_COUNTED_SEMAPHORE
    #define BDLMTT_PLATFORM_POSIX_SEMAPHORE
    ...
    #define BDLMTT_PLATFORM_POSIXADV_TIMEDSEMAPHORE 1
