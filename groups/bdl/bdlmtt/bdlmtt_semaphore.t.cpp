...
typedef bdlmtt::Semaphore Obj;

void waitAndSet(bdlmtt::Semaphore *obj,
                bsls::AtomicInt *val)
{
    obj->wait();
    (*val) = 1;
    ...
    switch (test) {
      case 2: {
        ...
        }
        {
            ...
            bsls::AtomicInt flag;
            ASSERT(0 == bdlmtt::ThreadUtil::create(&h,
                                               bdlf::BindUtil::bind(&waitAndSet,
                                                                   &X,
                                                                   &flag)));
            bdlmtt::ThreadUtil::sleep(bsls::TimeInterval(1));
            ASSERT(0 == flag);
            X.post();
            bdlmtt::ThreadUtil::join(h);
            ASSERT(1 == flag);
        }
      } break;
      case 1: {
