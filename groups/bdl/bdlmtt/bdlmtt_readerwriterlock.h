// bdlmtt_readerwriterlock.h                                           -*-C++-*-
#ifndef INCLUDED_BDLMTT_READERWRITERLOCK
#define INCLUDED_BDLMTT_READERWRITERLOCK
...
//
//@CLASSES:
//   bdlmtt::ReaderWriterLock: multi-reader/single-writer lock class
//
//@SEE_ALSO:
//
...
//
// 'bdlmtt::ReaderWriterLock' also supports atomic conversion from *read* to
