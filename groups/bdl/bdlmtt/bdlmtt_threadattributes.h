// bdlmtt_threadattributes.h                                           -*-C++-*-
#ifndef INCLUDED_BDLMTT_THREADATTRIBUTES
#define INCLUDED_BDLMTT_THREADATTRIBUTES
...
//
//@CLASSES:
//  bdlmtt::ThreadAttributes: description of the attributes of a thread
//
//@SEE_ALSO: bdlmtt_threadutil, bdlmtt_configuration
//
//@DESCRIPTION: This component provides a simply constrained (value-semantic)
// attribute class, 'bdlmtt::ThreadAttributes', for describing attributes of a
// thread in a platform-independent way.
//
// The default values and constraints for the attributes provided by
// 'bdlmtt::ThreadAttributes' are listed in the following two tables:
//..
//  Name                Type                   Default
//  ------------------  ---------------------  -------------------------------
...
// 'bdlmtt_threadutil'), in which case the joining thread will block, waiting
...
// stack size (see 'bdlmtt_configuration').  The 'stackSize' attribute should be
...
// default native guard size (see 'bdlmtt_configuration').  Note that the
...
// to configure a thread.  See 'bdlmtt_threadutil' for information about support
// for this attribute.
//
...
// See 'bdlmtt_threadutil' for information about support for this attribute.
//
...
// 'bdlmtt_threadutil'.  This attribute is ignored unless 'inheritSchedule' is
// 'false'.  See 'bdlmtt_threadutil' for information about support for this
// attribute.
//
///Usage
///-----
...
// 'bdlmtt::ThreadAttributes' object, then using it with a hypothetical
...
//                      const bdlmtt::ThreadAttributes&  attributes,
//                      void (*)()                     function);
...
// in 'bdlmtt_threadutil'.
//..
//  int myMinPriority(bdlmtt::ThreadAttributes::SchedulingPolicy policy);
//  int myMaxPriority(bdlmtt::ThreadAttributes::SchedulingPolicy policy);
//..
...
// 'bdlmtt::ThreadAttributes' object describing the properties a thread we will
// create.
//..
//  int testMain()
//  {
...
//          stackSize = bdlmtt::Configuration::defaultThreadStackSize();
//      }
...
//          guardSize = bdlmtt::Configuration::nativeDefaultThreadGuardSize();
//      }
//
...
class ThreadAttributes {
  ...
  public:
    ...
    void setGuardSize(int value);
        ...
        // one or two pages (see 'bdlmtt_configuration').  The behavior is
    ...
    void setInheritSchedule(bool value);
        ...
        // 'bdlmtt_threadutil' for information about support for this attribute.
    ...
    void setSchedulingPolicy(SchedulingPolicy value);
        ...
        // 'inheritSchedule' is 'false'.  See 'bdlmtt_threadutil' for
    ...
    void setSchedulingPriority(int value);
        ...
        // 'bdlmtt_threadutil'.  See 'bdlmtt_threadutil' for information about
        // this attribute.
    ...
    void setStackSize(int value);
        ...
        // 'bdlmtt_configuration'.  The behavior is undefined unless
    ...
    bool inheritSchedule() const;
        ...
        // respective values in this object.  See 'bdlmtt_threadutil' for
    ...
    SchedulingPolicy schedulingPolicy() const;
        ...
        // 'bdlmtt_threadutil' for information about this attribute.
    ...
    int schedulingPriority() const;
        ...
        // priority values are determined by methods in 'bdlmtt_threadutil'.
        // See 'bdlmtt_threadutil' for information about this attribute.
    ...
    int stackSize() const;
        ...
        // the default stack size value provided by 'bdlmtt_configuration'.
};
