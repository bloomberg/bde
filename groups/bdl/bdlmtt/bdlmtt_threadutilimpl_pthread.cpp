// bdlmtt_threadutilimpl_pthread.cpp                                   -*-C++-*-
#include <bdlmtt_threadutilimpl_pthread.h>

#include <bsls_ident.h>
BSLS_IDENT_RCSID(bdlmtt_threadutilimpl_pthread_cpp,"$Id$ $CSID$")
...
int localPthreadsPolicy(int policy)
    ...
    // 'bdlmtt::ThreadAttributes::SchedulingPolicy'.
{
...
static int initPthreadAttribute(pthread_attr_t                *dest,
                                const bdlmtt::ThreadAttributes&  src)
  ...
  public:
    ...
    ~MachClockGuard()
    {
        mach_port_deallocate(mach_task_self(), d_clock);
            ...
            // -------------------------------------------------------
            // class bdlmtt::ThreadUtilImpl<bdlmtt::Platform::PosixThreads>
            // -------------------------------------------------------

// CLASS DATA
const pthread_t
bdlmtt::ThreadUtilImpl<bdlmtt::Platform::PosixThreads>::INVALID_HANDLE =
                                                                (pthread_t) -1;

namespace bdlmtt {
// CLASS METHODS
int ThreadUtilImpl<bdlmtt::Platform::PosixThreads>::create(
          ThreadUtilImpl<bdlmtt::Platform::PosixThreads>::Handle *handle,
...
int ThreadUtilImpl<bdlmtt::Platform::PosixThreads>::
...
int ThreadUtilImpl<bdlmtt::Platform::PosixThreads>::sleep(
...
int ThreadUtilImpl<bdlmtt::Platform::PosixThreads>::microSleep(
                                                int                microsecs,
                                                int                seconds,
...
int ThreadUtilImpl<bdlmtt::Platform::PosixThreads>::sleepUntil(
