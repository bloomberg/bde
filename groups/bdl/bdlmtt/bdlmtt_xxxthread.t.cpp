...
// bdlmtt::Condition
//
// [ 4] int timedWait(bdlmtt::Mutex*, const bsls::TimeInterval&);
//
//-----------------------------------------------------------------------------
// Usage Examples
// --------------
...
{
    for(int i = 0; i < 5; ++i) {
        bdlmtt::ThreadUtil::microSleep(1000);  // 1 msec used for efficiency
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 3: {
        ...
        bdlmtt::ThreadUtil::create(&validH1, attributes, myThreadFunction, 0);
        bdlmtt::ThreadUtil::create(&validH2, attributes, myThreadFunction, 0);
