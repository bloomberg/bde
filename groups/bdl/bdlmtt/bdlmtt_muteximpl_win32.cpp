// bdlmtt_muteximpl_win32.cpp                                          -*-C++-*-
#include <bdlmtt_muteximpl_win32.h>

#include <bsls_ident.h>
BSLS_IDENT_RCSID(bdlmtt_muteximpl_win32_cpp,"$Id$ $CSID$")
...
BSLMF_ASSERT(sizeof(CRITICAL_SECTION) == sizeof(void *) *
   bdlmtt::MutexImpl<bdlmtt::Platform::Win32Threads>::CRITICAL_SECTION_BUFFER_SIZE);
