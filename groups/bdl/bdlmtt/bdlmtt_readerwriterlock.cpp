// bdlmtt_readerwriterlock.cpp      -*-C++-*-
#include <bdlmtt_readerwriterlock.h>

#include <bsls_ident.h>
BSLS_IDENT_RCSID(bdlmtt_readerwriterlock_cpp,"$Id$ $CSID$")
...
const long long bdlmtt::ReaderWriterLock::WRITER_MASK;
const long long bdlmtt::ReaderWriterLock::READER_MASK;
const long long bdlmtt::ReaderWriterLock::READER_INC;
const long long bdlmtt::ReaderWriterLock::BLOCKED_READER_MASK;
const long long bdlmtt::ReaderWriterLock::BLOCKED_READER_INC;
const long long bdlmtt::ReaderWriterLock::READ_OK;
const long long bdlmtt::ReaderWriterLock::UPGRADE_PENDING;
const long long bdlmtt::ReaderWriterLock::RESERVATION_PENDING;
const long long bdlmtt::ReaderWriterLock::READ_BCAST_MASK;
const long long bdlmtt::ReaderWriterLock::READ_BCAST_INC;
...
void ReaderWriterLock::lockRead()
{
    ...
    bsls::Types::Int64 newrwcount=bdlmtt::AtomicUtil::getInt64(d_rwCount);
    ...
    do {
        ...
        newrwcount = bdlmtt::AtomicUtil::testAndSwapInt64(&d_rwCount,
                                                       rwcount,
                                                       newrwcount);
    ...
    if (wait) {
        d_mutex.lock();
        do {
            rwcount = bdlmtt::AtomicUtil::getInt64(d_rwCount);
...
void ReaderWriterLock::lockReadReserveWrite()
{
    ...
    if (wait) {
        ...
        newrwcount = bdlmtt::AtomicUtil::getInt64(d_rwCount);
        do {
            rwcount = newrwcount;
        ...
        } while ((newrwcount = bdlmtt::AtomicUtil::testAndSwapInt64(
                                                     &d_rwCount,
                                                     rwcount,
                                                     newrwcount)) != rwcount );
        d_mutex.unlock();
...
int ReaderWriterLock::tryLockWrite()
{
    ...
    do {
        ...
        newrwcount = 1;
    } while ((newrwcount = bdlmtt::AtomicUtil::testAndSwapInt64(&d_rwCount,
                                                                rwcount,
                                                             newrwcount))
             != rwcount );
