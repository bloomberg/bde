...
//-----------------------------------------------------------------------------
// CREATORS
// [ 1] bdlmtt::ThreadGroup(bslma::Allocator *basicAllocator = 0);
// [ 5] ~bdlmtt::ThreadGroup();
//
// MANIPULATORS
...
class ThreadChecker {
    ...
    bdlmtt::Mutex *d_startBarrier;

  public:
    // CREATORS
    explicit ThreadChecker(bdlmtt::Mutex* startBarrier)
       : d_numCalls(0),
...
void synchronizedAdd(bdlmtt::ThreadGroup* tg,
    ...
    switch (test) { case 0:
      ...
      case 4: {
        ...
        bslma::TestAllocator ta(veryVeryVeryVerbose);
        {
            ...
            bdlmtt::Mutex     mutex;
            bdlmtt::Semaphore startSemaphore;
            bdlmtt::Semaphore doneSemaphore;
      ...
      case 2: {
        ...
        bslma::TestAllocator ta(veryVeryVeryVerbose);
        {
            ...
            bdlmtt::ThreadGroup tg(&ta);
            bdlmtt::ThreadGroup addingGroup(&ta);
      ...
      case 1: {
        ...
        //
        // Concerns:
        //   Exercise the basic functionality of the 'bdlmtt::ThreadGroup' class.
        ...
        //
        // Plan:
        //   Create a 'bdlmtt::ThreadGroup', 'mX', and a
        ...
        {
           bdlmtt::ThreadGroup        mX(&ta);
           const bdlmtt::ThreadGroup&  X = mX;

           bdlmtt::Mutex startBarrier;
