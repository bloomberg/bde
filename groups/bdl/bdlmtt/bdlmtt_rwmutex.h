...
#define INCLUDED_BDLMTT_RWMUTEX
...
//
//@CLASSES:
//   bdlmtt::RWMutex: platform-independent wrapper of an RW mutex
//
//@SEE_ALSO: bdlmtt_readerwriterlock
//
//@DESCRIPTION: This component provides a class, 'bdlmtt::RWMutex', that defines
...
#if defined(BDLMTT_PLATFORM_WIN32_THREADS) || defined(BSLS_PLATFORM_OS_AIX)
...
template <>
struct RWMutexImpl<bdlmtt::Platform::PosixThreads> {
...
class RWMutex {
    ...
    // DATA
#if defined(BSLS_PLATFORM_OS_AIX) || defined(BDLMTT_PLATFORM_WIN32_THREADS)
    ReaderWriterLock d_impl;
#else
    RWMutexImpl<bdlmtt::Platform::ThreadPolicy> d_impl;
#endif
...
// CREATORS
inline
RWMutexImpl<bdlmtt::Platform::PosixThreads>::RWMutexImpl()
{
...
inline
void
RWMutexImpl<bdlmtt::Platform::PosixThreads>::lockRead()
{
...
inline
void
RWMutexImpl<bdlmtt::Platform::PosixThreads>::lockWrite()
{
...
inline
int
RWMutexImpl<bdlmtt::Platform::PosixThreads>::tryLockRead()
{
...
inline
int
RWMutexImpl<bdlmtt::Platform::PosixThreads>::tryLockWrite()
{
...
inline
void
RWMutexImpl<bdlmtt::Platform::PosixThreads>::unlock()
{
