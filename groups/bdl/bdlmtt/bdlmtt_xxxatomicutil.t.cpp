...
//-----------------------------------------------------------------------------
//
// [2 ] initInt(bdlmtt::AtomicUtil::Int *aInt);
// [2 ] initInt64(bdlmtt::AtomicUtil::Int64 *aInt);
// [2 ] initPointer(bdlmtt::AtomicUtil::Pointer *aPointer);
// [6 ] initSpinLock(bdlmtt::AtomicUtil::SpinLock *aSpin);
// [3 ] addInt(bdlmtt::AtomicUtil::Int *aInt, int value);
// [5 ] incrementInt(bdlmtt::AtomicUtil::Int *aInt);
// [5 ] decrementInt(bdlmtt::AtomicUtil::Int *aInt);
// [4 ] swapInt64(bdlmtt::AtomicUtil::Int *aInt, int value);
// [4 ] testAndSwapInt(bdlmtt::AtomicUtil::Int *, int, int);
// [2 ] setInt(bdlmtt::AtomicUtil::Int *aInt, int value);
// [2 ] getInt(const bdlmtt::AtomicUtil::Int &aInt);
// [3 ] addIntNv(bdlmtt::AtomicUtil::Int *aInt, int val);
// [5 ] incrementIntNv(bdlmtt::AtomicUtil::Int *aInt);
// [5 ] decrementIntNv(bdlmtt::AtomicUtil::Int *aInt);
// [3 ] addInt64(bdlmtt::AtomicUtil::Int64 *, bsls::Types::Int64);
// [5 ] incrementInt64(bdlmtt::AtomicUtil::Int64 *aInt);
// [5 ] decrementInt64(bdlmtt::AtomicUtil::Int64 *aInt);
// [4 ] swapInt64(bdlmtt::AtomicUtil::Int64 *, bsls::Types::Int64);
// [4 ] testAndSwapInt64(bdlmtt::AtomicUtil::Int64 *, bsls::Types::Int64,
//                       bsls::Types::Int64);
// [3 ] addInt64Nv(bdlmtt::AtomicUtil::Int64 *, bsls::Types::Int64);
// [5 ] incrementInt64Nv(bdlmtt::AtomicUtil::Int64 *);
// [5 ] decrementInt64Nv(bdlmtt::AtomicUtil::Int64 *);
// [2 ] setInt64(bdlmtt::AtomicUtil::Int64 *, bsls::Types::Int64);
// [2 ] getInt64(const bdlmtt::AtomicUtil::Int64 &aInt);
// [2 ] getPtr(const bdlmtt::AtomicUtil::Pointer &aPointer);
// [2 ] setPtr(bdlmtt::AtomicUtil::Pointer *aPointer, void *value);
// [4 ] swapPtr(bdlmtt::AtomicUtil::Pointer *aPointer, void *value);
// [4 ] testAndSwapPtr(bdlmtt::AtomicUtil::Pointer *, void *, void *);
// [6 ] spinLock(bdlmtt::AtomicUtil::SpinLock *aSpin);
// [6 ] spinTryLock(bdlmtt::AtomicUtil::SpinLock *aSpin, int retries);
// [6 ] spinUnlock(bdlmtt::AtomicUtil::SpinLock *aSpin);
//-----------------------------------------------------------------------------
// [1 ] Breathing test
// [7 ] Usage examples
//-----------------------------------------------------------------------------
...
int main(int argc, char *argv[]) {
    ...
    switch (test) {
      ...
      case 9: {
        ...
        static bdlmtt::AtomicUtil::Int i     = { -2 };
        static bdlmtt::AtomicUtil::Int64 j   = { 0x1234abcd1234abcdLL };
        static bdlmtt::AtomicUtil::Pointer p = { &i };

        ASSERT(bdlmtt::AtomicUtil::getInt(i)   == -2);
        ASSERT(bdlmtt::AtomicUtil::getInt64(j) == 0x1234abcd1234abcdLL);
        ASSERT(bdlmtt::AtomicUtil::getPtr(p)   == &i);
      } break;
      ...
      case 5: {
        ...
        //
        // Testing:
        //   incrementInt(bdlmtt::AtomicUtil::Int *aInt);
        //   decrementInt(bdlmtt::AtomicUtil::Int *aInt);
        //   incrementIntNv(bdlmtt::AtomicUtil::Int *aInt);
        //   decrementIntNv(bdlmtt::AtomicUtil::Int *aInt);
        //   incrementInt64(bdlmtt::AtomicUtil::Int64 *aInt);
        //   decrementInt64(bdlmtt::AtomicUtil::Int64 *aInt);
        //   incrementInt64Nv(bdlmtt::AtomicUtil::Int64 *);
        //   decrementInt64Nv(bdlmtt::AtomicUtil::Int64 *);
        // --------------------------------------------------------------------
      ...
      case 4: {
        ...
        //
        // Testing:
        //   swapInt64(bdlmtt::AtomicUtil::Int *aInt, int value);
        //   testAndSwapInt(bdlmtt::AtomicUtil::Int *, int, int);
        //   swapInt64(bdlmtt::AtomicUtil::Int64 *, bsls::Types::Int64);
        //   testAndSwapInt64(bdlmtt::AtomicUtil::Int64 *, bsls::Types::Int6
        //                    bsls::Types::Int64 );
        //   swapPtr(bdlmtt::AtomicUtil::Pointer *aPointer, void *value);
        //   testAndSwapPtr(bdlmtt::AtomicUtil::Pointer *, void *, void *);
        // --------------------------------------------------------------------
        if (verbose) cout << "\nTesting SWAP Manipulators"
                          << "\n========================================="
                          << endl;
                          ...
                          << endl;
        {
            ...
            for (int i=0; i < NITERATIONS; ++i) {
                int oldValue = bdlmtt::AtomicUtil::swapInt( &mInt,
                                                         INT_SWAPTEST_VALUE1);
                if (oldValue == INT_SWAPTEST_VALUE1) ++value1Count;
                else if(oldValue == INT_SWAPTEST_VALUE2) ++value2Count;
                else ++errorCount;
                          ...
                          << endl;
        {
            ...
            for (int i=0; i < NITERATIONS; ++i) {
                bsls::Types::Int64 oldValue =
                      bdlmtt::AtomicUtil::swapInt64(&mInt, INT64_SWAPTEST_VALUE1);
                if (oldValue == INT64_SWAPTEST_VALUE1) ++value1Count;
                else if(oldValue == INT64_SWAPTEST_VALUE2) ++value2Count;
                else ++errorCount;
                          ...
                          << endl;
        {
            ...
            for (int i=0; i < NITERATIONS; ++i) {
                void* oldValue =
                    bdlmtt::AtomicUtil::swapPtr(&mPtr, POINTER_SWAPTEST_VALUE1);
                if (oldValue == POINTER_SWAPTEST_VALUE1) ++value1Count;
                else if(oldValue == POINTER_SWAPTEST_VALUE2) ++value2Count;
                else ++errorCount;
      ...
      case 3: {
        ...
        //   threads.
        // Testing:
        //   addInt(bdlmtt::AtomicUtil::Int *aInt, int value);
        //   addInt64(bdlmtt::AtomicUtil::Int64 *, bsls::Types::Int64);
        //   addIntNv(bdlmtt::AtomicUtil::Int *aInt, int value);
        //   addInt64Nv(bdlmtt::AtomicUtil::Int64 *, bsls::Types::Int64);
        // --------------------------------------------------------------------
      ...
      case 2: {
        ...
        //
        // Testing:
        //   initInt(bdlmtt::AtomicUtil::Int *aInt, int initialValue);
        //   initInt64(bdlmtt::AtomicUtil::Int64 *aInt);
        //   initPointer(bdlmtt::AtomicUtil::Pointer *aPointer);
        //   setInt(bdlmtt::AtomicUtil::Int *aInt, int value);
        //   getInt(const bdlmtt::AtomicUtil::Int &aInt);
        //   setInt64(bdlmtt::AtomicUtil::Int64 *, bsls::Types::Int64);
        //   getInt64(const bdlmtt::AtomicUtil::Int64 &aInt);
        //   getPtr(const bdlmtt::AtomicUtil::Pointer &aPointer);
        //   setPtr(bdlmtt::AtomicUtil::Pointer *aPointer, void *value);
        //
        // --------------------------------------------------------------------
