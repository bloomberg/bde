// bdlmtt_lockguard.h                                                  -*-C++-*-
#ifndef INCLUDED_BDLMTT_LOCKGUARD
#define INCLUDED_BDLMTT_LOCKGUARD
...
//
//@CLASSES:
//  bdlmtt::LockGuard: automatic locking-unlocking of mutexes
//  bdlmtt::LockGuardUnlock: automatic unlocking-locking of mutexes
//  bdlmtt::LockGuardTryLock: automatic non-blocking locking-unlocking of mutexes
//  bdlmtt::UnLockGuard: DEPRECATED
//  bdlmtt::TryLockGuard: DEPRECATED
//
//@SEE_ALSO: bdlmtt_xxxthread, bdlmtt_readlockguard, bdlmtt_writelockguard
//
...
// object can be any type (e.g., 'bdlmtt::Mutex' or 'bdlmtt::RecursiveMutex')
// that provides the following methods:
//..
//  void lock();
//  void unlock();
//..
// Both 'bdlmtt::LockGuard' and 'bdlmtt::LockGuardUnlock' implement the
// "construction is acquisition, destruction is release" idiom.  During
// construction, 'bdlmtt::LockGuard' automatically calls 'lock' on the
// user-supplied object, and 'unlock' when it is destroyed (unless released).
// 'bdlmtt::LockGuardUnlock' does the opposite -- it invokes the 'unlock' method
// when constructed and the 'lock' method when it is destroyed.
//
// A third type of guard, 'bdlmtt::LockGuardTryLock', attempts to acquire a
...
// value to indicate success.  Rather, the 'bdlmtt::LockGuardTryLock' contains a
// pointer to the synchronization object if 'tryLock' succeeds, and is null
// otherwise.  The synchronization object can be any type (e.g., 'bdlmtt::Mutex'
// or 'bdlmtt::RecursiveMutex') that provides the following methods:
//..
//  void tryLock();
//  void unlock();
//..
...
///--------------------------------
// Like all BDE proctor classes, each of the three 'bdlmtt::LockGuard*' classes
...
//
// In particular, 'bdlmtt::ReadLockGuard::release' does not unlock the lock
...
//..
//  // 'guard' is an existing guard of type 'bdlmtt::LockGuard<my_Lock>',
...
// a 'bdlmtt::LockGuardTryLock' in the typical following fashion:
//..
...
//  }
//..
// Instantiations of 'bdlmtt::LockGuardUnlock' can be interleaved with
// instantiations of 'bdlmtt::LockGuard' to create both critical sections
