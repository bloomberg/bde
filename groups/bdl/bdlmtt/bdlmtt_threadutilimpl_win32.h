// bdlmtt_threadutilimpl_win32.h                                       -*-C++-*-
#ifndef INCLUDED_BDLMTT_THREADUTILIMPL_WIN32
#define INCLUDED_BDLMTT_THREADUTILIMPL_WIN32
...
//@PURPOSE: Provide a win32 implementation of 'bdlmtt::ThreadUtil'.
//
//@CLASSES:
//  bdlmtt::ThreadUtilImpl<Win32Threads>: win32 specialization
//
...
//..
//  bdlmtt::ThreadUtilImpl<bdlmtt::Platform::Win32Threads>
//..
...
template <>
struct ThreadUtilImpl<bdlmtt::Platform::Win32Threads> {
...
// FREE OPERATORS
bool operator==(
         const ThreadUtilImpl<bdlmtt::Platform::Win32Threads>::Handle& lhs,
         const ThreadUtilImpl<bdlmtt::Platform::Win32Threads>::Handle& rhs);
...
// ===========================================================================
                             ...
                             // ----------------------------
                             // bdlmtt::ThreadUtilImpl::Handle
                             // ----------------------------

// FREE OPERATORS
inline
bool bdlmtt::operator==(
          const ThreadUtilImpl<bdlmtt::Platform::Win32Threads>::Handle& lhs,
          const ThreadUtilImpl<bdlmtt::Platform::Win32Threads>::Handle& rhs)
{
    return ThreadUtilImpl<bdlmtt::Platform::Win32Threads>::areEqual(lhs,
                                                                       rhs);
}
...
// CLASS METHODS
inline
int ThreadUtilImpl<bdlmtt::Platform::Win32Threads>::
...
inline
void ThreadUtilImpl<bdlmtt::Platform::Win32Threads>::yield()
{
    ::SleepEx(0, 0);
}

inline
void ThreadUtilImpl<bdlmtt::Platform::Win32Threads>::sleep(
...
inline
void ThreadUtilImpl<bdlmtt::Platform::Win32Threads>::microSleep(
                                                                 int microsecs,
                                                                 int seconds)
{
...
ThreadUtilImpl<bdlmtt::Platform::Win32Threads>::self()
{
    Handle h;
...
inline
ThreadUtilImpl<bdlmtt::Platform::Win32Threads>::NativeHandle
ThreadUtilImpl<bdlmtt::Platform::Win32Threads>::nativeHandle(
       const ThreadUtilImpl<bdlmtt::Platform::Win32Threads>::Handle& handle)
{
    return handle.d_handle;
}

inline
ThreadUtilImpl<bdlmtt::Platform::Win32Threads>::Id
ThreadUtilImpl<bdlmtt::Platform::Win32Threads>::selfId()
{
...
inline
bsls::Types::Uint64
ThreadUtilImpl<bdlmtt::Platform::Win32Threads>::selfIdAsInt()
{
...
inline
bsls::Types::Uint64
ThreadUtilImpl<bdlmtt::Platform::Win32Threads>::selfIdAsUint64()
{
...
inline
ThreadUtilImpl<bdlmtt::Platform::Win32Threads>::Id
ThreadUtilImpl<bdlmtt::Platform::Win32Threads>::handleToId(
...
inline
bsls::Types::Uint64
ThreadUtilImpl<bdlmtt::Platform::Win32Threads>::idAsUint64(
                                                             const Id& threadId)
{
...
inline
int ThreadUtilImpl<bdlmtt::Platform::Win32Threads>::idAsInt(
                                                            const Id& threadId)
{
...
inline
bool ThreadUtilImpl<bdlmtt::Platform::Win32Threads>::areEqualId(
                const ThreadUtilImpl<bdlmtt::Platform::Win32Threads>::Id& a,
                const ThreadUtilImpl<bdlmtt::Platform::Win32Threads>::Id& b)
{
    return a == b;
}

inline
void *ThreadUtilImpl<bdlmtt::Platform::Win32Threads>::getSpecific(
                                                                const Key& key)
{
