// bdlmtt_saturatedtimeconversionimputil.t.cpp                         -*-C++-*-
...
typedef bdlmtt::SaturatedTimeConversionImpUtil Obj;
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:
      case 7: {
        ...
        // 'bdlmtt::SaturatedTimeConversionImpUtil' handles values outside the
