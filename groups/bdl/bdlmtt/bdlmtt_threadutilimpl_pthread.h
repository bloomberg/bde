// bdlmtt_threadutilimpl_pthread.h                                     -*-C++-*-
#ifndef INCLUDED_BDLMTT_THREADUTILIMPL_PTHREAD
#define INCLUDED_BDLMTT_THREADUTILIMPL_PTHREAD
...
//@PURPOSE: Provide a POSIX implementation of 'bdlmtt::ThreadUtil'.
//
//@CLASSES:
//  bdlmtt::ThreadUtilImpl<PosixThreads>: POSIX specialization
//
//@SEE_ALSO: bdlmtt_threadutil
//
//@AUTHOR: Ilougino Rocha (irocha)
//
//@DESCRIPTION: This component provides an implementation of 'bdlmtt::ThreadUtil'
// for POSIX threads ("pthreads") via the template specialization:
//..
//  bdlmtt::ThreadUtilImpl<bdlmtt::Platform::PosixThreads>
//..
// This template class should not be used (directly) by client code.  Clients
// should instead use 'bdlmtt::ThreadUtil'.
//
...
extern "C" {
    typedef void *(*bcemt_ThreadFunction)(void *);
        ...
        // functions to 'bdlmtt::ThreadUtil::create'.  Note that 'create'
        // also
...
namespace bdlmtt {
            // =======================================================
            // class ThreadUtilImpl<bdlmtt::Platform::PosixThreads>
            // =======================================================

template <>
struct ThreadUtilImpl<bdlmtt::Platform::PosixThreads> {
...
inline
int ThreadUtilImpl<bdlmtt::Platform::PosixThreads>::detach(
             ThreadUtilImpl<bdlmtt::Platform::PosixThreads>::Handle& handle)
{
...
inline
void ThreadUtilImpl<bdlmtt::Platform::PosixThreads>::exit(void *status)
{
    pthread_exit(status);
}

inline
int ThreadUtilImpl<bdlmtt::Platform::PosixThreads>::join(
           ThreadUtilImpl<bdlmtt::Platform::PosixThreads>::Handle&   thread,
           void                                                       **status)
{
...
inline
void ThreadUtilImpl<bdlmtt::Platform::PosixThreads>::yield()
{
    sched_yield();
}
...
inline
bool ThreadUtilImpl<bdlmtt::Platform::PosixThreads>::areEqual(
            const ThreadUtilImpl<bdlmtt::Platform::PosixThreads>::Handle& a,
            const ThreadUtilImpl<bdlmtt::Platform::PosixThreads>::Handle& b)
{
    return pthread_equal(a, b);
}

inline
bool ThreadUtilImpl<bdlmtt::Platform::PosixThreads>::areEqualId(
                const ThreadUtilImpl<bdlmtt::Platform::PosixThreads>::Id& a,
                const ThreadUtilImpl<bdlmtt::Platform::PosixThreads>::Id& b)
{
    return pthread_equal(a, b);
}

inline
ThreadUtilImpl<bdlmtt::Platform::PosixThreads>::Id
ThreadUtilImpl<bdlmtt::Platform::PosixThreads>::handleToId(
...
inline
bsls::Types::Uint64
ThreadUtilImpl<bdlmtt::Platform::PosixThreads>::idAsUint64(
                                                            const Id& threadId)
{
...
inline
int
ThreadUtilImpl<bdlmtt::Platform::PosixThreads>::idAsInt(const Id& threadId)
{
...
inline
ThreadUtilImpl<bdlmtt::Platform::PosixThreads>::NativeHandle
ThreadUtilImpl<bdlmtt::Platform::PosixThreads>::nativeHandle(
       const ThreadUtilImpl<bdlmtt::Platform::PosixThreads>::Handle& handle)
{
    return handle;
}

inline
ThreadUtilImpl<bdlmtt::Platform::PosixThreads>::Handle
ThreadUtilImpl<bdlmtt::Platform::PosixThreads>::self()
{
    return pthread_self();
}
...
inline
ThreadUtilImpl<bdlmtt::Platform::PosixThreads>::Id
ThreadUtilImpl<bdlmtt::Platform::PosixThreads>::selfId()
{
    return pthread_self();
}
...
inline
bsls::Types::Uint64
ThreadUtilImpl<bdlmtt::Platform::PosixThreads>::selfIdAsInt()
{
...
inline
bsls::Types::Uint64
ThreadUtilImpl<bdlmtt::Platform::PosixThreads>::selfIdAsUint64()
{
...
inline
int ThreadUtilImpl<bdlmtt::Platform::PosixThreads>::createKey(
                                       Key                         *key,
...
inline
int ThreadUtilImpl<bdlmtt::Platform::PosixThreads>::deleteKey(Key& key)
{
    return pthread_key_delete(key);
}

inline
void *ThreadUtilImpl<bdlmtt::Platform::PosixThreads>::getSpecific(
                                                                const Key& key)
{
...
inline
int ThreadUtilImpl<bdlmtt::Platform::PosixThreads>::setSpecific(
                                                             const Key&  key,
                                                             const void *value)
{
