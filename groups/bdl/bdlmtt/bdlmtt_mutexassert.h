// bdlmtt_mutexassert.h                                                -*-C++-*-
#ifndef INCLUDED_BDLMTT_MUTEXASSERT
#define INCLUDED_BDLMTT_MUTEXASSERT
...
//
//@MACROS:
//  BDLMTT_MUTEXASSERT_IS_LOCKED: verify a mutex is locked in non-opt modes
//  BDLMTT_MUTEXASSERT_IS_LOCKED_SAFE: verify a mutex is locked in safe mode
//  BDLMTT_MUTEXASSERT_IS_LOCKED_OPT: verify a mutex is locked in all modes
//
...
//
//: o 'BDLMTT_MUTEXASSERT_IS_LOCKED': active when 'BSLS_ASSERT' is active
//:
//: o 'BDLMTT_MUTEXASSERT_IS_LOCKED_SAFE': active when 'BSLS_ASSERT_SAFE' is
//:   active
//:
//: o 'BDLMTT_MUTEXASSERT_IS_LOCKED_OPT': active when 'BSLS_ASSERT_OPT' is
//:   active
//
...
// guarded by an internal mutex.  We can use 'BDLMTT_MUTEXASSERT_IS_LOCKED_SAFE'
...
//                                       // standard container
//
//      mutable bdlmtt::Mutex  d_mutex;    // mutex to provide thread safety
//
//      // PRIVATE MANIPULATOR
...
//  {
//      BDLMTT_MUTEXASSERT_IS_LOCKED_SAFE(&d_mutex);
//
//      if (d_deque.empty()) {
//          return -1;                                                // RETURN
//      }
...
// 'BDLMTT_MUTEXASSERT_IS_LOCKED*' macros.  We use the '...IS_LOCKED_SAFE...'
...
// 'BDLMTT_MUTEXASSERT_IS_LOCKED_SAFE(&d_mutex)' macro issues an error message
// and aborts:
//..
//  Assertion failed: BDLMTT_MUTEXASSERT_IS_LOCKED_SAFE(&d_mutex), file /bb/big
...
#include <bsls_assert.h>
    ...
    #define BDLMTT_MUTEXASSERT_IS_LOCKED(mutex_p) do {                         \
        bdlmtt::MutexAssert_Imp::assertIsLockedImpl(                            \
                           (mutex_p),                                         \
                           "BDLMTT_MUTEXASSERT_IS_LOCKED(" #mutex_p ")",       \
                           __FILE__,                                          \
                           __LINE__); } while (false)
#else
    #define BDLMTT_MUTEXASSERT_IS_LOCKED(mutex_p) ((void) 0)
#endif

#if defined(BSLS_ASSERT_SAFE_IS_ACTIVE)
    #define BDLMTT_MUTEXASSERT_IS_LOCKED_SAFE(mutex_p) do {                    \
        bdlmtt::MutexAssert_Imp::assertIsLockedImpl(                            \
                           (mutex_p),                                         \
                           "BDLMTT_MUTEXASSERT_IS_LOCKED_SAFE(" #mutex_p ")",  \
                           __FILE__,                                          \
                           __LINE__); } while (false)
#else
    #define BDLMTT_MUTEXASSERT_IS_LOCKED_SAFE(mutex_p) ((void) 0)
#endif

#if defined(BSLS_ASSERT_OPT_IS_ACTIVE)
    #define BDLMTT_MUTEXASSERT_IS_LOCKED_OPT(mutex_p) do {                     \
        bdlmtt::MutexAssert_Imp::assertIsLockedImpl(                            \
                           (mutex_p),                                         \
                           "BDLMTT_MUTEXASSERT_IS_LOCKED_OPT(" #mutex_p ")",   \
                           __FILE__,                                          \
                           __LINE__); } while (false)
#else
    #define BDLMTT_MUTEXASSERT_IS_LOCKED_OPT(mutex_p) ((void) 0)
#endif
...
struct MutexAssert_Imp {
    ...
    void assertIsLockedImpl(Mutex *mutex,
        ...
        // 'BDLMTT_MUTEXASSERT_IS_LOCKED', 'BDLMTT_MUTEXASSERT_IS_LOCKED_SAFE',
        // and 'BDLMTT_MUTEXASSERT_IS_LOCKED_OPT' and should not otherwise be
        // called directly.
};
