// bdlmtt_meteredmutex.h      -*-C++-*-
#ifndef INCLUDED_BDLMTT_METEREDMUTEX
#define INCLUDED_BDLMTT_METEREDMUTEX
...
//
//@CLASSES:
// bdlmtt::MeteredMutex: mutex capable of keeping track of wait and hold time
//
//@SEE_ALSO:
//
//@AUTHOR: Ujjwal Bhoota (ubhoota)
//
//@DESCRIPTION: This component provides a class, 'bdlmtt::MeteredMutex', that
