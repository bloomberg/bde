...
#define DEC(X) BDLDFP_DECIMAL_DF(X)
            ...
            static const struct {
                ...
                {  L_,                  DEC(0.02),       0  ,  e_F, "0"     },
                {  L_,                  DEC(0.02),       1  ,  e_F, "0.0"   },
                {  L_,                  DEC(0.02),       2  ,  e_F, "0.02"  },
                {  L_,                  DEC(0.02),       3  ,  e_F, "0.020" },

                {  L_,                  DEC(30.0),        0  ,  e_F, "30"     },
                {  L_,                  DEC(30.0),        1  ,  e_F, "30.0"  },
                {  L_,                  DEC(30.0),        2  ,  e_F, "30.00"  },
                ...
                {  L_,               DEC(-10.1239),        3  ,  e_F, "-10.124"  },

                {  L_,               DEC(-1.999e+3),        0  ,  e_F, "-1999"  },
                {  L_,               DEC(-1.23e+7),        0  ,  e_F, "-12300000"  },
...
#define DEC(X) BDLDFP_DECIMAL_DL(X)
            ...
            static const struct {
                ...
                {  L_,                  DEC(0.2),        0  ,  e_F, "0"     },
                {  L_,                  DEC(0.2),        1  ,  e_F, "0.2"   },
                {  L_,                  DEC(0.2),        2  ,  e_F, "0.20"  },

                {  L_,                  DEC(0.03),       0  ,  e_F, "0"     },
                {  L_,                  DEC(0.03),       1  ,  e_F, "0.0"   },
                {  L_,                  DEC(0.03),       2  ,  e_F, "0.03"  },
                {  L_,                  DEC(0.03),       3  ,  e_F, "0.030" },

                {  L_,                  DEC(40.0),        0  ,  e_F, "40"     },
                {  L_,                  DEC(40.0),        1  ,  e_F, "40.0"  },
                {  L_,                  DEC(40.0),        2  ,  e_F, "40.00"  },
