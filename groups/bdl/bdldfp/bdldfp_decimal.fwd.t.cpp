...
template <class T> bool isIncomplete(int(*)[sizeof(T)]);
template <class T> bool isIncomplete(...);
...
template <class T>
bool isIncomplete(int(*)[sizeof(T)])
{
    return false;
}
...
int main(int argc, char* argv[])
{
    ...
    switch (test) { case 0:
      case 1: {
        ...
        //: using &#39;isIncomplete&#39;.
        //:
        //: 2 Invoke &#39;testCompleted&#39;, defined below after the inclusion of the
        //: primary header, to verify that the forward names are completed by
