...
//=============================================================================
//        Helper Functions for Testing 'bdlu_BitUtil' Searching Functions
//-----------------------------------------------------------------------------
// These functions perform operations that are identical to 'bdlu_BitUtil'
// methods, but using a completely independent implementation.

/*
static long long roundUpToBinaryPower(Uint64 srcInteger)
{
    // Return the value of 'bdlu_BitUtil::roundUpToBinaryPower(srcInteger)'
...
static int findFirstBit1(Int64 srcInteger)
    // Return the value of 'bdlu_BitUtil::find1AtLargestIndex(srcInteger)'
...
static int findLastBit1(Int64 srcInteger)
    // Return the value of 'bdlu_BitUtil::find1AtSmallestIndex(srcInteger)'
    // but use a completely independent implementation.
{
    for (int i = 0; i < BPS; ++i) {
        if (srcInteger & ((Int64) 1 << i))
    ...
    return Util::BDLU_BITS_PER_INT64;
}
*/
//-----------------------------------------------------------------------------
...
//..
    ASSERT((int) 0xffff0000 == bdlu_BitUtil::geMask(16));
//
//  +-------------------------------------------------------------------------+
//  | 'bdlu_BitUtil::geMask(16)' in binary:                                   |
//  |                                                                         |
//  | bit 16:                                               *                 |
...
//..
    ASSERT((int) 0x0000ffff == bdlu_BitUtil::ltMask(16));
//
//  +-------------------------------------------------------------------------+
//  | 'bdlu_BitUtil::ltMask(16)' in binary:                                   |
//  |                                                                         |
//  | bit 16:                                               *                 |
...
//..
    ASSERT((int) 0x00800000 == bdlu_BitUtil::eqMask(23));
//
//  +-------------------------------------------------------------------------+
//  | 'bdlu_BitUtil::eqMask(23)' in binary:                                   |
//  |                                                                         |
//  | bit 23:                                        *                        |
...
// 'index' cleared:
//..
    ASSERT((int) 0xfffeffff == bdlu_BitUtil::neMask(16));
//
//  +-------------------------------------------------------------------------+
//  | 'bdlu_BitUtil::neMask(16)' in binary:                                   |
//  |                                                                         |
//  | bit 16:                                               *                 |
...
//..
    ASSERT((int) 0x000f0000 == bdlu_BitUtil::oneMask(16, 4));
//
//  +-------------------------------------------------------------------------+
//  | 'bdlu_BitUtil::oneMask(16, 4)' in binary:                               |
//  |                                                                         |
//  | bit 16:                                               *                 |
...
//  +-------------------------------------------------------------------------+
//
    ASSERT((int) 0xfff0ffff == bdlu_BitUtil::zeroMask(16, 4));
//
//  +-------------------------------------------------------------------------+
//  | 'bdlu_BitUtil::zeroMask(16, 4)' in binary:                              |
//  |                                                                         |
//  | bit 16:                                               *                 |
//  | 4 bits starting at bit 16:                         ****                 |
...
//..
    int myInt = 0x3333;
    bdlu_BitUtil::andEqual(&myInt, 9, false);
    ASSERT(0x3133 == myInt);
//
//  +-------------------------------------------------------------------------+
//  | 'bdlu_BitUtil::andEqual(&myInt, 9, false)' in binary:                   |
//  |                                                                         |
...
//
    myInt = 0x3333;
    bdlu_BitUtil::andEqual(&myInt, 9, true);
    ASSERT(0x3333 == myInt);

    myInt = 0x3333;
    bdlu_BitUtil::andEqual(&myInt, 8,  0, 8);
    ASSERT(  0x33 == myInt);

    myInt = 0x3333;
    bdlu_BitUtil::andEqual(&myInt, 8, -1, 8);    // Note '-1' is all '1's.
    ASSERT(0x3333 == myInt);
//..
...
//..
    myInt = 0x3333;
    bdlu_BitUtil::insertOne( &myInt, 4, 8);
    ASSERT(0x333ff3 == myInt);
//
//  +-------------------------------------------------------------------------+
//  | 'bdlu_BitUtil::insertOne( &myInt, 4, 8)' in binary:                     |
//  |                                                                         |
//  | 'myInt' before in binary:                                11001100110011 |
...
//
    myInt = 0x3333;
    bdlu_BitUtil::insertZero(&myInt, 4, 8);
...
//..
    myInt = 0x33333333;
    bdlu_BitUtil::orEqual(&myInt, 16, -1, 8);
    ASSERT((int) 0x33ff3333 == myInt);
//
//  +-------------------------------------------------------------------------+
//  | 'bdlu_BitUtil::orEqual(&myInt, 16, -1, 8)' in binary:                   |
//  |                                                                         |
...
//..
    myInt = 0x12345678;
    bdlu_BitUtil::removeOne(&myInt, 8, 16);
    ASSERT((int) 0xffff1278 == myInt);
//
//  +-------------------------------------------------------------------------+
//  | 'bdlu_BitUtil::removeOne(&myInt, 8, 16)' in binary:                     |
//  |                                                                         |
...
//
    myInt = 0x12345678;
    bdlu_BitUtil::removeZero(&myInt, 8, 16);
...
//..
    myInt = 0x11111111;
    bdlu_BitUtil::toggle(&myInt, 8, 16);
    ASSERT((int) 0x11eeee11 == myInt);
//
//  +-------------------------------------------------------------------------+
//  | 'bdlu_BitUtil::toggle(&myInt, 8, 16)' in binary:                        |
//  |                                                                         |
...
//..
    myInt = 0x11111111;
    bdlu_BitUtil::xorEqual(&myInt, 16, true);
    ASSERT((int) 0x11101111 == myInt);
//
//  +-------------------------------------------------------------------------+
//  | 'bdlu_BitUtil::xorEqual(&myInt, 16, true)' in binary:                   |
//  |                                                                         |
//  | 'myInt' before in binary:              00010001000100010001000100010001 |
//  | xor bit 16:                                           1                 |
...
//
    myInt = 0x11111111;
    bdlu_BitUtil::xorEqual(&myInt, 16, false);
...
//..
    myInt = 0x77777777;
    bdlu_BitUtil::xorEqual(&myInt, 16, 0xff, 8);
    ASSERT((int) 0x77887777 == myInt);
//
//  +-------------------------------------------------------------------------+
//  | 'bdlu_BitUtil::xorEqual(&myInt, 16, 0xff, 8)' in binary:                |
//  |                                                                         |
...
//
    myInt = 0x77777777;
    bdlu_BitUtil::xorEqual(&myInt, 16, 0x55, 8);
...
//..
    ASSERT( 8 == bdlu_BitUtil::find1AtLargestIndex(  0x00000101));
//
//  +-------------------------------------------------------------------------+
//  | 'bdlu_BitUtil::find1AtLargestIndex(  0x00000101)' in binary:            |
//  |                                                                         |
...
//  +-------------------------------------------------------------------------+
//
    ASSERT( 8 == bdlu_BitUtil::find0AtLargestIndex( ~0x00000101));
    ASSERT( 8 == bdlu_BitUtil::find0AtLargestIndex(  0xfffffe55));
    ASSERT( 8 == bdlu_BitUtil::find1AtLargestIndexGE(0x00000101,  3));
    ASSERT(-1 == bdlu_BitUtil::find1AtLargestIndexGE(0x00000155, 16));
    ASSERT(-1 == bdlu_BitUtil::find1AtLargestIndexLT(0xffff0100,  3));

    ASSERT( 8 == bdlu_BitUtil::find1AtLargestIndexLT(0xffff0100, 16));
//
//  +-------------------------------------------------------------------------+
//  | 'bdlu_BitUtil::find1AtLargestIndexLT(0xffff0100, 16)' in binary:        |
//  |                                                                         |
...
//  +-------------------------------------------------------------------------+
//
    ASSERT( 8 == bdlu_BitUtil::find1AtSmallestIndex(  0xffff0100));
    ASSERT(16 == bdlu_BitUtil::find1AtSmallestIndexGE(0xffff0100, 10));
//
//  +-------------------------------------------------------------------------+
//  | 'bdlu_BitUtil::find1AtSmallestIndexGE(0xffff0100, 10)' in binary:       |
//  |                                                                         |
//  | input:                                 11111111111111110000000100000000 |
//  | bit 10:                                                     *           |
...
//..
    ASSERT(      6 == bdlu_BitUtil::intAbs( 6));
    ASSERT(      6 == bdlu_BitUtil::intAbs(-6));
    ASSERT(INT_MAX == bdlu_BitUtil::intAbs(-INT_MAX));
    ASSERT(INT_MIN == bdlu_BitUtil::intAbs( INT_MIN));    // see note below

    ASSERT(12 == bdlu_BitUtil::intMax(-5, 12));
    ASSERT(-5 == bdlu_BitUtil::intMin(-5, 12));
//..
...
// 'bdlu_BitUtil::intAbs(INT_MIN)' cannot be represented as a positive integer.
...
//..
    ASSERT((int) 0x0f0f0f0f ==
                      bdlu_BitUtil::merge(0x0f0f0000, 0xffff0f0f, 0x0000ffff));
//
//  +-------------------------------------------------------------------------+
//  | 'bdlu_BitUtil::merge(0x0f0f0000, 0xffff0f0f, 0x0000ffff))' in binary:   |
//  |                                                                         |
...
//
    ASSERT((int) 0x55555555 ==
                      bdlu_BitUtil::merge(0x00000000, 0xffffffff, 0x55555555));
//..
// 'numSetOne' and 'numSetZero' count the number of set (or clear) bits:
//..
    ASSERT(16 == bdlu_BitUtil::numSetOne( 0x55555555));
//
//  +-------------------------------------------------------------------------+
//  | 'bdlu_BitUtil::numSetOne( 0x55555555)' in binary:                       |
//  |                                                                         |
//  | input in binary:                       01010101010101010101010101010101 |
//  | that has 16 ones set.  result: 16                                       |
//  +-------------------------------------------------------------------------+
//
    ASSERT(16 == bdlu_BitUtil::numSetOne( 0xffff0000));
    ASSERT(16 == bdlu_BitUtil::numSetOne( 0x0000ffff));
    ASSERT( 1 == bdlu_BitUtil::numSetOne( 0x00010000));
    ASSERT(31 == bdlu_BitUtil::numSetZero(0x00010000));
//..
// 'rangeZero' and 'rangeOne' mask out a sub-range of bits from a value,
// filling the rest with '0's or '1's:
//..
    ASSERT((int) 0x00333300 == bdlu_BitUtil::rangeZero(0x33333333, 8, 16));
//
//  +-------------------------------------------------------------------------+
//  | 'bdlu_BitUtil::rangeZero(0x33333333,  8, 16)' in binary:                |
//  |                                                                         |
...
//  +-------------------------------------------------------------------------+
//
    ASSERT((int) 0x00f0f000 == bdlu_BitUtil::rangeZero(0xf0f0f0f0, 8, 16));
    ASSERT((int) 0xff3333ff == bdlu_BitUtil::rangeOne (0x33333333, 8, 16));
//..
// 'base2Log' takes a binary log of a number, rounded up to the next integer:
//..
    ASSERT(7 == bdlu_BitUtil::base2Log(100));
    ASSERT(7 == bdlu_BitUtil::base2Log(128));
    ASSERT(8 == bdlu_BitUtil::base2Log(129));
//..
// 'roundUpToBinaryPower' rounds a number up to the next power of 2:
//..
    ASSERT(128 == bdlu_BitUtil::roundUpToBinaryPower(100));
    ASSERT(128 == bdlu_BitUtil::roundUpToBinaryPower(128));
//..
// 'setBitOne' will set a bit (or bits) to one, leaving other bits unaffected:
//..
    ASSERT((int) 0x66676666 == bdlu_BitUtil::setBitOne(0x66666666, 16));
//
//  +-------------------------------------------------------------------------+
//  | 'bdlu_BitUtil::setBitOne(0x66666666, 16)' in binary:                    |
//  |                                                                         |
...
//  +-------------------------------------------------------------------------+
//
    ASSERT((int) 0x00010000 == bdlu_BitUtil::setBitOne(0, 16));

    ASSERT((int) 0x33ffff33 == bdlu_BitUtil::setOne(0x33333333, 8, 16));
//..
...
//..
    ...
    ASSERT( 8 == bdlu_BitUtil::sizeInBits(thisChar));
    ASSERT(16 == bdlu_BitUtil::sizeInBits(thisShort));
    ASSERT(32 == bdlu_BitUtil::sizeInBits(thisInt));
    ASSERT(64 == bdlu_BitUtil::sizeInBits(thisBigInt));
//..
}
...
void testG(int test)
{
    switch (test) {
      ...
      case 31: {
////////////////////////////////////////////////////////////////////////////
// print() has been removed from bdlu_BitUtil
////////////////////////////////////////////////////////////////////////////
//
//     // --------------------------------------------------------------------
    ...
    switch (test) {
      ...
      case 3: {
        ...
        if (veryVerbose) {
            ...
            T_();  P(Util::BDLU_WORD_SIZE);
            T_();  P(CHAR_BIT);
            T_();  P(Util::BDLU_BITS_PER_INT);
        }
        ASSERT(sizeof(int) == Util::BDLU_WORD_SIZE);
        ASSERT(EIGHT       == CHAR_BIT);
        ASSERT(BPW         == Util::BDLU_BITS_PER_INT);
