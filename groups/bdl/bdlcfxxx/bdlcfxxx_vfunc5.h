...
#define INCLUDED_BDLCFXXX_VFUNC5
...
//
//@CLASSES:
//   bdlcfxxx::Vfunc5: signature-specific function object (functor)
//
...
// construction.
//
// The 'bdlcfxxx::Vfunc5' functor (envelope) holds a polymorphic, reference-counted,
...
// signature and (2) the supplied user data.  See the 'bdlcfxxxu_vfunc5' component
// for more information on populating 'bdlcfxxx::Vfunc5' function objects with
...
class Vfunc5 {
    ...
    bdlcfxxxr::Vfunc5<A1, A2, A3, A4, A5> *d_rep_p;
        // polymorphic functor representation

    // NOT IMPLEMENTED
    bool operator==(const Vfunc5&) const;
    bool operator!=(const Vfunc5&) const;

    template<class B1, class B2, class B3, class B4, class B5>
    bool operator==(const Vfunc5<B1, B2, B3, B4, B5>&) const;
    template<class B1, class B2, class B3, class B4, class B5>
    bool operator!=(const Vfunc5<B1, B2, B3, B4, B5>&) const;

  public:
    // TRAITS
    BSLALG_DECLARE_NESTED_TRAITS(Vfunc5,
    ...
    Vfunc5(bdlcfxxxr::Vfunc5<A1, A2, A3, A4, A5> *representation);
        ...
        // components (see 'bdlcfxxxu_vfunc5') to create an appropriate
        // representation and load it into an existing functor.

    Vfunc5(const Vfunc5<A1, A2, A3, A4, A5>& functionObject);
    ...
    ~Vfunc5();
        ...
        // the static 'deleteObject' method of 'bdlcfxxxr::Vfunc5' base class).

    // MANIPULATORS
    Vfunc5<A1, A2, A3, A4, A5>& operator=(
        const Vfunc5<A1, A2, A3, A4, A5>& functionObject);
        ...
        // 'deleteObject' method of 'bdlcfxxxr::Vfunc5' base class.
...
template <class A1, class A2, class A3, class A4, class A5>
inline
Vfunc5<A1, A2, A3, A4, A5>::Vfunc5(
    bdlcfxxxr::Vfunc5<A1, A2, A3, A4, A5> *rep)
: d_rep_p(rep)
{
    if (d_rep_p) {
        d_rep_p->increment();
...
template <class A1, class A2, class A3, class A4, class A5>
inline Vfunc5<A1, A2, A3, A4, A5>::Vfunc5(const Vfunc5& functor)
...
inline Vfunc5<A1, A2, A3, A4, A5>::~Vfunc5()
{
    if (d_rep_p && 0 == d_rep_p->decrement()) {
        bdlcfxxxr::Vfunc5<A1, A2, A3, A4, A5>::deleteObject(d_rep_p);
    }
}

template <class A1, class A2, class A3, class A4, class A5> inline
Vfunc5<A1, A2, A3, A4, A5>&
Vfunc5<A1, A2, A3, A4, A5>::operator=(
    const Vfunc5<A1, A2, A3, A4, A5>& rhs)
{
...
template <class A1, class A2, class A3, class A4, class A5>
inline void Vfunc5<A1, A2, A3, A4, A5>::operator()(
                                                const A1& argument1,
                                                const A2& argument2,
                                                const A3& argument3,
                                                const A4& argument4,
...
template <class A1, class A2, class A3, class A4, class A5>
inline bdlcfxxx::Vfunc5<A1, A2, A3, A4, A5>::operator const void *() const
{
    return d_rep_p;
}
