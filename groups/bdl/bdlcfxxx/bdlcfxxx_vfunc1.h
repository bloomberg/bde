...
//
//@CLASSES:
//   bdlcfxxx::Vfunc1: signature-specific function object (functor)
//
...
// construction.
//
// The 'bdlcfxxx::Vfunc1' functor (envelope) holds a polymorphic, reference-counted,
...
// signature and (2) the supplied user data.  See the 'bdlcfxxxu_vfunc1' component
// for more information on populating 'bdlcfxxx::Vfunc1' function objects with
...
//
//     public:
//       MyGuiButton(const bdlcfxxx::Vfunc1<MyGuiInformation *>&
//                                              buttonPressCallback);
...
// 'bdlcfxxx::Vfunc1' class specifies the number of required arguments).  However,
...
//   }
//..
// The 'bdlcfxxx::Vfunc1<MyGuiInformation *>' class used in 'MyGuiButton'
// class has a private member of an abstract class 'bdlcfxxxr_vfunc1', whose
// 'execute' method is called when the functor is being called.  The 'execute'
// method of the 'bdlcfxxxr_vfunc1' class, the functor invocation operator of the
// 'bdlcfxxx::Vfunc1' class, and the 'pressButton' method of 'MyGuiButton' class
...
// signature the user implements a concrete class derived from 'bdlcfxxxr_vfunc1'
// as follows:
//..
...
class Vfunc1 {
  ...
  public:
    // TRAITS
    BSLALG_DECLARE_NESTED_TRAITS(Vfunc1,
    ...
    Vfunc1(bdlcfxxxr::Vfunc1<A1> *representation);
        ...
        // components (see 'bdlcfxxxu_vfunc1') to create an appropriate
        // representation and load it into an existing functor.

    Vfunc1(const Vfunc1<A1>& functionObject);
    ...
    ~Vfunc1();
        ...
        // the static 'deleteObject' method of 'bdlcfxxxr::Vfunc1' base class).

    // MANIPULATORS
    Vfunc1<A1>& operator=(const Vfunc1<A1>& functionObject);
        ...
        // 'deleteObject' method of 'bdlcfxxxr::Vfunc1' base class.
...
template <class A1>
inline Vfunc1<A1>::Vfunc1(bdlcfxxxr::Vfunc1<A1> *rep)
: d_rep_p(rep)
{
    if (d_rep_p) {
        d_rep_p->increment();
...
template <class A1>
inline Vfunc1<A1>::Vfunc1(const Vfunc1& functor)
...
Vfunc1<A1>&
Vfunc1<A1>::operator=(const Vfunc1<A1>& rhs)
{
...
template <class A1>
inline bdlcfxxx::Vfunc1<A1>::operator const void *() const
{
    return d_rep_p;
}
