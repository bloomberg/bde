...
//                              Overview
//                              --------
// The 'bdlcfxxx::Vfunc3' class holds a pointer to an instance of a 'bdlcfxxxr::Vfunc3'
// (an abstact class), and manipulates it appropriately.  Our main objective
// is to make sure that the 'bdlcfxxxr::Vfunc3' object is initialized correctly and
// that its integer data (the reference count) is modified by the methods of
// 'bdlcfxxx::Vfunc3' as expected.
//
...
//
//-----------------------------------------------------------------------------
// [ 1] bdlcfxxx::Vfunc3<A1-3>();
// [ 1] bdlcfxxx::Vfunc3<A1-3>(bdlcfxxxr::Vfunc3<A1-3> *);
// [ 1] bdlcfxxx::Vfunc3<A1-3>(const bdlcfxxx::Vfunc3<A1-3>&);
// [ 1] ~bdlcfxxx::Vfunc3<A1-3>();
// [ 2] bdlcfxxx::Vfunc3<A1-3>& operator=(const bdlcfxxx::Vfunc3<A1-3>&);
...
class FunctorRep : public bdlcfxxxr::Vfunc3<A1, A2, A3> {
...
inline FunctorRep<F, A1, A2, A3, D1, D2, D3, D4, D5, D6>::FunctorRep(
                                             ...
                                             const D6&        embeddedArg6,
                                             bslma::Allocator*basicAllocator)
: bdlcfxxxr::Vfunc3<A1, A2, A3>(basicAllocator)
, d_f(procedure)
, d_d1(embeddedArg1)
, d_d2(embeddedArg2)
, d_d3(embeddedArg3)
...
//-----------------------------------------------------------------------------
    ...
    typedef bdlcfxxxr::Vfunc3<int *, int *, int *> ObjRep;
    typedef bdlcfxxx::Vfunc3<int *, int *, int *> Obj;
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 2: {
        ...
        //    2. A new object shares a 'bdlcfxxxr::Vfunc3' object with its "right
        ...
        //   'bdlcfxxxr::Vfunc3<A1, A2, A3> *' object 'R'.  Call the constructor to
        //   create 'bdlcfxxx::Vfunc3' objects 'Obj2' and 'Obj3' using 'R'.
        ...
        //    3c. N/A.
        //
        //   Create the 'bdlcfxxxr::Vfunc3<A1, A2, A3> *' object.  Call the
        //   constructor to create the 'bdlcfxxx::Vfunc3' object 'Obj1'.
        ...
        //        to verify that 'Obj1' and 'Obj2' use the same 'bdlcfxxxr::Vfunc3'
        //        object.
        //    3d. Check the reference counter using the 'getCount' function.
        //        Create another object and check it again.
        //
        //   Create two 'bdlcfxxxr::Vfunc3<A1, A2, A3> *' objects 'R1' and 'R2'.
        //   Create two 'bdlcfxxx::Vfunc3' objects 'Obj1' and 'Obj2' using 'R1' and
        //   'R2', respectively.
        ...
        //        to verify that 'Obj2' and 'Obj3' use the same 'bdlcfxxxr::Vfunc3'
        //        object.
        //    3e. Check the reference counter using the 'getCount' function
        //        before and after the assignment for both 'Obj1' and 'Obj2'
        //        representations.
        //
        //   Create a 'bdlcfxxxr::Vfunc3<A1, A2, A3> *' object.  Call the
        //   constructor to create a 'bdlcfxxx::Vfunc3' object 'Obj1'.
        ...
        //
        // Testing:
        //   bdlcfxxx::Vfunc3<A1-3>& operator=(const bdlcfxxx::Vfunc3<A1-3>&);
        // --------------------------------------------------------------------
      ...
      case 1: {
        ...
        //    b. constructor taking a pointer to a 'bdlcfxxxr::Vfunc3' object
        //    c. copy constructor
        //
        ...
        //       'void operator()'.
        //    3. The reference count of the 'bdlcfxxxr::Vfunc3' object used is
        //       incremented.
        //
        //   Specific concerns for the copy constructor:
        //    4. A new object created by the copy constructor shares a
        //       'bdlcfxxxr::Vfunc3' object with its copy.
        //
        ...
        //    6. The 'bdlcfxxxr::Vfunc3<A1, A2, A3>' object is destroyed when the
        ...
        //       'operator const void *() const'.
        //
        //   1b. Create the 'bdlcfxxxr::Vfunc3<A1, A2, A3> *' object.  Call the
        ...
        //       'bdlcfxxxr::Vfunc3<A1, A2, A3> *' object.  Verify that the
        ...
        //       to verify that both 'bdlcfxxx::Vfunc3' objects use the same
        //       'bdlcfxxxr::Vfunc3' object.
        ...
        //
        // Testing:
        //   bdlcfxxx::Vfunc3(const bdlcfxxx::Vfunc3 &rhs);
        // --------------------------------------------------------------------
                          ...
                          << "==============================" << endl;
        {
            ...
            if (verbose)
                cout << "\nTesting Constructor Taking '*bdlcfxxxr::Vfunc3'."
                     << endl;
