...
#define INCLUDED_BDLCFXXX_VFUNC3
...
//
//@CLASSES:
//   bdlcfxxx::Vfunc3: signature-specific function object (functor)
//
...
// construction.
//
// The 'bdlcfxxx::Vfunc3' functor (envelope) holds a polymorphic, reference-counted,
...
// signature and (2) the supplied user data.  See the 'bdlcfxxxu_vfunc3' component
// for more information on populating 'bdlcfxxx::Vfunc3' function objects with
...
class Vfunc3 {
    ...
    bdlcfxxxr::Vfunc3<A1, A2, A3> *d_rep_p;  // polymorphic functor representation
  ...
  public:
    // TRAITS
    BSLALG_DECLARE_NESTED_TRAITS(Vfunc3,
    ...
    Vfunc3(bdlcfxxxr::Vfunc3<A1, A2, A3> *representation);
        ...
        // components (see 'bdlcfxxxu_vfunc3') to create an appropriate
        // representation and load it into an existing functor.

    Vfunc3(const Vfunc3<A1, A2, A3>& functionObject);
    ...
    ~Vfunc3();
        ...
        // the static 'deleteObject' method of 'bdlcfxxxr::Vfunc3' base class).

    // MANIPULATORS
    Vfunc3<A1, A2, A3>& operator=(
        const Vfunc3<A1, A2, A3>& functionObject);
        ...
        // 'deleteObject' method of 'bdlcfxxxr::Vfunc3' base class.
...
template <class A1, class A2, class A3>
inline Vfunc3<A1, A2, A3>::Vfunc3(bdlcfxxxr::Vfunc3<A1, A2, A3> *rep)
: d_rep_p(rep)
{
    if (d_rep_p) {
        d_rep_p->increment();
...
template <class A1, class A2, class A3>
inline Vfunc3<A1, A2, A3>::Vfunc3(const Vfunc3& functor)
...
Vfunc3<A1, A2, A3>&
Vfunc3<A1, A2, A3>::operator=(const Vfunc3<A1, A2, A3>& rhs)
{
...
template <class A1, class A2, class A3>
inline bdlcfxxx::Vfunc3<A1, A2, A3>::operator const void *() const
{
    return d_rep_p;
}
