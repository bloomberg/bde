// bdlcfxxx_vfunc4.t.cpp                                              -*-C++-*-

#include <bdlcfxxx_vfunc4.h>
...
//                              Overview
//                              --------
// The 'bdlcfxxx::Vfunc4' class holds a pointer to an instance of a 'bdlcfxxxr::Vfunc4'
// (an abstact class), and manipulates it appropriately.  Our main objective
// is to make sure that the 'bdlcfxxxr::Vfunc4' object is initialized correctly and
// that its integer data (the reference count) is modified by the methods of
// 'bdlcfxxx::Vfunc4' as expected.
//
...
//
//-----------------------------------------------------------------------------
// [ 1] bdlcfxxx::Vfunc4<A1-4>();
// [ 1] bdlcfxxx::Vfunc4<A1-4>(bdlcfxxxr::Vfunc4<A1-4> *);
// [ 1] bdlcfxxx::Vfunc4<A1-4>(const bdlcfxxx::Vfunc4<A1-4>&);
// [ 1] ~bdlcfxxx::Vfunc4<A1-4>();
// [ 2] bdlcfxxx::Vfunc4<A1-4>& operator=(const bdlcfxxx::Vfunc4<A1-4>&);
// [ 1] void operator()(c_A1-4&) const;
...
class FunctorRep : public bdlcfxxxr::Vfunc4<A1, A2, A3, A4> {
  ...
  private:
    // not implemented
    FunctorRep(const FunctorRep<F, A1, A2, A3, A4, D1, D2, D3, D4, D5>&);
    FunctorRep<F, A1, A2, A3, A4, D1, D2, D3, D4, D5>&
        operator=(const FunctorRep<F, A1, A2, A3, A4, D1, D2, D3, D4, D5>&);
  private:
    inline ~FunctorRep();
  ...
  public:
    ...
    inline FunctorRep(F                procedure,
        ...
        // five additional trailing arguments, and the corresponding
    ...
    inline void execute(const A1& argument1, const A2& argument2,
        ...
        // function, or functor) with the specified 'argument1-4' along with
...
inline FunctorRep<F, A1, A2, A3, A4, D1, D2, D3, D4, D5>::FunctorRep(
                                             ...
                                             const D5&        embeddedArg5,
                                             bslma::Allocator*basicAllocator)
: bdlcfxxxr::Vfunc4<A1, A2, A3, A4>(basicAllocator)
, d_f(procedure)
, d_d1(embeddedArg1)
, d_d2(embeddedArg2)
, d_d3(embeddedArg3)
...
template <class F, class A1, class A2, class A3, class A4,
          class D1, class D2, class D3, class D4, class D5>
inline
FunctorRep<F, A1, A2, A3, A4, D1, D2, D3, D4, D5>::~FunctorRep()
{
}

template <class F, class A1, class A2, class A3, class A4,
          class D1, class D2, class D3, class D4, class D5> inline
void FunctorRep<F, A1, A2, A3, A4, D1, D2, D3, D4, D5>::execute(
                                                   const A1& argument1,
                                                   const A2& argument2,
                                                   const A3& argument3,
...
template <class F, class A1, class A2, class A3, class A4,
          class D1, class D2, class D3, class D4, class D5>
int
FunctorRep<F, A1, A2, A3, A4, D1, D2, D3, D4, D5>::invocationCounter() const
{
...
//-----------------------------------------------------------------------------
    ...
    typedef bdlcfxxxr::Vfunc4<int *, int *, int *, int *> ObjRep;
    typedef bdlcfxxx::Vfunc4<int *, int *, int *, int *> Obj;
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 2: {
        ...
        //    2. A new object shares a 'bdlcfxxxr::Vfunc4' object with its "right
        ...
        //   'bdlcfxxxr::Vfunc4<A1, A2, A3, A4> *' object 'R'.  Call the
        //   constructor to create 'bdlcfxxx::Vfunc4' objects 'Obj2' and 'Obj3'
        //   using 'R'.
        ...
        //    3c. N/A.
        //
        //   Create the 'bdlcfxxxr::Vfunc4<A1, A2, A3, A4> *' object.  Call the
        //   constructor to create the 'bdlcfxxx::Vfunc4' object 'Obj1'.
        ...
        //        to verify that 'Obj1' and 'Obj2' use the same 'bdlcfxxxr::Vfunc4'
        //        object.
        //    3d. Check the reference counter using the 'getCount' function.
        //        Create another object and check it again.
        //
        //   Create two 'bdlcfxxxr::Vfunc4<A1, A2, A3, A4> *' objects 'R1' and 'R2'.
        //   Create two 'bdlcfxxx::Vfunc4' objects 'Obj1' and 'Obj2' using 'R1'
        //   and 'R2', respectively.
        ...
        //        to verify that 'Obj2' and 'Obj3' use the same 'bdlcfxxxr::Vfunc4'
        //        object.
        //    3e. Check the reference counter using the 'getCount' function
        //        before and after the assignment for both 'Obj1' and 'Obj2'
        //        representations.
        //
        //   Create a 'bdlcfxxxr::Vfunc4<A1, A2, A3, A4> *' object.  Call the
        //   constructor to create a 'bdlcfxxx::Vfunc4' object 'Obj1'.
        ...
        //
        // Testing:
        //   bdlcfxxx::Vfunc4<A1-4>& operator=(const bdlcfxxx::Vfunc4<A1-4>&);
        // --------------------------------------------------------------------
                 ...
                 << endl;
        {
            ...
            ObjRep *rep1 = new(testAllocator)
                ParmMatchingFunctorImp(checkParameterMatching, &a5, &a6,
            ...
            cout << "    Testing assignment to an initialized object." << endl;
        {
            ...
            ObjRep *rep2 = new(testAllocator)
                ParmMatchingFunctorImp(checkParameterMatching, &b5, &b6,
      ...
      case 1: {
        ...
        //    b. constructor taking a pointer to a 'bdlcfxxxr::Vfunc4' object
        //    c. copy constructor
        //
        ...
        //       'void operator()'.
        //    3. The reference count of the 'bdlcfxxxr::Vfunc4' object used is
        //       incremented.
        //
        //   Specific concerns for the copy constructor:
        //    4. A new object created by the copy constructor shares a
        //       'bdlcfxxxr::Vfunc4' object with its copy.
        //
        ...
        //    6. The 'bdlcfxxxr::Vfunc4<A1, A2, A3, A4>' object
        ...
        //       'operator const void *() const'.
        //
        //   1b. Create the 'bdlcfxxxr::Vfunc4<A1, A2, A3, A4> *' object.  Call the
        ...
        //       'bdlcfxxxr::Vfunc4<A1, A2, A3, A4> *' object.  Verify that the
        ...
        //       to verify that both 'bdlcfxxx::Vfunc4' objects use the same
        //       'bdlcfxxxr::Vfunc4' object.
        ...
        //
        // Testing:
        //   bdlcfxxx::Vfunc4(const bdlcfxxx::Vfunc4 &rhs);
        // --------------------------------------------------------------------
                          ...
                          << "==============================" << endl;
        {
            ...
            if (verbose)
                cout << "\nTesting Constructor Taking '*bdlcfxxxr::Vfunc4'."
                     << endl;
