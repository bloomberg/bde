// bdlcfxxx_vfunc1.t.cpp              -*-C++-*-

#include <bdlcfxxx_vfunc1.h>
...
//                              Overview
//                              --------
// The 'bdlcfxxx::Vfunc1' class holds a pointer to an instance of a 'bdlcfxxxr::Vfunc1'
// (an abstact class), and manipulates it appropriately.  Our main objective
// is to make sure that the 'bdlcfxxxr::Vfunc1' object is initialized correctly and
// that its integer data (the reference count) is modified by the methods of
// 'bdlcfxxx::Vfunc1' as expected.
//
...
//
//-----------------------------------------------------------------------------
// [ 1] bdlcfxxx::Vfunc1<A1>();
// [ 1] bdlcfxxx::Vfunc1<A1>(bdlcfxxxr::Vfunc1<A1> *);
// [ 1] bdlcfxxx::Vfunc1<A1>(const bdlcfxxx::Vfunc1<A1>&);
// [ 1] ~bdlcfxxx::Vfunc1<A1>();
// [ 2] bdlcfxxx::Vfunc1<A1>& operator=(const bdlcfxxx::Vfunc1<A1>&);
...
class FunctorRep : public bdlcfxxxr::Vfunc1<A1> {
...
//-----------------------------------------------------------------------------
    ...
    typedef bdlcfxxxr::Vfunc1<int *> ObjRep;
    typedef bdlcfxxx::Vfunc1<int *> Obj;
...
class MyGuiButton  {
    bdlcfxxx::Vfunc1<MyGuiInformation *> d_callback;
        // Functor to execute when button is pressed.

  public:
    MyGuiButton(const bdlcfxxx::Vfunc1<MyGuiInformation *>& buttonPressCallback);
...
MyGuiButton::MyGuiButton(const bdlcfxxx::Vfunc1<MyGuiInformation *>&
                                                      buttonPressCallback)
...
class FuncRep : public bdlcfxxxr::Vfunc1<A1> {
    // This class defines the representation for a function object (functor),
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      case 3: {
                          ...
                          << "=====================" << endl;
        {
          ...
          bdlcfxxxr::Vfunc1<MyGuiInformation *>  *rep = new(*myAllocator)
          ...
          bdlcfxxx::Vfunc1<MyGuiInformation *> callbackFunctor(rep);
      ...
      case 2: {
        ...
        //    2. A new object shares a 'bdlcfxxxr::Vfunc1' object with its "right
        ...
        //   'bdlcfxxxr::Vfunc1<A1> *' object 'R'.  Call the constructor to
        //   create 'bdlcfxxx::Vfunc1' objects 'Obj2' and 'Obj3' using 'R'.
        ...
        //    3c. N/A.
        //
        //   Create the 'bdlcfxxxr::Vfunc1<A1> *' object.  Call the constructor
        //   to create the 'bdlcfxxx::Vfunc1' object 'Obj1'.
        ...
        //        to verify that 'Obj1' and 'Obj2' use the same 'bdlcfxxxr::Vfunc1'
        //        object.
        //    3d. Check the reference counter using the 'getCount' function.
        //        Create another object and check it again.
        //
        //   Create two 'bdlcfxxxr::Vfunc1<A1> *' objects 'R1' and 'R2'.  Create
        //   two 'bdlcfxxx::Vfunc1' objects 'Obj1' and 'Obj2' using 'R1' and 'R2',
        //   respectively.
        ...
        //        to verify that 'Obj2' and 'Obj3' use the same 'bdlcfxxxr::Vfunc1'
        //        object.
        //    3e. Check the reference counter using the 'getCount' function
        //        before and after the assignment for both 'Obj1' and 'Obj2'
        //        representations.
        //
        //   Create a 'bdlcfxxxr::Vfunc1<A1> *' object.  Call the constructor to
        //   create a 'bdlcfxxx::Vfunc1' object 'Obj1'.
        ...
        //
        // Testing:
        //   bdlcfxxx::Vfunc1<A1>& operator=(const bdlcfxxx::Vfunc1<A1>&);
        // --------------------------------------------------------------------
      ...
      case 1: {
        ...
        //    b. constructor taking a pointer to a 'bdlcfxxxr::Vfunc1' object
        //    c. copy constructor
        //
        ...
        //    3. The reference count of the 'bdlcfxxxr::Vfunc1' object used is
        //       incremented.
        //
        //   Specific concerns for the copy constructor:
        //    4. A new object created by the copy constructor shares a
        //       'bdlcfxxxr::Vfunc1' object with its copy.
        //
        ...
        //    6. The 'bdlcfxxxr::Vfunc1<A1>' object is destroyed when the
        ...
        //       'operator const void *() const'.
        //
        //   1b. Create the 'bdlcfxxxr::Vfunc1<A1> *' object.  Call the
        ...
        //       'bdlcfxxxr::Vfunc1<A1> *' object.  Verify that the reference
        ...
        //       to verify that both 'bdlcfxxx::Vfunc1' objects use the same
        //       'bdlcfxxxr::Vfunc1' object.
        ...
        //
        // Testing:
        //   bdlcfxxx::Vfunc1(const bdlcfxxx::Vfunc1 &rhs);
        // --------------------------------------------------------------------
                          ...
                          << "==============================" << endl;
        {
            ...
            if (verbose)
                cout << "\nTesting Constructor Taking '*bdlcfxxxr::Vfunc1'."
                     << endl;
