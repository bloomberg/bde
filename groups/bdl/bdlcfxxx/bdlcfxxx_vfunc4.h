...
#define INCLUDED_BDLCFXXX_VFUNC4
...
//
//@CLASSES:
//   bdlcfxxx::Vfunc4: signature-specific function object (functor)
//
...
// construction.
//
// The 'bdlcfxxx::Vfunc4' functor (envelope) holds a polymorphic, reference-counted,
...
// signature and (2) the supplied user data.  See the 'bdlcfxxxu_vfunc4' component
// for more information on populating 'bdlcfxxx::Vfunc4' function objects with
...
class Vfunc4 {
    ...
    // NOT IMPLEMENTED
    bool operator==(const Vfunc4&) const;
    bool operator!=(const Vfunc4&) const;

    template<class B1, class B2, class B3, class B4>
    bool operator==(const Vfunc4<B1, B2, B3, B4>&) const;
    template<class B1, class B2, class B3, class B4>
    bool operator!=(const Vfunc4<B1, B2, B3, B4>&) const;

  public:
    // TRAITS
    BSLALG_DECLARE_NESTED_TRAITS(Vfunc4,
    ...
    Vfunc4(bdlcfxxxr::Vfunc4<A1, A2, A3, A4> *representation);
        ...
        // components (see 'bdlcfxxxu_vfunc4') to create an appropriate
        // representation and load it into an existing functor.

    Vfunc4(const Vfunc4<A1, A2, A3, A4>& functionObject);
    ...
    ~Vfunc4();
        ...
        // the static 'deleteObject' method of 'bdlcfxxxr::Vfunc4' base class).

    // MANIPULATORS
    Vfunc4<A1, A2, A3, A4>& operator=(
        const Vfunc4<A1, A2, A3, A4>& functionObject);
        ...
        // 'deleteObject' method of 'bdlcfxxxr::Vfunc4' base class.
...
template <class A1, class A2, class A3, class A4>
inline
Vfunc4<A1, A2, A3, A4>::Vfunc4(
    bdlcfxxxr::Vfunc4<A1, A2, A3, A4> *rep)
: d_rep_p(rep)
{
    if (d_rep_p) {
        d_rep_p->increment();
...
template <class A1, class A2, class A3, class A4>
inline Vfunc4<A1, A2, A3, A4>::Vfunc4(const Vfunc4& functor)
...
inline Vfunc4<A1, A2, A3, A4>::~Vfunc4()
{
    if (d_rep_p && 0 == d_rep_p->decrement()) {
        bdlcfxxxr::Vfunc4<A1, A2, A3, A4>::deleteObject(d_rep_p);
    }
}

template <class A1, class A2, class A3, class A4> inline
Vfunc4<A1, A2, A3, A4>&
Vfunc4<A1, A2, A3, A4>::operator=(const Vfunc4<A1, A2, A3, A4>& rhs)
{
...
template <class A1, class A2, class A3, class A4>
inline void Vfunc4<A1, A2, A3, A4>::operator()(
                                                const A1& argument1,
                                                const A2& argument2,
                                                const A3& argument3,
...
template <class A1, class A2, class A3, class A4>
inline bdlcfxxx::Vfunc4<A1, A2, A3, A4>::operator const void *() const
{
    return d_rep_p;
}
