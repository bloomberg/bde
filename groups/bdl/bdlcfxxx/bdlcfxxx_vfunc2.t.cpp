...
//                              Overview
//                              --------
// The 'bdlcfxxx::Vfunc2' class holds a pointer to an instance of a 'bdlcfxxxr::Vfunc2'
// (an abstact class), and manipulates it appropriately.  Our main objective
// is to make sure that the 'bdlcfxxxr::Vfunc2' object is initialized correctly and
// that its integer data (the reference count) is modified by the methods of
// 'bdlcfxxx::Vfunc2' as expected.
//
...
//
//-----------------------------------------------------------------------------
// [ 1] bdlcfxxx::Vfunc2<A1-2>();
// [ 1] bdlcfxxx::Vfunc2<A1-2>(bdlcfxxxr::Vfunc2<A1-2> *);
// [ 1] bdlcfxxx::Vfunc2<A1-2>(const bdlcfxxx::Vfunc2<A1-2>&);
// [ 1] ~bdlcfxxx::Vfunc2<A1-2>();
// [ 2] bdlcfxxx::Vfunc2<A1-2>& operator=(const bdlcfxxx::Vfunc2<A1-2>&);
...
class FunctorRep : public bdlcfxxxr::Vfunc2<A1, A2> {
...
//-----------------------------------------------------------------------------
    ...
    typedef bdlcfxxxr::Vfunc2<int *, int *> ObjRep;
    typedef bdlcfxxx::Vfunc2<int *, int *> Obj;
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 2: {
        ...
        //       const A2&) const'
        //    2. A new object shares a 'bdlcfxxxr::Vfunc2' object with its "right
        ...
        //   'bdlcfxxxr::Vfunc2<A1, A2> *' object 'R'.  Call the constructor to
        //   create 'bdlcfxxx::Vfunc2' objects 'Obj2' and 'Obj3' using 'R'.
        ...
        //    3c. N/A.
        //
        //   Create the 'bdlcfxxxr::Vfunc2<A1, A2> *' object.  Call the constructor
        //   to create the 'bdlcfxxx::Vfunc2' object 'Obj1'.
        ...
        //        to verify that 'Obj1' and 'Obj2' use the same 'bdlcfxxxr::Vfunc2'
        //        object.
        //    3d. Check the reference counter using the 'getCount' function.
        //        Create another object and check it again.
        //
        //   Create two 'bdlcfxxxr::Vfunc2<A1, A2> *' objects 'R1' and 'R2'.  Create
        //   two 'bdlcfxxx::Vfunc2' objects 'Obj1' and 'Obj2' using 'R1' and 'R2',
        //   respectively.
        ...
        //        to verify that 'Obj2' and 'Obj3' use the same 'bdlcfxxxr::Vfunc2'
        //        object.
        //    3e. Check the reference counter using the 'getCount' function
        //        before and after the assignment for both 'Obj1' and 'Obj2'
        //        representations.
        //
        //   Create a 'bdlcfxxxr::Vfunc2<A1, A2> *' object.  Call the constructor to
        //   create a 'bdlcfxxx::Vfunc2' object 'Obj1'.
        ...
        //
        // Testing:
        //   bdlcfxxx::Vfunc2<A1-2>& operator=(const bdlcfxxx::Vfunc2<A1-2>&);
        // --------------------------------------------------------------------
      ...
      case 1: {
        ...
        //    b. constructor taking a pointer to a 'bdlcfxxxr::Vfunc2' object
        //    c. copy constructor
        //
        ...
        //    3. The reference count of the 'bdlcfxxxr::Vfunc2' object used is
        //       incremented.
        //
        //   Specific concerns for the copy constructor:
        //    4. A new object created by the copy constructor shares a
        //       'bdlcfxxxr::Vfunc2' object with its copy.
        //
        ...
        //    6. The 'bdlcfxxxr::Vfunc2<A1, A2>' object is destroyed when the
        ...
        //       'operator const void *() const'.
        //
        //   1b. Create the 'bdlcfxxxr::Vfunc2<A1, A2> *' object.  Call the
        ...
        //       'bdlcfxxxr::Vfunc2<A1, A2> *' object.  Verify that the reference
        ...
        //       to verify that both 'bdlcfxxx::Vfunc2' objects use the same
        //       'bdlcfxxxr::Vfunc2' object.
        ...
        //
        // Testing:
        //   bdlcfxxx::Vfunc2(const bdlcfxxx::Vfunc2 &rhs);
        // --------------------------------------------------------------------
                          ...
                          << "==============================" << endl;
        {
            ...
            if (verbose)
                cout << "\nTesting Constructor Taking '*bdlcfxxxr::Vfunc2'."
                     << endl;
