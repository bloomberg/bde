...
//                              Overview
//                              --------
// The 'bdlcfxxx::Vfunc0' class holds a pointer to an instance of a 'bdlcfxxxr::Vfunc0'
// (an abstact class), and manipulates it appropriately.  Our main objective
// is to make sure that the 'bdlcfxxxr::Vfunc0' object is initialized correctly and
// that its integer data (the reference count) is modified by the methods of
// 'bdlcfxxx::Vfunc0' as expected.
//
...
//-----------------------------------------------------------------------------
// [ 1] bdlcfxxx::Vfunc0();
// [ 1] bdlcfxxx::Vfunc0(bdlcfxxxr::Vfunc0 *);
// [ 1] bdlcfxxx::Vfunc0(const bdlcfxxx::Vfunc0&);
// [ 1] ~bdlcfxxx::Vfunc0();
// [ 2] bdlcfxxx::Vfunc0& operator=(const bdlcfxxx::Vfunc0&);
...
class FunctorRep : public bdlcfxxxr::Vfunc0 {
...
//-----------------------------------------------------------------------------
    ...
    typedef bdlcfxxxr::Vfunc0 ObjRep;
    typedef bdlcfxxx::Vfunc0 Obj;
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 2: {
        ...
        //    2. A new object shares a 'bdlcfxxxr::Vfunc0' object with its "right
        ...
        //   'bdlcfxxxr::Vfunc0 *' object 'R'.  Call the constructor to create
        //   'bdlcfxxx::Vfunc0' objects 'Obj2' and 'Obj3' using 'R'.
        ...
        //    3c. N/A.
        //
        //   Create the 'bdlcfxxxr::Vfunc0 *' object.  Call the constructor to
        //   create the 'bdlcfxxx::Vfunc0' object 'Obj1'.
        ...
        //        to verify that 'Obj1' and 'Obj2' use the same 'bdlcfxxxr::Vfunc0'
        //        object.
        //    3d. Check the reference counter using the 'getCount' function.
        //        Create another object and check it again.
        //
        //   Create two 'bdlcfxxxr::Vfunc0 *' objects 'R1' and 'R2'.  Create two
        //   'bdlcfxxx::Vfunc0' objects 'Obj1' and 'Obj2' using 'R1' and 'R2',
        //   respectively.
        ...
        //        to verify that 'Obj2' and 'Obj3' use the same 'bdlcfxxxr::Vfunc0'
        //        object.
        //    3e. Check the reference counter using the 'getCount' function
        //        before and after the assignment for both 'Obj1' and 'Obj2'
        //        representations.
        //
        //   Create a 'bdlcfxxxr::Vfunc0 *' object.  Call the constructor to create
        //   a 'bdlcfxxx::Vfunc0' object 'Obj1'.
        ...
        //
        // Testing:
        //   bdlcfxxx::Vfunc0& operator=(const bdlcfxxx::Vfunc0&);
        // --------------------------------------------------------------------
      ...
      case 1: {
        ...
        //    b. constructor taking a pointer to a 'bdlcfxxxr::Vfunc0' object
        //    c. copy constructor
        //
        ...
        //       'void operator()() const'.
        //    3. The reference count of the 'bdlcfxxxr::Vfunc0' object used is
        //       incremented.
        //
        //   Specific concerns for the copy constructor:
        //    4. A new object created by the copy constructor shares a
        //       'bdlcfxxxr::Vfunc0' object with its copy.
        //
        ...
        //    6. The 'bdlcfxxxr::Vfunc0' object is destroyed when the
        ...
        //       'operator const void *() const'.
        //
        //   1b. Create the 'bdlcfxxxr::Vfunc0 *' object.  Call the
        ...
        //       'bdlcfxxxr::Vfunc0 *' object.  Verify that the reference counter
        //       is incremented.
        //
        ...
        //       to verify that both 'bdlcfxxx::Vfunc0' objects use the same
        //       'bdlcfxxxr::Vfunc0' object.
        ...
        //
        // Testing:
        //   bdlcfxxx::Vfunc0(const bdlcfxxx::Vfunc0 &rhs);
        // --------------------------------------------------------------------
                          ...
                          << "==============================" << endl;
        {
            ...
            if (verbose)
                cout << "\nTesting Constructor Taking '*bdlcfxxxr::Vfunc0'."
                     << endl;
