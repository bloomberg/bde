...
//                              Overview
//                              --------
// The 'bdlcfxxx::Vfunc5' class holds a pointer to an instance of a 'bdlcfxxxr::Vfunc5'
// (an abstact class), and manipulates it appropriately.  Our main objective
// is to make sure that the 'bdlcfxxxr::Vfunc5' object is initialized correctly and
// that its integer data (the reference count) is modified by the methods of
// 'bdlcfxxx::Vfunc5' as expected.
//
...
//
//-----------------------------------------------------------------------------
// [ 1] bdlcfxxx::Vfunc5<A1-5>();
// [ 1] bdlcfxxx::Vfunc5<A1-5>(bdlcfxxxr::Vfunc5<A1-5> *);
// [ 1] bdlcfxxx::Vfunc5<A1-5>(const bdlcfxxx::Vfunc5<A1-5>&);
// [ 1] ~bdlcfxxx::Vfunc5<A1-5>();
// [ 2] bdlcfxxx::Vfunc5<A1-5>& operator=(const bdlcfxxx::Vfunc5<A1-5>&);
...
class FunctorRep : public bdlcfxxxr::Vfunc5<A1, A2, A3, A4, A5> {
...
//-----------------------------------------------------------------------------
    ...
    typedef bdlcfxxxr::Vfunc5<int *, int *, int *, int *, int *> ObjRep;
    typedef bdlcfxxx::Vfunc5<int *, int *, int *, int *, int *> Obj;
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 2: {
        ...
        //    2. A new object shares a 'bdlcfxxxr::Vfunc5' object with its "right
        ...
        //   'bdlcfxxxr::Vfunc5<A1, A2, A3, A4, A5> *' object 'R'.  Call the
        //   constructor to create 'bdlcfxxx::Vfunc5' objects 'Obj2' and 'Obj3'
        //   using 'R'.
        ...
        //    3c. N/A.
        //
        //   Create the 'bdlcfxxxr::Vfunc5<A1, A2, A3, A4, A5> *' object.  Call the
        //   constructor to create the 'bdlcfxxx::Vfunc5' object 'Obj1'.
        ...
        //        to verify that 'Obj1' and 'Obj2' use the same 'bdlcfxxxr::Vfunc5'
        //        object.
        //    3d. Check the reference counter using the 'getCount' function.
        //        Create another object and check it again.
        //
        //   Create two 'bdlcfxxxr::Vfunc5<A1, A2, A3, A4, A5> *' objects 'R1' and
        //   'R2'.  Create two 'bdlcfxxx::Vfunc5' objects 'Obj1' and 'Obj2' using
        ...
        //        to verify that 'Obj2' and 'Obj3' use the same 'bdlcfxxxr::Vfunc5'
        //        object.
        //    3e. Check the reference counter using the 'getCount' function
        //        before and after the assignment for both 'Obj1' and 'Obj2'
        //        representations.
        //
        //   Create a 'bdlcfxxxr::Vfunc5<A1, A2, A3, A4, A5> *' object.  Call the
        //   constructor to create a 'bdlcfxxx::Vfunc5' object 'Obj1'.
        ...
        //
        // Testing:
        //   bdlcfxxx::Vfunc5<A1-5>& operator=(const bdlcfxxx::Vfunc5<A1-5>&);
        // --------------------------------------------------------------------
      ...
      case 1: {
        ...
        //    b. constructor taking a pointer to a 'bdlcfxxxr::Vfunc5' object
        //    c. copy constructor
        //
        ...
        //       'void operator()'.
        //    3. The reference count of the 'bdlcfxxxr::Vfunc5' object used is
        //       incremented.
        //
        //   Specific concerns for the copy constructor:
        //    4. A new object created by the copy constructor shares a
        //       'bdlcfxxxr::Vfunc5' object with its copy.
        //
        ...
        //    6. The 'bdlcfxxxr::Vfunc5<A1, A2, A3, A4, A5>' object
        ...
        //       'operator const void *() const'.
        //
        //   1b. Create the 'bdlcfxxxr::Vfunc5<A1, A2, A3, A4, A5> *' object.
        ...
        //       'bdlcfxxxr::Vfunc5<A1, A2, A3, A4, A5> *' object.  Verify that the
        ...
        //       to verify that both 'bdlcfxxx::Vfunc5' objects use the same
        //       'bdlcfxxxr::Vfunc5' object.
        ...
        //
        // Testing:
        //   bdlcfxxx::Vfunc5(const bdlcfxxx::Vfunc5 &rhs);
        // --------------------------------------------------------------------
                          ...
                          << "==============================" << endl;
        {
            ...
            if (verbose)
                cout << "\nTesting Constructor Taking '*bdlcfxxxr::Vfunc5'."
                     << endl;
