...
// [ 1] const char *toAscii(bdlde::IgnoreMode::Enum val);
//
// FREE OPERATORS
// [ 3] operator<<(ostream& s, bdlde::IgnoreMode::Enum val);
// ----------------------------------------------------------------------------
// [ 5] USAGE EXAMPLE
...
typedef bdlde::Base64IgnoreMode::Enum Enum;
typedef bdlde::Base64IgnoreMode       Obj;
...
#define NL "\n"
            ...
            { L_,    0,    2,  Obj::e_IGNORE_NONE,       "IGNORE_NONE" NL    },
            { L_,    1,    1,  Obj::e_IGNORE_NONE,       " IGNORE_NONE" NL   },
            { L_,    1,    2,  Obj::e_IGNORE_NONE,       "  IGNORE_NONE" NL  },
            { L_,   -1,    2,  Obj::e_IGNORE_NONE,       "IGNORE_NONE" NL    },
            { L_,   -2,    1,  Obj::e_IGNORE_NONE,       "IGNORE_NONE" NL    },
            { L_,    2,    1,  Obj::e_IGNORE_NONE,       "  IGNORE_NONE" NL  },
            { L_,    1,    3,  Obj::e_IGNORE_NONE,       "   IGNORE_NONE" NL },
#undef NL
        };
