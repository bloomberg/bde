...
//
//@SEE_ALSO: 'bdlxxxx_instreammethods'
//
//@DEPRECATED: This component should not be used for new code.  Use (and
// specialize the functions in 'bdlxxxx_outstreamfunctions', instead.
//
...
///------------------------------------------------------------
// 'bdlxxxx_outstreammethods' is an integral part of the 'bdex' externalization
...
// 'bdlxxxx_outstreammethods' plays several related but different roles in helping
// various developers to produce 'bdex'-compliant components.  In this section
// we briefly highlight how and why 'bdlxxxx_outstreammethods' is helpful (or
...
//..
//    template <>
//    class bdex_OutStreamMethods<bdlt::DayOfWeek::Enum>
//..
...
// 'bdlxxxx::ByteOutStreamFormatter'), but this factoring is not central to the
...
///- - - - - - - - - - - - -
// One obvious design choice for 'bdlxxxx_outstreammethods' is that it supports
...
struct OutStreamMethodsUtil {
  ...
  public:
    ...
    static STREAM& streamOutVersionAndObject(STREAM&     stream,
        ...
        // 'GenericOutStreamMethods', which the unspecialized
