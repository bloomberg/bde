...
//-----------------------------------------------------------------------------
// [ 3] bdlxxxx::TestInStream();
// [ 3] bdlxxxx::TestInStream(const char *buffer, int numBytes);
// [ 3] ~bdlxxxx::TestInStream();
// [ 3] setQuiet(int flag);
...
//
// [ 5] ostream& operator<<(ostream& stream, const bdlxxxx::TestInStream& obj);
//-----------------------------------------------------------------------------
// [31] USAGE TEST
// [ 1] BREATHING TEST
...
typedef bdlxxxx::TestInStream Obj;
...
// right to configure a 'bdlxxxx::TestOutStream' object according to a custom
...
int main(int argc, char *argv[]) {
    ...
    switch (test) { case 0:
      case 31: {
        ...
        //   following test plan.  Note that the 'bdlxxxx::TestInStream' and
        //   'bdlxxxx::TestOutStream' components are used to test the
        ...
        //
        // Testing:
        //   bdlxxxx::TestInStream& streamIn(bdlxxxx::TestInStream& stream);
        //   bdlxxxx::TestOutStream& streamOut(bdlxxxx::TestOutStream& stream) const;
        // --------------------------------------------------------------------
...
//
         ...
         bdlxxxx::TestInStream in(PD, NPB);
...
//
             for (int j = 0; SPECS[j]; ++j) {
                 bdlxxxx::TestInStream testInStream(PD, NPB);
...
//
         for (int i = 0; i < NPB; ++i) {
             bdlxxxx::TestInStream in(PD,i);  in.setQuiet(!veryVerbose);
             in.setSuppressVersionCheck(1);
...
//
                            ...
                            << bsl::endl;
     {
         const int length  = 5;
//
         bdlxxxx::TestOutStream out;    // Stream out "new" value.
...
//
         ...
         bdlxxxx::TestInStream in(PD, NPB); ASSERT(in);
         in.setSuppressVersionCheck(1);
...
//
         MyObj t(X);    ASSERT(W != t);    ASSERT(X == t);   ASSERT(Y != t);
         bdlxxxx::TestInStream in(PD, NPB);  in.setQuiet(!veryVerbose);
         in.setSuppressVersionCheck(1);
         ASSERT(in);
         bdex_InStreamFunctions::streamIn(in, t, version); ASSERT(!in);
                      ASSERT(W != t);    ASSERT(X == t);   ASSERT(Y != t);
...
//
      ...
      case 30: {
        ...
        if (verbose) cout << "\nTesting 'getLength'." << endl;
        {
            for (int len = 0; len <= 256; ++len) {
                ...
                out.putVersion(1);
                out.putLength(len);
                bdlxxxx::TestInStream in(out.data(),
                                     out.length());
                int tmp;
                in.getVersion(tmp);
                in.getLength(tmp);
        ...
        if (verbose) cout << "\nTesting 'getVersion'." << endl;
        {
            ...
            typedef bdlxxxx::TestInStream& (Obj::*FuncPtr)(ElemType&);
    ...
    { L_, "A0 C0 T1 C234",  0,     5,      { VC[0] }                         },
      ...
      case 29: {
        // --------------------------------------------------------------------
        // RELOAD TEST:
        //   Create 'bdlxxxx::TestInStream' objects containing data of varying
 ...
 //-------------v
      ...
      case 26: {
        // --------------------------------------------------------------------
        // SEEK/RESET TEST:
        //   Create a 'bdlxxxx::TestInStream' object initialized with arbitrary
      ...
      case 25: {
        ...
        if (verbose) cout << "\nTesting 'getArrayFloat64'." << endl;
        {
            ...
            typedef bdlxxxx::TestInStream& (Obj::*FuncPtr)(ElemType*, int);
  ...
  { L_, "A0 c1 q2 c3",  0,        0,      3,      { 1, 2, 3 },   { 1, 0, 0 } },
    ...
    { L_, "A0 C0 T1 C234",  0,     5,      { VC[0] }                         },
      ...
      case 5: {
        ...
        //
        // Testing:
        //   ostream& operator<<(ostream&, const bdlxxxx::TestInStream&);
        // --------------------------------------------------------------------
      ...
      case 3: {
        ...
        //
        // Testing
        //   bdlxxxx::TestInStream();
        //   bdlxxxx::TestInStream(const char *buffer, int numBytes);
        //   ~bdlxxxx::TestInStream();   // by purify
        //   setQuiet(int flag);
    ...
    */
      ...
      case 1: {
        // --------------------------------------------------------------------
        // BREATHING TEST:
        //   Create 'bdlxxxx::TestInStream' objects containing various data.
