// bdlxxxx_byteinstreamraw.h                                          -*-C++-*-
#ifndef INCLUDED_BDLXXXX_BYTEINSTREAMRAW
#define INCLUDED_BDLXXXX_BYTEINSTREAMRAW
...
//
//@CLASSES:
//   bdlxxxx::ByteInStreamRaw: byte-array-based input stream for fundamental types
//
//@AUTHOR: Shao-wei Hung
//
//@SEE_ALSO: bdlxxxx_byteoutstreamraw, bdlxxxx_byteoutstream
//
...
// 'bdlxxxx_byteoutstreamraw' or the 'bdlxxxx_byteoutstream' externalization
// components, at the user's choice.  Each input method of
// 'bdlxxxx::ByteInStreamRaw' reads a value or a homogeneous array of values from a
...
// on any other mechanism to read data written by 'bdlxxxx::ByteOutStreamRaw'
...
// 'JaneSmith' and a 'bdlxxxx::ByteOutStreamRaw' 'outStream'.
//..
// // my_testapp.m.cpp
//
// using namespace std;
...
class ByteInStreamRaw {
    ...
    // DATA
    int                                           d_size;
    bdlsb::FixedMemInput                           d_streambuf; // externalized
                                                               // values
    GenericByteInStream<bdlsb::FixedMemInput> d_formatter; // formatter

    friend bsl::ostream& operator<<(bsl::ostream&               stream,
                                    const ByteInStreamRaw& object);

    // NOT DEFINED
    ByteInStreamRaw(const ByteInStreamRaw&);
    ByteInStreamRaw& operator=(const ByteInStreamRaw&);

    bool operator==(const ByteInStreamRaw&) const;
    bool operator!=(const ByteInStreamRaw&) const;

  public:
    // CREATORS
    ByteInStreamRaw(const char *buffer, int numBytes);
    ...
    ByteInStreamRaw& getLength(int& variable);
    ...
    ByteInStreamRaw& getString(bsl::string& str);
    ...
    ByteInStreamRaw& getVersion(int& variable);
...
// TBD #ifndef BDE_OMIT_DEPRECATED
    ...
    template <class TYPE>
    ByteInStreamRaw& get(TYPE& variable);
        // TBD
...
// TBD #endif  // BDE_OMIT_DEPRECATED
    ...
    ByteInStreamRaw& getInt64(bsls::Types::Int64& variable);
    ...
    ByteInStreamRaw& getUint64(bsls::Types::Uint64& variable);
    ...
    ByteInStreamRaw& getInt56(bsls::Types::Int64& variable);
    ...
    ByteInStreamRaw& getUint56(bsls::Types::Uint64& variable);
    ...
    ByteInStreamRaw& getInt48(bsls::Types::Int64& variable);
    ...
    ByteInStreamRaw& getUint48(bsls::Types::Uint64& variable);
    ...
    ByteInStreamRaw& getInt40(bsls::Types::Int64& variable);
    ...
    ByteInStreamRaw& getUint40(bsls::Types::Uint64& variable);
    ...
    ByteInStreamRaw& getInt32(int& variable);
    ...
    ByteInStreamRaw& getUint32(unsigned int& variable);
    ...
    ByteInStreamRaw& getInt24(int& variable);
    ...
    ByteInStreamRaw& getUint24(unsigned int& variable);
    ...
    ByteInStreamRaw& getInt16(short& variable);
    ...
    ByteInStreamRaw& getUint16(unsigned short& variable);
    ...
    ByteInStreamRaw& getInt8(char& variable);
    ByteInStreamRaw& getInt8(signed char& variable);
    ...
    ByteInStreamRaw& getUint8(char& variable);
    ByteInStreamRaw& getUint8(unsigned char& variable);
    ...
    ByteInStreamRaw& getFloat64(double& variable);
    ...
    ByteInStreamRaw& getFloat32(float& variable);
    ...
    ByteInStreamRaw& getArrayInt64(bsls::Types::Int64 *array, int length);
    ...
    ByteInStreamRaw& getArrayUint64(bsls::Types::Uint64 *array,
                                         int                  length);
    ...
    ByteInStreamRaw& getArrayInt56(bsls::Types::Int64 *array, int length);
    ...
    ByteInStreamRaw& getArrayUint56(bsls::Types::Uint64 *array,
                                         int                  length);
    ...
    ByteInStreamRaw& getArrayInt48(bsls::Types::Int64 *array, int length);
    ...
    ByteInStreamRaw& getArrayUint48(bsls::Types::Uint64 *array,
                                         int                  length);
    ...
    ByteInStreamRaw& getArrayInt40(bsls::Types::Int64 *array, int length);
    ...
    ByteInStreamRaw& getArrayUint40(bsls::Types::Uint64 *array,
                                         int                  length);
    ...
    ByteInStreamRaw& getArrayInt32(int *array, int length);
    ...
    ByteInStreamRaw& getArrayUint32(unsigned int *array, int length);
    ...
    ByteInStreamRaw& getArrayInt24(int *array, int length);
    ...
    ByteInStreamRaw& getArrayUint24(unsigned int *array, int length);
    ...
    ByteInStreamRaw& getArrayInt16(short *array, int length);
    ...
    ByteInStreamRaw& getArrayUint16(unsigned short *array, int length);
    ...
    ByteInStreamRaw& getArrayInt8(char *array, int length);
    ByteInStreamRaw& getArrayInt8(signed char *array, int length);
    ...
    ByteInStreamRaw& getArrayUint8(char *array, int length);
    ByteInStreamRaw& getArrayUint8(unsigned char *array, int length);
    ...
    ByteInStreamRaw& getArrayFloat64(double *array, int count);
    ...
    ByteInStreamRaw& getArrayFloat32(float *array, int length);
...
inline
ByteInStreamRaw& operator>>(ByteInStreamRaw& stream, OBJECT& object);
...
// CREATORS
inline
ByteInStreamRaw::ByteInStreamRaw(const char *buffer, int numBytes)
: d_size(numBytes)
...
inline
ByteInStreamRaw::~ByteInStreamRaw()
{
}

// MANIPULATORS
inline
void ByteInStreamRaw::invalidate()
{
    d_formatter.invalidate();
}

inline
void ByteInStreamRaw::reset(const char *buffer, int numBytes)
{
    BSLS_ASSERT_SAFE(buffer);
    BSLS_ASSERT_SAFE(0 <= numBytes);
...
inline
void ByteInStreamRaw::setCursor(int index)
{
...
inline
ByteInStreamRaw& ByteInStreamRaw::getLength(int& variable)
{
...
inline
ByteInStreamRaw& ByteInStreamRaw::getString(bsl::string& str)
{
...
inline
ByteInStreamRaw& ByteInStreamRaw::getVersion(int& variable)
{
...
inline
ByteInStreamRaw& ByteInStreamRaw::getInt32(int& variable)
{
...
inline
ByteInStreamRaw& ByteInStreamRaw::getUint32(unsigned int& variable)
{
...
inline
ByteInStreamRaw& ByteInStreamRaw::getInt24(int& variable)
{
...
inline
ByteInStreamRaw& ByteInStreamRaw::getUint24(unsigned int& variable)
{
...
inline
ByteInStreamRaw& ByteInStreamRaw::getInt16(short& variable)
{
...
inline
ByteInStreamRaw& ByteInStreamRaw::getUint16(unsigned short& variable)
{
...
inline
ByteInStreamRaw& ByteInStreamRaw::getInt8(char& variable)
{
...
inline
ByteInStreamRaw& ByteInStreamRaw::getInt8(signed char& variable)
{
    d_formatter.getInt8(variable);
    return *this;
}
...
inline
ByteInStreamRaw& ByteInStreamRaw::getUint8(char& variable)
{
...
inline
ByteInStreamRaw& ByteInStreamRaw::getUint8(unsigned char& variable)
{
    d_formatter.getUint8(variable);
    return *this;
}
...
inline
ByteInStreamRaw& ByteInStreamRaw::getFloat64(double& variable)
{
...
inline
ByteInStreamRaw& ByteInStreamRaw::getFloat32(float& variable)
{
...
inline
ByteInStreamRaw&
ByteInStreamRaw::getArrayInt64(bsls::Types::Int64 *array, int numValues)
{
...
inline
ByteInStreamRaw&
ByteInStreamRaw::getArrayUint64(bsls::Types::Uint64 *array, int numValues)
{
    BSLS_ASSERT_SAFE(array);
    BSLS_ASSERT_SAFE(0 <= numValues);
...
inline
ByteInStreamRaw&
ByteInStreamRaw::getArrayInt56(bsls::Types::Int64 *array, int numValues)
{
    BSLS_ASSERT_SAFE(array);
    BSLS_ASSERT_SAFE(0 <= numValues);
...
inline
ByteInStreamRaw&
ByteInStreamRaw::getArrayUint56(bsls::Types::Uint64 *array, int numValues)
{
    BSLS_ASSERT_SAFE(array);
    BSLS_ASSERT_SAFE(0 <= numValues);
...
inline
ByteInStreamRaw&
ByteInStreamRaw::getArrayInt48(bsls::Types::Int64 *array, int numValues)
{
    BSLS_ASSERT_SAFE(array);
    BSLS_ASSERT_SAFE(0 <= numValues);
...
inline
ByteInStreamRaw&
ByteInStreamRaw::getArrayUint48(bsls::Types::Uint64 *array, int numValues)
{
    BSLS_ASSERT_SAFE(array);
    BSLS_ASSERT_SAFE(0 <= numValues);
...
inline
ByteInStreamRaw&
ByteInStreamRaw::getArrayInt40(bsls::Types::Int64 *array, int numValues)
{
    BSLS_ASSERT_SAFE(array);
    BSLS_ASSERT_SAFE(0 <= numValues);
...
inline
ByteInStreamRaw&
ByteInStreamRaw::getArrayUint40(bsls::Types::Uint64 *array, int numValues)
{
    BSLS_ASSERT_SAFE(array);
    BSLS_ASSERT_SAFE(0 <= numValues);
...
inline
ByteInStreamRaw&
ByteInStreamRaw::getArrayInt32(int *array, int numValues)
{
    BSLS_ASSERT_SAFE(array);
    BSLS_ASSERT_SAFE(0 <= numValues);
...
inline
ByteInStreamRaw&
ByteInStreamRaw::getArrayUint32(unsigned int *array, int numValues)
{
    BSLS_ASSERT_SAFE(array);
    BSLS_ASSERT_SAFE(0 <= numValues);
...
inline
ByteInStreamRaw&
ByteInStreamRaw::getArrayInt24(int *array, int numValues)
{
    BSLS_ASSERT_SAFE(array);
    BSLS_ASSERT_SAFE(0 <= numValues);
...
inline
ByteInStreamRaw&
ByteInStreamRaw::getArrayUint24(unsigned int *array, int numValues)
{
    BSLS_ASSERT_SAFE(array);
    BSLS_ASSERT_SAFE(0 <= numValues);
...
inline
ByteInStreamRaw&
ByteInStreamRaw::getArrayInt16(short *array, int numValues)
{
    BSLS_ASSERT_SAFE(array);
    BSLS_ASSERT_SAFE(0 <= numValues);
...
inline
ByteInStreamRaw&
ByteInStreamRaw::getArrayUint16(unsigned short *array, int numValues)
{
    BSLS_ASSERT_SAFE(array);
    BSLS_ASSERT_SAFE(0 <= numValues);
...
inline
ByteInStreamRaw&
ByteInStreamRaw::getArrayInt8(char *array, int numValues)
{
    BSLS_ASSERT_SAFE(array);
    BSLS_ASSERT_SAFE(0 <= numValues);
...
inline
ByteInStreamRaw&
ByteInStreamRaw::getArrayInt8(signed char *array, int numValues)
{
    BSLS_ASSERT_SAFE(array);
    BSLS_ASSERT_SAFE(0 <= numValues);
...
inline
ByteInStreamRaw&
ByteInStreamRaw::getArrayUint8(char *array, int numValues)
{
    BSLS_ASSERT_SAFE(array);
    BSLS_ASSERT_SAFE(0 <= numValues);
...
inline
ByteInStreamRaw&
ByteInStreamRaw::getArrayUint8(unsigned char *array, int numValues)
{
    BSLS_ASSERT_SAFE(array);
    BSLS_ASSERT_SAFE(0 <= numValues);
...
inline
ByteInStreamRaw&
ByteInStreamRaw::getArrayFloat64(double *array, int numValues)
{
    BSLS_ASSERT_SAFE(array);
    BSLS_ASSERT_SAFE(0 <= numValues);
...
inline
ByteInStreamRaw& ByteInStreamRaw::getArrayFloat32(float *array,
                                                            int    numValues)
{
    BSLS_ASSERT_SAFE(array);
    BSLS_ASSERT_SAFE(0 <= numValues);
...
template <class TYPE>
inline
ByteInStreamRaw& ByteInStreamRaw::get(TYPE& variable)
{
...
// ACCESSORS
inline
bdlxxxx::ByteInStreamRaw::operator const void *() const
{
...
namespace bdlxxxx {
inline
const char *ByteInStreamRaw::data() const
{
    return d_streambuf.data();
}

inline
bool ByteInStreamRaw::isEmpty() const
{
    return 0 == d_streambuf.length();
}

inline
int ByteInStreamRaw::length() const
{
    return d_size;
}

inline
int ByteInStreamRaw::cursor() const
{
...
template <class OBJECT>
inline
bdlxxxx::ByteInStreamRaw& bdlxxxx::operator>>(ByteInStreamRaw& stream, OBJECT& object)
{
