// bdlxxxx_byteoutstreamraw.t.cpp             -*-C++-*-
...
//                              Overview
//                              --------
// For all output methods in 'bdlxxxx::ByteOutStreamRaw', the formatting of the
...
// bytes.
//
// We have chosen the primary black-box manipulator for 'bdlxxxx::ByteOutStreamRaw'
// to be 'putInt8'.
//-----------------------------------------------------------------------------
// [ 2] bdlxxxx::ByteOutStreamRaw(char *buffer, int length);
// [ 2] ~bdlxxxx::ByteOutStreamRaw();
// [25] void invalidate();
...
// [ 3] int length();
//
// [ 4] ostream& operator<<(ostream& stream, const bdlxxxx::ByteOutStreamRaw&);
//-----------------------------------------------------------------------------
// [ 1] BREATHING TEST
// [26] USAGE
//=============================================================================
...
typedef bdlxxxx::ByteOutStreamRaw Obj;
...
//     return 0;
      ...
      case 4: {
        ...
        //
        // Testing:
        //   ostream& operator<<(ostream&, const bdlxxxx::ByteOutStreamRaw&);
        // --------------------------------------------------------------------
      ...
      case 2: {
        ...
        //
        // Testing:
        //   bdlxxxx::ByteOutStreamRaw(char *buffer, int length);
        //   ~bdlxxxx::ByteOutStreamRaw();  // via purify
        //   putInt8(int value);
        //   putUint8(int value);
        //   removeAll();
      ...
      case 1: {
        // --------------------------------------------------------------------
        // BREATHING TEST:
        //   Create 'bdlxxxx::ByteOutStreamRaw' objects using default and copy
