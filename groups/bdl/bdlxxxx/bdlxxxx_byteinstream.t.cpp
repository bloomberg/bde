...
//                              Overview
//                              --------
// For all input methods in 'bdlxxxx::ByteInStream', the "unexternalization" from
...
// 'bdlxxxx::ByteOutStream' object 'oX' containing some arbitrarily chosen values.
// The values are interleaved with chosen "marker" bytes to check for alignment
// issues.  We then create a 'bdlxxxx::ByteInStream' object 'iX' initialized with
...
//-----------------------------------------------------------------------------
// [ 2] bdlxxxx::ByteInStream();
// [ 2] bdlxxxx::ByteInStream(const char *buffer, int numBytes);
// [ 2] ~bdlxxxx::ByteInStream();
...
// [ 3] int cursor() const;
//
// [ 4] ostream& operator<<(ostream& stream, const bdlxxxx::ByteInStream& obj);
//-----------------------------------------------------------------------------
// [ 1] BREATHING TEST
// [26] USAGE EXAMPLE
//=============================================================================
...
typedef bdlxxxx::ByteInStream Obj;
typedef bdlxxxx::ByteOutStream Out;
...
//     return 0;
      ...
      case 4: {
        ...
        //
        // Testing:
        //   ostream& operator<<(ostream&, const bdlxxxx::ByteInStream&);
        // --------------------------------------------------------------------
      ...
      case 1: {
        // --------------------------------------------------------------------
        // BREATHING TEST:
        //   Create 'bdlxxxx::ByteInStream' objects containing various data.
