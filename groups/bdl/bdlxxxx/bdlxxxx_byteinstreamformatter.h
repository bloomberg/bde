...
//
//@CLASSES:
//  bdlxxxx::ByteInStreamFormatter: read fundamental types from a 'streambuf'
//
...
// 'bdlxxxx_byteoutstreamformatter' externalization component.  Each input
// method of 'bdlxxxx::ByteInStreamFormatter' reads either a value or a
// homogeneous array of values of a fundamental type, in a format that was
// written by the corresponding 'bdlxxxx::ByteOutStreamFormatter' method.  In
...
//      bdlxxxx::ByteOutStreamFormatter outStream;
//      const int VERSION = 1;
...
//..
// Now create a 'bdlxxxx::ByteInStreamFormatter' 'inStream' initialized with the
// buffer from the 'bdlxxxx::ByteOutStreamFormatter' object 'outStream'.
//..
//      bdlxxxx::ByteInStreamFormatter inStream(outStream.data(),
//                                          outStream.length());
//      int version;
