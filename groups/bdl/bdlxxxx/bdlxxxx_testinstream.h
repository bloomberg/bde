...
//
//@CLASSES:
//   bdlxxxx::TestInStream: byte-array-based input stream class
...
// 'bdlxxxx_testoutstream' externalization component.  Each input method of
// 'bdlxxxx::TestInStream' reads either a value or a homogeneous array of values of
// a fundamental type, in a format that was written by the corresponding
// 'bdlxxxx::TestOutStream' method.  In general, the user of this component cannot
...
///Version Checking
///----------------
// By default, 'bdlxxxx::TestInStream' assumes that the first unit of data in the
...
// 'bdlxxxx::TestInStream', the stream checks for the existence of this version
...
// involved.
//
// A 'bdlxxxx::TestInStream' named 'testInStream' *must* *be* *defined* *in*
...
///Usage
///-----
// This 'bdlxxxx_testinstream' component (in conjunction with the companion
// 'bdlxxxx_testoutstream' component) is most useful in testing the 'bdex'
...
//      //     'bdlxxxx::TestInStream' object to throw an exception for every
...
class TestInStream {
    ...
    bdlsb::FixedMemInStreamBuf   d_streambuf;    // externalized values
    TestInStreamFormatter  d_formatter;    // formatter
  ...
  public:
    // CREATORS
    TestInStream(bslma::Allocator *basicAllocator = 0);
...
// TBD #endif  // BDE_OMIT_DEPRECATED
    ...
    TestInStream& getArrayFloat32(float *array, int length);
        // Verify the type of the next value in this stream, consume that IEEE
...
// ACCESSORS
inline
bdlxxxx::TestInStream::operator const void *() const
{
