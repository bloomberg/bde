...
int extractExpectedObjectsFromStream(bdlxxxx::InStream& inputStream)
{
...
//--------------------------------------------------------------------------
class MyInStream : public bdlxxxx::InStream {
  ...
  public:
    ...
    bdlxxxx::InStream& getLength(int&)              { d_fun =  10; return *this; }
    bdlxxxx::InStream& getVersion(int&)             { d_fun =  11; return *this; }
    bdlxxxx::InStream& getInt64(Int64&)             { d_fun = -64; return *this; }
    bdlxxxx::InStream& getUint64(Uint64&)           { d_fun = +64; return *this; }
    bdlxxxx::InStream& getInt56(Int64&)             { d_fun = -56; return *this; }
    bdlxxxx::InStream& getUint56(Uint64&)           { d_fun = +56; return *this; }
    bdlxxxx::InStream& getInt48(Int64&)             { d_fun = -48; return *this; }
    bdlxxxx::InStream& getUint48(Uint64&)           { d_fun = +48; return *this; }
    bdlxxxx::InStream& getInt40(Int64&)             { d_fun = -40; return *this; }
    bdlxxxx::InStream& getUint40(Uint64&)           { d_fun = +40; return *this; }
    bdlxxxx::InStream& getInt32(int&)               { d_fun = -32; return *this; }
    bdlxxxx::InStream& getUint32(unsigned int&)     { d_fun = +32; return *this; }
    bdlxxxx::InStream& getInt24(int&)               { d_fun = -24; return *this; }
    bdlxxxx::InStream& getUint24(unsigned int&)     { d_fun = +24; return *this; }
    bdlxxxx::InStream& getInt16(short&)             { d_fun = -16; return *this; }
    bdlxxxx::InStream& getUint16(unsigned short&)   { d_fun = +16; return *this; }
    bdlxxxx::InStream& getInt8(signed char&)        { d_fun =  -8; return *this; }

    // Initialize argument to quell purify: UMR: Uninitialized memory read
    bdlxxxx::InStream& getInt8(char& c)    { c = 'z'; d_fun =  -1; return *this; }

    bdlxxxx::InStream& getUint8(char&)              { d_fun =  +1; return *this; }
    bdlxxxx::InStream& getUint8(unsigned char&)     { d_fun =  +8; return *this; }
    bdlxxxx::InStream& getFloat64(double&)          { d_fun = 164; return *this; }
    bdlxxxx::InStream& getFloat32(float&)           { d_fun = 132; return *this; }


    bdlxxxx::InStream& getArrayInt64(Int64 *array, int count)
                                            { d_fun = -1064; return *this; }
    bdlxxxx::InStream& getArrayUint64(Uint64 *array, int count)
                                            { d_fun = +1064; return *this; }
    bdlxxxx::InStream& getArrayInt56(Int64 *array, int count)
                                            { d_fun = -1056; return *this; }
    bdlxxxx::InStream& getArrayUint56(Uint64 *array, int count)
                                            { d_fun = +1056; return *this; }
    bdlxxxx::InStream& getArrayInt48(Int64 *array, int count)
                                            { d_fun = -1048; return *this; }
    bdlxxxx::InStream& getArrayUint48(Uint64 *array, int count)
                                            { d_fun = +1048; return *this; }
    bdlxxxx::InStream& getArrayInt40(Int64 *array, int count)
                                            { d_fun = -1040; return *this; }
    bdlxxxx::InStream& getArrayUint40(Uint64 *array, int count)
                                            { d_fun = +1040; return *this; }
    bdlxxxx::InStream& getArrayInt32(int *array, int count)
                                            { d_fun = -1032; return *this; }
    bdlxxxx::InStream& getArrayUint32(unsigned int *array, int count)
                                            { d_fun = +1032; return *this; }
    bdlxxxx::InStream& getArrayInt24(int *array, int count)
                                            { d_fun = -1024; return *this; }
    bdlxxxx::InStream& getArrayUint24(unsigned int *array, int count)
                                            { d_fun = +1024; return *this; }
    bdlxxxx::InStream& getArrayInt16(short *array, int count)
                                            { d_fun = -1016; return *this; }
    bdlxxxx::InStream& getArrayUint16(unsigned short *array, int count)
                                            { d_fun = +1016; return *this; }
    bdlxxxx::InStream& getArrayInt8(signed char *array, int count)
                                            { d_fun = -1008; return *this; }
    bdlxxxx::InStream& getArrayUint8(unsigned char *array, int count)
                                            { d_fun = +1008; return *this; }
    bdlxxxx::InStream& getArrayInt8(char *array, int count)
                                            { d_fun = -1001; return *this; }
    bdlxxxx::InStream& getArrayUint8(char *array, int count)
                                            { d_fun = +1001; return *this; }
    bdlxxxx::InStream& getArrayFloat64(double *array, int count)
                                            { d_fun = +1164; return *this; }
    bdlxxxx::InStream& getArrayFloat32(float *array, int count)
                                            { d_fun = +1132; return *this; }
    bdlxxxx::InStream& getString(bsl::string& value)
...
int main(int argc, char *argv[]) {
    ...
    switch (test) { case 0:
      ...
      case 1: {
        ...
        //   'bdlxxxx::InStream' class compiles and links when all virtual
        //   functions are defined.
        //
        // Plan:
        //   Construct an object of a class derived from 'bdlxxxx::InStream'.
        //   Upcast a reference to the object to the base class
        //   'bdlxxxx::InStream'.  Using the base class reference invoke various
        //   methods of the base class.  Verify that the correct
        //   implementations of the methods are called.
        //
        // Testing:
        //   virtual ~bdlxxxx::InStream();
        ...
        if (verbose) cout << endl << "PROTOCOL TEST" << endl
                                  << "=============" << endl;
        MyInStream myS;
        bdlxxxx::InStream& s = myS; const bdlxxxx::InStream& S = s;
