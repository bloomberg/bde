...
//
//@CLASSES:
//   bdlxxxx::GenericByteInStream: read from a parameterized stream buffer
//
//@AUTHOR: Herve Bronnimann (hbronnimann)
//
//@SEE_ALSO:  bdlxxxx_byteoutstreamformatter, bdlxxxx_genericbyteoutstream
//
...
// 'bdlxxxx_genericbyteoutstream' externalization component.  Each input method of
// 'bdlxxxx::GenericByteInStream' reads either a value or a homogeneous array of
// values of a fundamental type, in a format that was written by the
// corresponding 'bdlxxxx::GenericByteOutStream' method.  In general, the user of
// this component cannot rely on being able to read data that was written by
// any mechanism other than 'bdlxxxx::GenericByteOutStream'.  Note that the
// 'bdlxxxx::ByteOutStream' is a kind of 'bdlxxxx::GenericByteOutStream', so it is
// perfectly acceptable to write with a 'bdlxxxx::ByteOutStream' values that will
// be read with a 'bdlxxxx::GenericByteInStream', and vice versa.
//
...
///--------------------------
// The class 'bdlxxxx::GenericByteInStream' is parameterized by a
...
// 'bsl::basic_streambuf' protocol, but also 'bdlsb::FixedMemInput' which does
...
//
// The class 'bdlxxxx::ByteInStreamFormatter' is not parameterized and is resolved
// to be the same type as 'bdlxxxx::GenericByteInStream<bsl::streambuf>'.
//
...
// a non-'const' method) 'bdlxxxx::StreamIn'.  This example shows how to implement
...
// 'JaneSmith' and a 'bdlxxxx::GenericByteOutStream' 'outStream'.
//..
//  // my_testapp.m.cpp
//
...
//      char buffer[200];
//      bdlsb::FixedMemOutStreamBuf osb(buffer, 200);
//      bdlxxxx::GenericByteOutStream<bdlsb::FixedMemOutStreamBuf>
//                                                             outStream(&osb);
//      const int VERSION = 1;
...
//..
// Now create a 'bdlxxxx::GenericByteInStream' object 'inStream' initialized with
// the buffer from the 'bdlxxxx::GenericByteOutStream' object 'outStream'.  To
// demonstrate the generic aspect, we will use 'bdlsb::FixedMemInput' and
// 'bdlsb::FixedMemOutput' objects for implementing the underlying streaming
// to the memory buffers.
//..
//      bdlsb::FixedMemInput sb(buffer, osb.length());
//      bdlxxxx::GenericByteInStream<bdlsb::FixedMemInput> inStream(&sb);
//      int version;
...
class GenericByteInStream {
    ...
    // non-parameterized 'ByteOutStreamFormatter' class.
    ...
    bool operator==(const GenericByteInStream&) const;
    bool operator!=(const GenericByteInStream&) const;

    template<class OTHER_BUF>
    bool operator==(const GenericByteInStream<OTHER_BUF>&) const;
    template<class OTHER_BUF>
    bool operator!=(const GenericByteInStream<OTHER_BUF>&) const;

  public:
    // CREATORS
    GenericByteInStream(StreamBuf *streamBuffer);
        // Create an input byte stream that reads bytes obtained from the
        // specified 'streamBuffer' and formatted by a corresponding
        // 'ByteOutStreamFormatter' object.
    ...
    GenericByteInStream& getString(bsl::string& str);
    ...
    GenericByteInStream& getVersion(int& variable);
    ...
    GenericByteInStream& getUint8(unsigned char& variable);
     ...
     GenericByteInStream& getArrayInt32(int *array, int count);
     ...
     GenericByteInStream& getArrayUint32(unsigned int *array, int count);
        // Read the specified 'count' four-byte, two's complement integers (in
        // network byte order) from this input stream and store these
        // values sequentially in the the specified 'array' (in host byte
        // order).  The behavior is undefined unless '0 <= count'.  Note that
     ...
     GenericByteInStream& getArrayInt24(int *array, int count);
     ...
     GenericByteInStream& getArrayUint24(unsigned int *array, int count);
        // Read the specified 'count' three-byte, two's complement integers (in
        // network byte order) from this input stream and store these
        // values sequentially in the the specified 'array' (in host byte
        // order).  The behavior is undefined unless '0 <= count'.  Note that
     ...
     GenericByteInStream& getArrayInt16(short *array, int count);
     ...
     GenericByteInStream& getArrayUint16(unsigned short *array,
                                              int             count);
        // Read the specified 'count' two-byte, two's complement integers (in
        // network byte order) from this input stream and store these
        // values sequentially in the the specified 'array' (in host byte
     ...
     GenericByteInStream& getArrayInt8(char *array, int count);
     GenericByteInStream& getArrayInt8(signed char *array, int count);
    ...
    GenericByteInStream& getArrayUint8(char *array, int count);
    GenericByteInStream& getArrayUint8(unsigned char *array, int count);
     ...
     ///- - - - - - - - - - - - - - - - - - - -
     GenericByteInStream& getArrayFloat64(double *array, int count);
     ...
     GenericByteInStream& getArrayFloat32(float *array, int count);
...
GenericByteInStream<StreamBuf>& operator>>(
    ...
    // 'stream' was written by a 'ByteOutStream' object.  (See the 'bdex'
...
inline
GenericByteInStream<StreamBuf>&
GenericByteInStream<StreamBuf>::getVersion(int& variable)
{
...
template <class StreamBuf>
GenericByteInStream<StreamBuf>&
GenericByteInStream<StreamBuf>::getString(bsl::string& str)
{
    if (BSLS_PERFORMANCEHINT_PREDICT_UNLIKELY(!d_valid)) {
        BSLS_PERFORMANCEHINT_UNLIKELY_HINT;
        return *this;                                                 // RETURN
...
#endif
GenericByteInStream<StreamBuf>&
GenericByteInStream<StreamBuf>::getArrayInt64(bsls::Types::Int64 *array,
                                                   int                 count)
{
...
#endif
GenericByteInStream<StreamBuf>&
GenericByteInStream<StreamBuf>::getArrayUint64(bsls::Types::Uint64 *array,
                                                    int                  count)
{
    BSLS_ASSERT_SAFE(array);
    BSLS_ASSERT_SAFE(0 <= count);
...
template <class StreamBuf>
GenericByteInStream<StreamBuf>&
GenericByteInStream<StreamBuf>::getArrayInt56(bsls::Types::Int64 *array,
                                                   int                 count)
{
    BSLS_ASSERT_SAFE(array);
    BSLS_ASSERT_SAFE(0 <= count);
...
template <class StreamBuf>
GenericByteInStream<StreamBuf>&
GenericByteInStream<StreamBuf>::getArrayUint56(bsls::Types::Uint64 *array,
                                                    int                  count)
{
    BSLS_ASSERT_SAFE(array);
    BSLS_ASSERT_SAFE(0 <= count);
...
template <class StreamBuf>
GenericByteInStream<StreamBuf>&
GenericByteInStream<StreamBuf>::getArrayInt48(bsls::Types::Int64 *array,
                                                   int                 count)
{
    BSLS_ASSERT_SAFE(array);
    BSLS_ASSERT_SAFE(0 <= count);
...
template <class StreamBuf>
GenericByteInStream<StreamBuf>&
GenericByteInStream<StreamBuf>::getArrayUint48(bsls::Types::Uint64 *array,
                                                    int                  count)
{
    BSLS_ASSERT_SAFE(array);
    BSLS_ASSERT_SAFE(0 <= count);
...
template <class StreamBuf>
GenericByteInStream<StreamBuf>&
GenericByteInStream<StreamBuf>::getArrayInt40(bsls::Types::Int64 *array,
                                                   int                 count)
{
    BSLS_ASSERT_SAFE(array);
    BSLS_ASSERT_SAFE(0 <= count);
...
template <class StreamBuf>
GenericByteInStream<StreamBuf>&
GenericByteInStream<StreamBuf>::getArrayUint40(bsls::Types::Uint64 *array,
                                                    int                  count)
{
    BSLS_ASSERT_SAFE(array);
    BSLS_ASSERT_SAFE(0 <= count);
...
#endif
GenericByteInStream<StreamBuf>&
GenericByteInStream<StreamBuf>::getArrayInt32(int *array, int count)
{
    BSLS_ASSERT_SAFE(array);
    BSLS_ASSERT_SAFE(0 <= count);
...
#endif
GenericByteInStream<StreamBuf>&
GenericByteInStream<StreamBuf>::getArrayUint32(unsigned int *array,
                                                    int           count)
{
    BSLS_ASSERT_SAFE(array);
    BSLS_ASSERT_SAFE(0 <= count);
...
template <class StreamBuf>
GenericByteInStream<StreamBuf>&
GenericByteInStream<StreamBuf>::getArrayInt24(int *array, int count)
{
    BSLS_ASSERT_SAFE(array);
    BSLS_ASSERT_SAFE(0 <= count);
...
template <class StreamBuf>
GenericByteInStream<StreamBuf>&
GenericByteInStream<StreamBuf>::getArrayUint24(unsigned int *array,
                                                    int           count)
{
    BSLS_ASSERT_SAFE(array);
    BSLS_ASSERT_SAFE(0 <= count);
...
#endif
GenericByteInStream<StreamBuf>&
GenericByteInStream<StreamBuf>::getArrayInt16(short *array, int count)
{
    BSLS_ASSERT_SAFE(array);
    BSLS_ASSERT_SAFE(0 <= count);
...
#endif
GenericByteInStream<StreamBuf>&
GenericByteInStream<StreamBuf>::getArrayUint16(unsigned short *array,
                                                    int             count)
{
    BSLS_ASSERT_SAFE(array);
    BSLS_ASSERT_SAFE(0 <= count);
...
inline
GenericByteInStream<StreamBuf>&
GenericByteInStream<StreamBuf>::getArrayInt8(char *array, int count)
{
    BSLS_ASSERT_SAFE(array);
    BSLS_ASSERT_SAFE(0 <= count);
...
inline
GenericByteInStream<StreamBuf>&
GenericByteInStream<StreamBuf>::getArrayInt8(signed char *array,
                                                  int          count)
{
    BSLS_ASSERT_SAFE(array);
    BSLS_ASSERT_SAFE(0 <= count);
...
inline
GenericByteInStream<StreamBuf>&
GenericByteInStream<StreamBuf>::getArrayUint8(char *array, int count)
{
    BSLS_ASSERT_SAFE(array);
    BSLS_ASSERT_SAFE(0 <= count);
...
inline
GenericByteInStream<StreamBuf>&
GenericByteInStream<StreamBuf>::getArrayUint8(unsigned char *array,
                                                   int            count)
{
    BSLS_ASSERT_SAFE(array);
    BSLS_ASSERT_SAFE(0 <= count);
...
#endif
GenericByteInStream<StreamBuf>&
GenericByteInStream<StreamBuf>::getArrayFloat64(double *array, int count)
{
    BSLS_ASSERT_SAFE(array);
    BSLS_ASSERT_SAFE(0 <= count);
...
#endif
GenericByteInStream<StreamBuf>&
GenericByteInStream<StreamBuf>::getArrayFloat32(float *array, int count)
{
    BSLS_ASSERT_SAFE(array);
    BSLS_ASSERT_SAFE(0 <= count);
...
template <class StreamBuf>
inline
bdlxxxx::GenericByteInStream<StreamBuf>::operator const void *() const
{
...
{
    return InStreamMethodsUtil::streamInVersionAndObject(stream, object);
}
