...
//                              Overview
//                              --------
// We are testing a "test" implementation of the 'bdlxxxx::OutStream' protocol.
...
// [ 3] int length();
//
// [ 4] ostream& operator<<(ostream& stream, const bdlxxxx::TestOutStream&);
//-----------------------------------------------------------------------------
// [ 1] BREATHING TEST
//=============================================================================
...
// Type codes from bdlxxxx::FieldCode as bytes in string representation
#define INT8_FL    "\xe0"
#define UINT8_FL   "\xe1"
#define INT16_FL   "\xe2"
...
// bdlxxxx::FieldCode::INT8 as bits in string representation
...
typedef bdlxxxx::TestOutStream Obj;
...
int main(int argc, char *argv[]) {
    ...
    switch (test) { case 0:
      ...
      case 4: {
        ...
        //
        // Testing:
        //   ostream& operator<<(ostream&, const bdlxxxx::TestOutStream&);
        // --------------------------------------------------------------------
      ...
      case 2: {
        ...
        //   ~bdlxxxx::TestOutStream();  // via purify
        //   putInt8(int value);
        //   putUint8(int value);
        //   removeAll();
        // --------------------------------------------------------------------
      ...
      case 1: {
        // --------------------------------------------------------------------
        // BREATHING TEST:
        //   Create 'bdlxxxx::TestOutStream' objects using the default constructor,
