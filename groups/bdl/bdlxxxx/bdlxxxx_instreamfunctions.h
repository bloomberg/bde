...
//
//@SEE_ALSO: bdlxxxx_outstreamfunctions, bdlxxxx_versionfunctions
//
...
///------------------------------------------------------------
// 'bdlxxxx_instreamfunctions' is an integral part of the 'bdex' unexternalization
...
// 'bdlxxxx_instreamfunctions' plays several related but different roles in
// helping various developers to produce 'bdex'-compliant components.  In this
// section we briefly highlight how and why 'bdlxxxx_instreamfunctions' is helpful
...
///- - - - - - - - - - - - -
// One obvious design choice for 'bdlxxxx_instreamfunctions' is that it supports
...
namespace bdlxxxx {
struct InStreamFunctions_IsEnumType {
...
struct InStreamFunctions_IsNotEnumType {
    // This 'struct' is a dummy struct used to perform function overload
...
namespace bdex_InStreamFunctions {
    ...
    STREAM& streamIn_Imp(STREAM&                                  stream,
                         TYPE&                                    object,
                         int                                      ,
                         const bdlxxxx::InStreamFunctions_IsEnumType&)
    ...
    STREAM& streamIn_Imp(STREAM&                                     stream,
                         TYPE&                                       object,
                         int                                         version,
                         const bdlxxxx::InStreamFunctions_IsNotEnumType&)
        // Assign to the specified 'object' the value read from the specified
        ...
        // from 'stream'.
    {
        ...
        // bdlxxxx::InStreamFunctions_IsEnumType and
        // bdlxxxx::InStreamFunctions_IsNotEnumType to choose the correct function.

        typedef typename bslmf::If<bslmf::IsEnum<TYPE>::VALUE,
                                  bdlxxxx::InStreamFunctions_IsEnumType,
                                  bdlxxxx::InStreamFunctions_IsNotEnumType>::Type
                                                                     dummyType;
