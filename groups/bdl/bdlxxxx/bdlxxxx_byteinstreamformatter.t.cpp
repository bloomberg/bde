...
//                              Overview
//                              --------
// For all input methods in 'bdlxxxx::ByteInStreamFormatter', the
...
// first creating a 'bdlxxxx::ByteOutStreamFormatter' object 'oX' containing some
// arbitrarily chosen values.  The values are interleaved with chosen "marker"
// bytes to check for alignment issues.  We then create a 'bdlxxxx::ByteInStream'
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:
      case 24: {
        ...
        bdlxxxx::ByteOutStreamFormatter outStream(&osb);
        const int VERSION = 1;
        ...
        bdlsb::FixedMemInStreamBuf sb(buffer, osb.length());
        bdlxxxx::ByteInStreamFormatter inStream(&sb);
        int version;
      ...
      case 23: {
        ...
        {
            char workSpace[100];
            bdlsb::FixedMemOutStreamBuf osb(workSpace, 100);
            bdlxxxx::ByteOutStreamFormatter o(&osb);
            o.putLength(1);             o.putInt8(0xFF);
            o.putLength(128);           o.putInt8(0xFE);
            o.putLength(3);             o.putInt8(0xFD);

            bdlsb::FixedMemInStreamBuf isb(workSpace, 9);
            bdlxxxx::ByteInStreamFormatter x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
            int val;
        ...
        }
        {
            ...
            bdlsb::FixedMemInStreamBuf isb(workSpace, 12);
            bdlxxxx::ByteInStreamFormatter x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
            int val;
        ...
        if (verbose) cout << "\nTesting getVersion(int&)." << endl;
        {
            ...
            bdlsb::FixedMemInStreamBuf isb(workSpace, 4);
            bdlxxxx::ByteInStreamFormatter x(&isb);
            if (veryVerbose) { P(x) }
            int val;
      ...
      case 22: {
        ...
        if (verbose) cout << "\nTesting getArrayFloat64." << endl;
        {
            ...
            bdlsb::FixedMemInStreamBuf isb(workSpace, 52);
            bdlxxxx::ByteInStreamFormatter x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
            double ar[] = { V, V, V };
      ...
      case 21: {
        ...
        if (verbose) cout << "\nTesting getArrayFloat32." << endl;
        {
            ...
            bdlsb::FixedMemInStreamBuf isb(workSpace, 28);
            bdlxxxx::ByteInStreamFormatter x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
            float ar[] = { V, V, V };
      ...
      case 20: {
        ...
        if (verbose) cout << "\nTesting getArrayInt64." << endl;
        {
            ...
            bdlsb::FixedMemInStreamBuf isb(workSpace, 54);
            bdlxxxx::ByteInStreamFormatter x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
      ...
      case 19: {
        ...
        if (verbose) cout << "\nTesting getArrayInt56." << endl;
        {
            ...
            bdlsb::FixedMemInStreamBuf isb(workSpace, 46);
            bdlxxxx::ByteInStreamFormatter x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
            bsls::Types::Int64 ar[] = { V, V, V };
      ...
      case 18: {
        ...
        if (verbose) cout << "\nTesting getArrayInt48." << endl;
        {
            ...
            bdlsb::FixedMemInStreamBuf isb(workSpace, 40);
            bdlxxxx::ByteInStreamFormatter x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
            bsls::Types::Int64 ar[] = { V, V, V };
      ...
      case 17: {
        ...
        if (verbose) cout << "\nTesting getArrayInt40." << endl;
        {
            ...
            bdlsb::FixedMemInStreamBuf isb(workSpace, 34);
            bdlxxxx::ByteInStreamFormatter x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
            bsls::Types::Int64 ar[] = { V, V, V };
      ...
      case 15: {
        ...
        if (verbose) cout << "\nTesting getArrayInt24." << endl;
        {
            ...
            bdlsb::FixedMemInStreamBuf isb(workSpace, 22);
            bdlxxxx::ByteInStreamFormatter x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
            int ar[] = { V, V, V };
      ...
      case 14: {
        ...
        if (verbose) cout << "\nTesting getArrayInt16." << endl;
        {
            ...
            bdlsb::FixedMemInStreamBuf isb(workSpace, 16);
            bdlxxxx::ByteInStreamFormatter x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
            short ar[] = { V, V, V };
      ...
      case 13: {
        ...
        if (verbose) cout << "\nTesting getArrayInt8(char*, int)." << endl;
        {
            ...
            bdlsb::FixedMemInStreamBuf isb(workSpace, 10);
            bdlxxxx::ByteInStreamFormatter x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
            char ar[] = { V, V, V };
      ...
      case 12: {
        ...
        if (verbose) cout << "\nTesting getFloat64." << endl;
        {
            ...
            bdlsb::FixedMemInStreamBuf isb(workSpace, 27);
            bdlxxxx::ByteInStreamFormatter x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
            double val;
      ...
      case 11: {
        ...
        if (verbose) cout << "\nTesting getFloat32." << endl;
        {
            ...
            bdlsb::FixedMemInStreamBuf isb(workSpace, 15);
            bdlxxxx::ByteInStreamFormatter x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
            float val;
      ...
      case 9: {
        ...
        if (verbose) cout << "\nTesting getInt56." << endl;
        {
            ...
            bdlsb::FixedMemInStreamBuf isb(workSpace, 24);
            bdlxxxx::ByteInStreamFormatter x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
            bsls::Types::Int64 val;
      ...
      case 8: {
        ...
        if (verbose) cout << "\nTesting getInt48." << endl;
        {
            ...
            bdlsb::FixedMemInStreamBuf isb(workSpace, 21);
            bdlxxxx::ByteInStreamFormatter x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
            bsls::Types::Int64 val;
      ...
      case 7: {
        ...
        if (verbose) cout << "\nTesting getInt40." << endl;
        {
            ...
            bdlsb::FixedMemInStreamBuf isb(workSpace, 18);
            bdlxxxx::ByteInStreamFormatter x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
            bsls::Types::Int64 val;
      ...
      case 2: {
        ...
        //   For each independent test, create bdlxxxx::ByteInStreamFormatter
        ...
        {
            char workSpace[100];
            bdlsb::FixedMemInStreamBuf isb(workSpace, 100);
            bdlxxxx::ByteInStreamFormatter x0(&isb);
        ...
        for (int i = 0; i < 5; i++) {
            // test default bdlxxxx::ByteInStreamFormatterects
            char workSpace[100];
            bdlsb::FixedMemInStreamBuf isb(workSpace, 100);
            bdlxxxx::ByteInStreamFormatter x(&isb);
      ...
      case 1: {
        // --------------------------------------------------------------------
        // BREATHING TEST:
        //   Create 'bdlxxxx::ByteInStreamFormatter' containing various data.
        //   Exercise these bdlxxxx::ByteInStreamFormatter using appropriate input
        //   methods and primary manipulators, then verify the state of the
        //   resulting bdlxxxx::ByteInStreamFormatter using basic accessors.
        //
        // Testing:
        ...
        if (verbose) cout <<
             "\nCreate bdlxxxx::ByteInStreamFormatter x1 using default ctor."
             << endl;

        int i;
        char workSpace[1];
        bdlsb::FixedMemInStreamBuf sb(workSpace, 1);
        bdlxxxx::ByteInStreamFormatter x1(&sb);

        {
            if (verbose)
          cout << "\nCreate bdlxxxx::ByteInStreamFormatter x2 w/ an initial value."
               << endl;

            bdlsb::FixedMemInStreamBuf sb2("\x00\x01\x02\x03\x04", 5);
            bdlxxxx::ByteInStreamFormatter x2(&sb2);
      ...
      case -1: {
        ...
        if (verbose) cout << "\nTest performance on ctor+putInt8+dtor.\n";
        {
            ...
            for (int i = 0; i <= NUM_OUT_ITERS; ++i) {
                ...
                bdlxxxx::ByteInStreamFormatter xi(&sbi);
                bdlxxxx::ByteOutStreamFormatter xo(&sbo);
