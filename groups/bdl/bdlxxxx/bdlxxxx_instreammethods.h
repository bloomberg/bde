...
//
//@SEE_ALSO: bdlxxxx_instreamfunctions, bdlxxxx_outstreammethods
//
//@DEPRECATED: This component should not be used for new code.  Use (and
// specialize the functions in 'bdlxxxx_instreamfunctions', instead.
//
...
// 'enum' types such as 'bdlt::DayOfWeek::Enum') to provide the appropriate
// specialization of 'bdex_InStreamMethods' for that entity.
//
///Component Design, Anticipated Usage, and the 'bdex' Contract
///------------------------------------------------------------
// 'bdlxxxx_instreammethods' is an integral part of the 'bdex' externalization
...
// 'bdlxxxx_instreammethods' plays several related but different roles in helping
// various developers to produce 'bdex'-compliant components.  In this section
// we briefly highlight how and why 'bdlxxxx_instreammethods' is helpful (or
...
// (e.g., 'bdlt::DayOfWeek::Enum') must also define a corresponding
// specialization of the form:
//..
//    template <>
//    class bdex_InStreamMethods<bdlt::DayOfWeek::Enum>
//..
...
// 'bdlxxxx::ByteInStreamFormatter'), but this factoring is not central to the
...
//  template <>
//  inline
//  bdlxxxx::ByteInStream& operator>>(bdlxxxx::ByteInStream& stream,
//                                int&               variable)
//  {
...
/// - - - - - - - - - - - -
// One obvious design choice for 'bdlxxxx_instreammethods' is that it supports the
...
struct InStreamMethodsUtil {
  ...
  public:
    ...
    static STREAM& streamInVersionAndObject(STREAM& stream, TYPE& object) {
        ...
        // 'GenericInStreamMethods', which the unspecialized
