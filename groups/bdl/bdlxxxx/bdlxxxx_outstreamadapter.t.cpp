...
// CREATORS
// [ 2] virtual bdlxxxx::OutStreamAdapter<STREAM>(STREAM *stream);
// [ 2] virtual ~bdlxxxx::OutStreamAdapter();
//
// MANIPULATORS
...
//..
      ...
      case 3: {
        ...
        MyOutStream myS;
        bdlxxxx::OutStreamAdapter<MyOutStream> s(&myS);
        const bdlxxxx::OutStreamAdapter<MyOutStream>& S = s;
      ...
      case 1: {
        // --------------------------------------------------------------------
        // BREATHING TEST:
        //   Create 'bdlxxxx::OutStreamAdapter' object templated on the
        //   'bdlxxxx::ByteOutStream' class.  This ensures that the template gets
        ...
        bdlxxxx::ByteOutStream bs;
        bdlxxxx::OutStreamAdapter<bdlxxxx::ByteOutStream> s(&bs);
