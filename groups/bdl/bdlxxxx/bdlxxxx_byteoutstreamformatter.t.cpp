...
//                              Overview
//                              --------
// For all output methods in 'bdlxxxx::ByteOutStreamFormatter', the formatting of
...
// 'bdlxxxx::ByteOutStreamFormatter' to be 'putInt8'.
//-----------------------------------------------------------------------------
// [ 2] bdlxxxx::ByteOutStreamFormatter(bsl::streambuf *);
// [ 2] ~bdlxxxx::ByteOutStreamFormatter();
// [24] bdlxxxx::ByteOutStreamFormatter& flush();
// [23] void invalidate();
...
typedef bdlxxxx::ByteOutStreamFormatter Obj;
...
class my_FixedMemOutStreamBuf : public bdlsb::FixedMemOutStreamBuf
{
...
{
    ++d_flushCount;
    return bdlsb::FixedMemOutStreamBuf::sync();
}

// CREATORS
my_FixedMemOutStreamBuf::my_FixedMemOutStreamBuf(char            *buffer,
                                                 bsl::streamsize  length)
: bdlsb::FixedMemOutStreamBuf(buffer, length)
, d_flushCount(0)
{
}
...
// }
      ...
      case 24: {
        ...
        //
        // Testing:
        //   operator<<(bdlxxxx::BdexByteOutStreamFormatter&, bdexFlush);
        // --------------------------------------------------------------------
      ...
      case 22: {
                          ...
                          << "===========================" << endl;
        {
            ...
            {
                char workSpace[100];
                bdlsb::FixedMemOutStreamBuf sb(workSpace, 100);
                Obj x(&sb);
                                    x.putInt8(0xff);
      ...
      case 2: {
        ...
        //
        // Testing:
        //   bdlxxxx::ByteOutStreamFormatter(bsl::streambuf *);
        //   ~bdlxxxx::ByteOutStreamFormatter();  // via purify
        //   putInt8(int value);
        //   putUint8(int value);
        //   removeAll();
      ...
      case 1: {
        // --------------------------------------------------------------------
        // BREATHING TEST:
        //   Create 'bdlxxxx::ByteOutStreamFormatter' objects using default and
      ...
      case -1: {
        ...
        if (verbose)
            cout << "\nPERFORMANCE TEST FOR 'bdlxxxx::BdexByteOutStreamFormatter'"
                 << "\n======================================================"
                 << endl;
        ...
        if (verbose) cout << "\nTest performance on ctor+putInt8+dtor.\n";
        {
            ...
            for (int i = 0; i <= NUM_OUT_ITERS; ++i) {
                bdlsb::FixedMemOutStreamBuf sb(workSpace, SIZE);
                Obj x1(&sb);
