...
//
//@CLASSES:
//   bdlxxxx::ByteOutStream: byte-array-based output stream class
//
//@AUTHOR: Shao-wei Hung
//
//@SEE_ALSO: bdlxxxx_byteinstream, bdlxxxx_byteinstreamraw
//
...
// 'bdlxxxx_byteinstream' "unexternalization" component.  Each output method of
// 'bdlxxxx::ByteOutStream' writes a value or a homogeneous array of values to an
// internally managed buffer.  The values are formatted to be readable by the
// corresponding 'bdlxxxx::ByteInStream' method.  'bdlxxxx::ByteInStreamRaw' may also
// be used to read buffers written by this stream; see the
// 'bdlxxxx_byteinstreamraw' component documentation for more information about
// "raw" stream interoperability.  In general, the user cannot rely on any
// other mechanism to read data written by 'bdlxxxx::ByteOutStream' unless that
...
///Usage
///-----
// The 'bdlxxxx::ByteOutStream' implementation of the 'bdlxxxx::OutStream' protocol can
...
// 'bdlxxxx::ByteOutStream', and then writes the contents of the 'bdex' stream's
// buffer to 'stdout'.
//..
...
class ByteOutStream {
    ...
    ByteOutStreamFormatter d_formatter;     // formatter
  ...
  public:
    // CREATORS
    ByteOutStream(bslma::Allocator *basicAllocator = 0);
    ...
    ByteOutStream(int               initialCapacity,
...
// TBD #endif  // BDE_OMIT_DEPRECATED
    ...
    ByteOutStream& putArrayInt64(const bsls::Types::Int64 *array,
                                      int                       count);
    ...
    ByteOutStream& putArrayUint64(const bsls::Types::Uint64 *array,
                                       int                        count);
        // Format as an atomic sequence the least significant 64 bits of each
        // of the specified 'count' leading entries in the specified 'array' to
        // this output stream and return a reference to this modifiable stream.
    ...
    ByteOutStream& putArrayInt56(const bsls::Types::Int64 *array,
                                      int                       count);
    ...
    ByteOutStream& putArrayUint56(const bsls::Types::Uint64 *array,
                                       int                        count);
        // Format as an atomic sequence the least significant 56 bits of each
        // of the specified 'count' leading entries in the specified 'array' to
        // this output stream and return a reference to this modifiable stream.
    ...
    ByteOutStream& putArrayInt48(const bsls::Types::Int64 *array,
                                      int                       count);
    ...
    ByteOutStream& putArrayUint48(const bsls::Types::Uint64 *array,
                                       int                        count);
        // Format as an atomic sequence the least significant 48 bits of each
        // of the specified 'count' leading entries in the specified 'array' to
        // this output stream and return a reference to this modifiable stream.
    ...
    ByteOutStream& putArrayInt40(const bsls::Types::Int64 *array,
                                      int                       count);
    ...
    ByteOutStream& putArrayUint40(const bsls::Types::Uint64 *array,
                                       int                        count);
        // Format as an atomic sequence the least significant 40 bits of each
        // of the specified 'count' leading entries in the specified 'array' to
        // this output stream and return a reference to this modifiable stream.
    ...
    ByteOutStream& putArrayInt32(const int *array, int count);
    ...
    ByteOutStream& putArrayUint32(const unsigned int *array, int count);
        // Format as an atomic sequence the least significant 32 bits of each
        // of the specified 'count' leading entries in the specified 'array' to
        // this output stream and return a reference to this modifiable stream.
        // The behavior is undefined unless '0 <= count'.
    ...
    ByteOutStream& putArrayInt24(const int *array, int count);
    ...
    ByteOutStream& putArrayUint24(const unsigned int *array,
                                       int                 count);
        // Format as an atomic sequence the least significant 24 bits of each
        // of the specified 'count' leading entries in the specified 'array' to
        // this output stream and return a reference to this modifiable stream.
    ...
    ByteOutStream& putArrayInt16(const short *array, int count);
    ...
    ByteOutStream& putArrayUint16(const unsigned short *array,
                                       int                   count);
        // Format as an atomic sequence the least significant 16 bits of each
        // of the specified 'count' leading entries in the specified 'array' to
        // this output stream and return a reference to this modifiable stream.
    ...
    ByteOutStream& putArrayInt8(const char *array, int count);
    ByteOutStream& putArrayInt8(const signed char *array, int count);
    ...
    ByteOutStream& putArrayUint8(const char *array, int count);
    ByteOutStream& putArrayUint8(const unsigned char *array, int count);
        // Format as an atomic sequence the least significant 8 bits of each of
        // the specified 'count' leading entries in the specified 'array' to
        // this output stream and return a reference to this modifiable stream.
        // The behavior is undefined unless '0 <= count'.
    ...
    ByteOutStream& putArrayFloat64(const double *array, int count);
    ...
    ByteOutStream& putArrayFloat32(const float *array, int count);
...
inline
ByteOutStream&
ByteOutStream::putArrayUint24(const unsigned int *array, int count)
{
    BSLS_ASSERT_SAFE(array);
    BSLS_ASSERT_SAFE(0 <= count);
...
inline
ByteOutStream&
ByteOutStream::putArrayUint16(const unsigned short *array, int count)
{
    BSLS_ASSERT_SAFE(array);
    BSLS_ASSERT_SAFE(0 <= count);
...
// ACCESSORS
inline
bdlxxxx::ByteOutStream::operator const void *() const
{
