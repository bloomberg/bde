...
//                              Overview
//                              --------
// For all input methods in 'bdlxxxx::GenericByteInStream', the "unexternalization"
...
// a 'bdlxxxx::GenericByteOutStream' object 'oX' containing some arbitrarily chosen
// values.  The values are interleaved with chosen "marker" bytes to check for
// alignment issues.  We then create a 'bdlxxxx::GenericByteInStream' object 'iX'
...
// 'bdlsb::FixedMemInput' parameter, but test case [24] verifies that it can be
...
class my_FixedMemInStreamBuf {
    // This class implements a very basic 'bdlsb::FixedMemInput' suitable
    // for use in 'bdlxxxx::GenericByteInStream'.
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:
      case 25: {
        ...
        bdlxxxx::GenericByteOutStream<bdlsb::FixedMemOutStreamBuf> outStream(&osb);
        const int VERSION = 1;
      ...
      case 24: {
        // --------------------------------------------------------------------
        // CLASS 'bdlxxxx::GenericByteInStream'
        //
        // Concerns:
        //   That 'bdlxxxx::GenericBdexByteInStream' can be parameterized
        ...
        //
        // Testing:
        //   CLASS 'bdlxxxx::GenericBdexByteInStream'
        // --------------------------------------------------------------------

        if (verbose)
         cout << "\nBREATHING TEST FOR 'bdlxxxx::GenericBdexByteInStream'"
              << "\n================================================="
              << endl;
        ...
        if (verbose)
            cout << "\nCreate bdlxxxx::GenericByteInStream x1 using default ctor."
                 << endl;
        int i;
        char workSpace[1];
        my_FixedMemInStreamBuf sb(workSpace, 1);
        bdlxxxx::GenericByteInStream<my_FixedMemInStreamBuf> x1(&sb);

        if (verbose)
            cout << "\nCreate bdlxxxx::GenericByteInStream x2 w/ an initial value."
                 << endl;
        my_FixedMemInStreamBuf sb2(const_cast<char *>("\x00\x01\x02\x03\x04"),
                                   5);
        bdlxxxx::GenericByteInStream<my_FixedMemInStreamBuf> x2(&sb2);
      ...
      case 23: {
        ...
        {
            char workSpace[100];
            bdlsb::FixedMemOutput osb(workSpace, 100);
            bdlxxxx::GenericByteOutStream<bdlsb::FixedMemOutput> o(&osb);
            o.putLength(1);             o.putInt8(0xFF);
            o.putLength(128);           o.putInt8(0xFE);
            o.putLength(3);             o.putInt8(0xFD);

            bdlsb::FixedMemInput isb(workSpace, 9);
            bdlxxxx::GenericByteInStream<bdlsb::FixedMemInput> x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
            int val;
        ...
        }
        {
            ...
            bdlsb::FixedMemInput isb(workSpace, 12);
            bdlxxxx::GenericByteInStream<bdlsb::FixedMemInput> x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
            int val;
        ...
        if (verbose) cout << "\nTesting getVersion(int&)." << endl;
        {
            ...
            bdlsb::FixedMemInput isb(workSpace, 4);
            bdlxxxx::GenericByteInStream<bdlsb::FixedMemInput> x(&isb);
            if (veryVerbose) { P(x) }
            int val;
      ...
      case 22: {
        ...
        if (verbose) cout << "\nTesting getArrayFloat64." << endl;
        {
            ...
            bdlsb::FixedMemInput isb(workSpace, 52);
            bdlxxxx::GenericByteInStream<bdlsb::FixedMemInput> x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
            double ar[] = { V, V, V };
      ...
      case 21: {
        ...
        if (verbose) cout << "\nTesting getArrayFloat32." << endl;
        {
            ...
            bdlsb::FixedMemInput isb(workSpace, 28);
            bdlxxxx::GenericByteInStream<bdlsb::FixedMemInput> x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
            float ar[] = { V, V, V };
      ...
      case 20: {
        ...
        if (verbose) cout << "\nTesting getArrayInt64." << endl;
        {
            ...
            bdlsb::FixedMemInput isb(workSpace, 54);
            bdlxxxx::GenericByteInStream<bdlsb::FixedMemInput> x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
      ...
      case 19: {
        ...
        if (verbose) cout << "\nTesting getArrayInt56." << endl;
        {
            ...
            bdlsb::FixedMemInput isb(workSpace, 46);
            bdlxxxx::GenericByteInStream<bdlsb::FixedMemInput> x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
            bsls::Types::Int64 ar[] = { V, V, V };
      ...
      case 18: {
        ...
        if (verbose) cout << "\nTesting getArrayInt48." << endl;
        {
            ...
            bdlsb::FixedMemInput isb(workSpace, 40);
            bdlxxxx::GenericByteInStream<bdlsb::FixedMemInput> x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
            bsls::Types::Int64 ar[] = { V, V, V };
      ...
      case 17: {
        ...
        if (verbose) cout << "\nTesting getArrayInt40." << endl;
        {
            ...
            bdlsb::FixedMemInput isb(workSpace, 34);
            bdlxxxx::GenericByteInStream<bdlsb::FixedMemInput> x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
            bsls::Types::Int64 ar[] = { V, V, V };
      ...
      case 15: {
        ...
        if (verbose) cout << "\nTesting getArrayInt24." << endl;
        {
            ...
            bdlsb::FixedMemInput isb(workSpace, 22);
            bdlxxxx::GenericByteInStream<bdlsb::FixedMemInput> x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
            int ar[] = { V, V, V };
      ...
      case 14: {
        ...
        if (verbose) cout << "\nTesting getArrayInt16." << endl;
        {
            ...
            bdlsb::FixedMemInput isb(workSpace, 16);
            bdlxxxx::GenericByteInStream<bdlsb::FixedMemInput> x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
            short ar[] = { V, V, V };
      ...
      case 13: {
        ...
        if (verbose) cout << "\nTesting getArrayInt8(char*, int)." << endl;
        {
            ...
            bdlsb::FixedMemInput isb(workSpace, 10);
            bdlxxxx::GenericByteInStream<bdlsb::FixedMemInput> x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
            char ar[] = { V, V, V };
      ...
      case 12: {
        ...
        if (verbose) cout << "\nTesting getFloat64." << endl;
        {
            ...
            bdlsb::FixedMemInput isb(workSpace, 27);
            bdlxxxx::GenericByteInStream<bdlsb::FixedMemInput> x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
            double val;
      ...
      case 11: {
        ...
        if (verbose) cout << "\nTesting getFloat32." << endl;
        {
            ...
            bdlsb::FixedMemInput isb(workSpace, 15);
            bdlxxxx::GenericByteInStream<bdlsb::FixedMemInput> x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
            float val;
      ...
      case 9: {
        ...
        if (verbose) cout << "\nTesting getInt56." << endl;
        {
            ...
            bdlsb::FixedMemInput isb(workSpace, 24);
            bdlxxxx::GenericByteInStream<bdlsb::FixedMemInput> x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
            bsls::Types::Int64 val;
      ...
      case 8: {
        ...
        if (verbose) cout << "\nTesting getInt48." << endl;
        {
            ...
            bdlsb::FixedMemInput isb(workSpace, 21);
            bdlxxxx::GenericByteInStream<bdlsb::FixedMemInput> x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
            bsls::Types::Int64 val;
      ...
      case 7: {
        ...
        if (verbose) cout << "\nTesting getInt40." << endl;
        {
            ...
            bdlsb::FixedMemInput isb(workSpace, 18);
            bdlxxxx::GenericByteInStream<bdlsb::FixedMemInput> x(&isb);
            if (veryVerbose) { P(x) }
            char marker;
            bsls::Types::Int64 val;
      ...
      case 2: {
        ...
        //   For each independent test, create bdlxxxx::GenericByteInStream objects
        ...
        //   state of the bdlxxxx::GenericByteInStream objects.
        //
        // Testing
        //   bdlxxxx::ByteInStream();
        //   bdlxxxx::ByteInStream(const char *buffer, int numBytes);
        //   ~bdlxxxx::ByteInStream();   // by purify
        ...
        {
            char workSpace[100];
            bdlsb::FixedMemInput isb(workSpace, 100);
            bdlxxxx::GenericByteInStream<bdlsb::FixedMemInput> x0(&isb);
        ...
        for (int i = 0; i < 5; i++) {
            // test default bdlxxxx::GenericByteInStream<bdlsb::FixedMemInput>
            char workSpace[100];
            bdlsb::FixedMemInput isb(workSpace, 100);
            bdlxxxx::GenericByteInStream<bdlsb::FixedMemInput> x(&isb);
      ...
      case 1: {
        // --------------------------------------------------------------------
        // BREATHING TEST:
        //   Create 'bdlxxxx::GenericByteInStream' containing various data.
        //   Exercise these bdlxxxx::GenericByteInStream using appropriate input
        //   methods and primary manipulators, then verify the state of the
        //   resulting bdlxxxx::GenericByteInStream using basic accessors.
        //
        // Testing:
        ...
        int i;
        char workSpace[1];
        bdlsb::FixedMemInput sb(workSpace, 1);
        bdlxxxx::GenericByteInStream<bdlsb::FixedMemInput> x1(&sb);

        if (verbose)
            cout << "\nCreate bdlxxxx::GenericByteInStream x2 w/ an initial value."
                 << endl;

        bdlsb::FixedMemInput sb2(const_cast<char *>("\x00\x01\x02\x03\x04"), 5);
        bdlxxxx::GenericByteInStream<bdlsb::FixedMemInput> x2(&sb2);
      ...
      case -1: {
        ...
        if (verbose) cout << "\nWith bdesb::FixedMemIn/Output:" << endl;
        ...
        if (verbose) cout << "\tTest performance on ctor+putInt8+dtor.\n";
        {
            ...
            for (int i = 0; i <= NUM_OUT_ITERS; ++i) {
                char marker = 0;
                bdlsb::FixedMemOutput  sbo(workSpace, SIZE);
                bdlxxxx::GenericByteOutStream<bdlsb::FixedMemOutput> xo(&sbo);
                bdlsb::FixedMemInput  sbi(workSpace, SIZE);
                bdlxxxx::GenericByteInStream<bdlsb::FixedMemInput> xi(&sbi);
        ...
        if (verbose) cout << "\nWith bdesb::FixedMemIn/OutStreamBuf:" << endl;
        ...
        if (verbose) cout << "\tTest performance on ctor+putInt8+dtor.\n";
        {
            ...
            for (int i = 0; i <= NUM_OUT_ITERS; ++i) {
                char marker = 0;
                bdlsb::FixedMemOutStreamBuf sbo(workSpace, SIZE);
                bdlxxxx::GenericByteOutStream<bdlsb::FixedMemOutStreamBuf> xo(&sbo);
                bdlsb::FixedMemInStreamBuf sbi(workSpace, SIZE);
                bdlxxxx::GenericByteInStream<bdlsb::FixedMemInStreamBuf> xi(&sbi);
                for (int j = 0; j < NUM_ITERS; ++j) {
                    xo.putInt8(0x7f); // value does not matter
                    xi.getInt8(marker);
                }
