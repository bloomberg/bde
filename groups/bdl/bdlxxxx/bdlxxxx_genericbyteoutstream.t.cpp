...
#include <bdlsb_fixedmemoutput.h>               // for testing only
...
//                              Overview
//                              --------
// For all output methods in 'bdlxxxx::GenericByteOutStream', the formatting of
...
// 'bdlxxxx::GenericByteOutStream' to be 'putInt8'.
//
// The class under test is a class template, so we choose to test it with a
// 'bdlsb::FixedMemOutput' parameter, but test case [25] verifies that it can be
// instantiated by a class that has the minimal requirements.
//-----------------------------------------------------------------------------
// [ 2] bdlxxxx::GenericByteOutStream(bsl::streambuf *);
// [ 2] ~bdlxxxx::GenericByteOutStream();
// [24] bdlxxxx::GenericByteOutStream& flush();
// [23] void invalidate();
...
typedef bdlxxxx::GenericByteOutStream<bdlsb::FixedMemOutput> Obj;
...
class my_FixedMemOutStreamBuf {
    // This class implements a very basic 'bdlsb::FixedMemOutput' suitable
    // for use in 'bdlxxxx::GenericByteOutStream'.
...
//  }
      ...
      case 25: {
        // --------------------------------------------------------------------
        // CLASS 'bdlxxxx::GenericBdexByteOutStream'
        // Concerns:
        //   That 'bdlxxxx::GenericBdexByteOutStream' can be parameterized
        ...
        if (verbose)
            cout << "\nGENERIC TEST FOR 'bdlxxxx::GenericBdexByteOutStream'"
                 << "\n================================================"
                 << endl;
      ...
      case 24: {
        ...
        //
        // Testing:
        //   operator<<(bdlxxxx::BdexByteOutStream&, bdexFlush);
        // --------------------------------------------------------------------
        ...
        using namespace genericTest;
        typedef bdlxxxx::GenericByteOutStream<my_FixedMemOutStreamBuf> Obj;
      ...
      case 22: {
                          ...
                          << "===========================" << endl;
        {
            ...
            {
                char workSpace[100];
                bdlsb::FixedMemOutput sb(workSpace, 100);
                Obj x(&sb);
                                    x.putInt8(0xff);
      ...
      case 2: {
        ...
        //
        // Testing:
        //   bdlxxxx::GenericByteOutStream(bsl::streambuf *);
        //   ~bdlxxxx::GenericByteOutStream();  // via purify
        //   putInt8(int value);
        //   putUint8(int value);
        //   removeAll();
      ...
      case 1: {
        // --------------------------------------------------------------------
        // BREATHING TEST:
        //   Create 'bdlxxxx::GenericByteOutStream' objects using default and
      ...
      case -1: {
            ...
            cout << "\tTest performance on ctor+putInt8+dtor." << endl;
        {
            ...
            for (int i = 0; i <= NUM_OUT_ITERS; ++i) {
                bdlsb::FixedMemOutput sb(workSpace, SIZE);
                bdlxxxx::GenericByteOutStream<bdlsb::FixedMemOutput> x1(&sb);
        ...
        if (verbose) cout << "\nWith bdlsb::FixedMemOutStreamBuf:" << endl;
