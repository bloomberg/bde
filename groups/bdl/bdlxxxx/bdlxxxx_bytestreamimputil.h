...
//
//@CLASSES:
//   bdlxxxx::ByteStreamImpUtil: namespace for put/get externalization functions
//
//@AUTHOR: John Lakos (jlakos)
//
//@SEE_ALSO: bdlxxxx_byteinstream, bdlxxxx_byteoutstream
//
...
///-------------------------------------
// The names and interfaces of the methods of 'bdlxxxx::ByteStreamImpUtil' follow a
...
///Example 1
///- - - - -
// The 'bdlxxxx::ByteStreamImpUtil' component can be used stand-alone to save
...
// objects derived from abstract streaming interfaces such as 'bdlxxxx::InStream'
// and 'bdlxxxx::OutStream' (see 'bdlxxxx::ByteInStream' and 'bdlxxxx::ByteOutStream).
...
inline
void ByteStreamImpUtil::getUint32(unsigned int *variable,
                                       const char   *buffer)
{
    BSLS_ASSERT_SAFE(variable);
    BSLS_ASSERT_SAFE(buffer);
...
inline
void ByteStreamImpUtil::getUint24(unsigned int *variable,
                                       const char   *buffer)
{
    BSLS_ASSERT_SAFE(variable);
    BSLS_ASSERT_SAFE(buffer);
...
inline
void ByteStreamImpUtil::getUint16(unsigned short *variable,
                                       const char     *buffer)
{
    BSLS_ASSERT_SAFE(variable);
    BSLS_ASSERT_SAFE(buffer);
...
inline
void ByteStreamImpUtil::getInt8(unsigned char *variable,
                                     const char    *buffer)
{
    BSLS_ASSERT_SAFE(variable);
    BSLS_ASSERT_SAFE(buffer);
...
inline
void ByteStreamImpUtil::getArrayInt8(char       *array,
                                          const char *buffer,
                                          int         count)
{
    BSLS_ASSERT_SAFE(buffer);
...
inline
void ByteStreamImpUtil::getArrayInt8(signed char *array,
                                          const char  *buffer,
                                          int          count)
{
    BSLS_ASSERT_SAFE(buffer);
...
inline
void ByteStreamImpUtil::getArrayInt8(unsigned char *array,
                                          const char    *buffer,
                                          int            count)
{
    BSLS_ASSERT_SAFE(buffer);
