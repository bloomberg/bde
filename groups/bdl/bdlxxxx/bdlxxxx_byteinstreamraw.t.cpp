// bdlxxxx_byteinstreamraw.t.cpp                                         -*-C++-*-

#include <bdlxxxx_byteinstreamraw.h>
...
//                              Overview
//                              --------
// For all input methods in 'bdlxxxx::ByteInStreamRaw', the "unexternalization"
...
// a 'bdlxxxx::ByteOutStream' object 'oX' containing some arbitrarily chosen
// values.  The values are interleaved with chosen "marker" bytes to check for
// alignment issues.  We then create a 'bdlxxxx::ByteInStreamRaw' object 'iX'
...
//-----------------------------------------------------------------------------
// [ 2] bdlxxxx::ByteInStreamRaw();
// [ 2] bdlxxxx::ByteInStreamRaw(const char *buffer, int numBytes);
// [ 2] ~bdlxxxx::ByteInStreamRaw();
...
// [ 3] int cursor() const;
//
// [ 4] ostream& operator<<(ostream& stream, const bdlxxxx::ByteInStreamRaw& obj);
//-----------------------------------------------------------------------------
// [ 1] BREATHING TEST
// [26] USAGE EXAMPLE
//=============================================================================
...
typedef bdlxxxx::ByteInStreamRaw Obj;
typedef bdlxxxx::ByteOutStreamRaw Out;
...
// non-'const' method) 'bdlxxxx::StreamIn'.  This example shows how to implement
...
// int main(int argc, char *argv[])
   {
       ...
       bdlxxxx::ByteOutStreamRaw outStream(buffer);
       const int             VERSION = 1;
...
//..
// Now create a 'bdlxxxx::ByteInStreamRaw' 'inStream' initialized with the
// user-supplied 'buffer' that was provided to the 'bdlxxxx::ByteOutStreamRaw'
// object 'outStream'.  Note that 'bdlxxxx::ByteOutStreamRaw' has 'data' and
// 'length' accessors, and so may be used exactly as 'bdlxxxx::ByteOutStream', but
...
//..
       bdlxxxx::ByteInStreamRaw inStream(buffer, BUFFER_SIZE);
       int version;
...
//     return 0;
      ...
      case 4: {
        ...
        //
        // Testing:
        //   ostream& operator<<(ostream&, const bdlxxxx::ByteInStreamRaw&);
        // --------------------------------------------------------------------
      ...
      case 2: {
        ...
        //
        // Testing
        //   bdlxxxx::ByteInStreamRaw();
        //   bdlxxxx::ByteInStreamRaw(const char *buffer, int numBytes);
        //   ~bdlxxxx::ByteInStreamRaw();   // by purify
      ...
      case 1: {
        // --------------------------------------------------------------------
        // BREATHING TEST:
        //   Create 'bdlxxxx::ByteInStreamRaw' objects containing various data.
