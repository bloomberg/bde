...
//                              Overview
//                              --------
// For all output methods in 'bdlxxxx::ByteOutStream', the formatting of the input
...
//
// We have chosen the primary black-box manipulator for 'bdlxxxx::ByteOutStream'
// to be 'putInt8'.
//-----------------------------------------------------------------------------
// [ 2] bdlxxxx::ByteOutStream(*ba = 0);
// [ 2] bdlxxxx::ByteOutStream(int initialCapacity, *ba = 0);
// [ 2] ~bdlxxxx::ByteOutStream();
// [25] void invalidate();
...
// [ 3] int length();
//
// [ 4] ostream& operator<<(ostream& stream, const bdlxxxx::ByteOutStream&);
//-----------------------------------------------------------------------------
// [ 1] BREATHING TEST
// [26] USAGE
//=============================================================================
...
typedef bdlxxxx::ByteOutStream Obj;
...
// example of using 'bdex' streams with a value-semantic type.
      ...
      case 4: {
        ...
        //
        // Testing:
        //   ostream& operator<<(ostream&, const bdlxxxx::ByteOutStream&);
        // --------------------------------------------------------------------
      ...
      case 2: {
        ...
        //
        // Testing:
        //   bdlxxxx::ByteOutStream(*ba = 0);
        //   bdlxxxx::ByteOutStream(int initialCapacity, *ba = 0);
        //   ~bdlxxxx::ByteOutStream();  // via purify
        //   putInt8(int value);
        //   putUint8(int value);
        //   removeAll();
        ...
        if (verbose) cout << "\nTesting putInt8, reserveCapacity, and "
                          << "constructor." << endl;
        {
            int allocations = ta.numAllocations();
            Obj x(100, &ta);
            ASSERT(0 == x.length());
        ...
        }
        {
            Obj x(&ta);
            int allocations = ta.numAllocations();
            x.reserveCapacity(300);     // Make larger than default
            ASSERT(0 == x.length());
            ASSERT(allocations + 1 == ta.numAllocations());
            x.putInt8(5);
            x.putInt8(6);
      ...
      case 1: {
        // --------------------------------------------------------------------
        // BREATHING TEST:
        //   Create 'bdlxxxx::ByteOutStream' objects using default and copy
