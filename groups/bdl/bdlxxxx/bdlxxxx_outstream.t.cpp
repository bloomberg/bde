...
class MyOutStream : public bdlxxxx::OutStream {
  ...
  public:
    ...
    bdlxxxx::OutStream& putLength(int length)   { d_fun =  10; return *this; }
    bdlxxxx::OutStream& putVersion(int version) { d_fun =  11; return *this; }

    bdlxxxx::OutStream& putInt64(Int64 value)   { d_fun = -64; return *this; }
    bdlxxxx::OutStream& putUint64(Int64 value)  { d_fun = +64; return *this; }
    bdlxxxx::OutStream& putInt56(Int64 value)   { d_fun = -56; return *this; }
    bdlxxxx::OutStream& putUint56(Int64 value)  { d_fun = +56; return *this; }
    bdlxxxx::OutStream& putInt48(Int64 value)   { d_fun = -48; return *this; }
    bdlxxxx::OutStream& putUint48(Int64 value)  { d_fun = +48; return *this; }
    bdlxxxx::OutStream& putInt40(Int64 value)   { d_fun = -40; return *this; }
    bdlxxxx::OutStream& putUint40(Int64 value)  { d_fun = +40; return *this; }
    bdlxxxx::OutStream& putInt32(int value)     { d_fun = -32; return *this; }
    bdlxxxx::OutStream& putUint32(unsigned int value)
                                            { d_fun = +32; return *this; }
    bdlxxxx::OutStream& putInt24(int value)     { d_fun = -24; return *this; }
    bdlxxxx::OutStream& putUint24(int value)    { d_fun = +24; return *this; }
    bdlxxxx::OutStream& putInt16(int value)     { d_fun = -16; return *this; }
    bdlxxxx::OutStream& putUint16(int value)    { d_fun = +16; return *this; }
    bdlxxxx::OutStream& putInt8(int value)      { d_fun =  -8; return *this; }
    bdlxxxx::OutStream& putUint8(int value)     { d_fun =  +8; return *this; }
    bdlxxxx::OutStream& putFloat64(double value){ d_fun = 164; return *this; }
    bdlxxxx::OutStream& putFloat32(float value) { d_fun = 132; return *this; }

    typedef bsls::Types::Uint64 Uint64;

    bdlxxxx::OutStream& putArrayInt64(const Int64 *array, int count)
                                            { d_fun = -1064; return *this; }
    bdlxxxx::OutStream& putArrayUint64(const Uint64 *array, int count)
                                            { d_fun = +1064; return *this; }
    bdlxxxx::OutStream& putArrayInt56(const Int64 *array, int count)
                                            { d_fun = -1056; return *this; }
    bdlxxxx::OutStream& putArrayUint56(const Uint64 *array, int count)
                                            { d_fun = +1056; return *this; }
    bdlxxxx::OutStream& putArrayInt48(const Int64 *array, int count)
                                            { d_fun = -1048; return *this; }
    bdlxxxx::OutStream& putArrayUint48(const Uint64 *array, int count)
                                            { d_fun = +1048; return *this; }
    bdlxxxx::OutStream& putArrayInt40(const Int64 *array, int count)
                                            { d_fun = -1040; return *this; }
    bdlxxxx::OutStream& putArrayUint40(const Uint64 *array, int count)
                                            { d_fun = +1040; return *this; }
    bdlxxxx::OutStream& putArrayInt32(const int *array, int count)
                                            { d_fun = -1032; return *this; }
    bdlxxxx::OutStream& putArrayUint32(const unsigned int *array, int count)
                                            { d_fun = +1032; return *this; }
    bdlxxxx::OutStream& putArrayInt24(const int *array, int count)
                                            { d_fun = -1024; return *this; }
    bdlxxxx::OutStream& putArrayUint24(const unsigned int *array, int count)
                                            { d_fun = +1024; return *this; }
    bdlxxxx::OutStream& putArrayInt16(const short *array, int count)
                                            { d_fun = -1016; return *this; }
    bdlxxxx::OutStream& putArrayUint16(const unsigned short *array, int count)
                                            { d_fun = +1016; return *this; }
    bdlxxxx::OutStream& putArrayInt8(const signed char *array, int count)
                                            { d_fun = -1008; return *this; }
    bdlxxxx::OutStream& putArrayUint8(const unsigned char *array, int count)
                                            { d_fun = +1008; return *this; }
    bdlxxxx::OutStream& putArrayInt8(const char *array, int count)
                                            { d_fun = -1001; return *this; }
    bdlxxxx::OutStream& putArrayUint8(const char *array, int count)
                                            { d_fun = +1001; return *this; }
    bdlxxxx::OutStream& putArrayFloat64(const double *array, int count)
                                            { d_fun = +1164; return *this; }
    bdlxxxx::OutStream& putArrayFloat32(const float *array, int count)
                                            { d_fun = +1132; return *this; }

    bdlxxxx::OutStream& putString(const bsl::string& value)
...
int main(int argc, char *argv[]) {
    ...
    switch (test) { case 0:
      ...
      case 1: {
        ...
        //   'bdlxxxx::OutStream' class compiles and links when all virtual
        //   functions are defined.
        //
        // Plan:
        //   Construct an object of a class derived from 'bdlxxxx::OutStream'.
        //   Upcast a reference to the object to the base class
        //   'bdlxxxx::OutStream'.  Using the base class reference invoke various
        //   methods of the base class.  Verify that the correct
        //   implementations of the methods are called.
        //
        // Testing:
        //
        //   virtual ~bdlxxxx::OutStream();
        ...
        if (verbose) cout << endl << "PROTOCOL TEST" << endl
                                  << "=============" << endl;
        MyOutStream myS;
        bdlxxxx::OutStream& s = myS; const bdlxxxx::OutStream& S = myS;
