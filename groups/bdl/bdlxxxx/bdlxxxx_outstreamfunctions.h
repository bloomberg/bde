...
//
//@SEE_ALSO: bdlxxxx_instreamfunctions, bdlxxxx_versionfunctions
//
...
///------------------------------------------------------------
// 'bdlxxxx_outstreamfunctions' is an integral part of the 'bdex' externalization
...
// 'bdlxxxx_outstreamfunctions' plays several related but different roles in
// helping various developers to produce 'bdex'-compliant components.  In this
// section we briefly highlight how and why 'bdlxxxx_outstreamfunctions' is
...
///- - - - - - - - - - - - -
// One obvious design choice for 'bdlxxxx_outstreamfunctions' is that it supports
...
namespace bdlxxxx {
struct OutStreamFunctions_IsEnumType {
...
struct OutStreamFunctions_IsNotEnumType {
    // This 'struct' is a dummy struct used to perform function overload
...
namespace bdex_OutStreamFunctions {
    ...
    bool outStreamFunctionsDeprecatedFunctionIsInUse();
        ...
        // call the deprecated 'streamOutVersionAndObject' family of functions
    ...
    STREAM& streamOut_Imp(STREAM&                                   stream,
                          const TYPE&                               value,
                          int,
                          const bdlxxxx::OutStreamFunctions_IsEnumType&)
    ...
    STREAM& streamOut_Imp(STREAM&                                      stream,
                          const TYPE&                                  value,
                          int                                          version,
                          const bdlxxxx::OutStreamFunctions_IsNotEnumType&)
        ...
        // unmodified.  Note that 'version' is not written.
    {
        ...
        // bdlxxxx::OutStreamFunctions_IsEnumType and
        // bdlxxxx::OutStreamFunctions_IsNotEnumType to choose the correct
        // function.

        typedef typename bslmf::If<bslmf::IsEnum<TYPE>::VALUE,
                                  bdlxxxx::OutStreamFunctions_IsEnumType,
                                  bdlxxxx::OutStreamFunctions_IsNotEnumType>::Type
                                                                     dummyType;
