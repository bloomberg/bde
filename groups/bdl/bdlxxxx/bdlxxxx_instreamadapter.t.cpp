...
// [ 2] virtual ~bdlxxxx::InStreamAdapter();
//
// MANIPULATORS
...
//..
      ...
      case 3: {
        ...
        if (verbose) cout << "\nFORWARDING TEST" << endl
                          << "\n===============" << endl;
        MyInStream myS;
        bdlxxxx::InStreamAdapter<MyInStream> s(&myS);
        const bdlxxxx::InStreamAdapter<MyInStream>& S = s;
      ...
      case 1: {
        // --------------------------------------------------------------------
        // BREATHING TEST:
        //   Create 'bdlxxxx_instreamadapter' objects containing various data.
        ...
        bdlxxxx::ByteInStream bs;
        bdlxxxx::InStreamAdapter<bdlxxxx::ByteInStream> s(&bs);
