...
//
//@CLASSES:
//   bdlxxxx::InStream: protocol class for (un)externalizing fundamental types
//
//@AUTHOR: John Lakos (jlakos)
//
//@SEE_ALSO: bdlxxxx_outstream
//
...
// the 'bdlxxxx_outstream' protocol.  The supported types and required content are
...
///Usage Example 1
///---------------
// The 'bdlxxxx::InStream' input stream interface provided in this component is
...
class InStream {
  ...
  public:
    ...
    // MANIPULATORS
    virtual InStream& getLength(int& length) = 0;
    ...
    virtual InStream& getVersion(int& version) = 0;
    ...
    virtual InStream& getInt64(bsls::Types::Int64& variable) = 0;
    ...
    virtual InStream& getUint64(bsls::Types::Uint64& variable) = 0;
    ...
    virtual InStream& getInt56(bsls::Types::Int64& variable) = 0;
    ...
    virtual InStream& getUint56(bsls::Types::Uint64& variable) = 0;
    ...
    virtual InStream& getInt48(bsls::Types::Int64& variable) = 0;
    ...
    virtual InStream& getUint48(bsls::Types::Uint64& variable) = 0;
    ...
    virtual InStream& getInt40(bsls::Types::Int64& variable) = 0;
    ...
    virtual InStream& getUint40(bsls::Types::Uint64& variable) = 0;
    ...
    virtual InStream& getInt32(int& variable) = 0;
    ...
    virtual InStream& getUint32(unsigned int& variable) = 0;
    ...
    virtual InStream& getInt24(int& variable) = 0;
    ...
    virtual InStream& getUint24(unsigned int& variable) = 0;
    ...
    virtual InStream& getInt16(short& variable) = 0;
    ...
    virtual InStream& getUint16(unsigned short& variable) = 0;
    ...
    virtual InStream& getInt8(char& variable) = 0;
    virtual InStream& getInt8(signed char& variable) = 0;
    ...
    virtual InStream& getUint8(char& variable) = 0;
    virtual InStream& getUint8(unsigned char& variable) = 0;
    ...
    virtual InStream& getFloat64(double& variable) = 0;
    ...
    virtual InStream& getFloat32(float& variable) = 0;
    ...
    virtual InStream& getString(bsl::string& value) = 0;
    ...
    virtual
    InStream& getArrayUint64(bsls::Types::Uint64 *array,
                                  int                  length) = 0;
    ...
    virtual InStream& getArrayInt32(int *array, int length) = 0;
    ...
    virtual InStream& getArrayUint32(unsigned int *array, int length) = 0;
    ...
    virtual InStream& getArrayInt24(int *array, int length) = 0;
        // Consume a 24-bit signed integer value from this input stream, place
        // that value in the specified 'variable', and return a reference to
        // this modifiable stream.  If this stream is initially invalid, this
        // operation has no effect.  If this function otherwise fails to
    ...
    virtual InStream& getArrayUint24(unsigned int *array, int length) = 0;
        // Consume a 24-bit unsigned integer value from this input stream,
        // place that value in the specified 'variable', and return a reference
        // to this modifiable stream.  If this stream is initially invalid,
        // this operation has no effect.  If this function otherwise fails to
    ...
    virtual InStream& getArrayInt16(short *array, int length) = 0;
    ...
    virtual InStream& getArrayUint16(unsigned short *array,
                                          int             length) = 0;
    ...
    virtual InStream& getArrayInt8(char *array, int length) = 0;
    virtual InStream& getArrayInt8(signed char *array, int length) = 0;
    ...
    virtual InStream& getArrayUint8(char *array, int length) = 0;
    virtual InStream& getArrayUint8(unsigned char *array, int length) = 0;
    ...
    virtual InStream& getArrayFloat64(double *array, int count) = 0;
    ...
    virtual InStream& getArrayFloat32(float *array, int length) = 0;
...
InStream& operator>>(InStream& stream, OBJECT& object);
    ...
    // written by a 'bdlxxxx::ByteOutStream' object.  (See the 'bdex' package-level
