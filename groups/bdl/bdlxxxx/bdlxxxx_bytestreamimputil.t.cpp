...
int restorePoint(MyPoint *point, const char *buffer, int bufferLength)
{
    ...
    int result;
    bdlxxxx::ByteStreamImpUtil::getInt32(&result, buffer + 0 );
    point->setX(result);
    bdlxxxx::ByteStreamImpUtil::getInt32(&result, buffer + 4 );
    point->setY(result);
    return SUCCESS;
}
      ...
      case 26: {
        ...
        if (testIndividualDoubles) {
            for (i = SIZE - 1; i >= 0; --i)  {
                ...
                bdlxxxx::ByteStreamImpUtil::putFloat64(b, x);
                bdlxxxx::ByteStreamImpUtil::getFloat64(&y, b);
            }
            ASSERT (x == y);
            for (i = 0; i < COUNT; ++i) {
                LOOP_ASSERT(i, xa[i] != ya[i]);
            ...
            for (i = SIZE - 1; i >= 0; --i)  {
                ...
                bdlxxxx::ByteStreamImpUtil::putArrayFloat64(buffer, xa, COUNT);
                bdlxxxx::ByteStreamImpUtil::getArrayFloat64(ya, buffer, COUNT);
            }
      ...
      case 24: {
        ...
        // Ensure expected pattern match actual buffer pattern for each value.
        {
            ...
            for (i = 0; i < NUM_VALUES; ++i) {
                ...
                char buffer[SIZE];
                bdlxxxx::ByteStreamImpUtil::putFloat32(buffer, VALUES[i]);
        ...
        for (int length = 0; length < NUM_TRIALS; ++length) {
            for (int align = 0; align < SIZE; ++align) {
                ...
                bdlxxxx::ByteStreamImpUtil::putArrayFloat32(
                ...
                bdlxxxx::ByteStreamImpUtil::getArrayFloat32(result1,
                                        buffer1 + align, length);
                bdlxxxx::ByteStreamImpUtil::getArrayFloat32(result2,
      ...
      case 23: {
        ...
        // Ensure expected pattern match actual buffer pattern for each value.
        {
            ...
            for (i = 0; i < NUM_VALUES; ++i) {
                ...
                g(exp, SPECS[i], NUM_BITS);
                char buffer[SIZE];
                bdlxxxx::ByteStreamImpUtil::putFloat64(buffer, VALUES[i]);
                bool isEq = eq(exp, buffer, NUM_BITS);
                if (veryVerbose || !isEq) {
                    P(VALUES[i])
                    cout << "exp: "; pBytes(exp, SIZE) << endl;
        ...
        for (int length = 0; length < NUM_TRIALS; ++length) {
            for (int align = 0; align < SIZE; ++align) {
                ...
                bdlxxxx::ByteStreamImpUtil::putArrayFloat64(
                                        buffer1 + align, input, length);
                bdlxxxx::ByteStreamImpUtil::putArrayFloat64(
                                        buffer2 + align, input, length);
                // check buffer data
                ...
                // fetch data from arrays
                bdlxxxx::ByteStreamImpUtil::getArrayFloat64(result1,
                                        buffer1 + align, length);
                bdlxxxx::ByteStreamImpUtil::getArrayFloat64(result2,
                                        buffer2 + align, length);
      ...
      case 22: {
        ...
        // Ensure expected pattern match actual buffer pattern for each value.
        {
            ...
            for (i = 0; i < NUM_VALUES; ++i) {
                ...
                g(exp, SPECS[i], NUM_BITS);
                char buffer[SIZE];
                bdlxxxx::ByteStreamImpUtil::putInt8(buffer, VALUES[i]);
                bool isEq = eq(exp, buffer, NUM_BITS);
                if (veryVerbose || !isEq) {
                    P(VALUES[i] & 0xFF)
                    cout << "exp: "; pBytes(exp, SIZE) << endl;
        ...
        for (int length = 0; length < NUM_TRIALS; ++length) {
            for (int align = 0; align < SIZE; ++align) {
                ...
                bdlxxxx::ByteStreamImpUtil::putArrayInt8(
                ...
                // fetch data from arrays
                bdlxxxx::ByteStreamImpUtil::getArrayInt8(result1,
                                        buffer1 + align, length);
                bdlxxxx::ByteStreamImpUtil::getArrayInt8(result2,
                                        buffer2 + align, length);
                bdlxxxx::ByteStreamImpUtil::getArrayInt8(result3,
      ...
      case 21: {
        ...
        // Ensure expected pattern match actual buffer pattern for each value.
        {
            ...
            for (i = 0; i < NUM_VALUES; ++i) {
                ...
                g(exp, SPECS[i], NUM_BITS);
                char buffer[SIZE];
                bdlxxxx::ByteStreamImpUtil::putInt16(buffer, VALUES[i]);
                bool isEq = eq(exp, buffer, NUM_BITS);
                if (veryVerbose || !isEq) {
                    P(VALUES[i])
                    cout << "exp: "; pBytes(exp, SIZE) << endl;
        ...
        for (int length = 0; length < NUM_TRIALS; ++length) {
            for (int align = 0; align < SIZE; ++align) {
                ...
                bdlxxxx::ByteStreamImpUtil::putArrayInt16(
                                        buffer1 + align, (T*) input, length);
                bdlxxxx::ByteStreamImpUtil::putArrayInt16(
                                        buffer2 + align, (U*) input, length);
                // check buffer data
                ...
                // fetch data from arrays
                bdlxxxx::ByteStreamImpUtil::getArrayInt16(result1,
                                        buffer1 + align, length);
                bdlxxxx::ByteStreamImpUtil::getArrayUint16(result2,
                                        buffer2 + align, length);
      ...
      case 20: {
        ...
        // Ensure expected pattern match actual buffer pattern for each value.
        {
            ...
            for (i = 0; i < NUM_VALUES; ++i) {
                ...
                char buffer[SIZE];
                bdlxxxx::ByteStreamImpUtil::putInt24(buffer, VALUES[i]);
        ...
        for (int length = 0; length < NUM_TRIALS; ++length) {
            for (int align = 0; align < SIZE; ++align) {
                ...
                bdlxxxx::ByteStreamImpUtil::putArrayInt24(
                                        buffer1 + align, (T*) input, length);
                bdlxxxx::ByteStreamImpUtil::putArrayInt24(
                                        buffer2 + align, (U*) input, length);
                // check buffer data
                ...
                // fetch data from arrays
                bdlxxxx::ByteStreamImpUtil::getArrayInt24(result1,
                                        buffer1 + align, length);
                bdlxxxx::ByteStreamImpUtil::getArrayUint24(result2,
                                        buffer2 + align, length);
      ...
      case 19: {
        ...
        // Ensure expected pattern match actual buffer pattern for each value.
        {
            ...
            for (i = 0; i < NUM_VALUES; ++i) {
                ...
                g(exp, SPECS[i], NUM_BITS);
                char buffer[SIZE];
                bdlxxxx::ByteStreamImpUtil::putInt32(buffer, VALUES[i]);
                bool isEq = eq(exp, buffer, NUM_BITS);
                if (veryVerbose || !isEq) {
                    P(VALUES[i])
                    cout << "exp: "; pBytes(exp, SIZE) << endl;
        ...
        for (int length = 0; length < NUM_TRIALS; ++length) {
            for (int align = 0; align < SIZE; ++align) {
                ...
                bdlxxxx::ByteStreamImpUtil::putArrayInt32(
                                        buffer1 + align, (T*) input, length);
                bdlxxxx::ByteStreamImpUtil::putArrayInt32(
                                        buffer2 + align, (U*) input, length);
                // check buffer data
                ...
                // fetch data from arrays
                bdlxxxx::ByteStreamImpUtil::getArrayInt32(result1,
                                        buffer1 + align, length);
                bdlxxxx::ByteStreamImpUtil::getArrayUint32(result2,
                                        buffer2 + align, length);
      ...
      case 18: {
        ...
        // Ensure expected pattern match actual buffer pattern for each value.
        {
            ...
            for (i = 0; i < NUM_VALUES; ++i) {
                ...
                g(exp, SPECS[i], NUM_BITS_IN_VALUE);
                char buffer[SIZE];
                bdlxxxx::ByteStreamImpUtil::putInt40(buffer, VALUES[i]);
                bool isEq = eq(exp + OFFSET, buffer, NUM_BITS_IN_BUFFER);
                if (veryVerbose || !isEq) {
                    P(VALUES[i])
                    cout << "exp: "; pBytes(exp + OFFSET, SIZE) << endl;
        ...
        for (int length = 0; length < NUM_TRIALS; ++length) {
            for (int align = 0; align < SIZE; ++align) {
                ...
                bdlxxxx::ByteStreamImpUtil::putArrayInt40(
                                        buffer1 + align, (T*) input, length);
                bdlxxxx::ByteStreamImpUtil::putArrayInt40(
                                        buffer2 + align, (U*) input, length);
                // check buffer data
                ...
                // fetch data from arrays
                bdlxxxx::ByteStreamImpUtil::getArrayInt40(result1,
                                        buffer1 + align, length);
                bdlxxxx::ByteStreamImpUtil::getArrayUint40(result2,
                                        buffer2 + align, length);
      ...
      case 17: {
        ...
        // Ensure expected pattern match actual buffer pattern for each value.
        {
            ...
            for (i = 0; i < NUM_VALUES; ++i) {
                ...
                g(exp, SPECS[i], NUM_BITS_IN_VALUE);
                char buffer[SIZE];
                bdlxxxx::ByteStreamImpUtil::putInt48(buffer, VALUES[i]);
                bool isEq = eq(exp + OFFSET, buffer, NUM_BITS_IN_BUFFER);
                if (veryVerbose || !isEq) {
                    P(VALUES[i])
                    cout << "exp: "; pBytes(exp + OFFSET, SIZE) << endl;
        ...
        for (int length = 0; length < NUM_TRIALS; ++length) {
            for (int align = 0; align < SIZE; ++align) {
                ...
                bdlxxxx::ByteStreamImpUtil::putArrayInt48(
                                        buffer1 + align, (T*) input, length);
                bdlxxxx::ByteStreamImpUtil::putArrayInt48(
                                        buffer2 + align, (U*) input, length);
                // check buffer data
                ...
                // fetch data from arrays
                bdlxxxx::ByteStreamImpUtil::getArrayInt48(result1,
                                        buffer1 + align, length);
                bdlxxxx::ByteStreamImpUtil::getArrayUint48(result2,
                                        buffer2 + align, length);
      ...
      case 16: {
        ...
        // Ensure expected pattern match actual buffer pattern for each value.
        {
            ...
            for (i = 0; i < NUM_VALUES; ++i) {
                ...
                g(exp, SPECS[i], NUM_BITS_IN_VALUE);
                char buffer[SIZE];
                bdlxxxx::ByteStreamImpUtil::putInt56(buffer, VALUES[i]);
                bool isEq = eq(exp + OFFSET, buffer, NUM_BITS_IN_BUFFER);
                if (veryVerbose || !isEq) {
                    P(VALUES[i])
                    cout << "exp: "; pBytes(exp + OFFSET, SIZE) << endl;
        ...
        for (int length = 0; length < NUM_TRIALS; ++length) {
            for (int align = 0; align < SIZE; ++align) {
                ...
                bdlxxxx::ByteStreamImpUtil::putArrayInt56(
                                        buffer1 + align, (T*) input, length);
                bdlxxxx::ByteStreamImpUtil::putArrayInt56(
                                        buffer2 + align, (U*) input, length);
                // check buffer data
                ...
                // fetch data from arrays
                bdlxxxx::ByteStreamImpUtil::getArrayInt56(result1,
                                        buffer1 + align, length);
                bdlxxxx::ByteStreamImpUtil::getArrayUint56(result2,
                                        buffer2 + align, length);
      ...
      case 15: {
        ...
        // Ensure expected pattern match actual buffer pattern for each value.
        {
            ...
            for (i = 0; i < NUM_VALUES; ++i) {
                ...
                g(exp, SPECS[i], NUM_BITS);
                char buffer[SIZE];
                bdlxxxx::ByteStreamImpUtil::putInt64(buffer, VALUES[i]);
                bool isEq = eq(exp, buffer, NUM_BITS);
                if (veryVerbose || !isEq) {
                    P(VALUES[i])
                    cout << "exp: "; pBytes(exp, SIZE) << endl;
        ...
        for (int length = 0; length < NUM_TRIALS; ++length) {
            for (int align = 0; align < SIZE; ++align) {
                ...
                bdlxxxx::ByteStreamImpUtil::putArrayInt64(
                                        buffer1 + align, (T*) input, length);
                bdlxxxx::ByteStreamImpUtil::putArrayInt64(
                                        buffer2 + align, (U*) input, length);
                // check buffer data
                ...
                // fetch data from arrays
                bdlxxxx::ByteStreamImpUtil::getArrayInt64(result1,
                                        buffer1 + align, length);
                bdlxxxx::ByteStreamImpUtil::getArrayUint64(result2,
                                        buffer2 + align, length);
    ...
    // Microsoft 2003 compiler does not support -0.0
        ...
        for (int di = 0; di < NUM_DATA; ++di) {
            ...
            for (int i = 0; i < SIZE; ++i) {
                ...
                bdlxxxx::ByteStreamImpUtil::putFloat32(buffer + i, number);
                ...
                for (int k = 0; k < NUM_VALUES; ++k) {
                    {
                        ...
                        bdlxxxx::ByteStreamImpUtil::getFloat32(&x, buffer + i);
                        if (number != x) {
                            P_(number) P(x)
                        }
                        LOOP3_ASSERT(LINE, i, k, number == x);
    ...
    // Microsoft 2003 compiler does not support -0.0
        ...
        for (int di = 0; di < NUM_DATA; ++di) {
            ...
            for (int i = 0; i < SIZE; ++i) {
                ...
                bdlxxxx::ByteStreamImpUtil::putFloat64(buffer + i, number);
                bool isEq = eq(exp, buffer + i, NUM_BITS);
                if (veryVerbose || !isEq) {
                    const char *e = isLittleEndian()
                                    ? "little endian " : "BIG ENDIAN ";
                ...
                for (int k = 0; k < NUM_VALUES; ++k) {
                    {
                        T x = INITIAL_VALUES[k];
                        LOOP3_ASSERT(LINE, i, k, number != x);
                        bdlxxxx::ByteStreamImpUtil::getFloat64(&x, buffer + i);
                        if (number != x) {
                            P_(number) P(x)
                        }
                        LOOP3_ASSERT(LINE, i, k, number == x);
      ...
      case 12: {
        ...
        for (int di = 0; di < NUM_DATA; ++di) {
            ...
            for (int i = 0; i < SIZE; ++i) {
                ...
                bdlxxxx::ByteStreamImpUtil::putInt8(buffer + i, xsignedNumber);
                bool isEq = eq(exp, buffer + i, NUM_BITS);
                if (veryVerbose || !isEq) {
                    const char *e = isLittleEndian()
                                    ? "little endian " : "BIG ENDIAN ";
                ...
                bdlxxxx::ByteStreamImpUtil::putInt8(buffer + i, unsignedNumber);
                LOOP2_ASSERT(LINE, i, eq(exp, buffer + i, NUM_BITS));
                ...
                for (int k = 0; k < NUM_VALUES; ++k) {
                    {
                        ...
                        bdlxxxx::ByteStreamImpUtil::getInt8(&x, buffer + i);
                        if (xsignedNumber != x) {
                    ...
                    }
                    {
                        ...
                        bdlxxxx::ByteStreamImpUtil::getInt8(&y, buffer + i);
                        if (unsignedNumber != y) {
                    ...
                    }
                    {
                        ...
                        bdlxxxx::ByteStreamImpUtil::getInt8(&z, buffer + i);
                        if (signedNumber != z) {
      ...
      case 11: {
        ...
        for (int di = 0; di < NUM_DATA; ++di) {
            ...
            for (int i = 0; i < SIZE; ++i) {
                ...
                bdlxxxx::ByteStreamImpUtil::putInt16(buffer + i, signedNumber);
                bool isEq = eq(exp, buffer + i, NUM_BITS);
                if (veryVerbose || !isEq) {
                    const char *e = isLittleEndian()
                                    ? "little endian " : "BIG ENDIAN ";
                ...
                bdlxxxx::ByteStreamImpUtil::putInt16(buffer + i, unsignedNumber);
                LOOP2_ASSERT(LINE, i, eq(exp, buffer + i, NUM_BITS));
                ...
                for (int k = 0; k < NUM_VALUES; ++k) {
                    {
                        ...
                        bdlxxxx::ByteStreamImpUtil::getInt16(&x, buffer + i);
                        if (signedNumber != x) {
                            P_(signedNumber) P(x)
                        }
                        LOOP3_ASSERT(LINE, i, k, signedNumber == x);
                    }
                    {
                        U y = INITIAL_VALUES[k];
                        LOOP3_ASSERT(LINE, i, k, unsignedNumber != y);
                        bdlxxxx::ByteStreamImpUtil::getUint16(&y, buffer + i);
                        if (unsignedNumber != y) {
      ...
      case 10: {
        ...
        for (int di = 0; di < NUM_DATA; ++di) {
            ...
            for (int i = 0; i < SIZE; ++i) {
                ...
                bdlxxxx::ByteStreamImpUtil::putInt24(buffer + i, signedNumber);
                ...
                bdlxxxx::ByteStreamImpUtil::putInt24(buffer + i, unsignedNumber);
                LOOP2_ASSERT(LINE, i, eq(exp + OFFSET,
                                         buffer + i,   NUM_BITS_IN_BUFFER));
                ...
                for (int k = 0; k < NUM_VALUES; ++k) {
                    {
                        T x = INITIAL_VALUES[k];
                        LOOP3_ASSERT(LINE, i, k, signedNumber != x);
                        bdlxxxx::ByteStreamImpUtil::getInt24(&x, buffer + i);
                        if (signedNumber != x) {
                            P_(signedNumber) P(x)
                        }
                        LOOP3_ASSERT(LINE, i, k, signedNumber == x);
                    }
                    {
                        ...
                        if (signedNumber > 0) {
                            LOOP3_ASSERT(LINE, i, k, unsignedNumber != y);
                            bdlxxxx::ByteStreamImpUtil::getUint24(&y, buffer + i);
                            if (unsignedNumber != y) {
                                P_(unsignedNumber) P(y)
                            }
                            LOOP3_ASSERT(LINE, i, k, unsignedNumber == y);
      ...
      case 9: {
        ...
        for (int di = 0; di < NUM_DATA; ++di) {
            ...
            for (int i = 0; i < SIZE; ++i) {
                ...
                bdlxxxx::ByteStreamImpUtil::putInt32(buffer + i, signedNumber);
                bool isEq = eq(exp, buffer + i, NUM_BITS);
                if (veryVerbose || !isEq) {
                    const char *e = isLittleEndian()
                                    ? "little endian " : "BIG ENDIAN ";
                ...
                bdlxxxx::ByteStreamImpUtil::putInt32(buffer + i, unsignedNumber);
                LOOP2_ASSERT(LINE, i, eq(exp, buffer + i, NUM_BITS));
                ...
                for (int k = 0; k < NUM_VALUES; ++k) {
                    {
                        T x = INITIAL_VALUES[k];
                        LOOP3_ASSERT(LINE, i, k, signedNumber != x);
                        bdlxxxx::ByteStreamImpUtil::getInt32(&x, buffer + i);
                        if (signedNumber != x) {
                            P_(signedNumber) P(x)
                        }
                        LOOP3_ASSERT(LINE, i, k, signedNumber == x);
                    }
                    {
                        U y = INITIAL_VALUES[k];
                        LOOP3_ASSERT(LINE, i, k, unsignedNumber != y);
                        bdlxxxx::ByteStreamImpUtil::getUint32(&y, buffer + i);
                        if (unsignedNumber != y) {
                            P_(unsignedNumber) P(y)
                        }
                        LOOP3_ASSERT(LINE, i, k, unsignedNumber == y);
      ...
      case 8: {
        ...
        for (int di = 0; di < NUM_DATA; ++di) {
            ...
            for (int i = 0; i < SIZE; ++i) {
                ...
                bdlxxxx::ByteStreamImpUtil::putInt40(buffer + i, signedNumber);
                bool isEq = eq(exp + OFFSET, buffer + i, NUM_BITS_IN_BUFFER);
                if (veryVerbose || !isEq) {
                    const char *e = isLittleEndian()
                                    ? "little endian " : "BIG ENDIAN ";
                ...
                bdlxxxx::ByteStreamImpUtil::putInt40(buffer + i, unsignedNumber);
                LOOP2_ASSERT(LINE, i, eq(exp + OFFSET,
                                         buffer + i,   NUM_BITS_IN_BUFFER));
                ...
                for (int k = 0; k < NUM_VALUES; ++k) {
                    {
                        T x = INITIAL_VALUES[k];
                        LOOP3_ASSERT(LINE, i, k, signedNumber != x);
                        bdlxxxx::ByteStreamImpUtil::getInt40(&x, buffer + i);
                        if (signedNumber != x) {
                            P_(signedNumber) P(x)
                        }
                        LOOP3_ASSERT(LINE, i, k, signedNumber == x);
                    }
                    {
                        ...
                        if (signedNumber > 0) {
                            LOOP3_ASSERT(LINE, i, k, unsignedNumber != y);
                            bdlxxxx::ByteStreamImpUtil::getUint40(&y, buffer + i);
                            if (unsignedNumber != y) {
                                P_(unsignedNumber) P(y)
                            }
                            LOOP3_ASSERT(LINE, i, k, unsignedNumber == y);
      ...
      case 7: {
        ...
        for (int di = 0; di < NUM_DATA; ++di) {
            ...
            for (int i = 0; i < SIZE; ++i) {
                ...
                bdlxxxx::ByteStreamImpUtil::putInt48(buffer + i, signedNumber);
                bool isEq = eq(exp + OFFSET, buffer + i, NUM_BITS_IN_BUFFER);
                if (veryVerbose || !isEq) {
                    const char *e = isLittleEndian()
                                    ? "little endian " : "BIG ENDIAN ";
                ...
                bdlxxxx::ByteStreamImpUtil::putInt48(buffer + i, unsignedNumber);
                LOOP2_ASSERT(LINE, i, eq(exp + OFFSET,
                                         buffer + i,   NUM_BITS_IN_BUFFER));
                ...
                for (int k = 0; k < NUM_VALUES; ++k) {
                    {
                        T x = INITIAL_VALUES[k];
                        LOOP3_ASSERT(LINE, i, k, signedNumber != x);
                        bdlxxxx::ByteStreamImpUtil::getInt48(&x, buffer + i);
                        if (signedNumber != x) {
                            P_(signedNumber) P(x)
                        }
                        LOOP3_ASSERT(LINE, i, k, signedNumber == x);
                    }
                    {
                        ...
                        if (signedNumber > 0) {
                            LOOP3_ASSERT(LINE, i, k, unsignedNumber != y);
                            bdlxxxx::ByteStreamImpUtil::getUint48(&y, buffer + i);
                            if (unsignedNumber != y) {
                                P_(unsignedNumber) P(y)
                            }
                            LOOP3_ASSERT(LINE, i, k, unsignedNumber == y);
      ...
      case 6: {
        ...
        for (int di = 0; di < NUM_DATA; ++di) {
            ...
            for (int i = 0; i < SIZE; ++i) {
                ...
                bdlxxxx::ByteStreamImpUtil::putInt56(buffer + i, signedNumber);
                bool isEq = eq(exp + OFFSET, buffer + i, NUM_BITS_IN_BUFFER);
                if (veryVerbose || !isEq) {
                    const char *e = isLittleEndian()
                                    ? "little endian " : "BIG ENDIAN ";
                ...
                bdlxxxx::ByteStreamImpUtil::putInt56(buffer + i, unsignedNumber);
                LOOP2_ASSERT(LINE, i, eq(exp + OFFSET,
                                         buffer + i,   NUM_BITS_IN_BUFFER));
                ...
                for (int k = 0; k < NUM_VALUES; ++k) {
                    {
                        T x = INITIAL_VALUES[k];
                        LOOP3_ASSERT(LINE, i, k, signedNumber != x);
                        bdlxxxx::ByteStreamImpUtil::getInt56(&x, buffer + i);
                        if (signedNumber != x) {
                            P_(signedNumber) P(x)
                        }
                        LOOP3_ASSERT(LINE, i, k, signedNumber == x);
                    }
                    {
                        ...
                        if (signedNumber > 0) {
                            LOOP3_ASSERT(LINE, i, k, unsignedNumber != y);
                            bdlxxxx::ByteStreamImpUtil::getUint56(&y, buffer + i);
                            if (unsignedNumber != y) {
                                P_(unsignedNumber) P(y)
                            }
                            LOOP3_ASSERT(LINE, i, k, unsignedNumber == y);
      ...
      case 5: {
        ...
        for (int di = 0; di < NUM_DATA; ++di) {
            ...
            for (int i = 0; i < SIZE; ++i) {
                ...
                bdlxxxx::ByteStreamImpUtil::putInt64(buffer + i, signedNumber);
                bool isEq = eq(exp, buffer + i, NUM_BITS);
                if (veryVerbose || !isEq) {
                    const char *e = isLittleEndian()
                                    ? "little endian " : "BIG ENDIAN ";
                ...
                bdlxxxx::ByteStreamImpUtil::putInt64(buffer + i, unsignedNumber);
                LOOP2_ASSERT(LINE, i, eq(exp, buffer + i, NUM_BITS));
                ...
                for (int k = 0; k < NUM_VALUES; ++k) {
                    {
                        T x = INITIAL_VALUES[k];
                        LOOP3_ASSERT(LINE, i, k, signedNumber != x);
                        bdlxxxx::ByteStreamImpUtil::getInt64(&x, buffer + i);
                        if (signedNumber != x) {
                            P_(signedNumber) P(x)
                        }
                        LOOP3_ASSERT(LINE, i, k, signedNumber == x);
                    }
                    {
                        U y = INITIAL_VALUES[k];
                        LOOP3_ASSERT(LINE, i, k, unsignedNumber != y);
                        bdlxxxx::ByteStreamImpUtil::getUint64(&y, buffer + i);
                        if (unsignedNumber != y) {
                            P_(unsignedNumber) P(y)
                        }
                        LOOP3_ASSERT(LINE, i, k, unsignedNumber == y);
