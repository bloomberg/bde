...
//
//@CLASSES:
//   bdlxxxx::OutStream: protocol class for externalizing fundamental types
//
//@AUTHOR: John Lakos (jlakos)
//
//@SEE_ALSO: bdlxxxx_instream
//
...
// with an "unexternalization" component implementing the 'bdlxxxx_instream'
...
///Usage
///-----
// The 'bdlxxxx::OutStream' output stream interface provided in this component is
...
class OutStream {
  ...
  public:
    ...
    virtual OutStream& putUint64(bsls::Types::Int64 value) = 0;
        // Format the least significant 64 bits of the specified 'value' to
        // this output stream and return a reference to this modifiable stream.

    virtual OutStream& putInt56(bsls::Types::Int64 value) = 0;
        // Format the least significant 56 bits of the specified 'value' to
        // this output stream and return a reference to this modifiable stream.

    virtual OutStream& putUint56(bsls::Types::Int64 value) = 0;
        // Format the least significant 56 bits of the specified 'value' to
        // this output stream and return a reference to this modifiable stream.

    virtual OutStream& putInt48(bsls::Types::Int64 value) = 0;
        // Format the least significant 48 bits of the specified 'value' to
        // this output stream and return a reference to this modifiable stream.

    virtual OutStream& putUint48(bsls::Types::Int64 value) = 0;
        // Format the least significant 48 bits of the specified 'value' to
        // this output stream and return a reference to this modifiable stream.

    virtual OutStream& putInt40(bsls::Types::Int64 value) = 0;
        // Format the least significant 40 bits of the specified 'value' to
        // this output stream and return a reference to this modifiable stream.

    virtual OutStream& putUint40(bsls::Types::Int64 value) = 0;
        // Format the least significant 40 bits of the specified 'value' to
        // this output stream and return a reference to this modifiable stream.

    virtual OutStream& putInt32(int value) = 0;
        // Format the least significant 32 bits of the specified 'value' to
        // this output stream and return a reference to this modifiable stream.

    virtual OutStream& putUint32(unsigned int value) = 0;
        // Format the least significant 32 bits of the specified 'value' to
        // this output stream and return a reference to this modifiable stream.

    virtual OutStream& putInt24(int value) = 0;
        // Format the least significant 24 bits of the specified 'value' to
        // this output stream and return a reference to this modifiable stream.

    virtual OutStream& putUint24(int value) = 0;
        // Format the least significant 24 bits of the specified 'value' to
        // this output stream and return a reference to this modifiable stream.

    virtual OutStream& putInt16(int value) = 0;
        // Format the least significant 16 bits of the specified 'value' to
        // this output stream and return a reference to this modifiable stream.

    virtual OutStream& putUint16(int value) = 0;
        // Format the least significant 16 bits of the specified 'value' to
        // this output stream and return a reference to this modifiable stream.

    virtual OutStream& putInt8(int value) = 0;
    ...
    virtual OutStream& putUint8(int value) = 0;
        // Format the least significant 8 bits of the specified 'value' to this
        // output stream and return a reference to this modifiable stream.

                        // *** scalar floating-point values ***

    virtual OutStream& putFloat64(double value) = 0;
    ...
    virtual OutStream& putFloat32(float value) = 0;
    ...
    virtual OutStream& putString(const bsl::string& value) = 0;
    ...
    virtual OutStream& putArrayInt32(const int *array, int count) = 0;
    ...
    virtual
    OutStream& putArrayUint32(const unsigned int *array, int count) = 0;
        // Format as an atomic sequence the least significant 32 bits of each
        // of the specified 'count' leading entries in the specified 'array' to
        // this output stream and return a reference to this modifiable stream.
        // The behavior is undefined unless 0 <= count.

    virtual OutStream& putArrayInt24(const int *array, int count) = 0;
    ...
    virtual
    OutStream& putArrayUint24(const unsigned int *array, int count) = 0;
        // Format as an atomic sequence the least significant 24 bits of each
        // of the specified 'count' leading entries in the specified 'array' to
        // this output stream and return a reference to this modifiable stream.
        // The behavior is undefined unless 0 <= count.

    virtual OutStream& putArrayInt16(const short *array, int count) = 0;
    ...
    virtual
    OutStream& putArrayUint16(const unsigned short *array, int count) = 0;
        // Format as an atomic sequence the least significant 16 bits of each
        // of the specified 'count' leading entries in the specified 'array' to
        // this output stream and return a reference to this modifiable stream.
        // The behavior is undefined unless 0 <= count.

    virtual OutStream& putArrayInt8(const char *array, int count) = 0;
    virtual OutStream& putArrayInt8(const signed char *array,
                                         int                count) = 0;
    ...
    virtual OutStream& putArrayUint8(const char *array, int count) = 0;
    virtual OutStream& putArrayUint8(const unsigned char *array,
                                          int                  count) = 0;
        // Format as an atomic sequence the least significant 8 bits of each of
        // the specified 'count' leading entries in the specified 'array' to
        // this output stream and return a reference to this modifiable stream.
    ...
    virtual OutStream& putArrayFloat64(const double *array,int count) = 0;
    ...
    virtual OutStream& putArrayFloat32(const float *array, int count) = 0;
...
inline
OutStream& operator<<(OutStream& stream, const OBJECT& object);
...
template <class OBJECT>
inline
bdlxxxx::OutStream& bdlxxxx::operator<<(OutStream& stream, const OBJECT& object)
{
    return OutStreamMethodsUtil::streamOutVersionAndObject(stream,
                                                                object);
}
