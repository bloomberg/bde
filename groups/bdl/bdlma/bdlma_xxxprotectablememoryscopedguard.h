// bdlma_xxxprotectablememoryscopedguard.h                               -*-C++-*-
#ifndef INCLUDED_BDLMA_XXXPROTECTABLEMEMORYSCOPEDGUARD
#define INCLUDED_BDLMA_XXXPROTECTABLEMEMORYSCOPEDGUARD
...
//
//@CLASSES:
//  bdlma::ProtectableMemoryScopedGuard: used to temporarily unprotect memory
//
//@AUTHOR: Henry Verschell (hverschell)
//
//@SEE_ALSO: bdlmca_xxxprotectablesequentialallocator,
//           bdlmca_xxxprotectablemultipoolallocator,
//           bdlma_xxxprotectableblocklist
//
...
//    void protect();
//..
// For example, two such types are 'bdlma::ProtectableBlockList' and
// 'bdlmca::ProtectableSequentialAllocator'.
// The 'bdlma::ProtectableMemoryScopedGuard' class implements the "construction
// is acquisition, destruction is release" idiom.  Upon construction, a
// 'bdlma::ProtectableMemoryScopedGuard' automatically calls 'unprotect'
...
namespace bdlma {
                // ========================================
                // class ProtectableMemoryScopedGuard
                // ========================================
...
class ProtectableMemoryScopedGuard {
    ...
    // NOT IMPLEMENTED
    ProtectableMemoryScopedGuard(
                                    const ProtectableMemoryScopedGuard&);
    ProtectableMemoryScopedGuard& operator=(
                                    const ProtectableMemoryScopedGuard&);

  public:
    // CREATORS
    ProtectableMemoryScopedGuard(MANAGER_TYPE *memoryManager);
...
template <class MANAGER_TYPE>
inline
ProtectableMemoryScopedGuard<MANAGER_TYPE>::
ProtectableMemoryScopedGuard(MANAGER_TYPE *memoryManager)
