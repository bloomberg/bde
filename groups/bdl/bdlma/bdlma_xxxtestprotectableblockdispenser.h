// bdlma_xxxtestprotectableblockdispenser.h   -*-C++-*-
#ifndef INCLUDED_BDLMA_XXXTESTPROTECTABLEBLOCKDISPENSER
#define INCLUDED_BDLMA_XXXTESTPROTECTABLEBLOCKDISPENSER
...
//
//@CLASSES:
// bdlma::TestProtectableBlockDispenser: concrete test dispenser implementation
//
//@AUTHOR: Henry Verschell (hverschell)
//
//@DESCRIPTION: This component implements the
// 'bdlma::ProtectableBlockDispenser' protocol with a test implementation
...
//..
//            ( bdlma::TestProtectableBlockDispenser )
//                               |          ctor
...
///Usage
///-----
// The 'bdlma::TestProtectableBlockDispenser' class defined in this component
// can be used to test objects that take a 'bdlma::ProtectableBlockDispenser'
...
// in the usage example from 'bdlma_xxxprotectableblockdispenser':
//..
//  // IntegerStack.t.cpp
//
//  #include <IntegerStack.h>  // from bdlma_xxxprotectableblockdispenser.h
...
//
//      bdlma::TestProtectableBlockDispenser testDispenser(64, veryVeryVerbose);
//
//      switch (test) { case 0:
//
//        // ...
...
class TestProtectableBlockDispenser :
    ...
    TestProtectableBlockDispenser(
                                   const TestProtectableBlockDispenser&);
    TestProtectableBlockDispenser& operator=(
                                   const TestProtectableBlockDispenser&);
  public:
    // PUBLIC TYPES
    enum {
    ...
    // CREATORS
    explicit TestProtectableBlockDispenser(int  pageSize,
    ...
    bool isProtected(const MemoryBlockDescriptor& block) const;
...
// MANIPULATORS
inline
void TestProtectableBlockDispenser::setNoAbort(bool flagValue)
{
    d_noAbortFlag = flagValue;
}

inline
void TestProtectableBlockDispenser::setQuiet(bool flagValue)
{
    d_quietFlag = flagValue;
}

inline
void TestProtectableBlockDispenser::setVerbose(bool flagValue)
{
    d_verboseFlag = flagValue;
}

inline
void TestProtectableBlockDispenser::setAllocationLimit(int numAlloc)
{
...
// ACCESSORS
inline
bool TestProtectableBlockDispenser::isNoAbort() const
{
    return d_noAbortFlag;
}

inline
bool TestProtectableBlockDispenser::isQuiet() const
{
    return d_quietFlag;
}

inline
bool TestProtectableBlockDispenser::isVerbose() const
{
    return d_verboseFlag;
}

inline
int TestProtectableBlockDispenser::numBlocksInUse() const
{
    return d_numBlocksInUse;
}

inline
int TestProtectableBlockDispenser::numBytesInUse() const
{
    return d_numBytesInUse;
}

inline
int TestProtectableBlockDispenser::numBlocksMax() const
{
    return d_numBlocksMax;
}

inline
int TestProtectableBlockDispenser::numBytesMax() const
{
    return d_numBytesMax;
}

inline
int TestProtectableBlockDispenser::numBlocksTotal() const
{
    return d_numBlocksTotal;
}

inline
int TestProtectableBlockDispenser::numBytesTotal() const
{
    return d_numBytesTotal;
}

inline
int TestProtectableBlockDispenser::numErrors() const
{
    return d_numErrors;
}

inline
int TestProtectableBlockDispenser::allocationLimit() const
{
    return d_allocationLimit;
}

inline
int TestProtectableBlockDispenser::lastAllocatedNumBytes() const
{
    return d_lastAllocateNumBytes;
}

inline
int TestProtectableBlockDispenser::lastDeallocatedNumBytes() const
{
    return d_lastDeallocateNumBytes;
}

inline
void *TestProtectableBlockDispenser::lastAllocatedAddress() const
{
    return d_lastAllocateAddress;
}

inline
void *TestProtectableBlockDispenser::lastDeallocatedAddress() const
{
    return d_lastDeallocateAddress;
}

inline
int TestProtectableBlockDispenser::numAllocations() const
{
    return d_numAllocations;
}

inline
int TestProtectableBlockDispenser::numDeallocations() const
{
    return d_numDeallocations;
}

inline
int TestProtectableBlockDispenser::pageSize() const
{
    return d_pageSize;
}

inline
int TestProtectableBlockDispenser::numBlocksProtected() const
{
