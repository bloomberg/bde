// bdlma_xxxtestprotectableblockdispenser.t.cpp -*-C++-*-
...
//-----------------------------------------------------------------------------
// [ 1] bdlma::TestProtectableBlockDispenser(int verboseFlag = 0);
// [ 2] ~bdlma::TestProtectableBlockDispenser();
// [ 3] bdlma::MemoryBlockDescriptor allocate(int size);
// [ 3] void deallocate(bdlma::MemoryBlockDescriptor);
...
// [ 1] int protect(const bdlma::MemoryBlockDescriptor&) const;
// [ 1] int unprotect(const bdlma::MemoryBlockDescriptor&) const;
// [ 1] bool isProtected(const bdlma::MemoryBlockDescriptor&) const;
// [ 1] int numProtectedBlocks();
// [ 5] ostream& operator<<(
//                      ostream&                                   stream,
//                      const bdlma::TestProtectableBlockDispenser& rhs);
//-----------------------------------------------------------------------------
...
// This is copied from 'bdlma_xxxtestprotectableblockdispenser.cpp'
// to compare with scribbled deallocated memory.
const unsigned char SCRIBBLED_MEMORY = 0xA5;   // byte used to scribble
                                               // deallocated memory

typedef bdlma::TestProtectableBlockDispenser Obj;
typedef bdlma::MemoryBlockDescriptor         BlkDesc;
typedef bdlma::ProtectableBlockDispenser     BlkDisp;
//=============================================================================
//                                USAGE EXAMPLE
//-----------------------------------------------------------------------------
// integerstack.h
...
// The following code uses pipe() and fork(), so only works on Unix.
        ...
        // bdlma::TestProtectableBlockDispenser does not have a function
      ...
      case 4: {
        ...
        //
        // Testing:
        //   bdlma::MemoryBlockDescriptor allocate(int size);
        //
        // --------------------------------------------------------------------
      ...
      case 3: {
        ...
        //   bdlma::MemoryBlockDescriptor allocate(int size);
        //   void deallocate(const bdlma::MemoryBlockDescriptor&);
        //
      ...
      case 1: {
        ...
        //
        //   bdlma::TestProtectableBlockDispenser(int verboseFlag = 0);
        ...
        //   int protect(const bdlma::MemoryBlockDescriptor& )
        //   int unprotect(const bdlma::MemoryBlockDescriptor& )
        //
