// bdlma_xxxprotectableblocklist.t.cpp                                   -*-C++-*-
...
// bdlma::ProtectableBlockList and bdema_VallocProtectedAllocator.
//
...
//      bdlma::ProtectableBlockList(bdema::ProtectedMemoryAllocator *)
//      blockHeaderSize();
// [ 4] Manipulator: bdlma::ProtectableBlockList::allocate
// [ 5] Manipulator: bdlma::ProtectableBlockList::deallocate
// [ 6] Manipulator: bdlma::ProtectableBlockList::protect
//                   bdlma::ProtectableBlockList::unprotect
//      Accessor:    bdlma::ProtectableBlockList::isProtected
// [ 7] Manipulator: bdlma::ProtectableBlockList::release
//
//-----------------------------------------------------------------------------
// [ 1] BREATHING TEST
// [ 8] USAGE EXAMPLE
...
typedef bdlma::ProtectableBlockList            Obj;
typedef bdlma::TestProtectableBlockDispenser   TestDisp;
typedef bdlma::NativeProtectableBlockDispenser NativeDisp;
typedef bdlma::MemoryBlockDescriptor           BlkDesc;
...
//..
// We pass a 'bdlma::ProtectableBlockDispenser' to the
// 'bdlma::ProtectableBlockList' on construction.
//..
  public:
         // CREATORS
         myProtectedDataProvider(
                     bdlma::ProtectableBlockDispenser *protectedDispener)
...
// The 'bdlma::ProtectableBlockList' is unprotected before it is used and
...
//..
             ...
             // valid memory region of the specified 'size'.
         {
             ...
             bdlma::MemoryBlockDescriptor block = d_blockList.allocate(size);
...
// 'bdlma::ProtectableBlockList' using the 'dispenser'.
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:
      ...
      case 7: {
        ...
        //
        // Testing:
        //     bdlma::ProtectableBlockList::release()
        // --------------------------------------------------------------------
        if (verbose) {
            bsl::cout
                << "\nVerify:\n"
      ...
      case 6: {
        ...
        //
        // Testing:
        //     bdlma::ProtectableBlockList::protect()
        //     bdlma::ProtectableBlockList::unprotect()
        //     bdlma::ProtectableBlockList::isProtected() const
        // --------------------------------------------------------------------
        if (verbose) {
            bsl::cout
                << "\tVerify:\n"
      ...
      case 5: {
        // --------------------------------------------------------------------
        // MANIPULATOR TEST:
        //                bdlma::ProtectableBlockList::deallocate(void *)
        //
        // Use a table of input data describing various allocation sizes to
        ...
        // --------------------------------------------------------------------
          ...
          const int BHS = BLOCK_HEADER_SIZE;
          {
              ...
              bdlma::MemoryBlockDescriptor BLOCKS[NUM_TESTS];
      ...
      case 4: {
        // --------------------------------------------------------------------
        // MANIPULATOR TEST:
        //               bdlma::ProtectableBlockList::allocate(int)
        //
      ...
      case 3: {
        ...
        //
        // Testing:
        // 1.  bdlma::ProtectableBlockList(
        //                             bdlma::ProtectableBlockDispenser *)
        //    ~bdlma::ProtectableBlockList()
        // 2.  bdlma::ProtectableBlockList::BLOCK_HEADER_SIZE
        //
        // -------------------------------------------------------------------
          if (verbose) {
          ...
          }
          {
              ...
              if (veryVerbose) {
                  bsl::cout << "\t~bdlma::ProtectableBlockList() "
                            << "protected mem"
                            << bsl::endl;
              }
              {
      ...
      case 2: {
        ...
        }
        {
            ...
            char  dummy = '0';
            int   size;
            bdlma::MemoryBlockDescriptor block = a.allocate(1);
      ...
      case 1: {
        ...
        for (int i = 0; i < NUM_TESTS; ++i) {
            // Initialized DATA
            bdlma::MemoryBlockDescriptor block= a.allocate(SIZES[i]);
