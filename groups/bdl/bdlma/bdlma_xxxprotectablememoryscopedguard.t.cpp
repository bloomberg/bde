// bdlma_xxxprotectablememoryscopedguard.t.cpp  -*-C++-*-

#include <bdlma_xxxprotectablememoryscopedguard.h>

#include <bslma_defaultallocatorguard.h>                // for testing only
#include <bdlma_xxxprotectableblocklist.h>                 // for testing only
...
//                                  Overview
//                                  --------
// bdlma::ProtectableMemoryScopedGuard is a guard component which has two
...
//..
    void setMemory(char                       *protectedBuffer,
                   int                         length,
                   char                        value,
                   bdlma::ProtectableBlockList *blockList)
...
//..
        bdlma::ProtectableMemoryScopedGuard<bdlma::ProtectableBlockList>
                                                            guard(blockList);
//..
//..
// Write to the memory:
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:
      case 4: {
        ...
        {
            bdlma::ProtectableBlockList blockList(&testDispenser);
            bdlma::MemoryBlockDescriptor block = blockList.allocate(2);
      ...
      case 1: {
        ...
        //
        // Plan:
        //   Create a 'bdlma::ProtectableMemoryScopedGuard' around a
