// bdlma_xxxprotectableblockdispenser.h                                  -*-C++-*-
#ifndef INCLUDED_BDLMA_XXXPROTECTABLEBLOCKDISPENSER
#define INCLUDED_BDLMA_XXXPROTECTABLEBLOCKDISPENSER
...
//
//@CLASSES:
//  bdlma::ProtectableBlockDispenser: protocol to allocate and protect blocks
//
//@AUTHOR: Henry Verschell (hverschell)
//
//@SEE_ALSO: bdlma_memoryblockdescriptor, bdlma_xxxnativeprotectableblockdispenser
//
...
// 'bdlma::MemoryBlockDescriptor' that holds a pointer to the allocated memory
// as well as the size that was allocated.
//
///Usage
///-----
// The following examples demonstrate how the
// 'bdlma::ProtectableBlockDispenser' protocol can be implemented and used.
//
///Usage 1: Trivial example
///- - - - - - - - - - - -
// The following is a simple example of using a
// 'bdlma::ProtectableBlockDispenser' to allocate, protect, unprotect, and
// deallocate memory blocks:
//..
//    void doImportantStuff(bdlma::ProtectableBlockDispenser *dispenser)
//    {
//        assert(0 != dispenser);
//..
...
//    }
//..
///Usage 2: Create a class that uses a 'bdlma::ProtectableBlockDispenser'
///- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// This example demonstrates a more realistic use of a protectable memory
// block dispenser.  The class 'IntegerStack' uses a
// 'bdlma::ProtectableBlockDispenser', supplied at construction, to protect the
...
//        // checking.
//
//        bdlma::MemoryBlockDescriptor      d_data;         // block of memory
//                                                         // holding the stack
//
//        int                             *d_cursor_p;     // top of the stack
//
//        bdlma::ProtectableBlockDispenser *d_dispenser_p;  // memory dispenser
//                                                         // (held not owned)
//  // ...
//      private:
...
//        {
//            bdlma::MemoryBlockDescriptor oldData = d_data;
...
//    };
//..
///Usage 3: Implementing the 'bdlma::ProtectableBlockDispenser' Protocol
/// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// In this example we create a dummy implementation of the
// 'bdlma::ProtectableBlockDispenser' protocol.  In order to avoid
...
//
//        // MANIPULATORS
//        bdlma::MemoryBlockDescriptor allocate(size_type size);
...
//            // construction.
//
//        bool isProtected(const bdlma::MemoryBlockDescriptor& block) const;
...
namespace bdlma {
                  // =====================================
                  // class ProtectableBlockDispenser
                  // =====================================
...
class ProtectableBlockDispenser {
    ...
    // a 'MemoryBlockDescriptor' that was obtained from a call to
  ...
  public:
    ...
    // CREATORS
    virtual ~ProtectableBlockDispenser();
        // Destroy this 'ProtectableBlockDispenser'.  Note that the
    ...
    // MANIPULATORS
    virtual MemoryBlockDescriptor allocate(size_type numBytes) = 0;
    ...
    virtual void deallocate(const MemoryBlockDescriptor& block) = 0;
        ...
        // 'ProtectableBlockDispenser' object, has not since been
        // deallocated, and is currently in an unprotected state.

    virtual int protect(const MemoryBlockDescriptor& block) = 0;
    ...
    virtual int unprotect(const MemoryBlockDescriptor& block) = 0;
