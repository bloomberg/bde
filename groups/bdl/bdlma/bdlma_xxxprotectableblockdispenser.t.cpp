// bdlma_xxxprotectableblockdispenser.t.cpp  -*-C++-*-
...
typedef bdlma::MemoryBlockDescriptor Block;
...
class NoopProtectableBlockDispenser : public bdlma::ProtectableBlockDispenser {
        // The NoopProtectedAllocator is an empty implementation of the
        // 'bdlma::ProtectableBlockDispenser' interface that tracks the
        // methods called and verifies the 'bdema::ProtectedAllocator'
        // protocol.
...
// 'bdlma::ProtectableBlockDispenser' protocol can be implemented and
// used.

///Usage 1 -- Trivial example
///- - - - - - - - - - - - -
// The following is a simple and somewhat unrealistic example of using a
// 'bdlma::ProtectableBlockDispenser' to allocate, protect, unprotect,
...
//..
///Usage 2 - Creating a Class that Uses a 'bdlma::ProtectableBlockDispenser'
/// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
// 'bdlma::ProtectableBlockDispenser', supplied at construction, to
...
//    // dummyprotectablebufferblockdispenser.h
      ...
      class DummyProtectableBufferBlockDispenser :
        ...
        public:
          ...
          void print(const bdlma::MemoryBlockDescriptor& block) const;
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:
      ...
      case 1: {
        ...
        //   bdem::ProtectableBlockDispenser will call the implemented
        //   methods of concrete implementations.
        //
        // Plan:
        //  Construct a NoopProtectedBlockAllcoator.  Obtain a
        //  'bdlma::ProtectableBlockDispenser' reference to it and call
        //  the various methods on the 'bdlma::ProtectableBlockDispenser'
