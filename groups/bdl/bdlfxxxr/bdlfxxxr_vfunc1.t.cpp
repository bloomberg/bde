// bdlfxxxr_vfunc1.t.cpp                                              -*-C++-*-

#include <bdlfxxxr_vfunc1.h>
...
//                              Overview
//                              --------
// 'bdlfxxxr::Vfunc1' is an abstract class that provides a pure virtual function
...
//
// In order to test 'bdlfxxxr::Vfunc1' we have to implement a concrete class
...
//
//-----------------------------------------------------------------------------
// [ 2] bdlfxxxr::Vfunc1<A1>(bslma::Allocator *ba);
// [ 2] void increment();
// [ 2] int decrement();
// [ 2] void execute(c_A1&) const;
// [ 2] ~bdlfxxxr::Vfunc1<A1>();
// [ 2] static void deleteObject(bdlfxxxr::Vfunc1 *object);
//-----------------------------------------------------------------------------
...
class ConcreteDerivedClass : public bdlfxxxr::Vfunc1 <A1> {
  public:
    ...
    : bdlfxxxr::Vfunc1<A1>(basicAllocator) { }

    virtual void execute(const A1& argument1) const
        // Increment global counter 'executeUsageCounter'.
        //
        // This function tests that the 'execute' method of 'bdlfxxxr::Vfunc1' is
...
class EnvelopeClass {
    ...
    bdlfxxxr::Vfunc1<A1> *d_rep_p;  // polymorphic functor representation
  ...
  public:
    ...
    ~EnvelopeClass()
        ...
        // representation using 'deleteObject' method of 'bdlfxxxr::Vfunc1' class.
    {
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 2: {
        ...
        //
        // Testing:
        //   bdlfxxxr::Vfunc1<A1>(bslma::Allocator *ba);
        //   void increment();
        //   int decrement();
        //   void execute(c_A1&) const;
        //   static void deleteObject(bdlfxxxr::Vfunc1 *object);
        //   ~bdlfxxxr::Vfunc1<A1>();
        // --------------------------------------------------------------------
