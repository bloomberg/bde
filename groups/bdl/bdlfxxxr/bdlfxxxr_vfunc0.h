// bdlfxxxr_vfunc0.h               -*-C++-*-
#ifndef INCLUDED_BDLFXXXR_VFUNC0
#define INCLUDED_BDLFXXXR_VFUNC0
...
//
//@CLASSES:
//   bdlfxxxr::Vfunc0: reference-counted base class with an allocator
//
...
// class for all internal representations of the 'bdlfxxx::Vfunc0' family of
...
// reflect the number of 'bdlfxxx::Vfunc0' objects (envelopes) or other partial
...
// reaches '0') without any information about the details of the 'bdlfxxxr::Vfunc0'
...
// 'bdlfxxxr::Vfunc0' to declare the destructor 'private', thereby limiting object
...
//..
// Implement a 'ConcreteDerivedClass' derived from 'bdlfxxxr::Vfunc0':
//..
//   class ConcreteDerivedClass : public bdlfxxxr::Vfunc0 {
//     public:
//       ConcreteDerivedClass(bslma::Allocator *basicAllocator)
//       : bdlfxxxr::Vfunc0(basicAllocator) { }
//
...
// comman (instanciated) 'bdlfxxxr::Vfunc0' object:
//..
//   class EnvelopeClass {
//       // Provide an object that encapsulates a 'bdlfxxxr::Vfunc0' object.
//
//       bdlfxxxr::Vfunc0 *d_rep_p;
//           // polymorphic functor representation
//
//     public:
//       // CREATORS
//       EnvelopeClass(bdlfxxxr::Vfunc0 *rep) : d_rep_p(rep)
...
//           // representation using 'deleteObject' method of 'bdlfxxxr::Vfunc0'
//           // class.
//       {
//           if (0 == d_rep_p->decrement()) {
//               bdlfxxxr::Vfunc0::deleteObject(d_rep_p);
//           }
//       }
//
//       // ACCESSORS
...
class Vfunc0 {
    ...
    // and deallocate the concrete objects derived from 'Vfunc0', which
