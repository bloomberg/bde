...
//                              Overview
//                              --------
// 'bdlfxxxr::Vfunc2' is an abstract class that provides a pure virtual function
...
//
// In order to test 'bdlfxxxr::Vfunc2' we have to implement a concrete class
...
//
//-----------------------------------------------------------------------------
// [ 2] bdlfxxxr::Vfunc2<A1, A2>(bslma::Allocator *ba);
// [ 2] void increment();
// [ 2] int decrement();
// [ 2] void execute(const A1& argument1, const A2& argument2) const;
// [ 2] ~bdlfxxxr::Vfunc2<A1, A2>();
// [ 2] static void deleteObject(bdlfxxxr::Vfunc2 *object);
//-----------------------------------------------------------------------------
...
class ConcreteDerivedClass : public bdlfxxxr::Vfunc2 <A1, A2> {
  public:
    ...
    virtual void execute(const A1& argument1, const A2& argument2) const
        ...
        //
        // This function tests that the 'execute' method of 'bdlfxxxr::Vfunc2' is
...
class EnvelopeClass {
  ...
  public:
    ...
    ~EnvelopeClass()
        ...
        // representation using 'deleteObject' method of 'bdlfxxxr::Vfunc2' class.
    {
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 2: {
        ...
        //
        // Testing:
        //   bdlfxxxr::Vfunc2<A1, A2>(bslma::Allocator *ba);
        //   void increment();
        //   int decrement();
        //   void execute(const A1& argument1, const A2& argument2) const;
        //   static void deleteObject(bdlfxxxr::Vfunc2 *object);
        //   ~bdlfxxxr::Vfunc2<A1, A2>();
        // --------------------------------------------------------------------
