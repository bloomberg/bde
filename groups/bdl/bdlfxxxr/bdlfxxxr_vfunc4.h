...
#define INCLUDED_BDLFXXXR_VFUNC4
...
//
//@CLASSES:
//   bdlfxxxr::Vfunc4: reference-counted base class with an allocator
//
...
// class for all internal representations of the 'bdlfxxx::Vfunc4' family of
...
// reflect the number of 'bdlfxxx::Vfunc4' objects (envelopes) or other partial
...
// reaches '0') without any information about the details of the 'bdlfxxxr::Vfunc4'
...
// 'bdlfxxxr::Vfunc4' to declare the destructor 'private', thereby limiting object
...
//   class ConcreteDerivedClass : public bdlfxxxr::Vfunc4 <A1, A2, A3, A4>
//   {
//     public:
//       ConcreteDerivedClass(bslma::Allocator *basicAllocator)
//       : bdlfxxxr::Vfunc4(basicAllocator) { }
//
...
// common (instantiated) 'bdlfxxxr::Vfunc4<A1, A2, A3, A4>' template object:
//..
//   template <class A1, class A2, class A3, class A4>
//   class EnvelopeClass {
//       // Provide an object that encapsulates a 'bdlfxxxr::Vfunc4' object.
//
//       bdlfxxxr::Vfunc4<A1, A2, A3, A4> *d_rep_p;
//           // polymorphic functor representation
//
//     public:
//       // CREATORS
//       EnvelopeClass(bdlfxxxr::Vfunc4<A1, A2, A3, A4> *rep) :
//           d_rep_p(rep)
...
//           // representation using 'deleteObject' method of 'bdlfxxxr::Vfunc4'
//           // class.
//       {
//           if (0 == d_rep_p->decrement()) {
//               bdlfxxxr::Vfunc4<A1, A2, A3, A4>::
...
//   typedef bdlfxxxr::Vfunc4<int, int, int, int> Obj;
...
//       EnvelopeClass<int, int, int, int> env0(x);          //    1   0     0
//       // The reference counter is 1.
//       env0(1, 2, 3, 4);  assert(1 == executeUsageCounter);
//                                                           //    1   1     0
//       {
//           EnvelopeClass<int, int, int, int> env1(x);      //    2   1     0
//           // The reference counter is 2.
//           env1(1, 2, 3, 4);  assert(2 == executeUsageCounter);
//                                                           //    2   2     0
//       }
//       // The reference counter is 1.
...
class Vfunc4 {
    ...
    // facilitates the use of 'Vfunc4' as a reference-counted letter
    // class in the envelope-letter pattern.  'deleteObject' is used to destroy
    // and deallocate the concrete objects derived from 'Vfunc4', which
  ...
  private:
    Vfunc4(const Vfunc4&);                  // not implemented
    Vfunc4& operator=(const Vfunc4&);       // not implemented
  ...
  public:
    // CLASS METHODS
    static void deleteObject(Vfunc4 *object);
    ...
    // CREATORS
    Vfunc4(bslma::Allocator *basicAllocator);
    ...
    virtual void execute(const A1& argument1, const A2& argument2,
                         const A3& argument3, const A4& argument4) const = 0;
        // Invoke the client-supplied callback function with the specified
        // 'argument1', 'argument2', 'argument3', and 'argument4'.
};
...
// PROTECTED CREATORS
template <class A1, class A2, class A3, class A4>
inline Vfunc4<A1, A2, A3, A4>::~Vfunc4()
{
}
...
template <class A1, class A2, class A3, class A4>
inline
void Vfunc4<A1, A2, A3, A4>::deleteObject(Vfunc4 *object)
{
    object->~Vfunc4();
...
// MANIPULATORS
template <class A1, class A2, class A3, class A4>
inline void Vfunc4<A1, A2, A3, A4>::increment()
{
    ++d_count;  // Warning: not guaranteed to be an atomic operation.
}

template <class A1, class A2, class A3, class A4>
inline int Vfunc4<A1, A2, A3, A4>::decrement()
{
