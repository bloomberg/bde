...
//                              Overview
//                              --------
// 'bdlfxxxr::Vfunc3' is an abstract class that provides a pure virtual function
...
//
// In order to test 'bdlfxxxr::Vfunc3' we have to implement a concrete class
...
//
//-----------------------------------------------------------------------------
// [ 2] bdlfxxxr::Vfunc3<A1-3>(bslma::Allocator *ba);
// [ 2] void increment();
// [ 2] int decrement();
// [ 2] void execute(c_A1-3&) const;
// [ 2] ~bdlfxxxr::Vfunc3<A1-3>();
// [ 2] static void deleteObject(bdlfxxxr::Vfunc3 *object);
//-----------------------------------------------------------------------------
...
class ConcreteDerivedClass : public bdlfxxxr::Vfunc3 <A1, A2, A3> {
  public:
    ...
    virtual void execute(const A1& argument1, const A2& argument2,
        ...
        //
        // This function tests that the 'execute' method of 'bdlfxxxr::Vfunc3' is
...
class EnvelopeClass {
  ...
  public:
    ...
    ~EnvelopeClass()
        ...
        // representation using 'deleteObject' method of 'bdlfxxxr::Vfunc3' class.
    {
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      ...
      case 2: {
        ...
        //
        // Testing:
        //   bdlfxxxr::Vfunc3<A1-3>(bslma::Allocator *ba);
        //   void increment();
        //   int decrement();
        //   void execute(c_A1-3&) const;
        //   static void deleteObject(bdlfxxxr::Vfunc3 *object);
        //   ~bdlfxxxr::Vfunc3<A1-3>();
        // --------------------------------------------------------------------
