// bdlfxxxr_vfunc5.h                                                  -*-C++-*-
#ifndef INCLUDED_BDLFXXXR_VFUNC5
#define INCLUDED_BDLFXXXR_VFUNC5
...
//
//@CLASSES:
//   bdlfxxxr::Vfunc5: reference-counted base class with an allocator
//
...
// class for all internal representations of the 'bdlfxxx::Vfunc5' family of
...
// reflect the number of 'bdlfxxx::Vfunc5' objects (envelopes) or other partial
...
// reaches '0') without any information about the details of the 'bdlfxxxr::Vfunc5'
...
// 'bdlfxxxr::Vfunc5' to declare the destructor 'private', thereby limiting object
...
//   class ConcreteDerivedClass : public bdlfxxxr::Vfunc5 <A1, A2, A3, A4, A5>
//   {
//     public:
//       ConcreteDerivedClass(bslma::Allocator *basicAllocator)
//       : bdlfxxxr::Vfunc5(basicAllocator) { }
//
...
// common (instantiated) 'bdlfxxxr::Vfunc5<A1, A2, A3, A4, A5>' template object:
//..
//   template <class A1, class A2, class A3, class A4, class A5>
//   class EnvelopeClass {
//       // Provide an object that encapsulates a 'bdlfxxxr::Vfunc5' object.
//
//       bdlfxxxr::Vfunc5<A1, A2, A3, A4, A5> *d_rep_p;
//           // polymorphic functor representation
//
//     public:
//       // CREATORS
//       EnvelopeClass(bdlfxxxr::Vfunc5<A1, A2, A3, A4, A5> *rep) :
//           d_rep_p(rep)
...
//           // representation using 'deleteObject' method of 'bdlfxxxr::Vfunc5'
//           // class.
//       {
//           if (0 == d_rep_p->decrement()) {
//               bdlfxxxr::Vfunc5<A1, A2, A3, A4, A5>::
...
//   typedef bdlfxxxr::Vfunc5<int, int, int, int, int> Obj;
...
class Vfunc5 {
    ...
    // facilitates the use of 'Vfunc5' as a reference-counted letter
    // class in the envelope-letter pattern.  'deleteObject' is used to destroy
    // and deallocate the concrete objects derived from 'Vfunc5', which
  ...
  private:
    Vfunc5(const Vfunc5&);                  // not implemented
    Vfunc5& operator=(const Vfunc5&);       // not implemented
  ...
  public:
    // CLASS METHODS
    static void deleteObject(Vfunc5 *object);
    ...
    // CREATORS
    Vfunc5(bslma::Allocator *basicAllocator);
...
// PROTECTED CREATORS
template <class A1, class A2, class A3, class A4, class A5>
inline Vfunc5<A1, A2, A3, A4, A5>::~Vfunc5()
{
}
...
template <class A1, class A2, class A3, class A4, class A5>
inline
void Vfunc5<A1, A2, A3, A4, A5>::deleteObject(Vfunc5 *object)
{
    object->~Vfunc5();
...
// MANIPULATORS
template <class A1, class A2, class A3, class A4, class A5>
inline void Vfunc5<A1, A2, A3, A4, A5>::increment()
{
    ++d_count;  // Warning: not guaranteed to be an atomic operation.
}

template <class A1, class A2, class A3, class A4, class A5>
inline int Vfunc5<A1, A2, A3, A4, A5>::decrement()
{
