...
//
//@CLASSES:
//   bdlfxxxr::Vfunc2: reference-counted base class with an allocator
//
...
// class for all internal representations of the 'bdlfxxx::Vfunc2' family of
...
// reflect the number of 'bdlfxxx::Vfunc2' objects (envelopes) or other partial
...
// reaches '0') without any information about the details of the 'bdlfxxxr::Vfunc2'
...
// 'bdlfxxxr::Vfunc2' to declare the destructor 'private', thereby limiting object
...
//   class ConcreteDerivedClass : public bdlfxxxr::Vfunc2 <A1, A2> {
//     public:
//       ConcreteDerivedClass(bslma::Allocator *basicAllocator)
//       : bdlfxxxr::Vfunc2(basicAllocator) { }
//
...
// common (instantiated) 'bdlfxxxr::Vfunc2<A1, A2>' template object:
//..
//   template <class A1, class A2>
//   class EnvelopeClass {
//       // Provide an object that encapsulates a 'bdlfxxxr::Vfunc2' object.
//
//       bdlfxxxr::Vfunc2<A1, A2> *d_rep_p;  // polymorphic functor representation
//
//     public:
//       // CREATORS
//       EnvelopeClass(bdlfxxxr::Vfunc2<A1, A2> *rep) : d_rep_p(rep)
...
//           // representation using 'deleteObject' method of 'bdlfxxxr::Vfunc2'
//           // class.
//       {
...
//   typedef bdlfxxxr::Vfunc2<int, int> Obj;
...
class Vfunc2 {
    ...
    // and deallocate the concrete objects derived from 'Vfunc2', which
