...
#define INCLUDED_BDLFXXXR_VFUNC3
...
//
//@CLASSES:
//   bdlfxxxr::Vfunc3: reference-counted base class with an allocator
//
...
// class for all internal representations of the 'bdlfxxx::Vfunc3' family of
...
// reflect the number of 'bdlfxxx::Vfunc3' objects (envelopes) or other partial
...
// reaches '0') without any information about the details of the 'bdlfxxxr::Vfunc3'
...
// 'bdlfxxxr::Vfunc3' to declare the destructor 'private', thereby limiting object
...
//   class ConcreteDerivedClass : public bdlfxxxr::Vfunc3 <A1, A2, A3> {
//     public:
//       ConcreteDerivedClass(bslma::Allocator *basicAllocator)
//       : bdlfxxxr::Vfunc3(basicAllocator) { }
//
...
// common (instantiated) 'bdlfxxxr::Vfunc3<A1, A2, A3>' template object:
//..
//   template <class A1, class A2, class A3>
//   class EnvelopeClass {
//       // Provide an object that encapsulates a 'bdlfxxxr::Vfunc3' object.
//
//       bdlfxxxr::Vfunc3<A1, A2, A3> *d_rep_p;
//           // polymorphic functor representation
//
//     public:
//       // CREATORS
//       EnvelopeClass(bdlfxxxr::Vfunc3<A1, A2, A3> *rep) : d_rep_p(rep)
...
//           // representation using 'deleteObject' method of 'bdlfxxxr::Vfunc3'
//           // class.
//       {
//           if (0 == d_rep_p->decrement()) {
//               bdlfxxxr::Vfunc3<A1, A2, A3>::deleteObject(d_rep_p);
//           }
//       }
//
//       // ACCESSORS
...
//   typedef bdlfxxxr::Vfunc3<int, int, int> Obj;
...
//       EnvelopeClass<int, int, int> env0(x);               //    1   0     0
//       // The reference counter is 1.
//       env0(3, 4, 5);  assert(1 == executeUsageCounter);   //    1   1     0
//       {
//           EnvelopeClass<int, int, int> env1(x);           //    2   1     0
...
class Vfunc3 {
    ...
    // and deallocate the concrete objects derived from 'Vfunc3', which
