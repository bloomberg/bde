...
//
//@CLASSES:
//   bdlfxxxu::Vfunc3: namespace for factory methods loading 3-arg void functors
//
...
//..
//   bdlfxxxu::Vfunc3::makeF:    Initialize the functor by embedding a function
//                           (or another functor) and any additional trailing
//                           arguments.
//
//   bdlfxxxu::Vfunc3::makeC:    Initialize the functor by embedding an object, one
//                           of that object's 'const' methods, and any
//                           additional trailing arguments for that method.
//
//   bdlfxxxu::Vfunc3::makeM:    Initialize the functor by embedding THE ADDRESS OF
...
//
//   bdlfxxxu::Vfunc3::makeNull: Initialize the functor with an empty function.
//..
...
struct Vfunc3 {
    ...
    static void makeNull(bdlfxxx::Vfunc3<A1, A2, A3> *handle)
        ...
        // the currently installed default allocator is used.
    {
        ...
        *handle = bdlfxxx::Vfunc3<A1, A2, A3>(
            new(*ba) bdlfxxxi::Vfunc3Null<A1, A2, A3>(ba));
    }

    template <class A1, class A2, class A3>
    static void makeNull(bslma::Allocator *basicAllocator,
                         bdlfxxx::Vfunc3<A1, A2, A3> *handle)
        // Initialize the specified three-argument empty functor 'handle'.
        // Optionally specify, as the *first* argument, a 'basicAllocator'
        // used to supply memory.  If 'basicAllocator' is 0 or unspecified,
        // the currently installed default allocator is used.
    ...
    static void makeF(bdlfxxx::Vfunc3<A1, A2, A3> *handle, F function)
        ...
        // default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc3<A1, A2, A3>(
            new(*ba) bdlfxxxi::Vfunc3F3<F, A1, A2, A3>(function, ba));
    }
    ...
    static void makeF(bdlfxxx::Vfunc3<A1, A2, A3> *handle,
                      F                function,
        ...
        // or unspecified, the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc3<A1, A2, A3>(
            new(*ba) bdlfxxxi::Vfunc3F4<F, A1, A2, A3, D1> (
        ...
        // or unspecified, the currently installed default allocator is used.
    {
        ...
        *handle = bdlfxxx::Vfunc3<A1, A2, A3>(
            new(*ba) bdlfxxxi::Vfunc3F5<F, A1, A2, A3, D1, D2>
        ...
        // or unspecified, the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc3<A1, A2, A3>(
            new(*ba) bdlfxxxi::Vfunc3F6<F, A1, A2, A3, D1, D2, D3>
        ...
        // or unspecified, the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc3<A1, A2, A3>(
            new(*ba) bdlfxxxi::Vfunc3F7<F, A1, A2, A3, D1, D2, D3, D4>
        ...
        // or unspecified, the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc3<A1, A2, A3>(
            new(*ba) bdlfxxxi::Vfunc3F8<F, A1, A2, A3, D1, D2, D3, D4, D5>
                (function, embeddedArg1, embeddedArg2, embeddedArg3,
        ...
        // or unspecified, the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc3<A1, A2, A3>(
            new(*ba) bdlfxxxi::Vfunc3F9<F, A1, A2, A3, D1, D2, D3, D4, D5, D6>
                (function, embeddedArg1, embeddedArg2, embeddedArg3,
    ...
    static void makeC(bdlfxxx::Vfunc3<A1, A2, A3> *handle, const OBJ& object,
                      C                method)
        // Initialize the specified three-argument functor 'handle' by
        // embedding the specified 'function' (or functor) taking no
        // additional trailing arguments.  Optionally specify, as the *first*
        ...
        // default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc3<A1, A2, A3>(
            new(*ba) bdlfxxxi::Vfunc3C3<OBJ, C, A1, A2, A3>(object, method, ba));
    }
    ...
    static void makeC(bdlfxxx::Vfunc3<A1, A2, A3> *handle,
                      const OBJ&       object,
                      C                method,
                      const D1&        embeddedArg1)
        // Initialize the specified three-argument functor 'handle' by
        ...
        // default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc3<A1, A2, A3>(
            new(*ba) bdlfxxxi::Vfunc3C4<OBJ, C, A1, A2, A3, D1>(
        ...
        // or unspecified, the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc3<A1, A2, A3>(
            new(*ba) bdlfxxxi::Vfunc3C5<OBJ, C, A1, A2, A3, D1, D2>(
        ...
        // or unspecified, the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc3<A1, A2, A3>(
            new(*ba) bdlfxxxi::Vfunc3C6<OBJ, C, A1, A2, A3, D1, D2, D3>(
        ...
        // or unspecified, the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc3<A1, A2, A3>(
            new(*ba) bdlfxxxi::Vfunc3C7<OBJ, C, A1, A2, A3, D1, D2, D3, D4>(
        ...
        // or unspecified, the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc3<A1, A2, A3>(
            new(*ba) bdlfxxxi::Vfunc3C8<OBJ, C, A1, A2, A3, D1, D2, D3, D4, D5>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, ba));
    }
        ...
        // or unspecified, the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc3<A1, A2, A3>(
           new(*ba) bdlfxxxi::Vfunc3C9<OBJ, C, A1, A2, A3, D1, D2, D3, D4, D5, D6>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, embeddedArg6, ba));
    }
    ...
    static void makeM(bdlfxxx::Vfunc3<A1, A2, A3> *handle, OBJ *object,
                      M                method)
        // Initialize the specified three-argument functor 'handle' by
        ...
        // default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc3<A1, A2, A3>(
            new(*ba) bdlfxxxi::Vfunc3M3<OBJ, M, A1, A2, A3>(object, method, ba));
    }
    ...
    static void makeM(bdlfxxx::Vfunc3<A1, A2, A3> *handle,
                      OBJ             *object,
                      M                method,
                      const D1&        embeddedArg1)
        // Initialize the specified three-argument functor 'handle' by
        ...
        // default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc3<A1, A2, A3>(
            new(*ba) bdlfxxxi::Vfunc3M4<OBJ, M, A1, A2, A3, D1>(
                object, method, embeddedArg1, ba));
    }
        ...
        // or unspecified, the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc3<A1, A2, A3>(
            new(*ba) bdlfxxxi::Vfunc3M5<OBJ, M, A1, A2, A3, D1, D2>(
                object, method, embeddedArg1, embeddedArg2, ba));
    }
...
static void makeM(bdlfxxx::Vfunc3<A1, A2, A3> *handle,
        ...
        // or unspecified, the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc3<A1, A2, A3>(
            new(*ba) bdlfxxxi::Vfunc3M6<OBJ, M, A1, A2, A3, D1, D2, D3>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3, ba));
    }
        ...
        // or unspecified, the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc3<A1, A2, A3>(
            new(*ba) bdlfxxxi::Vfunc3M7<OBJ, M, A1, A2, A3, D1, D2, D3, D4>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, ba));
    }
        ...
        // or unspecified, the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc3<A1, A2, A3>(
            new(*ba) bdlfxxxi::Vfunc3M8<OBJ, M, A1, A2, A3, D1, D2, D3, D4, D5>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, ba));
    }
    ...
    static void makeM(bdlfxxx::Vfunc3<A1, A2, A3> *handle,
                      ...
                      const D6&        embeddedArg6)
        // Initialize the specified three-argument functor 'handle' by
        // embedding the specified 'method' (or functor) taking six
        // additional trailing arguments and the values corresponding to those
        // arguments.  Optionally specify, as the *first* argument, a
        // 'basicAllocator' used to supply memory.  If 'basicAllocator' is 0
        // or unspecified, the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc3<A1, A2, A3>(
           new(*ba) bdlfxxxi::Vfunc3M9<OBJ, M, A1, A2, A3, D1, D2, D3, D4, D5, D6>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, embeddedArg6, ba));
    }
