...
//
//@CLASSES:
//   bdlfxxxu::Vfunc0: namespace for factory methods loading 0-arg void functors
//
...
//..
//   bdlfxxxu::Vfunc0::makeF:    Initialize the functor by embedding a function
//                           (or another functor) and any additional trailing
//                           arguments.
//
//   bdlfxxxu::Vfunc0::makeC:    Initialize the functor by embedding an object, one
//                           of that object's 'const' methods, and any
//                           additional trailing arguments for that method.
//
//   bdlfxxxu::Vfunc0::makeM:    Initialize the functor by embedding THE ADDRESS OF
...
//
//   bdlfxxxu::Vfunc0::makeNull: Initialize the functor with an empty function.
//..
...
#ifndef INCLUDED_BDLFXXX_VFUNC0
...
struct Vfunc0 {
    ...
    static void makeNull(bdlfxxx::Vfunc0 *handle)
        ...
        // the currently installed default allocator is used.
    {
        ...
        *handle = bdlfxxx::Vfunc0(new(*ba) bdlfxxxi::Vfunc0Null(ba));
    }

    static void makeNull(bslma::Allocator *basicAllocator,
                         bdlfxxx::Vfunc0     *handle)
        // Initialize the specified zero-argument empty functor 'handle'.
        // Optionally specify, as the *first* argument, a 'basicAllocator'
        // used to supply memory.  If 'basicAllocator' is 0 or unspecified,
        // the currently installed default allocator is used.
    ...
    template <class F>
    static void makeF(bdlfxxx::Vfunc0 *handle, F function)
    ...
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc0(
                              new(*ba) bdlfxxxi::Vfunc0F0<F>(function, ba));
    }
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc0(
            new(*ba) bdlfxxxi::Vfunc0F1<F, D1> (function, embeddedArg1, ba));
    }
        ...
        // the currently installed default allocator is used.
    {
        ...
        *handle = bdlfxxx::Vfunc0(
            new(*ba) bdlfxxxi::Vfunc0F2<F, D1, D2>
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc0(
            new(*ba) bdlfxxxi::Vfunc0F3<F, D1, D2, D3>
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc0(
            new(*ba) bdlfxxxi::Vfunc0F4<F, D1, D2, D3, D4>
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc0(
            new(*ba) bdlfxxxi::Vfunc0F5<F, D1, D2, D3, D4, D5>
                (function, embeddedArg1, embeddedArg2, embeddedArg3,
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc0(
            new(*ba) bdlfxxxi::Vfunc0F6<F, D1, D2, D3, D4, D5, D6>
                (function, embeddedArg1, embeddedArg2, embeddedArg3,
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc0(
            new(*ba) bdlfxxxi::Vfunc0F7<F, D1, D2, D3, D4, D5, D6, D7>
                (function, embeddedArg1, embeddedArg2, embeddedArg3,
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc0(
            new(*ba) bdlfxxxi::Vfunc0F8<F, D1, D2, D3, D4, D5, D6, D7, D8>
                (function, embeddedArg1, embeddedArg2, embeddedArg3,
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc0(
            new(*ba) bdlfxxxi::Vfunc0F9<F, D1, D2, D3, D4, D5, D6, D7, D8, D9>
                (function, embeddedArg1, embeddedArg2, embeddedArg3,
                 embeddedArg4, embeddedArg5, embeddedArg6, embeddedArg7,
    ...
    static void makeC(bdlfxxx::Vfunc0 *handle, const OBJ& object,
                      C            method)
        // Initialize the specified zero-argument functor 'handle' by embedding
        // the specified 'function' (or functor) taking no additional trailing
        // arguments.  Optionally specify, as the *first* argument, a
        ...
        // or unspecified, the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc0(
            new(*ba) bdlfxxxi::Vfunc0C0<OBJ, C>(object, method, ba));
    }
        ...
        // default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc0(
            new(*ba) bdlfxxxi::Vfunc0C1<OBJ, C, D1>(
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc0(
            new(*ba) bdlfxxxi::Vfunc0C2<OBJ, C, D1, D2>(
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc0(
            new(*ba) bdlfxxxi::Vfunc0C3<OBJ, C, D1, D2, D3>(
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc0(
            new(*ba) bdlfxxxi::Vfunc0C4<OBJ, C, D1, D2, D3, D4>(
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc0(
            new(*ba) bdlfxxxi::Vfunc0C5<OBJ, C, D1, D2, D3, D4, D5>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, ba));
    }
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc0(
            new(*ba) bdlfxxxi::Vfunc0C6<OBJ, C, D1, D2, D3, D4, D5, D6>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, embeddedArg6, ba));
    }
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc0(
            new(*ba) bdlfxxxi::Vfunc0C7<OBJ, C, D1, D2, D3, D4, D5, D6, D7>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, embeddedArg6, embeddedArg7,  ba));
    }
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc0(
            new(*ba) bdlfxxxi::Vfunc0C8<OBJ, C, D1, D2, D3, D4, D5, D6, D7, D8>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, embeddedArg6, embeddedArg7,
                embeddedArg8, ba));
    }
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc0(
           new(*ba) bdlfxxxi::Vfunc0C9<OBJ, C, D1, D2, D3, D4, D5, D6, D7, D8, D9>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, embeddedArg6, embeddedArg7,
                embeddedArg8, embeddedArg9, ba));
    }
    ...
    static void makeM(bdlfxxx::Vfunc0 *handle, OBJ *object,
                      M            method)
        // Initialize the specified zero-argument functor 'handle' by embedding
        ...
        // or unspecified, the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc0(
            new(*ba) bdlfxxxi::Vfunc0M0<OBJ, M>(object, method, ba));
    }
        ...
        // default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc0(
            new(*ba) bdlfxxxi::Vfunc0M1<OBJ, M, D1>(
                object, method, embeddedArg1, ba));
    }
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc0(
            new(*ba) bdlfxxxi::Vfunc0M2<OBJ, M, D1, D2>(
                object, method, embeddedArg1, embeddedArg2, ba));
    }
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc0(
            new(*ba) bdlfxxxi::Vfunc0M3<OBJ, M, D1, D2, D3>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3, ba));
    }
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc0(
            new(*ba) bdlfxxxi::Vfunc0M4<OBJ, M, D1, D2, D3, D4>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, ba));
    }
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc0(
            new(*ba) bdlfxxxi::Vfunc0M5<OBJ, M, D1, D2, D3, D4, D5>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, ba));
    }
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc0(
            new(*ba) bdlfxxxi::Vfunc0M6<OBJ, M, D1, D2, D3, D4, D5, D6>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, embeddedArg6, ba));
    }
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc0(
            new(*ba) bdlfxxxi::Vfunc0M7<OBJ, M, D1, D2, D3, D4, D5, D6, D7>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, embeddedArg6, embeddedArg7, ba));
    }
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc0(
            new(*ba) bdlfxxxi::Vfunc0M8<OBJ, M, D1, D2, D3, D4, D5, D6, D7, D8>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, embeddedArg6, embeddedArg7,
                embeddedArg8, ba));
    }
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc0(
           new(*ba) bdlfxxxi::Vfunc0M9<OBJ, M, D1, D2, D3, D4, D5, D6, D7, D8, D9>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, embeddedArg6, embeddedArg7,
                embeddedArg8, embeddedArg9, ba));
    }
