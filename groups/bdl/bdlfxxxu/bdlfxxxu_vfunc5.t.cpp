// bdlfxxxu_vfunc5.t.cpp                                              -*-C++-*-

#include <bdlfxxxu_vfunc5.h>
...
//
//-----------------------------------------------------------------------------
// [ 9] makeF(         bdlfxxx::Vfunc5<A1-5> *,       F, c_D1-4&);
// [ 9] makeC(         bdlfxxx::Vfunc5<A1-5> *, c_O&, C, c_D1-4&);
// [ 9] makeM(         bdlfxxx::Vfunc5<A1-5> *, OBJ*, M, c_D1-4&);
// [ 9] makeF(   bA *, bdlfxxx::Vfunc5<A1-5> *,       F, c_D1-4&);
// [ 9] makeC(   bA *, bdlfxxx::Vfunc5<A1-5> *, c_O&, C, c_D1-4&);
// [ 9] makeM(   bA *, bdlfxxx::Vfunc5<A1-5> *, OBJ*, M, c_D1-4&);
// [ 8] makeF(         bdlfxxx::Vfunc5<A1-5> *,       F, c_D1-3&);
// [ 8] makeC(         bdlfxxx::Vfunc5<A1-5> *, c_O&, C, c_D1-3&);
// [ 8] makeM(         bdlfxxx::Vfunc5<A1-5> *, OBJ*, M, c_D1-3&);
// [ 8] makeF(   bA *, bdlfxxx::Vfunc5<A1-5> *,       F, c_D1-3&);
// [ 8] makeC(   bA *, bdlfxxx::Vfunc5<A1-5> *, c_O&, C, c_D1-3&);
// [ 8] makeM(   bA *, bdlfxxx::Vfunc5<A1-5> *, OBJ*, M, c_D1-3&);
// [ 7] makeF(         bdlfxxx::Vfunc5<A1-5> *,       F, c_D1-2&);
// [ 7] makeC(         bdlfxxx::Vfunc5<A1-5> *, c_O&, C, c_D1-2&);
// [ 7] makeM(         bdlfxxx::Vfunc5<A1-5> *, OBJ*, M, c_D1-2&);
// [ 7] makeF(   bA *, bdlfxxx::Vfunc5<A1-5> *,       F, c_D1-2&);
// [ 7] makeC(   bA *, bdlfxxx::Vfunc5<A1-5> *, c_O&, C, c_D1-2&);
// [ 7] makeM(   bA *, bdlfxxx::Vfunc5<A1-5> *, OBJ*, M, c_D1-2&);
// [ 6] makeF(         bdlfxxx::Vfunc5<A1-5> *,       F, c_D1&);
// [ 6] makeC(         bdlfxxx::Vfunc5<A1-5> *, c_O&, C, c_D1&);
// [ 6] makeM(         bdlfxxx::Vfunc5<A1-5> *, OBJ*, M, c_D1&);
// [ 6] makeF(   bA *, bdlfxxx::Vfunc5<A1-5> *,       F, c_D1&);
// [ 6] makeC(   bA *, bdlfxxx::Vfunc5<A1-5> *, c_O&, C, c_D1&);
// [ 6] makeM(   bA *, bdlfxxx::Vfunc5<A1-5> *, OBJ*, M, c_D1&);
// [ 5] makeF(         bdlfxxx::Vfunc5<A1-5> *,       F);
// [ 5] makeC(         bdlfxxx::Vfunc5<A1-5> *, c_O&, C);
// [ 5] makeM(         bdlfxxx::Vfunc5<A1-5> *, OBJ*, M);
// [ 5] makeF(   bA *, bdlfxxx::Vfunc5<A1-5> *,       F);
// [ 5] makeC(   bA *, bdlfxxx::Vfunc5<A1-5> *, c_O&, C);
// [ 5] makeM(   bA *, bdlfxxx::Vfunc5<A1-5> *, OBJ*, M);
// [ 5] makeNull(      bdlfxxx::Vfunc5<A1-5> *);
// [ 5] makeNull(bA *, bdlfxxx::Vfunc5<A1-5> *);
//-----------------------------------------------------------------------------
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      case 9: {
        ...
        //
        // Plan:
        //   Use each function to initialize a separate 'bdlfxxx::Vfunc5' object
        //   with the 'checkArgumentValues' function, which verifies that the
        //   parameters are "wired" correctly.  Use each function to
        //   initialize 'bdlfxxx::Vfunc5' object with the 'checkParameterTypes'
        ...
        //
        // Testing:
        //    makeF(      bdlfxxx::Vfunc5<A1-5> *,        F, c_D1-4&);
        //    makeC(      bdlfxxx::Vfunc5<A1-5> *, c_O&,  C, c_D1-4&);
        //    makeM(      bdlfxxx::Vfunc5<A1-5> *, OBJ *, M, c_D1-4&);
        //    makeF(bA *, bdlfxxx::Vfunc5<A1-5> *,        F, c_D1-4&);
        //    makeC(bA *, bdlfxxx::Vfunc5<A1-5> *, c_O&,  C, c_D1-4&);
        //    makeM(bA *, bdlfxxx::Vfunc5<A1-5> *, OBJ *, M, c_D1-4&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc5<int *, int *, int *, int *, int *> x1;
                bdlfxxxu::Vfunc5::makeF(&x1, checkArgumentValues9,
                                    &a6, &a7, &a8, &a9);
                x1(&a1, &a2, &a3, &a4, &a5);
            ...
            {
                bdlfxxx::Vfunc5<int *, int *, int *, int *, int *> x1;
                bdlfxxxu::Vfunc5::makeC(&x1, cbObj,
            ...
            {
                bdlfxxx::Vfunc5<int *, int *, int *, int *, int *> x1;
                bdlfxxxu::Vfunc5::makeM(&x1, &cbObj,
                                    &CbClass::checkArgumentValues9,
                                    &a6, &a7, &a8, &a9);
                x1(&a1, &a2, &a3, &a4, &a5);
                ASSERT(ARG1_PLUS1 == a1);
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            if (verbose) cout << "Testing 'makeF'" << endl;
            {
                bdlfxxx::Vfunc5<T1, T2, T3, T4, T5> x1;
                bdlfxxxu::Vfunc5::makeF(&x1, checkParameterTypes9,
                                    a6, a7, a8, a9);
                x1(a1, a2, a3, a4, a5);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc5<int *, int *, int *, int *, int *> x1;
                bdlfxxxu::Vfunc5::makeF(&ta, &x1, checkArgumentValues9,
                                    &a6, &a7, &a8, &a9);
                x1(&a1, &a2, &a3, &a4, &a5);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            {
                bdlfxxx::Vfunc5<int *, int *, int *, int *, int *> x1;
                bdlfxxxu::Vfunc5::makeC(&ta, &x1, cbObj,
                                    &CbClass::checkArgumentValues9,
                                    &a6, &a7, &a8, &a9);
                x1(&a1, &a2, &a3, &a4, &a5);
                ASSERT(ARG1_PLUS1 == a1);
            ...
            {
                bdlfxxx::Vfunc5<int *, int *, int *, int *, int *> x1;
                bdlfxxxu::Vfunc5::makeM(&ta, &x1, &cbObj,
                                    &CbClass::checkArgumentValues9,
                                    &a6, &a7, &a8, &a9);
                x1(&a1, &a2, &a3, &a4, &a5);
                ASSERT(ARG1_PLUS1 == a1);
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc5<T1, T2, T3, T4, T5> x1;
                bdlfxxxu::Vfunc5::makeF(&ta, &x1, checkParameterTypes9,
                                    a6, a7, a8, a9);
                x1(a1, a2, a3, a4, a5);
            }
      ...
      case 8: {
        ...
        //
        // Testing:
        //    makeF(      bdlfxxx::Vfunc5<A1-5> *,        F, c_D1-3&);
        //    makeC(      bdlfxxx::Vfunc5<A1-5> *, c_O&,  C, c_D1-3&);
        //    makeM(      bdlfxxx::Vfunc5<A1-5> *, OBJ *, M, c_D1-3&);
        //    makeF(bA *, bdlfxxx::Vfunc5<A1-5> *,        F, c_D1-3&);
        //    makeC(bA *, bdlfxxx::Vfunc5<A1-5> *, c_O&,  C, c_D1-3&);
        //    makeM(bA *, bdlfxxx::Vfunc5<A1-5> *, OBJ *, M, c_D1-3&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc5<int *, int *, int *, int *, int *> x1;
                bdlfxxxu::Vfunc5::makeF(&x1, checkArgumentValues8,
                                    &a6, &a7, &a8);
                x1(&a1, &a2, &a3, &a4, &a5);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc5<T1, T2, T3, T4, T5> x1;
                bdlfxxxu::Vfunc5::makeF(&x1, checkParameterTypes8,
                                    a6, a7, a8);
                x1(a1, a2, a3, a4, a5);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc5<int *, int *, int *, int *, int *> x1;
                bdlfxxxu::Vfunc5::makeF(&ta, &x1, checkArgumentValues8,
                                    &a6, &a7, &a8);
                x1(&a1, &a2, &a3, &a4, &a5);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc5<T1, T2, T3, T4, T5> x1;
                bdlfxxxu::Vfunc5::makeF(&ta, &x1, checkParameterTypes8,
                                    a6, a7, a8);
                x1(a1, a2, a3, a4, a5);
            }
      ...
      case 7: {
        ...
        //
        // Testing:
        //    makeF(      bdlfxxx::Vfunc5<A1-5> *,        F, c_D1-2&);
        //    makeC(      bdlfxxx::Vfunc5<A1-5> *, c_O&,  C, c_D1-2&);
        //    makeM(      bdlfxxx::Vfunc5<A1-5> *, OBJ *, M, c_D1-2&);
        //    makeF(bA *, bdlfxxx::Vfunc5<A1-5> *,        F, c_D1-2&);
        //    makeC(bA *, bdlfxxx::Vfunc5<A1-5> *, c_O&,  C, c_D1-2&);
        //    makeM(bA *, bdlfxxx::Vfunc5<A1-5> *, OBJ *, M, c_D1-2&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc5<int *, int *, int *, int *, int *> x1;
                bdlfxxxu::Vfunc5::makeF(&x1, checkArgumentValues7, &a6, &a7);
                x1(&a1, &a2, &a3, &a4, &a5);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            }
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc5<T1, T2, T3, T4, T5> x1;
                bdlfxxxu::Vfunc5::makeF(&x1, checkParameterTypes7, a6, a7);
                x1(a1, a2, a3, a4, a5);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc5<int *, int *, int *, int *, int *> x1;
                bdlfxxxu::Vfunc5::makeF(&ta, &x1, checkArgumentValues7, &a6, &a7);
                x1(&a1, &a2, &a3, &a4, &a5);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc5<T1, T2, T3, T4, T5> x1;
                bdlfxxxu::Vfunc5::makeF(&ta, &x1, checkParameterTypes7, a6, a7);
                x1(a1, a2, a3, a4, a5);
            }
      ...
      case 6: {
        ...
        //
        // Testing:
        //    makeF(      bdlfxxx::Vfunc5<A1-5> *,        F, c_D1&);
        //    makeC(      bdlfxxx::Vfunc5<A1-5> *, c_O&,  C, c_D1&);
        //    makeM(      bdlfxxx::Vfunc5<A1-5> *, OBJ *, M, c_D1&);
        //    makeF(bA *, bdlfxxx::Vfunc5<A1-5> *,        F, c_D1&);
        //    makeC(bA *, bdlfxxx::Vfunc5<A1-5> *, c_O&,  C, c_D1&);
        //    makeM(bA *, bdlfxxx::Vfunc5<A1-5> *, OBJ *, M, c_D1&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc5<int *, int *, int *, int *, int *> x1;
                bdlfxxxu::Vfunc5::makeF(&x1, checkArgumentValues6, &a6);
                x1(&a1, &a2, &a3, &a4, &a5);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            }
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc5<T1, T2, T3, T4, T5> x1;
                bdlfxxxu::Vfunc5::makeF(&x1, checkParameterTypes6, a6);
                x1(a1, a2, a3, a4, a5);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc5<int *, int *, int *, int *, int *> x1;
                bdlfxxxu::Vfunc5::makeF(&ta, &x1, checkArgumentValues6, &a6);
                x1(&a1, &a2, &a3, &a4, &a5);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc5<T1, T2, T3, T4, T5> x1;
                bdlfxxxu::Vfunc5::makeF(&ta, &x1, checkParameterTypes6, a6);
                x1(a1, a2, a3, a4, a5);
            }
      ...
      case 5: {
        ...
        //
        // Testing:
        //    makeF(         bdlfxxx::Vfunc5<A1-5> *,        F);
        //    makeC(         bdlfxxx::Vfunc5<A1-5> *, c_O&,  C);
        //    makeM(         bdlfxxx::Vfunc5<A1-5> *, OBJ *, M);
        //    makeNull(      bdlfxxx::Vfunc5<A1-5> *);
        //    makeF(   bA *, bdlfxxx::Vfunc5<A1-5> *,        F);
        //    makeC(   bA *, bdlfxxx::Vfunc5<A1-5> *, c_O&,  C);
        //    makeM(   bA *, bdlfxxx::Vfunc5<A1-5> *, OBJ *, M);
        //    makeNull(bA *, bdlfxxx::Vfunc5<A1-5> *);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc5<int *, int *, int *, int *, int *> x1;
                bdlfxxxu::Vfunc5::makeF(&x1, checkArgumentValues5);
                x1(&a1, &a2, &a3, &a4, &a5);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            }
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc5<T1, T2, T3, T4, T5> x1;
                bdlfxxxu::Vfunc5::makeF(&x1, checkParameterTypes5);
                x1(a1, a2, a3, a4, a5);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc5<int *, int *, int *, int *, int *> x1;
                bdlfxxxu::Vfunc5::makeF(&ta, &x1, checkArgumentValues5);
                x1(&a1, &a2, &a3, &a4, &a5);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            {
                bdlfxxx::Vfunc5<int *, int *, int *, int *, int *> x1;
                bdlfxxxu::Vfunc5::makeNull(&ta, &x1);
                x1(&a1, &a2, &a3, &a4, &a5);
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc5<T1, T2, T3, T4, T5> x1;
                bdlfxxxu::Vfunc5::makeF(&ta, &x1, checkParameterTypes5);
                x1(a1, a2, a3, a4, a5);
            }
