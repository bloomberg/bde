// bdlfxxxu_vfunc3.t.cpp              -*-C++-*-

#include <bdlfxxxu_vfunc3.h>
...
//
//-----------------------------------------------------------------------------
// [ 9] makeF(         bdlfxxx::Vfunc3<A1-3> *,       F, c_D1-6&);
// [ 9] makeC(         bdlfxxx::Vfunc3<A1-3> *, c_O&, C, c_D1-6&);
// [ 9] makeM(         bdlfxxx::Vfunc3<A1-3> *, OBJ*, M, c_D1-6&);
// [ 9] makeF(   bA *, bdlfxxx::Vfunc3<A1-3> *,       F, c_D1-6&);
// [ 9] makeC(   bA *, bdlfxxx::Vfunc3<A1-3> *, c_O&, C, c_D1-6&);
// [ 9] makeM(   bA *, bdlfxxx::Vfunc3<A1-3> *, OBJ*, M, c_D1-6&);
// [ 8] makeF(         bdlfxxx::Vfunc3<A1-3> *,       F, c_D1-5&);
// [ 8] makeC(         bdlfxxx::Vfunc3<A1-3> *, c_O&, C, c_D1-5&);
// [ 8] makeM(         bdlfxxx::Vfunc3<A1-3> *, OBJ*, M, c_D1-5&);
// [ 8] makeF(   bA *, bdlfxxx::Vfunc3<A1-3> *,       F, c_D1-5&);
// [ 8] makeC(   bA *, bdlfxxx::Vfunc3<A1-3> *, c_O&, C, c_D1-5&);
// [ 8] makeM(   bA *, bdlfxxx::Vfunc3<A1-3> *, OBJ*, M, c_D1-5&);
// [ 7] makeF(         bdlfxxx::Vfunc3<A1-3> *,       F, c_D1-4&);
// [ 7] makeC(         bdlfxxx::Vfunc3<A1-3> *, c_O&, C, c_D1-4&);
// [ 7] makeM(         bdlfxxx::Vfunc3<A1-3> *, OBJ*, M, c_D1-4&);
// [ 7] makeF(   bA *, bdlfxxx::Vfunc3<A1-3> *,       F, c_D1-4&);
// [ 7] makeC(   bA *, bdlfxxx::Vfunc3<A1-3> *, c_O&, C, c_D1-4&);
// [ 7] makeM(   bA *, bdlfxxx::Vfunc3<A1-3> *, OBJ*, M, c_D1-4&);
// [ 6] makeF(         bdlfxxx::Vfunc3<A1-3> *,       F, c_D1-3&);
// [ 6] makeC(         bdlfxxx::Vfunc3<A1-3> *, c_O&, C, c_D1-3&);
// [ 6] makeM(         bdlfxxx::Vfunc3<A1-3> *, OBJ*, M, c_D1-3&);
// [ 6] makeF(   bA *, bdlfxxx::Vfunc3<A1-3> *,       F, c_D1-3&);
// [ 6] makeC(   bA *, bdlfxxx::Vfunc3<A1-3> *, c_O&, C, c_D1-3&);
// [ 6] makeM(   bA *, bdlfxxx::Vfunc3<A1-3> *, OBJ*, M, c_D1-3&);
// [ 5] makeF(         bdlfxxx::Vfunc3<A1-3> *,       F, c_D1-2&);
// [ 5] makeC(         bdlfxxx::Vfunc3<A1-3> *, c_O&, C, c_D1-2&);
// [ 5] makeM(         bdlfxxx::Vfunc3<A1-3> *, OBJ*, M, c_D1-2&);
// [ 5] makeF(   bA *, bdlfxxx::Vfunc3<A1-3> *,       F, c_D1-2&);
// [ 5] makeC(   bA *, bdlfxxx::Vfunc3<A1-3> *, c_O&, C, c_D1-2&);
// [ 5] makeM(   bA *, bdlfxxx::Vfunc3<A1-3> *, OBJ*, M, c_D1-2&);
// [ 4] makeF(         bdlfxxx::Vfunc3<A1-3> *,       F, c_D1&);
// [ 4] makeC(         bdlfxxx::Vfunc3<A1-3> *, c_O&, C, c_D1&);
// [ 4] makeM(         bdlfxxx::Vfunc3<A1-3> *, OBJ*, M, c_D1&);
// [ 4] makeF(   bA *, bdlfxxx::Vfunc3<A1-3> *,       F, c_D1&);
// [ 4] makeC(   bA *, bdlfxxx::Vfunc3<A1-3> *, c_O&, C, c_D1&);
// [ 4] makeM(   bA *, bdlfxxx::Vfunc3<A1-3> *, OBJ*, M, c_D1&);
// [ 3] makeF(         bdlfxxx::Vfunc3<A1-3> *,       F);
// [ 3] makeC(         bdlfxxx::Vfunc3<A1-3> *, c_O&, C);
// [ 3] makeM(         bdlfxxx::Vfunc3<A1-3> *, OBJ*, M);
// [ 3] makeF(   bA *, bdlfxxx::Vfunc3<A1-3> *,       F);
// [ 3] makeC(   bA *, bdlfxxx::Vfunc3<A1-3> *, c_O&, C);
// [ 3] makeM(   bA *, bdlfxxx::Vfunc3<A1-3> *, OBJ*, M);
// [ 3] makeNull(      bdlfxxx::Vfunc3<A1-3> *);
// [ 3] makeNull(bA *, bdlfxxx::Vfunc3<A1-3> *);
//-----------------------------------------------------------------------------
...
class CbClass {
  public:
    void checkVfunc3ExecutionC() const
    {
        ++a0_global;
    }

    void checkVfunc3ExecutionM() const
    {
        ++a0_global;
    }
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      case 9: {
        ...
        //
        // Plan:
        //   Use each function to initialize a separate 'bdlfxxx::Vfunc3' object
        //   with the 'checkArgumentValues' function, which verifies that the
        //   parameters are "wired" correctly.  Use each function to
        //   initialize 'bdlfxxx::Vfunc3' object with the 'checkParameterTypes'
        ...
        //
        // Testing:
        //    makeF(      bdlfxxx::Vfunc3<A1-3> *,        F, c_D1-6&);
        //    makeC(      bdlfxxx::Vfunc3<A1-3> *, c_O&,  C, c_D1-6&);
        //    makeM(      bdlfxxx::Vfunc3<A1-3> *, OBJ *, M, c_D1-6&);
        //    makeF(bA *, bdlfxxx::Vfunc3<A1-3> *,        F, c_D1-6&);
        //    makeC(bA *, bdlfxxx::Vfunc3<A1-3> *, c_O&,  C, c_D1-6&);
        //    makeM(bA *, bdlfxxx::Vfunc3<A1-3> *, OBJ *, M, c_D1-6&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc3<int *, int *, int *> x1;
                bdlfxxxu::Vfunc3::makeF(&x1, checkArgumentValues9,
                                    &a4, &a5, &a6, &a7, &a8, &a9);
                x1(&a1, &a2, &a3);
            ...
            {
                bdlfxxx::Vfunc3<int *, int *, int *> x1;
                bdlfxxxu::Vfunc3::makeC(&x1, cbObj,
            ...
            {
                bdlfxxx::Vfunc3<int *, int *, int *> x1;
                bdlfxxxu::Vfunc3::makeM(&x1, &cbObj,
                                    &CbClass::checkArgumentValues9,
                                    &a4, &a5, &a6, &a7, &a8, &a9);
                x1(&a1, &a2, &a3);
                ASSERT(ARG1_PLUS1 == a1);
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            if (verbose) cout << "Testing 'makeF'" << endl;
            {
                bdlfxxx::Vfunc3<T1, T2, T3> x1;
                bdlfxxxu::Vfunc3::makeF(&x1, checkParameterTypes9,
                                    a4, a5, a6, a7, a8, a9);
                x1(a1, a2, a3);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc3<int *, int *, int *> x1;
                bdlfxxxu::Vfunc3::makeF(&ta, &x1, checkArgumentValues9,
                                    &a4, &a5, &a6, &a7, &a8, &a9);
                x1(&a1, &a2, &a3);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            {
                bdlfxxx::Vfunc3<int *, int *, int *> x1;
                bdlfxxxu::Vfunc3::makeC(&ta, &x1, cbObj,
                                    &CbClass::checkArgumentValues9,
                                    &a4, &a5, &a6, &a7, &a8, &a9);
                x1(&a1, &a2, &a3);
                ASSERT(ARG1_PLUS1 == a1);
            ...
            {
                bdlfxxx::Vfunc3<int *, int *, int *> x1;
                bdlfxxxu::Vfunc3::makeM(&ta, &x1, &cbObj,
                                    &CbClass::checkArgumentValues9,
                                    &a4, &a5, &a6, &a7, &a8, &a9);
                x1(&a1, &a2, &a3);
                ASSERT(ARG1_PLUS1 == a1);
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc3<T1, T2, T3> x1;
                bdlfxxxu::Vfunc3::makeF(&ta, &x1, checkParameterTypes9,
                                    a4, a5, a6, a7, a8, a9);
                x1(a1, a2, a3);
            }
      ...
      case 8: {
        ...
        //
        // Testing:
        //    makeF(      bdlfxxx::Vfunc3<A1-3> *,        F, c_D1-5&);
        //    makeC(      bdlfxxx::Vfunc3<A1-3> *, c_O&,  C, c_D1-5&);
        //    makeM(      bdlfxxx::Vfunc3<A1-3> *, OBJ *, M, c_D1-5&);
        //    makeF(bA *, bdlfxxx::Vfunc3<A1-3> *,        F, c_D1-5&);
        //    makeC(bA *, bdlfxxx::Vfunc3<A1-3> *, c_O&,  C, c_D1-5&);
        //    makeM(bA *, bdlfxxx::Vfunc3<A1-3> *, OBJ *, M, c_D1-5&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc3<int *, int *, int *> x1;
                bdlfxxxu::Vfunc3::makeF(&x1, checkArgumentValues8,
                                    &a4, &a5, &a6, &a7, &a8);
                x1(&a1, &a2, &a3);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc3<T1, T2, T3> x1;
                bdlfxxxu::Vfunc3::makeF(&x1, checkParameterTypes8,
                                    a4, a5, a6, a7, a8);
                x1(a1, a2, a3);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc3<int *, int *, int *> x1;
                bdlfxxxu::Vfunc3::makeF(&ta, &x1, checkArgumentValues8,
                                    &a4, &a5, &a6, &a7, &a8);
                x1(&a1, &a2, &a3);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc3<T1, T2, T3> x1;
                bdlfxxxu::Vfunc3::makeF(&ta, &x1, checkParameterTypes8,
                                    a4, a5, a6, a7, a8);
                x1(a1, a2, a3);
            }
      ...
      case 7: {
        ...
        //
        // Testing:
        //    makeF(      bdlfxxx::Vfunc3<A1-3> *,        F, c_D1-4&);
        //    makeC(      bdlfxxx::Vfunc3<A1-3> *, c_O&,  C, c_D1-4&);
        //    makeM(      bdlfxxx::Vfunc3<A1-3> *, OBJ *, M, c_D1-4&);
        //    makeF(bA *, bdlfxxx::Vfunc3<A1-3> *,        F, c_D1-4&);
        //    makeC(bA *, bdlfxxx::Vfunc3<A1-3> *, c_O&,  C, c_D1-4&);
        //    makeM(bA *, bdlfxxx::Vfunc3<A1-3> *, OBJ *, M, c_D1-4&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc3<int *, int *, int *> x1;
                bdlfxxxu::Vfunc3::makeF(&x1, checkArgumentValues7,
                                    &a4, &a5, &a6, &a7);
                x1(&a1, &a2, &a3);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc3<T1, T2, T3> x1;
                bdlfxxxu::Vfunc3::makeF(&x1, checkParameterTypes7,
                                    a4, a5, a6, a7);
                x1(a1, a2, a3);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc3<int *, int *, int *> x1;
                bdlfxxxu::Vfunc3::makeF(&ta, &x1, checkArgumentValues7,
                                    &a4, &a5, &a6, &a7);
                x1(&a1, &a2, &a3);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc3<T1, T2, T3> x1;
                bdlfxxxu::Vfunc3::makeF(&ta, &x1, checkParameterTypes7,
                                    a4, a5, a6, a7);
                x1(a1, a2, a3);
            }
      ...
      case 6: {
        ...
        //
        // Testing:
        //    makeF(      bdlfxxx::Vfunc3<A1-3> *,        F, c_D1-3&);
        //    makeC(      bdlfxxx::Vfunc3<A1-3> *, c_O&,  C, c_D1-3&);
        //    makeM(      bdlfxxx::Vfunc3<A1-3> *, OBJ *, M, c_D1-3&);
        //    makeF(bA *, bdlfxxx::Vfunc3<A1-3> *,        F, c_D1-3&);
        //    makeC(bA *, bdlfxxx::Vfunc3<A1-3> *, c_O&,  C, c_D1-3&);
        //    makeM(bA *, bdlfxxx::Vfunc3<A1-3> *, OBJ *, M, c_D1-3&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc3<int *, int *, int *> x1;
                bdlfxxxu::Vfunc3::makeF(&x1, checkArgumentValues6,
                                    &a4, &a5, &a6);
                x1(&a1, &a2, &a3);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc3<T1, T2, T3> x1;
                bdlfxxxu::Vfunc3::makeF(&x1, checkParameterTypes6,
                                    a4, a5, a6);
                x1(a1, a2, a3);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc3<int *, int *, int *> x1;
                bdlfxxxu::Vfunc3::makeF(&ta, &x1, checkArgumentValues6,
                                    &a4, &a5, &a6);
                x1(&a1, &a2, &a3);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc3<T1, T2, T3> x1;
                bdlfxxxu::Vfunc3::makeF(&ta, &x1, checkParameterTypes6,
                                    a4, a5, a6);
                x1(a1, a2, a3);
            }
      ...
      case 5: {
        ...
        //
        // Testing:
        //    makeF(      bdlfxxx::Vfunc3<A1-3> *,        F, c_D1-2&);
        //    makeC(      bdlfxxx::Vfunc3<A1-3> *, c_O&,  C, c_D1-2&);
        //    makeM(      bdlfxxx::Vfunc3<A1-3> *, OBJ *, M, c_D1-2&);
        //    makeF(bA *, bdlfxxx::Vfunc3<A1-3> *,        F, c_D1-2&);
        //    makeC(bA *, bdlfxxx::Vfunc3<A1-3> *, c_O&,  C, c_D1-2&);
        //    makeM(bA *, bdlfxxx::Vfunc3<A1-3> *, OBJ *, M, c_D1-2&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc3<int *, int *, int *> x1;
                bdlfxxxu::Vfunc3::makeF(&x1, checkArgumentValues5,
                                    &a4, &a5);
                x1(&a1, &a2, &a3);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc3<T1, T2, T3> x1;
                bdlfxxxu::Vfunc3::makeF(&x1, checkParameterTypes5,
                                    a4, a5);
                x1(a1, a2, a3);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc3<int *, int *, int *> x1;
                bdlfxxxu::Vfunc3::makeF(&ta, &x1, checkArgumentValues5,
                                    &a4, &a5);
                x1(&a1, &a2, &a3);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc3<T1, T2, T3> x1;
                bdlfxxxu::Vfunc3::makeF(&ta, &x1, checkParameterTypes5,
                                    a4, a5);
                x1(a1, a2, a3);
            }
      ...
      case 4: {
        ...
        //
        // Testing:
        //    makeF(      bdlfxxx::Vfunc3<A1-3> *,        F, c_D1&);
        //    makeC(      bdlfxxx::Vfunc3<A1-3> *, c_O&,  C, c_D1&);
        //    makeM(      bdlfxxx::Vfunc3<A1-3> *, OBJ *, M, c_D1&);
        //    makeF(bA *, bdlfxxx::Vfunc3<A1-3> *,        F, c_D1&);
        //    makeC(bA *, bdlfxxx::Vfunc3<A1-3> *, c_O&,  C, c_D1&);
        //    makeM(bA *, bdlfxxx::Vfunc3<A1-3> *, OBJ *, M, c_D1&);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc3<int *, int *, int *> x1;
                bdlfxxxu::Vfunc3::makeF(&x1, checkArgumentValues4, &a4);
                x1(&a1, &a2, &a3);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            }
            ...
            if (verbose) cout << "Testing 'makeC'" << endl;
            {
                bdlfxxx::Vfunc3<int *, int *, int *> x1;
                bdlfxxxu::Vfunc3::makeC(&x1, cbObj,
                                    &CbClass::checkArgumentValues4, &a4);
                x1(&a1, &a2, &a3);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            }
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc3<T1, T2, T3> x1;
                bdlfxxxu::Vfunc3::makeF(&x1, checkParameterTypes4, a4);
                x1(a1, a2, a3);
            }
            ...
            if (verbose) cout << "Testing 'makeC'" << endl;
            {
                ...
                CbClass cbObj;
                bdlfxxxu::Vfunc3::makeC(&x1, cbObj,
                                    &CbClass::checkParameterTypesC4, a4);
                x1(a1, a2, a3);
            }
            ...
            if (verbose) cout << "Testing 'makeM'" << endl;
            {
                ...
                CbClass cbObj;
                bdlfxxxu::Vfunc3::makeM(&x1, &cbObj,
                                     &CbClass::checkParameterTypesM4, a4);
                x1(a1, a2, a3);
            }
        }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc3<int *, int *, int *> x1;
                bdlfxxxu::Vfunc3::makeF(&ta, &x1, checkArgumentValues4, &a4);
                x1(&a1, &a2, &a3);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc3<T1, T2, T3> x1;
                bdlfxxxu::Vfunc3::makeF(&ta, &x1, checkParameterTypes4, a4);
                x1(a1, a2, a3);
            }
      ...
      case 3: {
        ...
        //
        // Testing:
        //    makeF(         bdlfxxx::Vfunc3<A1-3> *,        F);
        //    makeC(         bdlfxxx::Vfunc3<A1-3> *, c_O&,  C);
        //    makeM(         bdlfxxx::Vfunc3<A1-3> *, OBJ *, M);
        //    makeNull(      bdlfxxx::Vfunc3<A1-3> *);
        //    makeF(   bA *, bdlfxxx::Vfunc3<A1-3> *,        F);
        //    makeC(   bA *, bdlfxxx::Vfunc3<A1-3> *, c_O&,  C);
        //    makeM(   bA *, bdlfxxx::Vfunc3<A1-3> *, OBJ *, M);
        //    makeNull(bA *, bdlfxxx::Vfunc3<A1-3> *);
        // --------------------------------------------------------------------
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc3<int *, int *, int *> x1;
                bdlfxxxu::Vfunc3::makeF(&x1, checkArgumentValues3);
                x1(&a1, &a2, &a3);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            }
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc3<T1, T2, T3> x1;
                bdlfxxxu::Vfunc3::makeF(&x1, checkParameterTypes3);
                x1(a1, a2, a3);
            }
            ...
            cout << "\nTesting argument values." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc3<int *, int *, int *> x1;
                bdlfxxxu::Vfunc3::makeF(&ta, &x1, checkArgumentValues3);
                x1(&a1, &a2, &a3);
                ASSERT(ARG1_PLUS1 == a1);
                a1 = ARG1;
            ...
            {
                bdlfxxx::Vfunc3<int *, int *, int *> x1;
                bdlfxxxu::Vfunc3::makeNull(&ta, &x1);
                x1(&a1, &a2, &a3);
            ...
            cout << "\nTesting parameter types." << endl;
        {
            ...
            {
                bdlfxxx::Vfunc3<T1, T2, T3> x1;
                bdlfxxxu::Vfunc3::makeF(&ta, &x1, checkParameterTypes3);
                x1(a1, a2, a3);
            }
