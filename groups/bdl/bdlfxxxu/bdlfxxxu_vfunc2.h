// bdlfxxxu_vfunc2.h                                                  -*-C++-*-
#ifndef INCLUDED_BDLFXXXU_VFUNC2
#define INCLUDED_BDLFXXXU_VFUNC2
...
//
//@CLASSES:
//   bdlfxxxu::Vfunc2: namespace for factory methods loading 2-arg void functors
//
...
//..
//   bdlfxxxu::Vfunc2::makeF:    Initialize the functor by embedding a function
//                           (or another functor) and any additional trailing
//                           arguments.
//
//   bdlfxxxu::Vfunc2::makeC:    Initialize the functor by embedding an object, one
//                           of that object's 'const' methods, and any
//                           additional trailing arguments for that method.
//
//   bdlfxxxu::Vfunc2::makeM:    Initialize the functor by embedding THE ADDRESS OF
...
//
//   bdlfxxxu::Vfunc2::makeNull: Initialize the functor with an empty function.
//..
...
struct Vfunc2 {
    ...
    static void makeNull(bdlfxxx::Vfunc2<A1, A2> *handle)
        ...
        // the currently installed default allocator is used.
    {
        ...
        *handle = bdlfxxx::Vfunc2<A1, A2>(new(*ba) bdlfxxxi::Vfunc2Null<A1, A2>(ba));
    }

    template <class A1, class A2>
    static void makeNull(bslma::Allocator *basicAllocator,
                         bdlfxxx::Vfunc2<A1, A2> *handle)
        // Initialize the specified two-argument empty functor 'handle'.
        // Optionally specify, as the *first* argument, a 'basicAllocator'
        // used to supply memory.  If 'basicAllocator' is 0 or unspecified,
        // the currently installed default allocator is used.
    ...
    static void makeF(bdlfxxx::Vfunc2<A1, A2> *handle, F function)
    ...
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc2<A1, A2>(
                             new(*ba) bdlfxxxi::Vfunc2F2<F, A1, A2>(function, ba));
    }
    ...
    static void makeF(bdlfxxx::Vfunc2<A1, A2> *handle,
                      F                function,
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc2<A1, A2>(
          new(*ba) bdlfxxxi::Vfunc2F3<F, A1, A2, D1> (function, embeddedArg1, ba));
    }
        ...
        // the currently installed default allocator is used.
    {
        ...
        *handle = bdlfxxx::Vfunc2<A1, A2>(
            new(*ba) bdlfxxxi::Vfunc2F4<F, A1, A2, D1, D2>
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc2<A1, A2>(
            new(*ba) bdlfxxxi::Vfunc2F5<F, A1, A2, D1, D2, D3>
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc2<A1, A2>(
            new(*ba) bdlfxxxi::Vfunc2F6<F, A1, A2, D1, D2, D3, D4>
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc2<A1, A2>(
            new(*ba) bdlfxxxi::Vfunc2F7<F, A1, A2, D1, D2, D3, D4, D5>
                (function, embeddedArg1, embeddedArg2, embeddedArg3,
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc2<A1, A2>(
            new(*ba) bdlfxxxi::Vfunc2F8<F, A1, A2, D1, D2, D3, D4, D5, D6>
                (function, embeddedArg1, embeddedArg2, embeddedArg3,
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc2<A1, A2>(
            new(*ba) bdlfxxxi::Vfunc2F9<F, A1, A2, D1, D2, D3, D4, D5, D6, D7>
                (function, embeddedArg1, embeddedArg2, embeddedArg3,
    ...
    static void makeC(bdlfxxx::Vfunc2<A1, A2> *handle, const OBJ& object,
                      C                method)
        // Initialize the specified two-argument functor 'handle' by embedding
        // the specified 'function' (or functor) taking no additional trailing
        // arguments.  Optionally specify, as the *first* argument, a
        ...
        // or unspecified, the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc2<A1, A2>(
            new(*ba) bdlfxxxi::Vfunc2C2<OBJ, C, A1, A2>(object, method, ba));
    }
    ...
    static void makeC(bdlfxxx::Vfunc2<A1, A2> *handle,
                      const OBJ&       object,
                      C                method,
                      const D1&        embeddedArg1)
        // Initialize the specified two-argument functor 'handle' by embedding
        ...
        // default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc2<A1, A2>(
            new(*ba) bdlfxxxi::Vfunc2C3<OBJ, C, A1, A2, D1>(
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc2<A1, A2>(
            new(*ba) bdlfxxxi::Vfunc2C4<OBJ, C, A1, A2, D1, D2>(
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc2<A1, A2>(
            new(*ba) bdlfxxxi::Vfunc2C5<OBJ, C, A1, A2, D1, D2, D3>(
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc2<A1, A2>(
            new(*ba) bdlfxxxi::Vfunc2C6<OBJ, C, A1, A2, D1, D2, D3, D4>(
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc2<A1, A2>(
            new(*ba) bdlfxxxi::Vfunc2C7<OBJ, C, A1, A2, D1, D2, D3, D4, D5>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, ba));
    }
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc2<A1, A2>(
            new(*ba) bdlfxxxi::Vfunc2C8<OBJ, C, A1, A2, D1, D2, D3, D4, D5, D6>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, embeddedArg6, ba));
    }
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc2<A1, A2>(
           new(*ba) bdlfxxxi::Vfunc2C9<OBJ, C, A1, A2, D1, D2, D3, D4, D5, D6, D7>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, embeddedArg6, embeddedArg7,  ba));
    }
    ...
    static void makeM(bdlfxxx::Vfunc2<A1, A2> *handle, OBJ *object,
                      M                method)
        // Initialize the specified two-argument functor 'handle' by embedding
        ...
        // or unspecified, the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc2<A1, A2>(
            new(*ba) bdlfxxxi::Vfunc2M2<OBJ, M, A1, A2>(object, method, ba));
    }
    ...
    static void makeM(bdlfxxx::Vfunc2<A1, A2> *handle,
                      OBJ             *object,
                      M                method,
                      const D1&        embeddedArg1)
        // Initialize the specified two-argument functor 'handle' by embedding
        ...
        // default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc2<A1, A2>(
            new(*ba) bdlfxxxi::Vfunc2M3<OBJ, M, A1, A2, D1>(
                object, method, embeddedArg1, ba));
    }
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc2<A1, A2>(
            new(*ba) bdlfxxxi::Vfunc2M4<OBJ, M, A1, A2, D1, D2>(
                object, method, embeddedArg1, embeddedArg2, ba));
    }
...
static void makeM(bdlfxxx::Vfunc2<A1, A2> *handle,
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc2<A1, A2>(
            new(*ba) bdlfxxxi::Vfunc2M5<OBJ, M, A1, A2, D1, D2, D3>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3, ba));
    }
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc2<A1, A2>(
            new(*ba) bdlfxxxi::Vfunc2M6<OBJ, M, A1, A2, D1, D2, D3, D4>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, ba));
    }
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc2<A1, A2>(
            new(*ba) bdlfxxxi::Vfunc2M7<OBJ, M, A1, A2, D1, D2, D3, D4, D5>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, ba));
    }
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc2<A1, A2>(
            new(*ba) bdlfxxxi::Vfunc2M8<OBJ, M, A1, A2, D1, D2, D3, D4, D5, D6>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, embeddedArg6, ba));
    }
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc2<A1, A2>(
           new(*ba) bdlfxxxi::Vfunc2M9<OBJ, M, A1, A2, D1, D2, D3, D4, D5, D6, D7>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, embeddedArg6, embeddedArg7, ba));
    }
