// bdlfxxxu_vfunc1.h                                                  -*-C++-*-
#ifndef INCLUDED_BDLFXXXU_VFUNC1
#define INCLUDED_BDLFXXXU_VFUNC1
...
//
//@CLASSES:
//   bdlfxxxu::Vfunc1: namespace for factory methods loading 1-arg void functors
//
...
//..
//   bdlfxxxu::Vfunc1::makeF:    Initialize the functor by embedding a function
//                           (or another functor) and any additional trailing
//                           arguments.
//
//   bdlfxxxu::Vfunc1::makeC:    Initialize the functor by embedding an object, one
//                           of that object's 'const' methods, and any
//                           additional trailing arguments for that method.
//
//   bdlfxxxu::Vfunc1::makeM:    Initialize the functor by embedding THE ADDRESS OF
...
//
//   bdlfxxxu::Vfunc1::makeNull: Initialize the functor with an empty function.
//..
...
#ifndef INCLUDED_BDLFXXX_VFUNC1
#include <bdlfxxx_vfunc1.h>
#endif

#ifndef INCLUDED_BDLFXXXI_VFUNC1
#include <bdlfxxxi_vfunc1.h>
#endif
...
struct Vfunc1 {
    ...
    template <class A1>
    static void makeNull(bdlfxxx::Vfunc1<A1> *handle)
        ...
        // the currently installed default allocator is used.
    {
        ...
        *handle = bdlfxxx::Vfunc1<A1>(new(*ba) bdlfxxxi::Vfunc1Null<A1>(ba));
    }

    template <class A1>
    static void makeNull(bslma::Allocator *basicAllocator,
                         bdlfxxx::Vfunc1<A1> *handle)
        // Initialize the specified one-argument empty functor 'handle'.
        // Optionally specify, as the *first* argument, a 'basicAllocator'
        // used to supply memory.  If 'basicAllocator' is 0 or unspecified,
        // the currently installed default allocator is used.
    ...
    static void makeF(bdlfxxx::Vfunc1<A1> *handle, F function)
    ...
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc1<A1>(
                              new(*ba) bdlfxxxi::Vfunc1F1<F, A1>(function, ba));
    }
    ...
    static void makeF(bdlfxxx::Vfunc1<A1> *handle,
                      F                function,
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc1<A1>(
            new(*ba) bdlfxxxi::Vfunc1F2<F, A1, D1> (function, embeddedArg1, ba));
    }
        ...
        // the currently installed default allocator is used.
    {
        ...
        *handle = bdlfxxx::Vfunc1<A1>(
            new(*ba) bdlfxxxi::Vfunc1F3<F, A1, D1, D2>
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc1<A1>(
            new(*ba) bdlfxxxi::Vfunc1F4<F, A1, D1, D2, D3>
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc1<A1>(
            new(*ba) bdlfxxxi::Vfunc1F5<F, A1, D1, D2, D3, D4>
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc1<A1>(
            new(*ba) bdlfxxxi::Vfunc1F6<F, A1, D1, D2, D3, D4, D5>
                (function, embeddedArg1, embeddedArg2, embeddedArg3,
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc1<A1>(
            new(*ba) bdlfxxxi::Vfunc1F7<F, A1, D1, D2, D3, D4, D5, D6>
                (function, embeddedArg1, embeddedArg2, embeddedArg3,
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc1<A1>(
            new(*ba) bdlfxxxi::Vfunc1F8<F, A1, D1, D2, D3, D4, D5, D6, D7>
                (function, embeddedArg1, embeddedArg2, embeddedArg3,
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc1<A1>(
            new(*ba) bdlfxxxi::Vfunc1F9<F, A1, D1, D2, D3, D4, D5, D6, D7, D8>
                (function, embeddedArg1, embeddedArg2, embeddedArg3,
    ...
    static void makeC(bdlfxxx::Vfunc1<A1> *handle, const OBJ& object,
                      C                method)
        // Initialize the specified one-argument functor 'handle' by embedding
        // the specified 'function' (or functor) taking no additional trailing
        // arguments.  Optionally specify, as the *first* argument, a
        ...
        // or unspecified, the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc1<A1>(
            new(*ba) bdlfxxxi::Vfunc1C1<OBJ, C, A1>(object, method, ba));
    }
    ...
    static void makeC(bdlfxxx::Vfunc1<A1> *handle,
                      const OBJ&       object,
                      C                method,
                      const D1&        embeddedArg1)
        // Initialize the specified one-argument functor 'handle' by embedding
        ...
        // default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc1<A1>(
            new(*ba) bdlfxxxi::Vfunc1C2<OBJ, C, A1, D1>(
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc1<A1>(
            new(*ba) bdlfxxxi::Vfunc1C3<OBJ, C, A1, D1, D2>(
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc1<A1>(
            new(*ba) bdlfxxxi::Vfunc1C4<OBJ, C, A1, D1, D2, D3>(
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc1<A1>(
            new(*ba) bdlfxxxi::Vfunc1C5<OBJ, C, A1, D1, D2, D3, D4>(
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc1<A1>(
            new(*ba) bdlfxxxi::Vfunc1C6<OBJ, C, A1, D1, D2, D3, D4, D5>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, ba));
    }
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc1<A1>(
            new(*ba) bdlfxxxi::Vfunc1C7<OBJ, C, A1, D1, D2, D3, D4, D5, D6>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, embeddedArg6, ba));
    }
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc1<A1>(
            new(*ba) bdlfxxxi::Vfunc1C8<OBJ, C, A1, D1, D2, D3, D4, D5, D6, D7>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, embeddedArg6, embeddedArg7,  ba));
    }
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc1<A1>(
           new(*ba) bdlfxxxi::Vfunc1C9<OBJ, C, A1, D1, D2, D3, D4, D5, D6, D7, D8>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, embeddedArg6, embeddedArg7,
                embeddedArg8, ba));
    }
    ...
    static void makeM(bdlfxxx::Vfunc1<A1> *handle, OBJ *object,
                      M                method)
        // Initialize the specified one-argument functor 'handle' by embedding
        ...
        // or unspecified, the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc1<A1>(
            new(*ba) bdlfxxxi::Vfunc1M1<OBJ, M, A1>(object, method, ba));
    }
    ...
    static void makeM(bdlfxxx::Vfunc1<A1> *handle,
                      OBJ             *object,
                      M                method,
                      const D1&        embeddedArg1)
        // Initialize the specified one-argument functor 'handle' by embedding
        ...
        // default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc1<A1>(
            new(*ba) bdlfxxxi::Vfunc1M2<OBJ, M, A1, D1>(
                object, method, embeddedArg1, ba));
    }
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc1<A1>(
            new(*ba) bdlfxxxi::Vfunc1M3<OBJ, M, A1, D1, D2>(
                object, method, embeddedArg1, embeddedArg2, ba));
    }
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc1<A1>(
            new(*ba) bdlfxxxi::Vfunc1M4<OBJ, M, A1, D1, D2, D3>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3, ba));
    }
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc1<A1>(
            new(*ba) bdlfxxxi::Vfunc1M5<OBJ, M, A1, D1, D2, D3, D4>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, ba));
    }
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc1<A1>(
            new(*ba) bdlfxxxi::Vfunc1M6<OBJ, M, A1, D1, D2, D3, D4, D5>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, ba));
    }
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc1<A1>(
            new(*ba) bdlfxxxi::Vfunc1M7<OBJ, M, A1, D1, D2, D3, D4, D5, D6>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, embeddedArg6, ba));
    }
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc1<A1>(
            new(*ba) bdlfxxxi::Vfunc1M8<OBJ, M, A1, D1, D2, D3, D4, D5, D6, D7>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, embeddedArg6, embeddedArg7, ba));
    }
        ...
        // the currently installed default allocator is used.
    {
        bslma::Allocator *ba = bslma::Default::defaultAllocator();
        *handle = bdlfxxx::Vfunc1<A1>(
           new(*ba) bdlfxxxi::Vfunc1M9<OBJ, M, A1, D1, D2, D3, D4, D5, D6, D7, D8>(
                object, method, embeddedArg1, embeddedArg2, embeddedArg3,
                embeddedArg4, embeddedArg5, embeddedArg6, embeddedArg7,
                embeddedArg8, ba));
    }
