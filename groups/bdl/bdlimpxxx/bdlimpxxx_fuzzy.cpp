// bdlimpxxx_fuzzy.cpp          -*-C++-*-
#include <bdlimpxxx_fuzzy.h>

#include <bsls_ident.h>
BSLS_IDENT_RCSID(bdlimpxxx_fuzzy_cpp,"$Id$ $CSID$")

namespace BloombergLP {

const double bdlimpxxx::Fuzzy::S_DEFAULT_REL_TOL = 1e-12;  // Default relative and
const double bdlimpxxx::Fuzzy::S_DEFAULT_ABS_TOL = 1e-24;  // absolute tolerances.
...
// CLASS METHODS
int Fuzzy::compare(double a, double b, double relTol, double absTol)
{
    enum {
