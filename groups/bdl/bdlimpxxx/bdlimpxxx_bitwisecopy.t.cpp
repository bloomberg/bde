...
inline void performtest(const char *name, char *testsource, char *testdest)
{
        ...
        times(&endmemcpyTime);
        for (int i = 0; i < iter; ++i) {
            bdlimpxxx::BitwiseCopy<T>::copy(&TD, &TS);
            avoidopt((int *) &i, &TD,  &TS);
            bdlimpxxx::BitwiseCopy<T>::copy(&TD, &TS);
            avoidopt((int *) &i, &TD,  &TS);
            bdlimpxxx::BitwiseCopy<T>::copy(&TD, &TS);
...
{
    bdlimpxxx::BitwiseCopy<TYPE>::swap(d_array_p + index1, d_array_p + index2);
}
...
int main(int argc, char *argv[]) {
    ...
    switch (test) { case 0:
      case 3: {
        ...
        bdlimpxxx::BitwiseCopy<MyObject>::copy(dstAddr, srcAddr);
        ...
        bdlimpxxx::BitwiseCopy<MyObject>::swap(&srcObj, &dstObj);
        ...
        if (performanceTest != 0) {
            ...
            switch (perfTest) {
              ...
              case 9: {
                ...
                times(&startTime);
                for (int i = 0; i < 20000000; ++i) {
                    bdlimpxxx::BitwiseCopy<testChar143>::copy(&TD, &TS);
                    avoidopt((int *) &i, &TD,  &TS);
                    bdlimpxxx::BitwiseCopy<testChar143>::copy(&TD, &TS);
                    avoidopt((int *) &i, &TD,  &TS);
                    bdlimpxxx::BitwiseCopy<testChar143>::copy(&TD, &TS);
              ...
              case 8: {
                ...
                times(&startTime);
                for (int i = 0; i < 20000000; ++i) {
                    bdlimpxxx::BitwiseCopy<testChar43>::copy(&TD, &TS);
                    avoidopt((int *) &i, &TD,  &TS);
                    bdlimpxxx::BitwiseCopy<testChar43>::copy(&TD, &TS);
                    avoidopt((int *) &i, &TD,  &TS);
                    bdlimpxxx::BitwiseCopy<testChar43>::copy(&TD, &TS);
              ...
              case 7: {
                ...
                times(&startTime);
                for (int i = 0; i < 20000000; ++i) {
                    bdlimpxxx::BitwiseCopy<testChar10>::copy(&TD, &TS);
                    avoidopt((int *) &i, &TD,  &TS);
                    bdlimpxxx::BitwiseCopy<testChar10>::copy(&TD, &TS);
                    avoidopt((int *) &i, &TD,  &TS);
                    bdlimpxxx::BitwiseCopy<testChar10>::copy(&TD, &TS);
              ...
              case 6: {
                ...
                times(&startTime);
                for (int i = 0; i < 20000000; ++i) {
                    bdlimpxxx::BitwiseCopy<testChar4>::copy(&TD, &TS);
                    avoidopt((int *) &i, &TD,  &TS);
                    bdlimpxxx::BitwiseCopy<testChar4>::copy(&TD, &TS);
                    avoidopt((int *) &i, &TD,  &TS);
                    bdlimpxxx::BitwiseCopy<testChar4>::copy(&TD, &TS);
              ...
              case 5: {
                ...
                times(&startTime);
                for (int i = 0; i < 200000; ++i) {
                    bdlimpxxx::BitwiseCopy<testInt143>::copy(&TD, &TS);
                    avoidopt((int *) &i, &TD,  &TS);
                    bdlimpxxx::BitwiseCopy<testInt143>::copy(&TD, &TS);
                    avoidopt((int *) &i, &TD,  &TS);
                    bdlimpxxx::BitwiseCopy<testInt143>::copy(&TD, &TS);
              ...
              case 4: {
                ...
                times(&startTime);
                for (int i = 0; i < 20000000; ++i) {
                    bdlimpxxx::BitwiseCopy<testInt10>::copy(&TD, &TS);
                    avoidopt((int *) &i, &TD,  &TS);
                    bdlimpxxx::BitwiseCopy<testInt10>::copy(&TD, &TS);
                    avoidopt((int *) &i, &TD,  &TS);
                    bdlimpxxx::BitwiseCopy<testInt10>::copy(&TD, &TS);
              ...
              case 3: {
                ...
                times(&startTime);
                for (int i = 0; i < 20000000; ++i) {
                    bdlimpxxx::BitwiseCopy<testInt4>::copy(&TD, &TS);
                    avoidopt((int *) &i, &TD,  &TS);
                    bdlimpxxx::BitwiseCopy<testInt4>::copy(&TD, &TS);
                    avoidopt((int *) &i, &TD,  &TS);
                    bdlimpxxx::BitwiseCopy<testInt4>::copy(&TD, &TS);
              ...
              case 2: {
                ...
                times(&startTime);
                for (int i = 0; i < 20000000; ++i) {
                    bdlimpxxx::BitwiseCopy<testInt>::copy(&TD, &TS);
                    avoidopt((int *) &i, &TD,  &TS);
                    bdlimpxxx::BitwiseCopy<testInt>::copy(&TD, &TS);
                    avoidopt((int *) &i, &TD,  &TS);
                    bdlimpxxx::BitwiseCopy<testInt>::copy(&TD, &TS);
      ...
      case 1: {
        ...
        //
        // Testing:
        //    bdlimpxxx::BitwiseCopy<T>::copy(d, s);
        //
        // --------------------------------------------------------------------
        union Align {
          char                                d_bytes[4096];
                          ...
                          << "testing copy of int[7] struct." << endl;
        {
            ...
            bdlimpxxx::BitwiseCopy<testInt7>::copy(&TD, &TS);
                          ...
                          << "testing copy of int[8] struct." << endl;
        {
            ...
            bdlimpxxx::BitwiseCopy<testInt8>::copy(&TD, &TS);
                          ...
                          << "testing copy of double[3] struct." << endl;
        {
            ...
            bdlimpxxx::BitwiseCopy<testDouble3>::copy(&TD, &TS);
                     ...
                     << "testing copy of char struct. int aligned" << endl;
        {
            ...
            bdlimpxxx::BitwiseCopy<testChar>::copy(&TD, &TS);
