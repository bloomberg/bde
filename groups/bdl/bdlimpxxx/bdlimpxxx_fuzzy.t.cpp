...
// The 'bdlimpxxx::Fuzzy' utility functions are well suited for comparing both
...
//..
            if (bdlimpxxx::Fuzzy::gt(a, b, 1e-1, 1e-3)) {
                if (verbose) {
...
//..
//  bdlimpxxx_fuzzy::ne(a, b, 1e-1, 1e-3) && a > b
//..
// is true.
        }
      } break;
      case 5: {
        ...
        //
        // Testing:
        //   The numerical example from 'bdlimpxxx_fuzzy.h'.
        // --------------------------------------------------------------------
