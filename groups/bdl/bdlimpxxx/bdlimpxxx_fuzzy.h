...
//
//@CLASSES:
//   bdlimpxxx::Fuzzy: namespace for "fuzzy" comparison functions
//
...
// associated static member functions defined within the 'bdlimpxxx::Fuzzy'
...
//  ------------   ---------------   --------------------------------------
//       ==             ~eq          bdlimpxxx::Fuzzy::eq(a, b, relTol, absTol)
//       !=             ~ne          bdlimpxxx::Fuzzy::ne(a, b, relTol, absTol)
//       <              ~lt          bdlimpxxx::Fuzzy::lt(a, b, relTol, absTol)
//       <=             ~le          bdlimpxxx::Fuzzy::le(a, b, relTol, absTol)
//       >              ~gt          bdlimpxxx::Fuzzy::gt(a, b, relTol, absTol)
//       >=             ~ge          bdlimpxxx::Fuzzy::ge(a, b, relTol, absTol)
//..
...
// CLASS METHODS
inline
int Fuzzy::compare(double a, double b)
{
    return compare(a, b, S_DEFAULT_REL_TOL, S_DEFAULT_ABS_TOL);
}

inline
int Fuzzy::compare(double a, double b, double relTol)
{
    return compare(a, b, relTol, S_DEFAULT_ABS_TOL);
}

inline
bool Fuzzy::eq(double a, double b)
{
    return compare(a, b, S_DEFAULT_REL_TOL, S_DEFAULT_ABS_TOL) == 0;
}

inline
bool Fuzzy::eq(double a, double b, double relTol)
{
    return compare(a, b, relTol, S_DEFAULT_ABS_TOL) == 0;
}

inline
bool Fuzzy::eq(double a, double b, double relTol, double absTol)
{
    return compare(a, b, relTol, absTol) == 0;
}

inline
bool Fuzzy::ne(double a, double b)
{
    return compare(a, b, S_DEFAULT_REL_TOL, S_DEFAULT_ABS_TOL) != 0;
}

inline
bool Fuzzy::ne(double a, double b, double relTol)
{
    return compare(a, b, relTol, S_DEFAULT_ABS_TOL) != 0;
}

inline
bool Fuzzy::ne(double a, double b, double relTol, double absTol)
{
    return compare(a, b, relTol, absTol) != 0;
}

inline
bool Fuzzy::lt(double a, double b)
{
    return compare(a, b, S_DEFAULT_REL_TOL, S_DEFAULT_ABS_TOL) < 0;
}

inline
bool Fuzzy::lt(double a, double b, double relTol)
{
    return compare(a, b, relTol, S_DEFAULT_ABS_TOL) < 0;
}

inline
bool Fuzzy::lt(double a, double b, double relTol, double absTol)
{
    return compare(a, b, relTol, absTol) < 0;
}

inline
bool Fuzzy::le(double a, double b)
{
    return compare(a, b, S_DEFAULT_REL_TOL, S_DEFAULT_ABS_TOL) <= 0;
}

inline
bool Fuzzy::le(double a, double b, double relTol)
{
    return compare(a, b, relTol, S_DEFAULT_ABS_TOL) <= 0;
}

inline
bool Fuzzy::le(double a, double b, double relTol, double absTol)
{
    return compare(a, b, relTol, absTol) <= 0;
}

inline
bool Fuzzy::gt(double a, double b)
{
    return compare(a, b, S_DEFAULT_REL_TOL, S_DEFAULT_ABS_TOL) > 0;
}

inline
bool Fuzzy::gt(double a, double b, double relTol)
{
    return compare(a, b, relTol, S_DEFAULT_ABS_TOL) > 0;
}

inline
bool Fuzzy::gt(double a, double b, double relTol, double absTol)
{
    return compare(a, b, relTol, absTol) > 0;
}

inline
bool Fuzzy::ge(double a, double b)
{
    return compare(a, b, S_DEFAULT_REL_TOL, S_DEFAULT_ABS_TOL) >= 0;
}

inline
bool Fuzzy::ge(double a, double b, double relTol)
{
    return compare(a, b, relTol, S_DEFAULT_ABS_TOL) >= 0;
}

inline
bool Fuzzy::ge(double a, double b, double relTol, double absTol)
{
    return compare(a, b, relTol, absTol) >= 0;
}
...
namespace bdlimpxxx {
inline
int Fuzzy::fuzzyCompare(double a,
                               double b,
                               double relTol,
                               double absTol)
{
