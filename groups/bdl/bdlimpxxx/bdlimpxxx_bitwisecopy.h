// bdlimpxxx_bitwisecopy.h                                            -*-C++-*-
#ifndef INCLUDED_BDLIMPXXX_BITWISECOPY
#define INCLUDED_BDLIMPXXX_BITWISECOPY
...
//
//@CLASSES:
//   bdlimpxxx::BitwiseCopy: namespace for bitwise copy function
//
...
// 'bdlimpxxx::BitwiseCopy' component.
//..
//  // my_array.h
//  template <class TYPE>
//  class my_Array {
...
template <class TYPE>
inline
void BitwiseCopy<TYPE>::copy(TYPE *dstAddr, const TYPE *srcAddr)
{
...
template <class TYPE>
inline
void BitwiseCopy<TYPE>::swap(TYPE *addr1, TYPE *addr2)
{
    ...
    BitwiseCopy<TYPE>::copy(&temp.object(), addr1);
    BitwiseCopy<TYPE>::copy(addr1, addr2);
    BitwiseCopy<TYPE>::copy(addr2, &temp.object());
}
