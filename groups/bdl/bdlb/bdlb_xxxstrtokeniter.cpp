// bdlb_xxxstrtokeniter.cpp                                           -*-C++-*-
#include <bdlb_xxxstrtokeniter.h>

#include <bsls_ident.h>
BSLS_IDENT_RCSID(bdlb_xxxstrtokeniter_cpp,"$Id$ $CSID$")
...
///--------------------
// 'bdlb::StrTokenIter' was originally implemented using 'bdea::CharArray'.
// The internal capacity of instances of that container never shrinks.  Use of
// 'bdea::CharArray' was replaced with 'bsl::string' prior to releasing this
...
// adversely impact the efficiency of 'bdlb::StrTokenIter'.  However, STLport
...
//CREATORS
StrTokenIter::StrTokenIter(const char       *input,
...
StrTokenIter::~StrTokenIter()
{
}

// MANIPULATORS
void StrTokenIter::operator++()
{
...
void StrTokenIter::reset(const char *input)
{
    d_string_p = input;
...
// ACCESSORS
bool StrTokenIter::isHard() const
{
...
bool StrTokenIter::isPreviousHard() const
{
...
bool StrTokenIter::hasSoft() const
{
    const char *dBuf = d_delimBuf_p->data();
...
bool StrTokenIter::hasPreviousSoft() const
{
    const char *dBuf = d_prevBuf_p->data();
    unsigned char firstCharType = d_delimTable[(unsigned char)*dBuf];
