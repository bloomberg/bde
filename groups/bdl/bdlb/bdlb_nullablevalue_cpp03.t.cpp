// bdlb_nullablevalue_cpp03.t.cpp                                     -*-C++-*-
...
// original.
//
// Generated on Fri Feb 12 08:20:26 2021
// Command line: sim_cpp11_features.pl bdlb_nullablevalue.t.cpp

// Expanded test driver only when compiling bdlb_nullablevalue.cpp
#ifdef COMPILING_BDLB_NULLABLEVALUE_T_CPP

// No C++03 Expansion

#else // if ! defined(COMPILING_BDLB_NULLABLEVALUE_T_CPP)

// Trivial program when not compiling bdlb_nullablevalue.t.cpp
int main() {
    return -1;
}

#endif // defined(COMPILING_BDLB_NULLABLEVALUE_T_CPP)
