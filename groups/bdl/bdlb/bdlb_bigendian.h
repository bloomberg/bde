...
///Usage
///-----
// 'bdeut::BigEndian' types are very useful to represent structures meant to be
...
//          // This line will work on any architecture.  'bdeut::BigEndian'
...
class BigEndianInt16 {
  ...
  public:
    // TRAITS
    BSLALG_DECLARE_NESTED_TRAITS2(BigEndianInt16,
    ...
    static BigEndianInt16 make(short value);
        // Create and initialize a 'BigEndianInt16' object which stores
...
// FREE OPERATORS
inline
bool operator==(const BigEndianInt16& lhs,
                const BigEndianInt16& rhs);
    // Return 'true' if the specified 'lhs' and 'rhs' 'BigEndianInt16'
    // objects have the same value, and 'false' otherwise.  Two
    // 'BigEndianInt16' objects have the same value if and only if the
...
bool operator!=(const BigEndianInt16& lhs,
    ...
    // 'BigEndianInt16' objects do not have the same value if and only if
...
class BigEndianUint16 {
  ...
  public:
    // TRAITS
    BSLALG_DECLARE_NESTED_TRAITS2(BigEndianUint16,
                                  bslalg::TypeTraitBitwiseCopyable,
                                  bdlb::TypeTraitHasPrintMethod);
    ...
    static BigEndianUint16 make(unsigned short value);
        // Create and initialize a 'BigEndianUint16' object which stores
...
// FREE OPERATORS
inline
bool operator==(const BigEndianUint16& lhs,
                const BigEndianUint16& rhs);
    // Return 'true' if the specified 'lhs' and 'rhs' 'BigEndianUint16'
    // objects have the same value, and 'false' otherwise.  Two
    // 'BigEndianUint16' objects have the same value if and only if the
    // respective integral network byte-order values that they represent have
    // the same value.
...
bool operator!=(const BigEndianUint16& lhs,
    ...
    // Return 'true' if the specified 'lhs' and 'rhs' 'BigEndianUint16'
    // objects do not have the same value, and 'false' otherwise.  Two
    // 'BigEndianUint16' objects do not have the same value if and only
...
class BigEndianInt32 {
  ...
  public:
    // TRAITS
    BSLALG_DECLARE_NESTED_TRAITS2(BigEndianInt32,
                                  bslalg::TypeTraitBitwiseCopyable,
                                  bdlb::TypeTraitHasPrintMethod);
    ...
    static BigEndianInt32 make(int value);
        // Create and initialize a 'BigEndianInt32' object which stores
...
// FREE OPERATORS
inline
bool operator==(const BigEndianInt32& lhs,
                const BigEndianInt32& rhs);
    // Return 'true' if the specified 'lhs' and 'rhs' 'BigEndianInt32'
    // objects have the same value, and 'false' otherwise.  Two
    // 'BigEndianInt32' objects have the same value if and only if the
    // respective integral network byte-order values that they represent have
    // the same value.
...
bool operator!=(const BigEndianInt32& lhs,
    ...
    // Return 'true' if the specified 'lhs' and 'rhs' 'BigEndianInt32'
    // objects do not have the same value, and 'false' otherwise.  Two
    // 'BigEndianInt32' objects do not have the same value if and only if
    // the respective integral network byte-order values that they represent do
    // not have the same value.
...
class BigEndianUint32 {
  ...
  public:
    // TRAITS
    BSLALG_DECLARE_NESTED_TRAITS2(BigEndianUint32,
                                  bslalg::TypeTraitBitwiseCopyable,
                                  bdlb::TypeTraitHasPrintMethod);
    ...
    static BigEndianUint32 make(unsigned int value);
        // Create and initialize a 'BigEndianUint32' object which stores
...
bool operator==(const BigEndianUint32& lhs,
                const BigEndianUint32& rhs);
    // Return 'true' if the specified 'lhs' and 'rhs' 'BigEndianUint32'
    // objects have the same value, and 'false' otherwise.  Two
    // 'BigEndianUint32' objects have the same value if and only if the
    // respective integral network byte-order values that they represent have
    // the same value.
...
bool operator!=(const BigEndianUint32& lhs,
    ...
    // Return 'true' if the specified 'lhs' and 'rhs' 'BigEndianUint32'
    // objects do not have the same value, and 'false' otherwise.  Two
    // 'BigEndianUint32' objects do not have the same value if and only
    // if the respective integral network byte-order values that they represent
    // do not have the same value.
...
class BigEndianInt64 {
  ...
  public:
    // TRAITS
    BSLALG_DECLARE_NESTED_TRAITS2(BigEndianInt64,
                                  bslalg::TypeTraitBitwiseCopyable,
                                  bdlb::TypeTraitHasPrintMethod);
    ...
    static BigEndianInt64 make(bsls::Types::Int64 value);
        // Create and initialize a 'BigEndianInt64' object which stores
...
// FREE OPERATORS
inline
bool operator==(const BigEndianInt64& lhs,
                const BigEndianInt64& rhs);
    // Return 'true' if the specified 'lhs' and 'rhs' 'BigEndianInt64'
    // objects have the same value, and 'false' otherwise.  Two
    // 'BigEndianInt64' objects have the same value if and only if the
    // respective integral network byte-order values that they represent have
    // the same value.
...
bool operator!=(const BigEndianInt64& lhs,
    ...
    // Return 'true' if the specified 'lhs' and 'rhs' 'BigEndianInt64'
    // objects do not have the same value, and 'false' otherwise.  Two
    // 'BigEndianInt64' objects do not have the same value if and only if
    // the respective integral network byte-order values that they represent do
    // not have the same value.
...
class BigEndianUint64 {
  ...
  public:
    // TRAITS
    BSLALG_DECLARE_NESTED_TRAITS2(BigEndianUint64,
                                  bslalg::TypeTraitBitwiseCopyable,
                                  bdlb::TypeTraitHasPrintMethod);
...
bool operator==(const BigEndianUint64& lhs,
                const BigEndianUint64& rhs);
    // Return 'true' if the specified 'lhs' and 'rhs' 'BigEndianUint64'
    // objects have the same value, and 'false' otherwise.  Two
    // 'BigEndianUint64' objects have the same value if and only if the
    // respective integral network byte-order values that they represent have
    // the same value.
...
bool operator!=(const BigEndianUint64& lhs,
    ...
    // Return 'true' if the specified 'lhs' and 'rhs' 'BigEndianUint64'
    // objects do not have the same value, and 'false' otherwise.  Two
    // 'BigEndianUint64' objects do not have the same value if and only
    // if the respective integral network byte-order values that they represent
    // do not have the same value.
