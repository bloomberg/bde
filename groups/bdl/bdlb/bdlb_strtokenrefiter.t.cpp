...
//                                  TBD
//-----------------------------------------------------------------------------
// [ 3] bdlb::StrTokenRefIter(const char*, const char*);
// [ 4] bdlb::StrTokenRefIter(const char*, const char*, const char*);
// [ 3] bdlb::StrTokenRefIter(const StringRef&, const char*);
// [ 4] bdlb::StrTokenRefIter(const StringRef&, const char*, const char*);
// [  ] ~bdlb::StrTokenRefIter();
// [ 5] void operator++();
...
int checkDateFormat(const char *input)
{
    ...
    for (; I; ++mI) {
        if (!I().length()) return BAD;       // empty token           // RETURN
    }
...
int restrictiveCheckDateFormat(const char *input)
{
    ...
    Obj mI(input, " \t", "/");  const Obj& I = mI;
                                     // generate iterator outside 'for' loop
    if (I.previousDelimiter().length()) return BAD;                   // RETURN
    for (; I; ++mI) {
        if (!I().length()) return BAD;       // empty token           // RETURN
    }
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      case 7: {
        ...
        bdlb::StrTokenRefIter it("", softDelims, hardDelims);
        ...
        if (veryVerbose) cout << "\t\tTesting nested iterator example" << endl;
        {
            ...
            for (bdlb::StrTokenRefIter it1(string, "\n"); it1; ++it1) {
                if (veryVerbose) cout << '@';
                for (bdlb::StrTokenRefIter it2(it1(), " "); it2; ++it2) {
      ...
      case 4: {
        // --------------------------------------------------------------------
        // Testing:
        //   bdlb::StrTokenRefIter(const char*, const char*, const char*);
        //   bdlb::StrTokenRefIter(const StringRef&, const char*, const char*);
        // --------------------------------------------------------------------
        ...
        if (veryVerbose) cout <<
            "\tTesting 'bdlb::StrTokenRefIter(const char*, "
        ...
        if (veryVerbose) cout <<
            "\tTesting 'bdlb::StrTokenRefIter(const StringRef&, "
                                             "const char*, const char*)'."
                              << endl;
        {
            if (veryVerbose) cout << "\t\t  0\t|     0\t\t|     0" << endl;
      ...
      case 3: {
        // --------------------------------------------------------------------
        // Testing:
        //   bdlb::StrTokenRefIter(const char*, const char*);
        //   bdlb::StrTokenRefIter(const StringRef&, const char*);
        // --------------------------------------------------------------------
        ...
        if (veryVerbose) cout <<
            "\tTesting 'bdlb::StrTokenRefIter(const char*, const char*)'."
                              << endl;
        {
            if (veryVerbose) cout << "\t\t  0\t|     0\t\t|     0" << endl;
            {
        ...
        if (veryVerbose) cout <<
            "\tTesting 'bdlb::StrTokenRefIter(const StringRef&, const char*)'."
                              << endl;
        {
            if (veryVerbose) cout << "\t\t  0\t|     0\t\t|     0" << endl;
            {
