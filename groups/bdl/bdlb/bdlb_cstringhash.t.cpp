...
// [ 2] bdlb::CStringHash()
// [ 2] bdlb::CStringHash(const bdlb::CStringHash)
// [ 2] ~bdlb::CStringHash()
// [ 2] bdlb::CStringHash& operator=(const bdlb::CStringHash&)
// ----------------------------------------------------------------------------
// [ 1] BREATHING TEST
// [ 7] USAGE EXAMPLE
// [ 4] Standard typedefs
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:
      ...
      case 5: {
        ...
        ASSERT((bslalg::HasTrait<bdlb::CStringHash,
      ...
      case 2: {
        ...
        // Testing:
        //   bdlb::CStringHash()
        //   bdlb::CStringHash(const bdlb::CStringHash)
        //   ~bdlb::CStringHash()
        //   bdlb::CStringHash& operator=(const bdlb::CStringHash&)
        // --------------------------------------------------------------------
