...
// [ 4] bdlb::StrTokenIter(const char*, const char*, const char*, ba* = 0);
// [  ] ~bdlb::StrTokenIter();
// [ 5] void operator++();
...
int main(int argc, char *argv[])
{
    ...
    switch (test) { case 0:  // Zero is always the leading case.
      case 8: {
        ...
        const char *softDelims = " \t\n";
        const char *hardDelims = "/!";
        bdlb::StrTokenIter it("", softDelims, hardDelims);
      ...
      case 4: {
        // --------------------------------------------------------------------
        // Testing:
        //    bdlb::StrTokenIter(const char*, const char*, const char*, ba*);
        // --------------------------------------------------------------------
      ...
      case 3: {
        // --------------------------------------------------------------------
        // Testing:
        //    bdlb::StrTokenIter(const char*, const char*, ba*);
        // --------------------------------------------------------------------
