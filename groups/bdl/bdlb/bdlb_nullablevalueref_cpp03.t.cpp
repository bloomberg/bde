// bdlb_nullablevalueref_cpp03.t.cpp                                  -*-C++-*-
...
//
// Generated on Fri Sep 15 15:39:13 2023
// Command line: sim_cpp11_features.pl bdlb_nullablevalueref.t.cpp

// Expanded test driver only when compiling bdlb_nullablevalueref.cpp
#ifdef COMPILING_BDLB_NULLABLEVALUEREF_T_CPP

// No C++03 Expansion

#else // if ! defined(COMPILING_BDLB_NULLABLEVALUEREF_T_CPP)

// Trivial program when not compiling bdlb_nullablevalueref.t.cpp
int main() {
    return -1;
}

#endif // defined(COMPILING_BDLB_NULLABLEVALUEREF_T_CPP)
