...
//
//@SEE_ALSO: bdlb_xxxbitutil, bdlcxxx_bitarray
//
...
//  }
//..
// Now, we can easily use 'bdlb::BitstringUtil' methods to find days of
// interest.  For example:
//..
//  int firstWeekendDay = bdlb::BitstringUtil::find1AtSmallestIndex(weekends,
//                                                                 365 + 1);
//  int lastWeekendDay  = bdlb::BitstringUtil::find1AtLargestIndex(weekends,
//                                                                365 + 1);
//..
...
inline
void BitstringUtil::append(int  *bitstring,
                                int   length,
                                bool  value,
                                int   numBits)
{
...
inline
void BitstringUtil::append0(int *bitstring, int length, int numBits)
{
    BSLS_ASSERT_SAFE(bitstring);
    BSLS_ASSERT_SAFE(0 <= length);
    BSLS_ASSERT_SAFE(0 <= numBits);
...
inline
void BitstringUtil::append1(int *bitstring, int length, int numBits)
{
    BSLS_ASSERT_SAFE(bitstring);
    BSLS_ASSERT_SAFE(0 <= length);
    BSLS_ASSERT_SAFE(0 <= numBits);
...
inline
void BitstringUtil::insert(int  *bitstring,
                                int   length,
                                int   dstIndex,
                                bool  value,
                                int   numBits)
...
inline
void BitstringUtil::insert0(int *bitstring,
                                 int  length,
                                 int  dstIndex,
                                 int  numBits)
{
...
inline
void BitstringUtil::insert1(int *bitstring,
                                 int  length,
                                 int  dstIndex,
                                 int  numBits)
{
...
inline
void BitstringUtil::removeAndFill(int  *bitstring,
                                       int   length,
                                       int   index,
                                       bool  value,
                                       int   numBits)
...
inline
void BitstringUtil::removeAndFill0(int *bitstring,
                                        int  length,
                                        int  index,
                                        int  numBits)
{
...
inline
void BitstringUtil::removeAndFill1(int *bitstring,
                                        int  length,
                                        int  index,
                                        int  numBits)
{
...
namespace bdlb {
inline
void BitstringUtil::appendBits(int  *bitstring,
                                    int   length,
                                    int   numBits,
                                    bool  value)
{
...
inline
void BitstringUtil::appendBits0(int *bitstring, int length, int numBits)
{
    return append0(bitstring, length, numBits);
}

inline
void BitstringUtil::appendBits1(int *bitstring, int length, int numBits)
{
    return append1(bitstring, length, numBits);
}

inline
bool BitstringUtil::compareBits(const int *lhsArray,
                                     int        lhsArrayIndex,
                                     const int *rhsArray,
                                     int        rhsArrayIndex,
                                     int        numBits)
...
inline
void BitstringUtil::copyBits(int       *dstArray,
                                  int        dstArrayIndex,
                                  const int *srcArray,
                                  int        srcArrayIndex,
                                  int        numBits)
...
inline
int BitstringUtil::findBit0AtLargestIndex(const int *bitstring,
                                               int        length)
{
...
inline
int BitstringUtil::findBit0AtLargestIndexGE(const int *bitstring,
                                                 int        length,
                                                 int        index)
{
...
inline
int BitstringUtil::findBit0AtLargestIndexGT(const int *bitstring,
                                                 int        length,
                                                 int        index)
{
...
inline
int BitstringUtil::findBit0AtLargestIndexLE(const int *bitstring,
                                                 int        index)
{
...
inline
int BitstringUtil::findBit0AtLargestIndexLT(const int *bitstring,
                                                 int        index)
{
...
inline
int BitstringUtil::findBit0AtSmallestIndex(const int *bitstring,
                                                int        length)
{
...
inline
int BitstringUtil::findBit0AtSmallestIndexGE(const int *bitstring,
                                                  int        length,
                                                  int        index)
{
...
inline
int BitstringUtil::findBit0AtSmallestIndexGT(const int *bitstring,
                                                  int        length,
                                                  int        index)
{
...
inline
int BitstringUtil::findBit0AtSmallestIndexLE(const int *bitstring,
                                                  int        index)
{
...
inline
int BitstringUtil::findBit0AtSmallestIndexLT(const int *bitstring,
                                                  int        index)
{
...
inline
int BitstringUtil::findBit1AtLargestIndex(const int *bitstring,
                                               int        length)
{
...
inline
int BitstringUtil::findBit1AtLargestIndexGE(const int *bitstring,
                                                 int        length,
                                                 int        index)
{
...
inline
int BitstringUtil::findBit1AtLargestIndexGT(const int *bitstring,
                                                 int        length,
                                                 int        index)
{
...
inline
int BitstringUtil::findBit1AtLargestIndexLE(const int *bitstring,
                                                 int        index)
{
...
inline
int BitstringUtil::findBit1AtLargestIndexLT(const int *bitstring,
                                                 int        index)
{
...
inline
int BitstringUtil::findBit1AtSmallestIndex(const int *bitstring,
                                                int        length)
{
...
inline
int BitstringUtil::findBit1AtSmallestIndexGE(const int *bitstring,
                                                  int        length,
                                                  int        index)
{
...
inline
int BitstringUtil::findBit1AtSmallestIndexGT(const int *bitstring,
                                                  int        length,
                                                  int        index)
{
...
inline
int BitstringUtil::findBit1AtSmallestIndexLE(const int *bitstring,
                                                  int        index)
{
...
inline
int BitstringUtil::findBit1AtSmallestIndexLT(const int *bitstring,
                                                  int        index)
{
...
inline
bool BitstringUtil::getBit(const int *bitstring, int index)
{
    return get(bitstring, index);
}

inline
int BitstringUtil::getBits(const int *bitstring, int index, int numBits)
{
    return get(bitstring, index, numBits);
}

inline
void BitstringUtil::insertBits(int  *bitstring,
                                    int   length,
                                    int   dstIndex,
                                    int   numBits,
                                    bool  value)
...
inline
void BitstringUtil::insertBits0(int *bitstring,
                                     int  length,
                                     int  dstIndex,
                                     int  numBits)
{
...
inline
void BitstringUtil::insertBits1(int *bitstring,
                                     int  length,
                                     int  dstIndex,
                                     int  numBits)
{
...
inline
void BitstringUtil::insertBitsRaw(int *bitstring,
                                       int  length,
                                       int  dstIndex,
                                       int  numBits)
{
...
inline
bool BitstringUtil::isAnyBit0(const int *bitstring,
                                   int        index,
                                   int        numBits)
{
...
inline
bool BitstringUtil::isAnyBit1(const int *bitstring,
                                   int        index,
                                   int        numBits)
{
...
inline
void BitstringUtil::moveBits(int       *dstArray,
                                  int        dstArrayIndex,
                                  const int *srcArray,
                                  int        srcArrayIndex,
                                  int        numBits)
...
inline
void BitstringUtil::removeBits(int  *bitstring,
                                    int   length,
                                    int   index,
                                    int   numBits,
                                    bool  value)
...
inline
void BitstringUtil::removeBits0(int *bitstring,
                                     int  length,
                                     int  index,
                                     int  numBits)
{
...
inline
void BitstringUtil::removeBits1(int *bitstring,
                                     int  length,
                                     int  index,
                                     int  numBits)
{
...
inline
void BitstringUtil::removeBitsRaw(int *bitstring,
                                       int  length,
                                       int  index,
                                       int  numBits)
{
...
inline
void BitstringUtil::setBit(int *bitstring, int index, bool value)
{
    set(bitstring, index, value);
}

inline
void BitstringUtil::setBits(int  *bitstring,
                                 int   index,
                                 int   numBits,
                                 bool  value)
{
...
inline
void BitstringUtil::swapBits(int *lhsArray,
                                  int  lhsArrayIndex,
                                  int *rhsArray,
                                  int  rhsArrayIndex,
                                  int  numBits)
