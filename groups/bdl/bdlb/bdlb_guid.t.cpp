...
//                line  spec  indent  s/tab format                adjust
//                ----  ----  ------  ----- --------------------- ------
                { L_,   "",    0,      0,   "["                       NL
                           "00000000-0000-0000-0000-000000000000"     NL
                                            "]"                       NL},
                ...
                { L_,   "A",   0,      0,   "["                       NL
                           "00010203-0405-0607-0809-0a0b0c0d0e0f"     NL
                                            "]"                       NL},

                { L_,   "H",   0,      0,   "["                       NL
                           "00102030-4050-6070-8090-a0b0c0d0e0f0"     NL
                                            "]"                       NL},

                { L_,   "B",   0,      2,   "["                       NL
                           "5c9d4e50-0df1-11e4-9191-0800200c9a66"     NL
                                            "]"                       NL},

                { L_,   "D",   1,      2,   "  ["                     NL
                           "5c9d4e52-0df1-11e4-9191-0800200c9a66"     NL
                                            "  ]"                     NL},
            };
#undef NL
            const int  NUM_DATA = sizeof DATA / sizeof *DATA;
