...
//
//@CLASSES:
//  bdlb::BitUtil: namespace for efficient bit-level operations on integers
//
...
//..
//  assert(static_cast<int>(0xffff0000) == bdlb::BitUtil::geMask(16));
//
//  /*------------------------------------------------------------------------+
//  | 'bdlb::BitUtil::geMask(16)' in binary:                                   |
//  |                                                                         |
//  | bit 16:                                               *                 |
...
//..
//  assert(static_cast<int>(0x0000ffff) == bdlb::BitUtil::ltMask(16));
//
//  /*------------------------------------------------------------------------+
//  | 'bdlb::BitUtil::ltMask(16)' in binary:                                   |
//  |                                                                         |
//  | bit 16:                                               *                 |
...
//..
//  assert(static_cast<int>(0x00800000) == bdlb::BitUtil::eqMask(23));
//
//  /*------------------------------------------------------------------------+
//  | 'bdlb::BitUtil::eqMask(23)' in binary:                                   |
//  |                                                                         |
//  | bit 23:                                        *                        |
...
// 'index' cleared:
//..
//  assert(static_cast<int>(0xfffeffff) == bdlb::BitUtil::neMask(16));
//
//  /*------------------------------------------------------------------------+
//  | 'bdlb::BitUtil::neMask(16)' in binary:                                   |
//  |                                                                         |
//  | bit 16:                                               *                 |
...
//..
//  assert(static_cast<int>(0x000f0000) == bdlb::BitUtil::oneMask(16, 4));
//
//  /*------------------------------------------------------------------------+
//  | 'bdlb::BitUtil::oneMask(16, 4)' in binary:                               |
//  |                                                                         |
//  | bit 16:                                               *                 |
...
//  +------------------------------------------------------------------------*/
//
//  assert(static_cast<int>(0xfff0ffff) == bdlb::BitUtil::zeroMask(16, 4));
//
//  /*------------------------------------------------------------------------+
//  | 'bdlb::BitUtil::zeroMask(16, 4)' in binary:                              |
//  |                                                                         |
//  | bit 16:                                               *                 |
//  | 4 bits starting at bit 16:                         ****                 |
...
//..
//  int myInt = 0x3333;
//  bdlb::BitUtil::andEqual(&myInt, 9, false);
//  assert(0x3133 == myInt);
//
//  /*------------------------------------------------------------------------+
//  | 'bdlb::BitUtil::andEqual(&myInt, 9, false)' in binary:                   |
//  |                                                                         |
...
//
//  myInt = 0x3333;
//  bdlb::BitUtil::andEqual(&myInt, 9, true);
//  assert(0x3333 == myInt);
//
//  myInt = 0x3333;
//  bdlb::BitUtil::andEqual(&myInt, 8,  0, 8);
//  assert(  0x33 == myInt);
//
//  myInt = 0x3333;
//  bdlb::BitUtil::andEqual(&myInt, 8, -1, 8);    // Note '-1' is all 1's.
//  assert(0x3333 == myInt);
//..
...
//..
//  myInt = 0x3333;
//  bdlb::BitUtil::insertOne(&myInt, 4, 8);
//  assert(0x333ff3 == myInt);
//
//  /*------------------------------------------------------------------------+
//  | 'bdlb::BitUtil::insertOne(&myInt, 4, 8)' in binary:                      |
//  |                                                                         |
//  | 'myInt' before in binary:                                11001100110011 |
...
//
//  myInt = 0x3333;
//  bdlb::BitUtil::insertZero(&myInt, 4, 8);
...
//..
//  myInt = 0x33333333;
//  bdlb::BitUtil::orEqual(&myInt, 16, -1, 8);
//  assert(static_cast<int>(0x33ff3333) == myInt);
//
//  /*------------------------------------------------------------------------+
//  | 'bdlb::BitUtil::orEqual(&myInt, 16, -1, 8)' in binary:                   |
//  |                                                                         |
...
//..
//  myInt = 0x12345678;
//  bdlb::BitUtil::removeOne(&myInt, 8, 16);
//  assert(static_cast<int>(0xffff1278) == myInt);
//
//  /*------------------------------------------------------------------------+
//  | 'bdlb::BitUtil::removeOne(&myInt, 8, 16)' in binary:                     |
//  |                                                                         |
...
//
//  myInt = 0x12345678;
//  bdlb::BitUtil::removeZero(&myInt, 8, 16);
...
//..
//  myInt = 0x11111111;
//  bdlb::BitUtil::toggle(&myInt, 8, 16);
//  assert(static_cast<int>(0x11eeee11) == myInt);
//
//  /*------------------------------------------------------------------------+
//  | 'bdlb::BitUtil::toggle(&myInt, 8, 16)' in binary:                        |
//  |                                                                         |
...
//..
//  myInt = 0x11111111;
//  bdlb::BitUtil::xorEqual(&myInt, 16, true);
//  assert(static_cast<int>(0x11101111) == myInt);
//
//  /*------------------------------------------------------------------------+
//  | 'bdlb::BitUtil::xorEqual(&myInt, 16, true)' in binary:                   |
//  |                                                                         |
//  | 'myInt' before in binary:              00010001000100010001000100010001 |
//  | xor bit 16:                                           1                 |
...
//
//  myInt = 0x11111111;
//  bdlb::BitUtil::xorEqual(&myInt, 16, false);
...
//..
//  myInt = 0x77777777;
//  bdlb::BitUtil::xorEqual(&myInt, 16, 0xff, 8);
//  assert(static_cast<int>(0x77887777) == myInt);
//
//  /*------------------------------------------------------------------------+
//  | 'bdlb::BitUtil::xorEqual(&myInt, 16, 0xff, 8)' in binary:                |
//  |                                                                         |
...
//
//  myInt = 0x77777777;
//  bdlb::BitUtil::xorEqual(&myInt, 16, 0x55, 8);
...
// the integer):
//..
//  assert( 8 == bdlb::BitUtil::find1AtLargestIndex(0x00000101));
//
//  /*------------------------------------------------------------------------+
//  | 'bdlb::BitUtil::find1AtLargestIndex(0x00000101)' in binary:              |
//  |                                                                         |
...
//  +------------------------------------------------------------------------*/
//
//  assert( 8 == bdlb::BitUtil::find0AtLargestIndex( ~0x00000101));
//  assert( 8 == bdlb::BitUtil::find0AtLargestIndex(  0xfffffe55));
//  assert( 8 == bdlb::BitUtil::find1AtLargestIndexGE(0x00000101,  3));
//  assert(-1 == bdlb::BitUtil::find1AtLargestIndexGE(0x00000155, 16));
//  assert(-1 == bdlb::BitUtil::find1AtLargestIndexLT(0xffff0100,  3));
//
//  assert( 8 == bdlb::BitUtil::find1AtLargestIndexLT(0xffff0100, 16));
//
//  /*------------------------------------------------------------------------+
//  | 'bdlb::BitUtil::find1AtLargestIndexLT(0xffff0100, 16)' in binary:        |
//  |                                                                         |
...
//  +------------------------------------------------------------------------*/
//
//  assert( 8 == bdlb::BitUtil::find1AtSmallestIndex(  0xffff0100));
//  assert(16 == bdlb::BitUtil::find1AtSmallestIndexGE(0xffff0100, 10));
//
//  /*------------------------------------------------------------------------+
//  | 'bdlb::BitUtil::find1AtSmallestIndexGE(0xffff0100, 10)' in binary:       |
//  |                                                                         |
//  | input:                                 11111111111111110000000100000000 |
//  | bit 10:                                                     *           |
...
//..
//  assert(      6 == bdlb::BitUtil::intAbs( 6));
//  assert(      6 == bdlb::BitUtil::intAbs(-6));
//  assert(INT_MAX == bdlb::BitUtil::intAbs(-INT_MAX));
//  assert(INT_MIN == bdlb::BitUtil::intAbs( INT_MIN));   // see note below
//
//  assert(12 == bdlb::BitUtil::intMax(-5, 12));
//  assert(-5 == bdlb::BitUtil::intMin(-5, 12));
//..
...
// 'bdlb::BitUtil::intAbs(INT_MIN)' cannot be represented as a positive integer.
...
//                    bdlb::BitUtil::merge(0x0f0f0000, 0xffff0f0f, 0x0000ffff));
//
//  /*------------------------------------------------------------------------+
//  | 'bdlb::BitUtil::merge(0x0f0f0000, 0xffff0f0f, 0x0000ffff))' in binary:   |
//  |                                                                         |
...
//                    bdlb::BitUtil::merge(0x00000000, 0xffffffff, 0x55555555));
//..
// 'numSetOne' ('numSetZero') counts the number of set (cleared) bits:
//..
//  assert(16 == bdlb::BitUtil::numSetOne(0x55555555));
//
//  /*------------------------------------------------------------------------+
//  | 'bdlb::BitUtil::numSetOne( 0x55555555)' in binary:                       |
//  |                                                                         |
//  | input in binary:                       01010101010101010101010101010101 |
//  | that has 16 ones set.  result: 16                                       |
//  +------------------------------------------------------------------------*/
//
//  assert(16 == bdlb::BitUtil::numSetOne( 0xffff0000));
//  assert(16 == bdlb::BitUtil::numSetOne( 0x0000ffff));
//  assert( 1 == bdlb::BitUtil::numSetOne( 0x00010000));
//  assert(31 == bdlb::BitUtil::numSetZero(0x00010000));
//..
...
//                                 bdlb::BitUtil::rangeZero(0x33333333, 8, 16));
//
//  /*------------------------------------------------------------------------+
//  | 'bdlb::BitUtil::rangeZero(0x33333333,  8, 16)' in binary:                |
//  |                                                                         |
...
//                                 bdlb::BitUtil::rangeZero(0xf0f0f0f0, 8, 16));
//  assert(static_cast<int>(0xff3333ff) ==
//                                 bdlb::BitUtil::rangeOne (0x33333333, 8, 16));
//..
// 'base2Log' takes a binary log of a number, rounded up to the next integer:
//..
//  assert(7 == bdlb::BitUtil::base2Log(100));
//  assert(7 == bdlb::BitUtil::base2Log(128));
//  assert(8 == bdlb::BitUtil::base2Log(129));
//..
// 'roundUpToBinaryPower' rounds a number up to the next power of 2:
//..
//  assert(128 == bdlb::BitUtil::roundUpToBinaryPower(100));
//  assert(128 == bdlb::BitUtil::roundUpToBinaryPower(128));
//..
// 'setBitOne' will set a bit (or bits) to one, leaving other bits unaffected:
//..
//  assert(static_cast<int>(0x66676666) ==
//                                    bdlb::BitUtil::setBitOne(0x66666666, 16));
//
//  /*------------------------------------------------------------------------+
//  | 'bdlb::BitUtil::setBitOne(0x66666666, 16)' in binary:                    |
//  |                                                                         |
...
//  +------------------------------------------------------------------------*/
//
//  assert(static_cast<int>(0x00010000) == bdlb::BitUtil::setBitOne(0, 16));
//
//  assert(static_cast<int>(0x33ffff33) ==
//                                    bdlb::BitUtil::setOne(0x33333333, 8, 16));
//..
...
//
//  assert( 8 == bdlb::BitUtil::sizeInBits(thisChar));
//  assert(16 == bdlb::BitUtil::sizeInBits(thisShort));
//  assert(32 == bdlb::BitUtil::sizeInBits(thisInt));
//  assert(64 == bdlb::BitUtil::sizeInBits(thisBigInt));
//..
...
// TBD #ifndef BDE_OMIT_TRANSITIONAL // DEPRECATED
      , BDES_BITS_PER_BYTE  = CHAR_BIT
      , BDES_BITS_PER_WORD  = BDES_BITS_PER_INT
// TBD #endif  // BDE_OMIT_TRANSITIONAL
  ...
  public:
    ...
    static void andEqual64(Int64 *dstInteger,
        ...
        // 'dstIndex + numBits <= BitUtil::sizeInBits(*dstInteger)'.
    ...
    static void andEqual64(Int64 *dstInteger,
        ...
        // 'dstIndex + numBits <= BitUtil::sizeInBits(*dstInteger)', and
        // 'srcIndex + numBits <= BitUtil::sizeInBits(*srcInteger)'.
    ...
    static void minusEqual64(Int64 *dstInteger,
        ...
        // starting at the specified 'dstIndex'.  The behavior is undefined
        // unless '0 <= dstIndex', '0 <= numBits', and
        // 'dstIndex + numBits <= BitUtil::sizeInBits(*dstInteger)'.  Note
    ...
    static void minusEqual64(Int64 *dstInteger,
        ...
        // undefined unless '0 <= dstIndex', '0 <= srcIndex', '0 <= numBits',
        // 'dstIndex + numBits <= BitUtil::sizeInBits(*dstInteger)', and
        // 'srcIndex + numBits <= BitUtil::sizeInBits(*srcInteger)'.  Note
        // that the bitwise difference, 'a - b', is defined in C++ code as
        // 'a & ~b'.
...
inline
bsls::Types::Int64 BitUtil::eqMask64(int index)
{
    BSLS_ASSERT_SAFE(    0 <= index);
...
inline
bsls::Types::Int64 BitUtil::geMask64(int index)
{
    BSLS_ASSERT_SAFE(    0 <= index);
    BSLS_ASSERT_SAFE(index <= static_cast<int>(BDES_BITS_PER_INT64));
...
inline
bsls::Types::Int64 BitUtil::gtMask64(int index)
{
    BSLS_ASSERT_SAFE(    0 <= index);
    BSLS_ASSERT_SAFE(index <= static_cast<int>(BDES_BITS_PER_INT64));
...
inline
bsls::Types::Int64 BitUtil::leMask64(int index)
{
    BSLS_ASSERT_SAFE(    0 <= index);
    BSLS_ASSERT_SAFE(index <= static_cast<int>(BDES_BITS_PER_INT64));
...
inline
bsls::Types::Int64 BitUtil::ltMask64(int index)
{
    BSLS_ASSERT_SAFE(    0 <= index);
    BSLS_ASSERT_SAFE(index <= static_cast<int>(BDES_BITS_PER_INT64));
...
inline
bsls::Types::Int64 BitUtil::neMask64(int index)
{
    BSLS_ASSERT_SAFE(    0 <= index);
    BSLS_ASSERT_SAFE(index <= static_cast<int>(BDES_BITS_PER_INT64));
...
inline
int BitUtil::find1AtLargestIndex(int srcInteger)
{
...
inline
int BitUtil::find1AtLargestIndex64(Int64 srcInteger)
{
#if defined(BSLS_PLATFORM_CMP_IBM)
...
inline
int BitUtil::find1AtSmallestIndex(int srcInteger)
{
#if defined(BSLS_PLATFORM_CMP_IBM)
...
inline
int BitUtil::find1AtSmallestIndex64(Int64 srcInteger)
{
#if defined(BSLS_PLATFORM_CMP_IBM)
...
inline
int BitUtil::numSetOne(int srcInteger)
{
...
inline
int BitUtil::numSetOne64(Int64 srcInteger)
{
...
inline
int BitUtil::oneMask(int index, int numBits)
{
    BSLS_ASSERT_SAFE(              0 <= index);
...
inline
bsls::Types::Int64 BitUtil::oneMask64(int index, int numBits)
{
    BSLS_ASSERT_SAFE(              0 <= index);
    BSLS_ASSERT_SAFE(              0 <= numBits);
...
inline
int BitUtil::zeroMask(int index, int numBits)
{
    BSLS_ASSERT_SAFE(              0 <= index);
    BSLS_ASSERT_SAFE(              0 <= numBits);
    BSLS_ASSERT_SAFE(index + numBits <= BDES_BITS_PER_INT);
...
inline
bsls::Types::Int64 BitUtil::zeroMask64(int index, int numBits)
{
    BSLS_ASSERT_SAFE(              0 <= index);
    BSLS_ASSERT_SAFE(              0 <= numBits);
    BSLS_ASSERT_SAFE(index + numBits <= BDES_BITS_PER_INT64);
...
inline
int BitUtil::find0AtLargestIndex(int srcInteger)
{
...
inline
int BitUtil::find0AtLargestIndex64(Int64 srcInteger)
{
    // Note that both AIX xlC and GNU GCC compilers have no built-in routines
...
inline
int BitUtil::find0AtSmallestIndex(int srcInteger)
{
...
inline
int BitUtil::find0AtSmallestIndex64(Int64 srcInteger)
{
    // Note that AIX xlC compiler has no built-in primitive that counts
...
inline
int BitUtil::rangeOne(int srcInteger, int srcIndex, int numBits)
{
...
inline
bsls::Types::Int64 BitUtil::rangeOne64(Int64 srcInteger,
                                            int   srcIndex,
                                            int   numBits)
{
    BSLS_ASSERT_SAFE(                 0 <= srcIndex);
...
inline
int BitUtil::rangeZero(int srcInteger, int srcIndex, int numBits)
{
    BSLS_ASSERT_SAFE(                 0 <= srcIndex);
    BSLS_ASSERT_SAFE(                 0 <= numBits);
    BSLS_ASSERT_SAFE(srcIndex + numBits <= BDES_BITS_PER_INT);
...
inline
bsls::Types::Int64 BitUtil::rangeZero64(Int64 srcInteger,
                                             int   srcIndex,
                                             int   numBits)
{
    BSLS_ASSERT_SAFE(                 0 <= srcIndex);
...
inline
unsigned BitUtil::roundUpToBinaryPower(unsigned srcInteger)
{
...
inline
bsls::Types::Uint64 BitUtil::roundUpToBinaryPower64(Uint64 srcInteger)
{
...
inline
void BitUtil::andEqual(int *dstInteger, int dstIndex, bool value)
{
...
inline
void BitUtil::andEqual64(Int64 *dstInteger, int dstIndex, bool value)
{
    BSLS_ASSERT_SAFE(       0 <= dstIndex);
...
inline
void BitUtil::andEqual(int *dstInteger,
                            int  dstIndex,
                            int  srcInteger,
                            int  numBits)
{
...
inline
void BitUtil::andEqual64(Int64 *dstInteger,
                              int    dstIndex,
                              Int64  srcInteger,
                              int    numBits)
{
...
inline
void BitUtil::insertOne(int *dstInteger, int dstIndex, int numBits)
{
    BSLS_ASSERT_SAFE(                 0 <= dstIndex);
    BSLS_ASSERT_SAFE(                 0 <= numBits);
    BSLS_ASSERT_SAFE(dstIndex + numBits <= BDES_BITS_PER_INT);
...
inline
void BitUtil::insertOne64(Int64 *dstInteger, int dstIndex, int numBits)
{
    BSLS_ASSERT_SAFE(                 0 <= dstIndex);
    BSLS_ASSERT_SAFE(                 0 <= numBits);
    BSLS_ASSERT_SAFE(dstIndex + numBits <= BDES_BITS_PER_INT64);
...
inline
void BitUtil::insertZero(int *dstInteger, int dstIndex, int numBits)
{
    BSLS_ASSERT_SAFE(                 0 <= dstIndex);
    BSLS_ASSERT_SAFE(                 0 <= numBits);
    BSLS_ASSERT_SAFE(dstIndex + numBits <= BDES_BITS_PER_INT);
...
inline
void BitUtil::insertZero64(Int64 *dstInteger, int dstIndex, int numBits)
{
    BSLS_ASSERT_SAFE(                 0 <= dstIndex);
    BSLS_ASSERT_SAFE(                 0 <= numBits);
    BSLS_ASSERT_SAFE(dstIndex + numBits <= BDES_BITS_PER_INT64);
...
inline
void BitUtil::insertValue(int *dstInteger,
                               int  dstIndex,
                               int  srcInteger,
                               int  numBits)
{
...
inline
void BitUtil::insertValue64(Int64 *dstInteger,
                                 int    dstIndex,
                                 Int64  srcInteger,
                                 int    numBits)
{
...
inline
void BitUtil::insertValueUpTo(int *dstInteger,
                                   int  numBits,
                                   int  srcInteger)
{
    BSLS_ASSERT_SAFE(      0 <= numBits);
...
inline
void BitUtil::insertValueUpTo64(Int64 *dstInteger,
                                     int    numBits,
                                     Int64  srcInteger)
{
    BSLS_ASSERT_SAFE(      0 <= numBits);
...
inline
void BitUtil::minusEqual(int *dstInteger, int dstIndex, bool value)
{
    BSLS_ASSERT_SAFE(       0 <= dstIndex);
    BSLS_ASSERT_SAFE(dstIndex <= BDES_BITS_PER_INT);
...
inline
void BitUtil::minusEqual64(Int64 *dstInteger, int dstIndex, bool value)
{
    BSLS_ASSERT_SAFE(       0 <= dstIndex);
    BSLS_ASSERT_SAFE(dstIndex <= BDES_BITS_PER_INT64);
...
inline
void BitUtil::minusEqual(int *dstInteger,
                              int  dstIndex,
                              int  srcInteger,
                              int  numBits)
{
...
inline
void BitUtil::minusEqual64(Int64 *dstInteger,
                                int    dstIndex,
                                Int64  srcInteger,
                                int    numBits)
{
...
inline
void BitUtil::orEqual(int *dstInteger, int dstIndex, bool value)
{
    BSLS_ASSERT_SAFE(       0 <= dstIndex);
    BSLS_ASSERT_SAFE(dstIndex <  BDES_BITS_PER_INT);
...
inline
void BitUtil::orEqual64(Int64 *dstInteger, int dstIndex, bool value)
{
    BSLS_ASSERT_SAFE(       0 <= dstIndex);
    BSLS_ASSERT_SAFE(dstIndex <  BDES_BITS_PER_INT64);
...
inline
void BitUtil::orEqual(int *dstInteger,
                           int  dstIndex,
                           int  srcInteger,
                           int  numBits)
{
...
inline
void BitUtil::orEqual64(Int64 *dstInteger,
                             int    dstIndex,
                             Int64  srcInteger,
                             int    numBits)
{
...
inline
void BitUtil::removeOne(int *dstInteger, int dstIndex, int numBits)
{
    BSLS_ASSERT_SAFE(                 0 <= dstIndex);
    BSLS_ASSERT_SAFE(                 0 <= numBits);
    BSLS_ASSERT_SAFE(dstIndex + numBits <= BDES_BITS_PER_INT);
...
inline
void BitUtil::removeOne64(Int64 *dstInteger, int dstIndex, int numBits)
{
    BSLS_ASSERT_SAFE(                 0 <= dstIndex);
    BSLS_ASSERT_SAFE(                 0 <= numBits);
    BSLS_ASSERT_SAFE(dstIndex + numBits <= BDES_BITS_PER_INT64);
...
inline
void BitUtil::removeZero(int *dstInteger, int dstIndex, int numBits)
{
    BSLS_ASSERT_SAFE(                 0 <= dstIndex);
    BSLS_ASSERT_SAFE(                 0 <= numBits);
    BSLS_ASSERT_SAFE(dstIndex + numBits <= BDES_BITS_PER_INT);
...
inline
void BitUtil::removeZero64(Int64 *dstInteger, int dstIndex, int numBits)
{
    BSLS_ASSERT_SAFE(                 0 <= dstIndex);
    BSLS_ASSERT_SAFE(                 0 <= numBits);
    BSLS_ASSERT_SAFE(dstIndex + numBits <= BDES_BITS_PER_INT64);
...
inline
void BitUtil::replaceBitOne(int *dstInteger, int dstIndex)
{
    BSLS_ASSERT_SAFE(       0 <= dstIndex);
    BSLS_ASSERT_SAFE(dstIndex <  BDES_BITS_PER_INT);
...
inline
void BitUtil::replaceBitOne64(Int64 *dstInteger, int dstIndex)
{
    BSLS_ASSERT_SAFE(       0 <= dstIndex);
    BSLS_ASSERT_SAFE(dstIndex <  BDES_BITS_PER_INT64);
...
inline
void BitUtil::replaceBitValue(int *dstInteger,
                                   int  dstIndex,
                                   int  value)
{
    BSLS_ASSERT_SAFE(       0 <= dstIndex);
...
inline
void BitUtil::replaceBitValue64(Int64 *dstInteger,
                                     int    dstIndex,
                                     int    value)
{
    BSLS_ASSERT_SAFE(       0 <= dstIndex);
...
inline
void BitUtil::replaceBitZero(int *dstInteger, int dstIndex)
{
    BSLS_ASSERT_SAFE(0        <= dstIndex);
    BSLS_ASSERT_SAFE(dstIndex <  BDES_BITS_PER_INT);
...
inline
void BitUtil::replaceBitZero64(Int64 *dstInteger, int dstIndex)
{
    BSLS_ASSERT_SAFE(0        <= dstIndex);
    BSLS_ASSERT_SAFE(dstIndex <  BDES_BITS_PER_INT64);
...
inline
void BitUtil::replaceOne(int *dstInteger, int dstIndex, int numBits)
{
    BSLS_ASSERT_SAFE(0                  <= dstIndex);
    BSLS_ASSERT_SAFE(0                  <= numBits);
    BSLS_ASSERT_SAFE(dstIndex + numBits <= BDES_BITS_PER_INT);
...
inline
void BitUtil::replaceOne64(Int64 *dstInteger, int dstIndex, int numBits)
{
    BSLS_ASSERT_SAFE(0                  <= dstIndex);
    BSLS_ASSERT_SAFE(0                  <= numBits);
    BSLS_ASSERT_SAFE(dstIndex + numBits <= BDES_BITS_PER_INT64);
...
inline
void BitUtil::replaceValue(int *dstInteger,
                                int  dstIndex,
                                int  srcInteger,
                                int  numBits)
{
...
inline
void BitUtil::replaceValue64(Int64 *dstInteger,
                                  int    dstIndex,
                                  Int64  srcInteger,
                                  int    numBits)
{
...
inline
void BitUtil::replaceValueUpTo(int *dstInteger,
                                    int  dstIndex,
                                    int  srcInteger)
{
    BSLS_ASSERT_SAFE(0        <= dstIndex);
...
inline
void BitUtil::replaceValueUpTo64(Int64 *dstInteger,
                                      int    dstIndex,
                                      Int64  srcInteger)
{
    BSLS_ASSERT_SAFE(0        <= dstIndex);
...
inline
void BitUtil::replaceZero(int *dstInteger, int dstIndex, int numBits)
{
    BSLS_ASSERT_SAFE(0                  <= dstIndex);
    BSLS_ASSERT_SAFE(0                  <= numBits);
    BSLS_ASSERT_SAFE(dstIndex + numBits <= BDES_BITS_PER_INT);
...
inline
void BitUtil::replaceZero64(Int64 *dstInteger, int dstIndex, int numBits)
{
    BSLS_ASSERT_SAFE(0                  <= dstIndex);
    BSLS_ASSERT_SAFE(0                  <= numBits);
    BSLS_ASSERT_SAFE(dstIndex + numBits <= BDES_BITS_PER_INT64);
...
inline
void BitUtil::toggle(int *dstInteger, int dstIndex, int numBits)
{
    BSLS_ASSERT_SAFE(0                  <= dstIndex);
    BSLS_ASSERT_SAFE(0                  <= numBits);
    BSLS_ASSERT_SAFE(dstIndex + numBits <= BDES_BITS_PER_INT);
...
inline
void BitUtil::toggle64(Int64 *dstInteger, int dstIndex, int numBits)
{
    BSLS_ASSERT_SAFE(0                  <= dstIndex);
    BSLS_ASSERT_SAFE(0                  <= numBits);
    BSLS_ASSERT_SAFE(dstIndex + numBits <= BDES_BITS_PER_INT64);
...
inline
void BitUtil::toggleBit(int *dstInteger, int dstIndex)
{
    BSLS_ASSERT_SAFE(0        <= dstIndex);
    BSLS_ASSERT_SAFE(dstIndex <  BDES_BITS_PER_INT);
...
inline
void BitUtil::toggleBit64(Int64 *dstInteger, int dstIndex)
{
    BSLS_ASSERT_SAFE(0        <= dstIndex);
    BSLS_ASSERT_SAFE(dstIndex <  BDES_BITS_PER_INT64);
...
inline
void BitUtil::xorEqual(int *dstInteger, int dstIndex, bool value)
{
    BSLS_ASSERT_SAFE(0        <= dstIndex);
    BSLS_ASSERT_SAFE(dstIndex <  BDES_BITS_PER_INT);
...
inline
void BitUtil::xorEqual64(Int64 *dstInteger,
                              int    dstIndex,
                              bool   value)
{
    BSLS_ASSERT_SAFE(0        <= dstIndex);
...
inline
void BitUtil::xorEqual(int *dstInteger,
                            int  dstIndex,
                            int  srcInteger,
                            int  numBits)
{
...
inline
int BitUtil::base2Log(unsigned srcInteger)
{
    return numSetOne(roundUpToBinaryPower(srcInteger) - 1);
}

inline
int BitUtil::base2Log64(Uint64 srcInteger)
{
    return numSetOne64(roundUpToBinaryPower64(srcInteger) - 1);
}

inline
int BitUtil::extractOne(int srcInteger, int srcIndex, int numBits)
{
    BSLS_ASSERT_SAFE(                 0 <= srcIndex);
    BSLS_ASSERT_SAFE(                 0 <= numBits);
    BSLS_ASSERT_SAFE(srcIndex + numBits <= BDES_BITS_PER_INT);
...
inline
bsls::Types::Int64 BitUtil::extractOne64(Int64 srcInteger,
                                              int   srcIndex,
                                              int   numBits)
{
    BSLS_ASSERT_SAFE(                 0 <= srcIndex);
...
inline
int BitUtil::extractOne(int srcInteger,
                             int srcIndex,
                             int numBits,
                             int offset)
{
...
inline
int BitUtil::extractZero(int srcInteger, int srcIndex, int numBits)
{
    BSLS_ASSERT_SAFE(                 0 <= srcIndex);
    BSLS_ASSERT_SAFE(                 0 <= numBits);
    BSLS_ASSERT_SAFE(srcIndex + numBits <= BDES_BITS_PER_INT);
...
inline
bsls::Types::Int64 BitUtil::extractZero64(Int64 srcInteger,
                                               int   srcIndex,
                                               int   numBits)
{
    BSLS_ASSERT_SAFE(                 0 <= srcIndex);
...
inline
int BitUtil::extractZero(int srcInteger,
                              int srcIndex,
                              int numBits,
                              int offset)
{
...
inline
int BitUtil::find0AtLargestIndexGE(int srcInteger, int srcIndex)
{
    BSLS_ASSERT_SAFE(       0 <= srcIndex);
...
inline
int BitUtil::find0AtLargestIndexGE64(Int64 srcInteger, int srcIndex)
{
    BSLS_ASSERT_SAFE(       0 <= srcIndex);
...
inline
int BitUtil::find0AtLargestIndexGT(int srcInteger, int srcIndex)
{
    BSLS_ASSERT_SAFE(       0 <= srcIndex);
    BSLS_ASSERT_SAFE(srcIndex <= BDES_BITS_PER_INT);
...
inline
int BitUtil::find0AtLargestIndexGT64(Int64 srcInteger, int srcIndex)
{
    BSLS_ASSERT_SAFE(       0 <= srcIndex);
    BSLS_ASSERT_SAFE(srcIndex <= BDES_BITS_PER_INT64);
...
inline
int BitUtil::find0AtLargestIndexLE(int srcInteger, int srcIndex)
{
    BSLS_ASSERT_SAFE(       0 <= srcIndex);
    BSLS_ASSERT_SAFE(srcIndex <= BDES_BITS_PER_INT);
...
inline
int BitUtil::find0AtLargestIndexLE64(Int64 srcInteger, int srcIndex)
{
    BSLS_ASSERT_SAFE(       0 <= srcIndex);
    BSLS_ASSERT_SAFE(srcIndex <= BDES_BITS_PER_INT64);
...
inline
int BitUtil::find0AtLargestIndexLT(int srcInteger, int srcIndex)
{
    BSLS_ASSERT_SAFE(       0 <= srcIndex);
    BSLS_ASSERT_SAFE(srcIndex <= BDES_BITS_PER_INT);
...
inline
int BitUtil::find0AtLargestIndexLT64(Int64 srcInteger, int srcIndex)
{
    BSLS_ASSERT_SAFE(       0 <= srcIndex);
    BSLS_ASSERT_SAFE(srcIndex <= BDES_BITS_PER_INT64);
...
inline
int BitUtil::find0AtSmallestIndexGE(int srcInteger, int srcIndex)
{
    BSLS_ASSERT_SAFE(       0 <= srcIndex);
    BSLS_ASSERT_SAFE(srcIndex <= BDES_BITS_PER_INT);
...
inline
int BitUtil::find0AtSmallestIndexGE64(Int64 srcInteger, int srcIndex)
{
    BSLS_ASSERT_SAFE(       0 <= srcIndex);
    BSLS_ASSERT_SAFE(srcIndex <= BDES_BITS_PER_INT64);
...
inline
int BitUtil::find0AtSmallestIndexGT(int srcInteger, int srcIndex)
{
    BSLS_ASSERT_SAFE(       0 <= srcIndex);
    BSLS_ASSERT_SAFE(srcIndex <= BDES_BITS_PER_INT);
...
inline
int BitUtil::find0AtSmallestIndexGT64(Int64 srcInteger, int srcIndex)
{
    BSLS_ASSERT_SAFE(       0 <= srcIndex);
    BSLS_ASSERT_SAFE(srcIndex <= BDES_BITS_PER_INT64);
...
inline
int BitUtil::find0AtSmallestIndexLE(int srcInteger, int srcIndex)
{
    BSLS_ASSERT_SAFE(       0 <= srcIndex);
    BSLS_ASSERT_SAFE(srcIndex <= BDES_BITS_PER_INT);
...
inline
int BitUtil::find0AtSmallestIndexLE64(Int64 srcInteger, int srcIndex)
{
    BSLS_ASSERT_SAFE(       0 <= srcIndex);
    BSLS_ASSERT_SAFE(srcIndex <= BDES_BITS_PER_INT64);
...
inline
int BitUtil::find0AtSmallestIndexLT(int srcInteger, int srcIndex)
{
    BSLS_ASSERT_SAFE(       0 <= srcIndex);
    BSLS_ASSERT_SAFE(srcIndex <= BDES_BITS_PER_INT);
...
inline
int BitUtil::find0AtSmallestIndexLT64(Int64 srcInteger, int srcIndex)
{
    BSLS_ASSERT_SAFE(       0 <= srcIndex);
    BSLS_ASSERT_SAFE(srcIndex <= BDES_BITS_PER_INT64);
...
inline
int BitUtil::find1AtLargestIndexGE(int srcInteger, int srcIndex)
{
    BSLS_ASSERT_SAFE(       0 <= srcIndex);
    BSLS_ASSERT_SAFE(srcIndex <= BDES_BITS_PER_INT);
...
inline
int BitUtil::find1AtLargestIndexGE64(Int64 srcInteger, int srcIndex)
{
    BSLS_ASSERT_SAFE(       0 <= srcIndex);
    BSLS_ASSERT_SAFE(srcIndex <= BDES_BITS_PER_INT64);
...
inline
int BitUtil::find1AtLargestIndexGT(int srcInteger, int srcIndex)
{
    BSLS_ASSERT_SAFE(       0 <= srcIndex);
    BSLS_ASSERT_SAFE(srcIndex <= BDES_BITS_PER_INT);
...
inline
int BitUtil::find1AtLargestIndexGT64(Int64 srcInteger, int srcIndex)
{
    BSLS_ASSERT_SAFE(       0 <= srcIndex);
    BSLS_ASSERT_SAFE(srcIndex <= BDES_BITS_PER_INT64);
...
inline
int BitUtil::find1AtLargestIndexLE(int srcInteger, int srcIndex)
{
    BSLS_ASSERT_SAFE(       0 <= srcIndex);
    BSLS_ASSERT_SAFE(srcIndex <= BDES_BITS_PER_INT);
...
inline
int BitUtil::find1AtLargestIndexLE64(Int64 srcInteger, int srcIndex)
{
    BSLS_ASSERT_SAFE(       0 <= srcIndex);
    BSLS_ASSERT_SAFE(srcIndex <= BDES_BITS_PER_INT64);
...
inline
int BitUtil::find1AtLargestIndexLT(int srcInteger, int srcIndex)
{
    BSLS_ASSERT_SAFE(       0 <= srcIndex);
    BSLS_ASSERT_SAFE(srcIndex <= BDES_BITS_PER_INT);
...
inline
int BitUtil::find1AtLargestIndexLT64(Int64 srcInteger, int srcIndex)
{
    BSLS_ASSERT_SAFE(       0 <= srcIndex);
    BSLS_ASSERT_SAFE(srcIndex <= BDES_BITS_PER_INT64);
...
inline
int BitUtil::find1AtSmallestIndexGE(int srcInteger, int srcIndex)
{
    BSLS_ASSERT_SAFE(       0 <= srcIndex);
    BSLS_ASSERT_SAFE(srcIndex <= BDES_BITS_PER_INT);
...
inline
int BitUtil::find1AtSmallestIndexGE64(Int64 srcInteger, int srcIndex)
{
    BSLS_ASSERT_SAFE(       0 <= srcIndex);
    BSLS_ASSERT_SAFE(srcIndex <= BDES_BITS_PER_INT64);
...
inline
int BitUtil::find1AtSmallestIndexGT(int srcInteger, int srcIndex)
{
    BSLS_ASSERT_SAFE(       0 <= srcIndex);
    BSLS_ASSERT_SAFE(srcIndex <= BDES_BITS_PER_INT);
...
inline
int BitUtil::find1AtSmallestIndexGT64(Int64 srcInteger, int srcIndex)
{
    BSLS_ASSERT_SAFE(       0 <= srcIndex);
    BSLS_ASSERT_SAFE(srcIndex <= BDES_BITS_PER_INT64);
...
inline
int BitUtil::find1AtSmallestIndexLE(int srcInteger, int srcIndex)
{
    BSLS_ASSERT_SAFE(       0 <= srcIndex);
    BSLS_ASSERT_SAFE(srcIndex <= BDES_BITS_PER_INT);
...
inline
int BitUtil::find1AtSmallestIndexLE64(Int64 srcInteger, int srcIndex)
{
    BSLS_ASSERT_SAFE(       0 <= srcIndex);
    BSLS_ASSERT_SAFE(srcIndex <= BDES_BITS_PER_INT64);
...
inline
int BitUtil::find1AtSmallestIndexLT(int srcInteger, int srcIndex)
{
    BSLS_ASSERT_SAFE(       0 <= srcIndex);
    BSLS_ASSERT_SAFE(srcIndex <= BDES_BITS_PER_INT);
...
inline
int BitUtil::find1AtSmallestIndexLT64(Int64 srcInteger, int srcIndex)
{
    BSLS_ASSERT_SAFE(       0 <= srcIndex);
    BSLS_ASSERT_SAFE(srcIndex <= BDES_BITS_PER_INT64);
...
inline
int BitUtil::intAbs(int srcInteger)
{
    return srcInteger ^ ((-srcInteger ^ srcInteger) & -(srcInteger < 0));
}

inline
bsls::Types::Int64 BitUtil::intAbs64(Int64 srcInteger)
{
...
inline
int BitUtil::intMax(int srcIntegerX, int srcIntegerY)
{
...
inline
bsls::Types::Int64 BitUtil::intMax64(Int64 srcIntegerX, Int64 srcIntegerY)
{
    return srcIntegerX ^ ((srcIntegerY ^ srcIntegerX)
...
inline
int BitUtil::intMin(int srcIntegerX, int srcIntegerY)
{
    return srcIntegerX ^ ((srcIntegerY ^ srcIntegerX)
                        & -(srcIntegerY < srcIntegerX));
}
...
inline
bsls::Types::Int64 BitUtil::intMin64(Int64 srcIntegerX, Int64 srcIntegerY)
{
    return srcIntegerX ^ ((srcIntegerY ^ srcIntegerX)
                        & -static_cast<int>(srcIntegerY < srcIntegerX));
}
...
inline
bool BitUtil::isAnySetOne(int srcInteger)
{
    return !!srcInteger;
}

inline
bool BitUtil::isAnySetOne64(Int64 srcInteger)
{
    return !!srcInteger;
}

inline
bool BitUtil::isAnySetZero(int srcInteger)
{
    return srcInteger != ~0;
}

inline
bool BitUtil::isAnySetZero64(Int64 srcInteger)
{
    return srcInteger != ~static_cast<Int64>(0);
}

inline
bool BitUtil::isSetOne(int srcInteger, int srcIndex)
{
    BSLS_ASSERT_SAFE(       0 <= srcIndex);
    BSLS_ASSERT_SAFE(srcIndex <  BDES_BITS_PER_INT);
...
inline
bool BitUtil::isSetOne64(Int64 srcInteger, int srcIndex)
{
    BSLS_ASSERT_SAFE(       0 <= srcIndex);
    BSLS_ASSERT_SAFE(srcIndex <  BDES_BITS_PER_INT64);
...
inline
bool BitUtil::isSetZero(int srcInteger, int srcIndex)
{
    BSLS_ASSERT_SAFE(       0 <= srcIndex);
    BSLS_ASSERT_SAFE(srcIndex <  BDES_BITS_PER_INT);
...
inline
bool BitUtil::isSetZero64(Int64 srcInteger, int srcIndex)
{
    BSLS_ASSERT_SAFE(       0 <= srcIndex);
    BSLS_ASSERT_SAFE(srcIndex <  BDES_BITS_PER_INT64);
...
inline
int BitUtil::merge(int zeroSrcInteger, int oneSrcInteger, int mask)
{
    return zeroSrcInteger ^ ((zeroSrcInteger ^ oneSrcInteger) & mask);
}

inline
bsls::Types::Int64 BitUtil::merge64(Int64 zeroSrcInteger,
                                         Int64 oneSrcInteger,
                                         Int64 mask)
{
    return zeroSrcInteger ^ ((zeroSrcInteger ^ oneSrcInteger) & mask);
...
inline
int BitUtil::numSetZero(int srcInteger)
{
    return numSetOne(~srcInteger);
}

inline
int BitUtil::numSetZero64(Int64 srcInteger)
{
    return numSetOne64(~srcInteger);
}

inline
int BitUtil::setBitOne(int srcInteger, int srcIndex)
{
    BSLS_ASSERT_SAFE(       0 <= srcIndex);
    BSLS_ASSERT_SAFE(srcIndex <  BDES_BITS_PER_INT);
...
inline
bsls::Types::Int64 BitUtil::setBitOne64(Int64 srcInteger, int srcIndex)
{
    BSLS_ASSERT_SAFE(       0 <= srcIndex);
    BSLS_ASSERT_SAFE(srcIndex <  BDES_BITS_PER_INT64);
...
inline
int BitUtil::setBitValue(int srcInteger, int srcIndex, int value)
{
    BSLS_ASSERT_SAFE(       0 <= srcIndex);
    BSLS_ASSERT_SAFE(srcIndex <  BDES_BITS_PER_INT);
...
inline
bsls::Types::Int64 BitUtil::setBitValue64(Int64 srcInteger,
                                               int   srcIndex,
                                               int   value)
{
    BSLS_ASSERT_SAFE(       0 <= srcIndex);
...
inline
int BitUtil::setBitZero(int srcInteger, int srcIndex)
{
    BSLS_ASSERT_SAFE(       0 <= srcIndex);
    BSLS_ASSERT_SAFE(srcIndex <  BDES_BITS_PER_INT);
...
inline
bsls::Types::Int64 BitUtil::setBitZero64(Int64 srcInteger, int srcIndex)
{
    BSLS_ASSERT_SAFE(       0 <= srcIndex);
    BSLS_ASSERT_SAFE(srcIndex <  BDES_BITS_PER_INT64);
...
inline
int BitUtil::setOne(int srcInteger, int srcIndex, int numBits)
{
    BSLS_ASSERT_SAFE(                 0 <= srcIndex);
    BSLS_ASSERT_SAFE(                 0 <= numBits);
    BSLS_ASSERT_SAFE(srcIndex + numBits <= BDES_BITS_PER_INT);
...
inline
bsls::Types::Int64 BitUtil::setOne64(Int64 srcInteger,
                                          int   srcIndex,
                                          int   numBits)
{
    BSLS_ASSERT_SAFE(                 0 <= srcIndex);
...
inline
int BitUtil::setValue(int srcInteger,
                           int srcIndex,
                           int value,
                           int numBits)
{
...
inline
bsls::Types::Int64 BitUtil::setValue64(Int64 srcInteger,
                                            int   srcIndex,
                                            Int64 value,
                                            int   numBits)
{
...
inline
int BitUtil::setValueUpTo(int srcInteger, int srcIndex, int value)
{
    BSLS_ASSERT_SAFE(       0 <= srcIndex);
    BSLS_ASSERT_SAFE(srcIndex <  BDES_BITS_PER_INT);
...
inline
bsls::Types::Int64 BitUtil::setValueUpTo64(Int64 srcInteger,
                                                int   srcIndex,
                                                Int64 value)
{
    BSLS_ASSERT_SAFE(0        <= srcIndex);
...
inline
int BitUtil::setZero(int srcInteger, int srcIndex, int numBits)
{
    BSLS_ASSERT_SAFE(                 0 <= srcIndex);
    BSLS_ASSERT_SAFE(                 0 <= numBits);
    BSLS_ASSERT_SAFE(srcIndex + numBits <= BDES_BITS_PER_INT);
...
inline
bsls::Types::Int64 BitUtil::setZero64(Int64 srcInteger,
                                           int   srcIndex,
                                           int   numBits)
{
    BSLS_ASSERT_SAFE(                 0 <= srcIndex);
...
namespace bdlb {
inline
int BitUtil::findBit0AtLargestIndex(int srcInteger)
{
    return find0AtLargestIndex(srcInteger);
}

inline
int BitUtil::findBit0AtLargestIndex64(Int64 srcInteger)
{
    return find0AtLargestIndex64(srcInteger);
}

inline
int BitUtil::findBit0AtLargestIndexGE(int srcInteger, int srcIndex)
{
    return find0AtLargestIndexGE(srcInteger, srcIndex);
}

inline
int BitUtil::findBit0AtLargestIndexGE64(Int64 srcInteger, int srcIndex)
{
    return find0AtLargestIndexGE64(srcInteger, srcIndex);
}

inline
int BitUtil::findBit0AtLargestIndexGT(int srcInteger, int srcIndex)
{
    return find0AtLargestIndexGT(srcInteger, srcIndex);
}

inline
int BitUtil::findBit0AtLargestIndexGT64(Int64 srcInteger, int srcIndex)
{
    return find0AtLargestIndexGT64(srcInteger, srcIndex);
}

inline
int BitUtil::findBit0AtLargestIndexLE(int srcInteger, int srcIndex)
{
    return find0AtLargestIndexLE(srcInteger, srcIndex);
}

inline
int BitUtil::findBit0AtLargestIndexLE64(Int64 srcInteger, int srcIndex)
{
    return find0AtLargestIndexLE64(srcInteger, srcIndex);
}

inline
int BitUtil::findBit0AtLargestIndexLT(int srcInteger, int srcIndex)
{
    return find0AtLargestIndexLT(srcInteger, srcIndex);
}

inline
int BitUtil::findBit0AtLargestIndexLT64(Int64 srcInteger, int srcIndex)
{
    return find0AtLargestIndexLT64(srcInteger, srcIndex);
}

inline
int BitUtil::findBit0AtSmallestIndex(int srcInteger)
{
    return find0AtSmallestIndex(srcInteger);
}

inline
int BitUtil::findBit0AtSmallestIndex64(Int64 srcInteger)
{
    return find0AtSmallestIndex64(srcInteger);
}

inline
int BitUtil::findBit0AtSmallestIndexGE(int srcInteger, int srcIndex)
{
    return find0AtSmallestIndexGE(srcInteger, srcIndex);
}

inline
int BitUtil::findBit0AtSmallestIndexGE64(Int64 srcInteger, int srcIndex)
{
    return find0AtSmallestIndexGE64(srcInteger, srcIndex);
}

inline
int BitUtil::findBit0AtSmallestIndexGT(int srcInteger, int srcIndex)
{
    return find0AtSmallestIndexGT(srcInteger, srcIndex);
}

inline
int BitUtil::findBit0AtSmallestIndexGT64(Int64 srcInteger, int srcIndex)
{
    return find0AtSmallestIndexGT64(srcInteger, srcIndex);
}

inline
int BitUtil::findBit0AtSmallestIndexLE(int srcInteger, int srcIndex)
{
    return find0AtSmallestIndexLE(srcInteger, srcIndex);
}

inline
int BitUtil::findBit0AtSmallestIndexLE64(Int64 srcInteger, int srcIndex)
{
    return find0AtSmallestIndexLE64(srcInteger, srcIndex);
}

inline
int BitUtil::findBit0AtSmallestIndexLT(int srcInteger, int srcIndex)
{
    return find0AtSmallestIndexLT(srcInteger, srcIndex);
}

inline
int BitUtil::findBit0AtSmallestIndexLT64(Int64 srcInteger, int srcIndex)
{
    return find0AtSmallestIndexLT64(srcInteger, srcIndex);
}

inline
int BitUtil::findBit1AtLargestIndex(int srcInteger)
{
    return find1AtLargestIndex(srcInteger);
}

inline
int BitUtil::findBit1AtLargestIndex64(Int64 srcInteger)
{
    return find1AtLargestIndex64(srcInteger);
}

inline
int BitUtil::findBit1AtLargestIndexGE(int srcInteger, int srcIndex)
{
    return find1AtLargestIndexGE(srcInteger, srcIndex);
}

inline
int BitUtil::findBit1AtLargestIndexGE64(Int64 srcInteger, int srcIndex)
{
    return find1AtLargestIndexGE64(srcInteger, srcIndex);
}

inline
int BitUtil::findBit1AtLargestIndexGT(int srcInteger, int srcIndex)
{
    return find1AtLargestIndexGT(srcInteger, srcIndex);
}

inline
int BitUtil::findBit1AtLargestIndexGT64(Int64 srcInteger, int srcIndex)
{
    return find1AtLargestIndexGT64(srcInteger, srcIndex);
}

inline
int BitUtil::findBit1AtLargestIndexLE(int srcInteger, int srcIndex)
{
    return find1AtLargestIndexLE(srcInteger, srcIndex);
}

inline
int BitUtil::findBit1AtLargestIndexLE64(Int64 srcInteger, int srcIndex)
{
    return find1AtLargestIndexLE64(srcInteger, srcIndex);
}

inline
int BitUtil::findBit1AtLargestIndexLT(int srcInteger, int srcIndex)
{
    return find1AtLargestIndexLT(srcInteger, srcIndex);
}

inline
int BitUtil::findBit1AtLargestIndexLT64(Int64 srcInteger, int srcIndex)
{
    return find1AtLargestIndexLT64(srcInteger, srcIndex);
}

inline
int BitUtil::findBit1AtSmallestIndex(int srcInteger)
{
    return find1AtSmallestIndex(srcInteger);
}

inline
int BitUtil::findBit1AtSmallestIndex64(Int64 srcInteger)
{
    return find1AtSmallestIndex64(srcInteger);
}

inline
int BitUtil::findBit1AtSmallestIndexGE(int srcInteger, int srcIndex)
{
    return find1AtSmallestIndexGE(srcInteger, srcIndex);
}

inline
int BitUtil::findBit1AtSmallestIndexGE64(Int64 srcInteger, int srcIndex)
{
    return find1AtSmallestIndexGE64(srcInteger, srcIndex);
}

inline
int BitUtil::findBit1AtSmallestIndexGT(int srcInteger, int srcIndex)
{
    return find1AtSmallestIndexGT(srcInteger, srcIndex);
}

inline
int BitUtil::findBit1AtSmallestIndexGT64(Int64 srcInteger, int srcIndex)
{
    return find1AtSmallestIndexGT64(srcInteger, srcIndex);
}

inline
int BitUtil::findBit1AtSmallestIndexLE(int srcInteger, int srcIndex)
{
    return find1AtSmallestIndexLE(srcInteger, srcIndex);
}

inline
int BitUtil::findBit1AtSmallestIndexLE64(Int64 srcInteger, int srcIndex)
{
    return find1AtSmallestIndexLE64(srcInteger, srcIndex);
}

inline
int BitUtil::findBit1AtSmallestIndexLT(int srcInteger, int srcIndex)
{
    return find1AtSmallestIndexLT(srcInteger, srcIndex);
}

inline
int BitUtil::findBit1AtSmallestIndexLT64(Int64 srcInteger, int srcIndex)
{
    return find1AtSmallestIndexLT64(srcInteger, srcIndex);
}

inline
int BitUtil::abs32(int srcInteger)
{
    return intAbs(srcInteger);
}

inline
bsls::Types::Int64 BitUtil::abs64(Int64 srcInteger)
{
    return intAbs64(srcInteger);
}

inline
int BitUtil::max32(int srcIntegerX, int srcIntegerY)
{
    return intMax(srcIntegerX, srcIntegerY);
}

inline
bsls::Types::Int64 BitUtil::max64(Int64 srcIntegerX, Int64 srcIntegerY)
{
    return intMax64(srcIntegerX, srcIntegerY);
}

inline
int BitUtil::min32(int srcIntegerX, int srcIntegerY)
{
    return intMin(srcIntegerX, srcIntegerY);
}

inline
bsls::Types::Int64 BitUtil::min64(Int64 srcIntegerX, Int64 srcIntegerY)
{
    return intMin64(srcIntegerX, srcIntegerY);
}

inline
int BitUtil::numSet0(int srcInteger)
{
    return numSetZero(srcInteger);
}

inline
int BitUtil::numSet1(int srcInteger)
{
    return numSetOne(srcInteger);
}

inline
bool BitUtil::isSet0(int srcInteger, int srcIndex)
{
    return isSetZero(srcInteger, srcIndex);
}

inline
bool BitUtil::isSet1(int srcInteger, int srcIndex)
{
    return isSetOne(srcInteger, srcIndex);
}

inline
int BitUtil::setBit0(int srcInteger, int srcIndex)
{
    return setBitZero(srcInteger, srcIndex);
}

inline
int BitUtil::setBit1(int srcInteger, int srcIndex)
{
    return setBitOne(srcInteger, srcIndex);
}

inline
int BitUtil::extract0(int srcInteger, int srcIndex, int numBits)
{
    return extractZero(srcInteger, srcIndex, numBits);
}

inline
int BitUtil::extract0(int srcInteger,
                           int srcIndex,
                           int numBits,
                           int offset)
{
...
inline
int BitUtil::extract1(int srcInteger, int srcIndex, int numBits)
{
    return extractOne(srcInteger, srcIndex, numBits);
}

inline
int BitUtil::extract1(int srcInteger,
                           int srcIndex,
                           int numBits,
                           int offset)
{
...
inline
void BitUtil::replaceBit0(int *dstInteger, int dstIndex)
{
    return replaceBitZero(dstInteger, dstIndex);
}

inline
void BitUtil::replaceBit1(int *dstInteger, int dstIndex)
{
    return replaceBitOne(dstInteger, dstIndex);
}

inline
void BitUtil::remove0(int *dstInteger, int dstIndex, int numBits)
{
    return removeZero(dstInteger, dstIndex, numBits);
}

inline
void BitUtil::remove1(int *dstInteger, int dstIndex, int numBits)
{
    return removeOne(dstInteger, dstIndex, numBits);
}

inline
void BitUtil::insert0(int *dstInteger, int dstIndex, int numBits)
{
    return insertZero(dstInteger, dstIndex, numBits);
}

inline
void BitUtil::insert1(int *dstInteger, int dstIndex, int numBits)
{
    return insertOne(dstInteger, dstIndex, numBits);
}

inline
int BitUtil::set0(int srcInteger, int srcIndex, int numBits)
{
    return setZero(srcInteger, srcIndex, numBits);
}

inline
int BitUtil::set1(int srcInteger, int srcIndex, int numBits)
{
    return setOne(srcInteger, srcIndex, numBits);
}

inline
void BitUtil::replace0(int *dstInteger, int dstIndex, int numBits)
{
    return replaceZero(dstInteger, dstIndex, numBits);
}

inline
void BitUtil::replace1(int *dstInteger, int dstIndex, int numBits)
{
    return replaceOne(dstInteger, dstIndex, numBits);
}

inline
bool BitUtil::isAnySet0(int srcInteger)
{
    return isAnySetZero(srcInteger);
}

inline
bool BitUtil::isAnySet1(int srcInteger)
{
    return isAnySetOne(srcInteger);
}

inline
int BitUtil::range0(int srcInteger, int srcIndex, int numBits)
{
    return rangeZero(srcInteger, srcIndex, numBits);
}

inline
int BitUtil::range1(int srcInteger, int srcIndex, int numBits)
{
    return rangeOne(srcInteger, srcIndex, numBits);
}

inline
int BitUtil::maskZero(int index, int numBits)
{
    return zeroMask(index, numBits);
}

inline
bsls::Types::Int64 BitUtil::maskZero64(int index, int numBits)
{
    return zeroMask64(index, numBits);
}

inline
int BitUtil::maskOne(int index, int numBits)
{
    return oneMask(index, numBits);
}

inline
bsls::Types::Int64 BitUtil::maskOne64(int index, int numBits)
{
    return oneMask64(index, numBits);
}

inline
int BitUtil::mask0(int index, int numBits)
{
    return zeroMask(index, numBits);
}

inline
int BitUtil::mask1(int index, int numBits)
{
    return oneMask(index, numBits);
}
