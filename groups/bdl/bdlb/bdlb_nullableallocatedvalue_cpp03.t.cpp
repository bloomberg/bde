// bdlb_nullableallocatedvalue_cpp03.t.cpp                            -*-C++-*-
...
//
// Generated on Tue Aug 22 16:05:46 2023
// Command line: sim_cpp11_features.pl bdlb_nullableallocatedvalue.t.cpp

// Expanded test driver only when compiling bdlb_nullableallocatedvalue.cpp
#ifdef COMPILING_BDLB_NULLABLEALLOCATEDVALUE_T_CPP

// No C++03 Expansion

#else // if ! defined(COMPILING_BDLB_NULLABLEALLOCATEDVALUE_T_CPP)

// Trivial program when not compiling bdlb_nullableallocatedvalue.t.cpp
int main() {
    return -1;
}

#endif // defined(COMPILING_BDLB_NULLABLEALLOCATEDVALUE_T_CPP)
