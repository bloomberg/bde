...
//=============================================================================
//        Helper Functions for Testing 'bdlb::BitUtil' Searching Functions
//-----------------------------------------------------------------------------
// These functions perform operations that are identical to 'bdlb::BitUtil'
...
static int findFirstBit1(Int64 srcInteger)
    // Return the value of 'bdlb::BitUtil::find1AtLargestIndex(srcInteger)'
...
static int findLastBit1(Int64 srcInteger)
    // Return the value of 'bdlb::BitUtil::find1AtSmallestIndex(srcInteger)'
    // but use a completely independent implementation.
{
    for (int i = 0; i < BPS; ++i) {
        if (srcInteger & ((Int64) 1 << i))
...
//..
    ASSERT((int) 0xffff0000 == bdlb::BitUtil::geMask(16));
//
//  +-------------------------------------------------------------------------+
...
//..
    ASSERT((int) 0x0000ffff == bdlb::BitUtil::ltMask(16));
//
//  +-------------------------------------------------------------------------+
...
//..
    ASSERT((int) 0x00800000 == bdlb::BitUtil::eqMask(23));
//
//  +-------------------------------------------------------------------------+
...
// 'index' cleared:
//..
    ASSERT((int) 0xfffeffff == bdlb::BitUtil::neMask(16));
//
//  +-------------------------------------------------------------------------+
...
//..
    ASSERT((int) 0x000f0000 == bdlb::BitUtil::oneMask(16, 4));
//
//  +-------------------------------------------------------------------------+
...
//  +-------------------------------------------------------------------------+
//
    ASSERT((int) 0xfff0ffff == bdlb::BitUtil::zeroMask(16, 4));
//
//  +-------------------------------------------------------------------------+
...
//..
    ASSERT((int) 0x00333300 == bdlb::BitUtil::rangeZero(0x33333333, 8, 16));
//
//  +-------------------------------------------------------------------------+
...
//  +-------------------------------------------------------------------------+
//
    ASSERT((int) 0x00f0f000 == bdlb::BitUtil::rangeZero(0xf0f0f0f0, 8, 16));
    ASSERT((int) 0xff3333ff == bdlb::BitUtil::rangeOne (0x33333333, 8, 16));
//..
...
//..
    ASSERT((int) 0x66676666 == bdlb::BitUtil::setBitOne(0x66666666, 16));
//
//  +-------------------------------------------------------------------------+
...
//  +-------------------------------------------------------------------------+
//
    ASSERT((int) 0x00010000 == bdlb::BitUtil::setBitOne(0, 16));

    ASSERT((int) 0x33ffff33 == bdlb::BitUtil::setOne(0x33333333, 8, 16));
//..
...
void testG(int test)
{
    switch (test) {
      ...
      case 31: {
////////////////////////////////////////////////////////////////////////////
// print() has been removed from bdlb::BitUtil
////////////////////////////////////////////////////////////////////////////
//
//     // --------------------------------------------------------------------
